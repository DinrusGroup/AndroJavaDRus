...
final class ProcessEnvironment
{
    ...
    private static class Variable
        : ExternalData : Comparable<Variable>
    {
    ...
    // This : the String map view the user sees.
        ...
        : AbstractSet<Map.Entry<String,String>>
    {
        ...
        public bool contains(Object o) { return s.contains(vvEntry(o)); }
        public bool remove(Object o)   { return s.remove(vvEntry(o)); }
        public bool equals(Object o) {
    ...
    private static class StringKeySet : AbstractSet<String> {
