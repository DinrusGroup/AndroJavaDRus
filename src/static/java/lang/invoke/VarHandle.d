 ...
 * is {@code (CT1 c1, ..., CTn cn, T expectedValue, T newValue)bool}.
 ...
 * {@code (String[] c1, int c2, String expectedValue, String newValue)bool}.
 ...
 * bool r = avh.compareAndSet(sa, 10, "expected", "new");
 * }</pre>
 *
...
public abstract class VarHandle {
    ...
    */
     ...
     * {@link #getVolatile}.
     *
     * <p>The method signature is of the form {@code (CT1 ct1, ..., CTn ctn, T expectedValue, T newValue)bool}.
     *
    ...
    // Android-removed: unsupported annotation.
    // @HotSpotIntrinsicCandidate
    bool compareAndSet(Object... args);
    ...
    // Android-removed: unsupported annotation.
    // @HotSpotIntrinsicCandidate
    bool weakCompareAndSetPlain(Object... args);
    ...
    // Android-removed: unsupported annotation.
    // @HotSpotIntrinsicCandidate
    bool weakCompareAndSet(Object... args);
    ...
    // Android-removed: unsupported annotation.
    // @HotSpotIntrinsicCandidate
    bool weakCompareAndSetAcquire(Object... args);
    ...
    // Android-removed: unsupported annotation.
    // @HotSpotIntrinsicCandidate
    bool weakCompareAndSetRelease(Object... args);
     ...
     * {@link #getVolatile}.
     *
     * <p>If the variable type is the non-integral {@code bool} type then a
    ...
    enum AccessType {
        ...
        MethodType accessModeType(Class!(T) receiver, Class!(T) value,
                                  Class!(T)... intermediate) {
            Class!(T)[] ps;
            int i;
            switch (this) {
                case GET:
                ...
                case COMPARE_AND_SWAP:
                    ...
                    ps[i++] = value;
                    ps[i] = value;
                    return MethodType.methodType(bool.class, ps);
        ...
        private static Class!(T)[] allocateParameters(int values,
                                                     Class!(T) receiver, Class!(T)... intermediate) {
            int size = ((receiver != null) ? 1 : 0) + intermediate.length + values;
            return new Class!(T)[size];
        }

        private static int fillParameters(Class!(T)[] ps,
                                          Class!(T) receiver, Class!(T)... intermediate) {
            int i = 0;
            if (receiver != null)
                ps[i++] = receiver;
    ...
    */
     ...
     */
    public final List<Class!(T)> coordinateTypes() {
        // Android-removed: existing implementation.
     ...
     * {@code false}.
     */
    public final bool isAccessModeSupported(AccessMode accessMode) {
    ...
    */
     ...
     * @hide
     */
    VarHandle(Class!(T) varType, bool isFinal) {
     ...
     * @hide
     */
    VarHandle(Class!(T) varType, bool isFinal, Class!(T) coordinateType) {
        this.varType = Objects.requireNonNull(varType);
     ...
     * @hide
     */
    VarHandle(Class!(T) varType, Class!(T) backingArrayType,  bool isFinal,
              Class!(T) coordinateType0, Class!(T) coordinateType1) {
        this.varType = Objects.requireNonNull(varType);
        ...
        Class!(T) backingArrayComponentType = backingArrayType.getComponentType();
    ...
    static int alignedAccessModesBitMask(Class!(T) varType, bool isFinal) {
        ...
        if (varType != bool.class && varType != byte.class && varType != short.class &&
    ...
    static int unalignedAccessModesBitMask(Class!(T) varType) {
