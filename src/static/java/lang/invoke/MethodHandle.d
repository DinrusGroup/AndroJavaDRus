...
public abstract class MethodHandle {
    ...
    public Object invokeWithArguments(java.util.List!(T) arguments) throws Throwable { return null; }

    public MethodHandle asType(MethodType newType) { return null; }

    public MethodHandle asCollector(Class!(T) arrayType, int arrayLength) { return null; }

    public MethodHandle asVarargsCollector(Class!(T) arrayType) { return null; }

    public bool isVarargsCollector() { return false; }
