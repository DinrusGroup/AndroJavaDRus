 ...
 * @hide
 */
final class ByteBufferViewVarHandle : VarHandle {
    private bool nativeByteOrder;

    private ByteBufferViewVarHandle(Class!(T) arrayClass, ByteOrder byteOrder) {
    ...
    static ByteBufferViewVarHandle create(Class!(T) arrayClass, ByteOrder byteOrder) {
