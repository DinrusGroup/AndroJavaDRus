...
public class ThreadLocal<T> {
     ...
     */
    static final class SuppliedThreadLocal<T> : ThreadLocal<T> {

        private final Supplier<? : T> supplier;

        SuppliedThreadLocal(Supplier<? : T> supplier) {
    ...
    static class ThreadLocalMap {
         ...
         */
        static class Entry : WeakReference<ThreadLocal!(T)> {
         ...
         */
        ThreadLocalMap(ThreadLocal!(T) firstKey, Object firstValue) {
         ...
         *         searching for key.
         */
        private void replaceStaleEntry(ThreadLocal!(T) key, Object value,
                                       int staleSlot) {
            Entry[] tab = table;
            int len = tab.length;
            Entry e;
