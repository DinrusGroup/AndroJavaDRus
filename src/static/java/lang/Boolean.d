 ...
 * @since   JDK1.0
 */
public final class Boolean : java.io.Serializable.Serializable,
                                      Comparable<Boolean>
{
    /**
    ...
    public static final Class<Boolean> TYPE = (Class<Boolean>) Class.getPrimitiveClass("bool");
   ...
   /**
    ...
    public bool equals(Object obj) {
        if (obj instanceof Boolean) {
            return value == ((Boolean)obj).boolValue();
        }
        return false;
    }
