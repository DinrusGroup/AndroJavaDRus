...
public class Throwable : Serializable {
     ...
     * }
     *
     * class MidLevelException : Exception {
    ...
    private static class WrappedPrintStream : PrintStreamOrWriter {
    ...
    private static class WrappedPrintWriter : PrintStreamOrWriter {
     ...
     * Throwable#Throwable(String, Throwable, bool, bool) is not
     ...
     * {@linkplain #Throwable(String, Throwable, bool, bool) via
     ...
     * #Throwable(String, Throwable, bool, bool) suppression is
