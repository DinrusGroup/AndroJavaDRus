 ...
 */
public final class Constructor<T> : Executable {
    ...
    private final Class!(T) serializationCtor;

    private Constructor() {
      this(null, null);
    }

    private Constructor(Class!(T) serializationCtor,
     ...
     * @hide
     */
    public Constructor<T> serializationCopy(Class!(T) ctor, Class!(T) cl) {
    ...
    public Class!(T)[] getParameterTypes() {
        ...
        Class!(T)[] paramTypes = super.getParameterTypesInternal();
        if (paramTypes == null) {
    ...
    @FastNative
    public native Class!(T)[] getExceptionTypes();
    ...
    public bool equals(Object obj) {
        if (obj != null && obj instanceof Constructor) {
            Constructor!(T) other = (Constructor!(T))obj;
    ...
    @FastNative
    private static native Object newInstanceFromSerialization(Class!(T) ctorClass, Class!(T) allocClass)
