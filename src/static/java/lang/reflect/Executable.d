 ...
 * @since 1.8
 */
public abstract class Executable : AccessibleObject
     ...
     */
    abstract bool hasGenericInformation();

    bool equalParamTypes(Class!(T)[] params1, Class!(T)[] params2) {
    ...
    void separateWithCommas(Class!(T)[] types, StringBuilder sb) {
    ...
    void printModifiersIfNonzero(StringBuilder sb, int mask, bool isDefault) {
    ...
    String sharedToGenericString(int modifierMask, bool isDefault) {
        try {
            StringBuilder sb = new StringBuilder();
     ...
     */
    public abstract Class!(T) getDeclaringClass();
     ...
     */
    public abstract TypeVariable!(T)[] getTypeParameters();
     ...
     * represents
     */
    public abstract Class!(T)[] getParameterTypes();
    ...
    Type[] getAllGenericParameterTypes() {
        final bool genericInfo = hasGenericInformation();
        ...
        if (!genericInfo) {
            ...
            final bool realParamData = hasRealParameterData();
    ...
    private transient volatile bool hasRealParameterData;
     ...
     */
    public abstract Class!(T)[] getExceptionTypes();
     ...
     */
    public <T : Annotation> T getAnnotation(Class<T> annotationClass) {
    ...
    // Android-changed: Implemented getAnnotation(Class) natively.
    @FastNative
    private native <T : Annotation> T getAnnotationNative(Class<T> annotationClass);
     ...
     */
    override
    public <T : Annotation> T[] getAnnotationsByType(Class<T> annotationClass) {
     ...
     */
    @SuppressWarnings("unused") // set by runtime
    private Class!(T) declaringClassOfOverriddenMethod;
    ...
    final Class!(T) getDeclaringClassInternal() {
     ...
     */
    @FastNative
    final native Class!(T)[] getParameterTypesInternal();
    ...
    override
    public final bool isAnnotationPresent(Class<? : Annotation> annotationType) {
        Objects.requireNonNull(annotationType);
        return isAnnotationPresentNative(annotationType);
    }
    @FastNative
    private native bool isAnnotationPresentNative(Class<? : Annotation> annotationType);
    ...
    final bool hasGenericInformationInternal() {
    ...
    final GenericInfo getMethodOrConstructorGenericInfoInternal() {
        ...
        Class!(T)[] exceptionTypes = this.getExceptionTypes();
    ...
    final bool equalNameAndParametersInternal(Method m) {
