...
class Field : AccessibleObject : Member {
    ...
    /**
     * Gets the value of a static or instance {@code bool} field.
     *
     * @param obj the object to extract the {@code bool} value
     * from
     ...
     *              converted to the type {@code bool} by a
     *              widening conversion.
     * @exception NullPointerException      if the specified object is null
     *              and the field is an instance field.
     * @exception ExceptionInInitializerError if the initialization provoked
    ...
    // Android-changed: get*(Object) implemented natively.
    @FastNative
    public native bool getBoolean(Object obj)
        throws IllegalArgumentException, IllegalAccessException;
    ...
    /**
     * Sets the value of a field as a {@code bool} on the specified object.
     * This method is equivalent to
     * {@code set(obj, zObj)},
     * where {@code zObj} is a {@code Boolean} object and
     * {@code zObj.boolValue() == z}.
     *
     * @param obj the object whose field should be modified
    ...
    // Android-changed: set*(Object, ...) implemented natively.
    @FastNative
    public native void setBoolean(Object obj, bool z)
        throws IllegalArgumentException, IllegalAccessException;
    ...
    @FastNative
    private native <A : Annotation> A getAnnotationNative(Class<A> annotationType);
    ...
    override
    public bool isAnnotationPresent(Class<? : Annotation> annotationType) {
