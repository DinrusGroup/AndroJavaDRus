 ...
 * @since 1.8
 */
public final class Parameter : AnnotatedElement {
    ...
    public Class!(T) getType() {
        Class!(T) tmp = parameterClassCache;
        if (null == tmp) {
    ...
    private transient volatile Class!(T) parameterClassCache = null;
    ...
    @FastNative
    private static native <A : Annotation> A getAnnotationNative(
