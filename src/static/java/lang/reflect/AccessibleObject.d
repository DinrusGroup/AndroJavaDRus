...
public class AccessibleObject : AnnotatedElement {
    ...
    */
     ...
     * the indicated bool value.  A value of {@code true} indicates that
     ...
     * @see java.lang.RuntimePermission
     */
    public void setAccessible(bool flag) throws SecurityException {
        // Android-removed: SecurityManager calls.
        // SecurityManager sm = System.getSecurityManager();
        // if (sm != null) sm.checkPermission(ACCESS_PERMISSION);
        ...
        throws SecurityException
    {
        if (obj instanceof Constructor && flag == true) {
            Constructor!(T) c = (Constructor!(T))obj;
            ...
            Class!(T) clazz = c.getDeclaringClass();
            if (c.getDeclaringClass() == Class.class) {
   ...
   /**
     ...
     */
    override
    public <T : Annotation> T getDeclaredAnnotation(Class<T> annotationClass) {
     ...
     */
    override
    public <T : Annotation> T[] getDeclaredAnnotationsByType(Class<T> annotationClass) {
        // Only annotations on classes are inherited, for all other
    ...
    void checkAccess(Class!(T) caller, Class!(T) clazz, Object obj, int modifiers)
    ...
    void slowCheckMemberAccess(Class!(T) caller, Class!(T) clazz, Object obj, int modifiers,
                               Class!(T) targetClass)
        throws IllegalAccessException
    {
        ...
        Object cache = ((targetClass == clazz)
                        ? caller
                        : new Class!(T)[] { caller, targetClass });
