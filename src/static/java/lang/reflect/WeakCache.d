...
final class WeakCache<K, P, V> {
    ...
    /**
     * A factory {@link Supplier} that : the lazy synchronized
     * construction of the value and installment of it into the cache.
     */
    private final class Factory : Supplier<V> {
     ...
     */
    private static final class LookupValue<V> : Value<V> {
        ...
        public bool equals(Object obj) {
            return obj == this ||
                   ...
                   this.value == ((Value!(T)) obj).get();  // compare by identity
        }
    }
        ...
        : WeakReference<V> : Value<V>
    {
        ...
        public bool equals(Object obj) {
            ...
            return obj == this ||
                   ...
                   (value = get()) != null &&
                   value == ((Value!(T)) obj).get(); // compare by identity
        }
    }
     ...
     */
    private static final class CacheKey<K> : WeakReference<K> {
        ...
        void expungeFrom(ConcurrentMap<?, ? : ConcurrentMap<?, ?>> map,
