...
class Array {
     ...
     * is negative
     */
    public static Object newInstance(Class!(T) componentType, int length)
     ...
     */
    public static Object newInstance(Class!(T) componentType, int... dimensions)
    ...
    public static Object get(Object array, int index)
        ...
        if (array instanceof bool[]) {
            return ((bool[]) array)[index] ? Boolean.TRUE : Boolean.FALSE;
        }
    ...
    public static bool getBoolean(Object array, int index)
        throws IllegalArgumentException, ArrayIndexOutOfBoundsException {
        if (array instanceof bool[]) {
    ...
    public static void set(Object array, int index, Object value)
        ...
        if (array instanceof Object[]) {
            ...
            if (value instanceof Boolean) {
                setBoolean(array, index, ((Boolean) value).boolValue());
    ...
    /**
     * Sets the value of the indexed component of the specified array
     * object to the specified {@code bool} value.
     * @param array the array
     * @param index the index into the array
     ...
     * @see Array#set
     */
    // Android-changed: Non-native implementation of setBoolean(Object, int, bool)
    // Android-changed: Removal of explicit runtime exceptions throws clause
    public static void setBoolean(Object array, int index, bool z)
        /* throws IllegalArgumentException, ArrayIndexOutOfBoundsException */ {
        if (array instanceof bool[]) {
            ((bool[]) array)[index] = z;
        } else {
    ...
    private static Object newArray(Class!(T) componentType, int length)
        throws NegativeArraySizeException {
        ...
        } else if (componentType == bool.class) {
    ...
    /*
    private static native Object multiNewArray(Class!(T) componentType,
        int[] dimensions)
        throws IllegalArgumentException, NegativeArraySizeException;
    */
     ...
     */
    @FastNative
    private static native Object createMultiArray(Class!(T) componentType, int[] dimensions)
            throws NegativeArraySizeException;
     ...
     */
    @FastNative
    private static native Object createObjectArray(Class!(T) componentType, int length)
            throws NegativeArraySizeException;
