...
public interface AnnotatedElement {
   ...
   /**
     ...
     * @since 1.5
     */
    <T : Annotation> T getAnnotation(Class<T> annotationClass);
     ...
     * @since 1.8
     */
    default <T : Annotation> T[] getAnnotationsByType(Class<T> annotationClass) {
     ...
     * @since 1.8
     */
    default <T : Annotation> T getDeclaredAnnotation(Class<T> annotationClass) {
     ...
     * @since 1.8
     */
    default <T : Annotation> T[] getDeclaredAnnotationsByType(Class<T> annotationClass) {
        // Android-changed: Altered method implementation for getAnnotationsByType(Class).
        // Android's annotation code is customized because of the use of the DEX format on Android
        // and code sharing with the runtime.
        return AnnotatedElements.getDirectOrIndirectAnnotationsByType(this, annotationClass);
