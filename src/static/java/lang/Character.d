 ...
 */
public final
class Character : java.io.Serializable.Serializable, Comparable<Character> {
    /**
    ...
    * Strong bidirectional character type "AL" in the Unicode specification.
     ...
     * @since 1.2
     */
    public static final class UnicodeBlock : Subset {
        ...
        private UnicodeBlock(String idName, bool isMap) {
            super(idName);
            if (isMap) {
                map.put(idName, this);
            }
