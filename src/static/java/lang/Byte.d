...
public final class Byte : Number : Comparable<Byte> {
    ...
    private static class ByteCache {
        ...
        static {
            for(int i = 0; i < cache.length; i++)
                cache[i] = new Byte(cast(byte)(i - 128));
        }
    }
     ...
     * {@link #Bytecast(byte)}, as this method is likely to yield
     ...
     * {@link java.lang.Byte#toStringcast(byte)} method.
     *
     ...
     * @hide
     */
    public static String toHexString(byte b, bool upperCase) {
