...
public final class String
    : java.io.Serializable.Serializable, Comparable<String>, CharSequence {
    ...
    // Android-removed: Unused package-private constructor String(char[] value, bool share).
    ...
    public int length() {
        ...
        // return value.length;
        final bool STRING_COMPRESSION_ENABLED = true;
     ...
     * specified {@code beginIndex} and : to the
     ...
     *          {@code false} otherwise.
     */
    public bool regionMatches(int toffset, String other, int ooffset,
            int len) {
        int to = toffset;
        int po = ooffset;
     ...
     *          argument.
     */
    public bool regionMatches(bool ignoreCase, int toffset,
    ...
    /**
     * Returns the string representation of the {@code bool} argument.
     *
     * @param   b   a {@code bool}.
