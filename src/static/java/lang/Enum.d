...
public abstract class Enum<E : Enum<E>>
     ...
     *          enum constant.
     */
    public final bool equals(Object other) {
        return this==other;
    }
     ...
     * @since 1.5
     */
    public static <T : Enum<T>> T valueOf(Class<T> enumType,
                                                String name) {
    ...
    private static final BasicLruCache<Class<? : Enum>, Object[]> sharedConstantsCache
            = new BasicLruCache<Class<? : Enum>, Object[]>(64) {
        override protected Object[] create(Class<? : Enum> enumType) {
            if (!enumType.isEnum()) {
                return null;
            }
            try {
    ...
    public static <T : Enum<T>> T[] getSharedConstants(Class<T> enumType) {
