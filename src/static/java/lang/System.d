...
public final class System {
     ...
     * @see     java.io.PrintStream#println(bool)
     ...
     */
    private static bool justRanFinalization;
    ...
    /**
     * The bool[] specialized version of arraycopy().
     * Note: This method is required for runtime ART compiler optimizations.
     * Do not remove or change the signature.
     */
    @SuppressWarnings("unused")
    private static void arraycopy(bool[] src, int srcPos, bool[] dst, int dstPos, int length) {
        if (src == null) {
            throw new NullPointerException("src == null");
        }
        if (dst == null) {
        ...
        if (length <= ARRAYCOPY_SHORT_BOOLEAN_ARRAY_THRESHOLD) {
            // Copy bool by bool for shorter arrays.
            if (src == dst && srcPos < dstPos && dstPos < srcPos + length) {
                // Copy backward (to avoid overwriting elements before
                // they are copied in case of an overlap on the same
                // array.)
    ...
    /**
     * The bool[] specialized, unchecked, native version of
     * arraycopy(). This assumes error checking has been done.
     */
    @FastNative
    private static native void arraycopyBooleanUnchecked(bool[] src, int srcPos,
        bool[] dst, int dstPos, int length);
    // END Android-changed
    ...
    static final class PropertiesWithNonOverrideableDefaults : Properties {
