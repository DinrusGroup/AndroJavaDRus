...
class ThreadGroup : Thread.UncaughtExceptionHandler {
     ...
     * @since      JDK1.0
     */
    public final void setDaemon(bool daemon) {
        checkAccess();
        this.daemon = daemon;
    }
     ...
     * @since   JDK1.0
     */
    public final bool parentOf(ThreadGroup g) {
     ...
     *
     * <blockquote>
     * {@linkplain #enumerate(ThreadGroup[], bool) enumerate}{@code (list, true)}
     * </blockquote>
     *
     * @param  list
