 ...
 * : the <code>Runnable</code> interface. That class then
 * : the <code>run</code> method. An instance of the class can
...
class Thread : Runnable {
   ...
   /**
    ...
    Thread(ThreadGroup group, String name, int priority, bool daemon) {
        this.group = group;
    ...
    private native static void nativeCreate(Thread t, long stackSize, bool daemon);
     ...
     */
    @FastNative
    public static native bool interrupted();
     ...
     */
    @FastNative
    public native bool isInterrupted();
     ...
     */
    public final void setDaemon(bool on) {
        checkAccess();
        if (isAlive()) {
            throw new IllegalThreadStateException();
        }
    ...
    private native bool nativeHoldsLock(Object object);
     ...
     */
    private static bool isCCLOverridden(Class!(T) cl) {
        if (cl == Thread.class)
            return false;
        ...
        Boolean result = AccessController.doPrivileged(
            new PrivilegedAction<Boolean>() {
                public Boolean run() {
                    ...
                    {
                        try {
                            cl.getDeclaredMethod("getContextClassLoader", new Class!(T)[0]);
                            return Boolean.TRUE;
                        } catch (NoSuchMethodException ex) {
                        }
                        try {
                            Class!(T)[] params = {ClassLoader.class};
    ...
    private native int nativeGetStatus(bool hasBeenStarted);
