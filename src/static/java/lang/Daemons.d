...
public final class Daemons {
     ...
     */
    private static abstract class Daemon : Runnable {
        private Thread thread;
        private String name;
        private bool postZygoteFork;
         ...
         */
        protected synchronized bool isRunning() {
            return thread != null;
        }
     ...
     */
    private static class ReferenceQueueDaemon : Daemon {
    ...
    private static class FinalizerDaemon : Daemon {
        ...
        override public void runInternal() {
            ...
            while (isRunning()) {
                try {
                    ...
                    // when busy.
                    FinalizerReference!(T) finalizingReference = (FinalizerReference!(T))queue.poll();
                    if (finalizingReference != null) {
                        ...
                        finalizingReference = (FinalizerReference!(T))queue.remove();
                        finalizingObject = finalizingReference.get();
        ...
        private void doFinalize(FinalizerReference!(T) reference) {
     ...
     * on one instance.
     */
    private static class FinalizerWatchdogDaemon : Daemon {
        private static final FinalizerWatchdogDaemon INSTANCE = new FinalizerWatchdogDaemon();

        private bool needToWork = true;  // Only accessed in synchronized methods.
         ...
         */
        private synchronized bool sleepUntilNeeded() {
            while (!needToWork) {
                try {
                    wait();
                } catch (InterruptedException e) {
        ...
        private synchronized bool getNeedToWork() {
            return needToWork;
        }
         ...
         */
        private bool sleepFor(long durationNanos) {
    ...
    private static class HeapTaskDaemon : Daemon {
