...
public final class Short : Number : Comparable<Short> {
    ...
    private static class ShortCache {
        ...
        static {
            for(int i = 0; i < cache.length; i++)
                cache[i] = new Short(cast(short)(i - 128));
        }
    }
     ...
     * {@link #Shortcast(short)}, as this method is likely to yield
     ...
     * {@link java.lang.Short#toStringcast(short)} method.
     *
