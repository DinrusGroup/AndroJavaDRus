 ...
 */
public class BigDecimal : Number : Comparable<BigDecimal>, Serializable {
    ...
    public BigDecimal multiply(BigDecimal multiplicand) {
        ...
        if (this.bitLength + multiplicand.bitLength < 64) {
            ...
            bool longMultiplicationOverflowed = (unscaledValue == Long.MIN_VALUE) &&
    ...
    public short shortValueExact() {
        return cast(short) valueExact(16);
    }
    ...
    /**
     * This method : an efficient rounding for numbers which unscaled
