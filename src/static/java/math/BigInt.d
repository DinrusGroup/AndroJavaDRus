...
final class BigInt {
    ...
    void putULongInt(long val, bool neg) {
        this.makeValid();
    ...
    void putBigEndian(byte[] a, bool neg) {
        this.makeValid();
        NativeBN.BN_bin2bn(a, a.length, neg, this.bignum);
    }

    void putLittleEndianInts(int[] a, bool neg) {
        this.makeValid();
    ...
    bool twosCompFitsIntoBytes(int desiredByteCount) {
