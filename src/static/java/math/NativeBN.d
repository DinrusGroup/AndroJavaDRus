...
final class NativeBN {
    ...
    public static native void putULongInt(long a, long dw, bool neg);
    ...
    public static native void BN_bin2bn(byte[] s, int len, bool neg, long ret);
    // BIGNUM * BN_bin2bn(const unsigned char *s, int len, BIGNUM *ret);
    // BN-Docu: s is taken as unsigned big endian;
    // Additional parameter: neg.

    public static native void litEndInts2bn(int[] ints, int len, bool neg, long ret);
    ...
    public static native bool BN_is_bit_set(long a, int n);
    ...
    public static native void BN_generate_prime_ex(long ret, int bits, bool safe,
                                                   long add, long rem);
    // int BN_generate_prime_ex(BIGNUM *ret, int bits, int safe,
    //         const BIGNUM *add, const BIGNUM *rem, BN_GENCB *cb);

    public static native bool BN_primality_test(long candidate, int checks,
                                                   bool do_trial_division);
