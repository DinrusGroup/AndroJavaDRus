 ...
 * java.io.FileOutputStream#FileOutputStream(java.io.File,bool)
 * FileOutputStream(File,bool)} constructor and passing <tt>true</tt> for
    ...
    : SeekableByteChannel, GatheringByteChannel, ScatteringByteChannel
{
     ...
     *
     * <pre>
     *     fc.{@link #lock(long,long,bool) lock}(0L, Long.MAX_VALUE, false) </pre>
     *
     * @return  A lock object representing the newly-acquired lock
     *
     * @throws  ClosedChannelException
     ...
     *
     * <pre>
     *     fc.{@link #tryLock(long,long,bool) tryLock}(0L, Long.MAX_VALUE, false) </pre>
     *
     * @return  A lock object representing the newly-acquired lock,
     *          or <tt>null</tt> if the lock could not be acquired
     *          because another program holds an overlapping lock
