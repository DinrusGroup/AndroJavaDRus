    ...
    : AsynchronousChannel
{
    ...
    private static final FileAttribute!(T)[] NO_ATTRIBUTES = new FileAttribute[0];
     ...
     *          If some other I/O error occurs
     */
    public abstract void force(bool metaData) throws IOException;
     ...
     * <pre>
     *     ch.{@link #lock(long,long,bool,Object,CompletionHandler) lock}(0L, Long.MAX_VALUE, false, att, handler)
     * </pre>
     *
     * @param   <A>
     *          The type of the attachment
     ...
     * manner as the {@link #lock(long, long, bool, Object, CompletionHandler)}
     ...
     * invocation
     * <pre>
     *     ch.{@link #lock(long,long,bool) lock}(0L, Long.MAX_VALUE, false)
     * </pre>
     *
     * @return  a {@code Future} object representing the pending result
     *
     ...
     * @see     #lock(long,long,bool,Object,CompletionHandler)
     * @see     #tryLock()
     */
     ...
     *
     * <pre>
     *     ch.{@link #tryLock(long,long,bool) tryLock}(0L, Long.MAX_VALUE, false) </pre>
     *
     * @return  A lock object representing the newly-acquired lock,
     *          or {@code null} if the lock could not be acquired
     *          because another program holds an overlapping lock
