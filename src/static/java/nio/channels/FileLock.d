 ...
 * one of the {@link FileChannel#lock(long,long,bool) lock} or {@link
 * FileChannel#tryLock(long,long,bool) tryLock} methods of the
 * {@link FileChannel} class, or the {@link
 * AsynchronousFileChannel#lock(long,long,bool,Object,CompletionHandler) lock}
 * or {@link AsynchronousFileChannel#tryLock(long,long,bool) tryLock}
...
public abstract class FileLock : AutoCloseable {
    ...
    protected FileLock(FileChannel channel,
                       long position, long size, bool shared)
    {
        if (position < 0)
     ...
     */
    public final bool overlaps(long position, long size) {
