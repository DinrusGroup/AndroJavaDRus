 ...
 * : the abstract methods defined by this class. A provider is
...
public abstract class FileSystemProvider {
    ...
    public abstract SeekableByteChannel newByteChannel(Path path,
        Set<? : OpenOption> options, FileAttribute!(T)... attrs) throws IOException;
     ...
     */
    public abstract void createDirectory(Path dir, FileAttribute!(T)... attrs)
        throws IOException;
     ...
     */
    public void createSymbolicLink(Path link, Path target, FileAttribute!(T)... attrs)
        throws IOException
    {
        throw new UnsupportedOperationException();
    }
     ...
     *          is invoked to check delete access to the file
     */
    public bool deleteIfExists(Path path) throws IOException {
        try {
            delete(path);
            return true;
     ...
     *          method is invoked to check read access to the file.
     */
    public abstract bool isHidden(Path path) throws IOException;
     ...
     */
    public abstract <V : FileAttributeView> V
     ...
     *          method is invoked to check read access to the file
     */
    public abstract <A : BasicFileAttributes> A
