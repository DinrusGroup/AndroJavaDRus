...
public final class Files {
        ...
        : DirectoryStream.Filter<Path>
    {
        ...
        override
        public bool accept(Path entry) { return true; }
     ...
     * <pre>
     *     DirectoryStream.Filter&lt;Path&gt; filter = new DirectoryStream.Filter&lt;Path&gt;() {
     *         public bool accept(Path file) throws IOException {
     ...
     */
    public static Path createFile(Path path, FileAttribute!(T)... attrs)
        throws IOException
    {
     ...
     */
    public static Path createDirectory(Path dir, FileAttribute!(T)... attrs)
        throws IOException
    {
     ...
     */
    public static Path createDirectories(Path dir, FileAttribute!(T)... attrs)
        throws IOException
    {
     ...
     *          is invoked to check delete access to the file.
     */
    public static bool deleteIfExists(Path path) throws IOException {
     ...
     */
    public static bool isSameFile(Path path, Path path2) throws IOException {
     ...
     *          method is invoked to check read access to the file.
     */
    public static bool isHidden(Path path) throws IOException {
     ...
     */
    public static <V : FileAttributeView> V getFileAttributeView(Path path,
                                                                       Class<V> type,
                                                                       LinkOption... options)
    {
     ...
     */
    public static <A : BasicFileAttributes> A readAttributes(Path path,
                                                                   Class<A> type,
                                                                   LinkOption... options)
        throws IOException
    {
     ...
     *          method denies read access to the file.
     */
    public static bool isDirectory(Path path, LinkOption... options) {
        try {
     ...
     *          method denies read access to the file.
     */
    public static bool isRegularFile(Path path, LinkOption... options) {
        try {
     ...
     */
    private static bool followLinks(LinkOption... options) {
     ...
     * @see #notExists
     */
    public static bool exists(Path path, LinkOption... options) {
        try {
     ...
     *          read access to the file.
     */
    public static bool notExists(Path path, LinkOption... options) {
        try {
            if (followLinks(options)) {
                provider(path).checkAccess(path);
            } else {
     ...
     */
    private static bool isAccessible(Path path, AccessMode... modes) {
        try {
     ...
     *          method is invoked to check write access to the file.
     */
    public static Path write(Path path, Iterable<? : CharSequence> lines,
