...
public class DirectByteBuffer : MappedByteBuffer : DirectBuffer {
    ...
    private ByteBuffer putChar(long a, char x) {
        Memory.pokeShort(a, cast(short) x, !nativeByteOrder);
        return this;
    }
    ...
    override
    public final bool isAccessible() {
        return memoryRef.isAccessible;
    }

    override
    public final void setAccessible(bool value) {
