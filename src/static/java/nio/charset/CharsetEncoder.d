 ...
 * (but not always) has the initial value&nbsp;<tt>{</tt>&nbsp;<tt>cast(byte)'?'</tt>&nbsp;<tt>}</tt>;
...
public abstract class CharsetEncoder {
     ...
     * byte array <tt>{</tt>&nbsp;<tt>cast(byte)'?'</tt>&nbsp;<tt>}</tt>.
     *
     * @param  cs
     *         The charset that created this encoder
     *
     ...
     *          #encode(CharBuffer,ByteBuffer,bool) encode} method
     ...
     *
     * <p> This method : an entire <a href="#steps">encoding
     ...
     *          If an encoding operation is already in progress
     */
    public bool canEncode(CharSequence cs) {
        CharBuffer cb;
