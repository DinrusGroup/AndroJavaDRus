    ...
    : Comparable<Charset>
{
    ...
    static bool atBugLevel(String bl) {              // package-private
    ...
    private static ThreadLocal<ThreadLocal!(T)> gate =
            new ThreadLocal<ThreadLocal!(T)>();
    ...
    // private static bool extendedProviderProbed = false;
     ...
     */
    public final bool isRegistered() {
     ...
     *          given object
     */
    public final bool equals(Object ob) {
