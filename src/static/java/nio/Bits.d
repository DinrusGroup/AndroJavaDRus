...
class Bits {                            // package-private
    ...
    static char getChar(ByteBuffer bb, int bi, bool bigEndian) {
        return bigEndian ? getCharB(bb, bi) : getCharL(bb, bi);
    }

    static char getChar(long a, bool bigEndian) {
        return bigEndian ? getCharB(a) : getCharL(a);
    }

    private static byte char1(char x) { return cast(byte)(x >> 8); }
    private static byte char0(char x) { return cast(byte)(x     ); }
    ...
    static void putChar(ByteBuffer bb, int bi, char x, bool bigEndian) {
        if (bigEndian)
            putCharB(bb, bi, x);
        else
            putCharL(bb, bi, x);
    ...
    static void putChar(long a, char x, bool bigEndian) {
        if (bigEndian)
            putCharB(a, x);
        else
            putCharL(a, x);
    ...
    static short getShort(long a, bool bigEndian) {
    ...
    static void putShort(long a, short x, bool bigEndian) {
        if (bigEndian)
            putShortB(a, x);
        else
            putShortL(a, x);
    ...
    static int getInt(long a, bool bigEndian) {
    ...
    static void putInt(long a, int x, bool bigEndian) {
        if (bigEndian)
            putIntB(a, x);
        else
            putIntL(a, x);
    ...
    static long getLong(ByteBuffer bb, int bi, bool bigEndian) {
        return bigEndian ? getLongB(bb, bi) : getLongL(bb, bi);
    }

    static long getLong(long a, bool bigEndian) {
    ...
    static void putLong(ByteBuffer bb, int bi, long x, bool bigEndian) {
        if (bigEndian)
            putLongB(bb, bi, x);
        else
            putLongL(bb, bi, x);
    ...
    static void putLong(long a, long x, bool bigEndian) {
        if (bigEndian)
            putLongB(a, x);
        else
            putLongL(a, x);
    ...
    static float getFloat(long a, bool bigEndian) {
    ...
    static void putFloat(long a, float x, bool bigEndian) {
        if (bigEndian)
            putFloatB(a, x);
        else
            putFloatL(a, x);
    ...
    static double getDouble(long a, bool bigEndian) {
    ...
    static void putDouble(ByteBuffer bb, int bi, double x, bool bigEndian) {
        if (bigEndian)
            putDoubleB(bb, bi, x);
        else
            putDoubleL(bb, bi, x);
    ...
    static void putDouble(long a, double x, bool bigEndian) {
        if (bigEndian)
            putDoubleB(a, x);
        else
            putDoubleL(a, x);
