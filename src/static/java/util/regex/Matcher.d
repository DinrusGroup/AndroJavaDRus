 ...
 * </ul>
 *
 * <p> Each of these methods returns a bool indicating success or failure.
...
public final class Matcher : MatchResult {
    /**
     ...
     * @see java.util.regex.Matcher#useTransparentBounds(bool)
     * @since 1.5
     */
     ...
     * matcher to use <i>transparent</i> bounds. If the bool
     ...
     *
     * @param  value a bool indicating whether to use opaque or transparent
     *         regions
     * @return this matcher
     ...
     *         <tt>false</tt> otherwise.
     * @see java.util.regex.Matcher#useAnchoringBounds(bool)
     * @since 1.5
     */
     ...
     *
     * <p> Invoking this method with an argument of <tt>true</tt> will set this
     * matcher to use <i>anchoring</i> bounds. If the bool
     ...
     * <p> By default, a matcher uses anchoring region boundaries.
     *
     * @param  value a bool indicating whether or not to use anchoring bounds.
     * @return this matcher
    ...
    private static native bool findImpl(long addr, int startIndex, int[] offsets);
    private static native bool findNextImpl(long addr, int[] offsets);
    private static native long getNativeFinalizer();
    private static native int groupCountImpl(long addr);
    private static native bool hitEndImpl(long addr);
    private static native bool lookingAtImpl(long addr, int[] offsets);
    private static native bool matchesImpl(long addr, int[] offsets);
    private static native int nativeSize();
    private static native long openImpl(long patternAddr);
    private static native bool requireEndImpl(long addr);
    private static native void setInputImpl(long addr, String s, int start, int end);
    private static native void useAnchoringBoundsImpl(long addr, bool value);
    private static native void useTransparentBoundsImpl(long addr, bool value);
     ...
     */
    static final class OffsetBasedMatchResult : MatchResult {
