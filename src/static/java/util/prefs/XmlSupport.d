...
class XmlSupport {
     ...
     */
    static void export(OutputStream os, final Preferences p, bool subTree)
    ...
    private static void putPreferencesInXml(Element elt, Document doc,
               Preferences prefs, bool subTree) throws BackingStoreException
    {
    ...
    private static class Resolver : EntityResolver {
    ...
    private static class EH : ErrorHandler {
