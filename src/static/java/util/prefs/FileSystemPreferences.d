...
public class FileSystemPreferences : AbstractPreferences {
    /**
     ...
     */
    private static bool isSystemRootWritable;
     ...
     */
    private static bool isUserRootWritable;
   ...
   /**
     ...
     */
    private static bool isUserRootModified = false;
     ...
     */
    private static bool isSystemRootModified = false;
    ...
    */
     ...
     */
    private class NodeCreate : Change {
        /**
    ...
    public FileSystemPreferences(String path, File lockFile, bool isUserNode) {
        super(null, "");
     ...
     */
    private static bool isDirChar(char ch) {
    ...
    private static byte[] byteArray(String s) {
        ...
        for (int i=0, j=0; i<len; i++) {
            char c = s.charAt(i);
            result[j++] = cast(byte) (c>>8);
            result[j++] = cast(byte) c;
        }
        return result;
    }
 ...
 * (Inverts the transformation of dirName(String).
     ...
     */
    private bool lockFile(bool shared) throws SecurityException{
        bool usernode = isUserNode();
        int[] result;
        int errorCode = 0;
...
//                // If at first, you don't succeed...
    ...
    private static native int[]
            lockFile0(String fileName, int permission, bool shared);
