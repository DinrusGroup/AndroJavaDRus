...
public abstract class Preferences {
     ...
     */
    public static Preferences userNodeForPackage(Class!(T) c) {
     ...
     * @see    RuntimePermission
     */
    public static Preferences systemNodeForPackage(Class!(T) c) {
     ...
     */
    private static String nodeName(Class!(T) c) {
        if (c.isArray())
    ...
    /**
     * Associates a string representing the specified bool value with the
     ...
     * @throws IllegalStateException if this node (or an ancestor) has been
     *         removed with the {@link #removeNode()} method.
     * @see #getBoolean(String,bool)
     * @see #get(String,String)
     */
    public abstract void putBoolean(String key, bool value);

    /**
     * Returns the bool value represented by the string associated with the
