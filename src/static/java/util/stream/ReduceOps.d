...
final class ReduceOps {
    ...
    /**
     * Constructs a {@code TerminalOp} that : a functional reduce on
     * reference values.
     *
    ...
    makeRef(U seed, BiFunction<U, ? super T, U> reducer, BinaryOperator<U> combiner) {
        ...
        class ReducingSink : Box<U> : AccumulatingSink<T, U, ReducingSink> {
            override
    ...
    /**
     * Constructs a {@code TerminalOp} that : a mutable reduce on
     * reference values.
     *
     * @param <T> the type of the input elements
    ...
    makeInt(IntBinaryOperator operator) {
        Objects.requireNonNull(operator);
        class ReducingSink
                : AccumulatingSink<Integer, OptionalInt, ReducingSink>, Sink.OfInt {
            private bool empty;
            private int state;
    ...
    makeLong(LongBinaryOperator operator) {
        Objects.requireNonNull(operator);
        class ReducingSink
                : AccumulatingSink<Long, OptionalLong, ReducingSink>, Sink.OfLong {
            private bool empty;
            private long state;
    ...
    makeDouble(DoubleBinaryOperator operator) {
        Objects.requireNonNull(operator);
        class ReducingSink
                : AccumulatingSink<Double, OptionalDouble, ReducingSink>, Sink.OfDouble {
            private bool empty;
            private double state;
    ...
    /**
     * A type of {@code TerminalSink} that : an associative reducing
     ...
     */
    private interface AccumulatingSink<T, R, K : AccumulatingSink<T, R, K>>
            : TerminalSink<T, R> {
     ...
     */
    private static abstract class ReduceOp<T, R, S : AccumulatingSink<T, R, S>>
            : TerminalOp<T, R> {
