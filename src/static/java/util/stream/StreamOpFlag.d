...
public enum StreamOpFlag {
     ...
     */
    public bool isCleared(int flags) {
     ...
     * @return true if this flag is preserved, otherwise false.
     */
    public bool isPreserved(int flags) {
     ...
     * @return the stream flags.
     */
    public static int fromCharacteristics(Spliterator!(T) spliterator) {
