...
public abstract class LongPipeline<E_IN>
        : AbstractPipeline<E_IN, Long, LongStream>
        : LongStream {
     ...
     */
    LongPipeline(Supplier<? : Spliterator<Long>> source,
    ...
    public final Spliterator.OfLong lazySpliterator(Supplier<? : Spliterator<Long>> supplier) {
    ...
    override
    public final LongStream flatMap(LongFunction<? : LongStream> mapper) {
        return new StatelessOp<Long>(this, StreamShape.LONG_VALUE,
    ...
    override
    public final bool anyMatch(LongPredicate predicate) {
        return evaluate(MatchOps.makeLong(predicate, MatchOps.MatchKind.ANY));
    }

    override
    public final bool allMatch(LongPredicate predicate) {
        return evaluate(MatchOps.makeLong(predicate, MatchOps.MatchKind.ALL));
    }

    override
    public final bool noneMatch(LongPredicate predicate) {
     ...
     */
    public static class Head<E_IN> : LongPipeline<E_IN> {
        /**
         ...
         * @param parallel {@code true} if the pipeline is parallel
         */
        public Head(Supplier<? : Spliterator<Long>> source,
             int sourceFlags, bool parallel) {
            super(source, sourceFlags, parallel);
        }
     ...
     * @hide Visible for CTS testing only (OpenJDK8 tests).
     */
    public abstract static class StatelessOp<E_IN> : LongPipeline<E_IN> {
        /**
     ...
     * @hide Visible for CTS testing only (OpenJDK8 tests).
     */
    public abstract static class StatefulOp<E_IN> : LongPipeline<E_IN> {
        /**
