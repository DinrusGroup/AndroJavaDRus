...
public abstract class ReferencePipeline<P_IN, P_OUT>
        : AbstractPipeline<P_IN, P_OUT, Stream<P_OUT>>
        : Stream<P_OUT>  {
     ...
     */
    ReferencePipeline(Supplier<? : Spliterator!(T)> source,
                      int sourceFlags, bool parallel) {
     ...
     * @param parallel {@code true} if the pipeline is parallel
     */
    ReferencePipeline(Spliterator!(T) source,
                      int sourceFlags, bool parallel) {
        super(source, sourceFlags, parallel);
    }
    ...
    override
    public final Spliterator<P_OUT> lazySpliterator(Supplier<? : Spliterator<P_OUT>> supplier) {
    ...
    public final <R> Stream<R> map(Function<? super P_OUT, ? : R> mapper) {
    ...
    override
    public final <R> Stream<R> flatMap(Function<? super P_OUT, ? : Stream<? : R>> mapper) {
        Objects.requireNonNull(mapper);
        ...
        return new StatelessOp<P_OUT, R>(this, StreamShape.REFERENCE,
            ...
            public Sink<P_OUT> opWrapSink(int flags, Sink<R> sink) {
                return new Sink.ChainedReference<P_OUT, R>(sink) {
                    ...
                    override
                    public void accept(P_OUT u) {
                        try (Stream<? : R> result = mapper.apply(u)) {
    ...
    override
    public final IntStream flatMapToInt(Function<? super P_OUT, ? : IntStream> mapper) {
        Objects.requireNonNull(mapper);
        // We can do better than this, by polling cancellationRequested when stream is infinite
        return new IntPipeline.StatelessOp<P_OUT>(this, StreamShape.REFERENCE,
                                              StreamOpFlag.NOT_SORTED | StreamOpFlag.NOT_DISTINCT | StreamOpFlag.NOT_SIZED) {
    ...
    override
    public final DoubleStream flatMapToDouble(Function<? super P_OUT, ? : DoubleStream> mapper) {
        Objects.requireNonNull(mapper);
        // We can do better than this, by polling cancellationRequested when stream is infinite
        return new DoublePipeline.StatelessOp<P_OUT>(this, StreamShape.REFERENCE,
                                                     StreamOpFlag.NOT_SORTED | StreamOpFlag.NOT_DISTINCT | StreamOpFlag.NOT_SIZED) {
    ...
    override
    public final LongStream flatMapToLong(Function<? super P_OUT, ? : LongStream> mapper) {
        Objects.requireNonNull(mapper);
        // We can do better than this, by polling cancellationRequested when stream is infinite
        return new LongPipeline.StatelessOp<P_OUT>(this, StreamShape.REFERENCE,
                                                   StreamOpFlag.NOT_SORTED | StreamOpFlag.NOT_DISTINCT | StreamOpFlag.NOT_SIZED) {
    ...
    override
    public final bool anyMatch(Predicate<? super P_OUT> predicate) {
        return evaluate(MatchOps.makeRef(predicate, MatchOps.MatchKind.ANY));
    }

    override
    public final bool allMatch(Predicate<? super P_OUT> predicate) {
        return evaluate(MatchOps.makeRef(predicate, MatchOps.MatchKind.ALL));
    }

    override
    public final bool noneMatch(Predicate<? super P_OUT> predicate) {
     ...
     * @hide Visible for CTS testing only (OpenJDK8 tests).
     */
    public static class Head<E_IN, E_OUT> : ReferencePipeline<E_IN, E_OUT> {
        /**
         ...
         */
        public Head(Supplier<? : Spliterator!(T)> source,
             int sourceFlags, bool parallel) {
            super(source, sourceFlags, parallel);
        }
         ...
         *                    in {@link StreamOpFlag}
         */
        public Head(Spliterator!(T) source,
             int sourceFlags, bool parallel) {
            super(source, sourceFlags, parallel);
        }

        override
        public final bool opIsStateful() {
