...
public enum IntStreamTestScenario : OpTestCase.BaseStreamTestScenario {

    STREAM_FOR_EACH_WITH_CLOSE(false) {
        <T, S_IN : BaseStream<T, S_IN>>
    ...
    private final bool isOrdered;

    IntStreamTestScenario(bool isParallel) {
        this(isParallel, true);
    }

    IntStreamTestScenario(bool isParallel, bool isOrdered) {
