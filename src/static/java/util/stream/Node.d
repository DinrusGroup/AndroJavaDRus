...
public interface Node<T> {
    ...
    /**
     * A mutable builder for a {@code Node} that : {@link Sink}, which
     * builds a flat node containing the elements that have been pushed to it.
     */
    interface Builder<T> : Sink<T> {
         ...
         */
        interface OfInt : Node.Builder<Integer>, Sink.OfInt {
            override
            Node.OfInt build();
        }
         ...
         */
        interface OfLong : Node.Builder<Long>, Sink.OfLong {
            override
            Node.OfLong build();
        }
         ...
         */
        interface OfDouble : Node.Builder<Double>, Sink.OfDouble {
            override
            Node.OfDouble build();
        }
    }
    ...
    public interface OfPrimitive<T, T_CONS, T_ARR,
                                 ...
                                 T_NODE : OfPrimitive<T, T_CONS, T_ARR, T_SPLITR, T_NODE>>
            : Node<T> {
     ...
     */
    interface OfInt : OfPrimitive<Integer, IntConsumer, int[], Spliterator.OfInt, OfInt> {
     ...
     */
    interface OfLong : OfPrimitive<Long, LongConsumer, long[], Spliterator.OfLong, OfLong> {
     ...
     */
    interface OfDouble : OfPrimitive<Double, DoubleConsumer, double[], Spliterator.OfDouble, OfDouble> {
