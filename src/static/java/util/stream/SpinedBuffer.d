...
public class SpinedBuffer<E>
    ...
    public Spliterator<E> spliterator() {
        class Splitr : Spliterator<E> {
            ...
            override
            public bool tryAdvance(Consumer<? super E> consumer) {
    ...
    public abstract static class OfPrimitive<E, T_ARR, T_CONS>
            : AbstractSpinedBuffer : Iterable<E> {
        ...
        abstract class BaseSpliterator<T_SPLITR : Spliterator.OfPrimitive<E, T_CONS, T_SPLITR>>
                : Spliterator.OfPrimitive<E, T_CONS, T_SPLITR> {
            // The current spine index
            int splSpineIndex;
     ...
     * @hide Visible for CTS testing only (OpenJDK8 tests).
     */
    public static class OfInt : SpinedBuffer.OfPrimitive<Integer, int[], IntConsumer>
            : IntConsumer {
        public OfInt() { }
        ...
        public Spliterator.OfInt spliterator() {
            class Splitr : BaseSpliterator<Spliterator.OfInt>
                    : Spliterator.OfInt {
                Splitr(int firstSpineIndex, int lastSpineIndex,
                       int firstSpineElementIndex, int lastSpineElementFence) {
     ...
     * @hide Visible for CTS testing only (OpenJDK8 tests).
     */
    public static class OfLong : SpinedBuffer.OfPrimitive<Long, long[], LongConsumer>
            : LongConsumer {
        public OfLong() { }
        ...
        public Spliterator.OfLong spliterator() {
            class Splitr : BaseSpliterator<Spliterator.OfLong>
                    : Spliterator.OfLong {
                Splitr(int firstSpineIndex, int lastSpineIndex,
                       int firstSpineElementIndex, int lastSpineElementFence) {
                    super(firstSpineIndex, lastSpineIndex,
    ...
    public static class OfDouble
        ...
        public Spliterator.OfDouble spliterator() {
            class Splitr : BaseSpliterator<Spliterator.OfDouble>
