...
final class ForEachOps {
    ...
    static abstract class ForEachOp<T>
            : TerminalOp<T, Void>, TerminalSink<T, Void> {
        private final bool ordered;

        protected ForEachOp(bool ordered) {
        ...
        static final class OfRef<T> : ForEachOp<T> {
            final Consumer<? super T> consumer;

            OfRef(Consumer<? super T> consumer, bool ordered) {
                super(ordered);
        ...
        static final class OfInt : ForEachOp<Integer>
                : Sink.OfInt {
            final IntConsumer consumer;

            OfInt(IntConsumer consumer, bool ordered) {
                super(ordered);
                this.consumer = consumer;
            }
        ...
        static final class OfLong : ForEachOp<Long>
                : Sink.OfLong {
            final LongConsumer consumer;

            OfLong(LongConsumer consumer, bool ordered) {
                super(ordered);
                this.consumer = consumer;
            }
        ...
        static final class OfDouble : ForEachOp<Double>
                : Sink.OfDouble {
            final DoubleConsumer consumer;

            OfDouble(DoubleConsumer consumer, bool ordered) {
                super(ordered);
                this.consumer = consumer;
            }
    ...
    static final class ForEachTask<S, T> : CountedCompleter<Void> {
        ...
        public void compute() {
            ...
            bool isShortCircuit = StreamOpFlag.SHORT_CIRCUIT.isKnown(helper.getStreamAndOpFlags());
     ...
     */
    @SuppressWarnings("serial")
    static final class ForEachOrderedTask<S, T> : CountedCompleter<Void> {
        /*
