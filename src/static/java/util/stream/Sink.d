 ...
 */
public interface Sink<T> : Consumer<T> {
    /**
     ...
     */
    default bool cancellationRequested() {
        return false;
    }
    ...
    /**
     * {@code Sink} that : {@code Sink<Integer>}, re-abstracts
     * {@code accept(int)}, and wires {@code accept(Integer)} to bridge to
     * {@code accept(int)}.
     */
    interface OfInt : Sink<Integer>, IntConsumer {
        override
    ...
    /**
     * {@code Sink} that : {@code Sink<Long>}, re-abstracts
     * {@code accept(long)}, and wires {@code accept(Long)} to bridge to
     * {@code accept(long)}.
     */
    interface OfLong : Sink<Long>, LongConsumer {
        override
    ...
    /**
     * {@code Sink} that : {@code Sink<Double>}, re-abstracts
     * {@code accept(double)}, and wires {@code accept(Double)} to bridge to
     * {@code accept(double)}.
     */
    interface OfDouble : Sink<Double>, DoubleConsumer {
        override
     ...
     */
    static abstract class ChainedReference<T, E_OUT> : Sink<T> {
     ...
     * {@code accept()} method on the downstream {@code Sink}.
     */
    static abstract class ChainedInt<E_OUT> : Sink.OfInt {
        protected final Sink<? super E_OUT> downstream;
     ...
     * {@code accept()} method on the downstream {@code Sink}.
     */
    static abstract class ChainedLong<E_OUT> : Sink.OfLong {
        protected final Sink<? super E_OUT> downstream;
     ...
     * {@code accept()} method on the downstream {@code Sink}.
     */
    static abstract class ChainedDouble<E_OUT> : Sink.OfDouble {
        protected final Sink<? super E_OUT> downstream;
