...
final class Streams {
     ...
     */
    static final class RangeIntSpliterator : Spliterator.OfInt {
        ...
        RangeIntSpliterator(int from, int upTo, bool closed) {
     ...
     * than Long.MAX_VALUE
     */
    static final class RangeLongSpliterator : Spliterator.OfLong {
        // Can never be greater that upTo, this avoids overflow if upper bound
        // is Long.MAX_VALUE
        // All elements are traversed if from == upTo & last == 0
        private long from;
        ...
        RangeLongSpliterator(long from, long upTo, bool closed) {
            this(from, upTo, closed ? 1 : 0);
        }
    ...
    private static abstract class AbstractStreamBuilderImpl<T, S : Spliterator<T>> : Spliterator<T> {
    ...
    static final class StreamBuilderImpl<T>
            : AbstractStreamBuilderImpl<T, Spliterator<T>>
            : Stream.Builder<T> {
    ...
    static final class IntStreamBuilderImpl
            : AbstractStreamBuilderImpl<Integer, Spliterator.OfInt>
    ...
    static final class LongStreamBuilderImpl
            : AbstractStreamBuilderImpl<Long, Spliterator.OfLong>
    ...
    static final class DoubleStreamBuilderImpl
            : AbstractStreamBuilderImpl<Double, Spliterator.OfDouble>
    ...
    abstract static class ConcatSpliterator<T, T_SPLITR : Spliterator<T>>
            : Spliterator<T> {
        ...
        static class OfRef<T> : ConcatSpliterator<T, Spliterator<T>> {
            OfRef(Spliterator<T> aSpliterator, Spliterator<T> bSpliterator) {
                super(aSpliterator, bSpliterator);
            }
        }

        private static abstract class OfPrimitive<T, T_CONS, T_SPLITR : Spliterator.OfPrimitive<T, T_CONS, T_SPLITR>>
                : ConcatSpliterator<T, T_SPLITR>
