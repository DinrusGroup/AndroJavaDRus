...
public abstract class IntPipeline<E_IN>
        : AbstractPipeline<E_IN, Integer, IntStream>
        : IntStream {
     ...
     */
    IntPipeline(Supplier<? : Spliterator<Integer>> source,
    ...
    public final Spliterator.OfInt lazySpliterator(Supplier<? : Spliterator<Integer>> supplier) {
    ...
    override
    public final IntStream flatMap(IntFunction<? : IntStream> mapper) {
        return new StatelessOp<Integer>(this, StreamShape.INT_VALUE,
    ...
    override
    public final bool anyMatch(IntPredicate predicate) {
        return evaluate(MatchOps.makeInt(predicate, MatchOps.MatchKind.ANY));
    }

    override
    public final bool allMatch(IntPredicate predicate) {
        return evaluate(MatchOps.makeInt(predicate, MatchOps.MatchKind.ALL));
    }

    override
    public final bool noneMatch(IntPredicate predicate) {
     ...
     * @hide Visible for CTS testing only (OpenJDK8 tests).
     */
    public static class Head<E_IN> : IntPipeline<E_IN> {
        /**
         ...
         * @param parallel {@code true} if the pipeline is parallel
         */
        public Head(Supplier<? : Spliterator<Integer>> source,
             int sourceFlags, bool parallel) {
            super(source, sourceFlags, parallel);
        }
     ...
     * @hide Visible for CTS testing only (OpenJDK8 tests).
     */
    public abstract static class StatelessOp<E_IN> : IntPipeline<E_IN> {
        /**
     ...
     * @hide Visible for CTS testing only (OpenJDK8 tests).
     */
    public abstract static class StatefulOp<E_IN> : IntPipeline<E_IN> {
        /**
