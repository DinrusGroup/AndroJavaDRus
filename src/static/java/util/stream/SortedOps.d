...
final class SortedOps {
     ...
     */
    private static final class OfRef<T> : ReferencePipeline.StatefulOp<T, T> {
        /**
         * Comparator used for sorting
         */
        private final bool isNaturalSort;
     ...
     */
    private static final class OfInt : IntPipeline.StatefulOp<Integer> {
     ...
     */
    private static final class OfLong : LongPipeline.StatefulOp<Long> {
     ...
     */
    private static final class OfDouble : DoublePipeline.StatefulOp<Double> {
     ...
     * parallel pipelines.
     */
    private static abstract class AbstractRefSortingSink<T> : Sink.ChainedReference<T, T> {
        protected final Comparator<? super T> comparator;
        // @@@ could be a lazy final value, if/when support is added
        protected bool cancellationWasRequested;
         ...
         */
        override
        public final bool cancellationRequested() {
     ...
     */
    private static final class SizedRefSortingSink<T> : AbstractRefSortingSink<T> {
        private T[] array;
        private int offset;
     ...
     */
    private static final class RefSortingSink<T> : AbstractRefSortingSink<T> {
     ...
     */
    private static abstract class AbstractIntSortingSink : Sink.ChainedInt<Integer> {
        protected bool cancellationWasRequested;
     ...
     */
    private static final class SizedIntSortingSink : AbstractIntSortingSink {
        private int[] array;
        private int offset;
     ...
     */
    private static final class IntSortingSink : AbstractIntSortingSink {
     ...
     */
    private static abstract class AbstractLongSortingSink : Sink.ChainedLong<Long> {
        protected bool cancellationWasRequested;
     ...
     */
    private static final class SizedLongSortingSink : AbstractLongSortingSink {
        private long[] array;
        private int offset;
     ...
     */
    private static final class LongSortingSink : AbstractLongSortingSink {
     ...
     * Abstract {@link Sink} for implementing sort on long streams.
     */
    private static abstract class AbstractDoubleSortingSink : Sink.ChainedDouble<Double> {
        protected bool cancellationWasRequested;
     ...
     */
    private static final class SizedDoubleSortingSink : AbstractDoubleSortingSink {
     ...
     */
    private static final class DoubleSortingSink : AbstractDoubleSortingSink {
