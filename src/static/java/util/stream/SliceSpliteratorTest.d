 ...
 */
@Test
public class SliceSpliteratorTest : LoggingTestCase {

    static class UnorderedContentAsserter<T> : SpliteratorTestHelper.ContentAsserter<T> {
        Collection<T> source;
        ...
        override
        public void assertContents(Collection<T> actual, Collection<T> expected, bool isOrdered) {
            if (isOrdered) {
