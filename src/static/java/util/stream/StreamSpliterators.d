...
class StreamSpliterators {
    ...
    static final class WrappingSpliterator<P_IN, P_OUT>
        ...
        override
        public bool tryAdvance(Consumer<? super P_OUT> consumer) {
     ...
     * @param <T>
     */
    static class DelegatingSpliterator<T, T_SPLITR : Spliterator<T>>
            : Spliterator<T> {
        private final Supplier<? : T_SPLITR> supplier;

        private T_SPLITR s;

        DelegatingSpliterator(Supplier<? : T_SPLITR> supplier) {
        ...
        static class OfPrimitive<T, T_CONS, T_SPLITR : Spliterator.OfPrimitive<T, T_CONS, T_SPLITR>>
            : DelegatingSpliterator<T, T_SPLITR>
            : Spliterator.OfPrimitive<T, T_CONS, T_SPLITR> {
            OfPrimitive(Supplier<? : T_SPLITR> supplier) {
                super(supplier);
            }

            override
            public bool tryAdvance(T_CONS consumer) {
                return get().tryAdvance(consumer);
            }
     ...
     *
     */
    static abstract class SliceSpliterator<T, T_SPLITR : Spliterator<T>> {
        ...
        static final class OfRef<T>
                : SliceSpliterator<T, Spliterator<T>>
                : Spliterator<T> {
        ...
        static abstract class OfPrimitive<T,
            ...
            override
            public bool tryAdvance(T_CONS action) {
                Objects.requireNonNull(action);
        ...
        static final class OfInt : OfPrimitive<Integer, Spliterator.OfInt, IntConsumer>
                : Spliterator.OfInt {
        ...
        static final class OfLong : OfPrimitive<Long, Spliterator.OfLong, LongConsumer>
                : Spliterator.OfLong {
        ...
        static final class OfDouble : OfPrimitive<Double, Spliterator.OfDouble, DoubleConsumer>
                : Spliterator.OfDouble {
     ...
     */
    static abstract class UnorderedSliceSpliterator<T, T_SPLITR : Spliterator<T>> {
        static final int CHUNK_SIZE = 1 << 7;

        // The spliterator to slice
        protected final T_SPLITR s;
        protected final bool unlimited;
        ...
        static final class OfRef<T> : UnorderedSliceSpliterator<T, Spliterator<T>>
        ...
        static abstract class OfPrimitive<
                T,
                T_CONS,
                T_BUFF : ArrayBuffer.OfPrimitive<T_CONS>,
                T_SPLITR : Spliterator.OfPrimitive<T, T_CONS, T_SPLITR>>
     ...
     */
    static final class DistinctSpliterator<T> : Spliterator<T>, Consumer<T> {
     ...
     *
     */
    static abstract class InfiniteSupplyingSpliterator<T> : Spliterator<T> {
        long estimate;
        ...
        static final class OfRef<T> : InfiniteSupplyingSpliterator<T> {
            final Supplier<T> s;
        ...
        static final class OfInt : InfiniteSupplyingSpliterator<Integer>
                : Spliterator.OfInt {
            final IntSupplier s;
        ...
        static final class OfLong : InfiniteSupplyingSpliterator<Long>
                : Spliterator.OfLong {
        ...
        static final class OfDouble : InfiniteSupplyingSpliterator<Double>
                : Spliterator.OfDouble {
    ...
    static abstract class ArrayBuffer {
        ...
        static final class OfRef<T> : ArrayBuffer : Consumer<T> {
            final Object[] array;
        ...
        static abstract class OfPrimitive<T_CONS> : ArrayBuffer {
            int index;
        ...
        static final class OfInt : OfPrimitive<IntConsumer>
                : IntConsumer {
            final int[] array;
        ...
        static final class OfLong : OfPrimitive<LongConsumer>
                : LongConsumer {
            final long[] array;
        ...
        static final class OfDouble : OfPrimitive<DoubleConsumer>
                : DoubleConsumer {
            final double[] array;
