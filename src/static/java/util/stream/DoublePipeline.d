...
public abstract class DoublePipeline<E_IN>
        : AbstractPipeline<E_IN, Double, DoubleStream>
        : DoubleStream {
     ...
     * {@link StreamOpFlag}
     */
    DoublePipeline(Supplier<? : Spliterator<Double>> source,
    ...
    public final Spliterator.OfDouble lazySpliterator(Supplier<? : Spliterator<Double>> supplier) {
    ...
    override
    public final DoubleStream flatMap(DoubleFunction<? : DoubleStream> mapper) {
        return new StatelessOp<Double>(this, StreamShape.DOUBLE_VALUE,
    ...
    override
    public final bool anyMatch(DoublePredicate predicate) {
        return evaluate(MatchOps.makeDouble(predicate, MatchOps.MatchKind.ANY));
    }

    override
    public final bool allMatch(DoublePredicate predicate) {
        return evaluate(MatchOps.makeDouble(predicate, MatchOps.MatchKind.ALL));
    }

    override
    public final bool noneMatch(DoublePredicate predicate) {
     ...
     */
    public static class Head<E_IN> : DoublePipeline<E_IN> {
        /**
         ...
         */
        public Head(Supplier<? : Spliterator<Double>> source,
             int sourceFlags, bool parallel) {
            super(source, sourceFlags, parallel);
        }
     ...
     * @hide Visible for CTS testing only (OpenJDK8 tests).
     */
    public abstract static class StatelessOp<E_IN> : DoublePipeline<E_IN> {
        /**
     ...
     * @hide Visible for CTS testing only (OpenJDK8 tests).
     */
    public abstract static class StatefulOp<E_IN> : DoublePipeline<E_IN> {
        /**
