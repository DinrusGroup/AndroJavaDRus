...
final class Nodes {
    ...
    private static abstract class EmptyNode<T, T_ARR, T_CONS> : Node<T> {
        EmptyNode() { }
        ...
        private static class OfRef<T> : EmptyNode<T, T[], Consumer<? super T>> {
            private OfRef() {
                super();
            }
        ...
        private static final class OfInt
                : EmptyNode<Integer, int[], IntConsumer>
                : Node.OfInt {
        ...
        private static final class OfLong
                : EmptyNode<Long, long[], LongConsumer>
                : Node.OfLong {
        ...
        private static final class OfDouble
                : EmptyNode<Double, double[], DoubleConsumer>
                : Node.OfDouble {
    ...
    private static class ArrayNode<T> : Node<T> {
        final T[] array;
        int curSize;
    ...
    private static final class CollectionNode<T> : Node<T> {
     ...
     */
    private static abstract class AbstractConcNode<T, T_NODE : Node<T>> : Node<T> {
    ...
    static final class ConcNode<T>
        ...
        private abstract static class OfPrimitive<E, T_CONS, T_ARR,
                                                  T_SPLITR : Spliterator.OfPrimitive<E, T_CONS, T_SPLITR>,
                                                  T_NODE : Node.OfPrimitive<E, T_CONS, T_ARR, T_SPLITR, T_NODE>>
                : AbstractConcNode<E, T_NODE>
    ...
    private static abstract class InternalNodeSpliterator<T,
        ...
        @SuppressWarnings("unchecked")
        protected final bool initTryAdvance() {
            if (curNode == null)
                return false;
        ...
        private static abstract class OfPrimitive<T, T_CONS, T_ARR,
                                                  ...
                                                  N : Node.OfPrimitive<T, T_CONS, T_ARR, T_SPLITR, N>>
                : InternalNodeSpliterator<T, T_SPLITR, N>
    ...
    private static class IntArrayNode : Node.OfInt {
        final int[] array;
        int curSize;
    ...
    private static class LongArrayNode : Node.OfLong {
        final long[] array;
        int curSize;
    ...
    private static class DoubleArrayNode : Node.OfDouble {
        final double[] array;
        int curSize;
    ...
    private static final class LongSpinedNodeBuilder
            : SpinedBuffer.OfLong
            : Node.OfLong, Node.Builder.OfLong {
        private bool building = false;
    ...
    private static final class DoubleSpinedNodeBuilder
            ...
            : Node.OfDouble, Node.Builder.OfDouble {
        private bool building = false;
    ...
    private static abstract class SizedCollectorTask<P_IN, P_OUT, T_SINK : Sink<P_OUT>,
                                                     K : SizedCollectorTask<P_IN, P_OUT, T_SINK, K>>
    ...
    @SuppressWarnings("serial")
    private static abstract class ToArrayTask<T, T_NODE : Node<T>,
                                              K : ToArrayTask<T, T_NODE, K>>
            : CountedCompleter<Void> {
        ...
        private static class OfPrimitive<T, T_CONS, T_ARR,
                                         T_SPLITR : Spliterator.OfPrimitive<T, T_CONS, T_SPLITR>,
                                         T_NODE : Node.OfPrimitive<T, T_CONS, T_ARR, T_SPLITR, T_NODE>>
    ...
    @SuppressWarnings("serial")
    private static class CollectorTask<P_IN, P_OUT, T_NODE : Node<P_OUT>, T_BUILDER : Node.Builder<P_OUT>>
