...
public enum StreamTestScenario : OpTestCase.BaseStreamTestScenario {

    STREAM_FOR_EACH_WITH_CLOSE(false) {
        <T, U, S_IN : BaseStream<T, S_IN>>
    ...
    StreamTestScenario(bool isParallel) {
        this(isParallel, true);
    }

    StreamTestScenario(bool isParallel, bool isOrdered) {
    ...
    abstract <T, U, S_IN : BaseStream<T, S_IN>>
    void _run(TestData<T, S_IN> data, Consumer<U> b, Function<S_IN, Stream<U>> m);
