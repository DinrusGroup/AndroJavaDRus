...
/*package*/ class ArraysParallelSortHelpers {
     ...
     */
    static final class EmptyCompleter : CountedCompleter<Void> {
        static final long serialVersionUID = 2446542900576103244L;
        EmptyCompleter(CountedCompleter!(T) p) { super(p); }
     ...
     */
    static final class Relay : CountedCompleter<Void> {
        static final long serialVersionUID = 2446542900576103244L;
        final CountedCompleter!(T) task;
        Relay(CountedCompleter!(T) task) {
            super(null, 1);
            this.task = task;
        }
        public final void compute() { }
        public final void onCompletion(CountedCompleter!(T) t) {
            task.compute();
        }
    }
    ...
    static final class FJObject {
        static final class Sorter<T> : CountedCompleter<Void> {
            static final long serialVersionUID = 2446542900576103244L;
            final T[] a, w;
            final int base, size, wbase, gran;
            Comparator<? super T> comparator;
            Sorter(CountedCompleter!(T) par, T[] a, T[] w, int base, int size,
                   int wbase, int gran,
                   Comparator<? super T> comparator) {
                super(par);
        ...
        static final class Merger<T> : CountedCompleter<Void> {
            static final long serialVersionUID = 2446542900576103244L;
            final T[] a, w; // main and workspace arrays
            final int lbase, lsize, rbase, rsize, wbase, gran;
            Comparator<? super T> comparator;
            Merger(CountedCompleter!(T) par, T[] a, T[] w,
    ...
    static final class FJByte {
        static final class Sorter : CountedCompleter<Void> {
            static final long serialVersionUID = 2446542900576103244L;
            final byte[] a, w;
            final int base, size, wbase, gran;
            Sorter(CountedCompleter!(T) par, byte[] a, byte[] w, int base,
        ...
        static final class Merger : CountedCompleter<Void> {
            static final long serialVersionUID = 2446542900576103244L;
            final byte[] a, w; // main and workspace arrays
            final int lbase, lsize, rbase, rsize, wbase, gran;
            Merger(CountedCompleter!(T) par, byte[] a, byte[] w,
                   int lbase, int lsize, int rbase,
                   int rsize, int wbase, int gran) {
                super(par);
                this.a = a; this.w = w;
    ...
    static final class FJChar {
        static final class Sorter : CountedCompleter<Void> {
            ...
            final char[] a, w;
            final int base, size, wbase, gran;
            Sorter(CountedCompleter!(T) par, char[] a, char[] w, int base,
                   int size, int wbase, int gran) {
                super(par);
                this.a = a; this.w = w; this.base = base; this.size = size;
                this.wbase = wbase; this.gran = gran;
        ...
        static final class Merger : CountedCompleter<Void> {
            ...
            final int lbase, lsize, rbase, rsize, wbase, gran;
            Merger(CountedCompleter!(T) par, char[] a, char[] w,
                   int lbase, int lsize, int rbase,
                   int rsize, int wbase, int gran) {
                super(par);
                this.a = a; this.w = w;
    ...
    static final class FJShort {
        static final class Sorter : CountedCompleter<Void> {
            ...
            final short[] a, w;
            final int base, size, wbase, gran;
            Sorter(CountedCompleter!(T) par, short[] a, short[] w, int base,
                   int size, int wbase, int gran) {
                super(par);
                this.a = a; this.w = w; this.base = base; this.size = size;
                this.wbase = wbase; this.gran = gran;
        ...
        static final class Merger : CountedCompleter<Void> {
            ...
            final int lbase, lsize, rbase, rsize, wbase, gran;
            Merger(CountedCompleter!(T) par, short[] a, short[] w,
                   int lbase, int lsize, int rbase,
                   int rsize, int wbase, int gran) {
                super(par);
                this.a = a; this.w = w;
    ...
    static final class FJInt {
        static final class Sorter : CountedCompleter<Void> {
            ...
            final int[] a, w;
            final int base, size, wbase, gran;
            Sorter(CountedCompleter!(T) par, int[] a, int[] w, int base,
                   int size, int wbase, int gran) {
                super(par);
                this.a = a; this.w = w; this.base = base; this.size = size;
                this.wbase = wbase; this.gran = gran;
        ...
        static final class Merger : CountedCompleter<Void> {
            ...
            final int lbase, lsize, rbase, rsize, wbase, gran;
            Merger(CountedCompleter!(T) par, int[] a, int[] w,
                   int lbase, int lsize, int rbase,
                   int rsize, int wbase, int gran) {
                super(par);
                this.a = a; this.w = w;
    ...
    static final class FJLong {
        static final class Sorter : CountedCompleter<Void> {
            ...
            final long[] a, w;
            final int base, size, wbase, gran;
            Sorter(CountedCompleter!(T) par, long[] a, long[] w, int base,
                   int size, int wbase, int gran) {
                super(par);
                this.a = a; this.w = w; this.base = base; this.size = size;
                this.wbase = wbase; this.gran = gran;
        ...
        static final class Merger : CountedCompleter<Void> {
            ...
            final int lbase, lsize, rbase, rsize, wbase, gran;
            Merger(CountedCompleter!(T) par, long[] a, long[] w,
                   int lbase, int lsize, int rbase,
                   int rsize, int wbase, int gran) {
                super(par);
                this.a = a; this.w = w;
    ...
    static final class FJFloat {
        static final class Sorter : CountedCompleter<Void> {
            ...
            final float[] a, w;
            final int base, size, wbase, gran;
            Sorter(CountedCompleter!(T) par, float[] a, float[] w, int base,
                   int size, int wbase, int gran) {
                super(par);
                this.a = a; this.w = w; this.base = base; this.size = size;
                this.wbase = wbase; this.gran = gran;
        ...
        static final class Merger : CountedCompleter<Void> {
            ...
            final int lbase, lsize, rbase, rsize, wbase, gran;
            Merger(CountedCompleter!(T) par, float[] a, float[] w,
                   int lbase, int lsize, int rbase,
                   int rsize, int wbase, int gran) {
                super(par);
                this.a = a; this.w = w;
    ...
    static final class FJDouble {
        static final class Sorter : CountedCompleter<Void> {
            ...
            final double[] a, w;
            final int base, size, wbase, gran;
            Sorter(CountedCompleter!(T) par, double[] a, double[] w, int base,
                   int size, int wbase, int gran) {
                super(par);
                this.a = a; this.w = w; this.base = base; this.size = size;
                this.wbase = wbase; this.gran = gran;
        ...
        static final class Merger : CountedCompleter<Void> {
            ...
            final int lbase, lsize, rbase, rsize, wbase, gran;
            Merger(CountedCompleter!(T) par, double[] a, double[] w,
                   int lbase, int lsize, int rbase,
                   int rsize, int wbase, int gran) {
                super(par);
                this.a = a; this.w = w;
