 ...
 * @serial exclude
 */
class RegularEnumSet<E : Enum<E>> : EnumSet<E> {
    ...
    RegularEnumSet(Class<E>elementType, Enum!(T)[] universe) {
    ...
    private class EnumSetIterator<E : Enum<E>> : Iterator<E> {
        /**
    ...
    public bool contains(Object e) {
        ...
        return (elements & (1L << ((Enum!(T))e).ordinal())) != 0;
    }
    ...
    public bool containsAll(Collection!(T) c) {
        ...
        RegularEnumSet!(T) es = (RegularEnumSet!(T))c;
    ...
    public bool equals(Object o) {
        ...
        RegularEnumSet!(T) es = (RegularEnumSet!(T))o;
        if (es.elementType != elementType)
