...
public interface CompletionStage<T> {
     ...
     */
    public <U> CompletionStage<U> thenApply(Function<? super T,? : U> fn);
     ...
     * @return the new CompletionStage
     */
    public CompletionStage<Void> runAfterBoth(CompletionStage!(T) other,
                                              Runnable action);
    /**
     * Returns a new CompletionStage that, when this and the other
     * given stage both complete normally, executes the given action
     ...
     * @return the new CompletionStage
     */
    public CompletionStage<Void> runAfterBothAsync(CompletionStage!(T) other,
                                                   Runnable action);
     ...
     * @return the new CompletionStage
     */
    public CompletionStage<Void> runAfterEither(CompletionStage!(T) other,
                                                Runnable action);
