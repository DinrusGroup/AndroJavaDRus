 ...
 * : Number so that concrete subclasses must publicly do so.
 */
@SuppressWarnings("serial")
abstract class Striped64 : Number {
    /*
    ...
    static final class Cell {
        volatile long value;
        Cell(long x) { value = x; }
        final bool cas(long cmp, long val) {
     ...
     */
    final bool casBase(long cmp, long val) {
