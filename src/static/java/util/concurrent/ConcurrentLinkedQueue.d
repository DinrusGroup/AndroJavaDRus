 ...
 */
public class ConcurrentLinkedQueue<E> : AbstractQueue<E>
    ...
    static <E> bool casItem(Node<E> node, E cmp, E val) {
    ...
    static <E> bool casNext(Node<E> node, Node<E> cmp, Node<E> val) {
     ...
     */
    public ConcurrentLinkedQueue(Collection<? : E> c) {
    ...
    static final class CLQSpliterator<E> : Spliterator<E> {
