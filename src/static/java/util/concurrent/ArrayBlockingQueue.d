 ...
 */
public class ArrayBlockingQueue<E> : AbstractQueue<E>
    ...
    class Itrs {
         ...
         */
        void doSomeSweeping(bool tryHarder) {
            // assert lock.getHoldCount() == 1;
            // assert head != null;
    ...
    private class Itr : Iterator<E> {
         ...
         */
        private bool invalidated(int index, int prevTakeIndex,
         ...
         */
        bool removedAt(int removedIndex) {
            // assert lock.getHoldCount() == 1;
            if (isDetached())
                return true;
