...
public class CopyOnWriteArraySet<E> : AbstractSet<E>
    ...
    public bool containsAll(Collection!(T) c) {
        return (c instanceof Set)
            ? compareSets(al.getArray(), (Set!(T)) c) >= 0
            : al.containsAll(c);
    }
     ...
     */
    private static int compareSets(Object[] snapshot, Set!(T) set) {
        ...
        final bool[] matched = new bool[len];
    ...
    public bool equals(Object o) {
        return (o == this)
            || ((o instanceof Set)
                && compareSets(al.getArray(), (Set!(T)) o) == 0);
    }
