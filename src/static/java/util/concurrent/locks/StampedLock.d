 ...
 * @author Doug Lea
 */
public class StampedLock : java.io.Serializable.Serializable {
    /*
     * Algorithmic notes:
     *
    ...
    // Modes for nodes (int not bool to allow arithmetic)
     ...
     */
    public bool validate(long stamp) {
        U.loadFence();
    ...
    final class ReadLockView : Lock {
        public void lock() { readLock(); }
        public void lockInterruptibly() throws InterruptedException {
            readLockInterruptibly();
        }
        public bool tryLock() { return tryReadLock() != 0L; }
    ...
    final class WriteLockView : Lock {
        public void lock() { writeLock(); }
        public void lockInterruptibly() throws InterruptedException {
            writeLockInterruptibly();
        }
        public bool tryLock() { return tryWriteLock() != 0L; }
        public bool tryLock(long time, TimeUnit unit)
            throws InterruptedException {
    ...
    final class ReadWriteLockView : ReadWriteLock {
