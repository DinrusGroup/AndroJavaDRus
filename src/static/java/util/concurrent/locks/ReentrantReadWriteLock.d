...
public class ReentrantReadWriteLock
     ...
     */
    abstract static class Sync : AbstractQueuedSynchronizer {
         ...
         */
        abstract bool readerShouldBlock();
         ...
         * because of policy for overtaking other waiting threads.
         */
        abstract bool writerShouldBlock();
        ...
        protected final bool tryReleaseShared(int unused) {
            Thread current = Thread.currentThread();
        ...
        protected final bool isHeldExclusively() {
     ...
     */
    static final class NonfairSync : Sync {
        private static final long serialVersionUID = -8159625535654395037L;
        final bool writerShouldBlock() {
            return false; // writers can always barge
        }
        final bool readerShouldBlock() {
     ...
     */
    static final class FairSync : Sync {
     ...
     */
    public static class ReadLock : Lock, java.io.Serializable {
     ...
     */
    public static class WriteLock : Lock, java.io.Serializable {
     ...
     */
    public final bool hasQueuedThread(Thread thread) {
