 ...
 *
 * <pre> {@code
 * class FIFOEntry<E : Comparable<? super E>>
...
public class PriorityBlockingQueue<E> : AbstractQueue<E>
     ...
     */
    public PriorityBlockingQueue(Collection<? : E> c) {
        this.lock = new ReentrantLock();
        this.notEmpty = lock.newCondition();
        ...
        else if (c instanceof PriorityBlockingQueue!(T)) {
            PriorityBlockingQueue<? : E> pq =
    ...
    static final class PBQSpliterator<E> : Spliterator<E> {
