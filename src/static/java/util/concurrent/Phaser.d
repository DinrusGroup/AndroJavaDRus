 ...
 *     protected bool onAdvance(int phase, int registeredParties) {
...
public class Phaser {
    /*
     * This class : an extension of X10 "clocks".  Thanks to
     ...
     *   protected bool onAdvance(int phase, int parties) { return false; }
     * }}</pre>
     *
     ...
     */
    static final class QNode : ForkJoinPool.ManagedBlocker {
        final Phaser phaser;
        final int phase;
        ...
        QNode(Phaser phaser, int phase, bool interruptible,
