 ...
 */
public class SynchronousQueue<E> : AbstractQueue<E>
    : BlockingQueue<E>, java.io.Serializable {
    private static final long serialVersionUID = -3223113410248163686L;

    /*
     * This class : extensions of the dual stack and dual
    ...
    abstract static class Transferer<E> {
         ...
         */
        abstract E transfer(E e, bool timed, long nanos);
    }
    ...
    /** Dual stack */
    static final class TransferStack<E> : Transferer<E> {
        /*
         * This : Scherer-Scott dual stack algorithm, differing,
        ...
        static bool isFulfilling(int m) { return (m & FULFILLING) != 0; }
        ...
        static final class SNode {
            ...
            bool casNext(SNode cmp, SNode val) {
                return cmp == next &&
        ...
        E transfer(E e, bool timed, long nanos) {
            /*
         ...
         */
        SNode awaitFulfill(SNode s, bool timed, long nanos) {
            /*
    ...
    /** Dual Queue */
    static final class TransferQueue<E> : Transferer<E> {
        /*
         * This : Scherer-Scott dual queue algorithm, differing,
         ...
         */
        Object awaitFulfill(QNode s, E e, bool timed, long nanos) {
    ...
    static class WaitQueue : java.io.Serializable.Serializable { }
    static class LifoWaitQueue : WaitQueue {
        private static final long serialVersionUID = -3633113410248163686L;
    }
    static class FifoWaitQueue : WaitQueue {
    ...
    private void writeObject(java.io.ObjectOutputStream s)
        ...
        bool fair = transferer instanceof TransferQueue;
        if (fair) {
