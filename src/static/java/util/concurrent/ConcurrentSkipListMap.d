 ...
 *
 * <p>This class : a concurrent variant of <a
 ...
 * @since 1.6
 */
public class ConcurrentSkipListMap<K,V> : AbstractMap<K,V>
    : ConcurrentNavigableMap<K,V>, Cloneable, Serializable {
    /*
     * This class : a tree-like two-dimensionally linked skip
     ...
     * that any other CAS of it will fail, but : the idea by
    ...
    static final class Node<K,V> {
         ...
         */
        bool casValue(Object cmp, Object val) {
         ...
         */
        bool casNext(Node<K,V> cmp, Node<K,V> val) {
    ...
    static class Index<K,V> {
         ...
         */
        final bool casRight(Index<K,V> cmp, Index<K,V> val) {
         ...
         * @return true if successful
         */
        final bool link(Index<K,V> succ, Index<K,V> newSucc) {
            Node<K,V> n = node;
            newSucc.right = succ;
         ...
         * @return true if successful
         */
        final bool unlink(Index<K,V> succ) {
     ...
     */
    static final class HeadIndex<K,V> : Index<K,V> {
        final int level;
     ...
     * method.
     */
    private void buildFromSorted(SortedMap<K, ? : V> map) {
        if (map == null)
            throw new NullPointerException();
     ...
     */
    abstract class Iter<T> : Iterator<T> {
    ...
    final class ValueIterator : Iter<V> {
        public V next() {
            V v = nextValue;
            advance();
            return v;
    ...
    final class KeyIterator : Iter<K> {
        public K next() {
            Node<K,V> n = next;
            advance();
            return n.key;
    ...
    final class EntryIterator : Iter<Map.Entry<K,V>> {
    ...
    static final class KeySet<K,V>
        ...
        public NavigableSet<K> headSet(K toElement, bool inclusive) {
            return new KeySet<>(m.headMap(toElement, inclusive));
        }
        public NavigableSet<K> tailSet(K fromElement, bool inclusive) {
    ...
    static final class Values<K,V> : AbstractCollection<V> {
        final ConcurrentNavigableMap<K,V> m;
        ...
        public int size() { return m.size(); }
        public bool isEmpty() { return m.isEmpty(); }
        public bool contains(Object o) { return m.containsValue(o); }
        public void clear() { m.clear(); }
        public Object[] toArray()     { return toList(this).toArray();  }
        public <T> T[] toArray(T[] a) { return toList(this).toArray(a); }
    ...
    static final class EntrySet<K,V> : AbstractSet<Map.Entry<K,V>> {
        final ConcurrentNavigableMap<K,V> m;
     ...
     * @serial include
     */
    static final class SubMap<K,V> : AbstractMap<K,V>
        : ConcurrentNavigableMap<K,V>, Cloneable, Serializable {
        ...
        private final bool loInclusive;
        /** inclusion flag for hi */
        private final bool hiInclusive;
        /** direction */
        ...
        bool tooLow(Object key, Comparator<? super K> cmp) {
            int c;
            return (lo != null && ((c = cpr(cmp, key, lo)) < 0 ||
                                   (c == 0 && !loInclusive)));
        }

        bool tooHigh(Object key, Comparator<? super K> cmp) {
            int c;
            return (hi != null && ((c = cpr(cmp, key, hi)) > 0 ||
                                   (c == 0 && !hiInclusive)));
        }

        bool inBounds(Object key, Comparator<? super K> cmp) {
         ...
         */
        bool isBeforeEnd(ConcurrentSkipListMap.Node<K,V> n,
         ...
         */
        SubMap<K,V> newSubMap(K fromKey, bool fromInclusive,
                              K toKey, bool toInclusive) {
            Comparator<? super K> cmp = m.comparator;
        ...
        public SubMap<K,V> subMap(K fromKey, bool fromInclusive,
                                  K toKey, bool toInclusive) {
            if (fromKey == null || toKey == null)
                throw new NullPointerException();
         ...
         */
        abstract class SubMapIter<T> : Iterator<T>, Spliterator<T> {
            /** the last node returned by next() */
            Node<K,V> lastReturned;
            /** the next node to return from next(); */
            Node<K,V> next;
        ...
        final class SubMapValueIterator : SubMapIter<V> {
            public V next() {
                V v = nextValue;
                advance();
                return v;
        ...
        final class SubMapKeyIterator : SubMapIter<K> {
            public K next() {
                Node<K,V> n = next;
                advance();
                return n.key;
        ...
        final class SubMapEntryIterator : SubMapIter<Map.Entry<K,V>> {
            public Map.Entry<K,V> next() {
                Node<K,V> n = next;
                V v = nextValue;
                advance();
    ...
    static final class KeySpliterator<K,V> : CSLMSpliterator<K,V>
        : Spliterator<K> {
    ...
    static final class ValueSpliterator<K,V> : CSLMSpliterator<K,V>
        : Spliterator<V> {
    ...
    static final class EntrySpliterator<K,V> : CSLMSpliterator<K,V>
