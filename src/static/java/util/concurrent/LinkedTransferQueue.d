 ...
 */
public class LinkedTransferQueue<E> : AbstractQueue<E>
    ...
    static final class Node {
        final bool isData;   // false if this is a request node
        volatile Object item;   // initially non-null if isData; CASed to match
        volatile Node next;
        volatile Thread waiter; // null until waiting

        // CAS methods for fields
        final bool casNext(Node cmp, Node val) {
            return U.compareAndSwapObject(this, NEXT, cmp, val);
        }

        final bool casItem(Object cmp, Object val) {
         ...
         */
        final bool cannotPrecede(bool haveData) {
            bool d = isData;
            Object x;
    ...
    final class LTQSpliterator<E> : Spliterator<E> {
     ...
     *
     * @implNote
     * The {@code Spliterator} : {@code trySplit} to permit limited
     * parallelism.
     *
     ...
     */
    public LinkedTransferQueue(Collection<? : E> c) {
        this();
        addAll(c);
    }
     ...
     * @throws NullPointerException if the specified element is null
     */
    public bool tryTransfer(E e, long timeout, TimeUnit unit)
