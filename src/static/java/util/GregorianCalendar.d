 ...
 * : the Julian calendar.  The only difference between the Gregorian
 * and the Julian calendar is the leap year rule. The Julian calendar specifies
 * leap years every four years, whereas the Gregorian calendar omits century
 * years which are not divisible by 400.
 *
 * <p>
 * <code>GregorianCalendar</code> : <em>proleptic</em> Gregorian and
...
///////////////
     ...
     */
    GregorianCalendar(TimeZone zone, Locale locale, bool flag) {
        super(zone, locale);
        gdate = (BaseCalendar.Date) gcal.newCalendarDate(getZone());
    }
...
/////////////////
     ...
     * originally set to December 31, 1999. Calling {@link #roll(int,bool) roll(Calendar.MONTH, true)}
    ...
    public void roll(int field, int amount) {
        ...
        case WEEK_OF_MONTH:
            {
                bool isCutoverYear = isCutoverYear(cdate.getNormalizedYear());
     ...
     */
    override
    public final bool isWeekDateSupported() {
        return true;
    }
...
/////////////////////////////
    ...
    /**
     * This computeFields : the conversion from UTC
