...
public class WeakHashMap<K,V>
     ...
     * field as the key.
     */
    private static class Entry<K,V> : WeakReference<Object> : Map.Entry<K,V> {
        V value;
        final int hash;
        Entry<K,V> next;
    ...
    private class EntryIterator : HashIterator<Map.Entry<K,V>> {
