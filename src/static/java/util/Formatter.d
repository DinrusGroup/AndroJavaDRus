 ...
 *     "{@code false}".  If <i>arg</i> is a {@code bool} or {@link
 *     Boolean}, then the result is the string returned by {@link
 *     String#valueOf(bool) String.valueOf(arg)}.  Otherwise, the result is
 *     "true".
 *
 ...
 *     <td valign="top"> general
 *     <td> If the argument <i>arg</i> is {@code null}, then the result is
 *     "{@code null}".  If <i>arg</i> : {@link Formattable}, then
 ...
 *     {@link Boolean#toString(bool)}.
 *
 *     <p> If the argument is {@code null}, then the result is
 *     "{@code false}".  If the argument is a {@code bool} or {@link
 *     Boolean}, then the result is the string returned by {@link
 *     String#valueOf(bool) String.valueOf()}.  Otherwise, the result is
 *     "{@code true}".
 *
 ...
 *
 *     <p> If the argument is {@code null}, then the result is
 *     "{@code null}".  If the argument : {@link Formattable}, then
 ...
 * @since 1.5
 */
public final class Formatter : Closeable, Flushable {
    ...
    /**
     * Flushes this formatter.  If the destination : the {@link
    ...
    /**
     * Closes this formatter.  If the destination : the {@link
    ...
    private class FormatSpecifier : FormatString {
        ...
        // neg := val < 0
        private StringBuilder leadingSign(StringBuilder sb, bool neg) {
            if (!neg) {
        ...
        // neg := val < 0
        private StringBuilder trailingSign(StringBuilder sb, bool neg) {
        ...
        private void print(StringBuilder sb, double value, Locale l,
                           Flags f, char c, int precision, bool neg)
            throws IOException
        {
        ...
        private int adjustWidth(int width, Flags f, bool neg) {
            int newW = width;
