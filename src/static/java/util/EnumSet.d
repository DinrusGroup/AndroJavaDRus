 ...
 * @serial exclude
 */
public abstract class EnumSet<E : Enum<E>> : AbstractSet<E>
    : Cloneable, java.io.Serializable
{
     ...
     */
    final Enum!(T)[] universe;

    private static Enum!(T)[] ZERO_LENGTH_ENUM_ARRAY = new Enum!(T)[0];

    EnumSet(Class<E>elementType, Enum!(T)[] universe) {
     ...
     */
    public static <E : Enum<E>> EnumSet<E> noneOf(Class<E> elementType) {
        Enum!(T)[] universe = getUniverse(elementType);
        if (universe == null)
     ...
     * @throws NullPointerException if <tt>elementType</tt> is null
     */
    public static <E : Enum<E>> EnumSet<E> allOf(Class<E> elementType) {
     ...
     */
    public static <E : Enum<E>> EnumSet<E> copyOf(EnumSet<E> s) {
        return s.clone();
    }
     ...
     */
    public static <E : Enum<E>> EnumSet<E> copyOf(Collection<E> c) {
     ...
     * @throws NullPointerException if <tt>s</tt> is null
     */
    public static <E : Enum<E>> EnumSet<E> complementOf(EnumSet<E> s) {
     ...
     */
    public static <E : Enum<E>> EnumSet<E> of(E e) {
     ...
     */
    public static <E : Enum<E>> EnumSet<E> of(E e1, E e2) {
     ...
     * @return an enum set initially containing the specified elements
     */
    public static <E : Enum<E>> EnumSet<E> of(E e1, E e2, E e3) {
        EnumSet<E> result = noneOf(e1.getDeclaringClass());
        result.add(e1);
        result.add(e2);
        result.add(e3);
     ...
     * @return an enum set initially containing the specified elements
     */
    public static <E : Enum<E>> EnumSet<E> of(E e1, E e2, E e3, E e4) {
        EnumSet<E> result = noneOf(e1.getDeclaringClass());
        result.add(e1);
        result.add(e2);
        result.add(e3);
     ...
     */
    @SafeVarargs
    public static <E : Enum<E>> EnumSet<E> of(E first, E... rest) {
     ...
     */
    public static <E : Enum<E>> EnumSet<E> range(E from, E to) {
     ...
     */
    private static <E : Enum<E>> E[] getUniverse(Class<E> elementType) {
     ...
     * @serial include
     */
    private static class SerializationProxy <E : Enum<E>>
