 ...
 * @serial exclude
 */
class JumboEnumSet<E : Enum<E>> : EnumSet<E> {
    ...
    JumboEnumSet(Class<E>elementType, Enum!(T)[] universe) {
    ...
    public bool containsAll(Collection!(T) c) {
        ...
        JumboEnumSet!(T) es = (JumboEnumSet!(T))c;
    ...
    public bool equals(Object o) {
        ...
        JumboEnumSet!(T) es = (JumboEnumSet!(T))o;
        if (es.elementType != elementType)
