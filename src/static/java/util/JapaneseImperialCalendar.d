...
/**
 * <code>JapaneseImperialCalendar</code> : a Japanese
...
class JapaneseImperialCalendar : Calendar {
     ...
     */
    JapaneseImperialCalendar(TimeZone zone, Locale aLocale, bool flag) {
        super(zone, aLocale);
        jdate = jcal.newCalendarDate(zone);
    }
    ...
    public void roll(int field, int amount) {
        ...
        case WEEK_OF_MONTH:
            {
                bool isTransitionYear = isTransitionYear(jdate.getNormalizedYear());
    ...
    private int computeFields(int fieldMask, int tzMask) {
        ...
        if ((fieldMask & (DAY_OF_YEAR_MASK|WEEK_OF_YEAR_MASK
            ...
            bool transitionYear = isTransitionYear(jdate.getNormalizedYear());
            int dayOfYear;
            long fixedDateJan1;
            if (transitionYear) {
