    ...
    : Iterable<S>
{
    ...
    private static void fail(Class!(T) service, String msg, Throwable cause)
    ...
    private static void fail(Class!(T) service, String msg)
        throws ServiceConfigurationError
    {
        throw new ServiceConfigurationError(service.getName() + ": " + msg);
    }

    private static void fail(Class!(T) service, URL u, int line, String msg)
        throws ServiceConfigurationError
    {
    ...
    //
    private int parseLine(Class!(T) service, URL u, BufferedReader r, int lc,
                          List<String> names)
    ...
    //
    private Iterator<String> parse(Class!(T) service, URL u)
        throws ServiceConfigurationError
    {
        InputStream in = null;
    ...
    public static <S> S loadFromSystemProperty(final Class<S> service) {
        try {
            ...
            if (className != null) {
                Class!(T) c = ClassLoader.getSystemClassLoader().loadClass(className);
