    ...
    : Map<K,V>
{
     ...
     */
    static class LinkedHashMapEntry<K,V> : HashMap.Node<K,V> {
    ...
    void afterNodeInsertion(bool evict) { // possibly remove eldest
     ...
     */
    protected bool removeEldestEntry(Map.Entry<K,V> eldest) {
        return false;
    }
    ...
    final class LinkedEntrySet : AbstractSet<Map.Entry<K,V>> {
        public final int size()                 { return size; }
        public final void clear()               { LinkedHashMap.this.clear(); }
    ...
    final class LinkedKeyIterator : LinkedHashIterator
        : Iterator<K> {
        public final K next() { return nextNode().getKey(); }
    }

    final class LinkedValueIterator : LinkedHashIterator
        : Iterator<V> {
        public final V next() { return nextNode().value; }
    }

    final class LinkedEntryIterator : LinkedHashIterator
