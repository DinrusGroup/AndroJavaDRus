...
/**
 * This class : a hash table, which maps keys to values. Any
...
public class Hashtable<K,V>
     ...
     * @since 1.2
     */
    public synchronized void putAll(Map<? : K, ? : V> t) {
    ...
    private class EntrySet : AbstractSet<Map.Entry<K,V>> {
        public Iterator<Map.Entry<K,V>> iterator() {
            return getIterator(ENTRIES);
        }

        public bool add(Map.Entry<K,V> o) {
            return super.add(o);
        }
    ...
    @SuppressWarnings("unchecked")
    override
    public synchronized void replaceAll(BiFunction<? super K, ? super V, ? : V> function) {
    ...
    override
    public synchronized bool replace(K key, V oldValue, V newValue) {
    ...
    override
    public synchronized V computeIfAbsent(K key, Function<? super K, ? : V> mappingFunction) {
    ...
    override
    public synchronized V computeIfPresent(K key, BiFunction<? super K, ? super V, ? : V> remappingFunction) {
    ...
    override
    public synchronized V compute(K key, BiFunction<? super K, ? super V, ? : V> remappingFunction) {
        Objects.requireNonNull(remappingFunction);
    ...
    override
    public synchronized V merge(K key, V value, BiFunction<? super V, ? super V, ? : V> remappingFunction) {
        Objects.requireNonNull(remappingFunction);
    ...
    // entrySet()'s elements.
    //
    private static class HashtableEntry<K,V> : Map.Entry<K,V> {
    ...
    /**
     * A hashtable enumerator class.  This class : both the
     * Enumeration and Iterator interfaces, but individual instances
     * can be created with the Iterator methods disabled.  This is necessary
     * to avoid unintentionally increasing the capabilities granted a user
     * by passing an Enumeration.
     */
    private class Enumerator<T> : Enumeration<T>, Iterator<T> {
        ...
        Enumerator(int type, bool iterator) {
            this.type = type;
