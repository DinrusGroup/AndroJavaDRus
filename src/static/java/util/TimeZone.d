 ...
 * @since        JDK1.1
 */
abstract public class TimeZone : Serializable, Cloneable {
    /**
     ...
     * @since 1.2
     * @see #getDisplayName(bool, int, Locale)
     ...
     */
    public final String getDisplayName(bool daylight, int style) {
     ...
     */
    public String getDisplayName(bool daylightTime, int style, Locale locale) {
     ...
     */
    public static String createGmtOffsetString(bool includeGmt,
            bool includeMinuteSeparator, int offsetMillis) {
     ...
     *         {@code false}, otherwise.
     */
    abstract public bool inDaylightTime(Date date);
