 ...
 * <blockquote>
 * <pre>
 * public class MyResources : ListResourceBundle {
 ...
 * public class MyResources : ResourceBundle {
 ...
 *
 * // German language
 * public class MyResources_de : MyResources {
 *     public Object handleGetObject(String key) {
...
public abstract class ResourceBundle {
    ...
    */
     ...
     */
    private static class RBClassLoader : ClassLoader {
     ...
     * value.
     */
    private static class CacheKey : Cloneable {
     ...
     */
    private static class LoaderReference : WeakReference<ClassLoader>
                                         : CacheKeyReference {
     ...
     */
    private static class BundleReference : SoftReference<ResourceBundle>
                                         : CacheKeyReference {
        private CacheKey cacheKey;
     ...
     * String, ClassLoader, bool) control.newBundle} method is called to
     ...
     * Control#newBundle(String, Locale, String, ClassLoader, bool)
    ...
    private static ResourceBundle getBundleImpl(String baseName, Locale locale,
        ...
        bool isKnownControl = (control == Control.INSTANCE) ||
        ...
        for (Locale targetLocale = locale;
            ...
            if (isValidBundle(bundle)) {
                bool isBaseBundle = Locale.ROOT.equals(bundle.locale);
     ...
     */
    private static bool checkList(List!(T) a) {
        bool valid = (a != null && !a.isEmpty());
        if (valid) {
            int size = a.size();
     ...
     * ...
     *
     * private static class XMLResourceBundle : ResourceBundle {
    ...
    public static class Control {
        ...
        private static class CandidateListCache : LocaleObjectCache<BaseLocale, List<Locale>> {
         ...
         * {@linkplain URLConnection#setUseCaches(bool) disable the
        ...
        public ResourceBundle newBundle(String baseName, Locale locale, String format,
                                        ClassLoader loader, bool reload)
            ...
            if (format.equals("java.class")) {
                try {
                    ...
                    Class<? : ResourceBundle> bundleClass
                        = (Class<? : ResourceBundle>)loader.loadClass(bundleName);
         ...
         */
        public bool needsReload(String baseName, Locale locale,
         ...
         * ClassLoader, bool) newBundle} and {@link #needsReload(String,
    ...
    private static class SingleFormatControl : Control {
    ...
    private static final class NoFallbackControl : SingleFormatControl {
