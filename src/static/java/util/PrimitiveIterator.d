...
public interface PrimitiveIterator<T, T_CONS> : Iterator<T> {
     ...
     * @since 1.8
     */
    public static interface OfInt : PrimitiveIterator<Integer, IntConsumer> {
     ...
     * @since 1.8
     */
    public static interface OfLong : PrimitiveIterator<Long, LongConsumer> {
     ...
     * @since 1.8
     */
    public static interface OfDouble : PrimitiveIterator<Double, DoubleConsumer> {
