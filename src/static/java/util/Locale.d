 ...
 * region, or culture.
 *
 * <p> The {@code Locale} class : IETF BCP 47 which is composed of
 ...
 * lookup mechanism also : this mapping, so that resources
...
public final class Locale : Cloneable, Serializable {
    ...
    private static class Cache : LocaleObjectCache<LocaleKey, Locale> {
        private Cache() {
        }
    ...
    public final String toString() {
        bool l = (baseLocale.getLanguage().length() != 0);
        bool s = (baseLocale.getScript().length() != 0);
        bool r = (baseLocale.getRegion().length() != 0);
        bool v = (baseLocale.getVariant().length() != 0);
        bool e = (localeExtensions != null && localeExtensions.getID().length() != 0);
     ...
     * </pre></ul>
     *
     * <p>This : the 'Language-Tag' production of BCP47, and
    ...
    private static String normalizeAndValidateLanguage(String language, bool strict) {
     ...
     */
    private static bool isAsciiAlphaNum(String string) {
    ...
    private static String normalizeAndValidateRegion(String region, bool strict) {
    ...
    private static bool isValidBcp47Alpha(String string, int lowerBound, int upperBound) {
     ...
     */
    private static bool isUnM49AreaCode(String code) {
        if (code.length() != 3) {
            return false;
        }
    ...
    private static bool isValidVariantSubtag(String subTag) {
