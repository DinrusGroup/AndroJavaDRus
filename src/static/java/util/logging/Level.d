...
public class Level : java.io.Serializable.Serializable {
    ...
    private String computeLocalizedLevelName(Locale newLocale) {
        ...
        final bool isDefaultBundle = defaultBundle.equals(resourceBundleName);
        ...
        static synchronized KnownLevel matches(Level l) {
            ...
            if (list != null) {
                for (KnownLevel level : list) {
                    ...
                    Class<? : Level> type = level.levelObject.getClass();
