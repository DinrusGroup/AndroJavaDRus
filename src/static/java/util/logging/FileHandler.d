...
public class FileHandler : StreamHandler {
    ...
    private void open(File fname, bool append) throws IOException {
        int len = 0;
        if (append) {
    ...
    private static class InitializationErrorManager : ErrorManager {
     ...
     */
    // private static native bool isSetUID();
}
