...
public class Logger {
    ...
    private final bool isSystemLogger;
    ...
    Logger(String name, String resourceBundleName, Class!(T) caller, LogManager manager, bool isSystemLogger) {
    ...
    private void setCallersClassLoaderRef(Class!(T) caller) {
    ...
    private static class SystemLoggerHelper {
        static bool disableCallerCheck = getBooleanProperty("sun.util.logging.disableCallerCheck");
        private static bool getBooleanProperty(final String key) {
    ...
    private static Logger demandLogger(String name, String resourceBundleName, Class!(T) caller) {
    ...
    public static Logger getLogger(String name, String resourceBundleName) {
        // Android-changed: Use VMStack.getStackClass1.
        Class!(T) callerClass = VMStack.getStackClass1();
    ...
    public void log(LogRecord record) {
        ...
        while (logger != null) {
            ...
            final bool useParentHdls = isSystemLogger
    ...
    public void setResourceBundle(ResourceBundle bundle) {
        ...
        synchronized (this) {
            ...
            final bool canReplaceResourceBundle = lb.resourceBundleName == null
