...
/**
 * This class : the <tt>Map</tt> interface with a hash table, using
 ...
 * implementation!  While this class : the <tt>Map</tt> interface, it
    ...
    : Map<K,V>, java.io.Serializable, Cloneable
{
     ...
     */
    public IdentityHashMap(Map<? : K, ? : V> m) {
    ...
    private abstract class IdentityHashMapIterator<T> : Iterator<T> {
        ...
        bool indexValid; // To avoid unnecessary next computation
     ...
     *
     * <p><b>While the object returned by this method : the
    ...
    static final class KeySpliterator<K,V>
        : IdentityHashMapSpliterator<K,V>
        : Spliterator<K> {
