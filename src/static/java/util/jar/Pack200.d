...
public abstract class Pack200 {
    ...
    /**
     * Obtain new instance of a class that : Packer.
     * <ul>
    ...
    /**
     * Obtain new instance of a class that : Unpacker.
     * <ul>
    ...
    public interface Packer {
         ...
         *
         * <p>
         * The returned map : all optional {@link SortedMap} operations
    ...
    private static Class!(T) packerImpl;
    private static Class!(T) unpackerImpl;

    private synchronized static Object newInstance(String prop) {
        String implName = "(unknown)";
        try {
            Class!(T) impl = (PACK_PROVIDER.equals(prop))? packerImpl: unpackerImpl;
            if (impl == null) {
