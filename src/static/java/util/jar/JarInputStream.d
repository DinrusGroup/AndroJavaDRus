 ...
 * a JAR file from any input stream. It : the class
 ...
 */
public
class JarInputStream : ZipInputStream {
    private Manifest man;
    private JarEntry first;
    private JarVerifier jv;
    private ManifestEntryVerifier mev;
    private final bool doVerify;
     ...
     * @exception IOException if an I/O error has occurred
     */
    public JarInputStream(InputStream in, bool verify) throws IOException {
        super(in);
