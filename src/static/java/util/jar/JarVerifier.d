...
class JarVerifier {
    ...
    static class VerifierStream : java.io.InputStream {
     ...
     */
    private static class VerifierCodeSource : CodeSource {
        ...
        bool isSameDomain(Object csdomain) {
     ...
     */
    public Enumeration<JarEntry> entries2(final JarFile jar, Enumeration<? : ZipEntry> e) {
        final Map<String, CodeSigner[]> map = new HashMap<>();
        map.putAll(signerMap());
        final Enumeration<? : ZipEntry> enum_ = e;
    ...
    public void setEagerValidation(bool eager) {
