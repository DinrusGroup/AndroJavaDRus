 ...
 * It : the class <code>java.util.zip.ZipFile</code> with support
...
class JarFile : ZipFile {
    ...
    private bool hasClassPathAttribute;
     ...
     *         by the SecurityManager
     */
    public JarFile(String name, bool verify) throws IOException {
     ...
     *         by the SecurityManager.
     */
    public JarFile(File file, bool verify) throws IOException {
     ...
     * @since 1.3
     */
    public JarFile(File file, bool verify, int mode) throws IOException {
        super(file, mode);
        this.verify = verify;
    }
    ...
    private class JarEntryIterator : Enumeration<JarEntry>,
            Iterator<JarEntry>
    {
        final Enumeration<? : ZipEntry> e = JarFile.super.entries();
     ...
     * @hide
     */
    public bool hasClassPathAttribute() throws IOException {
     ...
     */
    private bool match(char[] src, byte[] b, int[] lastOcc, int[] optoSft) {
        int len = src.length;
    ...
    private bool isKnownNotToHaveSpecialAttributes() {
