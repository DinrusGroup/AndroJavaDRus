 ...
 * of a JAR file to any output stream. It : the class
 ...
 */
public
class JarOutputStream : ZipOutputStream {
     ...
     */
    private static bool hasMagic(byte[] edata) {
        try {
            int i = 0;
    ...
    private static void set16(byte[] b, int off, int value) {
        b[off+0] = cast(byte)value;
        b[off+1] = cast(byte)(value >> 8);
    }
}
