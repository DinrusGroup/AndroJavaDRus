 ...
 * space at a time.
 *
 * <p> A scanner can read text from any object which : the {@link
 ...
 * if the source : the {@link java.io.Closeable} interface.
 *
 ...
 * @since   1.5
 */
public final class Scanner : Iterator<String>, Closeable {
    ...
    new LRUCache<String,Pattern>(7) {
        ...
        protected bool hasName(Pattern p, String s) {
    ...
    /**
     * Fields and an accessor method to match bools
     */
     ...
     * {@linkplain java.lang.Readable readable} also : the {@link
     ...
     * interpreted as a bool value using a case insensitive pattern
    ...
    /**
     * Scans the next token of the input into a bool value and returns
     * that value. This method will throw <code>InputMismatchException</code>
     * if the next token cannot be translated into a valid bool value.
     * If the match is successful, the scanner advances past the input that
     * matched.
     *
     * @return the bool scanned from the input
     * @throws InputMismatchException if the next token is not a valid bool
