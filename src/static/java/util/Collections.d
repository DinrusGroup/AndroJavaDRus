...
public class Collections {
    ...
    public static <T : Comparable<? super T>> void sort(List<T> list) {
     ...
     */
    public static <T>
    int binarySearch(List<? : Comparable<? super T>> list, T key) {
    ...
    private static <T>
    int indexedBinarySearch(List<? : Comparable<? super T>> list, T key) {
        int low = 0;
    ...
    private static <T>
    int iteratorBinarySearch(List<? : Comparable<? super T>> list, T key)
    {
        int low = 0;
        int high = list.size()-1;
        ListIterator<? : Comparable<? super T>> i = list.listIterator();
    ...
    public static <T> int binarySearch(List<? : T> list, T key, Comparator<? super T> c) {
        if (c==null)
            return binarySearch((List<? : Comparable<? super T>>) list, key);
    ...
    private static <T> int indexedBinarySearch(List<? : T> l, T key, Comparator<? super T> c) {
        int low = 0;
        int high = l.size()-1;
    ...
    private static <T> int iteratorBinarySearch(List<? : T> l, T key, Comparator<? super T> c) {
        int low = 0;
        int high = l.size()-1;
     ...
     * @see Comparable
     */
    public static <T : Object & Comparable<? super T>> T min(Collection<? : T> coll) {
     ...
     */
    @SuppressWarnings({"unchecked", "rawtypes"})
    public static <T> T min(Collection<? : T> coll, Comparator<? super T> comp) {
        if (comp==null)
     ...
     * @see Comparable
     */
    public static <T : Object & Comparable<? super T>> T max(Collection<? : T> coll) {
        Iterator<? : T> i = coll.iterator();
        T candidate = i.next();
     ...
     * shift distance.
     *
     * <p>If the specified list is small or : the {@link
     ...
     * @since 1.4
     */
    public static void rotate(List!(T) list, int distance) {
    ...
    private static void rotate2(List!(T) list, int distance) {
        int size = list.size();
        if (size == 0)
            return;
     ...
     * @since  1.4
     */
    public static int indexOfSubList(List!(T) source, List!(T) target) {
     ...
     * @since  1.4
     */
    public static int lastIndexOfSubList(List!(T) source, List!(T) target) {
        int sourceSize = source.size();
        int targetSize = target.size();
        int maxCandidate = sourceSize - targetSize;
     ...
     * @serial include
     */
    static class UnmodifiableCollection<E> : Collection<E>, Serializable {
        ...
        public bool isEmpty()            {return c.isEmpty();}
        public bool contains(Object o)   {return c.contains(o);}
        ...
        public bool containsAll(Collection!(T) coll) {
            return c.containsAll(coll);
        }
        public bool addAll(Collection<? : E> coll) {
            throw new UnsupportedOperationException();
        }
        public bool removeAll(Collection!(T) coll) {
            throw new UnsupportedOperationException();
        }
        public bool retainAll(Collection!(T) coll) {
            throw new UnsupportedOperationException();
        }
        public void clear() {
            throw new UnsupportedOperationException();
     ...
     * @serial include
     */
    static class UnmodifiableSet<E> : UnmodifiableCollection<E>
                                 : Set<E>, Serializable {
        private static final long serialVersionUID = -9215047833775013803L;

        UnmodifiableSet(Set<? : E> s)     {super(s);}
        public bool equals(Object o) {return o == this || c.equals(o);}
    ...
    static class UnmodifiableNavigableSet<E>
         ...
         */
        private static class EmptyNavigableSet<E> : UnmodifiableNavigableSet<E>
            : Serializable {
        ...
        private static final NavigableSet!(T) EMPTY_NAVIGABLE_SET =
     ...
     * @serial include
     */
    static class UnmodifiableList<E> : UnmodifiableCollection<E>
                                  : List<E> {
        ...
        public bool equals(Object o) {return o == this || list.equals(o);}
     ...
     * @serial include
     */
    static class UnmodifiableRandomAccessList<E> : UnmodifiableList<E>
                                              : RandomAccess
    {
     ...
     * @serial include
     */
    private static class UnmodifiableMap<K,V> : Map<K,V>, Serializable {
        ...
        public bool isEmpty()                 {return m.isEmpty();}
        public bool containsKey(Object key)   {return m.containsKey(key);}
        public bool containsValue(Object val) {return m.containsValue(val);}
        ...
        public bool equals(Object o) {return o == this || m.equals(o);}
        ...
        override
        public void replaceAll(BiFunction<? super K, ? super V, ? : V> function) {
            throw new UnsupportedOperationException();
        }
        ...
        override
        public V computeIfAbsent(K key, Function<? super K, ? : V> mappingFunction) {
            throw new UnsupportedOperationException();
        }

        override
        public V computeIfPresent(K key,
                BiFunction<? super K, ? super V, ? : V> remappingFunction) {
            throw new UnsupportedOperationException();
        }
        ...
        public V merge(K key, V value,
                BiFunction<? super V, ? super V, ? : V> remappingFunction) {
            throw new UnsupportedOperationException();
        }
        ...
        static class UnmodifiableEntrySet<K,V>
            ...
            static final class UnmodifiableEntrySetSpliterator<K, V>
                ...
                override
                public bool tryAdvance(Consumer<? super Entry<K, V>> action) {
                    Objects.requireNonNull(action);
             ...
             */
            private static class UnmodifiableEntry<K,V> : Map.Entry<K,V> {
                private Map.Entry<? : K, ? : V> e;

                UnmodifiableEntry(Map.Entry<? : K, ? : V> e)
    ...
    static class UnmodifiableNavigableMap<K,V>
         ...
         */
        private static class EmptyNavigableMap<K,V> : UnmodifiableNavigableMap<K,V>
            : Serializable {
     ...
     * @serial include
     */
    static class SynchronizedCollection<E> : Collection<E>, Serializable {
    ...
    private static class SynchronizedMap<K,V>
        ...
        public V computeIfAbsent(K key,
                Function<? super K, ? : V> mappingFunction) {
     ...
     * @serial include
     */
    static class CheckedCollection<E> : Collection<E>, Serializable {
        ...
        public <T> T[] toArray(T[] a)     { return c.toArray(a); }
        public String toString()          { return c.toString(); }
        public bool remove(Object o)   { return c.remove(o); }
        ...
        public Iterator<E> iterator() {
            ...
            return new Iterator<E>() {
                public bool hasNext() { return it.hasNext(); }
                public E next()          { return it.next(); }
                public void remove()     {        it.remove(); }};
            // Android-note: Should we delegate to it for forEachRemaining ?
        }

        public bool add(E e)          { return c.add(typeCheck(e)); }
        ...
        @SuppressWarnings("unchecked")
        Collection<E> checkedCopyOf(Collection<? : E> coll) {
            Object[] a;
            try {
        ...
        : Queue<E>, Serializable
    {
        ...
        public bool offer(E e)       {return queue.offer(typeCheck(e));}
    }
     ...
     * @serial include
     */
    static class CheckedSet<E> : CheckedCollection<E>
                                 : Set<E>, Serializable
    {
     ...
     * @serial include
     */
    static class CheckedSortedSet<E> : CheckedSet<E>
        : SortedSet<E>, Serializable
    {
...
/**
     ...
     * @serial include
     */
    static class CheckedNavigableSet<E> : CheckedSortedSet<E>
        : NavigableSet<E>, Serializable
    {
     ...
     * @serial include
     */
    static class CheckedRandomAccessList<E> : CheckedList<E>
                                            : RandomAccess
    {
        ...
        : Map<K,V>, Serializable
    {
        ...
        private BiFunction<? super K, ? super V, ? : V> typeCheck(
                BiFunction<? super K, ? super V, ? : V> func) {
        ...
        public bool isEmpty()               { return m.isEmpty(); }
        public bool containsKey(Object key) { return m.containsKey(key); }
        public bool containsValue(Object v) { return m.containsValue(v); }
        public V get(Object key)               { return m.get(key); }
         ...
         * @serial exclude
         */
        static class CheckedEntrySet<K,V> : Set<Map.Entry<K,V>> {
            ...
            public bool isEmpty() { return s.isEmpty(); }
            public String toString() { return s.toString(); }
            public int hashCode()    { return s.hashCode(); }
            public void clear()      {        s.clear(); }

            public bool add(Map.Entry<K, V> e) {
                throw new UnsupportedOperationException();
            }
            public bool addAll(Collection<? : Map.Entry<K, V>> coll) {
                throw new UnsupportedOperationException();
            }
            ...
            private bool batchRemove(Collection!(T) c, bool complement) {
             ...
             * Map.Entry when asked to perform an equality check.
             */
            private static class CheckedEntry<K,V,T> : Map.Entry<K,V> {
     ...
     * @serial include
     */
    static class CheckedSortedMap<K,V> : CheckedMap<K,V>
        : SortedMap<K,V>, Serializable
    {
     ...
     * @serial include
     */
    static class CheckedNavigableMap<K,V> : CheckedSortedMap<K,V>
        : NavigableMap<K,V>, Serializable
    {
    ...
    private static class EmptyIterator<E> : Iterator<E> {
        ...
        : ListIterator<E>
    {
        ...
        public bool hasPrevious() { return false; }
    ...
    private static class EmptyEnumeration<E> : Enumeration<E> {
        static final EmptyEnumeration<Object> EMPTY_ENUMERATION
            = new EmptyEnumeration<>();

        public bool hasMoreElements() { return false; }
        ...
        : Serializable
    {
        ...
        public bool containsAll(Collection!(T) c) { return c.isEmpty(); }
    ...
    private static class EmptyList<E>
        ...
        public bool equals(Object o) {
            return (o instanceof List) && ((List!(T))o).isEmpty();
        }
        ...
        : Serializable
    {
        ...
        public bool containsValue(Object value) {return false;}
    ...
    static <T> Spliterator<T> singletonSpliterator(final T element) {
        return new Spliterator<T>() {
            ...
            override
            public bool tryAdvance(Consumer<? super T> consumer) {
        ...
        : Serializable
    {
        ...
        public bool contains(Object o) {return eq(o, element);}
    ...
    private static class SingletonList<E>
        ...
        public bool contains(Object obj) {return eq(obj, element);}
    ...
    private static class SingletonMap<K,V>
        ...
        public bool containsKey(Object key)             {return eq(key, k);}
        public bool containsValue(Object value)       {return eq(value, v);}
     ...
     * @serial include
     */
    private static class ReverseComparator2<T> : Comparator<T>,
        Serializable
    {
     ...
     * @since 1.5
     */
    public static int frequency(Collection!(T) c, Object o) {
        int result = 0;
        if (o == null) {
            for (Object e : c)
                if (e == null)
     ...
     * @since 1.5
     */
    public static bool disjoint(Collection!(T) c1, Collection!(T) c2) {
        // The collection to be used for contains(). Preference is given to
        // the collection who's contains() has lower O() complexity.
        Collection!(T) contains = c2;
        // The collection to be iterated. If the collections' contains() impl
        // are of different O() complexity, the collection with slower
        // contains() will be used for iteration. For collections who's
        // contains() are of the same complexity then best performance is
        // achieved by iterating the smaller collection.
        Collection!(T) iterate = c1;
     ...
     */
    @SafeVarargs
    public static <T> bool addAll(Collection<? super T> c, T... elements) {
        bool result = false;
     ...
     * @serial include
     */
    private static class SetFromMap<E> : AbstractSet<E>
        : Set<E>, Serializable
    {
        ...
        public int size()                 { return m.size(); }
        public bool isEmpty()          { return m.isEmpty(); }
        public bool contains(Object o) { return m.containsKey(o); }
        public bool remove(Object o)   { return m.remove(o) != null; }
        public bool add(E e) { return m.put(e, Boolean.TRUE) == null; }
        public Iterator<E> iterator()     { return s.iterator(); }
        public Object[] toArray()         { return s.toArray(); }
        public <T> T[] toArray(T[] a)     { return s.toArray(a); }
        public String toString()          { return s.toString(); }
        public int hashCode()             { return s.hashCode(); }
        public bool equals(Object o)   { return o == this || s.equals(o); }
        public bool containsAll(Collection!(T) c) {return s.containsAll(c);}
        public bool removeAll(Collection!(T) c)   {return s.removeAll(c);}
        public bool retainAll(Collection!(T) c)   {return s.retainAll(c);}
     ...
     * @serial include
     */
    static class AsLIFOQueue<E> : AbstractQueue<E>
        : Queue<E>, Serializable {
        private static final long serialVersionUID = 1802017725587941708L;
        private final Deque<E> q;
        AsLIFOQueue(Deque<E> q)           { this.q = q; }
        public bool add(E e)           { q.addFirst(e); return true; }
        public bool offer(E e)         { return q.offerFirst(e); }
        ...
        public bool isEmpty()          { return q.isEmpty(); }
        public bool contains(Object o) { return q.contains(o); }
        public bool remove(Object o)   { return q.remove(o); }
        public Iterator<E> iterator()     { return q.iterator(); }
        public Object[] toArray()         { return q.toArray(); }
        public <T> T[] toArray(T[] a)     { return q.toArray(a); }
        public String toString()          { return q.toString(); }
        public bool containsAll(Collection!(T) c) {return q.containsAll(c);}
        public bool removeAll(Collection!(T) c)   {return q.removeAll(c);}
        public bool retainAll(Collection!(T) c)   {return q.retainAll(c);}
