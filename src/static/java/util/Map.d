...
public interface Map<K, V> {
    ...
    interface Entry<K, V> {
         ...
         * @since 1.8
         */
        public static <K : Comparable<? super K>, V> Comparator<Map.Entry<K, V>> comparingByKey() {
         ...
         * @since 1.8
         */
        public static <K, V : Comparable<? super V>> Comparator<Map.Entry<K, V>> comparingByValue() {
            return (Comparator<Map.Entry<K, V>> & Serializable)
     ...
     * @since 1.8
     */
    default void replaceAll(BiFunction<? super K, ? super V, ? : V> function) {
     ...
     * @since 1.8
     */
    default bool remove(Object key, Object value) {
     ...
     * @since 1.8
     */
    default bool replace(K key, V oldValue, V newValue) {
        Object curValue = get(key);
