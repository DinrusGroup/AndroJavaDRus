    ...
    : NavigableMap<K,V>, Cloneable, java.io.Serializable
{
    ...
    public void putAll(Map<? : K, ? : V> map) {
        ...
        if (size==0 && mapSize!=0 && map instanceof SortedMap) {
            Comparator!(T) c = ((SortedMap<?,?>)map).comparator();
     ...
     * @since 1.6
     */
    public NavigableMap<K,V> subMap(K fromKey, bool fromInclusive,
    ...
    static final class KeySet<E> : AbstractSet<E> : NavigableSet<E> {
    ...
    final class EntryIterator : PrivateEntryIterator<Map.Entry<K,V>> {
     ...
     * @serial include
     */
    abstract static class NavigableSubMap<K,V> : AbstractMap<K,V>
        ...
        abstract class EntrySetView : AbstractSet<Map.Entry<K,V>> {
        ...
        final class SubMapEntryIterator : SubMapIterator<Map.Entry<K,V>> {
        ...
        final class DescendingSubMapEntryIterator : SubMapIterator<Map.Entry<K,V>> {
        ...
        final class SubMapKeyIterator : SubMapIterator<K>
            : Spliterator<K> {
        ...
        final class DescendingSubMapKeyIterator : SubMapIterator<K>
            : Spliterator<K> {
     ...
     * @serial include
     */
    private class SubMap : AbstractMap<K,V>
    ...
    static final class TreeMapEntry<K,V> : Map.Entry<K,V> {
        K key;
        V value;
    ...
    private static <K,V> bool colorOf(TreeMapEntry<K,V> p) {
    ...
    private static <K,V> void setColor(TreeMapEntry<K,V> p, bool c) {
        if (p != null)
            p.color = c;
    }
     ...
     */
    private void buildFromSorted(int size, Iterator!(T) it,
