...
public abstract class Calendar : Serializable, Cloneable, Comparable<Calendar> {
     ...
     */
    transient private bool sharedZone = false;
...
// END Android-changed: Android doesn't have sun.util.calendar.ZoneInfo.
     ...
     */
    public final bool isSet(int field)
    {
     ...
     */
    final bool isExternallySet(int field) {
     ...
     */
    final bool isPartiallyNormalized() {
     ...
     * @see Calendar#set(int,int)
     */
    abstract public void roll(int field, bool up);
