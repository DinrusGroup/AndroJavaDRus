...
public final class Spliterators {
     ...
     * <em><a href="Spliterator.html#binding">late-binding</a></em>, inherits
     * the <em>fail-fast</em> properties of the iterator, and :
     * {@code trySplit} to permit limited parallelism.
     *
    ...
    public static PrimitiveIterator.OfInt iterator(Spliterator.OfInt spliterator) {
        Objects.requireNonNull(spliterator);
        class Adapter : PrimitiveIterator.OfInt, IntConsumer {
            bool valueReady = false;
            int nextElement;
    ...
    public static PrimitiveIterator.OfLong iterator(Spliterator.OfLong spliterator) {
        Objects.requireNonNull(spliterator);
        class Adapter : PrimitiveIterator.OfLong, LongConsumer {
            bool valueReady = false;
            long nextElement;
    ...
    public static PrimitiveIterator.OfDouble iterator(Spliterator.OfDouble spliterator) {
        Objects.requireNonNull(spliterator);
        class Adapter : PrimitiveIterator.OfDouble, DoubleConsumer {
            bool valueReady = false;
            double nextElement;
    ...
    private static abstract class EmptySpliterator<T, S : Spliterator<T>, C> {
        ...
        public bool tryAdvance(C consumer) {
     ...
     */
    static final class ArraySpliterator<T> : Spliterator<T> {
        /**
     ...
     */
    static final class IntArraySpliterator : Spliterator.OfInt {
     ...
     * elements maintained in an unmodifiable {@code int[]} array.
     */
    static final class LongArraySpliterator : Spliterator.OfLong {
     ...
     * elements maintained in an unmodifiable {@code int[]} array.
     */
    static final class DoubleArraySpliterator : Spliterator.OfDouble {
    ...
    /**
     * An abstract {@code Spliterator} that : {@code trySplit} to
     ...
     * @since 1.8
     */
    public static abstract class AbstractSpliterator<T> : Spliterator<T> {
        ...
        static final class HoldingConsumer<T> : Consumer<T> {
            Object value;
    ...
    /**
     * An abstract {@code Spliterator.OfInt} that : {@code trySplit} to
     * permit limited parallelism.
     *
     ...
     * @since 1.8
     */
    public static abstract class AbstractIntSpliterator : Spliterator.OfInt {
        ...
        static final class HoldingIntConsumer : IntConsumer {
            int value;
    ...
    /**
     * An abstract {@code Spliterator.OfLong} that : {@code trySplit}
     ...
     * @since 1.8
     */
    public static abstract class AbstractLongSpliterator : Spliterator.OfLong {
        static final int MAX_BATCH = AbstractSpliterator.MAX_BATCH;
        static final int BATCH_UNIT = AbstractSpliterator.BATCH_UNIT;
        private final int characteristics;
        private long est;             // size estimate
        ...
        static final class HoldingLongConsumer : LongConsumer {
            long value;
    ...
    /**
     * An abstract {@code Spliterator.OfDouble} that :
     * {@code trySplit} to permit limited parallelism.
     *
     * <p>To implement a spliterator an extending class need only
     ...
     * @since 1.8
     */
    public static abstract class AbstractDoubleSpliterator : Spliterator.OfDouble {
        static final int MAX_BATCH = AbstractSpliterator.MAX_BATCH;
        static final int BATCH_UNIT = AbstractSpliterator.BATCH_UNIT;
        private final int characteristics;
        private long est;             // size estimate
        ...
        static final class HoldingDoubleConsumer : DoubleConsumer {
            double value;
     ...
     * operations. The spliterator : {@code trySplit} to
     * permit limited parallelism.
     */
    static class IteratorSpliterator<T> : Spliterator<T> {
        static final int BATCH_UNIT = 1 << 10;  // batch array size increment
        static final int MAX_BATCH = 1 << 25;  // max batch array size;
     ...
     * permit limited parallelism.
     */
    static final class IntIteratorSpliterator : Spliterator.OfInt {
    ...
    static final class LongIteratorSpliterator : Spliterator.OfLong {
        static final int BATCH_UNIT = IteratorSpliterator.BATCH_UNIT;
        static final int MAX_BATCH = IteratorSpliterator.MAX_BATCH;
    ...
    static final class DoubleIteratorSpliterator : Spliterator.OfDouble {
        static final int BATCH_UNIT = IteratorSpliterator.BATCH_UNIT;
        static final int MAX_BATCH = IteratorSpliterator.MAX_BATCH;
