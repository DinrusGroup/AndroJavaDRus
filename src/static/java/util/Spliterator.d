 ...
 * }
 *
 * static class ParEach<T> : CountedCompleter<Void> {
...
public interface Spliterator<T> {
     ...
     * @since 1.8
     */
    public interface OfPrimitive<T, T_CONS, T_SPLITR : Spliterator.OfPrimitive<T, T_CONS, T_SPLITR>>
            : Spliterator<T> {
        override
        T_SPLITR trySplit();
     ...
     * @since 1.8
     */
    public interface OfInt : OfPrimitive<Integer, IntConsumer, OfInt> {
     ...
     * @since 1.8
     */
    public interface OfLong : OfPrimitive<Long, LongConsumer, OfLong> {
     ...
     * @since 1.8
     */
    public interface OfDouble : OfPrimitive<Double, DoubleConsumer, OfDouble> {
