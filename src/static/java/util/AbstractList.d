...
public abstract class AbstractList<E> : AbstractCollection<E> : List<E> {
     ...
     *
     * <p>This implementation returns a straightforward implementation of the
     * {@code ListIterator} interface that : the implementation of the
     ...
     * of the subclass, one of which : {@code RandomAccess}.
     * If this list : {@code RandomAccess} the returned list will
     * be an instance of the subclass that : {@code RandomAccess}.
     *
