...
public interface CallableStatement : PreparedStatement {
     ...
     * <code>bool</code> in the Java programming language.
     *
     * @param parameterIndex the first parameter is 1, the second is 2,
     *        and so on
     * @return the parameter value.  If the value is SQL <code>NULL</code>,
     ...
     * @since 1.2
     */
    Object getObject(int parameterIndex, java.util.Map<String,Class!(T)> map)
        throws SQLException;
  ...
  //--------------------------JDBC 3.0-----------------------------
     ...
     * @since 1.4
     */
    Object getObject(String parameterName, java.util.Map<String,Class!(T)> map)
      throws SQLException;
