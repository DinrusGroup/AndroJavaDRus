...
public interface Statement : Wrapper, AutoCloseable {
  ...
  //--------------------------JDBC 3.0-----------------------------
     ...
     * @since 1.4
     */
    bool execute(String sql, int autoGeneratedKeys) throws SQLException;
     ...
     * @since 1.4
     */
    bool execute(String sql, String columnNames[]) throws SQLException;
   ...
   /**
    ...
    bool isClosed() throws SQLException;
         ...
         * @since 1.6
         * <p>
         * @see java.sql.Statement#setPoolable(bool) setPoolable(bool)
         */
        bool isPoolable()
                throws SQLException;
