 ...
 * <ul>
 * <li>create a class that : the {@link SQLData}
...
public interface Array {
   ...
   * @since 1.2
   */
  Object getArray(java.util.Map<String,Class!(T)> map) throws SQLException;
   ...
   * @since 1.2
   */
  Object getArray(long index, int count, java.util.Map<String,Class!(T)> map)
    throws SQLException;
   ...
   * @since 1.2
   */
  ResultSet getResultSet (java.util.Map<String,Class!(T)> map) throws SQLException;
  ...
  ResultSet getResultSet (long index, int count,
                          java.util.Map<String,Class!(T)> map)
    throws SQLException;
    /**
