...
public interface ResultSet : Wrapper, AutoCloseable {
     ...
     * Retrieves the value of the designated column in the current row
     * of this <code>ResultSet</code> object as
     * a <code>bool</code> in the Java programming language.
     *
     ...
     *            called on a closed result set
     */
    bool getBoolean(String columnLabel) throws SQLException;
    ...
    /**
     * Updates the designated column with a <code>bool</code> value.
     * The updater methods are used to update column values in the
     * current row or the insert row.  The updater methods do not
     ...
     * @since 1.2
     */
    void updateBoolean(String columnLabel, bool x) throws SQLException;
     ...
     * @since 1.2
     */
    Object getObject(int columnIndex, java.util.Map<String,Class!(T)> map)
        throws SQLException;
     ...
     * @since 1.2
     */
    Object getObject(String columnLabel, java.util.Map<String,Class!(T)> map)
      throws SQLException;
