 ...
 * as ICU4J.
 */
public class IcuZoneRulesProvider : ZoneRulesProvider {
     ...
     */
    private static void verify(bool check, String zoneId, String message) {
        if (!check) {
    ...
    private static class ZoneRulesCache : BasicLruCache<String, ZoneRules> {
