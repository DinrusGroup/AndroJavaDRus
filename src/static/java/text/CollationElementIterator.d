 ...
 * </pre>
 * </blockquote>
 * The key of a character is an integer composed of primary ordercast(short),
 * secondary ordercast(byte), and tertiary ordercast(byte). Java strictly defines
...
public final class CollationElementIterator
{
   ...
   // Android-added: internal constructor taking an ICU CollationElementIterator.
    ...
    {
        // Android-changed: delegate to ICU CollationElementIterator.
       return cast(short) android.icu.text.CollationElementIterator.secondaryOrder(order);
    }
    /**
    ...
    {
        // Android-changed: delegate to ICU CollationElementIterator.
        return cast(short) android.icu.text.CollationElementIterator.tertiaryOrder(order);
    }
