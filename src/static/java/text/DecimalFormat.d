...
public class DecimalFormat : NumberFormat {
    ...
    public DecimalFormat() {
        ...
        */
        ...
        // Android-changed: use initPattern() instead of removed applyPattern(String, bool).
     ...
     */
    override
    public void setParseIntegerOnly(bool value) {
    ...
    private bool compareIcuRoundingIncrement(android.icu.text.DecimalFormat_ICU58_Android other) {
    ...
    // Android-removed: private helper methods expandAffixes(), expandAffix(), toPattern(bool).
    ...
    // Android-removed: applyPattern(String, bool) as apply[Localized]Pattern calls ICU directly.
    ...
    private static final ObjectStreamField[] serialPersistentFields = {
            ...
            new ObjectStreamField("groupingUsed", bool.class),
            new ObjectStreamField("decimalSeparatorAlwaysShown", bool.class),
            new ObjectStreamField("parseBigDecimal", bool.class),
            new ObjectStreamField("roundingMode", RoundingMode.class),
            new ObjectStreamField("symbols", DecimalFormatSymbols.class),
            new ObjectStreamField("useExponentialNotation", bool.class),
    ...
    private void writeObject(ObjectOutputStream stream) throws IOException, ClassNotFoundException {
        ...
        fields.put("groupingSize", cast(byte) icuDecimalFormat.getGroupingSize());
        ...
        fields.put("minExponentDigits", cast(byte) 0);
    ...
    private void readObject(ObjectInputStream stream)
        ...
        bool parseBigDecimal = fields.get("parseBigDecimal", true);
