...
public class SimpleDateFormat : DateFormat {
     ...
     */
    transient private bool hasFollowingMinusSign = false;
     ...
     */
    transient bool useDateFormatSymbols;
                           ...
                           bool useDateFormatSymbols)
    {
        ...
        // BEGIN Android-changed: use shared code in TimeZone for zone offset string.
        {
            ...
            final bool includeSeparator = (count >= 4);
            final bool includeGmt = (count == 4);
    ...
    private String formatWeekday(int count, int value, bool useDateFormatSymbols,
                                 bool standalone) {
        if (useDateFormatSymbols) {
    ...
    private String formatMonth(int count, int value, int maxIntCount, StringBuffer buffer,
                               bool useDateFormatSymbols, bool standalone) {
        String current = null;
        if (useDateFormatSymbols) {
            final String[] months;
            if (count == 4) {
    ...
    private int subParseZoneStringFromICU(String text, int start, CalendarBuilder calb) {
        ...
        bool isDst = DST_NAME_TYPES.contains(bestMatch.nameType());
    ...
    private int subParseNumericZone(String text, int start, int sign, int count,
                                    bool colonRequired, CalendarBuilder calb) {
        int index = start;
    ...
    private int subParse(String text, int start, int patternCharIndex, int count,
                         bool obeyCount, bool[] ambiguousYear,
                         ParsePosition origPos,
                         bool useFollowingMinusSignAsDelimiter, CalendarBuilder calb) {
        Number number;
        int value = 0;
    ...
    private int parseMonth(String text, int count, int value, int start,
                           int field, ParsePosition pos, bool useDateFormatSymbols,
                           bool standalone,
                           CalendarBuilder out) {
    ...
    private int parseWeekday(String text, int start, int field, bool useDateFormatSymbols,
                             bool standalone, CalendarBuilder out) {
        int index = -1;
        if (useDateFormatSymbols) {
            // Want to be able to parse both short and long forms.
    ...
    private bool isGregorianCalendar() {
