...
class ExpiringCache {
   ...
   // @SuppressWarnings("serial")
    this(long millisUntilExpiration) {
        ...
        map = new LinkedHashMap!(String,Entry)() {
            ...
            // protected bool removeEldestEntry(Map.Entry<String,Entry> eldest) {
            protected bool removeEldestEntry(Map.Entry!(String,ExpiringCache.Entry) eldest) {
