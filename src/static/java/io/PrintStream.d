    ...
    : Appendable, Closeable
{
    ...
    private PrintStream(bool autoFlush, OutputStream out) {
        super(out);
    ...
    private PrintStream(bool autoFlush, OutputStream out, Charset charset) {
        super(out);
        this.autoFlush = autoFlush;
        // Android-changed: Lazy initialization of charOut and textOut.
     ...
     * charset name.
     */
    private PrintStream(bool autoFlush, Charset charset, OutputStream out)
        throws UnsupportedEncodingException
    {
     ...
     * @param  out        The output stream to which values and objects will be
     *                    printed
     * @param  autoFlush  A bool; if true, the output buffer will be flushed
     *                    whenever a byte array is written, one of the
     *                    <code>println</code> methods is invoked, or a newline
     *                    character or byte (<code>'\n'</code>) is written
     *
     * @see java.io.PrintWriter#PrintWriter(java.io.OutputStream, bool)
     */
    ...
    /**
     * Prints a bool and then terminate the line.  This method behaves as
     * though it invokes <code>{@link #print(bool)}</code> and then
     * <code>{@link #println()}</code>.
     *
     * @param x  The <code>bool</code> to be printed
     */
