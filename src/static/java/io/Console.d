...
public final class Console : Flushable
{
   /**
    ...
    */
    ...
    private static native bool echo(bool on) throws IOException;
    private static bool echoOff;

    private char[] readline(bool zeroOut) throws IOException {
    ...
    private native static bool istty();
    private this() {
    ...
    private this(InputStream inStream, OutputStream outStream) {
