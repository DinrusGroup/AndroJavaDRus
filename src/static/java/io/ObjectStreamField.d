    ...
    : Comparable<Object>
{
     ...
     */
    public ObjectStreamField(String name, Class!(T) type) {
     ...
     * @since   1.4
     */
    public ObjectStreamField(String name, Class!(T) type, bool unshared) {
        if (name == null) {
     ...
     */
    ObjectStreamField(String name, String signature, bool unshared) {
        if (name == null) {
            throw new NullPointerException();
        }
        this.name = name;
     ...
     */
    ObjectStreamField(Field field, bool unshared, bool showType) {
        this.field = field;
        this.unshared = unshared;
        name = field.getName();
        Class!(T) ftype = field.getType();
    ...
    /**
     * Returns bool value indicating whether or not the serializable field
