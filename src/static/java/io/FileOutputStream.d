...
class FileOutputStream : OutputStream
{
   ...
   // @ReachabilitySensitive
     ...
     */
    public this(FileDescriptor fdObj) {
     ...
     * @hide
     */
    public this(FileDescriptor fdObj, bool isFdOwner) {
        if (fdObj == null) {
     ...
     */
    private native void open0(String name, bool append) ;
    ...
    // Android-removed: write(int, bool), use IoBridge instead.
    /*
    /**
     ...
     *
    private native void write(int b, bool append) throws IOException;
    */
    ...
    public void write(int b) {
        ...
        write(new byte[] { cast(byte) b }, 0, 1);
    }
     ...
     *
    private native void writeBytes(byte b[], int off, int len, bool append)
        throws IOException;
    */
