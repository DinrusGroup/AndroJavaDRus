...
public class RandomAccessFile : DataOutput, DataInput, Closeable {
     ...
     * java.nio.channels.FileChannel#force(bool) force(bool)} method of
     ...
     * @see        java.lang.SecurityManager#checkRead(java.lang.String)
     * @see        java.lang.SecurityManager#checkWrite(java.lang.String)
     * @see        java.nio.channels.FileChannel#force(bool)
     * @revised 1.4
     * @spec JSR-51
     */
    ...
    /**
     * Reads a {@code bool} from this file. This method reads a
     ...
     * @exception  IOException   if an I/O error occurs.
     */
    public final bool readBoolean() throws IOException {
        int ch = this.read();
        if (ch < 0)
            throw new EOFException();
        return (ch != 0);
    ...
    /**
     * Writes a {@code bool} to the file as a one-byte value. The
     * value {@code true} is written out as the value
     * {@code cast(byte)1}; the value {@code false} is written out
     * as the value {@code cast(byte)0}. The write starts at
     * the current position of the file pointer.
     *
     * @param      v   a {@code bool} value to be written.
     * @exception  IOException  if an I/O error occurs.
     */
    public final void writeBoolean(bool v) throws IOException {
        write(v ? 1 : 0);
        //written++;
    }
