 ...
 * @since 1.6
 */
public final class HttpCookie : Cloneable {
    ...
    private bool httpOnly;   // HttpOnly ... i.e. not accessible to scripts
    ...
    */
    ...
    // class.
    private static List<HttpCookie> parse(String header, bool retainHeader) {
     ...
     *
     * @return  a {@code bool} to represent this cookie's discard attribute
     *
     * @see  #setDiscard
     */
    ...
    private static bool isFullyQualifiedDomainName(String s, int firstCharacter) {
