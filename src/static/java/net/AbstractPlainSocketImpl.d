 ...
 */
abstract class AbstractPlainSocketImpl : SocketImpl
{
    ...
    */
     ...
     */
    protected synchronized void create(bool stream) throws IOException {
        this.stream = stream;
        if (!stream) {
    ...
    protected bool supportsUrgentData () {
        return true;
    }
    ...
    public bool isConnectionResetPending() {
        synchronized (resetLock) {
    ...
    abstract void socketCreate(bool isServer) throws IOException;
    ...
    abstract int socketAvailable()
        throws IOException;
    abstract void socketClose0(bool useDeferredClose)
        throws IOException;
