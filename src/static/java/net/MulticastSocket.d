...
class MulticastSocket : DatagramSocket {
     ...
     * {@link DatagramSocket#setReuseAddress(bool)} method is
     ...
     * @see java.net.DatagramSocket#setReuseAddress(bool)
     */
     ...
     * @see #getLoopbackMode
     */
    public void setLoopbackMode(bool disable) throws SocketException {
     ...
     * @see #setLoopbackMode
     */
    public bool getLoopbackMode() throws SocketException {
        return ((Boolean)getImpl().getOption(SocketOptions.IP_MULTICAST_LOOP)).boolValue();
    }
