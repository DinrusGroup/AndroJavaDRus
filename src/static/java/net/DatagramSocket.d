...
class DatagramSocket : java.io.Closeable {
    ...
    void createImpl() throws SocketException {
        if (impl == null) {
            if (factory != null) {
                ...
                bool isMulticast = (this instanceof MulticastSocket) ? true : false;
    ...
    private bool checkFiltering(DatagramPacket p) throws SocketException {
     ...
     * @see #isClosed()
     */
    public synchronized void setReuseAddress(bool on) throws SocketException {
        if (isClosed())
            throw new SocketException("Socket is closed");
     ...
     *
     * @return a {@code bool} indicating whether or not SO_REUSEADDR is enabled.
     * @exception SocketException if there is an error
     * in the underlying protocol, such as an UDP error.
     * @since   1.4
     * @see #setReuseAddress(bool)
     */
    public synchronized bool getReuseAddress() throws SocketException {
        if (isClosed())
            throw new SocketException("Socket is closed");
        Object o = getImpl().getOption(SocketOptions.SO_REUSEADDR);
        return ((Boolean)o).boolValue();
    }
     ...
     * @see #getBroadcast()
     */
    public synchronized void setBroadcast(bool on) throws SocketException {
        if (isClosed())
            throw new SocketException("Socket is closed");
     ...
     * @return a {@code bool} indicating whether or not SO_BROADCAST is enabled.
     * @exception SocketException if there is an error
     * in the underlying protocol, such as an UDP error.
     * @since 1.4
     * @see #setBroadcast(bool)
     */
    public synchronized bool getBroadcast() throws SocketException {
        if (isClosed())
            throw new SocketException("Socket is closed");
        return ((Boolean)(getImpl().getOption(SocketOptions.SO_BROADCAST))).boolValue();
    }
