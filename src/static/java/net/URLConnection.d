 ...
 * @see     java.net.URLConnection#setAllowUserInteraction(bool)
 * @see     java.net.URLConnection#setDefaultUseCaches(bool)
 * @see     java.net.URLConnection#setDoInput(bool)
 * @see     java.net.URLConnection#setDoOutput(bool)
 * @see     java.net.URLConnection#setIfModifiedSince(long)
 * @see     java.net.URLConnection#setRequestProperty(java.lang.String, java.lang.String)
 * @see     java.net.URLConnection#setUseCaches(bool)
 * @since   JDK1.0
 */
public abstract class URLConnection {
   ...
   /**
     ...
     * @see     java.net.URLConnection#setDoOutput(bool)
     */
    protected bool doOutput = false;

    private static bool defaultAllowUserInteraction = false;
   ...
   /**
     ...
     * @see     java.net.URLConnection#setAllowUserInteraction(bool)
     * @see     java.net.URLConnection#setDefaultAllowUserInteraction(bool)
     */
    protected bool allowUserInteraction = defaultAllowUserInteraction;

    private static bool defaultUseCaches = true;
   ...
   /**
     ...
     * @see     java.net.URLConnection#setDefaultUseCaches(bool)
     */
    protected bool useCaches = defaultUseCaches;
    ...
    */
     ...
     */
    public void setAllowUserInteraction(bool allowuserinteraction) {
        if (connected)
            throw new IllegalStateException("Already connected");
     ...
     *          this object.
     * @see     #setAllowUserInteraction(bool)
     */
     ...
     */
    public static void setDefaultAllowUserInteraction(bool defaultallowuserinteraction) {
     ...
     *          field.
     * @see     #setDefaultAllowUserInteraction(bool)
     */
     ...
     * true.
     *
     * @param usecaches a {@code bool} indicating whether
   ...
   /**
     ...
     */
    public void setDefaultUseCaches(bool defaultusecaches) {
     ...
     */
    static private bool checkfpx(InputStream is) throws IOException {
