...
class Inet4Address : InetAddress {
    ...
    public static final InetAddress ALL =
            new Inet4Address(null, new byte[] { cast(byte) 255, cast(byte) 255,
                  cast(byte) 255, cast(byte) 255 });
    /** @hide */
    ...
    */
    ...
    public byte[] getAddress() {
        ...
        addr[0] = cast(byte) ((address >>> 24) & 0xFF);
        addr[1] = cast(byte) ((address >>> 16) & 0xFF);
        addr[2] = cast(byte) ((address >>> 8) & 0xFF);
        addr[3] = cast(byte) (address & 0xFF);
        return addr;
    }
