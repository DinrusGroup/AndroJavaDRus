...
public class URLClassLoader : SecureClassLoader : Closeable {
    ...
    */
     ...
     */
    protected Class!(T) findClass(final String name)
        throws ClassNotFoundException
    {
        final Class!(T) result;
        try {
            result = AccessController.doPrivileged(
                new PrivilegedExceptionAction<Class!(T)>() {
     ...
     * used.
     */
    private Class!(T) defineClass(String name, Resource res) throws IOException {
...
final class FactoryURLClassLoader : URLClassLoader {
    ...
    public final Class!(T) loadClass(String name, bool resolve)
        throws ClassNotFoundException
    {
