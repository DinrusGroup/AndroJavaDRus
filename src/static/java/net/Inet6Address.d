...
class Inet6Address : InetAddress {
    ...
    */
    ...
    private class Inet6AddressHolder {
        ...
        private Inet6AddressHolder(
            byte[] ipaddress, int scope_id, bool scope_id_set,
            NetworkInterface ifname, bool scope_ifname_set)
        {
    ...
    */
    ...
    private static bool isDifferentLocalAddressType(
     ...
     * @serialField scope_id_set bool
     * @serialField scope_ifname_set bool
    ...
    private static final ObjectStreamField[] serialPersistentFields = {
         ...
         new ObjectStreamField("scope_id_set", bool.class),
         new ObjectStreamField("scope_ifname_set", bool.class),
     ...
     *
     * @return a {@code bool} indicating if the InetAddress is an IP
     *         multicast address
     *
     * @since JDK1.1
     */
     ...
     *
     * @return a {@code bool} indicating if the Inetaddress is
     *         a wildcard address.
     *
     * @since 1.4
     */
     ...
     *
     * @return a {@code bool} indicating if the InetAddress is a loopback
     ...
     *
     * @return a {@code bool} indicating if the InetAddress is a link local
    ...
    static bool isLinkLocalAddress(byte[] ipaddress) {
        return ((ipaddress[0] & 0xff) == 0xfe
                && (ipaddress[1] & 0xc0) == 0x80);
    }
     ...
     *
     * @return a {@code bool} indicating if the InetAddress is a site local
    ...
    /* static version of above */
    static bool isSiteLocalAddress(byte[] ipaddress) {
        return ((ipaddress[0] & 0xff) == 0xfe
                && (ipaddress[1] & 0xc0) == 0xc0);
    }
     ...
     *
     * @return a {@code bool} indicating if the address has is a multicast
     ...
     *
     * @return a {@code bool} indicating if the InetAddress is an IPv4
