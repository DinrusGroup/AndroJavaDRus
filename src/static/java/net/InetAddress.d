 ...
 */
public
class InetAddress : java.io.Serializable.Serializable {
    ...
    */
    ...
    static {
        preferIPv6Address = java.security.AccessController.doPrivileged(
            new GetBooleanAction("java.net.preferIPv6Addresses")).boolValue();
    ...
    */
     ...
     *
     * @return a {@code bool} indicating if the address has
     ...
     * @return a {@code bool} indicating if the address is reachable.
     * @throws IOException if a network error occurs
     * @throws  IllegalArgumentException if {@code timeout} is negative.
     * @since 1.5
     */
    public bool isReachable(int timeout) throws IOException {
     ...
     * @since 1.5
     */
    public bool isReachable(NetworkInterface netif, int ttl,
     ...
     */
    public bool isReachableByICMP(int timeout) throws IOException {
    ...
    */
     ...
     */
    public static bool isNumeric(String address) {
    ...
    static InetAddress[] getAllByName0(String authHost, bool check) throws UnknownHostException {
...
class InetAddressImplFactory {
    ...
    static native bool isIPv6Supported();
}
*/
// END Android-removed: Android doesn't load user-provided implementation.
