...
public final class NetworkInterface {
    ...
    public Enumeration<InetAddress> getInetAddresses() {
        ...
        class checkedAddresses : Enumeration<InetAddress> {
    ...
    public bool isUp() throws SocketException {
        // Android-changed: Rewrote NetworkInterface on top of Libcore.io.
    ...
    public bool isLoopback() throws SocketException {
        // Android-changed: Rewrote NetworkInterface on top of Libcore.io.
    ...
    public bool isPointToPoint() throws SocketException {
        // Android-changed: Rewrote NetworkInterface on top of Libcore.io.
    ...
    public bool supportsMulticast() throws SocketException {
        // Android-changed: Rewrote NetworkInterface on top of Libcore.io.
    ...
    /*
    private native static bool isUp0(String name, int ind) throws SocketException;
    private native static bool isLoopback0(String name, int ind) throws SocketException;
    private native static bool supportsMulticast0(String name, int ind) throws SocketException;
    private native static bool isP2P0(String name, int ind) throws SocketException;
