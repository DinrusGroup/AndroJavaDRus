 ...
 *       {@link #setDoOutput(bool) setDoOutput(true)} if they include a
 ...
 * {@link #setDoOutput(bool) setDoOutput(true)}.
 *
 ...
 * @since JDK1.1
 */
abstract public class HttpURLConnection : URLConnection {
    /* instance variables */
    ...
    private static bool followRedirects = true;
     ...
     */
    protected bool instanceFollowRedirects = followRedirects;
     ...
     *
     * @param set a {@code bool} indicating whether or not
     ...
     */
    public static void setFollowRedirects(bool set) {
    ...
    /**
     * Returns a {@code bool} indicating
     ...
     * true.
     *
     * @param followRedirects a {@code bool} indicating
     ...
     * @return a bool indicating if the connection is
     * using a proxy.
     */
