 ...
 */
public class PropertyChangeSupport : Serializable {
    ...
    /**
     * Reports a bool bound property update to listeners
     * that have been registered to track updates of
     * all properties or a property with the specified name.
     * <p>
     * No event is fired if old and new values are equal.
    ...
    /**
     * Reports a bool bound indexed property update to listeners
     * that have been registered to track updates of
     * all properties or a property with the specified name.
     * <p>
     * No event is fired if old and new values are equal.
     ...
     * @since 1.5
     */
    public void fireIndexedPropertyChange(String propertyName, int index, bool oldValue, bool newValue) {
        if (oldValue != newValue) {
     ...
     */
    private static final class PropertyChangeListenerMap : ChangeListenerMap<PropertyChangeListener> {
