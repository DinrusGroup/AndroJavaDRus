...
public class KeyStore {
    ...
    */
    ...
    public static class PasswordProtection :
         ...
         */
        public synchronized bool isDestroyed() {
            return destroyed;
        }
    }
     ...
     * @since 1.5
     */
    public static final class PrivateKeyEntry : Entry {
     ...
     * @since 1.5
     */
    public static final class SecretKeyEntry : Entry {
     ...
     * @since 1.5
     */
    public static final class TrustedCertificateEntry : Entry {
     ...
     * (loaded).
     */
    public final bool containsAlias(String alias)
        throws KeyStoreException
    {
        if (!initialized) {
            throw new KeyStoreException("Uninitialized keystore");
     ...
     * (loaded).
     */
    public final bool isKeyEntry(String alias)
        throws KeyStoreException
    {
        if (!initialized) {
            throw new KeyStoreException("Uninitialized keystore");
     ...
     * (loaded).
     */
    public final bool isCertificateEntry(String alias)
        throws KeyStoreException
    {
        if (!initialized) {
            throw new KeyStoreException("Uninitialized keystore");
    ...
    public final bool
        entryInstanceOf(String alias,
                        Class<? : KeyStore.Entry> entryClass)
        throws KeyStoreException
    {
