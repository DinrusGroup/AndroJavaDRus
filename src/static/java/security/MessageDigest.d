 ...
 * processed through it using the {@link #updatecast(byte) update}
...
public abstract class MessageDigest : MessageDigestSpi {
    ...
    */
    ...
    /**
     * Returns a MessageDigest object that : the specified digest
     * algorithm.
     *
     ...
     * for information about standard algorithm names.
     *
     * @return a Message Digest object that : the specified algorithm.
     *
     ...
     *
     * @return a MessageDigest object that : the specified algorithm.
     *
    ...
    static class Delegate : MessageDigest {
