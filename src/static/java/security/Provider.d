 ...
 * Java Security API, where a provider : some or all parts of
...
public abstract class Provider : Properties {
     ...
     */
    override
    public synchronized bool remove(Object key, Object value) {
        check("removeProviderProperty."+name);
        if (debug != null) {
            debug.println("Remove " + name + " provider property " + key);
        }
     ...
     */
    override
    public synchronized bool replace(Object key, Object oldValue,
            Object newValue) {
        check("putProviderProperty." + name);
     ...
     */
    override
    public synchronized void replaceAll(BiFunction<? super Object, ? super Object, ? : Object> function) {
        check("putProviderProperty." + name);
    ...
    public synchronized Object compute(Object key,
        BiFunction<? super Object, ? super Object, ? : Object> remappingFunction) {
        check("putProviderProperty." + name);
        check("removeProviderProperty" + name);
     ...
     */
    override
    public synchronized Object computeIfAbsent(Object key, Function<? super Object, ? : Object> mappingFunction) {
        check("putProviderProperty." + name);
        check("removeProviderProperty" + name);
     ...
     */
    override
    public synchronized Object computeIfPresent(Object key, BiFunction<? super Object, ? super Object, ? : Object> remappingFunction) {
        check("putProviderProperty." + name);
        check("removeProviderProperty" + name);
     ...
     */
    override
    public synchronized Object merge(Object key, Object value,  BiFunction<? super Object, ? super Object, ? : Object>  remappingFunction) {
        check("putProviderProperty." + name);
        check("removeProviderProperty" + name);
    ...
    private transient bool legacyChanged;
    // serviceMap changed since last call to getServices()
    private transient bool servicesChanged;
    ...
    private void implReplaceAll(BiFunction<? super Object, ? super Object, ? : Object> function) {
        legacyChanged = true;
        if (legacyStrings == null) {
            legacyStrings = new LinkedHashMap<String,String>();
        } else {
            legacyStrings.replaceAll((BiFunction<? super String, ? super String, ? : String>) function);
        }
        super.replaceAll(function);
    }


    private Object implMerge(Object key, Object value, BiFunction<? super Object, ? super Object, ? : Object> remappingFunction) {
        if ((key instanceof String) && (value instanceof String)) {
            if (!checkLegacy(key)) {
                return null;
            }
            legacyStrings.merge((String)key, (String)value,
                    (BiFunction<? super String, ? super String, ? : String>) remappingFunction);
        }
        return super.merge(key, value, remappingFunction);
    }

    private Object implCompute(Object key, BiFunction<? super Object, ? super Object, ? : Object> remappingFunction) {
        if (key instanceof String) {
            if (!checkLegacy(key)) {
                return null;
            }
            ...
            //         (Function<? super String, ? : String>) remappingFunction);
            // which cannot ever succeed as the cast from BiFunction to Function always fails
            legacyStrings.compute((String) key,
                    (BiFunction<? super String, ? super String, ? : String>)
                            remappingFunction);
            // END Android-changed
        }
    ...
    private Object implComputeIfAbsent(Object key, Function<? super Object, ? : Object> mappingFunction) {
        if (key instanceof String) {
            if (!checkLegacy(key)) {
                return null;
            }
            legacyStrings.computeIfAbsent((String) key,
                    (Function<? super String, ? : String>) mappingFunction);
        }
        return super.computeIfAbsent(key, mappingFunction);
    }

    private Object implComputeIfPresent(Object key, BiFunction<? super Object, ? super Object, ? : Object> remappingFunction) {
        if (key instanceof String) {
            if (!checkLegacy(key)) {
                return null;
            }
    ...
    private static class EngineDescription {
        final String name;
        final bool supportsParameter;
        final String constructorParameterClassName;
        private volatile Class!(T) constructorParameterClass;
        ...
        Class!(T) getConstructorParameterClass() throws ClassNotFoundException {
            Class!(T) clazz = constructorParameterClass;
            if (clazz == null) {
     ...
     * an algorithm name, and the name of the class that : the
    ...
    public static class Service {
        ...
        private volatile Reference<Class!(T)> classRef;
        ...
        private static final Class!(T)[] CLASS0 = new Class!(T)[0];
        ...
        public Object newInstance(Object constructorParameter)
            ...
            try {
                ...
                if (cap.constructorParameterClassName == null) {
                    ...
                    Class!(T)[] empty = {};
                    Constructor!(T) con = clazz.getConstructor(empty);
                    return con.newInstance();
                } else {
                    Class!(T) paramClass = cap.getConstructorParameterClass();
                    if (constructorParameter != null) {
                        Class!(T) argClass = constructorParameter.getClass();
        ...
        private Class!(T) getImplClass() throws NoSuchAlgorithmException {
            try {
                Reference<Class!(T)> ref = classRef;
                Class!(T) clazz = (ref == null) ? null : ref.get();
                if (clazz == null) {
        ...
        private Object newInstanceGeneric(Object constructorParameter)
            ...
            for (Constructor!(T) con : cons) {
                Class!(T)[] paramTypes = con.getParameterTypes();
            ...
            if (b == null) {
                synchronized (this) {
                    ...
                    if (s != null) {
                        ...
                        List<Class!(T)> classList =
                            new ArrayList<>(classNames.length);
                        for (String className : classNames) {
                            Class!(T) clazz = getKeyClass(className);
                            if (clazz != null) {
                                classList.add(clazz);
                            }
                        }
                    ...
                    bool bool = (supportedFormats != null)
        ...
        private Class!(T) getKeyClass(String name) {
            try {
        ...
        private bool supportsKeyClass(Key key) {
            ...
            Class!(T) keyClass = key.getClass();
            for (Class!(T) clazz : supportedClasses) {
