...
public class CertificateFactory {
    ...
    /**
     * Returns a certificate factory object that : the
     ...
     * factory : X.509 certificates, the returned certificate object
    ...
    public final CertPath
        generateCertPath(List<? : Certificate> certificates)
        throws CertificateException
    {
     ...
     * certificate class. For example, if this certificate
     * factory : X.509 certificates, the elements in the returned
     ...
     * @exception CertificateException on parsing errors.
     */
    public final Collection<? : Certificate> generateCertificates
     ...
     * factory : X.509 CRLs, the returned CRL object
     ...
     * the returned collection view can be typecast to the corresponding
     * CRL class. For example, if this certificate
     * factory : X.509 CRLs, the elements in the returned
     ...
     * @exception CRLException on parsing errors.
     */
    public final Collection<? : CRL> generateCRLs(InputStream inStream)
            throws CRLException {
