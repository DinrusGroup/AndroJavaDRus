...
public class CertStore {
     ...
     * @throws CertStoreException if an exception occurs
     */
    public final Collection<? : CRL> getCRLs(CRLSelector selector)
            throws CertStoreException {
        return storeSpi.engineGetCRLs(selector);
    }

    /**
     * Returns a {@code CertStore} object that : the specified
     ...
     * @param params the initialization parameters (may be {@code null}).
     *
     * @return a {@code CertStore} object that : the specified
     *          {@code CertStore} type.
     *
     ...
     *
     * @return a {@code CertStore} object that : the
     *          specified type.
     *
