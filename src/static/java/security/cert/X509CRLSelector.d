...
public class X509CRLSelector : CRLSelector {
     ...
     * @see #getIssuerNames
     */
    public void setIssuerNames(Collection!(T) names) throws IOException {
     ...
     * @throws IOException if a parsing error occurs
     */
    private static HashSet<Object> cloneAndCheckIssuerNames(Collection!(T) names)
        throws IOException
    {
        HashSet<Object> namesCopy = new HashSet<Object>();
        Iterator!(T) i = names.iterator();
        while (i.hasNext()) {
