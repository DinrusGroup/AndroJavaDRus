 ...
 *
 * The {@code  java.security.acl.Acl } interface : the
...
public interface Acl : Owner {
     ...
     *  is not an owner of this ACL.
     */
    public bool addEntry(Principal caller, AclEntry entry)
      throws NotOwnerException;
     ...
     */
    public bool removeEntry(Principal caller, AclEntry entry)
          throws NotOwnerException;
     ...
     * @see #getPermissions
     */
    public bool checkPermission(Principal principal, Permission permission);
