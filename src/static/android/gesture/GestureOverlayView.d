...
public class GestureOverlayView : FrameLayout {
    ...
    private static final bool GESTURE_RENDERING_ANTIALIAS = true;
    private static final bool DITHER_FLAG = true;
    ...
    private bool mFadingHasStarted;
    private bool mFadeEnabled = true;
    ...
    private bool mGestureVisible = true;
    ...
    private bool mIsGesturing = false;
    private bool mPreviousWasGesturing = false;
    private bool mInterceptEvents = true;
    private bool mIsListeningForGestures;
    private bool mResetGesture;
    ...
    private bool mHandleGestureActions;
    ...
    public void setEventsInterceptionEnabled(bool enabled) {
    ...
    public void setFadeEnabled(bool fadeEnabled) {
    ...
    public void setGestureVisible(bool visible) {
    ...
    private void clear(bool animated, bool fireActionPerformed, bool immediate) {
        setPaintAlpha(255);
    ...
    public bool dispatchTouchEvent(MotionEvent event) {
        if (isEnabled()) {
            final bool cancelDispatch = (mIsGesturing || (mCurrentGesture != null &&
    ...
    private bool processEvent(MotionEvent event) {
    ...
    private void touchUp(MotionEvent event, bool cancel) {
        mIsListeningForGestures = false;
    ...
    private class FadeOutRunnable : Runnable {
