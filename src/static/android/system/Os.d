...
public final class Os {
     ...
     */
    public static bool access(String path, int mode) throws ErrnoException { return Libcore.os.access(path, mode); }
     ...
     */
    public static bool isatty(FileDescriptor fd) { return Libcore.os.isatty(fd); }
     ...
     */
    public static void setenv(String name, String value, bool overwrite) throws ErrnoException { Libcore.os.setenv(name, value, overwrite); }
