 ...
 * @hide
 */
public final class PacketSocketAddress : SocketAddress {
    ...
    public PacketSocketAddress(short sll_protocol, int sll_ifindex) {
        this(sll_protocol, sll_ifindex, cast(short) 0, cast(byte) 0, null);
    }

    /** Constructs a new PacketSocketAddress suitable for sending to. */
    public PacketSocketAddress(int sll_ifindex, byte[] sll_addr) {
        this(cast(short) 0, sll_ifindex, cast(short) 0, cast(byte) 0, sll_addr);
    }
}
