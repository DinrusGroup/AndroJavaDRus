...
public final class Half : Number : Comparable<Half> {
    /**
     ...
     */
    public static final @HalfFloat short EPSILON = cast(short) 0x1400;
     ...
     */
    public static final @HalfFloat short LOWEST_VALUE = cast(short) 0xfbff;
    /**
     * Maximum positive finite value a half-precision float may have.
     */
    public static final @HalfFloat short MAX_VALUE = cast(short) 0x7bff;
    /**
     * Smallest positive normal value a half-precision float may have.
     */
    public static final @HalfFloat short MIN_NORMAL = cast(short) 0x0400;
    /**
     * Smallest positive non-zero value a half-precision float may have.
     */
    public static final @HalfFloat short MIN_VALUE = cast(short) 0x0001;
    /**
     * A Not-a-Number representation of a half-precision float.
     */
    public static final @HalfFloat short NaN = cast(short) 0x7e00;
    /**
     * Negative infinity of type half-precision float.
     */
    public static final @HalfFloat short NEGATIVE_INFINITY = cast(short) 0xfc00;
    /**
     * Negative 0 of type half-precision float.
     */
    public static final @HalfFloat short NEGATIVE_ZERO = cast(short) 0x8000;
    /**
     * Positive infinity of type half-precision float.
     */
    public static final @HalfFloat short POSITIVE_INFINITY = cast(short) 0x7c00;
    /**
     * Positive 0 of type half-precision float.
     */
    public static final @HalfFloat short POSITIVE_ZERO = cast(short) 0x0000;
    ...
    public byte byteValue() {
        return cast(byte) toFloat(mValue);
    }
    ...
    public short shortValue() {
        return cast(short) toFloat(mValue);
    }
     ...
     * {@link #halfToIntBitscast(short)} returns an identical {@code int} value for both.
     *
     * @param o The object to compare
     * @return True if the objects are the same, false otherwise
     *
     * @see #halfToIntBitscast(short)
     */
    override
    public bool equals(@Nullable Object o) {
     ...
     * {@link #halfToIntBitscast(short)}, of the primitive half-precision float
     ...
     * float value. See {@link #toStringcast(short)} for more information.
     *
     ...
     *
     * <p>Similar to {@link #halfToIntBitscast(short)}, this method collapses all
     ...
     * according to the bit layout described in {@link Half}.</p>
     *
     * <p>Unlike {@link #halfToRawIntBitscast(short)}, this method collapses all
     * possible Not-a-Number values to a single canonical Not-a-Number value
     * defined by {@link #NaN}.</p>
     *
     * @param h A half-precision float value
     * @return The bits that represent the half-precision float value
     *
     * @see #halfToRawIntBitscast(short)
     * @see #halfToShortBitscast(short)
    ...
    public static @HalfFloat short copySign(@HalfFloat short magnitude, @HalfFloat short sign) {
        return cast(short) ((sign & FP16_SIGN_MASK) | (magnitude & FP16_COMBINED));
    }
    ...
    public static @HalfFloat short abs(@HalfFloat short h) {
        return cast(short) (h & FP16_COMBINED);
    }
     ...
     */
    public static bool less(@HalfFloat short x, @HalfFloat short y) {
     ...
     */
    public static bool lessEquals(@HalfFloat short x, @HalfFloat short y) {
        if ((x & FP16_COMBINED) > FP16_EXPONENT_MAX) return false;
        if ((y & FP16_COMBINED) > FP16_EXPONENT_MAX) return false;
     ...
     */
    public static bool greater(@HalfFloat short x, @HalfFloat short y) {
        if ((x & FP16_COMBINED) > FP16_EXPONENT_MAX) return false;
        if ((y & FP16_COMBINED) > FP16_EXPONENT_MAX) return false;
     ...
     * @return True if x is greater than y, false otherwise
     */
    public static bool greaterEquals(@HalfFloat short x, @HalfFloat short y) {
        if ((x & FP16_COMBINED) > FP16_EXPONENT_MAX) return false;
        if ((y & FP16_COMBINED) > FP16_EXPONENT_MAX) return false;
     ...
     */
    public static bool equals(@HalfFloat short x, @HalfFloat short y) {
        if ((x & FP16_COMBINED) > FP16_EXPONENT_MAX) return false;
        if ((y & FP16_COMBINED) > FP16_EXPONENT_MAX) return false;
     ...
     *         false otherwise
     */
    public static bool isInfinite(@HalfFloat short h) {
     ...
     * @return True if the value is a NaN, false otherwise
     */
    public static bool isNaN(@HalfFloat short h) {
        return (h & FP16_COMBINED) > FP16_EXPONENT_MAX;
    }
     ...
     */
    public static bool isNormalized(@HalfFloat short h) {
        ...
        if (e == 0xff) { // Infinite or NaN
            ...
            if (e >= 0x1f) { // Overflow
                ...
                if ((m & 0x1000) != 0) {
                    ...
                    out++;
                    return cast(short) (out | (s << FP16_SIGN_SHIFT));
                }
            }
        }

        return cast(short) ((s << FP16_SIGN_SHIFT) | (outE << FP16_EXPONENT_SHIFT) | outM);
    }
