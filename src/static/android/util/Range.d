 ...
 */
public final class Range<T : Comparable<? super T>> {
    /**
     ...
     * @throws NullPointerException if {@code lower} or {@code upper} is {@code null}
     */
    public static <T : Comparable<? super T>> Range<T> create(final T lower, final T upper) {
    ...
    public bool contains(T value) {
        ...
        bool gteLower = value.compareTo(mLower) >= 0;
        bool lteUpper  = value.compareTo(mUpper) <= 0;
    ...
    public bool contains(Range<T> range) {
        ...
        bool gteLower = range.mLower.compareTo(mLower) >= 0;
        bool lteUpper = range.mUpper.compareTo(mUpper) <= 0;
