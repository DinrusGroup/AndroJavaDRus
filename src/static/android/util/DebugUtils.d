...
public class DebugUtils {
     ...
     * @hide
     */
    public static String valueToString(Class!(T) clazz, String prefix, int value) {
     ...
     * @hide
     */
    public static String flagsToString(Class!(T) clazz, String prefix, int flags) {
        final StringBuilder res = new StringBuilder();
        bool flagsWasZero = flags == 0;
