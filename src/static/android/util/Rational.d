 ...
 * Rational number. </p>
 */
public final class Rational : Number : Comparable<Rational> {
    /**
    ...
    private bool isPosInf() {
        return mDenominator == 0 && mNumerator > 0;
    }

    private bool isNegInf() {
        return mDenominator == 0 && mNumerator < 0;
    }
     ...
     *
     * @return A bool that determines whether or not the two Rational objects are equal.
     */
    override
