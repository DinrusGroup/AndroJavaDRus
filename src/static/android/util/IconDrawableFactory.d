...
public class IconDrawableFactory {
    ...
    protected final bool mEmbedShadow;

    private IconDrawableFactory(Context context, bool embedShadow) {
        mContext = context;
    ...
    protected bool needsBadging(ApplicationInfo appInfo, @UserIdInt int userId) {
    ...
    public static IconDrawableFactory newInstance(Context context, bool embedShadow) {
