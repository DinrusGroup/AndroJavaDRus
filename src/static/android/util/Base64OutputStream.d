...
public class Base64OutputStream : FilterOutputStream {
     ...
     * @hide
     */
    public Base64OutputStream(OutputStream out, int flags, bool encode) {
        super(out);
        this.flags = flags;
        if (encode) {
     ...
     */
    private void internalWrite(byte[] b, int off, int len, bool finish) throws IOException {
