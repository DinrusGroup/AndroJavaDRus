...
public final class StrictJarFile {
    ...
    public StrictJarFile(FileDescriptor fd,
            bool verify,
            bool signatureSchemeRollbackProtectionsEnforced)
                    throws IOException, SecurityException {
    ...
    static final class EntryIterator : Iterator<ZipEntry> {
    ...
    static final class JarFileInputStream : FilterInputStream {
    ...
    /** @hide */
    public static class ZipInflaterInputStream : InflaterInputStream {
     ...
     * @hide
     */
    public static class FDStream : InputStream {
        private final FileDescriptor fd;
