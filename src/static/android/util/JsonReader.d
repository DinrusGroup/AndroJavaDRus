 ...
 * values (strings, numbers, bools, and nulls) as well as the begin and
 ...
 *   }
 * ]}</pre>
 * This code : the parser for the above structure: <pre>   {@code
 *
 ...
 */
public final class JsonReader : Closeable {
     ...
     */
    public bool hasNext() throws IOException {
        peek();
    ...
    /**
     * Returns the {@link JsonToken#BOOLEAN bool} value of the next token,
     * consuming it.
     *
     * @throws IllegalStateException if the next token is not a bool or if
     *     this reader is closed.
     */
    public bool nextBoolean() throws IOException {
        peek();
        if (token != JsonToken.BOOLEAN) {
            throw new IllegalStateException("Expected a bool but was " + token);
        }
    ...
    private JsonToken nextInArray(bool firstElement) throws IOException {
        if (firstElement) {
    ...
    private JsonToken nextInObject(bool firstElement) throws IOException {
        /*
     ...
     * false.
     */
    private bool fillBuffer(int minimum) throws IOException {
    ...
    private bool skipTo(String toFind) throws IOException {
        outer:
     ...
     */
    private String nextLiteral(bool assignOffsetsOnly) throws IOException {
        StringBuilder builder = null;
        valuePos = -1;
        valueLength = 0;
        int i = 0;
    ...
    /**
     * Reads a null, bool, numeric or unquoted string literal value.
     */
