...
public class PathParser_Delegate {
    ...
    @LayoutlibDelegate
    /*package*/ static bool nInterpolatePathData(long outDataPtr, long fromDataPtr,
    ...
    @LayoutlibDelegate
    /*package*/ static bool nCanMorph(long fromDataPtr, long toDataPtr) {
    ...
    public static class PathDataNode {
        ...
        private static void drawArc(@NonNull Path_Delegate p, float x0, float y0, float x1,
                float y1, float a, float b, float theta, bool isMoreThanHalf,
                bool isPositiveArc) {
