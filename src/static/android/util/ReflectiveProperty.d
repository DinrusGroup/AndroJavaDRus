...
class ReflectiveProperty<T, V> : Property<T, V> {
    ...
    public ReflectiveProperty(Class<T> propertyHolder, Class<V> valueType, String name) {
        ...
        try {
            mGetter = propertyHolder.getMethod(getterName, (Class!(T)[])null);
