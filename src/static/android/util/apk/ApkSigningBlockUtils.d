...
final class ApkSigningBlockUtils {
    ...
    private static byte[][] computeContentDigestsPer1MbChunk(
        ...
        chunkContentPrefix[0] = cast(byte) 0xa5;
        int chunkIndex = 0;
    ...
    static Pair<String, ? : AlgorithmParameterSpec>
    ...
    static void setUnsignedInt32LittleEndian(int value, byte[] result, int offset) {
        result[offset] = cast(byte) (value & 0xff);
        result[offset + 1] = cast(byte) ((value >>> 8) & 0xff);
        result[offset + 2] = cast(byte) ((value >>> 16) & 0xff);
        result[offset + 3] = cast(byte) ((value >>> 24) & 0xff);
    }
     ...
     */
    private static class MultipleDigestDataDigester : DataDigester {
