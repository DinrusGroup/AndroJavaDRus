...
public class ApkSignatureSchemeV3Verifier {
     ...
     */
    public static bool hasSignature(String apkFile) throws IOException {
    ...
    private static VerifiedSigner verify(String apkFile, bool verifyIntegrity)
            throws SignatureNotFoundException, SecurityException, IOException {
        try (RandomAccessFile apk = new RandomAccessFile(apkFile, "r")) {
     ...
     * @throws IOException if an I/O error occurs while reading the APK file.
     */
    private static VerifiedSigner verify(RandomAccessFile apk, bool verifyIntegrity)
            throws SignatureNotFoundException, SecurityException, IOException {
    ...
    private static VerifiedSigner verify(
            ...
            bool doVerifyIntegrity) throws SecurityException, IOException {
        int signerCount = 0;
    ...
    private static VerifiedSigner verifySigner(
        ...
        Pair<String, ? : AlgorithmParameterSpec> signatureAlgorithmParams =
        ...
        try {
            ...
            while (porBuf.hasRemaining()) {
                ...
                if (lastCert != null) {
                    ...
                    Pair<String, ? : AlgorithmParameterSpec> sigAlgParams =
    ...
    private static bool isSupportedSignatureAlgorithm(int sigAlgorithm) {
        switch (sigAlgorithm) {
    ...
    private static class PlatformNotSupportedException : Exception {
