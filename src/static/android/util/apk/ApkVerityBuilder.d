...
abstract class ApkVerityBuilder {
     ...
     */
    private static class BufferedDigester : DataDigester {
    ...
    private static ByteBuffer generateFsverityHeader(ByteBuffer buffer, long fileSize, int depth,
        ...
        buffer.put(cast(byte) 1);               // major version
        buffer.put(cast(byte) 0);               // minor version
        buffer.put(cast(byte) 12);              // log2(block-size): log2(4096)
        buffer.put(cast(byte) 7);               // log2(leaves-per-node): log2(4096 / 32)

        buffer.putShort(cast(short) 1);         // meta algorithm, SHA256 == 1
        buffer.putShort(cast(short) 1);         // data algorithm, SHA256 == 1
        ...
        buffer.put(cast(byte) 2);               // authenticated extension count
        buffer.put(cast(byte) 0);               // unauthenticated extension count
    ...
    private static ByteBuffer generateFsverityExtensions(ByteBuffer buffer, long signingBlockOffset,
...

        {
            ...
            buffer.putShort(cast(short) 1);  // ID of elide extension
...

        {
            ...
            buffer.putShort(cast(short) 2);  // ID of patch extension
            skip(buffer, 2);             // reserved
