...
public final class Log {
     ...
     * @hide
     */
    public static class TerribleFailure : Exception {
    ...
    public interface TerribleFailureHandler {
        void onTerribleFailure(String tag, TerribleFailure what, bool system);
    }

    private static TerribleFailureHandler sWtfHandler = new TerribleFailureHandler() {
            public void onTerribleFailure(String tag, TerribleFailure what, bool system) {
     ...
     */
    public static native bool isLoggable(String tag, int level);
    ...
    static int wtf(int logId, String tag, String msg, Throwable tr, bool localStack,
            bool system) {
    ...
    static void wtfQuiet(int logId, String tag, String msg, bool system) {
     ...
     */
    private static class ImmediateLogWriter : Writer {
