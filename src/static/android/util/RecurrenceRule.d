 ...
 * @hide
 */
public class RecurrenceRule : Parcelable {
    private static final String TAG = "RecurrenceRule";
    private static final bool LOGD = Log.isLoggable(TAG, Log.DEBUG);
    ...
    private class NonrecurringIterator : Iterator<Range<ZonedDateTime>> {
        bool hasNext;
    ...
    private class RecurringIterator : Iterator<Range<ZonedDateTime>> {
        int i;
