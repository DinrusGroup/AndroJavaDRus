 ...
 * @see CameraManager
 */
public final class CameraCharacteristics : CameraMetadata<CameraCharacteristics.Key!(T)> {
    ...
    public static final class Key<T> {
        ...
        private Key(CameraMetadataNative.Key!(T) nativeKey) {
            mKey = (CameraMetadataNative.Key<T>) nativeKey;
        }
    }

    private final CameraMetadataNative mProperties;
    private List<CameraCharacteristics.Key!(T)> mKeys;
    private List<CaptureRequest.Key!(T)> mAvailableRequestKeys;
    private List<CaptureRequest.Key!(T)> mAvailableSessionKeys;
    private List<CaptureRequest.Key!(T)> mAvailablePhysicalRequestKeys;
    private List<CaptureResult.Key!(T)> mAvailableResultKeys;
    ...
    @SuppressWarnings("unchecked")
    override
    protected <T> T getProtected(Key!(T) key) {
    ...
    @SuppressWarnings("unchecked")
    override
    protected Class<Key!(T)> getKeyClass() {
        Object thisClass = Key.class;
        return (Class<Key!(T)>)thisClass;
    }
     ...
     */
    @SuppressWarnings({"unchecked"})
    public List<CaptureRequest.Key!(T)> getAvailableSessionKeys() {
        if (mAvailableSessionKeys == null) {
            Object crKey = CaptureRequest.Key.class;
            Class<CaptureRequest.Key!(T)> crKeyTyped = (Class<CaptureRequest.Key!(T)>)crKey;
     ...
     */
    @SuppressWarnings({"unchecked"})
    public List<CaptureRequest.Key!(T)> getAvailablePhysicalCameraRequestKeys() {
    ...
    @SuppressWarnings({"unchecked"})
    @NonNull
    public List<CaptureRequest.Key!(T)> getAvailableCaptureRequestKeys() {
    ...
    @SuppressWarnings({"unchecked"})
    @NonNull
    public List<CaptureResult.Key!(T)> getAvailableCaptureResultKeys() {
        if (mAvailableResultKeys == null) {
            Object crKey = CaptureResult.Key.class;
            Class<CaptureResult.Key!(T)> crKeyTyped = (Class<CaptureResult.Key!(T)>)crKey;
    ...
    getAvailableKeyList(Class!(T) metadataClass, Class<TKey> keyClass, int[] filterTags) {
     ...
     * <p>High speed video streaming : significant performance pressue to camera hardware,
    ...
    public static final Key<Boolean> CONTROL_AE_LOCK_AVAILABLE =
            new Key<Boolean>("android.control.aeLockAvailable", bool.class);
    ...
    public static final Key<Boolean> CONTROL_AWB_LOCK_AVAILABLE =
            new Key<Boolean>("android.control.awbLockAvailable", bool.class);
    ...
    public static final Key<Boolean> FLASH_INFO_AVAILABLE =
            new Key<Boolean>("android.flash.info.available", bool.class);
    ...
    public static final Key<Boolean> SENSOR_INFO_LENS_SHADING_APPLIED =
            new Key<Boolean>("android.sensor.info.lensShadingApplied", bool.class);
     ...
     */
    @PublicKey
    public static final Key<bool[]> STATISTICS_INFO_AVAILABLE_HOT_PIXEL_MAP_MODES =
            new Key<bool[]>("android.statistics.info.availableHotPixelMapModes", bool[].class);
     ...
     * bool isHardwareLevelSupported(CameraCharacteristics c, int requiredLevel) {
    ...
    public static final Key<Boolean> DEPTH_DEPTH_IS_EXCLUSIVE =
            new Key<Boolean>("android.depth.depthIsExclusive", bool.class);
