...
public class MarshalRegistry {
    ...
    public static <T> Marshaler<T> getMarshaler(TypeReference<T> typeToken, int nativeType) {
        synchronized(sMarshalLock) {
            ...
            if (marshaler == null) {
                ...
                for (MarshalQueryable!(T) potentialMarshaler : sRegisteredMarshalQueryables) {
    ...
    private static class MarshalToken<T> {
        ...
        public bool equals(Object other) {
            if (other instanceof MarshalToken!(T)) {
                MarshalToken!(T) otherToken = (MarshalToken!(T))other;
    ...
    private static final List<MarshalQueryable!(T)> sRegisteredMarshalQueryables =
            new ArrayList<MarshalQueryable!(T)>();
    private static final HashMap<MarshalToken!(T), Marshaler!(T)> sMarshalerMap =
            new HashMap<MarshalToken!(T), Marshaler!(T)>();
