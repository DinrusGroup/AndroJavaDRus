...
public class MarshalQueryablePair<T1, T2>
        : MarshalQueryable<Pair<T1, T2>> {

    private class MarshalerPair : Marshaler<Pair<T1, T2>> {
    ...
    override
    public bool isTypeMappingSupported(TypeReference<Pair<T1, T2>> managedType, int nativeType) {
