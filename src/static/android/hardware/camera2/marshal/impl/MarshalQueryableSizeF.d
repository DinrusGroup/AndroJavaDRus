 ...
 */
public class MarshalQueryableSizeF : MarshalQueryable<SizeF> {

    private static final int SIZE = SIZEOF_FLOAT * 2;

    private class MarshalerSizeF : Marshaler<SizeF> {
    ...
    override
    public bool isTypeMappingSupported(TypeReference<SizeF> managedType, int nativeType) {
