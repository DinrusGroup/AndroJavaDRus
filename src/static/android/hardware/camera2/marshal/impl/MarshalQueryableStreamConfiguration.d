...
public class MarshalQueryableStreamConfiguration
        : MarshalQueryable<StreamConfiguration> {
    private static final int SIZE = SIZEOF_INT32 * 4;

    private class MarshalerStreamConfiguration : Marshaler<StreamConfiguration> {
    ...
    override
    public bool isTypeMappingSupported(TypeReference<StreamConfiguration> managedType,
            int nativeType) {
