...
/**
 * Marshal any {@code T : Parcelable} to/from any native type
 *
 * <p>Use with extreme caution! File descriptors and binders will not be marshaled across.</p>
 */
public class MarshalQueryableParcelable<T : Parcelable>
        : MarshalQueryable<T> {
    ...
    private class MarshalerParcelable : Marshaler<T> {
