 ...
 */
public class MarshalQueryableArray<T> : MarshalQueryable<T> {

    private static final String TAG = MarshalQueryableArray.class.getSimpleName();
    private static final bool DEBUG = false;

    private class MarshalerArray : Marshaler<T> {
        private final Class<T> mClass;
        private final Marshaler!(T) mComponentMarshaler;
        ...
        protected MarshalerArray(TypeReference<T> typeReference, int nativeType) {
            ...
            TypeReference!(T) componentToken = typeReference.getComponentType();
        ...
        @SuppressWarnings("unchecked")
        private Object copyListToArray(ArrayList!(T) arrayList, Object arrayDest) {
