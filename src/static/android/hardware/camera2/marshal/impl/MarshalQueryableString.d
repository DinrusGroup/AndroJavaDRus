 ...
 */
public class MarshalQueryableString : MarshalQueryable<String> {
    ...
    private static final byte NUL = cast(byte)'\0'; // used as string terminator

    private class MarshalerString : Marshaler<String> {
    ...
    override
    public bool isTypeMappingSupported(TypeReference<String> managedType, int nativeType) {
