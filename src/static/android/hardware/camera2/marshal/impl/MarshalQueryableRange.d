 ...
 */
public class MarshalQueryableRange<T : Comparable<? super T>>
        : MarshalQueryable<Range<T>> {
    private static final int RANGE_COUNT = 2;

    private class MarshalerRange : Marshaler<Range<T>> {
        ...
        protected MarshalerRange(TypeReference<Range<T>> typeReference,
            ...
            TypeReference!(T) actualTypeArgToken =
    ...
    override
    public bool isTypeMappingSupported(TypeReference<Range<T>> managedType, int nativeType) {
