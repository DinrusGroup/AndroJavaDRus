...
public class SurfaceUtils {
     ...
     */
    public static bool isSurfaceForPreview(Surface surface) {
     ...
     */
    public static bool isSurfaceForHwVideoEncoder(Surface surface) {
    ...
    public static void checkConstrainedHighSpeedSurfaces(Collection<Surface> surfaces,
        ...
        if (surfaces.size() == 2) {
            ...
            bool isFirstSurfacePreview =
                    SurfaceUtils.isSurfaceForPreview(iterator.next());
            bool isSecondSurfacePreview =
                    SurfaceUtils.isSurfaceForPreview(iterator.next());
