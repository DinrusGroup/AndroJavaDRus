...
public final class StreamConfigurationMap {
     ...
     */
    public static <T> bool isOutputSupportedFor(Class<T> klass) {
     ...
     */
    public bool isOutputSupportedFor(Surface surface) {
        ...
        bool isFlexible = SurfaceUtils.isFlexibleConsumer(surface);
    ...
    private int checkArgumentFormatSupported(int format, bool output) {
        checkArgumentFormat(format);
    ...
    private Size[] getPublicFormatSizes(int format, bool output, bool highRes) {
        try {
    ...
    private int[] getPublicFormats(bool output) {
    ...
    private SparseIntArray getFormatsMap(bool output) {
    ...
    private int getPublicFormatCount(bool output) {
    ...
    private static <T> bool arrayContains(T[] array, T element) {
        if (array == null) {
            return false;
        }
    ...
    private bool isSupportedInternalConfiguration(int format, int dataspace,
            Size size) {
        StreamConfiguration[] configurations =
                (dataspace == HAL_DATASPACE_DEPTH) ? mDepthConfigurations : mConfigurations;
    ...
    private final bool mListHighResolution;
