...
public final class CameraManager {
     ...
     *             flash unit.
     */
    public void setTorchMode(@NonNull String cameraId, bool enabled)
            throws CameraAccessException {
        if (CameraManagerGlobal.sCameraServiceDisabled) {
            throw new IllegalArgumentException("No cameras available on device");
        }
    ...
    public static abstract class TorchCallback {
         ...
         *                be turned on.
         */
        public void onTorchModeChanged(@NonNull String cameraId, bool enabled) {
            // default empty implementation
        }
    }
     ...
     */
    private bool supportsCamera2ApiLocked(String cameraId) {
     ...
     */
    private bool supportsCameraApiLocked(String cameraId, int apiVersion) {
        /*
     ...
     */
    private static final class CameraManagerGlobal : ICameraServiceListener.Stub
        ...
        public static final bool sCameraServiceDisabled =
        ...
        public void setTorchMode(String cameraId, bool enabled) throws CameraAccessException {
            synchronized(mLock) {
        ...
        private bool isAvailable(int status) {
            switch (status) {
        ...
        private bool validTorchStatus(int status) {
            switch (status) {
