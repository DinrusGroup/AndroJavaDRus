...
public class RequestThreadManager {
    ...
    private bool mPreviewRunning = false;
    ...
    private static final bool USE_BLOB_FORMAT_OVERRIDE = true;
    ...
    private static bool checkAspectRatiosMatch(Size a, Size b) {
        ...
        public bool handleMessage(Message msg) {
            ...
            switch (msg.what) {
                case MSG_CONFIGURE_OUTPUTS:
                    ...
                    try {
                        bool success = mCaptureCollector.waitForEmpty(JPEG_FRAME_TIMEOUT,
                ...
                case MSG_SUBMIT_CAPTURE_REQUEST:
                    ...
                    bool anyRequestOutputAbandoned = false;
                    ...
                    for (RequestHolder holder : requests) {
                        ...
                        try {
                            bool success = mCaptureCollector.queueRequest(holder,
                        ...
                        try {
                            bool success = mCaptureCollector.waitForRequestCompleted(holder,
     ...
     */
    public SubmitInfo submitCaptureRequests(CaptureRequest[] requests, bool repeating) {
        Handler handler = mRequestThread.waitAndGetHandler();
        SubmitInfo info;
        synchronized (mIdleLock) {
