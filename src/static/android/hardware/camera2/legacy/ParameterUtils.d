...
public class ParameterUtils {
     ...
     */
    public static bool containsSize(List<Camera.Size> sizeList, int width, int height) {
        checkNotNull(sizeList, "sizeList must not be null");
        for (Camera.Size s : sizeList) {
    ...
    private static Point convertCameraPointToActiveArrayPoint(
            Rect activeArray, ZoomData zoomData, Point point, bool usePreviewCrop) {
    ...
    private static WeightedRectangle convertCameraAreaToActiveArrayRectangle(
            Rect activeArray, ZoomData zoomData, Camera.Area area, bool usePreviewCrop) {
        Rect previewCrop = zoomData.previewCrop;
