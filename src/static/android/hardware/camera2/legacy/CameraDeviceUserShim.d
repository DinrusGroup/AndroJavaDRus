...
public class CameraDeviceUserShim : ICameraDeviceUser {
     ...
     */
    private static class CameraLooper : Runnable, AutoCloseable {
     ...
     * callee.</p>
     */
    private static class CameraCallbackThread : ICameraDeviceCallbacks {
    ...
    override
    public SubmitInfo submitRequest(CaptureRequest request, bool streaming) {
        if (DEBUG) {
    ...
    override
    public SubmitInfo submitRequestList(CaptureRequest[] request, bool streaming) {
        if (DEBUG) {
