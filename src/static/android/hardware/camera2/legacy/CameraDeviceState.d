...
public class CameraDeviceState {
     ...
     */
    public synchronized bool setConfiguring() {
     ...
     * @return {@code false} if an error has occurred.
     */
    public synchronized bool setIdle() {
     ...
     * @return {@code false} if an error has occurred.
     */
    public synchronized bool setCaptureStart(final RequestHolder request, long timestamp,
                                            int captureError) {
     ...
     * @return {@code false} if an error has occurred.
     */
    public synchronized bool setCaptureResult(final RequestHolder request,
