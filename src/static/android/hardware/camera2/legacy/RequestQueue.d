...
public class RequestQueue {
    ...
    public final class RequestQueueEntry {
        ...
        private final bool mQueueEmpty;
        ...
        public RequestQueueEntry(BurstHolder burstHolder, Long frameNumber, bool queueEmpty) {
    ...
    public synchronized RequestQueueEntry getNext() {
        ...
        bool queueEmptied = (next != null && mRequestQueue.size() == 0);
     ...
     */
    public synchronized SubmitInfo submit(CaptureRequest[] requests, bool repeating) {
