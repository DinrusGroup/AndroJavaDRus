...
public class LegacyRequestMapper {
    ...
    public static void convertRequestMetadata(LegacyRequest legacyRequest) {
        ...
        // jpeg.thumbnailSize
        {
            ...
            if (sizes != null && sizes.size() > 0) {
                ...
                bool invalidSize = (s == null) ? false : !ParameterUtils.containsSize(sizes,
    ...
    private static bool checkForCompleteGpsData(Location location) {
    ...
    private static <T> T getIfSupported(
            CaptureRequest r, CaptureRequest.Key<T> key, T defaultValue, bool isSupported,
            T allowedValue) {
