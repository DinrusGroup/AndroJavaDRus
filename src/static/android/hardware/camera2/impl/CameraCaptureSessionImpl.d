...
public class CameraCaptureSessionImpl : CameraCaptureSession
    ...
    CameraCaptureSessionImpl(int id, Surface input,
            ...
            Executor deviceStateExecutor, bool configureSuccess) {
        if (callback == null) {
    ...
    private class SequenceDrainListener : TaskDrainer.DrainListener {
        override
    ...
    private class AbortDrainListener : TaskDrainer.DrainListener {
        override
        public void onDrained() {
    ...
    private class IdleDrainListener : TaskDrainer.DrainListener {
        override
        public void onDrained() {
