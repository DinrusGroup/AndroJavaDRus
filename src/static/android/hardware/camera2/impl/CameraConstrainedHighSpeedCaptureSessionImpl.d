 ...
 * but : the few necessary behavior changes and additional methods required
 * for the constrained high speed speed mode.
 * </p>
 */

public class CameraConstrainedHighSpeedCaptureSessionImpl
        : CameraConstrainedHighSpeedCaptureSession : CameraCaptureSessionCore {
    ...
    private bool isConstrainedHighSpeedRequestList(List<CaptureRequest> requestList) {
    ...
    private class WrapperCallback : StateCallback {
