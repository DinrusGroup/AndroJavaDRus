...
public class CameraDeviceImpl : CameraDevice
    ...
    private final bool DEBUG = false;
    ...
    private final Runnable mCallOnClosed = new Runnable() {
        private bool mClosedOnce = false;
    ...
    public void setRemoteFailure(final ServiceSpecificException failure) {
        ...
        final bool isError = failureIsError;
        synchronized(mInterfaceLock) {
            mInError = true;
     ...
     */
    public bool configureStreamsChecked(InputConfiguration inputConfig,
    ...
    private void overrideEnableZsl(CameraMetadataNative request, bool newValue) {
    ...
    private int submitCaptureRequest(List<CaptureRequest> requestList, CaptureCallback callback,
            Executor executor, bool repeating) throws CameraAccessException {
     ...
     */
    public static abstract class StateCallbackKK : StateCallback {
        /**
    ...
    static class CaptureCallbackHolder {
         ...
         */
        private final bool mHasBatchedOutputs;

        CaptureCallbackHolder(CaptureCallback callback, List<CaptureRequest> requestList,
                Executor executor, bool repeating, int sessionId) {
    ...
    public class FrameNumberTracker {
         ...
         */
        public void updateTracker(long frameNumber, bool isError, bool isReprocess) {
            if (isError) {
         ...
         * @param isReprocess true if it is a reprocess result, false if it is a regular result.
         */
        public void updateTracker(long frameNumber, CaptureResult result, bool partial,
                bool isReprocess) {
            if (!partial) {
    ...
    public class CameraDeviceCallbacks : ICameraDeviceCallbacks.Stub {
        ...
        public void onResultReceived(CameraMetadataNative result,
            ...
            synchronized(mInterfaceLock) {
                ...
                bool isReprocess = request.isReprocess();
        ...
        private void onCaptureErrorLocked(int errorCode, CaptureResultExtras resultExtras) {
            ...
            if (errorCode == ERROR_CAMERA_BUFFER) {
                ...
                bool mayHaveBuffers = (errorCode == ERROR_CAMERA_RESULT);
     ...
     * @hide
     */
    private static class CameraHandlerExecutor : Executor {
