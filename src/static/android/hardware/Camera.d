...
public class Camera {
    ...
    private bool mUsingPreviewAllocation;
    ...
    private bool mWithBuffer;
    private bool mFaceDetectionRunning = false;
    ...
    private bool mHasAppOpsPlayAudio = true;
    @GuardedBy("mShutterSoundLock")
    private bool mShutterSoundEnabledFromApp = true;
     ...
     * @hide
     */
    public static bool checkInitErrors(int err) {
        return err != NO_ERROR;
    }
     ...
     * @hide
     */
    public native final bool previewEnabled();
    ...
    private native final void setHasPreviewCallback(bool installed, bool manualBuffer);
    ...
    public interface AutoFocusCallback
    {
         ...
         * @param camera  the Camera service object
         * @see android.hardware.Camera.Parameters#setAutoExposureLock(bool)
         * @see android.hardware.Camera.Parameters#setAutoWhiteBalanceLock(bool)
         */
     ...
     * it is a no-op and {@link AutoFocusCallback#onAutoFocus(bool, Camera)}
     ...
     * {@link Camera.OnZoomChangeListener#onZoomChange(int, bool, Camera)}
     ...
     * @see ShutterCallback
     */
    public final bool enableShutterSound(bool enabled) {
        bool canDisableShutterSound = true;
        IBinder b = ServiceManager.getService(Context.AUDIO_SERVICE);
        IAudioService audioService = IAudioService.Stub.asInterface(b);
        try {
            if (audioService.isCameraSoundForced()) {
        ...
        synchronized (mShutterSoundLock) {
            ...
            bool ret = _enableShutterSound(enabled);
     ...
     * @hide
     */
    public final bool disableShutterSound() {
        return _enableShutterSound(/*enabled*/false);
    }

    private native final bool _enableShutterSound(bool enabled);

    private static class IAppOpsCallbackWrapper : IAppOpsCallback.Stub {
    ...
    private void updateAppOpsPlayAudio() {
        synchronized (mShutterSoundLock) {
            bool oldHasAppOpsPlayAudio = mHasAppOpsPlayAudio;
            try {
    ...
    public static class Face {
         ...
         * bool mirror = (info.facing == CameraInfo.CAMERA_FACING_FRONT);
    ...
    public class Parameters {
         ...
         * immediately return with a bool that indicates whether the focus is
         ...
         * scanning, the focus callback will immediately return with a bool
         ...
         * @see #getWhiteBalance()
         * @see #setAutoWhiteBalanceLock(bool)
         */
         ...
         */
        public void setAutoExposureLock(bool toggle) {
         ...
         */
        public void setAutoWhiteBalanceLock(bool toggle) {
         ...
         */
        public void setRecordingHint(bool hint) {
         ...
         */
        public void setVideoStabilization(bool toggle) {
         ...
         * @see #isVideoStabilizationSupported()
         * @see #setVideoStabilization(bool)
         */
        ...
        private bool same(String s1, String s2) {
