 ...
 * @hide
 */
public final class WifiDisplaySessionInfo : Parcelable {
    private final bool mClient;
    ...
    public WifiDisplaySessionInfo(
            bool client, int session, String group, String pp, String ip) {
        mClient = client;
        mSessionId = session;
        mGroupId = group;
        mPassphrase = pp;
