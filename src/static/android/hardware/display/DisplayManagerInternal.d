...
public abstract class DisplayManagerInternal {
     ...
     */
    public abstract bool requestPowerState(DisplayPowerRequest request,
            bool waitForNegativeProximity);

    /**
     * Returns true if the proximity sensor screen-off function is available.
     */
    public abstract bool isProximitySensorAvailable();
     ...
     */
    public abstract void setDisplayProperties(int displayId, bool hasContent,
     ...
     * */
    public abstract bool isUidPresentOnDisplay(int uid, int displayId);
    ...
    public static final class DisplayPowerRequest {
        ...
        public bool boostScreenBrightness;
        ...
        public bool equals(DisplayPowerRequest other) {
            return other != null
                    && policy == other.policy
                    && useProximitySensor == other.useProximitySensor
                    && screenBrightnessOverride == other.screenBrightnessOverride
