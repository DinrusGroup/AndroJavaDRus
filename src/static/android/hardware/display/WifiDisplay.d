 ...
 * @hide
 */
public final class WifiDisplay : Parcelable {
    private final String mDeviceAddress;
    private final String mDeviceName;
    private final String mDeviceAlias;
    private final bool mIsAvailable;
    private final bool mCanConnect;
    private final bool mIsRemembered;
    ...
    public static final Creator<WifiDisplay> CREATOR = new Creator<WifiDisplay>() {
        public WifiDisplay createFromParcel(Parcel in) {
            ...
            bool isAvailable = (in.readInt() != 0);
            bool canConnect = (in.readInt() != 0);
            bool isRemembered = (in.readInt() != 0);
    ...
    public WifiDisplay(String deviceAddress, String deviceName, String deviceAlias,
            bool available, bool canConnect, bool remembered) {
     ...
     */
    public bool equals(WifiDisplay other) {
        return other != null
     ...
     */
    public bool hasSameAddress(WifiDisplay other) {
