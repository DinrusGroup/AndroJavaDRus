...
@SystemApi
@TestApi
public final class BrightnessChangeEvent : Parcelable {
    /** Brightness in nits */
    ...
    public final bool isDefaultBrightnessConfig;

    /** Whether brightness curve includes a user brightness point */
    public final bool isUserSetBrightness;
    ...
    private BrightnessChangeEvent(float brightness, long timeStamp, String packageName,
            ...
            float powerBrightnessFactor, bool nightMode, int colorTemperature,
            float lastBrightness, bool isDefaultBrightnessConfig, bool isUserSetBrightness) {
    ...
    /** @hide */
    public BrightnessChangeEvent(BrightnessChangeEvent other, bool redactPackage) {
    ...
    public static class Builder {
        ...
        private bool mNightMode;
        private int mColorTemperature;
        private float mLastBrightness;
        private bool mIsDefaultBrightnessConfig;
        private bool mIsUserSetBrightness;
        ...
        public Builder setNightMode(bool nightMode) {
        ...
        public Builder setIsDefaultBrightnessConfig(bool isDefaultBrightnessConfig) {
            mIsDefaultBrightnessConfig = isDefaultBrightnessConfig;
            return this;
        }

        /** {@see BrightnessChangeEvent#userBrightnessPoint} */
        public Builder setUserBrightnessPoint(bool isUserSetBrightness) {
