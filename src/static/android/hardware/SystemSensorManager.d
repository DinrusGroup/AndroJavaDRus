 ...
 * @hide
 */
public class SystemSensorManager : SensorManager {
    //TODO: disable extra logging before release
    private static final bool DEBUG_DYNAMIC_SENSOR = true;
    ...
    private static native bool nativeGetSensorAtIndex(long nativeInstance,
            Sensor sensor, int index);
    private static native void nativeGetDynamicSensors(long nativeInstance, List<Sensor> list);
    private static native bool nativeIsDataInjectionEnabled(long nativeInstance);
    ...
    @GuardedBy("sLock")
    private static bool sNativeClassInited = false;
    @GuardedBy("sLock")
    ...
    private bool mDynamicSensorListDirty = true;
    ...
    /** @hide */
    override
    protected bool registerListenerImpl(SensorEventListener listener, Sensor sensor,
    ...
    protected bool initDataInjectionImpl(bool enable) {
        synchronized (sLock) {
            if (enable) {
                bool isDataInjectionModeEnabled = nativeIsDataInjectionEnabled(mNativeInstance);
    ...
    private void updateDynamicSensorList() {
        synchronized (mFullDynamicSensorsList) {
            if (mDynamicSensorListDirty) {
                ...
                bool changed = diffSortedSensorList(
     ...
     * interested.
     */
    private static bool diffSortedSensorList(
    ...
    private abstract static class BaseEventQueue {
        ...
        public bool removeSensor(Sensor sensor, bool disable) {
    ...
    static final class SensorEventQueue : BaseEventQueue {
    ...
    static final class TriggerEventQueue : BaseEventQueue {
    ...
    final class InjectEventQueue : BaseEventQueue {
