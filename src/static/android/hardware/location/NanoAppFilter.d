...
@SystemApi
@Deprecated
public class NanoAppFilter : Parcelable {
    ...
    private bool versionsMatch(int versionRestrictionMask, int expected, int actual){
     ...
     */
    public bool testMatch(NanoAppInstanceInfo info) {
