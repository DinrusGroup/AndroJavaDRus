...
public final class GeofenceHardwareImpl {
    ...
    private void updateFusedHardwareAvailability() {
        bool fusedSupported;
        try {
            final bool hasGnnsCapabilities = (mVersion < FIRST_VERSION_WITH_CAPABILITIES)
    ...
    public bool removeGeofence(int geofenceId, int monitoringType) {
        // This API is not thread safe. Operations on the same geofence need to be serialized
        // by upper layers
    ...
    public bool pauseGeofence(int geofenceId, int monitoringType) {
        // This API is not thread safe. Operations on the same geofence need to be serialized
        // by upper layers
    ...
    public bool resumeGeofence(int geofenceId,  int monitoringType, int monitorTransition) {
        // This API is not thread safe. Operations on the same geofence need to be serialized
        // by upper layers
    ...
    class Reaper : IBinder.DeathRecipient {
         ...
         */
        private bool binderEquals(IInterface left, IInterface right) {
          if (left == null) {
            return right == null;
          } else {
        ...
        private bool callbackEquals(IGeofenceHardwareCallback cb) {
