 ...
 * public class SensorActivity : Activity : SensorEventListener {
...
public abstract class SensorManager {
     ...
     */
    public Sensor getDefaultSensor(int type, bool wakeUp) {
        List<Sensor> l = getSensorList(type);
        for (Sensor sensor : l) {
     ...
     */
    @Deprecated
    public bool registerListener(SensorListener listener, int sensors) {
     ...
     */
    @Deprecated
    public bool registerListener(SensorListener listener, int sensors, int rate) {
     ...
     * @see #unregisterListener(SensorEventListener, Sensor)
     */
    public bool registerListener(SensorEventListener listener, Sensor sensor,
    ...
    /** @hide */
    protected abstract bool registerListenerImpl(SensorEventListener listener, Sensor sensor,
     ...
     */
    public bool flush(SensorEventListener listener) {
        return flushImpl(listener);
    }

    /** @hide */
    protected abstract bool flushImpl(SensorEventListener listener);
     ...
     *
     * @param callback An object that : the
    ...
    public static bool getRotationMatrix(float[] R, float[] I,
    ...
    private static bool remapCoordinateSystemImpl(float[] inR, int X, int Y, float[] outR) {
        /*
     ...
     */
    public bool requestTriggerSensor(TriggerEventListener listener, Sensor sensor) {
     ...
     * @hide
     */
    protected abstract bool requestTriggerSensorImpl(TriggerEventListener listener,
            Sensor sensor);
     ...
     */
    public bool cancelTriggerSensor(TriggerEventListener listener, Sensor sensor) {
     ...
     * @hide
     */
    protected abstract bool cancelTriggerSensorImpl(TriggerEventListener listener,
            Sensor sensor, bool disable);
     ...
     */
    @SystemApi
    public bool initDataInjection(bool enable) {
     ...
     * @hide
     */
    protected abstract bool initDataInjectionImpl(bool enable);

    /**
     * For testing purposes only. Not for third party applications.
     *
     * This method is used to inject raw sensor data into the HAL.  Call {@link
     * initDataInjection(bool)} before this method to set the HAL in data injection mode. This
     ...
     *
     * @return bool True if the data injection succeeds, false
     *         otherwise.
     ...
     */
    @SystemApi
    public bool injectSensorData(Sensor sensor, float[] values, int accuracy,
                long timestamp) {
        if (sensor == null) {
     ...
     * @hide
     */
    protected abstract bool injectSensorDataImpl(Sensor sensor, float[] values, int accuracy,
                long timestamp);
    ...
    /** @hide */
    public bool setOperationParameter(SensorAdditionalInfo parameter) {
        return setOperationParameterImpl(parameter);
    }

    /** @hide */
    protected abstract bool setOperationParameterImpl(SensorAdditionalInfo parameter);
}
