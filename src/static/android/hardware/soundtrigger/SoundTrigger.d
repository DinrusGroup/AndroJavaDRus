...
public class SoundTrigger {
     ...
     * @hide
     ****************************************************************************/
    public static class ModuleProperties : Parcelable {
        ...
        public final bool supportsCaptureTransition;

        /** Maximum buffering capacity in ms if supportsCaptureTransition() is true */
        public final int maxBufferMs;

        /** Supports capture by other use cases while detection is active */
        public final bool supportsConcurrentCapture;
        ...
        public final bool returnsTriggerInEvent;
        ...
        ModuleProperties(int id, String implementor, String description,
                ...
                int maxUsers, int recognitionModes, bool supportsCaptureTransition,
                int maxBufferMs, bool supportsConcurrentCapture,
                int powerConsumptionMw, bool returnsTriggerInEvent) {
            this.id = id;
        ...
        private static ModuleProperties fromParcel(Parcel in) {
            ...
            bool supportsCaptureTransition = in.readByte() == 1;
            int maxBufferMs = in.readInt();
            bool supportsConcurrentCapture = in.readByte() == 1;
            int powerConsumptionMw = in.readInt();
            bool returnsTriggerInEvent = in.readByte() == 1;
        ...
        public void writeToParcel(Parcel dest, int flags) {
            ...
            dest.writeByte(cast(byte) (supportsCaptureTransition ? 1 : 0));
            dest.writeInt(maxBufferMs);
            dest.writeByte(cast(byte) (supportsConcurrentCapture ? 1 : 0));
            dest.writeInt(powerConsumptionMw);
            dest.writeByte(cast(byte) (returnsTriggerInEvent ? 1 : 0));
        }
     ...
     * @hide
     ****************************************************************************/
    public static class Keyphrase : Parcelable {
     ...
     * @hide
     ****************************************************************************/
    public static class KeyphraseSoundModel : SoundModel : Parcelable {
     ...
     * @hide
     ****************************************************************************/
    public static class GenericSoundModel : SoundModel : Parcelable {
    ...
    public static class RecognitionEvent {
         ...
         * @hide
         */
        public final bool captureAvailable;
        /**
         ...
         * @hide
         */
        public final bool triggerInData;
        /**
        ...
        /** @hide */
        public RecognitionEvent(int status, int soundModelHandle, bool captureAvailable,
                int captureSession, int captureDelayMs, int capturePreambleMs,
                bool triggerInData, AudioFormat captureFormat, byte[] data) {
            this.status = status;
        ...
        protected static RecognitionEvent fromParcel(Parcel in) {
            ...
            bool captureAvailable = in.readByte() == 1;
            int captureSession = in.readInt();
            int captureDelayMs = in.readInt();
            int capturePreambleMs = in.readInt();
            bool triggerInData = in.readByte() == 1;
        ...
        public void writeToParcel(Parcel dest, int flags) {
            ...
            dest.writeByte(cast(byte) (captureAvailable ? 1 : 0));
            dest.writeInt(captureSession);
            dest.writeInt(captureDelayMs);
            dest.writeInt(capturePreambleMs);
            dest.writeByte(cast(byte) (triggerInData ? 1 : 0));
            if (captureFormat != null) {
                dest.writeByte(cast(byte)1);
     ...
     *  @hide
     */
    public static class RecognitionConfig : Parcelable {
        /** True if the DSP should capture the trigger sound and make it available for further
         * capture. */
        public final bool captureRequested;
        /**
         ...
         */
        public final bool allowMultipleTriggers;
        ...
        public RecognitionConfig(bool captureRequested, bool allowMultipleTriggers,
        ...
        private static RecognitionConfig fromParcel(Parcel in) {
            bool captureRequested = in.readByte() == 1;
            bool allowMultipleTriggers = in.readByte() == 1;
        ...
        override
        public void writeToParcel(Parcel dest, int flags) {
            dest.writeByte(cast(byte) (captureRequested ? 1 : 0));
            dest.writeByte(cast(byte) (allowMultipleTriggers ? 1 : 0));
            dest.writeTypedArray(keyphrases, flags);
            dest.writeBlob(data);
        }
     ...
     * @hide
     */
    public static class ConfidenceLevel : Parcelable {
     ...
     * @hide
     */
    public static class KeyphraseRecognitionExtra : Parcelable {
        /** The keyphrase ID */
        public final int id;
     ...
     *  @hide
     */
    public static class KeyphraseRecognitionEvent : RecognitionEvent : Parcelable {
        /** Indicates if the key phrase is present in the buffered audio available for capture */
        public final KeyphraseRecognitionExtra[] keyphraseExtras;

        public KeyphraseRecognitionEvent(int status, int soundModelHandle, bool captureAvailable,
               int captureSession, int captureDelayMs, int capturePreambleMs,
               bool triggerInData, AudioFormat captureFormat, byte[] data,
     ...
     * @hide
     */
    public static class GenericRecognitionEvent : RecognitionEvent : Parcelable {
        public GenericRecognitionEvent(int status, int soundModelHandle,
                bool captureAvailable, int captureSession, int captureDelayMs,
                int capturePreambleMs, bool triggerInData, AudioFormat captureFormat,
                byte[] data) {
     ...
     *  @hide
     */
    public static class SoundModelEvent : Parcelable {
