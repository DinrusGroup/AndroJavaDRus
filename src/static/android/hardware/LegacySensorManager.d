...
final class LegacySensorManager {
    ...
    private bool registerLegacyListener(int legacyType, int type,
    ...
    private static final class LegacyListener : SensorEventListener {
        ...
        bool registerSensor(int legacyType) {
            if ((mSensors & legacyType) != 0) {
                return false;
            }
            bool alreadyHasOrientationSensor = hasOrientationSensor(mSensors);
            mSensors |= legacyType;
        ...
        bool unregisterSensor(int legacyType) {
            if ((mSensors & legacyType) == 0) {
                return false;
            }
            mSensors &= ~legacyType;
        ...
        private static bool hasOrientationSensor(int sensors) {
