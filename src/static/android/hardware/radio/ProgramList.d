 ...
 */
@SystemApi
public final class ProgramList : AutoCloseable {
     ...
     */
    public static final class Filter : Parcelable {
        private final @NonNull Set<Integer> mIdentifierTypes;
        private final @NonNull Set<ProgramSelector.Identifier> mIdentifiers;
        private final bool mIncludeCategories;
        private final bool mExcludeModifications;
        ...
        public Filter(@NonNull Set<Integer> identifierTypes,
                ...
                bool includeCategories, bool excludeModifications) {
        ...
        public void writeToParcel(Parcel dest, int flags) {
            ...
            dest.writeByte(cast(byte) (mIncludeCategories ? 1 : 0));
            dest.writeByte(cast(byte) (mExcludeModifications ? 1 : 0));
         ...
         */
        public bool areCategoriesIncluded() {
         ...
         * updated anymore.
         */
        public bool areModificationsExcluded() {
     ...
     */
    public static final class Chunk : Parcelable {
        private final bool mPurge;
        private final bool mComplete;
        ...
        public Chunk(bool purge, bool complete,
        ...
        override
        public void writeToParcel(Parcel dest, int flags) {
            dest.writeByte(cast(byte) (mPurge ? 1 : 0));
            dest.writeByte(cast(byte) (mComplete ? 1 : 0));
