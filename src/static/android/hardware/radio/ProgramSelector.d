 ...
 */
@SystemApi
public final class ProgramSelector : Parcelable {
     ...
     */
    private static bool isValidAmFmFrequency(bool isAm, int frequencyKhz) {
        if (isAm) {
    ...
    public static @NonNull ProgramSelector createAmFmSelector(
        ...
        bool isAm = (band == RadioManager.BAND_AM || band == RadioManager.BAND_AM_HD);
        bool isDigital = (band == RadioManager.BAND_AM_HD || band == RadioManager.BAND_FM_HD);
     ...
     */
    public static final class Identifier : Parcelable {
