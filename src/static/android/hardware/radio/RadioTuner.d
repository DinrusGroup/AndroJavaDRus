 ...
 * RadioManager.BandConfig, bool, RadioTuner.Callback, Handler)}.
 * @hide
 */
@SystemApi
public abstract class RadioTuner {

    /** Scanning direction UP for {@link #step(int, bool)}, {@link #scan(int, bool)} */
    public static final int DIRECTION_UP      = 0;

    /** Scanning directions DOWN for {@link #step(int, bool)}, {@link #scan(int, bool)} */
     ...
     * </ul>
     */
    public abstract int setMute(bool mute);
     ...
     * </ul>
     */
    public abstract int step(int direction, bool skipSubChannel);
     ...
     * </ul>
     */
    public abstract int scan(int direction, bool skipSubChannel);
     ...
     */
    public abstract bool startBackgroundScan();
     ...
     */
    @Deprecated
    public abstract bool isAnalogForced();
     ...
     * @throws IllegalStateException if the switch is not supported at current
     *         configuration.
     * @deprecated Use {@link setConfigFlag(int, bool)} instead.
     */
    @Deprecated
    public abstract void setAnalogForced(bool isForced);
     ...
     */
    public bool isConfigFlagSupported(@RadioManager.ConfigFlag int flag) {
        return false;
    }
     ...
     */
    public bool isConfigFlagSet(@RadioManager.ConfigFlag int flag) {
     ...
     * @throws UnsupportedOperationException if the flag is not supported at all.
     */
    public void setConfigFlag(@RadioManager.ConfigFlag int flag, bool value) {
        throw new UnsupportedOperationException();
    }
    ...
    public static abstract class Callback {
         ...
         * {@link RadioManager#openTuner(int, RadioManager.BandConfig, bool, Callback, Handler)}
         ...
         *
         * It happens either upon successful completion of {@link RadioTuner#step(int, bool)},
         * {@link RadioTuner#scan(int, bool)}, {@link RadioTuner#tune(int, int)}; when
         ...
         */
        public void onControlChanged(bool control) {}
         ...
         */
        public void onBackgroundScanAvailabilityChange(bool isAvailable) {}
