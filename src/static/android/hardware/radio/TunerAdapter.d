...
class TunerAdapter : RadioTuner {
    ...
    override
    public int step(int direction, bool skipSubChannel) {
        try {
    ...
    override
    public int scan(int direction, bool skipSubChannel) {
        try {
    ...
    override
    public void setAnalogForced(bool isForced) {
        try {
    ...
    override
    public bool isAntennaConnected() {
