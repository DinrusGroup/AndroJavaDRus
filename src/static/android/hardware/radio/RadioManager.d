...
public class RadioManager {
    ...
    public static class ModuleProperties : Parcelable {
        ...
        private final bool mIsInitializationRequired;
        private final bool mIsCaptureSupported;
        private final BandDescriptor[] mBands;
        private final bool mIsBgScanSupported;
        ...
        public ModuleProperties(int id, String serviceName, int classId, String implementor,
                ...
                bool isInitializationRequired, bool isCaptureSupported,
                BandDescriptor[] bands, bool isBgScanSupported,
         ...
         * For use with {@link #openTuner(int, BandConfig, bool, Callback, Handler)}.
         ...
         */
        public bool isBackgroundScanningSupported() {
         ...
         */
        public bool isProgramTypeSupported(@ProgramSelector.ProgramType int type) {
         ...
         * @return {@code true} if a given program type is supported.
         */
        public bool isProgramIdentifierSupported(@ProgramSelector.IdentifierType int type) {
    ...
    public static class BandDescriptor : Parcelable {
     ...
     * @see #BAND_FM
     * @see #BAND_FM_HD */
    public static class FmBandDescriptor : BandDescriptor {
        private final bool mStereo;
        private final bool mRds;
        private final bool mTa;
        private final bool mAf;
        private final bool mEa;

        /** @hide */
        public FmBandDescriptor(int region, int type, int lowerLimit, int upperLimit, int spacing,
                bool stereo, bool rds, bool ta, bool af, bool ea) {
        ...
        public void writeToParcel(Parcel dest, int flags) {
            ...
            dest.writeByte(cast(byte) (mStereo ? 1 : 0));
            dest.writeByte(cast(byte) (mRds ? 1 : 0));
            dest.writeByte(cast(byte) (mTa ? 1 : 0));
            dest.writeByte(cast(byte) (mAf ? 1 : 0));
            dest.writeByte(cast(byte) (mEa ? 1 : 0));
        }
    ...
    /** AM band descriptor.
     * @see #BAND_AM */
    public static class AmBandDescriptor : BandDescriptor {
    ...
    public static class BandConfig : Parcelable {
     ...
     * @see #BAND_FM
     * @see #BAND_FM_HD */
    public static class FmBandConfig : BandConfig {
        private final bool mStereo;
        private final bool mRds;
        private final bool mTa;
        private final bool mAf;
        ...
        public static class Builder {
             ...
             */
            public Builder setStereo(bool state) {
                mStereo = state;
                return this;
            }
             ...
             * @return the same Builder instance.
             */
            public Builder setRds(bool state) {
                mRds = state;
                return this;
            }
             ...
             * @return the same Builder instance.
             */
            public Builder setTa(bool state) {
                mTa = state;
                return this;
            }
             ...
             * @return the same Builder instance.
             */
            public Builder setAf(bool state) {
                mAf = state;
                return this;
            }
             ...
             * @return the same Builder instance.
             */
            public Builder setEa(bool state) {
                mEa = state;
                return this;
            }
        };
     ...
     * @see #BAND_AM */
    public static class AmBandConfig : BandConfig {
        private final bool mStereo;
    ...
    public static class ProgramInfo : Parcelable {
         ...
         * at the very moment.
         */
        public bool isTrafficAnnouncementActive() {
     ...
     */
    @RequiresPermission(Manifest.permission.ACCESS_BROADCAST_RADIO)
    public RadioTuner openTuner(int moduleId, BandConfig config, bool withAudio,
