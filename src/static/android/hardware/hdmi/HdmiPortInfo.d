 ...
 */
@SystemApi
public final class HdmiPortInfo : Parcelable {
    ...
    private final bool mCecSupported;
    private final bool mArcSupported;
    private final bool mMhlSupported;
     ...
     */
    public HdmiPortInfo(int id, int type, int address, bool cec, bool mhl, bool arc) {
        mId = id;
        mType = type;
        mAddress = address;
        mCecSupported = cec;
    ...
    public static final Parcelable.Creator<HdmiPortInfo> CREATOR =
            new Parcelable.Creator<HdmiPortInfo>() {
                ...
                public HdmiPortInfo createFromParcel(Parcel source) {
                    ...
                    bool cec = (source.readInt() == 1);
                    bool arc = (source.readInt() == 1);
                    bool mhl = (source.readInt() == 1);
