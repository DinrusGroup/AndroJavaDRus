...
public abstract class HdmiClient {
     ...
     */
    public void sendKeyEvent(int keyCode, bool isPressed) {
        try {
     ...
     */
    public void sendVendorCommand(int targetAddress, byte[] params, bool hasVendorId) {
        try {
    ...
    private static IHdmiVendorCommandListener getListenerWrapper(
        ...
        return new IHdmiVendorCommandListener.Stub() {
            ...
            override
            public void onControlStateChanged(bool enabled, int reason) {
