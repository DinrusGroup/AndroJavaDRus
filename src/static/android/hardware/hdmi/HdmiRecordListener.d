...
public abstract class HdmiRecordListener {
    ...
    public static class TimerStatusData {
        private bool mOverlapped;
        private int mMediaInfo;
        private bool mProgrammed;
        ...
        static TimerStatusData parseFrom(int result) {
            ...
            if (data.mProgrammed) {
                ...
                data.mDurationHour = bcdByteToInt(cast(byte) ((result >> 16) & 0xFF));
                data.mDurationMinute = bcdByteToInt(cast(byte) ((result >> 8) & 0xFF));
            } else {
