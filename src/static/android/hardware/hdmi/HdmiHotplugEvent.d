 ...
 */
@SystemApi
public final class HdmiHotplugEvent : Parcelable {

    private final int mPort;
    private final bool mConnected;
     ...
     * @hide
     */
    public HdmiHotplugEvent(int port, bool connected) {
        mPort = port;
    ...
    public void writeToParcel(Parcel dest, int flags) {
        dest.writeInt(mPort);
        dest.writeByte(cast(byte) (mConnected ? 1 : 0));
    }
