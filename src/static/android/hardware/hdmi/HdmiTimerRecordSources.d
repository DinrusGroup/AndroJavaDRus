...
public class HdmiTimerRecordSources {
    ...
    /* package */ static class TimeUnit {
        ...
        /* package */ static byte toBcdByte(int value) {
            ...
            return cast(byte) ((digitOfTen << 4) | digitOfOne);
        }
    }
     ...
     */
    @SystemApi
    public static final class Time : TimeUnit {
     ...
     */
    @SystemApi
    public static final class Duration : TimeUnit {
    ...
    public static final class TimerInfo {
        ...
        int toByteArray(byte[] data, int index) {
            // [Day of Month]
            data[index] = cast(byte) mDayOfMonth;
            index += DAY_OF_MONTH_SIZE;
            // [Month of Year]
            data[index] = cast(byte) mMonthOfYear;
            ...
            // [Duration]
            // [Recording Sequence]
            data[index] = cast(byte) mRecordingSequence;
            return getDataSize();
        }
     ...
     */
    private static class ExternalSourceDecorator : RecordSource {
        private final RecordSource mRecordSource;
        ...
        int extraParamToByteArray(byte[] data, int index) {
            data[index] = cast(byte) mExternalSourceSpecifier;
     ...
     */
    @SystemApi
    public static bool checkTimerRecordSource(int sourcetype, byte[] recordSource) {
