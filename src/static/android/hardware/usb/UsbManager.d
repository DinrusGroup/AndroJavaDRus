...
public class UsbManager {
   ...
   /**
     ...
     * <ul>
     * <li> {@link #USB_CONNECTED} bool indicating whether USB is connected or disconnected.
     * <li> {@link #USB_HOST_CONNECTED} bool indicating whether USB is connected or
     *     disconnected as host.
     * <li> {@link #USB_CONFIGURED} bool indicating whether USB is configured.
     * currently zero if not configured, one for configured.
     * <li> {@link #USB_FUNCTION_ADB} bool extra indicating whether the
     * adb function is enabled
     * <li> {@link #USB_FUNCTION_RNDIS} bool extra indicating whether the
     * RNDIS ethernet function is enabled
     * <li> {@link #USB_FUNCTION_MTP} bool extra indicating whether the
     * MTP function is enabled
     * <li> {@link #USB_FUNCTION_PTP} bool extra indicating whether the
     * PTP function is enabled
     * <li> {@link #USB_FUNCTION_ACCESSORY} bool extra indicating whether the
     * accessory function is enabled
     * <li> {@link #USB_FUNCTION_AUDIO_SOURCE} bool extra indicating whether the
     * audio source function is enabled
     * <li> {@link #USB_FUNCTION_MIDI} bool extra indicating whether the
   ...
   /**
     ...
     * containing a bool value indicating whether the user granted permission or not.
     */
    ...
    public UsbDeviceConnection openDevice(UsbDevice device) {
        try {
            ...
            if (pfd != null) {
                ...
                bool result = connection.open(deviceName, pfd, mContext);
                pfd.close();
                if (result) {
                    return connection;
                }
     ...
     */
    @RequiresFeature(PackageManager.FEATURE_USB_ACCESSORY)
    public bool hasPermission(UsbAccessory accessory) {
        if (mService == null) {
            return false;
        }
        try {
     ...
     * <li> {@link #EXTRA_PERMISSION_GRANTED} containing bool indicating whether
     ...
     */
    @Deprecated
    public void setCurrentFunction(String functions, bool usbDataUnlocked) {
        try {
     ...
     * {@hide}
     */
    public static bool areSettableFunctions(long functions) {
