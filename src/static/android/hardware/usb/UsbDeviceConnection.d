...
public class UsbDeviceConnection {
    ...
    /* package */ bool open(String name, ParcelFileDescriptor pfd, @NonNull Context context) {
        mContext = context.getApplicationContext();
        bool wasOpened = native_open(name, pfd.getFileDescriptor());
     ...
     */
    public bool claimInterface(UsbInterface intf, bool force) {
     ...
     */
    public bool releaseInterface(UsbInterface intf) {
     ...
     */
    public bool setInterface(UsbInterface intf) {
     ...
     */
    public bool setConfiguration(UsbConfiguration configuration) {
    ...
    private native bool native_open(String deviceName, FileDescriptor pfd);
    private native void native_close();
    private native int native_get_fd();
    private native byte[] native_get_desc();
    private native bool native_claim_interface(int interfaceID, bool force);
    private native bool native_release_interface(int interfaceID);
    private native bool native_set_interface(int interfaceID, int alternateSetting);
    private native bool native_set_configuration(int configurationID);
    ...
    private native bool native_reset_device();
}
