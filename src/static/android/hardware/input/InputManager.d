...
public final class InputManager {
     ...
     * @hide
     */
    public bool isInputDeviceEnabled(int id) {
        try {
     ...
     * @hide
     */
    public bool[] deviceHasKeys(int[] keyCodes) {
     ...
     * @hide
     */
    public bool[] deviceHasKeys(int id, int[] keyCodes) {
     ...
     * @hide
     */
    public void requestPointerCapture(IBinder windowToken, bool enable) {
        try {
    ...
    private static bool containsDeviceId(int[] deviceIdAndGeneration, int deviceId) {
        for (int i = 0; i < deviceIdAndGeneration.length; i += 2) {
    ...
    private void onTabletModeChanged(long whenNanos, bool inTabletMode) {
        if (DEBUG) {
    ...
    private final class InputDevicesChangedListener : IInputDevicesChangedListener.Stub {
        override
    ...
    private static final class InputDeviceListenerDelegate : Handler {
    ...
    public interface OnTabletModeChangedListener {
         ...
         */
        void onTabletModeChanged(long whenNanos, bool inTabletMode);
    }

    private final class TabletModeChangedListener : ITabletModeChangedListener.Stub {
        override
        public void onTabletModeChanged(long whenNanos, bool inTabletMode) {
            InputManager.this.onTabletModeChanged(whenNanos, inTabletMode);
        }
    }

    private static final class OnTabletModeChangedListenerDelegate : Handler {
        ...
        public void sendTabletModeChanged(long whenNanos, bool inTabletMode) {
    ...
    private final class InputDeviceVibrator : Vibrator {
