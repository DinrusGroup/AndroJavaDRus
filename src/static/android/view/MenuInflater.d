...
public class MenuInflater {
    ...
    private static final Class!(T)[] ACTION_VIEW_CONSTRUCTOR_SIGNATURE = new Class[] {Context.class};

    private static final Class!(T)[] ACTION_PROVIDER_CONSTRUCTOR_SIGNATURE = ACTION_VIEW_CONSTRUCTOR_SIGNATURE;
    ...
    private static class InflatedOnMenuItemClickListener
        ...
        private static final Class!(T)[] PARAM_TYPES = new Class[] { MenuItem.class };
    ...
    private class MenuState {
        ...
        private static final bool defaultItemChecked = false;
        private static final bool defaultItemVisible = true;
        private static final bool defaultItemEnabled = true;
        ...
        public void readItem(AttributeSet attrs) {
            ...
            final bool hasActionProvider = itemActionProviderClassName != null;
        ...
        private <T> T newInstance(String className, Class!(T)[] constructorSignature,
                Object[] arguments) {
            try {
                Class!(T) clazz = mContext.getClassLoader().loadClass(className);
                Constructor!(T) constructor = clazz.getConstructor(constructorSignature);
