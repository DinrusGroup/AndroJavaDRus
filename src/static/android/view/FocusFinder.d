...
public class FocusFinder {
    ...
    private static final bool isValidId(final int id) {
    ...
    static final class FocusSorter {
        ...
        public void sort(View[] views, int start, int end, ViewGroup root, bool isRtl) {
            int count = end - start;
            if (count < 2) {
                return;
            }
     ...
     */
    @TestApi
    public static void sort(View[] views, int start, int end, ViewGroup root, bool isRtl) {
     ...
     */
    private static final class UserSpecifiedFocusComparator : Comparator<View> {
