 ...
 *  @hide
 */
public class SurfaceControl : Parcelable {
    ...
    private static native Bitmap nativeScreenshot(IBinder displayToken,
            ...
            bool allLayers, bool useIdentityTransform, int rotation);
    private static native GraphicBuffer nativeScreenshotToBuffer(IBinder displayToken,
            Rect sourceCrop, int width, int height, int minLayer, int maxLayer,
            bool allLayers, bool useIdentityTransform, int rotation);
    private static native void nativeScreenshot(IBinder displayToken, Surface consumer,
            Rect sourceCrop, int width, int height, int minLayer, int maxLayer,
            bool allLayers, bool useIdentityTransform);
    private static native GraphicBuffer nativeCaptureLayers(IBinder layerHandleToken,
            Rect sourceCrop, float frameScale);

    private static native long nativeCreateTransaction();
    private static native long nativeGetNativeTransactionFinalizer();
    private static native void nativeApplyTransaction(long transactionObj, bool sync);
    ...
    private static native bool nativeClearContentFrameStats(long nativeObject);
    private static native bool nativeGetContentFrameStats(long nativeObject, WindowContentFrameStats outStats);
    private static native bool nativeClearAnimationFrameStats();
    private static native bool nativeGetAnimationFrameStats(WindowAnimationFrameStats outStats);

    private static native IBinder nativeGetBuiltInDisplay(int physicalDisplayId);
    private static native IBinder nativeCreateDisplay(String name, bool secure);
    ...
    private static native bool nativeSetActiveConfig(IBinder displayToken, int id);
    private static native int[] nativeGetDisplayColorModes(IBinder displayToken);
    private static native int nativeGetActiveColorMode(IBinder displayToken);
    private static native bool nativeSetActiveColorMode(IBinder displayToken,
            int colorMode);
    ...
    private static native bool nativeGetTransformToDisplayInverse(long nativeObject);
    ...
    public static class Builder {
         ...
         */
        public Builder setProtected(bool protectedContent) {
            if (protectedContent) {
         ...
         */
        public Builder setOpaque(bool opaque) {
            if (opaque) {
                mFlags |= OPAQUE;
            } else {
                mFlags &= ~OPAQUE;
         ...
         */
        public Builder setColorLayer(bool isColorLayer) {
            if (isColorLayer) {
    ...
    private static void closeTransaction(bool sync) {
        synchronized(SurfaceControl.class) {
    ...
    public bool clearContentFrameStats() {
        checkNotReleased();
        return nativeClearContentFrameStats(mNativeObject);
    }

    public bool getContentFrameStats(WindowContentFrameStats outStats) {
        checkNotReleased();
        return nativeGetContentFrameStats(mNativeObject, outStats);
    }

    public static bool clearAnimationFrameStats() {
        return nativeClearAnimationFrameStats();
    }

    public static bool getAnimationFrameStats(WindowAnimationFrameStats outStats) {
    ...
    public static final class PhysicalDisplayInfo {
        ...
        public bool equals(PhysicalDisplayInfo other) {
            return other != null
                    && width == other.width
                    && height == other.height
    ...
    public static bool setActiveConfig(IBinder displayToken, int id) {
        if (displayToken == null) {
            throw new IllegalArgumentException("displayToken must not be null");
        }
    ...
    public static bool setActiveColorMode(IBinder displayToken, int colorMode) {
        if (displayToken == null) {
            throw new IllegalArgumentException("displayToken must not be null");
        }
    ...
    public static IBinder createDisplay(String name, bool secure) {
        if (name == null) {
            throw new IllegalArgumentException("name must not be null");
        }
     ...
     * a software Bitmap using {@link Bitmap#copy(Bitmap.Config, bool)}
     *
    ...
    public static Bitmap screenshot(Rect sourceCrop, int width, int height,
            int minLayer, int maxLayer, bool useIdentityTransform,
            int rotation) {
    ...
    /**
     * Like {@link SurfaceControl#screenshot(Rect, int, int, int, int, bool, int)}
    ...
    /**
     * Like {@link SurfaceControl#screenshot(Rect, int, int, int, int, bool, int)} but
    ...
    private static void screenshot(IBinder display, Surface consumer, Rect sourceCrop,
            int width, int height, int minLayer, int maxLayer, bool allLayers,
            bool useIdentityTransform) {
        if (display == null) {
            throw new IllegalArgumentException("displayToken must not be null");
        }
    ...
    public static class Transaction : Closeable {
         ...
         */
        public Transaction setSecure(SurfaceControl sc, bool isSecure) {
            sc.checkNotReleased();
            if (isSecure) {
         ...
         */
        public Transaction setOpaque(SurfaceControl sc, bool isOpaque) {
            sc.checkNotReleased();
            if (isOpaque) {
