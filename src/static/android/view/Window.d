...
public abstract class Window {
    ...
    private bool mOverlayWithDecorCaptionEnabled = false;
    private bool mCloseOnSwipeEnabled = false;
    ...
    public interface Callback {
         ...
         *
         * @return bool Return true if event population was completed.
         */
         ...
         *
         * @return bool You must return true for the panel to be displayed;
         ...
         *
         * @return bool Return true to finish processing of selection, or
         ...
         * {@link View#onWindowFocusChanged(bool)
         * View.onWindowFocusChangedNotLocked(bool)} for more information.
         *
         ...
         */
        default public void onPointerCaptureChanged(bool hasCapture) { };
    }
    ...
    public interface OnWindowDismissedCallback {
         ...
         */
        void onWindowDismissed(bool finishTask, bool suppressWindowTransition);
    }
    ...
    public final void dispatchOnWindowDismissed(
            bool finishTask, bool suppressWindowTransition) {
     ...
     */
    protected final bool hasSoftInputMode() {
        return mHasSoftInputMode;
    }

    /** @hide */
    public void setCloseOnTouchOutside(bool close) {
        mCloseOnTouchOutside = close;
        mSetCloseOnTouchOutside = true;
    }

    /** @hide */
    public void setCloseOnTouchOutsideIfNotSet(bool close) {
    ...
    /** @hide */
    public bool shouldCloseOnTouch(Context context, MotionEvent event) {
     ...
     */
    public void setSustainedPerformanceMode(bool enable) {
    ...
    private bool isOutOfBounds(Context context, MotionEvent event) {
    ...
    public abstract bool performPanelShortcut(int featureId,
                                                 int keyCode,
                                                 KeyEvent event,
                                                 int flags);
    public abstract bool performPanelIdentifierAction(int featureId,
                                                 int id,
                                                 int flags);
     ...
     * @see View#setClipToOutline(bool)
     * @see android.R.styleable#Window_windowClipToOutline
     */
    public void setClipToOutline(bool clipToOutline) {}
     ...
     *
     */
    public abstract bool superDispatchKeyEvent(KeyEvent event);
     ...
     *
     */
    public abstract bool superDispatchKeyShortcutEvent(KeyEvent event);
     ...
     *
     */
    public abstract bool superDispatchTouchEvent(MotionEvent event);
     ...
     *
     */
    public abstract bool superDispatchTrackballEvent(MotionEvent event);
     ...
     *
     */
    public abstract bool superDispatchGenericMotionEvent(MotionEvent event);
     ...
     */
    public abstract bool isShortcutKey(int keyCode, KeyEvent event);
     ...
     * @attr ref android.R.styleable#Window_windowAllowEnterTransitionOverlap
     */
    public bool getAllowEnterTransitionOverlap() { return true; }
     ...
     * @attr ref android.R.styleable#Window_windowAllowReturnTransitionOverlap
     */
    public bool getAllowReturnTransitionOverlap() { return true; }
     ...
     */
    public bool getSharedElementsUseOverlay() { return true; }
     ...
     * @hide
     */
    public abstract void onPictureInPictureModeChanged(bool isInPictureInPictureMode);
     ...
     * @hide
     */
    public bool isCloseOnSwipeEnabled() {
