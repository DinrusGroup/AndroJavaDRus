...
public final class DisplayCutout {
     ...
     */
    private DisplayCutout(Rect safeInsets, Region bounds, bool copyArguments) {
    ...
    private static Pair<Path, DisplayCutout> pathAndDisplayCutoutFromSpec(String spec,
        ...
        final bool inDp = spec.endsWith(DP_MARKER);
        if (inDp) {
     ...
     * @hide
     */
    public static final class ParcelableWrapper : Parcelable {
