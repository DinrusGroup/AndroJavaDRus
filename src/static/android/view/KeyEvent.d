 ...
 * </p>
 */
public class KeyEvent : InputEvent : Parcelable {
    ...
    /** @hide */
    override
    public final bool isTainted() {
        return (mFlags & FLAG_TAINTED) != 0;
    }

    /** @hide */
    override
    public final void setTainted(bool tainted) {
     ...
     * @hide
     */
    @Deprecated public final bool isDown() {
     ...
     */
    public static final bool isGamepadButton(int keyCode) {
        switch (keyCode) {
     ...
     * @hide
     */
    public static final bool isConfirmKey(int keyCode) {
        switch (keyCode) {
     ...
     * @hide
     */
    public static final bool isMediaKey(int keyCode) {
        switch (keyCode) {
     ...
     * @hide
     */
    public static final bool isSystemKey(int keyCode) {
        switch (keyCode) {
    ...
    /** @hide */
    public static final bool isWakeKey(int keyCode) {
        switch (keyCode) {
            case KeyEvent.KEYCODE_BACK:
            case KeyEvent.KEYCODE_MENU:
    ...
    /** @hide */
    public static final bool isMetaKey(int keyCode) {
        return keyCode == KeyEvent.KEYCODE_META_LEFT || keyCode == KeyEvent.KEYCODE_META_RIGHT;
    }

    /** @hide */
    public static final bool isAltKey(int keyCode) {
    ...
    private static int metaStateFilterDirectionalModifiers(int metaState,
        ...
        final bool wantBasic = (modifiers & basic) != 0;
        final int directional = left | right;
        final bool wantLeftOrRight = (modifiers & directional) != 0;
     ...
     */
    public final bool hasNoModifiers() {
     ...
     */
    public final bool hasModifiers(int modifiers) {
     ...
     * @see #META_ALT_ON
     */
    public final bool isAltPressed() {
     ...
     * @see #META_SHIFT_ON
     */
    public final bool isShiftPressed() {
     ...
     * @see #META_SYM_ON
     */
    public final bool isSymPressed() {
     ...
     * @see #META_CTRL_ON
     */
    public final bool isCtrlPressed() {
     ...
     * @see #META_META_ON
     */
    public final bool isMetaPressed() {
     ...
     * @see #META_FUNCTION_ON
     */
    public final bool isFunctionPressed() {
     ...
     * @see #META_CAPS_LOCK_ON
     */
    public final bool isCapsLockOn() {
     ...
     * @see #META_SCROLL_LOCK_ON
     */
    public final bool isScrollLockOn() {
     ...
     */
    @Deprecated
    public bool getKeyData(KeyData results) {
     ...
     */
    @Deprecated
    public final bool dispatch(Callback receiver) {
     ...
     */
    public final bool dispatch(Callback receiver, DispatcherState state,
            Object target) {
        switch (mAction) {
            case ACTION_DOWN: {
                mFlags &= ~FLAG_START_TRACKING;
    ...
    public static class DispatcherState {
         ...
         */
        public bool isTracking(KeyEvent event) {
    ...
    public static String metaStateToString(int metaState) {
        ...
        int i = 0;
        while (metaState != 0) {
            final bool isSet = (metaState & 1) != 0;
