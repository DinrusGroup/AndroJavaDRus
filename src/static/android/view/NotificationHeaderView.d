...
public class NotificationHeaderView : ViewGroup {
    ...
    private bool mShowExpandButtonAtEnd;
    private bool mShowWorkBadgeAtEnd;
    private Drawable mBackground;
    private bool mEntireHeaderClickable;
    private bool mExpandOnlyOnButton;
    private bool mAcceptAllTouches;
    ...
    protected void onLayout(bool changed, int l, int t, int r, int b) {
        ...
        final bool centerAligned = (mGravity & Gravity.CENTER_HORIZONTAL) != 0;
        if (centerAligned) {
    ...
    public void setShowWorkBadgeAtEnd(bool showWorkBadgeAtEnd) {
     ...
     * both this and {@link #setShowWorkBadgeAtEnd(bool)} have been set to true, then the
     * expand button will appear closer to the end than the work badge.
     */
    public void setShowExpandButtonAtEnd(bool showExpandButtonAtEnd) {
    ...
    public class HeaderTouchListener : View.OnTouchListener {

        private final ArrayList<Rect> mTouchRects = new ArrayList<>();
        private Rect mExpandButtonRect;
        private Rect mAppOpsRect;
        private int mTouchSlop;
        private bool mTrackGesture;
    ...
    public bool isInTouchRect(float x, float y) {
     ...
     */
    @RemotableViewMethod
    public void setAcceptAllTouches(bool acceptAllTouches) {
     ...
     */
    @RemotableViewMethod
    public void setExpandOnlyOnButton(bool expandOnlyOnButton) {
