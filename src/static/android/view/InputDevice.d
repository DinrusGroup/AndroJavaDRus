 ...
 * </p>
 */
public final class InputDevice : Parcelable {
    ...
    private final bool mIsExternal;
    private final int mSources;
    private final int mKeyboardType;
    private final KeyCharacterMap mKeyCharacterMap;
    private final bool mHasVibrator;
    private final bool mHasMicrophone;
    private final bool mHasButtonUnderPad;
    ...
    private InputDevice(int id, int generation, int controllerNumber, String name, int vendorId,
            int productId, String descriptor, bool isExternal, int sources, int keyboardType,
            KeyCharacterMap keyCharacterMap, bool hasVibrator, bool hasMicrophone,
     ...
     */
    public bool supportsSource(int source) {
     ...
     * @return An array of bools where each member specifies whether the device is capable of
     * generating the keycode given by the corresponding value at the same index in the keys array.
     */
    public bool[] hasKeys(int... keys) {
    ...
    public static final class MotionRange {
         ...
         */
        public bool isFromSource(int source) {
