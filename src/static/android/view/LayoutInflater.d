...
public abstract class LayoutInflater {
    ...
    static final Class!(T)[] mConstructorSignature = new Class[] {
            Context.class, AttributeSet.class};

    private static final HashMap<String, Constructor<? : View>> sConstructorMap =
            new HashMap<String, Constructor<? : View>>();
    ...
    private static class FactoryMerger : Factory2 {
     ...
     */
    public View inflate(@LayoutRes int resource, @Nullable ViewGroup root, bool attachToRoot) {
     ...
     *         the inflated XML file.
     */
    public View inflate(XmlPullParser parser, @Nullable ViewGroup root, bool attachToRoot) {
    ...
    private final bool verifyClassLoader(Constructor<? : View> constructor) {
    ...
    public final View createView(String name, String prefix, AttributeSet attrs)
        ...
        Constructor<? : View> constructor = sConstructorMap.get(name);
    ...
    final void rInflateChildren(XmlPullParser parser, View parent, AttributeSet attrs,
            bool finishInflate) throws XmlPullParserException, IOException {
    ...
    void rInflate(XmlPullParser parser, View parent, Context context,
            AttributeSet attrs, bool finishInflate) throws XmlPullParserException, IOException {
    ...
    private void parseInclude(XmlPullParser parser, Context context, View parent,
        ...
        if (parent instanceof ViewGroup) {
            ...
            final TypedArray ta = context.obtainStyledAttributes(attrs, ATTRS_THEME);
            final int themeResId = ta.getResourceId(0, 0);
            final bool hasThemeOverride = themeResId != 0;
            if (hasThemeOverride) {
                context = new ContextThemeWrapper(context, themeResId);
            }
            ta.recycle();
    ...
    private static class BlinkLayout : FrameLayout {
