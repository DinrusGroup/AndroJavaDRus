 ...
 */
public class Surface : Parcelable {
    ...
    private static native bool nativeIsValid(long nativeObject);
    private static native bool nativeIsConsumerRunningBehind(long nativeObject);
    ...
    private static native int nativeSetSharedBufferModeEnabled(long nativeObject, bool enabled);
    private static native int nativeSetAutoRefreshEnabled(long nativeObject, bool enabled);
    ...
    private bool mIsSingleBuffered;
    private bool mIsSharedBufferModeEnabled;
    private bool mIsAutoRefreshEnabled;
     ...
     * @hide
     */
    public bool isConsumerRunningBehind() {
        synchronized (mLock) {
            checkNotReleasedLocked();
     ...
     * {@link #setAutoRefreshEnabled(bool) auto-refresh} to avoid the overhead of
     ...
     * @see #setAutoRefreshEnabled(bool)
     *
     * @hide
     */
    public void setSharedBufferModeEnabled(bool enabled) {
     ...
     *
     * @see #setSharedBufferModeEnabled(bool)
     *
     * @hide
     */
    public bool isSharedBufferModeEnabled() {
     ...
     *
     * <p>Auto-refresh has no effect if the {@link #setSharedBufferModeEnabled(bool)
    ...
    public static class OutOfResourcesException : RuntimeException {
     ...
     * </ul>
     */
    private final class CompatibleCanvas : Canvas {
    ...
    private final class HwuiContext {
        ...
        private final bool mIsWideColorGamut;

        HwuiContext(bool isWideColorGamut) {
    ...
    private static native long nHwuiCreate(long rootNode, long surface, bool isWideColorGamut);
