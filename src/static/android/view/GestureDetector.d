...
public class GestureDetector {
     ...
     * of all the gestures. This : all methods in the
     ...
     */
    public static class SimpleOnGestureListener : OnGestureListener, OnDoubleTapListener,
        ...
        public bool onScroll(MotionEvent e1, MotionEvent e2,
    ...
    private bool mDeferConfirmSingleTap;
    private bool mInLongPress;
    private bool mInContextClick;
    ...
    private class GestureHandler : Handler {
        GestureHandler() {
            super();
        }
     ...
     */
    public void setIsLongpressEnabled(bool isLongpressEnabled) {
    ...
    private bool isConsideredDoubleTap(MotionEvent firstDown, MotionEvent firstUp,
