...
public class ScaleGestureDetector {
     ...
     * of scaling-related events. This : all methods in
     ...
     * {@code true}.
     */
    public static class SimpleOnScaleGestureListener : OnScaleGestureListener {
    ...
    private bool mStylusScaleEnabled;
    ...
    private bool mEventBeforeOrAboveStartingGestureEvent;
    ...
    public bool onTouchEvent(MotionEvent event) {
        ...
        final bool isStylusButtonDown =
                (event.getButtonState() & MotionEvent.BUTTON_STYLUS_PRIMARY) != 0;

        final bool anchoredScaleCancelled =
                mAnchoredScaleMode == ANCHORED_SCALE_MODE_STYLUS && !isStylusButtonDown;
        final bool streamComplete = action == MotionEvent.ACTION_UP ||
        ...
        final bool configChanged = action == MotionEvent.ACTION_DOWN ||
                action == MotionEvent.ACTION_POINTER_UP ||
                action == MotionEvent.ACTION_POINTER_DOWN || anchoredScaleCancelled;

        final bool pointerUp = action == MotionEvent.ACTION_POINTER_UP;
        ...
        final bool wasInProgress = mInProgress;
        mFocusX = focusX;
        mFocusY = focusY;
    ...
    private bool inAnchoredScaleMode() {
     ...
     */
    public void setQuickScaleEnabled(bool scales) {
   ...
   */
     ...
     */
    public void setStylusScaleEnabled(bool scales) {
