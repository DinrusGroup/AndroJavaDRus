 ...
 * @hide
 */
public class RemoteAnimationTarget : Parcelable {
     ...
     */
    public final bool isTranslucent;
     ...
     * anything that : beyond these bounds will not have any effect. This implies that any
     ...
     */
    public bool isNotInRecents;

    public RemoteAnimationTarget(int taskId, int mode, SurfaceControl leash, bool isTranslucent,
            Rect clipRect, Rect contentInsets, int prefixOrderIndex, Point position,
            Rect sourceContainerBounds, WindowConfiguration windowConfig, bool isNotInRecents) {
        this.mode = mode;
        this.taskId = taskId;
        this.leash = leash;
