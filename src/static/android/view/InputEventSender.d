...
public abstract class InputEventSender {
    ...
    private static native bool nativeSendKeyEvent(long senderPtr, int seq, KeyEvent event);
    private static native bool nativeSendMotionEvent(long senderPtr, int seq, MotionEvent event);
     ...
     */
    public final bool sendInputEvent(int seq, InputEvent event) {
        if (event == null) {
    ...
    private void dispatchInputEventFinished(int seq, bool handled) {
