...
public final class AutofillManager {
    ...
    public interface AutofillClient {
         ...
         */
        bool autofillClientRequestShowFillUi(@NonNull View anchor, int width, int height,
         ...
         */
        bool autofillClientRequestHideFillUi();
         ...
         */
        bool autofillClientIsFillUiShowing();
         ...
         */
        @NonNull bool[] autofillClientGetViewVisibility(@NonNull AutofillId[] autofillIds);
         ...
         */
        bool autofillClientIsVisibleForAutofill();

        /**
         * Client might disable enter/exit event e.g. when activity is paused.
         */
        bool isDisablingEnterExitEventForAutofill();
        ...
        /**
          ...
          */
        bool autofillClientIsCompatibilityModeEnabled();
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        synchronized (mLock) {
            ...
            if (mSessionId != NO_SESSION) {
                ...
                if (client != null) {
                    try {
                        final bool sessionWasRestored = mService.restoreSession(mSessionId,
     ...
     */
    @GuardedBy("mLock")
    public bool isCompatibilityModeEnabledLocked() {
    ...
    @GuardedBy("mLock")
    private bool shouldIgnoreViewEnteredLocked(@NonNull AutofillId id, int flags) {
        if (isDisabledByServiceLocked()) {
            if (sVerbose) {
    ...
    private bool isClientVisibleForAutofillLocked() {
        final AutofillClient client = getClient();
        return client != null && client.autofillClientIsVisibleForAutofill();
    }

    private bool isClientDisablingEnterExitEvent() {
        final AutofillClient client = getClient();
     ...
     */
    public void notifyViewVisibilityChanged(@NonNull View view, bool isVisible) {
     ...
     * @param isVisible visible if the view is visible in the view hierarchy.
     */
    public void notifyViewVisibilityChanged(@NonNull View view, int virtualId, bool isVisible) {
     ...
     * @hide
     */
    public bool isAutofillUiShowing() {
        final AutofillClient client = mContext.getAutofillClient();
    ...
    @GuardedBy("mLock")
    private void resetSessionLocked(bool resetEnteredIds) {
        mSessionId = NO_SESSION;
        mState = STATE_UNKNOWN;
        mTrackedViews = null;
        mFillableIds = null;
    ...
    private void updateSessionLocked(AutofillId id, Rect bounds, AutofillValue value, int action,
        ...
        bool restartIfNecessary = (flags & FLAG_MANUAL_REQUEST) != 0;
    ...
    public void registerCallback(@Nullable AutofillCallback callback) {
        ...
        synchronized (mLock) {
            ...
            final bool hadCallback = mCallback != null;
            mCallback = callback;
    ...
    private void setTrackedViews(int sessionId, @Nullable AutofillId[] trackedIds,
            bool saveOnAllViewsInvisible, bool saveOnFinish,
    ...
    private void setNotifyOnClickLocked(@NonNull AutofillId id, bool notify) {
    ...
    private void setSaveUiState(int sessionId, bool shown) {
    ...
    private void requestHideFillUi(AutofillId id, bool force) {
    ...
    /** @hide */
    public bool hasAutofillFeature() {
    ...
    @GuardedBy("mLock")
    private bool isDisabledByServiceLocked() {
     ...
     */
    private final class CompatibilityBridge : AccessibilityManager.AccessibilityPolicy {
        @GuardedBy("mLock")
        ...
        override
        public bool isEnabled(bool accessibilityEnabled) {
            return true;
        }
        ...
        public AccessibilityEvent onAccessibilityEvent(AccessibilityEvent event,
                bool accessibilityEnabled, int relevantEventTypes) {
        ...
        private bool notifyViewEntered(int windowId, long nodeId, Rect focusedBounds) {
        ...
        private bool isVirtualNode(int nodeId) {
    ...
    private class TrackedViews {
        ...
        private <T> bool isInSet(@Nullable ArraySet<T> set, T value) {
        ...
        TrackedViews(@Nullable AutofillId[] trackedIds) {
            ...
            if (!ArrayUtils.isEmpty(trackedIds) && client != null) {
                ...
                if (client.autofillClientIsVisibleForAutofill()) {
                    ...
                    // All false
                    isVisible = new bool[trackedIds.length];
                }
         ...
         */
        @GuardedBy("mLock")
        void notifyViewVisibilityChangedLocked(@NonNull AutofillId id, bool isVisible) {
            if (sDebug) {
        ...
        void onVisibleForAutofillChangedLocked() {
            ...
            if (client != null) {
                ...
                if (mInvisibleTrackedIds != null) {
                    ...
                    final bool[] isVisible = client.autofillClientGetViewVisibility(
    ...
    private static final class AutofillManagerClient : IAutoFillManagerClient.Stub {
        ...
        public void setTrackedViews(int sessionId, AutofillId[] ids,
                bool saveOnAllViewsInvisible, bool saveOnFinish, AutofillId[] fillableIds,
        ...
        override
        public void setSaveUiState(int sessionId, bool shown) {
            final AutofillManager afm = mAfm.get();
            if (afm != null) {
