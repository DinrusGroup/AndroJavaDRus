...
public final class InputEventConsistencyVerifier {
    private static final bool IS_ENG_BUILD = Build.IS_ENG;
    ...
    public void onTouchEvent(MotionEvent event, int nestingLevel) {
        ...
        final int action = event.getAction();
        final bool newStream = action == MotionEvent.ACTION_DOWN
    ...
    private bool startEvent(InputEvent event, int nestingLevel, String eventType) {
    ...
    private static void appendEvent(StringBuilder message, int index,
            InputEvent event, bool unhandled) {
    ...
    private KeyState findKeyState(int deviceId, int source, int keyCode, bool remove) {
        KeyState last = null;
