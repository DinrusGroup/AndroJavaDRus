 ...
 */
public final class InputMethodInfo : Parcelable {
    static final String TAG = "InputMethodInfo";

    /**
     * The Service that : this input method component.
     */
    ...
    /**
     * The resource in the input method's .apk that holds a bool indicating
    ...
    public InputMethodInfo(Context context, ResolveInfo service,
        ...
        bool isAuxIme = true;
        bool supportsSwitchingToNextInputMethod = false; // false as default
        mForceDefault = false;
     ...
     * @hide
     */
    public InputMethodInfo(ResolveInfo ri, bool isAuxIme,
     ...
     * @hide
     */
    public InputMethodInfo(ResolveInfo ri, bool isAuxIme, String settingsActivity,
            List<InputMethodSubtype> subtypes, int isDefaultResId, bool forceDefault,
            bool supportsSwitchingToNextInputMethod, bool isVrOnly) {
    ...
    /**
     * Return the .apk package that : this input method.
     */
    ...
    /**
     * Return the class name of the service component that :
     * this input method.
     */
    ...
    /**
     * Return the component of the service that : this input
     * method.
     */
     ...
     * @hide
     */
    public bool isDefault(Context context) {
        if (mForceDefault) {
            return true;
        }
        try {
     ...
     * @hide
     */
    public bool supportsSwitchingToNextInputMethod() {
