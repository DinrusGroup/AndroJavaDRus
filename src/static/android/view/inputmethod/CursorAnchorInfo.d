 ...
 * actually inserted.</p>
 */
public final class CursorAnchorInfo : Parcelable {
    /**
     ...
     */
    private static bool areSameFloatImpl(final float a, final float b) {
    ...
    public static final class Builder {
        ...
        private bool mMatrixInitialized = false;
        ...
        public CursorAnchorInfo build() {
            if (!mMatrixInitialized) {
                ...
                final bool hasCharacterBounds = (mCharacterBoundsArrayBuilder != null
