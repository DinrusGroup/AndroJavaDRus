 ...
 * <li> An <strong>input method (IME)</strong> : a particular
...
public final class InputMethodManager {
    ...
    /**
     * {@code true} if next {@link #onPostWindowFocus(View, View, int, bool, int)} needs to
     * restart input.
     */
    bool mRestartOnNextWindowFocus = true;
    ...
    private static bool isAutofillUIShowing(View servedView) {
        AutofillManager afm = servedView.getContext().getSystemService(AutofillManager.class);
        return afm != null && afm.isAutofillUiShowing();
    }

    private static bool canStartInput(View servedView) {
    ...
    class H : Handler {
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                ...
                case MSG_SET_ACTIVE: {
                    final bool active = msg.arg1 != 0;
                    final bool fullscreen = msg.arg2 != 0;
                    if (DEBUG) {
    ...
    private static class ControlledInputConnectionWrapper : IInputConnectionWrapper {
    ...
    final IInputMethodClient.Stub mClient = new IInputMethodClient.Stub() {
        ...
        override
        public void setUsingInputMethod(bool state) {
        }
        ...
        override
        public void setActive(bool active, bool fullscreen) {
        ...
        override
        public void reportFullscreenMode(bool fullscreen) {
     ...
     * @param allowsImplicitlySelectedSubtypes A bool flag to allow to return the implicitly
     ...
     */
    public bool showSoftInput(View view, int flags) {
     ...
     * {@link #RESULT_HIDDEN}.
     */
    public bool showSoftInput(View view, int flags, ResultReceiver resultReceiver) {
        checkFocus();
        synchronized (mH) {
            if (mServedView != view && (mServedView == null
                    || !mServedView.checkInputConnectionProxy(view))) {
     ...
     */
    public bool hideSoftInputFromWindow(IBinder windowToken, int flags) {
    ...
    bool startInputInner(@InputMethodClient.StartInputReason final int startInputReason,
    ...
    private bool checkFocusNoStartInput(bool forceNewFocus) {
    ...
    public void onPostWindowFocus(View rootView, View focusedView,
            @SoftInputModeFlags int softInputMode, bool first, int windowFlags) {
        bool forceNewFocus = false;
        synchronized (mH) {
    ...
    /** @hide */
    public void onPreWindowFocus(View rootView, bool hasWindowFocus) {
        synchronized (mH) {
            if (rootView == null) {
                mCurRootView = null;
            } if (hasWindowFocus) {
    ...
    public void viewClicked(View view) {
        final bool focusChanged = mServedView != mNextServedView;
        checkFocus();
        synchronized (mH) {
            if ((mServedView != view && (mServedView == null
                    || !mServedView.checkInputConnectionProxy(view)))
     ...
     * @hide
     */
    public bool isCursorAnchorInfoEnabled() {
        synchronized (mH) {
            final bool isImmediate = (mRequestUpdateCursorAnchorInfoMonitorMode &
                    InputConnection.CURSOR_UPDATE_IMMEDIATE) != 0;
            final bool isMonitoring = (mRequestUpdateCursorAnchorInfoMonitorMode &
    ...
    void finishedInputEvent(int seq, bool handled, bool timeout) {
    ...
    void invokeFinishedInputEventCallback(PendingEvent p, bool handled) {
        p.mHandled = handled;
     ...
     * @hide
     */
    public void showInputMethodPicker(bool showAuxiliarySubtypes) {
        synchronized (mH) {
            try {
     ...
     */
    @TestApi
    public bool isInputMethodPickerShown() {
        try {
     ...
     */
    @Deprecated
    public bool switchToLastInputMethod(IBinder imeToken) {
     ...
     * @hide
     */
    public bool switchToPreviousInputMethodInternal(IBinder imeToken) {
        synchronized (mH) {
            try {
     ...
     * @deprecated Use {@link InputMethodService#switchToNextInputMethod(bool)} instead. This
     ...
     */
    @Deprecated
    public bool switchToNextInputMethod(IBinder imeToken, bool onlyCurrentIme) {
     ...
     * @hide
     */
    public bool switchToNextInputMethodInternal(IBinder imeToken, bool onlyCurrentIme) {
        synchronized (mH) {
            try {
     ...
     */
    @Deprecated
    public bool shouldOfferSwitchingToNextInputMethod(IBinder imeToken) {
     ...
     * @hide
     */
    public bool shouldOfferSwitchingToNextInputMethodInternal(IBinder imeToken) {
        synchronized (mH) {
            try {
    ...
    private final class ImeInputEventSender : InputEventSender {
        public ImeInputEventSender(InputChannel inputChannel, Looper looper) {
            super(inputChannel, looper);
        }

        override
        public void onInputEventFinished(int seq, bool handled) {
            finishedInputEvent(seq, handled, false);
        }
    }

    private final class PendingEvent : Runnable {
