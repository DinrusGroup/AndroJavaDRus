...
public final class InputConnectionInspector {
    ...
    private static bool hasGetSelectedText(@NonNull final Class clazz) {
        try {
    ...
    private static bool hasSetComposingRegion(@NonNull final Class clazz) {
        try {
    ...
    private static bool hasCommitCorrection(@NonNull final Class clazz) {
        try {
    ...
    private static bool hasRequestCursorUpdate(@NonNull final Class clazz) {
        try {
    ...
    private static bool hasDeleteSurroundingTextInCodePoints(@NonNull final Class clazz) {
        try {
    ...
    private static bool hasGetHandler(@NonNull final Class clazz) {
        try {
    ...
    private static bool hasCloseConnection(@NonNull final Class clazz) {
        try {
    ...
    private static bool hasCommitContent(@NonNull final Class clazz) {
        try {
