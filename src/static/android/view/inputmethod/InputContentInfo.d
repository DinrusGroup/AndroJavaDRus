 ...
 */
public final class InputContentInfo : Parcelable {
     ...
     * @throws InvalidParameterException if any invalid parameter is specified.
     */
    private static bool validateInternal(@NonNull Uri contentUri,
            @NonNull ClipDescription description, @Nullable Uri linkUri, bool throwException) {
        if (contentUri == null) {
            if (throwException) {
