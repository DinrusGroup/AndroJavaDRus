...
public interface MenuItem {
    ...
    public interface OnActionExpandListener {
         ...
         */
        public bool onMenuItemActionExpand(MenuItem item);
         ...
         */
        public bool onMenuItemActionCollapse(MenuItem item);
    }
     ...
     * mutually-exclusive items (set via {@link Menu#setGroupCheckable(int, bool, bool)},
     ...
     * set it to invisible and {@link #setEnabled(bool) disabled}).
     * 
     ...
     * @hide
     */
    default bool requiresActionButton() {
        return false;
    }
