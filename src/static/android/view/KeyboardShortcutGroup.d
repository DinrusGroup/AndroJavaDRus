...
public final class KeyboardShortcutGroup : Parcelable {
    ...
    @TestApi
    public KeyboardShortcutGroup(@Nullable CharSequence label,
            @NonNull List<KeyboardShortcutInfo> items, bool isSystemGroup) {
        mLabel = label;
        mItems = new ArrayList<>(checkNotNull(items));
     ...
     */
    @TestApi
    public KeyboardShortcutGroup(@Nullable CharSequence label, bool isSystemGroup) {
