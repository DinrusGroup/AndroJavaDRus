...
public final class WindowInsets {
     ...
     */
    private bool mAlwaysConsumeNavBar;

    private bool mSystemWindowInsetsConsumed = false;
    private bool mWindowDecorInsetsConsumed = false;
    private bool mStableInsetsConsumed = false;
    private bool mDisplayCutoutConsumed = false;
    ...
    public WindowInsets(Rect systemWindowInsets, Rect windowDecorInsets, Rect stableInsets,
            bool isRound, bool alwaysConsumeNavBar, DisplayCutout displayCutout) {
     ...
     * @hide pending API
     */
    public bool hasWindowDecorInsets() {
     ...
     * @hide pending API
     */
    public WindowInsets consumeSystemWindowInsets(bool left, bool top,
     ...
     * @hide
     */
    public WindowInsets consumeWindowDecorInsets(bool left, bool top,
            bool right, bool bottom) {
        if (left || top || right || bottom) {
            final WindowInsets result = new WindowInsets(this);
     ...
     * @hide
     */
    public bool shouldAlwaysConsumeNavBar() {
     ...
     */
    bool isSystemWindowInsetsConsumed() {
