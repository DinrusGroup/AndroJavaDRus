...
public interface WindowManager : ViewManager {
     ...
     * is invalid.
     */
    public static class BadTokenException : RuntimeException {
     ...
     */
    public static class InvalidDisplayException : RuntimeException {
    ...
    public static class LayoutParams : ViewGroup.LayoutParams : Parcelable {
        /**
         ...
         * @hide
         */
        public static bool isSystemAlertWindowType(int type) {
            switch (type) {
                case TYPE_PHONE:
         ...
         * {@link android.app.Activity#setShowWhenLocked(bool)} instead to prevent an
         ...
         * {@link android.app.Activity#setTurnScreenOn(bool)} instead to prevent an
         * unintentional double life-cycle event.
         */
        @Deprecated
         ...
         * {@link View#setFitsSystemWindows(bool) View.setFitsSystemWindows(bool)}
         ...
         * {@link Window#setLocalFocus(bool, bool)}.
         ...
         * {@link
         * android.service.wallpaper.WallpaperService.Engine#setOffsetNotificationsEnabled(bool)}.
         *
         * @hide
         */
         ...
         * @hide
         */
        public bool hasManualSurfaceInsets;
         ...
         * @hide
         */
        public bool preservePreviousSurfaceInsets = true;
         ...
         *
         * <p>
         * In this mode, the window : under cutouts on the short edge of the display in both
         ...
         * @hide
         */
        public final void setSurfaceInsets(View view, bool manual, bool preservePrevious) {
