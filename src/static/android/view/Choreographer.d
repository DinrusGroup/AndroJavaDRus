...
public final class Choreographer {
    ...
    private static final bool DEBUG_JANK = false;

    // Prints debug messages about every frame and callback registered (high volume).
    private static final bool DEBUG_FRAMES = false;
    ...
    private static final bool USE_VSYNC = SystemProperties.getBoolean(
            "debug.choreographer.vsync", true);

    // Enable/disable using the frame time instead of returning now.
    private static final bool USE_FRAME_TIME = SystemProperties.getBoolean(
    ...
    private bool mFrameScheduled;
    private bool mCallbacksRunning;
    private long mLastFrameTimeNanos;
    private long mFrameIntervalNanos;
    private bool mDebugPrintNextFrameTimeDelta;
    ...
    private bool isRunningOnLooperThreadLocked() {
    ...
    private final class FrameHandler : Handler {
    ...
    private final class FrameDisplayEventReceiver : DisplayEventReceiver
            : Runnable {
        private bool mHavePendingVsync;
    ...
    private final class CallbackQueue {
        ...
        public bool hasDueCallbacksLocked(long now) {
