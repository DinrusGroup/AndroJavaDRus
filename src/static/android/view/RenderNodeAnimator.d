 ...
 * @hide
 */
public class RenderNodeAnimator : Animator {
    ...
    private final bool mUiThreadHandlesDelay;
    ...
    static bool isNativeInterpolator(TimeInterpolator interpolator) {
     ...
     */
    private bool processDelayed(long frameTimeMs) {
        if (mStartTime == 0) {
    ...
    private static native void nSetAllowRunningAsync(long animPtr, bool mayRunAsync);
