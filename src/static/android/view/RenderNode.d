...
public class RenderNode {
     ...
     *
     * @return bool true if the display list is able to be replayed, false otherwise.
     */
    public bool isValid() {
    ...
    public bool setLayerType(int layerType) {
        return nSetLayerType(mNativeRenderNode, layerType);
    }

    public bool setLayerPaint(@Nullable Paint paint) {
        return nSetLayerPaint(mNativeRenderNode, paint != null ? paint.getNativeInstance() : 0);
    }

    public bool setClipBounds(@Nullable Rect rect) {
        if (rect == null) {
     ...
     */
    public bool setClipToBounds(bool clipToBounds) {
     ...
     */
    public bool setProjectionReceiver(bool shouldRecieve) {
     ...
     */
    public bool setOutline(@Nullable Outline outline) {
        if (outline == null) {
    ...
    /** setSpotShadowColor */
    public bool setSpotShadowColor(int color) {
        return nSetSpotShadowColor(mNativeRenderNode, color);
    }

    /** setAmbientShadowColor */
    public bool setAmbientShadowColor(int color) {
     ...
     */
    public bool setRevealClip(bool shouldClip,
     ...
     */
    public bool setStaticMatrix(Matrix matrix) {
     ...
     */
    public bool setAnimationMatrix(Matrix matrix) {
     ...
     *
     * @see #setHasOverlappingRendering(bool)
     */
    ...
    public bool setElevation(float lift) {
     ...
     * @see #getTranslationX()
     */
    public bool setTranslationX(float translationX) {
     ...
     * @see #getTranslationY()
     */
    public bool setTranslationY(float translationY) {
     ...
     * @see #getRotationX()
     */
    public bool setRotationX(float rotationX) {
     ...
     * @see #getScaleX()
     */
    public bool setScaleX(float scaleX) {
     ...
     * @see #getScaleY()
     */
    public bool setScaleY(float scaleY) {
     ...
     * @see #getPivotY()
     */
    public bool setPivotY(float pivotY) {
     ...
     */
    public bool setRight(int right) {
     ...
     */
    public bool setBottom(int bottom) {
     ...
     * @see View#setBottom(int)
     */
    public bool setLeftTopRightBottom(int left, int top, int right, int bottom) {
     ...
     */
    public bool offsetLeftAndRight(int offset) {
    ...
    @CriticalNative
    private static native bool nIsValid(long renderNode);
    ...
    @CriticalNative
    private static native bool nHasIdentityMatrix(long renderNode);

    // Properties

    @CriticalNative
    private static native bool nOffsetTopAndBottom(long renderNode, int offset);
    @CriticalNative
    private static native bool nOffsetLeftAndRight(long renderNode, int offset);
    @CriticalNative
    private static native bool nSetLeftTopRightBottom(long renderNode, int left, int top,
            int right, int bottom);
    @CriticalNative
    private static native bool nSetBottom(long renderNode, int bottom);
    @CriticalNative
    private static native bool nSetRight(long renderNode, int right);
    @CriticalNative
    private static native bool nSetTop(long renderNode, int top);
    @CriticalNative
    private static native bool nSetLeft(long renderNode, int left);
    @CriticalNative
    private static native bool nSetCameraDistance(long renderNode, float distance);
    @CriticalNative
    private static native bool nSetPivotY(long renderNode, float pivotY);
    @CriticalNative
    private static native bool nSetPivotX(long renderNode, float pivotX);
    @CriticalNative
    private static native bool nResetPivot(long renderNode);
    @CriticalNative
    private static native bool nSetLayerType(long renderNode, int layerType);
    @CriticalNative
    private static native bool nSetLayerPaint(long renderNode, long paint);
    @CriticalNative
    private static native bool nSetClipToBounds(long renderNode, bool clipToBounds);
    @CriticalNative
    private static native bool nSetClipBounds(long renderNode, int left, int top,
            int right, int bottom);
    @CriticalNative
    private static native bool nSetClipBoundsEmpty(long renderNode);
    @CriticalNative
    private static native bool nSetProjectBackwards(long renderNode, bool shouldProject);
    @CriticalNative
    private static native bool nSetProjectionReceiver(long renderNode, bool shouldRecieve);
    @CriticalNative
    private static native bool nSetOutlineRoundRect(long renderNode, int left, int top,
            int right, int bottom, float radius, float alpha);
    @CriticalNative
    private static native bool nSetOutlineConvexPath(long renderNode, long nativePath,
            float alpha);
    @CriticalNative
    private static native bool nSetOutlineEmpty(long renderNode);
    @CriticalNative
    private static native bool nSetOutlineNone(long renderNode);
    @CriticalNative
    private static native bool nHasShadow(long renderNode);
    @CriticalNative
    private static native bool nSetSpotShadowColor(long renderNode, int color);
    @CriticalNative
    private static native bool nSetAmbientShadowColor(long renderNode, int color);
    @CriticalNative
    ...
    @CriticalNative
    private static native bool nSetClipToOutline(long renderNode, bool clipToOutline);
    @CriticalNative
    private static native bool nSetRevealClip(long renderNode,
            bool shouldClip, float x, float y, float radius);
    @CriticalNative
    private static native bool nSetAlpha(long renderNode, float alpha);
    @CriticalNative
    private static native bool nSetHasOverlappingRendering(long renderNode,
            bool hasOverlappingRendering);
    @CriticalNative
    private static native bool nSetElevation(long renderNode, float lift);
    @CriticalNative
    private static native bool nSetTranslationX(long renderNode, float translationX);
    @CriticalNative
    private static native bool nSetTranslationY(long renderNode, float translationY);
    @CriticalNative
    private static native bool nSetTranslationZ(long renderNode, float translationZ);
    @CriticalNative
    private static native bool nSetRotation(long renderNode, float rotation);
    @CriticalNative
    private static native bool nSetRotationX(long renderNode, float rotationX);
    @CriticalNative
    private static native bool nSetRotationY(long renderNode, float rotationY);
    @CriticalNative
    private static native bool nSetScaleX(long renderNode, float scaleX);
    @CriticalNative
    private static native bool nSetScaleY(long renderNode, float scaleY);
    @CriticalNative
    private static native bool nSetStaticMatrix(long renderNode, long nativeMatrix);
    @CriticalNative
    private static native bool nSetAnimationMatrix(long renderNode, long animationMatrix);

    @CriticalNative
    private static native bool nHasOverlappingRendering(long renderNode);
    @CriticalNative
    private static native bool nGetClipToOutline(long renderNode);
    @CriticalNative
    ...
    @CriticalNative
    private static native bool nIsPivotExplicitlySet(long renderNode);
    @CriticalNative
