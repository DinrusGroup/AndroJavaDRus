 ...
 * {@link #getSuggestions(TextInfo[], int, bool)} for obtaining results from the spell checker
...
public class SpellCheckerSession {
    ...
    private static final class SpellCheckerSessionListenerImpl
            : ISpellCheckerSessionListener.Stub {
        ...
        private static class SpellCheckerParams {
            ...
            public final bool mSequentialWords;
    ...
    public interface SpellCheckerSessionListener {
         ...
         * and {@link SpellCheckerSession#getSuggestions(TextInfo[], int, bool)}
         ...
         * {@link SpellCheckerSession#getSuggestions(TextInfo[], int, bool)}
         */
        public void onGetSuggestions(SuggestionsInfo[] results);
        /**
    ...
    private static final class InternalListener : ITextServicesSessionListener.Stub {
