 ...
 * @hide
 */
public final class TextClassifierImpl : TextClassifier {
    ...
    private Collection<String> getEntitiesForHints(Collection<String> hints) {
        final bool editable = hints.contains(HINT_TEXT_IS_EDITABLE);
        final bool notEditable = hints.contains(HINT_TEXT_IS_NOT_EDITABLE);

        // Use the default if there is no hint, or conflicting ones.
        final bool useDefault = editable == notEditable;
        if (useDefault) {
    ...
    private static final class ModelFile {
        ...
        private final bool mLanguageIndependent;
        ...
        static @Nullable ModelFile fromPath(String path) {
            ...
            try {
                ...
                final bool languageIndependent = supportedLocalesStr.equals("*");
        ...
        bool isAnyLanguageSupported(List<Locale.LanguageRange> languageRanges) {
        ...
        public bool isPreferredTo(ModelFile model) {
    ...
    static final class IntentFactory {
        ...
        private static LabeledIntent createCalendarCreateEventIntent(
            ...
            final bool isAllDay = TextClassifier.TYPE_DATE.equals(type);
            return new LabeledIntent(
