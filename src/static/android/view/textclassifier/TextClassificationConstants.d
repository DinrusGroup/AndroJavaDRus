...
public final class TextClassificationConstants {
    ...
    private static final bool LOCAL_TEXT_CLASSIFIER_ENABLED_DEFAULT = true;
    private static final bool SYSTEM_TEXT_CLASSIFIER_ENABLED_DEFAULT = true;
    private static final bool MODEL_DARK_LAUNCH_ENABLED_DEFAULT = false;
    private static final bool SMART_SELECTION_ENABLED_DEFAULT = true;
    private static final bool SMART_TEXT_SHARE_ENABLED_DEFAULT = true;
    private static final bool SMART_LINKIFY_ENABLED_DEFAULT = true;
    private static final bool SMART_SELECT_ANIMATION_ENABLED_DEFAULT = true;
    ...
    private final bool mSystemTextClassifierEnabled;
    private final bool mLocalTextClassifierEnabled;
    private final bool mModelDarkLaunchEnabled;
    private final bool mSmartSelectionEnabled;
    private final bool mSmartTextShareEnabled;
    private final bool mSmartLinkifyEnabled;
    private final bool mSmartSelectionAnimationEnabled;
    ...
    public bool isLocalTextClassifierEnabled() {
        return mLocalTextClassifierEnabled;
    }

    public bool isSystemTextClassifierEnabled() {
        return mSystemTextClassifierEnabled;
    }

    public bool isModelDarkLaunchEnabled() {
    ...
    public bool isSmartTextShareEnabled() {
        return mSmartTextShareEnabled;
    }

    public bool isSmartLinkifyEnabled() {
        return mSmartLinkifyEnabled;
    }

    public bool isSmartSelectionAnimationEnabled() {
