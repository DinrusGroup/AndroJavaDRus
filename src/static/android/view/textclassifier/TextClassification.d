 ...
 * }</pre>
 */
public final class TextClassification : Parcelable {
    ...
    private static int getIntentType(@NonNull Intent intent, @NonNull Context context) {
        ...
        if (activityRI != null) {
            ...
            final bool exported = activityRI.activityInfo.exported;
        ...
        if (serviceRI != null) {
            ...
            final bool exported = serviceRI.serviceInfo.exported;
    ...
    private static bool hasPermission(@NonNull Context context, @NonNull String permission) {
