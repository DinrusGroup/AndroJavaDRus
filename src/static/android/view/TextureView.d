 ...
 *
 * <pre>
 *  public class LiveCameraActivity : Activity : TextureView.SurfaceTextureListener {
...
public class TextureView : View {
    ...
    TextureLayer getTextureLayer() {
        if (mLayer == null) {
            ...
            bool createNewSurface = (mSurface == null);
            if (createNewSurface) {
    ...
    private static native bool nLockCanvas(long nativeWindow, Canvas canvas, Rect dirty);
