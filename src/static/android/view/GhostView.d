...
public class GhostView : View {
     ...
     */
    private static bool isGhostWrapper(View view) {
     ...
     */
    private static bool isOnTop(ArrayList<View> viewParents, ArrayList<View> comparedWith) {
        ...
        bool isComparedWithTheParent = (comparedWith.size() == depth);
     ...
     */
    private static bool isOnTop(View view, View comparedWith) {
        ViewGroup parent = (ViewGroup) view.getParent();
