...
public final class Display {
     ...
     * @hide
     */
    public bool getDisplayInfo(DisplayInfo outDisplayInfo) {
        synchronized (this) {
            updateDisplayInfoLocked();
     ...
     * Each field of the rectangle is the number of pixels the overscan area :
     ...
     * @hide
     */
    public bool hasAccess(int uid) {
        return Display.hasAccess(uid, mFlags, mOwnerUid);
    }

    /** @hide */
    public static bool hasAccess(int uid, int flags, int ownerUid) {
     ...
     * @hide
     */
    public bool isPublicPresentation() {
     ...
     * @hide
     */
    public static bool isSuspendedState(int state) {
     ...
     * @hide
     */
    public static bool isDozeState(int state) {
     ...
     */
    public static final class Mode : Parcelable {
        /**
         * @hide
         */
         ...
         * @hide
         */
        public bool matches(int width, int height, float refreshRate) {
            return mWidth == width &&
                    mHeight == height &&
     ...
     */
    public static final class HdrCapabilities : Parcelable {
        /**
