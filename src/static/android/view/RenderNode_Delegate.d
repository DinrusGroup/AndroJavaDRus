...
public class RenderNode_Delegate {
    ...
    private bool mPivotExplicitlySet;
    private int mLeft;
    private int mRight;
    private int mTop;
    private int mBottom;
    ...
    @LayoutlibDelegate
    /*package*/ static bool nSetElevation(long renderNode, float lift) {
    ...
    @LayoutlibDelegate
    /*package*/ static bool nSetTranslationX(long renderNode, float translationX) {
        RenderNode_Delegate delegate = sManager.getDelegate(renderNode);
    ...
    @LayoutlibDelegate
    /*package*/ static bool nSetTranslationY(long renderNode, float translationY) {
        RenderNode_Delegate delegate = sManager.getDelegate(renderNode);
    ...
    @LayoutlibDelegate
    /*package*/ static bool nSetTranslationZ(long renderNode, float translationZ) {
        RenderNode_Delegate delegate = sManager.getDelegate(renderNode);
    ...
    @LayoutlibDelegate
    /*package*/ static bool nSetRotation(long renderNode, float rotation) {
        RenderNode_Delegate delegate = sManager.getDelegate(renderNode);
    ...
    @LayoutlibDelegate
    /*package*/ static bool nSetLeft(long renderNode, int left) {
        RenderNode_Delegate delegate = sManager.getDelegate(renderNode);
    ...
    @LayoutlibDelegate
    /*package*/ static bool nSetTop(long renderNode, int top) {
        RenderNode_Delegate delegate = sManager.getDelegate(renderNode);
    ...
    @LayoutlibDelegate
    /*package*/ static bool nSetRight(long renderNode, int right) {
        RenderNode_Delegate delegate = sManager.getDelegate(renderNode);
    ...
    @LayoutlibDelegate
    /*package*/ static bool nSetBottom(long renderNode, int bottom) {
        RenderNode_Delegate delegate = sManager.getDelegate(renderNode);
    ...
    @LayoutlibDelegate
    /*package*/ static bool nSetLeftTopRightBottom(long renderNode, int left, int top, int right,
            int bottom) {
        RenderNode_Delegate delegate = sManager.getDelegate(renderNode);
    ...
    @LayoutlibDelegate
    /*package*/ static bool nIsPivotExplicitlySet(long renderNode) {
        RenderNode_Delegate delegate = sManager.getDelegate(renderNode);
        return delegate != null && delegate.mPivotExplicitlySet;
    }

    @LayoutlibDelegate
    /*package*/ static bool nSetPivotX(long renderNode, float pivotX) {
        RenderNode_Delegate delegate = sManager.getDelegate(renderNode);
        if (delegate != null) {
    ...
    @LayoutlibDelegate
    /*package*/ static bool nSetPivotY(long renderNode, float pivotY) {
        RenderNode_Delegate delegate = sManager.getDelegate(renderNode);
        if (delegate != null) {
    ...
    @LayoutlibDelegate
    /*package*/ static bool nSetScaleX(long renderNode, float scaleX) {
        RenderNode_Delegate delegate = sManager.getDelegate(renderNode);
    ...
    @LayoutlibDelegate
    /*package*/ static bool nSetScaleY(long renderNode, float scaleY) {
        RenderNode_Delegate delegate = sManager.getDelegate(renderNode);
