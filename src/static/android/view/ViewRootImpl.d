...
public final class ViewRootImpl : ViewParent,
        View.AttachInfo.Callbacks, ThreadedRenderer.DrawCallbacks {
    private static final String TAG = "ViewRootImpl";
    private static final bool DBG = false;
    private static final bool LOCAL_LOGV = false;
    /** @noinspection PointlessBooleanExpression*/
    private static final bool DEBUG_DRAW = false || LOCAL_LOGV;
    private static final bool DEBUG_LAYOUT = false || LOCAL_LOGV;
    private static final bool DEBUG_DIALOG = false || LOCAL_LOGV;
    private static final bool DEBUG_INPUT_RESIZE = false || LOCAL_LOGV;
    private static final bool DEBUG_ORIENTATION = false || LOCAL_LOGV;
    private static final bool DEBUG_TRACKBALL = false || LOCAL_LOGV;
    private static final bool DEBUG_IMF = false || LOCAL_LOGV;
    private static final bool DEBUG_CONFIGURATION = false || LOCAL_LOGV;
    private static final bool DEBUG_FPS = false;
    private static final bool DEBUG_INPUT_STAGES = false || LOCAL_LOGV;
    private static final bool DEBUG_KEEP_SCREEN_ON = false || LOCAL_LOGV;
     ...
     */
    private static final bool MT_RENDERER_AVAILABLE = true;
     ...
     *
     * @see #performConfigurationChange(Configuration, Configuration, bool, int)
     */
    private bool mForceNextConfigUpdate;
     ...
     */
    private static bool sAlwaysAssignFocus;
    ...
    private bool mForceDecorViewVisibility = false;
    ...
    bool mIsAmbientMode = false;

    // Set to true to stop input during an Activity Transition.
    bool mPausedForTransition = false;

    bool mLastInCompatMode = false;
    ...
    int mHeight;
    Rect mDirty;
    public bool mIsAnimating;

    private bool mUseMTRenderer;
    private bool mDragResizing;
    ...
    @GuardedBy("this")
    bool mWindowFocusChanged;
    @GuardedBy("this")
    bool mUpcomingWindowFocus;
    @GuardedBy("this")
    bool mUpcomingInTouchMode;

    public bool mTraversalScheduled;
    int mTraversalBarrier;
    bool mWillDrawSoon;
    /** Set to true while in performTraversals for detecting when die(true) is called from internal
     * callbacks such as onMeasure, onPreDraw, onDraw and deferring doDie() until later. */
    bool mIsInTraversal;
    bool mApplyInsetsRequested;
    bool mLayoutRequested;
    bool mFirst;
    bool mReportNextDraw;
    bool mFullRedrawNeeded;
    bool mNewSurfaceNeeded;
    bool mHasHadWindowFocus;
    bool mLastWasImTarget;
    ...
    bool mProcessInputEventsScheduled;
    bool mUnbufferedInputDispatch;
    ...
    bool mWindowAttributesChanged = false;
    ...
    bool mPendingAlwaysConsumeNavBar;
    ...
    private bool mRenderProfilingEnabled;
    ...
    bool mHandlingLayoutInLayoutRequest = false;
    ...
    private bool mNeedsRendererSetup;
        ...
        synchronized (this) {
            if (mView == null) {
                ...
                if (mSurfaceHolder == null) {
                    ...
                    final bool useMTRenderer = MT_RENDERER_AVAILABLE
    ...
    private bool isInLocalFocusMode() {
     ...
     *                          asynchronously.
     */
    public static void invokeFunctor(long functor, bool waitForCompletion) {
    ...
    private void enableHardwareAcceleration(WindowManager.LayoutParams attrs) {
        ...
        if (hardwareAccelerated) {
            ...
            final bool fakeHwAccelerated = (attrs.privateFlags &
                    WindowManager.LayoutParams.PRIVATE_FLAG_FAKE_HARDWARE_ACCELERATED) != 0;
            final bool forceHwAccelerated = (attrs.privateFlags &
            ...
            if (fakeHwAccelerated) {
                ...
                final bool hasSurfaceInsets = insets.left != 0 || insets.right != 0
                        || insets.top != 0 || insets.bottom != 0;
                final bool translucent = attrs.format != PixelFormat.OPAQUE || hasSurfaceInsets;
    ...
    void setLayoutParams(WindowManager.LayoutParams attrs, bool newView) {
        synchronized (this) {
            ...
            final bool oldHasManualSurfaceInsets = mWindowAttributes.hasManualSurfaceInsets;
    ...
    private void invalidateRectOnScreen(Rect dirty) {
        ...
        final bool intersected = localDirty.intersect(0, 0,
    ...
    public void setIsAmbientMode(bool ambient) {
        mIsAmbientMode = ambient;
    }

    interface WindowStoppedCallback {
        public void windowStopped(bool stopped);
    }
    ...
    void setWindowStopped(bool stopped) {
        if (mStopped != stopped) {
            mStopped = stopped;
     ...
     */
    public void setPausedForTransition(bool paused) {
    ...
    override
    public bool getChildVisibleRect(View child, Rect r, android.graphics.Point offset) {
        if (child != mView) {
    ...
    private bool measureHierarchy(final View host, final WindowManager.LayoutParams lp,
    ...
    /* package */ WindowInsets getWindowInsets(bool forceConstruct) {
    ...
    void dispatchApplyInsets(View host) {
        ...
        final bool dispatchCutout = (mWindowAttributes.layoutInDisplayCutoutMode
    ...
    private static bool shouldUseDisplaySize(final WindowManager.LayoutParams lp) {
    ...
    private void performTraversals() {
        ...
        final bool viewVisibilityChanged = !mFirst
                && (mViewVisibility != viewVisibility || mNewSurfaceNeeded
                // Also check for possible double visibility update, which will make current
                // viewVisibility value equal to mViewVisibility and we may miss it.
                || mAppVisibilityChanged);
        mAppVisibilityChanged = false;
        final bool viewUserVisibilityChanged = !mFirst &&
        ...
        bool layoutRequested = mLayoutRequested && (!mStopped || mReportNextDraw);
        if (layoutRequested) {
        ...
        final bool computesInternalInsets =
        ...
        final bool isViewVisible = viewVisibility == View.VISIBLE;
        final bool windowRelayoutWasForced = mForceNextWindowRelayout;
        if (mFirst || windowShouldResize || insetsChanged ||
            ...
            bool contentInsetsChanged = false;
            bool hadSurface = mSurface.isValid();
            ...
            try {
                ...
                final bool overscanInsetsChanged = !mPendingOverscanInsets.equals(
                        mAttachInfo.mOverscanInsets);
                contentInsetsChanged = !mPendingContentInsets.equals(
                        mAttachInfo.mContentInsets);
                final bool visibleInsetsChanged = !mPendingVisibleInsets.equals(
                        mAttachInfo.mVisibleInsets);
                final bool stableInsetsChanged = !mPendingStableInsets.equals(
                        mAttachInfo.mStableInsets);
                final bool cutoutChanged = !mPendingDisplayCutout.equals(
                        mAttachInfo.mDisplayCutout);
                final bool outsetsChanged = !mPendingOutsets.equals(mAttachInfo.mOutsets);
                final bool surfaceSizeChanged = (relayoutResult
                        & WindowManagerGlobal.RELAYOUT_RES_SURFACE_RESIZED) != 0;
                surfaceChanged |= surfaceSizeChanged;
                final bool alwaysConsumeNavBarChanged =
                        mPendingAlwaysConsumeNavBar != mAttachInfo.mAlwaysConsumeNavBar;
                ...
                final bool freeformResizing = (relayoutResult
                        & WindowManagerGlobal.RELAYOUT_RES_DRAG_RESIZING_FREEFORM) != 0;
                final bool dockedResizing = (relayoutResult
                        & WindowManagerGlobal.RELAYOUT_RES_DRAG_RESIZING_DOCKED) != 0;
                final bool dragResizing = freeformResizing || dockedResizing;
            ...
            if (!mStopped || mReportNextDraw) {
                bool focusChangedDueToTouchMode = ensureTouchModeLocally(
        ...
        final bool didLayout = layoutRequested && (!mStopped || mReportNextDraw);
        ...
        final bool changedVisibility = (viewVisibilityChanged || mFirst) && isViewVisible;
        final bool hasWindowFocus = mAttachInfo.mHasWindowFocus && isViewVisible;
        final bool regainedFocus = hasWindowFocus && mLostWindowFocus;
        if (regainedFocus) {
        ...
        if (changedVisibility || regainedFocus) {
            ...
            bool isToast = (mWindowAttributes == null) ? false
        ...
        if (hasWindowFocus && !isInLocalFocusMode()) {
            final bool imTarget = WindowManager.LayoutParams
        ...
        bool cancelDraw = mAttachInfo.mTreeObserver.dispatchOnPreDraw() || !isViewVisible;
    ...
    private void maybeHandleWindowMove(Rect frame) {
        ...
        final bool windowMoved = mAttachInfo.mWindowLeft != frame.left
                || mAttachInfo.mWindowTop != frame.top;
        if (windowMoved) {
            if (mTranslator != null) {
     ...
     */
    bool requestLayoutDuringLayout(final View view) {
    ...
    private void performDraw() {
        ...
        final bool fullRedrawNeeded = mFullRedrawNeeded || mReportNextDraw;
        mFullRedrawNeeded = false;

        mIsDrawing = true;
        Trace.traceBegin(Trace.TRACE_TAG_VIEW, "draw");

        bool usingAsyncReport = false;
    ...
    private bool draw(bool fullRedrawNeeded) {
        ...
        bool animating = mScroller != null && mScroller.computeScrollOffset();
        ...
        final float appScale = mAttachInfo.mApplicationScale;
        final bool scalingRequired = mAttachInfo.mScalingRequired;
        ...
        if (drawable != null) {
            ...
            final bool hasFocus = getAccessibilityFocusedRect(bounds);
            if (!hasFocus) {
                bounds.setEmpty();
            }
        ...
        if (!dirty.isEmpty() || mIsAnimating || accessibilityFocusDirty) {
            if (mAttachInfo.mThreadedRenderer != null && mAttachInfo.mThreadedRenderer.isEnabled()) {
                ...
                final bool updated = updateContentDrawBounds();
     ...
     */
    private bool drawSoftware(Surface surface, AttachInfo attachInfo, int xoff, int yoff,
            bool scalingRequired, Rect dirty, Rect surfaceInsets) {
    ...
    private bool getAccessibilityFocusedRect(Rect bounds) {
    ...
    private Drawable getAccessibilityFocusedDrawable() {
        ...
        if (mAttachInfo.mAccessibilityFocusDrawable == null) {
            ...
            final bool resolved = mView.mContext.getTheme().resolveAttribute(
    ...
    void requestPointerCapture(bool enabled) {
    ...
    private void handlePointerCaptureChanged(bool hasCapture) {
     ...
     *                     changed.
     */
    private void performConfigurationChange(MergedConfiguration mergedConfiguration, bool force,
            int newDisplayId) {
    ...
    final class ViewRootHandler : Handler {
        override
            ...
            switch (msg.what) {
                ...
                case MSG_RESIZED_REPORT:
                    if (mAdded) {
                        ...
                        final bool displayChanged = mDisplay.getDisplayId() != displayId;
                        ...
                        final bool framesChanged = !mWinFrame.equals(args.arg1)
                                || !mPendingOverscanInsets.equals(args.arg5)
                                || !mPendingContentInsets.equals(args.arg2)
                                || !mPendingStableInsets.equals(args.arg6)
                                || !mPendingDisplayCutout.get().equals(args.arg9)
                ...
                case MSG_POINTER_CAPTURE_CHANGED: {
                    final bool hasCapture = msg.arg1 != 0;
     ...
     */
    bool ensureTouchMode(bool inTouchMode) {
    ...
    abstract class InputStage {
         ...
         */
        protected void finish(QueuedInputEvent q, bool handled) {
        ...
        protected void onWindowFocusChanged(bool hasWindowFocus) {
            if (mNext != null) {
        ...
        protected bool shouldDropInputEvent(QueuedInputEvent q) {
        ...
        private bool isBack(InputEvent event) {
     ...
     * </p>
     */
    abstract class AsyncInputStage : InputStage {
     ...
     */
    final class NativePreImeInputStage : AsyncInputStage
        ...
        override
        public void onFinishedInputEvent(Object token, bool handled) {
     ...
     * Does not support pointer events.
     */
    final class ViewPreImeInputStage : InputStage {
     ...
     * Does not support pointer events.
     */
    final class ImeInputStage : AsyncInputStage
     ...
     */
    final class EarlyPostImeInputStage : InputStage {
     ...
     */
    final class NativePostImeInputStage : AsyncInputStage
            : InputQueue.FinishedInputEventCallback {
     ...
     */
    final class ViewPostImeInputStage : InputStage {
        ...
        private bool performFocusNavigation(KeyEvent event) {
            int direction = 0;
        ...
        private bool performKeyboardGroupNavigation(int direction) {
            final View focused = mView.findFocus();
        ...
        private int processPointerEvent(QueuedInputEvent q) {
            ...
            bool handled = mView.dispatchPointerEvent(event);
    ...
    private bool updatePointerIcon(MotionEvent event) {
     ...
     */
    final class SyntheticInputStage : InputStage {
     ...
     */
    final class SyntheticJoystickHandler : Handler {
        ...
        final class JoystickAxesState {
            ...
            private bool isXAxis(int axis) {
                return axis == MotionEvent.AXIS_X || axis == MotionEvent.AXIS_HAT_X;
            }
            private bool isYAxis(int axis) {
     ...
     */
    final class SyntheticTouchNavigationHandler : Handler {
        private static final String LOCAL_TAG = "SyntheticTouchNavigationHandler";
        private static final bool LOCAL_DEBUG = false;
        ...
        private bool mCurrentDeviceSupported;
        ...
        private bool mConsumedMovement;
        ...
        private bool startFling(long time, float vx, float vy) {
            if (LOCAL_DEBUG) {
        ...
        private bool postFling(long time) {
     ...
     */
    private static bool isTypingKey(KeyEvent keyEvent) {
     ...
     */
    private bool checkForLeavingTouchModeAndConsume(KeyEvent event) {
    ...
    private void handleDragEvent(DragEvent event) {
        ...
        if (mView != null && mAdded) {
            ...
            if (what == DragEvent.ACTION_DRAG_EXITED) {
                ...
                bool result = mView.dispatchDragEvent(event);
    ...
    private bool isAutofillUiShowing() {
        AutofillManager afm = getAutofillManager();
        if (afm == null) {
            return false;
        }
    ...
    private int relayoutWindow(WindowManager.LayoutParams params, int viewVisibility,
            bool insetsPending) throws RemoteException {
    ...
    public void loadSystemProperties() {
        mHandler.post(new Runnable() {
            ...
            public void run() {
                ...
                // Layout debugging
                bool layout = SystemProperties.getBoolean(View.DEBUG_LAYOUT_PROPERTY, false);
    ...
    private void dispatchResized(Rect frame, Rect overscanInsets, Rect contentInsets,
            Rect visibleInsets, Rect stableInsets, Rect outsets, bool reportDraw,
        ...
        if (mDragResizing && mUseMTRenderer) {
            bool fullscreen = frame.equals(backDropFrame);
            synchronized (mWindowCallbacks) {
                for (int i = mWindowCallbacks.size() - 1; i >= 0; i--) {
        ...
        final bool sameProcessCall = (Binder.getCallingPid() == android.os.Process.myPid());
    ...
    private static final class QueuedInputEvent {
        ...
        public bool shouldSendToSynthesizer() {
        ...
        private bool flagToString(String name, int flag,
                bool hasPrevious, StringBuilder sb) {
            if ((mFlags & flag) != 0) {
                if (hasPrevious) {
                    sb.append("|");
                }
    ...
    void enqueueInputEvent(InputEvent event,
            InputEventReceiver receiver, int flags, bool processImmediately) {
    ...
    private void finishInputEvent(QueuedInputEvent q) {
        ...
        if (q.mReceiver != null) {
            bool handled = (q.mFlags & QueuedInputEvent.FLAG_FINISHED_HANDLED) != 0;
    ...
    static bool isTerminalInputEvent(InputEvent event) {
        if (event instanceof KeyEvent) {
    ...
    final class TraversalRunnable : Runnable {
        override
        public void run() {
            doTraversal();
        }
    ...
    final class WindowInputEventReceiver : InputEventReceiver {
    ...
    final class ConsumeBatchedInputRunnable : Runnable {
        override
        public void run() {
    ...
    bool mConsumeBatchedInputScheduled;

    final class ConsumeBatchedInputImmediatelyRunnable : Runnable {
        override
        public void run() {
    ...
    bool mConsumeBatchedInputImmediatelyScheduled;

    final class InvalidateOnAnimationRunnable : Runnable {
    ...
    public void dispatchPointerCaptureChanged(bool on) {
    ...
    override
    public bool showContextMenuForChild(View originalView, float x, float y) {
        return false;
    }
    ...
    override
    public bool requestSendAccessibilityEvent(View child, AccessibilityEvent event) {
    ...
    public bool requestChildRectangleOnScreen(View child, Rect rectangle, bool immediate) {
        ...
        final bool scrolled = scrollToRectOrFocus(rectangle, immediate);
        mTempRect.set(rectangle);
    ...
    override
    public bool onNestedPrePerformAccessibilityAction(View target, int action, Bundle args) {
        return false;
    }
    ...
    void changeCanvasOpacity(bool opaque) {
     ...
     */
    public bool dispatchUnhandledKeyEvent(KeyEvent event) {
        return mUnhandledKeyManager.dispatch(mView, event);
    }

    class TakenSurfaceHolder : BaseSurfaceHolder {
        override
        public bool onAllowLockCanvas() {
    ...
    public static final class CalledFromWrongThreadException : AndroidRuntimeException {
     ...
     */
    private void startDragResizing(Rect initialBounds, bool fullscreen, Rect systemInsets,
    ...
    private bool updateContentDrawBounds() {
        bool updated = false;
        if (mUseMTRenderer) {
            for (int i = mWindowCallbacks.size() - 1; i >= 0; i--) {
                updated |=
    ...
    final class AccessibilityInteractionConnectionManager
        ...
        public void ensureConnection() {
            final bool registered = mAttachInfo.mAccessibilityWindowId
    ...
    final class HighContrastTextManager : HighTextContrastChangeListener {
        HighContrastTextManager() {
            ThreadedRenderer.setHighContrastText(mAccessibilityManager.isHighTextContrastEnabled());
        }
        override
        public void onHighTextContrastStateChanged(bool enabled) {
    ...
    static final class AccessibilityInteractionConnection
            : IAccessibilityInteractionConnection.Stub {
    ...
    private class SendWindowContentChangedAccessibilityEvent : Runnable {
    ...
    private static class UnhandledKeyManager {
        ...
        bool dispatch(View root, KeyEvent event) {
            if (mDispatched) {
                return false;
            }
            View consumer;
         ...
         */
        bool preViewDispatch(KeyEvent event) {
            mDispatched = false;
