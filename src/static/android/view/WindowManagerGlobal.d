...
public final class WindowManagerGlobal {
    ...
    public void removeView(View view, bool immediate) {
        if (view == null) {
            throw new IllegalArgumentException("view must not be null");
        }
    ...
    private void removeViewLocked(int index, bool immediate) {
        ViewRootImpl root = mRoots.get(index);
        ...
        bool deferred = root.die(immediate);
        if (view != null) {
    ...
    private int findViewLocked(View view, bool required) {
    ...
    public static bool shouldDestroyEglContext(int trimLevel) {
    ...
    public void setStoppedState(IBinder token, bool stopped) {
        synchronized (mLock) {
            int count = mViews.size();
    ...
    /** @hide */
    public void changeCanvasOpacity(IBinder token, bool opaque) {
        if (token == null) {
            return;
        }
        synchronized (mLock) {
...
final class WindowLeaked : AndroidRuntimeException {
