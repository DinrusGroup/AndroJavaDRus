...
public abstract class InputEventReceiver {
    ...
    private static native void nativeFinishInputEvent(long receiverPtr, int seq, bool handled);
    private static native bool nativeConsumeBatchedInputEvents(long receiverPtr,
            long frameTimeNanos);
     ...
     */
    public final void finishInputEvent(InputEvent event, bool handled) {
        if (event == null) {
     ...
     */
    public final bool consumeBatchedInputEvents(long frameTimeNanos) {
        if (mReceiverPtr == 0) {
