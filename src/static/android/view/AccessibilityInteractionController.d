...
final class AccessibilityInteractionController {
    ...
    // Debugging flag
    private static final bool ENFORCE_NODE_TREE_CONSISTENT = false;

    // Constants for readability
    private static final bool IGNORE_REQUEST_PREPARERS = true;
    private static final bool CONSIDER_REQUEST_PREPARERS = false;
    ...
    private bool isShown(View view) {
     ...
     */
    private bool holdOffMessageIfNeeded(
    ...
    private bool shouldApplyAppScaleAndMagnificationSpec(float appScale,
            MagnificationSpec spec) {
    ...
    private bool handleClickableSpanActionUiThread(
    ...
    private final class AddNodeInfosForViewId : Predicate<View> {
