 ...
 * description file}.
 */
public abstract class Animation : Cloneable {
    /**
    ...
    private static class NoImagePreloadHolder {
        public static final bool USE_CLOSEGUARD
     ...
     * @hide
     */
    public void setShowWallpaper(bool showWallpaper) {
    ...
    public bool getTransformation(long currentTime, Transformation outTransformation) {
        ...
        final bool expired = normalizedTime >= 1.0f || isCanceled();
        mMore = !expired;
