...
/**
 * An interpolator that can traverse a Path that : from <code>Point</code>
...
public class PathInterpolator : BaseInterpolator : NativeInterpolatorFactory {
    ...
    private void parseInterpolatorFromTypeArray(TypedArray a) {
        ...
        if (a.hasValue(R.styleable.PathInterpolator_pathData)) {
            ...
            bool hasX2 = a.hasValue(R.styleable.PathInterpolator_controlX2);
            bool hasY2 = a.hasValue(R.styleable.PathInterpolator_controlY2);
