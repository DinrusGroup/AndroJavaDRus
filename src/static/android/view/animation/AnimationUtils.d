...
public class AnimationUtils {
     ...
     */
    public static Animation makeInAnimation(Context c, bool fromLeft) {
        Animation a;
        if (fromLeft) {
     ...
     * @return The new animation
     */
    public static Animation makeOutAnimation(Context c, bool toRight) {
        Animation a;
        if (toRight) {
