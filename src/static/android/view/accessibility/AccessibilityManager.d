 ...
 * events implement and register an accessibility service which :
...
public final class AccessibilityManager {
    ...
    public interface AccessibilityPolicy {
        ...
        @Nullable AccessibilityEvent onAccessibilityEvent(@NonNull AccessibilityEvent event,
                bool accessibilityEnabled, @EventType int relevantEventTypes);
     ...
     *
     */
    public bool isHighTextContrastEnabled() {
        return false;
    }
     ...
     */
    public bool isObservedEventType(@AccessibilityEvent.EventType int type) {
        return false;
    }
     ...
     */
    public bool addAccessibilityStateChangeListener(
    ...
    public bool removeAccessibilityStateChangeListener(
            AccessibilityStateChangeListener listener) {
        return true;
    }
     ...
     * @return True if successfully registered.
     */
    public bool addTouchExplorationStateChangeListener(
     ...
     */
    public bool removeTouchExplorationStateChangeListener(
            @NonNull TouchExplorationStateChangeListener listener) {
        return true;
    }
