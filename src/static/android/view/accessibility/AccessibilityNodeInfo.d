 ...
 */
public class AccessibilityNodeInfo : Parcelable {
     ...
     * @hide
     */
    public bool refresh(Bundle arguments, bool bypassCache) {
        enforceSealed();
        if (!canPerformRequestOverConnection(mSourceNodeId)) {
            return false;
        }
     ...
     * recycled).
     */
    public bool refreshWithExtraData(String extraDataKey, Bundle args) {
    ...
    private void addChildInternal(View root, int virtualDescendantId, bool checked) {
        enforceNotSealed();
        if (mChildNodeIds == null) {
     ...
     */
    public bool removeChild(View root, int virtualDescendantId) {
        enforceNotSealed();
     ...
     * @throws IllegalStateException If called from an AccessibilityService.
     */
    public bool removeAction(AccessibilityAction action) {
        enforceNotSealed();
     ...
     * @throws IllegalStateException If called outside of an AccessibilityService.
     */
    public bool performAction(int action, Bundle arguments) {
        enforceSealed();
        if (!canPerformRequestOverConnection(mSourceNodeId)) {
            return false;
        }
     ...
     * @throws IllegalStateException If called from an AccessibilityService.
     */
    public void setVisibleToUser(bool visibleToUser) {
     ...
     * @throws IllegalStateException If called from an AccessibilityService.
     */
    public void setAccessibilityFocused(bool focused) {
     ...
     */
    public void setContentInvalid(bool contentInvalid) {
     ...
     */
    public void setCanOpenPopup(bool opensPopup) {
        enforceNotSealed();
     ...
     */
    public void setImportantForAccessibility(bool important) {
     ...
     *                              {@code false} otherwise.
     */
    public void setScreenReaderFocusable(bool screenReaderFocusable) {
     ...
     * {@code false} otherwise.
     */
    public void setShowingHintText(bool showingHintText) {
        setBooleanProperty(BOOLEAN_PROPERTY_IS_SHOWING_HINT, showingHintText);
    }

    /**
     * Returns whether node represents a heading.
     * <p><strong>Note:</strong> Returns {@code true} if either {@link #setHeading(bool)}
     ...
     */
    public void setHeading(bool isHeading) {
    ...
    private void initFromParcel(Parcel parcel) {
        ...
        int fieldIndex = 0;
        final bool sealed = isBitSet(nonDefaultFields, fieldIndex++)
                ? (parcel.readInt() == 1)
                : DEFAULT.mSealed;
    ...
    private static bool isDefaultStandardAction(AccessibilityAction action) {
    ...
    private bool canPerformRequestOverConnection(long accessibilityNodeId) {
     ...
     * {@link CollectionInfo#obtain(int, int, bool)} to get an instance. Recycling is
     * handled by the {@link AccessibilityNodeInfo} to which this object is attached.
     * <p>
    ...
    public static final class CollectionInfo {
         ...
         */
        private CollectionInfo(int rowCount, int columnCount, bool hierarchical,
                int selectionMode) {
            mRowCount = rowCount;
     ...
     * {@link CollectionItemInfo#obtain(int, int, int, int, bool)}
    ...
    public static final class CollectionItemInfo {
         ...
         *                {@link AccessibilityNodeInfo#setHeading(bool)}).
         */
