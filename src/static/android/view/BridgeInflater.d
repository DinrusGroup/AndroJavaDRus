 ...
 */
public final class BridgeInflater : LayoutInflater {

    private final LayoutlibCallback mLayoutlibCallback;

    private bool mIsInMerge = false;
     ...
     */
    @NotNull
    private static Method getCreateViewMethod(Class!(T) customInflaterClass) throws NoSuchMethodException {
        Class!(T) current = customInflaterClass;
        do {
            try {
                Method method = current.getDeclaredMethod("createView", View.class, String.class,
                                Context.class, AttributeSet.class, bool.class, bool.class,
     ...
     */
    @Nullable
    private static Class!(T) findCustomInflater(@NotNull BridgeContext bc,
    ...
    private View createViewFromCustomInflater(@NotNull String name, @NotNull AttributeSet attrs) {
        if (mCustomInflater == null) {
            ...
            if (context instanceof BridgeContext) {
                ...
                Class!(T) inflaterClass = findCustomInflater(bc, mLayoutlibCallback);

                if (inflaterClass != null) {
                    try {
                        Constructor!(T) constructor =  inflaterClass.getDeclaredConstructor();
     ...
     */
    private View loadCustomView(String name, AttributeSet attrs, bool silent) throws Exception {
    ...
    public void setIsInMerge(bool isInMerge) {
    ...
    /*package*/ static Object getViewKeyFromParser(AttributeSet attrs, BridgeContext bc,
            ResourceReference resourceReference, bool isInMerge) {
