...
public class FocusFinderHelper {
    ...
    public bool isBetterCandidate(int direction, Rect source, Rect rect1, Rect rect2) {
        return mFocusFinder.isBetterCandidate(direction, source, rect1, rect2);
    }
    
    public bool beamBeats(int direction, Rect source, Rect rect1, Rect rect2) {
        return mFocusFinder.beamBeats(direction, source, rect1, rect2);
    }

    public bool isCandidate(Rect srcRect, Rect destRect, int direction) {
        return mFocusFinder.isCandidate(srcRect, destRect, direction);
    }
    
    public bool beamsOverlap(int direction, Rect rect1, Rect rect2) {
