...
public final class ThreadedRenderer {
    ...
    public static bool sTrimForeground = false;
    ...
    public static bool isAvailable() {
        if (sSupportsOpenGL != null) {
            return sSupportsOpenGL.boolValue();
        }
     ...
     */
    public static ThreadedRenderer create(Context context, bool translucent, String name) {
    ...
    private bool mRootNodeNeedsUpdate;

    private bool mEnabled;
    private bool mRequested = true;
    private bool mIsOpaque = false;

    ThreadedRenderer(Context context, bool translucent, String name) {
     ...
     */
    bool initialize(Surface surface) throws OutOfResourcesException {
        bool status = !mInitialized;
        mInitialized = true;
     ...
     */
    bool initializeIfNeeded(int width, int height, View.AttachInfo attachInfo,
    ...
    bool loadSystemProperties() {
        bool changed = nLoadSystemProperties(mNativeProxy);
        if (changed) {
            invalidateRoot();
        }
        return changed;
     ...
     */
    public void addRenderNode(RenderNode node, bool placeFront) {
    ...
    static void invokeFunctor(long functor, bool waitForCompletion) {
    ...
    bool copyLayerInto(final TextureLayer layer, final Bitmap bitmap) {
     ...
     */
    public static void setHighContrastText(bool highContrastText) {
     ...
     */
    public static void setIsolatedProcess(bool isIsolated) {
     ...
     */
    public static void setDebuggingEnabled(bool enable) {
    ...
    private static native long nCreateProxy(bool translucent, long rootRenderNode);
    private static native void nDeleteProxy(long nativeProxy);

    private static native bool nLoadSystemProperties(long nativeProxy);
    private static native void nSetName(long nativeProxy, String name);

    private static native void nInitialize(long nativeProxy, Surface window);
    private static native void nUpdateSurface(long nativeProxy, Surface window);
    private static native bool nPauseSurface(long nativeProxy, Surface window);
    private static native void nSetStopped(long nativeProxy, bool stopped);
    private static native void nSetup(long nativeProxy,
            float lightRadius, int ambientShadowAlpha, int spotShadowAlpha);
    private static native void nSetLightCenter(long nativeProxy,
            float lightX, float lightY, float lightZ);
    private static native void nSetOpaque(long nativeProxy, bool opaque);
    private static native void nSetWideGamut(long nativeProxy, bool wideGamut);
    ...
    private static native void nInvokeFunctor(long functor, bool waitForCompletion);

    private static native long nCreateTextureLayer(long nativeProxy);
    private static native void nBuildLayer(long nativeProxy, long node);
    private static native bool nCopyLayerInto(long nativeProxy, long layer, Bitmap bitmap);
    ...
    private static native void nSetHighContrastText(bool enabled);
    // For temporary experimentation b/66945974
    private static native void nHackySetRTAnimationsEnabled(bool enabled);
    private static native void nSetDebuggingEnabled(bool enabled);
    private static native void nSetIsolatedProcess(bool enabled);
