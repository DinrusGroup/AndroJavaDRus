 ...
 * </p>
 */
public final class MotionEvent : InputEvent : Parcelable {
    private static final long NS_PER_MS = 1000000;
    private static final String LABEL_PREFIX = "AXIS_";

    private static final bool DEBUG_CONCISE_TOSTRING = false;
     ...
     * @see #setTargetAccessibilityFocus(bool)
     */
    ...
    @CriticalNative
    private static native bool nativeIsTouchEvent(long nativePtr);
    @CriticalNative
     ...
     * @hide
     */
    public final bool isTouchEvent() {
    ...
    /** @hide */
    public final bool isTargetAccessibilityFocus() {
        final int flags = getFlags();
        return (flags & FLAG_TARGET_ACCESSIBILITY_FOCUS) != 0;
    }

    /** @hide */
    public final void setTargetAccessibilityFocus(bool targetsFocus) {
        final int flags = getFlags();
    ...
    /** @hide */
    public final bool isHoverExitPending() {
        final int flags = getFlags();
        return (flags & FLAG_HOVER_EXIT_PENDING) != 0;
    }

    /** @hide */
    public void setHoverExitPending(bool hoverExitPending) {
        final int flags = getFlags();
     ...
     * @hide
     */
    public final bool addBatch(MotionEvent event) {
     ...
     * @hide
     */
    public final bool isWithinBoundsNoHistory(float left, float top,
    ...
    public static String buttonStateToString(int buttonState) {
        ...
        int i = 0;
        while (buttonState != 0) {
            final bool isSet = (buttonState & 1) != 0;
     ...
     * @see #BUTTON_STYLUS_SECONDARY
     */
    public final bool isButtonPressed(int button) {
        if (button == 0) {
            return false;
        }
    ...
    public static final class PointerProperties {
        ...
        private bool equals(PointerProperties other) {
