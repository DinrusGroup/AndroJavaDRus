 ...
 * </div>
 */
public class DragEvent : Parcelable {
    private static final bool TRACK_RECYCLED_LOCATION = false;
    ...
    private void init(int action, float x, float y, ClipDescription description, ClipData data,
            IDragAndDropPermissions dragAndDropPermissions, Object localState, bool result) {
        mAction = action;
        mX = x;
        mY = y;
    ...
    public static DragEvent obtain(int action, float x, float y, Object localState,
            ...
            IDragAndDropPermissions dragAndDropPermissions, bool result) {
        final DragEvent ev;
