...
public final class InputQueue {
    ...
    private static native long nativeSendKeyEvent(long ptr, KeyEvent e, bool preDispatch);
    ...
    /** @hide */
    public void dispose(bool finalized) {
        if (mCloseGuard != null) {
            if (finalized) {
    ...
    /** @hide */
    public void sendInputEvent(InputEvent e, Object token, bool predispatch,
    ...
    private void finishInputEvent(long id, bool handled) {
