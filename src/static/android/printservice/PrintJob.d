...
public final class PrintJob {
     ...
     */
    @MainThread
    public bool block(@Nullable String reason) {
        PrintService.throwIfNotCalledOnMainThread();
     ...
     */
    @MainThread
    public bool fail(@Nullable String error) {
        PrintService.throwIfNotCalledOnMainThread();
        if (!isInImmutableState()) {
     ...
     */
    @MainThread
    public bool setTag(@NonNull String tag) {
        PrintService.throwIfNotCalledOnMainThread();
        if (isInImmutableState()) {
            return false;
        }
    ...
    private bool isInImmutableState() {
    ...
    private bool setState(int state, @Nullable String error) {
        try {
