 ...
 */
@SystemApi
public final class RecommendationInfo : Parcelable {
    ...
    private final bool mRecommendsMultiVendorService;
    ...
    public RecommendationInfo(@NonNull CharSequence packageName, @NonNull CharSequence name,
            @NonNull List<InetAddress> discoveredPrinters, bool recommendsMultiVendorService) {
     ...
     * @param recommendsMultiVendorService If the service detects printer from multiple vendor
     *
     * @deprecated Use {@link RecommendationInfo(String, String, List<InetAddress>, bool)}
     *             instead
     */
    @Deprecated
    public RecommendationInfo(@NonNull CharSequence packageName, @NonNull CharSequence name,
            @IntRange(from = 0) int numDiscoveredPrinters, bool recommendsMultiVendorService) {
     ...
     */
    public bool recommendsMultiVendorService() {
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeByte(cast(byte) (mRecommendsMultiVendorService ? 1 : 0));
    }
