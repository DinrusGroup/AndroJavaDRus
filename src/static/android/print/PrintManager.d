...
public final class PrintManager {
     ...
     *         not yet available
     * @see android.print.PrinterInfo.Builder#setHasCustomPrinterIcon(bool)
     * @hide
     */
     ...
     * @hide
     */
    public void setPrintServiceEnabled(@NonNull ComponentName service, bool isEnabled) {
        if (mService == null) {
            Log.w(LOG_TAG, "Feature android.software.print not available");
            return;
        }
     ...
     * @hide
     */
    public static final class PrintDocumentAdapterDelegate : IPrintDocumentAdapter.Stub
        ...
        private bool isDestroyedLocked() {
        ...
        private final class MyLayoutResultCallback : LayoutResultCallback
                : DestroyableCallback {
            ...
            override
            public void onLayoutFinished(PrintDocumentInfo info, bool changed) {
        ...
        private final class MyWriteResultCallback : WriteResultCallback
                : DestroyableCallback {
