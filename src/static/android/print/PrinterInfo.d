 ...
 * </p>
 */
public final class PrinterInfo : Parcelable {
    ...
    private final bool mHasCustomPrinterIcon;
    ...
    private PrinterInfo(@NonNull PrinterId printerId, @NonNull String name, @Status int status,
            int iconResourceId, bool hasCustomPrinterIcon, String description,
     ...
     * @hide
     */
    public bool getHasCustomPrinterIcon() {
    ...
    public void writeToParcel(Parcel parcel, int flags) {
        ...
        parcel.writeByte(cast(byte) (mHasCustomPrinterIcon ? 1 : 0));
     ...
     * @hide
     */
    public bool equalsIgnoringStatus(PrinterInfo other) {
    ...
    public static final class Builder {
        ...
        private bool mHasCustomPrinterIcon;
         ...
         * @return This builder.
         */
        public @NonNull Builder setHasCustomPrinterIcon(bool hasCustomPrinterIcon) {
            mHasCustomPrinterIcon = hasCustomPrinterIcon;
            return this;
        }
