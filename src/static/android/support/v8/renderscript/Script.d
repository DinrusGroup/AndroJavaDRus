...
public class Script : BaseObj {
     ...
     *
     */
    private bool mUseIncSupp;
    protected void setIncSupp(bool useInc) {
        mUseIncSupp = useInc;
    }
    protected bool isIncSupp() {
        return mUseIncSupp;
    }
    /**
     ...
     *
     */
    public static final class KernelID : BaseObj {
     ...
     *
     */
    public static final class InvokeID : BaseObj {
        Script mScript;
        int mSlot;
     ...
     *
     */
    public static final class FieldID : BaseObj {
     ...
     * @param v
     */
    public void setVar(int index, bool v) {
