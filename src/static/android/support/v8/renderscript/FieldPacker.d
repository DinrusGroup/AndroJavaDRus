...
public class FieldPacker {
    ...
    public void addI16(short v) {
        align(2);
        mData[mPos++] = cast(byte)(v & 0xff);
        mData[mPos++] = cast(byte)(v >> 8);
    }

    public short subI16() {
        subalign(2);
        short v = 0;
        v = cast(short)((mData[--mPos] & 0xff) << 8);
        v = cast(short)(v | cast(short)(mData[--mPos] & 0xff));
        return v;
    }
    ...
    public void addI32(int v) {
        align(4);
        mData[mPos++] = cast(byte)(v & 0xff);
        mData[mPos++] = cast(byte)((v >> 8) & 0xff);
        mData[mPos++] = cast(byte)((v >> 16) & 0xff);
        mData[mPos++] = cast(byte)((v >> 24) & 0xff);
    }
    ...
    public void addI64(long v) {
        ...
        mData[mPos++] = cast(byte)((v >> 16) & 0xff);
        mData[mPos++] = cast(byte)((v >> 24) & 0xff);
        mData[mPos++] = cast(byte)((v >> 32) & 0xff);
        mData[mPos++] = cast(byte)((v >> 40) & 0xff);
        mData[mPos++] = cast(byte)((v >> 48) & 0xff);
        mData[mPos++] = cast(byte)((v >> 56) & 0xff);
    }
    ...
    private static void addToPack(FieldPacker fp, Object obj) {
        if (obj instanceof Boolean) {
            fp.addBoolean(((Boolean)obj).boolValue());
            return;
        }
