...
public class RenderScript {
    ...
    static final bool LOG_ENABLED = false;
    ...
    private bool mIsProcessContext = false;
    private bool mEnableMultiInput = false;
    ...
    native bool nLoadSO(bool useNative, int deviceApi, String libPath);
    native bool nLoadIOSO();
    ...
    static private bool useIOlib = false;
    static private bool useNative;
     ...
     */
    static private bool setupNative(int sdkVersion, Context ctx) {
        ...
        if (sNative == -1) {
            ...
            int forcecompat = 0;
            try {
                Class!(T) sysprop = Class.forName("android.os.SystemProperties");
            ...
            if (sNative == 1) {
                ...
                try {
                    Class!(T) javaRS = Class.forName("android.renderscript.RenderScript");
    ...
    native long  rsnElementCreate(long con, long type, int kind, bool norm, int vecSize);
    synchronized long nElementCreate(long type, int kind, bool norm, int vecSize) {
        validate();
    ...
    native long rsnTypeCreate(long con, long eid, int x, int y, int z, bool mips, bool faces, int yuv);
    synchronized long nTypeCreate(long eid, int x, int y, int z, bool mips, bool faces, int yuv) {
        validate();
    ...
    */
    ...
    native void rsnAllocationRead(long con, long id, Object d, int dt, int mSize, bool usePadding);
    synchronized void nAllocationRead(long id, Object d, Element.DataType dt, int mSize, bool usePadding) {
        validate();
    ...
    native void rsnAllocationRead1D(long con, long id, int off, int mip, int count, Object d,
                                    int sizeBytes, int dt, int mSize, bool usePadding);
    synchronized void nAllocationRead1D(long id, int off, int mip, int count, Object d,
                                        int sizeBytes, Element.DataType dt, int mSize, bool usePadding) {
        validate();
    ...
    */
    ...
    native void rsnScriptBindAllocation(long con, long script, long alloc, int slot, bool mUseInc);
    synchronized void nScriptBindAllocation(long script, long alloc, int slot, bool mUseInc) {
        validate();
        long curCon = mContext;
        if (mUseInc) {
            curCon = mIncCon;
    ...
    native void rsnScriptSetTimeZone(long con, long script, byte[] timeZone, bool mUseInc);
    synchronized void nScriptSetTimeZone(long script, byte[] timeZone, bool mUseInc) {
        validate();
        long curCon = mContext;
        if (mUseInc) {
            curCon = mIncCon;
    ...
    native void rsnScriptInvoke(long con, long id, int slot, bool mUseInc);
    synchronized void nScriptInvoke(long id, int slot, bool mUseInc) {
        validate();
        long curCon = mContext;
        if (mUseInc) {
            curCon = mIncCon;
    ...
    native void rsnScriptForEach(long con, long incCon, long id, int slot, long ain, long aout, byte[] params, bool mUseInc);
    native void rsnScriptForEach(long con, long incCon, long id, int slot, long ain, long aout, bool mUseInc);
    native void rsnScriptForEachClipped(long con, long incCon, long id, int slot, long ain, long aout, byte[] params,
                                        int xstart, int xend, int ystart, int yend, int zstart, int zend, bool mUseInc);
    native void rsnScriptForEachClipped(long con, long incCon, long id, int slot, long ain, long aout,
                                        int xstart, int xend, int ystart, int yend, int zstart, int zend, bool mUseInc);
    synchronized void nScriptForEach(long id, int slot, long ain, long aout, byte[] params, bool mUseInc) {
        validate();
        if (params == null) {
    ...
    native void rsnScriptInvokeV(long con, long id, int slot, byte[] params, bool mUseInc);
    synchronized void nScriptInvokeV(long id, int slot, byte[] params, bool mUseInc) {
        validate();
        long curCon = mContext;
        if (mUseInc) {
            curCon = mIncCon;
    ...
    native void rsnScriptSetVarI(long con, long id, int slot, int val, bool mUseInc);
    synchronized void nScriptSetVarI(long id, int slot, int val, bool mUseInc) {
        validate();
        long curCon = mContext;
        if (mUseInc) {
            curCon = mIncCon;
    ...
    native void rsnScriptSetVarJ(long con, long id, int slot, long val, bool mUseInc);
    synchronized void nScriptSetVarJ(long id, int slot, long val, bool mUseInc) {
        validate();
        long curCon = mContext;
        if (mUseInc) {
            curCon = mIncCon;
    ...
    native void rsnScriptSetVarF(long con, long id, int slot, float val, bool mUseInc);
    synchronized void nScriptSetVarF(long id, int slot, float val, bool mUseInc) {
        validate();
        long curCon = mContext;
        if (mUseInc) {
            curCon = mIncCon;
    ...
    native void rsnScriptSetVarD(long con, long id, int slot, double val, bool mUseInc);
    synchronized void nScriptSetVarD(long id, int slot, double val, bool mUseInc) {
        validate();
        long curCon = mContext;
        if (mUseInc) {
            curCon = mIncCon;
    ...
    native void rsnScriptSetVarV(long con, long id, int slot, byte[] val, bool mUseInc);
    synchronized void nScriptSetVarV(long id, int slot, byte[] val, bool mUseInc) {
        validate();
        long curCon = mContext;
        if (mUseInc) {
            curCon = mIncCon;
    ...
    native void rsnScriptSetVarObj(long con, long id, int slot, long val, bool mUseInc);
    synchronized void nScriptSetVarObj(long id, int slot, long val, bool mUseInc) {
        validate();
        long curCon = mContext;
        if (mUseInc) {
            curCon = mIncCon;
    ...
    native long  rsnScriptIntrinsicCreate(long con, int id, long eid, bool mUseInc);
    synchronized long nScriptIntrinsicCreate(int id, long eid, bool mUseInc) {
        validate();
        if (mUseInc) {
    ...
    native long  rsnScriptKernelIDCreate(long con, long sid, int slot, int sig, bool mUseInc);
    synchronized long nScriptKernelIDCreate(long sid, int slot, int sig, bool mUseInc) {
        validate();
        long curCon = mContext;
        if (mUseInc) {
            curCon = mIncCon;
    ...
    native long  rsnScriptFieldIDCreate(long con, long sid, int slot, bool mUseInc);
    synchronized long nScriptFieldIDCreate(long sid, int slot, bool mUseInc) {
        validate();
        long curCon = mContext;
        if (mUseInc) {
            curCon = mIncCon;
...
// Additional Entry points For inc libRSSupport
    ...
    native bool nIncLoadSO(int deviceApi, String libPath);
    ...
    native long  rsnIncElementCreate(long con, long type, int kind, bool norm, int vecSize);
    synchronized long nIncElementCreate(long type, int kind, bool norm, int vecSize) {
        validate();
        return rsnIncElementCreate(mIncCon, type, kind, norm, vecSize);
    }
    native long rsnIncTypeCreate(long con, long eid, int x, int y, int z, bool mips, bool faces, int yuv);
    synchronized long nIncTypeCreate(long eid, int x, int y, int z, bool mips, bool faces, int yuv) {
        validate();
     ...
     *
     */
    public static class RSMessageHandler : Runnable {
        protected int[] mData;
        protected int mID;
     ...
     *
     */
    public static class RSErrorHandler : Runnable {
    ...
    static class MessageThread : Thread {
        RenderScript mRS;
        bool mRun = true;
    ...
    private static RenderScript internalCreate(Context ctx, int sdkVersion, ContextType ct, int flags) {
        ...
        synchronized(lock) {
            if (sInitialized == false) {
                try {
                    Class!(T) vm_runtime = Class.forName("dalvik.system.VMRuntime");
    ...
    private void helpDestroy() {
        ...
        if (shouldDestroy) {
            ...
            bool hasJoined = false, interrupted = false;
            while (!hasJoined) {
                try {
                    mMessageThread.join();
                    hasJoined = true;
