...
public final class ScriptGroup : BaseObj {
    ...
    public static final class Closure : BaseObj {
        ...
        private static final class ValueAndSize {
            public ValueAndSize(RenderScript rs, Object obj) {
                if (obj instanceof Allocation) {
                    ...
                    value = ((Boolean)obj).boolValue() ? 1 : 0;
                    size = 4;
    ...
    public static final class Builder {
         ...
         */
        private bool calcOrderRecurse(Node node0, int depth) {
            node0.mSeen = true;
    ...
    public static final class Builder2 {
        ...
        private bool seperateArgsAndBindings(Object[] argsAndBindings,
