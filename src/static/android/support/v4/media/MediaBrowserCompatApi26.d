...
class MediaBrowserCompatApi26 {
    ...
    interface SubscriptionCallback : MediaBrowserCompatApi21.SubscriptionCallback {
        void onChildrenLoaded(@NonNull String parentId, List!(T) children, @NonNull Bundle options);
        void onError(@NonNull String parentId, @NonNull  Bundle options);
    }

    static class SubscriptionCallbackProxy<T : SubscriptionCallback>
            : MediaBrowserCompatApi21.SubscriptionCallbackProxy<T> {
