...
class MediaSessionCompatApi21 {
    ...
    public static void setActive(Object sessionObj, bool active) {
        ((MediaSession)sessionObj).setActive(active);
    }

    public static bool isActive(Object sessionObj) {
    ...
    public static bool hasCallback(Object sessionObj) {
    ...
    interface Callback {
        ...
        bool onMediaButtonEvent(Intent mediaButtonIntent);
        void onPlay();
    ...
    static class CallbackProxy<T : Callback> : MediaSession.Callback {
