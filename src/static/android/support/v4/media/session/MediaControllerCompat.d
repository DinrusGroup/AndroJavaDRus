...
public final class MediaControllerCompat {
    ...
    private static class MediaControllerExtraData : ComponentActivity.ExtraData {
     ...
     */
    public static abstract class Callback : IBinder.DeathRecipient {
         ...
         */
        public void onCaptioningEnabledChanged(bool enabled) {
        }
        ...
        private static class StubApi21 : MediaControllerCompatApi21.Callback {
            ...
            override
            public void onQueueChanged(List!(T) queue) {
                MediaControllerCompat.Callback callback = mCallback.get();
                if (callback != null) {
        ...
        private static class StubCompat : IMediaControllerCallback.Stub {
            private final WeakReference<MediaControllerCompat.Callback> mCallback;
            ...
            override
            public void onCaptioningEnabledChanged(bool enabled) throws RemoteException {
                MediaControllerCompat.Callback callback = mCallback.get();
                if (callback != null) {
            ...
            override
            public void onShuffleModeChangedRemoved(bool enabled) throws RemoteException {
                // Do nothing.
            }
            ...
            public void handleMessage(Message msg) {
                ...
                switch (msg.what) {
                    ...
                    case MSG_UPDATE_CAPTIONING_ENABLED:
                        onCaptioningEnabledChanged((bool) msg.obj);
                        break;
    ...
    public static abstract class TransportControls {
         ...
         */
        public abstract void setCaptioningEnabled(bool enabled);
    ...
    interface MediaControllerImpl {
        ...
        bool dispatchMediaButtonEvent(KeyEvent keyEvent);
    ...
    static class MediaControllerImplBase : MediaControllerImpl {
        ...
        override
        public bool dispatchMediaButtonEvent(KeyEvent event) {
            if (event == null) {
    ...
    static class TransportControlsBase : TransportControls {
        private IMediaSession mBinder;
    ...
    @RequiresApi(21)
    static class MediaControllerImplApi21 : MediaControllerImpl {
        ...
        private static class ExtraBinderRequestResultReceiver : ResultReceiver {
        ...
        private static class ExtraCallback : Callback.StubCompat {
    ...
    static class TransportControlsApi21 : TransportControls {
    ...
    @RequiresApi(23)
    static class MediaControllerImplApi23 : MediaControllerImplApi21 {
    ...
    @RequiresApi(23)
    static class TransportControlsApi23 : TransportControlsApi21 {
    ...
    @RequiresApi(24)
    static class MediaControllerImplApi24 : MediaControllerImplApi23 {
    ...
    @RequiresApi(24)
    static class TransportControlsApi24 : TransportControlsApi23 {
