...
public class MediaSessionCompat {
     ...
     * until {@link #setActive(bool) setActive(true)} is called.
     * </p><p>
     ...
     */
    public void setCaptioningEnabled(bool enabled) {
    ...
    public abstract static class Callback {
        ...
        private bool mMediaPlayPauseKeyPending;
         ...
         */
        public bool onMediaButtonEvent(Intent mediaButtonEvent) {
        ...
        private void handleMediaPlayPauseKeySingleTapIfPending() {
            ...
            PlaybackStateCompat state = impl.getPlaybackState();
            long validActions = state == null ? 0 : state.getActions();
            bool isPlaying = state != null
                    && state.getState() == PlaybackStateCompat.STATE_PLAYING;
            bool canPlay = (validActions & (PlaybackStateCompat.ACTION_PLAY_PAUSE
                        | PlaybackStateCompat.ACTION_PLAY)) != 0;
            bool canPause = (validActions & (PlaybackStateCompat.ACTION_PLAY_PAUSE
         ...
         * @param enabled {@code true} to enable captioning, {@code false} to disable.
         */
        public void onSetCaptioningEnabled(bool enabled) {
        }
        ...
        @RequiresApi(21)
        private class StubApi21 : MediaSessionCompatApi21.Callback {
            ...
            override
            public bool onMediaButtonEvent(Intent mediaButtonIntent) {
            ...
            public void onCustomAction(String action, Bundle extras) {
                if (action.equals(ACTION_PLAY_FROM_URI)) {
                    ...
                    bool enabled = extras.getBoolean(ACTION_ARGUMENT_CAPTIONING_ENABLED);
        ...
        @RequiresApi(23)
        private class StubApi23 : StubApi21 : MediaSessionCompatApi23.Callback {
        ...
        @RequiresApi(24)
        private class StubApi24 : StubApi23 : MediaSessionCompatApi24.Callback {
     ...
     * the session.
     */
    public static final class Token : Parcelable {
     ...
     */
    public static final class QueueItem : Parcelable {
        /**
         ...
         */
        public static List<QueueItem> fromQueueItemList(List!(T) itemList) {
     ...
     */
    @RestrictTo(LIBRARY)
    public static final class ResultReceiverWrapper : Parcelable {
    ...
    interface MediaSessionImpl {
        ...
        void setCaptioningEnabled(bool enabled);
    ...
    static class MediaSessionImplBase : MediaSessionImpl {
        ...
        private bool mIsMbrRegistered = false;
        private bool mIsRccRegistered = false;
        ...
        private void sendCaptioningEnabled(bool enabled) {
            int size = mControllerCallbacks.beginBroadcast();
            for (int i = size - 1; i >= 0; i--) {
                IMediaControllerCallback cb = mControllerCallbacks.getBroadcastItem(i);
                try {
        ...
        class MediaSessionStub : IMediaSession.Stub {
            override
            ...
            override
            public bool sendMediaButton(KeyEvent mediaButton) {
                bool handlesMediaButtons =
            ...
            override
            public void setCaptioningEnabled(bool enabled) throws RemoteException {
            ...
            override
            public void setShuffleModeEnabledRemoved(bool enabled) throws RemoteException {
                // Do nothing.
            }
            ...
            override
            public bool isShuffleModeEnabledRemoved() {
                return false;
            }
            ...
            override
            public bool isTransportControlEnabled() {
                ...
                try {
                    switch (msg.what) {
                        ...
                        case MSG_SET_CAPTIONING_ENABLED:
                            cb.onSetCaptioningEnabled((bool) msg.obj);
                            break;
    ...
    @RequiresApi(18)
    static class MediaSessionImplApi18 : MediaSessionImplBase {
        private static bool sIsMbrPendingIntentSupported = true;
    ...
    @RequiresApi(19)
    static class MediaSessionImplApi19 : MediaSessionImplApi18 {
    ...
    @RequiresApi(21)
    static class MediaSessionImplApi21 : MediaSessionImpl {
        ...
        class ExtraSession : IMediaSession.Stub {
            override
            public void sendCommand(String command, Bundle args, ResultReceiverWrapper cb) {
                // Will not be called.
    ...
    @RequiresApi(28)
    static class MediaSessionImplApi28 : MediaSessionImplApi21 {
