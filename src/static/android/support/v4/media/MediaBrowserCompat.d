...
public final class MediaBrowserCompat {
     ...
     * right values.
     */
    public static class MediaItem : Parcelable {
         ...
         */
        public static List<MediaItem> fromMediaItemList(List!(T) itemList) {
    ...
    public static class ConnectionCallback {
        ...
        private class StubApi21 : MediaBrowserCompatApi21.ConnectionCallback {
            StubApi21() {
            }
    ...
    public static abstract class SubscriptionCallback {
        ...
        private class StubApi21 : MediaBrowserCompatApi21.SubscriptionCallback {
            StubApi21() {
            }

            override
            public void onChildrenLoaded(@NonNull String parentId, List!(T) children) {
        ...
        private class StubApi26 : StubApi21
    ...
    public static abstract class ItemCallback {
        ...
        private class StubApi23 : MediaBrowserCompatApi23.ItemCallback {
            StubApi23() {
            }
    ...
    static class MediaBrowserImplBase
            : MediaBrowserImpl, MediaBrowserServiceCallbackImpl {
        ...
        private bool isCurrent(Messenger callback, String funcName) {
         ...
         */
        private class MediaServiceConnection : ServiceConnection {
             ...
             */
            bool isCurrent(String funcName) {
    ...
    @RequiresApi(21)
    static class MediaBrowserImplApi21 : MediaBrowserImpl, MediaBrowserServiceCallbackImpl,
    ...
    @RequiresApi(23)
    static class MediaBrowserImplApi23 : MediaBrowserImplApi21 {
    ...
    @RequiresApi(26)
    static class MediaBrowserImplApi26 : MediaBrowserImplApi23 {
    ...
    private static class CallbackHandler : Handler {
    ...
    private  static class ItemReceiver : ResultReceiver {
    ...
    private static class SearchResultReceiver : ResultReceiver {
    ...
    private static class CustomActionResultReceiver : ResultReceiver {
