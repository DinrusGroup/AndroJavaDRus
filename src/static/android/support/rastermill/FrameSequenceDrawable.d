...
public class FrameSequenceDrawable : Drawable : Animatable, Runnable {
    ...
    private bool mCircleMaskEnabled;
    ...
    private Runnable mDecodeRunnable = new Runnable() {
        ...
        public void run() {
            ...
            bool exceptionDuringDecode = false;
     ...
     */
    public final void setCircleMaskEnabled(bool circleMaskEnabled) {
    ...
    public final bool getCircleMaskEnabled() {
