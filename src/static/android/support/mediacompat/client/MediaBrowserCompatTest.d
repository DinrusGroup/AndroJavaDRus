...
public class MediaBrowserCompatTest {
    ...
    private class StubConnectionCallback : MediaBrowserCompat.ConnectionCallback {
    ...
    private class StubSubscriptionCallback : MediaBrowserCompat.SubscriptionCallback {
    ...
    private class StubItemCallback : MediaBrowserCompat.ItemCallback {
        final Object mWaitLock = new Object();
    ...
    private class StubSearchCallback : MediaBrowserCompat.SearchCallback {
        final Object mWaitLock = new Object();
        bool mOnSearchResult;
    ...
    private class CustomActionCallback : MediaBrowserCompat.CustomActionCallback {
        ...
        Bundle mExtras;
        Bundle mData;
        bool mOnProgressUpdateCalled;
        bool mOnResultCalled;
        bool mOnErrorCalled;
