 ...
 *
 */
public class DrmManagerClient : AutoCloseable {
    /**
    ...
    private class InfoHandler : Handler {
    ...
    */
     ...
     */
    public bool canHandle(Uri uri, String mimeType) {
    ...
    private native bool _canHandle(int uniqueId, String path, String mimeType);
