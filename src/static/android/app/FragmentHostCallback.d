 ...
 */
@Deprecated
public abstract class FragmentHostCallback<E> : FragmentContainer {
    ...
    private bool mRetainLoaders;
    /** The loader manger for the fragment host [i.e. Activity#getLoaderManager()] */
    private LoaderManagerImpl mLoaderManager;
    private bool mCheckedForLoaderManager;
    /** Whether or not the fragment host loader manager was started */
    private bool mLoadersStarted;
    ...
    LoaderManagerImpl getLoaderManager(String who, bool started, bool create) {
        if (mAllLoaderManagers == null) {
    ...
    ArrayMap<String, LoaderManager> retainLoaderNonConfig() {
        ...
        if (mAllLoaderManagers != null) {
            ...
            final bool doRetainLoaders = getRetainLoaders();
            for (int i=0; i<N; i++) {
                LoaderManagerImpl lm = loaders[i];
