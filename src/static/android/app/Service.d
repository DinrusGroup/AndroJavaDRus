 ...
 *      bind}
 */
public abstract class Service : ContextWrapper : ComponentCallbacks2 {
     ...
     * @see #stopSelf()
     */
    public final bool stopSelfResult(int startId) {
        if (mActivityManager == null) {
            return false;
        }
        try {
     ...
     */
    @Deprecated
    public final void setForeground(bool isForeground) {
     ...
     */
    public final void stopForeground(bool removeNotification) {
