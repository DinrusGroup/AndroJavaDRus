...
public class BackupManager {
    ...
    @SystemApi
    @RequiresPermission(android.Manifest.permission.BACKUP)
    public bool isBackupServiceActive(UserHandle user) {
    ...
    @SystemApi
    @RequiresPermission(android.Manifest.permission.BACKUP)
    public void setAutoRestore(bool isEnabled) {
        checkServiceBinder();
        if (sService != null) {
            try {
     ...
     */
    private class BackupObserverWrapper : IBackupObserver.Stub {
    ...
    private class SelectTransportListenerWrapper : ISelectBackupTransportCallback.Stub {
    ...
    private class BackupManagerMonitorWrapper : IBackupManagerMonitor.Stub {
