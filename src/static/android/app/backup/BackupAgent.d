 ...
 * on the main thread (UI thread) of the application that : the BackupAgent.
...
public abstract class BackupAgent : ContextWrapper {
    ...
    class SharedPrefsSynchronizer : Runnable {
    ...
    private bool areIncludeRequiredTransportFlagsSatisfied(int includeFlags,
            int transportFlags) {
    ...
    private bool manifestExcludesContainFilePath(
    ...
    public void onRestoreFile(ParcelFileDescriptor data, long size,
        ...
        final bool accept = isFileEligibleForRestore(destination);
    ...
    private bool isFileEligibleForRestore(File destination) throws IOException {
     ...
     */
    private bool isFileSpecifiedInPathList(File file,
    ...
    private class BackupServiceBinder : IBackupAgent.Stub {
    ...
    static class FailRunnable : Runnable {
