...
class EnterTransitionCoordinator : ActivityTransitionCoordinator {
    ...
    private bool mSharedElementTransitionStarted;
    private Activity mActivity;
    private bool mHasStopped;
    private bool mIsCanceled;
    private ObjectAnimator mBackgroundAnimator;
    private bool mIsExitTransitionComplete;
    private bool mIsReadyForTransition;
    private Bundle mSharedElementsBundle;
    private bool mWasOpaque;
    private bool mAreViewsReady;
    private bool mIsViewsTransitionStarted;
    private Transition mEnterViewsTransition;
    private OneShotPreDrawListener mViewsReadyListener;
    private final bool mIsCrossTask;
    private Drawable mReplacedBackground;

    public EnterTransitionCoordinator(Activity activity, ResultReceiver resultReceiver,
            ArrayList<String> sharedElementNames, bool isReturning, bool isCrossTask) {
    ...
    private static SharedElementCallback getListener(Activity activity, bool isReturning) {
    ...
    public bool isWaitingForRemoteExit() {
    ...
    private void startSharedElementTransition(Bundle sharedElementState) {
        ...
        bool startEnterTransition = allowOverlappingTransitions() && !mIsReturning;
        bool startSharedElementTransition = true;
    ...
    private Transition beginTransition(ViewGroup decorView, bool startEnterTransition,
            bool startSharedElementTransition) {
    ...
    private bool allowOverlappingTransitions() {
    ...
    private void startEnterTransitionOnly() {
        startTransition(new Runnable() {
            override
            public void run() {
                bool startEnterTransition = true;
                bool startSharedElementTransition = false;
                ViewGroup decorView = getDecor();
                if (decorView != null) {
                    Transition transition = beginTransition(decorView, startEnterTransition,
                            startSharedElementTransition);
