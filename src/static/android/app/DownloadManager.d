...
public class DownloadManager {
    ...
    public static class Request {
        ...
        private bool mRoamingAllowed = true;
        private bool mMeteredAllowed = true;
        private int mFlags = 0;
        private bool mIsVisibleInDownloadsUi = true;
        private bool mScannable = false;
         ...
         */
        @Deprecated
        public Request setShowRunningNotification(bool show) {
         ...
         * @return this object
         */
        public Request setAllowedOverRoaming(bool allowed) {
         ...
         */
        public Request setAllowedOverMetered(bool allow) {
         ...
         * @see android.app.job.JobInfo.Builder#setRequiresCharging(bool)
         */
        public Request setRequiresCharging(bool requiresCharging) {
            if (requiresCharging) {
         ...
         * @see android.app.job.JobInfo.Builder#setRequiresDeviceIdle(bool)
         */
        public Request setRequiresDeviceIdle(bool requiresDeviceIdle) {
         ...
         * @return this object
         */
        public Request setVisibleInDownloadsUi(bool isVisible) {
    ...
    public static class Query {
        ...
        private bool mOnlyIncludeVisibleInDownloadsUi = false;
         ...
         * @hide
         */
        public Query setOnlyIncludeVisibleInDownloadsUi(bool value) {
     ...
     * @hide
     */
    public void setAccessAllDownloads(bool accessAllDownloads) {
    ...
    /** {@hide} */
    public void setAccessFilename(bool accessFilename) {
     ...
     * @hide
     */
    public bool rename(Context context, long id, String displayName) {
    ...
    /** {@hide} */
    public static bool isActiveNetworkExpensive(Context context) {
    ...
    public long addCompletedDownload(String title, String description,
            bool isMediaScannerScannable, String mimeType, String path, long length,
    ...
    public long addCompletedDownload(String title, String description,
            bool isMediaScannerScannable, String mimeType, String path, long length,
            bool showNotification, Uri uri, Uri referer) {
        return addCompletedDownload(title, description, isMediaScannerScannable, mimeType, path,
    ...
    public long addCompletedDownload(String title, String description,
            bool isMediaScannerScannable, String mimeType, String path, long length,
            bool showNotification, bool allowWrite) {
        return addCompletedDownload(title, description, isMediaScannerScannable, mimeType, path,
    ...
    public long addCompletedDownload(String title, String description,
            bool isMediaScannerScannable, String mimeType, String path, long length,
            bool showNotification, bool allowWrite, Uri uri, Uri referer) {
     ...
     * underlying data.
     */
    private static class CursorTranslator : CursorWrapper {
        private final Uri mBaseUri;
        private final bool mAccessFilename;

        public CursorTranslator(Cursor cursor, Uri baseUri, bool accessFilename) {
            super(cursor);
            mBaseUri = baseUri;
            mAccessFilename = accessFilename;
        }
