...
public class Instrumentation {
     ...
     *         didn't happen.
     */
    public bool onException(Object obj, Throwable e) {
        return false;
    }
     ...
     * focus mode.
     */
    public void setInTouchMode(bool inTouch) {
        try {
    ...
    public static class ActivityMonitor {
        ...
        private final bool mBlock;
        private final bool mIgnoreMatchingSpecificIntents;
        ...
        public ActivityMonitor(
            IntentFilter which, ActivityResult result, bool block) {
            mWhich = which;
            mClass = null;
            mResult = result;
            mBlock = block;
         ...
         */
        public ActivityMonitor(
            String cls, ActivityResult result, bool block) {
            mWhich = null;
            mClass = cls;
            mResult = result;
            mBlock = block;
         ...
         */
        final bool ignoreMatchingSpecificIntents() {
     ...
     *  
     * @see #addMonitor(IntentFilter, ActivityResult, bool) 
     * @see #checkMonitorHit 
     */
    ...
    public ActivityMonitor addMonitor(
        IntentFilter filter, ActivityResult result, bool block) {
     ...
     * @see #addMonitor 
     */
    public bool checkMonitorHit(ActivityMonitor monitor, int minHits) {
        waitForIdleSync();
        synchronized (mSync) {
     ...
     */
    public bool invokeMenuActionSync(Activity targetActivity, 
                                    int id, int flag) {
        class MenuRunnable : Runnable {
     ...
     *         false if item is disabled).
     */
    public bool invokeContextMenuAction(Activity targetActivity, int id, int flag) {
        validateNotAppThread();
        ...
        class ContextMenuRunnable : Runnable {
            private final Activity activity;
            private final int identifier;
            private final int flags;
            bool returnValue;
     ...
     * @return The newly instantiated Application object.
     */
    static public Application newApplication(Class!(T) clazz, Context context)
            throws InstantiationException, IllegalAccessException, 
            ClassNotFoundException {
     ...
     */
    public Activity newActivity(Class!(T) clazz, Context context, 
...
//      }
    ...
    public ActivityResult execStartActivityAsCaller(
            Context who, IBinder contextThread, IBinder token, Activity target,
            Intent intent, int requestCode, Bundle options, bool ignoreTargetSecurity,
            int userId) {
        IApplicationThread whoThread = (IApplicationThread) contextThread;
        if (mActivityMonitors != null) {
            synchronized (mSync) {
     ...
     * target, while {@link UiAutomation#injectInputEvent(android.view.InputEvent, bool)}
    ...
    public UiAutomation getUiAutomation(@UiAutomationFlags int flags) {
        bool mustCreateNewAutomation = (mUiAutomation == null) || (mUiAutomation.isDestroyed());
    ...
    private final class InstrumentationThread : Thread {
    ...
    private static final class EmptyRunnable : Runnable {
        public void run() {
        }
    }

    private static final class SyncRunnable : Runnable {
    ...
    private final class ActivityGoing : MessageQueue.IdleHandler {
    ...
    private static final class Idler : MessageQueue.IdleHandler {
