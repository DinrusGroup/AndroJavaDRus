...
public class ResourcesManager {
    ...
    private static class ApkKey {
        ...
        public final bool sharedLib;
        public final bool overlay;

        ApkKey(String path, bool sharedLib, bool overlay) {
            this.path = path;
    ...
    public bool applyCompatConfigurationLocked(int displayDensity,
    ...
    private @NonNull ApkAssets loadApkAssets(String path, bool sharedLib, bool overlay)
            throws IOException {
    ...
    */
    ...
    private Configuration generateConfig(@NonNull ResourcesKey key, @NonNull DisplayMetrics dm) {
        ...
        final bool isDefaultDisplay = (key.mDisplayId == Display.DEFAULT_DISPLAY);
        final bool hasOverrideConfig = key.hasOverrideConfiguration();
     ...
     */
    bool isSameResourcesOverrideConfig(@Nullable IBinder activityToken,
    ...
    public void updateResourcesForActivity(@NonNull IBinder activityToken,
        ...
        try {
            ...
            synchronized (this) {
                ...
                final bool activityHasOverrideConfig =
                        !activityResources.overrideConfig.equals(Configuration.EMPTY);
    ...
    public final bool applyConfigurationToResourcesLocked(@NonNull Configuration config,
        ...
        try {
            ...
            for (int i = mResourceImpls.size() - 1; i >= 0; i--) {
                ...
                if (r != null) {
                    ...
                    bool isDefaultDisplay = (displayId == Display.DEFAULT_DISPLAY);
                    DisplayMetrics dm = defaultDisplayMetrics;
                    final bool hasOverrideConfiguration = key.hasOverrideConfiguration();
