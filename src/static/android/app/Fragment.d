 ...
 */
@Deprecated
public class Fragment : ComponentCallbacks2, OnCreateContextMenuListener {
    private static final ArrayMap<String, Class!(T)> sClassMap =
            new ArrayMap<String, Class!(T)>();
    ...
    bool mLoadersStarted;
    bool mCheckedForLoaderManager;
     ...
     */
    @Deprecated
    public static class SavedState : Parcelable {
        final Bundle mState;
     ...
     */
    @Deprecated
    static public class InstantiationException : AndroidRuntimeException {
    ...
    public static Fragment instantiate(Context context, String fname, @Nullable Bundle args) {
        try {
            Class!(T) clazz = sClassMap.get(fname);
            if (clazz == null) {
     ...
     */
    override final public bool equals(Object o) {
     ...
     */
    public final bool isStateSaved() {
     ...
     * </ul>
     */
    public void setRetainInstance(bool retain) {
        mRetainInstance = retain;
    }

    final public bool getRetainInstance() {
     ...
     */
    public void setHasOptionsMenu(bool hasMenu) {
        if (mHasMenu != hasMenu) {
            mHasMenu = hasMenu;
            if (isAdded() && !isHidden()) {
     ...
     */
    public void setMenuVisibility(bool menuVisible) {
    ...
    public void setUserVisibleHint(bool isVisibleToUser) {
        ...
        bool useBrokenAddedCheck = false;
        ...
        final bool performDeferredStart;
     ...
     */
    public Animator onCreateAnimator(int transit, bool enter, int nextAnim) {
        return null;
    }
     ...
     * instance is retained across Activity re-creation (see {@link #setRetainInstance(bool)}).
     *
    ...
    void restoreChildFragmentState(@Nullable Bundle savedInstanceState, bool provideNonConfig) {
     ...
     * {@link #setRetainInstance(bool)} to retain their instance,
     ...
     * Activity re-creation (see {@link #setRetainInstance(bool)}), in which case it is called
     * after {@link #onStop()}.
     */
    @CallSuper
     ...
     */
    public void setAllowReturnTransitionOverlap(bool allow) {
     ...
     * @see FragmentTransaction#setReorderingAllowed(bool)
     */
     ...
     */
    private bool shouldChangeTransition(Transition transition, Transition defaultValue) {
    ...
    @Deprecated
    void performMultiWindowModeChanged(bool isInMultiWindowMode) {
        onMultiWindowModeChanged(isInMultiWindowMode);
        if (mChildFragmentManager != null) {
    ...
    void performMultiWindowModeChanged(bool isInMultiWindowMode, Configuration newConfig) {
    ...
    @Deprecated
    void performPictureInPictureModeChanged(bool isInPictureInPictureMode) {
        onPictureInPictureModeChanged(isInPictureInPictureMode);
        if (mChildFragmentManager != null) {
    ...
    void setHideReplaced(bool replaced) {
