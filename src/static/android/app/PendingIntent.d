 ...
 */
public final class PendingIntent : Parcelable {
     ...
     */
    public static class CanceledException : AndroidException {
    ...
    private static class FinishedDispatcher : IIntentReceiver.Stub
            : Runnable {
        ...
        public void performReceive(Intent intent, int resultCode, String data,
                Bundle extras, bool serialized, bool sticky, int sendingUser) {
            mIntent = intent;
    ...
    public void registerCancelListener(CancelListener cancelListener) {
        synchronized (this) {
            ...
            bool wasEmpty = mCancelListeners.isEmpty();
