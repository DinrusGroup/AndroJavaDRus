 ...
 * </div>
 */
public class Dialog : DialogInterface, Window.Callback,
     ...
     * {@hide}
     */
    protected bool mCancelable = true;
    ...
    Dialog(@NonNull Context context, @StyleRes int themeResId, bool createContextThemeWrapper) {
     ...
     */
    @Deprecated
    protected Dialog(@NonNull Context context, bool cancelable,
    ...
    public void show() {
        ...
        bool restoreSoftInputMode = false;
        if ((l.softInputMode
     ...
     */
    override
    public bool onKeyDown(int keyCode, @NonNull KeyEvent event) {
     ...
     */
    override
    public bool onKeyLongPress(int keyCode, @NonNull KeyEvent event) {
        return false;
    }
     ...
     */
    override
    public bool onKeyUp(int keyCode, @NonNull KeyEvent event) {
        if ((keyCode == KeyEvent.KEYCODE_BACK || keyCode == KeyEvent.KEYCODE_ESCAPE)
                && event.isTracking()
                && !event.isCanceled()) {
            onBackPressed();
     ...
     */
    override
    public bool onKeyMultiple(int keyCode, int repeatCount, @NonNull KeyEvent event) {
        return false;
    }
     ...
     */
    public bool onKeyShortcut(int keyCode, @NonNull KeyEvent event) {
        return false;
    }
     ...
     */
    public bool onTouchEvent(@NonNull MotionEvent event) {
     ...
     */
    public bool onTrackballEvent(@NonNull MotionEvent event) {
        return false;
    }
     ...
     * The default implementation always returns false.
     */
    public bool onGenericMotionEvent(@NonNull MotionEvent event) {
        return false;
    }
     ...
     */
    override
    public bool dispatchKeyEvent(@NonNull KeyEvent event) {
     ...
     */
    override
    public bool dispatchKeyShortcutEvent(@NonNull KeyEvent event) {
     ...
     */
    override
    public bool dispatchTouchEvent(@NonNull MotionEvent ev) {
     ...
     */
    override
    public bool dispatchTrackballEvent(@NonNull MotionEvent ev) {
     ...
     */
    override
    public bool dispatchGenericMotionEvent(@NonNull MotionEvent ev) {
    ...
    override
    public bool dispatchPopulateAccessibilityEvent(@NonNull AccessibilityEvent event) {
     ...
     */
    override
    public bool onCreatePanelMenu(int featureId, @NonNull Menu menu) {
     ...
     */
    public bool onCreateOptionsMenu(@NonNull Menu menu) {
        return true;
    }
     ...
     * @see #getOwnerActivity()
     */
    public bool onPrepareOptionsMenu(@NonNull Menu menu) {
        return true;
    }
     ...
     */
    public bool onOptionsItemSelected(@NonNull MenuItem item) {
        return false;
    }
     ...
     */
    public bool onContextItemSelected(@NonNull MenuItem item) {
        return false;
    }
     ...
     */
    override
    public bool onSearchRequested(@NonNull SearchEvent searchEvent) {
    ...
    /** @hide */
    public bool takeCancelAndDismissListeners(@Nullable String msg,
    ...
    private static final class ListenersHandler : Handler {
