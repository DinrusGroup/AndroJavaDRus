...
final class FragmentManagerImpl : FragmentManager : LayoutInflater.Factory2 {
    ...
    static class AnimateOnHWLayerIfNeededListener : Animator.AnimatorListener {
        private bool mShouldRunOnHWLayer = false;
        private View mView;
    ...
    bool mAllowOldReentrantBehavior;
    ...
    static bool shouldRunOnHWLayer(View v, Animator anim) {
        if (v == null || anim == null) {
            return false;
        }
    ...
    override
    public bool popBackStackImmediate(String name, int flags) {
        checkStateLoss();
    ...
    Animator loadAnimator(Fragment fragment, int transit, bool enter,
            int transitionStyle) {
    ...
    public void attachController(FragmentHostCallback!(T) host, FragmentContainer container,
            Fragment parent) {
    ...
    /**
     * @deprecated use {@link #dispatchMultiWindowModeChanged(bool, Configuration)}
     */
    @Deprecated
    ...
    /**
     * @deprecated use {@link #dispatchPictureInPictureModeChanged(bool, Configuration)}
     */
    @Deprecated
    ...
    void dispatchOnFragmentPreAttached(Fragment f, Context context, bool onlyRecursive) {
        if (mParent != null) {
    ...
    void dispatchOnFragmentAttached(Fragment f, Context context, bool onlyRecursive) {
        if (mParent != null) {
            FragmentManager parentManager = mParent.getFragmentManager();
            if (parentManager instanceof FragmentManagerImpl) {
                ((FragmentManagerImpl) parentManager)
    ...
    void dispatchOnFragmentCreated(Fragment f, Bundle savedInstanceState, bool onlyRecursive) {
        if (mParent != null) {
            FragmentManager parentManager = mParent.getFragmentManager();
            if (parentManager instanceof FragmentManagerImpl) {
                ((FragmentManagerImpl) parentManager)
    ...
    void dispatchOnFragmentStarted(Fragment f, bool onlyRecursive) {
        if (mParent != null) {
            FragmentManager parentManager = mParent.getFragmentManager();
            if (parentManager instanceof FragmentManagerImpl) {
                ((FragmentManagerImpl) parentManager)
    ...
    void dispatchOnFragmentResumed(Fragment f, bool onlyRecursive) {
        if (mParent != null) {
            FragmentManager parentManager = mParent.getFragmentManager();
            if (parentManager instanceof FragmentManagerImpl) {
                ((FragmentManagerImpl) parentManager)
    ...
    void dispatchOnFragmentPaused(Fragment f, bool onlyRecursive) {
        if (mParent != null) {
            FragmentManager parentManager = mParent.getFragmentManager();
            if (parentManager instanceof FragmentManagerImpl) {
                ((FragmentManagerImpl) parentManager)
    ...
    void dispatchOnFragmentStopped(Fragment f, bool onlyRecursive) {
        if (mParent != null) {
            FragmentManager parentManager = mParent.getFragmentManager();
            if (parentManager instanceof FragmentManagerImpl) {
                ((FragmentManagerImpl) parentManager)
    ...
    void dispatchOnFragmentSaveInstanceState(Fragment f, Bundle outState, bool onlyRecursive) {
        if (mParent != null) {
            FragmentManager parentManager = mParent.getFragmentManager();
            if (parentManager instanceof FragmentManagerImpl) {
                ((FragmentManagerImpl) parentManager)
    ...
    void dispatchOnFragmentViewDestroyed(Fragment f, bool onlyRecursive) {
        if (mParent != null) {
            FragmentManager parentManager = mParent.getFragmentManager();
            if (parentManager instanceof FragmentManagerImpl) {
                ((FragmentManagerImpl) parentManager)
    ...
    void dispatchOnFragmentDestroyed(Fragment f, bool onlyRecursive) {
        if (mParent != null) {
            FragmentManager parentManager = mParent.getFragmentManager();
            if (parentManager instanceof FragmentManagerImpl) {
                ((FragmentManagerImpl) parentManager)
    ...
    void dispatchOnFragmentDetached(Fragment f, bool onlyRecursive) {
        if (mParent != null) {
            FragmentManager parentManager = mParent.getFragmentManager();
            if (parentManager instanceof FragmentManagerImpl) {
                ((FragmentManagerImpl) parentManager)
    ...
    static class StartEnterTransitionListener
        ...
        public StartEnterTransitionListener(BackStackRecord record, bool isBack) {
            mIsBack = isBack;
            mRecord = record;
        }
