 ...
 */
public final class NotificationChannel : Parcelable {
    ...
    private static final bool DEFAULT_DELETED = false;
    ...
    private bool mFgServiceShown;
    private bool mVibrationEnabled;
    private bool mShowBadge = DEFAULT_SHOW_BADGE;
    private bool mDeleted = DEFAULT_DELETED;
    private String mGroup;
    private AudioAttributes mAudioAttributes = Notification.AUDIO_ATTRIBUTES_DEFAULT;
    // If this is a blockable system notification channel.
    private bool mBlockableSystem = false;
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeByte(mBypassDnd ? cast(byte) 1 : cast(byte) 0);
        ...
        dest.writeByte(mLights ? cast(byte) 1 : cast(byte) 0);
        dest.writeLongArray(mVibration);
        dest.writeInt(mUserLockedFields);
        dest.writeByte(mFgServiceShown ? cast(byte) 1 : cast(byte) 0);
        dest.writeByte(mVibrationEnabled ? cast(byte) 1 : cast(byte) 0);
        dest.writeByte(mShowBadge ? cast(byte) 1 : cast(byte) 0);
        dest.writeByte(mDeleted ? cast(byte) 1 : cast(byte) 0);
        if (mGroup != null) {
            dest.writeByte(cast(byte) 1);
     ...
     * @hide
     */
    public void setFgServiceShown(bool shown) {
     ...
     * @hide
     */
    public void setBlockableSystem(bool blockableSystem) {
     ...
     * {@link #enableLights(bool) enabled} on this channel and the device supports that feature.
     *
     * Only modifiable before the channel is submitted to
     * {@link NotificationManager#createNotificationChannel(NotificationChannel)}.
     */
     ...
     * pattern is valid (non-null, non-empty), will {@link #enableVibration(bool)} enable
     ...
     */
    private void populateFromXml(XmlPullParser parser, bool forRestore,
     ...
     */
    private void writeXml(XmlSerializer out, bool forBackup, @Nullable Context context)
            throws IOException {
    ...
    private static bool safeBool(XmlPullParser parser, String att, bool defValue) {
