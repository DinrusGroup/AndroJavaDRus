...
public final class StatsManager {
     ...
     */
    @RequiresPermission(allOf = { DUMP, PACKAGE_USAGE_STATS })
    public bool addConfiguration(long configKey, byte[] config) {
        try {
     ...
     */
    @RequiresPermission(allOf = { DUMP, PACKAGE_USAGE_STATS })
    public bool removeConfiguration(long configKey) {
        try {
     ...
     */
    @RequiresPermission(allOf = { DUMP, PACKAGE_USAGE_STATS })
    public bool setBroadcastSubscriber(
     ...
     */
    @RequiresPermission(allOf = { DUMP, PACKAGE_USAGE_STATS })
    public bool setDataFetchOperation(long configKey, PendingIntent pendingIntent) {
        try {
     ...
     */
    public static class StatsUnavailableException : AndroidException {
