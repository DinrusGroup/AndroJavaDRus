 ...
 */
public final class NetworkStats : AutoCloseable {
     ...
     */
    public bool getNextBucket(Bucket bucketOut) {
        if (mSummary != null) {
     ...
     */
    private bool getNextSummaryBucket(Bucket bucketOut) {
     ...
     * @return true if a next item could be set.
     */
    private bool getNextHistoryBucket(Bucket bucketOut) {
    ...
    private bool isUidEnumeration() {
        return mUids != null;
    }

    private bool hasNextUid() {
