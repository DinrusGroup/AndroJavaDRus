...
public class NetworkStatsManager {
    ...
    /** @hide */
    public void setPollOnOpen(bool pollOnOpen) {
        if (pollOnOpen) {
    ...
    /** @hide */
    @TestApi
    public void setPollForce(bool pollForce) {
        if (pollForce) {
    ...
    /** @hide */
    public void setAugmentWithSubscriptionPlan(bool augmentWithSubscriptionPlan) {
