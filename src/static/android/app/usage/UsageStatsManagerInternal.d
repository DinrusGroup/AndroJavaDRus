...
public abstract class UsageStatsManagerInternal {
     ...
     * @return
     */
    public abstract bool isAppIdle(String packageName, int uidForAppId, @UserIdInt int userId);
     ...
     */
    public abstract bool isAppIdleParoleOn();
    ...
    public static abstract class AppIdleStateChangeListener {
         ...
         */
        public abstract void onParoleStateChanged(bool isParoleOn);
    ...
    public abstract List<UsageStats> queryUsageStatsForUser(@UserIdInt int userId, int interval,
            long beginTime, long endTime, bool obfuscateInstantApps);
