...
class FragmentTransition {
    ...
    static void startTransitions(FragmentManagerImpl fragmentManager,
            ...
            int startIndex, int endIndex, bool isReordered) {
    ...
    private static void configureTransitionsReordered(FragmentManagerImpl fragmentManager,
        ...
        final bool inIsPop = fragments.lastInIsPop;
        final bool outIsPop = fragments.firstOutIsPop;
    ...
    private static TransitionSet getSharedElementTransition(Fragment inFragment,
            Fragment outFragment, bool isPop) {
     ...
     */
    private static Transition getEnterTransition(Fragment inFragment, bool isPop) {
        if (inFragment == null) {
            return null;
        }
     ...
     */
    private static Transition getExitTransition(Fragment outFragment, bool isPop) {
        if (outFragment == null) {
            return null;
        }
    ...
    private static View getInEpicenterView(ArrayMap<String, View> inSharedElements,
            FragmentContainerTransition fragments,
            Transition enterTransition, bool inIsPop) {
    ...
    private static void setOutEpicenter(TransitionSet sharedElementTransition,
            Transition exitTransition, ArrayMap<String, View> outSharedElements, bool outIsPop,
    ...
    private static void callSharedElementStartEnd(Fragment inFragment, Fragment outFragment,
            bool isPop, ArrayMap<String, View> sharedElements, bool isStart) {
     ...
     */
    private static bool containedBeforeIndex(final List<View> views, final View view,
            final int maxIndex) {
     ...
     */
    private static bool hasSimpleTarget(Transition transition) {
     ...
     */
    private static bool isNullOrEmpty(List list) {
    ...
    public static void calculatePopFragments(BackStackRecord transaction,
            SparseArray<FragmentContainerTransition> transitioningFragments, bool isReordered) {
    ...
    private static void addToFirstInLastOut(BackStackRecord transaction, BackStackRecord.Op op,
            SparseArray<FragmentContainerTransition> transitioningFragments, bool isPop,
            bool isReorderedTransaction) {
        ...
        bool setLastIn = false;
        bool wasRemoved = false;
        bool setFirstOut = false;
        bool wasAdded = false;
        switch (command) {
