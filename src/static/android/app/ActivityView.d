 ...
 * @hide
 */
public class ActivityView : ViewGroup {
    ...
    private bool mOpened; // Protected by mGuard.
    ...
    private bool injectInputEvent(InputEvent event) {
    ...
    private class SurfaceCallback : SurfaceHolder.Callback {
        override
     ...
     */
    private class TaskStackListenerImpl : TaskStackListener {
