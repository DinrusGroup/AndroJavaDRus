 ...
 */
public class JobInfo : Parcelable {
    ...
    private final bool hasEarlyConstraint;
    private final bool hasLateConstraint;
    private final NetworkRequest networkRequest;
    private final long networkDownloadBytes;
    private final long networkUploadBytes;
    private final long minLatencyMillis;
    private final long maxExecutionDelayMillis;
    private final bool isPeriodic;
    private final bool isPersisted;
    ...
    /** @hide */
    public bool isExemptedFromAppStandby() {
        return ((flags & FLAG_EXEMPT_FROM_APP_STANDBY) != 0) && !isPeriodic();
    }

    /**
     * @see JobInfo.Builder#setRequiresCharging(bool)
     */
    ...
    /**
     * @see JobInfo.Builder#setRequiresBatteryNotLow(bool)
     */
    ...
    /**
     * @see JobInfo.Builder#setRequiresDeviceIdle(bool)
     */
    ...
    /**
     * @see JobInfo.Builder#setRequiresStorageNotLow(bool)
     */
    ...
    /**
     * @see JobInfo.Builder#setPersisted(bool)
     */
    ...
    /**
     * @see JobInfo.Builder#setImportantWhileForeground(bool)
     */
    ...
    /**
     * @see JobInfo.Builder#setPrefetch(bool)
     */
     ...
     * @hide
     */
    public bool hasEarlyConstraint() {
     ...
     * @hide
     */
    public bool hasLateConstraint() {
        return hasLateConstraint;
    }

    private static bool kindofEqualsBundle(BaseBundle a, BaseBundle b) {
     ...
     * trigger on.
     */
    public static final class TriggerContentUri : Parcelable {
    ...
    public static final class Builder {
        ...
        private bool mIsPersisted;
        // One-off parameters.
        private long mMinLatencyMillis;
        private long mMaxExecutionDelayMillis;
        // Periodic parameters.
        private bool mIsPeriodic;
        private bool mHasEarlyConstraint;
        private bool mHasLateConstraint;
        ...
        private bool mBackoffPolicySet = false;
         ...
         */
        public Builder setRequiresBatteryNotLow(bool batteryNotLow) {
         ...
         * {@link #setPeriodic(long)} or {@link #setPersisted(bool)}.  To continually monitor
         ...
         * {@link #setRequiresDeviceIdle(bool)} will throw an exception when you call build().
         * This is because back-off typically does not make sense for these types of jobs. See
         * {@link android.app.job.JobService#jobFinished(android.app.job.JobParameters, bool)}
         ...
         */
        public Builder setImportantWhileForeground(bool importantWhileForeground) {
        ...
        /**
         * @removed
         * @deprecated replaced with {@link #setPrefetch(bool)}
         */
        @Deprecated
        public Builder setIsPrefetch(bool isPrefetch) {
         ...
         */
        public Builder setPrefetch(bool prefetch) {
            if (prefetch) {
        ...
        public Builder setPersisted(bool isPersisted) {
