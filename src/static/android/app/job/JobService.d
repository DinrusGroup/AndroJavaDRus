...
public abstract class JobService : Service {
     ...
     *     otherwise.
     */
    public final void jobFinished(JobParameters params, bool wantsReschedule) {
     ...
     * {@link #jobFinished(JobParameters, bool)} to tell the system that it has completed
     * its work, or until the job's required constraints are no longer satisfied.  For
     * example, if the job was scheduled using
     * {@link JobInfo.Builder#setRequiresCharging(bool) setRequiresCharging(true)},
     ...
     * you call {@link #jobFinished(JobParameters, bool)}, or after the system invokes
     ...
     *     {@link #jobFinished(JobParameters, bool)}.
     ...
     * even before you've had a chance to call {@link #jobFinished(JobParameters, bool)}.
     *
     * <p>This will happen if the requirements specified at schedule time are no longer met. For
     * example you may have requested WiFi with
     * {@link android.app.job.JobInfo.Builder#setRequiredNetworkType(int)}, yet while your
     * job was executing the user toggled WiFi. Another example is if you had specified
     * {@link android.app.job.JobInfo.Builder#setRequiresDeviceIdle(bool)}, and the phone left its
