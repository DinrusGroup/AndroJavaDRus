...
public abstract class JobServiceEngine {
    ...
    static final class JobInterface : IJobService.Stub {
    ...
    class JobHandler : Handler {
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                case MSG_EXECUTE_JOB:
                    try {
                        bool workOngoing = JobServiceEngine.this.onStartJob(params);
                ...
                case MSG_STOP_JOB:
                    try {
                        bool ret = JobServiceEngine.this.onStopJob(params);
                ...
                case MSG_JOB_FINISHED:
                    final bool needsReschedule = (msg.arg2 == 1);
        ...
        private void ackStartMessage(JobParameters params, bool workOngoing) {
        ...
        private void ackStopMessage(JobParameters params, bool reschedule) {
            final IJobCallback callback = params.getCallback();
            final int jobId = params.getJobId();
            if (callback != null) {
                try {
     ...
     * {@link JobService#jobFinished(JobParameters, bool)}  JobService.jobFinished} for more
     * information.
     */
