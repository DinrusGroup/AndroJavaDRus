...
class LoaderManagerImpl : LoaderManager {
    ...
    bool mStarted;
    bool mRetaining;
    bool mRetainingStarted;
    
    bool mCreatingLoader;
    private FragmentHostCallback mHost;

    final class LoaderInfo : Loader.OnLoadCompleteListener<Object>,
        ...
        bool cancel() {
            ...
            if (mStarted && mLoader != null && mListenerRegistered) {
                final bool cancelLoadResult = mLoader.cancelLoad();
                if (!cancelLoadResult) {
    ...
    LoaderManagerImpl(String who, FragmentHostCallback host, bool started) {
        mWho = who;
        mHost = host;
        mStarted = started;
    }
