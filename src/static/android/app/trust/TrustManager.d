...
public class TrustManager {
     ...
     */
    public void reportUnlockAttempt(bool successful, int userId) {
        try {
    ...
    public interface TrustListener {
         ...
         */
        void onTrustChanged(bool enabled, int userId, int flags);
         ...
         */
        void onTrustManagedChanged(bool enabled, int userId);
