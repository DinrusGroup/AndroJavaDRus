 ...
 * </div>
 */
public class AlertDialog : Dialog : DialogInterface {
     ...
     * @see android.R.styleable#Theme_alertDialogTheme
     */
    protected AlertDialog(Context context, bool cancelable, OnCancelListener cancelListener) {
        this(context, 0);
    ...
    AlertDialog(Context context, @StyleRes int themeResId, bool createContextThemeWrapper) {
    ...
    public static class Builder {
         ...
         * @return This Builder object to allow for chaining of calls to set methods
         */
        public Builder setMultiChoiceItems(@ArrayRes int itemsId, bool[] checkedItems,
         ...
         * @return This Builder object to allow for chaining of calls to set methods
         */
        public Builder setMultiChoiceItems(CharSequence[] items, bool[] checkedItems,
                final OnMultiChoiceClickListener listener) {
            P.mItems = items;
            P.mOnCheckboxClickListener = listener;
            P.mCheckedItems = checkedItems;
         ...
         */
        @Deprecated
        public Builder setInverseBackgroundForced(bool useInverseBackground) {
         ...
         * @hide
         */
        public Builder setRecycleOnMeasureEnabled(bool enabled) {
