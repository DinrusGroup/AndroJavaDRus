...
/** @hide */
public class ApplicationPackageManager : PackageManager {
    private static final String TAG = "ApplicationPackageManager";
    private final static bool DEBUG_ICONS = false;
    ...
    public Resources getResourcesForApplication(@NonNull ApplicationInfo app)
        ...
        final bool sameUid = (app.uid == Process.myUid());
    ...
    static void handlePackageBroadcast(int cmd, String[] pkgList, bool hasPkgInfo) {
        bool immediateGc = false;
    ...
    private static bool isPrimaryStorageCandidateVolume(VolumeInfo vol) {
    ...
    private bool isManagedProfile(int userId) {
    ...
    /** {@hide} */
    private static class MoveCallbackDelegate : IPackageMoveObserver.Stub :
            Handler.Callback {
    ...
    public class OnPermissionsChangeListenerDelegate : IOnPermissionsChangeListener.Stub
            : Handler.Callback{
    ...
    private static class DexModuleRegisterResult {
        ...
        private DexModuleRegisterResult(String dexModulePath, bool success, String message) {
    ...
    private static class DexModuleRegisterCallbackDelegate
        ...
        override
        public void onDexModuleRegistered(@NonNull String dexModulePath, bool success,
