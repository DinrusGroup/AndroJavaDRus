...
public abstract class ClientTransactionHandler {
    ...
    public abstract void updateProcessState(int processState, bool fromIpc);
    ...
    public abstract void handleDestroyActivity(IBinder token, bool finishing, int configChanges,
            bool getNonConfigInstance, String reason);

    /** Pause the activity. */
    public abstract void handlePauseActivity(IBinder token, bool finished, bool userLeaving,
     ...
     */
    public abstract void handleResumeActivity(IBinder token, bool finalStateRequest,
            bool isForward, String reason);
     ...
     * @param reason Reason for performing this operation.
     */
    public abstract void handleStopActivity(IBinder token, bool show, int configChanges,
    ...
    public abstract void performRestartActivity(IBinder token, bool start);
    ...
    public abstract void handleMultiWindowModeChanged(IBinder token, bool isInMultiWindowMode,
    ...
    public abstract void handlePictureInPictureModeChanged(IBinder token, bool isInPipMode,
            Configuration overrideConfig);

    /** Update window visibility. */
    public abstract void handleWindowVisibility(IBinder token, bool show);
