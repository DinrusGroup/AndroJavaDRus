 ...
 */
@TestApi
public class WindowConfiguration : Parcelable, Comparable<WindowConfiguration> {
    /**
     ...
     * @hide
     */
    public @WindowConfig long diff(WindowConfiguration other, bool compareUndefined) {
        long changes = 0;
     ...
     * @hide
     */
    public bool hasWindowDecorCaption() {
     ...
     * @hide
     */
    public bool canResizeTask() {
        return mWindowingMode == WINDOWING_MODE_FREEFORM;
    }

    /** Returns true if the task bounds should persist across power cycles.
     * @hide */
    public bool persistTaskBounds() {
        return mWindowingMode == WINDOWING_MODE_FREEFORM;
    }
     ...
     * @hide
     */
    public static bool isFloating(int windowingMode) {
     ...
     * @hide
     */
    public bool keepVisibleDeadAppWindowOnScreen() {
        return mWindowingMode != WINDOWING_MODE_PINNED;
    }
     ...
     * @hide
     */
    public bool useWindowFrameForBackdrop() {
     ...
     * @hide
     */
    public bool windowsAreScaleable() {
        return mWindowingMode == WINDOWING_MODE_PINNED;
    }
     ...
     * @hide
     */
    public bool hasMovementAnimations() {
        return mWindowingMode != WINDOWING_MODE_PINNED;
    }
     ...
     * @hide
     */
    public bool supportSplitScreenWindowingMode() {
        return supportSplitScreenWindowingMode(mActivityType);
    }

    /** @hide */
    public static bool supportSplitScreenWindowingMode(int activityType) {
