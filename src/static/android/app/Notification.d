...
public class Notification : Parcelable
{
     ...
     * {@link android.app.Notification.Builder#setShowWhen(bool)}
     */
    public long when;
    ...
    private bool mUsesStandardHeader;
    ...
    /**
     * {@link #extras} key: bool as supplied to
     * {@link Builder#setShowRemoteInputSpinner(bool)}.
     *
     ...
     *
     * @see Builder#setShowRemoteInputSpinner(bool)
     * @hide
     */
    ...
    /**
     * {@link #extras} key: bool as supplied to
     * {@link Builder#setHideSmartReplies(bool)}.
     *
     * If set to true, then any smart reply buttons will be hidden.
     *
     * @see Builder#setHideSmartReplies(bool)
     * @hide
     */
     ...
     * {@link Builder#setProgress(int, int, bool)}.
     */
     ...
     * {@link Builder#setUsesChronometer(bool)}.
     */
     ...
     * This extra is a bool. The default is false.
     */
    public static final String EXTRA_CHRONOMETER_COUNT_DOWN = "android.chronometerCountDown";

    /**
     * {@link #extras} key: whether {@link #when} should be shown,
     * as supplied to {@link Builder#setShowWhen(bool)}.
     */
     ...
     * supplied to {@link Builder#setColorized(bool)}}.
     */
     ...
     * to attach actions.
     */
    public static class Action : Parcelable {
        /**
        ...
        private bool mAllowGeneratedReplies = true;
        ...
        private Action(Icon icon, CharSequence title, PendingIntent intent, Bundle extras,
                RemoteInput[] remoteInputs, bool allowGeneratedReplies,
         ...
         *         .build();</pre>
         */
        public static final class WearableExtender : Extender {
             ...
             * Defaults to true.
             */
            public WearableExtender setAvailableOffline(bool availableOffline) {
     ...
     * @hide
     */
    public void cloneInto(Notification that, bool heavy) {
    ...
    public void writeToParcel(Parcel parcel, int flags) {
        ...
        final bool collectPendingIntents = (allPendingIntents == null);
     ...
     * @hide
     */
    public static bool areActionsVisiblyDifferent(Notification first, Notification second) {
     ...
     * @hide
     */
    public static bool areStyledNotificationsVisiblyDifferent(Builder first, Builder second) {
     ...
     * @hide
     */
    public static bool areRemoteViewsChanged(Builder first, Builder second) {
    ...
    private static bool areRemoteViewsChanged(RemoteViews first, RemoteViews second) {
     ...
     * @hide
     */
    public bool hasCompletedProgress() {
     ...
     * @hide
     */
    public bool suppressAlertingDueToGrouping() {
        if (isGroupSummary()
    ...
    public static class Builder {
        ...
        private static final bool USE_ONLY_TITLE_IN_LOW_PRIORITY_SUMMARY =
        ...
        private bool mIsLegacyInitialized;
        ...
        private bool mRebuildStyledRemoteViews;

        private bool mTintActionButtons;
        private bool mInNightMode;
         ...
         * {@link #setChronometerCountDown(bool)}.
         *
         * @see android.widget.Chronometer
         * @see Notification#when
         * @see #setChronometerCountDown(bool)
         */
        public Builder setUsesChronometer(bool b) {
         ...
         *
         * <p>This is only relevant if {@link #setUsesChronometer(bool)} has been set to true.
         * If it isn't set the chronometer will count up.
         *
         * @see #setUsesChronometer(bool)
         */
        public Builder setChronometerCountDown(bool countDown) {
         ...
         * You should not be using {@link #setProgress(int, int, bool)} at the
         ...
         * @hide
         */
        public Builder setShowRemoteInputSpinner(bool showSpinner) {
         ...
         * @hide
         */
        public Builder setHideSmartReplies(bool hideSmartReplies) {
         ...
         */
        public Builder setFullScreenIntent(PendingIntent intent, bool highPriority) {
         ...
         *
         * @deprecated use {@link NotificationChannel#enableLights(bool)} instead.
         ...
         * @see Service#setForeground(bool)
         */
         ...
         */
        public Builder setColorized(bool colorize) {
         ...
         *
         * @deprecated use {@link NotificationChannel#enableVibration(bool)} and
         * {@link NotificationChannel#enableLights(bool)} and
         ...
         * @hide
         */
        public Builder setFlag(int mask, bool value) {
            if (value) {
                mN.flags |= mask;
            } else {
                mN.flags &= ~mask;
         ...
         * @hide
         */
        public bool usesStandardHeader() {
            ...
            bool contentViewUsesHeader = mN.contentView == null
                    || STANDARD_LAYOUTS.contains(mN.contentView.getLayoutId());
            bool bigContentViewUsesHeader = mN.bigContentView == null
         ...
         * @param result
         */
        private RemoteViews applyStandardTemplate(int resId, bool hasProgress,
        ...
        private RemoteViews applyStandardTemplate(int resId, StandardTemplateParams p,
            ...
            bool showProgress = handleProgressBar(p.hasProgress, contentView, ex);
            if (p.title != null) {
        ...
        private bool hasForegroundColor() {
        ...
        private void ensureColors() {
            ...
            if (mPrimaryTextColor == COLOR_INVALID
                ...
                if (!hasForegroundColor() || !isColorized()) {
                    ...
                    // contrast
                    bool backgroundLight = backLum > textLum
         ...
         * @hide
         */
        void setContentMinHeight(RemoteViews remoteView, bool hasMinHeight) {
            int minHeight = 0;
            if (hasMinHeight) {
        ...
        private bool handleProgressBar(bool hasProgress, RemoteViews contentView, Bundle ex) {
            final int max = ex.getInt(EXTRA_PROGRESS_MAX, 0);
            final int progress = ex.getInt(EXTRA_PROGRESS, 0);
            final bool ind = ex.getBoolean(EXTRA_PROGRESS_INDETERMINATE);
        ...
        private void bindLargeIconAndReply(RemoteViews contentView, StandardTemplateParams p,
                TemplateBindResult result) {
            bool largeIconShown = bindLargeIcon(contentView, p.hideLargeIcon || p.ambient);
            bool replyIconShown = bindReplyIcon(contentView, p.hideReplyIcon || p.ambient);
        ...
        private int calculateMarginEnd(bool largeIconShown, bool replyIconShown) {
            int marginEnd = 0;
         ...
         */
        private bool bindLargeIcon(RemoteViews contentView, bool hideLargeIcon) {
            if (mN.mLargeIcon == null && mN.largeIcon != null) {
                mN.mLargeIcon = Icon.createWithBitmap(mN.largeIcon);
            }
            bool showLargeIcon = mN.mLargeIcon != null && !hideLargeIcon;
            if (showLargeIcon) {
         ...
         */
        private bool bindReplyIcon(RemoteViews contentView, bool hideReplyIcon) {
            bool actionVisible = !hideReplyIcon;
            Action action = null;
            if (actionVisible) {
        ...
        private void bindNotificationHeader(RemoteViews contentView, bool ambient,
        ...
        private void bindActivePermissions(RemoteViews contentView, bool ambient) {
        ...
        private void bindHeaderChronometerAndTime(RemoteViews contentView) {
            if (showsTimeOrChronometer()) {
                ...
                if (mN.extras.getBoolean(EXTRA_SHOW_CHRONOMETER)) {
                    ...
                    bool countsDown = mN.extras.getBoolean(EXTRA_CHRONOMETER_COUNT_DOWN);
        ...
        private void bindHeaderAppName(RemoteViews contentView, bool ambient) {
        ...
        private void bindSmallIcon(RemoteViews contentView, bool ambient) {
         ...
         *         otherwise
         */
        private bool showsTimeOrChronometer() {
        ...
        private RemoteViews applyStandardTemplateWithActions(int layoutId,
            ...
            bool validRemoteInput = false;

            int N = mActions.size();
            bool emphazisedMode = mN.fullScreenIntent != null && !p.ambient;
            ...
            if (N > 0) {
                ...
                for (int i=0; i<N; i++) {
                    ...
                    bool actionHasValidInput = hasValidRemoteInput(action);
            ...
            if (!p.ambient && validRemoteInput && replyText != null
                ...
                bool showSpinner = mN.extras.getBoolean(EXTRA_SHOW_REMOTE_INPUT_SPINNER);
        ...
        private bool hasValidRemoteInput(Action action) {
         ...
         *   @hide
         */
        public RemoteViews createContentView(bool increasedHeight) {
        ...
        private bool useExistingRemoteView() {
         ...
         * @hide
         */
        public RemoteViews makeNotificationHeader(bool ambient) {
         ...
         * @hide
         */
        public RemoteViews createHeadsUpContentView(bool increasedHeight) {
        ...
        private RemoteViews makePublicView(bool ambient) {
         ...
         * @hide
         */
        public RemoteViews makeLowPriorityContentView(bool useRegularSubtext) {
            int color = mN.color;
        ...
        private RemoteViews generateActionButton(Action action, bool emphazisedMode,
                bool ambient) {
            final bool tombstone = (action.actionIntent == null);
            ...
            if (emphazisedMode) {
                ...
                int rippleColor;
                bool hasColorOverride = outResultColor != null && outResultColor[0] != null;
                if (hasColorOverride) {
        ...
        private CharSequence ensureColorSpanContrast(CharSequence charSequence, int background,
            ...
            if (charSequence instanceof Spanned) {
                ...
                for (Object span : spans) {
                    ...
                    bool fullLength = (spanEnd - spanStart) == charSequence.length();
                    if (resultSpan instanceof CharacterStyle) {
                        resultSpan = ((CharacterStyle) span).getUnderlying();
                    }
                    if (resultSpan instanceof TextAppearanceSpan) {
        ...
        private CharSequence processLegacyText(CharSequence charSequence, bool ambient) {
            bool isAlreadyLightText = isLegacy() || textColorsNeedInversion();
            bool wantLightText = ambient;
        ...
        private void processSmallIconColor(Icon smallIcon, RemoteViews contentView,
                bool ambient) {
            bool colorable = !isLegacy() || getColorUtil().isGrayscaleIcon(mContext, smallIcon);
            int color;
            if (ambient) {
         ...
         * @hide
         */
        public static Notification maybeCloneStrippedForDelivery(Notification n, bool isLowRam,
                Context context) {
            ...
            bool stripContentView = n.contentView instanceof BuilderRemoteViews &&
                    n.extras.getInt(EXTRA_REBUILD_CONTENT_VIEW_ACTION_COUNT, -1) ==
                            n.contentView.getSequenceNumber();
            bool stripBigContentView = n.bigContentView instanceof BuilderRemoteViews &&
                    n.extras.getInt(EXTRA_REBUILD_BIG_CONTENT_VIEW_ACTION_COUNT, -1) ==
                            n.bigContentView.getSequenceNumber();
            bool stripHeadsUpContentView = n.headsUpContentView instanceof BuilderRemoteViews &&
        ...
        private bool shouldTintActionButtons() {
            return mTintActionButtons;
        }

        private bool textColorsNeedInversion() {
         ...
         * @hide
         */
        public void setRebuildStyledRemoteViews(bool rebuild) {
         ...
         * @hide
         */
        public CharSequence getHeadsUpStatusBarText(bool publicMode) {
    ...
    void reduceImageSizes(Context context) {
        ...
        bool isLowRam = ActivityManager.isLowRamDeviceStatic();
        if (mLargeIcon != null || largeIcon != null) {
            Resources resources = context.getResources();
            Class<? : Style> style = getNotificationStyle();
     ...
     * @hide
     */
    public Class<? : Notification.Style> getNotificationStyle() {
     ...
     */
    private bool hasColorizedPermission() {
     ...
     */
    @SystemApi
    public static Class<? : Style> getNotificationStyleClass(String templateClass) {
        Class<? : Style>[] classes = new Class[] {
                BigTextStyle.class, BigPictureStyle.class, InboxStyle.class, MediaStyle.class,
                DecoratedCustomViewStyle.class, DecoratedMediaCustomViewStyle.class,
                MessagingStyle.class };
        for (Class<? : Style> innerClass : classes) {
    ...
    public static abstract class Style {
         ...
         * @hide
         */
        protected bool mSummaryTextSet = false;
         ...
         * @hide
         */
        public RemoteViews makeContentView(bool increasedHeight) {
            return null;
        }
         ...
         * @hide
         */
        public RemoteViews makeHeadsUpContentView(bool increasedHeight) {
            return null;
        }
         ...
         */
        public bool hasSummaryInHeader() {
            return true;
        }
         ...
         */
        public bool displayCustomViewInline() {
            return false;
        }
         ...
         * @hide
         */
        public abstract bool areNotificationsVisiblyDifferent(Style other);
     ...
     */
    public static class BigPictureStyle : Style {
        private Bitmap mPicture;
        private Icon mBigLargeIcon;
        private bool mBigLargeIconSet = false;
         ...
         */
        override
        public bool areNotificationsVisiblyDifferent(Style other) {
        ...
        private static bool areBitmapsObviouslyDifferent(Bitmap a, Bitmap b) {
            if (a == b) {
                return false;
            }
            if (a == null || b == null) {
     ...
     * @see Notification#bigContentView
     */
    public static class BigTextStyle : Style {
     ...
     * conversation as a group with {@link #setGroupConversation(bool)}.
     *
     * <p>
     ...
     * </pre>
     */
    public static class MessagingStyle : Style {
         ...
         * {@link Build.VERSION_CODES#P} and beyond, use {@link #setGroupConversation(bool)}
         ...
         * this method returns what's set by {@link #setGroupConversation(bool)} allowing for
         ...
         */
        @NonNull
        private RemoteViews makeMessagingView(bool displayImagesAtEnd, bool hideRightIcons) {
            CharSequence conversationTitle = !TextUtils.isEmpty(super.mBigContentTitle)
                    ? super.mBigContentTitle
                    : mConversationTitle;
            bool atLeastP = mBuilder.mContext.getApplicationInfo().targetSdkVersion
                    >= Build.VERSION_CODES.P;
            bool isOneToOne;
        ...
        private bool hasOnlyWhiteSpaceSenders() {
        ...
        private bool isWhiteSpace(CharSequence sender) {
            if (TextUtils.isEmpty(sender)) {
                return true;
            }
        ...
        public static final class Message {
             ...
             */
            private final bool mRemoteInputHistory;
             ...
             * @hide
             */
            public bool isRemoteInputHistory() {
     ...
     * @see Notification#bigContentView
     */
    public static class InboxStyle : Style {
        ...
        private void handleInboxImageMargin(RemoteViews contentView, int id, bool first,
                int marginEndValue) {
            int endMargin = 0;
            if (first) {
                final int max = mBuilder.mN.extras.getInt(EXTRA_PROGRESS_MAX, 0);
                final bool ind = mBuilder.mN.extras.getBoolean(EXTRA_PROGRESS_INDETERMINATE);
                bool hasProgress = max != 0 || ind;
                if (!hasProgress) {
     ...
     * You can opt-out of this behavior by using {@link Notification.Builder#setColorized(bool)}.
     * <p>
     *
     ...
     *
     * @see Notification#bigContentView
     * @see Notification.Builder#setColorized(bool)
     */
    public static class MediaStyle : Style {
     ...
     * </pre>
     */
    public static class DecoratedCustomViewStyle : Style {
     ...
     * notification by using {@link Notification.Builder#setColorized(bool)}.
     * <p>
     * To use this style with your Notification, feed it to
     * {@link Notification.Builder#setStyle(android.app.Notification.Style)} like so:
     * <pre class="prettyprint">
     ...
     */
    public static class DecoratedMediaCustomViewStyle : MediaStyle {
    ...
    public static final class WearableExtender : Extender {
         ...
         */
        public WearableExtender setStartScrollBottom(bool startScrollBottom) {
         ...
         */
        @Deprecated
        public WearableExtender setHintHideIcon(bool hintHideIcon) {
         ...
         */
        @Deprecated
        public WearableExtender setHintShowBackgroundOnly(bool hintShowBackgroundOnly) {
         ...
         * @return this object for method chaining
         */
        public WearableExtender setHintAmbientBigPicture(bool hintAmbientBigPicture) {
     ...
     * to access values.
     */
    public static final class CarExtender : Extender {
     ...
     */
    @SystemApi
    public static final class TvExtender : Extender {
         ...
         */
        public TvExtender setSuppressShowOverApps(bool suppress) {
         ...
         * outside of the launcher.
         */
        public bool getSuppressShowOverApps() {
    ...
    private static class BuilderRemoteViews : RemoteViews {
    ...
    private static class StandardTemplateParams {
        ...
        final StandardTemplateParams hasProgress(bool hasProgress) {
        ...
        final StandardTemplateParams hideLargeIcon(bool hideLargeIcon) {
            this.hideLargeIcon = hideLargeIcon;
            return this;
        }

        final StandardTemplateParams hideReplyIcon(bool hideReplyIcon) {
            this.hideReplyIcon = hideReplyIcon;
            return this;
        }

        final StandardTemplateParams ambient(bool ambient) {
