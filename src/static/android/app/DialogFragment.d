 ...
 * the fragment, but can be customized with {@link #setShowsDialog(bool)}.
 *
...
public class DialogFragment : Fragment
    ...
    void dismissInternal(bool allowStateLoss) {
        if (mDismissed) {
            return;
        }
        mDismissed = true;
     ...
     * directly calling {@link Dialog#setCancelable(bool)
     * Dialog.setCancelable(bool)}, because DialogFragment needs to change
    ...
    /**
     * Return the current value of {@link #setCancelable(bool)}.
     */
     ...
     * left undisturbed.
     */
    public void setShowsDialog(bool showsDialog) {
        mShowsDialog = showsDialog;
    }

    /**
     * Return the current value of {@link #setShowsDialog(bool)}.
     */
