...
public class NotificationManager {
    ...
    public void notifyAsUser(String tag, int id, Notification notification, UserHandle user)
    {
        ...
        bool isLowRam = am.isLowRamDevice();
     ...
     */
    public bool removeAutomaticZenRule(String id) {
        INotificationManager service = getService();
        try {
     ...
     * @hide
     */
    public bool removeAutomaticZenRules(String packageName) {
        INotificationManager service = getService();
        try {
    ...
    /** @hide */
    public void setNotificationListenerAccessGranted(ComponentName listener, bool granted) {
        INotificationManager service = getService();
        try {
     ...
     * filtering.
     */
    public static class Policy : android.os.Parcelable {
         ...
         * @hide
         */
        public static bool areAllVisualEffectsSuppressed(int effects) {
            for (int i = 0; i < ALL_SUPPRESSED_EFFECTS.length; i++) {
         ...
         * @hide
         */
        public static bool areAnyScreenOffEffectsSuppressed(int effects) {
         ...
         * @hide
         */
        public static bool areAnyScreenOnEffectsSuppressed(int effects) {
         ...
         * @hide
         */
        public static int toggleScreenOffEffectsSuppressed(int currentEffects, bool suppress) {
         ...
         * @hide
         */
        public static int toggleScreenOnEffectsSuppressed(int currentEffects, bool suppress) {
            return toggleEffects(currentEffects, SCREEN_ON_SUPPRESSED_EFFECTS, suppress);
        }

        private static int toggleEffects(int currentEffects, int[] effects, bool suppress) {
