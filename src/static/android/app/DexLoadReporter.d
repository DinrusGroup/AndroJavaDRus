 ...
 * @hide
 */
/*package*/ class DexLoadReporter : BaseDexClassLoader.Reporter {
    ...
    private void registerSecondaryDexForProfiling(String dexPath, String[] dataDirs) {
        ...
        try {
            bool created = secondaryProfile.createNewFile();
            if (DEBUG && created) {
    ...
    // data directories.
    private bool isSecondaryDexFile(String dexPath, String[] dataDirs) {
