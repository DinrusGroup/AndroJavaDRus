...
public class FragmentController {
    private final FragmentHostCallback!(T) mHost;

    /**
     * Returns a {@link FragmentController}.
     */
    public static final FragmentController createController(FragmentHostCallback!(T) callbacks) {
        return new FragmentController(callbacks);
    }

    private FragmentController(FragmentHostCallback!(T) callbacks) {
        mHost = callbacks;
    }
     ...
     */
    public void doLoaderStop(bool retain) {
