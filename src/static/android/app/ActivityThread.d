...
final class RemoteServiceException : AndroidRuntimeException {
 ...
 * {@hide}
 */
public final class ActivityThread : ClientTransactionHandler {
    /** @hide */
    public static final String TAG = "ActivityThread";
    private static final android.graphics.Bitmap.Config THUMBNAIL_FORMAT = Bitmap.Config.RGB_565;
    static final bool localLOGV = false;
    static final bool DEBUG_MESSAGES = false;
    /** @hide */
    public static final bool DEBUG_BROADCAST = false;
    private static final bool DEBUG_RESULTS = false;
    private static final bool DEBUG_BACKUP = false;
    public static final bool DEBUG_CONFIGURATION = false;
    private static final bool DEBUG_SERVICE = false;
    public static final bool DEBUG_MEMORY_TRIM = false;
    private static final bool DEBUG_PROVIDER = false;
    public static final bool DEBUG_ORDER = false;
    ...
    private static final bool REPORT_TO_ACTIVITY = true;
    ...
    bool mSystemThread = false;
    bool mJitEnabled = false;
    bool mSomeActivitiesChanged = false;
    bool mUpdatingSystemConfig = false;
    /* package */ bool mHiddenApiWarningShown = false;
    ...
    public static final class ActivityClientRecord {
        ...
        bool startsNotResumed;
        public final bool isForward;
        int pendingConfigChanges;

        Window mPendingRemoveWindow;
        WindowManager mPendingRemoveWindowManager;
        bool mPreserveWindow;
        ...
        public ActivityClientRecord(IBinder token, Intent intent, int ident,
                ...
                List<ReferrerIntent> pendingNewIntents, bool isForward,
        ...
        public bool isVisibleFromServer() {
    ...
    static final class ReceiverData : BroadcastReceiver.PendingResult {
        public ReceiverData(Intent intent, int resultCode, String resultData, Bundle resultExtras,
                bool ordered, bool sticky, IBinder token, int sendingUser) {
    ...
    static final class AppBindData {
        ...
        int debugMode;
        bool enableBinderTracking;
        bool trackAllocation;
        bool restrictedBackupMode;
        bool persistent;
        ...
        bool autofillCompatibilityEnabled;
    ...
    static final class Profiler {
        ...
        bool autoStopProfiler;
        bool streamingOutput;
        bool profiling;
        bool handlingProfiling;
    ...
    private class ApplicationThread : IApplicationThread.Stub {
        ...
        public final void scheduleSleeping(IBinder token, bool sleeping) {
            sendMessage(H.SLEEPING, token, sleeping ? 1 : 0);
        }

        public final void scheduleReceiver(Intent intent, ActivityInfo info,
                CompatibilityInfo compatInfo, int resultCode, String data, Bundle extras,
                bool sync, int sendingUser, int processState) {
        ...
        public final void bindApplication(String processName, ApplicationInfo appInfo,
                ...
                bool enableBinderTracking, bool trackAllocation,
                bool isRestrictedBackupMode, bool persistent, Configuration config,
                CompatibilityInfo compatInfo, Map services, Bundle coreSettings,
                String buildSerial, bool autofillCompatibilityEnabled) {
        ...
        public void scheduleRegisteredReceiver(IIntentReceiver receiver, Intent intent,
                int resultCode, String dataStr, Bundle extras, bool ordered,
                bool sticky, int sendingUser, int processState) throws RemoteException {
            updateProcessState(processState, false);
        ...
        override
        public void profilerControl(bool start, ProfilerInfo profilerInfo, int profileType) {
            sendMessage(H.PROFILER_CONTROL, profilerInfo, start ? 1 : 0, profileType);
        }

        override
        public void dumpHeap(bool managed, bool mallocInfo, bool runGc, String path,
                ParcelFileDescriptor fd) {
        ...
        override
        public void dumpMemInfo(ParcelFileDescriptor pfd, Debug.MemoryInfo mem, bool checkin,
                bool dumpFullInfo, bool dumpDalvik, bool dumpSummaryOnly,
                bool dumpUnreachable, String[] args) {
        ...
        private void dumpMemInfo(PrintWriter pw, Debug.MemoryInfo memInfo, bool checkin,
                bool dumpFullInfo, bool dumpDalvik, bool dumpSummaryOnly, bool dumpUnreachable) {
            ...
            if (dumpUnreachable) {
                bool showContents = ((mBoundApplication != null)
        ...
        private void dumpMemInfo(ProtoOutputStream proto, Debug.MemoryInfo memInfo,
                bool dumpFullInfo, bool dumpDalvik,
                bool dumpSummaryOnly, bool dumpUnreachable) {
            long nativeMax = Debug.getNativeHeapSize() / 1024;
            long nativeAllocated = Debug.getNativeHeapAllocatedSize() / 1024;
            long nativeFree = Debug.getNativeHeapFreeSize() / 1024;
            ...
            if (dumpUnreachable) {
                ...
                bool showContents = (flags & ApplicationInfo.FLAG_DEBUGGABLE) != 0
                        || android.os.Build.IS_DEBUGGABLE;
        ...
        public void scheduleTranslucentConversionComplete(IBinder token, bool drawComplete) {
        ...
        public void updateProcessState(int processState, bool fromIpc) {
            synchronized (this) {
    ...
    private class Idler : MessageQueue.IdleHandler {
        override
        public final bool queueIdle() {
    ...
    final class GcIdler : MessageQueue.IdleHandler {
        override
        public final bool queueIdle() {
            doGcIfNeeded();
            return false;
    ...
    public final LoadedApk getPackageInfo(String packageName, CompatibilityInfo compatInfo,
        ...
        final bool differentUser = (UserHandle.myUserId() != userId);
        synchronized (mResourcesManager) {
    ...
    public final LoadedApk getPackageInfo(ApplicationInfo ai, CompatibilityInfo compatInfo,
            int flags) {
        bool includeCode = (flags&Context.CONTEXT_INCLUDE_CODE) != 0;
        bool securityViolation = includeCode && ai.uid != 0
                && ai.uid != Process.SYSTEM_UID && (mBoundApplication != null
                        ? !UserHandle.isSameApp(ai.uid, mBoundApplication.appInfo.uid)
                        : true);
        bool registerPackage = includeCode && (flags&Context.CONTEXT_REGISTER_PACKAGE) != 0;
    ...
    public final LoadedApk peekPackageInfo(String packageName, bool includeCode) {
        synchronized (mResourcesManager) {
            WeakReference<LoadedApk> ref;
            if (includeCode) {
                ref = mPackages.get(packageName);
    ...
    private LoadedApk getPackageInfo(ApplicationInfo aInfo, CompatibilityInfo compatInfo,
            ClassLoader baseLoader, bool securityViolation, bool includeCode,
            bool registerPackage) {
        final bool differentUser = (UserHandle.myUserId() != UserHandle.getUserId(aInfo.uid));
        synchronized (mResourcesManager) {
            WeakReference<LoadedApk> ref;
            if (differentUser) {
                // Caching not supported across users
    ...
    public static void dumpMemInfoTable(PrintWriter pw, Debug.MemoryInfo memInfo, bool checkin,
            bool dumpFullInfo, bool dumpDalvik, bool dumpSummaryOnly,
    ...
    private static void dumpMemoryInfo(ProtoOutputStream proto, long fieldId, String name,
            ...
            bool hasSwappedOutPss, int dirtySwap, int dirtySwapPss) {
    ...
    public static void dumpMemInfoTable(ProtoOutputStream proto, Debug.MemoryInfo memInfo,
            bool dumpDalvik, bool dumpSummaryOnly,
            long nativeMax, long nativeAllocated, long nativeFree,
            long dalvikMax, long dalvikAllocated, long dalvikFree) {
    ...
    private void sendMessage(int what, Object obj, int arg1, int arg2, bool async) {
    ...
    void performNewIntents(IBinder token, List<ReferrerIntent> intents, bool andPause) {
        final ActivityClientRecord r = mActivities.get(token);
        if (r == null) {
            return;
        }

        final bool resumed = !r.paused;
        if (resumed) {
    ...
    override
    public void handleNewIntent(IBinder token, List<ReferrerIntent> intents, bool andPause) {
    ...
    public void handleRequestAssistContextExtras(RequestAssistContextExtras cmd) {
        ...
        bool forAutofill = cmd.requestType == ActivityManager.ASSIST_CONTEXT_AUTOFILL;
    ...
    public void handleTranslucentConversionComplete(IBinder token, bool drawComplete) {
    ...
    override
    public void handleMultiWindowModeChanged(IBinder token, bool isInMultiWindowMode,
            Configuration overrideConfig) {
        final ActivityClientRecord r = mActivities.get(token);
        if (r != null) {
    ...
    override
    public void handlePictureInPictureModeChanged(IBinder token, bool isInPipMode,
            Configuration overrideConfig) {
        final ActivityClientRecord r = mActivities.get(token);
        if (r != null) {
            final Configuration newConfig = new Configuration(mConfiguration);
    ...
    private static bool attemptAttachAgent(String agent, ClassLoader classLoader) {
        try {
     ...
     */
    @VisibleForTesting
    public ActivityClientRecord performResumeActivity(IBinder token, bool finalStateRequest,
            String reason) {
        final ActivityClientRecord r = mActivities.get(token);
        if (localLOGV) {
    ...
    static final void cleanUpPendingRemoveWindows(ActivityClientRecord r, bool force) {
    ...
    override
    public void handleResumeActivity(IBinder token, bool finalStateRequest, bool isForward,
            String reason) {
        // If we are getting ready to gc after going to the background, well
        // we are back active so skip it.
        unscheduleGcIdler();
        ...
        bool willBeVisible = !a.mStartedActivity;
        if (!willBeVisible) {
            try {
    ...
    override
    public void handlePauseActivity(IBinder token, bool finished, bool userLeaving,
    ...
    final Bundle performPauseActivity(IBinder token, bool finished, String reason,
            PendingTransactionActions pendingActions) {
        ActivityClientRecord r = mActivities.get(token);
     ...
     */
    private Bundle performPauseActivity(ActivityClientRecord r, bool finished, String reason,
            PendingTransactionActions pendingActions) {
        if (r.paused) {
            if (r.activity.mFinished) {
        ...
        final bool shouldSaveState = !r.activity.mFinished && r.isPreHoneycomb();
        if (shouldSaveState) {
    ...
    final void performStopActivity(IBinder token, bool saveState, String reason) {
        ActivityClientRecord r = mActivities.get(token);
     ...
     */
    private void performStopActivityInner(ActivityClientRecord r, StopInfo info, bool keepShown,
            bool saveState, bool finalStateRequest, String reason) {
     ...
     */
    private void callActivityOnStop(ActivityClientRecord r, bool saveState, String reason) {
        // Before P onSaveInstanceState was called before onStop, starting with P it's
        // called after. Before Honeycomb state was always saved before onPause.
        final bool shouldSaveState = saveState && !r.activity.mFinished && r.state == null
                && !r.isPreHoneycomb();
        final bool isPreP = r.isPreP();
    ...
    private void updateVisibility(ActivityClientRecord r, bool show) {
    ...
    override
    public void handleStopActivity(IBinder token, bool show, int configChanges,
            PendingTransactionActions pendingActions, bool finalStateRequest, String reason) {
        final ActivityClientRecord r = mActivities.get(token);
        r.activity.mConfigChangeFlags |= configChanges;
    ...
    override
    public void performRestartActivity(IBinder token, bool start) {
        ActivityClientRecord r = mActivities.get(token);
        if (r.stopped) {
    ...
    override
    public void handleWindowVisibility(IBinder token, bool show) {
        ActivityClientRecord r = mActivities.get(token);
    ...
    private void handleSleeping(IBinder token, bool sleeping) {
        ActivityClientRecord r = mActivities.get(token);
    ...
    ActivityClientRecord performDestroyActivity(IBinder token, bool finishing,
            int configChanges, bool getNonConfigInstance, String reason) {
        ActivityClientRecord r = mActivities.get(token);
    ...
    override
    public void handleDestroyActivity(IBinder token, bool finishing, int configChanges,
            bool getNonConfigInstance, String reason) {
    ...
    public ActivityClientRecord prepareRelaunchActivity(IBinder token,
            ...
            int configChanges, MergedConfiguration config, bool preserveWindow) {
        ActivityClientRecord target = null;
        bool scheduleRelaunch = false;
    ...
    private void handleRelaunchActivityInner(ActivityClientRecord r, int configChanges,
            ...
            PendingTransactionActions pendingActions, bool startsNotResumed,
    ...
    ArrayList<ComponentCallbacks2> collectComponentCallbacks(
            bool allActivities, Configuration newConfig) {
    ...
    private Configuration performConfigurationChangedForActivity(ActivityClientRecord r,
            Configuration newBaseConfig, int displayId, bool movedToDifferentDisplay) {
    ...
    private void handleConfigurationChanged(Configuration config, CompatibilityInfo compat) {
        ...
        final bool equivalent = config != null && mConfiguration != null
    ...
    static void freeTextLayoutCachesIfNeeded(int configDiff) {
        if (configDiff != 0) {
            ...
            bool hasLocaleConfigChange = ((configDiff & ActivityInfo.CONFIG_LOCALE) != 0);
    ...
    public void handleActivityConfigurationChanged(IBinder activityToken,
        ...
        final bool movedToDifferentDisplay = displayId != INVALID_DISPLAY
    ...
    final void handleProfilerControl(bool start, ProfilerInfo profilerInfo, int profileType) {
        if (start) {
            try {
                switch (profileType) {
                    default:
    ...
    final void handleDispatchPackageBroadcast(int cmd, String[] packages) {
        ...
        switch (cmd) {
            ...
            {
                final bool killApp = cmd == ApplicationThreadConstants.PACKAGE_REMOVED;
                if (packages == null) {
                    break;
                }
                synchronized (mResourcesManager) {
    ...
    private void handleBindApplication(AppBindData data) {
        ...
        bool isAppDebuggable = (data.appInfo.flags & ApplicationInfo.FLAG_DEBUGGABLE) != 0;
    ...
    public final IContentProvider acquireProvider(
            Context c, String auth, int userId, bool stable) {
    ...
    private final void incProviderRefLocked(ProviderRefCount prc, bool stable) {
        if (stable) {
            prc.stableCount += 1;
    ...
    public final bool releaseProvider(IContentProvider provider, bool stable) {
        if (provider == null) {
            return false;
        }
    ...
    final void handleUnstableProviderDied(IBinder provider, bool fromClient) {
        synchronized (mProviderMap) {
            handleUnstableProviderDiedLocked(provider, fromClient);
        }
    }

    final void handleUnstableProviderDiedLocked(IBinder provider, bool fromClient) {
    ...
    private ContentProviderHolder installProvider(Context context,
            ...
            bool noisy, bool noReleaseNeeded, bool stable) {
    ...
    private void attach(bool system, long startSeq) {
    ...
    private static class EventLoggingReporter : EventLogger.Reporter {
        override
    ...
    private class DropBoxReporter : DropBox.Reporter {
