 ...
 * @hide
 */
public class LaunchActivityItem : ClientTransactionItem {
    ...
    public static LaunchActivityItem obtain(Intent intent, int ident, ActivityInfo info,
            ...
            List<ReferrerIntent> pendingNewIntents, bool isForward, ProfilerInfo profilerInfo) {
    ...
    public bool equals(Object o) {
        ...
        final bool intentsEqual = (mIntent == null && other.mIntent == null)
    ...
    private bool activityInfoEqual(ActivityInfo other) {
        if (mInfo == null) {
            return other == null;
        }
    ...
    private static bool areBundlesEqual(BaseBundle extras, BaseBundle newExtras) {
    ...
    private static void setValues(LaunchActivityItem instance, Intent intent, int ident,
            ...
            bool isForward, ProfilerInfo profilerInfo) {
