...
class ObjectPool {
    ...
    private static final Map<Class, ArrayList<? : ObjectPoolItem>> sPoolMap =
            new HashMap<>();
     ...
     */
    public static <T : ObjectPoolItem> T obtain(Class<T> itemClass) {
     ...
     */
    public static <T : ObjectPoolItem> void recycle(T item) {
        synchronized (sPoolSync) {
            @SuppressWarnings("unchecked")
