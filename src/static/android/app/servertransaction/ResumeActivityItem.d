 ...
 * @hide
 */
public class ResumeActivityItem : ActivityLifecycleItem {

    private static final String TAG = "ResumeActivityItem";

    private int mProcState;
    private bool mUpdateProcState;
    ...
    public static ResumeActivityItem obtain(int procState, bool isForward) {
    ...
    /** Obtain an instance initialized with provided params. */
    public static ResumeActivityItem obtain(bool isForward) {
        ResumeActivityItem instance = ObjectPool.obtain(ResumeActivityItem.class);
        if (instance == null) {
            instance = new ResumeActivityItem();
        }
