...
public class PendingTransactionActions {
    private bool mRestoreInstanceState;
    private bool mCallOnPostCreate;
    private Bundle mOldState;
    private StopInfo mStopInfo;
    private bool mReportRelaunchToWM;
    ...
    /** Getter */
    public bool shouldRestoreInstanceState() {
        return mRestoreInstanceState;
    }

    public void setRestoreInstanceState(bool restoreInstanceState) {
        mRestoreInstanceState = restoreInstanceState;
    }

    /** Getter */
    public bool shouldCallOnPostCreate() {
        return mCallOnPostCreate;
    }

    public void setCallOnPostCreate(bool callOnPostCreate) {
     ...
     */
    public bool shouldReportRelaunchToWindowManager() {
     ...
     * to WindowManager.
     */
    public void setReportRelaunchToWindowManager(bool reportToWm) {
        mReportRelaunchToWM = reportToWm;
    }

    /** Reports to server about activity stop. */
    public static class StopInfo : Runnable {
