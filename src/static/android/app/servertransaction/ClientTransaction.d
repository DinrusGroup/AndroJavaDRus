 ...
 * @hide
 */
public class ClientTransaction : Parcelable, ObjectPoolItem {
    ...
    private ClientTransaction(Parcel in) {
        ...
        final bool readActivityToken = in.readBoolean();
        if (readActivityToken) {
            mActivityToken = in.readStrongBinder();
        }
        mLifecycleStateRequest = in.readParcelable(getClass().getClassLoader());
        final bool readActivityCallbacks = in.readBoolean();
