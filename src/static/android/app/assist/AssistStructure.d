 ...
 */
public class AssistStructure : Parcelable {
    static final String TAG = "AssistStructure";

    static final bool DEBUG_PARCEL = false;
    static final bool DEBUG_PARCEL_CHILDREN = false;
    static final bool DEBUG_PARCEL_TREE = false;
     ...
     */
    public void setHomeActivity(bool isHomeActivity) {
    ...
    final static class SendChannel : Binder {
        ...
        override protected bool onTransact(int code, Parcel data, Parcel reply, int flags)
    ...
    final static class ParcelTransferWriter : Binder {
        final bool mWriteStructure;
        int mCurWindow;
        int mNumWindows;
        ...
        void writeToParcel(AssistStructure as, Parcel out) {
            ...
            mNumWrittenViews = 0;
            bool more = writeToParcelInner(as, out);
        ...
        bool writeToParcelInner(AssistStructure as, Parcel out) {
            if (mNumWindows == 0) {
                return false;
            }
        ...
        bool writeNextEntryToParcel(AssistStructure as, Parcel out, PooledStringWriter pwriter) {
    ...
    final static class ViewNodeText {
        ...
        ViewNodeText(Parcel in, bool simple) {
        ...
        void writeToParcel(Parcel out, bool simple, bool writeSensitive) {
    ...
    static public class WindowNode {
        ...
        WindowNode(AssistStructure assist, ViewRootImpl root, bool forAutoFill, int flags) {
    ...
    static public class ViewNode {
        ...
        int writeSelfToParcel(Parcel out, PooledStringWriter pwriter, bool sanitizeOnWrite,
                float[] tmpMatrix) {
         ...
         */
        public bool isOpaque() { return (mFlags&ViewNode.FLAGS_OPAQUE) != 0; }
    ...
    static class ViewNodeBuilder : ViewStructure {
        final AssistStructure mAssist;
        final ViewNode mNode;
        final bool mAsync;

        ViewNodeBuilder(AssistStructure assist, ViewNode node, bool async) {
            mAssist = assist;
            mNode = node;
            mAsync = async;
        }
        ...
        override
        public void setAssistBlocked(bool state) {
        ...
        override
        public void setAccessibilityFocused(bool state) {
        ...
        override
        public void setDataIsSensitive(bool sensitive) {
    ...
    private static final class HtmlInfoNode : HtmlInfo : Parcelable {
    ...
    private static final class HtmlInfoNodeBuilder : HtmlInfo.Builder {
        private final String mTag;
    ...
    /** @hide */
    public AssistStructure(Activity activity, bool forAutoFill, int flags) {
        mHaveData = true;
     ...
     * @hide
     */
    public void sanitizeForParceling(bool sanitize) {
        mSanitizeOnWrite = sanitize;
    }

    /** @hide */
    public void dump(bool showSensitive) {
    ...
    void dump(String prefix, ViewNode node, bool showSensitive) {
