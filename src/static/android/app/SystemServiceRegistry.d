...
final class SystemServiceRegistry {
    ...
    private static final HashMap<Class!(T), String> SYSTEM_SERVICE_NAMES =
            new HashMap<Class!(T), String>();
    private static final HashMap<String, ServiceFetcher!(T)> SYSTEM_SERVICE_FETCHERS =
            new HashMap<String, ServiceFetcher!(T)>();
    ...
    public static Object getSystemService(ContextImpl ctx, String name) {
        ServiceFetcher!(T) fetcher = SYSTEM_SERVICE_FETCHERS.get(name);
     ...
     */
    public static String getSystemServiceName(Class!(T) serviceClass) {
     ...
     */
    static abstract class CachedServiceFetcher<T> : ServiceFetcher<T> {
     ...
     */
    static abstract class StaticServiceFetcher<T> : ServiceFetcher<T> {
     ...
     */
    static abstract class StaticApplicationContextServiceFetcher<T> : ServiceFetcher<T> {
        private T mCachedInstance;
