...
final class IntentReceiverLeaked : AndroidRuntimeException {
    public IntentReceiverLeaked(String msg) {
        super(msg);
    }
}

final class ServiceConnectionLeaked : AndroidRuntimeException {
...
public final class LoadedApk {
    ...
    private final bool mSecurityViolation;
    private final bool mIncludeCode;
    private final bool mRegisterPackage;
    ...
    public LoadedApk(ActivityThread activityThread, ApplicationInfo aInfo,
            ...
            bool securityViolation, bool includeCode, bool registerPackage) {
     ...
     */
    private class SplitDependencyLoaderImpl : SplitDependencyLoader<NameNotFoundException> {
    ...
    private void createOrUpdateClassLoaderLocked(List<String> addedPaths) {
        ...
        bool isBundledApp = mApplicationInfo.isSystemApp()
        ...
        final bool treatVendorApkAsUnbundled = !defaultSearchPaths.contains("/vendor/lib");
        ...
        bool needToSetupJitProfiles = false;
        if (mClassLoader == null) {
    ...
    private void initializeJavaContextClassLoader() {
         ...
         */
        bool sharedUserIdSet = (pi.sharedUserId != null);
        bool processNameNotDefault =
            (pi.applicationInfo != null &&
             !mPackageName.equals(pi.applicationInfo.processName));
        bool sharable = (sharedUserIdSet || processNameNotDefault);
    ...
    private static class WarningContextClassLoader : ClassLoader {
        ...
        override public Class!(T) loadClass(String className) throws ClassNotFoundException {
            warn("loadClass");
            return getParent().loadClass(className);
        }

        override public void setClassAssertionStatus(String cname, bool enable) {
            warn("setClassAssertionStatus");
            getParent().setClassAssertionStatus(cname, enable);
        }

        override public void setPackageAssertionStatus(String pname, bool enable) {
            warn("setPackageAssertionStatus");
            getParent().setPackageAssertionStatus(pname, enable);
        }

        override public void setDefaultAssertionStatus(bool enable) {
    ...
    public Application makeApplication(bool forceDefaultAppClass,
    ...
    public void removeContextRegistrations(Context context,
        ...
        final bool reportRegistrationLeaks = StrictMode.vmRegistrationLeaksEnabled();
    ...
    public IIntentReceiver getReceiverDispatcher(BroadcastReceiver r,
            ...
            Instrumentation instrumentation, bool registered) {
        synchronized (mReceivers) {
    ...
    static final class ReceiverDispatcher {
        ...
        final static class InnerReceiver : IIntentReceiver.Stub {
            final WeakReference<LoadedApk.ReceiverDispatcher> mDispatcher;
            final LoadedApk.ReceiverDispatcher mStrongRef;

            InnerReceiver(LoadedApk.ReceiverDispatcher rd, bool strong) {
        ...
        final bool mRegistered;
        final IntentReceiverLeaked mLocation;
        RuntimeException mUnregisterLocation;
        bool mForgotten;

        final class Args : BroadcastReceiver.PendingResult {
            private Intent mCurIntent;
            private final bool mOrdered;
            ...
            public Args(Intent intent, int resultCode, String resultData, Bundle resultExtras,
                    bool ordered, bool sticky, int sendingUser) {
    ...
    static final class ServiceDispatcher {
        ...
        private static class InnerConnection : IServiceConnection.Stub {
            ...
            public void connected(ComponentName name, IBinder service, bool dead)
        ...
        public void doConnected(ComponentName name, IBinder service, bool dead) {
        ...
        private final class RunConnection : Runnable {
            RunConnection(ComponentName name, IBinder service, int command, bool dead) {
                mName = name;
                mService = service;
                mCommand = command;
                mDead = dead;
        ...
        private final class DeathMonitor : IBinder.DeathRecipient
        {
