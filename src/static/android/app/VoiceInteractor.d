...
public final class VoiceInteractor {
    ...
    final IVoiceInteractorCallback.Stub mCallback = new IVoiceInteractorCallback.Stub() {
        override
        public void deliverConfirmationResult(IVoiceInteractorRequest request, bool finished,
                Bundle result) {
        ...
        public void deliverPickOptionResult(IVoiceInteractorRequest request,
                bool finished, PickOptionRequest.Option[] options, Bundle result) {
        ...
        override
        public void deliverCommandResult(IVoiceInteractorRequest request, bool complete,
                Bundle result) {
            mHandlerCaller.sendMessage(mHandlerCaller.obtainMessageIOO(
     ...
     * either {@link #onConfirmationResult(bool, android.os.Bundle)} or
     ...
     */
    public static class ConfirmationRequest : Request {
         ...
         */
        public void onConfirmationResult(bool confirmed, Bundle result) {
        }
     ...
     */
    public static class PickOptionRequest : Request {
        final Prompt mPrompt;
         ...
         */
        public static final class Option : Parcelable {
     ...
     * interaction task.
     */
    public static class CompleteVoiceRequest : Request {
        final Prompt mPrompt;
        final Bundle mExtras;
     ...
     * interaction task.
     */
    public static class AbortVoiceRequest : Request {
        final Prompt mPrompt;
        final Bundle mExtras;
     ...
     * The result of the confirmation will be returned through an asynchronous call to
     * either {@link #onCommandResult(bool, android.os.Bundle)} or
     * {@link #onCancel()}.
     *
     ...
     */
    public static class CommandRequest : Request {
         ...
         */
        public void onCommandResult(bool isCompleted, Bundle result) {
        }
     ...
     * "Purchase item".
     */
    public static class Prompt : Parcelable {
    ...
    Request pullRequest(IVoiceInteractorRequest request, bool complete) {
     ...
     */
    public bool submitRequest(Request request, String name) {
        try {
     ...
     * @return Array of bools indicating whether each command is supported or not.
     */
    public bool[] supportsCommands(String[] commands) {
        try {
            bool[] res = mInteractor.supportsCommands(mContext.getOpPackageName(), commands);
