 ...
 * @hide
 */
public final class RulesState : Parcelable {
    ...
    private final bool mOperationInProgress;
     ...
     */
    public bool isDistroFormatVersionSupported(DistroFormatVersion distroFormatVersion) {
     ...
     * in the system image.
     */
    public bool isSystemVersionNewerThan(DistroRulesVersion distroRulesVersion) {
    ...
    private static RulesState createFromParcel(Parcel in) {
        ...
        bool operationInProgress = in.readByte() == BYTE_TRUE;
    ...
    public void writeToParcel(Parcel out, int flags) {
        ...
        out.writeByte(cast(byte) mStagedOperationType);
        out.writeParcelable(mStagedDistroRulesVersion, 0);
        out.writeByte(cast(byte) mDistroStatus);
