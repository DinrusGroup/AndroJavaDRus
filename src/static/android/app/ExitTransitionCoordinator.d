...
class ExitTransitionCoordinator : ActivityTransitionCoordinator {
    ...
    private bool mExitNotified;
    private bool mSharedElementNotified;
    private Activity mActivity;
    private bool mIsBackgroundReady;
    private bool mIsCanceled;
    private Handler mHandler;
    private ObjectAnimator mBackgroundAnimator;
    private bool mIsHidden;
    private Bundle mExitSharedElementBundle;
    private bool mIsExitStarted;
    private bool mSharedElementsHidden;
    ...
    public ExitTransitionCoordinator(Activity activity, Window window,
            ...
            ArrayList<String> accepted, ArrayList<View> mapped, bool isReturning) {
    ...
    public void startExit(int resultCode, Intent data) {
        if (!mIsExitStarted) {
            ...
            final bool targetsM = decorView == null || decorView.getContext()
    ...
    protected bool isReadyToNotify() {
