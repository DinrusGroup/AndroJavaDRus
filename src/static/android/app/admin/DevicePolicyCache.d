...
public abstract class DevicePolicyCache {
     ...
     */
    public abstract bool getScreenCaptureDisabled(@UserIdInt int userHandle);

    /**
     * Empty implementation.
     */
    private static class EmptyDevicePolicyCache : DevicePolicyCache {
        private static final EmptyDevicePolicyCache INSTANCE = new EmptyDevicePolicyCache();

        override
        public bool getScreenCaptureDisabled(int userHandle) {
            return false;
        }
    }
}
