...
public class DevicePolicyManager {
    ...
    private final bool mParentInstance;
    ...
    /**
     * A bool extra indicating whether the wifi network in {@link #EXTRA_PROVISIONING_WIFI_SSID}
     * is hidden or not.
     *
     * <p>Use in an NFC record with {@link #MIME_TYPE_PROVISIONING_NFC} that starts device owner
     * provisioning via an NFC bump.
    ...
    /**
     * A bool extra indicating whether device encryption can be skipped as part of device owner
    ...
    /**
     * A bool extra indicating if user setup should be skipped, for when provisioning is started
     * during setup-wizard.
     *
    ...
    /**
     * A bool extra indicating if the user consent steps from the provisioning flow should be
    ...
    /**
     * A bool extra indicating if mobile data should be used during NFC device owner provisioning
     ...
     * @see #setCameraDisabled(ComponentName, bool)
     */
     ...
     * {@link #createAdminSupportIntent(String)}.
     * @see #setScreenCaptureDisabled(ComponentName, bool)
     */
     ...
     * {@link #setKeyguardDisabled(ComponentName, bool)}, setting this flag will have no effect.
     ...
     *         otherwise
     */
    public bool isAdminActive(@NonNull ComponentName admin) {
     ...
     * @hide
     */
    public bool isAdminActiveAsUser(@NonNull ComponentName admin, int userId) {
        if (mService != null) {
            try {
     ...
     * @hide
     */
    public bool isRemovingAdmin(@NonNull ComponentName admin, int userId) {
        if (mService != null) {
            try {
    ...
    public bool packageHasActiveAdmins(String packageName) {
     ...
     * @hide
     */
    public bool packageHasActiveAdmins(String packageName, int userId) {
        if (mService != null) {
            try {
     ...
     */
    public bool hasGrantedPolicy(@NonNull ComponentName admin, int usesPolicy) {
     ...
     */
    public bool isUsingUnifiedPassword(@NonNull ComponentName admin) {
     ...
     */
    public bool resetPassword(String password, int flags) {
     ...
     */
    public bool resetPasswordWithToken(@NonNull ComponentName admin, String password,
     ...
     */
    public int setStorageEncryption(@NonNull ComponentName admin, bool encrypt) {
     ...
     */
    public bool getStorageEncryption(@Nullable ComponentName admin) {
     ...
     * @hide
     */
    public bool approveCaCert(String alias, int userHandle, bool approval) {
        if (mService != null) {
            try {
     ...
     * @hide
     */
    public bool isCaCertApproved(String alias, int userHandle) {
        if (mService != null) {
            try {
     ...
     */
    public bool installCaCert(@Nullable ComponentName admin, byte[] certBuffer) {
     ...
     *         owner.
     */
    public bool hasCaCertInstalled(@Nullable ComponentName admin, byte[] certBuffer) {
     ...
     * {@link #installKeyPair(ComponentName, PrivateKey, Certificate[], String, bool)} instead.
     *
     * @param admin Which {@link DeviceAdminReceiver} this request is associated with, or
     *            {@code null} if calling from a delegated certificate installer.
     ...
     * @see #DELEGATION_CERT_INSTALL
     */
    public bool installKeyPair(@Nullable ComponentName admin, @NonNull PrivateKey privKey,
     ...
     */
    public bool installKeyPair(@Nullable ComponentName admin, @NonNull PrivateKey privKey,
            @NonNull Certificate[] certs, @NonNull String alias, bool requestAccess) {
    ...
    public bool installKeyPair(@Nullable ComponentName admin, @NonNull PrivateKey privKey,
        ...
        bool requestAccess = (flags & INSTALLKEY_REQUEST_CREDENTIALS_ACCESS)
                == INSTALLKEY_REQUEST_CREDENTIALS_ACCESS;
        bool isUserSelectable = (flags & INSTALLKEY_SET_USER_SELECTABLE)
     ...
     * @see #DELEGATION_CERT_INSTALL
     */
    public bool removeKeyPair(@Nullable ComponentName admin, @NonNull String alias) {
    ...
    public AttestedKeyPair generateKeyPair(@Nullable ComponentName admin,
        ...
        try {
            ...
            final bool success = mService.generateKeyPair(
     ...
     */
    public bool setKeyPairCertificate(@Nullable ComponentName admin,
            @NonNull String alias, @NonNull List<Certificate> certs, bool isUserSelectable) {
     ...
     */
    public void setCameraDisabled(@NonNull ComponentName admin, bool disabled) {
     ...
     */
    public bool getCameraDisabled(@Nullable ComponentName admin) {
        throwIfParentInstance("getCameraDisabled");
        return getCameraDisabled(admin, myUserId());
    }

    /** @hide per-user version */
    public bool getCameraDisabled(@Nullable ComponentName admin, int userHandle) {
        if (mService != null) {
            try {
     ...
     */
    public bool requestBugreport(@NonNull ComponentName admin) {
     ...
     * @hide
     */
    public bool getGuestUserDisabled(@Nullable ComponentName admin) {
     ...
     * @throws SecurityException if {@code admin} is not a device or profile owner.
     */
    public void setScreenCaptureDisabled(@NonNull ComponentName admin, bool disabled) {
     ...
     */
    public bool getScreenCaptureDisabled(@Nullable ComponentName admin) {
        throwIfParentInstance("getScreenCaptureDisabled");
        return getScreenCaptureDisabled(admin, myUserId());
    }

    /** @hide per-user version */
    public bool getScreenCaptureDisabled(@Nullable ComponentName admin, int userHandle) {
        if (mService != null) {
            try {
     ...
     */
    public void setAutoTimeRequired(@NonNull ComponentName admin, bool required) {
    ...
    public void setForceEphemeralUsers(
            @NonNull ComponentName admin, bool forceEphemeralUsers) {
     ...
     * @hide
     */
    public bool getForceEphemeralUsers(@NonNull ComponentName admin) {
     ...
     * @hide
     */
    public void setActiveAdmin(@NonNull ComponentName policyReceiver, bool refreshing,
            int userHandle) {
        if (mService != null) {
            try {
     ...
     */
    public bool setDeviceOwner(ComponentName who) {
     ...
     * @hide
     */
    public bool setDeviceOwner(ComponentName who, int userId)  {
     ...
     * @hide
     */
    public bool setDeviceOwner(ComponentName who, String ownerName) {
     ...
     * @throws IllegalStateException If the preconditions mentioned are not met.
     */
    public bool setDeviceOwner(ComponentName who, String ownerName, int userId)
     ...
     */
    public bool isDeviceOwnerApp(String packageName) {
     ...
     * @hide
     */
    public bool isDeviceOwnerAppOnCallingUser(String packageName) {
     ...
     * @hide
     */
    public bool isDeviceOwnerAppOnAnyUser(String packageName) {
    ...
    private bool isDeviceOwnerAppOnAnyUserInner(String packageName, bool callingUserOnly) {
        if (packageName == null) {
            return false;
        }
    ...
    private ComponentName getDeviceOwnerComponentInner(bool callingUserOnly) {
        if (mService != null) {
            try {
    ...
    public bool setActiveProfileOwner(@NonNull ComponentName admin, @Deprecated String ownerName)
     ...
     */
    public bool setProfileOwner(@NonNull ComponentName admin, @Deprecated String ownerName,
    ...
    public @NonNull String[] setPackagesSuspended(@NonNull ComponentName admin,
            @NonNull String[] packageNames, bool suspended) {
     ...
     * @see #DELEGATION_PACKAGE_ACCESS
     */
    public bool isPackageSuspended(@NonNull ComponentName admin, String packageName)
     ...
     */
    public bool isProfileOwnerApp(String packageName) {
     ...
     * @throws SecurityException if {@code admin} is not a profile owner.
     */
    public void setCrossProfileCallerIdDisabled(@NonNull ComponentName admin, bool disabled) {
     ...
     * @throws SecurityException if {@code admin} is not a profile owner.
     */
    public bool getCrossProfileCallerIdDisabled(@NonNull ComponentName admin) {
     ...
     * @hide
     */
    public bool getCrossProfileCallerIdDisabled(UserHandle userHandle) {
        if (mService != null) {
            try {
     ...
     * @throws SecurityException if {@code admin} is not a profile owner.
     */
    public bool getCrossProfileContactsSearchDisabled(@NonNull ComponentName admin) {
     ...
     * @hide
     */
    public bool getCrossProfileContactsSearchDisabled(@NonNull UserHandle userHandle) {
        if (mService != null) {
            try {
                return mService
    ...
    public void startManagedQuickContact(String actualLookupKey, long actualContactId,
            bool isContactIdIgnored, long directoryId, Intent originalIntent) {
        if (mService != null) {
            try {
     ...
     * @throws SecurityException if {@code admin} is not a profile owner.
     */
    public void setBluetoothContactSharingDisabled(@NonNull ComponentName admin, bool disabled) {
     ...
     * @throws SecurityException if {@code admin} is not a profile owner.
     */
    public bool getBluetoothContactSharingDisabled(@NonNull ComponentName admin) {
     ...
     * @hide
     */
    public bool getBluetoothContactSharingDisabled(UserHandle userHandle) {
        if (mService != null) {
            try {
     ...
     * @throws SecurityException if {@code admin} is not a device or profile owner.
     */
    public bool setPermittedAccessibilityServices(@NonNull ComponentName admin,
     ...
     * @hide
     */
    public bool isAccessibilityServicePermittedByAdmin(@NonNull ComponentName admin,
     ...
     * @throws SecurityException if {@code admin} is not a device or profile owner.
     */
    public bool setPermittedInputMethods(
     ...
     * @hide
     */
    public bool isInputMethodPermittedByAdmin(@NonNull ComponentName admin,
            @NonNull String packageName, int userHandle) {
        if (mService != null) {
            try {
     ...
     * {@link #setApplicationHidden(ComponentName, String, bool)})
     *
     * @param admin Which {@link DeviceAdminReceiver} this request is associated with.
     ...
     * @hide
     */
    public bool isNotificationListenerServicePermitted(
     ...
     * @throws SecurityException if {@code admin} is not a device owner.
     */
    public bool removeUser(@NonNull ComponentName admin, @NonNull UserHandle userHandle) {
     ...
     */
    public bool switchUser(@NonNull ComponentName admin, @Nullable UserHandle userHandle) {
     ...
     */
    public bool isEphemeralUser(@NonNull ComponentName admin) {
     ...
     *            unhidden.
     * @return bool Whether the hidden setting of the package was successfully updated.
     * @throws SecurityException if {@code admin} is not a device or profile owner.
     * @see #setDelegatedScopes
     * @see #DELEGATION_PACKAGE_ACCESS
     */
    public bool setApplicationHidden(@NonNull ComponentName admin, String packageName,
            bool hidden) {
     ...
     * @return bool {@code true} if the package is hidden, {@code false} otherwise.
     * @throws SecurityException if {@code admin} is not a device or profile owner.
     * @see #setDelegatedScopes
     * @see #DELEGATION_PACKAGE_ACCESS
     */
    public bool isApplicationHidden(@NonNull ComponentName admin, String packageName) {
     ...
     * @see #DELEGATION_PACKAGE_ACCESS
     */
    public bool installExistingPackage(@NonNull ComponentName admin, String packageName) {
     ...
     * @param disabled The bool indicating that account management will be disabled (true) or
     *            enabled (false).
     * @throws SecurityException if {@code admin} is not a device or profile owner.
     */
     ...
     * {@link android.net.wifi.WifiManager#setWifiEnabled(bool)} instead.</li>
     * </ul>
     *
     * @param admin Which {@link DeviceAdminReceiver} this request is associated with.
     ...
     * @throws SecurityException if {@code admin} is not a device owner.
     */
    public bool setTime(@NonNull ComponentName admin, long millis) {
     ...
     * @throws SecurityException if {@code admin} is not a device owner.
     */
    public bool setTimeZone(@NonNull ComponentName admin, String timeZone) {
     ...
     *
     * @param admin Which {@link DeviceAdminReceiver} this request is associated with.
     * @param provider The component name of the service that :
     ...
     * @throws SecurityException if {@code admin} is not a device or profile owner.
     */
    public void setMasterVolumeMuted(@NonNull ComponentName admin, bool on) {
     ...
     * @throws SecurityException if {@code admin} is not a device or profile owner.
     */
    public bool isMasterVolumeMuted(@NonNull ComponentName admin) {
     ...
     * @throws SecurityException if {@code admin} is not a device or profile owner.
     */
    public bool isUninstallBlocked(@Nullable ComponentName admin, String packageName) {
     ...
     */
    public bool addCrossProfileWidgetProvider(@NonNull ComponentName admin, String packageName) {
     ...
     * @see #getCrossProfileWidgetProviders(android.content.ComponentName)
     */
    public bool removeCrossProfileWidgetProvider(
     ...
     */
    public bool setKeyguardDisabled(@NonNull ComponentName admin, bool disabled) {
     ...
     * @see #getSecondaryUsers
     */
    public bool setStatusBarDisabled(@NonNull ComponentName admin, bool disabled) {
     ...
     * {@link #notifyPendingSystemUpdate(long, bool)}.
     *
     ...
     *         update is available.
     * @see #notifyPendingSystemUpdate(long, bool)
     * @hide
     */
    @SystemApi
    ...
    @SystemApi
    @RequiresPermission(android.Manifest.permission.NOTIFY_PENDING_SYSTEM_UPDATE)
    public void notifyPendingSystemUpdate(long updateReceivedTime, bool isSecurityPatch) {
        throwIfParentInstance("notifyPendingSystemUpdate");
        if (mService != null) {
            try {
                mService.notifyPendingSystemUpdate(SystemUpdateInfo.of(updateReceivedTime,
     ...
     * @see #DELEGATION_PERMISSION_GRANT
     */
    public bool setPermissionGrantState(@NonNull ComponentName admin, String packageName,
     ...
     */
    public bool isProvisioningAllowed(@NonNull String action) {
     ...
     */
    public bool isManagedProfile(@NonNull ComponentName admin) {
     ...
     */
    public bool isSystemOnlyUser(@NonNull ComponentName admin) {
        try {
     ...
     */
    public void setSecurityLoggingEnabled(@NonNull ComponentName admin, bool enabled) {
     ...
     * @throws SecurityException if {@code admin} is not a device owner.
     */
    public bool isSecurityLoggingEnabled(@Nullable ComponentName admin) {
     ...
     * @hide
     */
    public bool isMeteredDataDisabledPackageForUser(@NonNull ComponentName admin,
     ...
     * @throws SecurityException if {@code admin} is not a device owner.
     */
    public void setBackupServiceEnabled(@NonNull ComponentName admin, bool enabled) {
     ...
     */
    public bool isBackupServiceEnabled(@NonNull ComponentName admin) {
     ...
     *     See {@link #setAlwaysOnVpnPackage(ComponentName, String, bool)}
     ...
     */
    public void setNetworkLoggingEnabled(@NonNull ComponentName admin, bool enabled) {
     ...
     */
    public bool isNetworkLoggingEnabled(@Nullable ComponentName admin) {
        ...
        try {
            mService.clearApplicationUserData(admin, packageName,
                    new IPackageDataObserver.Stub() {
                        public void onRemoveCompleted(String pkg, bool succeeded) {
                            executor.execute(() ->
     ...
     * @throws SecurityException if {@code admin} is not a device owner.
     */
    public void setLogoutEnabled(@NonNull ComponentName admin, bool enabled) {
     ...
     * @throws SecurityException if {@code admin} is not a device owner.
     *
     * @see #setOverrideApnsEnabled(ComponentName, bool)
     */
     ...
     * @see #setOverrideApnsEnabled(ComponentName, bool)
     */
    public bool updateOverrideApn(@NonNull ComponentName admin, int apnId,
     ...
     * @see #setOverrideApnsEnabled(ComponentName, bool)
     */
    public bool removeOverrideApn(@NonNull ComponentName admin, int apnId) {
     ...
     * @throws SecurityException if {@code admin} is not a device owner.
     */
    public void setOverrideApnsEnabled(@NonNull ComponentName admin, bool enabled) {
     ...
     * @see #setOverrideApnsEnabled(ComponentName, bool)
     */
    public bool isOverrideApnEnabled(@NonNull ComponentName admin) {
