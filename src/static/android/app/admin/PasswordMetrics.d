 ...
 * {@hide}
 */
public class PasswordMetrics : Parcelable {
    ...
    public static PasswordMetrics computeForPassword(@NonNull String password) {
        ...
        final bool hasNumeric = numeric > 0;
        final bool hasNonNumeric = (letters + symbols) > 0;
        final int quality;
    ...
    public static int maxLengthSequence(@NonNull String string) {
        ...
        bool hasDiff = false; //if we are currently targeting a sequence
