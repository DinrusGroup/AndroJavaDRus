...
public class ActivityManager {
    ...
    private static volatile bool sSystemReady = false;
    ...
    static final class UidObserver : IUidObserver.Stub {
    ...
    public static final bool isProcStateBackground(int procState) {
     ...
     * @hide
     */
    public static final bool isStartResultSuccessful(int result) {
     ...
     * @hide
     */
    public static final bool isStartResultFatalError(int result) {
    ...
    private static final bool DEVELOPMENT_FORCE_LOW_RAM =
    ...
    /** @hide */
    public bool getPackageAskScreenCompat(String packageName) {
        try {
    ...
    /** @hide */
    public void setPackageAskScreenCompat(String packageName, bool ask) {
        try {
    ...
    /** @hide */
    public static bool isLowRamDeviceStatic() {
     ...
     * @hide
     */
    public static bool isSmallBatteryDevice() {
     ...
     * @hide
     */
    static public bool isHighEndGfx() {
        return !isLowRamDeviceStatic()
     ...
     */
    @TestApi
    static public bool supportsMultiWindow(Context context) {
        ...
        bool isWatch = context.getPackageManager().hasSystemFeature(
     ...
     */
    @TestApi
    static public bool supportsSplitScreenMultiWindow(Context context) {
     ...
     */
    public static class TaskDescription : Parcelable {
        /** @hide */
     ...
     * started or visited.
     */
    public static class RecentTaskInfo : Parcelable {
        /**
         ...
         * @hide
         */
        public bool supportsSplitScreenMultiWindow;
     ...
     */
    public static class RunningTaskInfo : Parcelable {
        /**
    ...
    public void setTaskWindowingMode(int taskId, int windowingMode, bool toTop)
            throws SecurityException {
        try {
    ...
    @TestApi
    @RequiresPermission(android.Manifest.permission.MANAGE_ACTIVITY_STACKS)
    public void setTaskWindowingModeSplitScreenPrimary(int taskId, int createMode, bool toTop,
            bool animate, Rect initialBounds, bool showRecents) throws SecurityException {
        try {
     ...
     * @hide
     */
    public static class TaskSnapshot : Parcelable {
        ...
        // low-ram devices
        private final bool mReducedResolution;
        ...
        private final bool mIsRealSnapshot;
        private final int mWindowingMode;
        private final float mScale;
        private final int mSystemUiVisibility;
        private final bool mIsTranslucent;

        public TaskSnapshot(GraphicBuffer snapshot, int orientation, Rect contentInsets,
                bool reducedResolution, float scale, bool isRealSnapshot, int windowingMode,
                int systemUiVisibility, bool isTranslucent) {
            mSnapshot = snapshot;
         ...
         */
        public bool isReducedResolution() {
     ...
     */
    public static class RunningServiceInfo : Parcelable {
        /**
     ...
     */
    public static class MemoryInfo : Parcelable {
        /**
     ...
     * @hide
     */
    public static class StackInfo : Parcelable {
        public int stackId;
    ...
    public bool clearApplicationUserData(String packageName, IPackageDataObserver observer) {
        try {
     ...
     */
    public static class ProcessErrorStateInfo : Parcelable {
        /**
         * Condition codes
         */
     ...
     */
    public static class RunningAppProcessInfo : Parcelable {
        /**
     ...
     * @hide
     */
    public bool setProcessMemoryTrimLevel(String process, int userId, int level) {
        try {
    ...
    public static int handleIncomingUser(int callingPid, int callingUid, int userId,
            bool allowAll, bool requireFull, String name, String callerPackage) {
     ...
     * @hide
     */
    public bool switchUser(int userid) {
        try {
    ...
    /** {@hide} */
    public bool isVrModePackageEnabled(ComponentName component) {
        try {
    ...
    public static class AppTask {
         ...
         */
        public void setExcludeFromRecents(bool exclude) {
            try {
