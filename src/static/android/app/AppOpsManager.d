...
public class AppOpsManager {
     ...
     */
    private static bool[] sOpAllowSystemRestrictionBypass = new bool[] {
     ...
     */
    private static bool[] sOpDisableReset = new bool[] {
            false,
            false,
            false,
            false,
     ...
     * @hide
     */
    public static bool opAllowSystemBypassRestriction(int op) {
     ...
     * @hide
     */
    public static bool opAllowsReset(int op) {
     ...
     * @hide
     */
    public static class PackageOps : Parcelable {
     ...
     * @hide
     */
    public static class OpEntry : Parcelable {
        ...
        public OpEntry(int op, int mode, long[] times, long[] rejectTimes, int duration,
                bool running, int proxyUid, String proxyPackage) {
            mOp = op;
            mMode = mode;
            mTimes = new long[_NUM_UID_STATE];
            mRejectTimes = new long[_NUM_UID_STATE];
    ...
    public interface OnOpActiveChangedListener {
         ...
         */
        void onOpActiveChanged(int code, int uid, String packageName, bool active);
    }
     ...
     * @hide
     */
    public static class OnOpChangedInternalListener : OnOpChangedListener {
        public void onOpChanged(String op, String packageName) { }
    ...
    /** @hide */
    public void setUserRestriction(int code, bool restricted, IBinder token) {
    ...
    /** @hide */
    public void setUserRestrictionForUser(int code, bool restricted, IBinder token,
    ...
    public void startWatchingActive(@NonNull int[] ops,
        ...
        synchronized (mActiveWatchers) {
            ...
            cb = new IAppOpsActiveCallback.Stub() {
                override
                public void opActiveChanged(int op, int uid, String packageName, bool active) {
     ...
     * @hide
     */
    public int startOp(int op, int uid, String packageName, bool startIfModeDefault) {
    ...
    /**
     * Like {@link #startOp(int, int, String, bool)} but instead of throwing a
     ...
     * @hide
     */
    public int startOpNoThrow(int op, int uid, String packageName, bool startIfModeDefault) {
        try {
