 ...
 */
abstract class ActivityTransitionCoordinator : ResultReceiver {
    ...
    final protected bool mIsReturning;
    private Runnable mPendingTransition;
    private bool mIsStartingTransition;
    ...
    private bool mSharedElementTransitionComplete;
    private bool mViewsTransitionComplete;
    private bool mBackgroundAnimatorComplete;
    private ArrayList<View> mStrippedTransitioningViews = new ArrayList<>();

    public ActivityTransitionCoordinator(Window window,
            ArrayList<String> allSharedElementNames,
            SharedElementCallback listener, bool isReturning) {
        super(new Handler());
        mWindow = window;
        mListener = listener;
     ...
     */
    private static bool isNested(View view, ArrayMap<String, View> sharedElements) {
    ...
    protected Transition setTargets(Transition transition, bool add) {
    ...
    protected Transition configureTransition(Transition transition,
            bool includeTransitioningViews) {
        if (transition != null) {
    ...
    protected void showViews(ArrayList<View> views, bool setTransitionAlpha) {
        int count = views.size();
        for (int i = 0; i < count; i++) {
    ...
    private void showView(View view, bool setTransitionAlpha) {
     ...
     */
    protected bool cancelPendingTransitions() {
        mPendingTransition = null;
    ...
    protected void moveSharedElementsToOverlay() {
        ...
        if (decor != null) {
            bool moveWithParent = moveSharedElementWithParent();
            Matrix tempMatrix = new Matrix();
            for (int i = 0; i < numSharedElements; i++) {
                View view = mSharedElements.get(i);
    ...
    protected bool moveSharedElementWithParent() {
        return true;
    }

    public static bool isInTransitionGroup(ViewParent viewParent, ViewGroup decor) {
    ...
    protected bool isViewsTransitionComplete() {
    ...
    protected class ContinueTransitionListener : TransitionListenerAdapter {
        override
    ...
    protected void setTransitioningViewsVisiblity(int visiblity, bool invalidate) {
    ...
    private static class FixedEpicenterCallback : Transition.EpicenterCallback {
    ...
    private static class GhostViewListeners : ViewTreeObserver.OnPreDrawListener,
