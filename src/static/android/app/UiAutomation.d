 ...
 * call to {@link #injectInputEvent(InputEvent, bool)}.
 * </p>
 * <p>
...
public final class UiAutomation {
    ...
    private bool mWaitingForEventDelivery;
    ...
    public static interface AccessibilityEventFilter {
         ...
         */
        public bool accept(AccessibilityEvent event);
    }
     ...
     */
    public bool injectInputEvent(InputEvent event, bool sync) {
        synchronized (mLock) {
            throwIfNotConnectedLocked();
        }
        try {
     ...
     */
    public bool setRotation(int rotation) {
        synchronized (mLock) {
            throwIfNotConnectedLocked();
        }
        switch (rotation) {
    ...
    @Deprecated
    @TestApi
    public bool grantRuntimePermission(String packageName, String permission,
    ...
    @Deprecated
    @TestApi
    public bool revokeRuntimePermission(String packageName, String permission,
            UserHandle userHandle) {
    ...
    private class IAccessibilityServiceClientImpl : IAccessibilityServiceClientWrapper {
