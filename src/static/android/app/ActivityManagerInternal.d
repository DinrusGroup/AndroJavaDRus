...
public abstract class ActivityManagerInternal {
    ...
    /**
     * Grant Uri permissions from one app to another. This method only :
     ...
     */
    public abstract bool startIsolatedProcess(String entryPoint, String[] mainArgs,
     ...
     * minimized state.
     */
    public abstract void notifyDockedStackMinimizedChanged(bool minimized);
     ...
     */
    public abstract bool isSystemReady();
     ...
     */
    public abstract void setHasOverlayUi(int pid, bool hasOverlayUi);
     ...
     */
    public abstract void setRunningRemoteAnimation(int pid, bool runningRemoteAnimation);
     ...
     */
    public abstract bool isRuntimeRestarted();

    /**
     * Returns {@code true} if {@code uid} is running an activity from {@code packageName}.
     */
    public abstract bool hasRunningActivity(int uid, @Nullable String packageName);
     ...
     */
    public abstract bool canStartMoreUsers();
     ...
     */
    public abstract bool isCallerRecents(int callingUid);

    /**
     * Returns whether the recents component is the home activity for the given user.
     */
    public abstract bool isRecentsComponentHomeActivity(int userId);

    /**
     * Cancels any currently running recents animation.
     */
    public abstract void cancelRecentsAnimation(bool restoreHomeStackPosition);

    /**
     * Whether an UID is active or idle.
     */
    public abstract bool isUidActive(int uid);
