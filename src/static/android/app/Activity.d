 ...
 * public class Activity : ApplicationContext {
...
public class Activity : ContextThemeWrapper
    ...
    private static final bool DEBUG_LIFECYCLE = false;
    ...
    Activity mParent;
    bool mCalled;
    /*package*/ bool mResumed;
    /*package*/ bool mStopped;
    bool mFinished;
    bool mStartedActivity;
    private bool mDestroyed;
    private bool mDoReportFullyDrawn = true;
    private bool mRestoredFromBundle;
    ...
    private bool mCanEnterPictureInPicture = false;
    /** true if the activity is going through a transient pause */
    /*package*/ bool mTemporaryPause = false;
    /** true if the activity is being destroyed in order to recreate it with a new configuration */
    /*package*/ bool mChangingConfigurations = false;
    ...
    /*package*/ bool mWindowAdded = false;
    /*package*/ bool mVisibleFromServer = false;
    /*package*/ bool mVisibleFromClient = true;
    ...
    private bool mChangeCanvasToTranslucent;
    ...
    private bool mHasCurrentPermissionsRequest;

    private bool mAutoFillResetNeeded;
    private bool mAutoFillIgnoreFirstResumePause;
     ...
     */
    @Deprecated
    public bool onCreateThumbnail(Bitmap outBitmap, Canvas canvas) {
        return false;
    }
     ...
     */
    public bool showAssist(Bundle args) {
        try {
     ...
     */
    public void onMultiWindowModeChanged(bool isInMultiWindowMode, Configuration newConfig) {
     ...
     * @param isInMultiWindowMode True if the activity is in multi-window mode.
     *
     * @deprecated Use {@link #onMultiWindowModeChanged(bool, Configuration)} instead.
     */
    @Deprecated
    public void onMultiWindowModeChanged(bool isInMultiWindowMode) {
        // Left deliberately empty. There should be no side effects if a direct
        // subclass of Activity does not call super.
    }
     ...
     */
    public void onPictureInPictureModeChanged(bool isInPictureInPictureMode,
     ...
     * @param isInPictureInPictureMode True if the activity is in picture-in-picture mode.
     *
     * @deprecated Use {@link #onPictureInPictureModeChanged(bool, Configuration)} instead.
     */
    @Deprecated
    public void onPictureInPictureModeChanged(bool isInPictureInPictureMode) {
        // Left deliberately empty. There should be no side effects if a direct
    ...
    /** @removed */
    @Deprecated
    public bool enterPictureInPictureMode(@NonNull PictureInPictureArgs args) {
     ...
     */
    public bool enterPictureInPictureMode(@NonNull PictureInPictureParams params) {
        try {
     ...
     */
    private bool deviceSupportsPictureInPictureMode() {
     ...
     * {@link Fragment#setRetainInstance(bool)} instead; this is also
     ...
     * {@link Fragment#setRetainInstance(bool)
     * Fragment.setRetainInstance(bool}.</em>
     *
     ...
     */
    @NonNull
    public final <T : View> T requireViewById(@IdRes int id) {
     ...
     * bounds.
     */
    public void setFinishOnTouchOutside(bool finish) {
     ...
     * @see #hasWindowFocus()
     * @see #onResume
     * @see View#onWindowFocusChanged(bool)
     */
     ...
     */
    override
    public void onWindowDismissed(bool finishTask, bool suppressWindowTransition) {
     ...
     *
     * @return bool Return true if this event was consumed.
     */
     ...
     * @return bool Return true if this event was consumed.
     */
    public bool dispatchTrackballEvent(MotionEvent ev) {
        onUserInteraction();
    ...
    public bool dispatchPopulateAccessibilityEvent(AccessibilityEvent event) {
        ...
        bool isFullScreen = (params.width == LayoutParams.MATCH_PARENT) &&
     ...
     *
     * @return bool Return false to allow normal menu processing to
     ...
     */
    public bool onNavigateUpFromChild(Activity child) {
        return onNavigateUp();
    }
     ...
     * @return bool Return false to allow normal context menu processing to
     *         proceed, true to consume it here.
     */
     ...
     */
    @Deprecated
    public final bool showDialog(int id, Bundle args) {
        if (mManagedDialogs == null) {
     ...
     */
    public bool onSearchRequested(@Nullable SearchEvent searchEvent) {
        mSearchEvent = searchEvent;
        bool result = onSearchRequested();
        mSearchEvent = null;
        return result;
    }
     ...
     */
    public void startSearch(@Nullable String initialQuery, bool selectInitialQuery,
            @Nullable Bundle appSearchData, bool globalSearch) {
        ensureSearchManager();
     ...
     */
    public void takeKeyEvents(bool get) {
     ...
     */
    public final bool requestWindowFeature(int featureId) {
     ...
     * @see #onRequestPermissionsResult(int, String[], int[])
     */
    public bool shouldShowRequestPermissionRationale(@NonNull String permission) {
    ...
    public void startActivityAsCaller(Intent intent, @Nullable Bundle options,
            bool ignoreTargetSecurity, int userId) {
        if (mParent != null) {
            throw new RuntimeException("Can't be called from a child");
        }
        options = transferSpringboardActivityOptions(options);
     ...
     * @see #startActivityForResult
     */
    public bool startActivityIfNeeded(@RequiresPermission @NonNull Intent intent,
            int requestCode) {
     ...
     * inside of it.
     *
     * @return Returns a bool indicating whether there was another Activity
     * to start: true if there was a next activity to start, false if there
     * wasn't.  In general, if true is returned you will then want to call
     * finish() on yourself.
     */
    public bool startNextMatchingActivity(@RequiresPermission @NonNull Intent intent) {
     ...
     */
    @Deprecated
    public final void setProgressBarVisibility(bool visible) {
     ...
     */
    @Deprecated
    public final void setProgressBarIndeterminateVisibility(bool visible) {
     ...
     */
    @Deprecated
    public final void setProgressBarIndeterminate(bool indeterminate) {
     ...
     */
    @SystemApi
    public bool convertToTranslucent(TranslucentConversionListener callback,
    ...
    /** @hide */
    void onTranslucentConversionComplete(bool drawComplete) {
     ...
     */
    @Deprecated
    public bool requestVisibleBehind(bool visible) {
        return false;
    }
     ...
     * {@link #requestVisibleBehind(bool)}, false otherwise.
     *
     * @see #requestVisibleBehind(bool)
     * @see #onVisibleBehindCanceled()
     * @see #onBackgroundVisibleBehindChanged(bool)
     * @hide
     */
    @Deprecated
    @SystemApi
    public bool isBackgroundVisibleBehind() {
        return false;
    }
     ...
     *
     * This call may be a consequence of {@link #requestVisibleBehind(bool)} or might be
    ...
    @Deprecated
    @SystemApi
    public void onBackgroundVisibleBehindChanged(bool visible) {
    }
     ...
     */
    public void setVrModeEnabled(bool enabled, @NonNull ComponentName requestedComponent)
     ...
     */
    public bool shouldUpRecreateTask(Intent targetIntent) {
        try {
     ...
     */
    public bool navigateUpTo(Intent upIntent) {
        if (mParent == null) {
     ...
     *         not be found and this activity was simply finished normally.
     */
    public bool navigateUpToFromChild(Activity child, Intent upIntent) {
    ...
    final void performStart(String reason) {
        ...
        bool isDlwarningEnabled = SystemProperties.getInt("ro.bionic.ld.warning", 0) == 1;
        ...
        // This property is set for all non-user builds except final release
        bool isApiWarningEnabled = SystemProperties.getInt("ro.art.hiddenapi.warning", 0) == 1;
     ...
     */
    final void performRestart(bool start, String reason) {
        mCanEnterPictureInPicture = true;
        mFragments.noteStateNotSaved();
    ...
    final void performResume(bool followedByPause, String reason) {
    ...
    final void performStop(bool preserveWindow, String reason) {
        mDoReportFullyDrawn = false;
    ...
    final void dispatchMultiWindowModeChanged(bool isInMultiWindowMode,
            Configuration newConfig) {
    ...
    final void dispatchPictureInPictureModeChanged(bool isInPictureInPictureMode,
            Configuration newConfig) {
        if (DEBUG_LIFECYCLE) Slog.v(TAG,
     ...
     *
     * @see #setOverlayWithDecorCaptionEnabled(bool)
     * @hide
     */
    public bool isOverlayWithDecorCaptionEnabled() {
     ...
     * @hide
     */
    public void setOverlayWithDecorCaptionEnabled(bool enabled) {
    ...
    public interface TranslucentConversionListener {
         ...
         */
        public void onTranslucentConversionComplete(bool drawComplete);
    }
    ...
    /** @hide */
    override
    public final bool autofillClientRequestShowFillUi(@NonNull View anchor, int width,
    ...
    /** @hide */
    override
    public final bool autofillClientRequestHideFillUi() {
        if (mAutofillPopupWindow == null) {
            return false;
        }
    ...
    /** @hide */
    override
    public final bool autofillClientIsFillUiShowing() {
    ...
    /** @hide */
    override
    public final @NonNull bool[] autofillClientGetViewVisibility(
            @NonNull AutofillId[] autofillIds) {
        final int autofillIdCount = autofillIds.length;
        final bool[] visible = new bool[autofillIdCount];
    ...
    /** @hide */
    override
    public final bool autofillClientIsVisibleForAutofill() {
        return !mStopped;
    }

    /** @hide */
    override
    public final bool autofillClientIsCompatibilityModeEnabled() {
        return isAutofillCompatibilityEnabled();
    }

    /** @hide */
    override
    public final bool isDisablingEnterExitEventForAutofill() {
     ...
     * @hide
     */
    public void setDisablePreviewScreenshots(bool disable) {
        try {
     ...
     * @see #setTurnScreenOn(bool)
     * @see android.R.attr#turnScreenOn
     * @see android.R.attr#showWhenLocked
     */
    public void setShowWhenLocked(bool showWhenLocked) {
        try {
     ...
     *
     * @see #setShowWhenLocked(bool)
     * @see android.R.attr#turnScreenOn
     * @see android.R.attr#showWhenLocked
     */
    public void setTurnScreenOn(bool turnScreenOn) {
        try {
    ...
    class HostCallbacks : FragmentHostCallback<Activity> {
        ...
        override
        public bool onShouldSaveFragmentState(Fragment fragment) {
            return !isFinishing();
        }
        ...
        @Nullable
        override
        public <T : View> T onFindViewById(int id) {
