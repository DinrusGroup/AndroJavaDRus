...
public abstract class CaptivePortalProbeSpec {
     ...
     */
    private static class RegexMatchProbeSpec : CaptivePortalProbeSpec {
        @Nullable
        ...
        public CaptivePortalProbeResult getResult(int status, String locationHeader) {
            final bool statusMatch = safeMatch(String.valueOf(status), mStatusRegex);
            final bool locationMatch = safeMatch(locationHeader, mLocationHeaderRegex);
    ...
    private static bool safeMatch(@Nullable String value, @Nullable Pattern pattern) {
