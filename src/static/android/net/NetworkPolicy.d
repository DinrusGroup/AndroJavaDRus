 ...
 * @hide
 */
public class NetworkPolicy : Parcelable, Comparable<NetworkPolicy> {
    ...
    @Deprecated public bool metered = true;
    ...
    public NetworkPolicy(NetworkTemplate template, int cycleDay, String cycleTimezone,
            long warningBytes, long limitBytes, bool metered) {
    ...
    public NetworkPolicy(NetworkTemplate template, RecurrenceRule cycleRule, long warningBytes,
            long limitBytes, long lastWarningSnooze, long lastLimitSnooze, bool metered,
            bool inferred) {
     ...
     */
    public bool isOverWarning(long totalBytes) {
     ...
     */
    public bool isOverLimit(long totalBytes) {
    ...
    public static NetworkPolicy getNetworkPolicyFromBackup(DataInputStream in) throws IOException,
        ...
        final bool metered = in.readInt() == 1;
        final bool inferred = in.readInt() == 1;
