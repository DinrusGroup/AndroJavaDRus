...
public class IpConnectivityLog {
    ...
    private bool checkLoggerService() {
        if (mService != null) {
            return true;
        }
     ...
     */
    public bool log(ConnectivityMetricsEvent ev) {
     ...
     * @return true if the event was successfully logged.
     */
    public bool log(long timestamp, Parcelable data) {
     ...
     * @return true if the event was successfully logged.
     */
    public bool log(String ifname, Parcelable data) {
        ConnectivityMetricsEvent ev = makeEv(data);
        ev.ifname = ifname;
        return log(ev);
    }
     ...
     * @return true if the event was successfully logged.
     */
    public bool log(int netid, int[] transports, Parcelable data) {
        ConnectivityMetricsEvent ev = makeEv(data);
        ev.netId = netid;
     ...
     * @return true if the event was successfully logged.
     */
    public bool log(Parcelable data) {
