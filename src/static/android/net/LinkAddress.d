 ...
 * </ul>
 */
public class LinkAddress : Parcelable {
    /**
     ...
     */
    private bool isIPv6ULA() {
        if (isIPv6()) {
            byte[] bytes = address.getAddress();
            return ((bytes[0] & cast(byte)0xfe) == cast(byte)0xfc);
        }
        return false;
    }
     ...
     * @hide
     */
    public bool isSameAddressAs(LinkAddress other) {
