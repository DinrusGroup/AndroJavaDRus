...
public class NetworkPolicyManager {
    ...
    private static final bool ALLOW_PLATFORM_APP_POLICY = true;
     ...
     */
    @Deprecated
    public static bool isUidValidForPolicy(Context context, int uid) {
     ...
     */
    public static bool isProcStateAllowedWhileIdleOrPowerSaveMode(int procState) {
     ...
     */
    public static bool isProcStateAllowedWhileOnRestrictBackground(int procState) {
        return procState <= FOREGROUND_THRESHOLD_STATE;
    }
    ...
    /** {@hide} */
    public static class Listener : INetworkPolicyListener.Stub {
        ...
        override public void onRestrictBackgroundChanged(bool restrictBackground) { }
