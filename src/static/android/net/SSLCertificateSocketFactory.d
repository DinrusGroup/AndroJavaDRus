...
public class SSLCertificateSocketFactory : SSLSocketFactory {
    ...
    private SSLCertificateSocketFactory(
            int handshakeTimeoutMillis, SSLSessionCache cache, bool secure) {
    ...
    private static bool isSslCheckRelaxed() {
     ...
     * @throws IllegalArgumentException if the socket was not created by this factory.
     */
    public void setUseSessionTickets(Socket socket, bool useSessionTickets) {
     ...
     */
    override
    public Socket createSocket(Socket k, String host, int port, bool close) throws IOException {
