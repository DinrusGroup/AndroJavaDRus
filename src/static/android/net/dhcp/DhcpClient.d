 ...
 * @hide
 */
public class DhcpClient : StateMachine {

    private static final String TAG = "DhcpClient";
    private static final bool DBG = true;
    private static final bool STATE_DBG = false;
    private static final bool MSG_DBG = false;
    private static final bool PACKET_DBG = false;
    ...
    // This is not strictly needed, since the client is asynchronous and : exponential
    ...
    private static final bool DO_UNICAST   = false;
    ...
    private bool mRegisteredForPreDhcpNotification;
    ...
    private bool initPacketSocket() {
        try {
            mPacketSock = Os.socket(AF_PACKET, SOCK_RAW, ETH_P_IP);
            PacketSocketAddress addr = new PacketSocketAddress(cast(short) ETH_P_IP, mIface.index);
    ...
    private bool connectUdpSock(Inet4Address to) {
        try {
    ...
    class ReceiveThread : Thread {
        ...
        private volatile bool mStopped = false;
    ...
    private short getSecs() {
        return cast(short) ((SystemClock.elapsedRealtime() - mTransactionStartMillis) / 1000);
    }

    private bool transmitPacket(ByteBuffer buf, String description, int encap, Inet4Address to) {
        try {
    ...
    private bool sendDiscoverPacket() {
    ...
    private bool sendRequestPacket(
    ...
    abstract class LoggingState : State {
    ...
    abstract class WaitBeforeOtherState : LoggingState {
    ...
    class WaitBeforeStartState : WaitBeforeOtherState {
    ...
    class WaitBeforeRenewalState : WaitBeforeOtherState {
    ...
    public bool isValidPacket(DhcpPacket packet) {
        // TODO: check checksum.
     ...
     */
    abstract class PacketRetransmittingState : LoggingState {
        ...
        abstract protected bool sendPacket();
    ...
    class DhcpInitState : PacketRetransmittingState {
    ...
    class DhcpSelectingState : LoggingState {
    }

    class DhcpRequestingState : PacketRetransmittingState {
    ...
    class DhcpHaveLeaseState : State {
        override
        public bool processMessage(Message message) {
            switch (message.what) {
    ...
    class ConfiguringInterfaceState : LoggingState {
        override
        public void enter() {
            super.enter();
    ...
    class DhcpBoundState : LoggingState {
        override
        public void enter() {
            super.enter();
    ...
    abstract class DhcpReacquiringState : PacketRetransmittingState {
    ...
    class DhcpRenewingState : DhcpReacquiringState {
    ...
    class DhcpRebindingState : DhcpReacquiringState {
    ...
    class DhcpInitRebootState : LoggingState {
    }

    class DhcpRebootingState : LoggingState {
    }
