 ...
 * Internet Protocol</a>
 */
public final class IpSecAlgorithm : Parcelable {
    ...
    private static void checkValidOrThrow(String name, int keyLen, int truncLen) {
        bool isValidLen = true;
        bool isValidTruncLen = true;
    ...
    private static bool isUnsafeBuild() {
    ...
    /** @hide */
    @VisibleForTesting
    public static bool equals(IpSecAlgorithm lhs, IpSecAlgorithm rhs) {
