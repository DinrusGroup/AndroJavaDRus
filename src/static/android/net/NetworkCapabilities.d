 ...
 */
public final class NetworkCapabilities : Parcelable {
     ...
     * @hide
     */
    public NetworkCapabilities setCapability(@NetCapability int capability, bool value) {
        if (value) {
     ...
     */
    public bool hasCapability(@NetCapability int capability) {
        return isValidCapability(capability)
                && ((mNetworkCapabilities & (1 << capability)) != 0);
    }

    /** @hide */
    public bool hasUnwantedCapability(@NetCapability int capability) {
        return isValidCapability(capability)
    ...
    private bool satisfiedByNetCapabilities(NetworkCapabilities nc, bool onlyImmutable) {
    ...
    /** @hide */
    public bool equalsNetCapabilities(NetworkCapabilities nc) {
        return (nc.mNetworkCapabilities == this.mNetworkCapabilities)
                && (nc.mUnwantedNetworkCapabilities == this.mUnwantedNetworkCapabilities);
    }

    private bool equalsNetCapabilitiesRequestable(NetworkCapabilities that) {
    ...
    public void maybeMarkCapabilitiesRestricted() {
        ...
        final bool forceRestrictedCapability =
                (mNetworkCapabilities & FORCE_RESTRICTED_CAPABILITIES) != 0;

        // Verify there aren't any unrestricted capabilities.  If there are we say
        // the whole thing is unrestricted unless it is forced to be restricted.
        final bool hasUnrestrictedCapabilities =
                (mNetworkCapabilities & UNRESTRICTED_CAPABILITIES) != 0;

        // Must have at least some restricted capabilities.
        final bool hasRestrictedCapabilities =
    ...
    /** @hide */
    public static bool isValidTransport(@Transport int transportType) {
     ...
     * @hide
     */
    public NetworkCapabilities setTransportType(@Transport int transportType, bool value) {
        if (value) {
     ...
     * @return {@code true} if set on this instance.
     */
    public bool hasTransport(@Transport int transportType) {
    ...
    private bool satisfiedByTransportTypes(NetworkCapabilities nc) {
        return ((this.mTransportTypes == 0) ||
                ((this.mTransportTypes & nc.mTransportTypes) != 0));
    }

    /** @hide */
    public bool equalsTransportTypes(NetworkCapabilities nc) {
    ...
    private bool satisfiedByLinkBandwidths(NetworkCapabilities nc) {
        return !(this.mLinkUpBandwidthKbps > nc.mLinkUpBandwidthKbps ||
                this.mLinkDownBandwidthKbps > nc.mLinkDownBandwidthKbps);
    }
    private bool equalsLinkBandwidths(NetworkCapabilities nc) {
        return (this.mLinkUpBandwidthKbps == nc.mLinkUpBandwidthKbps &&
                this.mLinkDownBandwidthKbps == nc.mLinkDownBandwidthKbps);
    }
    /** @hide */
     ...
     * </p>
     *
     * @param networkSpecifier A concrete, parcelable framework class that :
     *                         NetworkSpecifier.
     * @return This NetworkCapabilities instance, to facilitate chaining.
     * @hide
     */
    ...
    private bool satisfiedBySpecifier(NetworkCapabilities nc) {
        return mNetworkSpecifier == null || mNetworkSpecifier.satisfiedBy(nc.mNetworkSpecifier)
                || nc.mNetworkSpecifier instanceof MatchAllNetworkSpecifier;
    }

    private bool equalsSpecifier(NetworkCapabilities nc) {
    ...
    private bool satisfiedBySignalStrength(NetworkCapabilities nc) {
        return this.mSignalStrength <= nc.mSignalStrength;
    }

    private bool equalsSignalStrength(NetworkCapabilities nc) {
        return this.mSignalStrength == nc.mSignalStrength;
    }
     ...
     * @hide
     */
    public bool appliesToUid(int uid) {
     ...
     */
    @VisibleForTesting
    public bool equalsUids(NetworkCapabilities nc) {
     ...
     * @hide
     */
    public bool satisfiedByUids(NetworkCapabilities nc) {
     ...
     */
    @VisibleForTesting
    public bool appliesToUidRange(UidRange requiredRange) {
        if (null == mUids) return true;
     ...
     * @hide
     */
    public bool equalsSSID(NetworkCapabilities nc) {
     ...
     * @hide
     */
    public bool satisfiedBySSID(NetworkCapabilities nc) {
     ...
     * @hide
     */
    private bool satisfiedByNetworkCapabilities(NetworkCapabilities nc, bool onlyImmutable) {
        return (nc != null
     ...
     * @hide
     */
    public bool satisfiedByNetworkCapabilities(NetworkCapabilities nc) {
     ...
     * @hide
     */
    public bool satisfiedByImmutableNetworkCapabilities(NetworkCapabilities nc) {
     ...
     * @hide
     */
    public bool equalRequestableCapabilities(NetworkCapabilities nc) {
    ...
    private static bool isValidCapability(@NetworkCapabilities.NetCapability int capability) {
