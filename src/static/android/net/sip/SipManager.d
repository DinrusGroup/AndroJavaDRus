...
public class SipManager {
     ...
     */
    public static bool isApiSupported(Context context) {
     ...
     */
    public static bool isVoipSupported(Context context) {
        return context.getPackageManager().hasSystemFeature(
     ...
     */
    public static bool isSipWifiOnly(Context context) {
     ...
     * @throws SipException if calling the SIP service results in an error
     */
    public bool isOpened(String localProfileUri) throws SipException {
        try {
            checkSipServiceConnection();
     ...
     * @throws SipException if calling the SIP service results in an error
     */
    public bool isRegistered(String localProfileUri) throws SipException {
        try {
            checkSipServiceConnection();
     ...
     */
    public static bool isIncomingCallIntent(Intent intent) {
    ...
    private static class ListenerRelay : SipSessionAdapter {
