...
public class SipAudioCall {
    ...
    private static final bool RELEASE_SOCKET = true;
    private static final bool DONT_RELEASE_SOCKET = false;
    ...
    private synchronized void close(bool closeRtp) {
     ...
     */
    public void setSpeakerMode(bool speakerMode) {
        synchronized (this) {
    ...
    private void stopCall(bool releaseSocket) {
