...
public final class LinkProperties : Parcelable {
     ...
     * @hide
     */
    public bool addLinkAddress(LinkAddress address) {
        if (address == null) {
            return false;
        }
     ...
     * @hide
     */
    public bool removeLinkAddress(LinkAddress toRemove) {
     ...
     * @hide
     */
    public bool addDnsServer(InetAddress dnsServer) {
     ...
     * @hide
     */
    public bool removeDnsServer(InetAddress dnsServer) {
        if (dnsServer != null) {
     ...
     * @hide
     */
    public void setUsePrivateDns(bool usePrivateDns) {
     ...
     * @hide
     */
    public bool addValidatedPrivateDnsServer(InetAddress dnsServer) {
     ...
     * @hide
     */
    public bool removeValidatedPrivateDnsServer(InetAddress dnsServer) {
        if (dnsServer != null) {
     ...
     * @hide
     */
    public bool addRoute(RouteInfo route) {
        if (route != null) {
     ...
     * @hide
     */
    public bool removeRoute(RouteInfo route) {
        return route != null &&
     ...
     * @hide
     */
    public bool addStackedLink(LinkProperties link) {
     ...
     * @hide
     */
    public bool removeStackedLink(String iface) {
        if (iface != null) {
     ...
     * @return {@code true} if there is an IPv4 address, {@code false} otherwise.
     */
    private bool hasIPv4AddressOnInterface(String iface) {
     ...
     * @hide
     */
    public bool hasGlobalIPv6Address() {
        for (LinkAddress address : mLinkAddresses) {
     ...
     * @hide
     */
    public bool hasIPv4DefaultRoute() {
     ...
     * @hide
     */
    public bool hasIPv6DefaultRoute() {
        for (RouteInfo r : mRoutes) {
            if (r.isIPv6Default()) {
                return true;
            }
     ...
     * @hide
     */
    public bool isReachable(InetAddress ip) {
     ...
     * @hide
     */
    public bool isIdenticalInterfaceName(LinkProperties target) {
     ...
     * @hide
     */
    public bool isIdenticalAddresses(LinkProperties target) {
     ...
     * @hide
     */
    public bool isIdenticalDnses(LinkProperties target) {
     ...
     * @hide
     */
    public bool isIdenticalPrivateDns(LinkProperties target) {
     ...
     * @hide
     */
    public bool isIdenticalValidatedPrivateDnses(LinkProperties target) {
     ...
     * @hide
     */
    public bool isIdenticalRoutes(LinkProperties target) {
     ...
     * @hide
     */
    public bool isIdenticalHttpProxy(LinkProperties target) {
     ...
     * @hide
     */
    public bool isIdenticalStackedLinks(LinkProperties target) {
     ...
     * @hide
     */
    public bool isIdenticalMtu(LinkProperties target) {
     ...
     * @hide
     */
    public bool isIdenticalTcpBufferSizes(LinkProperties target) {
     ...
     * @hide
     */
    public static bool isValidMtu(int mtu, bool ipv6) {
        if (ipv6) {
