...
public class ConnectivityManager {
     ...
     * disconnected network, then the FAILOVER_CONNECTION bool extra is
     * set to true.
     * <p/>
     ...
     * <p/>
     * For a disconnect event, the bool extra EXTRA_NO_CONNECTIVITY
    ...
    /**
     * The lookup key for a bool that indicates whether a connect event
     * is for a network to which the connectivity manager was failing over
     * following a disconnect on another network.
     * Retrieve it with {@link android.content.Intent#getBooleanExtra(String,bool)}.
     */
    ...
    /**
     * The lookup key for a bool that indicates whether there is a
    ...
    /**
     * The lookup key for a bool that indicates the device is active or not. {@code true} means
    ...
    /**
     * The lookup key for a bool that indicates whether a captive portal was detected.
     * Retrieve it with {@link android.content.Intent#getBooleanExtra(String,bool)}.
     * @hide
     */
     ...
     * @see #startTethering(int, OnStartTetheringCallback, bool)
     * @hide
     */
     ...
     * @return a bool.  {@code true} if the type is valid, else {@code false}
     ...
     * @return a bool - {@code true} if uses cellular network, else {@code false}
     * @deprecated Types are deprecated. Use {@link NetworkCapabilities} instead.
     * {@hide}
     */
    @Deprecated
     ...
     */
    @Deprecated
    public static bool isNetworkTypeWifi(int networkType) {
        switch (networkType) {
            case TYPE_WIFI:
            case TYPE_WIFI_P2P:
                return true;
     ...
     * @hide
     */
    public bool isAlwaysOnVpnPackageSupportedForUser(int userId, @Nullable String vpnPackage) {
        try {
     ...
     * @hide
     */
    public bool setAlwaysOnVpnPackageForUser(int userId, @Nullable String vpnPackage,
    ...
    private bool removeRequestForFeature(NetworkCapabilities netCap) {
     ...
     */
    @Deprecated
    public bool requestRouteToHost(int networkType, int hostAddress) {
     ...
     */
    @Deprecated
    public bool requestRouteToHostAddress(int networkType, InetAddress hostAddress) {
        checkLegacyRoutingApiAccess();
        try {
     ...
     */
    @Deprecated
    public void setBackgroundDataSetting(bool allowBackgroundData) {
        // ignored
    }
     ...
     */
    @Deprecated
    public bool getMobileDataEnabled() {
        ...
        if (b != null) {
            try {
                ...
                bool retVal = it.isUserDataEnabled(subId);
                Log.d("ConnectivityManager", "getMobileDataEnabled()- subId=" + subId
                        + " retVal=" + retVal);
                return retVal;
            } catch (RemoteException e) {
     ...
     *
     * @return a bool - {@code true} indicating Tethering is supported.
     *
     * {@hide}
     */
    @SystemApi
     ...
     * {@link #startTethering(int, bool, OnStartTetheringCallback, Handler)} which passes a null
     * handler to run on the current thread's {@link Looper}.
     * @hide
     */
    @SystemApi
    @RequiresPermission(android.Manifest.permission.TETHER_PRIVILEGED)
    public void startTethering(int type, bool showProvisioningUi,
     ...
     * @param showProvisioningUi a bool indicating to show the provisioning app UI if there
     ...
     * {@link android.provider.Settings.System#canWrite}.</p>
     *
     * @param enable a bool - {@code true} to enable tethering
     * @return error a {@code TETHER_ERROR} value indicating success or failure type
     *
     * {@hide}
     */
    public int setUsbTethering(bool enable) {
        try {
            String pkgName = mContext.getOpPackageName();
     ...
     *
     * @return a bool with {@code} indicating success
     *
    ...
    /** @hide */
    public static class TooManyRequestsException : RuntimeException {}
     ...
     * @return {@code true} on success, {@code false} if the {@link Network} is no longer valid.
     */
    public bool bindProcessToNetwork(Network network) {
     ...
     */
    @Deprecated
    public static bool setProcessDefaultNetworkForHostResolution(Network network) {
