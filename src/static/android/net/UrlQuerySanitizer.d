...
public class UrlQuerySanitizer {
    ...
    private bool mAllowUnregisteredParamaters;
    private bool mPreferFirstRepeatedParameter;
    ...
    public static class IllegalCharacterValueSanitizer :
         ...
         */
        private bool characterIsLegal(char c) {
            switch(c) {
    ...
    public void setAllowUnregisteredParamaters(
            bool allowUnregisteredParamaters) {
     ...
     * @see #setAllowUnregisteredParamaters(bool)
     */
    ...
    public void setPreferFirstRepeatedParameter(
            bool preferFirstRepeatedParameter) {
     ...
     * preferred.
     * @see #setPreferFirstRepeatedParameter(bool)
     */
