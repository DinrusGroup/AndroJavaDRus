 ...
 * @hide
 */
public class KeepalivePacketData : Parcelable {
    ...
    public static class InvalidPacketException : Exception {
    ...
    public static KeepalivePacketData nattKeepalivePacket(
        ...
        buf.putShort(cast(short) 0x4500);             // IP version and TOS
        buf.putShort(cast(short) length);
        buf.putInt(0);                            // ID, flags, offset
        buf.put(cast(byte) 64);                       // TTL
        buf.put(cast(byte) OsConstants.IPPROTO_UDP);
        int ipChecksumOffset = buf.position();
        buf.putShort(cast(short) 0);                  // IP checksum
        buf.put(srcAddress.getAddress());
        buf.put(dstAddress.getAddress());
        buf.putShort(cast(short) srcPort);
        buf.putShort(cast(short) dstPort);
        buf.putShort(cast(short) (length - 20));      // UDP length
        int udpChecksumOffset = buf.position();
        buf.putShort(cast(short) 0);                  // UDP checksum
        buf.put(cast(byte) 0xff);                     // NAT-T keepalive
