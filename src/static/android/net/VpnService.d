...
public class VpnService : Service {
    ...
    /**
     * Key for bool meta-data field indicating whether this VpnService supports always-on mode.
     *
     ...
     */
    public bool protect(int socket) {
     ...
     * @see #protect(int)
     */
    public bool protect(Socket socket) {
     ...
     * @see #protect(int)
     */
    public bool protect(DatagramSocket socket) {
        return protect(socket.getFileDescriptor$().getInt$());
    }
     ...
     * @hide
     */
    public bool addAddress(InetAddress address, int prefixLength) {
     ...
     * @hide
     */
    public bool removeAddress(InetAddress address, int prefixLength) {
        check(address, prefixLength);
        try {
     ...
     * @return {@code true} on success.
     */
    public bool setUnderlyingNetworks(Network[] networks) {
        try {
    ...
    public class Builder {
         ...
         * @return this {@link Builder} object to facilitate chaining method calls.
         */
        public Builder setBlocking(bool blocking) {
