...
public class NetworkUtils {
     ...
     */
    public native static bool bindProcessToNetwork(int netId);
     ...
     */
    @Deprecated
    public native static bool bindProcessToNetworkForHostResolution(int netId);
     ...
     */
    public static bool protectFromVpn(FileDescriptor fd) {
     ...
     * forwarded through the VPN.
     */
    public native static bool protectFromVpn(int socketfd);

    /**
     * Determine if {@code uid} can access network designated by {@code netId}.
     * @return {@code true} if {@code uid} can access network, {@code false} otherwise.
     */
    public native static bool queryUserAccess(int uid, int netId);
    ...
    public static InetAddress intToInetAddress(int hostAddress) {
        byte[] addressBytes = { cast(byte)(0xff & hostAddress),
                                cast(byte)(0xff & (hostAddress >> 8)),
                                cast(byte)(0xff & (hostAddress >> 16)),
                                cast(byte)(0xff & (hostAddress >> 24)) };
    ...
    public static void maskRawAddress(byte[] array, int prefixLength) {
        ...
        byte mask = cast(byte)(0xFF << (8 - remainder));

        if (offset < array.length) array[offset] = cast(byte)(array[offset] & mask);
     ...
     */
    public static bool addressTypeMatches(InetAddress left, InetAddress right) {
