 ...
 * @hide
 */
public class NetworkTemplate : Parcelable {
    ...
    private static bool isKnownMatchRule(final int rule) {
        switch (rule) {
            case MATCH_MOBILE:
            case MATCH_WIFI:
            case MATCH_ETHERNET:
    ...
    private static bool sForceAllNetworkTypes = false;
     ...
     */
    public bool matches(NetworkIdentity ident) {
     ...
     */
    private bool matchesMobile(NetworkIdentity ident) {
     ...
     */
    private bool matchesWifi(NetworkIdentity ident) {
        switch (ident.mType) {
            case TYPE_WIFI:
     ...
     */
    private bool matchesEthernet(NetworkIdentity ident) {
    ...
    private bool matchesMobileWildcard(NetworkIdentity ident) {
        if (ident.mType == TYPE_WIMAX) {
            return true;
        } else {
            return sForceAllNetworkTypes || (ident.mType == TYPE_MOBILE && ident.mMetered);
    ...
    private bool matchesWifiWildcard(NetworkIdentity ident) {
        switch (ident.mType) {
            case TYPE_WIFI:
            case TYPE_WIFI_P2P:
                return true;
     ...
     */
    private bool matchesBluetooth(NetworkIdentity ident) {
     ...
     */
    private bool matchesProxy(NetworkIdentity ident) {
