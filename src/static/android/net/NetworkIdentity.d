 ...
 * @hide
 */
public class NetworkIdentity : Comparable<NetworkIdentity> {
     ...
     */
    @Deprecated
    public static final bool COMBINE_SUBTYPE_ENABLED = true;
    ...
    final bool mRoaming;
    final bool mMetered;
    final bool mDefaultNetwork;

    public NetworkIdentity(
            int type, int subType, String subscriberId, String networkId, bool roaming,
            bool metered, bool defaultNetwork) {
        mType = type;
    ...
    public bool getMetered() {
        return mMetered;
    }

    public bool getDefaultNetwork() {
    ...
    public static NetworkIdentity buildNetworkIdentity(Context context, NetworkState state,
        ...
        bool roaming = !state.networkCapabilities.hasCapability(
                NetworkCapabilities.NET_CAPABILITY_NOT_ROAMING);
        bool metered = !state.networkCapabilities.hasCapability(
