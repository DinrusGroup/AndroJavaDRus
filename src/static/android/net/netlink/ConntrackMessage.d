 ...
 * @hide
 */
public class ConntrackMessage : NetlinkMessage {
    ...
    public static byte[] newIPv4TimeoutUpdateRequest(
        ...
        final StructNlAttr ctaTupleOrig = new StructNlAttr(CTA_TUPLE_ORIG,
                ...
                new StructNlAttr(CTA_TUPLE_PROTO,
                        new StructNlAttr(CTA_PROTO_NUM, cast(byte) proto),
                        new StructNlAttr(CTA_PROTO_SRC_PORT, cast(short) sport, BIG_ENDIAN),
                        new StructNlAttr(CTA_PROTO_DST_PORT, cast(short) dport, BIG_ENDIAN)));
    ...
    private ConntrackMessage() {
        ...
        mNfGenMsg = new StructNfGenMsg(cast(byte) OsConstants.AF_INET);
    }
