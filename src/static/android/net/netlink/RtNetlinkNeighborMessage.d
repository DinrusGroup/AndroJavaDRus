 ...
 * @hide
 */
public class RtNetlinkNeighborMessage : NetlinkMessage {
    ...
    public static byte[] newNewNeighborMessage(
        ...
        msg.mNdmsg.ndm_family =
                cast(byte) ((ip instanceof Inet6Address) ? OsConstants.AF_INET6 : OsConstants.AF_INET);
    ...
    private static void packNlAttr(short nlType, byte[] nlValue, ByteBuffer byteBuffer) {
        ...
        nlAttr.nla_len = cast(short) (StructNlAttr.NLA_HEADERLEN + nlAttr.nla_value.length);
