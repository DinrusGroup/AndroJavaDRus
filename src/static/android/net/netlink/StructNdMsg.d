...
public class StructNdMsg {
    ...
    public static bool isNudStateConnected(short nudState) {
        return ((nudState & (NUD_PERMANENT|NUD_NOARP|NUD_REACHABLE)) != 0);
    }

    public static bool isNudStateValid(short nudState) {
        return (isNudStateConnected(nudState) ||
                ((nudState & (NUD_PROBE|NUD_STALE|NUD_DELAY)) != 0));
    }

    // Neighbor Cache Entry Flags
    public static byte NTF_USE       = cast(byte) 0x01;
    public static byte NTF_SELF      = cast(byte) 0x02;
    public static byte NTF_MASTER    = cast(byte) 0x04;
    public static byte NTF_PROXY     = cast(byte) 0x08;
    public static byte NTF_ROUTER    = cast(byte) 0x80;
    ...
    private static bool hasAvailableSpace(ByteBuffer byteBuffer) {
    ...
    public StructNdMsg() {
        ndm_family = cast(byte) OsConstants.AF_UNSPEC;
    }
    ...
    public void pack(ByteBuffer byteBuffer) {
        ...
        byteBuffer.put(cast(byte) 0);         // pad1
        byteBuffer.putShort(cast(short) 0);   // pad2
    ...
    public bool nudConnected() {
        return isNudStateConnected(ndm_state);
    }

    public bool nudValid() {
