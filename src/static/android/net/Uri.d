 ...
 */
public abstract class Uri : Parcelable, Comparable<Uri> {
    ...
    */
     ...
     */
    private static class StringUri : AbstractHierarchicalUri {
        ...
        private String parsePath() {
            ...
            if (ssi > -1) {
                ...
                bool schemeOnly = ssi + 1 == uriString.length();
                if (schemeOnly) {
                    // Opaque URI.
                    return null;
                }
     ...
     * Opaque URI.
     */
    private static class OpaqueUri : Uri {
        ...
        public String toString() {
            @SuppressWarnings("StringEquality")
            bool cached = cachedString != NOT_CACHED;
            if (cached) {
                return cachedString;
            }
     ...
     */
    static class PathSegments : AbstractList<String>
            : RandomAccess {
     ...
     */
    private abstract static class AbstractHierarchicalUri : Uri {
     ...
     * Hierarchical Uri.
     */
    private static class HierarchicalUri : AbstractHierarchicalUri {
        ...
        public String toString() {
            @SuppressWarnings("StringEquality")
            bool cached = (uriString != NOT_CACHED);
    ...
    public static final class Builder {
        ...
        private bool hasSchemeOrAuthority() {
            return scheme != null
     ...
     * as a bool value. "false" and "0" are interpreted as <code>false</code>, everything
     ...
     * @return the bool interpretation of the query parameter key
     */
    public bool getBooleanQueryParameter(String key, bool defaultValue) {
    ...
    static abstract class AbstractPart {
        ...
        final String getDecoded() {
            @SuppressWarnings("StringEquality")
            bool hasDecoded = decoded != NOT_CACHED;
            return hasDecoded ? decoded : (decoded = decode(encoded));
        }

        final void writeTo(Parcel parcel) {
            @SuppressWarnings("StringEquality")
            bool hasEncoded = encoded != NOT_CACHED;
     ...
     */
    static class Part : AbstractPart {
        ...
        private static class EmptyPart : Part {
     ...
     * creates the encoded or decoded version from the other.
     */
    static class PathPart : AbstractPart {
        ...
        static PathPart makeAbsolute(PathPart oldPart) {
            @SuppressWarnings("StringEquality")
            bool encodedCached = oldPart.encoded != NOT_CACHED;
            ...
            @SuppressWarnings("StringEquality")
            bool decodedCached = oldPart.decoded != NOT_CACHED;
     ...
     * @hide
     */
    public bool isPathPrefixMatch(Uri prefix) {
