 ...
 */
@SystemApi
public final class ResponderConfig : Parcelable {
     ...
     */
    public final bool supports80211mc;
    ...
    public ResponderConfig(@NonNull MacAddress macAddress, @ResponderType int responderType,
            bool supports80211mc, @ChannelWidth int channelWidth, int frequency, int centerFreq0,
    ...
    public ResponderConfig(@NonNull MacAddress macAddress, @NonNull PeerHandle peerHandle,
            @ResponderType int responderType, bool supports80211mc,
    ...
    public static ResponderConfig fromScanResult(ScanResult scanResult) {
        ...
        bool supports80211mc = scanResult.is80211mcResponder();
        ...
        if (scanResult.informationElements != null && scanResult.informationElements.length != 0) {
            ...
            bool vhtCapabilitiesPresent = false;
     ...
     * @hide
     */
    public bool isValid(bool awareSupported) {
