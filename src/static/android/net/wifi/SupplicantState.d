 ...
 */
public enum SupplicantState : Parcelable {
    /**
    ...
    /** @hide */
    public static bool isConnecting(SupplicantState state) {
        switch(state) {
            case AUTHENTICATING:
            case ASSOCIATING:
            case ASSOCIATED:
    ...
    /** @hide */
    public static bool isDriverActive(SupplicantState state) {
        switch(state) {
            case DISCONNECTED:
            case DORMANT:
            case INACTIVE:
