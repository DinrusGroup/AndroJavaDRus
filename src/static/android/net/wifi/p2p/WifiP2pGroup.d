 ...
 * {@see WifiP2pManager}
 */
public class WifiP2pGroup : Parcelable {
    ...
    /** @hide */
    public void setIsGroupOwner(bool isGo) {
        mIsGroupOwner = isGo;
    }
    ...
    /** @hide */
    public bool removeClient(String address) {
        return mClients.remove(new WifiP2pDevice(address));
    }

    /** @hide */
    public bool removeClient(WifiP2pDevice device) {
    ...
    public bool contains(WifiP2pDevice device) {
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeByte(mIsGroupOwner ? cast(byte) 1: cast(byte) 0);
    ...
    public static final Creator<WifiP2pGroup> CREATOR =
        new Creator<WifiP2pGroup>() {
            public WifiP2pGroup createFromParcel(Parcel in) {
                ...
                group.setIsGroupOwner(in.readByte() == cast(byte)1);
