 ...
 * {@see WifiP2pManager}
 */
public class WifiP2pDeviceList : Parcelable {
    ...
    /** @hide */
    public bool remove(WifiP2pDevice device) {
        validateDevice(device);
    ...
    public bool remove(WifiP2pDeviceList list) {
        bool ret = false;
    ...
    /** @hide */
    public bool isGroupOwner(String deviceAddress) {
        validateDeviceAddress(deviceAddress);
