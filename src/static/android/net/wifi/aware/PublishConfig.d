 ...
 */
public final class PublishConfig : Parcelable {
    /** @hide */
    @IntDef({
    ...
    /** @hide */
    public final bool mEnableRanging;

    /** @hide */
    public PublishConfig(byte[] serviceName, byte[] serviceSpecificInfo, byte[] matchFilter,
            int publishType, int ttlSec, bool enableTerminateNotification,
            bool enableRanging) {
    ...
    public static final Creator<PublishConfig> CREATOR = new Creator<PublishConfig>() {
        ...
        public PublishConfig createFromParcel(Parcel in) {
            ...
            bool enableRanging = in.readInt() != 0;
    ...
    public static final class Builder {
        ...
        private bool mEnableRanging = false;
         ...
         * {@link #setTerminateNotificationEnabled(bool)} disables the callback].
         * <p>
         ...
         *         {@code builder.setXXX(..).setXXX(..)}.
         */
        public Builder setRangingEnabled(bool enable) {
