...
public class WifiAwareManager {
     ...
     *
     * @return A bool indicating whether the app can use the Aware API at this time (true) or
     * not (false).
     */
    ...
    private static class WifiAwareEventCallbackProxy : IWifiAwareEventCallback.Stub {
    ...
    private static class WifiAwareDiscoverySessionCallbackProxy :
        ...
        WifiAwareDiscoverySessionCallbackProxy(WifiAwareManager mgr, Looper looper,
                bool isPublish, DiscoverySessionCallback originalCallback,
                int clientId) {
            mAwareManager = new WeakReference<>(mgr);
