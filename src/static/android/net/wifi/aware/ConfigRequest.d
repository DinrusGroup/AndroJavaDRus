 ...
 * @hide
 */
public final class ConfigRequest : Parcelable {
    /**
     ...
     */
    public final bool mSupport5gBand;
    ...
    private ConfigRequest(bool support5gBand, int masterPreference, int clusterLow,
    ...
    public static final Creator<ConfigRequest> CREATOR = new Creator<ConfigRequest>() {
        ...
        public ConfigRequest createFromParcel(Parcel in) {
            bool support5gBand = in.readInt() != 0;
    ...
    public static final class Builder {
        private bool mSupport5gBand = false;
         ...
         */
        public Builder setSupport5gBand(bool support5gBand) {
            mSupport5gBand = support5gBand;
            return this;
        }
