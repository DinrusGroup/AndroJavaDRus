...
public class WifiManager {
     ...
     * {@code true} for ESS.
     *
     * Retrieve with {@link android.content.Intent#getBooleanExtra(String, bool)}.
     *
     * @hide
     */
     ...
     * lost. One extra provides the connection state as a bool, where {@code true}
     * means CONNECTED.
     * @deprecated This is no longer supported.
    ...
    /**
     * The lookup key for a bool that indicates whether a connection to
     ...
     * and a {@code bool} value indicating if the scan was successful.
     */
    @SdkConstant(SdkConstantType.BROADCAST_INTENT_ACTION)
    public static final String SCAN_RESULTS_AVAILABLE_ACTION = "android.net.wifi.SCAN_RESULTS";

    /**
     * Lookup key for a {@code bool} extra in intent {@link #SCAN_RESULTS_AVAILABLE_ACTION}
    ...
    /** @hide */
    public static final bool DEFAULT_POOR_NETWORK_AVOIDANCE_ENABLED = false;
     ...
     */
    public bool removeNetwork(int netId) {
        try {
     ...
     * @return {@code true} if the operation succeeded
     */
    public bool enableNetwork(int netId, bool attemptConnect) {
        final bool pin = attemptConnect && mTargetSdkVersion < Build.VERSION_CODES.LOLLIPOP;
        if (pin) {
    ...
    private bool isFeatureSupported(int feature) {
     ...
     * @hide
     */
    public bool isPasspointSupported() {
     ...
     */
    @SystemApi
    public bool isPortableHotspotSupported() {
     ...
     */
    @SystemApi
    public bool isWifiScannerSupported() {
     ...
     * @hide
     */
    public bool isWifiAwareSupported() {
     ...
     */
    @SystemApi
    public bool isDeviceToDeviceRttSupported() {
     ...
     * @hide
     */
    public bool isAdditionalStaSupported() {
     ...
     * @hide
     */
    public bool isOffChannelTdlsSupported() {
    ...
    public bool startScan(WorkSource workSource) {
        try {
    ...
    */
     ...
     * @hide
     */
    public bool isDualModeSupported() {
        try {
     ...
     * @hide
     */
    public bool startSoftAp(@Nullable WifiConfiguration wifiConfig) {
        try {
     ...
     */
    public void setTdlsEnabled(InetAddress remoteIPAddress, bool enable) {
        try {
    ...
    /**
     * Similar to {@link #setTdlsEnabled(InetAddress, bool) }, except
     ...
     * @param enable true = setup and false = tear down TDLS
     */
    public void setTdlsEnabledWithMacAddress(String remoteMacAddress, bool enable) {
        try {
     ...
     * @hide
     */
    private static class SoftApCallbackProxy : ISoftApCallback.Stub {
     ...
     */
    public class LocalOnlyHotspotReservation : AutoCloseable {
     ...
     * @hide
     */
    public class LocalOnlyHotspotSubscription : AutoCloseable {
        private final CloseGuard mCloseGuard = CloseGuard.get();
    ...
    public class WifiLock {
         ...
         */
        public void setReferenceCounted(bool refCounted) {
     ...
     */
    public bool initializeMulticastFiltering() {
        try {
     ...
     * @deprecated
     */
    public bool setEnableAutoJoinWhenAssociated(bool enabled) {
        return false;
    }
     ...
     * @deprecated
     */
    public bool getEnableAutoJoinWhenAssociated() {
        return false;
    }
    ...
    private static class ProvisioningCallbackProxy : IProvisioningCallback.Stub {
        private final Handler mHandler;
