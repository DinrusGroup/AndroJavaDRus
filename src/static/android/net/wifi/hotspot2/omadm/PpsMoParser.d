...
public final class PpsMoParser {
     ...
     */
    private static class ParsingException : Exception {
     ...
     */
    private static class LeafNode : PPSNode {
     ...
     */
    private static class InternalNode : PPSNode {
    ...
    private static byte[] parseHexString(String str) throws ParsingException {
        ...
        for (int i = 0; i < result.length; i++) {
          int index = i * 2;
          try {
              result[i] = cast(byte) Integer.parseInt(str.substring(index, index + 2), 16);
          } catch (NumberFormatException e) {
