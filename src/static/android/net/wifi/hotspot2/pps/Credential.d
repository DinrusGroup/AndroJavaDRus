 ...
 */
public final class Credential : Parcelable {
    ...
    * Using Long.MIN_VALUE to indicate unset value.
     ...
     */
    private bool mCheckAaaServerCertStatus = false;
    /**
     * @hide
     */
    public void setCheckAaaServerCertStatus(bool checkAaaServerCertStatus) {
        mCheckAaaServerCertStatus = checkAaaServerCertStatus;
    }
    /**
     * @hide
     */
    public bool getCheckAaaServerCertStatus() {
     ...
     */
    public static final class UserCredential : Parcelable {
        /**
         ...
         */
        private bool mMachineManaged = false;
        /**
         * @hide
         */
        public void setMachineManaged(bool machineManaged) {
            mMachineManaged = machineManaged;
        }
        /**
         * @hide
         */
        public bool getMachineManaged() {
         ...
         */
        private bool mAbleToShare = false;
        /**
         * @hide
         */
        public void setAbleToShare(bool ableToShare) {
            mAbleToShare = ableToShare;
        }
        /**
         * @hide
         */
        public bool getAbleToShare() {
            return mAbleToShare;
        }
        ...
        override
        public bool equals(Object thatObject) {
            if (this == thatObject) {
                return true;
            }
     ...
     */
    public static final class CertificateCredential : Parcelable {
        /**
     ...
     */
    public static final class SimCredential : Parcelable {
        /**
     ...
     */
    private bool verifyUserCredential() {
        if (mUserCredential == null) {
     ...
     */
    private bool verifyCertCredential() {
        if (mCertCredential == null) {
     ...
     */
    private bool verifySimCredential() {
        if (mSimCredential == null) {
    ...
    private static bool isPrivateKeyEquals(PrivateKey key1, PrivateKey key2) {
    ...
    private static bool isX509CertificateEquals(X509Certificate cert1, X509Certificate cert2) {
    ...
    private static bool isX509CertificatesEquals(X509Certificate[] certs1,
     ...
     */
    private static bool verifySha256Fingerprint(X509Certificate[] certChain,
