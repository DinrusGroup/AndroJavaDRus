...
public class WifiScanner {
    ...
    public static class ChannelSpec {
         ...
         * @hide
         */
        public bool passive;                                    /* ignored on DFS channels */
        /**
     ...
     */
    public static class ScanSettings : Parcelable {
        /**
     ...
     */
    public static class ScanData : Parcelable {
        /** scan identifier */
        private int mId;
         ...
         * {@hide}
         */
        private bool mAllChannelsScanned;
        ...
        /** {@hide} */
        public ScanData(int id, int flags, int bucketsScanned, bool allChannelsScanned,
                ScanResult[] results) {
            mId = id;
            mFlags = flags;
        ...
        /** {@hide} */
        public bool isAllChannelsScanned() {
        ...
        public static final Creator<ScanData> CREATOR =
                new Creator<ScanData>() {
                    public ScanData createFromParcel(Parcel in) {
                        ...
                        bool allChannelsScanned = in.readInt() != 0;
                        int n = in.readInt();
    ...
    public static class ParcelableScanData : Parcelable {
    ...
    public static class ParcelableScanResults : Parcelable {
     ...
     * {@hide}
     */
    public static class PnoSettings : Parcelable {
        /**
     ...
     * {@link #startScan}
     */
    public interface ScanListener : ActionListener {
        /**
     ...
     * {@hide}
     */
    public interface PnoScanListener : ScanListener {
        /**
    ...
    @SystemApi
    @Deprecated
    public static class WifiChangeSettings : Parcelable {
     ...
     */
    @Deprecated
    public interface WifiChangeListener : ActionListener {
    ...
    @Deprecated
    public static interface BssidListener : ActionListener {
    ...
    @SystemApi
    @Deprecated
    public static class HotlistSettings : Parcelable {
        public BssidInfo[] bssidInfos;
    ...
    private int addListener(ActionListener listener) {
        synchronized (mListenerMapLock) {
            bool keyExists = (getListenerKey(listener) != INVALID_KEY);
    ...
    /** @hide */
    public static class OperationResult : Parcelable {
        public int reason;
