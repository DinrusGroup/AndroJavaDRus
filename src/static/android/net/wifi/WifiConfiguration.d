 ...
 */
public class WifiConfiguration : Parcelable {
    ...
    */
     ...
     */
    public bool isHomeProviderNetwork;
     ...
     */
    public bool validatedInternetAccess;
     ...
     * @hide
     */
    public bool isLegacyPasspointConfig = false;
    /**
     * @hide
     ...
     */
    @SystemApi
    public bool hasNoInternetAccess() {
     ...
     * @hide
     */
    public bool noInternetAccessExpected;
     ...
     */
    @SystemApi
    public bool isNoInternetAccessExpected() {
     ...
     * This bool is cleared if we get a connect/save/ update or
     ...
     * @hide
     */
    public bool selfAdded;

    /**
     * Set if the configuration was self added by the framework
     * This bool is set once and never cleared. It is used
     * so as we never loose track of who created the
     * configuration in the first place.
     * @hide
     */
    public bool didSelfAdd;
     ...
     * @hide
     */
    public static bool isMetered(WifiConfiguration config, WifiInfo info) {
        bool metered = false;
    ...
    public bool isOpenNetwork() {
        ...
        final bool hasNoKeyMgmt = cardinality == 0
                || (cardinality == 1 && allowedKeyManagement.get(KeyMgmt.NONE));

        bool hasNoWepKeys = true;
        if (wepKeys != null) {
     ...
     */
    public static bool isValidMacAddressForRandomization(MacAddress mac) {
    ...
    public static class NetworkSelectionStatus {
         ...
         */
        private bool mSeenInLastQualifiedNetworkSelection;
         ...
         */
        private bool mHasEverConnected;
         ...
         */
        public void setSeenInLastQualifiedNetworkSelection(bool seen) {
         ...
         */
        public bool getSeenInLastQualifiedNetworkSelection() {
        ...
        public void setHasEverConnected(bool value) {
            mHasEverConnected = value;
        }

        public bool getHasEverConnected() {
         ...
         */
        public bool isNetworkTemporaryDisabled() {
         ...
         */
        public bool isNetworkPermanentlyDisabled() {
         ...
         */
        public bool isDisabledByReason(int reason) {
     ...
     * @hide
     */
    public bool isLinked(WifiConfiguration config) {
        if (config != null) {
     ...
     */
    public String configKey(bool allowCached) {
        String key;
