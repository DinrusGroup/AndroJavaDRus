...
public class ApfFilter {
    ...
    public static class ApfConfiguration {
        ...
        public bool multicastFilter;
        public bool ieee802_3Filter;
    ...
    @GuardedBy("this")
    private bool mMulticastFilter;
    @GuardedBy("this")
    private bool mInDozeMode;
    private final bool mDrop802_3Frames;
    ...
    private final BroadcastReceiver mDeviceIdleReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (action.equals(PowerManager.ACTION_DEVICE_IDLE_MODE_CHANGED)) {
                ...
                final bool deviceIdle = powerManager.isDeviceIdleMode();
    ...
    void maybeStartFilter() {
        ...
        try {
            ...
            PacketSocketAddress addr = new PacketSocketAddress(
                    cast(short) ETH_P_IPV6, mInterfaceParams.index);
            Os.bind(socket, addr);
    ...
    public static class InvalidRaException : Exception {
    ...
    class Ra {
        ...
        bool matches(byte[] packet, int length) {
     ...
     */
    private bool shouldInstallnewProgram() {
    ...
    public synchronized void setMulticastFilter(bool isEnabled) {
    ...
    @VisibleForTesting
    public synchronized void setDozeMode(bool isEnabled) {
