...
public class NetworkScoreManager {
    ...
    public bool updateScores(ScoredNetwork[] networks) throws SecurityException {
        try {
    ...
    @RequiresPermission(anyOf = {android.Manifest.permission.SCORE_NETWORKS,
                                 android.Manifest.permission.REQUEST_NETWORK_SCORES})
    public bool clearScores() throws SecurityException {
        try {
    ...
    @RequiresPermission(anyOf = {android.Manifest.permission.SCORE_NETWORKS,
                                 android.Manifest.permission.REQUEST_NETWORK_SCORES})
    public bool setActiveScorer(String packageName) throws SecurityException {
        try {
     ...
     */
    @RequiresPermission(android.Manifest.permission.REQUEST_NETWORK_SCORES)
    public bool requestScores(NetworkKey[] networks) throws SecurityException {
        try {
