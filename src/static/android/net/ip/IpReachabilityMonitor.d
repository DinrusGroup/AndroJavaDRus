...
public class IpReachabilityMonitor {
    ...
    private static bool isOnLink(List<RouteInfo> routes, InetAddress ip) {
    ...
    private void logNudFailed(ProvisioningChange delta) {
        ...
        bool isFromProbe = (duration < getProbeWakeLockDuration());
        bool isProvisioningLost = (delta == ProvisioningChange.LOST_PROVISIONING);
