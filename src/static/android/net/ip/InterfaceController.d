...
public class InterfaceController {
    ...
    public bool setIPv4Address(LinkAddress address) {
    ...
    public bool setIPv6PrivacyExtensions(bool enabled) {
        try {
    ...
    public bool setIPv6AddrGenModeIfSupported(int mode) {
        try {
    ...
    public bool addAddress(LinkAddress addr) {
        return addAddress(addr.getAddress(), addr.getPrefixLength());
    }

    public bool addAddress(InetAddress ip, int prefixLen) {
        try {
    ...
    public bool removeAddress(InetAddress ip, int prefixLen) {
        try {
