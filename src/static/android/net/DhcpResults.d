 ...
 * @hide
 */
public class DhcpResults : StaticIpConfiguration {
    ...
    public bool setIpAddress(String addrString, int prefixLength) {
        try {
    ...
    public bool setGateway(String addrString) {
        try {
    ...
    public bool addDns(String addrString) {
    ...
    public bool setServerAddress(String addrString) {
        try {
