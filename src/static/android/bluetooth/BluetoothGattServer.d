 ...
 * of this class.
 */
public final class BluetoothGattServer : BluetoothProfile {
    ...
    private final IBluetoothGattServerCallback mBluetoothGattServerCallback =
            new IBluetoothGattServerCallback.Stub() {
                ...
                public void onCharacteristicReadRequest(String address, int transId,
                        int offset, bool isLong, int handle) {
                ...
                public void onCharacteristicWriteRequest(String address, int transId,
                        int offset, int length, bool isPrep, bool needRsp,
                ...
                public void onDescriptorWriteRequest(String address, int transId, int offset,
                        int length, bool isPrep, bool needRsp, int handle, byte[] value) {
     ...
     * error
     */
    /*package*/ bool registerCallback(BluetoothGattServerCallback callback) {
     ...
     */
    public bool sendResponse(BluetoothDevice device, int requestId,
     ...
     */
    public bool notifyCharacteristicChanged(BluetoothDevice device,
