 ...
 */
public final class BluetoothHeadset : BluetoothProfile {
     ...
     * @hide
     */
    public static bool isBluetoothVoiceDialingEnabled(Context context) {
     ...
     * @hide
     */
    public void setAudioRouteAllowed(bool allowed) {
    ...
    /**
     * Returns whether audio routing is allowed. see {@link #setAudioRouteAllowed(bool)}.
     * Note: This is an internal function and shouldn't be exposed
     *
     * @hide
     */
    public bool getAudioRouteAllowed() {
     ...
     * @hide
     */
    public void setForceScoAudio(bool forced) {
    ...
    public bool startScoUsingVirtualVoiceCall() {
     ...
     */
    @RequiresPermission(Manifest.permission.BLUETOOTH_ADMIN)
    public bool stopScoUsingVirtualVoiceCall() {
     ...
     * @hide
     */
    public void clccResponse(int index, int direction, int status, int mode, bool mpty,
     ...
     */
    public bool sendVendorSpecificResultCode(BluetoothDevice device, String command,
            String arg) {
        if (DBG) {
     ...
     */
    @RequiresPermission(android.Manifest.permission.BLUETOOTH_ADMIN)
    public bool setActiveDevice(@Nullable BluetoothDevice device) {
        if (DBG) {
     ...
     */
    @RequiresPermission(android.Manifest.permission.BLUETOOTH)
    public bool isInbandRingingEnabled() {
        if (DBG) {
     ...
     * @hide
     */
    public static bool isInbandRingingSupported(Context context) {
        return context.getResources().getBoolean(
