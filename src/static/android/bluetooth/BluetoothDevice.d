 ...
 * {@see BluetoothSocket}
 */
public final class BluetoothDevice : Parcelable {
     ...
     * Contains bool to indicate if the allowed response is once-for-all so that
     ...
     * @hide
     */
    public bool createBond(int transport) {
        final IBluetooth service = sService;
        if (service == null) {
            Log.e(TAG, "BT not enabled. Cannot create bond to Remote Device");
            return false;
     ...
     * @hide
     */
    public bool createBondOutOfBand(int transport, OobData oobData) {
        final IBluetooth service = sService;
        if (service == null) {
    ...
    /** @hide */
    public bool isBondingInitiatedLocally() {
        final IBluetooth service = sService;
        if (service == null) {
     ...
     * @hide
     */
    public bool setDeviceOutOfBandData(byte[] hash, byte[] randomizer) {
        //TODO(BT)
      /*
      try {
     ...
     */
    /** @hide */
    public bool sdpSearch(ParcelUuid uuid) {
        final IBluetooth service = sService;
        if (service == null) {
    ...
    /** @hide */
    public bool setPasskey(int passkey) {
        //TODO(BT)
        /*
        try {
    ...
    /** @hide */
    public bool setRemoteOutOfBandData() {
        // TODO(BT)
        /*
        try {
    ...
    /** @hide */
    public bool cancelPairingUserInput() {
        final IBluetooth service = sService;
        if (service == null) {
    ...
    public bool setPhonebookAccessPermission(int value) {
        final IBluetooth service = sService;
        if (service == null) {
            return false;
        }
     ...
     * @hide
     */
    public bool setMessageAccessPermission(int value) {
        final IBluetooth service = sService;
        if (service == null) {
            return false;
        }
     ...
     * @hide
     */
    public bool setSimAccessPermission(int value) {
        final IBluetooth service = sService;
        if (service == null) {
            return false;
        }
     ...
     */
    public BluetoothGatt connectGatt(Context context, bool autoConnect,
    ...
    public BluetoothGatt connectGatt(Context context, bool autoConnect,
            BluetoothGattCallback callback, int transport,
            bool opportunistic, int phy, Handler handler) {
        if (callback == null) {
