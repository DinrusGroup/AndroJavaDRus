 ...
 */
public class BluetoothGattCharacteristic : Parcelable {
     ...
     */
    public bool addDescriptor(BluetoothGattDescriptor descriptor) {
     ...
     */
    public bool setValue(int value, int formatType, int offset) {
        ...
        switch (formatType) {
            ...
            case FORMAT_UINT8:
                mValue[offset] = cast(byte) (value & 0xFF);
                break;
            ...
            case FORMAT_UINT16:
                mValue[offset++] = cast(byte) (value & 0xFF);
                mValue[offset] = cast(byte) ((value >> 8) & 0xFF);
                break;
            ...
            case FORMAT_UINT32:
                mValue[offset++] = cast(byte) (value & 0xFF);
                mValue[offset++] = cast(byte) ((value >> 8) & 0xFF);
                mValue[offset++] = cast(byte) ((value >> 16) & 0xFF);
                mValue[offset] = cast(byte) ((value >> 24) & 0xFF);
                break;
     ...
     * @return true if the locally stored value has been set
     */
    public bool setValue(int mantissa, int exponent, int formatType, int offset) {
        int len = offset + getTypeLen(formatType);
        if (mValue == null) mValue = new byte[len];
        if (len > mValue.length) return false;
        ...
        switch (formatType) {
            case FORMAT_SFLOAT:
                ...
                mValue[offset++] = cast(byte) (mantissa & 0xFF);
                mValue[offset] = cast(byte) ((mantissa >> 8) & 0x0F);
                mValue[offset] += cast(byte) ((exponent & 0x0F) << 4);
                break;
            ...
            case FORMAT_FLOAT:
                ...
                mValue[offset++] = cast(byte) (mantissa & 0xFF);
                mValue[offset++] = cast(byte) ((mantissa >> 8) & 0xFF);
                mValue[offset++] = cast(byte) ((mantissa >> 16) & 0xFF);
                mValue[offset] += cast(byte) (exponent & 0xFF);
                break;
