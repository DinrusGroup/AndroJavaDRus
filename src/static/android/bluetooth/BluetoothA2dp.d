 ...
 */
public final class BluetoothA2dp : BluetoothProfile {
     ...
     * @hide
     */
    public bool isAvrcpAbsoluteVolumeSupported() {
     ...
     * @hide
     */
    public bool shouldSendVolumeKeys(BluetoothDevice device) {
     ...
     */
    private void enableDisableOptionalCodecs(BluetoothDevice device, bool enable) {
        try {
            mServiceLock.readLock().lock();
            if (mService != null && isEnabled()) {
                if (enable) {
    ...
    private bool isValidDevice(BluetoothDevice device) {
