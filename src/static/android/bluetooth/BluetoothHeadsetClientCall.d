 ...
 * It : {@link Parcelable} for inter-process message passing.
 *
 * @hide
 */
public final class BluetoothHeadsetClientCall : Parcelable {
    ...
    private bool mMultiParty;
    private final bool mOutgoing;
    private final UUID mUUID;
    private final long mCreationElapsedMilli;
    private final bool mInBandRing;
    ...
    public BluetoothHeadsetClientCall(BluetoothDevice device, int id, UUID uuid, int state,
            String number, bool multiParty, bool outgoing, bool inBandRing) {
        mDevice = device;
        mId = id;
        mUUID = uuid;
        mState = state;
     ...
     */
    public void setMultiParty(bool multiParty) {
        mMultiParty = multiParty;
    }
     ...
     * @return log string
     */
    public String toString(bool loggable) {
