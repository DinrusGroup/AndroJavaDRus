 ...
 * @hide
 */
public final class BluetoothHeadsetClient : BluetoothProfile {
    ...
    /* Extras for AG_FEATURES, extras type is bool */
     ...
     */
    public bool setPriority(BluetoothDevice device, int priority) {
     ...
     * is not supported.</p>
     */
    public bool startVoiceRecognition(BluetoothDevice device) {
     ...
     * is not supported.</p>
     */
    public bool stopVoiceRecognition(BluetoothDevice device) {
     ...
     */
    public bool acceptCall(BluetoothDevice device, int flag) {
     ...
     * otherwise; upon completion HFP sends {@link #ACTION_CALL_CHANGED} intent.
     */
    public bool holdCall(BluetoothDevice device) {
        if (DBG) log("holdCall()");
        final IBluetoothHeadsetClient service = mService;
        if (service != null && isEnabled() && isValidDevice(device)) {
            try {
     ...
     * supported.</p>
     */
    public bool rejectCall(BluetoothDevice device) {
     ...
     * supported.</p>
     */
    public bool terminateCall(BluetoothDevice device, BluetoothHeadsetClientCall call) {
     ...
     * supported.</p>
     */
    public bool enterPrivateMode(BluetoothDevice device, int index) {
     ...
     * is not supported.</p>
     */
    public bool explicitCallTransfer(BluetoothDevice device) {
     ...
     */
    public bool sendDTMF(BluetoothDevice device, byte code) {
        if (DBG) log("sendDTMF()");
        final IBluetoothHeadsetClient service = mService;
        if (service != null && isEnabled() && isValidDevice(device)) {
            try {
     ...
     */
    public bool getLastVoiceTagNumber(BluetoothDevice device) {
     ...
     */
    public void setAudioRouteAllowed(BluetoothDevice device, bool allowed) {
     ...
     * exposed
     */
    public bool getAudioRouteAllowed(BluetoothDevice device) {
     ...
     */
    public bool connectAudio(BluetoothDevice device) {
        final IBluetoothHeadsetClient service = mService;
        if (service != null && isEnabled()) {
            try {
     ...
     * otherwise; upon completion HFP sends {@link #ACTION_AUDIO_STATE_CHANGED} intent;
     */
    public bool disconnectAudio(BluetoothDevice device) {
        final IBluetoothHeadsetClient service = mService;
        if (service != null && isEnabled()) {
            try {
    ...
    private static bool isValidDevice(BluetoothDevice device) {
