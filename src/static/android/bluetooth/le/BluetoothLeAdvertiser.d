...
public final class BluetoothLeAdvertiser {
    ...
    AdvertisingSetCallback wrapOldCallback(AdvertiseCallback callback, AdvertiseSettings settings) {
        return new AdvertisingSetCallback() {
            ...
            override
            public void onAdvertisingEnabled(AdvertisingSet advertisingSet, bool enabled,
                    int status) {
                if (enabled) {
    ...
    public void startAdvertisingSet(AdvertisingSetParameters parameters,
        ...
        if (parameters.isLegacy()) {
            ...
            bool supportCodedPhy = mBluetoothAdapter.isLeCodedPhySupported();
            bool support2MPhy = mBluetoothAdapter.isLe2MPhySupported();
            ...
            bool supportPeriodic = mBluetoothAdapter.isLePeriodicAdvertisingSupported();
    ...
    private int totalBytes(AdvertiseData data, bool isFlagsIncluded) {
    ...
    IAdvertisingSetCallback wrap(AdvertisingSetCallback callback, Handler handler) {
        return new IAdvertisingSetCallback.Stub() {
            ...
            override
            public void onAdvertisingEnabled(int advertiserId, bool enabled, int status) {
                handler.post(new Runnable() {
                    override
                    public void run() {
                        AdvertisingSet advertisingSet = mAdvertisingSets.get(advertiserId);
            ...
            override
            public void onPeriodicAdvertisingEnabled(int advertiserId, bool enable, int status) {
                handler.post(new Runnable() {
                    override
                    public void run() {
                        AdvertisingSet advertisingSet = mAdvertisingSets.get(advertiserId);
