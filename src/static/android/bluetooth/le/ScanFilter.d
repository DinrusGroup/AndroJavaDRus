 ...
 */
public final class ScanFilter : Parcelable {
     ...
     * @hide
     */
    public static bool matchesServiceUuids(ParcelUuid uuid, ParcelUuid parcelUuidMask,
    ...
    private static bool matchesServiceUuid(UUID uuid, UUID mask, UUID data) {
        return BitUtils.maskedEquals(data, uuid, mask);
    }

    // Check whether the data pattern matches the parsed data.
    private bool matchesPartialData(byte[] data, byte[] dataMask, byte[] parsedData) {
