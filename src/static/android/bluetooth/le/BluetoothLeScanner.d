...
public final class BluetoothLeScanner {
     ...
     */
    private class BleScanCallbackWrapper : IScannerCallback.Stub {
        ...
        override
        public void onFoundOrLost(final bool onFound, final ScanResult scanResult) {
            if (VDBG) {
    ...
    private bool isSettingsConfigAllowedForScan(ScanSettings settings) {
    ...
    private bool isSettingsAndFilterComboAllowed(ScanSettings settings,
    ...
    private bool isHardwareResourcesAvailableForScan(ScanSettings settings) {
        final int callbackType = settings.getCallbackType();
