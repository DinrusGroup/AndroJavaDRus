 ...
 */
public final class BluetoothHealth : BluetoothProfile {
     ...
     */
    public bool registerSinkAppConfiguration(String name, int dataType,
     ...
     * @hide
     */
    public bool registerAppConfiguration(String name, int dataType, int role,
     ...
     */
    public bool unregisterAppConfiguration(BluetoothHealthAppConfiguration config) {
        bool result = false;
        final IBluetoothHealth service = mService;
     ...
     */
    public bool connectChannelToSource(BluetoothDevice device,
            BluetoothHealthAppConfiguration config) {
        final IBluetoothHealth service = mService;
     ...
     * @hide
     */
    public bool connectChannelToSink(BluetoothDevice device,
     ...
     * @return If true, the callback associated with the application config will be called.
     */
    public bool disconnectChannel(BluetoothDevice device,
    ...
    private static class BluetoothHealthCallbackWrapper : IBluetoothHealthCallback.Stub {
    ...
    private bool checkAppParam(String name, int role, int channelType,
            BluetoothHealthCallback callback) {
