 ...
 * scan process.
 */
public final class BluetoothGatt : BluetoothProfile {
    ...
    /*package*/ BluetoothGatt(IBluetoothGatt iGatt, BluetoothDevice device,
            int transport, bool opportunistic, int phy) {
        mService = iGatt;
        mDevice = device;
     ...
     * error
     */
    private bool registerApp(BluetoothGattCallback callback, Handler handler) {
     ...
     */
    /*package*/ bool connect(Boolean autoConnect, BluetoothGattCallback callback,
            Handler handler) {
        if (DBG) {
            Log.d(TAG,
     ...
     * @hide
     */
    public bool discoverServiceByUuid(UUID uuid) {
     ...
     */
    public bool readCharacteristic(BluetoothGattCharacteristic characteristic) {
     ...
     * @hide
     */
    public bool readUsingCharacteristicUuid(UUID uuid, int startHandle, int endHandle) {
     ...
     * @return true, if the read operation was initiated successfully
     */
    public bool readDescriptor(BluetoothGattDescriptor descriptor) {
     ...
     * @return true, if the write operation was initiated successfully
     */
    public bool writeDescriptor(BluetoothGattDescriptor descriptor) {
     ...
     */
    public bool setCharacteristicNotification(BluetoothGattCharacteristic characteristic,
            bool enable) {
        if (DBG) {
     ...
     */
    public bool requestConnectionPriority(int connectionPriority) {
     ...
     * @hide
     */
    public bool requestLeConnectionUpdate(int minConnectionInterval, int maxConnectionInterval,
