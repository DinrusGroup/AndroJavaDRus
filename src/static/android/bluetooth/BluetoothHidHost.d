 ...
 * @hide
 */
public final class BluetoothHidHost : BluetoothProfile {
     ...
     * @hide
     */
    public bool virtualUnplug(BluetoothDevice device) {
     ...
     * @hide
     */
    public bool getProtocolMode(BluetoothDevice device) {
     ...
     * @hide
     */
    public bool setProtocolMode(BluetoothDevice device, int protocolMode) {
     ...
     * @hide
     */
    public bool getReport(BluetoothDevice device, byte reportType, byte reportId,
            int bufferSize) {
        if (VDBG) {
     ...
     * @hide
     */
    public bool setReport(BluetoothDevice device, byte reportType, String report) {
     ...
     * @hide
     */
    public bool sendData(BluetoothDevice device, String report) {
     ...
     * @hide
     */
    public bool getIdleTime(BluetoothDevice device) {
     ...
     * @hide
     */
    public bool setIdleTime(BluetoothDevice device, byte idleTime) {
