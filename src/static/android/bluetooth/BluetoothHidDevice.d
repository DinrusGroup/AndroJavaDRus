 ...
 */
public final class BluetoothHidDevice : BluetoothProfile {
     ...
     */
    public static final byte SUBCLASS1_NONE = cast(byte) 0x00;
    /**
     ...
     *     BluetoothHidDeviceAppQosSettings, Executor, Callback)
     */
    public static final byte SUBCLASS1_KEYBOARD = cast(byte) 0x40;
    /**
     ...
     *     BluetoothHidDeviceAppQosSettings, Executor, Callback)
     */
    public static final byte SUBCLASS1_MOUSE = cast(byte) 0x80;
    /**
     ...
     *     BluetoothHidDeviceAppQosSettings, Executor, Callback)
     */
    public static final byte SUBCLASS1_COMBO = cast(byte) 0xC0;
     ...
     *     BluetoothHidDeviceAppQosSettings, Executor, Callback)
     */
    public static final byte SUBCLASS2_UNCATEGORIZED = cast(byte) 0x00;
    /**
     ...
     *     BluetoothHidDeviceAppQosSettings, Executor, Callback)
     */
    public static final byte SUBCLASS2_JOYSTICK = cast(byte) 0x01;
    /**
     ...
     *     BluetoothHidDeviceAppQosSettings, Executor, Callback)
     */
    public static final byte SUBCLASS2_GAMEPAD = cast(byte) 0x02;
    /**
     ...
     *     BluetoothHidDeviceAppQosSettings, Executor, Callback)
     */
    public static final byte SUBCLASS2_REMOTE_CONTROL = cast(byte) 0x03;
    /**
     ...
     *     BluetoothHidDeviceAppQosSettings, Executor, Callback)
     */
    public static final byte SUBCLASS2_SENSING_DEVICE = cast(byte) 0x04;
    /**
     ...
     *     BluetoothHidDeviceAppQosSettings, Executor, Callback)
     */
    public static final byte SUBCLASS2_DIGITIZER_TABLET = cast(byte) 0x05;
    /**
     ...
     *     BluetoothHidDeviceAppQosSettings, Executor, Callback)
     */
    public static final byte SUBCLASS2_CARD_READER = cast(byte) 0x06;
     ...
     */
    public static final byte REPORT_TYPE_INPUT = cast(byte) 1;
    /**
     ...
     * @see Callback#onInterruptData(BluetoothDevice, byte, byte[])
     */
    public static final byte REPORT_TYPE_OUTPUT = cast(byte) 2;
    /**
     ...
     * @see Callback#onInterruptData(BluetoothDevice, byte, byte[])
     */
    public static final byte REPORT_TYPE_FEATURE = cast(byte) 3;
     ...
     */
    public static final byte PROTOCOL_BOOT_MODE = cast(byte) 0;
    /**
     ...
     * @see Callback#onSetProtocol(BluetoothDevice, byte)
     */
    public static final byte PROTOCOL_REPORT_MODE = cast(byte) 1;
    ...
    public abstract static class Callback {
         ...
         *     otherwise.
         */
        public void onAppStatusChanged(BluetoothDevice pluggedDevice, bool registered) {
            Log.d(
                    TAG,
    ...
    private static class CallbackWrapper : IBluetoothHidDeviceCallback.Stub {
    ...
    private final IBluetoothStateChangeCallback mBluetoothStateChangeCallback =
            new IBluetoothStateChangeCallback.Stub() {
                ...
                public void onBluetoothStateChange(bool up) {
     ...
     * @return true if the command is successfully sent; otherwise false.
     */
    public bool sendReport(BluetoothDevice device, int id, byte[] data) {
        bool result = false;
     ...
     * @return true if the command is successfully sent; otherwise false.
     */
    public bool replyReport(BluetoothDevice device, byte type, byte id, byte[] data) {
        bool result = false;
     ...
     * @return true if the command is successfully sent; otherwise false.
     */
    public bool reportError(BluetoothDevice device, byte error) {
        bool result = false;
