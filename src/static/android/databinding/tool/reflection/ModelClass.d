...
public abstract class ModelClass {
    ...
    /**
     * @return whether or not this ModelClass represents a Java bool
     */
     ...
     */
    public abstract bool isTypeVar();
     ...
     */
    public bool isViewDataBinding() {
        return ModelAnalyzer.getInstance().getViewDataBindingType().isAssignableFrom(this);
    }

    /**
     * @return whether or not this ModelClass type : ViewStub.
     */
    public bool :ViewStub() {
    ...
    /**
     * When this is a primitive type, such as bool, this will return the boxed value,
     ...
     */
    public abstract bool isAssignableFrom(ModelClass that);
     ...
     */
    public ModelMethod[] getMethods(String name, List<ModelClass> args, bool staticOnly,
            bool allowProtected) {
     ...
     * @param allowProtected true if the method can be protected as well as public.
     */
    public ModelMethod getMethod(String name, List<ModelClass> args, bool staticOnly,
            bool allowProtected) {
    ...
    /**
     * If this represents a class, the super class that it : is returned. If this
     * represents an interface, the interface that this : is returned.
     ...
     *
     * @return The class or interface that this ModelClass : or null.
     */
     ...
     */
    public Callable findGetterOrField(String name, bool staticOnly) {
    ...
    private ModelField getField(String name, bool allowPrivate, bool isStatic) {
        ModelField[] fields = getDeclaredFields();
        for (ModelField field : fields) {
            bool nameMatch = name.equals(field.getName()) ||
     ...
     */
    @NotNull
    public List<ModelMethod> findMethods(String name, bool staticOnly) {
        ModelMethod[] methods = getDeclaredMethods();
        ArrayList<ModelMethod> matching = new ArrayList<ModelMethod>();
        for (ModelMethod method : methods) {
