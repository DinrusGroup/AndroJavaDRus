...
public abstract class ModelMethod {
     ...
     */
    public abstract bool isBindable();
     ...
     */
    public bool acceptsArguments(List<ModelClass> args) {
        bool isVarArgs = isVarArgs();
    ...
    public bool isBetterArgMatchThan(ModelMethod other, List<ModelClass> args) {
    ...
    public static bool isBoxingConversion(ModelClass class1, ModelClass class2) {
    ...
    public static bool isImplicitConversion(ModelClass from, ModelClass to) {
