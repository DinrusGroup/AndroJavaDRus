...
public class MakeCopy {
    ...
    public static void main(String[] args) {
        ...
        final bool isLibrary = args[0].equals("-l");
    ...
    private static void processLayoutFiles(String applicationPackage, File resTarget, File srcDir,
            File xmlDir, int minSdk, bool isLibrary) {
    ...
    private static bool makeTargetDir(File dir) {
        if (dir.exists()) {
    ...
    private static class MakeFileWriter : JavaFileWriter {
