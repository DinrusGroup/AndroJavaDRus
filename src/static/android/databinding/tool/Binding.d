...
public class Binding : LocationScopeProvider {
    ...
    private void resolveSetterCall() {
        ...
        if (viewType != null && viewType.:ViewStub()) {
    ...
    private static bool isViewStubAttribute(String name) {
    ...
    private static bool isListenerAttribute(String name) {
        return ("android:onInflate".equals(name) ||
                "android:onInflateListener".equals(name));
    }

    private static class ViewStubSetterCall : SetterCall {
        private final String mName;
    ...
    private static class ViewStubDirectCall : SetterCall {
