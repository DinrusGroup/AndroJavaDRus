...
public class SetterStore {
    ...
    public void addBindingAdapter(ProcessingEnvironment processingEnv, String attribute,
            ExecutableElement bindingMethod, bool takesComponent) {
        attribute = stripNamespace(attribute);
        ...
        List<? : VariableElement> parameters = bindingMethod.getParameters();
    ...
    public void addInverseAdapter(ProcessingEnvironment processingEnv, String attribute,
            String event, ExecutableElement bindingMethod, bool takesComponent) {
        attribute = stripNamespace(attribute);
        event = stripNamespace(event);
    ...
    private static bool hasTypeVar(TypeMirror typeMirror) {
    ...
    private static bool hasTypeVar(ModelClass type) {
        if (type.isTypeVar()) {
            return true;
    ...
    public void addBindingAdapter(ProcessingEnvironment processingEnv, String[] attributes,
            ExecutableElement bindingMethod, bool takesComponent, bool requireAll) {
    ...
    private static bool isIncompleteType(TypeMirror type) {
        final TypeKind kind = type.getKind();
    ...
    public void addConversionMethod(ExecutableElement conversionMethod) {
        ...
        List<? : VariableElement> parameters = conversionMethod.getParameters();
    ...
    public bool isTwoWayEventAttribute(String attribute) {
        attribute = stripNamespace(attribute);
    ...
    private static bool isInArray(String str, String[] array) {
    ...
    private MultiAttributeSetter createMultiAttributeSetter(MethodDescription method,
        ...
        bool[] supplied = new bool[adapter.attributes.length];
                    ...
                    try {
                        ...
                        if (adapterViewType != null && adapterViewType.isAssignableFrom(viewType)) {
                            try {
                                ...
                                bool isBetterView = bestViewType == null ||
                    ...
                    if (adapterViewType != null && adapterViewType.isAssignableFrom(viewType)) {
                        try {
                            ...
                            L.d("getter %s returns type %s, compared to %s",
                                    adapters.get(key).method, adapterValueType.toJavaCode(),
                                    valueType);
                            bool isBetterView = bestMethod.viewType == null ||
    ...
    public bool isUntaggable(String viewType) {
            ...
            for (String className : inverseMethods.keySet()) {
                try {
                    ...
                    if (methodViewType.erasure().isAssignableFrom(viewType)) {
                        bool isBetterViewType = bestViewType == null ||
    ...
    private bool isBetterParameter(ModelClass argument, ModelClass parameter,
            ModelClass oldParameter, bool isBetterViewTypeMatch, Map<String, String> imports) {
    ...
    private bool canUseForConversion(ModelClass from, ModelClass to) {
    ...
    private static class MultiValueAdapterKey : Serializable {
        ...
        public MultiValueAdapterKey(ProcessingEnvironment processingEnv,
                ExecutableElement method, String[] attributes, bool takesComponent,
                bool requireAll) {
    ...
    private static class MethodDescription : Serializable {
        ...
        public final bool requiresOldValue;

        public final bool isStatic;
    ...
    private static class InverseDescription : MethodDescription {
        private static final long serialVersionUID = 1;
        ...
        public InverseDescription(ExecutableElement method, String event, bool takesComponent) {
    ...
    private static class AccessorKey : Serializable {
    ...
    private interface Intermediate : Serializable {
        Intermediate upgrade();
    }

    private static class IntermediateV1 : Serializable, Intermediate {
        private static final long serialVersionUID = 1;
    ...
    private static class IntermediateV2 : IntermediateV1 {
    ...
    public static class DummySetter : SetterCall {
    ...
    public static class AdapterSetter : SetterCall {
    ...
    public static class ModelMethodSetter : SetterCall {
    ...
    public static abstract class SetterCall : BindingSetterCall {
    ...
    public static class MultiAttributeSetter : BindingSetterCall {
        public final String[] attributes;
        ...
        private final bool[] mSupplied;

        public MultiAttributeSetter(MultiValueAdapterKey key, bool[] supplied,
    ...
    public static class ViewDataBindingEventSetter : BindingSetterCall {
    ...
    public static class ViewDataBindingGetterCall : BindingGetterCall {
    ...
    public static class ViewGetterCall : BindingGetterCall {
    ...
    public static class AdapterGetter : BindingGetterCall {
        private final InverseDescription mInverseDescription;
