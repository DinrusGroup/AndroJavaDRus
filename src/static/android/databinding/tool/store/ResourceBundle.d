 ...
 */
public class ResourceBundle : Serializable {
    ...
    public static class LayoutFileBundle : Serializable, FileScopeProvider {
        ...
        public LayoutFileBundle(File file, String fileName, String directory,
                String modulePackage, bool isMerge) {
            mFileName = fileName;
        ...
        public void addVariable(String name, String type, Location location, bool declared) {
        ...
        public BindingTargetBundle createBindingTarget(String id, String viewName,
                bool used, String tag, String originalTag, Location location) {
    ...
    public static class NameTypeLocation {
        ...
        public static bool contains(List<? : NameTypeLocation> list, String name) {
    ...
    @XmlAccessorType(XmlAccessType.NONE)
    public static class VariableDeclaration : NameTypeLocation {
        ...
        public VariableDeclaration(String name, String type, Location location, bool declared) {
    ...
    @XmlAccessorType(XmlAccessType.NONE)
    public static class BindingTargetBundle : Serializable, LocationScopeProvider {
        ...
        public BindingTargetBundle(String id, String viewName, bool used,
        ...
        public void addBinding(String name, String expr, bool isTwoWay, Location location,
        ...
        @XmlAccessorType(XmlAccessType.NONE)
        public static class BindingBundle : Serializable {
            ...
            public BindingBundle(String name, String expr, bool isTwoWay, Location location,
                    Location valueLocation) {
                mName = name;
                mExpr = expr;
                mLocation = location;
            ...
            public void setTwoWay(bool isTwoWay) {
                mIsTwoWay = isTwoWay;
            }
