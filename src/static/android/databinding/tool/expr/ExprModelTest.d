...
public class ExprModelTest {
    ...
    private static class DummyExpr : Expr {
    ...
    public void testTernaryInsideTernary() {
        MockLayoutBinder lb = new MockLayoutBinder();
        mExprModel = lb.getModel();
        IdentifierExpr cond1 = lb.addVariable("cond1", "bool", null);
        IdentifierExpr cond2 = lb.addVariable("cond2", "bool", null);

        IdentifierExpr a = lb.addVariable("a", "bool", null);
        IdentifierExpr b = lb.addVariable("b", "bool", null);
        IdentifierExpr c = lb.addVariable("c", "bool", null);
    ...
    public void testInterExprCircularDependency2() {
        MockLayoutBinder lb = new MockLayoutBinder();
        mExprModel = lb.getModel();
        IdentifierExpr a = lb.addVariable("a", bool.class.getCanonicalName(),
                null);
        IdentifierExpr b = lb.addVariable("b", bool.class.getCanonicalName(),
                null);
    ...
    public void testInterExprCircularDependency3() {
        ...
        IdentifierExpr b = lb.addVariable("b", bool.class.getCanonicalName(),
                null);
        IdentifierExpr c = lb.addVariable("c", bool.class.getCanonicalName(),
                null);
    ...
    public void testInterExprCircularDependency4() {
        ...
        IdentifierExpr c = lb.addVariable("c", bool.class.getCanonicalName(),
                null);
        IdentifierExpr d = lb.addVariable("d", bool.class.getCanonicalName(),
                null);
    ...
    public void testInterExprDeepDependency() {
        MockLayoutBinder lb = new MockLayoutBinder();
        mExprModel = lb.getModel();
        IdentifierExpr a = lb.addVariable("a", bool.class.getCanonicalName(), null);
        IdentifierExpr b = lb.addVariable("b", bool.class.getCanonicalName(), null);
        IdentifierExpr c = lb.addVariable("c", bool.class.getCanonicalName(), null);
    ...
    public void testInterExprDependencyNotReadyYet() {
        ...
        IdentifierExpr b = lb.addVariable("b", bool.class.getCanonicalName(), null);
        IdentifierExpr c = lb.addVariable("c", bool.class.getCanonicalName(), null);
        IdentifierExpr d = lb.addVariable("d", bool.class.getCanonicalName(), null);
        IdentifierExpr e = lb.addVariable("e", bool.class.getCanonicalName(), null);
        final TernaryExpr cTernary = parse(lb, "c ? (a ? d : false) : false", TernaryExpr.class);
        final TernaryExpr baTernary = parse(lb, "b ? a : false", TernaryExpr.class);
    ...
    private bool hasIdentifier(ExprModel model, String name) {
    ...
    private bool hasCallbackIdentifier(ExprModel model, int index, String name) {
...
//    }
    ...
    private <T : Expr> T parse(LayoutBinder binder, String input, Class<T> klass) {
    ...
    public static class User : Observable {
        ...
        public static bool ourStaticMethod() {
            return true;
        }
