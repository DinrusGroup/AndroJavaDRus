...
public class LayoutXmlProcessor {
    ...
    private bool mProcessingComplete;
    private bool mWritten;
    private final bool mIsLibrary;
    ...
    public LayoutXmlProcessor(String applicationPackage,
            JavaFileWriter fileWriter, int minSdk, bool isLibrary,
    ...
    public bool processResources(final ResourceInput input)
    ...
    public void writeInfoClass(/*Nullable*/ File sdkDir, File xmlOutDir, File exportClassListTo,
            bool enableDebugLogs, bool printEncodedErrorLogs) {
    ...
    public static class ResourceInput {
        private final bool mIncremental;
        ...
        public ResourceInput(bool incremental, File rootInputFolder, File rootOutputFolder) {
