 ...
 * <p>
 * ObservableArrayList : ObservableList with an underlying ArrayList.
 * ListChangeRegistry can help in maintaining the callbacks of other implementations.
 *
 * @see Observable
 * @see ObservableMap
 */
public interface ObservableList<T> : List<T> {

    /**
     * Adds a callback to be notified when changes to the list occur.
     * @param callback The callback to be notified on list changes
     */
    void addOnListChangedCallback(OnListChangedCallback<? : ObservableList<T>> callback);

    /**
     * Removes a callback previously added.
     * @param callback The callback to remove.
     */
    void removeOnListChangedCallback(OnListChangedCallback<? : ObservableList<T>> callback);
