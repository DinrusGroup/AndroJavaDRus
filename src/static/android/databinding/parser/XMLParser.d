...
public class XMLParser : Parser {
	...
	public static class DocumentContext : ParserRuleContext {
		...
		public <T> T accept(ParseTreeVisitor<? : T> visitor) {
			if ( visitor instanceof XMLParserVisitor ) return ((XMLParserVisitor<? : T>)visitor).visitDocument(this);
	...
	public static class PrologContext : ParserRuleContext {
		...
		override
		public <T> T accept(ParseTreeVisitor<? : T> visitor) {
			if ( visitor instanceof XMLParserVisitor ) return ((XMLParserVisitor<? : T>)visitor).visitProlog(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class ContentContext : ParserRuleContext {
		...
		override
		public <T> T accept(ParseTreeVisitor<? : T> visitor) {
			if ( visitor instanceof XMLParserVisitor ) return ((XMLParserVisitor<? : T>)visitor).visitContent(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class ElementContext : ParserRuleContext {
		...
		override
		public <T> T accept(ParseTreeVisitor<? : T> visitor) {
			if ( visitor instanceof XMLParserVisitor ) return ((XMLParserVisitor<? : T>)visitor).visitElement(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class ReferenceContext : ParserRuleContext {
		...
		override
		public <T> T accept(ParseTreeVisitor<? : T> visitor) {
			if ( visitor instanceof XMLParserVisitor ) return ((XMLParserVisitor<? : T>)visitor).visitReference(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class AttributeContext : ParserRuleContext {
		...
		override
		public <T> T accept(ParseTreeVisitor<? : T> visitor) {
			if ( visitor instanceof XMLParserVisitor ) return ((XMLParserVisitor<? : T>)visitor).visitAttribute(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class ChardataContext : ParserRuleContext {
		...
		override
		public <T> T accept(ParseTreeVisitor<? : T> visitor) {
			if ( visitor instanceof XMLParserVisitor ) return ((XMLParserVisitor<? : T>)visitor).visitChardata(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class MiscContext : ParserRuleContext {
		...
		override
		public <T> T accept(ParseTreeVisitor<? : T> visitor) {
			if ( visitor instanceof XMLParserVisitor ) return ((XMLParserVisitor<? : T>)visitor).visitMisc(this);
			else return visitor.visitChildren(this);
		}
	}
