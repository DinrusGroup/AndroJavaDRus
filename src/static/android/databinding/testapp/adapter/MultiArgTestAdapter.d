...
public class MultiArgTestAdapter {
    ...
    public static class MultiBindingClass1 : BaseMultiBindingClass {

    }

    public static class MultiBindingClass2 : BaseMultiBindingClass {

    }

    public static class BaseMultiBindingClass : BaseObservable {
        View mSetOn;
        @Bindable
        String mValue;
