...
public class TextViewBindingObject : BindingAdapterBindingObject {
    ...
    @Bindable
    private bool mScrollHorizontally;
    ...
    public bool isScrollHorizontally() {
    ...
    public static class KeyListener1 : KeyListener {
        ...
        override
        public bool onKeyDown(View view, Editable text, int keyCode, KeyEvent event) {
            return false;
        }
    ...
    public static class KeyListener2 : KeyListener1 {
