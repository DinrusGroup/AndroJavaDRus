...
public class AbsListViewBindingObject : BindingAdapterBindingObject {
    @Bindable
    private ColorDrawable mListSelector = new ColorDrawable(0xFFFF0000);
    @Bindable
    private bool mScrollingCache;
    @Bindable
    private bool mSmoothScrollbar;

    public ColorDrawable getListSelector() {
        return mListSelector;
    }

    public bool isScrollingCache() {
        return mScrollingCache;
    }

    public bool isSmoothScrollbar() {
