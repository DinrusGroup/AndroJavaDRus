...
public class ListenerBindingObject {
    ...
    public bool inflateCalled;
    private final Context mContext;
    public bool wasRunnableRun;
    ...
    public bool isValid(CharSequence text) {
        return true;
    }
    ...
    public bool onChildClick(ExpandableListView parent, View v, int groupPosition,
    ...
    public bool onDrag(View v, DragEvent event) {
        return true;
    }

    public void onFocusChange(View v, bool hasFocus) { }

    public bool onGenericMotion(View v, MotionEvent event) {
        return true;
    }

    public bool onHover(View v, MotionEvent event) {
        return true;
    }
    ...
    public bool onBar(View view) {
        return true;
    }

    public static class Inner : BaseObservable {
        public bool clicked;
        public void onClick(View view) {
            clicked = true;
        }
