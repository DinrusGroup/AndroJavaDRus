...
public class BasicBindingTest : BaseDataBinderTest<BasicBindingBinding> {
    ...
    private class AllowRebind : OnRebindCallback<BasicBindingBinding> {
        public int rebindAttempts;
        public int rebindHalted;
        public int rebindWillEvaluate;

        override
        public bool onPreBind(BasicBindingBinding binding) {
            rebindAttempts++;
            return true;
        }
    ...
    private class NoRebind : AllowRebind {
        override
        public bool onPreBind(BasicBindingBinding binding) {
    ...
    private static class WaitForRun : Runnable {
