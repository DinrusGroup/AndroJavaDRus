...
public class BaseDataBinderTest<T : ViewDataBinding>
    ...
    protected void assertMethod(Class!(T) klass, String methodName) throws NoSuchMethodException {
        assertEquals(klass, mBinder.getClass().getDeclaredMethod(methodName).getReturnType());
    }

    protected void assertField(Class!(T) klass, String fieldName) throws NoSuchFieldException {
        assertEquals(klass, mBinder.getClass().getDeclaredField(fieldName).getType());
    }

    protected void assertPublicField(Class!(T) klass, String fieldName) throws NoSuchFieldException {
