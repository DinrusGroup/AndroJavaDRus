 ...
 */
public class ObservableArrayList<T> : ArrayList<T> : ObservableList<T> {
    ...
    public bool addAll(Collection<? : T> collection) {
        int oldSize = size();
        bool added = super.addAll(collection);
        if (added) {
    ...
    override
    public bool addAll(int index, Collection<? : T> collection) {
        bool added = super.addAll(index, collection);
        if (added) {
