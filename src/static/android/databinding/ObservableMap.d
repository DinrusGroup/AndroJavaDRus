 ...
 * @see ObservableList
 */
public interface ObservableMap<K, V> : Map<K, V> {
    ...
    void addOnMapChangedCallback(
            OnMapChangedCallback<? : ObservableMap<K, V>, K, V> callback);
     ...
     */
    abstract class OnMapChangedCallback<T : ObservableMap<K, V>, K, V> {
