...
public class DataBindingUtil {
     ...
     */
    public static <T : ViewDataBinding> T inflate(LayoutInflater inflater, int layoutId,
            @Nullable ViewGroup parent, bool attachToParent) {
     ...
     * @throws InflateException When a merge layout was used and attachToParent was false.
     */
    public static <T : ViewDataBinding> T inflate(
            LayoutInflater inflater, int layoutId, @Nullable ViewGroup parent,
            bool attachToParent, DataBindingComponent bindingComponent) {
        final bool useChildren = parent != null && attachToParent;
    ...
    public static <T : ViewDataBinding> T bind(View root) {
    ...
    @SuppressWarnings("unchecked")
    static <T : ViewDataBinding> T bind(DataBindingComponent bindingComponent, View[] roots,
            int layoutId) {
        return (T) sMapper.getDataBinder(bindingComponent, roots, layoutId);
    }

    static <T : ViewDataBinding> T bind(DataBindingComponent bindingComponent, View root,
            int layoutId) {
        return (T) sMapper.getDataBinder(bindingComponent, root, layoutId);
    }
     ...
     */
    public static <T : ViewDataBinding> T findBinding(View view) {
        while (view != null) {
     ...
     */
    public static <T : ViewDataBinding> T getBinding(View view) {
     ...
     */
    public static <T : ViewDataBinding> T setContentView(Activity activity, int layoutId) {
    ...
    private static <T : ViewDataBinding> T bindToAddedViews(DataBindingComponent component,
