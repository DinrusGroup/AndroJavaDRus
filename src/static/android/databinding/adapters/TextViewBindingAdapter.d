...
public class TextViewBindingAdapter {
    ...
    public static void setAutoText(TextView view, bool autoText) {
    ...
    public static void setCapitalize(TextView view, TextKeyListener.Capitalize capitalize) {
        ...
        bool autoText = (inputType & InputType.TYPE_TEXT_FLAG_AUTO_CORRECT) != 0;
        view.setKeyListener(TextKeyListener.getInstance(autoText, capitalize));
    }
    ...
    public static void setPhoneNumber(TextView view, bool phoneNumber) {
        if (phoneNumber) {
    ...
    public static void setInputMethod(TextView view, CharSequence inputMethod) {
        try {
            Class!(T) c = Class.forName(inputMethod.toString());
    ...
    public static void setPassword(TextView view, bool password) {
        if (password) {
    ...
    private static bool haveContentsChanged(CharSequence str1, CharSequence str2) {
