 ...
 * {@link DataBindingUtil#inflate(LayoutInflater, int, ViewGroup, bool)} should be used.
 */
public abstract class ViewDataBinding : BaseObservable {
    ...
    private static final bool USE_TAG_ID = DataBinderMapper.TARGET_MIN_SDK >= 14;

    private static final bool USE_CHOREOGRAPHER = SDK_INT >= 16;
     ...
     */
    private bool mIsExecutingPendingBindings;
     ...
     * that are instance methods to retrieve the class instance that : the
     * adapter.
     *
     * @hide
     */
     ...
     * @hide
     */
    protected abstract bool onFieldChange(int localFieldId, Object object, int fieldId);
     ...
     */
    public abstract bool setVariable(int variableId, Object value);
     ...
     */
    public abstract bool hasPendingBindings();
    ...
    private void handleFieldChange(int mLocalFieldId, Object object, int fieldId) {
        bool result = onFieldChange(mLocalFieldId, object, fieldId);
        if (result) {
            requestRebind();
        }
    }
     ...
     * @hide
     */
    protected bool unregisterFrom(int localFieldId) {
    ...
    private bool updateRegistration(int localFieldId, Object observable,
     ...
     * @hide
     */
    protected bool updateRegistration(int localFieldId, Observable observable) {
     ...
     * @hide
     */
    protected bool updateRegistration(int localFieldId, ObservableList observable) {
     ...
     * @hide
     */
    protected bool updateRegistration(int localFieldId, ObservableMap observable) {
     ...
     * @hide
     */
    protected void ensureBindingComponentIsNotNull(Class!(T) oneExample) {
    ...
    /** @hide */
    protected static bool parse(String str, bool fallback) {
        if (str == null) {
            return fallback;
        }
    ...
    /** @hide */
    protected static bool getFromArray(bool[] arr, int index) {
        if (arr == null || index < 0 || index >= arr.length) {
            return false;
        }
        return arr[index];
    ...
    /** @hide */
    protected static void setTo(bool[] arr, int index, bool value) {
        if (arr == null || index < 0 || index >= arr.length) {
            return;
        }
        arr[index] = value;
    ...
    /** @hide */
    protected static bool getFromList(SparseBooleanArray list, int index) {
        if (list == null || index < 0) {
            return false;
        }
        return list.get(index);
    ...
    /** @hide */
    protected static void setTo(SparseBooleanArray list, int index, bool value) {
        if (list == null || index < 0 || index >= list.size()) {
            return;
        }
        list.put(index, value);
    ...
    private static bool isNumeric(String tag, int startIndex) {
    ...
    private static class WeakListener<T> : WeakReference<ViewDataBinding> {
    ...
    private static class WeakPropertyListener : Observable.OnPropertyChangedCallback
    ...
    private static class WeakListListener : ObservableList.OnListChangedCallback
            : ObservableReference<ObservableList> {
    ...
    private static class WeakMapListener : ObservableMap.OnMapChangedCallback
            : ObservableReference<ObservableMap> {
    ...
    protected static abstract class PropertyChangedInverseListener
            : Observable.OnPropertyChangedCallback : InverseBindingListener {
