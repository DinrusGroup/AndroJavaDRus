...
public class ProcessBindable : ProcessDataBinding.ProcessingStep : BindableHolder {
    Intermediate mProperties;
    HashMap<String, HashSet<String>> mLayoutVariables = new HashMap<String, HashSet<String>>();

    override
    public bool onHandleStep(RoundEnvironment roundEnv, ProcessingEnvironment processingEnv,
    ...
    private void generateBRClasses(bool useFinalFields, String pkg) {
    ...
    private static bool prefixes(CharSequence sequence, String prefix) {
        bool prefixes = false;
    ...
    private static bool isGetter(ExecutableElement element) {
        Name name = element.getSimpleName();
    ...
    private static bool isSetter(ExecutableElement element) {
        Name name = element.getSimpleName();
    ...
    private static bool isBooleanGetter(ExecutableElement element) {
        Name name = element.getSimpleName();
