 ...
 */
public class ProcessDataBinding : AbstractProcessor {
    private List<ProcessingStep> mProcessingSteps;
    override
    public bool process(Set<? : TypeElement> annotations, RoundEnvironment roundEnv) {
    ...
    private void initProcessingSteps() {
        ...
        Callback dataBinderWriterCallback = new Callback() {
            CompilerChef mChef;
            BRWriter mBRWriter;
            bool mLibraryProject;
            int mMinSdk;

            override
            public void onChefReady(CompilerChef chef, bool libraryProject, int minSdk) {
    ...
    public abstract static class ProcessingStep {
        ...
        private bool runStep(RoundEnvironment roundEnvironment,
         ...
         */
        abstract public bool onHandleStep(RoundEnvironment roundEnvironment,
                ProcessingEnvironment processingEnvironment,
                BindingBuildInfo buildInfo) throws JAXBException;
    ...
    interface Callback {
        void onChefReady(CompilerChef chef, bool libraryProject, int minSdk);
