...
public class ProcessExpressions : ProcessDataBinding.ProcessingStep {
    public ProcessExpressions() {
    }

    override
    public bool onHandleStep(RoundEnvironment roundEnvironment,
    ...
    private void writeResourceBundle(ResourceBundle resourceBundle, bool forLibraryModule,
    ...
    public interface Intermediate : Serializable {
    ...
    public static class IntermediateV1 : Intermediate {
    ...
    public static class IntermediateV2 : IntermediateV1 {
