...
public abstract class CookieManager {
   ...
   /**
     ...
     */
    @SystemApi
    public abstract String getCookie(String url, bool privateBrowsing);
     ...
     */
    public abstract bool hasCookies();
     ...
     */
    @SystemApi
    public abstract bool hasCookies(bool privateBrowsing);
     ...
     */
    @SystemApi
    protected abstract bool allowFileSchemeCookiesImpl();
    ...
    /**
     * Implements {@link #setAcceptFileSchemeCookies(bool)}.
     *
     * @hide Only for use by WebViewProvider implementations
     */
    @SystemApi
    protected abstract void setAcceptFileSchemeCookiesImpl(bool accept);
}
