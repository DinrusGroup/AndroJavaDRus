...
public class WebViewLibraryLoader {
    ...
    private static bool sAddressSpaceReserved = false;
    ...
    private static class RelroFileCreator {
        ...
        public static void main(String[] args) {
            bool result = false;
            bool is64Bit = VMRuntime.getRuntime().is64Bit();
            try {
     ...
     */
    static void createRelroFile(final bool is64Bit, @NonNull WebViewNativeLibrary nativeLib) {
        final String abi =
        ...
        try {
            ...
            bool success = LocalServices.getService(ActivityManagerInternal.class)
    ...
    public static WebViewNativeLibrary getWebViewNativeLibrary(PackageInfo packageInfo,
            bool is64bit) throws WebViewFactory.MissingWebViewPackageException {
     ...
     */
    @VisibleForTesting
    public static String getWebViewNativeLibraryDirectory(ApplicationInfo ai, bool is64bit) {
    ...
    static native bool nativeReserveAddressSpace(long addressSpaceToReserve);
    static native bool nativeCreateRelroFile(String lib, String relro);
