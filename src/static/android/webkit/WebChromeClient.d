...
public class WebChromeClient {
     ...
     *         undefined behavior.
     */
    public bool onCreateWindow(WebView view, bool isDialog,
            bool isUserGesture, Message resultMsg) {
        return false;
    }
     ...
     * @return bool Whether the client will handle the alert dialog.
     */
    public bool onJsAlert(WebView view, String url, String message,
            JsResult result) {
        return false;
    }
     ...
     *               javascript.
     * @return bool Whether the client will handle the confirm dialog.
     */
    public bool onJsConfirm(WebView view, String url, String message,
            JsResult result) {
        return false;
    }
     ...
     *               javascript.
     * @return bool Whether the client will handle the prompt dialog.
     */
    public bool onJsPrompt(WebView view, String url, String message,
     ...
     * @return bool Whether the client will handle the confirm dialog.
     */
    public bool onJsBeforeUnload(WebView view, String url, String message,
            JsResult result) {
        return false;
    }
    ...
    */
     ...
     * point.
     * @return bool Whether the JavaScript execution should be interrupted.
     ...
     */
    public bool onConsoleMessage(ConsoleMessage consoleMessage) {
     ...
     */
    public bool onShowFileChooser(WebView webView, ValueCallback<Uri[]> filePathCallback,
    ...
    public static abstract class FileChooserParams {
         ...
         */
        public abstract bool isCaptureEnabled();
