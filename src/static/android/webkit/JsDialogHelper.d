...
public class JsDialogHelper {
    ...
    public bool invokeCallback(WebChromeClient client, WebView webView) {
        switch (mType) {
            case ALERT:
    ...
    private class CancelListener : DialogInterface.OnCancelListener,
    ...
    private class PositiveListener : DialogInterface.OnClickListener {
    ...
    private static bool canShowAlertDialog(Context context) {
