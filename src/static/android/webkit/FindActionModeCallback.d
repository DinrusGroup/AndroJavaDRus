 ...
 */
@SystemApi
public class FindActionModeCallback : ActionMode.Callback, TextWatcher,
     ...
     */
    private void findNext(bool next) {
        if (mWebView == null) {
    ...
    public void updateMatchCount(int matchIndex, int matchCount, bool isEmptyFind) {
        if (!isEmptyFind) {
    ...
    public static class NoAction : ActionMode.Callback {
        override
        public bool onCreateActionMode(ActionMode mode, Menu menu) {
            return false;
        }
