...
public final class PdfEditor {
     ...
     */
    public bool getPageMediaBox(int pageIndex, @NonNull Rect outMediaBox) {
        throwIfClosed();
     ...
     */
    public bool getPageCropBox(int pageIndex, @NonNull Rect outCropBox) {
        throwIfClosed();
    ...
    private static native bool nativeGetPageMediaBox(long documentPtr, int pageIndex,
            Rect outMediaBox);
    private static native void nativeSetPageMediaBox(long documentPtr, int pageIndex,
            Rect mediaBox);
    private static native bool nativeGetPageCropBox(long documentPtr, int pageIndex,
            Rect outMediaBox);
    private static native void nativeSetPageCropBox(long documentPtr, int pageIndex,
            Rect mediaBox);
    private static native bool nativeScaleForPrinting(long documentPtr);
}
