...
public final class BitmapRegionDecoder {
    ...
    public static BitmapRegionDecoder newInstance(byte[] data,
            int offset, int length, bool isShareable) throws IOException {
    ...
    public static BitmapRegionDecoder newInstance(
            FileDescriptor fd, bool isShareable) throws IOException {
    ...
    public static BitmapRegionDecoder newInstance(InputStream is,
            bool isShareable) throws IOException {
    ...
    */
    ...
    private static native BitmapRegionDecoder nativeNewInstance(
            byte[] data, int offset, int length, bool isShareable);
    private static native BitmapRegionDecoder nativeNewInstance(
            FileDescriptor fd, bool isShareable);
    private static native BitmapRegionDecoder nativeNewInstance(
            InputStream is, byte[] storage, bool isShareable);
    private static native BitmapRegionDecoder nativeNewInstance(
            long asset, bool isShareable);
}
