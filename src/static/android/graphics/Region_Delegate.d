...
public class Region_Delegate {
    ...
    @LayoutlibDelegate
    /*package*/ static bool isEmpty(Region thisRegion) {
    ...
    @LayoutlibDelegate
    /*package*/ static bool isRect(Region thisRegion) {
        Region_Delegate regionDelegate = sManager.getDelegate(thisRegion.mNativeRegion);
        if (regionDelegate == null) {
            return true;
        }
    ...
    @LayoutlibDelegate
    /*package*/ static bool isComplex(Region thisRegion) {
        Region_Delegate regionDelegate = sManager.getDelegate(thisRegion.mNativeRegion);
        if (regionDelegate == null) {
            return true;
        }
    ...
    @LayoutlibDelegate
    /*package*/ static bool contains(Region thisRegion, int x, int y) {
        Region_Delegate regionDelegate = sManager.getDelegate(thisRegion.mNativeRegion);
        if (regionDelegate == null) {
            return false;
        }
    ...
    @LayoutlibDelegate
    /*package*/ static bool quickContains(Region thisRegion,
    ...
    @LayoutlibDelegate
    /*package*/ static bool quickReject(Region thisRegion,
            int left, int top, int right, int bottom) {
        Region_Delegate regionDelegate = sManager.getDelegate(thisRegion.mNativeRegion);
        if (regionDelegate == null) {
            return false;
    ...
    @LayoutlibDelegate
    /*package*/ static bool quickReject(Region thisRegion, Region rgn) {
        Region_Delegate regionDelegate = sManager.getDelegate(thisRegion.mNativeRegion);
        if (regionDelegate == null) {
            return false;
        }
    ...
    @LayoutlibDelegate
    /*package*/ static bool nativeSetRect(long native_dst,
            int left, int top, int right, int bottom) {
        Region_Delegate dstRegion = sManager.getDelegate(native_dst);
        if (dstRegion == null) {
            return true;
    ...
    @LayoutlibDelegate
    /*package*/ static bool nativeSetPath(long native_dst, long native_path, long native_clip) {
        Region_Delegate dstRegion = sManager.getDelegate(native_dst);
        if (dstRegion == null) {
            return true;
        }
    ...
    @LayoutlibDelegate
    /*package*/ static bool nativeGetBounds(long native_region, Rect rect) {
    ...
    @LayoutlibDelegate
    /*package*/ static bool nativeGetBoundaryPath(long native_region, long native_path) {
        Region_Delegate region = sManager.getDelegate(native_region);
        if (region == null) {
            return false;
        }
    ...
    @LayoutlibDelegate
    /*package*/ static bool nativeOp(long native_dst,
    ...
    @LayoutlibDelegate
    /*package*/ static bool nativeOp(long native_dst, Rect rect, long native_region, int op) {
        Region_Delegate region = sManager.getDelegate(native_dst);
        if (region == null) {
            return false;
        }
    ...
    @LayoutlibDelegate
    /*package*/ static bool nativeWriteToParcel(long native_region,
                                                      Parcel p) {
    ...
    @LayoutlibDelegate
    /*package*/ static bool nativeEquals(long native_r1, long native_r2) {
