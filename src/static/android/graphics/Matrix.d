...
public class Matrix {
     ...
     */
    public bool setPolyToPoly(float[] src, int srcIndex,
            float[] dst, int dstIndex,
            int pointCount) {
        if (pointCount > 4) {
     ...
     */
    public bool invert(Matrix inverse) {
     ...
     * @return the result of calling rectStaysRect()
     */
    public bool mapRect(RectF rect) {
    ...
    @FastNative
    private static native bool nSetRectToRect(long nObject,
            RectF src, RectF dst, int stf);
    @FastNative
    private static native bool nSetPolyToPoly(long nObject,
    ...
    @FastNative
    private static native bool nMapRect(long nObject, RectF dst, RectF src);
    @FastNative
    ...
    @CriticalNative
    private static native bool nIsIdentity(long nObject);
    @CriticalNative
    private static native bool nIsAffine(long nObject);
    @CriticalNative
    private static native bool nRectStaysRect(long nObject);
    @CriticalNative
    ...
    @CriticalNative
    private static native bool nInvert(long nObject, long nInverse);
    @CriticalNative
    private static native float nMapRadius(long nObject, float radius);
    @CriticalNative
    private static native bool nEquals(long nA, long nB);
}
