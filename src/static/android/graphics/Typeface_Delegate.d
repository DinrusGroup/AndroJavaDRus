...
public final class Typeface_Delegate {
    ...
    @LayoutlibDelegate
    /*package*/ static Typeface create(Typeface family, int style, bool isItalic) {
    ...
    private static List<Font> computeFonts(FontVariant variant, FontFamily_Delegate[] fontFamilies,
        ...
        final bool isItalic = (inputStyle & Font.ITALIC) != 0;
    ...
    private static class FontsIterator : Iterator<Font>, Iterable<Font> {
        private final FontFamily_Delegate[] fontFamilies;
        private final int weight;
        private final bool isItalic;
