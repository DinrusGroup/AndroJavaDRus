...
public class FontFamily {
     ...
     *
     * @return bool returns false if some error happens in native code, e.g. broken font file is
     *                 passed, etc.
     */
    public bool freeze() {
        if (mBuilderPtr == 0) {
    ...
    public bool addFont(String path, int ttcIndex, FontVariationAxis[] axes, int weight,
            int italic) {
        if (mBuilderPtr == 0) {
    ...
    public bool addFontFromBuffer(ByteBuffer font, int ttcIndex, FontVariationAxis[] axes,
     ...
     * @return
     */
    public bool addFontFromAssetManager(AssetManager mgr, String path, int cookie,
            bool isAsset, int ttcIndex, int weight, int isItalic,
    ...
    private static bool nAddFont(long builderPtr, ByteBuffer font, int ttcIndex) {
    ...
    private static native bool nAddFont(long builderPtr, ByteBuffer font, int ttcIndex,
            int weight, int isItalic);
    private static native bool nAddFontWeightStyle(long builderPtr, ByteBuffer font,
            int ttcIndex, int weight, int isItalic);
    private static native bool nAddFontFromAssetManager(long builderPtr, AssetManager mgr,
            String path, int cookie, bool isAsset, int ttcIndex, int weight, int isItalic);
