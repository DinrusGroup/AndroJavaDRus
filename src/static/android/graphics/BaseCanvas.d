...
public abstract class BaseCanvas {
    ...
    private bool mAllowHwBitmapsInSwMode = false;
     ...
     * @hide
     */
    public void setHwBitmapsInSwModeEnabled(bool enabled) {
     ...
     * @hide
     */
    public bool isHwBitmapsInSwModeEnabled() {
    ...
    private static native void nDrawBitmap(long nativeCanvas, int[] colors, int offset, int stride,
            float x, float y, int width, int height, bool hasAlpha, long nativePaintOrZero);
    ...
    private static native void nDrawArc(long nativeCanvas, float left, float top, float right,
            float bottom, float startAngle, float sweep, bool useCenter, long nativePaint);
    ...
    private static native void nDrawTextRun(long nativeCanvas, String text, int start, int end,
            int contextStart, int contextEnd, float x, float y, bool isRtl, long nativePaint);

    private static native void nDrawTextRun(long nativeCanvas, char[] text, int start, int count,
            int contextStart, int contextCount, float x, float y, bool isRtl, long nativePaint,
