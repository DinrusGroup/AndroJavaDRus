...
public class Paint {
   ...
   /**
     ...
     * @hide
     */
    public bool hasEqualAttributes(@NonNull Paint other) {
     ...
     */
    public final bool isLinearText() {
     ...
     *                   false to clear it.
     */
    public void setLinearText(bool linearText) {
     ...
     */
    public final bool isSubpixelText() {
     ...
     */
    public void setSubpixelText(bool subpixelText) {
     ...
     */
    public final bool isUnderlineText() {
     ...
     *                      flags, false to clear it.
     */
    public void setUnderlineText(bool underlineText) {
     ...
     */
    public final bool isStrikeThruText() {
     ...
     *                       flags, false to clear it.
     */
    public void setStrikeThruText(bool strikeThruText) {
     ...
     */
    public final bool isFakeBoldText() {
     ...
     *                     flags, false to clear it.
     */
    public void setFakeBoldText(bool fakeBoldText) {
     ...
     */
    public final bool isFilterBitmap() {
     ...
     */
    public bool setFontVariationSettings(String fontVariationSettings) {
     ...
     *         abs(count).
     */
    public int breakText(String text, bool measureForwards,
                                float maxWidth, float[] measuredWidth) {
        if (text == null) {
            throw new IllegalArgumentException("text cannot be null");
        }
     ...
     * String.
     *
     * @see #getTextRunAdvances(String, int, int, int, int, bool, float[], int)
     * @hide
     */
    public float getTextRunAdvances(char[] chars, int index, int count,
            int contextIndex, int contextCount, bool isRtl, float[] advances,
            int advancesIndex) {
    ...
    public float getTextRunAdvances(CharSequence text, int start, int end,
            int contextStart, int contextEnd, bool isRtl, float[] advances,
            int advancesIndex) {
        if (text == null) {
            throw new IllegalArgumentException("text cannot be null");
        }
     ...
     */
    public bool hasGlyph(String string) {
    ...
    /**
     * @see #getRunAdvance(char[], int, int, int, int, bool, int)
     *
     * @param text the text to measure. Cannot be null.
     * @param start the index of the start of the range to measure
     * @param end the index + 1 of the end of the range to measure
    ...
    public int getOffsetForAdvance(char[] text, int start, int end, int contextStart,
            int contextEnd, bool isRtl, float advance) {
        if (text == null) {
            throw new IllegalArgumentException("text cannot be null");
        }
    ...
    /**
     * @see #getOffsetForAdvance(char[], int, int, int, int, bool, float)
     *
     * @param text the text to measure. Cannot be null.
     * @param start the index of the start of the range to measure
     * @param end the index + 1 of the end of the range to measure
     ...
     */
    public bool equalsForTextMeasurement(@NonNull Paint other) {
    ...
    private static native int nBreakText(long nObject, String text, bool measureForwards,
            float maxWidth, int bidiFlags, float[] measuredWidth);
    ...
    private static native bool nHasGlyph(long paintPtr, int bidiFlags, String string);
    ...
    private static native int nGetOffsetForAdvance(long paintPtr, char[] text, int start, int end,
            int contextStart, int contextEnd, bool isRtl, float advance);
    ...
    @CriticalNative
    private static native bool nGetFillPath(long paintPtr, long src, long dst);
    @CriticalNative
    ...
    @CriticalNative
    private static native bool nHasShadowLayer(long paintPtr);
    @CriticalNative
    ...
    @CriticalNative
    private static native void nSetDither(long paintPtr, bool dither);
    @CriticalNative
    ...
    @CriticalNative
    private static native void nSetAntiAlias(long paintPtr, bool aa);
    @CriticalNative
    private static native void nSetLinearText(long paintPtr, bool linearText);
    @CriticalNative
    private static native void nSetSubpixelText(long paintPtr, bool subpixelText);
    @CriticalNative
    private static native void nSetUnderlineText(long paintPtr, bool underlineText);
    @CriticalNative
    private static native void nSetFakeBoldText(long paintPtr, bool fakeBoldText);
    @CriticalNative
    private static native void nSetFilterBitmap(long paintPtr, bool filter);
    @CriticalNative
    ...
    @CriticalNative
    private static native void nSetStrikeThruText(long paintPtr, bool strikeThruText);
    @CriticalNative
    private static native bool nIsElegantTextHeight(long paintPtr);
    @CriticalNative
    private static native void nSetElegantTextHeight(long paintPtr, bool elegant);
    @CriticalNative
    ...
    @CriticalNative
    private static native bool nEqualsForTextMeasurement(long leftPaintPtr, long rightPaintPtr);
}
