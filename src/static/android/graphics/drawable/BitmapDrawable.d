...
public class BitmapDrawable : Drawable {
    ...
    private void updateShaderMatrix(@NonNull Bitmap bitmap, @NonNull Paint paint,
            @NonNull Shader shader, bool needMirroring) {
        final int sourceDensity = bitmap.getDensity();
        final int targetDensity = mTargetDensity;
        final bool needScaling = sourceDensity != 0 && sourceDensity != targetDensity;
    ...
    private void updateStateFromTypedArray(TypedArray a, int srcDensityOverride)
        ...
        final bool defMipMap = state.mBitmap != null ? state.mBitmap.hasMipMap() : false;
    ...
    final static class BitmapState : ConstantState {
        final Paint mPaint;
