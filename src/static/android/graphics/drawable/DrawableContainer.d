 ...
 */
public class DrawableContainer : Drawable : Drawable.Callback {
     ...
     */
    private static final bool DEFAULT_DITHER = true;
     ...
     * release.
     */
    public abstract static class DrawableContainerState : ConstantState {
        ...
        final bool setLayoutDirection(int layoutDirection, int currentIndex) {
            bool changed = false;
            ...
            for (int i = 0; i < N; i++) {
                if (drawables[i] != null) {
                    final bool childChanged = drawables[i].setLayoutDirection(layoutDirection);
                    if (i == currentIndex) {
        ...
        /**
         * A bool value indicating whether to use the maximum padding value
         * of all frames in the set (false), or to use the padding value of the
         * frame being shown (true). Default value is false.
         */
        public final void setVariablePadding(bool variable) {
        ...
        public final void setConstantSize(bool constant) {
            mConstantSize = constant;
        }

        public final bool isConstantSize() {
        ...
        public synchronized bool canConstantState() {
     ...
     */
    private static class BlockInvalidateCallback : Drawable.Callback {
