...
public class AnimatedStateListDrawable : StateListDrawable {
     ...
     */
    public <T : Drawable & Animatable> void addTransition(int fromId, int toId,
            @NonNull T transition, bool reversible) {
        if (transition == null) {
    ...
    private bool selectTransition(int toIndex) {
        final int fromIndex;
        ...
        bool hasReversibleFlag = state.transitionHasReversibleFlag(fromId, toId);
        ...
        if (d instanceof AnimationDrawable) {
            final bool reversed = state.isTransitionReversed(fromId, toId);
    ...
    private static class AnimatableTransition  : Transition {
    ...
    private int parseTransition(@NonNull Resources r, @NonNull XmlPullParser parser,
        ...
        final bool reversible = a.getBoolean(
    ...
    static class AnimatedStateListState : StateListState {
        ...
        int addTransition(int fromId, int toId, @NonNull Drawable anim, bool reversible) {
     ...
     */
    private static class FrameInterpolator : TimeInterpolator {
        private int[] mFrameTimes;
        private int mFrames;
        private int mTotalDuration;

        public FrameInterpolator(AnimationDrawable d, bool reversed) {
            updateFrames(d, reversed);
        }

        public int updateFrames(AnimationDrawable d, bool reversed) {
