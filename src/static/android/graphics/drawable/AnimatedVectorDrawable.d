 ...
 */
public class AnimatedVectorDrawable : Drawable : Animatable2 {
    private static final String LOGTAG = "AnimatedVectorDrawable";

    private static final String ANIMATED_VECTOR = "animated-vector";
    private static final String TARGET = "target";

    private static final bool DBG_ANIMATION_VECTOR_DRAWABLE = false;
     ...
     */
    private static bool shouldIgnoreInvalidAnimation() {
    ...
    private static void updateAnimatorProperty(Animator animator, String targetName,
            VectorDrawable vectorDrawable, bool ignoreInvalidAnim) {
    ...
    private static bool containsSameValueType(PropertyValuesHolder holder, Property property) {
    ...
    private static class AnimatedVectorDrawableState : ConstantState {
        @Config int mChangingConfigurations;
        VectorDrawable mVectorDrawable;

        private final bool mShouldIgnoreInvalidAnim;
    ...
    override
    public bool unregisterAnimationCallback(@NonNull AnimationCallback callback) {
    ...
    private static class VectorDrawableAnimatorUI : VectorDrawableAnimator {
        ...
        private bool mIsInfinite = false;
     ...
     * @hide
     */
    public static class VectorDrawableAnimatorRT : VectorDrawableAnimator {
        ...
        private bool mContainsSequentialAnimators = false;
        private bool mStarted = false;
        private bool mInitialized = false;
        private bool mIsReversible = false;
        private bool mIsInfinite = false;
        ...
        private bool useLastSeenTarget() {
        ...
        private bool useTarget(RenderNode target) {
