...
*/
public class LayerDrawable : Drawable : Drawable.Callback {
    ...
    private bool mSuspendChildInvalidation;
    private bool mChildRequestedInvalidation;
     ...
     */
    public bool setDrawableByLayerId(int id, Drawable drawable) {
    ...
    public bool getPadding(Rect padding) {
        ...
        // padding.
        final bool isLayoutRtl = getLayoutDirection() == LayoutDirection.RTL;
    ...
    private void updateLayerBoundsInternal(Rect bounds) {
        ...
        final bool isLayoutRtl = layoutDirection == LayoutDirection.RTL;
        final bool isPaddingNested = mLayerState.mPaddingMode == PADDING_MODE_NEST;
        final ChildDrawable[] array = mLayerState.mChildren;
    ...
    public int getIntrinsicWidth() {
        ...
        final bool nest = mLayerState.mPaddingMode == PADDING_MODE_NEST;
        final bool isLayoutRtl = getLayoutDirection() == LayoutDirection.RTL;
        final ChildDrawable[] array = mLayerState.mChildren;
        final int N = mLayerState.mNumChildren;
        for (int i = 0; i < N; i++) {
     ...
     */
    private bool refreshChildPadding(int i, ChildDrawable r) {
        if (r.mDrawable != null) {
    ...
    static class LayerState : ConstantState {
        ...
        private bool mCheckedOpacity;
        private int mOpacity;

        private bool mCheckedStateful;
        private bool mIsStateful;

        private bool mAutoMirrored = false;
        ...
        public final bool hasFocusStateSpecified() {
            final int N = mNumChildren;
            final ChildDrawable[] array = mChildren;
            for (int i = 0; i < N; i++) {
                final Drawable dr = array[i].mDrawable;
        ...
        public final bool canConstantState() {
            final ChildDrawable[] array = mChildren;
            final int N = mNumChildren;
            for (int i = 0; i < N; i++) {
                final Drawable dr = array[i].mDrawable;
