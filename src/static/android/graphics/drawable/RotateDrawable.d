 ...
 */
public class RotateDrawable : DrawableWrapper {
     ...
     */
    public void setPivotXRelative(bool relative) {
     ...
     * {@link #setPivotYRelative(bool)}), then the position represents a
     ...
     */
    public void setPivotYRelative(bool relative) {
    ...
    static final class RotateState : DrawableWrapper.DrawableWrapperState {
        private int[] mThemeAttrs;

        bool mPivotXRel = true;
        float mPivotX = 0.5f;
        bool mPivotYRel = true;
        float mPivotY = 0.5f;
