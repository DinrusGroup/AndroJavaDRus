...
public class GradientDrawable : Drawable {
     ...
     * @attr ref android.R.styleable#GradientDrawableGradient_useLevel
     */
    public void setUseLevel(bool useLevel) {
    ...
    public void draw(Canvas canvas) {
        ...
        final bool haveStroke = currStrokeAlpha > 0 && mStrokePaint != null &&
                mStrokePaint.getStrokeWidth() > 0;
        final bool haveFill = currFillAlpha > 0;
         ...
         */
        final bool useLayer = haveStroke && haveFill && st.mShape != LINE &&
    ...
    private void updateGradientDrawableGradient(Resources r, TypedArray a)
        ...
        final bool hasCenterColor = a.hasValue(
    ...
    private static float getFloatOrFraction(TypedArray a, int index, float defaultValue) {
        ...
        if (tv != null) {
            bool vIsFraction = tv.type == TypedValue.TYPE_FRACTION;
    ...
    public void getOutline(Outline outline) {
        ...
        bool useFillOpacity = st.mOpaqueOverShape && (mGradientState.mStrokeWidth <= 0
                || mStrokePaint == null
    ...
    final static class GradientState : ConstantState {
        ...
        bool mUseLevel = false;
        bool mUseLevelForShape = true;
