 ...
 */
public class AnimatedImageDrawable : Drawable : Animatable2 {
    ...
    public bool onLayoutDirectionChanged(int layoutDirection) {
        ...
        final bool mirror = layoutDirection == View.LAYOUT_DIRECTION_RTL;
        nSetMirrored(mState.mNativePtr, mirror);
        return true;
    }

    override
    public final bool isAutoMirrored() {
    ...
    @FastNative
    private static native bool nIsRunning(long nativePtr);
    // Return whether the animation started.
    @FastNative
    private static native bool nStart(long nativePtr);
    @FastNative
    private static native bool nStop(long nativePtr);
    @FastNative
    ...
    @FastNative
    private static native void nSetMirrored(long nativePtr, bool mirror);
}
