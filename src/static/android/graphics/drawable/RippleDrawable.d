...
public class RippleDrawable : LayerDrawable {
    ...
    private bool mOverrideBounds;

    /**
     * If set, force all ripple animations to not run on RenderThread, even if it would be
     * available.
     */
    private bool mForceSoftware;
    ...
    protected bool onStateChange(int[] stateSet) {
        final bool changed = super.onStateChange(stateSet);
    ...
    private void setBackgroundActive(bool hovered, bool focused, bool pressed) {
     ...
     * @hide
     */
    public void setForceSoftware(bool forceSoftware) {
    ...
    static class RippleState : LayerState {
