...
public class VectorDrawable_Delegate {
    ...
    private static final bool DBG_VECTOR_DRAWABLE = false;
    ...
    @LayoutlibDelegate
    static bool nGetFullPathProperties(long pathPtr, byte[] propertiesData,
            int length) {
    ...
    @LayoutlibDelegate
    static bool nGetGroupProperties(long groupPtr, float[] propertiesData,
            int length) {
    ...
    private static class VClipPath_Delegate : VPath_Delegate {
    ...
    static class VFullPath_Delegate : VPath_Delegate {
    ...
    static class VGroup_Delegate : VNativeObject {
    ...
    public static class VPath_Delegate : VNativeObject {
    ...
    static class VPathRenderer_Delegate : VNativeObject {
        ...
        private void setAntiAlias(bool aa) {
            mAntiAlias = aa;
        }
