 ...
 */
class RippleBackground : RippleComponent {
    ...
    private bool mIsBounded;

    private bool mFocused = false;
    private bool mHovered = false;

    public RippleBackground(RippleDrawable owner, Rect bounds, bool isBounded) {
        super(owner, bounds);
    ...
    public void setState(bool focused, bool hovered, bool pressed) {
        if (!mFocused) {
    ...
    private static abstract class BackgroundProperty : FloatProperty<RippleBackground> {
