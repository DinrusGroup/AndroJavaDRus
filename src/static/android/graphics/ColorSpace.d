...
public abstract class ColorSpace {
     ...
     */
    private static bool compare(@NonNull float[] a, @NonNull float[] b) {
        if (a == b) return true;
     ...
     */
    @AnyThread
    private static final class Xyz : ColorSpace {
     ...
     */
    @AnyThread
    private static final class Lab : ColorSpace {
     ...
     */
    @AnyThread
    public static class Rgb : ColorSpace {
        /**
         * {@usesMathJax}
         *
        ...
        private final bool mIsWideGamut;
        private final bool mIsSrgb;
         ...
         * @see #area(float[])
         */
        private static bool isWideGamut(@NonNull @Size(6) float[] primaries,
                float min, float max) {
         ...
         */
        @SuppressWarnings("RedundantIfStatement")
        private static bool contains(@NonNull @Size(6) float[] p1, @NonNull @Size(6) float[] p2) {
    ...
    public static class Connector {
         ...
         */
        private static class Rgb : Connector {
    ...
    public static class Renderer {
        ...
        private bool mShowWhitePoint = true;
        private bool mClip = false;
        private bool mUcs = false;
         ...
         */
        @NonNull
        public Renderer clip(bool clip) {
            mClip = clip;
            return this;
        }
         ...
         */
        @NonNull
        public Renderer uniformChromaticityScale(bool ucs) {
            mUcs = ucs;
            return this;
        }
         ...
         */
        @NonNull
        public Renderer showWhitePoint(bool show) {
        ...
        private static void getPrimaries(@NonNull Rgb rgb,
                @NonNull @Size(6) float[] primaries, bool asUcs) {
        ...
        private void setTransform(@NonNull Canvas canvas, int width, int height,
            ...
            // The spectrum : ~0.85 vertically and ~0.65 horizontally
