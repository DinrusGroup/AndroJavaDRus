...
public final class Bitmap_Delegate {
    ...
    private bool mHasAlpha = true;
    private bool mHasMipMap = false;      // TODO: check the default.
    private bool mIsPremultiplied = true;
     ...
     */
    public static Bitmap createBitmap(File input, bool isMutable, Density density)
            throws IOException {
     ...
     * @see Bitmap#getDensity()
     */
    public static Bitmap createBitmap(InputStream input, bool isMutable, Density density)
            throws IOException {
        return createBitmap(input, getPremultipliedBitmapCreateFlags(isMutable), density);
    }
     ...
     * @see Bitmap#getDensity()
     */
    public static Bitmap createBitmap(BufferedImage image, bool isMutable, Density density) {
    ...
    /*package*/ static Bitmap nativeCreate(int[] colors, int offset, int stride, int width,
            int height, int nativeConfig, bool isMutable, @Nullable float[] xyzD50,
    ...
    @LayoutlibDelegate
    /*package*/ static Bitmap nativeCopy(long srcBitmap, int nativeConfig, bool isMutable) {
    ...
    @LayoutlibDelegate
    /*package*/ static bool nativeRecycle(long nativeBitmap) {
    ...
    /*package*/ static void nativeReconfigure(long nativeBitmap, int width, int height,
            int config, bool isPremultiplied) {
        Bridge.getLog().error(LayoutLog.TAG_UNSUPPORTED,
                "Bitmap.reconfigure() is not supported", null /*data*/);
    }

    @LayoutlibDelegate
    /*package*/ static bool nativeCompress(long nativeBitmap, int format, int quality,
    ...
    @LayoutlibDelegate
    /*package*/ static bool nativeHasAlpha(long nativeBitmap) {
        // get the delegate from the native int.
        Bitmap_Delegate delegate = sManager.getDelegate(nativeBitmap);
    ...
    @LayoutlibDelegate
    /*package*/ static bool nativeHasMipMap(long nativeBitmap) {
        // get the delegate from the native int.
        Bitmap_Delegate delegate = sManager.getDelegate(nativeBitmap);
    ...
    @LayoutlibDelegate
    /*package*/ static bool nativeWriteToParcel(long nativeBitmap, bool isMutable,
    ...
    @LayoutlibDelegate
    /*package*/ static bool nativeIsPremultiplied(long nativeBitmap) {
        // get the delegate from the native int.
        Bitmap_Delegate delegate = sManager.getDelegate(nativeBitmap);
    ...
    @LayoutlibDelegate
    /*package*/ static void nativeSetPremultiplied(long nativeBitmap, bool isPremul) {
        // get the delegate from the native int.
        Bitmap_Delegate delegate = sManager.getDelegate(nativeBitmap);
        if (delegate == null) {
            return;
    ...
    @LayoutlibDelegate
    /*package*/ static void nativeSetHasAlpha(long nativeBitmap, bool hasAlpha,
            bool isPremul) {
        // get the delegate from the native int.
        Bitmap_Delegate delegate = sManager.getDelegate(nativeBitmap);
        if (delegate == null) {
    ...
    @LayoutlibDelegate
    /*package*/ static void nativeSetHasMipMap(long nativeBitmap, bool hasMipMap) {
        // get the delegate from the native int.
        Bitmap_Delegate delegate = sManager.getDelegate(nativeBitmap);
        if (delegate == null) {
            return;
    ...
    @LayoutlibDelegate
    /*package*/ static bool nativeSameAs(long nb0, long nb1) {
    ...
    @LayoutlibDelegate
    /*package*/ static bool nativeIsSRGB(long nativeBitmap) {
        Bridge.getLog().error(LayoutLog.TAG_UNSUPPORTED,
    ...
    @LayoutlibDelegate
    /*package*/ static bool nativeGetColorSpace(long nativePtr, float[] xyz, float[] params) {
        Bridge.getLog().error(LayoutLog.TAG_UNSUPPORTED,
                "Color spaces are not supported", null /*data*/);
        return false;
    }
    ...
    private static Bitmap createBitmap(Bitmap_Delegate delegate,
        ...
        bool isMutable = createFlags.contains(BitmapCreateFlags.MUTABLE);
        bool isPremultiplied = createFlags.contains(BitmapCreateFlags.PREMULTIPLIED);
    ...
    private static Set<BitmapCreateFlags> getPremultipliedBitmapCreateFlags(bool isMutable) {
