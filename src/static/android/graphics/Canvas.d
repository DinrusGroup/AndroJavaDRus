...
public class Canvas : BaseCanvas {
    ...
    /** @hide */
    public static bool sCompatibilityRestore = false;
    /** @hide */
    public static bool sCompatibilitySetBitmap = false;
    ...
    /** @hide */
    public bool isRecordingFor(Object o) { return false; }
    ...
    */
     ...
     */
    @Deprecated
    public bool clipRect(@NonNull RectF rect, @NonNull Region.Op op) {
        checkValidClipOp(op);
     ...
     */
    @Deprecated
    public bool clipRect(@NonNull Rect rect, @NonNull Region.Op op) {
        checkValidClipOp(op);
        return nClipRect(mNativeCanvasWrapper, rect.left, rect.top, rect.right, rect.bottom,
                op.nativeInt);
    }
     ...
     * @hide
     */
    public bool clipRectUnion(@NonNull Rect rect) {
        return nClipRect(mNativeCanvasWrapper, rect.left, rect.top, rect.right, rect.bottom,
     ...
     * @return true if the resulting clip is non-empty
     */
    public bool clipRect(@NonNull RectF rect) {
        return nClipRect(mNativeCanvasWrapper, rect.left, rect.top, rect.right, rect.bottom,
     ...
     * @return true if the resulting clip is non-empty
     */
    public bool clipOutRect(@NonNull RectF rect) {
        return nClipRect(mNativeCanvasWrapper, rect.left, rect.top, rect.right, rect.bottom,
     ...
     * @return true if the resulting clip is non-empty
     */
    public bool clipRect(@NonNull Rect rect) {
        return nClipRect(mNativeCanvasWrapper, rect.left, rect.top, rect.right, rect.bottom,
                Region.Op.INTERSECT.nativeInt);
    }
     ...
     * @return true if the resulting clip is non-empty
     */
    public bool clipOutRect(@NonNull Rect rect) {
        return nClipRect(mNativeCanvasWrapper, rect.left, rect.top, rect.right, rect.bottom,
                Region.Op.DIFFERENCE.nativeInt);
    }
     ...
     */
    @Deprecated
    public bool clipRect(float left, float top, float right, float bottom,
     ...
     * @return       true if the resulting clip is non-empty
     */
    public bool clipOutRect(float left, float top, float right, float bottom) {
        return nClipRect(mNativeCanvasWrapper, left, top, right, bottom,
                Region.Op.DIFFERENCE.nativeInt);
    }
     ...
     * @return       true if the resulting clip is non-empty
     */
    public bool clipOutRect(int left, int top, int right, int bottom) {
        return nClipRect(mNativeCanvasWrapper, left, top, right, bottom,
                Region.Op.DIFFERENCE.nativeInt);
    }
     ...
     */
    @Deprecated
    public bool clipPath(@NonNull Path path, @NonNull Region.Op op) {
        checkValidClipOp(op);
     ...
     * @return     true if the resulting clip is non-empty
     */
    public bool clipPath(@NonNull Path path) {
     ...
     * @return     true if the resulting clip is non-empty
     */
    public bool clipOutPath(@NonNull Path path) {
     ...
     */
    @Deprecated
    public bool clipRegion(@NonNull Region region, @NonNull Region.Op op) {
        return false;
    }
     ...
     */
    @Deprecated
    public bool clipRegion(@NonNull Region region) {
        return false;
    }
     ...
     */
    public bool quickReject(@NonNull RectF rect, @NonNull EdgeType type) {
     ...
     *                    does not intersect with the canvas' clip
     */
    public bool quickReject(@NonNull Path path, @NonNull EdgeType type) {
     ...
     *                    does not intersect with the canvas' clip
     */
    public bool quickReject(float left, float top, float right, float bottom,
     ...
     */
    public bool getClipBounds(@Nullable Rect bounds) {
    ...
    @FastNative
    private static native bool nGetClipBounds(long nativeCanvas, Rect bounds);

    // ---------------- @CriticalNative -------------------

    @CriticalNative
    private static native bool nIsOpaque(long canvasHandle);
    @CriticalNative
    ...
    @CriticalNative
    private static native bool nRestore(long canvasHandle);
    @CriticalNative
    ...
    @CriticalNative
    private static native bool nClipRect(long nativeCanvas,
            float left, float top, float right, float bottom, int regionOp);
    @CriticalNative
    private static native bool nClipPath(long nativeCanvas, long nativePath, int regionOp);
    @CriticalNative
    ...
    @CriticalNative
    private static native bool nQuickReject(long nativeCanvas, long nativePath);
    @CriticalNative
    private static native bool nQuickReject(long nativeCanvas, float left, float top,
     ...
     */
    public void drawArc(@NonNull RectF oval, float startAngle, float sweepAngle, bool useCenter,
            @NonNull Paint paint) {
    ...
    public void drawArc(float left, float top, float right, float bottom, float startAngle,
            float sweepAngle, bool useCenter, @NonNull Paint paint) {
     ...
     * <p>
     * Note: if the paint contains a maskfilter that generates a mask which : beyond the
    ...
    public void drawBitmap(@NonNull int[] colors, int offset, int stride, float x, float y,
            int width, int height, bool hasAlpha, @Nullable Paint paint) {
     ...
     * shaping.
     * <p>
     * See {@link #drawTextRun(CharSequence, int, int, int, int, float, float, bool, Paint)} for
    ...
    public void drawTextRun(@NonNull char[] text, int index, int count, int contextIndex,
            int contextCount, float x, float y, bool isRtl, @NonNull Paint paint) {
     ...
     * @param isRtl whether the run is in RTL direction
     * @param paint the paint
     * @see #drawTextRun(char[], int, int, int, int, float, float, bool, Paint)
     */
    public void drawTextRun(@NonNull CharSequence text, int start, int end, int contextStart,
            int contextEnd, float x, float y, bool isRtl, @NonNull Paint paint) {
