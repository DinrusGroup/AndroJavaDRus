...
public final class Bitmap : Parcelable {
    ...
    Bitmap(long nativeBitmap, int width, int height, int density,
            bool isMutable, bool requestPremultiplied,
    ...
    public static Bitmap createBitmap(@NonNull Bitmap source, int x, int y, int width, int height,
        ...
        if (m == null || m.isIdentity()) {
            ...
            final bool transformed = !m.rectStaysRect();
    ...
    public static Bitmap createBitmap(int width, int height,
            @NonNull Config config, bool hasAlpha) {
     ...
     */
    public static Bitmap createBitmap(int width, int height, @NonNull Config config,
            bool hasAlpha, @NonNull ColorSpace colorSpace) {
     ...
     */
    public static Bitmap createBitmap(@Nullable DisplayMetrics display, int width, int height,
            @NonNull Config config, bool hasAlpha, @NonNull ColorSpace colorSpace) {
        if (width <= 0 || height <= 0) {
            throw new IllegalArgumentException("width and height must be > 0");
        }
     ...
     */
    public final bool isPremultiplied() {
        if (mRecycled) {
     ...
     * @see BitmapFactory.Options#inPremultiplied
     */
    public final void setPremultiplied(bool premultiplied) {
     ...
     *         false otherwise
     *
     * @see #setHasMipMap(bool)
     */
    public final bool hasMipMap() {
        if (mRecycled) {
     ...
     * @see #hasMipMap()
     */
    public final void setHasMipMap(bool hasMipMap) {
    ...
    public final ColorSpace getColorSpace() {
        ...
        if (mColorSpace == null) {
            if (nativeIsSRGB(mNativePtr)) {
                ...
                bool hasColorSpace = nativeGetColorSpace(mNativePtr, xyz, params);
                if (hasColorSpace) {
    ...
    */
    ...
    private static native bool nativeRecycle(long nativeBitmap);
    private static native void nativeReconfigure(long nativeBitmap, int width, int height,
                                                 int config, bool isPremultiplied);

    private static native bool nativeCompress(long nativeBitmap, int format,
    ...
    private static native bool nativeWriteToParcel(long nativeBitmap,
                                                      bool isMutable,
                                                      int density,
                                                      Parcel p);
    ...
    private static native bool nativeHasAlpha(long nativeBitmap);
    private static native bool nativeIsPremultiplied(long nativeBitmap);
    ...
    private static native void nativeSetHasAlpha(long nativeBitmap,
                                                 bool hasAlpha,
                                                 bool requestPremul);
    private static native bool nativeHasMipMap(long nativeBitmap);
    private static native void nativeSetHasMipMap(long nativeBitmap, bool hasMipMap);
    private static native bool nativeSameAs(long nativeBitmap0, long nativeBitmap1);
    ...
    private static native bool nativeGetColorSpace(long nativePtr, float[] xyz, float[] params);
    private static native bool nativeIsSRGB(long nativePtr);
    private static native bool nativeIsSRGBLinear(long nativePtr);
