...
public class SurfaceTexture {
    ...
    @Deprecated
    public static class OutOfResourcesException : Exception {
     ...
     * OpenGL ES function call each frame.
     *
     * Unlike {@link #SurfaceTexture(int, bool)}, which takes an OpenGL texture object name,
     ...
     * For more information see {@link #SurfaceTexture(int, bool)}.
     */
    ...
    private native void nativeInit(bool isDetached, int texName,
            bool singleBufferMode, WeakReference<SurfaceTexture> weakSelf)
    ...
    private native bool nativeIsReleased();
}
