 ...
 *
 */
public final class Canvas_Delegate : BaseCanvas_Delegate {
    ...
    @LayoutlibDelegate
    public static bool nIsOpaque(long nativeCanvas) {
    ...
    @LayoutlibDelegate
    public static bool nRestore(long nativeCanvas) {
   ...
   public static void nSkew(long nativeCanvas, float kx, float ky) {
    ...
    @LayoutlibDelegate
    public static bool nClipRect(long nCanvas,
    ...
    @LayoutlibDelegate
    public static bool nClipPath(long nativeCanvas,
                                                  long nativePath,
                                                  int regionOp) {
        Canvas_Delegate canvasDelegate = Canvas_Delegate.getDelegate(nativeCanvas);
        if (canvasDelegate == null) {
    ...
    @LayoutlibDelegate
    public static bool nGetClipBounds(long nativeCanvas,
                                                       Rect bounds) {
        // get the delegate from the native int.
        Canvas_Delegate canvasDelegate = Canvas_Delegate.getDelegate(nativeCanvas);
        if (canvasDelegate == null) {
    ...
    @LayoutlibDelegate
    public static bool nQuickReject(long nativeCanvas, long path) {
        // FIXME properly implement quickReject
        return false;
    }

    @LayoutlibDelegate
    public static bool nQuickReject(long nativeCanvas,
                                                     float left, float top,
                                                     float right, float bottom) {
        // FIXME properly implement quickReject
        return false;
