...
public class Color {
    ...
    public static float red(@ColorLong long color) {
        ...
        return Half.toFloat(cast(short) ((color >> 48) & 0xffff));
    }
    ...
    public static float green(@ColorLong long color) {
        ...
        return Half.toFloat(cast(short) ((color >> 32) & 0xffff));
    }
    ...
    public static float blue(@ColorLong long color) {
        ...
        return Half.toFloat(cast(short) ((color >> 16) & 0xffff));
    }
     ...
     */
    public static bool isSrgb(@ColorLong long color) {
     ...
     * @see ColorSpace#isWideGamut()
     */
    public static bool isWideGamut(@ColorLong long color) {
     ...
     * @see #isWideGamut(long)
     */
    public static bool isInColorSpace(@ColorLong long color, @NonNull ColorSpace colorSpace) {
