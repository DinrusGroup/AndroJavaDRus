...
public final class Path_Delegate {
    ...
    private bool mCachedIsEmpty = true;
    ...
    @LayoutlibDelegate
    /*package*/ static bool nIsConvex(long nPath) {
    ...
    @LayoutlibDelegate
    /*package*/ static bool nIsEmpty(long nPath) {
        Path_Delegate pathDelegate = sManager.getDelegate(nPath);
    ...
    @LayoutlibDelegate
    /*package*/ static bool nIsRect(long nPath, RectF rect) {
        Path_Delegate pathDelegate = sManager.getDelegate(nPath);
        if (pathDelegate == null) {
            return false;
        }
    ...
    @LayoutlibDelegate
    /*package*/ static bool nOp(long nPath1, long nPath2, int op, long result) {
