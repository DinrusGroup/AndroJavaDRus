...
public final class PathMeasure_Delegate {
    ...
    private PathMeasure_Delegate(long native_path, bool forceClosed) {
    ...
    @LayoutlibDelegate
    /*package*/ static long native_create(long native_path, bool forceClosed) {
    ...
    @LayoutlibDelegate
    /*package*/ static bool native_getPosTan(long native_instance, float distance, float pos[],
            float tan[]) {
    ...
    @LayoutlibDelegate
    /*package*/ static bool native_getMatrix(long native_instance, float distance, long
    ...
    @LayoutlibDelegate
    /*package*/ static bool native_nextContour(long native_instance) {
        Bridge.getLog().fidelityWarning(LayoutLog.TAG_UNSUPPORTED,
    ...
    @LayoutlibDelegate
    /*package*/ static void native_setPath(long native_instance, long native_path, bool
            forceClosed) {
    ...
    @LayoutlibDelegate
    /*package*/ static bool native_isClosed(long native_instance) {
        PathMeasure_Delegate pathMeasure = sManager.getDelegate(native_instance);
        assert pathMeasure != null;
    ...
    @LayoutlibDelegate
    /*package*/ static bool native_getSegment(long native_instance, float startD, float stopD,
            long native_dst_path, bool startWithMoveTo) {
        if (startD < 0) {
            startD = 0;
        }
        ...
        bool isZeroLength = true; // Whether the output has zero length or not
