 ...
 */
public final class ImageDecoder : AutoCloseable {
    ...
    private static class ByteArraySource : Source {
    ...
    private static class ByteBufferSource : Source {
    ...
    private static class ContentResolverSource : Source {
     ...
     */
    private static class InputStreamSource : Source {
     ...
     * @hide
     */
    public static class AssetInputStreamSource : Source {
    ...
    private static class ResourceSource : Source {
    ...
    private static class FileSource : Source {
     ...
     */
    public static class IncompleteException : IOException {};
    ...
    public interface OnPartialImageListener {
         ...
         */
        bool onPartialImage(@Error int error, @NonNull Source source);
    }
     ...
     */
    public ImageDecoder setRequireUnpremultiplied(bool requireUnpremultiplied) {
        return this;
    }
     ...
     */
    public ImageDecoder setMutable(bool mutable) {
        return this;
    }
     ...
     */
    public ImageDecoder setPreferRamOverQuality(bool preferRamOverQuality) {
        return this;
    }
     ...
     *  {@link java.lang.IllegalStateException}.</p>
     */
    public ImageDecoder setAsAlphaMask(bool asAlphaMask) {
        return this;
    }
