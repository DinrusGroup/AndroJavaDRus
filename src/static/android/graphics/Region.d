...
public class Region : Parcelable {
    ...
    */
    ...
    public final bool union(Rect r) {
    ...
    private static native bool nativeEquals(long native_r1, long native_r2);
    ...
    private static native bool nativeSetRect(long native_dst, int left,
                                                int top, int right, int bottom);
    private static native bool nativeSetPath(long native_dst, long native_path,
                                                long native_clip);
    private static native bool nativeGetBounds(long native_region, Rect rect);
    private static native bool nativeGetBoundaryPath(long native_region,
                                                        long native_path);

    private static native bool nativeOp(long native_dst, int left, int top,
                                           int right, int bottom, int op);
    private static native bool nativeOp(long native_dst, Rect rect,
                                           long native_region, int op);
    private static native bool nativeOp(long native_dst, long native_region1,
                                           long native_region2, int op);

    private static native long nativeCreateFromParcel(Parcel p);
    private static native bool nativeWriteToParcel(long native_region,
                                                      Parcel p);
