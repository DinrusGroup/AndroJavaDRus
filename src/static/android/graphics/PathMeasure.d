...
public class PathMeasure {
    ...
    */
    public bool getPosTan(float distance, float pos[], float tan[]) {
     ...
     */
    public bool getMatrix(float distance, Matrix matrix, int flags) {
    ...
    private static native long native_create(long native_path, bool forceClosed);
    private static native void native_setPath(long native_instance, long native_path, bool forceClosed);
    private static native float native_getLength(long native_instance);
    private static native bool native_getPosTan(long native_instance, float distance, float pos[], float tan[]);
    private static native bool native_getMatrix(long native_instance, float distance, long native_matrix, int flags);
    private static native bool native_getSegment(long native_instance, float startD, float stopD, long native_path, bool startWithMoveTo);
    private static native bool native_isClosed(long native_instance);
    private static native bool native_nextContour(long native_instance);
