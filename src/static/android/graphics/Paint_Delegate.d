...
public class Paint_Delegate {
    ...
    @LayoutlibDelegate
    /*package*/ static void nSetFilterBitmap(long nativePaint, bool filter) {
    ...
    @LayoutlibDelegate
    /*package*/ static void nSetAntiAlias(long nativePaint, bool aa) {
    ...
    @LayoutlibDelegate
    /*package*/ static void nSetDither(long nativePaint, bool dither) {
        setFlag(nativePaint, Paint.DITHER_FLAG, dither);
    }

    @LayoutlibDelegate
    /*package*/ static void nSetLinearText(long nativePaint, bool linearText) {
    ...
    @LayoutlibDelegate
    /*package*/ static bool nHasShadowLayer(long paint) {
        // FIXME
        Bridge.getLog().fidelityWarning(LayoutLog.TAG_UNSUPPORTED,
    ...
    @LayoutlibDelegate
    /*package*/ static bool nIsElegantTextHeight(long nativePaint) {
        // get the delegate from the native int.
        Paint_Delegate delegate = sManager.getDelegate(nativePaint);
    ...
    @LayoutlibDelegate
    /*package*/ static int nBreakText(long nativePaint, String text, bool measureForwards,
    ...
    @LayoutlibDelegate
    /*package*/ static bool nGetFillPath(long native_object, long src, long dst) {
    ...
    @LayoutlibDelegate
    /*package*/ static bool nHasGlyph(long nativePaint, int bidiFlags, String string) {
        Paint_Delegate delegate = sManager.getDelegate(nativePaint);
        if (delegate == null) {
            return false;
        }
    ...
    /*package*/ static int nGetOffsetForAdvance(long nativePaint, char[] text, int start,
            int end, int contextStart, int contextEnd, bool isRtl, float advance) {
        int count = end - start;
        float[] advances = new float[count];
        int bidiFlags = isRtl ? Paint.BIDI_FORCE_RTL : Paint.BIDI_FORCE_LTR;
        nGetTextAdvances(nativePaint, text, start, count, contextStart,
    ...
    @LayoutlibDelegate
    /*package*/ static bool nEqualsForTextMeasurement(long leftPaintPtr, long rightPaintPtr) {
    ...
    private static void setFlag(long nativePaint, int flagMask, bool flagValue) {
        // get the delegate from the native int.
        Paint_Delegate delegate = sManager.getDelegate(nativePaint);
        if (delegate == null) {
            return;
