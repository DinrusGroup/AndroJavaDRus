...
public final class Matrix_Delegate {
    ...
    public static bool hasPerspective(Matrix m) {
        Matrix_Delegate delegate = sManager.getDelegate(m.native_instance);
        if (delegate == null) {
            return false;
        }
    ...
    public bool mapRect(RectF dst, RectF src) {
    ...
    @LayoutlibDelegate
    /*package*/ static bool nIsIdentity(long native_object) {
    ...
    @LayoutlibDelegate
    /*package*/ static bool nIsAffine(long native_object) {
        Matrix_Delegate d = sManager.getDelegate(native_object);
        if (d == null) {
            return true;
        }
    ...
    @LayoutlibDelegate
    /*package*/ static bool nRectStaysRect(long native_object) {
        Matrix_Delegate d = sManager.getDelegate(native_object);
        if (d == null) {
            return true;
        }
    ...
    @LayoutlibDelegate
    /*package*/ static bool nSetRectToRect(long native_object, RectF src,
            RectF dst, int stf) {
        Matrix_Delegate d = sManager.getDelegate(native_object);
        if (d == null) {
            return false;
    ...
    @LayoutlibDelegate
    /*package*/ static bool nSetPolyToPoly(long native_object, float[] src, int srcIndex,
    ...
    @LayoutlibDelegate
    /*package*/ static bool nInvert(long native_object, long inverse) {
        Matrix_Delegate d = sManager.getDelegate(native_object);
        if (d == null) {
            return false;
        }
    ...
    /*package*/ static void nMapPoints(long native_object, float[] dst, int dstIndex,
            float[] src, int srcIndex, int ptCount, bool isPts) {
        Matrix_Delegate d = sManager.getDelegate(native_object);
        if (d == null) {
            return;
        }
    ...
    @LayoutlibDelegate
    /*package*/ static bool nMapRect(long native_object, RectF dst, RectF src) {
        Matrix_Delegate d = sManager.getDelegate(native_object);
        if (d == null) {
            return false;
        }
    ...
    @LayoutlibDelegate
    /*package*/ static bool nEquals(long native_a, long native_b) {
