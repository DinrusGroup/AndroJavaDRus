 ...
 * {@link AccessibilityButtonCallback#onAvailabilityChanged(AccessibilityButtonController, bool)}
...
public final class AccessibilityButtonController {
     ...
     */
    void dispatchAccessibilityButtonAvailabilityChanged(bool available) {
        final ArrayMap<AccessibilityButtonCallback, Handler> entries;
        synchronized (mLock) {
            if (mCallbacks == null || mCallbacks.isEmpty()) {
                Slog.w(LOG_TAG,
