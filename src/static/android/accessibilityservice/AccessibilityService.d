...
public abstract class AccessibilityService : Service {
    ...
    public interface Callbacks {
        ...
        void onPerformGestureResult(int sequence, bool completedSuccessfully);
        void onFingerprintCapturingGesturesChanged(bool active);
        void onFingerprintGesture(int gesture);
        void onAccessibilityButtonClicked();
        void onAccessibilityButtonAvailabilityChanged(bool available);
    }
     ...
     */
    protected bool onGesture(int gestureId) {
        return false;
    }
     ...
     */
    protected bool onKeyEvent(KeyEvent event) {
        return false;
    }
     ...
     */
    public final bool dispatchGesture(@NonNull GestureDescription gesture,
    ...
    void onPerformGestureResult(int sequence, final bool completedSuccessfully) {
        if (mGestureStatusCallbackInfos == null) {
            return;
        }
     ...
     */
    private void onFingerprintCapturingGesturesChanged(bool active) {
    ...
    public static final class MagnificationController {
        ...
        public void addListener(@NonNull OnMagnificationChangedListener listener,
            ...
            synchronized (mLock) {
                ...
                final bool shouldEnableCallback = mListeners.isEmpty();
         ...
         */
        public bool removeListener(@NonNull OnMagnificationChangedListener listener) {
            if (mListeners == null) {
                return false;
            }
        ...
        private void setMagnificationCallbackEnabled(bool enabled) {
            final IAccessibilityServiceConnection connection =
                    AccessibilityInteractionClient.getInstance().getConnection(
    ...
    public static final class SoftKeyboardController {
         ...
         * @return {@code true} if the listener was removed, {@code false} otherwise
         */
        public bool removeOnShowModeChangedListener(@NonNull OnShowModeChangedListener listener) {
            if (mListeners == null) {
                return false;
            }
        ...
        private void setSoftKeyboardCallbackEnabled(bool enabled) {
            final IAccessibilityServiceConnection connection =
                    AccessibilityInteractionClient.getInstance().getConnection(
                            mService.mConnectionId);
            if (connection != null) {
         ...
         */
        public bool setShowMode(@SoftKeyboardShowMode int showMode) {
           final IAccessibilityServiceConnection connection =
                   AccessibilityInteractionClient.getInstance().getConnection(
                           mService.mConnectionId);
           if (connection != null) {
    ...
    private void onAccessibilityButtonAvailabilityChanged(bool available) {
     ...
     */
    public final bool performGlobalAction(int action) {
    ...
    public final IBinder onBind(Intent intent) {
        return new IAccessibilityServiceClientWrapper(this, getMainLooper(), new Callbacks() {
            ...
            override
            public bool onGesture(int gestureId) {
                return AccessibilityService.this.onGesture(gestureId);
            }

            override
            public bool onKeyEvent(KeyEvent event) {
            ...
            override
            public void onPerformGestureResult(int sequence, bool completedSuccessfully) {
                AccessibilityService.this.onPerformGestureResult(sequence, completedSuccessfully);
            }

            override
            public void onFingerprintCapturingGesturesChanged(bool active) {
            ...
            override
            public void onAccessibilityButtonAvailabilityChanged(bool available) {
     ...
     * @hide
     */
    public static class IAccessibilityServiceClientWrapper : IAccessibilityServiceClient.Stub
        ...
        public void onAccessibilityEvent(AccessibilityEvent event, bool serviceWantsEvent) {
        ...
        public void onPerformGestureResult(int sequence, bool successfully) {
            ...
            switch (message.what) {
                ...
                case DO_ON_KEY_EVENT: {
                    ...
                    try {
                        ...
                        if (connection != null) {
                            final bool result = mCallback.onKeyEvent(event);
                ...
                case DO_GESTURE_COMPLETE: {
                    if (mConnectionId != AccessibilityInteractionClient.NO_ID) {
                        final bool successfully = message.arg2 == 1;
