...
public class SmsMessage {
     ...
     */
    public static int[] calculateLength(CharSequence msgBody, bool use7bitOnly) {
    ...
    public static SubmitPdu getSubmitPdu(String scAddress,
            String destinationAddress, String message, bool statusReportRequested) {
     ...
     */
    public static SubmitPdu getSubmitPdu(String scAddress,
            String destinationAddress, String message, bool statusReportRequested, int subId) {
        SubmitPduBase spb;
     ...
     */
    private static bool useCdmaFormatForMoSms() {
     ...
     * @return true if Cdma format should be used for MO SMS, false otherwise.
     */
    private static bool useCdmaFormatForMoSms(int subId) {
     ...
     */
    private static bool isCdmaVoice() {
      ...
      * @return true if current phone type is cdma, false otherwise.
      */
     private static bool isCdmaVoice(int subId) {
     ...
     * {@hide}
     */
    public static bool hasEmsSupport() {
     ...
     * {@hide}
     */
    public static bool shouldAppendPageNumberAsPrefix() {
        if (!isNoEmsSupportConfigListExisted()) {
            return false;
        }
    ...
    private static bool mIsNoEmsSupportConfigListLoaded = false;

    private static bool isNoEmsSupportConfigListExisted() {
