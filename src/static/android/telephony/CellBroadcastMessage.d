 ...
 * {@hide}
 */
public class CellBroadcastMessage : Parcelable {
    ...
    private CellBroadcastMessage(SmsCbMessage message, long deliveryTime, bool isRead) {
        mSmsCbMessage = message;
    ...
    public static CellBroadcastMessage createFromCursor(Cursor cursor) {
        ...
        bool isRead = (cursor.getInt(cursor.getColumnIndexOrThrow(
     ...
     */
    public bool isPublicAlertMessage() {
     ...
     */
    public bool isEmergencyAlertMessage() {
        return mSmsCbMessage.isEmergencyMessage();
    }
     ...
     */
    public bool isEtwsEmergencyUserAlert() {
        SmsCbEtwsInfo etwsInfo = mSmsCbMessage.getEtwsWarningInfo();
