...
public class PhoneStateListener {
     ...
     * @see TelephonyManager#notifyCarrierNetworkChange(bool)
     * @hide
     */
            ...
            public void handleMessage(Message msg) {
                ...
                switch (msg.what) {
                    ...
                    case LISTEN_USER_MOBILE_DATA_STATE:
                        PhoneStateListener.this.onUserMobileDataStateChanged((bool)msg.obj);
                        break;
                    case LISTEN_OEM_HOOK_RAW_EVENT:
                        PhoneStateListener.this.onOemHookRawEvent((byte[])msg.obj);
                        break;
                    case LISTEN_CARRIER_NETWORK_CHANGE:
                        PhoneStateListener.this.onCarrierNetworkChange((bool)msg.obj);
                        break;
     ...
     */
    public void onMessageWaitingIndicatorChanged(bool mwi) {
        // default implementation empty
    }
     ...
     */
    public void onCallForwardingIndicatorChanged(bool cfi) {
        // default implementation empty
    }
     ...
     */
    public void onUserMobileDataStateChanged(bool enabled) {
        // default implementation empty
    }
     ...
     * {@link android.telephony.TelephonyManager#notifyCarrierNetworkChange(bool)}
     *
     ...
     */
    private static class IPhoneStateListenerStub : IPhoneStateListener.Stub {
