 ...
 *
 * The inner class {@link ImsConfigStub} : methods of IImsConfig AIDL interface.
...
public class ImsConfigImplBase {
     ...
     */
    public bool getVolteProvisioned() throws RemoteException {
        return false;
    }
     ...
     */
    @VisibleForTesting
    static public class ImsConfigStub : IImsConfig.Stub {
        Context mContext;
        ...
        protected synchronized void updateCachedValue(int item, int value, bool notifyChange) {
        ...
        protected synchronized void updateCachedValue(
                int item, String value, bool notifyChange) {
