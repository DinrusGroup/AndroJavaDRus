...
/**
 * Base implementation of IMS UT interface, which : stubs. Override these methods to
...
public class ImsUtImplBase {
    ...
    private IImsUt.Stub mServiceImpl = new IImsUt.Stub() {
        ...
        override
        public int updateCallWaiting(bool enable, int serviceClass) throws RemoteException {
        ...
        override
        public int updateCLIP(bool enable) throws RemoteException {
        ...
        override
        public int updateCOLP(bool enable) throws RemoteException {
     ...
     */
    public int updateCallWaiting(bool enable, int serviceClass) {
        return -1;
    }
     ...
     * @hide
     */
    public int updateCLIP(bool enable) {
     ...
     * @hide
     */
    public int updateCOLP(bool enable) {
