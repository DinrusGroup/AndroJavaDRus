 ...
 */
@SystemApi
public class MmTelFeature : ImsFeature {
    ...
    private final IImsMmTelFeature mImsMMTelBinder = new IImsMmTelFeature.Stub() {
        ...
        override
        public void sendSms(int token, int messageRef, String format, String smsc, bool retry,
                byte[] pdu) {
            synchronized (mLock) {
     ...
     */
    public static class MmTelCapabilities : Capabilities {
        ...
        override
        public final bool isCapable(@MmTelCapability int capabilities) {
    ...
    /**
     * Listener that the framework : for communication from the MmTelFeature.
     * @hide
     */
    public static class Listener : IImsMmTelListener.Stub {
    ...
    private void queryCapabilityConfigurationInternal(int capability, int radioTech,
            IImsCapabilityCallback c) {
        bool enabled = queryCapabilityConfiguration(capability, radioTech);
        try {
            if (c != null) {
     ...
     */
    public bool queryCapabilityConfiguration(@MmTelCapabilities.MmTelCapability int capability,
    ...
    private void sendSms(int token, int messageRef, String format, String smsc, bool isRetry,
            byte[] pdu) {
