 ...
 * It directly communicates with IMS service which : the IMS protocol behavior.
 *
 * @hide
 */
public class ImsCallSession {
     ...
     */
    public void sendRttModifyResponse(bool response) {
        if (mClosed) {
            return;
        }
     ...
     */
    private class IImsCallSessionListenerProxy : IImsCallSessionListener.Stub {
        /**
         ...
         *      otherwise.
         */
        public void callSessionMultipartyStateChanged(bool isMultiParty) {
            if (mListener != null) {
