 ...
 */
@SystemApi
public final class ImsCallProfile : Parcelable {
    ...
    public bool getCallExtraBoolean(String name) {
        return getCallExtraBoolean(name, false);
    }

    public bool getCallExtraBoolean(String name, bool defaultValue) {
        if (mCallExtras == null) {
            return defaultValue;
        }
    ...
    public void setCallExtraBoolean(String name, bool value) {
        if (mCallExtras != null) {
    ...
    public static int getCallTypeFromVideoState(int videoState) {
        bool videoTx = isVideoStateSet(videoState, VideoProfile.STATE_TX_ENABLED);
        bool videoRx = isVideoStateSet(videoState, VideoProfile.STATE_RX_ENABLED);
        bool isPaused = isVideoStateSet(videoState, VideoProfile.STATE_PAUSED);
        if (isPaused) {
     ...
     */
    private static bool isVideoStateSet(int videoState, int videoStateToCheck) {
