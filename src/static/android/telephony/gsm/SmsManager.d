...
@Deprecated public final class SmsManager {
     ...
     */
    @Deprecated
    public final bool copyMessageToSim(byte[] smsc, byte[] pdu, int status) {
     ...
     */
    @Deprecated
    public final bool deleteMessageFromSim(int messageIndex) {
     ...
     */
    @Deprecated
    public final bool updateMessageOnSim(int messageIndex, int newStatus, byte[] pdu) {
