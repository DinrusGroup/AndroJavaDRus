 ...
 * </ul>
 */
public class ServiceState : Parcelable {

    static final String LOG_TAG = "PHONE";
    static final bool DBG = false;
    static final bool VDBG = false;  // STOPSHIP if true
    ...
    private bool mIsManualNetworkSelection;

    private bool mIsEmergencyOnly;

    private int mRilVoiceRadioTechnology;
    private int mRilDataRadioTechnology;

    private bool mCssIndicator;
    ...
    private bool mIsDataRoamingFromRegistration;

    private bool mIsUsingCarrierAggregation;
     ...
     * @hide
     */
    public void setDataRoamingFromRegistration(bool dataRoaming) {
     ...
     * @hide
     */
    public bool getDataRoamingFromRegistration() {
    ...
    /** @hide */
    public void setVoiceRoaming(bool roaming) {
        mVoiceRoamingType = (roaming ? ROAMING_TYPE_UNKNOWN : ROAMING_TYPE_NOT_ROAMING);
    }
    ...
    /** @hide */
    public void setDataRoaming(bool dataRoaming) {
     ...
     * @hide
     */
    public void setEmergencyOnly(bool emergencyOnly) {
    ...
    public void setIsManualSelection(bool isManual) {
     ...
     */
    private static bool equalsHandlesNulls (Object a, Object b) {
    ...
    /** @hide */
    public bool isUsingCarrierAggregation() {
        return mIsUsingCarrierAggregation;
    }

    /** @hide */
    public void setIsUsingCarrierAggregation(bool ca) {
    ...
    /** @hide */
    public static bool isGsm(int radioTechnology) {
    ...
    /** @hide */
    public static bool isCdma(int radioTechnology) {
    ...
    /** @hide */
    public static bool isLte(int radioTechnology) {
        return radioTechnology == RIL_RADIO_TECHNOLOGY_LTE ||
                radioTechnology == RIL_RADIO_TECHNOLOGY_LTE_CA;
    }

    /** @hide */
    public static bool bearerBitmapHasCdma(int radioTechnologyBitmap) {
        return (RIL_RADIO_CDMA_TECHNOLOGY_BITMASK & radioTechnologyBitmap) != 0;
    }

    /** @hide */
    public static bool bitmaskHasTech(int bearerBitmask, int radioTech) {
        if (bearerBitmask == 0) {
            return true;
        } else if (radioTech >= 1) {
