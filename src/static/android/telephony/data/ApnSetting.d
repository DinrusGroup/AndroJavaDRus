 ...
 */
public class ApnSetting : Parcelable {
    ...
    private final bool mCarrierEnabled;

    private final int mNetworkTypeBitmask;

    private final int mProfileId;

    private final bool mModemCognitive;
    ...
    private bool mPermanentFailed = false;
     ...
     * @hide
     */
    public bool getPermanentFailed() {
     ...
     * @hide
     */
    public void setPermanentFailed(bool permanentFailed) {
    ...
    public static ApnSetting makeApnSetting(int id, String operatorNumeric, String entryName,
            ...
            int protocol, int roamingProtocol, bool carrierEnabled,
    ...
    /** @hide */
    public bool canHandleType(@ApnType int type) {
    ...
    private bool xorEquals(Object first, Object second) {
        return first == null || second == null || first.equals(second);
    }

    // Equal or one is not specified.
    private bool xorEqualsPort(int first, int second) {
    ...
    private static ApnSetting readFromParcel(Parcel in) {
        ...
        final bool carrierEnabled = in.readInt() > 0;
    ...
    public static class Builder{
        ...
        private bool mCarrierEnabled;
        private int mProfileId;
        private bool mModemCognitive;
         ...
         * @hide
         */
        public Builder setModemCognitive(bool modemCognitive) {
         ...
         */
        public Builder setCarrierEnabled(bool carrierEnabled) {
