 ...
 * @hide
 */
public abstract class DataService : Service {
    ...
    public class DataServiceProvider {
        ...
        public void setupDataCall(int accessNetworkType, DataProfile dataProfile, bool isRoaming,
                                  bool allowRoaming, @SetupDataReason int reason,
         ...
         *        int, DataProfile, bool, bool, int, LinkProperties, DataServiceCallback)}.
         ...
         *        about the result.
         */
        public void setInitialAttachApn(DataProfile dataProfile, bool isRoaming,
                                        @Nullable DataServiceCallback callback) {
            // The default implementation is to return unsupported.
         ...
         *        about the result.
         */
        public void setDataProfile(List<DataProfile> dps, bool isRoaming,
                                   @Nullable DataServiceCallback callback) {
            // The default implementation is to return unsupported.
    ...
    private static final class SetupDataCallRequest {
        ...
        public final bool isRoaming;
        public final bool allowRoaming;
        public final int reason;
        public final LinkProperties linkProperties;
        public final IDataServiceCallback callback;
        SetupDataCallRequest(int accessNetworkType, DataProfile dataProfile, bool isRoaming,
    ...
    private static final class SetInitialAttachApnRequest {
        ...
        public final bool isRoaming;
        public final IDataServiceCallback callback;
        SetInitialAttachApnRequest(DataProfile dataProfile, bool isRoaming,
                                   IDataServiceCallback callback) {
            this.dataProfile = dataProfile;
            this.isRoaming = isRoaming;
            this.callback = callback;
    ...
    private static final class SetDataProfileRequest {
        ...
        public final bool isRoaming;
        public final IDataServiceCallback callback;
        SetDataProfileRequest(List<DataProfile> dps, bool isRoaming,
                              IDataServiceCallback callback) {
            this.dps = dps;
            this.isRoaming = isRoaming;
            this.callback = callback;
    ...
    private class DataServiceHandler : Handler {
     ...
     */
    private class IDataServiceWrapper : IDataService.Stub {
        override
        ...
        public void setupDataCall(int slotId, int accessNetworkType, DataProfile dataProfile,
                                  bool isRoaming, bool allowRoaming, int reason,
        ...
        override
        public void setInitialAttachApn(int slotId, DataProfile dataProfile, bool isRoaming,
                                        IDataServiceCallback callback) {
        ...
        override
        public void setDataProfile(int slotId, List<DataProfile> dps, bool isRoaming,
                                   IDataServiceCallback callback) {
