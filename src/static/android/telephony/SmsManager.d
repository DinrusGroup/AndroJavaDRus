...
public final class SmsManager {
    ...
    /**
     * Whether content-disposition field should be expected in an MMS PDU (bool type)
     */
    ...
    public void sendTextMessageWithSelfPermissions(
            String destinationAddress, String scAddress, String text,
            PendingIntent sentIntent, PendingIntent deliveryIntent, bool persistMessage) {
        if (TextUtils.isEmpty(destinationAddress)) {
            throw new IllegalArgumentException("Invalid destinationAddress");
        }
   ...
   /**
    ...
    public int getSubscriptionId() {
        ...
        bool isSmsSimPickActivityNeeded = false;
     ...
     * {@hide}
     */
    public bool copyMessageToIcc(byte[] smsc, byte[] pdu,int status) {
        bool success = false;
    ...
    deleteMessageFromIcc(int messageIndex) {
        ...
        Arrays.fill(pdu, cast(byte)0xff);
     ...
     * {@hide}
     */
    public bool updateMessageOnIcc(int messageIndex, int newStatus, byte[] pdu) {
        bool success = false;
     ...
     * {@hide}
     */
    public bool deleteStoredMessage(Uri messageUri) {
        if (messageUri == null) {
     ...
     * {@hide}
     */
    public bool deleteStoredConversation(long conversationId) {
        try {
            IMms iMms = IMms.Stub.asInterface(ServiceManager.getService("imms"));
            if (iMms != null) {
     ...
     * {@hide}
     */
    public bool updateStoredMessageStatus(Uri messageUri, ContentValues statusValues) {
        if (messageUri == null) {
            throw new IllegalArgumentException("Empty message URI");
        }
        try {
     ...
     * {@hide}
     */
    public bool archiveStoredConversation(long conversationId, bool archived) {
        try {
            IMms iMms = IMms.Stub.asInterface(ServiceManager.getService("imms"));
            if (iMms != null) {
     ...
     * {@hide}
     */
    public void setAutoPersisting(bool enabled) {
        try {
            IMms iMms = IMms.Stub.asInterface(ServiceManager.getService("imms"));
            if (iMms != null) {
