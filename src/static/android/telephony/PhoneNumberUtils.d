...
public class PhoneNumberUtils {
     ...
     */
    public static bool compare(Context context, String a, String b) {
        bool useStrict = context.getResources().getBoolean(
     ...
     */
    public static bool compare(String a, String b, bool useStrictComparation) {
     ...
     */
    public static bool
    compareStrictly(String a, String b, bool acceptInvalidCCCPrefix) {
        if (a == null || b == null) {
            return a == b;
        ...
        bool bothHasCountryCallingCode = false;
        bool okToIgnorePrefix = true;
        bool trunkPrefixIsOmittedA = false;
        bool trunkPrefixIsOmittedB = false;
        ...
        if (okToIgnorePrefix) {
            ...
            bool maybeNamp = !bothHasCountryCallingCode;
    ...
    private static void internalCalledPartyBCDFragmentToString(
        ...
        for (int i = offset ; i < length + offset ; i++) {
            ...
            c = bcdToChar(cast(byte)(bytes[i] & 0xf), bcdExtType);
    ...
    public static bool isGlobalPhoneNumber(String phoneNumber) {
    ...
    private static bool isDialable(String address) {
    ...
    private static bool isNonSeparator(String address) {
        for (int i = 0, count = address.length(); i < count; i++) {
    ...
    private static byte[] numberToCalledPartyBCDHelper(
            String number, bool includeLength, @BcdExtendType int bcdExtType) {
        int numberLenReal = number.length();
        int numberLenEffective = numberLenReal;
        bool hasPlus = number.indexOf('+') != -1;
        ...
        for (int i = 0; i < numberLenReal; i++) {
            ...
            result[extraBytes + (digitCount >> 1)] |=
                    cast(byte)((charToBCD(c, bcdExtType) & 0x0F) << shift);
            digitCount++;
        }
        ...
        int offset = 0;
        if (includeLength) result[offset++] = cast(byte)(resultLen - 1);
        result[offset] = cast(byte)(hasPlus ? TOA_International : TOA_Unknown);
     ...
     * @hide
     */
    public static bool isInternationalNumber(String phoneNumber, String defaultCountryIso) {
     ...
     * @hide
     */
    public static bool isEmergencyNumber(int subId, String number) {
     ...
     * @hide
     */
    public static bool isPotentialEmergencyNumber(String number) {
     ...
     * @hide
     */
    public static bool isPotentialEmergencyNumber(int subId, String number) {
     ...
     *         listed in the RIL / sim, otherwise return false.
     */
    private static bool isEmergencyNumberInternal(String number, bool useExactMatch) {
     ...
     *         listed in the RIL / sim, otherwise return false.
     */
    private static bool isEmergencyNumberInternal(int subId, String number,
            bool useExactMatch) {
     ...
     * @hide
     */
    public static bool isEmergencyNumber(String number, String defaultCountryIso) {
     ...
     * @hide
     */
    public static bool isEmergencyNumber(int subId, String number, String defaultCountryIso) {
     ...
     * @hide
     */
    public static bool isPotentialEmergencyNumber(String number, String defaultCountryIso) {
     ...
     */
    private static bool isEmergencyNumberInternal(String number,
                                                     String defaultCountryIso,
                                                     bool useExactMatch) {
     ...
     * is currently in.
     */
    public static bool isLocalEmergencyNumber(Context context, String number) {
     ...
     * @hide
     */
    public static bool isLocalEmergencyNumber(Context context, int subId, String number) {
     ...
     * @hide
     */
    public static bool isPotentialLocalEmergencyNumber(Context context, String number) {
     ...
     * @hide
     */
    public static bool isPotentialLocalEmergencyNumber(Context context, int subId,
            String number) {
        return isLocalEmergencyNumberInternal(subId, number,
                                              context,
                                              false /* useExactMatch */);
     ...
     * @hide
     */
    private static bool isLocalEmergencyNumberInternal(String number,
                                                          Context context,
                                                          bool useExactMatch) {
     ...
     * @hide
     */
    private static bool isLocalEmergencyNumberInternal(int subId, String number,
                                                          Context context,
                                                          bool useExactMatch) {
        String countryIso;
     ...
     * @hide
     */
    public static bool isVoiceMailNumber(int subId, String number) {
     ...
     * @hide
     */
    public static bool isVoiceMailNumber(Context context, int subId, String number) {
        String vmNumber, mdn;
        try {
    ...
    cdmaCheckAndProcessPlusCodeByNumberFormat(String dialStr,int currFormat,int defaultFormat) {
        ...
        bool useNanp = (currFormat == defaultFormat) && (currFormat == FORMAT_NANP);
    ...
    private static String getCurrentIdp(bool useNanp) {
        String ps = null;
        if (useNanp) {
            ps = NANP_IDP_STRING;
        } else {
    ...
    private static bool isTwoToNine (char c) {
        if (c >= '2' && c <= '9') {
            return true;
        } else {
            return false;
     ...
     * @hide
     */
    public static bool isNanp (String dialStr) {
        bool retVal = false;
        if (dialStr != null) {
    ...
    */
    private static bool isOneNanp(String dialStr) {
        bool retVal = false;
        if (dialStr != null) {
     ...
     */
    public static bool isUriNumber(String number) {
     ...
     */
    private static String processPlusCode(String networkDialStr, bool useNanp) {
     ...
     */
    private static final bool COUNTRY_CALLING_CALL[] = {
     ...
     */
    private static bool isCountryCallingCode(int countryCallingCodeCandidate) {
    ...
    private static CountryCallingCodeAndNewIndex tryGetCountryCallingCodeAndNewIndex(
        String str, bool acceptThailandCase) {
        // Rough regexp:
     ...
     */
    private static bool checkPrefixIsIgnorable(final String str,
