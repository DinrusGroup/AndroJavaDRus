 ...
 */
public class SubscriptionInfo : Parcelable {
    ...
    public SubscriptionInfo(int id, String iccId, int simSlotIndex, CharSequence displayName,
            CharSequence carrierName, int nameSource, int iconTint, String number, int roaming,
            Bitmap icon, int mcc, int mnc, String countryIso,  bool isEmbedded,
     ...
     */
    @Deprecated
    public bool canManageSubscription(Context context) {
     ...
     */
    @Deprecated
    public bool canManageSubscription(Context context, String packageName) {
        if (!isEmbedded()) {
    ...
    public static final Parcelable.Creator<SubscriptionInfo> CREATOR = new Parcelable.Creator<SubscriptionInfo>() {
        ...
        public SubscriptionInfo createFromParcel(Parcel source) {
            ...
            bool isEmbedded = source.readBoolean();
