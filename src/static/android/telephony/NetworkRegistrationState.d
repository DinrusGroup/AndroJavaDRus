 ...
 * @hide
 */
public class NetworkRegistrationState : Parcelable {
    /**
     * Network domain
     * @hide
     */
    ...
    private final bool mEmergencyOnly;
    ...
    public NetworkRegistrationState(int transportType, int domain, int regState,
            int accessNetworkTechnology, int reasonForDenial, bool emergencyOnly,
    ...
    public NetworkRegistrationState(int transportType, int domain, int regState,
            int accessNetworkTechnology, int reasonForDenial, bool emergencyOnly,
            int[] availableServices, @Nullable CellIdentity cellIdentity, bool cssSupported,
     ...
     */
    public bool isEmergencyEnabled() { return mEmergencyOnly; }
