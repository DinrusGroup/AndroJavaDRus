...
public final class LocationAccessPolicy {
     ...
     * @return bool true or false if permissions is granted
     */
    public static bool canAccessCellLocation(@NonNull Context context, @NonNull String pkgName,
            int uid, int pid, bool throwOnDeniedPermission) throws SecurityException {
    ...
    private static bool isLocationModeEnabled(@NonNull Context context, @UserIdInt int userId) {
    ...
    private static bool checkInteractAcrossUsersFull(@NonNull Context context) {
        return context.checkCallingOrSelfPermission(
                android.Manifest.permission.INTERACT_ACROSS_USERS_FULL)
                == PackageManager.PERMISSION_GRANTED;
    }

    private static bool isCurrentProfile(@NonNull Context context, int uid) {
