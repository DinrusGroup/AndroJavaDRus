...
public class SubscriptionManager {
     ...
     * <p>
     * Override the onSubscriptionsChanged method in the object that : this
    ...
    public static class OnSubscriptionsChangedListener {
        private class OnSubscriptionsChangedListenerHandler : Handler {
    ...
    /** @hide */
    public bool allDefaultsSelected() {
     ...
     * @hide
     */
    public static bool isValidSubscriptionId(int subId) {
     ...
     * @hide
     */
    public static bool isUsableSubIdValue(int subId) {
    ...
    /** @hide */
    public static bool isValidPhoneId(int phoneId) {
    ...
    /**
     * Returns bool value corresponding to query result.
     * @param subId Subscription Id of Subscription
     * @param propKey Column name in SubscriptionInfo database
     * @param defValue Default bool value to be returned
     * @return bool result value to be returned
     * @hide
     */
    public static bool getBooleanSubscriptionProperty(int subId, String propKey,
            bool defValue, Context context) {
     ...
     * @hide
     */
    public bool isActiveSubId(int subId) {
        try {
            ISub iSub = ISub.Stub.asInterface(ServiceManager.getService("isub"));
            if (iSub != null) {
     ...
     */
    @SystemApi
    public void setSubscriptionOverrideUnmetered(int subId, bool overrideUnmetered,
     ...
     */
    @SystemApi
    public void setSubscriptionOverrideCongested(int subId, bool overrideCongested,
            @DurationMillisLong long timeoutMillis) {
        try {
     ...
     * @hide
     */
    public bool isSubscriptionPlansRefreshSupported(int subId) {
     ...
     */
    public bool canManageSubscription(SubscriptionInfo info) {
     ...
     * @hide
     */
    public bool canManageSubscription(SubscriptionInfo info, String packageName) {
        if (!info.isEmbedded()) {
