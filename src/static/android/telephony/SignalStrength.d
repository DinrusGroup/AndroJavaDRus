 ...
 */
public class SignalStrength : Parcelable {
    ...
    private bool mIsGsm; // This value is set by the ServiceStateTracker
                            // onSignalStrengthResult.
    private bool mUseOnlyRsrpForLteLevel; // Use only RSRP for the number of LTE signal bar.
     ...
     * @hide
     */
    public SignalStrength(bool gsmFlag) {
    ...
    public SignalStrength(
            ...
            int lteRsrpBoost, bool gsmFlag, bool lteLevelBaseOnRsrp,
     ...
     * @hide
     */
    public void setGsm(bool gsmFlag) {
        mIsGsm = gsmFlag;
    }
     ...
     * @hide
     */
    public void setUseOnlyRsrpForLteLevel(bool useOnlyRsrpForLteLevel) {
     ...
     * @hide
     */
    public bool useOnlyRsrpForLteLevel() {
