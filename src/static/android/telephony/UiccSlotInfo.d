 ...
 */
@SystemApi
public class UiccSlotInfo : Parcelable {
    /**
     * Card state.
     * @hide
     */
    ...
    private final bool mIsActive;
    private final bool mIsEuicc;
    private final String mCardId;
    private final @CardStateInfo int mCardStateInfo;
    private final int mLogicalSlotIdx;
    private final bool mIsExtendedApduSupported;
    ...
    public void writeToParcel(Parcel dest, int flags) {
        dest.writeByte(cast(byte) (mIsActive ? 1 : 0));
        dest.writeByte(cast(byte) (mIsEuicc ? 1 : 0));
        dest.writeString(mCardId);
        dest.writeInt(mCardStateInfo);
        dest.writeInt(mLogicalSlotIdx);
        dest.writeByte(cast(byte) (mIsExtendedApduSupported ? 1 : 0));
    }
    ...
    public UiccSlotInfo(bool isActive, bool isEuicc, String cardId,
            @CardStateInfo int cardStateInfo, int logicalSlotIdx, bool isExtendedApduSupported) {
     ...
     */
    public bool getIsExtendedApduSupported() {
