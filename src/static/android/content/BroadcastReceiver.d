...
public abstract class BroadcastReceiver {
    ...
    public static class PendingResult {
        ...
        final int mType;
        final bool mOrderedHint;
        final bool mInitialStickyHint;
        ...
        bool mAbortBroadcast;
        bool mFinished;

        /** @hide */
        public PendingResult(int resultCode, String resultData, Bundle resultExtras, int type,
                bool ordered, bool sticky, IBinder token, int userId, int flags) {
        ...
        /**
         * Version of {@link BroadcastReceiver#getResultExtras(bool)
         * BroadcastReceiver.getResultExtras(bool)} for
         * asynchronous broadcast handling.
         */
        public final Bundle getResultExtras(bool makeMap) {
         ...
         * asynchronous broadcast handling.
         */
        public final bool getAbortBroadcast() {
     ...
     * broadcast.
     */
    public final bool isOrderedBroadcast() {
     ...
     */
    public final bool isInitialStickyBroadcast() {
     ...
     */
    public final void setOrderedHint(bool isOrdered) {
     ...
     */
    public final void setDebugUnregister(bool debug) {
     ...
     */
    public final bool getDebugUnregister() {
