...
public abstract class AbstractThreadedSyncAdapter {
    ...
    private static final bool ENABLE_LOG = Build.IS_DEBUGGABLE && Log.isLoggable(TAG, Log.DEBUG);
    ...
    private final bool mAutoInitialize;
     ...
     */
    public AbstractThreadedSyncAdapter(Context context, bool autoInitialize) {
    ...
    public AbstractThreadedSyncAdapter(Context context,
            bool autoInitialize, bool allowParallelSyncs) {
        mContext = context;
    ...
    private class ISyncAdapterImpl : ISyncAdapter.Stub {
        override
     ...
     */
    private class SyncThread : Thread {
