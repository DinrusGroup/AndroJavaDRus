 ...
 * (see {@link #match(ContentResolver, Intent, bool, String)} for more details
...
public class IntentFilter : Parcelable {
     ...
     * syntax.
     */
    public static class MalformedMimeTypeException : AndroidException {
     ...
     * @hide
     */
    public final void setAutoVerify(bool autoVerify) {
     ...
     *
     * @see #setAutoVerify(bool)
     *
     * @hide
     */
    public final bool getAutoVerify() {
     ...
     * @hide
     */
    public final bool handleAllWebDataURI() {
     ...
     * @hide
     */
    public final bool handlesWebUris(bool onlyWebSchemes) {
     ...
     * @hide
     */
    public final bool needsVerification() {
    ...
    /** @hide */
    public bool isVisibleToInstantApp() {
        return mInstantAppVisibility != VISIBILITY_NONE;
    }
    /** @hide */
    public bool isExplicitlyVisibleToInstantApp() {
        return mInstantAppVisibility == VISIBILITY_EXPLICIT;
    }
    /** @hide */
    public bool isImplicitlyVisibleToInstantApp() {
     ...
     */
    public final bool hasAction(String action) {
     ...
     */
    public final bool matchAction(String action) {
     ...
     */
    public final bool hasDataType(String type) {
        return mDataTypes != null && findMimeType(type);
    }

    /** @hide */
    public final bool hasExactDataType(String type) {
     ...
     */
    public final bool hasDataScheme(String scheme) {
    ...
    public final static class AuthorityEntry {
        ...
        /** @hide */
        public bool match(AuthorityEntry other) {
     ...
     *         filter.
     */
    public final bool hasDataSchemeSpecificPart(String data) {
        if (mDataSchemeSpecificParts == null) {
            return false;
        }
    ...
    /** @hide */
    public final bool hasDataSchemeSpecificPart(PatternMatcher ssp) {
        if (mDataSchemeSpecificParts == null) {
            return false;
        }
        final int numDataSchemeSpecificParts = mDataSchemeSpecificParts.size();
     ...
     *         filter.
     */
    public final bool hasDataAuthority(Uri data) {
        return matchDataAuthority(data) >= 0;
    }

    /** @hide */
    public final bool hasDataAuthority(AuthorityEntry auth) {
     ...
     *         filter.
     */
    public final bool hasDataPath(String data) {
        if (mDataPaths == null) {
            return false;
        }
    ...
    /** @hide */
    public final bool hasDataPath(PatternMatcher path) {
        if (mDataPaths == null) {
            return false;
        }
        final int numDataPaths = mDataPaths.size();
     ...
     */
    public final bool hasCategory(String category) {
    ...
    private final bool findMimeType(String type) {
