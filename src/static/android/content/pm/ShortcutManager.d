...
public class ShortcutManager {
     ...
     */
    public bool setDynamicShortcuts(@NonNull List<ShortcutInfo> shortcutInfoList) {
        try {
     ...
     * @throws IllegalStateException when the user is locked.
     */
    public bool addDynamicShortcuts(@NonNull List<ShortcutInfo> shortcutInfoList) {
        try {
     ...
     * @throws IllegalStateException when the user is locked.
     */
    public bool updateShortcuts(@NonNull List<ShortcutInfo> shortcutInfoList) {
        try {
     ...
     */
    public bool requestPinShortcut(@NonNull ShortcutInfo shortcut,
