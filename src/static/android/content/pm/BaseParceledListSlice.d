...
abstract class BaseParceledListSlice<T> : Parcelable {
    ...
    BaseParceledListSlice(Parcel p, ClassLoader loader) {
        ...
        Parcelable.Creator!(T) creator = readParcelableCreator(p, loader);
        Class!(T) listElementClass = null;
    ...
    private T readCreator(Parcelable.Creator!(T) creator, Parcel p, ClassLoader loader) {
    ...
    private static void verifySameType(final Class!(T) expected, final Class!(T) actual) {
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        if (N > 0) {
            final Class!(T) listElementClass = mList.get(0).getClass();
            ...
            if (i < N) {
                ...
                Binder retriever = new Binder() {
                    override
                    protected bool onTransact(int code, Parcel data, Parcel reply, int flags)
    ...
    protected abstract Parcelable.Creator!(T) readParcelableCreator(Parcel from, ClassLoader loader);
}
