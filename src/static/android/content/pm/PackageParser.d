...
public class PackageParser {
    private static final bool DEBUG_JAR = false;
    private static final bool DEBUG_PARSER = false;
    private static final bool DEBUG_BACKUP = false;
    private static final bool LOG_PARSE_TIMINGS = Build.IS_DEBUGGABLE;
    private static final int LOG_PARSE_TIMINGS_THRESHOLD_MS = 100;

    private static final String PROPERTY_CHILD_PACKAGES_ENABLED =
            "persist.sys.child_packages_enabled";

    private static final bool MULTI_PACKAGE_APK_ENABLED = Build.IS_DEBUGGABLE &&
    ...
    private static final bool LOG_UNSAFE_BROADCASTS = false;
    ...
    /** @hide */
    @VisibleForTesting
    public static class ParseComponentArgs : ParsePackageItemArgs {
    ...
    public static class PackageLite {
        ...
        public final bool[] isFeatureSplits;
        ...
        public final bool coreApp;
        public final bool debuggable;
        public final bool multiArch;
        public final bool use32bitAbi;
        public final bool extractNativeLibs;
        public final bool isolatedSplits;

        public PackageLite(String codePath, ApkLite baseApk, String[] splitNames,
                bool[] isFeatureSplits, String[] usesSplitNames, String[] configForSplit,
    ...
    public static class ApkLite {
        ...
        public ApkLite(String codePath, String packageName, String splitName,
                ...
                SigningDetails signingDetails, bool coreApp,
                bool debuggable, bool multiArch, bool use32bitAbi,
                bool extractNativeLibs, bool isolatedSplits) {
            this.codePath = codePath;
    ...
    private static final bool RIGID_PARSER = false;
     ...
     */
    public void setOnlyCoreApps(bool onlyCoreApps) {
     ...
     * class.
     */
    public static final class CallbackImpl : Callback {
        ...
        override public bool hasFeature(String feature) {
    ...
    public static final bool isApkFile(File file) {
        return isApkPath(file.getName());
    }

    public static bool isApkPath(String path) {
     ...
     */
    private static bool checkUseInstalledOrHidden(int flags, PackageUserState state,
    ...
    public static bool isAvailable(PackageUserState state) {
     ...
     */
    private static class SplitNameComparator : Comparator<String> {
        override
     ...
     */
    public Package parsePackage(File packageFile, int flags, bool useCaches)
            throws PackageParserException {
    ...
    /**
     * Equivalent to {@link #parsePackage(File, int, bool)} with {@code useCaches == false}.
     */
     ...
     */
    private static bool isCacheUpToDate(File packageFile, File cacheFile) {
        try {
     ...
     */
    public static void collectCertificates(Package pkg, bool skipVerify)
            throws PackageParserException {
    ...
    private static void collectCertificatesInternal(Package pkg, bool skipVerify)
            throws PackageParserException {
    ...
    private static void collectCertificates(Package pkg, File apkFile, bool skipVerify)
            throws PackageParserException {
        final String apkPath = apkFile.getAbsolutePath();
    ...
    private static ApkLite parseApkLiteInner(File apkFile, FileDescriptor fd, String debugPathName,
        ...
        try {
            ...
            if ((flags & PARSE_COLLECT_CERTIFICATES) != 0) {
                ...
                final bool skipVerify = (flags & PARSE_IS_SYSTEM_DIR) != 0;
                Trace.traceBegin(TRACE_TAG_PACKAGE_MANAGER, "collectCertificates");
                try {
    ...
    private static String validateName(String name, bool requireSeparator,
    ...
    private static ApkLite parseApkLite(String codePath, XmlPullParser parser, AttributeSet attrs,
        ...
        bool use32bitAbi = false;
        bool extractNativeLibs = true;
        bool isolatedSplits = false;
        bool isFeatureSplit = false;
     ...
     * @throws IOException
     */
    private bool parseBaseApkChild(Package parentPkg, Resources res, XmlResourceParser parser,
    ...
    private Package parseBaseApkCommon(Package pkg, Set<String> acceptedTags, Resources res,
        ...
        // Resource bool are -1, so 1 means we don't know the value.
        ...
        while ((type = parser.next()) != XmlPullParser.END_DOCUMENT
            ...
            if (tagName.equals(TAG_APPLICATION)) {
                ...
                if (SDK_VERSION > 0) {
                    ...
                    bool defaultToCurrentDevBranch = (flags & PARSE_FORCE_SDK) != 0;
                ...
                // This is a trick to get a bool and still able to detect
                ...
                if ((flags & PARSE_IS_SYSTEM_DIR) != 0) {
                    ...
                    if (hash != null) {
                        ...
                        for (int i = 0; i < hashLength; i += 2){
                            hashBytes[i/2] = cast(byte) ((Character.digit(hash.charAt(i), 16) << 4)
    ...
    private bool checkOverlayRequiredSystemProperty(String propName, String propValue) {
    ...
    public static int computeTargetSdkVersion(@IntRange(from = 0) int targetVers,
            ...
            @NonNull String[] outError, bool forceCurrentDev) {
    ...
    private bool parseUsesStaticLibrary(Package pkg, Resources res, XmlResourceParser parser,
            String[] outError) throws XmlPullParserException, IOException {
        TypedArray sa = res.obtainAttributes(parser,
    ...
    private bool parseUsesPermission(Package pkg, Resources res, XmlResourceParser parser)
    ...
    private bool parseKeySets(Package owner, Resources res,
    ...
    private bool parsePermissionGroup(Package owner, int flags, Resources res,
            XmlResourceParser parser, String[] outError)
            throws XmlPullParserException, IOException {
    ...
    private bool parsePermission(Package owner, Resources res,
            XmlResourceParser parser, String[] outError)
        throws XmlPullParserException, IOException {
    ...
    private bool parsePermissionTree(Package owner, Resources res,
            XmlResourceParser parser, String[] outError)
        throws XmlPullParserException, IOException {
        Permission perm = new Permission(owner);
     ...
     */
    private bool parseBaseApplication(Package owner, Resources res,
        ...
        bool allowBackup = sa.getBoolean(
        ...
        if (allowBackup) {
            ...
            if (v != null && (ai.fullBackupContent = v.resourceId) == 0) {
                if (DEBUG_BACKUP) {
                    Slog.v(TAG, "fullBackupContent specified as bool=" +
                            (v.data == 0 ? "false" : "true"));
                }
                // "false" => -1, "true" => 0
        ...
        int type;
        bool hasActivityOrder = false;
        bool hasReceiverOrder = false;
     ...
     */
    private static bool hasDomainURLs(Package pkg) {
     ...
     * omitted here.
     */
    private bool parseSplitApplication(Package owner, Resources res, XmlResourceParser parser,
    ...
    private static bool parsePackageItemInfo(Package owner, PackageItemInfo outInfo,
            String[] outError, String tag, TypedArray sa, bool nameRequired,
    ...
    private Activity parseActivity(Package owner, Resources res,
            ...
            bool receiver, bool hardwareAccelerated)
            throws XmlPullParserException, IOException {
        ...
        bool setExported = sa.hasValue(R.styleable.AndroidManifestActivity_exported);
        if (setExported) {
    ...
    private void setActivityResizeMode(ActivityInfo aInfo, TypedArray sa, Package owner) {
        final bool appExplicitDefault = (owner.applicationInfo.privateFlags
        ...
        if (sa.hasValue(R.styleable.AndroidManifestActivity_resizeableActivity)
            ...
            final bool appResizeable = (owner.applicationInfo.privateFlags
    ...
    private Activity parseActivityAlias(Package owner, Resources res,
        ...
        final bool setExported = sa.hasValue(
    ...
    private Provider parseProvider(Package owner, Resources res,
        ...
        bool providerExportedDefault = false;
    ...
    private bool parseProviderTags(Resources res, XmlResourceParser parser,
            bool visibleToEphemeral, Provider outInfo, String[] outError)
                    throws XmlPullParserException, IOException {
        int outerDepth = parser.getDepth();
        int type;
        while ((type=parser.next()) != XmlPullParser.END_DOCUMENT
    ...
    private bool isImplicitlyExposedIntent(IntentInfo intent) {
    ...
    private bool parseAllMetaData(Resources res, XmlResourceParser parser, String tag,
            Component!(T) outInfo, String[] outError) throws XmlPullParserException, IOException {
        int outerDepth = parser.getDepth();
        int type;
        while ((type=parser.next()) != XmlPullParser.END_DOCUMENT
               && (type != XmlPullParser.END_TAG
        ...
        if (v != null && v.resourceId != 0) {
            ...
            if (v != null) {
                if (v.type == TypedValue.TYPE_STRING) {
                    ...
                    if (!RIGID_PARSER) {
                        Slog.w(TAG, "<meta-data> only supports string, integer, float, color, bool, and resource reference types: "
                                + parser.getName() + " at " + mArchiveSourcePath + " "
                                + parser.getPositionDescription());
                    } else {
                        outError[0] = "<meta-data> only supports string, integer, float, color, bool, and resource reference types";
                        data = null;
                    }
                }
            } else {
    ...
    private bool parseIntent(Resources res, XmlResourceParser parser, bool allowGlobs,
            bool allowAutoVerify, IntentInfo outInfo, String[] outError)
                    throws XmlPullParserException, IOException {
     ...
     * @hide
     */
    public static final class SigningDetails : Parcelable {
         ...
         */
        public bool hasAncestorOrSelf(SigningDetails oldDetails) {
         ...
         */
        public bool hasAncestor(SigningDetails oldDetails) {
            if (this == UNKNOWN || oldDetails == UNKNOWN) {
                return false;
            }
         ...
         */
        public bool checkCapability(SigningDetails oldDetails, @CertCapabilities int flags) {
            if (this == UNKNOWN || oldDetails == UNKNOWN) {
                return false;
            }
            if (oldDetails.signatures.length > 1) {
         ...
         */
        public bool checkCapabilityRecover(SigningDetails oldDetails,
         ...
         */
        public bool hasCertificate(Signature signature) {
         ...
         */
        public bool hasCertificate(Signature signature, @CertCapabilities int flags) {
        ...
        public bool hasCertificate(byte[] certificate) {
            Signature signature = new Signature(certificate);
            return hasCertificate(signature);
        }

        private bool hasCertificateInternal(Signature signature, int flags) {
            if (this == UNKNOWN) {
                return false;
            }
         ...
         */
        public bool checkCapability(String sha256String, @CertCapabilities int flags) {
            if (this == UNKNOWN) {
                return false;
            }
         ...
         */
        public bool hasSha256Certificate(byte[] sha256Certificate) {
         ...
         * single-signers.
         */
        public bool hasSha256Certificate(byte[] sha256Certificate, @CertCapabilities int flags) {
            return hasSha256CertificateInternal(sha256Certificate, flags);
        }

        private bool hasSha256CertificateInternal(byte[] sha256Certificate, int flags) {
            if (this == UNKNOWN) {
                return false;
            }
            if (hasPastSigningCertificates()) {
        ...
        public bool signaturesMatchExactly(SigningDetails other) {
     ...
     */
    public final static class Package : Parcelable {
        ...
        public bool baseHardwareAccelerated;
        ...
        public bool mRequiredForAllUsers;
        ...
        public bool hasChildPackage(String packageName) {
        ...
        public bool hasComponentClassName(String name) {
            for (int i=activities.size()-1; i>=0; i--) {
        ...
        /** @hide */
        public bool isUpdatedSystemApp() {
            return applicationInfo.isUpdatedSystemApp();
        }

        /** @hide */
        public bool canHaveOatDir() {
         ...
         */
        private void fixupOwner(List<? : Component!(T)> list) {
            if (list != null) {
    ...
    public static abstract class Component<II : IntentInfo> {
         ...
         * We cannot use that directly because IntentInfo : IntentFilter, which is parcelable
         ...
         */
        private static void writeIntentsList(ArrayList<? : IntentInfo> list, Parcel out,
                                             int flags) {
            if (list == null) {
                out.writeInt(-1);
                return;
        ...
        private static <T : IntentInfo> ArrayList<T> createIntentsList(Parcel in) {
            int N = in.readInt();
            if (N == -1) {
                return null;
            }
    ...
    public final static class Permission : Component<IntentInfo> : Parcelable {
    ...
    public final static class PermissionGroup : Component<IntentInfo> : Parcelable {
    ...
    private static bool copyNeeded(int flags, Package p,
        ...
        if (state.enabled != PackageManager.COMPONENT_ENABLED_STATE_DEFAULT) {
            bool enabled = state.enabled == PackageManager.COMPONENT_ENABLED_STATE_ENABLED;
            if (p.applicationInfo.enabled != enabled) {
                return true;
            }
        }
        bool suspended = (p.applicationInfo.flags & FLAG_SUSPENDED) != 0;
    ...
    public final static class Activity : Component<ActivityIntentInfo> : Parcelable {
        public final ActivityInfo info;
        private bool mHasMaxAspectRatio;

        private bool hasMaxAspectRatio() {
    ...
    public final static class Service : Component<ServiceIntentInfo> : Parcelable {
    ...
    public final static class Provider : Component<ProviderIntentInfo> : Parcelable {
    ...
    public final static class Instrumentation : Component<IntentInfo> :
            Parcelable {
    ...
    public static abstract class IntentInfo : IntentFilter {
    ...
    public final static class ActivityIntentInfo : IntentInfo {
    ...
    public final static class ServiceIntentInfo : IntentInfo {
    ...
    public static final class ProviderIntentInfo : IntentInfo {
    ...
    public static class PackageParserException : Exception {
