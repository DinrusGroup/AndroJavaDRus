 ...
 * @see ShortcutManager
 */
public final class ShortcutInfo : Parcelable {
    ...
    /** @hide */
    public static bool isDisabledForRestoreIssue(@DisabledReason int disabledReason) {
     ...
     * @hide
     */
    public void enforceMandatoryFields(bool forPinned) {
     ...
     */
    @VisibleForTesting
    public static String lookUpResourceName(@NonNull Resources res, int resId, bool withType,
     ...
     */
    public void ensureUpdatableWith(ShortcutInfo source, bool isUpdating) {
        if (isUpdating) {
    ...
    /** @hide*/
    public bool hasFlags(@ShortcutFlags int flags) {
        return (mFlags & flags) == flags;
    }

    /** @hide */
    public bool isReturnedByServer() {
    ...
    @Deprecated
    public bool isManifestShortcut() {
    ...
    /** @hide */
    public bool isOriginallyFromManifest() {
    ...
    /** @hide */
    public bool hasStringResources() {
     ...
     * @hide internal/unit tests only
     */
    public bool hasAdaptiveBitmap() {
        return hasFlags(FLAG_ADAPTIVE_BITMAP);
    }

    /** @hide */
    public bool isIconPendingSave() {
     ...
     */
    @TestApi
    public bool isVisibleToPublisher() {
    ...
    /** @hide */
    public bool hasStringResourcesResolved() {
    ...
    private String toStringInner(bool secure, bool includeInternalData, String indent) {
