...
public abstract class ShortcutServiceInternal {
    ...
    public abstract bool hasShortcutHostPermission(int launcherUserId,
            @NonNull String callingPackage, int callingPid, int callingUid);

    public abstract void setShortcutHostPackage(@NonNull String type, @Nullable String packageName,
            int userId);

    public abstract bool requestPinAppWidget(@NonNull String callingPackage,
            @NonNull AppWidgetProviderInfo appWidget, @Nullable Bundle extras,
            @Nullable IntentSender resultIntent, int userId);

    public abstract bool isRequestPinItemSupported(int callingUserId, int requestType);

    public abstract bool isForegroundDefaultLauncher(@NonNull String callingPackage,
            int callingUid);
}
