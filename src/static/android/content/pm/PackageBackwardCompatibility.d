 ...
 */
@VisibleForTesting
public class PackageBackwardCompatibility : PackageSharedLibraryUpdater {
    ...
    static {
        ...
        bool bootClassPathContainsOAHL = !addOptionalUpdater(packageUpdaters,
        ...
        // will remove any references to org.apache.http.library from the package so that it does
        // not try and load the library when it is on the bootclasspath.
        bool bootClassPathContainsATB = !addOptionalUpdater(packageUpdaters,
     ...
     */
    private static bool addOptionalUpdater(List<PackageSharedLibraryUpdater> packageUpdaters,
    ...
    private final bool mBootClassPathContainsOAHL;

    private final bool mBootClassPathContainsATB;

    private final PackageSharedLibraryUpdater[] mPackageUpdaters;

    public PackageBackwardCompatibility(bool bootClassPathContainsOAHL,
            bool bootClassPathContainsATB, PackageSharedLibraryUpdater[] packageUpdaters) {
     ...
     */
    @VisibleForTesting
    public static bool bootClassPathContainsOAHL() {
     ...
     */
    @VisibleForTesting
    public static bool bootClassPathContainsATB() {
     ...
     */
    @VisibleForTesting
    public static class AndroidTestRunnerSplitUpdater : PackageSharedLibraryUpdater {
