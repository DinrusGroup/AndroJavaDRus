...
public abstract class PackageManager {
    ...
    /** {@hide} */
    public static final bool APPLY_DEFAULT_TO_DEVICE_PROTECTED_STORAGE = true;

    /**
     * This exception is thrown when a given package, application, or component
     * name cannot be found.
     */
    public static class NameNotFoundException : AndroidException {
    ...
    /**
     * Feature for {@link #getSystemAvailableFeatures} and {@link #hasSystemFeature}:
     * The device : an optimized mode for virtual reality (VR) applications that handles
    ...
    /**
     * Feature for {@link #getSystemAvailableFeatures} and {@link #hasSystemFeature}:
     * The device : headtracking suitable for a VR device.
     */
    @SdkConstant(SdkConstantType.FEATURE)
    ...
    */
     ...
     */
    @TestApi
    public abstract bool isPermissionReviewModeEnabled();
     ...
     */
    @CheckResult
    public abstract bool isPermissionRevokedByPolicy(@NonNull String permName,
     ...
     */
    public abstract bool addPermissionAsync(PermissionInfo info);
     ...
     * @hide
     */
    public abstract bool shouldShowRequestPermissionRationale(String permission);
     ...
     */
    public abstract bool isInstantApp();
     ...
     */
    public abstract bool isInstantApp(String packageName);
     ...
     * @removed
     */
    public abstract bool setInstantAppCookie(@Nullable byte[] cookie);
     ...
     * @return Returns true if the devices supports the feature, else false.
     */
    public abstract bool hasSystemFeature(String name, int version);
     ...
     * related to the {@link android.content.IntentFilter#setAutoVerify(bool)} and
     ...
     * This is related to the {@link android.content.IntentFilter#setAutoVerify(bool)} and
     * {@link android.content.IntentFilter#getAutoVerify()}
     *
     * This is used by the ResolverActivity to change the status depending on what the User select
     * in the Disambiguation Dialog and also used by the Settings App for changing the default App
    ...
    public abstract bool updateIntentVerificationStatusAsUser(String packageName, int status,
            @UserIdInt int userId);
    ...
    @RequiresPermission(allOf = {
            ...
            Manifest.permission.INTERACT_ACROSS_USERS_FULL})
    public abstract bool setDefaultBrowserPackageNameAsUser(String packageName,
            @UserIdInt int userId);
    ...
    public abstract void setUpdateAvailable(String packageName, bool updateAvaialble);
     ...
     * {@link android.content.pm.IPackageDataObserver#onRemoveCompleted(String, bool)}
     ...
     * is complete.
     * {@link android.content.pm.IPackageStatsObserver#onGetStatsCompleted(PackageStats, bool)}
     * The observer's callback is invoked with a PackageStats object(containing the
     * code, data and cache sizes of the package) and a bool value representing
     ...
     * @hide
     */
    public abstract bool setApplicationHiddenSettingAsUser(String packageName, bool hidden,
            UserHandle userHandle);

    /**
     * Returns the hidden state of a package.
     * @see #setApplicationHiddenSettingAsUser(String, bool, UserHandle)
     * @hide
     */
    public abstract bool getApplicationHiddenSettingAsUser(String packageName,
            UserHandle userHandle);
     ...
     * @hide
     */
    public abstract bool isSignedBy(String packageName, KeySet ks);
     ...
     * @hide
     */
    public abstract bool isSignedByExactly(String packageName, KeySet ks);
    ...
    /**
     * @see #setPackagesSuspended(String[], bool, PersistableBundle, PersistableBundle, String)
     ...
     * @hide
     */
    public abstract bool isPackageSuspendedForUser(String packageName, int userId);
     ...
     */
    @SystemApi
    public bool isPackageSuspended(String packageName) throws NameNotFoundException {
    ...
    /** {@hide} */
    public static bool isMoveStatusFinished(int status) {
    ...
    /** {@hide} */
    public abstract bool isPackageAvailable(String packageName);
    ...
    /** {@hide} */
    public static class LegacyPackageDeleteObserver : PackageDeleteObserver {
    ...
    public static abstract class DexModuleRegisterCallback {
        public abstract void onDexModuleRegistered(String dexModulePath, bool success,
                String message);
    }
     ...
     * @hide
     */
    public bool isPackageStateProtected(String packageName, int userId) {
        throw new UnsupportedOperationException(
