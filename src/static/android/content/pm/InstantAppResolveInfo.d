 ...
 */
@SystemApi
public final class InstantAppResolveInfo : Parcelable {
     ...
     */
    private final bool mShouldLetInstallerDecide;
    ...
    private InstantAppResolveInfo(@NonNull InstantAppDigest digest, @Nullable String packageName,
            @Nullable List<InstantAppIntentFilter> filters, long versionCode,
            @Nullable Bundle extras, bool shouldLetInstallerDecide) {
        // validate arguments
     ...
     */
    public bool shouldLetInstallerDecide() {
     ...
     */
    @SystemApi
    public static final class InstantAppDigest : Parcelable {
        ...
        override
        public void writeToParcel(Parcel out, int flags) {
            final bool isUndefined = this == UNDEFINED;
