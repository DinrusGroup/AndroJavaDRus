...
public class PackageItemInfo {
    ...
    private static volatile bool sForceSafeLabels = false;

    /** {@hide} */
    public static void setForceSafeLabels(bool forceSafeLabels) {
    ...
    public @NonNull CharSequence loadSafeLabel(@NonNull PackageManager pm,
        ...
        bool onlyKeepFirstLine = ((flags & SAFE_LABEL_FLAG_FIRST_LINE) != 0);
        bool forceSingleLine = ((flags & SAFE_LABEL_FLAG_SINGLE_LINE) != 0);
        bool trim = ((flags & SAFE_LABEL_FLAG_TRIM) != 0);
        ...
        for (int offset = 0; offset < labelLength; ) {
            ...
            bool isNewline = isNewline(codePoint);
