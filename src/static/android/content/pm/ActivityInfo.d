 ...
 * &lt;receiver&gt; tags.
 */
public class ActivityInfo : ComponentInfo : Parcelable {
     ...
     * {@link android.app.Activity#setImmersive(bool)}.
     *
     * @see android.app.Notification#FLAG_HIGH_PRIORITY
     * @see android.app.Activity#setImmersive(bool)
     */
     ...
     *
     * {@see android.app.Activity#setVrMode(bool)}.
     */
     ...
     * @hide
     */
    bool isFixedOrientationLandscape() {
     ...
     * @hide
     */
    public static bool isFixedOrientationLandscape(@ScreenOrientation int orientation) {
     ...
     * @hide
     */
    bool isFixedOrientationPortrait() {
     ...
     * @hide
     */
    public static bool isFixedOrientationPortrait(@ScreenOrientation int orientation) {
     ...
     * @hide
     */
    public bool supportsPictureInPicture() {
        return (flags & FLAG_SUPPORTS_PICTURE_IN_PICTURE) != 0;
    }

    /** @hide */
    public static bool isResizeableMode(int mode) {
    ...
    /** @hide */
    public static bool isPreserveOrientationMode(int mode) {
     ...
     */
    @TestApi
    public static bool isTranslucentOrFloating(TypedArray attributes) {
        final bool isTranslucent =
                attributes.getBoolean(com.android.internal.R.styleable.Window_windowIsTranslucent,
                        false);
        final bool isSwipeToDismiss = !attributes.hasValue(
