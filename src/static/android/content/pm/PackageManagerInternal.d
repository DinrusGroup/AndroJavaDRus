...
public abstract class PackageManagerInternal {
     ...
     */
    public abstract bool isPermissionsReviewRequired(String packageName, int userId);
     ...
     * {@link PackageManager#setPackagesSuspended(String[], bool, PersistableBundle,
     ...
     */
    public abstract bool isPackageSuspended(String packageName, int userId);
     ...
     */
    public abstract bool isPackageDataProtected(int userId, String packageName);
     ...
     */
    public abstract bool isPackageStateProtected(String packageName, int userId);

    /**
     * Returns {@code true} if a given package is installed as ephemeral. Otherwise, returns
     * {@code false}.
     */
    public abstract bool isPackageEphemeral(int userId, String packageName);
     ...
     */
    public abstract bool wasPackageEverLaunched(String packageName, int userId);
    ...
    public abstract bool isInstantAppInstallerComponent(ComponentName component);
    /**
     ...
     */
    public abstract bool isPackagePersistent(String packageName);

    /**
     * Returns whether or not the given package represents a legacy system application released
     * prior to runtime permissions.
     */
    public abstract bool isLegacySystemApp(PackageParser.Package pkg);
     ...
     */
    public abstract bool setEnabledOverlayPackages(int userId, String targetPackageName,
    ...
    public abstract ResolveInfo resolveIntent(Intent intent, String resolvedType,
            int flags, int userId, bool resolveForStart, int filterCallingUid);
    ...
    */
    ...
    public abstract bool canAccessInstantApps(int callingUid, int userId);

    /** Whether the binder caller can access the given component. */
    public abstract bool canAccessComponent(int callingUid, ComponentName component, int userId);
     ...
     */
    public abstract bool hasInstantApplicationMetadata(String packageName, int userId);
     ...
     */
    public abstract bool isResolveActivityComponent(@NonNull ComponentInfo component);
     ...
     */
    public abstract bool isInstantApp(String packageName, int userId);
     ...
     */
    public abstract bool filterAppAccess(
     ...
     */
    public abstract bool isDataRestoreSafe(@NonNull byte[] restoringFromSigHash,
     ...
     */
    public abstract bool isDataRestoreSafe(@NonNull Signature restoringFromSig,
            @NonNull String packageName);
     ...
     */
    public abstract bool hasSignatureCapability(int serverUid, int clientUid,
