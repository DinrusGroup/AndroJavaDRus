 ...
 * &lt;application&gt; tag.
 */
public class ApplicationInfo : PackageItemInfo : Parcelable {
     ...
     * @hide
     */
    public bool nativeLibraryRootRequiresIsa;
    ...
    /** @hide */
    public static bool isValidHiddenApiEnforcementPolicy(int policy) {
     ...
     * @hide
     */
    public bool usesCompatibilityMode() {
    ...
    private bool isPackageWhitelistedForHiddenApis() {
        return SystemConfig.getInstance().getHiddenApiWhitelistedApps().contains(packageName);
    }

    private bool isAllowedToUseHiddenApis() {
    ...
    private bool isPackageUnavailable(PackageManager pm) {
        try {
     ...
     * @hide
     */
    public bool requestsIsolatedSplitLoading() {
