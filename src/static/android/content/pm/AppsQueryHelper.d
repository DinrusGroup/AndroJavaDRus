...
public class AppsQueryHelper {
     ...
     */
    public List<String> queryApps(int flags, bool systemAppsOnly, UserHandle user) {
        bool nonLaunchableApps = (flags & GET_NON_LAUNCHABLE_APPS) > 0;
        bool interactAcrossUsers = (flags & GET_APPS_WITH_INTERACT_ACROSS_USERS_PERM) > 0;
        bool imes = (flags & GET_IMES) > 0;
        bool requiredForSystemUser = (flags & GET_REQUIRED_FOR_SYSTEM_USER) > 0;
        if (mAllApps == null) {
