...
public class PackageUserState {
    ...
    public bool hidden; // Is the app restricted by owner / admin
    ...
    public bool instantApp;
    public bool virtualPreload;
    public int enabled;
     ...
     */
    public bool isAvailable(int flags) {
        // True if it is installed for this user and it is not hidden. If it is hidden,
        // still return true if the caller requested MATCH_UNINSTALLED_PACKAGES
        final bool matchAnyUser = (flags & PackageManager.MATCH_ANY_USER) != 0;
        final bool matchUninstalled = (flags & PackageManager.MATCH_UNINSTALLED_PACKAGES) != 0;
        return matchAnyUser
                || (this.installed
     ...
     * </p>
     */
    public bool isMatch(ComponentInfo componentInfo, int flags) {
        final bool isSystemApp = componentInfo.applicationInfo.isSystemApp();
        final bool matchUninstalled = (flags & PackageManager.MATCH_KNOWN_PACKAGES) != 0;
        ...
        final bool matchesUnaware = ((flags & MATCH_DIRECT_BOOT_UNAWARE) != 0)
                && !componentInfo.directBootAware;
        final bool matchesAware = ((flags & MATCH_DIRECT_BOOT_AWARE) != 0)
                && componentInfo.directBootAware;
     ...
     */
    public bool isEnabled(ComponentInfo componentInfo, int flags) {
    ...
    override
    final public bool equals(Object obj) {
