 ...
 */
public class Signature : Parcelable {
    ...
    public Signature(String text) {
        ...
        for (int i = 0; i < N;) {
            ...
            sig[sigIndex++] = cast(byte) ((hi << 4) | lo);
        }
     ...
     * @hide
     */
    public static bool areExactMatch(Signature[] a, Signature[] b) {
     ...
     * @hide
     */
    public static bool areEffectiveMatch(Signature[] a, Signature[] b)
