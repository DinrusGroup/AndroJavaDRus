 ...
 * developer guide.</p>
 */
public abstract class ContentProvider : ComponentCallbacks2 {
    ...
    private bool mNoPerms;
    private bool mSingleUser;
     ...
     * @hide
     */
    class Transport : ContentProviderNative {
        ...
        override
        public bool refresh(String callingPkg, Uri uri, Bundle args,
    ...
    bool checkUser(int pid, int uid, Context context) {
    ...
    protected int enforceReadPermissionInner(Uri uri, String callingPkg, IBinder callerToken)
        ...
        if (mExported && checkUser(pid, uid, context)) {
            ...
            bool allowDefaultRead = (componentPerm == null);
    ...
    protected int enforceWritePermissionInner(Uri uri, String callingPkg, IBinder callerToken)
        ...
        if (mExported && checkUser(pid, uid, context)) {
            ...
            // <path-permission> below removes this ability
            bool allowDefaultWrite = (componentPerm == null);
    ...
    /** @hide */
    protected final bool matchesOurAuthorities(String authority) {
        if (mAuthority != null) {
     ...
     */
    public bool refresh(Uri uri, @Nullable Bundle args,
    ...
    private void attachInfo(Context context, ProviderInfo info, bool testing) {
        mNoPerms = testing;
    ...
    /** @hide */
    public static bool uriHasUserId(Uri uri) {
