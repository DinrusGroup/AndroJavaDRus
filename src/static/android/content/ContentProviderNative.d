 ...
 * {@hide}
 */
abstract public class ContentProviderNative : Binder : IContentProvider {
        ...
        try {
            switch (code) {
                ...
                case REFRESH_TRANSACTION: {
                    ...
                    bool out = refresh(callingPkg, url, args, signal);
                    reply.writeNoException();
...
final class ContentProviderProxy : IContentProvider
{
    ...
    override
    public bool refresh(String callingPkg, Uri url, Bundle args, ICancellationSignal signal)
            throws RemoteException {
        Parcel data = Parcel.obtain();
        Parcel reply = Parcel.obtain();
        try {
