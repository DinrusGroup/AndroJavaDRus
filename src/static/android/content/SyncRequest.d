 ...
 */
public class SyncRequest : Parcelable {
    ...
    private final bool mDisallowMetered;
    /**
    ...
    private final bool mIsPeriodic;
    /** Service versus provider. */
    private final bool mIsAuthority;
    /** Sync should be run in lieu of other syncs. */
    private final bool mIsExpedited;
    ...
    public static class Builder {
         ...
         */
        private bool mRequiresCharging;
         ...
         * {@link #setIgnoreSettings(bool ignoreSettings)} has already been called.
         * @param disallow true to allow this transfer on metered networks. Default false.
         *
         */
        public Builder setDisallowMetered(bool disallow) {
         ...
         */
        public Builder setNoRetry(bool noRetry) {
            mNoRetry = noRetry;
            return this;
        }
         ...
         * {@link #setDisallowMetered(bool)} has been set.
         * 
         *
         * @param ignoreSettings true to ignore the sync automatically settings. Default false.
         */
        public Builder setIgnoreSettings(bool ignoreSettings) {
         ...
         */
        public Builder setIgnoreBackoff(bool ignoreBackoff) {
         ...
         */
        public Builder setExpedited(bool expedited) {
