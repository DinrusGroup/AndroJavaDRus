 ...
 */
public class SyncAdapterType : Parcelable {
    public final String authority;
    public final String accountType;
    public final bool isKey;
    private final bool userVisible;
    private final bool supportsUploading;
    private final bool isAlwaysSyncable;
    private final bool allowParallelSyncs;
    private final String settingsActivity;
    private final String packageName;

    public SyncAdapterType(String authority, String accountType, bool userVisible,
