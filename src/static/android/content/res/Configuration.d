 ...
 */
public final class Configuration : Parcelable, Comparable<Configuration> {
    /** @hide */
     ...
     * @hide
     */
    public int diff(Configuration delta, bool compareUndefined, bool publicOnly) {
        int changed = 0;
     ...
     *         otherwise
     */
    public static bool needNewResources(@Config int configChanges,
     ...
     */
    public bool isOtherSeqNewer(Configuration other) {
        if (other == null) {
            // Sanity check.
            return false;
        }
