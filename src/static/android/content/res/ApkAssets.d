...
public final class ApkAssets {
     ...
     * @throws IOException if a disk I/O error or parsing error occurred.
     */
    public static @NonNull ApkAssets loadFromPath(@NonNull String path, bool system)
            throws IOException {
     ...
     */
    public static @NonNull ApkAssets loadFromPath(@NonNull String path, bool system,
            bool forceSharedLibrary) throws IOException {
    ...
    public static @NonNull ApkAssets loadFromFd(@NonNull FileDescriptor fd,
            @NonNull String friendlyName, bool system, bool forceSharedLibrary)
            throws IOException {
     ...
     * @throws IOException if a disk I/O error or parsing error occurred.
     */
    public static @NonNull ApkAssets loadOverlayFromPath(@NonNull String idmapPath, bool system)
            throws IOException {
        return new ApkAssets(idmapPath, system, false /*forceSharedLibrary*/, true /*overlay*/);
    }

    private ApkAssets(@NonNull String path, bool system, bool forceSharedLib, bool overlay)
            throws IOException {
    ...
    private ApkAssets(@NonNull FileDescriptor fd, @NonNull String friendlyName, bool system,
            bool forceSharedLib) throws IOException {
    ...
    private static native long nativeLoad(
            @NonNull String path, bool system, bool forceSharedLib, bool overlay)
            throws IOException;
    private static native long nativeLoadFromFd(@NonNull FileDescriptor fd,
            @NonNull String friendlyName, bool system, bool forceSharedLib)
            throws IOException;
    private static native void nativeDestroy(long ptr);
    private static native @NonNull String nativeGetAssetPath(long ptr);
    private static native long nativeGetStringBlock(long ptr);
    private static native bool nativeIsUpToDate(long ptr);
