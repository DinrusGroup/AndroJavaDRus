 ...
 */
public final class BridgeTypedArray : TypedArray {
    ...
    private final bool[] mIsFramework;
     ...
     */
    public void bridgeSetValue(int index, String name, bool isFramework, int resourceId,
            ResourceValue value) {
     ...
     * {@link #bridgeSetValue(int, String, bool, int, ResourceValue)} have been done.
    ...
    /**
     * Retrieve the bool value for the attribute at <var>index</var>.
     *
     * @param index Index of attribute to retrieve.
     * @param defValue Value to return if the attribute is not defined.
     *
     * @return Attribute bool value, or defValue if not defined.
     */
    override
