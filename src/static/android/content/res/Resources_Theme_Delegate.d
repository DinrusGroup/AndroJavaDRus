...
public class Resources_Theme_Delegate {
    ...
    /*package*/ static TypedArray obtainStyledAttributes(
            ...
            int[] attrs) {
        bool changed = setupResources(thisTheme);
    ...
    @LayoutlibDelegate
    /*package*/ static bool resolveAttribute(
            Resources thisResources, Theme thisTheme,
            int resid, TypedValue outValue,
            bool resolveRefs) {
        bool changed = setupResources(thisTheme);
        bool found =  RenderSessionImpl.getCurrentContext().resolveThemeAttribute(resid,
    ...
    private static bool setupResources(Theme thisTheme) {
    ...
    private static void restoreResources(bool changed) {
        if (changed) {
