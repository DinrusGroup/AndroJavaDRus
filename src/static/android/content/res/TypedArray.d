...
public class TypedArray {
     ...
     * it is equal to zero. If the attribute is not a bool or integer value,
     ...
     * @throws RuntimeException if the TypedArray has already been recycled.
     */
    public bool getBoolean(@StyleableRes int index, bool defValue) {
        if (mRecycled) {
            throw new RuntimeException("Cannot make calls to a recycled instance!");
        }
     ...
     * @throws RuntimeException if the TypedArray has already been recycled.
     */
    public bool getValue(@StyleableRes int index, TypedValue outValue) {
        if (mRecycled) {
            throw new RuntimeException("Cannot make calls to a recycled instance!");
        }
     ...
     * @throws RuntimeException if the TypedArray has already been recycled.
     */
    public bool hasValue(@StyleableRes int index) {
        if (mRecycled) {
            throw new RuntimeException("Cannot make calls to a recycled instance!");
        }
     ...
     * @throws RuntimeException if the TypedArray has already been recycled.
     */
    public bool hasValueOrEmpty(@StyleableRes int index) {
        if (mRecycled) {
            throw new RuntimeException("Cannot make calls to a recycled instance!");
        }
