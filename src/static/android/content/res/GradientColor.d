 ...
 * @hide
 */
public class GradientColor : ComplexColor {
    private static final String TAG = "GradientColor";

    private static final bool DBG_GRADIENT = false;
    ...
    private bool mHasCenterColor = false;
    ...
    private void inflateChildElements(@NonNull Resources r, @NonNull XmlPullParser parser,
        ...
        while ((type = parser.next()) != XmlPullParser.END_DOCUMENT
            ...
            bool hasColor = a.hasValue(R.styleable.GradientColorItem_color);
            bool hasOffset = a.hasValue(R.styleable.GradientColorItem_offset);
    ...
    private static class GradientColorFactory : ConstantState<ComplexColor> {
