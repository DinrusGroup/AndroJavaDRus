...
public class Byte3 {
    ...
    public byte dotProduct(Byte3 a) {
        return cast(byte)(cast(byte)(cast(byte)(x * a.x) + cast(byte)(y * a.y)) + cast(byte)(z * a.z));
    }
    ...
    public static byte dotProduct(Byte3 a, Byte3 b) {
        return cast(byte)(cast(byte)(cast(byte)(b.x * a.x) + cast(byte)(b.y * a.y)) + cast(byte)(b.z * a.z));
    }
