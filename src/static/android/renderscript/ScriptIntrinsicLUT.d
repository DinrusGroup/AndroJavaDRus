 ...
 **/
public final class ScriptIntrinsicLUT : ScriptIntrinsic {
    ...
    private ScriptIntrinsicLUT(long id, RenderScript rs) {
        ...
        for (int ct=0; ct < 256; ct++) {
            mCache[ct] = cast(byte)ct;
            mCache[ct + 256] = cast(byte)ct;
            mCache[ct + 512] = cast(byte)ct;
            mCache[ct + 768] = cast(byte)ct;
        }
        setVar(0, mTables);
    }
