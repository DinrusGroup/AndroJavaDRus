...
public class RenderScript {
    ...
    */
    ...
    native long rsnProgramStoreCreate(long con, bool r, bool g, bool b, bool a,
                                      bool depthMask, bool dither,
                                      int srcMode, int dstMode, int depthFunc);
    synchronized long nProgramStoreCreate(bool r, bool g, bool b, bool a,
                                         bool depthMask, bool dither,
                                         int srcMode, int dstMode, int depthFunc) {
        validate();
    ...
    native long rsnProgramRasterCreate(long con, bool pointSprite, int cullMode);
    synchronized long nProgramRasterCreate(bool pointSprite, int cullMode) {
        validate();
