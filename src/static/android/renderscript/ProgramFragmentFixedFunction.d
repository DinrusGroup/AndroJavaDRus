 ...
 *
 **/
public class ProgramFragmentFixedFunction : ProgramFragment {
    ProgramFragmentFixedFunction(long id, RenderScript rs) {
        super(id, rs);
    }

    static class InternalBuilder : BaseProgramBuilder {
        /**
         * @deprecated in API 16
         */
    ...
    public static class Builder {
         ...
         *
         **/
        public Builder setPointSpriteTexCoordinateReplacement(bool enable) {
         ...
         *
         **/
        public Builder setVaryingColor(bool enable) {
