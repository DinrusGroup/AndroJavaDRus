...
public class Allocation : BaseObj {
    ...
    long mTimeStamp = -1;
    bool mReadAllowed = true;
    bool mWriteAllowed = true;
    bool mAutoPadding = false;
    int mSelectedX;
    int mSelectedY;
    int mSelectedZ;
    int mSelectedLOD;
    ...
    private Element.DataType validateObjectIsPrimitiveArray(Object d, bool checkType) {
   ...
   /**
     ...
     *
     */
    public void setAutoPadding(bool useAutoPadding) {
    ...
    Allocation(long id, RenderScript rs, Type t, bool owningType, int usage, MipmapControl mips) {
        this(id, rs, t, usage);
    ...
    private void data1DChecks(int off, int count, int len, int dataSize, bool usePadding) {
        mRS.validate();
        if(off < 0) {
