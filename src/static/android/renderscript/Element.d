...
public class Element : BaseObj {
    ...
    */
    ...
    Element(long id, RenderScript rs, DataType dt, DataKind dk, bool norm, int size) {
        super(id, rs);
    ...
    public static Element createVector(RenderScript rs, DataType dt, int size) {
        ...
        switch (dt) {
        // Support only primitive integer/float/bool types as vectors.
        case FLOAT_16:
        case FLOAT_32:
        case FLOAT_64:
        case SIGNED_8:
     ...
     *
     * @return bool true if the Elements are compatible, otherwise false.
     */
    public bool isCompatible(Element e) {
