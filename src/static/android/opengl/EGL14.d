...
public static final int EGL_CORE_NATIVE_ENGINE             = 0x305B;
    ...
    public static native bool eglInitialize(
        EGLDisplay dpy,
        int[] major,
        int majorOffset,
        int[] minor,
    ...
    public static native bool eglTerminate(
        EGLDisplay dpy
    );
    ...
    public static native bool eglGetConfigs(
        EGLDisplay dpy,
        EGLConfig[] configs,
        int configsOffset,
        int config_size,
    ...
    public static native bool eglChooseConfig(
        EGLDisplay dpy,
        int[] attrib_list,
    ...
    public static native bool eglGetConfigAttrib(
        EGLDisplay dpy,
        EGLConfig config,
        int attribute,
        int[] value,
    ...
    public static native bool eglDestroySurface(
        EGLDisplay dpy,
        EGLSurface surface
    );
    ...
    public static native bool eglQuerySurface(
        EGLDisplay dpy,
        EGLSurface surface,
        int attribute,
        int[] value,
    ...
    public static native bool eglBindAPI(
        int api
    );
    ...
    public static native bool eglWaitClient(
    );

    // C function EGLBoolean eglReleaseThread ( void )

    public static native bool eglReleaseThread(
    );
    ...
    public static native bool eglSurfaceAttrib(
        EGLDisplay dpy,
        EGLSurface surface,
        int attribute,
        int value
    ...
    public static native bool eglBindTexImage(
        EGLDisplay dpy,
        EGLSurface surface,
        int buffer
    );
    ...
    public static native bool eglReleaseTexImage(
        EGLDisplay dpy,
        EGLSurface surface,
        int buffer
    );
    ...
    public static native bool eglSwapInterval(
        EGLDisplay dpy,
        int interval
    );
    ...
    public static native bool eglDestroyContext(
        EGLDisplay dpy,
        EGLContext ctx
    );
    ...
    public static native bool eglMakeCurrent(
        EGLDisplay dpy,
        EGLSurface draw,
        EGLSurface read,
        EGLContext ctx
    ...
    public static native bool eglQueryContext(
        EGLDisplay dpy,
        EGLContext ctx,
        int attribute,
        int[] value,
    ...
    public static native bool eglCopyBuffers(
        EGLDisplay dpy,
        EGLSurface surface,
        int target
    );
