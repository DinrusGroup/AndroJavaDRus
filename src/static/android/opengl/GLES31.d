...
public class GLES31 : GLES30 {
    ...
    // C function GLbool glIsProgramPipeline ( GLuint pipeline )

    public static native bool glIsProgramPipeline(
        int pipeline
    );
    ...
    // C function void glProgramUniformMatrix2fv ( GLuint program, GLint location, GLsizei count, GLbool transpose, const GLfloat *value )
    ...
    // C function void glProgramUniformMatrix3fv ( GLuint program, GLint location, GLsizei count, GLbool transpose, const GLfloat *value )
    ...
    // C function void glProgramUniformMatrix4fv ( GLuint program, GLint location, GLsizei count, GLbool transpose, const GLfloat *value )
    ...
    // C function void glProgramUniformMatrix2x3fv ( GLuint program, GLint location, GLsizei count, GLbool transpose, const GLfloat *value )
    ...
    // C function void glProgramUniformMatrix3x2fv ( GLuint program, GLint location, GLsizei count, GLbool transpose, const GLfloat *value )
    ...
    // C function void glProgramUniformMatrix2x4fv ( GLuint program, GLint location, GLsizei count, GLbool transpose, const GLfloat *value )
    ...
    // C function void glProgramUniformMatrix4x2fv ( GLuint program, GLint location, GLsizei count, GLbool transpose, const GLfloat *value )
    ...
    // C function void glProgramUniformMatrix3x4fv ( GLuint program, GLint location, GLsizei count, GLbool transpose, const GLfloat *value )
    ...
    // C function void glProgramUniformMatrix4x3fv ( GLuint program, GLint location, GLsizei count, GLbool transpose, const GLfloat *value )
    ...
    // C function void glBindImageTexture ( GLuint unit, GLuint texture, GLint level, GLbool layered, GLint layer, GLenum access, GLenum format )
    ...
    // C function void glGetBooleani_v ( GLenum target, GLuint index, GLbool *data )
    ...
    // C function void glTexStorage2DMultisample ( GLenum target, GLsizei samples, GLenum internalformat, GLsizei width, GLsizei height, GLbool fixedsamplelocations )
    ...
    // C function void glVertexAttribFormat ( GLuint attribindex, GLint size, GLenum type, GLbool normalized, GLuint relativeoffset )
