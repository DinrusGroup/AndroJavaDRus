...
public class GLES31Ext {
    ...
    // C function void glDebugMessageControlKHR ( GLenum source, GLenum type, GLenum severity, GLsizei count, const GLuint *ids, GLbool enabled )
    ...
    // C function void glTexStorage3DMultisampleOES ( GLenum target, GLsizei samples, GLenum internalformat, GLsizei width, GLsizei height, GLsizei depth, GLbool fixedsamplelocations )
    ...
    // C function void glColorMaskiEXT ( GLuint index, GLbool r, GLbool g, GLbool b, GLbool a )
    ...
    // C function GLbool glIsEnablediEXT ( GLenum target, GLuint index )

    public static native bool glIsEnablediEXT(
        int target,
        int index
    );
