 ...
 *
 */
class GLLogWrapper : GLWrapperBase {
    private static final int FORMAT_INT = 0;
    private static final int FORMAT_FLOAT = 1;
    private static final int FORMAT_FIXED = 2;

    public GLLogWrapper(GL gl, Writer log, bool logArgumentNames) {
        super(gl);
        mLog = log;
    ...
    private void arg(String name, bool value) {
    ...
    private ByteBuffer toByteBuffer(int byteCount, Buffer input) {
        ...
        bool convertWholeBuffer = (byteCount < 0);
    ...
    private void doArrayElement(StringBuilder builder, bool enabled,
    ...
    public void glColorMask(bool red, bool green, bool blue,
            bool alpha) {
        begin("glColorMask");
        arg("red", red);
        arg("green", green);
    ...
    public void glSampleCoveragex(int value, bool invert) {
        begin("glSampleCoveragex");
        arg("value", value);
        arg("invert", invert);
        end();
    ...
    public void glGetBooleanv(int pname, bool[] params, int offset) {
        begin("glGetBooleanv");
        arg("pname", pname);
        arg("params", params.toString());
        arg("offset", offset);
    ...
    public bool glIsBuffer(int buffer) {
        ...
        bool result = mgl11.glIsBuffer(buffer);
        checkError();
        return result;
    }
    ...
    public bool glIsEnabled(int cap) {
        ...
        bool result = mgl11.glIsEnabled(cap);
        checkError();
        return result;
    }
    ...
    public bool glIsTexture(int texture) {
        ...
        bool result = mgl11.glIsTexture(texture);
        checkError();
        return result;
    }
    ...
    override
    public bool glIsFramebufferOES(int framebuffer) {
        begin("glIsFramebufferOES");
        arg("framebuffer", framebuffer);
        end();
        bool result = mgl11ExtensionPack.glIsFramebufferOES(framebuffer);
        checkError();
        return result;
    }

    override
    public bool glIsRenderbufferOES(int renderbuffer) {
    ...
    private Writer mLog;
    private bool mLogArgumentNames;
    ...
    bool mTextureCoordArrayEnabled;
