...
public class GLES11Ext {
    ...
    // C function void glSampleCoveragexOES ( GLclampx value, GLbool invert )
    ...
    // C function GLbool glIsRenderbufferOES ( GLuint renderbuffer )

    public static native bool glIsRenderbufferOES(
        int renderbuffer
    );
    ...
    // C function GLbool glIsFramebufferOES ( GLuint framebuffer )

    public static native bool glIsFramebufferOES(
        int framebuffer
    );
