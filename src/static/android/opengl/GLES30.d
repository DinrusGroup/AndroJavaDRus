...
public class GLES30 : GLES20 {
    ...
    // C function GLbool glIsQuery ( GLuint id )

    public static native bool glIsQuery(
        int id
    );
    ...
    // C function GLbool glUnmapBuffer ( GLenum target )

    public static native bool glUnmapBuffer(
        int target
    );
    ...
    // C function void glUniformMatrix2x3fv ( GLint location, GLsizei count, GLbool transpose, const GLfloat *value )
    ...
    // C function void glUniformMatrix3x2fv ( GLint location, GLsizei count, GLbool transpose, const GLfloat *value )
    ...
    // C function void glUniformMatrix2x4fv ( GLint location, GLsizei count, GLbool transpose, const GLfloat *value )
    ...
    // C function void glUniformMatrix4x2fv ( GLint location, GLsizei count, GLbool transpose, const GLfloat *value )
    ...
    // C function void glUniformMatrix3x4fv ( GLint location, GLsizei count, GLbool transpose, const GLfloat *value )
    ...
    // C function void glUniformMatrix4x3fv ( GLint location, GLsizei count, GLbool transpose, const GLfloat *value )
    ...
    // C function GLbool glIsVertexArray ( GLuint array )

    public static native bool glIsVertexArray(
        int array
    );
    ...
    // C function GLbool glIsSync ( GLsync sync )

    public static native bool glIsSync(
        long sync
    );
    ...
    // C function GLbool glIsSampler ( GLuint sampler )

    public static native bool glIsSampler(
        int sampler
    );
    ...
    // C function GLbool glIsTransformFeedback ( GLuint id )

    public static native bool glIsTransformFeedback(
        int id
    );
