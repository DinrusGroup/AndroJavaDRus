...
class EGLLogWrapper : EGL11 {
    private EGL10 mEgl10;
    Writer mLog;
    bool mLogArgumentNames;
    bool mCheckError;
    ...
    public bool eglChooseConfig(EGLDisplay display, int[] attrib_list,
        ...
        bool result = mEgl10.eglChooseConfig(display, attrib_list, configs,
    ...
    public bool eglCopyBuffers(EGLDisplay display, EGLSurface surface,
        ...
        bool result = mEgl10.eglCopyBuffers(display, surface, native_pixmap);
        returns(result);
        checkError();
        return result;
    }
    ...
    public bool eglDestroyContext(EGLDisplay display, EGLContext context) {
        begin("eglDestroyContext");
        arg("display", display);
        arg("context", context);
        end();

        bool result = mEgl10.eglDestroyContext(display, context);
        returns(result);
        checkError();
        return result;
    }

    public bool eglDestroySurface(EGLDisplay display, EGLSurface surface) {
        begin("eglDestroySurface");
        arg("display", display);
        arg("surface", surface);
        end();

        bool result = mEgl10.eglDestroySurface(display, surface);
        returns(result);
        checkError();
        return result;
    }

    public bool eglGetConfigAttrib(EGLDisplay display, EGLConfig config,
        ...
        bool result = mEgl10.eglGetConfigAttrib(display, config, attribute,
                value);
        arg("value", value);
        returns(result);
        checkError();
    ...
    public bool eglGetConfigs(EGLDisplay display, EGLConfig[] configs,
        ...
        bool result = mEgl10.eglGetConfigs(display, configs, config_size,
                num_config);
        arg("configs", configs);
        arg("num_config", num_config);
        returns(result);
    ...
    public bool eglInitialize(EGLDisplay display, int[] major_minor) {
        begin("eglInitialize");
        arg("display", display);
        end();
        bool result = mEgl10.eglInitialize(display, major_minor);
        returns(result);
    ...
    public bool eglMakeCurrent(EGLDisplay display, EGLSurface draw,
        ...
        bool result = mEgl10.eglMakeCurrent(display, draw, read, context);
        returns(result);
        checkError();
        return result;
    }

    public bool eglQueryContext(EGLDisplay display, EGLContext context,
            int attribute, int[] value) {
        ...
        bool result = mEgl10.eglQueryContext(display, context, attribute,
                value);
        returns(value[0]);
        returns(result);
        checkError();
    ...
    public bool eglQuerySurface(EGLDisplay display, EGLSurface surface,
            int attribute, int[] value) {
        ...
        bool result = mEgl10.eglQuerySurface(display, surface, attribute,
                value);
        returns(value[0]);
        returns(result);
        checkError();
    ...
    /** @hide **/
    public bool eglReleaseThread() {
        begin("eglReleaseThread");
        end();
        bool result = mEgl10.eglReleaseThread();
        returns(result);
        checkError();
        return result;
    }

    public bool eglSwapBuffers(EGLDisplay display, EGLSurface surface) {
        begin("eglSwapBuffers");
        arg("display", display);
        arg("surface", surface);
        end();
        bool result = mEgl10.eglSwapBuffers(display, surface);
        returns(result);
        checkError();
        return result;
    }

    public bool eglTerminate(EGLDisplay display) {
        begin("eglTerminate");
        arg("display", display);
        end();
        bool result = mEgl10.eglTerminate(display);
        returns(result);
        checkError();
        return result;
    }
    ...
    public bool eglWaitGL() {
        ...
        bool result = mEgl10.eglWaitGL();
        returns(result);
        checkError();
        return result;
    }

    public bool eglWaitNative(int engine, Object bindTarget) {
        begin("eglWaitNative");
        arg("engine", engine);
        arg("bindTarget", bindTarget);
        end();
        bool result = mEgl10.eglWaitNative(engine, bindTarget);
        returns(result);
        checkError();
        return result;
    }
    ...
    private void returns(bool result) {
