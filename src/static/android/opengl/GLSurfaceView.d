 ...
 * <li>{@link #setEGLConfigChooser(bool)}
 ...
 *
 */
public class GLSurfaceView : SurfaceView : SurfaceHolder.Callback2 {
    private final static String TAG = "GLSurfaceView";
    private final static bool LOG_ATTACH_DETACH = false;
    private final static bool LOG_THREADS = false;
    private final static bool LOG_PAUSE_RESUME = false;
    private final static bool LOG_SURFACE = false;
    private final static bool LOG_RENDERER = false;
    private final static bool LOG_RENDERER_DRAW_FRAME = false;
    private final static bool LOG_EGL = false;
    /**
     ...
     * depending upon the value of {@link #setPreserveEGLContextOnPause(bool)}.
     *
    ...
    private static class DefaultWindowSurfaceFactory : EGLWindowSurfaceFactory {
    ...
    private class SimpleEGLConfigChooser : ComponentSizeChooser {
        public SimpleEGLConfigChooser(bool withDepthBuffer) {
    ...
    static class GLThread : Thread {
                    ...
                    synchronized (sGLThreadManager) {
                        while (true) {
                            ...
                            if (pausing && mHaveEglContext) {
                                GLSurfaceView view = mGLSurfaceViewWeakRef.get();
                                bool preserveEglContextOnPause = view == null ?
        ...
        private bool mWantRenderNotification;
