...
public class GLES32 : GLES31 {
    ...
    // C function void glDebugMessageControl ( GLenum source, GLenum type, GLenum severity, GLsizei count, const GLuint *ids, GLbool enabled )
    ...
    // C function void glColorMaski ( GLuint index, GLbool r, GLbool g, GLbool b, GLbool a )
    ...
    // C function GLbool glIsEnabledi ( GLenum target, GLuint index )

    public static native bool glIsEnabledi(
        int target,
        int index
    );
    ...
    // C function void glTexStorage3DMultisample ( GLenum target, GLsizei samples, GLenum internalformat, GLsizei width, GLsizei height, GLsizei depth, GLbool fixedsamplelocations )
