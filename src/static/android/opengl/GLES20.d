...
public class GLES20 {
    ...
    // C function void glColorMask ( GLbool red, GLbool green, GLbool blue, GLbool alpha )
    ...
    // C function void glDepthMask ( GLbool flag )
    ...
    // C function void glGetBooleanv ( GLenum pname, GLbool *params )
    ...
    // C function GLbool glIsBuffer ( GLuint buffer )

    public static native bool glIsBuffer(
        int buffer
    );

    // C function GLbool glIsEnabled ( GLenum cap )

    public static native bool glIsEnabled(
        int cap
    );

    // C function GLbool glIsFramebuffer ( GLuint framebuffer )

    public static native bool glIsFramebuffer(
        int framebuffer
    );

    // C function GLbool glIsProgram ( GLuint program )

    public static native bool glIsProgram(
        int program
    );

    // C function GLbool glIsRenderbuffer ( GLuint renderbuffer )

    public static native bool glIsRenderbuffer(
        int renderbuffer
    );

    // C function GLbool glIsShader ( GLuint shader )

    public static native bool glIsShader(
        int shader
    );

    // C function GLbool glIsTexture ( GLuint texture )

    public static native bool glIsTexture(
        int texture
    );
    ...
    // C function void glSampleCoverage ( GLclampf value, GLbool invert )
    ...
    // C function void glUniformMatrix2fv ( GLint location, GLsizei count, GLbool transpose, const GLfloat *value )
    ...
    // C function void glUniformMatrix3fv ( GLint location, GLsizei count, GLbool transpose, const GLfloat *value )
    ...
    // C function void glUniformMatrix4fv ( GLint location, GLsizei count, GLbool transpose, const GLfloat *value )
    ...
    // C function void glVertexAttribPointer ( GLuint indx, GLint size, GLenum type, GLbool normalized, GLsizei stride, GLint offset )
    ...
    // C function void glVertexAttribPointer ( GLuint indx, GLint size, GLenum type, GLbool normalized, GLsizei stride, const GLvoid *ptr )
