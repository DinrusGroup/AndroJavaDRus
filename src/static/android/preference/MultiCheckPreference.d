 ...
 */
public class MultiCheckPreference : DialogPreference {
    private CharSequence[] mEntries;
    private String[] mEntryValues;
    private bool[] mSetValues;
    private bool[] mOrigValues;
    ...
    public void setEntries(CharSequence[] entries) {
        mEntries = entries;
        mSetValues = new bool[entries.length];
        mOrigValues = new bool[entries.length];
    }
    ...
    /**
     * Get the bool state of a given value.
     */
    ...
    /**
     * Set the bool state of a given value.
     */
