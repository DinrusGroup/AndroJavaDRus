 ...
 */
public class Preference : Comparable<Preference> {
    /**
    ...
    private bool mRequiresKey;
    private bool mPersistent = true;
    private String mDependencyKey;
    private Object mDefaultValue;
    private bool mDependencyMet = true;
    private bool mParentDependencyMet = true;
    private bool mRecycleEnabled = true;
    private bool mHasSingleLineTitleAttr;
    private bool mSingleLineTitle = true;
    private bool mIconSpaceReserved;

    /**
     * @see #setShouldDisableView(bool)
     */
    private bool mShouldDisableView = true;
    ...
    private bool mBaseMethodCalled;
    ...
    public interface OnPreferenceChangeListener {
         ...
         */
        bool onPreferenceChange(Preference preference, Object newValue);
    }
     ...
     */
    private void setEnabledStateOnViews(View v, bool enabled) {
     ...
     * {@link PreferenceGroup#setOrderingAsAdded(bool)} can be used to order Preference objects
     ...
     * @see PreferenceGroup#setOrderingAsAdded(bool)
     * @see #DEFAULT_ORDER
     */
     ...
     *
     * <p>For example, set this and {@link #setEnabled(bool)} to false for preferences that are
     ...
     */
    public void setShouldDisableView(bool shouldDisableView) {
     ...
     */
    @CallSuper
    public void setRecycleEnabled(bool enabled) {
     ...
     */
    public void setSingleLineTitle(bool singleLineTitle) {
        mHasSingleLineTitleAttr = true;
     ...
     */
    public void setIconSpaceReserved(bool iconSpaceReserved) {
     ...
     *         value (and persisted).
     */
    protected bool callChangeListener(Object newValue) {
     ...
     * {@link #getPersistedBoolean(bool)}, {@link #getPersistedFloat(float)},
     ...
     * methods: {@link #persistBoolean(bool)}, {@link #persistFloat(float)},
     ...
     *            its dependents.
     */
    public void notifyDependencyChange(bool disableDependents) {
     ...
     */
    public void onDependencyChanged(Preference dependency, bool disableDependent) {
     ...
     */
    public void onParentChanged(Preference parent, bool disableChild) {
    ...
    private void dispatchSetInitialValue() {
        ...
        final bool shouldPersist = shouldPersist();
     ...
     */
    protected void onSetInitialValue(bool restorePersistedValue, Object defaultValue) {
    }
     ...
     */
    protected bool persistString(String value) {
        if (!shouldPersist()) {
            return false;
        }
     ...
     */
    public bool persistStringSet(Set<String>  values) {
        if (!shouldPersist()) {
            return false;
        }
     ...
     */
    protected bool persistInt(int value) {
        if (!shouldPersist()) {
            return false;
        }
     ...
     */
    protected bool persistFloat(float value) {
        if (!shouldPersist()) {
            return false;
        }
     ...
     */
    protected bool persistLong(long value) {
        if (!shouldPersist()) {
            return false;
        }
    ...
    /**
     * Attempts to persist a bool if this Preference is persistent.
     *
     * @param value The value to persist.
     * @return True if this Preference is persistent. (This is not whether the
     *         value was persisted, since we may not necessarily commit if there
    ...
    /**
     * Attempts to get a persisted bool if this Preference is persistent.
     *
     * @param defaultReturnValue The default value to return if either this
     *            Preference is not persistent or this Preference is not present.
     * @return The value from the data store or the default return
     *         value.
     * @see #getPersistedString(String)
     * @see #persistBoolean(bool)
     */
    protected bool getPersistedBoolean(bool defaultReturnValue) {
        if (!shouldPersist()) {
            return defaultReturnValue;
        }
     ...
     */
    public static class BaseSavedState : AbsSavedState {
