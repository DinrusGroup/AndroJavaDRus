...
public interface PreferenceDataStore {
    ...
    /**
     * Set a bool value to the data store.
     *
     * <p>Once the value is set the data store is responsible for holding it.
     *
     * @param key The name of the preference to modify.
     ...
     */
    default void putBoolean(String key, bool value) {
        throw new UnsupportedOperationException("Not implemented on this data store");
    }
    ...
    /**
     * Retrieve a bool value from the data store.
     *
     * @param key The name of the preference to retrieve.
     * @param defValue Value to return if this preference does not exist.
     * @see #getBoolean(String, bool)
     */
    default bool getBoolean(String key, bool defValue) {
        return defValue;
    }
}
