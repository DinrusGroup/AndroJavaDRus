 ...
 * {@hide}
 */
public class MtpDatabase : AutoCloseable {
    ...
    private void endSendObject(int handle, bool succeeded) {
    ...
    private int renameFile(int handle, String newName) {
        ...
        bool success = oldPath.toFile().renameTo(newPath.toFile());
        try {
    ...
    private int beginMoveObject(int handle, int newParent, int newStorage) {
        ...
        bool allowed = mManager.beginMoveObject(obj, parent);
    ...
    private void endCopyObject(int handle, bool success) {
        MtpStorageManager.MtpObject obj = mManager.getObject(handle);
    ...
    private bool getObjectInfo(int handle, int[] outStorageFormatParent,
    ...
    private void endDeleteObject(int handle, bool success) {
        MtpStorageManager.MtpObject obj = mManager.getObject(handle);
        if (obj == null) {
            return;
        }
    ...
    private void deleteFromMedia(Path path, bool isDir) {
        try {
