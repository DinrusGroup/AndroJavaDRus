...
public final class MtpDevice {
     ...
     */
    public bool open(@NonNull UsbDeviceConnection connection) {
        bool result = false;
     ...
     */
    public bool importFile(int objectHandle, @NonNull String destPath) {
     ...
     * @return true if the file transfer succeeds
     */
    public bool importFile(int objectHandle, @NonNull ParcelFileDescriptor descriptor) {
    ...
    private native bool native_open(String deviceName, int fd);
    ...
    private native bool native_delete_object(int objectHandle);
    private native int native_get_parent(int objectHandle);
    private native int native_get_storage_id(int objectHandle);
    private native bool native_import_file(int objectHandle, String destPath);
    private native bool native_import_file(int objectHandle, int fd);
    private native bool native_send_object(int objectHandle, long size, int fd);
