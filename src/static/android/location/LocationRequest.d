 ...
 */
@SystemApi
public final class LocationRequest : Parcelable {
    /**
    ...
    private bool mExplicitFastestInterval = false;
    private long mExpireAt = Long.MAX_VALUE;  // no expiry
    private int mNumUpdates = Integer.MAX_VALUE;  // no expiry
    private float mSmallestDisplacement = 0.0f;    // meters
    private WorkSource mWorkSource = null;
    private bool mHideFromAppOps = false; // True if this request shouldn't be counted by AppOps
    ...
    public static LocationRequest createFromDeprecatedProvider(String provider, long minTime,
            float minDistance, bool singleShot) {
     ...
     */
    @SystemApi
    public LocationRequest setLowPowerMode(bool enabled) {
     ...
     */
    @SystemApi
    public void setHideFromAppOps(bool hideFromAppOps) {
        mHideFromAppOps = hideFromAppOps;
    }

    /** @hide */
    @SystemApi
    public bool getHideFromAppOps() {
