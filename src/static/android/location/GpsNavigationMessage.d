 ...
 */
@SystemApi
public class GpsNavigationMessage : Parcelable {
    ...
    public static final Creator<GpsNavigationMessage> CREATOR =
        ...
        public GpsNavigationMessage createFromParcel(Parcel parcel) {
            ...
            navigationMessage.setMessageId(cast(short) parcel.readInt());
            navigationMessage.setSubmessageId(cast(short) parcel.readInt());
            ...
            if (parcel.dataAvail() >= Integer.SIZE) {
                ...
                navigationMessage.setStatus(cast(short) status);
            } else {
