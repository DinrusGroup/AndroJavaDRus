 ...
 */
@SystemApi
public class GpsMeasurement : Parcelable {
    private int mFlags;
    private byte mPrn;
     ...
     */
    public bool isPseudorangeRateCorrected() {
     ...
     */
    public bool hasPseudorangeInMeters() {
     ...
     */
    public bool hasPseudorangeUncertaintyInMeters() {
     ...
     */
    public bool hasCodePhaseInChips() {
     ...
     */
    public bool hasCodePhaseUncertaintyInChips() {
     ...
     */
    public bool hasCarrierFrequencyInHz() {
     ...
     */
    public bool hasTimeFromLastBitInMs() {
     ...
     */
    public bool hasDopplerShiftInHz() {
     ...
     */
    public bool hasDopplerShiftUncertaintyInHz() {
     ...
     */
    public bool hasElevationUncertaintyInDeg() {
     ...
     */
    public bool hasAzimuthUncertaintyInDeg() {
     ...
     */
    public void setUsedInFix(bool value) {
        mUsedInFix = value;
    }
    ...
    public static final Creator<GpsMeasurement> CREATOR = new Creator<GpsMeasurement>() {
        ...
        public GpsMeasurement createFromParcel(Parcel parcel) {
            ...
            gpsMeasurement.mState = cast(short) parcel.readInt();
            ...
            gpsMeasurement.mAccumulatedDeltaRangeState = cast(short) parcel.readInt();
            ...
            gpsMeasurement.mTimeFromLastBitInMs = cast(short) parcel.readInt();
