 ...
 */
@SystemApi
public class GpsClock : Parcelable {
     ...
     */
    public bool hasTimeUncertaintyInNs() {
     ...
     */
    public bool hasBiasUncertaintyInNs() {
     ...
     */
    public bool hasDriftInNsPerSec() {
     ...
     */
    public bool hasDriftUncertaintyInNsPerSec() {
    ...
    public static final Creator<GpsClock> CREATOR = new Creator<GpsClock>() {
        ...
        public GpsClock createFromParcel(Parcel parcel) {
            ...
            gpsClock.mFlags = cast(short) parcel.readInt();
            gpsClock.mLeapSecond = cast(short) parcel.readInt();
    ...
    private bool isFlagSet(short flag) {
