...
public class AccountManager {
    ...
    public static final String KEY_BOOLEAN_RESULT = "boolResult";
     ...
     * authenticator-specific string tokens identifying bool account properties. For example,
     ...
     * string tokens identifying bool account properties (see {@link #hasFeatures}).
     *
     * <p>
     ...
     */
    public bool addAccountExplicitly(Account account, String password, Bundle userdata) {
        if (account == null) throw new IllegalArgumentException("account is null");
        try {
     ...
     */
    public bool setAccountVisibility(Account account, String packageName,
     ...
     * @return bool {@code true} if the authentication of the account has been successfully
     *         acknowledged. Otherwise {@code false}.
     */
    public bool notifyAccountAuthenticated(Account account) {
        if (account == null)
            throw new IllegalArgumentException("account is null");
        try {
     ...
     * {@link #getAuthToken(Account, String, bool, AccountManagerCallback, Handler)}.
     *
     ...
     * bool, AccountManagerCallback, android.os.Handler)} instead
     */
    @Deprecated
    public AccountManagerFuture<Bundle> getAuthToken(
            final Account account, final String authTokenType,
            final bool notifyAuthFailure,
     ...
     * @return
     */
    public bool removeSharedAccount(final Account account, UserHandle user) {
        try {
            bool val = mService.removeSharedAccountAsUser(account, user.getIdentifier());
            return val;
        } catch (RemoteException re) {
            throw re.rethrowFromSystemServer();
        }
    ...
    private abstract class AmsTask : FutureTask<Bundle> : AccountManagerFuture<Bundle> {
        ...
        private class Response : IAccountManagerResponse.Stub {
            override
    ...
    private abstract class BaseFutureTask<T> : FutureTask<T> {
        ...
        protected class Response : IAccountManagerResponse.Stub {
            override
            public void onResult(Bundle bundle) {
                try {
    ...
    private abstract class Future2Task<T>
            : BaseFutureTask<T> : AccountManagerFuture<T> {
    ...
    private class GetAuthTokenByTypeAndFeaturesTask
            : AmsTask : AccountManagerCallback<Bundle> {
     ...
     * @param alwaysPromptForAccount bool that is ignored.
     ...
     *
     * @see #addOnAccountsUpdatedListener(OnAccountsUpdateListener, Handler, bool,
     *      String[])
     */
    public void addOnAccountsUpdatedListener(final OnAccountsUpdateListener listener,
            Handler handler, bool updateImmediately) {
        addOnAccountsUpdatedListener(listener, handler,updateImmediately, null);
    }
     ...
     */
    public void addOnAccountsUpdatedListener(final OnAccountsUpdateListener listener,
            Handler handler, bool updateImmediately, String[] accountTypes) {
        if (listener == null) {
        ...
        synchronized (mAccountsUpdatedListeners) {
            ...
            final bool wasEmpty = mAccountsUpdatedListeners.isEmpty();
