...
public class Linkify {
    ...
    public static final MatchFilter sUrlMatchFilter = new MatchFilter() {
        public final bool acceptMatch(CharSequence s, int start, int end) {
            if (start == 0) {
                return true;
            }
    ...
    public interface MatchFilter {
         ...
         */
        bool acceptMatch(CharSequence s, int start, int end);
    }
     ...
     */
    public static final bool addLinks(@NonNull Spannable text, @LinkifyMask int mask) {
        return addLinks(text, mask, null);
    }

    private static bool addLinks(@NonNull Spannable text, @LinkifyMask int mask,
     ...
     *  @return True if at least one link is found and applied.
     */
    public static final bool addLinks(@NonNull TextView text, @LinkifyMask int mask) {
        if (mask == 0) {
            return false;
        }
    ...
    public static final void addLinks(@NonNull TextView text, @NonNull Pattern pattern,
        ...
        bool linksAdded = addLinks(spannable, pattern, defaultScheme, schemes, matchFilter,
                transformFilter);
        if (linksAdded) {
     ...
     *                      prepended to the links that do not start with this scheme.
     */
    public static final bool addLinks(@NonNull Spannable text, @NonNull Pattern pattern,
            @Nullable String scheme) {
     ...
     * @return True if at least one link is found and applied.
     */
    public static final bool addLinks(@NonNull Spannable spannable, @NonNull Pattern pattern,
            @Nullable String scheme, @Nullable MatchFilter matchFilter,
            @Nullable TransformFilter transformFilter) {
