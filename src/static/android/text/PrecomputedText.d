 ...
 * PrecomputedText.
 */
public class PrecomputedText : Spannable {
    ...
    public static final class Params {
        ...
        /** @hide */
        public bool isSameTextMetricsInternal(@NonNull TextPaint paint,
    ...
    public static ParagraphInfo[] createMeasuredParagraphs(
            ...
            @IntRange(from = 0) int start, @IntRange(from = 0) int end, bool computeLayout) {
        ArrayList<ParagraphInfo> result = new ArrayList<>();

        Preconditions.checkNotNull(text);
        Preconditions.checkNotNull(params);
        final bool needHyphenation = params.getBreakStrategy() != Layout.BREAK_STRATEGY_SIMPLE
     ...
     * @hide
     */
    public bool canUseMeasuredResult(@IntRange(from = 0) int start, @IntRange(from = 0) int end,
