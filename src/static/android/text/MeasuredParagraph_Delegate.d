...
public class MeasuredParagraph_Delegate {
    ...
    /*package*/ static long nBuildNativeMeasuredParagraph(long nativeBuilderPtr,
            @NonNull char[] text, bool computeHyphenation, bool computeLayout) {
    ...
    private static class StyleRun : Run {
        private final long mNativePaint;
        private final bool mIsRtl;

        private StyleRun(long nativePaint, int start, int end, bool isRtl) {
            super(start, end);
    ...
    private static class ReplacementRun : Run {
