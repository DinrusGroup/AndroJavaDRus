 ...
 */
public class SuggestionSpan : CharacterStyle : ParcelableSpan {
    ...
    public SuggestionSpan(Context context, Locale locale, String[] suggestions, int flags,
            Class!(T) notificationTargetClass) {
    ...
    public void updateDrawState(TextPaint tp) {
        final bool misspelled = (mFlags & FLAG_MISSPELLED) != 0;
        final bool easy = (mFlags & FLAG_EASY_CORRECT) != 0;
        final bool autoCorrection = (mFlags & FLAG_AUTO_CORRECTION) != 0;
        if (easy) {
            if (!misspelled) {
