 ...
 */
public class AbsoluteSizeSpan : MetricAffectingSpan : ParcelableSpan {

    private final int mSize;
    private final bool mDip;
     ...
     * @see AbsoluteSizeSpan#AbsoluteSizeSpan(int, bool)
     */
    public int getSize() {
        return mSize;
    }
     ...
     * <code>dip</code> flag passed in {@link #AbsoluteSizeSpan(int, bool)}
     *
     * @return <code>true</code> if the size is in device-independent pixels, <code>false</code>
     * otherwise
     *
     * @see #AbsoluteSizeSpan(int, bool)
     */
    public bool getDip() {
        return mDip;
    }
