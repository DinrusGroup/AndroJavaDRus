 ...
 * TtsSpan type.
 */
public class TtsSpan : ParcelableSpan {
     ...
     */
    public static class Builder<C : Builder!(T)> {
     ...
     * {@link TtsSpan.CardinalBuilder} are likely more useful.
     */
    public static class SemioticClassBuilder<C : SemioticClassBuilder!(T)>
            : Builder<C> {
     ...
     */
    public static class TextBuilder : SemioticClassBuilder<TextBuilder> {
    ...
    public static class CardinalBuilder
            : SemioticClassBuilder<CardinalBuilder> {
    ...
    public static class OrdinalBuilder
            : SemioticClassBuilder<OrdinalBuilder> {
    ...
    public static class DecimalBuilder
            : SemioticClassBuilder<DecimalBuilder> {
    ...
    public static class FractionBuilder
            : SemioticClassBuilder<FractionBuilder> {
    ...
    public static class MeasureBuilder
            : SemioticClassBuilder<MeasureBuilder> {
    ...
    public static class TimeBuilder
            : SemioticClassBuilder<TimeBuilder> {
    ...
    public static class DateBuilder
            : SemioticClassBuilder<DateBuilder> {
    ...
    public static class MoneyBuilder
            : SemioticClassBuilder<MoneyBuilder> {
    ...
    public static class TelephoneBuilder
            : SemioticClassBuilder<TelephoneBuilder> {
    ...
    public static class ElectronicBuilder
            : SemioticClassBuilder<ElectronicBuilder> {
    ...
    public static class DigitsBuilder
            : SemioticClassBuilder<DigitsBuilder> {
    ...
    public static class VerbatimBuilder
            : SemioticClassBuilder<VerbatimBuilder> {
