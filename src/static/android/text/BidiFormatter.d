...
public final class BidiFormatter {
     ...
     */
    private BidiFormatter(bool isRtlContext, int flags, TextDirectionHeuristic heuristic) {
        mIsRtlContext = isRtlContext;
        mFlags = flags;
    ...
    /**
     * Operates like {@link #unicodeWrap(String, TextDirectionHeuristic, bool)}, but takes a
    ...
    public @Nullable CharSequence unicodeWrap(@Nullable CharSequence str,
            TextDirectionHeuristic heuristic, bool isolate) {
        if (str == null) return null;
        final bool isRtl = heuristic.isRtl(str, 0, str.length());
    ...
    /**
     * Operates like {@link #unicodeWrap(String, TextDirectionHeuristic, bool)}, but assumes
    ...
    /**
     * Operates like {@link #unicodeWrap(CharSequence, TextDirectionHeuristic, bool)}, but
    ...
    /**
     * Operates like {@link #unicodeWrap(String, TextDirectionHeuristic, bool)}, but uses the
    ...
    /**
     * Operates like {@link #unicodeWrap(CharSequence, TextDirectionHeuristic, bool)}, but uses
     ...
     */
    private static bool isRtlLocale(Locale locale) {
