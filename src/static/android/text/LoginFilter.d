 ...
 * 
 */
public abstract class LoginFilter : InputFilter {
    private bool mAppendInvalid;  // whether to append or ignore invalid characters
    /**
     * Base constructor for LoginFilter
     * @param appendInvalid whether or not to append invalid characters.
     */
    LoginFilter(bool appendInvalid) {
     ...
     * 
     */
    public static class UsernameFilterGMail : LoginFilter {
        
        public UsernameFilterGMail() {
            super(false);
        }
        
        public UsernameFilterGMail(bool appendInvalid) {
            super(appendInvalid);
        }
     ...
     * 
     */
    public static class UsernameFilterGeneric : LoginFilter {
     ...
     * 
     */
    public static class PasswordFilterGMail : LoginFilter {
        
        public PasswordFilterGMail() {
            super(false);
        }
        
        public PasswordFilterGMail(bool appendInvalid) {
            super(appendInvalid);
        }
