...
public class StaticLayout : Layout {
    ...
    public final static class Builder {
         ...
         */
        @NonNull
        public Builder setIncludePad(bool includePad) {
         ...
         */
        @NonNull
        public Builder setUseLineSpacingFromFallbacks(bool useLineSpacingFromFallbacks) {
         ...
         */
        @NonNull
        /* package */ Builder setAddLastLineLineSpacing(bool value) {
        ...
        private bool mFallbackLineSpacing;
        ...
        private bool mAddLastLineLineSpacing;
    ...
    /* package */ void generate(Builder b, bool includepad, bool trackpad) {
        ...
        final bool fallbackLineSpacing = b.mFallbackLineSpacing;
        float spacingmult = b.mSpacingMult;
        float spacingadd = b.mSpacingAdd;
        float ellipsizedWidth = b.mEllipsizedWidth;
        TextUtils.TruncateAt ellipsize = b.mEllipsize;
        final bool addLastLineSpacing = b.mAddLastLineLineSpacing;
        ...
        try {
            for (int paraIndex = 0; paraIndex < paragraphInfo.length; paraIndex++) {
                ...
                final bool ellipsisMayBeApplied = ellipsize != null
    ...
    private int out(final CharSequence text, final int start, final int end, int above, int below,
            ...
            final int flags, final bool needMultiply, @NonNull final MeasuredParagraph measured,
            final int bufEnd, final bool includePad, final bool trackPad,
            final bool addLastLineLineSpacing, final char[] chs, final float[] widths,
            final int widthStart, final TextUtils.TruncateAt ellipsize, final float ellipsisWidth,
            final float textWidth, final TextPaint paint, final bool moreChars) {
        ...
        if (mEllipsized) {
            ...
            final bool lastCharIsNewLine = widthStart != bufEnd && bufEnd > 0
    ...
    override
    public bool getLineContainsTab(int line) {
