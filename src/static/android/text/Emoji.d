...
public class Emoji {
     ...
     */
    public static bool isRegionalIndicatorSymbol(int codePoint) {
     ...
     */
    public static bool isEmojiModifierBase(int c) {
     ...
     */
    public static bool isNewEmoji(int c) {
    ...
    public static bool isKeycapBase(int codePoint) {
     ...
     */
    public static bool isTagSpecChar(int codePoint) {
