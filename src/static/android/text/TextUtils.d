...
public class TextUtils {
    ...
    public static void getChars(CharSequence s, int start, int end,
        ...
        Class<? : CharSequence> c = s.getClass();
    ...
    public static bool regionMatches(CharSequence one, int toffset,
     ...
     * </pre>
     */
    public interface StringSplitter : Iterable<String> {
     ...
     */
    public static class SimpleStringSplitter : StringSplitter, Iterator<String> {
     ...
     */
    public static bool isEmpty(@Nullable CharSequence str) {
    ...
    /* package */
    static bool couldAffectRtl(char c) {
    ...
    /* package */
    static bool doesNotNeedBidi(char[] text, int start, int len) {
     ...
     */
    public static bool isGraphic(CharSequence str) {
     ...
     */
    public static bool isDigitsOnly(CharSequence str) {
        final int len = str.length();
        for (int cp, i = 0; i < len; i += Character.charCount(cp)) {
            cp = Character.codePointAt(str, i);
     ...
     * @hide
     */
    public static bool delimitedStringContains(
     ...
     * @hide
     */
    public static bool hasStyleSpan(@NonNull Spanned spanned) {
        Preconditions.checkArgument(spanned != null);
        final Class!(T)[] styleClasses = {
                CharacterStyle.class, ParagraphStyle.class, UpdateAppearance.class};
        for (Class!(T) clazz : styleClasses) {
     ...
     */
    @Nullable
    public static <T : CharSequence> T trimToParcelableSize(@Nullable T text) {
     ...
     */
    @Nullable
    public static <T : CharSequence> T trimToSize(@Nullable T text,
