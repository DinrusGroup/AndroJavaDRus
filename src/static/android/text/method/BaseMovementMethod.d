 ...
 */
public class BaseMovementMethod : MovementMethod {
    override
    ...
    override
    public bool onKeyDown(TextView widget, Spannable text, int keyCode, KeyEvent event) {
    ...
    override
    public bool onKeyOther(TextView widget, Spannable text, KeyEvent event) {
        final int movementMetaState = getMovementMetaState(text, event);
    ...
    override
    public bool onKeyUp(TextView widget, Spannable text, int keyCode, KeyEvent event) {
        return false;
    }
    ...
    override
    public bool onTouchEvent(TextView widget, Spannable text, MotionEvent event) {
        return false;
    }

    override
    public bool onTrackballEvent(TextView widget, Spannable text, MotionEvent event) {
        return false;
    }

    override
    public bool onGenericMotionEvent(TextView widget, Spannable text, MotionEvent event) {
     ...
     */
    protected bool handleMovementKey(TextView widget, Spannable buffer,
     ...
     * @hide
     */
    protected bool scrollLeft(TextView widget, Spannable buffer, int amount) {
     ...
     * @hide
     */
    protected bool scrollRight(TextView widget, Spannable buffer, int amount) {
     ...
     * @hide
     */
    protected bool scrollUp(TextView widget, Spannable buffer, int amount) {
        final Layout layout = widget.getLayout();
     ...
     * @hide
     */
    protected bool scrollDown(TextView widget, Spannable buffer, int amount) {
        final Layout layout = widget.getLayout();
     ...
     * @hide
     */
    protected bool scrollPageUp(TextView widget, Spannable buffer) {
        final Layout layout = widget.getLayout();
     ...
     * @hide
     */
    protected bool scrollPageDown(TextView widget, Spannable buffer) {
        final Layout layout = widget.getLayout();
        final int innerHeight = getInnerHeight(widget);
     ...
     * @hide
     */
    protected bool scrollTop(TextView widget, Spannable buffer) {
        final Layout layout = widget.getLayout();
     ...
     * @hide
     */
    protected bool scrollBottom(TextView widget, Spannable buffer) {
        final Layout layout = widget.getLayout();
     ...
     * @hide
     */
    protected bool scrollLineStart(TextView widget, Spannable buffer) {
        final int minScrollX = getScrollBoundsLeft(widget);
        int scrollX = widget.getScrollX();
        if (scrollX > minScrollX) {
     ...
     * @hide
     */
    protected bool scrollLineEnd(TextView widget, Spannable buffer) {
        final int maxScrollX = getScrollBoundsRight(widget) - getInnerWidth(widget);
        int scrollX = widget.getScrollX();
        if (scrollX < maxScrollX) {
