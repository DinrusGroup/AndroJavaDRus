 ...
 */
public abstract class BaseKeyListener : MetaKeyKeyListener
        : KeyListener {
     ...
     */
    public bool backspace(View view, Editable content, int keyCode, KeyEvent event) {
     ...
     * @return true if anything was deleted; false otherwise.
     */
    public bool forwardDelete(View view, Editable content, int keyCode, KeyEvent event) {
    ...
    private static int adjustReplacementSpan(CharSequence text, int offset, bool moveToStart) {
    ...
    private bool backspaceOrForwardDelete(View view, Editable content, int keyCode,
            KeyEvent event, bool isForwardDelete) {
        ...
        bool isCtrlActive = ((event.getMetaState() & KeyEvent.META_CTRL_ON) != 0);
        bool isShiftActive = (getMetaState(content, META_SHIFT_ON, event) == 1);
        bool isAltActive = (getMetaState(content, META_ALT_ON, event) == 1);
    ...
    private bool deleteUntilWordBoundary(View view, Editable content, bool isForwardDelete) {
    ...
    private bool deleteSelection(View view, Editable content) {
    ...
    private bool deleteLine(View view, Editable content) {
        if (view instanceof TextView) {
    ...
    public bool onKeyDown(View view, Editable content,
     ...
     */
    public bool onKeyOther(View view, Editable content, KeyEvent event) {
