 ...
 * </p><p>
 * {@link MetaKeyKeyListener} : chorded and toggled key modifiers.
...
public abstract class MetaKeyKeyListener {
     ...
     */
    public static bool isMetaTracker(CharSequence text, Object what) {
     ...
     */
    public static bool isSelectingMetaTracker(CharSequence text, Object what) {
     ...
     */
    public bool onKeyUp(View view, Editable content, int keyCode, KeyEvent event) {
        if (keyCode == KeyEvent.KEYCODE_SHIFT_LEFT || keyCode == KeyEvent.KEYCODE_SHIFT_RIGHT) {
