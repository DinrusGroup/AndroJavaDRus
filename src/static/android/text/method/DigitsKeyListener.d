 ...
 */
public class DigitsKeyListener : NumberKeyListener
{
    private char[] mAccepted;
    private bool mNeedsAdvancedInput;
    private final bool mSign;
    private final bool mDecimal;
    private final bool mStringMode;
    @Nullable
    ...
    private bool isSignChar(final char c) {
        return mSignChars.indexOf(c) != -1;
    }

    private bool isDecimalPointChar(final char c) {
     ...
     *
     * @deprecated Use {@link #DigitsKeyListener(Locale, bool, bool)} instead.
     */
    @Deprecated
    ...
    public DigitsKeyListener(@Nullable Locale locale, bool sign, bool decimal) {
        mSign = sign;
        mDecimal = decimal;
        mStringMode = false;
        mLocale = locale;
        ...
        final bool success = NumberKeyListener.addDigits(chars, locale);
        if (!success) {
            setToCompat();
            return;
        }
     ...
     * (only one per field) if specified.
     *
     * @deprecated Use {@link #getInstance(Locale, bool, bool)} instead.
     */
    @Deprecated
    @NonNull
    ...
    @NonNull
    public static DigitsKeyListener getInstance(
            @Nullable Locale locale, bool sign, bool decimal) {
