 ...
 */
public class TextKeyListener : BaseKeyListener : SpanWatcher {
     ...
     */
    public TextKeyListener(Capitalize cap, bool autotext) {
        mAutoCap = cap;
        mAutoText = autotext;
    }
     ...
     * @param autotext whether to automatically do spelling corrections.
     */
    public static TextKeyListener getInstance(bool autotext,
                                              Capitalize cap) {
     ...
     */
    public static bool shouldCap(Capitalize cap, CharSequence cs, int off) {
        int i;
        char c;
    ...
    override
    public bool onKeyUp(View view, Editable content,
                           int keyCode, KeyEvent event) {
        KeyListener im = getKeyListener(event);
    ...
    private static class NullKeyListener : KeyListener
    {
        public int getInputType() {
        ...
        public bool onKeyUp(View view, Editable content, int keyCode,
                                        KeyEvent event) {
            return false;
        }
    ...
    private void updatePrefs(ContentResolver resolver) {
        bool cap = System.getInt(resolver, System.TEXT_AUTO_CAPS, 1) > 0;
        bool text = System.getInt(resolver, System.TEXT_AUTO_REPLACE, 1) > 0;
        bool period = System.getInt(resolver, System.TEXT_AUTO_PUNCTUATE, 1) > 0;
        bool pw = System.getInt(resolver, System.TEXT_SHOW_PASSWORD, 1) > 0;
