 ...
 */
public abstract class NumberKeyListener : BaseKeyListener
    : InputFilter
{
    /**
    ...
    protected static bool ok(char[] accept, char c) {
    ...
    /* package */
    @Nullable
    static bool addDigits(@NonNull Collection<Character> collection, @Nullable Locale locale) {
        if (locale == null) {
            return false;
        }
    ...
    /* package */
    static bool addFormatCharsFromSkeleton(
    ...
    /* package */
    static bool addFormatCharsFromSkeletons(
            @NonNull Collection<Character> collection, @Nullable Locale locale,
            @NonNull String[] skeletons, @NonNull String symbolsToIgnore) {
        for (int i = 0; i < skeletons.length; i++) {
            final bool success = addFormatCharsFromSkeleton(
    ...
    /* package */
    static bool addAmPmChars(@NonNull Collection<Character> collection,
