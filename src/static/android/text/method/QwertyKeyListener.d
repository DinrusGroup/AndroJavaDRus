 ...
 */
public class QwertyKeyListener : BaseKeyListener {
    ...
    private QwertyKeyListener(Capitalize cap, bool autoText, bool fullKeyboard) {
        mAutoCap = cap;
        mAutoText = autoText;
        mFullKeyboard = fullKeyboard;
    }

    public QwertyKeyListener(Capitalize cap, bool autoText) {
     ...
     */
    public static QwertyKeyListener getInstance(bool autoText, Capitalize cap) {
    ...
    private bool showCharacterPicker(View view, Editable content, char c,
    ...
    /* package */ static class Replaced : NoCopySpan
    {
