...
public class Selection {
     ...
     */
    @TestApi
    public static final class MemoryTextWatcher : TextWatcher {
     ...
     */
    public static bool moveUp(Spannable text, Layout layout) {
     ...
     * end of the buffer.
     */
    public static bool moveDown(Spannable text, Layout layout) {
        int start = getSelectionStart(text);
        int end = getSelectionEnd(text);
     ...
     */
    public static bool moveLeft(Spannable text, Layout layout) {
        int start = getSelectionStart(text);
        int end = getSelectionEnd(text);
     ...
     * to move it to.
     */
    public static bool moveRight(Spannable text, Layout layout) {
        int start = getSelectionStart(text);
        int end = getSelectionEnd(text);
     ...
     */
    public static bool extendUp(Spannable text, Layout layout) {
        int end = getSelectionEnd(text);
        int line = layout.getLineForOffset(end);
     ...
     * the current selection end.
     */
    public static bool extendDown(Spannable text, Layout layout) {
        int end = getSelectionEnd(text);
        int line = layout.getLineForOffset(end);
     ...
     * the current selection end.
     */
    public static bool extendLeft(Spannable text, Layout layout) {
        int end = getSelectionEnd(text);
        int to = layout.getOffsetToLeftOf(end);
     ...
     * the current selection end.
     */
    public static bool extendRight(Spannable text, Layout layout) {
        int end = getSelectionEnd(text);
        int to = layout.getOffsetToRightOf(end);
    ...
    public static bool extendToLeftEdge(Spannable text, Layout layout) {
        int where = findEdge(text, layout, -1);
        extendSelection(text, where);
        return true;
    }

    public static bool extendToRightEdge(Spannable text, Layout layout) {
        int where = findEdge(text, layout, 1);
        extendSelection(text, where);
        return true;
    }

    public static bool moveToLeftEdge(Spannable text, Layout layout) {
        int where = findEdge(text, layout, -1);
        setSelection(text, where);
        return true;
    }

    public static bool moveToRightEdge(Spannable text, Layout layout) {
        int where = findEdge(text, layout, 1);
        setSelection(text, where);
        return true;
    }
    ...
    /** {@hide} */
    public static bool moveToPreceding(
            Spannable text, PositionIterator iter, bool extendSelection) {
    ...
    /** {@hide} */
    public static bool moveToFollowing(
            Spannable text, PositionIterator iter, bool extendSelection) {
    ...
    private static final class START : NoCopySpan { }
    private static final class END : NoCopySpan { }
    private static final class MEMORY : NoCopySpan { }
