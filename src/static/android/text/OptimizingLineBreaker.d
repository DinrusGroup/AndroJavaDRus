 ...
 * jagged.
 */
public class OptimizingLineBreaker : LineBreaker {
    ...
    private static float computeDemerits(float maxWidth, float width, bool finalBreak,
            float penalty) {
    ...
    private static class LineMetrics {
        ...
        public LineMetrics(float width, float printedWidth, bool hasTabs) {
            mWidth = width;
    ...
    private static class Node {
        ...
        public Node(int prev, int prevCount, float demerits, float width, bool hasTabs) {
            mPrev = prev;
