...
public class Time {
     ...
     * fields, call {@link #normalize(bool)} after parsing.
     *
     ...
     * @throws android.util.TimeFormatException if s cannot be parsed.
     */
     public bool parse3339(String s) {
         if (s == null) {
             throw new NullPointerException("time string is null");
         }
     ...
     private bool parse3339Internal(String s) {
         int len = s.length();
         if (len < 10) {
     ...
     * {@code -1}.
     */
    public long toMillis(bool ignoreDst) {
        calculator.copyFieldsFromTime(this);
     ...
     * Call {@link #normalize(bool)} if you need those.
     */
     ...
     */
    public String format3339(bool allDay) {
        if (allDay) {
            return format(Y_M_D);
     ...
     */
    public static bool isEpoch(Time time) {
     ...
     * by {@link #toMillis(bool)} or {@link #normalize(bool)})
    ...
    private static class TimeCalculator {
        ...
        public String format2445(bool hasTime) {
