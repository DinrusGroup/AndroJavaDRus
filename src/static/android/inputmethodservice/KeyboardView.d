 ...
 */
public class KeyboardView : View : View.OnClickListener {
    ...
    private void initGestureDetector() {
        if (mGestureDetector == null) {
            mGestureDetector = new GestureDetector(getContext(), new GestureDetector.SimpleOnGestureListener() {
                override
                public bool onFling(MotionEvent me1, MotionEvent me2,
     ...
     */
    public bool setShifted(bool shifted) {
        if (mKeyboard != null) {
     ...
     * @see KeyboardView#setShifted(bool)
     */
     ...
     */
    public void setProximityCorrectionEnabled(bool enabled) {
    ...
    private bool openPopupIfRequired(MotionEvent me) {
        ...
        bool result = onLongPress(popupKey);
        if (result) {
            mAbortKey = true;
            showPreview(NOT_A_KEY);
        }
     ...
     */
    protected bool onLongPress(Key popupKey) {
    ...
    private bool onModifiedTouchEvent(MotionEvent me, bool possiblePoly) {
