 ...
 * interface.
 */
public abstract class AbstractInputMethodService : Service
        : KeyEvent.Callback {
     ...
     * but most behavior must be implemented in a derived class.
     */
    public abstract class AbstractInputMethodSessionImpl : InputMethodSession {
        bool mEnabled = true;
        bool mRevoked;
        ...
        public void dispatchKeyEvent(int seq, KeyEvent event, EventCallback callback) {
            bool handled = event.dispatch(AbstractInputMethodService.this,
        ...
        public void dispatchTrackballEvent(int seq, MotionEvent event, EventCallback callback) {
            bool handled = onTrackballEvent(event);
            if (callback != null) {
                callback.finishedEvent(seq, handled);
            }
        }
        ...
        public void dispatchGenericMotionEvent(int seq, MotionEvent event, EventCallback callback) {
            bool handled = onGenericMotionEvent(event);
            if (callback != null) {
                callback.finishedEvent(seq, handled);
            }
        }
