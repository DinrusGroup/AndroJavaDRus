 ...
 * <li> {@link #onStartInputView(EditorInfo, bool)} to deal with input
 ...
 * {@link #setCandidatesViewShown(bool)}.  Note that because the candidate
 ...
 * {@link #onFinishInput()} and {@link #onStartInput(EditorInfo, bool)}.
...
public class InputMethodService : AbstractInputMethodService {
    ...
    bool mInputStarted;
    bool mInputViewStarted;
    bool mCandidatesViewStarted;
    InputConnection mStartedInputConnection;
    EditorInfo mInputEditorInfo;

    /**
     * A token to keep tracking the last IPC that triggered
     * {@link #doStartInput(InputConnection, EditorInfo, bool)}. If
     * {@link #doStartInput(InputConnection, EditorInfo, bool)} was not caused by IPCs from
    ...
    int mShowInputFlags;
    bool mShowInputRequested;
    bool mLastShowInputRequested;
    int mCandidatesVisibility;
    CompletionInfo[] mCurCompletions;

    bool mFullscreenApplied;
    bool mIsFullscreen;
    View mExtractView;
    bool mExtractViewHidden;
     ...
     */
    bool mShouldClearInsetOfPreviousIme;
    ...
    public class InputMethodImpl : AbstractInputMethodImpl {
        ...
        public void dispatchStartInputWithToken(@Nullable InputConnection inputConnection,
                @NonNull EditorInfo editorInfo, bool restarting,
     ...
     */
    public class InputMethodSessionImpl : AbstractInputMethodSessionImpl {
     ...
     */
    @MainThread
    private static final class SettingsObserver : ContentObserver {
        ...
        private bool shouldShowImeWithHardKeyboard() {
    ...
    private void resetStateForNewConfiguration() {
        bool visible = mWindowVisible;
        int showFlags = mShowInputFlags;
        bool showingInput = mShowInputRequested;
        ...
        if (visible) {
            ...
            // If user uses hard keyboard, IME button should always be shown.
            bool showing = onEvaluateInputViewShown();
            mImm.setImeWindowStatus(mToken, mStartInputToken,
     ...
     */
    public final bool switchToPreviousInputMethod() {
     ...
     */
    public final bool switchToNextInputMethod(bool onlyCurrentIme) {
     ...
     */
    public final bool shouldOfferSwitchingToNextInputMethod() {
    ...
    public void updateFullscreenMode() {
        bool isFullscreen = mShowInputRequested && onEvaluateFullscreenMode();
        bool changed = mLastShowInputRequested != mShowInputRequested;
     ...
     */
    public void onConfigureWindow(Window win, bool isFullscreen,
     ...
     */
    public void setExtractViewShown(bool shown) {
     ...
     * {@link #setExtractViewShown(bool)}.  This effectively lets you
    ...
    public void updateInputViewShown() {
        bool isShown = mShowInputRequested && onEvaluateInputViewShown();
     ...
     * it is hidden.
     */
    public void setCandidatesViewShown(bool shown) {
    ...
    void updateCandidatesVisibility(bool shown) {
     ...
     * {@link #setCandidatesViewShown(bool)}.
     ...
     */
    public void onStartInputView(EditorInfo info, bool restarting) {
        // Intentionally empty
    }
     ...
     */
    public void onFinishInputView(bool finishingInput) {
        if (!finishingInput) {
     ...
     * same text field as before.
     */
    public void onStartCandidatesView(EditorInfo info, bool restarting) {
        // Intentionally empty
    }
     ...
     * called immediately after.
     */
    public void onFinishCandidatesView(bool finishingInput) {
        if (!finishingInput) {
            InputConnection ic = getCurrentInputConnection();
            if (ic != null) {
                ic.finishComposingText();
     ...
     */
    public bool onShowInputRequested(int flags, bool configChange) {
    ...
    /**
     * A utility method to call {{@link #onShowInputRequested(int, bool)}} and update internal
     * states depending on its result.  Since {@link #onShowInputRequested(int, bool)} is
     ...
     * {@link #onShowInputRequested(int, bool)} is overridden by the IME author.
     * @param flags Provides additional information about the show request,
     * as per {@link InputMethod#showSoftInput InputMethod.showSoftInput()}.
     * @param configChange This is true if we are re-showing due to a
     * configuration change.
     * @return Returns true to indicate that the window should be shown.
     * @see #onShowInputRequested(int, bool)
     */
    private bool dispatchOnShowInputRequested(int flags, bool configChange) {
        final bool result = onShowInputRequested(flags, configChange);
        if (result) {
    ...
    public void showWindow(bool showInput) {
    ...
    void showWindowInner(bool showInput) {
        bool doShowInput = false;
     ...
     * may be followed by a series of {@link #onStartInput(EditorInfo, bool)}
     ...
     */
    public void onStartInput(EditorInfo attribute, bool restarting) {
        // Intentionally empty
    }
    ...
    void doStartInput(InputConnection ic, EditorInfo attribute, bool restarting) {
        if (!restarting) {
            doFinishInput();
        }
        mInputStarted = true;
     ...
     * {@link #onStartInput(EditorInfo, bool)} to perform input in a
     ...
     */
    public void onViewClicked(bool focusChanged) {
        // Intentionally empty
    }
     ...
     */
    public bool onKeyMultiple(int keyCode, int count, KeyEvent event) {
    ...
    bool doMovementKey(int keyCode, KeyEvent event, int count) {
        final ExtractEditText eet = getExtractEditTextIfVisible();
        if (eet != null) {
     ...
     * 
     * @return Returns a bool indicating whether an action has been sent.
     ...
     */
    public bool sendDefaultEditorAction(bool fromEnterKey) {
     ...
     */
    public bool onExtractTextContextMenuItem(int id) {
        InputConnection ic = getCurrentInputConnection();
        if (ic != null) {
    ...
    public void onUpdateExtractingViews(EditorInfo ei) {
        ...
        final bool hasAction = ei.actionLabel != null || (
    ...
    void startExtractingText(bool inputChanged) {
        final ExtractEditText eet = mExtractEditText;
     ...
     * by calling this in
     * {@link android.inputmethodservice.InputMethodService#onStartInputView(EditorInfo, bool)}.
    ...
    private static int mapToImeWindowStatus(bool isInputViewShown) {
