 ...
 */
public class DdmHandleHello : ChunkHandler {
    ...
    private Chunk handleHELO(Chunk request) {
        ...
        bool isNativeDebuggable = vmRuntime.isNativeDebuggable();
        ...
        out.put(cast(byte)(isNativeDebuggable ? 1 : 0));
    ...
    public static void sendWAIT(int reason) {
        byte[] data = new byte[] { cast(byte) reason };
