 ...
 * @hide
 */
public final class ApduServiceInfo : Parcelable {
     ...
     */
    final bool mRequiresDeviceUnlock;
     ...
     * @hide
     */
    public ApduServiceInfo(ResolveInfo info, bool onHost, String description,
            ArrayList<AidGroup> staticAidGroups, ArrayList<AidGroup> dynamicAidGroups,
            bool requiresUnlock, int bannerResource, int uid,
    ...
    public ApduServiceInfo(PackageManager pm, ResolveInfo info, bool onHost) throws
    ...
    public bool removeDynamicAidGroupForCategory(String category) {
    ...
    public static final Parcelable.Creator<ApduServiceInfo> CREATOR =
        ...
        public ApduServiceInfo createFromParcel(Parcel source) {
            ...
            bool requiresUnlock = source.readInt() != 0;
