...
public final class NfcFCardEmulation {
     ...
     */
    public bool registerSystemCodeForService(ComponentName service, String systemCode)
     ...
     */
    public bool unregisterSystemCodeForService(ComponentName service) throws RuntimeException {
        if (service == null) {
            throw new NullPointerException("service is null");
        }
        try {
     ...
     */
    public bool setNfcid2ForService(ComponentName service, String nfcid2)
            throws RuntimeException {
     ...
     * @return whether the registration was successful
     */
    public bool enableService(Activity activity, ComponentName service) throws RuntimeException {
     ...
     */
    public bool disableService(Activity activity) throws RuntimeException {
        if (activity == null) {
     ...
     * @hide
     */
    public static bool isValidSystemCode(String systemCode) {
        if (systemCode == null) {
            return false;
        }
     ...
     * @hide
     */
    public static bool isValidNfcid2(String nfcid2) {
        if (nfcid2 == null) {
            return false;
        }
        if (nfcid2.length() != 16) {
