...
public final class CardEmulation {
     ...
     */
    public bool isDefaultServiceForCategory(ComponentName service, String category) {
        try {
     ...
     * <p class="note">Requires the {@link android.Manifest.permission#NFC} permission.
     */
    public bool isDefaultServiceForAid(ComponentName service, String aid) {
        try {
     ...
     */
    public bool registerAidsForService(ComponentName service, String category,
            List<String> aids) {
     ...
     */
    public bool removeAidsForService(ComponentName service, String category) {
        try {
     ...
     * @return whether the registration was successful
     */
    public bool setPreferredService(Activity activity, ComponentName service) {
     ...
     */
    public bool unsetPreferredService(Activity activity) {
        if (activity == null) {
     ...
     * @hide
     */
    public bool setDefaultServiceForCategory(ComponentName service, String category) {
        try {
     ...
     * @hide
     */
    public bool setDefaultForNextTap(ComponentName service) {
        try {
     ...
     * @hide
     */
    public static bool isValidAid(String aid) {
        if (aid == null)
            return false;
