...
public final class NfcAdapter {
    ...
    public interface NfcUnlockHandler {
         ...
         */
        public bool onUnlockAttempted(Tag tag);
    }
     ...
     */
    private static bool hasNfcFeature() {
     ...
     */
    private static bool hasNfcHceFeature() {
        IPackageManager pm = ActivityThread.getPackageManager();
        if (pm == null) {
            Log.e(TAG, "Cannot get package manager, assuming no NFC feature");
            return false;
    ...
    public static synchronized NfcAdapter getNfcAdapter(Context context) {
        if (!sIsInitialized) {
            ...
            bool hasHceFeature = hasNfcHceFeature();
    ...
    */
    ...
    void disableForegroundDispatchInternal(Activity activity, bool force) {
        try {
     ...
     * @throws UnsupportedOperationException if FEATURE_NFC is unavailable.
     */
    public bool invokeBeam(Activity activity) {
        synchronized (NfcAdapter.class) {
            if (!sHasNfcFeature) {
                throw new UnsupportedOperationException();
            }
     ...
     * @hide
     */
    public bool invokeBeam(BeamShareData shareData) {
        try {
     ...
     */
    public bool ignore(final Tag tag, int debounceMs,
    ...
    @SystemApi
    @RequiresPermission(android.Manifest.permission.WRITE_SECURE_SETTINGS)
    public bool addNfcUnlockHandler(final NfcUnlockHandler unlockHandler,
        ...
        try {
            synchronized (mLock) {
                ...
                INfcUnlockHandler.Stub iHandler = new INfcUnlockHandler.Stub() {
                    override
                    public bool onUnlockAttempted(Tag tag) throws RemoteException {
    ...
    @SystemApi
    @RequiresPermission(android.Manifest.permission.WRITE_SECURE_SETTINGS)
    public bool removeNfcUnlockHandler(NfcUnlockHandler unlockHandler) {
        synchronized (NfcAdapter.class) {
            if (!sHasNfcFeature) {
                throw new UnsupportedOperationException();
            }
