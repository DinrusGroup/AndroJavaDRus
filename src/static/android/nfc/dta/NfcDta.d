...
public final class NfcDta {
     ...
     * @return true/false if enabling was successful
     */
    public bool enableServer(String serviceName, int serviceSap, int miu,
     ...
     * @return true/false if enabling was successful
     */
    public bool enableClient(String serviceName, int miu, int rwSize,
            int testCaseId) {
        try {
     ...
     */
    public bool registerMessageService(String msgServiceName) {
        try {
