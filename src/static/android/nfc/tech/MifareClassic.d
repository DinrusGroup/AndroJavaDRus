 ...
 */
public final class MifareClassic : BasicTagTechnology {
    ...
    public static final byte[] KEY_DEFAULT =
            {cast(byte)0xFF,cast(byte)0xFF,cast(byte)0xFF,cast(byte)0xFF,cast(byte)0xFF,cast(byte)0xFF};
    /**
     * The well-known key for tags formatted according to the
     * MIFARE Application Directory (MAD) specification.
     */
    public static final byte[] KEY_MIFARE_APPLICATION_DIRECTORY =
            {cast(byte)0xA0,cast(byte)0xA1,cast(byte)0xA2,cast(byte)0xA3,cast(byte)0xA4,cast(byte)0xA5};
    /**
     * The well-known key for tags formatted according to the
     * NDEF on MIFARE Classic specification.
     */
    public static final byte[] KEY_NFC_FORUM =
            {cast(byte)0xD3,cast(byte)0xF7,cast(byte)0xD3,cast(byte)0xF7,cast(byte)0xD3,cast(byte)0xF7};
     ...
     */
    public bool authenticateSectorWithKeyA(int sectorIndex, byte[] key) throws IOException {
     ...
     * @throws IOException if there is an I/O failure, or the operation is canceled
     */
    public bool authenticateSectorWithKeyB(int sectorIndex, byte[] key) throws IOException {
        return authenticate(sectorIndex, key, false);
    }

    private bool authenticate(int sector, byte[] key, bool keyA) throws IOException {
        ...
        cmd[1] = cast(byte) sectorToBlock(sector);
    ...
    public byte[] readBlock(int blockIndex) throws IOException {
        ...
        byte[] cmd = { 0x30, cast(byte) blockIndex };
    ...
    public void writeBlock(int blockIndex, byte[] data) throws IOException {
        ...
        cmd[0] = cast(byte) 0xA0; // MF write command
        cmd[1] = cast(byte) blockIndex;
    ...
    public void increment(int blockIndex, int value) throws IOException {
        ...
        cmd.put( cast(byte) 0xC1 );
        cmd.put( cast(byte) blockIndex );
        cmd.putInt(value);
    ...
    public void transfer(int blockIndex) throws IOException {
        ...
        byte[] cmd = { cast(byte) 0xB0, cast(byte) blockIndex };
    ...
    public void restore(int blockIndex) throws IOException {
        ...
        byte[] cmd = { cast(byte) 0xC2, cast(byte) blockIndex };
