...
public class Slide : Visibility {
    ...
    private static abstract class CalculateSlideHorizontal : CalculateSlide {
    ...
    private static abstract class CalculateSlideVertical : CalculateSlide {
    ...
    private static final CalculateSlide sCalculateStart = new CalculateSlideHorizontal() {
        override
        public float getGoneX(ViewGroup sceneRoot, View view, float fraction) {
            final bool isRtl = sceneRoot.getLayoutDirection() == View.LAYOUT_DIRECTION_RTL;
            final float x;
            if (isRtl) {
