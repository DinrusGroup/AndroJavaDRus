...
public abstract class Transition : Cloneable {
     ...
     * @hide
     */
    public bool isValidTarget(View target) {
        if (target == null) {
            return false;
        }
     ...
     * @return This transition object.
     */
    public Transition excludeChildren(int targetId, bool exclude) {
        if (targetId >= 0) {
     ...
     * @return This transition object.
     */
    public Transition excludeChildren(View target, bool exclude) {
     ...
     * @return This transition object.
     */
    public Transition excludeChildren(Class type, bool exclude) {
     ...
     */
    public TransitionValues getTransitionValues(View view, bool start) {
        if (mParent != null) {
