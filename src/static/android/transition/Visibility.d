 ...
 */
public abstract class Visibility : Transition {
    ...
    private bool mSuppressLayout = true;
     ...
     * @hide
     */
    public void setSuppressLayout(bool suppress) {
     ...
     * false otherwise.
     */
    public bool isVisible(TransitionValues values) {
        if (values == null) {
            return false;
        }
    ...
    override
    public bool isTransitionRequired(TransitionValues startValues, TransitionValues newValues) {
    ...
    private static class DisappearListener
            : TransitionListenerAdapter : AnimatorListener, AnimatorPauseListener {
        private final View mView;
        private final int mFinalVisibility;
        private final ViewGroup mParent;
        private final bool mSuppressLayout;

        private bool mLayoutSuppressed;
        bool mCanceled = false;

        public DisappearListener(View view, int finalVisibility, bool suppressLayout) {
            this.mView = view;
        ...
        private void suppressLayout(bool suppress) {
