 ...
 * @see ScanFilter
 */
public final class BluetoothLeDeviceFilter : DeviceFilter<ScanResult> {
    ...
    private final bool mRenameBytesReverseOrder;
    ...
    private BluetoothLeDeviceFilter(Pattern namePattern, ScanFilter scanFilter,
            ...
            int renameNameFrom, int renameNameLength, bool renameBytesReverseOrder) {
    ...
    /** @hide */
    public bool isRenameBytesReverseOrder() {
    ...
    public bool matches(ScanResult device) {
        bool result = matches(device.getDevice())
                && (mRawDataFilter == null
    ...
    private bool matches(BluetoothDevice device) {
    ...
    public static final Creator<BluetoothLeDeviceFilter> CREATOR
        ...
        public BluetoothLeDeviceFilter createFromParcel(Parcel in) {
            ...
            bool bytesReverseOrder = in.readBoolean();
     ...
     */
    public static final class Builder : OneTimeUseBuilder<BluetoothLeDeviceFilter> {
        ...
        private bool mRenameBytesReverseOrder = false;
