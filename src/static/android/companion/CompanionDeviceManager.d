...
public final class CompanionDeviceManager {
     ...
     */
    public bool hasNotificationAccess(ComponentName component) {
        if (!checkFeaturePresent()) {
            return false;
        }
        try {
    ...
    private bool checkFeaturePresent() {
        bool featurePresent = mService != null;
    ...
    private class CallbackProxy : IFindDeviceCallback.Stub
