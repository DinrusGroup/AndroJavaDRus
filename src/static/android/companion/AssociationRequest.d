 ...
 */
public final class AssociationRequest : Parcelable {

    private final bool mSingleDevice;
    private final List<DeviceFilter!(T)> mDeviceFilters;

    private AssociationRequest(
            bool singleDevice, @Nullable List<DeviceFilter!(T)> deviceFilters) {
    ...
    /** @hide */
    @NonNull
    public List<DeviceFilter!(T)> getDeviceFilters() {
    ...
    public void writeToParcel(Parcel dest, int flags) {
        dest.writeByte(cast(byte) (mSingleDevice ? 1 : 0));
     ...
     */
    public static final class Builder : OneTimeUseBuilder<AssociationRequest> {
        private bool mSingleDevice = false;
        @Nullable private ArrayList<DeviceFilter!(T)> mDeviceFilters = null;
         ...
         */
        @NonNull
        public Builder setSingleDevice(bool singleDevice) {
            checkNotUsed();
            this.mSingleDevice = singleDevice;
            return this;
        }
         ...
         */
        @NonNull
        public Builder addDeviceFilter(@Nullable DeviceFilter!(T) deviceFilter) {
            checkNotUsed();
