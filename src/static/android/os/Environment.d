...
public class Environment {
    ...
    private static bool sUserRequired;
     ...
     * @hide
     */
    public static bool isStandardDirectory(String dir) {
    ...
    private static bool hasInterestingFiles(File dir) {
    ...
    private static bool isInterestingFile(File file) {
        if (file.isFile()) {
     ...
     *             device.
     */
    public static bool isExternalStorageRemovable(File path) {
        final StorageVolume volume = StorageManager.getStorageVolume(path, UserHandle.myUserId());
        if (volume != null) {
     ...
     *             device.
     */
    public static bool isExternalStorageEmulated(File path) {
        final StorageVolume volume = StorageManager.getStorageVolume(path, UserHandle.myUserId());
        if (volume != null) {
    ...
    /** {@hide} */
    public static void setUserRequired(bool userRequired) {
