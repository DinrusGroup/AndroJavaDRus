 ...
 * @hide
 */
public abstract class ServiceManagerNative : Binder : IServiceManager
{
    /**
        ...
        try {
            switch (code) {
                ...
                case IServiceManager.ADD_SERVICE_TRANSACTION: {
                    ...
                    bool allowIsolated = data.readInt() != 0;
...
class ServiceManagerProxy : IServiceManager {
    ...
    public void addService(String name, IBinder service, bool allowIsolated, int dumpPriority)
    ...
    public String[] listServices(int dumpPriority) throws RemoteException {
        ...
        while (true) {
            ...
            n++;
            try {
                bool res = mRemote.transact(LIST_SERVICES_TRANSACTION, data, reply, 0);
                if (!res) {
                    break;
                }
