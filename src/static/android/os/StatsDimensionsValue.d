 ...
 * {@link String}, int, long, bool, float,
 ...
 */
@SystemApi
public final class StatsDimensionsValue : Parcelable {
    ...
    /** Indicates that this holds a bool. */
    ...
    /**
     * Retrieve the bool held, if any.
     *
     * @return the bool held if {@link #getValueType()} == {@link #BOOLEAN_VALUE_TYPE},
     *         false otherwise
     */
     ...
     */
    public bool isValueType(int valueType) {
    ...
    private static bool writeValueToParcel(int valueType, Object value, Parcel out, int flags) {
        try {
            switch (valueType) {
