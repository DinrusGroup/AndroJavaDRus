...
public class BaseBundle {
    ...
    private static final bool LOG_DEFUSABLE = false;

    private static volatile bool sShouldDefuse = false;
     ...
     * @hide
     */
    public static void setShouldDefuse(bool shouldDefuse) {
     ...
     */
    private bool mParcelledByNative;
    ...
    private void initializeFromParcelLocked(@NonNull Parcel parcelledData, bool recycleParcel,
            bool parcelledByNative) {
     ...
     * @hide
     */
    private static bool isEmptyParcel(Parcel p) {
     ...
     * @hide
     */
    public static bool kindofEquals(BaseBundle a, BaseBundle b) {
     ...
     */
    public bool kindofEquals(BaseBundle other) {
        if (other == null) {
            return false;
        }
    ...
    void copyInternal(BaseBundle from, bool deep) {
        synchronized (from) {
     ...
     * @param value a bool
     */
    public void putBoolean(@Nullable String key, bool value) {
        unparcel();
        mMap.put(key, value);
    }
    ...
    /**
     * Inserts a bool array value into the mapping of this Bundle, replacing
     * any existing value for the given key.  Either key or value may be null.
     *
     * @param key a String, or null
     * @param value a bool array object, or null
     */
    public void putBooleanArray(@Nullable String key, @Nullable bool[] value) {
        unparcel();
        mMap.put(key, value);
    }
    ...
    public bool getBoolean(String key) {
        unparcel();
        if (DEBUG) Log.d(TAG, "Getting bool in "
                + Integer.toHexString(System.identityHashCode(this)));
    ...
    byte getByte(String key) {
        unparcel();
        return getByte(key, cast(byte) 0);
    }
    ...
    short getShort(String key) {
        unparcel();
        return getShort(key, cast(short) 0);
    }
   ...
   public int getInt(String key, int defaultValue) {
     ...
     *
     * @param key a String, or null
     * @return a bool[] value, or null
     */
    @Nullable
    public bool[] getBooleanArray(@Nullable String key) {
        unparcel();
        Object o = mMap.get(key);
        if (o == null) {
            return null;
    ...
    private void readFromParcelInner(Parcel parcel, int length) {
        ...
        final bool isJavaBundle = magic == BUNDLE_MAGIC;
        final bool isNativeBundle = magic == BUNDLE_MAGIC_NATIVE;
