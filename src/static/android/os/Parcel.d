 ...
 *
 * <ul>
 * <li> {@link #writeBooleanArray(bool[])},
 * {@link #readBooleanArray(bool[])}, {@link #createBooleanArray()}
...
public final class Parcel {
    ...
    private static final bool DEBUG_RECYCLE = false;
    private static final bool DEBUG_ARRAY_MAP = false;
     ...
     */
    private bool mOwnsNativeParcelObject;
     ...
     */
    private static bool sParcelExceptionStackTrace;
    ...
    @CriticalNative
    private static native bool nativePushAllowFds(long nativePtr, bool allowFds);
    @CriticalNative
    private static native void nativeRestoreAllowFds(long nativePtr, bool lastValue);
    ...
    private static native bool nativeReadByteArray(long nativePtr, byte[] dest, int destLen);
    ...
    @CriticalNative
    private static native bool nativeHasFileDescriptors(long nativePtr);
     ...
     * @hide
     */
    public bool hasReadWriteHelper() {
    ...
    /** @hide */
    public final bool pushAllowFds(bool allowFds) {
        return nativePushAllowFds(mNativePtr, allowFds);
    }

    /** @hide */
    public final void restoreAllowFds(bool lastValue) {
     ...
     */
    public final bool hasFileDescriptors() {
    ...
    /** @hide */
    public final void writeBoolean(bool val) {
        writeInt(val ? 1 : 0);
    }
     ...
     * @hide
     */
    public void writeArraySet(@Nullable ArraySet<? : Object> val) {
    ...
    public final void writeSparseBooleanArray(SparseBooleanArray val) {
        ...
        while (i < N) {
            writeInt(val.keyAt(i));
            writeByte(cast(byte)(val.valueAt(i) ? 1 : 0));
            i++;
        }
    }
    ...
    public final void writeBooleanArray(bool[] val) {
        if (val != null) {
            int N = val.length;
            writeInt(N);
            for (int i=0; i<N; i++) {
    ...
    public final bool[] createBooleanArray() {
        int N = readInt();
        // >>2 as a fast divide-by-4 works in the create*Array() functions
        // because dataAvail() will never return a negative number.  4 is
        // the size of a stored bool in the stream.
    ...
    public final void readBooleanArray(bool[] val) {
        int N = readInt();
        if (N == val.length) {
            for (int i=0; i<N; i++) {
                val[i] = readInt() != 0;
     ...
     * type of the objects in the list must be one that : Parcelable.
     ...
     * @see Parcelable
     */
    public final <T : Parcelable> void writeTypedList(List<T> val) {
     ...
     * @hide
     */
    public <T : Parcelable> void writeTypedList(List<T> val, int parcelableFlags) {
        if (val == null) {
            writeInt(-1);
            return;
        }
     ...
     * @hide
     */
    public final <T : Parcelable> void writeParcelableList(List<T> val, int flags) {
        if (val == null) {
            writeInt(-1);
            return;
        }
     ...
     * the parcel, at
     * the current dataPosition() and growing dataCapacity() if needed.  The
     * type of the objects in the array must be one that : Parcelable.
     ...
     */
    public final <T : Parcelable> void writeTypedArray(T[] val,
            int parcelableFlags) {
        if (val != null) {
            int N = val.length;
            writeInt(N);
     ...
     * @see #readTypedObject
     */
    public final <T : Parcelable> void writeTypedObject(T val, int parcelableFlags) {
        if (val != null) {
            writeInt(1);
    ...
    public static void setStackTraceParceling(bool enabled) {
    ...
    public final void readByteArray(byte[] val) {
        bool valid = nativeReadByteArray(mNativePtr, val, (val != null) ? val.length : 0);
        if (!valid) {
            throw new RuntimeException("bad array lengths");
        }
    }
     ...
     * @hide
     */
    public final <T : Parcelable> List<T> readParcelableList(List<T> list, ClassLoader cl) {
        final int N = readInt();
        if (N == -1) {
            list.clear();
            return list;
     ...
     * @see #writeTypedArray
     */
    public final <T : Parcelable> void writeParcelableArray(T[] value,
            int parcelableFlags) {
        if (value != null) {
            int N = value.length;
            writeInt(N);
    ...
    public final <T : Parcelable> T readParcelable(ClassLoader loader) {
        Parcelable.Creator!(T) creator = readParcelableCreator(loader);
        if (creator == null) {
            return null;
        }
        if (creator instanceof Parcelable.ClassLoaderCreator!(T)) {
          Parcelable.ClassLoaderCreator!(T) classLoaderCreator =
              (Parcelable.ClassLoaderCreator!(T)) creator;
    ...
    /** @hide */
    @SuppressWarnings("unchecked")
    public final <T : Parcelable> T readCreator(Parcelable.Creator!(T) creator,
            ClassLoader loader) {
        if (creator instanceof Parcelable.ClassLoaderCreator!(T)) {
          Parcelable.ClassLoaderCreator!(T) classLoaderCreator =
              (Parcelable.ClassLoaderCreator!(T)) creator;
    ...
    /** @hide */
    public final Parcelable.Creator!(T) readParcelableCreator(ClassLoader loader) {
        ...
        synchronized (mCreators) {
            HashMap<String,Parcelable.Creator!(T)> map = mCreators.get(loader);
            if (map == null) {
                map = new HashMap<>();
            ...
            if (creator == null) {
                try {
                    ...
                    // Avoid initializing the Parcelable class until we know it :
                    // Parcelable and has the necessary CREATOR field. http://b/1171613.
                    Class!(T) parcelableClass = Class.forName(name, false /* initialize */,
    ...
    /** @hide */
    public final <T : Parcelable> T[] readParcelableArray(ClassLoader loader,
            Class<T> clazz) {
        int N = readInt();
        if (N < 0) {
            return null;
    ...
    private final Serializable readSerializable(final ClassLoader loader) {
        ...
        try {
            ObjectInputStream ois = new ObjectInputStream(bais) {
                override
                protected Class!(T) resolveClass(ObjectStreamClass osClass)
                        throws IOException, ClassNotFoundException {
                    // try the custom classloader if provided
                    if (loader != null) {
                        Class!(T) c = Class.forName(osClass.getName(), false, loader);
                        if (c != null) {
                            return c;
                        }
                    }
    ...
    // Method objects.
    private static final HashMap<ClassLoader,HashMap<String,Parcelable.Creator!(T)>>
     ...
     * @hide
     */
    public @Nullable ArraySet<? : Object> readArraySet(ClassLoader loader) {
