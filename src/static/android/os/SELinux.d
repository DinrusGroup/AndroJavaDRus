...
public class SELinux {
     ...
     * @return a bool indicating whether SELinux is enabled.
     */
    public static final native bool isSELinuxEnabled();

    /**
     * Determine whether SELinux is permissive or enforcing.
     * @return a bool indicating whether SELinux is enforcing.
     */
    public static final native bool isSELinuxEnforced();

    /**
     * Sets the security context for newly created file objects.
     * @param context a security context given as a String.
     * @return a bool indicating whether the operation succeeded.
     */
    public static final native bool setFSCreateContext(String context);
     ...
     * @return a bool indicating whether the operation succeeded.
     */
    public static final native bool setFileContext(String path, String context);
     ...
     * @return a bool indicating whether permission was granted.
     */
    public static final native bool checkSELinuxAccess(String scon, String tcon, String tclass, String perm);
     ...
     * @return a bool indicating whether the relabeling succeeded.
     * @exception NullPointerException if the pathname is a null object.
     */
    public static bool restorecon(String pathname) throws NullPointerException {
     ...
     * @return a bool indicating whether the relabeling succeeded.
     */
    private static native bool native_restorecon(String pathname, int flags);
     ...
     */
    public static bool restorecon(File file) throws NullPointerException {
        try {
     ...
     * @return a bool indicating whether the relabeling succeeded.
     */
    public static bool restoreconRecursive(File file) {
        try {
