 ...
 */
public final class UserHandle : Parcelable {
     ...
     */
    public static final bool MU_ENABLED = true;
     ...
     * @hide
     */
    public static bool isSameApp(int uid1, int uid2) {
     ...
     * @hide
     */
    public static bool isIsolated(int uid) {
        if (uid > 0) {
     ...
     * @hide
     */
    public static bool isApp(int uid) {
        if (uid > 0) {
            final int appId = getAppId(uid);
     ...
     * @hide
     */
    public static bool isCore(int uid) {
        if (uid >= 0) {
            final int appId = getAppId(uid);
