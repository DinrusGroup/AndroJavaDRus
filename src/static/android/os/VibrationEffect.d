 ...
 */
public abstract class VibrationEffect : Parcelable {
     ...
     * @hide
     */
    public static VibrationEffect get(int effectId, bool fallback) {
    ...
    /** @hide */
    public static class OneShot : VibrationEffect : Parcelable {
    ...
    /** @hide */
    public static class Waveform : VibrationEffect : Parcelable {
        ...
        private static bool hasNonZeroEntry(long[] vals) {
            for (long val : vals) {
                if (val != 0) {
                    return true;
                }
    ...
    /** @hide */
    public static class Prebaked : VibrationEffect : Parcelable {
        private final int mEffectId;
        private final bool mFallback;
        ...
        public Prebaked(int effectId, bool fallback) {
            mEffectId = effectId;
            mFallback = fallback;
        ...
        private static bool isValidEffectStrength(int strength) {
            switch (strength) {
        ...
        public void writeToParcel(Parcel out, int flags) {
            ...
            out.writeByte(cast(byte) (mFallback ? 1 : 0));
