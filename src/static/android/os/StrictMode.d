...
public final class StrictMode {
    ...
    private static final bool LOG_V = Log.isLoggable(TAG, Log.VERBOSE);
    ...
    /**
     * The bool system property to control screen flashes on violations.
     *
     * @hide
     */
     ...
     */
    private static final bool DISABLE = false;
    ...
    public static final class VmPolicy {
        ...
        public static final class Builder {
            ...
            private bool mClassInstanceLimitNeedCow = false; // need copy-on-write
     ...
     * @hide
     */
    public static bool isBundledSystemApp(ApplicationInfo ai) {
    ...
    private static class AndroidBlockGuardPolicy : BlockGuard.Policy {
        ...
        void onThreadPolicyViolation(final ViolationInfo info) {
            ...
            if (violationMaskSubset != 0) {
                ...
                final bool justDropBox = (info.mPolicy & THREAD_PENALTY_MASK) == PENALTY_DROPBOX;
                if (justDropBox) {
    ...
    private static class AndroidCloseGuardReporter : CloseGuard.Reporter {
    ...
    /* package */ static bool hasGatheredViolations() {
    ...
    private static bool sIsIdlerRegistered = false; // guarded by StrictMode.class
    ...
    /** @hide */
    public static bool vmRegistrationLeaksEnabled() {
        return (sVmPolicy.mask & DETECT_VM_REGISTRATION_LEAKS) != 0;
    }

    /** @hide */
    public static bool vmFileUriExposureEnabled() {
        return (sVmPolicy.mask & DETECT_VM_FILE_URI_EXPOSURE) != 0;
    }

    /** @hide */
    public static bool vmCleartextNetworkEnabled() {
        return (sVmPolicy.mask & DETECT_VM_CLEARTEXT_NETWORK) != 0;
    }

    /** @hide */
    public static bool vmContentUriWithoutPermissionEnabled() {
        return (sVmPolicy.mask & DETECT_VM_CONTENT_URI_WITHOUT_PERMISSION) != 0;
    }

    /** @hide */
    public static bool vmUntaggedSocketEnabled() {
    ...
    public static void onCleartextNetworkDetected(byte[] firstPacket) {
        ...
        final bool forceDeath = (sVmPolicy.mask & PENALTY_DEATH_ON_CLEARTEXT_NETWORK) != 0;
    ...
    /** @hide */
    public static void onVmPolicyViolation(Violation violation, bool forceDeath) {
        final bool penaltyDropbox = (sVmPolicy.mask & PENALTY_DROPBOX) != 0;
        final bool penaltyDeath = ((sVmPolicy.mask & PENALTY_DEATH) != 0) || forceDeath;
        final bool penaltyLog = (sVmPolicy.mask & PENALTY_LOG) != 0;
    ...
    /* package */ static void readAndHandleBinderCallViolations(Parcel p) {
        ...
        final bool currentlyGathering = (policyMask & PENALTY_GATHER) != 0;
     ...
     */
    @TestApi
    public static final class ViolationInfo : Parcelable {
         ...
         *     should be removed.
         */
        public ViolationInfo(Parcel in, bool unsetGatheringBit) {
    ...
    private static final class InstanceTracker {
        private static final HashMap<Class!(T), Integer> sInstanceCounts =
                new HashMap<Class!(T), Integer>();
        ...
        public static int getInstanceCount(Class!(T) klass) {
            synchronized (sInstanceCounts) {
