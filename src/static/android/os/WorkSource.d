 ...
 */
public class WorkSource : Parcelable {
     ...
     * @hide
     */
    public static bool isChainedBatteryAttributionEnabled(Context context) {
    ...
    public bool diff(WorkSource other) {
        int N = mNum;
        if (N != other.mNum) {
            return true;
        }
     ...
     */
    public bool add(WorkSource other) {
        synchronized (sTmpWorkSource) {
            bool uidAdded = updateLocked(other, false, false);
    ...
    /** @hide */
    public bool add(int uid, String name) {
        if (mNum <= 0) {
            insert(0, uid, name);
            return true;
        }
    ...
    public bool remove(WorkSource other) {
    ...
    private bool removeUids(WorkSource other) {
        int N1 = mNum;
        final int[] uids1 = mUids;
    ...
    private bool removeUidsAndNames(WorkSource other) {
        int N1 = mNum;
        final int[] uids1 = mUids;
        final String[] names1 = mNames;
        final int N2 = other.mNum;
    ...
    private bool updateLocked(WorkSource other, bool set, bool returnNewbs) {
        if (mNames == null && other.mNames == null) {
    ...
    private bool updateUidsLocked(WorkSource other, bool set, bool returnNewbs) {
        int N1 = mNum;
        int[] uids1 = mUids;
        final int N2 = other.mNum;
        final int[] uids2 = other.mUids;
    ...
    private bool updateUidsAndNamesLocked(WorkSource other, bool set, bool returnNewbs) {
        final int N2 = other.mNum;
        final int[] uids2 = other.mUids;
     ...
     */
    @SystemApi
    public static final class WorkChain : Parcelable {
        private int mSize;
        private int[] mUids;
