...
public class Build {
     ...
     * @hide
     */
    public static final bool IS_EMULATOR = getString("ro.kernel.qemu").equals("1");
    ...
    public static class VERSION_CODES {
         ...
         * <li> {@link android.webkit.WebSettings#setAllowFileAccessFromFileURLs(bool)
         * WebSettings.setAllowFileAccessFromFileURLs} and
         * {@link android.webkit.WebSettings#setAllowUniversalAccessFromFileURLs(bool)
     ...
     * @hide
     */
    public static final bool IS_TREBLE_ENABLED =
     ...
     * @hide
     */
    public static bool isBuildConsistent() {
     ...
     * @hide
     */
    public static final bool IS_DEBUGGABLE =
            SystemProperties.getInt("ro.debuggable", 0) == 1;

    /** {@hide} */
    public static final bool IS_ENG = "eng".equals(TYPE);
    /** {@hide} */
    public static final bool IS_USERDEBUG = "userdebug".equals(TYPE);
    /** {@hide} */
    public static final bool IS_USER = "user".equals(TYPE);
     ...
     * @hide
     */
    public static final bool IS_CONTAINER =
     ...
     */
    @SystemApi
    public static final bool PERMISSIONS_REVIEW_REQUIRED =
