...
public class HidlSupport {
     ...
     */
    @SystemApi
    public static bool deepEquals(Object lft, Object rgt) {
        if (lft == rgt) {
            return true;
        }
        ...
        Class!(T) lftClazz = lft.getClass();
        Class!(T) rgtClazz = rgt.getClass();
        if (lftClazz != rgtClazz) {
            return false;
        }

        if (lftClazz.isArray()) {
            Class!(T) lftElementType = lftClazz.getComponentType();
    ...
    public static int deepHashCode(Object o) {
        ...
        if (clazz.isArray()) {
            Class!(T) elementType = clazz.getComponentType();
    ...
    private static void throwErrorIfUnsupportedType(Object o) {
        if (o instanceof Collection!(T) && !(o instanceof List!(T))) {
    ...
    private static int primitiveArrayHashCode(Object o) {
        Class!(T) elementType = o.getClass().getComponentType();
        if (elementType == bool.class) {
            return Arrays.hashCode(((bool[])o));
        }
     ...
     */
    @SystemApi
    public static bool interfacesEqual(IHwInterface lft, Object rgt) {
        if (lft == rgt) {
            return true;
        }
        if (lft == null || rgt == null) {
