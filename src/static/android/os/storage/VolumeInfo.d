 ...
 * @hide
 */
public class VolumeInfo : Parcelable {
    ...
    public bool isMountedReadable() {
        return state == STATE_MOUNTED || state == STATE_MOUNTED_READ_ONLY;
    }

    public bool isMountedWritable() {
    ...
    public bool isVisibleForUser(int userId) {
    ...
    public bool isVisibleForRead(int userId) {
        return isVisibleForUser(userId);
    }

    public bool isVisibleForWrite(int userId) {
        return isVisibleForUser(userId);
    }
    ...
    public StorageVolume buildStorageVolume(Context context, int userId, bool reportUnmounted) {
