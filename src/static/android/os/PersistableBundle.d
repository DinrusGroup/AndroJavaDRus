 ...
 * @see Bundle
 */
public final class PersistableBundle : BaseBundle : Cloneable, Parcelable,
    ...
    public static bool isValidType(Object value) {
        return (value instanceof Integer) || (value instanceof Long) ||
                ...
                (value instanceof Boolean) || (value instanceof bool[]);
    }
    ...
    /** @hide */
    static class MyReadMapCallback :  XmlUtils.ReadMapCallback {
        override
    ...
    public void writeToParcel(Parcel parcel, int flags) {
        final bool oldAllowFds = parcel.pushAllowFds(false);
        try {
