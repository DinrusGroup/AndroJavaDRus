 ...
 * @hide
 */
public final class ParcelableException : RuntimeException : Parcelable {
    public ParcelableException(Throwable t) {
        super(t);
    }

    @SuppressWarnings("unchecked")
    public <T : Throwable> void maybeRethrow(Class<T> clazz) throws T {
    ...
    public static Throwable readFromParcel(Parcel in) {
        ...
        try {
            final Class!(T) clazz = Class.forName(name, true, Parcelable.class.getClassLoader());
