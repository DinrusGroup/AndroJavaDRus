...
public class Process {
     ...
     */
    public static final bool is64Bit() {
     ...
     * @hide
     */
    public static bool isCoreUid(int uid) {
     ...
     */
    public static final bool isIsolated() {
        return isIsolated(myUid());
    }

    /** {@hide} */
    public static final bool isIsolated(int uid) {
     ...
     * @hide
     */
    public static final native void setCanSelfBackground(bool backgroundOk);
     ...
     */
    @Deprecated
    public static final bool supportsProcesses() {
        return true;
    }
     ...
     * {@hide}
     */
    public static final native bool setSwappiness(int pid, bool is_increased);
    ...
    /** @hide */
    public static final native bool readProcFile(String file, int[] format,
            String[] outStrings, long[] outLongs, float[] outFloats);
    
    /** @hide */
    public static final native bool parseProcLine(byte[] buffer, int startIndex, 
     ...
     * @hide
     */
    public static final bool isThreadInProcess(int tid, int pid) {
