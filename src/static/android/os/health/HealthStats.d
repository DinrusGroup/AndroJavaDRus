...
public class HealthStats {
     ...
     */
    public bool hasMeasurement(int key) {
     ...
     */
    public bool hasMeasurements(int key) {
    ...
    /**
     * Create an ArrayMap<String,T : Parcelable> from the given Parcel using
     * the given Parcelable.Creator.
     */
    private static <T : Parcelable> ArrayMap<String,T> createParcelableMap(Parcel in,
