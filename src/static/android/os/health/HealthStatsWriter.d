...
public class HealthStatsWriter {
    ...
    // TimerStat fields
    private final bool[] mTimerFields;
    private final int[] mTimerCounts;
    private final long[] mTimerTimes;

    // Measurement fields
    private final bool[] mMeasurementFields;
    ...
    public HealthStatsWriter(HealthKeys.Constants constants) {
        ...
        mTimerFields = new bool[timerCount];
        ...
        mMeasurementFields = new bool[measurementCount];
     ...
     */
    private static int countBooleanArray(bool[] fields) {
        int count = 0;
     ...
     * Count how many of the fields have been set.
     */
    private static <T : Object> int countObjectArray(T[] fields) {
        int count = 0;
        final int N = fields.length;
        for (int i=0; i<N; i++) {
            if (fields[i] != null) {
     ...
     */
    private static <T : Parcelable> void writeParcelableMap(Parcel out,
