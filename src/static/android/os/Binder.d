...
public class Binder : IBinder {
    ...
    /** @hide */
    public static final bool CHECK_PARCEL_SIZE = false;
    static final String TAG = "Binder";

    /** @hide */
    public static bool LOG_RUNTIME_EXCEPTION = false; // DO NOT SUBMIT WITH TRUE
     ...
     */
    private static volatile bool sTracingEnabled = false;
    ...
    /** {@hide} */
    static volatile bool sWarnOnBlocking = false;
     ...
     * @hide
     */
    public static final bool isProxy(IInterface iface) {
    ...
    public Binder() {
        ...
        if (FIND_POTENTIAL_LEAKS) {
            final Class<? : Binder> klass = getClass();
     ...
     */
    protected bool onTransact(int code, @NonNull Parcel data, @Nullable Parcel reply,
     ...
     */
    public final bool transact(int code, @NonNull Parcel data, @Nullable Parcel reply,
            int flags) throws RemoteException {
        ...
        bool r = onTransact(code, data, reply, flags);
        if (reply != null) {
     ...
     * Local implementation is a no-op.
     */
    public bool unlinkToDeath(@NonNull DeathRecipient recipient, int flags) {
        return true;
    }
    ...
    private bool execTransact(int code, long dataObj, long replyObj,
            int flags) {
        ...
        final bool tracingEnabled = Binder.isTracingEnabled();
        try {
            if (tracingEnabled) {
 ...
 */
final class BinderProxy : IBinder {
    // See android_util_Binder.cpp for the native half of this.

    // Assume the process-wide default value when created
    volatile bool mWarnOnBlocking = Binder.sWarnOnBlocking;
    ...
    public native bool pingBinder();
    public native bool isBinderAlive();

    public IInterface queryLocalInterface(String descriptor) {
        return null;
    }

    public bool transact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
    ...
    public native bool transactNative(int code, Parcel data, Parcel reply,
            int flags) throws RemoteException;
    public native void linkToDeath(DeathRecipient recipient, int flags)
            throws RemoteException;
    public native bool unlinkToDeath(DeathRecipient recipient, int flags);
