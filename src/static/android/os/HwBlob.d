...
public class HwBlob {
    ...
    /**
     * @param offset offset to unmarshall a bool from
     * @return the unmarshalled bool value
     * @throws IndexOutOfBoundsException when offset is out of this HwBlob
     */
    public native final bool getBool(long offset);
    /**
     ...
     * @throws IndexOutOfBoundsException [offset, offset + size * sizeof(jbool)] out of the blob.
     */
    public native final void copyToBoolArray(long offset, bool[] array, int size);
    /**
     * Copy the blobs data starting from the given byte offset into the range, copying
     * a total of size elements.
     *
    ...
    /**
     * Writes a bool value at an offset.
     *
     * @param offset location to write value
     * @param x value to write
     * @throws IndexOutOfBoundsException when [offset, offset + sizeof(jbool)] is out of range
     */
    public native final void putBool(long offset, bool x);
    /**
    ...
    /**
     * Put a bool array contiguously at an offset in the blob.
     *
     * @param offset location to write values
     * @param x array to write
     * @throws IndexOutOfBoundsException [offset, offset + size * sizeof(jbool)] out of the blob.
     */
    public native final void putBoolArray(long offset, bool[] x);
    /**
    ...
    /**
     * Convert a primitive to a wrapped array for bool.
     *
     * @param array from array
     * @return transformed array
     */
    public static Boolean[] wrapArray(@NonNull bool[] array) {
