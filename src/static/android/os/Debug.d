...
public final class Debug
{
    ...
    private static volatile bool mWaiting = false;
    ...
    public static void startMethodTracing(String traceName, FileDescriptor fd,
        int bufferSize, int flags, bool streamOutput) {
    ...
    public static void startMethodTracingDdms(int bufferSize, int flags,
        bool samplingEnabled, int intervalUs) {
     ...
     * @hide
     */
    public static final bool cacheRegisterMap(String classAndMethodDesc) {
     ...
     * the field is of the primitive "bool" type.  Also handles all of
     * the java.lang.Number subclasses.
     */
    private static bool fieldTypeMatches(Field field, Class!(T) cl) {
        Class!(T) fieldClass = field.getType();
        if (fieldClass == cl) {
            return true;
        }
        ...
        try {
            return fieldClass == (Class!(T)) primitiveTypeField.get(null);
     ...
     *
     * @see #setFieldsOn(Class, bool)
     *
     * @hide
     */
    public static void setFieldsOn(Class!(T) cl) {
     ...
     */
    public static void setFieldsOn(Class!(T) cl, bool partial) {
        if (false) {
     ...
     * {@link Debug#setFieldsOn(Class, bool)}.
     *
     * @hide
     */
     ...
     */
    public static bool dumpService(String name, FileDescriptor fd, String[] args) {
     ...
     * @hide
     */
    public static native bool dumpJavaBacktraceToFileTimeout(int pid, String file,
                                                                int timeoutSecs);
     ...
     * @hide
     */
    public static native bool dumpNativeBacktraceToFileTimeout(int pid, String file,
                                                                  int timeoutSecs);
     ...
     * @hide */
    public static native String getUnreachableMemory(int limit, bool contents);
