...
public class HwParcel {
    ...
    private HwParcel(bool allocate) {
    ...
    /**
     * Writes a bool value to the end of the parcel.
     * @param val to write
     */
    public native final void writeBool(bool val);
    /**
    ...
    /**
     * Writes an array of bool values to the end of the parcel.
     * @param val to write
     */
    private native final void writeBoolVector(bool[] val);
    /**
    ...
    /**
     * Reads a bool value from the current location in the parcel.
     * @return value parsed from the parcel
     * @throws IllegalArgumentException if the parcel has no more data
     */
    public native final bool readBool();
    /**
    ...
    /**
     * Reads an array of bool values from the parcel.
     * @return array of parsed values
     * @throws IllegalArgumentException if the parcel has no more data
     */
    private native final bool[] readBoolVectorAsArray();
    /**
    ...
    private native final void native_setup(bool allocate);
