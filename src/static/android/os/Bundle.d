 ...
 */
public final class Bundle : BaseBundle : Cloneable, Parcelable {
    @VisibleForTesting
    ...
    public bool setAllowFds(bool allowFds) {
        final bool orig = (mFlags & FLAG_ALLOW_FDS) != 0;
        if (allowFds) {
            mFlags |= FLAG_ALLOW_FDS;
        } else {
            mFlags &= ~FLAG_ALLOW_FDS;
    ...
    /** {@hide} */
    public static Bundle setDefusable(Bundle bundle, bool defusable) {
        if (bundle != null) {
    ...
    public bool hasFileDescriptors() {
        if ((mFlags & FLAG_HAS_FDS_KNOWN) == 0) {
            bool fdFound = false;    // keep going until we find one or run out of data
    ...
    public void putParcelableArrayList(@Nullable String key,
            @Nullable ArrayList<? : Parcelable> value) {
        unparcel();
        mMap.put(key, value);
        mFlags &= ~FLAG_HAS_FDS_KNOWN;
    }
    ...
    public void putSparseParcelableArray(@Nullable String key,
            @Nullable SparseArray<? : Parcelable> value) {
        unparcel();
        mMap.put(key, value);
        mFlags &= ~FLAG_HAS_FDS_KNOWN;
    }
    ...
    /**
     * Returns the value associated with the given key, or cast(byte) 0 if
    ...
    /**
     * Returns the value associated with the given key, or cast(short) 0 if
     * no mapping of the desired type exists for the given key.
     *
     * @param key a String
     ...
     */
    @Nullable
    public <T : Parcelable> T getParcelable(@Nullable String key) {
        unparcel();
        Object o = mMap.get(key);
        if (o == null) {
            return null;
     ...
     */
    @Nullable
    public <T : Parcelable> ArrayList<T> getParcelableArrayList(@Nullable String key) {
        unparcel();
        Object o = mMap.get(key);
        if (o == null) {
            return null;
     ...
     */
    @Nullable
    public <T : Parcelable> SparseArray<T> getSparseParcelableArray(@Nullable String key) {
        unparcel();
        Object o = mMap.get(key);
        if (o == null) {
            return null;
    ...
    public void writeToParcel(Parcel parcel, int flags) {
        final bool oldAllowFds = parcel.pushAllowFds((mFlags & FLAG_ALLOW_FDS) != 0);
        try {
