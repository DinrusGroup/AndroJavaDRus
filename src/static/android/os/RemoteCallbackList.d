 ...
 * : the {@link #onCallbackDied} method.
 */
public class RemoteCallbackList<E : IInterface> {
    ...
    private final class Callback : IBinder.DeathRecipient {
        final E mCallback;
     ...
     */
    public bool register(E callback) {
     ...
     * @see #onCallbackDied
     */
    public bool register(E callback, Object cookie) {
        synchronized (mCallbacks) {
            if (mKilled) {
                return false;
            }
     ...
     * @see #register
     */
    public bool unregister(E callback) {
        synchronized (mCallbacks) {
