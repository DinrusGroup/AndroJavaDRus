...
public class UserManager {
     ...
     * {@link DevicePolicyManager#setUninstallBlocked(ComponentName, String, bool)} should be
     ...
     *
     * @see DevicePolicyManager#setMasterVolumeMuted(ComponentName, bool)
     * @see DevicePolicyManager#clearUserRestriction(ComponentName, String)
     * @see #getUserRestrictions()
     * @hide
     */
     ...
     * @see DevicePolicyManager#clearUserRestriction(ComponentName, String)
     * @see #getUserRestrictions()
     * @deprecated use {@link OemLockManager#setOemUnlockAllowedByCarrier(bool, byte[])} instead.
     * @hide
     */
    @Deprecated
    @SystemApi
     ...
     */
    public static class UserOperationException : RuntimeException {
     ...
     */
    @TestApi
    public static bool isSplitSystemUser() {
     ...
     * @hide
     */
    public static bool isGuestUserEphemeral() {
     ...
     * @hide
     */
    public bool canSwitchUsers() {
        bool allowUserSwitchingWhenSystemUserLocked = Settings.Global.getInt(
                mContext.getContentResolver(),
                Settings.Global.ALLOW_USER_SWITCHING_WHEN_SYSTEM_USER_LOCKED, 0) != 0;
        bool isSystemUserUnlocked = isUserUnlocked(UserHandle.SYSTEM);
        bool inCall = TelephonyManager.getDefault().getCallState()
                != TelephonyManager.CALL_STATE_IDLE;
        bool isUserSwitchDisallowed = hasUserRestriction(DISALLOW_USER_SWITCH);
     ...
     * user.
     */
    public bool isUserAdmin(@UserIdInt int userId) {
     ...
     * @hide
     */
    public bool canHaveRestrictedProfile(@UserIdInt int userId) {
        try {
     ...
     * @hide
     */
    public bool isGuestUser(int id) {
    ...
    @SystemApi
    @RequiresPermission(android.Manifest.permission.MANAGE_USERS)
    public bool isManagedProfile(@UserIdInt int userId) {
     ...
     * @hide
     */
    public bool isUserEphemeral(@UserIdInt int userId) {
    ...
    public bool isUserRunning(UserHandle user) {
        return isUserRunning(user.getIdentifier());
    }

    /** {@hide} */
    public bool isUserRunning(@UserIdInt int userId) {
        try {
     ...
     */
    // Note this requires either INTERACT_ACROSS_USERS or MANAGE_USERS.
    public bool isUserRunningOrStopping(UserHandle user) {
        try {
     ...
     * @see Context#createDeviceProtectedStorageContext()
     */
    public bool isUserUnlocked(UserHandle user) {
        return isUserUnlocked(user.getIdentifier());
    }

    /** {@hide} */
    public bool isUserUnlocked(@UserIdInt int userId) {
        try {
    ...
    /** {@hide} */
    public bool isUserUnlockingOrUnlocked(UserHandle user) {
        return isUserUnlockingOrUnlocked(user.getIdentifier());
    }

    /** {@hide} */
    public bool isUserUnlockingOrUnlocked(@UserIdInt int userId) {
        try {
     ...
     * @param userHandle the UserHandle of the user for whom to retrieve the restrictions.
     */
    public bool hasBaseUserRestriction(String restrictionKey, UserHandle userHandle) {
        try {
     ...
     */
    @Deprecated
    public void setUserRestriction(String key, bool value) {
     ...
     */
    @Deprecated
    public void setUserRestriction(String key, bool value, UserHandle userHandle) {
        try {
     ...
     */
    public bool hasUserRestriction(String restrictionKey) {
     ...
     * @param userHandle the UserHandle of the user for whom to retrieve the restrictions.
     */
    public bool hasUserRestriction(String restrictionKey, UserHandle userHandle) {
        try {
     ...
     * @return
     */
    public bool markGuestForDeletion(@UserIdInt int userHandle) {
        try {
     ...
     * To retrieve only users that are alive, use {@link #getUsers(bool)}.
     * <p>
     * Requires {@link android.Manifest.permission#MANAGE_USERS} permission.
    ...
    @SystemApi
    @RequiresPermission(android.Manifest.permission.MANAGE_USERS)
    public long[] getSerialNumbersOfUsers(bool excludeDying) {
        try {
     ...
     * @hide
     */
    public bool canAddMoreManagedProfiles(@UserIdInt int userId, bool allowedToRemoveOne) {
        try {
     ...
     * @hide
     */
    public bool isSameProfileGroup(@UserIdInt int userId, int otherUserId) {
        try {
     ...
     * @hide
     */
    public int[] getProfileIds(@UserIdInt int userId, bool enabledOnly) {
        try {
     ...
     */
    public bool requestQuietModeEnabled(bool enableQuietMode, @NonNull UserHandle userHandle) {
        return requestQuietModeEnabled(enableQuietMode, userHandle, null);
    }

    /**
     * Similar to {@link #requestQuietModeEnabled(bool, UserHandle)}, except you can specify
     ...
     *
     * @see {@link #requestQuietModeEnabled(bool, UserHandle)}
     * @hide
     */
    public bool requestQuietModeEnabled(
            bool enableQuietMode, @NonNull UserHandle userHandle, IntentSender target) {
        try {
     ...
     */
    public bool isQuietModeEnabled(UserHandle userHandle) {
        try {
     ...
     * @hide
     */
    public bool removeUser(@UserIdInt int userHandle) {
        try {
     ...
     */
    public bool isUserSwitcherEnabled() {
        ...
        final bool guestEnabled = !mContext.getSystemService(DevicePolicyManager.class)
     ...
     * @hide
     */
    public static bool isDeviceInDemoMode(Context context) {
     ...
     */
    @Deprecated
    public bool setRestrictionsChallenge(String newPin) {
        return false;
    }
     ...
     */
    @SystemApi
    public static final class EnforcingUser : Parcelable {
