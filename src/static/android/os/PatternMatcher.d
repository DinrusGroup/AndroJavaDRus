 ...
 * used maliciously.
 */
public class PatternMatcher : Parcelable {
    /**
    ...
    static bool matchPattern(String match, String pattern, int[] parsedPattern, int type) {
    ...
    static bool matchGlobPattern(String pattern, String match) {
    ...
    private static bool isParsedModifier(int parsedChar) {
    ...
    static bool matchAdvancedPattern(int[] parsedPattern, String match) {
    ...
    private static bool matchChar(String match, int im, final int lm, int tokenType,
