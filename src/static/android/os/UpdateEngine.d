...
public class UpdateEngine {
     ...
     */
    @SystemApi
    public bool bind(final UpdateEngineCallback callback, final Handler handler) {
     ...
     */
    @SystemApi
    public bool bind(final UpdateEngineCallback callback) {
    ...
    public bool unbind() {
        synchronized (mUpdateEngineCallbackLock) {
            ...
            try {
                bool result = mUpdateEngine.unbind(mUpdateEngineCallback);
     ...
     */
    @SystemApi
    public bool verifyPayloadMetadata(String payloadMetadataFilename) {
        try {
