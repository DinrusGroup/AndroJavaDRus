...
public abstract class TokenWatcher
{
    ...
    public void cleanup(IBinder token, bool unlink)
    {
        synchronized (mTokens) {
    ...
    private void sendNotificationLocked(bool on)
    {
        int value = on ? 1 : 0;
    ...
    private class Death : IBinder.DeathRecipient
    {
        IBinder token;
        String tag;
    ...
    private volatile bool mAcquired = false;
}
