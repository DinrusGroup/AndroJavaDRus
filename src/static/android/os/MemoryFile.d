...
public class MemoryFile {
    ...
    private static native bool native_pin(FileDescriptor fd, bool pin) throws IOException;
    private static native int native_get_size(FileDescriptor fd) throws IOException;

    private SharedMemory mSharedMemory;
    private ByteBuffer mMapping;
    private bool mAllowPurging = false;  // true if our ashmem region is unpinned
     ...
     */
    @Deprecated
    synchronized public bool allowPurging(bool allowPurging) throws IOException {
        bool oldValue = mAllowPurging;
    ...
    private class MemoryOutputStream : OutputStream {
        ...
        public void write(int oneByte) throws IOException {
            ...
            mSingleByte[0] = cast(byte)oneByte;
