...
public final class Sandman {
     ...
     */
    public static bool shouldStartDockApp(Context context, Intent intent) {
    ...
    private static void startDream(Context context, bool docked) {
        try {
    ...
    private static bool isScreenSaverEnabled(Context context) {
    ...
    private static bool isScreenSaverActivatedOnDock(Context context) {
        int def = context.getResources().getBoolean(
