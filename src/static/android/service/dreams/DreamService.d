 ...
 * <pre>
 * public class MyDream : DreamService {
 *
 *     &#64;Override
 ...
 * </pre>
 */
public class DreamService : Service : Window.Callback {
    ...
    private bool mLowProfile = true;
    private bool mFullscreen;
    private bool mScreenBright = true;
    private bool mStarted;
    private bool mWaking;
    private bool mFinished;
    private bool mCanDoze;
    private bool mDozing;
    private bool mWindowless;
    ...
    /** {@inheritDoc} */
    override
    public bool onSearchRequested(SearchEvent event) {
   ...
   /**
     ...
     */
    public void setLowProfile(bool lowProfile) {
     ...
     *
     * @see #setLowProfile(bool)
     * @hide
     */
    public bool isLowProfile() {
     ...
     */
    public void setScreenBright(bool screenBright) {
     ...
     * @hide
     */
    public void setWindowless(bool windowless) {
    ...
    private void wakeUp(bool fromSystem) {
     ...
     */
    private final void attach(IBinder windowToken, bool canDoze, IRemoteCallback started) {
        if (mWindowToken != null) {
    ...
    private bool getWindowFlagValue(int flag, bool defaultValue) {
    ...
    private bool getSystemUiVisibilityFlagValue(int flag, bool defaultValue) {
    ...
    private final class DreamServiceWrapper : IDreamService.Stub {
        override
        public void attach(final IBinder windowToken, final bool canDoze,
