 ...
 * @hide
 */
public final class GateKeeperResponse : Parcelable {
    ...
    @VisibleForTesting
    public static GateKeeperResponse createOkResponse(byte[] payload, bool shouldReEnroll) {
    ...
    public static final Parcelable.Creator<GateKeeperResponse> CREATOR
        ...
        public GateKeeperResponse createFromParcel(Parcel source) {
            ...
            if (responseCode == RESPONSE_RETRY) {
                ...
                final bool shouldReEnroll = source.readInt() == 1;
                byte[] payload = null;
