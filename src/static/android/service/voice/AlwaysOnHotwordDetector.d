...
public class AlwaysOnHotwordDetector {
    ...
    public static class EventPayload {
        ...
        private EventPayload(bool triggerAvailable, bool captureAvailable,
     ...
     *         {@link VoiceInteractionService} hosting this detector has been shut down.
     */
    public bool startRecognition(@RecognitionFlags int recognitionFlags) {
    ...
    private int startRecognitionLocked(int recognitionFlags) {
        ...
        bool captureTriggerAudio =
                (recognitionFlags&RECOGNITION_FLAG_CAPTURE_TRIGGER_AUDIO) != 0;
        bool allowMultipleTriggers =
    ...
    /** @hide */
    static final class SoundTriggerListener : IRecognitionStatusCallback.Stub {
        private final Handler mHandler;
    ...
    class RefreshAvailabiltyTask : AsyncTask<Void, Void, Void> {
         ...
         */
        private bool internalGetIsEnrolled(int keyphraseId, Locale locale) {
            try {
