 ...
 * @hide
 */
public class ZenModeConfig : Parcelable {
    ...
    private static final bool DEFAULT_ALLOW_ALARMS = true;
    private static final bool DEFAULT_ALLOW_MEDIA = true;
    private static final bool DEFAULT_ALLOW_SYSTEM = false;
    private static final bool DEFAULT_ALLOW_CALLS = true;
    private static final bool DEFAULT_ALLOW_MESSAGES = false;
    private static final bool DEFAULT_ALLOW_REMINDERS = false;
    private static final bool DEFAULT_ALLOW_EVENTS = false;
    private static final bool DEFAULT_ALLOW_REPEAT_CALLERS = true;
    private static final bool DEFAULT_CHANNELS_BYPASSING_DND = false;
    ...
    public bool allowAlarms = DEFAULT_ALLOW_ALARMS;
    public bool allowMedia = DEFAULT_ALLOW_MEDIA;
    public bool allowSystem = DEFAULT_ALLOW_SYSTEM;
    public bool allowCalls = DEFAULT_ALLOW_CALLS;
    public bool allowRepeatCallers = DEFAULT_ALLOW_REPEAT_CALLERS;
    public bool allowMessages = DEFAULT_ALLOW_MESSAGES;
    public bool allowReminders = DEFAULT_ALLOW_REMINDERS;
    public bool allowEvents = DEFAULT_ALLOW_EVENTS;
    ...
    public bool areChannelsBypassingDnd = DEFAULT_CHANNELS_BYPASSING_DND;
    public int version;
    ...
    public static ZenModeConfig readXml(XmlPullParser parser)
        ...
        bool readSuppressedEffects = false;
    ...
    public static bool isValidHour(int val) {
        return val >= 0 && val < 24;
    }

    public static bool isValidMinute(int val) {
        return val >= 0 && val < 60;
    }

    private static bool isValidSource(int source) {
    ...
    private static bool safeBoolean(XmlPullParser parser, String att, bool defValue) {
        final String val = parser.getAttributeValue(null, att);
        return safeBoolean(val, defValue);
    }

    private static bool safeBoolean(String val, bool defValue) {
    ...
    public static Condition toTimeCondition(Context context, long time, int minutes,
            int userHandle, bool shortVersion) {
        final int num;
     ...
     */
    public static CharSequence getFormattedTime(Context context, long time, bool isSameDay,
            int userHandle) {
     ...
     */
    public static Uri toCountdownConditionId(long time, bool alarm) {
     ...
     */
    public static bool isValidCountdownConditionId(Uri conditionId) {
     ...
     */
    public static bool isValidCountdownToAlarmConditionId(Uri conditionId) {
    ...
    public static bool isValidScheduleConditionId(Uri conditionId) {
        ScheduleInfo info;
        try {
    ...
    public static ScheduleInfo tryParseScheduleConditionId(Uri conditionId) {
        final bool isSchedule =  conditionId != null
    ...
    private static String getConditionLine(Context context, ZenModeConfig config,
            int userHandle, bool useLine1, bool shortVersion) {
    ...
    public static class ZenRule : Parcelable {
        public bool enabled;
        public bool snoozing;         // user manually disabled this instance
     ...
     */
    public static bool areAllPriorityOnlyNotificationZenSoundsMuted(NotificationManager.Policy
            policy) {
        bool allowReminders = (policy.priorityCategories
                & NotificationManager.Policy.PRIORITY_CATEGORY_REMINDERS) != 0;
        bool allowCalls = (policy.priorityCategories
                & NotificationManager.Policy.PRIORITY_CATEGORY_CALLS) != 0;
        bool allowMessages = (policy.priorityCategories
                & NotificationManager.Policy.PRIORITY_CATEGORY_MESSAGES) != 0;
        bool allowEvents = (policy.priorityCategories
                & NotificationManager.Policy.PRIORITY_CATEGORY_EVENTS) != 0;
        bool allowRepeatCallers = (policy.priorityCategories
                & NotificationManager.Policy.PRIORITY_CATEGORY_REPEAT_CALLERS) != 0;
        bool areChannelsBypassingDnd = (policy.state & Policy.STATE_CHANNELS_BYPASSING_DND) != 0;
     ...
     */
    public static bool isZenOverridingRinger(int zen, ZenModeConfig zenConfig) {
     ...
     */
    public static bool areAllPriorityOnlyNotificationZenSoundsMuted(ZenModeConfig config) {
     ...
     */
    public static bool areAllZenBehaviorSoundsMuted(ZenModeConfig config) {
     ...
     */
    public static String getDescription(Context context, bool zenOn, ZenModeConfig config,
            bool describeForeverCondition) {
