...
public abstract class NotificationListenerService : Service {
    ...
    /** @hide */
    protected class NotificationListenerWrapper : INotificationListener.Stub {
        override
    ...
    public static class Ranking {
        ...
        private String mKey;
        private int mRank = -1;
        private bool mIsAmbient;
        private bool mMatchesInterruptionFilter;
         ...
         */
        @VisibleForTesting
        public void populate(String key, int rank, bool matchesInterruptionFilter,
                int visibilityOverride, int suppressedVisualEffects, int importance,
                CharSequence explanation, String overrideGroupKey,
                NotificationChannel channel, ArrayList<String> overridePeople,
                ArrayList<SnoozeCriterion> snoozeCriteria, bool showBadge,
                int userSentiment, bool hidden) {
            mKey = key;
            mRank = rank;
     ...
     */
    public static class RankingMap : Parcelable {
         ...
         */
        public bool getRanking(String key, Ranking outRanking) {
        ...
        private bool isIntercepted(String key) {
            synchronized (this) {
        ...
        private bool getShowBadge(String key) {
            synchronized (this) {
                if (mShowBadge == null) {
            ...
            return showBadge == null ? false : showBadge.boolValue();
        }
        ...
        private bool getHidden(String key) {
            synchronized (this) {
                if (mHidden == null) {
                    buildHiddenLocked();
                }
            ...
            return hidden == null ? false : hidden.boolValue();
        }
