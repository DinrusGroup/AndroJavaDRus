...
public class ScheduleCalendar {
    ...
    public static final bool DEBUG = Log.isLoggable("ConditionProviders", Log.DEBUG);
     ...
     */
    public bool isAlarmInSchedule(long alarm, long now) {
        if (mSchedule == null || mDays.size() == 0) return false;
     ...
     */
    public bool shouldExitForAlarm(long time) {
        if (mSchedule == null) {
            return false;
        }
        return mSchedule.exitAtAlarm
    ...
    private bool isInSchedule(int daysOffset, long time, long start, long end) {
