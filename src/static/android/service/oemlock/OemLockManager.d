 ...
 *
 * This will only be available if the device : OEM lock protection.
 *
...
public class OemLockManager {
     ...
     *
     * @see #setOemUnlockAllowedByCarrier(bool, byte[])
     */
    @RequiresPermission(android.Manifest.permission.MANAGE_CARRIER_OEM_UNLOCK_STATE)
    ...
    public void setOemUnlockAllowedByUser(bool allowed) {
        try {
     ...
     *
     * @see #setOemUnlockAllowedByUser(bool)
     */
    @RequiresPermission(android.Manifest.permission.MANAGE_USER_OEM_UNLOCK_STATE)
