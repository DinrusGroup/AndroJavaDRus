 ...
 * {@link SpellCheckerService.Session#onGetSuggestionsMultiple(TextInfo[], int, bool)} for
...
public abstract class SpellCheckerService : Service {
    ...
    private static class InternalISpellCheckerSession : ISpellCheckerSession.Stub {
        ...
        public void onGetSuggestionsMultiple(
                TextInfo[] textInfos, int suggestionsLimit, bool sequentialWords) {
    ...
    private static class SpellCheckerServiceBinder : ISpellCheckerService.Stub {
         ...
         *                 {@link Session#onGetSuggestionsMultiple(TextInfo[], int, bool)} and
     ...
     * APIs used in
     * {@link SpellCheckerService.Session#onGetSuggestionsMultiple(TextInfo[], int, bool)}
     */
