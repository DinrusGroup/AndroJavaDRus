 ...
 */
public final class LuhnChecksumValidator : InternalValidator : Validator,
        Parcelable {
     ...
     */
    private static bool isLuhnChecksumValid(@NonNull String number) {
        int sum = 0;
    ...
    public bool isValid(@NonNull ValueFinder finder) {
        ...
        bool valid = isLuhnChecksumValid(number);
