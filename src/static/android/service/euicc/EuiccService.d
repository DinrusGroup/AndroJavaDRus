 ...
 */
@SystemApi
public abstract class EuiccService : Service {
    ...
    /**
     * Intent extra set for resolution requests containing a bool indicating whether to ask the
    ...
    public abstract GetDownloadableSubscriptionMetadataResult onGetDownloadableSubscriptionMetadata(
            int slotId, DownloadableSubscription subscription, bool forceDeactivateSim);
    ...
    public abstract GetDefaultDownloadableSubscriptionListResult
            onGetDefaultDownloadableSubscriptionList(int slotId, bool forceDeactivateSim);
     ...
     */
    private class IEuiccServiceWrapper : IEuiccService.Stub {
        override
        ...
        override
        public void getDefaultDownloadableSubscriptionList(int slotId, bool forceDeactivateSim,
        ...
        override
        public void switchToSubscription(int slotId, String iccid, bool forceDeactivateSim,
