 ...
 *
 */
public abstract class MediaBrowserService : Service {
    ...
    private class ServiceBinder : IMediaBrowserService.Stub {
        override
     ...
     */
    private bool isValidPackage(String pkg, int uid) {
        if (pkg == null) {
            return false;
        }
     ...
     */
    private bool removeSubscription(String id, ConnectionRecord connection, IBinder token) {
        if (token == null) {
