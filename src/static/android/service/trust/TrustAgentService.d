 ...
 */
@SystemApi
public class TrustAgentService : Service {
        ...
        public void handleMessage(android.os.Message msg) {
            switch (msg.what) {
                ...
                case MSG_CONFIGURE: {
                    ...
                    bool result = onConfigure(data.options);
                    if (data.token != null) {
                        try {
                            synchronized (mLock) {
                ...
                case MSG_ESCROW_TOKEN_REMOVED: {
                    Bundle data = msg.getData();
                    long handle = data.getLong(EXTRA_TOKEN_HANDLE);
                    bool success = data.getBoolean(EXTRA_TOKEN_REMOVED_RESULT);
     ...
     */
    public void onUnlockAttempt(bool successful) {
    }
     ...
     * call {@link #grantTrust(CharSequence, long, bool)} if the trust state should be
     * continued.
     */
     ...
     *
     */
    public void onEscrowTokenRemoved(long handle, bool successful) {
    }
     ...
     */
    public bool onConfigure(List<PersistableBundle> options) {
        return false;
    }
    ...
    public final void grantTrust(
            final CharSequence message, final long durationMs, final bool initiatedByUser) {
     ...
     */
    public final void setManagingTrust(bool managingTrust) {
        synchronized (mLock) {
     ...
     *
     * Result will be return in callback {@link #onEscrowTokenStateReceived(long, bool)}
     *
     ...
     *
     * Result will be return in callback {@link #onEscrowTokenRemoved(long, bool)}
     *
    ...
    private final class TrustAgentServiceWrapper : ITrustAgentService.Stub {
        override /* Binder API */
        public void onUnlockAttempt(bool successful) {
