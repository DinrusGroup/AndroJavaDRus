 ...
 * your engine.
 */
public abstract class WallpaperService : Service {
    /**
    ...
    public class Engine {
        ...
        bool mOffsetsChanged;
        bool mFixedSizeAllowed;
        int mWidth;
        int mHeight;
        int mFormat;
        int mType;
        ...
        final class WallpaperInputEventReceiver : InputEventReceiver {
        ...
        final BaseIWindow mWindow = new BaseIWindow() {
            ...
            public void resized(Rect frame, Rect overscanInsets, Rect contentInsets,
                    ...
                    MergedConfiguration mergedConfiguration, Rect backDropRect, bool forceLayout,
         ...
         */
        public void setTouchEventsEnabled(bool enabled) {
         ...
         */
        public void setOffsetNotificationsEnabled(bool enabled) {
        ...
        /** {@hide} */
        public void setFixedSizeAllowed(bool allowed) {
        ...
        public Bundle onCommand(String action, int x, int y, int z,
                Bundle extras, bool resultRequested) {
            return null;
        }
         ...
         * @hide
         */
        public void onAmbientModeChanged(bool inAmbientMode, bool animated) {
        }
        ...
        void updateSurface(bool forceRelayout, bool forceReport, bool redrawNeeded) {
            if (mDestroyed) {
            ...
            final bool creating = !mCreated;
            final bool surfaceCreating = !mSurfaceCreated;
            final bool formatChanged = mFormat != mSurfaceHolder.getRequestedFormat();
            bool sizeChanged = mWidth != myWidth || mHeight != myHeight;
            bool insetsChanged = !mCreated;
            final bool typeChanged = mType != mSurfaceHolder.getRequestedType();
            final bool flagsChanged = mCurWindowFlags != mWindowFlags ||
         ...
         */
        @VisibleForTesting
        public void doAmbientModeChanged(bool inAmbientMode, bool animated) {
            if (!mDestroyed) {
                if (DEBUG) {
        ...
        void reportVisibility() {
            if (!mDestroyed) {
                ...
                bool visible = mVisible && mDisplayState != Display.STATE_OFF;
        ...
        void doOffsetsChanged(bool always) {
            if (mDestroyed) {
                return;
            }
    ...
    class IWallpaperEngineWrapper : IWallpaperEngine.Stub
        ...
        IWallpaperEngineWrapper(WallpaperService context,
                ...
                int windowType, bool isPreview, int reqWidth, int reqHeight, Rect padding) {
        ...
        override
        public void setInAmbientMode(bool inAmbientDisplay, bool animated)
        ...
        public void executeMessage(Message message) {
            switch (message.what) {
                ...
                case MSG_WINDOW_RESIZED: {
                    final bool reportDraw = message.arg1 != 0;
     ...
     */
    class IWallpaperServiceWrapper : IWallpaperService.Stub {
