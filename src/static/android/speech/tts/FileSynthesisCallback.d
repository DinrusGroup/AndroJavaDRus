 ...
 */
class FileSynthesisCallback : AbstractSynthesisCallback {
    ...
    FileSynthesisCallback(@NonNull FileChannel fileChannel,
            @NonNull UtteranceProgressDispatcher dispatcher, bool clientIsUsingV2) {
    ...
    private ByteBuffer makeWavHeader(int sampleRateInHz, int audioFormat, int channelCount,
        ...
        short blockAlign = cast(short) (sampleSizeInBytes * channelCount);
        short bitsPerSample = cast(short) (sampleSizeInBytes * 8);
        ...
        header.putShort(cast(short) channelCount);
