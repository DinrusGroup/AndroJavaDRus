...
public class TtsEngines {
    ...
    private bool isSystemEngine(ServiceInfo info) {
     ...
     */
    public bool isEngineInstalled(String engine) {
        if (engine == null) {
            return false;
        }
    ...
    private static class EngineInfoComparator : Comparator<EngineInfo> {
     ...
     * @param engineName the engine to return the locale for.
     */
    public bool isLocaleSetToDefaultForEngine(String engineName) {
