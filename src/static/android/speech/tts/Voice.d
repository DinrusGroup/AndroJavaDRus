...
public class Voice : Parcelable {
    ...
    private final bool mRequiresNetworkConnection;
    ...
    public Voice(String name,
            ...
            int quality,
            int latency,
            bool requiresNetworkConnection,
            Set<String> features) {
        this.mName = name;
        this.mLocale = locale;
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeByte(cast(byte) (mRequiresNetworkConnection ? 1 : 0));
