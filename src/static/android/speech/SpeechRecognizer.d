...
public class SpeechRecognizer {
     ...
     */
    public static bool isRecognitionAvailable(final Context context) {
    ...
    private bool checkOpenConnection() {
        if (mService != null) {
            return true;
        }
        mListener.onError(ERROR_CLIENT);
     ...
     * RecognitionListener
     */
    private static class InternalListener : IRecognitionListener.Stub {
