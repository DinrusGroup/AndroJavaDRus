...
class PropertyValuesHolder_Delegate {
    ...
    private static long registerMethod(Class!(T) targetClass, String methodName, Class[] types,
            int nArgs) {
    ...
    @LayoutlibDelegate
    /*package*/ static long nGetIntMethod(Class!(T) targetClass, String methodName) {
        return nGetMultipleIntMethod(targetClass, methodName, 1);
    }

    @LayoutlibDelegate
    /*package*/ static long nGetFloatMethod(Class!(T) targetClass, String methodName) {
        return nGetMultipleFloatMethod(targetClass, methodName, 1);
    }

    @LayoutlibDelegate
    /*package*/ static long nGetMultipleIntMethod(Class!(T) targetClass, String methodName,
            int numParams) {
        return registerMethod(targetClass, methodName, INTEGER_VARIANTS, numParams);
    }

    @LayoutlibDelegate
    /*package*/ static long nGetMultipleFloatMethod(Class!(T) targetClass, String methodName,
            int numParams) {
