...
public class PathKeyframes : Keyframes {
    ...
    private abstract static class SimpleKeyframes : Keyframes {
        override
        public void setEvaluator(TypeEvaluator evaluator) {
        }
    ...
    abstract static class IntKeyframesBase : SimpleKeyframes : IntKeyframes {
        override
        public Class getType() {
    ...
    abstract static class FloatKeyframesBase : SimpleKeyframes
            : FloatKeyframes {
        override
        public Class getType() {
            return Float.class;
