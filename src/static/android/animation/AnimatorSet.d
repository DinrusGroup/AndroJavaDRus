 ...
 * </div>
 */
public final class AnimatorSet : Animator : AnimationHandler.AnimationFrameCallback {

    private static final String TAG = "AnimatorSet";
    /**
     * Internal variables
     * NOTE: This object : the clone() method, making a deep copy of any referenced
    ...
    private final bool mShouldIgnoreEndWithoutStart;
    ...
    private final bool mShouldResetValuesAtStart;
    ...
    private final bool mEndCanBeCalled;
    ...
    private void start(bool inReverse, bool selfPulse) {
        ...
        bool isEmptySet = isEmptySet(this);
        if (!isEmptySet) {
            startAnimation();
        }
     ...
     */
    private static class Node : Cloneable {
        Animator mAnimation;
