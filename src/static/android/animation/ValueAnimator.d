...
public class ValueAnimator : Animator : AnimationHandler.AnimationFrameCallback {
    ...
    bool animateBasedOnTime(long currentTime) {
        ...
        if (mRunning) {
            ...
            final bool newIteration = (int) fraction > (int) lastFraction;
            final bool lastIterationFinished = (fraction >= mRepeatCount + 1) &&
     ...
     * @hide
     */
    public final bool doAnimationFrame(long frameTime) {
        if (mStartTime < 0) {
