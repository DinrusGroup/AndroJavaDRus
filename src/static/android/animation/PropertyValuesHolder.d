 ...
 * in parallel.
 */
public class PropertyValuesHolder : Cloneable {
    ...
    void setupSetter(Class targetClass) {
        Class!(T) propertyType = mConverter == null ? mValueType : mConverter.getTargetType();
    ...
    static class IntPropertyValuesHolder : PropertyValuesHolder {
    ...
    static class FloatPropertyValuesHolder : PropertyValuesHolder {
    ...
    static class MultiFloatValuesHolder : PropertyValuesHolder {
    ...
    static class MultiIntValuesHolder : PropertyValuesHolder {
        private long mJniSetter;
        private static final HashMap<Class, HashMap<String, Long>> sJNISetterPropertyMap =
                new HashMap<Class, HashMap<String, Long>>();
     ...
     */
    private static class PointFToFloatArray : TypeConverter<PointF, float[]> {
     ...
     */
    private static class PointFToIntArray : TypeConverter<PointF, int[]> {
