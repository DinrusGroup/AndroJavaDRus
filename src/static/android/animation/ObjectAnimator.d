 ...
 *
 */
public final class ObjectAnimator : ValueAnimator {
    ...
    private bool hasSameTargetAndProperties(@Nullable Animator anim) {
    ...
    bool shouldAutoCancel(AnimationHandler.AnimationFrameCallback anim) {
        if (anim == null) {
            return false;
        }
