...
public class LayoutTransition {
     ...
     */
    private void addChild(ViewGroup parent, View child, bool changesLayout) {
     ...
     * affect CHANGE_APPEARING or CHANGE_DISAPPEARING animations.
     */
    private void removeChild(ViewGroup parent, View child, bool changesLayout) {
        if (parent.getWindowVisibility() != View.VISIBLE) {
            return;
        }
     ...
     */
    private static final class CleanupCallback : ViewTreeObserver.OnPreDrawListener,
