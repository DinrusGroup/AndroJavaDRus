...
public final class KeyChain {
    ...
    /**
     * Used as a bool extra field in {@link #ACTION_KEY_ACCESS_CHANGED} to supply if the key is
    ...
    private static class AliasResponse : IKeyChainAliasCallback.Stub {
     ...
     * "RSA").
     */
    public static bool isKeyAlgorithmSupported(
     ...
     */
    @Deprecated
    public static bool isBoundKeyAlgorithm(
            @NonNull @KeyProperties.KeyAlgorithmEnum String algorithm) {
     ...
     * @see KeyChain#bind
     */
    public static class KeyChainConnection : Closeable {
    ...
    public static KeyChainConnection bindAsUser(@NonNull Context context, UserHandle user)
        ...
        ServiceConnection keyChainServiceConnection = new ServiceConnection() {
            volatile bool mConnectedAtLeastOnce = false;
