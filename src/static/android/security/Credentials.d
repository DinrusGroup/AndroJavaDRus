...
public class Credentials {
     ...
     */
    public static bool deleteAllTypesForAlias(KeyStore keystore, String alias) {
     ...
     * Returns {@code true} if the alias no longer contains any types.
     */
    public static bool deleteAllTypesForAlias(KeyStore keystore, String alias, int uid) {
        /*
     ...
     */
    public static bool deleteCertificateTypesForAlias(KeyStore keystore, String alias) {
     ...
     * Returns {@code true} if the alias no longer contains either type.
     */
    public static bool deleteCertificateTypesForAlias(KeyStore keystore, String alias, int uid) {
        /*
     ...
     */
    public static bool deleteUserKeyTypeForAlias(KeyStore keystore, String alias) {
     ...
     * Returns {@code true} if the entry no longer exists.
     */
    public static bool deleteUserKeyTypeForAlias(KeyStore keystore, String alias, int uid) {
     ...
     * Returns {@code true} if the entry no longer exists.
     */
    public static bool deleteLegacyKeyForAlias(KeyStore keystore, String alias, int uid) {
