...
public class KeyStore {
    ...
    public bool put(String key, byte[] value, int uid, int flags) {
    ...
    public bool delete(String key, int uid) {
        try {
    ...
    public bool contains(String key, int uid) {
        try {
     ...
     */
    public bool unlock(int userId, String password) {
        try {
     ...
     */
    public bool isEmpty(int userId) {
        try {
    ...
    public bool generate(String key, int uid, int keyType, int keySize, int flags,
            byte[][] args) {
        try {
    ...
    public bool importKey(String keyName, byte[] key, int uid, int flags) {
        try {
    ...
    public bool verify(String key, byte[] data, byte[] signature) {
        try {
    ...
    public bool ungrant(String key, int uid) {
        try {
    ...
    public bool isHardwareBacked(String keyType) {
        try {
    ...
    public bool addRngEntropy(byte[] data, int flags) {
        try {
    ...
    public OperationResult begin(String alias, int purpose, bool pruneable,
     ...
     * {@link #begin(String, int, bool, KeymasterArguments, byte[], KeymasterArguments) begin}.
     */
    public bool isOperationAuthorized(IBinder token) {
        try {
     ...
     */
    public bool onUserPasswordChanged(int userId, String newPassword) {
    ...
    public bool onUserPasswordChanged(String newPassword) {
     ...
     */
    public bool isConfirmationPromptSupported() {
        try {
