 ...
 * @hide
 */
public abstract class AndroidKeyStoreKeyPairGeneratorSpi : KeyPairGeneratorSpi {

    public static class RSA : AndroidKeyStoreKeyPairGeneratorSpi {
        public RSA() {
            super(KeymasterDefs.KM_ALGORITHM_RSA);
        }
    }

    public static class EC : AndroidKeyStoreKeyPairGeneratorSpi {
        public EC() {
    ...
    private bool mEncryptionAtRestRequired;
    ...
    public void initialize(AlgorithmParameterSpec params, SecureRandom random)
        ...
        try {
            ...
            bool encryptionAtRestRequired = false;
    ...
    private static String getCertificateSignatureAlgorithm(
        ...
        switch (keymasterAlgorithm) {
            ...
            case KeymasterDefs.KM_ALGORITHM_RSA:
            {
                ...
                bool pkcs1SignaturePaddingSupported =
