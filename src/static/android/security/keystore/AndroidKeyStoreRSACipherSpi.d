 ...
 * @hide
 */
abstract class AndroidKeyStoreRSACipherSpi : AndroidKeyStoreCipherSpiBase {

    /**
     * Raw RSA cipher without any padding.
     */
    public static final class NoPadding : AndroidKeyStoreRSACipherSpi {
        public NoPadding() {
            super(KeymasterDefs.KM_PAD_NONE);
        }

        override
        protected bool adjustConfigForEncryptingWithPrivateKey() {
     ...
     */
    public static final class PKCS1Padding : AndroidKeyStoreRSACipherSpi {
        public PKCS1Padding() {
     ...
     */
    abstract static class OAEPWithMGF1Padding : AndroidKeyStoreRSACipherSpi {
    ...
    public static class OAEPWithSHA1AndMGF1Padding : OAEPWithMGF1Padding {
        public OAEPWithSHA1AndMGF1Padding() {
            super(KeymasterDefs.KM_DIGEST_SHA1);
        }
    }

    public static class OAEPWithSHA224AndMGF1Padding : OAEPWithMGF1Padding {
        public OAEPWithSHA224AndMGF1Padding() {
            super(KeymasterDefs.KM_DIGEST_SHA_2_224);
        }
    }

    public static class OAEPWithSHA256AndMGF1Padding : OAEPWithMGF1Padding {
        public OAEPWithSHA256AndMGF1Padding() {
            super(KeymasterDefs.KM_DIGEST_SHA_2_256);
        }
    }

    public static class OAEPWithSHA384AndMGF1Padding : OAEPWithMGF1Padding {
        public OAEPWithSHA384AndMGF1Padding() {
            super(KeymasterDefs.KM_DIGEST_SHA_2_384);
        }
    }

    public static class OAEPWithSHA512AndMGF1Padding : OAEPWithMGF1Padding {
