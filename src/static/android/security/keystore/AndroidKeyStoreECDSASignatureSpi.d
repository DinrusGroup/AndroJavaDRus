 ...
 * @hide
 */
abstract class AndroidKeyStoreECDSASignatureSpi : AndroidKeyStoreSignatureSpiBase {

    public final static class NONE : AndroidKeyStoreECDSASignatureSpi {
        public NONE() {
    ...
    public final static class SHA1 : AndroidKeyStoreECDSASignatureSpi {
        public SHA1() {
            super(KeymasterDefs.KM_DIGEST_SHA1);
        }
    }

    public final static class SHA224 : AndroidKeyStoreECDSASignatureSpi {
        public SHA224() {
            super(KeymasterDefs.KM_DIGEST_SHA_2_224);
        }
    }

    public final static class SHA256 : AndroidKeyStoreECDSASignatureSpi {
        public SHA256() {
            super(KeymasterDefs.KM_DIGEST_SHA_2_256);
        }
    }

    public final static class SHA384 : AndroidKeyStoreECDSASignatureSpi {
        public SHA384() {
            super(KeymasterDefs.KM_DIGEST_SHA_2_384);
        }
    }

    public final static class SHA512 : AndroidKeyStoreECDSASignatureSpi {
        public SHA512() {
