 ...
 * {@link Builder#setUserAuthenticationRequired(bool)}),</li>
 ...
 * }</pre>
 */
public final class KeyGenParameterSpec : AlgorithmParameterSpec, UserAuthArgs {
    ...
    private final bool mRandomizedEncryptionRequired;
    private final bool mUserAuthenticationRequired;
    private final int mUserAuthenticationValidityDurationSeconds;
    private final bool mUserPresenceRequired;
    private final byte[] mAttestationChallenge;
    private final bool mUniqueIdIncluded;
    private final bool mUserAuthenticationValidWhileOnBody;
    private final bool mInvalidatedByBiometricEnrollment;
    private final bool mIsStrongBoxBacked;
    private final bool mUserConfirmationRequired;
    private final bool mUnlockedDeviceRequired;
     ...
     * @see Builder#setUserAuthenticationRequired(bool)
     */
     ...
     * {@link Builder#setUserAuthenticationRequired(bool)}). Keys can be created that require
     ...
     * operations are not restricted.
     *
     * @see Builder#setUserConfirmationRequired(bool)
     */
     ...
     */
    public bool isUniqueIdIncluded() {
     ...
     * @see #isUserAuthenticationRequired()
     * @see #getUserAuthenticationValidityDurationSeconds()
     * @see Builder#setUserAuthenticationValidWhileOnBody(bool)
     */
     ...
     * @see #isUserAuthenticationRequired()
     * @see #getUserAuthenticationValidityDurationSeconds()
     * @see Builder#setInvalidatedByBiometricEnrollment(bool)
     */
     ...
     * locked.
     *
     * @see Builder#setUnlockedDeviceRequired(bool)
     */
    ...
    public final static class Builder {
        ...
        private bool mRandomizedEncryptionRequired = true;
        private bool mUserAuthenticationRequired;
        private int mUserAuthenticationValidityDurationSeconds = -1;
        private bool mUserPresenceRequired = false;
        private byte[] mAttestationChallenge = null;
        private bool mUniqueIdIncluded = false;
        private bool mUserAuthenticationValidWhileOnBody;
        private bool mInvalidatedByBiometricEnrollment = true;
        private bool mIsStrongBoxBacked = false;
        private bool mUserConfirmationRequired;
        private bool mUnlockedDeviceRequired = false;
         ...
         */
        @NonNull
        public Builder setRandomizedEncryptionRequired(bool required) {
         ...
         * #setInvalidatedByBiometricEnrollment(bool)} is used to allow validity after
         ...
         */
        @NonNull
        public Builder setUserAuthenticationRequired(bool required) {
         ...
         *
         * Confirmation is separate from user authentication (see
         * {@link #setUserAuthenticationRequired(bool)}). Keys can be created that require
         ...
         */
        @NonNull
        public Builder setUserConfirmationRequired(bool required) {
         ...
         * authentication for its use (see {@link #setUserAuthenticationRequired(bool)}).
         *
         ...
         *
         * @see #setUserAuthenticationRequired(bool)
         ...
         */
        @NonNull
        public Builder setUserPresenceRequired(bool required) {
        ...
        @TestApi
        @NonNull
        public Builder setUniqueIdIncluded(bool uniqueIdIncluded) {
            mUniqueIdIncluded = uniqueIdIncluded;
            return this;
        }
         ...
         */
        @NonNull
        public Builder setUserAuthenticationValidWhileOnBody(bool remainsValid) {
         ...
         * #setUserAuthenticationRequired(bool)}) and if no positive validity duration has been
         ...
         */
        @NonNull
        public Builder setInvalidatedByBiometricEnrollment(bool invalidateKey) {
         ...
         */
        @NonNull
        public Builder setIsStrongBoxBacked(bool isStrongBoxBacked) {
            mIsStrongBoxBacked = isStrongBoxBacked;
            return this;
        }
         ...
         */
        @NonNull
        public Builder setUnlockedDeviceRequired(bool unlockedDeviceRequired) {
            mUnlockedDeviceRequired = unlockedDeviceRequired;
            return this;
        }
