 ...
 * @hide
 */
public class AndroidKeyStoreSecretKeyFactorySpi : SecretKeyFactorySpi {
    ...
    static KeyInfo getKeyInfo(KeyStore keyStore, String entryAlias, String keyAliasInKeystore,
        ...
        bool userAuthenticationRequirementEnforcedBySecureHardware = (userAuthenticationRequired)
        ...
        bool trustedUserPresenceRequred =
        ...
        bool userConfirmationRequired = keyCharacteristics.hwEnforced.getBoolean(KeymasterDefs.KM_TAG_TRUSTED_CONFIRMATION_REQUIRED);
