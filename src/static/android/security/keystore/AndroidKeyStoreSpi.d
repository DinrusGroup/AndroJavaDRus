 ...
 * @hide
 */
public class AndroidKeyStoreSpi : KeyStoreSpi {
    ...
    private void setPrivateKeyEntry(String alias, PrivateKey key, Certificate[] chain,
        ...
        final bool shouldReplacePrivateKey;
    ...
    override
    public bool engineContainsAlias(String alias) {
        if (alias == null) {
            throw new NullPointerException("alias == null");
        }
    ...
    override
    public bool engineIsKeyEntry(String alias) {
        return isKeyEntry(alias);
    }

    private bool isKeyEntry(String alias) {
        return mKeyStore.contains(Credentials.USER_PRIVATE_KEY + alias, mUid) ||
                mKeyStore.contains(Credentials.USER_SECRET_KEY + alias, mUid);
    }


    private bool isCertificateEntry(String alias) {
        if (alias == null) {
            throw new NullPointerException("alias == null");
        }
    ...
    override
    public bool engineIsCertificateEntry(String alias) {
     ...
     * require an alias.
     */
    static class KeyStoreX509Certificate : DelegatingX509Certificate {
