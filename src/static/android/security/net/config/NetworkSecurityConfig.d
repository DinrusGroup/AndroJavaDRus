...
public final class NetworkSecurityConfig {
    /** @hide */
    public static final bool DEFAULT_CLEARTEXT_TRAFFIC_PERMITTED = true;
    /** @hide */
    public static final bool DEFAULT_HSTS_ENFORCED = false;

    private final bool mCleartextTrafficPermitted;
    private final bool mHstsEnforced;
    ...
    private NetworkSecurityConfig(bool cleartextTrafficPermitted, bool hstsEnforced,
    ...
    public static Builder getDefaultBuilder(ApplicationInfo info) {
        ...
        final bool cleartextTrafficPermitted = info.targetSdkVersion < Build.VERSION_CODES.P
    ...
    public static final class Builder {
        ...
        private bool mCleartextTrafficPermitted = DEFAULT_CLEARTEXT_TRAFFIC_PERMITTED;
        private bool mHstsEnforced = DEFAULT_HSTS_ENFORCED;
        private bool mCleartextTrafficPermittedSet = false;
        private bool mHstsEnforcedSet = false;
        ...
        public Builder setCleartextTrafficPermitted(bool cleartextTrafficPermitted) {
            mCleartextTrafficPermitted = cleartextTrafficPermitted;
            mCleartextTrafficPermittedSet = true;
            return this;
        }

        private bool getEffectiveCleartextTrafficPermitted() {
        ...
        public Builder setHstsEnforced(bool hstsEnforced) {
            mHstsEnforced = hstsEnforced;
            mHstsEnforcedSet = true;
            return this;
        }

        private bool getEffectiveHstsEnforced() {
            if (mHstsEnforcedSet) {
                return mHstsEnforced;
            }
            if (mParentBuilder != null) {
        ...
        public Builder addCertificatesEntryRefs(Collection<? : CertificatesEntryRef> refs) {
            if (mCertificatesEntryRefs == null) {
                mCertificatesEntryRefs = new ArrayList<CertificatesEntryRef>();
            }
        ...
        public bool hasCertificatesEntryRefs() {
        ...
        public NetworkSecurityConfig build() {
            bool cleartextPermitted = getEffectiveCleartextTrafficPermitted();
            bool hstsEnforced = getEffectiveHstsEnforced();
