 ...
 * @hide
 */
abstract class DirectoryCertificateSource : CertificateSource {
    ...
    protected abstract bool isCertMarkedAsRemoved(String caFile);
    ...
    public X509Certificate findBySubjectAndPublicKey(final X509Certificate cert) {
        return findCert(cert.getSubjectX500Principal(), new CertSelector() {
            override
            public bool match(X509Certificate ca) {
    ...
    private static interface CertSelector {
        bool match(X509Certificate cert);
    }
