...
public class XmlConfigSource : ConfigSource {
    ...
    private final bool mDebugBuild;
    ...
    private List<Pair<NetworkSecurityConfig.Builder, Set<Domain>>> parseConfigEntry(
        ...
        bool seenPinSet = false;
        bool seenTrustAnchors = false;
        bool defaultOverridePins = configType == CONFIG_DEBUG;
    ...
    private void parseNetworkSecurityConfig(XmlResourceParser parser)
        ...
        bool seenDebugOverrides = false;
        bool seenBaseConfig = false;
