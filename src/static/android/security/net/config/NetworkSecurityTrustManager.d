...
/**
 * {@link X509ExtendedTrustManager} that : the trust anchor and pinning for a
 * given {@link NetworkSecurityConfig}.
 * @hide
 */
public class NetworkSecurityTrustManager : X509ExtendedTrustManager {
    ...
    private bool isPinningEnforced(List<X509Certificate> chain) throws CertificateException {
        if (chain.isEmpty()) {
            return false;
        }
