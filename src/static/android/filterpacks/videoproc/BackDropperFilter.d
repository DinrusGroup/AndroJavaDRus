 ...
 * @hide
 */
public class BackDropperFilter : Filter {
    ...
    private bool mUseTheForce = false;

    @GenerateFinalPort(name = "provideDebugOutputs", hasDefault = true)
    private bool mProvideDebugOutputs = false;
    ...
    private final bool mLogVerbose;
    ...
    private bool mStartLearning;
    private bool mBackgroundFitModeChanged;
    ...
    private bool createMemoryFormat(FrameFormat inputFormat) {
    ...
    private void allocateFrames(FrameFormat inputFormat, FilterContext context) {
        ...
        for (int i = 0; i < numBytes; i++) {
            initialBgMean[i] = cast(byte)128;
            initialBgVariance[i] = cast(byte)10;
            initialMaskVerify[i] = cast(byte)0;
        }
    ...
    private void updateBgScaling(Frame video, Frame background, bool fitModeChanged) {
