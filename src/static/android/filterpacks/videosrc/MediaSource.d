 ...
 * @hide
 */
public class MediaSource : Filter {
    ...
    private bool mSelectedIsUrl = false;
    ...
    private bool mWaitForNewFrame = true;
    ...
    private bool mGotSize;
    private bool mPrepared;
    private bool mPlaying;
    private bool mNewFrameAvailable;
    private bool mOrientationUpdated;
    ...
    synchronized public void pauseVideo(bool pauseState) {
        if (isOpen()) {
    ...
    synchronized private bool setupMediaPlayer(bool useUrl) {
        mPrepared = false;
        mGotSize = false;
        mPlaying = false;
        mPaused = false;
