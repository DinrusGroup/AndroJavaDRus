 ...
 * {@link android.media.MediaDrm.MediaDrmStateException} :
 ...
 */
public final class MediaDrm : AutoCloseable {
     ...
     */
    public static final bool isCryptoSchemeSupported(@NonNull UUID uuid) {
     ...
     *   or "video/webm"
     */
    public static final bool isCryptoSchemeSupported(
    ...
    private static final native bool isCryptoSchemeSupportedNative(
     ...
     */
    public static final class MediaDrmStateException : java.lang.IllegalStateException {
                ...
                if (mOnKeyStatusChangeListener != null) {
                    if (msg.obj != null && msg.obj instanceof Parcel) {
                        ...
                        if (sessionId.length > 0) {
                            ...
                            bool hasNewUsableKey = (parcel.readInt() != 0);
    ...
    */
    ...
    private static final native bool verifyNative(
            @NonNull MediaDrm drm, @NonNull byte[] sessionId,
     ...
     * <p>
     * The CryptoSession class : generic encrypt/decrypt/sign/verify methods
