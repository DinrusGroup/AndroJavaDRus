...
public class Virtualizer : AudioEffect {
     ...
     */
    private bool mStrengthSupported = false;
     ...
     * @throws UnsupportedOperationException
     */
    private bool getAnglesInt(int inputChannelMask, int deviceType, int[] angles)
            throws IllegalStateException, IllegalArgumentException, UnsupportedOperationException {
        // parameter check
     ...
     * @throws UnsupportedOperationException
     */
    public bool canVirtualize(int inputChannelMask, @VirtualizationMode int virtualizationMode)
            throws IllegalStateException, IllegalArgumentException, UnsupportedOperationException {
     ...
     * @throws UnsupportedOperationException
     */
    public bool getSpeakerAngles(int inputChannelMask,
     ...
     * @throws UnsupportedOperationException
     */
    public bool forceVirtualizationMode(@ForceVirtualizationMode int virtualizationMode)
            throws IllegalStateException, IllegalArgumentException, UnsupportedOperationException {
        // convert Java device type to internal representation
