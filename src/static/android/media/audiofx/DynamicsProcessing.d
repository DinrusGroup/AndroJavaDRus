...
public final class DynamicsProcessing : AudioEffect {
    ...
    private static final bool CONFIG_DEFAULT_USE_PREEQ = true;
    private static final int CONFIG_DEFAULT_PREEQ_BANDS = 6;
    private static final bool CONFIG_DEFAULT_USE_MBC = true;
    private static final int CONFIG_DEFAULT_MBC_BANDS = 6;
    private static final bool CONFIG_DEFAULT_USE_POSTEQ = true;
    private static final int CONFIG_DEFAULT_POSTEQ_BANDS = 6;
    private static final bool CONFIG_DEFAULT_USE_LIMITER = true;
    ...
    private static final bool PREEQ_DEFAULT_ENABLED = true;
    private static final bool POSTEQ_DEFAULT_ENABLED = true;

    private static final bool MBC_DEFAULT_ENABLED = true;
    ...
    private static final bool LIMITER_DEFAULT_ENABLED = true;
     ...
     */
    public static class BandStage : Stage{
     ...
     * gain
     */
    public final static class EqBand : BandBase {
        private float mGain;
        /**
     ...
     */
    public final static class MbcBand : BandBase{
         ...
         */
        public MbcBand(bool enabled, float cutoffFrequency, float attackTime, float releaseTime,
     ...
     */
    public final static class Eq : BandStage {
     ...
     */
    public final static class Mbc : BandStage {
     ...
     */
    public final static class Limiter : Stage {
         ...
         * @param postGain Gain applied to the signal AFTER compression.
         */
        public Limiter(bool inUse, bool enabled, int linkGroup, float attackTime,
    ...
    public final static class Channel {
        ...
        public Channel (float inputGain,
                bool preEqInUse, int preEqBandCount,
                bool mbcInUse, int mbcBandCount,
                bool postEqInUse, int postEqBandCount,
                bool limiterInUse) {
    ...
    public final static class Config {
        ...
        private final bool mPreEqInUse;
        private final int mPreEqBandCount;
        private final bool mMbcInUse;
        private final int mMbcBandCount;
        private final bool mPostEqInUse;
        private final int mPostEqBandCount;
        private final bool mLimiterInUse;
        ...
        public final static class Builder {
            ...
            private bool mPreEqInUse;
            private int mPreEqBandCount;
            private bool mMbcInUse;
            private int mMbcBandCount;
            private bool mPostEqInUse;
            private int mPostEqBandCount;
            private bool mLimiterInUse;
    ...
    private void setEngineArchitecture(int variant, float preferredFrameDuration,
            bool preEqInUse, int preEqBandCount, bool mbcInUse, int mbcBandCount,
            bool postEqInUse, int postEqBandCount, bool limiterInUse) {
     ...
     * super class.
     */
    private class BaseParameterListener : AudioEffect.OnParameterChangeListener {
