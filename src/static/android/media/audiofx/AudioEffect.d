...
public class AudioEffect {
    ...
    /**
     * Checks if the device : the specified effect type.
     * @param type the requested effect type.
     * @return true if the device : the specified effect type, false otherwise.
     * @hide
     */
    @TestApi
    public static bool isEffectTypeAvailable(UUID type) {
     ...
     * @throws IllegalStateException
     */
    public int setEnabled(bool enabled) throws IllegalStateException {
     ...
     * @throws IllegalStateException
     */
    public bool getEnabled() throws IllegalStateException {
     ...
     * @throws IllegalStateException
     */
    public bool hasControl() throws IllegalStateException {
    ...
    private native final int native_setEnabled(bool enabled);

    private native final bool native_getEnabled();

    private native final bool native_hasControl();
