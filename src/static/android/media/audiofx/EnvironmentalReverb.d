...
public class EnvironmentalReverb : AudioEffect {
     ...
     * @return the decay HF ration. See {@link #setDecayHFRatiocast(short)} for units.
     * @throws IllegalStateException
     * @throws IllegalArgumentException
     * @throws UnsupportedOperationException
     */
     ...
     * (set using {@link #setRoomLevelcast(short)}).
     ...
     * <p>This level is combined with the overall room level (set using {@link #setRoomLevelcast(short)}).
     ...
     * @return the diffusion level. See {@link #setDiffusioncast(short)} for units.
     * @throws IllegalStateException
     * @throws IllegalArgumentException
     * @throws UnsupportedOperationException
     */
     ...
     * @return the density level. See {@link #setDiffusioncast(short)} for units.
     * @throws IllegalStateException
     * @throws IllegalArgumentException
     * @throws UnsupportedOperationException
     */
