 ...
 *         {@link #setLooping(bool)}, the MediaPlayer object shall remain in
 *         the <em>Started</em> state.</li>
 ...
 *
 */
public class MediaPlayer : PlayerBase
                                  ...
                                  , AudioRouting
{
    /**
       ...
       call.
       // FIXME: unhide.
       // FIXME: add link to getMetadata(bool, bool)
       {@hide}
     */
    public static final bool METADATA_UPDATE_ONLY = true;
    ...
    /**
       ...
       {@hide}
     */
    public static final bool METADATA_ALL = false;
    ...
    /**
       ...
       {@hide}
     */
    public static final bool APPLY_METADATA_FILTER = true;
    ...
    /**
       ...
       {@hide}
     */
    public static final bool BYPASS_METADATA_FILTER = false;
    ...
    private bool mBypassInterruptionPolicy;
    ...
    private bool attemptDataSource(ContentResolver resolver, Uri uri) {
     ...
     */
    public native void setLooping(bool looping);
    ...
    override
    void playerSetVolume(bool muting, float leftVolume, float rightVolume) {
    ...
    override
    int playerSetAuxEffectSendLevel(bool muting, float level) {
     ...
     */
    static public class TrackInfo : Parcelable {
        /**
         * Gets the track type.
    ...
    private bool mSubtitleDataListenerDisabled;
     ...
     */
    public static final class NoDrmSchemeException : MediaDrmException {
     ...
     * Extends MediaDrm.MediaDrmException
     */
    public static final class ProvisioningNetworkErrorException : MediaDrmException {
     ...
     * Extends MediaDrm.MediaDrmException
     */
    public static final class ProvisioningServerErrorException : MediaDrmException {
    ...
    /** @hide */
    static class TimeProvider : MediaPlayer.OnSeekCompleteListener,
            MediaTimeProvider {
