 ...
 */
public class AudioTrack : PlayerBase
                        : AudioRouting
                                 , VolumeAutomation
{
    //---------------------------------------------------------
    ...
    private AudioTrack(AudioAttributes attributes, AudioFormat format, int bufferSizeInBytes,
            int mode, int sessionId, bool offload)
                    throws IllegalArgumentException {
    ...
    public static class Builder {
         ...
         * @return the same Builder instance.
         */
        public @NonNull Builder setOffloadedPlayback(bool offload) {
            mOffload = offload;
            return this;
        }
    ...
    // Returns a bool whether the attributes, format, bufferSizeInBytes, mode allow
    ...
    private static bool shouldEnablePowerSaving(
     ...
     */
    private static bool isMultichannelConfigSupported(int channelConfig) {
    ...
    */
    ...
    public bool getTimestamp(AudioTimestamp timestamp)
    {
        if (timestamp == null) {
            throw new IllegalArgumentException();
        }
    ...
    */
     ...
     */
    @Deprecated
    public interface OnRoutingChangedListener : AudioRouting.OnRoutingChangedListener {
        /**
    ...
    private native final int native_write_native_bytes(Object audioData,
            int positionInBytes, int sizeInBytes, int format, bool blocking);
