 ...
 * its request as accepting delayed focus, with {@link Builder#setAcceptsDelayedFocusGain(bool)}.
 ...
 * speech, you can also declare so with {@link Builder#setWillPauseWhenDucked(bool)}, which will
...
public final class AudioFocusRequest {
     ...
     */
    final static bool isValidFocusGain(int focusGain) {
        switch (focusGain) {
            case AudioManager.AUDIOFOCUS_GAIN:
    ...
    public static final class Builder {
        ...
        private bool mPausesOnDuck = false;
        private bool mDelayedFocus = false;
        private bool mFocusLocked = false;
        private bool mA11yForceDucking = false;
         ...
         * @return this {@code Builder} instance.
         */
        public @NonNull Builder setWillPauseWhenDucked(bool pauseOnDuck) {
         ...
         * @return this {@code Builder} instance
         */
        public @NonNull Builder setAcceptsDelayedFocusGain(bool acceptsDelayedFocusGain) {
         ...
         */
        @SystemApi
        public @NonNull Builder setLocksFocus(bool focusLocked) {
         ...
         * @return this {@code Builder} instance
         */
        public @NonNull Builder setForceDucking(bool forceDucking) {
