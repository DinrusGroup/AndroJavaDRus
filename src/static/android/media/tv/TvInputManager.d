...
public final class TvInputManager {
    ...
    public abstract static class TvInputCallback {
         ...
         *
         * <p>Normally it happens when the user installs a new TV input package that :
    ...
    public void setParentalControlsEnabled(bool enabled) {
        try {
     ...
     */
    public bool isRatingBlocked(@NonNull TvContentRating rating) {
    ...
    private void createSessionInternal(String inputId, bool isRecordingSession,
    ...
    @SystemApi
    @RequiresPermission(android.Manifest.permission.CAPTURE_TV_INPUT)
    public bool isSingleSessionActive() {
        try {
    ...
    public static final class Session {
         ...
         */
        public void setCaptionEnabled(bool enabled) {
            if (mToken == null) {
                Log.w(TAG, "The session has been already released");
                return;
            }
        ...
        private bool containsTrack(List<TvTrackInfo> tracks, String trackId) {
         ...
         * there is an update.
         */
        bool updateTracks(List<TvTrackInfo> tracks) {
            synchronized (mMetadataLock) {
                mAudioTracks.clear();
                mVideoTracks.clear();
                mSubtitleTracks.clear();
         ...
         */
        bool updateTrackSelection(int type, String trackId) {
            synchronized (mMetadataLock) {
                if (type == TvTrackInfo.TYPE_AUDIO
         ...
         */
        void timeShiftEnablePositionTracking(bool enable) {
            if (mToken == null) {
                Log.w(TAG, "The session has been already released");
                return;
            }
        ...
        public interface FinishedInputEventCallback {
             ...
             */
            void onFinishedInputEvent(Object token, bool handled);
        }
        ...
        private final class InputEventHandler : Handler {
        ...
        private final class TvInputEventSender : InputEventSender {
    ...
    public final static class Hardware {
        ...
        public bool setSurface(Surface surface, TvStreamConfig config) {
            try {
        ...
        /** @removed */
        @SystemApi
        public bool dispatchKeyEventToHdmi(KeyEvent event) {
            return false;
        }
