 ...
 */
public final class TvInputInfo : Parcelable {
    ...
    private final bool mIsHardwareInput;
    ...
    private TvInputInfo(ResolveInfo service, String id, int type, bool isHardwareInput,
            CharSequence label, int labelResId, Icon icon, Icon iconStandby, Icon iconDisconnected,
            String setupActivity, bool canRecord, int tunerCount, HdmiDeviceInfo hdmiDeviceInfo,
            bool isConnectedToHdmiSwitch, String parentId, Bundle extras) {
        mService = service;
        mId = id;
        mType = type;
    ...
    /**
     * Returns the information of the service that : this TV input.
     */
    ...
    /**
     * Returns the component of the service that : this TV input.
     * @hide
     */
     ...
     */
    @SystemApi
    public bool isConnectedToHdmiSwitch() {
     ...
     *         otherwise.
     */
    public bool isHidden(Context context) {
    ...
    public void writeToParcel(@NonNull Parcel dest, int flags) {
        ...
        dest.writeInt(mType);
        dest.writeByte(mIsHardwareInput ? cast(byte) 1 : 0);
        ...
        dest.writeByte(mCanRecord ? cast(byte) 1 : 0);
        dest.writeInt(mTunerCount);
        dest.writeParcelable(mHdmiDeviceInfo, flags);
        dest.writeByte(mIsConnectedToHdmiSwitch ? cast(byte) 1 : 0);
    ...
    public static final class Builder {
         ...
         * @return This Builder object to allow for chaining of calls to builder methods.
         */
        public Builder setCanRecord(bool canRecord) {
         ...
         * for the {@link TvInputService} this TV input :.
         *
        ...
        public TvInputInfo build() {
            ...
            bool isConnectedToHdmiSwitch = false;
    ...
    public static final class TvInputSettings {
        ...
        private static bool isHidden(Context context, String inputId, int userId) {
