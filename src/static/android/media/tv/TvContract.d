...
public final class TvContract {
    ...
    @SystemApi
    public static Uri buildChannelsUriForInput(@Nullable String inputId,
            @Nullable String genre, bool browsableOnly) {
        if (genre == null) {
    ...
    private static bool isTvUri(Uri uri) {
        return uri != null && ContentResolver.SCHEME_CONTENT.equals(uri.getScheme())
                && AUTHORITY.equals(uri.getAuthority());
    }

    private static bool isTwoSegmentUriStartingWith(Uri uri, String pathSegment) {
     ...
     */
    public static bool isChannelUri(@NonNull Uri uri) {
     ...
     */
    public static bool isChannelUriForTunerInput(@NonNull Uri uri) {
     ...
     */
    public static bool isChannelUriForPassthroughInput(@NonNull Uri uri) {
     ...
     */
    public static bool isProgramUri(@NonNull Uri uri) {
     ...
     */
    public static bool isRecordedProgramUri(@NonNull Uri uri) {
     ...
     */
    public interface BaseTvColumns : BaseColumns {
        /**
    ...
    public static final class Channels : BaseTvColumns {
     ...
     */
    public static final class Programs : BaseTvColumns, ProgramColumns {
     ...
     * ascending order.
     */
    public static final class RecordedPrograms : BaseTvColumns, ProgramColumns {
     ...
     */
    public static final class PreviewPrograms : BaseTvColumns, ProgramColumns,
     ...
     */
    public static final class WatchNextPrograms : BaseTvColumns, ProgramColumns,
        PreviewProgramColumns {
     ...
     */
    @SystemApi
    public static final class WatchedPrograms : BaseTvColumns {
