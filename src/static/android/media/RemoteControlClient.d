...
@Deprecated public class RemoteControlClient
{
     ...
     * Use {@link RemoteControlClient#editMetadata(bool)} to create an instance of an editor,
     ...
     */
    @Deprecated public class MetadataEditor : MediaMetadataEditor {
         ...
         * (with {@link RemoteControlClient#editMetadata(bool)}).
         ...
         *     created with {@link RemoteControlClient#editMetadata(bool)}, or since
     ...
     */
    public MetadataEditor editMetadata(bool startEmpty) {
    ...
    private bool mNeedsPositionSync = false;
     ...
     *     playback state
     */
    static bool playbackPositionShouldMove(int playstate) {
        switch(playstate) {
