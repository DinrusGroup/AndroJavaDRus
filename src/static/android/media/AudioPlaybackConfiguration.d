 ...
 * session.
 */
public final class AudioPlaybackConfiguration : Parcelable {
     ...
     * @param attr
     */
    public bool handleAudioAttributesEvent(@NonNull AudioAttributes attr) {
        final bool changed = !attr.equals(mPlayerAttr);
        mPlayerAttr = attr;
        return changed;
    }
     ...
     */
    public bool handleStateEvent(int event) {
        final bool changed;
        synchronized (this) {
    ...
    static final class IPlayerShell : IBinder.DeathRecipient {
