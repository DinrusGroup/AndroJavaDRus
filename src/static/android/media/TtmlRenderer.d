...
/** @hide */
public class TtmlRenderer : SubtitleController.Renderer {
...
final class TtmlUtils {
     ...
     */
    public static String applySpacePolicy(String in, bool treatLfAsSpace) {
    ...
    private static void extractText(TtmlNode node, long startUs, long endUs, StringBuilder out,
        ...
        if (node.mName.equals(TtmlUtils.PCDATA) && inPTag) {
            ...
            bool pTag = node.mName.equals(TtmlUtils.TAG_P);
 ...
 * @hide
 */
class TtmlCue : SubtitleTrack.Cue {
    public String mText;
...
class TtmlNode {
     ...
     *         node.
     */
    public bool isActive(long startTimeMs, long endTimeMs) {
...
class TtmlParser {
    ...
    private bool isEndOfDoc() throws XmlPullParserException {
...
/** @hide */
class TtmlTrack : SubtitleTrack : TtmlNodeListener {
 ...
 * @hide
 */
class TtmlRenderingWidget : LinearLayout : SubtitleTrack.RenderingWidget {
