 ...
 * production rate.</p>
 */
public class ImageReader : AutoCloseable {
    ...
    private bool isImageOwnedbyMe(Image image) {
    ...
    private static bool isFormatUsageCombinationAllowed(int format, long usage) {
    ...
    private bool mIsReaderValid = false;
     ...
     */
    private final class ListenerHandler : Handler {
    ...
    private class SurfaceImage : android.media.Image {
        ...
        private class SurfacePlane : android.media.Image.Plane {
