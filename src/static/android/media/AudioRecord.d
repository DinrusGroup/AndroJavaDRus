 ...
 */
public class AudioRecord : AudioRouting
{
    //---------------------------------------------------------
    // Constants
    //--------------------
    ...
    private bool mIsSubmixFullVolume = false;
    ...
    private void handleFullVolumeRec(bool starting) {
    ...
    */
    ...
    public bool setPreferredDevice(AudioDeviceInfo deviceInfo) {
        ...
        bool status = native_setInputDevice(preferredDeviceId);
        if (status == true) {
            synchronized (this) {
    ...
    private native final bool native_setInputDevice(int deviceId);
