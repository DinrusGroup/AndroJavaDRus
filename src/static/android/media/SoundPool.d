 ...
 * resumes.</p>
 */
public class SoundPool : PlayerBase {
    ...
    private final static bool DEBUG = Log.isLoggable(TAG, Log.DEBUG);

    private long mNativeContext; // accessed by native methods

    private EventHandler mEventHandler;
    private SoundPool.OnLoadCompleteListener mOnLoadCompleteListener;
    private bool mHasAppOpsPlayAudio;
     ...
     */
    public native final bool unload(int soundID);
    ...
    private native final void _mute(bool muting);
    ...
    private final class EventHandler : Handler {
