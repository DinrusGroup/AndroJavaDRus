 ...
 */
public final class VolumeShaper : AutoCloseable {
    /* member variables */
    private int mId;
     ...
     */
    public void replace(
            @NonNull Configuration configuration, @NonNull Operation operation, bool join) {
        mId = applyPlayer(
                configuration,
     ...
     * This class : the Java {@code AutoClosable} interface and
     ...
     * by {@link VolumeShaper#replace(Configuration, Operation, bool)
     * VolumeShaper.replace(Configuration, Operation, bool)}
     ...
     */
    public static final class Configuration : Parcelable {
        ...
        private static @Nullable String checkCurveForErrors(
                @Nullable float[] times, @Nullable float[] volumes, bool log) {
            if (times == null) {
        ...
        private static void checkCurveForErrorsAndThrowException(
                @Nullable float[] times, @Nullable float[] volumes, bool log, bool ise) {
        ...
        private static void checkValidVolumeAndThrowException(float volume, bool log) {
            if (log) {
        ...
        private static void clampVolume(float[] volumes, bool log) {
            if (log) {
                for (int i = 0; i < volumes.length; ++i) {
                    if (!(volumes[i] <= 0.f) /* handle nan */) {
                        volumes[i] = 0.f;
        ...
        public static final class Builder {
            ...
            public @NonNull Builder setCurve(@NonNull float[] times, @NonNull float[] volumes) {
                final bool log = (mOptionFlags & OPTION_FLAG_VOLUME_IN_DBFS) != 0;
     ...
     */
    public static final class Operation : Parcelable {
        /**
        ...
        public static final class Builder {
             ...
             * @return the same {@code Builder} instance.
             */
            public @NonNull Builder replace(int id, bool join) {
                mReplaceId = id;
                if (join) {
                    mFlags |= FLAG_JOIN;
                } else {
     ...
     *  Not for public use.
     */
    public static final class State : Parcelable {
