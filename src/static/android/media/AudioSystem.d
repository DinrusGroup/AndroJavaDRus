...
public class AudioSystem
{
     ...
     */
    public static native int muteMicrophone(bool on);
     ...
     */
    public static native bool isMicrophoneMuted();
     ...
     */
    public static native bool isStreamActive(int stream, int inPastMs);
     ...
     */
    public static native bool isStreamActiveRemotely(int stream, int inPastMs);
     ...
     */
    public static native bool isSourceActive(int source);
    ...
    public static native int setMasterMute(bool mute);
    public static native bool getMasterMute();
    public static native int getDevicesForStream(int stream);

    /** @hide returns true if master mono is enabled. */
    public static native bool getMasterMono();
    /** @hide enables or disables the master mono mode. */
    public static native int setMasterMono(bool mono);
    ...
    public static native int setLowRamDevice(bool isLowRamDevice, long totalMemory);
    ...
    public static native int registerPolicyMixes(ArrayList<AudioMix> mixes, bool register);

    public static native int systemReady();

    public static native float getStreamVolumeDB(int stream, int index, int device);

    static bool isOffloadSupported(@NonNull AudioFormat format) {
        return native_is_offload_supported(format.getEncoding(), format.getSampleRate(),
                format.getChannelMask(), format.getChannelIndexMask());
    }

    private static native bool native_is_offload_supported(int encoding, int sampleRate,
    ...
    public static native int setSurroundFormatEnabled(int audioFormat, bool enabled);
     ...
     */
    public static bool isSingleVolume(Context context) {
        bool forceSingleVolume = context.getResources().getBoolean(
