...
/**
 ...
 <ul>
 <li><strong>Do not render the buffer:</strong> Call {@link #releaseOutputBuffer(int, bool)
 releaseOutputBuffer(bufferId, false)}.</li>
 <li><strong>Render the buffer with the default timestamp:</strong> Call {@link
 #releaseOutputBuffer(int, bool) releaseOutputBuffer(bufferId, true)}.</li>
 ...
 <table style="width: 100%;">
  ...
  <tbody class=api>
   ...
   <tr>
    ...
    <td>-</td>
    <td>-</td>
    <td class=fn>{@link #releaseOutputBuffer(int, bool)}</td>
    <td>&#9679;</td>
    <td>&#9679;</td>
    <td>&#9679;</td>
    <td>&#9679;</td>
...
final public class MediaCodec {
    ...
    private bool mHasSurface = false;
    ...
    private MediaCodec(
            @NonNull String name, bool nameIsType, bool encoder) {
        Looper looper;
    ...
    static class PersistentSurface : Surface {
     ...
     */
    public final static class CodecException : IllegalStateException {
     ...
     */
    public final static class CryptoException : RuntimeException {
     ...
     * @throws MediaCodec.CodecException upon codec error.
     */
    public final void releaseOutputBuffer(int index, bool render) {
    ...
    private native final void releaseOutputBuffer(
            int index, bool render, bool updatePTS, long timeNs);
    ...
    @NonNull
    private native final Map<String, Object> getFormatNative(bool input);
    ...
    private final void cacheBuffers(bool input) {
    ...
    private native void native_enableOnFrameRenderedListener(bool enable);
    ...
    @NonNull
    private native final ByteBuffer[] getBuffers(bool input);

    @Nullable
    private native final ByteBuffer getBuffer(bool input, int index);

    @Nullable
    private native final Image getImage(bool input, int index);
    ...
    /** @hide */
    public static class MediaImage : Image {
        private final bool mIsReadOnly;
        ...
        public MediaImage(
                @NonNull ByteBuffer buffer, @NonNull ByteBuffer info, bool readOnly,
        ...
        private class MediaPlane : Plane {
