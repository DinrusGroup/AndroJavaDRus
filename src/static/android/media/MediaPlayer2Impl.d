 ...
 * @hide
 */
public final class MediaPlayer2Impl : MediaPlayer2 {
    static {
    ...
    private bool mScreenOnWhilePlaying;
    private bool mStayAwake;
    ...
    private bool mNextSourcePlayPending = false;
    ...
    private bool mDrmInfoResolved;
    private bool mActiveDrmScheme;
    private bool mDrmConfigAllowed;
    private bool mDrmProvisioningInProgress;
    private bool mPrepareDrmInProgress;
     ...
     * This class : the Java {@code AutoCloseable} interface and
    ...
    private native void setLooping(bool looping);
     ...
     */
    override
    public bool isReversePlaybackSupported() {
        return false;
    }
     ...
     * does not support {@link #setScreenOnWhilePlaying(bool)}.  Setting a
    ...
    private void handleDataSource(bool isCurrent, @NonNull DataSourceDesc dsd, long srcId)
            throws IOException {
        Preconditions.checkNotNull(dsd, "the DataSourceDesc cannot be null");
    ...
    private bool attemptDataSource(
            bool isCurrent, long srcId, ContentResolver resolver, Uri uri) {
    ...
    private void handleDataSource(bool isCurrent, long srcId,
    ...
    private native void nativeHandleDataSourceFD(bool isCurrent, long srcId,
            FileDescriptor fd, long offset, long length) throws IOException;
     ...
     */
    private void handleDataSource(bool isCurrent, long srcId, Media2DataSource dataSource) {
        nativeHandleDataSourceCallback(isCurrent, srcId, dataSource);
    }

    private native void nativeHandleDataSourceCallback(
            bool isCurrent, long srcId, Media2DataSource dataSource);
     ...
     */
    override
    public bool setPreferredDevice(AudioDeviceInfo deviceInfo) {
        if (deviceInfo != null && !deviceInfo.isSink()) {
            return false;
        }
        int preferredDeviceId = deviceInfo != null ? deviceInfo.getId() : 0;
        bool status = native_setOutputDevice(preferredDeviceId);
        if (status == true) {
            synchronized (this) {
    ...
    private void enableNativeRoutingCallbacksLocked(bool enabled) {
    ...
    private native final bool native_setOutputDevice(int deviceId);
    private native final int native_getRoutedDeviceId();
    private native final void native_enableDeviceCallback(bool enabled);
     ...
     * high-level {@link #setScreenOnWhilePlaying(bool)} feature.
     *
     ...
     */
    override
    public void setScreenOnWhilePlaying(bool screenOn) {
    ...
    private void stayAwake(bool awake) {
        if (mWakeLock != null) {
     ...
     */
    override
    public Metadata getMetadata(final bool update_only,
                                final bool apply_filter) {
        Parcel reply = Parcel.obtain();
     ...
     */
    private native bool setParameter(int key, Parcel value);
     ...
     * @return The status code.
     */
    private native final bool native_getMetadata(bool update_only,
                                                    bool apply_filter,
                                                    Parcel reply);
     ...
     */
    public static final class TrackInfoImpl : TrackInfo {
        /**
         * Gets the track type.
     ...
     */
    private static bool availableMimeTypeForExternalSource(String mimeType) {
    ...
    private void selectOrDeselectTrack(int index, bool select)
            throws IllegalStateException {
    ...
    private void selectOrDeselectInbandTrack(int index, bool select)
            throws IllegalStateException {
        Parcel request = Parcel.obtain();
        Parcel reply = Parcel.obtain();
        try {
                   ...
                   ProvisioningNetworkErrorException, ProvisioningServerErrorException
    {
        ...
        bool allDoneWithoutProvisioning = false;
     ...
     */
    public static final class DrmInfoImpl : DrmInfo {
     ...
     */
    public static final class NoDrmSchemeExceptionImpl : NoDrmSchemeException {
    ...
    private static bool setAudioOutputDeviceById(AudioTrack track, int deviceId) {
        if (track == null) {
            return false;
        }
    ...
    @SuppressWarnings("unused")
    private static class StreamEventCallback : AudioTrack.StreamEventCallback {
    ...
    private class ProvisioningThread : Thread {
    ...
    private bool resumePrepareDrm(UUID uuid) {
    ...
    private static final byte[] getByteArrayFromUUID(@NonNull UUID uuid) {
        ...
        for (int i = 0; i < 8; ++i) {
            uuidBytes[i] = cast(byte)(msb >>> (8 * (7 - i)));
            uuidBytes[8 + i] = cast(byte)(lsb >>> (8 * (7 - i)));
        }
     ...
     */
    private bool isVideoScalingModeSupported(int mode) {
        return (mode == VIDEO_SCALING_MODE_SCALE_TO_FIT ||
                mode == VIDEO_SCALING_MODE_SCALE_TO_FIT_WITH_CROPPING);
    }

    /** @hide */
    static class TimeProvider : MediaTimeProvider {
        ...
        private synchronized void notifyTimedEvent(bool refreshTime) {
        ...
        public long getCurrentTimeUs(bool refreshTime, bool monotonic)
                throws IllegalStateException {
            synchronized (this) {
    ...
    private abstract class Task : Runnable {
        ...
        private final bool mNeedToWaitForEventToComplete;
        private DataSourceDesc mDSD;

        public Task (int mediaCallType, bool needToWaitForEventToComplete) {
