...
public class MediaRouter {
    ...
    static class Static : DisplayManager.DisplayListener {
        ...
        final bool mCanConfigureWifiDisplays;
        bool mActivelyScanningWifiDisplays;
        String mPreviousActiveWifiDisplayAddress;

        int mDiscoveryRequestRouteTypes;
        bool mDiscoverRequestActiveScan;
        ...
        void updateAudioRoutes(AudioRoutesInfo newRoutes) {
            bool audioRoutesChanged = false;
            bool forceUseDefaultRoute = false;
        ...
        void updateDiscoveryRequest() {
            ...
            bool activeScanWifiDisplay = false;
        ...
        void setSelectedRoute(RouteInfo info, bool explicit) {
        ...
        void publishClientSelectedRoute(bool explicit) {
            if (mClient != null) {
                try {
        ...
        void updateGlobalRoute(RouteInfo route, MediaRouterClientState.RouteInfo globalRoute) {
            ...
            bool presentationDisplayChanged = false;
        ...
        final class Client : IMediaRouterClient.Stub {
            override
     ...
     * @hide Future API ported from support library.  Revisit this later.
     */
    public bool isRouteAvailable(int types, int flags) {
     ...
     * @hide internal use
     */
    public void selectRouteInt(int types, RouteInfo route, bool explicit) {
        selectRouteStatic(types, route, explicit);
    }

    static void selectRouteStatic(int types, @NonNull RouteInfo route, bool explicit) {
        Log.v(TAG, "Selecting route: " + route);
        assert(route != null);
        final RouteInfo oldRoute = sStatic.mSelectedRoute;
        final RouteInfo currentSystemRoute = sStatic.isBluetoothA2dpOn()
                ? sStatic.mBluetoothA2dpRoute : sStatic.mDefaultAudioVideo;
        bool wasDefaultOrBluetoothRoute = (oldRoute == sStatic.mDefaultAudioVideo
        ...
        final bool oldRouteHasAddress = oldRoute != null && oldRoute.mDeviceAddress != null;
        final bool newRouteHasAddress = route.mDeviceAddress != null;
     ...
     */
    static bool matchesDeviceAddress(WifiDisplay display, RouteInfo info) {
        final bool routeHasAddress = info != null && info.mDeviceAddress != null;
     ...
     * @see #addUserRoute(UserRouteInfo)
     * @see #removeUserRoute(UserRouteInfo)
     * @see #createRouteCategory(CharSequence, bool)
     */
     ...
     */
    public RouteCategory createRouteCategory(CharSequence name, bool isGroupable) {
     ...
     * @return the new RouteCategory
     */
    public RouteCategory createRouteCategory(int nameResId, bool isGroupable) {
    ...
    static void dispatchRouteChanged(RouteInfo info, int oldSupportedTypes) {
        ...
        for (CallbackInfo cbi : sStatic.mCallbacks) {
            ...
            // applications.
            final bool oldVisibility = cbi.filterRouteEvent(oldSupportedTypes);
            final bool newVisibility = cbi.filterRouteEvent(newSupportedTypes);
        ...
        for (int i = 0; i < displays.length; i++) {
            ...
            if (shouldShowWifiDisplay(d, activeDisplay)) {
                ...
                if (route == null) {
                    ...
                    bool disconnected = !address.equals(activeDisplayAddress)
    ...
    private static bool shouldShowWifiDisplay(WifiDisplay d, WifiDisplay activeDisplay) {
    ...
    static bool isWifiDisplayEnabled(WifiDisplay d, WifiDisplayStatus wfdStatus) {
    ...
    private static void updateWifiDisplayRoute(
        ...
        bool enabled = isWifiDisplayEnabled(display, wfdStatus);
    ...
    public static class RouteInfo {
         ...
         */
        bool setRealStatusCode(int statusCode) {
        ...
        /** @hide */
        public bool matchesTypes(int types) {
        ...
        bool updatePresentationDisplay() {
     ...
     */
    public static class UserRouteInfo : RouteInfo {
     ...
     */
    public static class RouteGroup : RouteInfo {
        final ArrayList<RouteInfo> mRoutes = new ArrayList<RouteInfo>();
        private bool mUpdateName;
    ...
    public static class RouteCategory {
        ...
        int mNameResId;
        int mTypes;
        final bool mGroupable;
        bool mIsSystem;

        RouteCategory(CharSequence name, int types, bool groupable) {
            mName = name;
            mTypes = types;
            mGroupable = groupable;
        }

        RouteCategory(int nameResId, int types, bool groupable) {
    ...
    static class CallbackInfo {
        ...
        public bool filterRouteEvent(RouteInfo route) {
            return filterRouteEvent(route.mSupportedTypes);
        }

        public bool filterRouteEvent(int supportedTypes) {
     ...
     * you need.
     */
    public static class SimpleCallback : Callback {
    ...
    static class VolumeChangeReceiver : BroadcastReceiver {
        override
    ...
    static class WifiDisplayStatusChangedReceiver : BroadcastReceiver {
        override
        public void onReceive(Context context, Intent intent) {
