...
public class MediaFile {
    ...
    private static void addFileType(String extension, int fileType, String mimeType,
            int mtpFormatCode, bool primaryType) {
    ...
    private static bool isWMAEnabled() {
    ...
    private static bool isWMVEnabled() {
    ...
    public static bool isAudioFileType(int fileType) {
    ...
    public static bool isVideoFileType(int fileType) {
    ...
    public static bool isImageFileType(int fileType) {
    ...
    public static bool isRawImageFileType(int fileType) {
        return (fileType >= FIRST_RAW_IMAGE_FILE_TYPE &&
                fileType <= LAST_RAW_IMAGE_FILE_TYPE);
    }

    public static bool isPlayListFileType(int fileType) {
        return (fileType >= FIRST_PLAYLIST_FILE_TYPE &&
                fileType <= LAST_PLAYLIST_FILE_TYPE);
    }

    public static bool isDrmFileType(int fileType) {
