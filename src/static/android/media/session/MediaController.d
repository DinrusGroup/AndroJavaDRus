...
public final class MediaController {
    ...
    private bool mCbRegistered = false;
     ...
     */
    public bool dispatchMediaButtonEvent(@NonNull KeyEvent keyEvent) {
     ...
     * @hide
     */
    public bool dispatchMediaButtonEventAsSystemService(@NonNull KeyEvent keyEvent) {
        return dispatchMediaButtonEventInternal(true, keyEvent);
    }

    private bool dispatchMediaButtonEventInternal(bool asSystemService,
     ...
     * @hide
     */
    public bool controlsSameSession(MediaController other) {
    ...
    private bool removeCallbackLocked(Callback cb) {
        bool success = false;
    ...
    private final static class CallbackStub : ISessionControllerCallback.Stub {
    ...
    private final static class MessageHandler : Handler {
