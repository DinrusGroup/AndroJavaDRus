...
public final class MediaSessionManager {
     ...
     * @hide
     */
    public void dispatchMediaKeyEvent(@NonNull KeyEvent keyEvent, bool needWakeLock) {
    ...
    private void dispatchMediaKeyEventInternal(bool asSystemService, @NonNull KeyEvent keyEvent,
            bool needWakeLock) {
        try {
     ...
     * @hide
     */
    public void dispatchVolumeKeyEvent(@NonNull KeyEvent keyEvent, int stream, bool musicOnly) {
    ...
    private void dispatchVolumeKeyEventInternal(bool asSystemService, @NonNull KeyEvent keyEvent,
            int stream, bool musicOnly) {
        try {
     ...
     */
    public bool isTrustedForMediaControl(@NonNull RemoteUserInfo userInfo) {
        if (userInfo == null) {
     ...
     * @hide
     */
    public bool createSession2(@NonNull SessionToken2 token) {
        if (token == null) {
            return false;
        }
        try {
    ...
    public interface OnMediaKeyListener {
         ...
         */
        bool onMediaKey(KeyEvent event);
    }
    ...
    private static final class OnVolumeKeyLongPressListenerImpl
            : IOnVolumeKeyLongPressListener.Stub {
    ...
    private static final class OnMediaKeyListenerImpl : IOnMediaKeyListener.Stub {
        ...
        public void onMediaKey(KeyEvent event, ResultReceiver result) {
            ...
            mHandler.post(new Runnable() {
                override
                public void run() {
                    bool handled = mListener.onMediaKey(event);
    ...
    private static final class CallbackImpl : ICallback.Stub {
