 ...
 * set with {@link #setCallback(Callback)} and {@link #setActive(bool)
...
public final class MediaSession {
     ...
     * the system but will not be published until {@link #setActive(bool)
    ...
    public abstract static class Callback {
         ...
         */
        public bool onMediaButtonEvent(@NonNull Intent mediaButtonIntent) {
        ...
        private void handleMediaPlayPauseKeySingleTapIfPending() {
            ...
            bool canPlay = (validActions & (PlaybackState.ACTION_PLAY_PAUSE
                        | PlaybackState.ACTION_PLAY)) != 0;
            bool canPause = (validActions & (PlaybackState.ACTION_PLAY_PAUSE
     ...
     * @hide
     */
    public static class CallbackStub : ISessionCallback.Stub {
    ...
    private class CallbackMessageHandler : Handler {
