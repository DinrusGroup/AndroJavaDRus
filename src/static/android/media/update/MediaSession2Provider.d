 ...
 * @hide
 */
public interface MediaSession2Provider : TransportControlProvider {
    void close_impl();
    ...
    interface CommandGroupProvider {
        ...
        bool hasCommand_impl(SessionCommand2 command);
        bool hasCommand_impl(int code);
    ...
    interface CommandButtonProvider {
        ...
        interface BuilderProvider {
            ...
            Builder setEnabled_impl(bool enabled);
    ...
    interface ControllerInfoProvider {
        ...
        bool isTrusted_impl();
        int hashCode_impl();
        bool equals_impl(Object obj);
        String toString_impl();
    }

    interface BuilderBaseProvider<T : MediaSession2, C : SessionCallback> {
