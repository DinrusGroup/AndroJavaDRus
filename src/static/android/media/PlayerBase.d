...
public abstract class PlayerBase {
    ...
    /** Debug app ops */
    private static final bool DEBUG_APP_OPS = false;
    private static final bool DEBUG = DEBUG_APP_OPS || false;
    ...
    void baseUpdateAudioAttributes(@NonNull AudioAttributes attr) {
        ...
        synchronized (mLock) {
            bool attributesChanged = (mAttributes != attr);
            mAttributes = attr;
     ...
     */
    void updateAppOpsPlayAudio_sync(bool attributesChanged) {
     ...
     */
    abstract void playerSetVolume(bool muting, float leftVolume, float rightVolume);
    ...
    abstract int playerSetAuxEffectSendLevel(bool muting, float level);
     ...
     */
    private static class IPlayerWrapper : IPlayer.Stub {
        private final WeakReference<PlayerBase> mWeakPB;
     ...
     */
    public static class PlayerIdCard : Parcelable {
