...
/** @hide */
public class WebVttRenderer : SubtitleController.Renderer {
 ...
 */
class UnstyledTextExtractor : Tokenizer.OnTokenListener {
...
class Tokenizer {
    ...
    class DataTokenizer : TokenizerPhase {
        ...
        private bool replaceEscape(String escape, String replacement, int pos) {
    ...
    class TagTokenizer : TokenizerPhase {
        private bool mAtAnnotation;
...
/** @hide */
class TextTrackCue : SubtitleTrack.Cue {
...
/** @hide */
class WebVttTrack : SubtitleTrack : WebVttCueListener {
 ...
 * @hide
 */
class WebVttRenderingWidget : ViewGroup : SubtitleTrack.RenderingWidget {
    ...
    private void layoutCue(
        ...
        final bool cueSnapToLines = cue.mSnapToLines;
    ...
    private int calculateLinePosition(CueLayout cueBox) {
        ...
        final bool snapToLines = cue.mSnapToLines;
        final bool autoPosition = (linePosition == null);
     ...
     */
    private static class RegionLayout : LinearLayout {
     ...
     * single line of text.
     */
    private static class CueLayout : LinearLayout {
        ...
        public CueLayout(
            ...
            // TODO: Add support for vertical text.
            final bool horizontal = cue.mWritingDirection
                    == TextTrackCue.WRITING_DIRECTION_HORIZONTAL;
     ...
     */
    private static class SpanLayout : SubtitleView {
