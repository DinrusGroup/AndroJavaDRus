...
public class Ringtone {
     ...
     */
    private final bool mAllowRemote;
    ...
    private bool mIsLooping = false;
    private float mVolume = 1.0f;
    private final Object mPlaybackSettingsLock = new Object();

    /** {@hide} */
    public Ringtone(Context context, bool allowRemote) {
        mContext = context;
    ...
    public static String getTitle(
            Context context, Uri uri, bool followSettingsUri, bool allowRemote) {
    ...
    private bool playFallbackRingtone() {
    ...
    class MyOnCompletionListener : MediaPlayer.OnCompletionListener {
        override
