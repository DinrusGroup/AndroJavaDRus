...
public final class MediaCodecInfo {
    ...
    private static class Feature {
        ...
        public Feature(String name, int value, bool def) {
            mName = name;
            mValue = value;
            mDefault = def;
        }
    ...
    public static final class CodecCapabilities {
         ...
         */
        public final bool isFeatureSupported(String name) {
         ...
         */
        public final bool isFeatureRequired(String name) {
        ...
        private bool checkFeature(String name, int flags) {
         ...
         */
        public final bool isFormatSupported(MediaFormat format) {
        ...
        private static bool supportsBitrate(
        ...
        private bool supportsProfileLevel(int profile, Integer level) {
            for (CodecProfileLevel pl: profileLevels) {
                ...
                if (mMime.equalsIgnoreCase(MediaFormat.MIMETYPE_VIDEO_HEVC)) {
                    ...
                    bool checkingHighTier = (level & CodecProfileLevel.HEVCHighTierLevels) != 0;
        ...
        /* package private */ CodecCapabilities(
                CodecProfileLevel[] profLevs, int[] colFmts, bool encoder, int flags,
    ...
    public static final class AudioCapabilities {
        ...
        private bool supports(Integer sampleRate, Integer inputChannels) {
        ...
        /** @hide */
        public bool supportsFormat(MediaFormat format) {
            Map<String, Object> map = format.getMap();
    ...
    public static final class VideoCapabilities {
        ...
        private bool mAllowMbOverride; // allow XML to override calculated limits
         ...
         */
        public bool areSizeAndRateSupported(
        ...
        private bool supports(Integer width, Integer height, Number rate) {
            bool ok = true;
        ...
        /** @hide */
        public Range<Rational> getAspectRatioRange(bool blocks) {
    ...
    public static final class EncoderCapabilities {
         ...
         */
        public bool isBitrateModeSupported(int mode) {
            for (Feature feat: bitrates) {
                if (mode == feat.mValue) {
