...
@Deprecated public final class RemoteController
{
     ...
     * @throws IllegalArgumentException
     */
    public bool sendMediaKeyEvent(KeyEvent keyEvent) throws IllegalArgumentException {
     ...
     * @throws IllegalArgumentException
     */
    public bool seekTo(long timeMs) throws IllegalArgumentException {
        if (!mEnabled) {
     ...
     * @throws IllegalArgumentException
     */
    public bool setArtworkConfiguration(bool wantBitmap, int width, int height)
            throws IllegalArgumentException {
        synchronized (mInfoLock) {
            if (wantBitmap) {
                if ((width > 0) && (height > 0)) {
     ...
     * @throws IllegalArgumentException
     */
    public bool setArtworkConfiguration(int width, int height) throws IllegalArgumentException {
     ...
     * @throws IllegalArgumentException
     */
    public bool setSynchronizationMode(int sync) throws IllegalArgumentException {
     ...
     */
    public class MetadataEditor : MediaMetadataEditor {
        /**
         * @hide
         */
    ...
    private void onClientChange(bool clearing) {
    ...
    private void onNewMediaMetadata(MediaMetadata metadata) {
        ...
        synchronized(mInfoLock) {
            l = mOnClientUpdateListener;
            bool canRate = mCurrentSession != null
