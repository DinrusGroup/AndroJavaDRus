 ...
 * @hide
 */
public final class MidiDeviceServer : Closeable {
    ...
    abstract private class PortClient : IBinder.DeathRecipient {
    ...
    private class InputPortClient : PortClient {
    ...
    private class OutputPortClient : PortClient {
    ...
    /* package */ MidiDeviceServer(IMidiManager midiManager, MidiReceiver[] inputPortReceivers,
        ...
        mInputPortOpen = new bool[mInputPortCount];
