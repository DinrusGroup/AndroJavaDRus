...
@Deprecated public class Metadata
{
     ...
     */
    private bool scanAllRecords(Parcel parcel, int bytesLeft) {
        int recCount = 0;
        bool error = false;
     ...
     * {@hide}
     */
    public bool parse(Parcel parcel) {
     ...
     */
    public bool has(final int metadataId) {
        if (!checkMetadataId(metadataId)) {
    ...
    /**
     * Get the bool value indicated by key
     */
    public bool getBoolean(final int key) {
     ...
     **/
    private bool checkMetadataId(final int val) {
