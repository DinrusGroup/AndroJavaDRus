...
/** @hide */
public class MediaHTTPConnection : IMediaHTTPConnection.Stub {
    ...
    private bool mAllowCrossDomainRedirect = true;
    private bool mAllowCrossProtocolRedirect = true;
    ...
    private bool filterOutInternalHeaders(String key, String val) {
    ...
    private static final bool isLocalHost(URL url) {
        if (url == null) {
            return false;
        }
    ...
    private void seekTo(long offset) throws IOException {
        ...
        try {
            ...
            while (true) {
                ...
                bool sameProtocol = mURL.getProtocol().equals(url.getProtocol());
                if (!mAllowCrossProtocolRedirect && !sameProtocol) {
                    throw new NoRouteToHostException("Cross-protocol redirects are disallowed");
                }
                bool sameHost = mURL.getHost().equals(url.getHost());
