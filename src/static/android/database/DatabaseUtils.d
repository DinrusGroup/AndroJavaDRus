...
public class DatabaseUtils {
     ...
     * @hide
     */
    public static bool queryIsEmpty(SQLiteDatabase db, String table) {
    ...
    public static class InsertHelper {
        ...
        private SQLiteStatement getStatement(bool allowReplace) throws SQLException {
            if (allowReplace) {
         ...
         * error occurred
         */
        private long insertInternal(ContentValues values, bool allowReplace) {
    ...
    public static int getSqlStatementType(String sql) {
        ...
        if (prefixSql.equals("SEL")) {
            ...
            bool isRollbackToSavepoint = sql.toUpperCase(Locale.ROOT).contains(" TO ");
