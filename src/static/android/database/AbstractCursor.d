 ...
 */
public abstract class AbstractCursor : CrossProcessCursor {
    ...
    override
    abstract public bool isNull(int column);
    ...
    override
    public final bool moveToPosition(int position) {
        ...
        bool result = onMove(mPos, position);
        if (result == false) {
            mPos = -1;
        } else {
            mPos = position;
    ...
    override
    public final bool move(int offset) {
        return moveToPosition(mPos + offset);
    }

    override
    public final bool moveToFirst() {
        return moveToPosition(0);
    }

    override
    public final bool moveToLast() {
        return moveToPosition(getCount() - 1);
    }

    override
    public final bool moveToNext() {
        return moveToPosition(mPos + 1);
    }

    override
    public final bool moveToPrevious() {
        return moveToPosition(mPos - 1);
    }

    override
    public final bool isFirst() {
        return mPos == 0 && getCount() != 0;
    }

    override
    public final bool isLast() {
        int cnt = getCount();
        return mPos == (cnt - 1) && cnt != 0;
    }

    override
    public final bool isBeforeFirst() {
        if (getCount() == 0) {
            return true;
        }
        return mPos == -1;
     ...
     * @param selfChange
     */
    protected void onChange(bool selfChange) {
     ...
     */
    @Deprecated
    protected bool isFieldUpdated(int columnIndex) {
        return false;
    }
     ...
     */
    protected static class SelfContentObserver : ContentObserver {
