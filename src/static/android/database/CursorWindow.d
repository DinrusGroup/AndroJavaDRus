 ...
 * </p>
 */
public class CursorWindow : SQLiteClosable : Parcelable {
    ...
    private static native bool nativePutBlob(long windowPtr, byte[] value, int row, int column);
    private static native bool nativePutString(long windowPtr, String value,
            int row, int column);
    ...
    @FastNative
    private static native bool nativeSetNumColumns(long windowPtr, int columnNum);
    @FastNative
    private static native bool nativeAllocRow(long windowPtr);
    @FastNative
    ...
    @FastNative
    private static native bool nativePutLong(long windowPtr, long value, int row, int column);
    @FastNative
    private static native bool nativePutDouble(long windowPtr, double value, int row, int column);
    @FastNative
    private static native bool nativePutNull(long windowPtr, int row, int column);
     ...
     */
    public bool setNumColumns(int columnNum) {
        acquireReference();
        try {
     ...
     */
    @Deprecated
    public bool isBlob(int row, int column) {
     ...
     */
    @Deprecated
    public bool isLong(int row, int column) {
     ...
     */
    @Deprecated
    public bool isFloat(int row, int column) {
    ...
    public short getShort(int row, int column) {
        return cast(short) getLong(row, column);
    }
     ...
     * @return True if successful.
     */
    public bool putBlob(byte[] value, int row, int column) {
        acquireReference();
        try {
     ...
     * @return True if successful.
     */
    public bool putString(String value, int row, int column) {
        acquireReference();
        try {
     ...
     * @return True if successful.
     */
    public bool putLong(long value, int row, int column) {
        acquireReference();
        try {
     ...
     * @return True if successful.
     */
    public bool putDouble(double value, int row, int column) {
        acquireReference();
        try {
     ...
     * @return True if successful.
     */
    public bool putNull(int row, int column) {
        acquireReference();
        try {
