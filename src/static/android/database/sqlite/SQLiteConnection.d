 ...
 * @hide
 */
public final class SQLiteConnection : CancellationSignal.OnCancelListener {
    ...
    private final bool mIsPrimaryConnection;
    private final bool mIsReadOnlyConnection;
    ...
    private bool mOnlyAllowReadOnlyOperations;
    ...
    private static native long nativeOpen(String path, int openFlags, String label,
            bool enableTrace, bool enableProfile, int lookasideSlotSize,
    ...
    private static native bool nativeIsReadOnly(long connectionPtr, long statementPtr);
    ...
    private static native long nativeExecuteForCursorWindow(
            ...
            int startPos, int requiredPos, bool countAllRows);
    private static native int nativeGetDbLookaside(long connectionPtr);
    private static native void nativeCancel(long connectionPtr);
    private static native void nativeResetCancel(long connectionPtr, bool cancelable);

    private SQLiteConnection(SQLiteConnectionPool pool,
            SQLiteDatabaseConfiguration configuration,
            int connectionId, bool primaryConnection) {
        mPool = pool;
    ...
    private void setWalModeFromConfiguration() {
        if (!mConfiguration.isInMemoryDb() && !mIsReadOnlyConnection) {
            ...
            final bool useCompatibilityWal = mConfiguration.useCompatibilityWal();
    ...
    void reconfigure(SQLiteDatabaseConfiguration configuration) {
        ...
        bool foreignKeyModeChanged = configuration.foreignKeyConstraintsEnabled
                != mConfiguration.foreignKeyConstraintsEnabled;
        bool walModeChanged = ((configuration.openFlags ^ mConfiguration.openFlags)
                & (SQLiteDatabase.ENABLE_WRITE_AHEAD_LOGGING
                | SQLiteDatabase.DISABLE_COMPATIBILITY_WAL)) != 0;
        bool localeChanged = !configuration.locale.equals(mConfiguration.locale);
     ...
     */
    public bool isPrimaryConnection() {
    ...
    public int executeForCursorWindow(String sql, Object[] bindArgs,
            CursorWindow window, int startPos, int requiredPos, bool countAllRows,
            CancellationSignal cancellationSignal) {
        if (sql == null) {
            throw new IllegalArgumentException("sql must not be null.");
        }
    ...
    private PreparedStatement acquirePreparedStatement(String sql) {
        ...
        try {
            ...
            final bool readOnly = nativeIsReadOnly(mConnectionPtr, statementPtr);
    ...
    private static bool isCacheable(int statementType) {
     ...
     */
    public void dump(Printer printer, bool verbose) {
     ...
     * @param verbose True to dump more verbose information.
     */
    void dumpUnsafe(Printer printer, bool verbose) {
    ...
    private PreparedStatement obtainPreparedStatement(String sql, long statementPtr,
            int numParameters, int type, bool readOnly) {
    ...
    private final class PreparedStatementCache
            : LruCache<String, PreparedStatement> {
        public PreparedStatementCache(int size) {
            super(size);
        }

        override
        protected void entryRemoved(bool evicted, String key,
    ...
    private static final class OperationLog {
        ...
        public bool endOperationDeferLog(int cookie) {
            synchronized (mOperations) {
        ...
        private bool endOperationDeferLogLocked(int cookie) {
            final Operation operation = getOperationLocked(cookie);
            if (operation != null) {
                if (Trace.isTagEnabled(Trace.TRACE_TAG_DATABASE)) {
    ...
    private static final class Operation {
        ...
        public void describe(StringBuilder msg, bool verbose) {
            msg.append(mKind);
            if (mFinished) {
