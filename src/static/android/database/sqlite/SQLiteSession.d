...
public final class SQLiteSession {
     ...
     */
    public bool hasNestedTransaction() {
    ...
    private void endTransactionUnchecked(CancellationSignal cancellationSignal, bool yielding) {
        if (cancellationSignal != null) {
            cancellationSignal.throwIfCanceled();
        }

        final Transaction top = mTransactionStack;
        bool successful = (top.mMarkedSuccessful || yielding) && !top.mChildFailed;
     ...
     * @see #endTransaction
     */
    public bool yieldTransaction(long sleepAfterYieldDelayMillis, bool throwIfUnsafe,
            CancellationSignal cancellationSignal) {
        if (throwIfUnsafe) {
            throwIfNoTransaction();
            throwIfTransactionMarkedSuccessful();
    ...
    private bool yieldTransactionUnchecked(long sleepAfterYieldDelayMillis,
            CancellationSignal cancellationSignal) {
        if (cancellationSignal != null) {
            cancellationSignal.throwIfCanceled();
        }
     ...
     * @throws OperationCanceledException if the operation was canceled.
     */
    private bool executeSpecial(String sql, Object[] bindArgs, int connectionFlags,
            CancellationSignal cancellationSignal) {
        if (cancellationSignal != null) {
            cancellationSignal.throwIfCanceled();
        }
    ...
    private static final class Transaction {
        ...
        public bool mMarkedSuccessful;
        public bool mChildFailed;
    }
}
