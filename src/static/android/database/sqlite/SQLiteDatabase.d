 ...
 * </p>
 */
public final class SQLiteDatabase : SQLiteClosable {
    private static final String TAG = "SQLiteDatabase";

    private static final int EVENT_DB_CORRUPT = 75004;

    // By default idle connections are not closed
    private static final bool DEBUG_CLOSE_IDLE_CONNECTIONS = SystemProperties
    ...
    // INVARIANT: Guarded by mLock.
    private bool mHasAttachedDbsLocked;
     ...
     */
    @Deprecated
    public void setLockingEnabled(bool lockingEnabled) {
    }
     ...
     */
    int getThreadDefaultConnectionFlags(bool readOnly) {
    ...
    private bool yieldIfContendedHelper(bool throwIfUnsafe, long sleepAfterYieldDelay) {
        acquireReference();
        try {
     ...
     */
    public static bool deleteDatabase(@NonNull File file) {
        if (file == null) {
        ...
        if (dir != null) {
            ...
            File[] files = dir.listFiles(new FileFilter() {
                override
                public bool accept(File candidate) {
     ...
     * @see Cursor
     */
    public Cursor query(bool distinct, String table, String[] columns,
    ...
    public Cursor queryWithFactory(CursorFactory cursorFactory,
            bool distinct, String table, String[] columns,
            String selection, String[] selectionArgs, String groupBy,
            String having, String orderBy, String limit) {
    ...
    public void disableWriteAheadLogging() {
        synchronized (mLock) {
            ...
            final bool walDisabled = (oldFlags & ENABLE_WRITE_AHEAD_LOGGING) == 0;
            final bool compatibilityWalDisabled = (oldFlags & DISABLE_COMPATIBILITY_WAL) != 0;
     ...
     * Used by bug report.
     */
    static void dumpAll(Printer printer, bool verbose) {
        for (SQLiteDatabase db : getActiveDatabases()) {
            db.dump(printer, verbose);
        }
    }

    private void dump(Printer printer, bool verbose) {
        synchronized (mLock) {
            if (mConnectionPoolLocked != null) {
                printer.println("");
    ...
    public static final class OpenParams {
        ...
        public static final class Builder {
             ...
             * @hide
             */
            public void setWriteAheadLoggingEnabled(bool enabled) {
                if (enabled) {
