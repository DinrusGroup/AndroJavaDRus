 ...
 */
public class ContentObservable : Observable<ContentObserver> {
    ...
    /**
     * Invokes {@link ContentObserver#dispatchChange(bool)} on each observer.
     * <p>
    ...
    /**
     * Invokes {@link ContentObserver#dispatchChange(bool, Uri)} on each observer.
     ...
     */
    public void dispatchChange(bool selfChange, Uri uri) {
     ...
     */
    @Deprecated
    public void notifyChange(bool selfChange) {
        synchronized(mObservers) {
            for (ContentObserver observer : mObservers) {
