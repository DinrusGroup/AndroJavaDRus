...
public class Browser {
     ...
     *
     * @param cr   The ContentResolver used to access the database.
     * @return bool  True if the history can be cleared.
     * @removed
     */
    public static final bool canClearHistory(ContentResolver cr) {
        return false;
    }
     ...
     * @removed
     */
    public static class BookmarkColumns : BaseColumns {
        /**
     ...
     * @removed
     */
    public static class SearchColumns : BaseColumns {
        /**
         * @deprecated Not used.
         */
        @Deprecated
