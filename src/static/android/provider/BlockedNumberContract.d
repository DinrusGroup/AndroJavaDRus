...
public class BlockedNumberContract {
     ...
     */
    @WorkerThread
    public static bool isBlocked(Context context, String phoneNumber) {
        try {
     ...
     */
    public static bool canCurrentUserBlockNumbers(Context context) {
        try {
            final Bundle res = context.getContentResolver().call(
    ...
    public static class SystemContract {
         ...
         */
        public static bool shouldSystemBlockNumber(Context context, String phoneNumber,
                Bundle extras) {
            try {
                final Bundle res = context.getContentResolver().call(
         ...
         */
        public static bool shouldShowEmergencyCallNotification(Context context) {
            try {
                final Bundle res = context.getContentResolver().call(
         ...
         */
        public static bool getEnhancedBlockSetting(Context context, String key) {
         ...
         */
        public static void setEnhancedBlockSetting(Context context, String key, bool value) {
            Bundle extras = new Bundle();
            extras.putString(EXTRA_ENHANCED_SETTING_KEY, key);
        ...
        public static class BlockSuppressionStatus {
            public final bool isSuppressed;
            /**
             * Timestamp in milliseconds from epoch.
             */
            public final long untilTimestampMillis;

            public BlockSuppressionStatus(bool isSuppressed, long untilTimestampMillis) {
