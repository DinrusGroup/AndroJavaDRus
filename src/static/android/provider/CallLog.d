...
public class CallLog {
    ...
    private static final bool VERBOSE_LOG = false; // DON'T SUBMIT WITH TRUE.
     ...
     */
    public static class Calls : BaseColumns {
        /**
        ...
        public static Uri addCall(CallerInfo ci, Context context, String number,
                ...
                Long dataUsage, bool addForAllUsers, UserHandle userToBeInsertedTo) {
        ...
        /** @hide */
        public static bool shouldHaveSharedCallLogEntries(Context context,
