...
public final class CalendarContract {
     ...
     *
     */
    protected interface SyncColumns : CalendarSyncColumns {
        /**
     ...
     */
    public static final class CalendarEntity : BaseColumns, SyncColumns, CalendarColumns {
     ...
     * </ul>
     */
    public static final class Calendars : BaseColumns, SyncColumns, CalendarColumns {
     ...
     * </ul>
     */
    public static final class Attendees : BaseColumns, AttendeesColumns, EventsColumns {
    ...
    protected interface EventsColumns {
         ...
         * <P>Type: INTEGER (bool, readonly)</P>
         */
     ...
     */
    public static final class EventsEntity : BaseColumns, SyncColumns, EventsColumns {
        /**
     ...
     */
    public static final class Events : BaseColumns, SyncColumns, EventsColumns,
            CalendarColumns {
     ...
     */
    public static final class Instances : BaseColumns, EventsColumns, CalendarColumns {
     ...
     */
    public static final class CalendarCache : CalendarCacheColumns {
        /**
     ...
     * @hide
     */
    public static final class CalendarMetaData : CalendarMetaDataColumns, BaseColumns {
     ...
     */
    public static final class EventDays : EventDaysColumns {
        public static final Uri CONTENT_URI = Uri.parse("content://" + AUTHORITY
     ...
     * </ul>
     */
    public static final class Reminders : BaseColumns, RemindersColumns, EventsColumns {
     ...
     * state of a reminder.
     */
    public static final class CalendarAlerts : BaseColumns,
         ...
         * @hide
         */
        public static final bool alarmExists(ContentResolver cr, long eventId,
     ...
     */
    public static final class Colors : ColorsColumns {
        /**
         * @hide
         */
     ...
     * </ul>
     */
   public static final class ExtendedProperties : BaseColumns,
     ...
     * @hide
     */
    public static final class EventsRawTimes : BaseColumns, EventsRawTimesColumns {
