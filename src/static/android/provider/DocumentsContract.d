...
public final class DocumentsContract {
    ...
    public final static class Root {
         ...
         *      android.database.ContentObserver, bool)
         * @hide
         */
    ...
    /**
     * Optional bool flag included in a directory {@link Cursor#getExtras()}
    ...
    /**
     * Optional result (I'm thinking bool) answer to a question.
     * {@hide}
     */
     ...
     */
    public static bool isDocumentUri(Context context, @Nullable Uri uri) {
    ...
    /** {@hide} */
    public static bool isRootUri(Context context, @Nullable Uri uri) {
        if (isContentUri(uri) && isDocumentsProvider(context, uri.getAuthority())) {
            final List<String> paths = uri.getPathSegments();
    ...
    /** {@hide} */
    public static bool isContentUri(@Nullable Uri uri) {
    ...
    private static bool isDocumentsProvider(Context context, String authority) {
    ...
    /** {@hide} */
    public static bool isManageMode(Uri uri) {
    ...
    /** {@hide} */
    public static bool isChildDocument(ContentProviderClient client, Uri parentDocumentUri,
     ...
     */
    public static bool deleteDocument(ContentResolver resolver, Uri documentUri)
            throws FileNotFoundException {
        final ContentProviderClient client = resolver.acquireUnstableContentProviderClient(
                documentUri.getAuthority());
        try {
     ...
     */
    public static bool removeDocument(ContentResolver resolver, Uri documentUri,
     ...
     */
    public static final class Path : Parcelable {
