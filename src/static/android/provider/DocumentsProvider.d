...
public abstract class DocumentsProvider : ContentProvider {
     ...
     */
    public bool isChildDocument(String parentDocumentId, String documentId) {
        return false;
    }
     ...
     * android.database.ContentObserver, bool)} with
     ...
     * android.database.ContentObserver, bool)} with that Uri to send change
     * notifications.
     *
    ...
    private Bundle callUnchecked(String method, String arg, Bundle extras)
        ...
        if (METHOD_IS_CHILD_DOCUMENT.equals(method)) {
            ...
            final bool isTreeUri = isTreeUri(documentUri);
     ...
     * @hide
     */
    public static bool mimeTypeMatches(String filter, String test) {
        if (test == null) {
            return false;
