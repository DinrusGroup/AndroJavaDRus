...
public class SettingsValidators {
    ...
    public static final Validator PACKAGE_NAME_VALIDATOR = new Validator() {
        ...
        private bool isStringPackageName(String value) {
        ...
        private bool isSubpartValidForPackageName(String subpart) {
            if (subpart.length() == 0) return false;
            bool isValidSubpart = Character.isLetter(subpart.charAt(0));
    ...
    public interface Validator {
         ...
         */
        bool validate(@Nullable String value);
    }

    public static final class DiscreteValueValidator : Validator {
    ...
    public static final class InclusiveIntegerRangeValidator : Validator {
    ...
    public static final class InclusiveFloatRangeValidator : Validator {
    ...
    public static final class ComponentNameListValidator : Validator {
    ...
    public static final class PackageNameListValidator : Validator {
        private final String mSeparator;
