...
public final class Settings {
     ...
     * intent as a bool to indicate if it should be enabled.
     */
    ...
    private static bool sInSystemServer = false;
    ...
    /** @hide */
    public static bool isInSystemServer() {
        synchronized (sInSystemServerLock) {
            return sInSystemServer;
        }
    }

    public static class SettingNotFoundException : AndroidException {
     ...
     */
    public static class NameValueTable : BaseColumns {
        public static final String NAME = "name";
        public static final String VALUE = "value";

        protected static bool putString(ContentResolver resolver, Uri uri,
    ...
    private static final class GenerationTracker {
        ...
        public bool isGenerationChanged() {
    ...
    private static class NameValueCache {
        ...
        public bool putStringForUser(ContentResolver cr, String name, String value,
                String tag, bool makeDefault, final int userHandle) {
            try {
        ...
        public String getStringForUser(ContentResolver cr, String name, final int userHandle) {
            final bool isSelf = (userHandle == UserHandle.myUserId());
            ...
            if (mCallGetCommand != null) {
                try {
                    ...
                    bool needsGenerationTracker = false;
                    synchronized (NameValueCache.this) {
     ...
     */
    public static final class System : NameValueTable {
         ...
         */
        public static bool putString(ContentResolver resolver, String name, String value) {
            return putStringForUser(resolver, name, value, resolver.getUserId());
        }

        /** @hide */
        public static bool putStringForUser(ContentResolver resolver, String name, String value,
                int userHandle) {
            if (MOVED_TO_SECURE.contains(name)) {
                Log.w(TAG, "Setting " + name + " has moved from android.provider.Settings.System"
         ...
         * @return true if the value was set, false on database errors
         */
        public static bool putInt(ContentResolver cr, String name, int value) {
            return putIntForUser(cr, name, value, cr.getUserId());
        }

        /** @hide */
        public static bool putIntForUser(ContentResolver cr, String name, int value,
                int userHandle) {
         ...
         * @return true if the value was set, false on database errors
         */
        public static bool putLong(ContentResolver cr, String name, long value) {
            return putLongForUser(cr, name, value, cr.getUserId());
        }

        /** @hide */
        public static bool putLongForUser(ContentResolver cr, String name, long value,
                int userHandle) {
         ...
         * @return true if the value was set, false on database errors
         */
        public static bool putFloat(ContentResolver cr, String name, float value) {
            return putFloatForUser(cr, name, value, cr.getUserId());
        }

        /** @hide */
        public static bool putFloatForUser(ContentResolver cr, String name, float value,
                int userHandle) {
        ...
        public static void adjustConfigurationForUser(ContentResolver cr, Configuration outConfig,
                int userHandle, bool updateSettingsIfEmpty) {
         ...
         */
        public static bool putConfiguration(ContentResolver cr, Configuration config) {
            return putConfigurationForUser(cr, config, cr.getUserId());
        }

        /** @hide */
        public static bool putConfigurationForUser(ContentResolver cr, Configuration config,
                int userHandle) {
        ...
        /** @hide */
        public static bool hasInterestingConfigurationChanges(int changes) {
        ...
        @Deprecated
        public static bool getShowGTalkServiceStatus(ContentResolver cr) {
         ...
         */
        @Deprecated
        public static bool getShowGTalkServiceStatusForUser(ContentResolver cr,
                int userHandle) {
        ...
        /** @deprecated - Do not use */
        @Deprecated
        public static void setShowGTalkServiceStatus(ContentResolver cr, bool flag) {
         ...
         */
        @Deprecated
        public static void setShowGTalkServiceStatusForUser(ContentResolver cr, bool flag,
                int userHandle) {
        ...
        private static final Validator FONT_SCALE_VALIDATOR = new Validator() {
            override
            public bool validate(@Nullable String value) {
                try {
         ...
         * pending. The value is bool (1 or 0).
         * @hide
         */
       ...
       /**
         ...
         */
        public static bool canWrite(Context context) {
     ...
     */
    public static final class Secure : NameValueTable {
        // NOTE: If you add new settings here, be sure to add them to
        ...
        private static bool sIsSystemProcess;
        ...
        public static String getStringForUser(ContentResolver resolver, String name,
            ...
            if (MOVED_TO_LOCK_SETTINGS.contains(name)) {
                ...
                if (sLockSettings != null && !sIsSystemProcess) {
                    ...
                    bool isPreMnc = application != null
        ...
        /** @hide */
        public static bool putStringForUser(@NonNull ContentResolver resolver,
                @NonNull String name, @Nullable String value, @Nullable String tag,
                bool makeDefault, @UserIdInt int userHandle) {
        ...
        public static bool putString(@NonNull ContentResolver resolver,
                @NonNull String name, @Nullable String value, @Nullable String tag,
                bool makeDefault) {
         ...
         *
         * @see #putString(ContentResolver, String, String, String, bool)
         *
         * @hide
         */
        @SystemApi
        ...
        /**
         * Whether to show the IME when a hard keyboard is connected. This is a bool that
         ...
         * The value is bool (1 or 0), where 1 means automatic routing is disabled,
         ...
         */
        @Deprecated
        public static final bool isLocationProviderEnabled(ContentResolver cr, String provider) {
         ...
         */
        @Deprecated
        public static final bool isLocationProviderEnabledForUser(
         ...
         * @return true if the value was set, false on database errors
         *
         * @deprecated use {@link LocationManager#setProviderEnabledForUser(String, bool, int)}
         * @hide
         */
        @Deprecated
        public static final bool setLocationProviderEnabledForUser(ContentResolver cr,
                String provider, bool enabled, int userId) {
         ...
         *             {@link LocationManager#setLocationEnabledForUser(bool, int)}.
         *             To enable/disable a specific location provider, use
         *             {@link LocationManager#setProviderEnabledForUser(String, bool, int)}.
         */
        @Deprecated
        private static bool setLocationModeForUser(
            ...
            synchronized (mLocationSettingsLock) {
                ...
                bool nlpSuccess = Settings.Secure.setLocationProviderEnabledForUser(
                        cr, LocationManager.NETWORK_PROVIDER, network, userId);
                bool gpsSuccess = Settings.Secure.setLocationProviderEnabledForUser(
        ...
        private static final int getLocationModeForUser(ContentResolver cr, int userId) {
            synchronized (mLocationSettingsLock) {
                bool gpsEnabled = Settings.Secure.isLocationProviderEnabledForUser(
                        cr, LocationManager.GPS_PROVIDER, userId);
                bool networkEnabled = Settings.Secure.isLocationProviderEnabledForUser(
     ...
     */
    public static final class Global : NameValueTable {
        // NOTE: If you add new settings here, be sure to add them to
       ...
       public static final String TETHER_DUN_APN = "tether_dun_apn";
         ...
         *
         * Integer values are interpreted as bool, and the absence of an explicit setting
       ...
       public static final String OVERLAY_DISPLAY_DEVICES = "overlay_display_devices";
         ...
         *
         * <pre>
         * vibration_disabled                (bool)
         * animation_disabled                (bool)
         * soundtrigger_disabled             (bool)
         * fullbackup_deferred               (bool)
         * keyvaluebackup_deferred           (bool)
         * firewall_disabled                 (bool)
         * gps_mode                          (int)
         * adjust_brightness_disabled        (bool)
         ...
         *
         * <pre>
         * battery_tip_enabled              (bool)
         * summary_enabled                  (bool)
         * battery_saver_tip_enabled        (bool)
         * high_usage_enabled               (bool)
         * high_usage_app_count             (int)
         * high_usage_period_ms             (long)
         * high_usage_battery_draining      (int)
         * app_restriction_enabled          (bool)
         * reduced_battery_enabled          (bool)
        ...
        */
         ...
         *
         * <pre>
         * smart_linkify_enabled                    (bool)
         * system_textclassifier_enabled            (bool)
         * model_dark_launch_enabled                (bool)
         * smart_selection_enabled                  (bool)
         * smart_text_share_enabled                 (bool)
         * smart_linkify_enabled                    (bool)
         * smart_select_animation_enabled           (bool)
         ...
         * The following keys are supported:
         * <pre>
         * track_cpu_times_by_proc_state (bool)
         * track_cpu_active_cluster_time (bool)
         * read_binary_cpu_time          (bool)
         ...
         *
         * Type: bool (0 for false, 1 for true)
         * Default: 1
         *
         * @hide
         */
         ...
         * <pre>
         * enabled                  (bool)
         * disable_tilt_to_wake     (bool)
         * disable_touch_to_wake    (bool)
         * </pre>
         * Type: string
         * @hide
         */
        ...
        /** @hide */ public static bool isValidZenMode(int value) {
            switch (value) {
         ...
         * @return true if the value was set, false on database errors
         */
        public static bool putString(ContentResolver resolver,
                String name, String value) {
        ...
        /** @hide */
        public static bool putStringForUser(ContentResolver resolver,
         ...
         *
         * Supported keys:
         * compatibility_wal_supported      (bool)
         * wal_syncmode       (String)
         *
         * @hide
         */
     ...
     * @hide
     */
    public static final class Bookmarks : BaseColumns
    {
     ...
     * @hide
     */
    public static bool isCallingPackageAllowedToWriteSettings(Context context, int uid,
            String callingPackage, bool throwException) {
     ...
     * @hide
     */
    public static bool checkAndNoteWriteSettingsOperation(Context context, int uid,
            String callingPackage, bool throwException) {
        return isCallingPackageAllowedToPerformAppOpsProtectedOperation(context, uid,
                callingPackage, throwException, AppOpsManager.OP_WRITE_SETTINGS,
     ...
     * @hide
     */
    public static bool checkAndNoteChangeNetworkStateOperation(Context context, int uid,
            String callingPackage, bool throwException) {
     ...
     * @hide
     */
    public static bool isCallingPackageAllowedToDrawOverlays(Context context, int uid,
            String callingPackage, bool throwException) {
        return isCallingPackageAllowedToPerformAppOpsProtectedOperation(context, uid,
     ...
     * @hide
     */
    public static bool checkAndNoteDrawOverlaysOperation(Context context, int uid, String
            callingPackage, bool throwException) {
        return isCallingPackageAllowedToPerformAppOpsProtectedOperation(context, uid,
                callingPackage, throwException, AppOpsManager.OP_SYSTEM_ALERT_WINDOW,
     ...
     * @hide
     */
    public static bool isCallingPackageAllowedToPerformAppOpsProtectedOperation(Context context,
            int uid, String callingPackage, bool throwException, int appOpsOpCode, String[]
            permissions, bool makeNote) {
