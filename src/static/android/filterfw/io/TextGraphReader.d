 ...
 * @hide
 */
public class TextGraphReader : GraphReader {
    ...
    private class ImportPackageCommand : Command {
    ...
    private class AddLibraryCommand : Command {
    ...
    private class AllocateFilterCommand : Command {
    ...
    private class InitFilterCommand : Command {
    ...
    private KeyValueMap readKeyValueAssignments(PatternScanner scanner,
        ...
        final Pattern boolPattern = Pattern.compile("true|false");
        ...
        while (!scanner.atEnd() && !(endPattern != null && scanner.peek(endPattern))) {
            switch (state) {
                ...
                case STATE_VALUE:
                    ...
                    } else if ((curValue = scanner.tryEat(boolPattern)) != null) {
