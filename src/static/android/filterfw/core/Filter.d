...
public abstract class Filter {
     ...
     */
    public static final bool isAvailable(String filterName) {
     ...
     */
    protected void setWaitsOnInputPort(String portName, bool waits) {
     ...
     */
    protected void setWaitsOnOutputPort(String portName, bool waits) {
    ...
    synchronized final bool canProcess() {
    ...
    private final void addAndSetFinalPorts(KeyValueMap values) {
        ...
        for (Field field : filterClass.getDeclaredFields()) {
            if ((annotation = field.getAnnotation(GenerateFinalPort.class)) != null) {
                ...
                bool hasDefault = generator.hasDefault();
    ...
    private final Frame wrapInputValue(String inputName, Object value) {
        ...
        bool shouldSerialize = !(value instanceof Number)
    ...
    private final bool inputConditionsMet() {
    ...
    private final bool outputConditionsMet() {
    ...
    private final bool filterMustClose() {
        for (InputPort inputPort : mInputPorts.values()) {
