...
public class FrameFormat {
    ...
    public bool hasMetaKey(String key) {
        return mMetaData != null ? mMetaData.containsKey(key) : false;
    }

    public bool hasMetaKey(String key, Class expectedClass) {
    ...
    public bool isCompatibleWith(FrameFormat specification) {
        // Check base type
    ...
    public bool mayBeCompatibleWith(FrameFormat specification) {
        // Check base type
        if (specification.getBaseType() != TYPE_UNSPECIFIED
    ...
    bool isReplaceableBy(FrameFormat format) {
