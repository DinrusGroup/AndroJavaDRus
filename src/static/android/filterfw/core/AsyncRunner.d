 ...
 * @hide
 */
public class AsyncRunner : GraphRunner{
    ...
    private class AsyncRunnerTask : AsyncTask<SyncRunner, Void, RunnerResult> {
    ...
    override
    synchronized public bool isRunning() {
        return isProcessing;
    }
    ...
    synchronized private void setRunning(bool running) {
