...
public final class InCallAdapter {
     ...
     */
    public void rejectCall(String callId, bool rejectWithMessage, String textMessage) {
        try {
     ...
     * {@link InCallService} should invoke the {@link #postDialContinue(String,bool)} method.
     *
     * @param callId The unique ID of the call for which postdial string playing should continue.
     * @param proceed Whether or not to continue with the post-dial sequence.
     */
    public void postDialContinue(String callId, bool proceed) {
        try {
     ...
     */
    public void putExtra(String callId, String key, bool value) {
        try {
     ...
     */
    public void turnProximitySensorOff(bool screenOnImmediately) {
        try {
     ...
     */
    public void respondToRttRequest(String callId, int id, bool accept) {
        try {
