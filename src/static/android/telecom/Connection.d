...
public abstract class Connection : Conferenceable {
    ...
    private static final bool PII_DEBUG = Log.isLoggable(android.util.Log.DEBUG);
     ...
     * @hide
     */
    public bool can(int capability) {
    ...
    private static String capabilitiesToStringInternal(int capabilities, bool isLong) {
    ...
    private static String propertiesToStringInternal(int properties, bool isLong) {
        StringBuilder builder = new StringBuilder();
        builder.append("[");
        if (isLong) {
    ...
    public abstract static class Listener {
        ...
        public void onRingbackRequested(Connection c, bool ringback) {}
        ...
        public void onAudioModeIsVoipChanged(Connection c, bool isVoip) {}
        ...
        /** @hide */
        public void onConferenceSupportedChanged(Connection c, bool isConferenceSupported) {}
    ...
    public static abstract class VideoProvider {
         ...
         */
        private final class VideoProviderHandler : Handler {
         ...
         */
        private final class VideoProviderBinder : IVideoProvider.Stub {
     ...
     * on its behalf.
     */
    public final bool isRingbackRequested() {
     ...
     */
    public final bool getAudioModeIsVoip() {
     ...
     * to send an {@link #onPostDialContinue(bool)} signal.
     *
     * @param remaining The DTMF character sequence remaining to be emitted once the
     *         {@link #onPostDialContinue(bool)} is received, including any "wait" characters
     ...
     */
    public final void setRingbackRequested(bool ringback) {
        checkImmutable();
     ...
     */
    public final void setAudioModeIsVoip(bool isVoip) {
        checkImmutable();
     ...
     * @hide
     */
    public final bool setConference(Conference conference) {
        checkImmutable();
    ...
    /**
     * Adds a bool extra to this {@code Connection}.
     *
     * @param key The extra key.
     * @param value The value.
     * @hide
     */
    public final void putExtra(String key, bool value) {
     ...
     */
    public void onPostDialContinue(bool proceed) {}
    ...
    private static class FailureSignalingConnection : Connection {
        private bool mImmutable = false;
     ...
     * @hide
     */
    protected void notifyConferenceSupportedChanged(bool isConferenceSupported) {
        for (Listener l : mListeners) {
