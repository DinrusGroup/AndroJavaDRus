...
public abstract class InCallService : Service {
    ...
    private final class InCallServiceBinder : IInCallService.Stub {
        override
        ...
        override
        public void bringToForeground(bool showDialpad) {
            mHandler.obtainMessage(MSG_BRING_TO_FOREGROUND, showDialpad ? 1 : 0, 0).sendToTarget();
        }

        override
        public void onCanAddCallChanged(bool canAddCall) {
     ...
     */
    public void onBringToForeground(bool showDialpad) {
    }
    ...
    public static abstract class VideoCall {
        ...
        /**
         * The {@link InCallService} : this class to provide a means of receiving callbacks
