 ...
 * @hide
 */
public final class ParcelableCall : Parcelable {
    ...
    private final bool mIsVideoCallProviderChanged;
    private final IVideoProvider mVideoCallProvider;
    private VideoCallImpl mVideoCall;
    private final bool mIsRttCallChanged;
    ...
    public ParcelableCall(
            ...
            bool isVideoCallProviderChanged,
            IVideoProvider videoCallProvider,
            bool isRttCallChanged,
    ...
    public bool getIsRttCallChanged() {
     ...
     */
    public bool isVideoCallProviderChanged() {
    ...
    public static final Parcelable.Creator<ParcelableCall> CREATOR =
        ...
        public ParcelableCall createFromParcel(Parcel source) {
            ...
            bool isVideoCallProviderChanged = source.readByte() == 1;
            IVideoProvider videoCallProvider =
            ...
            bool isRttCallChanged = source.readByte() == 1;
    ...
    public void writeToParcel(Parcel destination, int flags) {
        ...
        destination.writeByte(cast(byte) (mIsVideoCallProviderChanged ? 1 : 0));
        ...
        destination.writeByte(cast(byte) (mIsRttCallChanged ? 1 : 0));
