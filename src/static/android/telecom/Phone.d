...
public final class Phone {
    ...
    public abstract static class Listener {
         ...
         */
        public void onBringToForeground(Phone phone, bool showDialpad) { }
         ...
         */
        public void onCanAddCallChanged(Phone phone, bool canAddCall) { }
    ...
    final void internalBringToForeground(bool showDialpad) {
        fireBringToForeground(showDialpad);
    }

    final void internalSetCanAddCall(bool canAddCall) {
     ...
     */
    public final void setMuted(bool state) {
     ...
     * @hide
     */
    public final void setProximitySensorOff(bool screenOnImmediately) {
    ...
    private void fireBringToForeground(bool showDialpad) {
        for (Listener listener : mListeners) {
            listener.onBringToForeground(this, showDialpad);
        }
    }

    private void fireCanAddCallChanged(bool canAddCall) {
        for (Listener listener : mListeners) {
