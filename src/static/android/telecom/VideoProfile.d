 ...
 */
public class VideoProfile : Parcelable {
     ...
     */
    public static bool isAudioOnly(@VideoState int videoState) {
     ...
     */
    public static bool isVideo(@VideoState int videoState) {
        return hasState(videoState, VideoProfile.STATE_TX_ENABLED)
                || hasState(videoState, VideoProfile.STATE_RX_ENABLED)
     ...
     */
    public static bool isTransmissionEnabled(@VideoState int videoState) {
        return hasState(videoState, VideoProfile.STATE_TX_ENABLED);
    }
     ...
     */
    public static bool isReceptionEnabled(@VideoState int videoState) {
     ...
     */
    public static bool isBidirectional(@VideoState int videoState) {
     ...
     */
    public static bool isPaused(@VideoState int videoState) {
     ...
     */
    private static bool hasState(@VideoState int videoState, @VideoState int state) {
     ...
     */
    public static final class CameraCapabilities : Parcelable {
         ...
         */
        private final bool mZoomSupported;
        ...
        public static final Parcelable.Creator<CameraCapabilities> CREATOR =
                new Parcelable.Creator<CameraCapabilities> () {
                    ...
                    public CameraCapabilities createFromParcel(Parcel source) {
                        ...
                        bool supportsZoom = source.readByte() != 0;
        ...
        public void writeToParcel(Parcel dest, int flags) {
            ...
            dest.writeByte(cast(byte) (isZoomSupported() ? 1 : 0));
