 ...
 */
public final class PhoneAccount : Parcelable {
    ...
    public static class Builder {
         ...
         * @hide
         */
        public Builder setIsEnabled(bool isEnabled) {
     ...
     * @hide
     */
    public bool hasAudioRoutes(int routes) {
    ...
    public void writeToParcel(Parcel out, int flags) {
        ...
        out.writeByte(cast(byte) (mIsEnabled ? 1 : 0));
