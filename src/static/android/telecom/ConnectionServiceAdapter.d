 ...
 * @hide
 */
final class ConnectionServiceAdapter : DeathRecipient {
    /**
     ...
     */
    void setRingbackRequested(String callId, bool ringback) {
        for (IConnectionServiceAdapter adapter : mAdapters) {
            try {
     ...
     */
    void setIsVoipAudioMode(String callId, bool isVoip) {
        for (IConnectionServiceAdapter adapter : mAdapters) {
            try {
     ...
     */
    void putExtra(String callId, String key, bool value) {
