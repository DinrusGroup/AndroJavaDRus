 ...
 */
@SystemApi
public class ParcelableCallAnalytics : Parcelable {
    /** {@hide} */
    public static final class VideoEvent : Parcelable {
    ...
    public static final class AnalyticsEvent : Parcelable {
    ...
    public static final class EventTiming : Parcelable {
    ...
    private final bool isAdditionalCall;

    // true if the call was interrupted by an incoming or outgoing call.
    private final bool isInterrupted;
    ...
    private final bool isEmergencyCall;
    ...
    private final bool isCreatedFromExistingConnection;
    ...
    public ParcelableCallAnalytics(long startTimeMillis, long callDurationMillis, int callType,
            bool isAdditionalCall, bool isInterrupted, int callTechnologies,
            int callTerminationCode, bool isEmergencyCall, String connectionService,
            bool isCreatedFromExistingConnection, List<AnalyticsEvent> analyticsEvents,
    ...
    /** {@hide} */
    public void setIsVideoCall(bool isVideoCall) {
    ...
    public bool isCreatedFromExistingConnection() {
    ...
    private static void writeBooleanAsByte(Parcel out, bool b) {
        out.writeByte(cast(byte) (b ? 1 : 0));
    }

    private static bool readByteAsBoolean(Parcel in) {
