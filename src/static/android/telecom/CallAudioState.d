 ...
 *  routing and mute.
 */
public final class CallAudioState : Parcelable {
    /** @hide */
     ...
     * {@link #ROUTE_SPEAKER}
     */
    public CallAudioState(bool muted, @CallAudioRoute int route,
    ...
    /** @hide */
    @TestApi
    public CallAudioState(bool isMuted, @CallAudioRoute int route,
            @CallAudioRoute int supportedRouteMask,
    ...
    public static final Parcelable.Creator<CallAudioState> CREATOR =
        ...
        public CallAudioState createFromParcel(Parcel source) {
            bool isMuted = source.readByte() == 0 ? false : true;
    ...
    public void writeToParcel(Parcel destination, int flags) {
        destination.writeByte(cast(byte) (isMuted ? 1 : 0));
