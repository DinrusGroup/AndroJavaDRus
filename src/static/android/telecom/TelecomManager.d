...
public class TelecomManager {
    ...
    /**
     * Optional extra for {@link android.content.Intent#ACTION_CALL} containing a bool that
    ...
    /**
     * Optional extra for {@link #ACTION_INCOMING_CALL} containing a bool to indicate that the
    ...
    /**
     * A bool extra, which when set on the {@link Intent#ACTION_CALL} intent or on the bundle
    ...
    /**
     * A bool meta-data value indicating whether an {@link InCallService} : an
    ...
    /**
     * A bool meta-data value indicating whether an {@link InCallService} : ringing.
    ...
    /**
     * A bool meta-data value indicating whether an {@link InCallService} wants to be informed of
    ...
    /**
     * The bool indicated by this extra controls whether or not a call is eligible to undergo
     ...
     * @hide
     */
    public List<PhoneAccountHandle> getCallCapablePhoneAccounts(bool includeDisabledAccounts) {
        try {
            if (isServiceConnected()) {
     ...
     * @hide
     */
    public bool setDefaultDialer(String packageName) {
        try {
            if (isServiceConnected()) {
     ...
     */
    @RequiresPermission(android.Manifest.permission.READ_PHONE_STATE)
    public bool isVoiceMailNumber(PhoneAccountHandle accountHandle, String number) {
        try {
            if (isServiceConnected()) {
     ...
     */
    @RequiresPermission(android.Manifest.permission.MODIFY_PHONE_STATE)
    public bool handleMmi(String dialString) {
     ...
     */
    @RequiresPermission(android.Manifest.permission.MODIFY_PHONE_STATE)
    public bool handleMmi(String dialString, PhoneAccountHandle accountHandle) {
        ITelecomService service = getTelecomService();
        if (service != null) {
            try {
     ...
     */
    @RequiresPermission(android.Manifest.permission.READ_PHONE_STATE)
    public void showInCallScreen(bool showDialpad) {
        ITelecomService service = getTelecomService();
        if (service != null) {
            try {
     ...
     * </ul>
     * <p>
     * An app which : the self-managed {@link ConnectionService} API uses
    ...
    @SystemApi
    @RequiresPermission(android.Manifest.permission.MODIFY_PHONE_STATE)
    public void enablePhoneAccount(PhoneAccountHandle handle, bool isEnabled) {
        ITelecomService service = getTelecomService();
        if (service != null) {
            try {
     ...
     *      otherwise.
     */
    public bool isIncomingCallPermitted(PhoneAccountHandle phoneAccountHandle) {
     ...
     *      otherwise.
     */
    public bool isOutgoingCallPermitted(PhoneAccountHandle phoneAccountHandle) {
        ITelecomService service = getTelecomService();
        if (service != null) {
            try {
    ...
    private bool isServiceConnected() {
        bool isConnected = getTelecomService() != null;
        if (!isConnected) {
