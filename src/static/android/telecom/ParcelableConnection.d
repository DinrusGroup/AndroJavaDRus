 ...
 * @hide
 */
public final class ParcelableConnection : Parcelable {
    ...
    private final bool mRingbackRequested;
    private final bool mIsVoipAudioMode;
    ...
    public ParcelableConnection(
            ...
            int videoState,
            bool ringbackRequested,
            bool isVoipAudioMode,
    ...
    public bool getIsVoipAudioMode() {
    ...
    public static final Parcelable.Creator<ParcelableConnection> CREATOR =
        ...
        public ParcelableConnection createFromParcel(Parcel source) {
            ...
            bool ringbackRequested = source.readByte() == 1;
            bool audioModeIsVoip = source.readByte() == 1;
    ...
    public void writeToParcel(Parcel destination, int flags) {
        ...
        destination.writeByte(cast(byte) (mRingbackRequested ? 1 : 0));
        destination.writeByte(cast(byte) (mIsVoipAudioMode ? 1 : 0));
