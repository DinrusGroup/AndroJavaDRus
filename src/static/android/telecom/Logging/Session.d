...
public class Session {
    ...
    public static class Info : Parcelable {
    ...
    private bool mIsStartedFromActiveSession = false;
    ...
    public Session(String sessionId, String shortMethodName, long startTimeMs,
            bool isStartedFromActiveSession, String ownerInfo) {
    ...
    public bool isStartedFromActiveSession() {
    ...
    public String getFullMethodPath(bool truncatePath) {
        StringBuilder sb = new StringBuilder();
        getFullMethodPath(sb, truncatePath);
        return sb.toString();
    }

    private synchronized void getFullMethodPath(StringBuilder sb, bool truncatePath) {
    ...
    private bool isSessionExternal() {
