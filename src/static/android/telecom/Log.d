...
public class Log {
    ...
    public static bool DEBUG = isLoggable(android.util.Log.DEBUG);
    public static bool INFO = isLoggable(android.util.Log.INFO);
    public static bool VERBOSE = isLoggable(android.util.Log.VERBOSE);
    public static bool WARN = isLoggable(android.util.Log.WARN);
    public static bool ERROR = isLoggable(android.util.Log.ERROR);

    private static final bool FORCE_LOGGING = false; /* STOP SHIP if true */
    private static final bool USER_BUILD = Build.IS_USER;
     ...
     */
    private static bool sIsUserExtendedLoggingEnabled = false;
     ...
     */
    public static void setIsExtendedLoggingEnabled(bool isExtendedLoggingEnabled) {
