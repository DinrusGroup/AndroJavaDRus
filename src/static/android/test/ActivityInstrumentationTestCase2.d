 ...
 */
@Deprecated
public abstract class ActivityInstrumentationTestCase2<T : Activity>
        : ActivityTestCase {
    Class<T> mActivityClass;
    bool mInitialTouchMode = false;
     ...
     * {@link #setActivityIntent(Intent)} and/or {@link #setActivityInitialTouchMode(bool)}
     ...
     * <p><b>NOTE:</b> Activities under test may not be started from within the UI thread.
     * If your test method is annotated with {@link android.test.UiThreadTest}, then you must call
     * {@link #setActivityInitialTouchMode(bool)} from {@link #setUp()}.
     *
     * @param initialTouchMode true if the Activity should be placed into "touch mode" when started
     */
    public void setActivityInitialTouchMode(bool initialTouchMode) {
