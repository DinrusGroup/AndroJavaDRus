...
public class TestCaseUtil {
    ...
    public static List<? : Test> getTests(Test test, bool flatten) {
        return getTests(test, flatten, new HashSet<Class!(T)>());
    }

    private static List<? : Test> getTests(Test test, bool flatten,
            Set<Class!(T)> seen) {
