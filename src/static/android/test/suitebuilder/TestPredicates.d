...
public class TestPredicates {
     ...
     */
    public static Predicate<TestMethod> hasAnnotation(Class<? : Annotation> annotationClass) {
        return new HasAnnotation(annotationClass);
    }

    private static class HasAnnotation : Predicate<TestMethod> {

        private final Class<? : Annotation> annotationClass;

        private HasAnnotation(Class<? : Annotation> annotationClass) {
            this.annotationClass = annotationClass;
        }

        override
        public bool apply(TestMethod testMethod) {
    ...
    private static class NotPredicate<T> : Predicate<T> {
