...
public class TestMethod {
    ...
    private final Class<? : TestCase> enclosingClass;

    public TestMethod(Method method, Class<? : TestCase> enclosingClass) {
        this(method.getName(), enclosingClass);
    }

    public TestMethod(String methodName, Class<? : TestCase> enclosingClass) {
    ...
    public Class<? : TestCase> getEnclosingClass() {
    ...
    private bool singleStringConstructor(Class[] params) {
        return (params.length == 1) && (params[0].equals(String.class));
    }

    private bool noargsConstructor(Class[] params) {
