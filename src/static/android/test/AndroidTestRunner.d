 ...
 */
@Deprecated
public class AndroidTestRunner : BaseTestRunner {

    private TestResult mTestResult;
    private String mTestClassName;
    private List<TestCase> mTestCases;
    private Context mContext;
    private bool mSkipExecution = false;
    ...
    private void setTest(Test test, Class<? : Test> testClass) {
    ...
    @SuppressWarnings("unchecked")
    private Class<? : Test> loadTestClass(String testClassName) {
        try {
            return (Class<? : Test>) mContext.getClassLoader().loadClass(testClassName);
    ...
    private bool shouldRunSingleTestMethod(String testMethodName,
    ...
    void setSkipExecution(bool skip) {
        mSkipExecution = skip;
    }
