 ...
 */
@Deprecated
public abstract class ActivityTestCase : InstrumentationTestCase {
     ...
     */
    protected void scrubClass(final Class!(T) testCaseClass)
    throws IllegalAccessException {
        final Field[] fields = getClass().getDeclaredFields();
        for (Field field : fields) {
            final Class!(T) fieldClass = field.getDeclaringClass();
