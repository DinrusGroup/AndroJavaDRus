 ...
 */
@Deprecated
public class InstrumentationTestCase : TestCase {
     ...
     */
    public final <T : Activity> T launchActivity(
            String pkg,
            Class<T> activityCls,
            Bundle extras) {
    ...
    public final <T : Activity> T launchActivityWithIntent(
            String pkg,
            Class<T> activityCls,
            Intent intent) {
    ...
    protected void runTest() throws Throwable {
        ...
        if (method.isAnnotationPresent(UiThreadTest.class)) {
            ...
            final bool repetitive = isRepetitive;
    ...
    private void runMethod(Method runMethod, int tolerance, bool isRepetitive) throws Throwable {
