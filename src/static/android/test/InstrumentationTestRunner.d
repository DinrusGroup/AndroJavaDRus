 ...
 */
@Deprecated
public class InstrumentationTestRunner : Instrumentation : TestSuiteProvider {
    ...
    private bool mDebug;
    private bool mJustCount;
    private bool mSuiteAssignmentMode;
    private int mTestCount;
    private String mPackageOfTests;
    private bool mCoverage;
    ...
    private bool getBooleanArgument(Bundle arguments, String tag) {
    ...
    */
    private Predicate<TestMethod> getAnnotationPredicate(String annotationClassName) {
        Class<? : Annotation> annotationClass = getAnnotationClass(annotationClassName);
     ...
     */
    private Class<? : Annotation> getAnnotationClass(String annotationClassName) {
        if (annotationClassName == null) {
            return null;
        }
        try {
           Class!(T) annotationClass = Class.forName(annotationClassName);
    ...
    private void generateCoverageReport() {
        ...
        try {
            Class!(T) emmaRTClass = Class.forName("com.vladium.emma.rt.RT");
            Method dumpCoverageMethod = emmaRTClass.getMethod("dumpCoverageData",
                    coverageFile.getClass(), bool.class, bool.class);
    ...
    private class StringResultPrinter : ResultPrinter {
     ...
     */
    private class SuiteAssignmentPrinter : TestListener {

        private Bundle mTestResult;
        private long mStartTime;
        private long mEndTime;
        private bool mTimingValid;
     ...
     */
    private class WatcherResultPrinter : TestListener {
