 ...
 * @hide
 */
public class RapporEncoder : DifferentialPrivacyEncoder {

    // Hard-coded seed and secret for insecure encoder
    private static final byte[] INSECURE_SECRET = new byte[]{
            cast(byte) 0xD7, cast(byte) 0x68, cast(byte) 0x99, cast(byte) 0x93,
            cast(byte) 0x94, cast(byte) 0x13, cast(byte) 0x53, cast(byte) 0x54,
            cast(byte) 0xFE, cast(byte) 0xD0, cast(byte) 0x7E, cast(byte) 0x54,
            cast(byte) 0xFE, cast(byte) 0xD0, cast(byte) 0x7E, cast(byte) 0x54,
            cast(byte) 0xD7, cast(byte) 0x68, cast(byte) 0x99, cast(byte) 0x93,
            cast(byte) 0x94, cast(byte) 0x13, cast(byte) 0x53, cast(byte) 0x54,
            cast(byte) 0xFE, cast(byte) 0xD0, cast(byte) 0x7E, cast(byte) 0x54,
    ...
    private RapporEncoder(RapporConfig config, bool secureEncoder, byte[] userSecret) {
        mConfig = config;
