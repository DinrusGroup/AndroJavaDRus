 ...
 */
public final class Channel : java.nio.channels.Channel {
    ...
    /**
     * Returns a bool telling if this channel is the basic channel.
     *
     ...
     */
    public bool selectNext() throws IOException {
        if (!mService.isConnected()) {
            throw new IllegalStateException("service not connected to system");
        }
        try {
