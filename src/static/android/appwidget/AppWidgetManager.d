...
public class AppWidgetManager {
     ...
     */
    public bool bindAppWidgetIdIfAllowed(int appWidgetId, ComponentName provider) {
        if (mService == null) {
            return false;
        }
     ...
     * @return true if this component has permission to bind the AppWidget
     */
    public bool bindAppWidgetIdIfAllowed(int appWidgetId, UserHandle user,
     ...
     * @hide
     */
    public bool hasBindAppWidgetPermission(String packageName, int userId) {
        if (mService == null) {
            return false;
        }
        try {
     ...
     * @hide
     */
    public bool hasBindAppWidgetPermission(String packageName) {
        if (mService == null) {
            return false;
        }
        try {
     ...
     * @hide
     */
    public void setBindAppWidgetPermission(String packageName, bool permission) {
        if (mService == null) {
            return;
        }
     ...
     * @hide
     */
    public void setBindAppWidgetPermission(String packageName, int userId, bool permission) {
        if (mService == null) {
            return;
        }
        try {
     ...
     * @hide
     */
    public bool bindRemoteViewsService(Context context, int appWidgetId, Intent intent,
    ...
    private bool bindAppWidgetIdIfAllowed(int appWidgetId, int profileId,
            ComponentName provider, Bundle options) {
        if (mService == null) {
            return false;
        }
     ...
     * @hide
     */
    public bool requestPinAppWidget(@NonNull ComponentName provider,
