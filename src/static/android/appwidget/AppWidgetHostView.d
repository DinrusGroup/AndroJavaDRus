...
public class AppWidgetHostView : FrameLayout {
     ...
     */
    public void updateAppWidgetSize(Bundle newOptions, int minWidth, int minHeight, int maxWidth,
            int maxHeight, bool ignorePadding) {
        if (newOptions == null) {
     ...
     * @hide
     */
    protected void applyRemoteViews(RemoteViews remoteViews, bool useAsyncIfPossible) {
        bool recycled = false;
        View content = null;
    ...
    private void applyContent(View content, bool recycled, Exception exception) {
        if (content == null) {
    ...
    private class ViewApplyListener : RemoteViews.OnViewAppliedListener {
        private final RemoteViews mViews;
        private final bool mIsReapply;
        private final int mLayoutId;

        public ViewApplyListener(RemoteViews views, int layoutId, bool isReapply) {
            mViews = views;
            mLayoutId = layoutId;
    ...
    void viewDataChanged(int viewId) {
        ...
        if ((v != null) && (v instanceof AdapterView!(T))) {
            AdapterView!(T) adapterView = (AdapterView!(T)) v;
