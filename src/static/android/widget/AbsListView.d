 ...
 */
public abstract class AbsListView : AdapterView<ListAdapter> : TextWatcher,
    ...
    private static final bool PROFILE_SCROLLING = false;
    private bool mScrollProfilingStarted = false;

    private static final bool PROFILE_FLINGING = false;
    ...
    final bool[] mIsScrap = new bool[1];
    ...
    private void updateOnScreenCheckedViews() {
        ...
        final bool useActivated = getContext().getApplicationInfo().targetSdkVersion
     ...
     * <p>
     * If the adapter backing this list : {@link SectionIndexer}, the
     ...
     */
    public void setFastScrollEnabled(final bool enabled) {
    ...
    private void setFastScrollerEnabledUiThread(bool enabled) {
        if (mFastScroll != null) {
     ...
     */
    public void setFastScrollAlwaysVisible(final bool alwaysShow) {
    ...
    private void setFastScrollerAlwaysVisibleUiThread(bool alwaysShow) {
        if (mFastScroll != null) {
     ...
     * @see #setFastScrollAlwaysVisible(bool)
     */
     ...
     */
    override
    protected bool isVerticalScrollBarHidden() {
     ...
     * @attr ref android.R.styleable#AbsListView_smoothScrollbar
     */
    public void setSmoothScrollbarEnabled(bool enabled) {
     ...
     * @see Filterable
     */
    public void setTextFilterEnabled(bool textFilterEnabled) {
     ...
     */
    public void setStackFromBottom(bool stackFromBottom) {
    ...
    static class SavedState : BaseSavedState {
        ...
        public void writeToParcel(Parcel out, int flags) {
            ...
            out.writeByte(cast(byte) (inActionMode ? 1 : 0));
    ...
    protected bool setFrame(int left, int top, int right, int bottom) {
        final bool changed = super.setFrame(left, top, right, bottom);
        ...
        if (changed) {
            ...
            final bool visible = getWindowVisibility() == View.VISIBLE;
     ...
     * @param outMetadata an array of at least 1 bool where the first entry
    ...
    class ListItemAccessibilityDelegate : AccessibilityDelegate {
        override
        ...
        override
        public bool performAccessibilityAction(View host, int action, Bundle arguments) {
    ...
    private bool isItemClickable(View view) {
    ...
    private void positionSelector(int position, View sel, bool manageHotspot, float x, float y) {
        final bool positionChanged = position != mSelectorPosition;
        if (position != INVALID_POSITION) {
        ...
        final bool isChildViewEnabled = sel.isEnabled();
    ...
    protected void dispatchDraw(Canvas canvas) {
        ...
        final bool drawSelectorOnTop = mDrawSelectorOnTop;
     ...
     */
    @TestApi
    public final bool shouldDrawSelector() {
     ...
     * @attr ref android.R.styleable#AbsListView_drawSelectorOnTop
     */
    public void setDrawSelectorOnTop(bool onTop) {
    ...
    void keyPressed() {
        ...
        if (selector != null && (isFocused() || touchModeDrawsInPressedState())
            ...
            final bool longClickable = isLongClickable();
    ...
    override
    public bool verifyDrawable(@NonNull Drawable dr) {
    ...
    private class PerformClick : WindowRunnnable : Runnable {
    ...
    private class CheckForLongPress : WindowRunnnable : Runnable {
    ...
    private class CheckForKeyLongPress : WindowRunnnable : Runnable {
        override
        public void run() {
    ...
    private bool performStylusButtonPressAction(MotionEvent ev) {
    ...
    bool performLongPress(final View child,
    ...
    private bool showContextMenuInternal(float x, float y, bool useOffsets) {
    ...
    private bool showContextMenuForChildInternal(View originalView, float x, float y,
            bool useOffsets) {
    ...
    private final class CheckForTap : Runnable {
        float x;
        float y;
    ...
    private bool startScrollIfNeeded(int x, int y, MotionEvent vtev) {
        // Check if we have moved far enough that it looks more like a
        // scroll than a tap
        final int deltaY = y - mMotionY;
        final int distance = Math.abs(deltaY);
        final bool overscroll = mScrollY != 0;
                ...
                if (motionView != null) {
                    ...
                    if (atEdge) {
                        ...
                        if (dispatchNestedScroll(0, overscroll - incrementalDeltaY, 0, overscroll,
                            ...
                            final bool atOverscrollEdge = overScrollBy(0, overscroll,
    ...
    private void invalidateTopGlow() {
        ...
        final bool clipToPadding = getClipToPadding();
    ...
    /** @hide */
    override
    protected bool handleScrollBarDragging(MotionEvent event) {
    ...
    private void onTouchUp(MotionEvent ev) {
        ...
        case TOUCH_MODE_DONE_WAITING:
            ...
            if (child != null) {
                ...
                final bool inList = x > mListPadding.left && x < getWidth() - mListPadding.right;
        ...
        case TOUCH_MODE_SCROLL:
            ...
            if (childCount > 0) {
                ...
                if (mFirstPosition == 0 && firstChildTop >= contentTop &&
                    ...
                    // fling further.
                    bool flingVelocity = Math.abs(initialVelocity) > mMinimumVelocity;
                    if (flingVelocity &&
                            !((mFirstPosition == 0 &&
     ...
     *
     */
    private class FlingRunnable : Runnable {
        /**
         ...
         */
        private bool mSuppressIdleStateChangeCall;
        ...
        public void run() {
            ...
            case TOUCH_MODE_FLING: {
                ...
                final bool atEdge = trackMotionScroll(delta, delta);
                final bool atEnd = atEdge && (delta != 0);
                if (atEnd) {
                    if (motionView != null) {
            ...
            case TOUCH_MODE_OVERFLING: {
                ...
                if (scroller.computeScrollOffset()) {
                    ...
                    if (overScrollBy(0, deltaY, 0, scrollY, 0, 0,
                            0, mOverflingDistance, false)) {
                        final bool crossDown = scrollY <= 0 && currY > 0;
                        final bool crossUp = scrollY >= 0 && currY < 0;
    ...
    void smoothScrollBy(int distance, int duration, bool linear,
            bool suppressEndFlingStateChangeCall) {
        if (mFlingRunnable == null) {
            mFlingRunnable = new FlingRunnable();
        }
     ...
     */
    public bool canScrollList(int direction) {
        final int childCount = getChildCount();
        if (childCount == 0) {
            return false;
        }
    ...
    bool trackMotionScroll(int deltaY, int incrementalDeltaY) {
        ...
        final bool cannotScrollDown = (firstPosition == 0 &&
                firstTop >= listPadding.top && incrementalDeltaY >= 0);
        final bool cannotScrollUp = (firstPosition + childCount == mItemCount &&
        ...
        final bool down = incrementalDeltaY < 0;

        final bool inTouchMode = isInTouchMode();
        if (inTouchMode) {
            hideSelector();
        }
     ...
     */
    abstract void fillGap(bool down);
     ...
     */
    bool sendToTextFilter(int keyCode, int count, KeyEvent event) {
        if (!acceptFilter()) {
            return false;
        }
    ...
    private class InputConnectionWrapper : InputConnection {
     ...
     */
    override
    public bool checkInputConnectionProxy(View view) {
    ...
    /** @hide **/
    override
    public void setRemoteViewsAdapter(Intent intent, bool isAsync) {
    ...
    class AdapterDataSetObserver : AdapterView<ListAdapter>.AdapterDataSetObserver {
        override
     ...
     * {@link #onItemCheckedStateChanged(ActionMode, int, long, bool)} events when the user
    ...
    public interface MultiChoiceModeListener : ActionMode.Callback {
        ...
        public void onItemCheckedStateChanged(ActionMode mode,
                int position, long id, bool checked);
    }
    ...
    class MultiChoiceModeWrapper : MultiChoiceModeListener {
        ...
        public bool hasWrappedCallback() {
    ...
    /**
     * AbsListView : LayoutParams to provide a place to hold the view type.
     */
    public static class LayoutParams : ViewGroup.LayoutParams {
        /**
    ...
    class RecycleBin {
        ...
        void addScrapView(View scrap, int position) {
            ...
            final bool scrapHasTransientState = scrap.hasTransientState();
        ...
        void scrapActiveViews() {
            final View[] activeViews = mActiveViews;
            final bool hasListener = mRecyclerListener != null;
            final bool multipleScraps = mViewTypeCount > 1;
        ...
        private void removeDetachedView(View child, bool animate) {
            child.setAccessibilityDelegate(null);
     ...
     */
    class PositionScroller : AbsPositionScroller : Runnable {
