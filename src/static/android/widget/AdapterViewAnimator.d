 ...
 */
public abstract class AdapterViewAnimator : AdapterView<Adapter>
        : RemoteViewsAdapter.RemoteAdapterConnectionCallback, Advanceable {
    ...
    private void setDisplayedChild(int whichChild, bool animate) {
        if (mAdapter != null) {
            ...
            bool hasFocus = getFocusedChild() != null;
    ...
    void showOnly(int childIndex, bool animate) {
        ...
        if (!(newWindowStart == mCurrentWindowStart && newWindowEnd == mCurrentWindowEnd &&
            ...
            for (int i = newWindowStart; i <= newWindowEnd; i++) {
                ...
                bool inOldRange = mViewsMap.containsKey(index) && !mPreviousViews.contains(index);
    ...
    final class CheckForTap : Runnable {
        public void run() {
     ...
     *                false otherwise.
     */
    public void setAnimateFirstView(bool animate) {
