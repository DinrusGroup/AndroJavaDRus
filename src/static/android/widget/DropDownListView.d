...
public class DropDownListView : ListView {
     ...
     */
    public DropDownListView(@NonNull Context context, bool hijackFocus) {
     ...
     * @param context this view's context
     */
    public DropDownListView(@NonNull Context context, bool hijackFocus, int defStyleAttr) {
     ...
     */
    public bool onForwardedEvent(@NonNull MotionEvent event, int activePointerId) {
     ...
     *                          {@code false} to show
     */
    public void setListSelectionHidden(bool hideListSelection) {
     ...
     */
    override
    View obtainView(int position, bool[] isScrap) {
