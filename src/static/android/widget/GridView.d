...
public class GridView : AbsListView {
    ...
    private View makeRow(int startPos, int y, bool flow) {
        ...
        final bool hasFocus = shouldShowSelector();
        final bool inClick = touchModeDrawsInPressedState();
    ...
    private void adjustForBottomFadingEdge(View childInSelectedRow,
        ...
        // Some of the newly selected item : below the bottom of the
        // list
        ...
        try {
            ...
            if (sel != null) {
               ...
               mSelectedTop = sel.getTop();
                ...
                final bool inTouchMode = mTouchMode > TOUCH_MODE_DOWN
