...
class YearPickerView : ListView {
    ...
    private static class YearAdapter : BaseAdapter {
        ...
        public bool setSelection(int year) {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            final TextView v;
            final bool hasNewView = convertView == null;
            if (hasNewView) {
            ...
            final bool activated = mActivatedYear == year;
