...
public class SlidingDrawer : ViewGroup {
    ...
    protected void dispatchDraw(Canvas canvas) {
        ...
        final View handle = mHandle;
        final bool isVertical = mVertical;
    ...
    private void animateClose(int position, bool notifyScrollListener) {
        prepareTracking(position);
        performFling(position, mMaximumAcceleration, true, notifyScrollListener);
    }

    private void animateOpen(int position, bool notifyScrollListener) {
        prepareTracking(position);
        performFling(position, -mMaximumAcceleration, true, notifyScrollListener);
    }

    private void performFling(int position, float velocity, bool always,
            bool notifyScrollListener) {
    ...
    private void stopTracking(bool notifyScrollListener) {
    ...
    private class DrawerToggler : OnClickListener {
