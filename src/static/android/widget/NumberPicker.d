...
public class NumberPicker : LinearLayout {
     ...
     */
    private bool mWrapSelectorWheelPreferred = true;
     ...
     * format().
     */
    private static class TwoDigitFormatter : NumberPicker.Formatter {
     ...
     */
    private final bool mComputeMaxWidth;
     ...
     */
    private final bool mHasSelectorWheel;
     ...
     */
    private bool mIgnoreMoveEvents;

    /**
     * Flag whether to perform a click on tap.
     */
    private bool mPerformClickOnTap;
     ...
     */
    private bool mIncrementVirtualButtonPressed;

    /**
     * Whether the decrement virtual button is pressed.
     */
    private bool mDecrementVirtualButtonPressed;
     ...
     */
    private bool mHideWheelUntilFocused;
     ...
     */
    private bool moveToFinalScrollerPosition(Scroller scroller) {
     ...
     */
    public void setWrapSelectorWheel(bool wrapSelectorWheel) {
     ...
     * the choice is allowed. The former comes from {@link #setWrapSelectorWheel(bool)}, the
    ...
    private void updateWrapSelectorWheel() {
        final bool wrappingAllowed = (mMaxValue - mMinValue) >= mSelectorIndices.length;
    ...
    protected void onDraw(Canvas canvas) {
        ...
        final bool showSelectorWheel = mHideWheelUntilFocused ? hasFocus() : true;
     ...
     */
    private void setValueInternal(int current, bool notifyChange) {
        if (mValue == current) {
            return;
        }
     ...
     */
     private void changeValueByOne(bool increment) {
        if (mHasSelectorWheel) {
            hideSoftInput();
     ...
     */
    private bool updateInputTextView() {
        /*
     ...
     */
    private void postChangeCurrentByOneFromLongPress(bool increment, long delayMillis) {
     ...
     */
    class InputTextFilter : NumberKeyListener {
     ...
     */
    private bool ensureScrollWheelAdjusted() {
    ...
    class PressedStateHelper : Runnable {
     ...
     */
    private static class SetSelectionCommand : Runnable {
        private final EditText mInputText;
     ...
     */
    class ChangeCurrentByOneFromLongPressCommand : Runnable {
        private bool mIncrement;

        private void setStep(bool increment) {
     ...
     * @hide
     */
    public static class CustomEditText : EditText {
     ...
     */
    class BeginSoftInputOnLongPressCommand : Runnable {
     ...
     */
    class AccessibilityNodeProviderImpl : AccessibilityNodeProvider {
            ...
            switch (virtualViewId) {
                ...
                case VIRTUAL_VIEW_ID_DECREMENT: {
                    switch (action) {
                        case AccessibilityNodeInfo.ACTION_CLICK: {
                            if (NumberPicker.this.isEnabled()) {
                                final bool increment = (virtualViewId == VIRTUAL_VIEW_ID_INCREMENT);
        ...
        private bool hasVirtualDecrementButton() {
            return getWrapSelectorWheel() || getValue() > getMinValue();
        }

        private bool hasVirtualIncrementButton() {
