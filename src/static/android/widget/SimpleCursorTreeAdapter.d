...
public abstract class SimpleCursorTreeAdapter : ResourceCursorTreeAdapter {
    ...
    override
    protected void bindChildView(View view, Context context, Cursor cursor, bool isLastChild) {
        if (mChildFrom == null) {
    ...
    override
    protected void bindGroupView(View view, Context context, Cursor cursor, bool isExpanded) {
        if (mGroupFrom == null) {
    ...
    public static interface ViewBinder {
         ...
         */
        bool setViewValue(View view, Cursor cursor, int columnIndex);
    }
}
