 ...
 */
class TimePickerClockDelegate : TimePicker.AbstractTimePickerDelegate {
    /**
    ...
    private bool mLastAnnouncedIsHour;
    ...
    private static class ClickActionDelegate : AccessibilityDelegate {
    ...
    private void updateHeaderAmPm() {
        if (mIs24Hour) {
            ...
            final bool isAmPmAtStart = dateTimePattern.startsWith("a");
    ...
    private void setHourInternal(int hour, @ChangeSource int source, bool announce,
            bool notify) {
    ...
    private void tryAnnounceForAccessibility(CharSequence text, bool isHour) {
     ...
     */
    private void setCurrentItemShowing(int index, bool animateCircle, bool announce) {
     ...
     */
    private static class NearestTouchDelegate : View.OnTouchListener {
            ...
            public bool onTouch(View view, MotionEvent motionEvent) {
                ...
                final bool handled = child.dispatchTouchEvent(motionEvent);
                motionEvent.offsetLocation(-offsetX, -offsetY);
