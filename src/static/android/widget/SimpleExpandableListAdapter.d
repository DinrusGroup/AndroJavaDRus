...
public class SimpleExpandableListAdapter : BaseExpandableListAdapter {
    private List<? : Map<String, ?>> mGroupData;
    ...
    public SimpleExpandableListAdapter(Context context,
            List<? : Map<String, ?>> groupData, int groupLayout,
            String[] groupFrom, int[] groupTo,
            List<? : List<? : Map<String, ?>>> childData,
     ...
     */
    public SimpleExpandableListAdapter(Context context,
            List<? : Map<String, ?>> groupData, int expandedGroupLayout,
     ...
     */
    public View newChildView(bool isLastChild, ViewGroup parent) {
     ...
     */
    public View newGroupView(bool isExpanded, ViewGroup parent) {
