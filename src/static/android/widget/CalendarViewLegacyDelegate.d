 ...
 */
class CalendarViewLegacyDelegate : CalendarView.AbstractCalendarViewDelegate {
    /**
     * Default value whether to show week number.
     */
    private static final bool DEFAULT_SHOW_WEEK_NUMBER = true;
    ...
    override
    public void setShowWeekNumber(bool showWeekNumber) {
    ...
    override
    public void setDate(long date, bool animate, bool center) {
    ...
    override
    public bool getBoundsForDate(long date, Rect outBounds) {
     ...
     * secondDate</code>.
     */
    private static bool isSameDate(Calendar firstDate, Calendar secondDate) {
     ...
     */
    private void goTo(Calendar date, bool animate, bool setSelected,
            bool forceScroll) {
     ...
     */
    private class ScrollStateRunnable : Runnable {
     ...
     * </p>
     */
    private class WeeksAdapter : BaseAdapter : View.OnTouchListener {
    ...
    private class WeekView : View {
        ...
        private bool[] mFocusDay;

        // Whether this view has a focused day.
        private bool mHasFocusedDay;

        // Whether this view has only focused days.
        private bool mHasUnfocusedDay;
        ...
        private bool mHasSelectedDay = false;
        ...
        public void init(int weekNumber, int selectedWeekDay, int focusedMonth) {
            ...
            for (; i < mNumCells; i++) {
                final bool isFocusedDay = (mTempDate.get(Calendar.MONTH) == focusedMonth);
         ...
         */
        public bool getDayFromLocation(float x, Calendar outCalendar) {
        ...
        public bool getBoundsForDate(Calendar date, Rect outBounds) {
