...
public final class Magnifier {
    ...
    private void performPixelCopy(final int startXInSurface, final int startYInSurface,
            final bool updateWindowPosition) {
    ...
    private static class InternalPopupWindow {
        ...
        private bool mFrameDrawScheduled;
        // The content bitmap.
        ...
        private bool mPendingWindowPositionUpdate;
        ...
        private void doDraw() {
            ...
            synchronized (mLock) {
                ...
                if (mPendingWindowPositionUpdate || mFirstDraw) {
                    ...
                    final bool firstDraw = mFirstDraw;
                    mFirstDraw = false;
                    final bool updateWindowPosition = mPendingWindowPositionUpdate;
