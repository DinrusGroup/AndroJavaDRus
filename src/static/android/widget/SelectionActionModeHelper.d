...
public final class SelectionActionModeHelper {
     ...
     */
    public void startSelectionActionModeAsync(bool adjustSelection) {
    ...
    public bool resetSelection(int textIndex) {
    ...
    public bool isDrawingHighlight() {
    ...
    private bool skipTextClassification() {
        // No need to make an async call for a no-op TextClassifier.
        final bool noOpTextClassifier = mTextView.usesNoOpTextClassifier();
        // Do not call the TextClassifier if there is no selection.
        final bool noSelection = mTextView.getSelectionEnd() == mTextView.getSelectionStart();
        // Do not call the TextClassifier if this is a password field.
        final bool password = mTextView.hasPasswordTransformationMethod()
    ...
    public static <T> void mergeRectangleIntoList(final List<T> list,
        ...
        for (int index = 0; index < elementCount; ++index) {
            ...
            final bool rectanglesContinueEachOther = candidate.left == existingRectangle.right
                    || candidate.right == existingRectangle.left;
            final bool canMerge = candidate.top == existingRectangle.top
    ...
    private static final class SelectionTracker {
        ...
        public void onOriginalSelection(
                CharSequence text, int selectionStart, int selectionEnd, bool isLink) {
         ...
         * on a single tap.
         */
        public bool resetSelection(int textIndex, Editor editor) {
            ...
            if (isSelectionStarted()
                ...
                mAllowReset = false;
                bool selected = editor.selectCurrentWord();
                if (selected) {
        ...
        private final class LogAbandonRunnable : Runnable {
            private bool mIsPending;
    ...
    private static final class SelectionMetricsLogger {
        ...
        private final bool mEditTextLogger;
        ...
        private bool hasActiveClassificationSession() {
        ...
        private bool isWhitespace(int start, int end) {
    ...
    private static final class TextClassificationHelper {
        ...
        private bool isDarkLaunchEnabled() {
