...
public class LinearLayout : ViewGroup {
     ...
     */
    private final bool mAllowInconsistentMeasurement;
    ...
    public LinearLayout(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        bool baselineAligned = a.getBoolean(R.styleable.LinearLayout_baselineAligned, true);
        if (!baselineAligned) {
    ...
    protected bool hasDividerBeforeChildAt(int childIndex) {
        ...
        bool allViewsAreGoneBefore = allViewsAreGoneBefore(childIndex);
    ...
    void measureVertical(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        final bool useLargestChild = mUseLargestChild;
        ...
        for (int i = 0; i < count; ++i) {
            ...
            final bool useExcessSpace = lp.height == 0 && lp.weight > 0;
    ...
    void measureHorizontal(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        final bool baselineAligned = mBaselineAligned;
        final bool useLargestChild = mUseLargestChild;

        final bool isExactly = widthMode == MeasureSpec.EXACTLY;
        ...
        for (int i = 0; i < count; ++i) {
            ...
            final bool useExcessSpace = lp.width == 0 && lp.weight > 0;
