 ...
 */
@Widget
public class Spinner : AbsSpinner : OnClickListener {
    ...
    private bool mDisableChildrenWhenDisabled;
    ...
    /**
     * @see android.view.View#onLayout(bool,int,int,int,int)
     *
     ...
     */
    private View makeView(int position, bool addChild) {
        View child;
     ...
     */
    private void setUpChild(View child, bool addChild) {
    ...
    public bool performClick() {
        bool handled = super.performClick();
    ...
    static class SavedState : AbsSpinner.SavedState {
        bool showDropdown;
        ...
        public void writeToParcel(Parcel out, int flags) {
            ...
            out.writeByte(cast(byte) (showDropdown ? 1 : 0));
        }
     ...
     */
    private static class DropDownAdapter : ListAdapter, SpinnerAdapter {
    ...
    private class DialogPopup : SpinnerPopup, DialogInterface.OnClickListener {
    ...
    private class DropdownPopup : ListPopupWindow : SpinnerPopup {
