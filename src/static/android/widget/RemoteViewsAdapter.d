 ...
 * @hide
 */
public class RemoteViewsAdapter : BaseAdapter : Handler.Callback {
    ...
    public interface RemoteAdapterConnectionCallback {
        ...
        void setRemoteViewsAdapter(Intent intent, bool isAsync);
    }

    public static class AsyncRemoteAdapterAction : Runnable {
     ...
     */
    private static class RemoteServiceHandler : Handler : ServiceConnection {
        ...
        private bool mNotifyDataSetChangedPending = false;
        private bool mBindRequested = false;
        ...
        private bool sendNotifyDataSetChange(bool always) {
            try {
     ...
     * they are loaded.
     */
    static class RemoteViewsFrameLayout : AppWidgetHostView {
        private final FixedSizeRemoteViewsCache mCache;
    ...
    private class RemoteViewsFrameLayoutRefSet
            : SparseArray<LinkedList<RemoteViewsFrameLayout>> {
    ...
    private static class RemoteViewsMetaData {
        ...
        public bool isViewTypeInRange(int typeId) {
    ...
    private static class FixedSizeRemoteViewsCache {
        ...
        public bool queuePositionsToBePreloadedFromRequestedPosition(int position) {
        ...
        public bool containsRemoteViewAt(int position) {
            return mIndexRemoteViews.indexOfKey(position) >= 0;
        }
        public bool containsMetaDataAt(int position) {
    ...
    public RemoteViewsAdapter(Context context, Intent intent,
            RemoteAdapterConnectionCallback callback, bool useAsyncLoader) {
        mContext = context;
        mIntent = intent;
    ...
    private void updateTemporaryMetaData(IRemoteViewsFactory factory) {
        try {
            ...
            bool hasStableIds = factory.hasStableIds();
    ...
    private static class HandlerThreadExecutor : Executor {
