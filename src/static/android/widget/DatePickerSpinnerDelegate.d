 ...
 */
class DatePickerSpinnerDelegate : AbstractDatePickerDelegate {
    ...
    private static final bool DEFAULT_CALENDAR_VIEW_SHOWN = true;

    private static final bool DEFAULT_SPINNERS_SHOWN = true;

    private static final bool DEFAULT_ENABLED_STATE = true;
    ...
    DatePickerSpinnerDelegate(DatePicker delegator, Context context, AttributeSet attrs,
        ...
        bool spinnersShown = attributesArray.getBoolean(com.android.internal.R.styleable.DatePicker_spinnersShown,
                DEFAULT_SPINNERS_SHOWN);
        bool calendarViewShown = attributesArray.getBoolean(
    ...
    override
    public void setCalendarViewShown(bool shown) {
    ...
    override
    public void setSpinnersShown(bool shown) {
     ...
     */
    private bool usingNumericMonths() {
     ...
     */
    private bool parseDate(String date, Calendar outDate) {
        try {
