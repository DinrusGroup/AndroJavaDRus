...
public class ImageView : View {
    ...
    private bool mHasDrawableTintMode = false;
    ...
    override
    protected bool verifyDrawable(@NonNull Drawable dr) {
    ...
    */
    ...
    private void updateDrawable(Drawable d) {
        ...
        if (d != null) {
            ...
            if (!sameDrawable || sCompatDrawableVisibilityDispatch) {
                final bool visible = sCompatDrawableVisibilityDispatch
    ...
    override
    @TestApi
    public bool isDefaultFocusHighlightNeeded(Drawable background, Drawable foreground) {
        final bool lackFocusState = mDrawable == null || !mDrawable.isStateful()
