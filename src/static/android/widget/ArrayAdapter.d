 ...
 */
public class ArrayAdapter<T> : BaseAdapter : Filterable, ThemedSpinnerAdapter {
    /**
     ...
     */
    private bool mObjectsFromResources;
    ...
    private ArrayAdapter(@NonNull Context context, @LayoutRes int resource,
            @IdRes int textViewResourceId, @NonNull List<T> objects, bool objsFromResources) {
        mContext = context;
