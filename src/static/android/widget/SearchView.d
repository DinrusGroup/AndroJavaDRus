 ...
 * needs to be set to iconified by default using {@link #setIconifiedByDefault(bool)
 ...
 */
public class SearchView : LinearLayout : CollapsibleActionView {
     ...
     * EditText.
     */
    private bool onSuggestionsKey(View v, int keyCode, KeyEvent event) {
     ...
     * @hide
     */
    public static class SearchAutoComplete : AutoCompleteTextView {
        ...
        public bool onKeyPreIme(int keyCode, KeyEvent event) {
            final bool consume = super.onKeyPreIme(keyCode, event);
