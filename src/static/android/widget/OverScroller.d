...
public class OverScroller {
     ...
     * @hide
     */
    public OverScroller(Context context, Interpolator interpolator, bool flywheel) {
     ...
     */
    public final void forceFinished(bool finished) {
    ...
    public bool springBack(int startX, int startY, int minX, int maxX, int minY, int maxY) {
        ...
        final bool spingbackX = mScrollerX.springback(startX, minX, maxX);
        final bool spingbackY = mScrollerY.springback(startY, minY, maxY);
