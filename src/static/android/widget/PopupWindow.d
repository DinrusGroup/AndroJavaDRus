...
public class PopupWindow {
    ...
    private bool mIsTransitioningToDismiss;
    ...
    private bool mAttachedInDecor = true;
    private bool mAttachedInDecorSet = false;
    ...
    private bool mIsAnchorRootAttached;
    ...
    private bool mPopupViewInitialLayoutDirectionInherited;
     ...
     */
    public PopupWindow(View contentView, int width, int height, bool focusable) {
        if (contentView != null) {
    ...
    private Transition getTransition(int resId) {
        if (resId != 0 && resId != R.transition.no_transition) {
            ...
            if (transition != null) {
                final bool isEmpty = transition instanceof TransitionSet
     ...
     * @hide
     */
    public void setClipToScreenEnabled(bool enabled) {
     ...
     */
    void setAllowScrollingAnchorParent(bool enabled) {
        mAllowScrollingAnchorParent = enabled;
    }

    /** @hide */
    protected final bool getAllowScrollingAnchorParent() {
     ...
     */
    public void setSplitTouchEnabled(bool enabled) {
     ...
     * @hide
     */
    public bool isLayoutInScreenEnabled() {
     ...
     * @hide
     */
    public void setLayoutInScreenEnabled(bool enabled) {
     ...
     * @see WindowManager.LayoutParams#FLAG_LAYOUT_ATTACHED_IN_DECOR
     */
    public void setAttachedInDecor(bool enabled) {
     ...
     *
     * <p>This will often be combined with {@link #setLayoutInScreenEnabled(bool)}.
     *
     ...
     * @hide
     */
    public void setLayoutInsetDecor(bool enabled) {
        mLayoutInsetDecor = enabled;
    }

    /** @hide */
    protected final bool isLayoutInsetDecor() {
     ...
     * @hide
     */
    public void setTouchModal(bool touchModal) {
     ...
     * @see #isShowing()
     */
    public void setOverlapAnchor(bool overlapAnchor) {
    ...
    /** @hide */
    protected final void setShowing(bool isShowing) {
        mIsShowing = isShowing;
    }

    /** @hide */
    protected final void setDropDown(bool isDropDown) {
        mIsDropdown = isDropDown;
    }

    /** @hide */
    protected final void setTransitioningToDismiss(bool transitioningToDismiss) {
        mIsTransitioningToDismiss = transitioningToDismiss;
    }

    /** @hide */
    protected final bool isTransitioningToDismiss() {
    ...
    /** @hide */
    protected final void updateAboveAnchor(bool aboveAnchor) {
     ...
     * @hide
     */
    protected bool findDropDownPosition(View anchor, WindowManager.LayoutParams outParams,
        ...
        final bool fitsVertical = tryFitVertical(outParams, yOffset, height,
        ...
        final bool fitsHorizontal = tryFitHorizontal(outParams, xOffset, width,
    ...
    private bool tryFitVertical(@NonNull LayoutParams outParams, int yOffset, int height,
    ...
    private bool positionInDisplayVertical(@NonNull LayoutParams outParams, int height,
    ...
    private bool tryFitHorizontal(@NonNull LayoutParams outParams, int xOffset, int width,
    ...
    private bool positionInDisplayHorizontal(@NonNull LayoutParams outParams, int width,
    ...
    public int getMaxAvailableHeight(
            @NonNull View anchor, int yOffset, bool ignoreBottomDecorations) {
     ...
     * This includes:
     * <ul>
     *     <li>{@link #setClippingEnabled(bool)}</li>
     *     <li>{@link #setFocusable(bool)}</li>
     *     <li>{@link #setIgnoreCheekPress()}</li>
     *     <li>{@link #setInputMethodMode(int)}</li>
     *     <li>{@link #setTouchable(bool)}</li>
     ...
     */
    public void update(int x, int y, int width, int height, bool force) {
        if (width >= 0) {
            mLastWidth = width;
            setWidth(width);
        }
    ...
    private void update(View anchor, bool updateLocation, int xoff, int yoff,
        ...
        final bool needsUpdate = updateLocation && (mAnchorXoff != xoff || mAnchorYoff != yoff);
        ...
        final bool aboveAnchor = findDropDownPosition(anchor, p, mAnchorXoff, mAnchorYoff,
                width, height, gravity, mAllowScrollingAnchorParent);
        updateAboveAnchor(aboveAnchor);

        final bool paramsChanged = oldGravity != p.gravity || oldX != p.x || oldY != p.y
    ...
    private class PopupDecorView : FrameLayout {
    ...
    private class PopupBackgroundView : FrameLayout {
