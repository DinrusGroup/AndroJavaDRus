...
public class ViewAnimator : FrameLayout {
    ...
    public ViewAnimator(Context context, AttributeSet attrs) {
        ...
        bool flag = a.getBoolean(com.android.internal.R.styleable.ViewAnimator_animateFirstView, true);
     ...
     * {@link #setMeasureAllChildren(bool)} based on {@link FrameLayout} flags.
     */
    private void initViewAnimator(Context context, AttributeSet attrs) {
        ...
        final bool measureAllChildren = a.getBoolean(
    ...
    void showOnly(int childIndex) {
        final bool animate = (!mFirstTime || mAnimateFirstTime);
