 ...
 */
public abstract class RemoteViewsService : Service {
     ...
     */
    private static class RemoteViewsFactoryAdapter : IRemoteViewsFactory.Stub {
        public RemoteViewsFactoryAdapter(RemoteViewsFactory factory, bool isCreated) {
            mFactory = factory;
            mIsCreated = isCreated;
        }
        public synchronized bool isCreated() {
            return mIsCreated;
        }
        ...
        public synchronized bool hasStableIds() {
