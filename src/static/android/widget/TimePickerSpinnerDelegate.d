 ...
 */
class TimePickerSpinnerDelegate : TimePicker.AbstractTimePickerDelegate {
    ...
    private bool mHourWithTwoDigit;
    ...
    private void setCurrentHour(int currentHour, bool notifyTimeChanged) {
    ...
    private void setCurrentMinute(int minute, bool notifyTimeChanged) {
        if (minute == getMinute()) {
            return;
        }
        resetAutofilledValue();
