 ...
 * {@link #setColumnShrinkable(int, bool) setColumnShrinkable()}
 * or {@link #setColumnStretchable(int, bool) setColumnStretchable()}. If
 ...
 * column by calling
 * {@link #setColumnCollapsed(int,bool) setColumnCollapsed()}.</p>
 *
...
public class TableLayout : LinearLayout {
     ...
     *
     * <p>The result of the parsing is stored in a sparse bool array. The
     ...
     * @return a sparse array of bool mapping column indexes to the columns
     *         collapse state
     */
     ...
     * @attr ref android.R.styleable#TableLayout_shrinkColumns
     */
    public void setShrinkAllColumns(bool shrinkAllColumns) {
     ...
     * @attr ref android.R.styleable#TableLayout_stretchColumns
     */
    public void setStretchAllColumns(bool stretchAllColumns) {
     ...
     */
    public void setColumnCollapsed(int columnIndex, bool isCollapsed) {
     ...
     * @attr ref android.R.styleable#TableLayout_stretchColumns
     */
    public void setColumnStretchable(int columnIndex, bool isStretchable) {
     ...
     */
    public bool isColumnStretchable(int columnIndex) {
     ...
     * @attr ref android.R.styleable#TableLayout_shrinkColumns
     */
    public void setColumnShrinkable(int columnIndex, bool isShrinkable) {
     ...
     */
    public bool isColumnShrinkable(int columnIndex) {
    ...
    private void mutateColumnsWidth(SparseBooleanArray columns,
            bool allColumns, int size, int totalWidth) {
        int skipped = 0;
        final int[] maxWidths = mMaxWidths;
    ...
    public static class LayoutParams : LinearLayout.LayoutParams {
        /**
         * {@inheritDoc}
         */
