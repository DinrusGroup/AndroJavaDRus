 ...
 */
@RemoteView
public class DateTimeView : TextView {
    ...
    private bool mShowRelativeTime;
        ...
        for (int i = 0; i < N; i++) {
            ...
            switch (attr) {
                case R.styleable.DateTimeView_showRelative:
                    bool relative = a.getBoolean(i, false);
    ...
    @android.view.RemotableViewMethod
    public void setShowRelativeTime(bool showRelativeTime) {
    ...
    private static class ReceiverInfo {
        ...
        public void addView(DateTimeView v) {
            synchronized (mAttachedViews) {
                final bool register = mAttachedViews.isEmpty();
