...
public class HorizontalScrollView : FrameLayout {
        ...
        switch (action & MotionEvent.ACTION_MASK) {
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                if (mIsBeingDragged) {
                    ...
                    final bool canOverscroll = overscrollMode == OVER_SCROLL_ALWAYS ||
     ...
     */
    private View findFocusableViewInMyBounds(final bool leftFocus,
     ...
     *         be found
     */
    private View findFocusableViewInBounds(bool leftFocus, int left, int right) {
        ...
        for (int i = 0; i < count; i++) {
            ...
            if (left < viewRight && viewLeft < right) {
                ...
                final bool viewIsFullyContained = (left < viewLeft) &&
                        (viewRight < right);
     ...
     */
    private bool isWithinDeltaOfScreen(View descendant, int delta) {
    ...
    protected void onLayout(bool changed, int l, int t, int r, int b) {
        ...
        final bool forceLeftGravity = (childWidth > available);
