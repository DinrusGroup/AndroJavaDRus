...
class DayPickerView : ViewGroup {
    ...
    private void updateButtonVisibility(int position) {
        final bool hasPrev = position > 0;
        final bool hasNext = position < (mAdapter.getCount() - 1);
     ...
     */
    public void setDate(long timeInMillis, bool animate) {
     ...
     */
    private void setDate(long timeInMillis, bool animate, bool setSelected) {
    ...
    public bool getBoundsForDate(long timeInMillis, Rect outBounds) {
        final int position = getPositionFromDay(timeInMillis);
        if (position != mViewPager.getCurrentItem()) {
            return false;
        }
    ...
    private final OnClickListener mOnClickListener = new OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            final bool animate = !mAccessibilityManager.isEnabled();
