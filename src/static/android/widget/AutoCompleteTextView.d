 ...
 */
public class AutoCompleteTextView : EditText : Filter.FilterListener {
     ...
     * @hide Pending API council approval
     */
    public bool isDropDownDismissedOnCompletion() {
     ...
     * @hide Pending API council approval
     */
    public void setDropDownDismissedOnCompletion(bool dropDownDismissedOnCompletion) {
     ...
     */
    public <T : ListAdapter & Filterable> void setAdapter(T adapter) {
        if (mObserver == null) {
    ...
    public bool onKeyDown(int keyCode, KeyEvent event) {
        ...
        bool handled = super.onKeyDown(keyCode, event);
     ...
     */
    private class MyWatcher : TextWatcher {
     ...
     */
    public void setText(CharSequence text, bool filter) {
        if (filter) {
            setText(text);
        } else {
            mBlockCompletion = true;
    ...
    private void updateDropDownForFilter(int count) {
        ...
        final bool dropDownAlwaysVisible = mPopup.isDropDownAlwaysVisible();
        final bool enoughToFilter = enoughToFilter();
    ...
    override
    protected bool setFrame(final int l, int t, final int r, int b) {
     ...
     */
    public void ensureImeVisible(bool visible) {
    ...
    private class DropDownItemClickListener : AdapterView.OnItemClickListener {
    ...
    public interface Validator {
         ...
         */
        bool isValid(CharSequence text);
     ...
     */
    private class PassThroughClickListener : OnClickListener {
     ...
     */
    private static class PopupDataSetObserver : DataSetObserver {
