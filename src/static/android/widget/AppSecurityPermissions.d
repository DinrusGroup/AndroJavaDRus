...
public class AppSecurityPermissions {
    ...
    private final static bool localLOGV = false;
    ...
    /** @hide */
    static class MyPermissionGroupInfo : PermissionGroupInfo {
        CharSequence mLabel;
    ...
    /** @hide */
    private static class MyPermissionInfo : PermissionInfo {
        CharSequence mLabel;
    ...
    /** @hide */
    public static class PermissionItemView : LinearLayout : View.OnClickListener {
        MyPermissionGroupInfo mGroup;
        MyPermissionInfo mPerm;
        AlertDialog mDialog;
        private bool mShowRevokeUI = false;
        private String mPackageName;
        ...
        public void setPermission(MyPermissionGroupInfo grp, MyPermissionInfo perm,
                bool first, CharSequence newPermPrefix, String packageName,
                bool showRevokeUI) {
            mGroup = grp;
            mPerm = perm;
    ...
    public static View getPermissionItemView(Context context,
            CharSequence grpName, CharSequence description, bool dangerous) {
    ...
    private void extractPerms(PackageInfo info, Set<MyPermissionInfo> permSet,
        ...
        for (int i=0; i<strList.length; i++) {
            ...
            try {
                ...
                final bool newPerm = installedPkgInfo != null
    ...
    private View getPermissionsView(int which, bool showRevokeUI) {
    ...
    private void displayPermissions(List<MyPermissionGroupInfo> groups,
            LinearLayout permListView, int which, bool showRevokeUI) {
    ...
    private PermissionItemView getPermissionItemView(MyPermissionGroupInfo grp,
            MyPermissionInfo perm, bool first, CharSequence newPermPrefix, bool showRevokeUI) {
    ...
    private static PermissionItemView getPermissionItemView(Context context, LayoutInflater inflater,
            MyPermissionGroupInfo grp, MyPermissionInfo perm, bool first,
            CharSequence newPermPrefix, String packageName, bool showRevokeUI) {
    ...
    private static View getPermissionItemViewOld(Context context, LayoutInflater inflater,
            CharSequence grpName, CharSequence permList, bool dangerous, Drawable icon) {
    ...
    private bool isDisplayablePermission(PermissionInfo pInfo, int newReqFlags,
            int existingReqFlags) {
        final int base = pInfo.protectionLevel & PermissionInfo.PROTECTION_MASK_BASE;
        final bool isNormal = (base == PermissionInfo.PROTECTION_NORMAL);
        ...
        final bool isDangerous = (base == PermissionInfo.PROTECTION_DANGEROUS)
    ...
    private static class PermissionGroupInfoComparator : Comparator<MyPermissionGroupInfo> {
    ...
    private static class PermissionInfoComparator : Comparator<MyPermissionInfo> {
        private final Collator sCollator = Collator.getInstance();
