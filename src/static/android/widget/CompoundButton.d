 ...
 * </p>
 */
public abstract class CompoundButton : Button : Checkable {
    ...
    private bool mCheckedFromResource = false;
    ...
    public CompoundButton(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        final bool checked = a.getBoolean(
    ...
    public bool performClick() {
        ...
        final bool handled = super.performClick();
        if (!handled) {
