...
public class ExpandableListView : ListView {
    ...
    private Drawable getIndicator(PositionMetadata pos) {
        ...
        if (pos.position.type == ExpandableListPosition.GROUP) {
            ...
            if (indicator != null && indicator.isStateful()) {
                ...
                bool isEmpty = (pos.groupMetadata == null) ||
    ...
    override
    public bool performItemClick(View v, int position, long id) {
     ...
     */
    public bool expandGroup(int groupPos) {
     ...
     *         was already expanded, this will return false)
     */
    public bool expandGroup(int groupPos, bool animate) {
     ...
     */
    public bool collapseGroup(int groupPos) {
    ...
    public interface OnGroupClickListener {
         ...
         */
        bool onGroupClick(ExpandableListView parent, View v, int groupPosition,
                long id);
    }
    ...
    public interface OnChildClickListener {
         ...
         * @return True if the click was handled
         */
        bool onChildClick(ExpandableListView parent, View v, int groupPosition,
     ...
     */
    public bool setSelectedChild(int groupPosition, int childPosition, bool shouldExpandGroup) {
     ...
     */
    public bool isGroupExpanded(int groupPosition) {
     ...
     */
    public static class ExpandableListContextMenuInfo : ContextMenu.ContextMenuInfo {
