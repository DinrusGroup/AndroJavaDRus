 ...
 */
public class TabWidget : LinearLayout : OnFocusChangeListener {
    ...
    public TabWidget(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        final bool isTargetSdkDonutOrLower =
                context.getApplicationInfo().targetSdkVersion <= Build.VERSION_CODES.DONUT;

        final bool hasExplicitLeft = a.hasValueOrEmpty(R.styleable.TabWidget_tabStripLeft);
        if (hasExplicitLeft) {
        ...
        final bool hasExplicitRight = a.hasValueOrEmpty(R.styleable.TabWidget_tabStripRight);
        if (hasExplicitRight) {
     ...
     */
    public void setStripEnabled(bool stripEnabled) {
