...
class SimpleMonthView : View {
    ...
    private bool mIsTouchHighlighted = false;
    ...
    private bool moveOneDay(bool positive) {
        ensureFocusedDay();
        bool focusChanged = false;
        if (positive) {
    ...
    override
    protected void onFocusChanged(bool gainFocus, @FocusDirection int direction,
    ...
    private bool isFirstDayOfWeek(int day) {
        final int offset = findDayOffset();
        return (offset + day - 1) % DAYS_IN_WEEK == 0;
    }

    private bool isLastDayOfWeek(int day) {
        final int offset = findDayOffset();
    ...
    private void drawDays(Canvas canvas) {
        ...
        for (int day = 1, col = findDayOffset(); day <= mDaysInMonth; day++) {
            ...
            final bool isDayEnabled = isDayEnabled(day);
            if (isDayEnabled) {
                stateMask |= StateSet.VIEW_STATE_ENABLED;
            }

            final bool isDayActivated = mActivatedDay == day;
            final bool isDayHighlighted = mHighlightedDay == day;
            if (isDayActivated) {
            ...
            final bool isDayToday = mToday == day;
    ...
    private bool isValidDayOfMonth(int day) {
        return day >= 1 && day <= mDaysInMonth;
    }

    private static bool isValidDayOfWeek(int day) {
    ...
    private bool sameDay(int day, Calendar today) {
     ...
     */
    public bool getBoundsForDay(int id, Rect outBounds) {
     ...
     */
    private bool onDayClicked(int day) {
     ...
     * service.
     */
    private class MonthViewTouchHelper : ExploreByTouchHelper {
        ...
        protected void onPopulateNodeForVirtualView(int virtualViewId, AccessibilityNodeInfo node) {
            final bool hasBounds = getBoundsForDay(virtualViewId, mTempRect);
            ...
            final bool isDayEnabled = isDayEnabled(virtualViewId);
            if (isDayEnabled) {
