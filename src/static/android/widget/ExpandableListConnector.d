 ...
 * expects.
 */
class ExpandableListConnector : BaseAdapter : Filterable {
    /**
    ...
    override
    public bool isEnabled(int flatListPos) {
    ...
    public View getView(int flatListPos, View convertView, ViewGroup parent) {
        ...
        if (posMetadata.position.type == ExpandableListPosition.GROUP) {
            ...
            final bool isLastChild = posMetadata.groupMetadata.lastChildFlPos == flatListPos;
    ...
    private void refreshExpGroupMetadataList(bool forceChildrenCountRefresh,
            bool syncGroupPositions) {
        final ArrayList<GroupMetadata> egml = mExpGroupMetadataList;
    ...
    protected class MyDataSetObserver : DataSetObserver {
        override
     ...
     * children
     */
    static class GroupMetadata : Parcelable, Comparable<GroupMetadata> {
