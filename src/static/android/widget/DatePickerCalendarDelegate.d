 ...
 */
class DatePickerCalendarDelegate : DatePicker.AbstractDatePickerDelegate {
    ...
    private void onCurrentDateChanged(bool announce) {
        if (mHeaderYear == null) {
            // Abort, we haven't initialized yet. This method will get called
            // again later after everything has been set up.
            return;
    ...
    private void onDateChanged(bool fromUser, bool callbackToClient) {
        final int year = mCurrentDate.get(Calendar.YEAR);
