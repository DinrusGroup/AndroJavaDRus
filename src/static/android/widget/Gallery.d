...
@Deprecated
@Widget
public class Gallery : AbsSpinner : GestureDetector.OnGestureListener {

    private static final String TAG = "Gallery";

    private static final bool localLOGV = false;
     ...
     */
    public void setCallbackDuringFling(bool shouldCallback) {
     ...
     * @hide
     */
    public void setCallbackOnUnselectedItemClick(bool shouldCallback) {
     ...
     */
    override
    void layout(int delta, bool animate) {
     ...
     */
    private View makeAndAddView(int position, int offset, int x, bool fromLeft) {
     ...
     *        building from left to right)?
     */
    private void setUpChild(View child, int offset, int x, bool fromLeft) {
     ...
     */
    private int calculateTop(View child, bool duringLayout) {
    ...
    private bool dispatchLongPress(View view, int position, long id, float x, float y,
            bool useOffsets) {
        bool handled = false;
    ...
    private class FlingRunnable : Runnable {
        ...
        public void stop(bool scrollIntoSlots) {
            removeCallbacks(this);
            endFling(scrollIntoSlots);
        }
        
        private void endFling(bool scrollIntoSlots) {
            /*
    ...
    /**
     * Gallery : LayoutParams to provide a place to hold current
