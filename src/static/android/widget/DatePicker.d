...
public class DatePicker : FrameLayout {
    ...
    public DatePicker(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        final bool isDialogMode = a.getBoolean(R.styleable.DatePicker_dialogMode, false);
    ...
    interface DatePickerDelegate {
        ...
        bool dispatchPopulateAccessibilityEvent(AccessibilityEvent event);
     ...
     */
    abstract static class AbstractDatePickerDelegate : DatePickerDelegate {
        // The delegator
        ...
        protected void onValidationChanged(bool valid) {
         ...
         */
        static class SavedState : View.BaseSavedState {
