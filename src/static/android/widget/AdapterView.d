 ...
 */
public abstract class AdapterView<T : Adapter> : ViewGroup {
     ...
     *
     */
    public static class AdapterContextMenuInfo : ContextMenu.ContextMenuInfo {
    ...
    public void setEmptyView(View emptyView) {
        ...
        final bool empty = ((adapter == null) || adapter.isEmpty());
    ...
    public void setFocusable(@Focusable int focusable) {
        final T adapter = getAdapter();
        final bool empty = adapter == null || adapter.getCount() == 0;
    ...
    void checkFocus() {
        final T adapter = getAdapter();
        final bool empty = adapter == null || adapter.getCount() == 0;
        final bool focusable = !empty || isInFilterMode();
