...
public class Editor {
    ...
    private static final bool DEBUG_UNDO = false;
    // Specifies whether to use or not the magnifier when pressing the insertion or selection
    // handles.
    private static final bool FLAG_USE_MAGNIFIER = true;
    ...
    private final bool mHapticTextHandleEnabled;
    ...
    bool mFrozenWithFocus;
    bool mSelectionMoved;
    bool mTouchFocusSelected;

    KeyListener mKeyListener;
    int mInputType = EditorInfo.TYPE_NULL;

    bool mDiscardNextActionUp;
    bool mIgnoreActionUpEvent;

    private long mShowCursor;
    private bool mRenderCursorRegardlessTiming;
    private Blink mBlink;

    bool mCursorVisible = true;
    bool mSelectAllOnFocus;
    bool mTextIsSelectable;

    CharSequence mError;
    bool mErrorWasChanged;
    ...
    bool mInBatchEditControllers;
    bool mShowSoftInputOnFocus = true;
    private bool mPreserveSelection;
    private bool mRestartActionModeOnNextRefresh;
    private bool mRequestingLinkActionMode;

    private SelectionActionModeHelper mSelectionActionModeHelper;

    bool mIsBeingLongClicked;
    ...
    private bool mUpdateWordIteratorText;
    ...
    bool mIsInsertionActionModeStartPending = false;
    ...
    void prepareCursorControllers() {
        ...
        bool enabled = windowSupportsHandles && mTextView.getLayout() != null;
     ...
     */
    private void updateSpellCheckSpans(int start, int end, bool createSpellChecker) {
    ...
    private bool needsToSelectAllToSelectWordOrParagraph() {
     ...
     * successfully performed.
     */
    private bool selectCurrentParagraph() {
        if (!mTextView.canSelectText()) {
            return false;
        }
    ...
    private int getNextCursorOffset(int offset, bool findAfterGivenOffset) {
        final Layout layout = mTextView.getLayout();
    ...
    private interface TextViewPositionListener {
        public void updatePosition(int parentPositionX, int parentPositionY,
                bool parentPositionChanged, bool parentScrolled);
    }
    ...
    public bool performLongClick(bool handled) {
    ...
    void onFocusChanged(bool focused, int direction) {
        ...
        if (focused) {
            ...
            final bool isFocusHighlighted = mSelectAllOnFocus && selStart == 0
    ...
    private void updateTapState(MotionEvent event) {
        ...
        if (action == MotionEvent.ACTION_DOWN) {
            final bool isMouse = event.isFromSource(InputDevice.SOURCE_MOUSE);
    ...
    private bool shouldFilterOutTouchEvent(MotionEvent event) {
        if (!event.isFromSource(InputDevice.SOURCE_MOUSE)) {
            return false;
        }
        final bool primaryButtonStateChanged =
    ...
    void onTouchEvent(MotionEvent event) {
        final bool filterOutEvent = shouldFilterOutTouchEvent(event);
    ...
    private bool extractTextInternal(@Nullable ExtractedTextRequest request,
    ...
    bool reportExtractedText() {
        ...
        final bool wasContentChanged = ims.mContentChanged;
    ...
    private int drawHardwareAcceleratedInner(Canvas canvas, Layout layout, Path highlight,
        ...
        final bool blockIsInvalid = blockIndex == DynamicLayout.INVALID_BLOCK_INDEX;
        if (blockIsInvalid) {
        ...
        final bool blockDisplayListIsInvalid = mTextRenderNodes[blockIndex].needsRecord();
    ...
    private void drawCursor(Canvas canvas, int cursorOffsetVertical) {
        final bool translate = cursorOffsetVertical != 0;
    ...
    void updateCursorPosition() {
        ...
        final bool clamped = layout.shouldClampCursor(line);
    ...
    void refreshTextActionMode() {
        ...
        final bool hasSelection = mTextView.hasSelection();
    ...
    void setRestartActionModeOnNextRefresh(bool value) {
     ...
     */
    void startSelectionActionModeAsync(bool adjustSelection) {
     ...
     */
    private bool selectCurrentWordAndStartDrag() {
        if (mInsertionActionModeRunnable != null) {
            mTextView.removeCallbacks(mInsertionActionModeRunnable);
        }
        if (extractedTextModeWillBeStarted()) {
    ...
    bool startActionModeInternal(@TextActionMode int actionMode) {
        if (extractedTextModeWillBeStarted()) {
            return false;
        }
        if (mTextActionMode != null) {
        ...
        final bool selectableText = mTextView.isTextEditable() || mTextView.isTextSelectable();
        ...
        final bool selectionStarted = mTextActionMode != null;
        if (selectionStarted
    ...
    private bool extractedTextModeWillBeStarted() {
        if (!(mTextView.isInExtractedMode())) {
            final InputMethodManager imm = InputMethodManager.peekInstance();
     ...
     */
    private bool shouldOfferToShowSuggestions() {
        CharSequence text = mTextView.getText();
        ...
        bool hasValidSuggestions = false;
        for (int i = 0; i < suggestionSpans.length; i++) {
    ...
    void onTouchUpEvent(MotionEvent event) {
        ...
        bool selectAllGotFocus = mSelectAllOnFocus && mTextView.didTouchFocusSelect();
        hideCursorAndSpanControllers();
        stopTextActionMode();
        CharSequence text = mTextView.getText();
        if (!selectAllGotFocus && text.length() > 0) {
            ...
            final bool shouldInsertCursor = !mRequestingLinkActionMode;
    ...
    void onDrop(DragEvent event) {
        ...
        try {
            ...
            bool dragDropIntoItself = dragLocalState != null
    ...
    void onCreateContextMenu(ContextMenu menu) {
        ...
        stopTextActionModeWithPreservingSelection();
        if (mTextView.canSelectText()) {
            final bool isOnSelection = mTextView.hasSelection()
     ...
     */
    private class SpanController : SpanWatcher {
        ...
        private bool isNonIntermediateSelectionSpan(final Spannable text,
                final Object span) {
     ...
     */
    private class EasyEditPopupWindow : PinnedPopupWindow
            : OnClickListener {
    ...
    private class PositionListener : ViewTreeObserver.OnPreDrawListener {
        // 3 handles
        ...
        private bool[] mCanMove = new bool[MAXIMUM_NUMBER_OF_LISTENERS];
        private bool mPositionHasChanged = true;
        // Absolute position of the TextView with respect to its parent window
        private int mPositionX, mPositionY;
        private int mPositionXOnScreen, mPositionYOnScreen;
        private int mNumberOfListeners;
        private bool mScrollHasChanged;
        final int[] mTempCoords = new int[2];

        public void addSubscriber(TextViewPositionListener positionListener, bool canMove) {
    ...
    private abstract class PinnedPopupWindow : TextViewPositionListener {
    ...
    private class SuggestionHelper {
        ...
        private class SuggestionSpanComparator : Comparator<SuggestionSpan> {
            public int compare(SuggestionSpan span1, SuggestionSpan span2) {
                final int flag1 = span1.getFlags();
                final int flag2 = span2.getFlags();
                if (flag1 != flag2) {
                    // The order here should match what is used in updateDrawState
                    final bool easy1 = (flag1 & SuggestionSpan.FLAG_EASY_CORRECT) != 0;
                    final bool easy2 = (flag2 & SuggestionSpan.FLAG_EASY_CORRECT) != 0;
                    final bool misspelled1 = (flag1 & SuggestionSpan.FLAG_MISSPELLED) != 0;
                    final bool misspelled2 = (flag2 & SuggestionSpan.FLAG_MISSPELLED) != 0;
    ...
    @VisibleForTesting
    public class SuggestionsPopupWindow : PinnedPopupWindow : OnItemClickListener {
        ...
        private bool mCursorWasVisibleBeforeSuggestions;
        private bool mIsShowingUp = false;
        ...
        private class CustomPopupWindow : PopupWindow {
        ...
        private Context applyDefaultTheme(Context originalContext) {
            ...
            bool isLightTheme = a.getBoolean(0, true);
        ...
        private class SuggestionAdapter : BaseAdapter {
        ...
        private bool updateSuggestions() {
            Spannable spannable = (Spannable) mTextView.getText();
     ...
     */
    private class TextActionModeCallback : ActionMode.Callback2 {
        private final Path mSelectionPath = new Path();
        private final RectF mSelectionBounds = new RectF();
        private final bool mHasSelection;
        ...
        private void updateSelectAllItem(Menu menu) {
            bool canSelectAll = mTextView.canSelectAllText();
            bool selectAllItemExists = menu.findItem(TextView.ID_SELECT_ALL) != null;
        ...
        private void updateReplaceItem(Menu menu) {
            bool canReplace = mTextView.isSuggestionsEnabled() && shouldOfferToShowSuggestions();
            bool replaceItemExists = menu.findItem(TextView.ID_REPLACE) != null;
        ...
        private bool hasLegacyAssistItem(TextClassification classification) {
        ...
        private bool onAssistMenuItemClicked(MenuItem assistMenuItem) {
        ...
        private bool shouldEnableAssistMenuItems() {
     ...
     */
    private final class CursorAnchorInfoNotifier : TextViewPositionListener {
        ...
        public void updatePosition(int parentPositionX, int parentPositionY,
            ...
            if (0 <= selectionStart) {
                ...
                final float insertionMarkerBottom = layout.getLineBottomWithoutSpacing(line)
                        + viewportToContentVerticalOffset;
                final bool isTopVisible = mTextView
                        .isPositionVisible(insertionMarkerX, insertionMarkerTop);
                final bool isBottomVisible = mTextView
    ...
    private static class MagnifierMotionAnimator {
        ...
        private bool mMagnifierIsShowing;
        ...
        private void show(final float x, final float y) {
            final bool startNewAnimation = mMagnifierIsShowing && y != mLastY;
    ...
    @VisibleForTesting
    public abstract class HandleView : View : TextViewPositionListener {
        ...
        protected void updateDrawable() {
            ...
            final bool isRtlCharAtOffset = isAtRtlRun(layout, offset);
        ...
        protected abstract int getHotspotX(Drawable drawable, bool isRtlRun);
        protected abstract int getHorizontalGravity(bool isRtlRun);
        ...
        private void filterOnTouchUp(bool fromTouchScreen) {
        ...
        public bool offsetHasBeenChanged() {
        ...
        private void setVisible(final bool visible) {
        ...
        protected abstract void updatePosition(float x, float y, bool fromTouchScreen);

        @MagnifierHandleTrigger
        protected abstract int getMagnifierHandleTrigger();

        protected bool isAtRtlRun(@NonNull Layout layout, int offset) {
         ...
         * touch screen.
         */
        protected void positionAtCursorOffset(int offset, bool forceUpdatePosition,
                bool fromTouchScreen) {
            ...
            bool offsetChanged = offset != mPreviousOffset;
        ...
        private bool tooLargeTextForMagnifier() {
         ...
         */
        private bool obtainMagnifierShowCoordinates(@NonNull final MotionEvent event,
            ...
            final bool sameLineSelection = otherHandleOffset != -1
                    && lineNumber == layout.getLineForOffset(otherHandleOffset);
            final bool rtl = sameLineSelection
        ...
        private bool handleOverlapsMagnifier(@NonNull final HandleView handle,
        ...
        protected final void updateMagnifier(@NonNull final MotionEvent event) {
            ...
            final bool shouldShow = !tooLargeTextForMagnifier()
    ...
    private class InsertionHandleView : HandleView {
        ...
        override
        protected int getHotspotX(Drawable drawable, bool isRtlRun) {
            return drawable.getIntrinsicWidth() / 2;
        }

        override
        protected int getHorizontalGravity(bool isRtlRun) {
        ...
        override
        public bool onTouchEvent(MotionEvent ev) {
            final bool result = super.onTouchEvent(ev);
        ...
        override
        protected void updatePosition(float x, float y, bool fromTouchScreen) {
            Layout layout = mTextView.getLayout();
            int offset;
            if (layout != null) {
    ...
    @VisibleForTesting
    public final class SelectionHandleView : HandleView {
        ...
        private bool mLanguageDirectionChanged = false;
        ...
        protected void updatePosition(float x, float y, bool fromTouchScreen) {
            ...
            final bool rtlAtCurrentOffset = isAtRtlRun(layout, currentOffset);
            final bool atRtl = isAtRtlRun(layout, offset);
            final bool isLvlBoundary = layout.isLevelBoundary(offset);
            ...
            if (isExpanding) {
                ...
                final bool shrinking = isStartHandle()
        ...
        public bool onTouchEvent(MotionEvent event) {
            bool superResult = super.onTouchEvent(event);
        ...
        private void positionAndAdjustForCrossingHandles(int offset, bool fromTouchScreen) {
            final int anotherHandleOffset =
                    isStartHandle() ? mTextView.getSelectionEnd() : mTextView.getSelectionStart();
        ...
        private bool positionNearEdgeOfScrollingView(float x, bool atRtl) {
        ...
        private float getHorizontal(@NonNull Layout layout, int offset, bool startHandle) {
            final int line = layout.getLineForOffset(offset);
            final int offsetToCheck = startHandle ? offset : Math.max(offset - 1, 0);
            final bool isRtlChar = layout.isRtlCharAt(offsetToCheck);
            final bool isRtlParagraph = layout.getParagraphDirection(line) == -1;
     ...
     */
    private interface CursorController : ViewTreeObserver.OnTouchModeChangeListener {
        /**
        ...
        public bool isCursorBeingModified();

        public bool isActive();
    }

    private class InsertionPointCursorController : CursorController {
    ...
    class SelectionModifierCursorController : CursorController {
        ...
        private float mDownPositionX, mDownPositionY;
        private bool mGestureStayedInTapRegion;

        // Where the user first starts the drag motion.
        private int mStartOffset = -1;

        private bool mHaventMovedEnoughToStartDrag;
        ...
        private bool mSwitchedLines = false;
         ...
         * @return true if the drag was started.
         */
        private bool selectCurrentParagraphAndStartDrag() {
            if (mInsertionActionModeRunnable != null) {
                mTextView.removeCallbacks(mInsertionActionModeRunnable);
            }
            stopTextActionMode();
        ...
        private void updateSelectionInternal(int selectionStart, int selectionEnd,
                bool fromTouchScreen) {
            final bool performHapticFeedback = fromTouchScreen && mHapticTextHandleEnabled
         ...
         */
        public bool isSelectionStartDragged() {
         ...
         */
        public bool isDragAcceleratorActive() {
    ...
    private class CorrectionHighlighter {
        ...
        private void invalidate(bool delayed) {
    ...
    private static class ErrorPopup : PopupWindow {
        private bool mAbove = false;
        ...
        override
        public void update(int x, int y, int w, int h, bool force) {
     ...
     */
    private static bool isValidRange(CharSequence text, int start, int end) {
    ...
    public static class UndoInputFilter : InputFilter {
        ...
        private bool mPreviousOperationWasInSameBatchEdit;
        ...
        public CharSequence filter(CharSequence source, int start, int end,
            ...
            final bool hadComposition = mHasComposition;
            mHasComposition = isComposition(source);
            final bool wasExpanding = mExpanding;
            bool shouldCreateSeparateState = false;
        ...
        private void handleEdit(CharSequence source, int start, int end,
                Spanned dest, int dstart, int dend, bool shouldCreateSeparateState) {
        ...
        private bool canUndoEdit(CharSequence source, int start, int end,
                Spanned dest, int dstart, int dend) {
        ...
        private static bool isComposition(CharSequence source) {
     ...
     */
    public static class EditOperation : UndoOperation<Editor> {
         ...
         * object unchanged.
         */
        private bool mergeWith(EditOperation edit) {
            if (DEBUG_UNDO) {
        ...
        private bool mergeInsertWith(EditOperation edit) {
        ...
        private bool mergeDeleteWith(EditOperation edit) {
        ...
        private bool mergeReplaceWith(EditOperation edit) {
    ...
    static final class ProcessTextIntentActionsHandler {
         ...
         */
        public bool performMenuItemAction(MenuItem item) {
         ...
         * @return True if the action was performed, false otherwise.
         */
        public bool performAccessibilityAction(int actionId) {
            return fireIntent(mAccessibilityIntents.get(actionId));
        }

        private bool fireIntent(Intent intent) {
        ...
        private bool isSupportedActivity(ResolveInfo info) {
