 ...
 * @hide
 */
public class ActionMenuPresenter : BaseMenuPresenter
        : ActionProvider.SubUiVisibilityListener {
    private static final int ITEM_ANIMATION_DURATION = 150;
    private static final bool ACTIONBAR_ANIMATIONS_ENABLED = false;

    private OverflowMenuButton mOverflowButton;
    private Drawable mPendingOverflowIcon;
    private bool mPendingOverflowIconSet;
    ...
    public void setWidthLimit(int width, bool strict) {
        mWidthLimit = width;
        mStrictWidthLimit = strict;
        mWidthLimitSet = true;
    }

    public void setReserveOverflow(bool reserveOverflow) {
    ...
    public void setExpandedActionViewsExclusive(bool isExclusive) {
    ...
    override
    public bool shouldIncludeItem(int childIndex, MenuItemImpl item) {
     ...
     */
    private void computeMenuItemAnimationInfo(bool preLayout) {
    ...
    override
    public bool filterLeftoverView(ViewGroup parent, int childIndex) {
    ...
    public bool flagActionItems() {
        ...
        for (int i = 0; i < itemsSize; i++) {
            ...
            if (item.requiresActionButton()) {
                ...
                final int groupId = item.getGroupId();
                final bool inGroup = seenGroups.get(groupId);
    ...
    private class OverflowMenuButton : ImageButton : ActionMenuView.ActionMenuChildView {
    ...
    private class OverflowPopup : MenuPopupHelper {
    ...
    private class ActionButtonSubmenu : MenuPopupHelper {
    ...
    private class PopupPresenterCallback : Callback {
    ...
    private class OpenOverflowRunnable : Runnable {
    ...
    private class ActionMenuPopupCallback : ActionMenuItemView.PopupCallback {
        override
        public ShowableListMenu getPopup() {
