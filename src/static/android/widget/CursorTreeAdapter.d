 ...
 * will not work.
 */
public abstract class CursorTreeAdapter : BaseExpandableListAdapter : Filterable,
     ...
     *        always displayed.
     */
    public CursorTreeAdapter(Cursor cursor, Context context, bool autoRequery) {
        init(cursor, context, autoRequery);
    }
    
    private void init(Cursor cursor, Context context, bool autoRequery) {
        mContext = context;
     ...
     */
    synchronized MyCursorHelper getChildrenCursorHelper(int groupPosition, bool requestCursor) {
     ...
     */
    protected abstract View newGroupView(Context context, Cursor cursor, bool isExpanded,
            ViewGroup parent);
     ...
     * @return the newly created view.
     */
    protected abstract View newChildView(Context context, Cursor cursor, bool isLastChild,
            ViewGroup parent);
     ...
     *            cursors.
     */
    public void notifyDataSetChanged(bool releaseCursors) {
    ...
    class MyCursorHelper {
        ...
        MyCursorHelper(Cursor cursor) {
            final bool cursorPresent = cursor != null;
            mCursor = cursor;
        ...
        void changeCursor(Cursor cursor, bool releaseCursors) {
