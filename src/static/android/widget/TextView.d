 ...
 */
@RemoteView
public class TextView : View : ViewTreeObserver.OnPreDrawListener {
    static final String LOG_TAG = "TextView";
    static final bool DEBUG_EXTRACT = false;
    ...
    private bool mPreDrawRegistered;
    private bool mPreDrawListenerDetached;
    ...
    // changing.
    private bool mPreventDefaultMovement;
    ...
    static class Drawables {
         ...
         */
        public bool resolveWithLayoutDirection(int layoutDirection) {
    ...
    private bool mLocalesChanged = false;

    // True if setKeyListener() has been explicitly called
    private bool mListenerChanged = false;
    // True if internationalized input should be used for numbers and date and time.
    private final bool mUseInternationalizedInput;
    // True if fallback fonts that end up getting used should be allowed to affect line spacing.
    /* package */ bool mUseFallbackLineSpacing;
    ...
    private bool mNeedsAutoSizeText = false;
    ...
    private bool mHasPresetAutoSizeValues = false;
    ...
    private bool mTextSetFromXmlOrResourceId = false;
    ...
    public interface OnEditorActionListener {
         ...
         */
        bool onEditorAction(TextView v, int actionId, KeyEvent event);
    }
    ...
    public TextView(
        ...
        final bool passwordInputType = variation
                == (EditorInfo.TYPE_CLASS_TEXT | EditorInfo.TYPE_TEXT_VARIATION_PASSWORD);
        final bool webPasswordInputType = variation
                == (EditorInfo.TYPE_CLASS_TEXT | EditorInfo.TYPE_TEXT_VARIATION_WEB_PASSWORD);
        final bool numberPasswordInputType = variation
        ...
        final bool isPassword = password || passwordInputType || webPasswordInputType
                || numberPasswordInputType;
        final bool isMonospaceEnforced = isPassword || (mEditor != null
                && (mEditor.mInputType
        ...
        bool canInputOrMove = (mMovement != null || getKeyListener() != null);
        bool clickable = canInputOrMove || isClickable();
        bool longClickable = canInputOrMove || isLongClickable();
    ...
    private void resolveStyleAndSetTypeface(@NonNull Typeface typeface, @Typeface.Style int style,
        ...
        if (weight >= 0) {
            ...
            final bool italic = (style & Typeface.ITALIC) != 0;
     ...
     */
    protected bool getDefaultEditable() {
        return false;
    }
    ...
    public void setCompoundDrawables(@Nullable Drawable left, @Nullable Drawable top,
        ...
        final bool drawables = left != null || top != null || right != null || bottom != null;
        if (!drawables) {
    ...
    public void setCompoundDrawablesRelative(@Nullable Drawable start, @Nullable Drawable top,
        ...
        final bool drawables = start != null || top != null
    ...
    private void applyCompoundDrawableTint() {
        ...
        if (mDrawables.mHasTint || mDrawables.mHasTintMode) {
            ...
            final bool hasTint = mDrawables.mHasTint;
            final bool hasTintMode = mDrawables.mHasTintMode;
    ...
    private void readTextAppearance(Context context, TypedArray appearance,
            TextAppearanceAttributes attributes, bool styleArray) {
    ...
    private void changeListenerLocaleTo(@Nullable Locale locale) {
        ...
        if (mEditor != null) {
            ...
            final bool wasPasswordType = isPasswordInputType(mEditor.mInputType);
    ...
    private void setTextSizeInternal(int unit, float size, bool shouldRequestLayout) {
    ...
    private void setRawTextSize(float size, bool shouldRequestLayout) {
     ...
     * @attr ref android.R.styleable#TextView_elegantTextHeight
     */
    public void setElegantTextHeight(bool elegant) {
     ...
     *
     * @see StaticLayout.Builder#setUseLineSpacingFromFallbacks(bool)
     *
     * @attr ref android.R.styleable#TextView_fallbackLineSpacing
     */
    public void setFallbackLineSpacing(bool enabled) {
     ...
     *
     * @see #setFallbackLineSpacing(bool)
     *
     * @attr ref android.R.styleable#TextView_fallbackLineSpacing
     */
     ...
     *
     * @see #setElegantTextHeight(bool)
     * @see Paint#setElegantTextHeight(bool)
     */
     ...
     */
    public bool setFontVariationSettings(@Nullable String fontVariationSettings) {
        ...
        bool effective = mTextPaint.setFontVariationSettings(fontVariationSettings);
     ...
     */
    @android.view.RemotableViewMethod
    public final void setShowSoftInputOnFocus(bool show) {
        createEditorIfNeeded();
     ...
     * TextView gets focused. The default is true.
     */
    public final bool getShowSoftInputOnFocus() {
     ...
     */
    @android.view.RemotableViewMethod
    public final void setLinksClickable(bool whether) {
     ...
     * @attr ref android.R.styleable#TextView_linksClickable
     */
    public final bool getLinksClickable() {
     ...
     * @attr ref android.R.styleable#TextView_scrollHorizontally
     */
    public void setHorizontallyScrolling(bool whether) {
     ...
     * @hide
     */
    public bool getHorizontallyScrolling() {
    ...
    public Parcelable onSaveInstanceState() {
        ...
        final bool freezesText = getFreezesText();
     ...
     */
    @android.view.RemotableViewMethod
    public void setFreezesText(bool freezesText) {
    ...
    public void setInputType(int type) {
        final bool wasPassword = isPasswordInputType(getInputType());
        final bool wasVisiblePassword = isVisiblePasswordInputType(getInputType());
        setInputType(type, false);
        final bool isPassword = isPasswordInputType(type);
        final bool isVisiblePassword = isVisiblePasswordInputType(type);
    ...
    protected bool setFrame(int l, int t, int r, int b) {
        bool result = super.setFrame(l, t, r, b);
    ...
    private void setFilters(Editable e, InputFilter[] filters) {
        if (mEditor != null) {
            final bool undoFilter = mEditor.mUndoInputFilter != null;
            final bool keyFilter = mEditor.mKeyListener instanceof InputFilter;
            int num = 0;
            if (undoFilter) num++;
            if (keyFilter) num++;
            if (num > 0) {
    ...
    override
    protected bool verifyDrawable(@NonNull Drawable who) {
        final bool verified = super.verifyDrawable(who);
     ...
     */
    public void setTextIsSelectable(bool selectable) {
    ...
    public void getFocusedRect(Rect r) {
        ...
        if (selStart < 0 || selStart >= selEnd) {
            ...
            if (lineStart == lineEnd) {
                ...
                // Selection : across multiple lines -- make the focused
     ...
     * @hide
     */
    public bool handleBackInTextActionModeIfNeeded(KeyEvent event) {
    ...
    private bool isDirectionalNavigationKey(int keyCode) {
        switch(keyCode) {
    ...
    private int doKeyDown(int keyCode, KeyEvent event, KeyEvent otherEvent) {
        ...
        if (mEditor != null && mEditor.mKeyListener != null) {
            ...
            if (otherEvent != null) {
                try {
                    beginBatchEdit();
                    final bool handled = mEditor.mKeyListener.onKeyOther(this, (Editable) mText,
                            otherEvent);
                    hideErrorIfUnchanged();
                    doDown = false;
                    if (handled) {
            ...
            if (doDown) {
                beginBatchEdit();
                final bool handled = mEditor.mKeyListener.onKeyDown(this, (Editable) mText,
                        keyCode, event);
                endBatchEdit();
                hideErrorIfUnchanged();
        ...
        if (mMovement != null && mLayout != null) {
            ...
            if (otherEvent != null) {
                try {
                    bool handled = mMovement.onKeyOther(this, mSpannable, otherEvent);
                    doDown = false;
                    if (handled) {
                        return KEY_EVENT_HANDLED;
                    }
     ...
     */
    public bool extractText(ExtractedTextRequest request, ExtractedText outText) {
        createEditorIfNeeded();
     ...
     */
    public bool onPrivateIMECommand(String action, Bundle data) {
        return false;
    }
    ...
    public void makeNewLayout(int wantWidth, int hintWidth,
        ...
        final bool testDirChange = mSingleLine && mLayout != null
                && (alignment == Layout.Alignment.ALIGN_NORMAL
                        || alignment == Layout.Alignment.ALIGN_OPPOSITE);
        int oldDir = 0;
        if (testDirChange) oldDir = mLayout.getParagraphDirection(0);
        bool shouldEllipsize = mEllipsize != null && getKeyListener() == null;
        final bool switchEllipsize = mEllipsize == TruncateAt.MARQUEE
                && mMarqueeFadeMode != MARQUEE_FADE_NORMAL;
    ...
    protected Layout makeSingleLayout(int wantWidth, BoringLayout.Metrics boring, int ellipsisWidth,
            Layout.Alignment alignment, bool shouldEllipsize, TruncateAt effectiveEllipsize,
            bool useSaved) {
        Layout result = null;
        if (useDynamicLayout()) {
     ...
     * @attr ref android.R.styleable#TextView_includeFontPadding
     */
    public void setIncludeFontPadding(bool includepad) {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (mLayout == null) {
            ...
            final bool layoutChanged = (mLayout.getWidth() != want) || (hintWidth != hintWant)
                    || (mLayout.getEllipsizedWidth()
                            != width - getCompoundPaddingLeft() - getCompoundPaddingRight());

            final bool widthChanged = (mHint == null) && (mEllipsize == null)
                    && (want > mLayout.getWidth())
                    && (mLayout instanceof BoringLayout
                            || (fromexisting && des >= 0 && des <= want));

            final bool maximumChanged = (mMaxMode != mOldMaxMode) || (mMaximum != mOldMaximum);
    ...
    private bool suggestedSizeFitsInSpace(int suggestedSizeInPx, RectF availableSpace) {
    ...
    private int getDesiredHeight(Layout layout, bool cap) {
        if (layout == null) {
            return 0;
        }
     ...
     */
    public bool bringPointIntoView(int offset) {
    ...
    private void applySingleLine(bool singleLine, bool applyTransformation,
            bool changeMaxLines) {
    ...
    public bool onTouchEvent(MotionEvent event) {
        ...
        final bool superResult = super.onTouchEvent(event);
        ...
        final bool touchIsFinished = (action == MotionEvent.ACTION_UP)
        ...
        if ((mMovement != null || onCheckIsTextEditor()) && isEnabled()
            ...
            final bool textIsSelectable = isTextSelectable();
    ...
    override
    public bool showContextMenu(float x, float y) {
        if (mEditor != null) {
    ...
    override
    public bool onTrackballEvent(MotionEvent event) {
    ...
    private bool isMarqueeFadeEnabled() {
    ...
    private Locale getTextServicesLocale(bool allowNullLocale) {
     ...
     * auto-size.
     */
    private bool isAutoSizeEnabled() {
     ...
     * @hide
     */
    protected bool supportsAutoSizeText() {
        return true;
    }
    ...
    private void onProvideAutoStructureForAssistOrAutofill(ViewStructure structure,
            bool forAutofill) {
        final bool isPassword = hasPasswordTransformationMethod()
    ...
    public void populateCharacterBounds(CursorAnchorInfo.Builder builder,
        ...
        for (int line = minLine; line <= maxLine; ++line) {
            ...
            for (int offset = offsetStart; offset < offsetEnd; ++offset) {
                ...
                final bool isRtl = mLayout.isRtlCharAt(offset);
                ...
                final bool isTopLeftVisible = isPositionVisible(localLeft, localTop);
                final bool isBottomRightVisible =
     ...
     * @hide
     */
    public bool isPositionVisible(final float positionX, final float positionY) {
    ...
    private bool performAccessibilityActionClick(Bundle arguments) {
        bool handled = false;
    ...
    public bool performLongClick() {
        bool handled = false;
        bool performedHapticFeedback = false;
     ...
     * @hide
     */
    public bool requestActionMode(@NonNull TextLinks.TextLinkSpan clickedSpan) {
     ...
     * @hide
     */
    public bool handleClick(@NonNull TextLinks.TextLinkSpan clickedSpan) {
        Preconditions.checkNotNull(clickedSpan);
        if (mText instanceof Spanned) {
    ...
    bool canPasteAsPlainText() {
        ...
        final bool isPlainType = description.hasMimeType(ClipDescription.MIMETYPE_TEXT_PLAIN);
     ...
     */
    private void paste(int min, int max, bool withFormatting) {
    ...
    @CheckResult
    private bool setPrimaryClip(ClipData clip) {
        ClipboardManager clipboard =
                (ClipboardManager) getContext().getSystemService(Context.CLIPBOARD_SERVICE);
        try {
    ...
    protected TextDirectionHeuristic getTextDirectionHeuristic() {
        ...
        final bool defaultIsRtl = (getLayoutDirection() == LAYOUT_DIRECTION_RTL);
     ...
     * @hide
     */
    public bool isAccessibilitySelectionExtendable() {
        return true;
    }
     ...
     */
    public static class SavedState : BaseSavedState {
        int selStart = -1;
        int selEnd = -1;
        CharSequence text;
    ...
    private static class CharWrapper : CharSequence, GetChars, GraphicsOperations {
        private char[] mChars;
        ...
        public float getTextRunAdvances(int start, int end, int contextStart,
                int contextEnd, bool isRtl, float[] advances, int advancesIndex,
                Paint p) {
            int count = end - start;
            int contextCount = contextEnd - contextStart;
    ...
    private class ChangeWatcher : TextWatcher, SpanWatcher {
