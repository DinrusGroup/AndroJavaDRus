 ...
 * @hide
 */
public class SpellChecker : SpellCheckerSessionListener {
    ...
    private bool mIsSentenceSpellCheckSupported;
    final int mCookie;
    ...
    public void spellCheck(int start, int end) {
        ...
        final bool isSessionActive = isSessionActive();
        if (locale == null || mCurrentLocale == null || (!(mCurrentLocale.equals(locale)))) {
            ...
            final bool spellCheckerActivated = mTextServicesManager.isSpellCheckerEnabled();
    ...
    private class SpellParser {
        ...
        public void parse() {
            ...
            if (mIsSentenceSpellCheckSupported) {
                ...
                bool correct = spellCheckEnd != BreakIterator.DONE;
                if (correct) {
    ...
    public static bool haveWordBoundariesChanged(final Editable editable, final int start,
            final int end, final int spanStart, final int spanEnd) {
        final bool haveWordBoundariesChanged;
