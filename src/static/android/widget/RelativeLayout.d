...
public class RelativeLayout : ViewGroup {
    ...
    private bool mAllowBrokenMeasureSpecs = false;
    ...
    private bool mMeasureVerticalWithPaddingMargin = false;
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        final bool horizontalGravity = gravity != Gravity.START && gravity != 0;
        gravity = mGravity & Gravity.VERTICAL_GRAVITY_MASK;
        final bool verticalGravity = gravity != Gravity.TOP && gravity != 0;
        ...
        final bool isWrapContentWidth = widthMode != MeasureSpec.EXACTLY;
        final bool isWrapContentHeight = heightMode != MeasureSpec.EXACTLY;
    ...
    private int getChildMeasureSpec(int childStart, int childEnd,
        ...
        final bool isUnspecified = mySize < 0;
    ...
    private bool positionChildHorizontal(View child, LayoutParams params, int myWidth,
            bool wrapContent) {
    ...
    private bool positionChildVertical(View child, LayoutParams params, int myHeight,
            bool wrapContent) {
     ...
     */
     private class TopToBottomLeftToRightComparator : Comparator<View> {
    ...
    public static class LayoutParams : ViewGroup.MarginLayoutParams {
         ...
         */
        private bool mNeedsLayoutResolution;

        private bool mRulesChanged = false;
        private bool mIsRtlCompatibilityMode = false;
         ...
         * sibling (ex. {@link #ALIGN_RIGHT}) or take a bool
         ...
         * {@link #ALIGN_RIGHT}) or take a bool value (ex.
         ...
         *                bool value (represented as {@link #TRUE} for true
         *                or 0 for false)
         * @see #addRule(int)
         * @see #removeRule(int)
         * @see #getRule(int)
         ...
         * @return the id of another view to use as an anchor, a bool value
        ...
        private bool isRelativeRule(int rule) {
        ...
        private void resolveRules(int layoutDirection) {
            final bool isLayoutRtl = (layoutDirection == View.LAYOUT_DIRECTION_RTL);
        ...
        private bool shouldResolveLayoutDirection(int layoutDirection) {
