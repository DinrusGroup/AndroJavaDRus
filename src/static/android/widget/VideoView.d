...
public class VideoView : SurfaceView
        : MediaPlayerControl, SubtitleController.Anchor {
    ...
    private MediaPlayer.OnInfoListener mInfoListener =
        ...
        public  bool onInfo(MediaPlayer mp, int arg1, int arg2) {
    ...
    private MediaPlayer.OnErrorListener mErrorListener =
        ...
        public bool onError(MediaPlayer mp, int framework_err, int impl_err) {
    ...
    SurfaceHolder.Callback mSHCallback = new SurfaceHolder.Callback()
    {
                                    ...
                                    int w, int h)
        {
            ...
            bool hasValidSize = (mVideoWidth == w && mVideoHeight == h);
    ...
    {
        bool isKeyCodeSupported = keyCode != KeyEvent.KEYCODE_BACK &&
    ...
    public void setSubtitleWidget(RenderingWidget subtitleWidget) {
        ...
        final bool attachedToWindow = isAttachedToWindow();
        if (mSubtitleWidget != null) {
            if (attachedToWindow) {
                mSubtitleWidget.onDetachedFromWindow();
            }
