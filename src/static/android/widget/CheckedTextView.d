 ...
 */
public class CheckedTextView : TextView : Checkable {
    ...
    public CheckedTextView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        final bool checked = a.getBoolean(R.styleable.CheckedTextView_checked, false);
        setChecked(checked);
    ...
    private void setBasePadding(bool checkmarkAtStart) {
        if (checkmarkAtStart) {
    ...
    private bool isCheckMarkAtStart() {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (checkMarkDrawable != null) {
            ...
            final bool checkMarkAtStart = isCheckMarkAtStart();
