...
/**
 * AbsSeekBar : the capabilities of ProgressBar by adding a draggable thumb.
 */
public abstract class AbsSeekBar : ProgressBar {
    ...
    private bool mHasTickMarkTint = false;
    private bool mHasTickMarkTintMode = false;
    ...
    public AbsSeekBar(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        final bool useDisabledAlpha = a.getBoolean(R.styleable.SeekBar_useDisabledAlpha, true);
        a.recycle();
