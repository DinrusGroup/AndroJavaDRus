...
public class StackView : AdapterViewAnimator {
     ...
     */
    void transformViewForTransition(int fromIndex, int toIndex, final View view, bool animate) {
        if (!animate) {
    ...
    private void transformViewAtIndex(int index, final View view, bool animate) {
    ...
    private static class StackFrame : FrameLayout {
    ...
    private class StackSlider {
        ...
        private float getDuration(bool invert, float velocity) {
            if (mView != null) {
                final LayoutParams viewLp = (LayoutParams) mView.getLayoutParams();
