 ...
 *
 */
public class TabHost : FrameLayout : ViewTreeObserver.OnTouchModeChangeListener {
...
mTabHost.addTab(TAB_TAG_1, "Hello, world!", "Tab 1");
    ...
    public bool dispatchKeyEvent(KeyEvent event) {
        final bool handled = super.dispatchKeyEvent(event);
     ...
     */
    private class LabelIndicatorStrategy : IndicatorStrategy {
     ...
     */
    private class LabelAndIconIndicatorStrategy : IndicatorStrategy {
        ...
        public View createIndicatorView() {
            ...
            final bool exclusive = iconView.getVisibility() == View.GONE;
            final bool bindIcon = !exclusive || TextUtils.isEmpty(mLabel);
     ...
     */
    private class ViewIndicatorStrategy : IndicatorStrategy {
     ...
     */
    private class ViewIdContentStrategy : ContentStrategy {
     ...
     */
    private class FactoryContentStrategy : ContentStrategy {
     ...
     */
    private class IntentContentStrategy : ContentStrategy {
