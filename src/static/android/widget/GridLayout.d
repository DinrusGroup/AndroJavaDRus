 ...
 * {@link GridLayout#setUseDefaultMargins(bool) useDefaultMargins}
...
public class GridLayout : ViewGroup {
    ...
    private static final bool DEFAULT_USE_DEFAULT_MARGINS = false;
    private static final bool DEFAULT_ORDER_PRESERVED = true;
    ...
    bool mUseDefaultMargins = DEFAULT_USE_DEFAULT_MARGINS;
     ...
     * @attr ref android.R.styleable#GridLayout_useDefaultMargins
     */
    public void setUseDefaultMargins(bool useDefaultMargins) {
     ...
     * @attr ref android.R.styleable#GridLayout_rowOrderPreserved
     */
    public void setRowOrderPreserved(bool rowOrderPreserved) {
     ...
     *         {@code false} otherwise
     *
     * @see #setColumnOrderPreserved(bool)
     *
     * @attr ref android.R.styleable#GridLayout_columnOrderPreserved
     */
     ...
     * @attr ref android.R.styleable#GridLayout_columnOrderPreserved
     */
    public void setColumnOrderPreserved(bool columnOrderPreserved) {
    ...
    private int getDefaultMargin(View c, bool horizontal, bool leading) {
    ...
    private int getDefaultMargin(View c, bool isAtEdge, bool horizontal, bool leading) {
        return /*isAtEdge ? DEFAULT_CONTAINER_MARGIN :*/ getDefaultMargin(c, horizontal, leading);
    }

    private int getDefaultMargin(View c, LayoutParams p, bool horizontal, bool leading) {
    ...
    private int getMargin(View view, bool horizontal, bool leading) {
    ...
    private int getTotalMargin(View child, bool horizontal) {
    ...
    private static int clip(Interval minorRange, bool minorWasDefined, int count) {
    ...
    private void validateLayoutParams() {
        final bool horizontal = (mOrientation == HORIZONTAL);
        ...
        for (int i = 0, N = getChildCount(); i < N; i++) {
            ...
            final bool majorWasDefined = majorSpec.startDefined;
            ...
            final bool minorWasDefined = minorSpec.startDefined;
    ...
    private void checkLayoutParams(LayoutParams lp, bool horizontal) {
    ...
    private int getMeasurement(View c, bool horizontal) {
        return horizontal ? c.getMeasuredWidth() : c.getMeasuredHeight();
    }

    final int getMeasurementIncludingMargin(View c, bool horizontal) {
    ...
    final class Axis {
        ...
        private PackedMap<Interval, MutableInt> createLinks(bool min) {
        ...
        private void computeLinks(PackedMap<Interval, MutableInt> links, bool min) {
        ...
        private bool relax(int[] locations, Arc entry) {
            if (!entry.valid) {
                return false;
            }
        ...
        private void logError(String axisName, Arc[] arcs, bool[] culprits0) {
        ...
        */
        private bool solve(Arc[] arcs, int[] locations) {
            return solve(arcs, locations, true);
        }

        private bool solve(Arc[] arcs, int[] locations, bool modifyOnError) {
     ...
     *          {@link GridLayout#setUseDefaultMargins(bool) useDefaultMargins} is
    ...
    final static class Assoc<K, V> : ArrayList<Pair<K, V>> {
    ...
    *do* get added multiples times. So the length of index is equals to the number of
    ...
    final static class PackedMap<K, V> {
        ...
        private static <K> K[] compact(K[] a, int[] index) {
            int size = a.length;
            Class!(T) componentType = a.getClass().getComponentType();
    ...
    */
    static class Bounds {
        ...
        protected int getOffset(GridLayout gl, View c, Alignment a, int size, bool horizontal) {
    ...
    public static class Spec {
        ...
        final bool startDefined;
        final Interval span;
        final Alignment alignment;
        final float weight;

        private Spec(bool startDefined, Interval span, Alignment alignment, float weight) {
        ...
        private Spec(bool startDefined, int start, int size, Alignment alignment, float weight) {
            this(startDefined, new Interval(start, start + size), alignment, weight);
        }

        private Alignment getAbsoluteAlignment(bool horizontal) {
        ...
        public Bounds getBounds() {
            return new Bounds() {
                ...
                */
                ...
                override
                protected int getOffset(GridLayout gl, View c, Alignment a, int size, bool hrz) {
