...
public interface RowSetMetaData : ResultSetMetaData {
   ...
   * @exception SQLException if a database access error occurs
   */
  void setAutoIncrement(int columnIndex, bool property) throws SQLException;
   ...
   * @exception SQLException if a database access error occurs
   */
  void setCaseSensitive(int columnIndex, bool property) throws SQLException;
   ...
   * @exception SQLException if a database access error occurs
   */
  void setSearchable(int columnIndex, bool property) throws SQLException;
   ...
   * @exception SQLException if a database access error occurs
   */
  void setCurrency(int columnIndex, bool property) throws SQLException;
   ...
   * @exception SQLException if a database access error occurs
   */
  void setSigned(int columnIndex, bool property) throws SQLException;
