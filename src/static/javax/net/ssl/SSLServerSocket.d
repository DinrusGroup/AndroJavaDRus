...
/**
 * This class : <code>ServerSocket</code>s and
...
public abstract class SSLServerSocket : ServerSocket {
     ...
     * </ul>
     * <P>
     * Unlike {@link #setWantClientAuth(bool)}, if the accepted
     ...
     * {@link SSLSocket#setNeedClientAuth(bool)} or
     * {@link SSLSocket#setWantClientAuth(bool)}.
     *
     ...
     * </ul>
     * <P>
     * Unlike {@link #setNeedClientAuth(bool)}, if the accepted
     * socket's option is set and the client chooses not to provide
     * authentication information about itself, <i>the negotiations
     * will continue</i>.
     * <P>
