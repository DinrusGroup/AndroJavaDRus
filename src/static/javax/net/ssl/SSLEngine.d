 ...
 * java.nio.channels.spi.AbstractSelectableChannel#configureBlocking(bool)
 ...
 * #setUseClientMode(bool)} configures the mode.  Once the initial
...
public abstract class SSLEngine {
     ...
     */
    public abstract void setUseClientMode(bool mode);
     ...
     * </ul>
     * <P>
     * Unlike {@link #setNeedClientAuth(bool)}, if this option is set and
     * the client chooses not to provide authentication information
     * about itself, <i>the negotiations will continue</i>.
     * <P>
     * Calling this method overrides any previous setting made by
     * this method or {@link #setNeedClientAuth(bool)}.
     *
     ...
     */
    public abstract void setEnableSessionCreation(bool flag);
     ...
     *          is the default.  false indicates that an existing session
     *          must be resumed
     * @see     #setEnableSessionCreation(bool)
     */
