 ...
 * </pre>
 *
 * <p> This {@code Subject} class : {@code Serializable}.
 ...
 */
public final class Subject : java.io.Serializable.Serializable {
     ...
     * @serial
     */
    private volatile bool readOnly = false;
     ...
     */
    public Subject(bool readOnly, Set<? : Principal> principals,
                   Set!(T) pubCredentials, Set!(T) privCredentials)
    {
     ...
     *                  is {@code null}.
     */
    public <T : Principal> Set<T> getPrincipals(Class<T> c) {
    ...
    private static class SecureSet<E>
        ...
        SecureSet(Subject subject, int which, Set<? : E> set) {
            this.subject = subject;
            this.which = which;
    ...
    /**
     * This class : a {@code Set} which returns only
