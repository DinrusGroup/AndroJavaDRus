 ...
 * The {@link #compare(Duration duration)} method : this
 * relationship.</p>
 *
...
public abstract class   Duration {
     ...
     */
    public abstract bool isSet(final DatatypeConstants.Field field);
     ...
     */
    public bool isLongerThan(final Duration duration) {
     ...
     * @see #compare(Duration duration)
     */
    public bool isShorterThan(final Duration duration) {
     ...
     * @see #compare(Duration duration)
     */
    public bool equals(final Object duration) {
        if (duration == this) {
            return true;
        }
