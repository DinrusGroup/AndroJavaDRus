...
public abstract class DocumentBuilderFactory {
     ...
     * a non-validating parser by leaving the {@link #setValidating(bool)}
     ...
     * </code>.</p>
     *
     * @param ignoreComments <code>bool</code> value to ignore comments during processing
     */
     ...
     * @since 1.5
     */
    public void setXIncludeAware(final bool state) {
        throw new UnsupportedOperationException(
            "This parser does not support specification \""
            + this.getClass().getPackage().getSpecificationTitle()
            + "\" version \""
