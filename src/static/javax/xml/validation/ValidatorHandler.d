 ...
 *
 * <p>
 * {@link ValidatorHandler} : from {@link ContentHandler},
...
public abstract class ValidatorHandler : ContentHandler {
     ...
     * <pre>
     * class DraconianErrorHandler : {@link ErrorHandler} {
     ...
     * <pre>
     * class DumbLSResourceResolver : {@link LSResourceResolver} {
     ...
     * @see #setFeature(String, bool)
     */
    public bool getFeature(String name) throws SAXNotRecognizedException, SAXNotSupportedException {
        if (name == null) {
     ...
     */
    public void setFeature(String name, bool value) throws SAXNotRecognizedException, SAXNotSupportedException {
        if (name == null) {
            throw new NullPointerException("name == null");
        }
        throw new SAXNotRecognizedException(name);
