 ...
 * @since 1.4
 */
public class DESKeySpec : java.security.spec.KeySpec {
    ...
    private static final byte[][] WEAK_KEYS = {
        ...
        { cast(byte)0x01, cast(byte)0x01, cast(byte)0x01, cast(byte)0x01, cast(byte)0x01,
          cast(byte)0x01, cast(byte)0x01, cast(byte)0x01 },

        { cast(byte)0xFE, cast(byte)0xFE, cast(byte)0xFE, cast(byte)0xFE, cast(byte)0xFE,
          cast(byte)0xFE, cast(byte)0xFE, cast(byte)0xFE },

        { cast(byte)0x1F, cast(byte)0x1F, cast(byte)0x1F, cast(byte)0x1F, cast(byte)0x0E,
          cast(byte)0x0E, cast(byte)0x0E, cast(byte)0x0E },

        { cast(byte)0xE0, cast(byte)0xE0, cast(byte)0xE0, cast(byte)0xE0, cast(byte)0xF1,
          cast(byte)0xF1, cast(byte)0xF1, cast(byte)0xF1 },

        { cast(byte)0x01, cast(byte)0xFE, cast(byte)0x01, cast(byte)0xFE, cast(byte)0x01,
          cast(byte)0xFE, cast(byte)0x01, cast(byte)0xFE },

        { cast(byte)0x1F, cast(byte)0xE0, cast(byte)0x1F, cast(byte)0xE0, cast(byte)0x0E,
          cast(byte)0xF1, cast(byte)0x0E, cast(byte)0xF1 },

        { cast(byte)0x01, cast(byte)0xE0, cast(byte)0x01, cast(byte)0xE0, cast(byte)0x01,
          cast(byte)0xF1, cast(byte)0x01, cast(byte)0xF1 },

        { cast(byte)0x1F, cast(byte)0xFE, cast(byte)0x1F, cast(byte)0xFE, cast(byte)0x0E,
          cast(byte)0xFE, cast(byte)0x0E, cast(byte)0xFE },

        { cast(byte)0x01, cast(byte)0x1F, cast(byte)0x01, cast(byte)0x1F, cast(byte)0x01,
          cast(byte)0x0E, cast(byte)0x01, cast(byte)0x0E },

        { cast(byte)0xE0, cast(byte)0xFE, cast(byte)0xE0, cast(byte)0xFE, cast(byte)0xF1,
          cast(byte)0xFE, cast(byte)0xF1, cast(byte)0xFE },

        { cast(byte)0xFE, cast(byte)0x01, cast(byte)0xFE, cast(byte)0x01, cast(byte)0xFE,
          cast(byte)0x01, cast(byte)0xFE, cast(byte)0x01 },

        { cast(byte)0xE0, cast(byte)0x1F, cast(byte)0xE0, cast(byte)0x1F, cast(byte)0xF1,
          cast(byte)0x0E, cast(byte)0xF1, cast(byte)0x0E },

        { cast(byte)0xE0, cast(byte)0x01, cast(byte)0xE0, cast(byte)0x01, cast(byte)0xF1,
          cast(byte)0x01, cast(byte)0xF1, cast(byte)0x01 },

        { cast(byte)0xFE, cast(byte)0x1F, cast(byte)0xFE, cast(byte)0x1F, cast(byte)0xFE,
          cast(byte)0x0E, cast(byte)0xFE, cast(byte)0x0E },

        { cast(byte)0x1F, cast(byte)0x01, cast(byte)0x1F, cast(byte)0x01, cast(byte)0x0E,
          cast(byte)0x01, cast(byte)0x0E, cast(byte)0x01 },

        { cast(byte)0xFE, cast(byte)0xE0, cast(byte)0xFE, cast(byte)0xE0, cast(byte)0xFE,
          cast(byte)0xF1, cast(byte)0xFE, cast(byte)0xF1 }
    };
