...
final class JceSecurity {
    ...
    // private static final bool isRestricted = true;
    ...
    */
    ...
    static Instance getInstance(String type, Class!(T) clazz, String algorithm,
    ...
    private static final Map<Class!(T), URL> codeBaseCacheRef =
            new WeakHashMap<>();

    /*
     * Returns the CodeBase for the given class.
     */
    static URL getCodeBase(final Class!(T) clazz) {
