...
public class Cipher {
    ...
    // Android-note: Android re: provider selection.
    //
    ...
    */
    ...
    /**
     * Returns a <code>Cipher</code> object that : the specified
     * transformation.
     *
     ...
     *
     * @return a cipher that : the requested transformation.
     *
    ...
    */
     ...
     * expression.
     */
    static bool matchAttribute(Provider.Service service, String attr, String value) {
        if (value == null) {
            return true;
        }
