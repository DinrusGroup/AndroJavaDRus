...
public class TestRunner : BaseTestRunner {
	 ...
	 */
	static public void run(Class<? : TestCase> testClass) {
	...
	public TestResult doRun(Test suite, bool wait) {
	...
	protected void pause(bool wait) {
		if (!wait) return;
	...
	protected TestResult runSingleMethod(String testCase, String method, bool wait) throws Exception {
		Class<? : TestCase> testClass= loadSuiteClass(testCase).asSubclass(TestCase.class);
