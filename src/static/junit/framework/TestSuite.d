...
public class TestSuite : Test {
	 ...
	 */
	static public Test createTest(Class!(T) theClass, String name) {
	 ...
	 */
	public static Constructor!(T) getTestConstructor(Class!(T) theClass) throws NoSuchMethodException {
		try {
	 ...
	 * Kanton Uri
	 */
	public TestSuite(final Class!(T) theClass) {
		addTestsFromTestCase(theClass);
	}

	private void addTestsFromTestCase(final Class!(T) theClass) {
	 ...
	 */
	public TestSuite(Class<? : TestCase>  theClass, String name) {
		this(theClass);
		setName(name);
	}
	 ...
	 */
	public TestSuite (Class!(T)... classes) {
		for (Class!(T) each : classes)
			addTest(testCaseForClass(each));
	}

	private Test testCaseForClass(Class!(T) each) {
	 ...
	 * @see TestSuite#TestSuite(Class[])
	 */
	public TestSuite(Class<? : TestCase>[] classes, String name) {
		this(classes);
		setName(name);
	}
	...
	private void addTestMethod(Method m, List<String> names, Class!(T) theClass) {
	...
	private bool isPublicTestMethod(Method m) {
