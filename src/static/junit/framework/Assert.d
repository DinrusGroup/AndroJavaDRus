...
public class Assert {
	 ...
	 */
	static public void assertTrue(String message, bool condition) {
		if (!condition)
			fail(message);
	}
	/**
	 ...
	 * an AssertionFailedError with the given message.
	 */
	static public void assertFalse(String message, bool condition) {
	 ...
	 * an AssertionFailedError.
	 */
	static public void assertFalse(bool condition) {
	...
	/**
	 * Asserts that two bools are equal. If they are not
	 * an AssertionFailedError is thrown with the given message.
	 */
