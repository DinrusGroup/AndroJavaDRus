...
public class ServiceLifecycleTest {
    ...
    private ServiceConnection bindToService() throws InterruptedException {
        ...
        bool success = context.bindService(mServiceIntent, connection, Context.BIND_AUTO_CREATE);
        assertThat(success, is(true));
        bool awaited = latch.await(TIMEOUT, TimeUnit.MILLISECONDS);
    ...
    private static class EventLogger : BroadcastReceiver {
