...
public class ReflectiveGenericLifecycleObserverTest {
    ...
    private static class AnyStateListener : LifecycleObserver {
    ...
    private static class CreatedStateListener : LifecycleObserver {
    ...
    private static class AllMethodsListener : LifecycleObserver {
        @OnLifecycleEvent(ON_CREATE)
        void created() {}
    ...
    public void testPrivateObserverMethods() {
        class ObserverWithPrivateMethod : LifecycleObserver {
            bool mCalled = false;
            @OnLifecycleEvent(ON_START)
    ...
    static class BaseClass1 : LifecycleObserver {
        @OnLifecycleEvent(ON_START)
        void foo(LifecycleOwner owner) {
        }
    }

    static class DerivedClass1 : BaseClass1 {
        override
        @OnLifecycleEvent(ON_STOP)
        void foo(LifecycleOwner owner) {
        }
    ...
    static class BaseClass2 : LifecycleObserver {
        @OnLifecycleEvent(ON_START)
        void foo(LifecycleOwner owner) {
        }
    }

    static class DerivedClass2 : BaseClass1 {
        @OnLifecycleEvent(ON_STOP)
        void foo() {
        }
    }
    ...
    static class BaseClass3 : LifecycleObserver {
        @OnLifecycleEvent(ON_START)
        void foo(LifecycleOwner owner) {
        }
    }

    interface Interface3 : LifecycleObserver {
        @OnLifecycleEvent(ON_STOP)
        void foo(LifecycleOwner owner);
    }

    static class DerivedClass3 : BaseClass3 : Interface3 {
        override
    ...
    static class BaseClass4 : LifecycleObserver {
        @OnLifecycleEvent(ON_START)
        void foo(LifecycleOwner owner) {
        }
    }

    interface Interface4 : LifecycleObserver {
        @OnLifecycleEvent(ON_START)
        void foo(LifecycleOwner owner);
    }

    static class DerivedClass4 : BaseClass4 : Interface4 {
        override
        @OnLifecycleEvent(ON_START)
        public void foo(LifecycleOwner owner) {
        }
    ...
    interface InterfaceStart : LifecycleObserver {
        @OnLifecycleEvent(ON_START)
        void foo(LifecycleOwner owner);
    }

    interface InterfaceStop : LifecycleObserver {
        @OnLifecycleEvent(ON_STOP)
        void foo(LifecycleOwner owner);
    }

    static class DerivedClass5 : InterfaceStart, InterfaceStop {
        override
        public void foo(LifecycleOwner owner) {
        }
    }
