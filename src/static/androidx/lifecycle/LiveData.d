...
public abstract class LiveData<T> {
    ...
    class LifecycleBoundObserver : ObserverWrapper : GenericLifecycleObserver {
    ...
    private abstract class ObserverWrapper {
        ...
        void activeStateChanged(bool newActive) {
            ...
            // owner
            mActive = newActive;
            bool wasInactive = LiveData.this.mActiveCount == 0;
    ...
    private class AlwaysActiveObserver : ObserverWrapper {
