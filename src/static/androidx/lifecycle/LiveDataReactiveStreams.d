...
public final class LiveDataReactiveStreams {
    ...
    private static final class LiveDataPublisher<T> : Publisher<T> {
        ...
        static final class LiveDataSubscription<T> : Subscription, Observer<T> {
     ...
     * @param <T> The type of data hold by this instance.
     */
    private static class PublisherLiveData<T> : LiveData<T> {
        ...
        final class LiveDataSubscriber : AtomicReference<Subscription>
                : Subscriber<T> {
