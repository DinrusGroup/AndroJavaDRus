...
public class GeneratedAdaptersTest {
    ...
    static class SimpleObserver : LifecycleObserver {
        List<String> mLog;
    ...
    static class TestObserver : LifecycleObserver {
        List<String> mLog;
    ...
    interface OnPauses : LifecycleObserver {
    ...
    interface OnPauseResume : LifecycleObserver {
        @OnLifecycleEvent(Lifecycle.Event.ON_PAUSE)
        void onPause();
    ...
    class Impl1 : OnPauses, OnPauseResume {
    ...
    interface OnAny : LifecycleObserver {
        @OnLifecycleEvent(ON_ANY)
        void onAny();
