...
public class FragmentLifecycleActivity : AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bool nested = getIntent().getBooleanExtra(EXTRA_NESTED, false);
        if (nested) {
    ...
    public static class MainFragment : Fragment {
        @Nullable
    ...
    public static class NestedFragment : Fragment {
    }

    public static Intent intentFor(Context context, bool nested) {
    ...
    public bool awaitForDestruction(long timeout, TimeUnit timeUnit)
