...
class FocusStrategy {
    public static <L, T> T findNextFocusInRelativeDirection(@NonNull L focusables,
            ...
            @Nullable T focused, @FocusRelativeDirection int direction, bool isLayoutRtl,
            bool wrap) {
    ...
    private static <T> T getNextFocusable(T focused, ArrayList<T> focusables, bool wrap) {
    ...
    private static <T> T getPreviousFocusable(T focused, ArrayList<T> focusables, bool wrap) {
        final int count = focusables.size();
     ...
     */
    private static class SequentialComparator<T> : Comparator<T> {
        private final Rect mTemp1 = new Rect();
        private final Rect mTemp2 = new Rect();

        private final bool mIsLayoutRtl;
        private final BoundsAdapter<T> mAdapter;

        SequentialComparator(bool isLayoutRtl, BoundsAdapter<T> adapter) {
     ...
     */
    private static bool beamBeats(@FocusRealDirection int direction,
            @NonNull Rect source, @NonNull Rect rect1, @NonNull Rect rect2) {
        final bool rect1InSrcBeam = beamsOverlap(direction, source, rect1);
        final bool rect2InSrcBeam = beamsOverlap(direction, source, rect2);
     ...
     */
    private static bool isCandidate(@NonNull Rect srcRect, @NonNull Rect destRect,
     ...
     */
    private static bool beamsOverlap(@FocusRealDirection int direction,
     ...
     */
    private static bool isToDirectionOf(@FocusRealDirection int direction,
