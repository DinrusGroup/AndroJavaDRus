 ...
 */
@ViewPager.DecorView
public class PagerTitleStrip : ViewGroup {
    ViewPager mPager;
    TextView mPrevText;
    TextView mCurrText;
    TextView mNextText;
    ...
    private static class SingleLineAllCapsTransform : SingleLineTransformationMethod {
    ...
    void updateTextPositions(int position, float positionOffset, bool force) {
    ...
    private class PageListener : DataSetObserver : ViewPager.OnPageChangeListener,
