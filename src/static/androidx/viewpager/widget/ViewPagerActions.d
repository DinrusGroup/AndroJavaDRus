...
public class ViewPagerActions {
    ...
    private abstract static class WrappedViewAction : ViewAction {
    }
     ...
     */
    public static ViewAction scrollRight(final bool smoothScroll) {
        return wrap(new ViewAction() {
            override
            public Matcher<View> getConstraints() {
                return isDisplayingAtLeast(90);
     ...
     */
    public static ViewAction scrollLeft(final bool smoothScroll) {
        return wrap(new ViewAction() {
            override
            public Matcher<View> getConstraints() {
                return isDisplayingAtLeast(90);
     ...
     */
    public static ViewAction scrollToLast(final bool smoothScroll) {
        return wrap(new ViewAction() {
            override
            public Matcher<View> getConstraints() {
                return isDisplayingAtLeast(90);
     ...
     */
    public static ViewAction scrollToFirst(final bool smoothScroll) {
        return wrap(new ViewAction() {
            override
            public Matcher<View> getConstraints() {
                return isDisplayingAtLeast(90);
     ...
     */
    public static ViewAction scrollToPage(final int page, final bool smoothScroll) {
        return wrap(new ViewAction() {
            override
            public Matcher<View> getConstraints() {
                return isDisplayingAtLeast(90);
