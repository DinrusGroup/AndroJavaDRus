 ...
 */
public abstract class BaseViewPagerTest<T : Activity> {
    @Rule
    ...
    protected static class BasePagerAdapter<Q> : PagerAdapter {
        ...
        override
        public bool isViewFromObject(View view, Object object) {
    ...
    protected static class ColorPagerAdapter : BasePagerAdapter<Integer> {
        override
    ...
    protected static class TextPagerAdapter : BasePagerAdapter<String> {
        override
        public Object instantiateItem(ViewGroup container, int position) {
    ...
    protected static class ButtonPagerAdapter : BasePagerAdapter<Integer> {
    ...
    private void verifyPageSelections(bool smoothScroll) {
    ...
    private void verifyPageContent(bool smoothScroll) {
        assertEquals("Initial state", 0, mViewPager.getCurrentItem());
    ...
    private void verifyAdapterChange(bool smoothScroll) {
    ...
    private void verifyTitleStripLayout(String expectedStartTitle, String expectedSelectedTitle,
        ...
        bool hasStartTitle = !TextUtils.isEmpty(expectedStartTitle);
        bool hasEndTitle = !TextUtils.isEmpty(expectedEndTitle);
    ...
    private void verifyPagerStrip(bool smoothScroll) {
     ...
     * non interactive).
     */
    protected abstract void assertStripInteraction(bool smoothScroll);
