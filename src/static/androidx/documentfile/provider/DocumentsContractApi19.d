...
class DocumentsContractApi19 {
    ...
    public static bool isVirtual(Context context, Uri self) {
    ...
    public static bool isDirectory(Context context, Uri self) {
        return DocumentsContract.Document.MIME_TYPE_DIR.equals(getRawType(context, self));
    }

    public static bool isFile(Context context, Uri self) {
    ...
    public static bool canRead(Context context, Uri self) {
    ...
    public static bool canWrite(Context context, Uri self) {
    ...
    public static bool exists(Context context, Uri self) {
