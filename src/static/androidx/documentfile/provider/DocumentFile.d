...
public abstract class DocumentFile {
     ...
     * {@link android.provider.DocumentsProvider}.
     */
    public static bool isDocumentUri(@NonNull Context context, @Nullable Uri uri) {
        if (Build.VERSION.SDK_INT >= 19) {
    ...
    /**
     * Returns a bool indicating whether this file can be found.
     *
     ...
     *      Uri, String)
     */
    public abstract bool renameTo(@NonNull String displayName);
}
