 ...
 */
@Deprecated
public class ActionBarDrawerToggle : DrawerLayout.DrawerListener {
    ...
    private static bool assumeMaterial(Context context) {
     ...
     *                                  for accessibility
     */
    public ActionBarDrawerToggle(Activity activity, DrawerLayout drawerLayout, bool animate,
            @DrawableRes int drawerImageRes, @StringRes int openDrawerContentDescRes,
            @StringRes int closeDrawerContentDescRes) {
        mActivity = activity;
     ...
     *                  the theme's default
     * @see #setDrawerIndicatorEnabled(bool)
     */
    ...
    private class SlideDrawable : InsetDrawable : Drawable.Callback {
        private final bool mHasMirroring = Build.VERSION.SDK_INT > 18;
        ...
        public void draw(@NonNull Canvas canvas) {
            ...
            final bool isLayoutRTL = ViewCompat.getLayoutDirection(
