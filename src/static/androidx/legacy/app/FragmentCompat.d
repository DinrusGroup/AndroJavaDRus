...
public class FragmentCompat {
    ...
    interface FragmentCompatImpl {
        void setUserVisibleHint(Fragment f, bool deferStart);
        void requestPermissions(Fragment fragment, String[] permissions, int requestCode);
        bool shouldShowRequestPermissionRationale(Fragment fragment, String permission);
    }
    ...
    public interface PermissionCompatDelegate {
         ...
         */
        @Deprecated
        bool requestPermissions(Fragment fragment, String[] permissions, int requestCode);
    }

    static class FragmentCompatBaseImpl : FragmentCompatImpl {
        override
        public void setUserVisibleHint(Fragment f, bool deferStart) {
        }
        override
        ...
        override
        public bool shouldShowRequestPermissionRationale(Fragment fragment, String permission) {
            return false;
        }
    }

    @RequiresApi(15)
    static class FragmentCompatApi15Impl : FragmentCompatBaseImpl {
        override
        public void setUserVisibleHint(Fragment f, bool deferStart) {
    ...
    @RequiresApi(23)
    static class FragmentCompatApi23Impl : FragmentCompatApi15Impl {
        override
    ...
    @RequiresApi(24)
    static class FragmentCompatApi24Impl : FragmentCompatApi23Impl {
        override
        public void setUserVisibleHint(Fragment f, bool deferStart) {
            f.setUserVisibleHint(deferStart);
        }
    ...
    /**
     * Call {@link Fragment#setMenuVisibility(bool) Fragment.setMenuVisibility(bool)}
     ...
     */
    @Deprecated
    public static void setMenuVisibility(Fragment f, bool visible) {
        f.setMenuVisibility(visible);
    }

    /**
     * Call {@link Fragment#setUserVisibleHint(bool) setUserVisibleHint(bool)}
     * if running on an appropriate version of the platform.
     *
     * @deprecated Use {@link androidx.fragment.app.Fragment} instead of the framework
     * {@link Fragment}.
     */
    @Deprecated
    public static void setUserVisibleHint(Fragment f, bool deferStart) {
     ...
     */
    @Deprecated
    public static bool shouldShowRequestPermissionRationale(@NonNull Fragment fragment,
