 ...
 */
@Deprecated
public class FragmentTabHost : TabHost : TabHost.OnTabChangeListener {
    ...
    static final class TabInfo {
        ...
        TabInfo(String _tag, Class!(T) _class, Bundle _args) {
            tag = _tag;
            clss = _class;
            args = _args;
        }
     ...
     */
    @Deprecated
    public void addTab(TabHost.TabSpec tabSpec, Class!(T) clss, Bundle args) {
