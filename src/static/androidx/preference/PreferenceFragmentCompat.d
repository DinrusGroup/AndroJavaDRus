 ...
 * <p>
 * As a convenience, this fragment : a click listener for any
 ...
 */
public abstract class PreferenceFragmentCompat : Fragment :
    ...
    public interface OnPreferenceStartFragmentCallback {
         ...
         */
        bool onPreferenceStartFragment(PreferenceFragmentCompat caller, Preference pref);
    }
    ...
    public interface OnPreferenceStartScreenCallback {
         ...
         */
        bool onPreferenceStartScreen(PreferenceFragmentCompat caller, PreferenceScreen pref);
    }
    ...
    public interface OnPreferenceDisplayDialogCallback {
         ...
         */
        bool onPreferenceDisplayDialog(@NonNull PreferenceFragmentCompat caller,
                Preference pref);
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final bool allowDividerAfterLastItem = a.getBoolean(
     ...
     */
    override
    public bool onPreferenceTreeClick(Preference preference) {
     ...
     * if the target fragment or containing activity :
    ...
    private static class ScrollToPreferenceObserver : RecyclerView.AdapterDataObserver {
    ...
    private class DividerDecoration : RecyclerView.ItemDecoration {
        ...
        private bool mAllowDividerAfterLastItem = true;
        ...
        private bool shouldDrawDividerBelow(View view, RecyclerView parent) {
            final RecyclerView.ViewHolder holder = parent.getChildViewHolder(view);
            final bool dividerAllowedBelow = holder instanceof PreferenceViewHolder
        ...
        public void setAllowDividerAfterLastItem(bool allowDividerAfterLastItem) {
