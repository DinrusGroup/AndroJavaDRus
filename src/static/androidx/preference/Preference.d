...
public class Preference : Comparable<Preference> {
    ...
    private bool mAllowDividerAbove = true;
    private bool mAllowDividerBelow = true;
    ...
    public void onBindViewHolder(PreferenceViewHolder holder) {
        ...
        final bool selectable = isSelectable();
     ...
     * {@link PreferenceGroup#setOrderingAsAdded(bool)} can be used to order
     ...
     * disabled.
     * <p>
     * For example, set this and {@link #setEnabled(bool)} to false for
     ...
     *         value (and persisted).
     */
    public bool callChangeListener(Object newValue) {
