...
public abstract class PreferenceGroup : Preference {
    ...
    private bool mOrderingAsAdded = true;

    private int mCurrentPreferenceOrder = 0;

    private bool mAttachedToHierarchy = false;
     ...
     */
    public void setOrderingAsAdded(bool orderingAsAdded) {
     ...
     */
    public bool addPreference(Preference preference) {
     ...
     */
    public bool removePreference(Preference preference) {
        final bool returnValue = removePreferenceInt(preference);
        notifyHierarchyChanged();
        return returnValue;
    }

    private bool removePreferenceInt(Preference preference) {
        synchronized(this) {
            preference.onPrepareForRemoval();
            if (preference.getParent() == this) {
                preference.assignParent(null);
            }
            bool success = mPreferenceList.remove(preference);
            if (success) {
     ...
     */
    protected bool onPrepareAddPreference(Preference preference) {
     ...
     */
    protected bool isOnSameScreenAsChildren() {
        return true;
    }
     ...
     */
    static class SavedState : Preference.BaseSavedState {
