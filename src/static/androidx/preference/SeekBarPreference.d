...
public class SeekBarPreference : Preference {
    ...
    private bool mAdjustable; // whether the seekbar should respond to the left/right keys
    private bool mShowSeekBarValue; // whether to show the seekbar value TextView next to the bar
    ...
    private void setValueInternal(int seekBarValue, bool notifyChanged) {
