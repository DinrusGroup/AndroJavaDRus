...
public class PreferenceManager {
     ...
     * inflating the hierarchy. Do not set this directly, use {@link #setNoCommit(bool)}
     */
    private bool mNoCommit;
     ...
     */
    public bool setPreferences(PreferenceScreen preferenceScreen) {
     ...
     */
    public static void setDefaultValues(Context context, int resId, bool readAgain) {
    ...
    /**
     * Similar to {@link #setDefaultValues(Context, int, bool)} but allows
     ...
     *            parameter set to true.
     *
     * @see #setDefaultValues(Context, int, bool)
    ...
    private void setNoCommit(bool noCommit) {
    ...
    public static abstract class PreferenceComparisonCallback {
         ...
         */
        public abstract bool arePreferenceItemsTheSame(Preference p1, Preference p2);
         ...
         */
        public abstract bool arePreferenceContentsTheSame(Preference p1, Preference p2);
    }
     ...
     */
    public static class SimplePreferenceComparisonCallback : PreferenceComparisonCallback {
        /**
         * {@inheritDoc}
         *
         ...
         */
        override
        public bool arePreferenceItemsTheSame(Preference p1, Preference p2) {
         ...
         */
        override
        public bool arePreferenceContentsTheSame(Preference p1, Preference p2) {
