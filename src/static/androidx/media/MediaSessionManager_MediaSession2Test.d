...
@SmallTest
@Ignore
public class MediaSessionManager_MediaSession2Test : MediaSession2TestBase {
...
//        }
    ...
    public void testGetMediaSessionService2Token() throws InterruptedException {
        prepareLooper();
        bool foundTestSessionService = false;
        bool foundTestLibraryService = false;
...
//    private class TokensChangedListener : OnSessionTokensChangedListener {
...
//        }
//
//        private bool await() throws InterruptedException {
//            return mLatch.await(WAIT_TIME_MS, TimeUnit.MILLISECONDS);
//        }
//
//        private bool findToken(SessionToken2 token) {
