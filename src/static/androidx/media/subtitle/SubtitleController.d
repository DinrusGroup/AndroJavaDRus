...
public class SubtitleController {
    ...
    /**
     * Creates a subtitle controller for a media playback object that :
     ...
     */
    public bool selectTrack(SubtitleTrack track) {
    ...
    private bool mTrackIsExplicit = false;
    private bool mVisibilityIsExplicit = false;
    ...
    public abstract static class Renderer {
         ...
         * renderer
         */
        public abstract bool supports(MediaFormat format);
     ...
     * the media format.
     */
    public bool hasRendererFor(MediaFormat format) {
        synchronized (mRenderersLock) {
            // TODO how to get available renderers in the system
            for (Renderer renderer: mRenderers) {
                if (renderer.supports(format)) {
