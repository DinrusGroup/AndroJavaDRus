...
class MediaSession2ImplBase : MediaSession2.SupportLibraryImpl {
    ...
    public void updatePlayer(@NonNull MediaPlayerInterface player,
        ...
        final bool hasPlayerChanged;
        final bool hasAgentChanged;
        final bool hasPlaybackInfoChanged;
    ...
    abstract static class BuilderBase
            <T : MediaSession2, C : SessionCallback> {
    ...
    static class MainHandlerExecutor : Executor {
        private final Handler mHandler;
