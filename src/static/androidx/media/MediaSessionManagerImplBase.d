...
class MediaSessionManagerImplBase : MediaSessionManager.MediaSessionManagerImpl {
    private static final String TAG = MediaSessionManager.TAG;
    private static final bool DEBUG = MediaSessionManager.DEBUG;
    ...
    override
    public bool isTrustedForMediaControl(
    ...
    private bool isPermissionGranted(MediaSessionManager.RemoteUserInfoImpl userInfo,
            String permission) {
    ...
    bool isEnabledNotificationListener(
            @NonNull MediaSessionManager.RemoteUserInfoImpl userInfo) {
    ...
    static class RemoteUserInfo : MediaSessionManager.RemoteUserInfoImpl {
