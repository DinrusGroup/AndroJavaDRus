...
public class MediaSession2 : MediaInterface2.SessionPlayer : AutoCloseable {
    /**
     * @hide
     */
    ...
    public abstract static class SessionCallback {
         ...
         */
        public bool onCommandRequest(@NonNull MediaSession2 session,
     ...
     */
    public static final class Builder : BuilderBase<MediaSession2, Builder, SessionCallback> {
    ...
    public static final class CommandButton {
        ...
        public static final class Builder {
             ...
             */
            public @NonNull Builder setEnabled(bool enabled) {
                mEnabled = enabled;
                return this;
            }
    ...
    abstract static class SupportLibraryImpl : MediaInterface2.SessionPlayer
            : AutoCloseable {
     ...
     * <pre>U : BuilderBase<T, U, C> setSessionCallback(Executor executor, C callback)</pre>
     * <p>
     ...
     *      T : android.media.MediaSession2,
     *      U : android.media.MediaSession2.BuilderBase<
     *              T, U, C : android.media.MediaSession2.SessionCallback>, C></pre>
     * @hide
     */
    @RestrictTo(LIBRARY_GROUP)
    abstract static class BuilderBase
            <T : MediaSession2, U : BuilderBase<T, U, C>, C : SessionCallback> {
