...
abstract class MediaSession2TestBase {
    ...
    interface TestControllerCallbackInterface {
        void waitForConnect(bool expect) throws InterruptedException;
        void waitForDisconnect(bool expect) throws InterruptedException;
    ...
    final MediaController2 createController(@NonNull SessionToken2 token,
            bool waitForConnect, @Nullable ControllerCallback callback)
    ...
    public static void waitForConnect(MediaController2 controller, bool expected)
            throws InterruptedException {
        getTestControllerCallbackInterface(controller).waitForConnect(expected);
    }

    public static void waitForDisconnect(MediaController2 controller, bool expected)
            throws InterruptedException {
    ...
    public static class TestControllerCallback : MediaController2.ControllerCallback
        ...
        override
        public void waitForConnect(bool expect) throws InterruptedException {
            if (expect) {
        ...
        override
        public void waitForDisconnect(bool expect) throws InterruptedException {
            if (expect) {
    ...
    public class TestMediaController : MediaController2 : TestControllerInterface {
