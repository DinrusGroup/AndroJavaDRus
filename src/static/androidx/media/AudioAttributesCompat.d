...
public class AudioAttributesCompat {
    ...
    // used by tests
    private static bool sForceLegacyBehavior;
    ...
    // The rest of this file : an approximation to AudioAttributes using old stream types
    ...
    static int toVolumeStreamType(bool fromGetVolumeControlStream, AudioAttributesCompat aa) {
        return toVolumeStreamType(fromGetVolumeControlStream, aa.getFlags(), aa.getUsage());
    }

    static int toVolumeStreamType(
            bool fromGetVolumeControlStream, int flags, @AttributeUsage int usage) {
