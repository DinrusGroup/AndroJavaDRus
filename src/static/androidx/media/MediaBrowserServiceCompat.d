 ...
 * </div>
 */
public abstract class MediaBrowserServiceCompat : Service {
    ...
    class MediaBrowserServiceImplBase : MediaBrowserServiceImpl {
    ...
    @RequiresApi(21)
    class MediaBrowserServiceImplApi21 : MediaBrowserServiceImpl,
    ...
    @RequiresApi(23)
    class MediaBrowserServiceImplApi23 : MediaBrowserServiceImplApi21 :
    ...
    @RequiresApi(26)
    class MediaBrowserServiceImplApi26 : MediaBrowserServiceImplApi23 :
    ...
    @RequiresApi(28)
    class MediaBrowserServiceImplApi28 : MediaBrowserServiceImplApi26 {
        override
        public RemoteUserInfo getCurrentBrowserInfo() {
            // mCurConnection is not null when EXTRA_MESSENGER_BINDER is used.
            if (mCurConnection != null) {
     ...
     */
    private class ConnectionRecord : IBinder.DeathRecipient {
    ...
    private static class ServiceCallbacksCompat : ServiceCallbacks {
     ...
     */
    bool isValidPackage(String pkg, int uid) {
        if (pkg == null) {
            return false;
        }
     ...
     */
    bool removeSubscription(String id, ConnectionRecord connection, IBinder token) {
        if (token == null) {
    ...
    public static final class BrowserRoot {
        /**
         * The lookup key for a bool that indicates whether the browser service should return a
