...
public class NotificationCompat {
     ...
     */
    public static class MediaStyle : androidx.core.app.NotificationCompat.Style {
         ...
         */
        public MediaStyle setShowCancelButton(bool show) {
            if (Build.VERSION.SDK_INT < 21) {
        ...
        private RemoteViews generateMediaActionButton(
            ...
            final bool tombstone = (action.getActionIntent() == null);
    ...
    public static class DecoratedMediaCustomViewStyle : MediaStyle {
        ...
        public RemoteViews makeContentView(NotificationBuilderWithBuilderAccessor builder) {
            ...
            bool hasContentView = mBuilder.getContentView() != null;
            if (Build.VERSION.SDK_INT >= 21) {
                ...
                bool createCustomContent = hasContentView
