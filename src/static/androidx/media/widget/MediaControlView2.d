...
public class MediaControlView2 : BaseLayout {
    /**
     * @hide
     */
    ...
    private bool mOverflowExpanded;
    private bool mIsStopped;
    private bool mSubtitleIsEnabled;
    private bool mSeekAvailable;
    private bool mIsAdvertisement;
    private bool mIsMute;
    private bool mNeedUXUpdate;
    ...
    public interface OnFullScreenListener {
         ...
         */
        void onFullScreen(View view, bool fullScreen);
    }
    ...
    private final Runnable mUpdateProgress = new Runnable() {
        ...
        public void run() {
            int pos = setProgress();
            bool isShowing = getVisibility() == View.VISIBLE;
    ...
    private final OnClickListener mFullScreenListener = new OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            final bool isEnteringFullScreen = !mIsFullScreen;
    ...
    private void updateLayout(int maxIconCount, int iconSize, int currWidth,
        ...
        bool isFullSize = (mMediaType == MEDIA_TYPE_DEFAULT) ? (currWidth == screenMaxLength) :
        ...
        public void onSessionEvent(String event, Bundle extras) {
            switch (event) {
                ...
                case EVENT_UPDATE_MEDIA_TYPE_STATUS:
                    bool newStatus = extras.getBoolean(KEY_STATE_IS_ADVERTISEMENT);
    ...
    private class SubSettingsAdapter : BaseAdapter {
