 ...
 * {@link #setSwipeable(bool)} can be used for more direct control over the feature.
 */
@UiThread
public class SwipeDismissFrameLayout : SwipeDismissLayout {
    ...
    public abstract static class Callback {
         ...
         * otherwise.
         */
        bool onPreSwipeStart(SwipeDismissFrameLayout layout, float xDown, float yDown) {
            return true;
        }
    ...
    private final class MyOnPreSwipeListener : OnPreSwipeListener {

        override
        public bool onPreSwipe(SwipeDismissLayout layout, float xDown, float yDown) {
    ...
    private final class MyOnDismissedListener : OnDismissedListener {
    ...
    private final class MyOnSwipeProgressChangedListener : OnSwipeProgressChangedListener {
