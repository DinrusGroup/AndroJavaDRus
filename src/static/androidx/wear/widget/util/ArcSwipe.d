...
public class ArcSwipe : Swiper {
    ...
    public enum Gesture {
        ...
        private final bool mClockwise;

        Gesture(int duration, bool clockwise) {
            mDuration = duration;
    ...
    private float[][] interpolate(float[] start, float[] end, int steps, bool isClockwise) {
    ...
    @VisibleForTesting
    float getSweepAngle(float startAngle, float endAngle, bool isClockwise) {
