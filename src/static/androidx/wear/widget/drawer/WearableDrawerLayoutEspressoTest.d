...
public class WearableDrawerLayoutEspressoTest {
    ...
    private static TypeSafeMatcher<View> isOpened(final bool isOpened) {
    ...
    private static TypeSafeMatcher<View> isClosed(final bool isClosed) {
        return new TypeSafeMatcher<View>() {
            override
            protected bool matchesSafely(View view) {
