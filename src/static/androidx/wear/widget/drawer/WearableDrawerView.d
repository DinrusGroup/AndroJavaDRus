 ...
 */
public class WearableDrawerView : FrameLayout {
    /**
    ...
    private bool mCanAutoPeek = true;
    private bool mLockWhenClosed = false;
    private bool mOpenOnlyAtTop = false;
    private bool mPeekOnScrollDown = false;
    private bool mIsPeeking;
     ...
     */
    public void setOpenOnlyAtTopEnabled(bool openOnlyAtTop) {
     ...
     * false}.
     */
    public bool isOpenOnlyAtTopEnabled() {
     ...
     */
    public void setPeekOnScrollDownEnabled(bool peekOnScrollDown) {
     ...
     * supported for bottom drawers. Defaults to {@code false}.
     */
    public bool isPeekOnScrollDownEnabled() {
     ...
     * @see #isLocked
     */
    public void setLockedWhenClosed(bool locked) {
     ...
     * @see #isLocked
     */
    public bool isLockedWhenClosed() {
     ...
     */
    public void setIsAutoPeekEnabled(bool canAutoPeek) {
     ...
     */
    private bool setDrawerContentWithoutAdding(View content) {
        if (content == mContent) {
            return false;
        }
        if (mContent != null) {
