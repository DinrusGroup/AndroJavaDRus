 ...
 * &lt;/androidx.wear.widget.drawer.WearableDrawerLayout&gt;</pre>
 */
public class WearableDrawerLayout : FrameLayout
        : View.OnLayoutChangeListener, NestedScrollingParent, FlingListener {
    ...
    private final bool mIsAccessibilityEnabled;
     ...
     */
    private bool mCanTopDrawerBeClosed;
    /**
     ...
     */
    private bool mCanBottomDrawerBeClosed;
    /**
     ...
     */
    private bool mLastScrollWasFling;
    /**
    ...
    public bool onInterceptTouchEvent(MotionEvent ev) {
        ...
        final bool shouldInterceptTop = mTopDrawerDragger.shouldInterceptTouchEvent(ev);
        final bool shouldInterceptBottom = mBottomDrawerDragger.shouldInterceptTouchEvent(ev);
    ...
    public void computeScroll() {
        ...
        final bool topSettling = mTopDrawerDragger.continueSettling(true /* deferCallbacks */);
        final bool bottomSettling = mBottomDrawerDragger.continueSettling(true /*
        deferCallbacks */);
    ...
    public void onFlingComplete(View view) {
        bool canTopPeek = mTopDrawerView != null && mTopDrawerView.isAutoPeekEnabled();
        bool canBottomPeek = mBottomDrawerView != null && mBottomDrawerView.isAutoPeekEnabled();
        bool canScrollUp = view.canScrollVertically(UP);
        bool canScrollDown = view.canScrollVertically(DOWN);
    ...
    public void onNestedScroll(@NonNull View target, int dxConsumed, int dyConsumed,
        ...
        bool scrolledUp = dyConsumed < 0;
        bool scrolledDown = dyConsumed > 0;
        bool overScrolledUp = dyUnconsumed < 0;
        bool overScrolledDown = dyUnconsumed > 0;
        ...
        bool canTopAutoPeek = mTopDrawerView != null && mTopDrawerView.isAutoPeekEnabled();
        bool canBottomAutoPeek =
                mBottomDrawerView != null && mBottomDrawerView.isAutoPeekEnabled();
        bool isTopDrawerPeeking = mTopDrawerView != null && mTopDrawerView.isPeeking();
        bool isBottomDrawerPeeking = mBottomDrawerView != null && mBottomDrawerView.isPeeking();
        bool scrolledDownPastSlop = false;
        bool shouldPeekOnScrollDown =
     ...
     */
    private bool isDrawerOrChildOfDrawer(View view) {
    ...
    private bool isClosingPeek(WearableDrawerView drawerView) {
    ...
    private bool canDrawerContentScrollVertically(
     ...
     */
    private abstract class DrawerDraggerCallback : ViewDragHelper.Callback {

        public abstract WearableDrawerView getDrawerView();

        override
        public bool tryCaptureView(@NonNull View child, int pointerId) {
     ...
     */
    private class TopDrawerDraggerCallback : DrawerDraggerCallback {
     ...
     */
    private class BottomDrawerDraggerCallback : DrawerDraggerCallback {
     ...
     */
    private class ClosePeekRunnable : Runnable {
