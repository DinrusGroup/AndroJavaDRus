...
public class MetadataConstants {
     ...
     * posted with
     * {@link android.app.Notification.Builder#setLocalOnly(bool) setLocalOnly(true)}.
     *
     ...
     */
    public static bool isStandalone(Context context) {
        try {
     ...
     */
    public static bool isNotificationBridgingEnabled(Context context) {
        try {
            ApplicationInfo appInfo = context.getPackageManager().getApplicationInfo(
                    context.getPackageName(), PackageManager.GET_META_DATA);
            if (appInfo.metaData != null) {
     ...
     */
    public static int getPreviewDrawableResourceId(Context context, bool circular) {
        try {
            ApplicationInfo appInfo = context.getPackageManager().getApplicationInfo(
                    context.getPackageName(), PackageManager.GET_META_DATA);
            if (appInfo.metaData != null) {
