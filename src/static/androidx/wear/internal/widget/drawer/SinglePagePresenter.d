...
public class SinglePagePresenter : WearableNavigationDrawerPresenter {
    ...
    public interface Ui {
         ...
         */
        void setText(CharSequence itemText, bool showToastIfNoTextView);
    ...
    public SinglePagePresenter(Ui ui, bool isAccessibilityEnabled) {
        if (ui == null) {
    ...
    override
    public void onSetCurrentItemRequested(int index, bool smoothScrollTo) {
        mUi.deselectItem(mSelected);
        mUi.selectItem(index);
        mSelected = index;
        if (mAdapter != null) {
