...
public class MultiPageUi : MultiPagePresenter.Ui {
    ...
    override
    public void setNavigationPagerSelectedItem(int index, bool smoothScrollTo) {
        if (mNavigationPager != null) {
     ...
     */
    private static final class NavigationPagerAdapter : PagerAdapter {
        ...
        override
        public bool isViewFromObject(@NonNull View view, @NonNull Object object) {
            return view == object;
        }
    }
}
