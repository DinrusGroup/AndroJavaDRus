...
public class ViewPager2 : ViewGroup {
    // reused in layout(...)
     ...
     */
    public <VH : ViewHolder> void setAdapter(final Adapter<VH> adapter) {
     ...
     * </ul>
     */
    private static class FragmentStateAdapter : RecyclerView.Adapter<FragmentViewHolder> {
        ...
        override
        public bool onFailedToRecycleView(@NonNull FragmentViewHolder holder) {
    ...
    private static class FragmentViewHolder : RecyclerView.ViewHolder {
