...
public class SwipeTest {
    private static final List<Class<? : BaseActivity>> TEST_ACTIVITIES_ALL = asList(
    ...
    private static final bool RANDOM_PASS_ENABLED = false;

    private final TestConfig mTestConfig;
    private ActivityTestRule<? : BaseActivity> mActivityTestRule;
    ...
    public static List<TestConfig> getParams() {
        ...
        for (Class<? : BaseActivity> activityClass : TEST_ACTIVITIES_ALL) {
    ...
    private static Collection<TestConfig> generateRandomTests() {
        ...
        for (int i = 0; i < 10; i++) {
            // both adapters
            for (Class<? : BaseActivity> adapterClass : TEST_ACTIVITIES_ALL) {
    ...
    private static TestConfig createRandomTest(int id, int totalPages, int sequenceLength,
            ...
            Class<? : BaseActivity> activityClass) {
    ...
    private static class TestConfig {
        ...
        final Class<? : BaseActivity> mActivityClass;
