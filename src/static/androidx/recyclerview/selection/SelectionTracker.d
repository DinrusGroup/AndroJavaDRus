...
public abstract class SelectionTracker<K> {
     ...
     */
    public abstract bool isSelected(@Nullable K key);
     ...
     */
    public abstract bool clearSelection();

    /**
     * Sets the selected state of the specified items if permitted after consulting
     * SelectionPredicate.
     */
    public abstract bool setItemsSelected(@NonNull Iterable<K> keys, bool selected);
     ...
     */
    public abstract bool select(@NonNull K key);
     ...
     */
    public abstract bool deselect(@NonNull K key);
    ...
    public abstract static class SelectionObserver<K> {
         ...
         */
        public void onItemStateChanged(@NonNull K key, bool selected) {
        }
         ...
         * calling {@link #onItemStateChanged(K, bool)} for each selected item,
         ...
         * {@link #onItemStateChanged(K, bool)} will *not* be called
    ...
    public abstract static class SelectionPredicate<K> {
         ...
         */
        public abstract bool canSetStateForKey(@NonNull K key, bool nextState);
         ...
         * @return true if the item at {@code id} can be set to {@code nextState}.
         */
        public abstract bool canSetStateAtPosition(int position, bool nextState);
         ...
         * use {@link #canSetStateForKey(Object, bool)} and
         * {@link #canSetStateAtPosition(int, bool)}.
         *
         * @return true if more than a single item can be selected.
         */
        public abstract bool canSelectMultiple();
    }
        ...
        public SelectionTracker<K> build() {
            ...
            mOnDragInitiatedListener = (mOnDragInitiatedListener != null)
                    ...
                    : new OnDragInitiatedListener() {
                        override
                        public bool onDragInitiated(@NonNull MotionEvent e) {
                            return false;
                        }
                    };
            ...
            mOnContextClickListener = (mOnContextClickListener != null)
                    ...
                    : new OnContextClickListener() {
                        override
                        public bool onContextClick(@NonNull MotionEvent e) {
                            return false;
                        }
                    };
