 ...
 * <b>Example</b>
 * <pre>
 * final class MyDetailsLookup : ItemDetailsLookup<Uri> {
 *
...
public abstract class ItemDetailsLookup<K> {
     ...
     */
    final bool overItem(@NonNull MotionEvent e) {
     ...
     */
    final bool overItemWithSelectionKey(@NonNull MotionEvent e) {
     ...
     * in that area.
     */
    final bool inItemDragRegion(@NonNull MotionEvent e) {
     ...
     */
    final bool inItemSelectRegion(@NonNull MotionEvent e) {
    ...
    final int getItemPosition(@NonNull MotionEvent e) {
        @Nullable ItemDetails!(T) item = getItemDetails(e);
        return item != null
                ? item.getPosition()
                : RecyclerView.NO_POSITION;
    }

    private static bool hasSelectionKey(@Nullable ItemDetails!(T) item) {
        return item != null && item.getSelectionKey() != null;
    }

    private static bool hasPosition(@Nullable ItemDetails!(T) item) {
    ...
    public abstract static class ItemDetails<K> {
         ...
         * selection.
         */
        public bool inSelectionHotspot(@NonNull MotionEvent e) {
            return false;
        }
         ...
         */
        public bool inDragRegion(@NonNull MotionEvent e) {
            return false;
        }

        override
        public bool equals(@Nullable Object obj) {
            return (obj instanceof ItemDetails)
                    && isEqualTo((ItemDetails) obj);
        }

        private bool isEqualTo(@NonNull ItemDetails other) {
