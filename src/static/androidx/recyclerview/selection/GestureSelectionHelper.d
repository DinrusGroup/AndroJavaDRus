 ...
 */
final class GestureSelectionHelper : OnItemTouchListener {

    private static final String TAG = "GestureSelectionHelper";

    private final SelectionTracker!(T) mSelectionMgr;
    ...
    GestureSelectionHelper(
            @NonNull SelectionTracker!(T) selectionTracker,
    ...
    override
    /** @hide */
    public bool onInterceptTouchEvent(@NonNull RecyclerView unused, @NonNull MotionEvent e) {
    ...
    private bool handleInterceptedDownEvent(@NonNull MotionEvent e) {
    ...
    @VisibleForTesting
    static final class RecyclerViewDelegate : ViewDelegate {
        ...
        int getLastGlidedItemPosition(@NonNull MotionEvent e) {
            ...
            final bool pastLastItem = isPastLastItem(lastItem.getTop(),
                    lastItem.getLeft(),
                    lastItem.getRight(),
                    e,
                    direction);
