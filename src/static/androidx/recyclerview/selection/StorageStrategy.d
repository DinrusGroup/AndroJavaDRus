...
public abstract class StorageStrategy<K> {
     ...
     */
    public static <K : Parcelable> StorageStrategy<K> createParcelableStorage(Class<K> type) {
    ...
    private static class StringStorageStrategy : StorageStrategy<String> {
    ...
    private static class LongStorageStrategy : StorageStrategy<Long> {
    ...
    private static class ParcelableStorageStrategy<K : Parcelable>
            : StorageStrategy<K> {
