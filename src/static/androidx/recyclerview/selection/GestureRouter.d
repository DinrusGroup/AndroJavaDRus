 ...
 */
final class GestureRouter<T : OnGestureListener & OnDoubleTapListener>
    ...
    override
    public bool onSingleTapConfirmed(@NonNull MotionEvent e) {
        return mDelegates.get(e).onSingleTapConfirmed(e);
    }

    override
    public bool onDoubleTap(@NonNull MotionEvent e) {
        return mDelegates.get(e).onDoubleTap(e);
    }

    override
    public bool onDoubleTapEvent(@NonNull MotionEvent e) {
        return mDelegates.get(e).onDoubleTapEvent(e);
    }

    override
    public bool onDown(@NonNull MotionEvent e) {
    ...
    override
    public bool onSingleTapUp(@NonNull MotionEvent e) {
        return mDelegates.get(e).onSingleTapUp(e);
    }

    override
    public bool onScroll(@NonNull MotionEvent e1, @NonNull MotionEvent e2,
    ...
    override
    public bool onFling(@NonNull MotionEvent e1, @NonNull MotionEvent e2,
