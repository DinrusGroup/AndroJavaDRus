...
public class TestSelectionObserver<K> : SelectionObserver<K> {

    private final Set<K> mSelected = new HashSet<>();
    private bool mSelectionChanged = false;
    private bool mSelectionReset = false;
    private bool mSelectionRestored = false;
    ...
    override
    public void onItemStateChanged(K key, bool selected) {
        if (selected) {
