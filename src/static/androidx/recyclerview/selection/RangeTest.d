...
public final class RangeTest {
    ...
    private static class Capture {
        ...
        private Capture(int begin, int end, bool selected, int type) {
            mBegin = begin;
            mEnd = end;
            mSelected = selected;
            mType = type;
        ...
        private void assertChanged(int begin, int end, bool selected) {
    ...
    private static final class RangeSpy : Range.Callbacks {
