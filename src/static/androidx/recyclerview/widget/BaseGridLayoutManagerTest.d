...
public class BaseGridLayoutManagerTest : BaseRecyclerViewInstrumentationTest {
    ...
    static class Config : Cloneable {
        ...
        public Config(int spanCount, int orientation, bool reverseLayout) {
            mSpanCount = spanCount;
        ...
        public Config reverseLayout(bool reverseLayout) {
            mReverseLayout = reverseLayout;
            return this;
        }
    ...
    class GridFocusableAdapter : FocusableAdapter {
