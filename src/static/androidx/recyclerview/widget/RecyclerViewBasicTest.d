...
public class RecyclerViewBasicTest {
    ...
    public void focusOrderTest() {
        ...
        bool isIcsOrLower = Build.VERSION.SDK_INT <= Build.VERSION_CODES.ICE_CREAM_SANDWICH_MR1;
    ...
    static class MockLayoutManager : RecyclerView.LayoutManager {
    ...
    static class LayoutManagerSavedState : Parcelable {
    ...
    static class MockAdapter : RecyclerView.Adapter {
    ...
    static class MockViewHolder : RecyclerView.ViewHolder {
        public Object mItem;
    ...
    static class LoggingView : TextView {
    ...
    static class FocusOrderAdapter : RecyclerView.Adapter {
        TextView mTopLeft;
        TextView mTopRight;
