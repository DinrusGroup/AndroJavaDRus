...
public class DiffUtil {
     ...
     */
    @NonNull
    public static DiffResult calculateDiff(@NonNull Callback cb, bool detectMoves) {
    ...
    public abstract static class ItemCallback<T> {
         ...
         */
        public abstract bool areItemsTheSame(@NonNull T oldItem, @NonNull T newItem);
         ...
         */
        public abstract bool areContentsTheSame(@NonNull T oldItem, @NonNull T newItem);
    ...
    public static class DiffResult {
        ...
        private final bool mDetectMoves;
         ...
         */
        private bool findMatchingItem(final int x, final int y, final int snakeIndex,
                final bool removal) {
            final int myItemPos;
            int curX;
            int curY;
