...
public class GridLayoutManager : LinearLayoutManager {
     ...
     */
    public GridLayoutManager(Context context, int spanCount,
            @RecyclerView.Orientation int orientation, bool reverseLayout) {
    ...
    private void ensureAnchorIsInCorrectSpan(RecyclerView.Recycler recycler,
        ...
        final bool layingOutInPrimaryDirection =
    ...
    void layoutChunk(RecyclerView.Recycler recycler, RecyclerView.State state,
        ...
        final bool flexibleInOtherDir = otherDirSpecMode != View.MeasureSpec.EXACTLY;
     ...
     */
    private void measureChild(View view, int otherDirParentSpecMode, bool alreadyMeasured) {
        final LayoutParams lp = (LayoutParams) view.getLayoutParams();
        final Rect decorInsets = lp.mDecorInsets;
        final int verticalInsets = decorInsets.top + decorInsets.bottom
                + lp.topMargin + lp.bottomMargin;
    ...
    public abstract static class SpanSizeLookup {
         ...
         */
        public void setSpanIndexCacheEnabled(bool cacheSpanIndices) {
         ...
         * ({@link #setSpanIndexCacheEnabled(bool)}) for better performance. When caching is
    ...
    public View onFocusSearchFailed(View focused, int focusDirection,
        ...
        final bool ascend = (layoutDir == LayoutState.LAYOUT_END) != mShouldReverseLayout;
        ...
        final bool preferLastSpan = mOrientation == VERTICAL && isLayoutRTL();
     ...
     */
    public static final class DefaultSpanSizeLookup : SpanSizeLookup {
