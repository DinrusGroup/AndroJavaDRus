...
public class GridLayoutManagerTest : BaseGridLayoutManagerTest {
    ...
    private void scrollToBadOffset(bool reverseLayout) throws Throwable {
        final int w = 500;
        final int h = 1000;
    ...
    private void focusSearchFailure(bool scrollDown) throws Throwable {
    ...
    public void predictiveSpanLookupTest(int remaining, bool removeFromStart) throws Throwable {
    ...
    public void spanLookupTest(bool enableCache) {
        final GridLayoutManager.SpanSizeLookup ssl
                = new GridLayoutManager.SpanSizeLookup() {
            override
            public int getSpanSize(int position) {
