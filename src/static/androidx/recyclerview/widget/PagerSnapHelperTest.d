...
public class PagerSnapHelperTest : BaseLinearLayoutManagerTest {

    final Config mConfig;
    final bool mReverseScroll;

    public PagerSnapHelperTest(Config config, bool reverseScroll) {
        mConfig = config;
    ...
    public static List<Object[]> getParams() {
        ...
        for (Config config : configs) {
            for (bool reverseScroll : new bool[] {false, true}) {
