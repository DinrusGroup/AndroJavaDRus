 ...
 * RecyclerView size.
 */
abstract public class BaseWrapContentTest : BaseRecyclerViewInstrumentationTest {
    ...
    void unspecifiedWithHintTest(bool horizontal) throws Throwable {
    ...
    class Snapshot {
        ...
        private void assertMap(String prefix, LongSparseArray!(T) map1, LongSparseArray!(T) map2) {
        ...
        private void assertAtIndex(String prefix, LongSparseArray!(T) map1, LongSparseArray!(T) map2,
                int index) {
        ...
        private void logInto(LongSparseArray!(T) map, StringBuilder sb) {
        ...
        private void collectInto(
                ...
                List<? : BaseRecyclerViewAnimationsTest.AnimateLogBase> list) {
        ...
        private Rect getChildBounds(RecyclerView recyclerView, View child, bool offset) {
    ...
    protected bool shouldWrapContentHorizontally() {
        return true;
    }

    protected bool shouldWrapContentVertically() {
        return true;
    }
    ...
    static class WrapContentConfig {
        ...
        public WrapContentConfig(bool unlimitedWidth, bool unlimitedHeight) {
            this.unlimitedWidth = unlimitedWidth;
            this.unlimitedHeight = unlimitedHeight;
        }

        public WrapContentConfig(bool unlimitedWidth, bool unlimitedHeight, Rect padding) {
            this.unlimitedWidth = unlimitedWidth;
            this.unlimitedHeight = unlimitedHeight;
            this.padding.set(padding);
        }

        public bool isUnlimitedWidth() {
            return unlimitedWidth;
        }

        public WrapContentConfig setUnlimitedWidth(bool unlimitedWidth) {
            this.unlimitedWidth = unlimitedWidth;
            return this;
        }

        public bool isUnlimitedHeight() {
            return unlimitedHeight;
        }

        public WrapContentConfig setUnlimitedHeight(bool unlimitedHeight) {
            this.unlimitedHeight = unlimitedHeight;
            return this;
        }
