...
public class RecyclerViewCacheTest {
    ...
    private class TimeMockingRecyclerView : RecyclerView {
    ...
    public void viewHolderFindsNestedRecyclerViews() {
        ...
        verify(mockAdapter, times(2)).onBindViewHolder(
                argThat(new ArgumentMatcher<RecyclerView.ViewHolder>() {
                    override
                    public bool matches(RecyclerView.ViewHolder holder) {
    ...
    class OuterAdapter : RecyclerView.Adapter<OuterAdapter.ViewHolder> {
        ...
        OuterAdapter(bool reverseInner) {
            this(reverseInner, 10);
        }

        OuterAdapter(bool reverseInner, int itemCount) {
     ...
     */
    class OuterNotifyAdapter : RecyclerView.Adapter<OuterNotifyAdapter.ViewHolder> {
        ...
        OuterNotifyAdapter(bool reverseInner) {
            mReverseInner = reverseInner;
