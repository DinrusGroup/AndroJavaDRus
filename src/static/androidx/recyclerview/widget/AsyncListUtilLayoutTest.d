...
public class AsyncListUtilLayoutTest : BaseRecyclerViewInstrumentationTest {
    ...
    private class TestDataCallback : AsyncListUtil.DataCallback<String> {
        ...
        public bool waitForTiles(long timeoutInSeconds) throws InterruptedException {
            return mTilesLatch.await(timeoutInSeconds, TimeUnit.SECONDS);
        }
    }

    private class TestViewCallback : AsyncListUtil.ViewCallback {
        override
    ...
    private static class SimpleViewHolder : RecyclerView.ViewHolder {
    ...
    private class AsyncTestAdapter : RecyclerView.Adapter<SimpleViewHolder> {
        ...
        public bool waitForItems(long timeoutInSeconds) throws InterruptedException {
