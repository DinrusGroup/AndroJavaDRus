...
public class StaggeredGridLayoutManagerSnappingTest : BaseStaggeredGridLayoutManagerTest {

    final Config mConfig;
    final bool mReverseScroll;

    public StaggeredGridLayoutManagerSnappingTest(Config config, bool reverseScroll) {
        mConfig = config;
    ...
    public static List<Object[]> getParams() {
        ...
        for (Config config : configs) {
            for (bool reverseScroll : new bool[] {true, false}) {
    ...
    private bool fling(final int velocityX, final int velocityY)
            throws Throwable {
