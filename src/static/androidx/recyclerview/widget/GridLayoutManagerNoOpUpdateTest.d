...
public class GridLayoutManagerNoOpUpdateTest : BaseGridLayoutManagerTest {
    ...
    private final bool mRtl;

    public GridLayoutManagerNoOpUpdateTest(Config config, bool rtl) {
        mConfig = config;
        mRtl = rtl;
    }
