 ...
 */
public class RecyclerView : ViewGroup : ScrollingView, NestedScrollingChild2 {

    static final String TAG = "RecyclerView";

    static final bool DEBUG = false;

    static final bool VERBOSE_TRACING = false;
     ...
     * this criteria.
     */
    static final bool FORCE_INVALIDATE_DISPLAY_LIST = Build.VERSION.SDK_INT == 18
     ...
     */
    static final bool ALLOW_SIZE_IN_UNSPECIFIED_SPEC = Build.VERSION.SDK_INT >= 23;

    static final bool POST_UPDATES_ON_ANIMATION = Build.VERSION.SDK_INT >= 16;
     ...
     */
    private static final bool ALLOW_THREAD_GAP_WORK = Build.VERSION.SDK_INT >= 21;
     ...
     */
    private static final bool FORCE_ABS_FOCUS_SEARCH_DIRECTION = Build.VERSION.SDK_INT <= 15;
     ...
     * side-effect.
     */
    private static final bool IGNORE_DETACHED_FOCUSED_CHILD = Build.VERSION.SDK_INT <= 15;

    static final bool DISPATCH_TEMP_DETACH = false;
    ...
    private static final Class!(T)[] LAYOUT_MANAGER_CONSTRUCTOR_SIGNATURE =
    ...
    @VisibleForTesting bool mFirstLayoutComplete;
     ...
     * {@link #stopInterceptRequestLayout(bool)} .  This is used to signal whether we
     ...
     *
     * @see #processDataSetCompletelyChanged(bool)
     */
    ...
    private bool mPreserveFocusAfterLayout = true;
     ...
     */
    public void swapAdapter(@Nullable Adapter adapter, bool removeAndRecycleExistingViews) {
     ...
     */
    private void setAdapterInternal(@Nullable Adapter adapter, bool compatibleWithPrevious,
            bool removeAndRecycleViews) {
        if (mAdapter != null) {
    ...
    private void addAnimatingView(ViewHolder viewHolder) {
        ...
        final bool alreadyParented = view.getParent() == this;
    ...
    bool removeAnimatingView(View view) {
        ...
        final bool removed = mChildHelper.removeViewIfHidden(view);
        if (removed) {
     ...
     * always call {@link ViewGroup#setChildrenDrawingOrderEnabled(bool)}. The parameter will be
    ...
    public void scrollBy(int x, int y) {
        ...
        final bool canScrollHorizontal = mLayout.canScrollHorizontally();
        final bool canScrollVertical = mLayout.canScrollVertically();
     ...
     * {@link #stopInterceptRequestLayout(bool)} that follows the code that may trigger a
     * child View to cause a call to {@link RecyclerView#requestLayout()}.
     *
     * @see #stopInterceptRequestLayout(bool)
     */
     ...
     * <p>
     * {@link #setAdapter(Adapter)} and {@link #swapAdapter(Adapter, bool)} will automatically
     * stop frozen.
     * <p>
     ...
     */
    public bool fling(int velocityX, int velocityY) {
        if (mLayout == null) {
        ...
        if (!dispatchNestedPreFling(velocityX, velocityY)) {
            final bool canScroll = canScrollHorizontal || canScrollVertical;
    ...
    public View focusSearch(View focused, int direction) {
        ...
        final bool canRunFocusFailure = mAdapter != null && mLayout != null
        ...
        if (canRunFocusFailure
            ...
            if (!needsFocusFailureLayout && mLayout.canScrollHorizontally()) {
                bool rtl = mLayout.getLayoutDirection() == ViewCompat.LAYOUT_DIRECTION_RTL;
     ...
     */
    private bool isPreferredNextFocus(View focused, View next, int direction) {
    ...
    override
    protected bool onRequestFocusInDescendants(int direction, Rect previouslyFocusedRect) {
    ...
    private bool dispatchOnItemTouchIntercept(MotionEvent e) {
    ...
    private bool dispatchOnItemTouch(MotionEvent e) {
        final int action = e.getAction();
    ...
    override
    public bool onInterceptTouchEvent(MotionEvent e) {
        if (mLayoutFrozen) {
        ...
        final bool canScrollHorizontally = mLayout.canScrollHorizontally();
        final bool canScrollVertically = mLayout.canScrollVertically();
    ...
    protected void onMeasure(int widthSpec, int heightSpec) {
        ...
        if (mLayout.isAutoMeasureEnabled()) {
            ...
            final bool measureSpecModeIsExactly =
    ...
    private void dispatchLayoutStep1() {
        ...
        if (mState.mRunPredictiveAnimations) {
            ...
            saveOldPositions();
            final bool didStructureChange = mState.mStructureChanged;
        ...
        if (mState.mRunSimpleAnimations) {
            ...
            for (int i = mChildHelper.getChildCount() - 1; i >= 0; i--) {
                ...
                if (oldChangeViewHolder != null && !oldChangeViewHolder.shouldIgnore()) {
                    ...
                    final bool oldDisappearing = mViewInfoStore.isDisappearing(
                            oldChangeViewHolder);
                    final bool newDisappearing = mViewInfoStore.isDisappearing(holder);
    ...
    private bool didChildRangeChange(int minPositionPreLayout, int maxPositionPreLayout) {
        findMinMaxChildLayoutPositions(mMinMaxLayoutPositions);
    ...
    override
    protected void removeDetachedView(View child, bool animate) {
     ...
     * focus.
     *
     * @see #setPreserveFocusAfterLayout(bool)
     */
     ...
     */
    public void setPreserveFocusAfterLayout(bool preserveFocusAfterLayout) {
     ...
     * use an Adapter with {@link Adapter#setHasStableIds(bool) stableIds} to
    ...
    override
    public bool drawChild(Canvas canvas, View child, long drawingTime) {
    ...
    class ViewFlinger : Runnable {
        ...
        private bool mEatRunOnAnimationRequest = false;

        // Tracks if postAnimationCallback should be re-attached when it is done
        private bool mReSchedulePostAnimationCallback = false;
        ...
        public void run() {
            ...
            if (scroller.computeScrollOffset()) {
                ...
                final bool fullyConsumedVertical = dy != 0 && mLayout.canScrollVertically()
                        && vresult == dy;
                final bool fullyConsumedHorizontal = dx != 0 && mLayout.canScrollHorizontally()
                        && hresult == dx;
                final bool fullyConsumedAny = (dx == 0 && dy == 0) || fullyConsumedHorizontal
        ...
        private int computeScrollDuration(int dx, int dy, int vx, int vy) {
            ...
            final bool horizontal = absDx > absDy;
    ...
    private class RecyclerViewDataObserver : AdapterDataObserver {
    ...
    public final class Recycler {
         ...
         * @return
         */
        private bool tryBindViewHolderByDeadline(@NonNull ViewHolder holder, int offsetPosition,
        ...
        private void invalidateDisplayListInt(ViewGroup viewGroup, bool invalidateThis) {
        ...
        void recycleViewHolderInternal(ViewHolder holder) {
            ...
            final bool transientStatePreventsRecycling = holder
                    .doesTransientStatePreventRecycling();
            final bool forceRecycle = mAdapter != null
         ...
         */
        void addViewHolderToRecycledViewPool(@NonNull ViewHolder holder, bool dispatchRecycled) {
     ...
     *
     * @param <VH> A class that : ViewHolder that will be used by the adapter.
     */
    public abstract static class Adapter<VH : ViewHolder> {
         ...
         */
        public final bool hasStableIds() {
         ...
         */
        public bool onFailedToRecycleView(@NonNull VH holder) {
            return false;
        }
         ...
         */
        public final bool hasObservers() {
    ...
    public abstract static class LayoutManager {
         ...
         * RecyclerView.
         * @see #isViewPartiallyVisible(View, bool, bool),
         * {@link LinearLayoutManager#findOneVisibleChild(int, int, bool, bool)},
        ...
        /**
         * This field is only set via the deprecated {@link #setAutoMeasureEnabled(bool)} and is
         ...
         */
        private bool mMeasurementCacheEnabled = true;

        private bool mItemPrefetchEnabled = true;
         ...
         */
        @Deprecated
        public void setAutoMeasureEnabled(bool enabled) {
         ...
         * deprecated {@link #setAutoMeasureEnabled(bool)}) and should be overridden to return
         ...
         * {@link #onLayout(bool, int, int, int, int)} method is called, RecyclerView checks
         ...
         */
        public final void setItemPrefetchEnabled(bool enabled) {
         ...
         * its viewport while the UI thread is idle between frames.
         *
         * @see #setItemPrefetchEnabled(bool)
         *
         * @return true if item prefetch is enabled, false otherwise
         */
        public final bool isItemPrefetchEnabled() {
         ...
         */
        public bool checkLayoutParams(LayoutParams lp) {
            return lp != null;
        }
        ...
        private void addViewInt(View child, int index, bool disappearing) {
            final ViewHolder holder = getChildViewHolderInt(child);
         ...
         * {@link #setAutoMeasureEnabled(bool)}.
         *
         ...
         */
        bool shouldReMeasureChild(View child, int widthSpec, int heightSpec, LayoutParams lp) {
         ...
         */
        bool shouldMeasureChild(View child, int widthSpec, int heightSpec, LayoutParams lp) {
         ...
         * {@link #setMeasurementCacheEnabled(bool)}.
         *
         * @return True if measurement cache is enabled, false otherwise.
         *
         * @see #setMeasurementCacheEnabled(bool)
         */
         ...
         */
        public void setMeasurementCacheEnabled(bool measurementCacheEnabled) {
            mMeasurementCacheEnabled = measurementCacheEnabled;
        }

        private static bool isMeasurementUpToDate(int childSize, int spec, int dimension) {
         ...
         * @deprecated use {@link #getChildMeasureSpec(int, int, int, int, bool)}
         */
        @Deprecated
         ...
         */
        public void getTransformedBoundingBox(@NonNull View child, bool includeDecorInsets,
                @NonNull Rect out) {
         ...
         * android.graphics.Rect, bool)} for more details.
         *
         ...
         */
        public bool requestChildRectangleOnScreen(@NonNull RecyclerView parent,
                @NonNull View child, @NonNull Rect rect, bool immediate) {
         ...
         */
        public bool isViewPartiallyVisible(@NonNull View child, bool completelyVisible,
            ...
            bool isViewFullyVisible = mHorizontalBoundCheck.isViewWithinBoundFlags(child,
                    boundsFlag)
         ...
         */
        private bool isFocusedChildVisibleAfterScrolling(RecyclerView parent, int dx, int dy) {
         ...
         */
        @Deprecated
        public bool onRequestChildFocus(@NonNull RecyclerView parent, @NonNull View child,
         ...
         */
        public bool onRequestChildFocus(@NonNull RecyclerView parent, @NonNull State state,
         ...
         * {@link RecyclerView#swapAdapter(Adapter, bool)}. The LayoutManager may use this
         ...
         */
        public bool onAddFocusables(@NonNull RecyclerView recyclerView,
         ...
         * {@link RecyclerView#swapAdapter(Adapter, bool)} ()} and signals that the the entire
         ...
         */
        public bool isLayoutHierarchical(@NonNull Recycler recycler, @NonNull State state) {
            return false;
        }

        // called by accessibility delegate
        bool performAccessibilityAction(int action, @Nullable Bundle args) {
         ...
         */
        public bool performAccessibilityAction(@NonNull Recycler recycler, @NonNull State state,
        ...
        // called by accessibility delegate
        bool performAccessibilityActionForItem(@NonNull View view, int action,
         ...
         * @see View#performAccessibilityAction(int, android.os.Bundle)
         */
        public bool performAccessibilityActionForItem(@NonNull Recycler recycler,
    ...
    public interface OnItemTouchListener {
         ...
         *         the gesture.
         */
        bool onInterceptTouchEvent(@NonNull RecyclerView rv, @NonNull MotionEvent e);
         ...
         * @see ViewParent#requestDisallowInterceptTouchEvent(bool)
         */
     ...
     */
    public static class SimpleOnItemTouchListener : RecyclerView.OnItemTouchListener {
        override
        public bool onInterceptTouchEvent(@NonNull RecyclerView rv, @NonNull MotionEvent e) {
            return false;
        }
    ...
    public abstract static class ViewHolder {
        ...
        private bool mInChangeScrap = false;
         ...
         * @see #isRecyclable()
         */
        public final void setIsRecyclable(bool recyclable) {
         ...
         *
         * @see #setIsRecyclable(bool)
         */
        public final bool isRecyclable() {
         ...
         */
        private bool shouldBeKeptAsChild() {
            return (mFlags & FLAG_NOT_RECYCLABLE) != 0;
        }
         ...
         */
        private bool doesTransientStatePreventRecycling() {
     ...
     */
    @VisibleForTesting
    bool setChildImportantForAccessibilityInternal(ViewHolder viewHolder,
    ...
    override
    public bool startNestedScroll(int axes, int type) {
    ...
    override
    public bool hasNestedScrollingParent(int type) {
        return getScrollingChildHelper().hasNestedScrollingParent(type);
    }

    override
    public bool dispatchNestedScroll(int dxConsumed, int dyConsumed, int dxUnconsumed,
     ...
     */
    public static class LayoutParams : android.view.ViewGroup.MarginLayoutParams {
    ...
    public abstract static class SmoothScroller {
        ...
        private void onAnimation(int dx, int dy) {
            ...
            if (mRunning) {
                ...
                bool hadJumpTarget = mRecyclingAction.hasJumpTarget();
                mRecyclingAction.runIfNecessary(recyclerView);
                if (hadJumpTarget) {
    ...
    static class AdapterDataObservable : Observable<AdapterDataObserver> {
     ...
     */
    @RestrictTo(LIBRARY_GROUP)
    public static class SavedState : AbsSavedState {
     ...
     */
    private class ItemAnimatorRestoreListener : ItemAnimator.ItemAnimatorListener {
    ...
    public abstract static class ItemAnimator {
         ...
         * false otherwise.
         */
        public abstract bool animateDisappearance(@NonNull ViewHolder viewHolder,
                @NonNull ItemHolderInfo preLayoutInfo, @Nullable ItemHolderInfo postLayoutInfo);
         ...
         * false otherwise.
         */
        public abstract bool animateAppearance(@NonNull ViewHolder viewHolder,
                @Nullable ItemHolderInfo preLayoutInfo, @NonNull ItemHolderInfo postLayoutInfo);
         ...
         * false otherwise.
         */
        public abstract bool animatePersistence(@NonNull ViewHolder viewHolder,
         ...
         * false otherwise.
         */
        public abstract bool animateChange(@NonNull ViewHolder oldHolder,
         ...
         * @return true if there are any item animations currently running, false otherwise.
         */
        public final bool isRunning(@Nullable ItemAnimatorFinishedListener listener) {
         ...
         */
        public bool canReuseUpdatedViewHolder(@NonNull ViewHolder viewHolder) {
            return true;
        }
