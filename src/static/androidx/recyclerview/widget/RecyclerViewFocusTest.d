...
public class RecyclerViewFocusTest {
    ...
    */
    ...
    private void setupRecyclerView(final bool hasAdapter, int orientation, bool ltr)
            throws Throwable {
    ...
    private class TestLinearLayoutManager : LinearLayoutManager {

        bool mOnFocusSearchFailedCalled = false;
        View mOnInterceptFocusSearchReturnValue;
        View mViewToReturnFromonFocusSearchFailed;

        TestLinearLayoutManager(Context context, int orientation, bool reverseLayout) {
    ...
    private class TestViewHolder : RecyclerView.ViewHolder {
