...
@LargeTest
public class LinearLayoutManagerWrapContentTest : BaseWrapContentTest {
    ...
    protected int getHorizontalGravity(RecyclerView.LayoutManager layoutManager) {
        bool rtl = layoutManager.getLayoutDirection() == ViewCompat.LAYOUT_DIRECTION_RTL;
        ...
        bool end = mConfig.mReverseLayout ^ mConfig.mStackFromEnd;
        if (rtl ^ end) {
            return Gravity.RIGHT;
        }
        return Gravity.LEFT;
