...
@LargeTest
public class RecyclerViewLayoutTest : BaseRecyclerViewInstrumentationTest {
    ...
    private void detachAttachGetReady(final bool requestLayoutOnDetach,
            final bool removeAdapter, final bool removeLayoutManager) throws Throwable {
        ...
        final bool requireLayout = requestLayoutOnDetach || removeAdapter || removeLayoutManager;
        layoutManager.expectLayouts(1);
        mActivityRule.runOnUiThread(new Runnable() {
            override
            public void run() {
    ...
    /**
     * If Adapter#setHasStableIds(bool) is false, cached ViewHolders should be recycled in
     ...
     *
     * If Adapter#setHasStableIds(bool) is true, cached Views/ViewHolders should not be recycled.
     */
    public void onDataSetChanged_handleCachedViews(bool hasStableIds) throws Throwable {
    ...
    private void testScrollFrozen(bool fling) throws Throwable {
    ...
    private bool fling(final int velocityX, final int velocityY) throws Throwable {
        final AtomicBoolean didStart = new AtomicBoolean(false);
        mActivityRule.runOnUiThread(new Runnable() {
            override
            public void run() {
                bool result = mRecyclerView.fling(velocityX, velocityY);
                didStart.set(result);
            }
        });
        if (!didStart.get()) {
    ...
    private void setupBasic(RecyclerView recyclerView, TestLayoutManager tlm,
            TestAdapter adapter, bool waitForFirstLayout) throws Throwable {
        recyclerView.setLayoutManager(tlm);
        recyclerView.setAdapter(adapter);
    ...
    public void transientStateRecycleTest(final bool succeed, final bool unsetTransientState)
            throws Throwable {
        final List<View> failedToRecycle = new ArrayList<>();
        final List<View> recycled = new ArrayList<>();
        TestAdapter testAdapter = new TestAdapter(10) {
            override
            public bool onFailedToRecycleView(@NonNull TestViewHolder holder) {
    ...
    public void avoidLeakingRecyclerViewIfViewIsNotRecycled() throws Throwable {
        ...
        TestAdapter adapter = new TestAdapter(10) {
            override
            public bool onFailedToRecycleView(
    ...
    private void swapViewsAtIndices(TestRecyclerView recyclerView, int index1, int index2) {
        ...
        bool v1Hidden = recyclerView.mChildHelper.isHidden(v1);
        bool v2Hidden = recyclerView.mChildHelper.isHidden(v2);
    ...
    public void recycleScrapTest(final bool useRecycler) throws Throwable {
        TestAdapter testAdapter = new TestAdapter(10);
    ...
    public void smoothScrollTest(final bool removeItem) throws Throwable {
    ...
    public void accessRecyclerOnOnMeasureTest(final bool enablePredictiveAnimations)
            throws Throwable {
        TestAdapter testAdapter = new TestAdapter(10);
    ...
    private void compatibleAdapterTest(bool useCustomPool, bool removeAndRecycleExistingViews)
            throws Throwable {
        TestAdapter testAdapter = new TestAdapter(10);
    ...
    public void incompatibleAdapterTest(bool useCustomPool) throws Throwable {
        TestAdapter testAdapter = new TestAdapter(10);
        TestLayoutManager lm = new TestLayoutManager() {
            override
            public void onLayoutChildren(RecyclerView.Recycler recycler, RecyclerView.State state) {
    ...
    public void stableIdsMoveTest(final bool supportsPredictive) throws Throwable {
        final TestAdapter testAdapter = new TestAdapter(10);
        testAdapter.setHasStableIds(true);
        final AtomicBoolean test = new AtomicBoolean(false);
    ...
    public void callbacksDuringAdapterChange(bool swap) throws Throwable {
    ...
    public void findViewByIdTest(final bool supportPredictive) throws Throwable {
        final RecyclerView recyclerView = new RecyclerView(getActivity());
        final int initialAdapterSize = 20;
        final TestAdapter adapter = new TestAdapter(initialAdapterSize);
    ...
    public void focusTooBigViewTest(final int gravity, final bool rtl) throws Throwable {
        RecyclerView rv = new RecyclerView(getActivity());
        if (rtl) {
    ...
    public void focusRectOnScreenTest(bool addItemDecors) throws Throwable {
        RecyclerView rv = new RecyclerView(getActivity());
    ...
    private void jumpingJackSmoothScrollerTest(final bool succeed) throws Throwable {
    ...
    private static class TestViewHolder2 : RecyclerView.ViewHolder {
    ...
    private static class TestAdapter2 : RecyclerView.Adapter<TestViewHolder2> {
    ...
    public class LayoutAllLayoutManager : TestLayoutManager {
        private final bool mAllowNullLayoutLatch;
        ...
        public LayoutAllLayoutManager(bool allowNullLayoutLatch) {
     ...
     */
    public static class TestRecyclerView : RecyclerView {
    ...
    public static class FullyConsumingNestedScroller : NestedScrollingParent2Adapter {
        override
