...
public class DiffUtilTest {
    ...
    private DiffUtil.Callback mCallback = new DiffUtil.Callback() {
        ...
        override
        public bool areItemsTheSame(int oldItemIndex, int newItemIndex) {
            return mBefore.get(oldItemIndex).id == mAfter.get(newItemIndex).id;
        }

        override
        public bool areContentsTheSame(int oldItemIndex, int newItemIndex) {
    ...
    private void log(String title, List!(T) items) {
