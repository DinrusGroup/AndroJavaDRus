...
public class ItemAnimatorV2ApiTest : BaseRecyclerViewAnimationsTest {
    override
    ...
    public void changeMovedOutsideWithPredictiveAndTwoViewHolders() throws Throwable {
        ...
        mAnimator.canReUseCallback = new CanReUseCallback() {
            override
            public bool canReUse(RecyclerView.ViewHolder viewHolder, List<Object> payloads) {
    ...
    private void notifyDataSetChangedWithAppearing(final bool notifyBoth) throws Throwable {
    ...
    private void notifyDataSetChangedWithDispappearing(final bool notifyBoth) throws Throwable {
        final TestAdapter adapter = new TestAdapter(10);
        adapter.setHasStableIds(true);
        setupBasic(10, 0, 10, adapter);
        mLayoutManager.expectLayouts(1);
    ...
    class LoggingV2Animator : RecyclerView.ItemAnimator {
        ...
        override
        public bool canReuseUpdatedViewHolder(RecyclerView.ViewHolder viewHolder,
        ...
        override
        public bool animateChange(@NonNull RecyclerView.ViewHolder oldHolder,
    ...
    interface CanReUseCallback {
        ...
        bool canReUse(RecyclerView.ViewHolder viewHolder, List<Object> payloads);
    }
}
