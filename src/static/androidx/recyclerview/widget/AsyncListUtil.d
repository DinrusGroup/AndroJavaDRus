...
public class AsyncListUtil<T> {
    ...
    private final ThreadUtil.MainThreadCallback<T>
        ...
        private bool isRequestedGeneration(int generation) {
    ...
    private final ThreadUtil.BackgroundCallback<T>
        ...
        private bool isTileLoaded(int position) {
    ...
    public static abstract class ViewCallback {
         ...
         *
         * <p>
         * If there is no scroll hint, the default implementation : the visible range by half
