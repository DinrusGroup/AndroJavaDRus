...
public class RecyclerViewAnimationsTest : BaseRecyclerViewAnimationsTest {
    ...
    public void changeAndDisappearTest(final bool reUse, final bool useScrap)
            throws Throwable {
    ...
    public void reuseHiddenViewWithProperPredictive() throws Throwable {
        reuseHiddenViewTest(new ReuseTestCallback() {
            ...
            public void postSetup(List<TestViewHolder> recycledList,
                ...
                mLayoutManager.waitForLayout(2);
                waitForAnimations(5);
                // This LM : predictive animations properly by requesting target view
                // in pre-layout.
                assertTrue(itemAnimator.contains(target, itemAnimator.mAnimatePersistenceList));
                assertFalse(itemAnimator.contains(target, itemAnimator.mAnimateChangeList));
                assertFalse(itemAnimator.contains(target, itemAnimator.mAnimateAppearanceList));
    ...
    public void addRemoveSamePass() throws Throwable {
        ...
        mRecyclerView.setItemAnimator(new DefaultItemAnimator() {
            override
            public bool animateAdd(RecyclerView.ViewHolder holder) {
                addVH.add(holder);
                return true;
            }

            override
            public bool animateRemove(RecyclerView.ViewHolder holder) {
                removeVH.add(holder);
                return true;
            }

            override
            public bool animateMove(RecyclerView.ViewHolder holder, int fromX, int fromY,
                    int toX, int toY) {
                moveVH.add(holder);
                return true;
            }
    ...
    public void changeAnimations() throws Throwable {
        final bool[] bools = {true, false};
        for (bool supportsChange : bools) {
            for (bool changeType : bools) {
                for (bool hasStableIds : bools) {
                    for (bool deleteSomeItems : bools) {
    ...
    public void changeAnimTest(final bool supportsChangeAnim, final bool changeType,
            final bool hasStableIds, final bool deleteSomeItems) throws Throwable {
    ...
    private void testChangeWithPayload(final bool supportsChangeAnim,
            final bool canReUse, Object[][] notifyPayloads, Object[][] expectedPayloadsInOnBind)
            throws Throwable {
    ...
    public void getItemForDeletedViewTest(bool stableIds) throws Throwable {
