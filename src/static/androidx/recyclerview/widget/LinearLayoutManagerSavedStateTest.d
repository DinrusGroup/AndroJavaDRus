...
@LargeTest
public class LinearLayoutManagerSavedStateTest : BaseLinearLayoutManagerTest {
    final Config mConfig;
    final bool mWaitForLayout;
    final bool mLoadDataAfterRestore;
    final PostLayoutRunnable mPostLayoutOperation;
    final PostRestoreRunnable mPostRestoreOperation;

    public LinearLayoutManagerSavedStateTest(Config config, bool waitForLayout,
            bool loadDataAfterRestore, PostLayoutRunnable postLayoutOperation,
    ...
    public static Iterable<Object[]> params()
        ...
        PostRestoreRunnable[] postRestoreOptions = new PostRestoreRunnable[]{
                ...
                new PostRestoreRunnable() {
                    ...
                    override
                    bool shouldLayoutMatch(Config config) {
        ...
        bool[] waitForLayoutOptions = new bool[]{true, false};
        bool[] loadDataAfterRestoreOptions = new bool[]{true, false};
        ...
        for (Config config : variations) {
            for (PostLayoutRunnable postLayoutRunnable : postLayoutOptions) {
                for (bool waitForLayout : waitForLayoutOptions) {
                    for (PostRestoreRunnable postRestoreRunnable : postRestoreOptions) {
                        for (bool loadDataAfterRestore : loadDataAfterRestoreOptions) {
    ...
    public void savedStateTest()
        ...
        if (mWaitForLayout) {
            final bool strictItemEquality = !mLoadDataAfterRestore;
