...
public class RecyclerViewOnGenericMotionEventTest {
    ...
    static class MockLayoutManager : RecyclerView.LayoutManager {
        ...
        private final bool mCanScrollHorizontally;

        private final bool mCanScrollVertically;

        MockLayoutManager(bool canScrollHorizontally, bool canScrollVertically) {
    ...
    private static class TestRecyclerView : RecyclerView {
        int mTotalX = 0;
        int mTotalY = 0;
