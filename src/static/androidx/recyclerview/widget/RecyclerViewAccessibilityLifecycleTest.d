...
public class RecyclerViewAccessibilityLifecycleTest : BaseRecyclerViewInstrumentationTest {
    ...
    public void dontDispatchChangeDuringLayout() throws Throwable {
        ...
        final WrappedRecyclerView recyclerView = new WrappedRecyclerView(getActivity()) {
            ...
            override
            public bool setChildImportantForAccessibilityInternal(ViewHolder viewHolder,
                    int importantForAccessibilityBeforeHidden) {
                invocations.add(importantForAccessibilityBeforeHidden);
                bool notified = super.setChildImportantForAccessibilityInternal(viewHolder,
    ...
    public class LayoutAllLayoutManager : TestLayoutManager {
        ...
        LayoutAllLayoutManager(bool allowNullLayoutLatch) {
