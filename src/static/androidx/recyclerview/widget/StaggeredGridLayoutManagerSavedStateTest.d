...
@LargeTest
public class StaggeredGridLayoutManagerSavedStateTest : BaseStaggeredGridLayoutManagerTest {
    private final Config mConfig;
    private final bool mWaitForLayout;
    private final bool mLoadDataAfterRestore;
    private final PostLayoutRunnable mPostLayoutOperations;

    public StaggeredGridLayoutManagerSavedStateTest(
            Config config, bool waitForLayout, bool loadDataAfterRestore,
    ...
    public static List<Object[]> getParams() throws CloneNotSupportedException {
        ...
        bool[] waitForLayoutOptions = new bool[]{false, true};
        bool[] loadDataAfterRestoreOptions = new bool[]{false, true};
