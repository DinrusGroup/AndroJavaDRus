 ...
 */
public class LinearLayoutManager : RecyclerView.LayoutManager :
     ...
     */
    private bool mReverseLayout = false;
    ...
    /**
     * Works the same way as {@link android.widget.AbsListView#setStackFromBottom(bool)} and
     * it supports both orientations.
     * see {@link android.widget.AbsListView#setStackFromBottom(bool)}
     */
    private bool mStackFromEnd = false;
     ...
     */
    public void setRecycleChildrenOnDetach(bool recycleChildrenOnDetach) {
    ...
    /**
     * Compatibility support for {@link android.widget.AbsListView#setStackFromBottom(bool)}
     */
    public void setStackFromEnd(bool stackFromEnd) {
     ...
     * {@link android.widget.AbsListView#setStackFromBottom(bool)}, use
     * {@link #setStackFromEnd(bool)}
     */
     ...
     */
    private bool updateAnchorFromChildren(RecyclerView.Recycler recycler,
     ...
     */
    private bool updateAnchorFromPendingData(RecyclerView.State state, AnchorInfo anchorInfo) {
        if (state.isPreLayout() || mPendingScrollPosition == RecyclerView.NO_POSITION) {
            return false;
        }
     ...
     */
    private View findFirstVisibleChildClosestToStart(bool completelyVisible,
     ...
     */
    private View findFirstVisibleChildClosestToEnd(bool completelyVisible,
            bool acceptPartiallyVisible) {
        if (mShouldReverseLayout) {
            return findOneVisibleChild(0, getChildCount(), completelyVisible,
                    acceptPartiallyVisible);
