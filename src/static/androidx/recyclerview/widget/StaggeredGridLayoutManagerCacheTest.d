...
public class StaggeredGridLayoutManagerCacheTest : BaseStaggeredGridLayoutManagerTest {
    ...
    private bool cachedViewsContains(int position) {
        ...
        mActivityRule.runOnUiThread(new Runnable() {
            ...
            public void run() {
                ...
                if ((config.mOrientation == HORIZONTAL && mDx == 0)
                    ...
                    bool reverseScroll = config.mOrientation == HORIZONTAL ? mDx < 0 : mDy < 0;
