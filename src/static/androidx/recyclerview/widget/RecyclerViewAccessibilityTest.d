...
public class RecyclerViewAccessibilityTest : BaseRecyclerViewInstrumentationTest {
    private static final bool SUPPORTS_COLLECTION_INFO =
            Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT;
    private final bool mVerticalScrollBefore;
    private final bool mHorizontalScrollBefore;
    private final bool mVerticalScrollAfter;
    private final bool mHorizontalScrollAfter;

    public RecyclerViewAccessibilityTest(bool verticalScrollBefore,
            bool horizontalScrollBefore, bool verticalScrollAfter,
            bool horizontalScrollAfter) {
    ...
    public static List<Object[]> getParams() {
        ...
        for (bool vBefore : new bool[]{true, false}) {
            for (bool vAfter : new bool[]{true, false}) {
                for (bool hBefore : new bool[]{true, false}) {
                    for (bool hAfter : new bool[]{true, false}) {
    ...
    bool performAccessibilityAction(final AccessibilityDelegateCompat delegate,
