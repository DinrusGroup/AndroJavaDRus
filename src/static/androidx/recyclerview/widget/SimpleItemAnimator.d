 ...
 * class that : {@link RecyclerView.ItemAnimator.ItemHolderInfo}.
 */
public abstract class SimpleItemAnimator : RecyclerView.ItemAnimator {
     ...
     */
    public void setSupportsChangeAnimations(bool supportsChangeAnimations) {
     ...
     * false otherwise.
     *
     * @see #setSupportsChangeAnimations(bool)
     */
    override
    public bool canReuseUpdatedViewHolder(@NonNull RecyclerView.ViewHolder viewHolder) {
        return !mSupportsChangeAnimations || viewHolder.isInvalid();
    }

    override
    public bool animateDisappearance(@NonNull RecyclerView.ViewHolder viewHolder,
    ...
    override
    public bool animateAppearance(@NonNull RecyclerView.ViewHolder viewHolder,
    ...
    override
    public bool animatePersistence(@NonNull RecyclerView.ViewHolder viewHolder,
    ...
    override
    public bool animateChange(@NonNull RecyclerView.ViewHolder oldHolder, @NonNull RecyclerView.ViewHolder newHolder,
            @NonNull ItemHolderInfo preInfo, @NonNull ItemHolderInfo postInfo) {
        if (DEBUG) {
     ...
     * false otherwise.
     */
    public abstract bool animateRemove(RecyclerView.ViewHolder holder);
     ...
     * false otherwise.
     */
    public abstract bool animateAdd(RecyclerView.ViewHolder holder);
     ...
     * false otherwise.
     */
    public abstract bool animateMove(RecyclerView.ViewHolder holder, int fromX, int fromY,
            int toX, int toY);
     ...
     * {@link #dispatchChangeFinished(RecyclerView.ViewHolder, bool)} for each non-null distinct ViewHolder,
     ...
     * {@link #dispatchChangeFinished(RecyclerView.ViewHolder, bool)} once and only once. In that case, the
     ...
     * false otherwise.
     */
    public abstract bool animateChange(RecyclerView.ViewHolder oldHolder,
     ...
     */
    public final void dispatchChangeFinished(RecyclerView.ViewHolder item, bool oldItem) {
     ...
     *                it is the new item that replaced the old item.
     */
    public final void dispatchChangeStarting(RecyclerView.ViewHolder item, bool oldItem) {
     ...
     */
    @SuppressWarnings("UnusedParameters")
    public void onChangeStarting(RecyclerView.ViewHolder item, bool oldItem) {
    }
     ...
     *                it is the new item that replaced the old item.
     */
    public void onChangeFinished(RecyclerView.ViewHolder item, bool oldItem) {
    }
}
