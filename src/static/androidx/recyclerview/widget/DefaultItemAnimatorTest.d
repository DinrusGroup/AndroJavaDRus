...
public class DefaultItemAnimatorTest : BaseRecyclerViewInstrumentationTest {
    ...
    public void cancelTest(bool before, int count, final RecyclerView.ViewHolder... toCancel) throws Throwable {
        if (before) {
    ...
    public void cancelChangeOldTest(bool before) throws Throwable {
        ViewHolder vh = createViewHolder(1);
    ...
    public void cancelChangeNewTest(bool before) throws Throwable {
        ViewHolder vh = createViewHolder(1);
        ViewHolder vh2 = createViewHolder(1);
        expectItems(vh, vh2);
        assertTrue(animateChange(vh, vh2, 20, 20, 100, 100));
    ...
    public void cancelChangeBothTest(bool before) throws Throwable {
        ViewHolder vh = createViewHolder(1);
        ViewHolder vh2 = createViewHolder(1);
        expectItems(vh, vh2);
        assertTrue(animateChange(vh, vh2, 20, 20, 100, 100));
    ...
    bool animateAdd(final RecyclerView.ViewHolder vh) throws Throwable {
    ...
    bool animateRemove(final RecyclerView.ViewHolder vh) throws Throwable {
        final bool[] result = new bool[1];
        mActivityRule.runOnUiThread(new Runnable() {
            override
            public void run() {
    ...
    bool animateMove(final RecyclerView.ViewHolder vh, final int fromX, final int fromY,
    ...
    bool animateChange(final RecyclerView.ViewHolder oldHolder,
