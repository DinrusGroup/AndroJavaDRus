 ...
 * ViewHolder, float, float, int, bool)}
 ...
 */
public class ItemTouchHelper : RecyclerView.ItemDecoration
    ...
    private static bool hitTest(View child, float x, float y, float left, float top) {
        return x >= left
    ...
    private bool hasRunningRecoverAnim() {
     ...
     */
    private bool scrollIfNecessary() {
        if (mSelected == null) {
            mDragScrollStartTimeInMs = Long.MIN_VALUE;
            return false;
        }
     ...
     */
    private void endRecoverAnimation(ViewHolder viewHolder, bool override) {
        final int recoverAnimSize = mRecoverAnimations.size();
        for (int i = recoverAnimSize - 1; i >= 0; i--) {
    ...
    public abstract static class Callback {
        ...
        bool hasDragFlag(RecyclerView recyclerView, ViewHolder viewHolder) {
            final int flags = getAbsoluteMovementFlags(recyclerView, viewHolder);
            return (flags & ACTION_MODE_DRAG_MASK) != 0;
        }

        bool hasSwipeFlag(RecyclerView recyclerView,
                ViewHolder viewHolder) {
            final int flags = getAbsoluteMovementFlags(recyclerView, viewHolder);
         ...
         */
        @SuppressWarnings("WeakerAccess")
        public bool canDropOver(@NonNull RecyclerView recyclerView, @NonNull ViewHolder current,
         ...
         */
        public abstract bool onMove(@NonNull RecyclerView recyclerView,
         ...
         */
        public bool isItemViewSwipeEnabled() {
            return true;
        }
         ...
         * bool)} or
         * {@link #onChildDrawOver(Canvas, RecyclerView, ViewHolder, float, float, int, bool)}.
         *
     ...
     *         public abstract bool onMove(RecyclerView recyclerView,
     ...
     * </pre>
     */
    public abstract static class SimpleCallback : Callback {
    ...
    private class ItemTouchHelperGestureListener : GestureDetector.SimpleOnGestureListener {
    ...
    private static class RecoverAnimation : Animator.AnimatorListener {
