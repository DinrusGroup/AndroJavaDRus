...
public class CustomTabsClient {
     ...
     */
    public static bool bindCustomTabsService(Context context,
     ...
     *
     * @see #getPackageName(Context, List<String>, bool)
     */
    ...
    public static String getPackageName(
        Context context, @Nullable List<String> packages, bool ignoreDefault) {
     ...
     * @return Whether the binding was successful.
     */
    public static bool connectAndInitialize(Context context, String packageName) {
    ...
    public CustomTabsSession newSession(final CustomTabsCallback callback) {
        ICustomTabsCallback.Stub wrapper = new ICustomTabsCallback.Stub() {
            ...
            public void onRelationshipValidationResult(
                    final @CustomTabsService.Relation int relation, final Uri requestedOrigin, final bool result,
