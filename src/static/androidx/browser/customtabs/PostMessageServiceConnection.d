 ...
 */
public abstract class PostMessageServiceConnection : ServiceConnection {
     ...
     */
    public bool bindSessionToPostMessageService(Context context, String packageName) {
     ...
     */
    public final bool notifyMessageChannelReady(Bundle extras) {
     ...
     */
    public final bool postMessage(String message, Bundle extras) {
        if (mService == null) return false;
        synchronized (mLock) {
            try {
