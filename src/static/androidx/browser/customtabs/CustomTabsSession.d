...
public final class CustomTabsSession {
     ...
     */
    public bool mayLaunchUrl(Uri url, Bundle extras, List<Bundle> otherLikelyBundles) {
        try {
     ...
     */
    public bool setActionButton(@NonNull Bitmap icon, @NonNull String description) {
     ...
     */
    public bool setSecondaryToolbarViews(@Nullable RemoteViews remoteViews,
     ...
     */
    @Deprecated
    public bool setToolbarItem(int id, @NonNull Bitmap icon, @NonNull String description) {
        Bundle bundle = new Bundle();
     ...
     *         asynchronous.
     */
    public bool requestPostMessageChannel(Uri postMessageOrigin) {
        try {
     ...
     */
    public bool validateRelationship(@CustomTabsService.Relation int relation, @NonNull Uri origin,
