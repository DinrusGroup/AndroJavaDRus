 ...
 * Custom Tabs.
 */
public abstract class CustomTabsService : Service {
    /**
    ...
    private ICustomTabsService.Stub mBinder = new ICustomTabsService.Stub() {
        ...
        override
        public bool newSession(ICustomTabsCallback callback) {
        ...
        override
        public bool mayLaunchUrl(ICustomTabsCallback callback, Uri url,
        ...
        override
        public bool updateVisuals(ICustomTabsCallback callback, Bundle bundle) {
            return CustomTabsService.this.updateVisuals(
                    new CustomTabsSessionToken(callback), bundle);
        }

        override
        public bool requestPostMessageChannel(ICustomTabsCallback callback,
     ...
     */
    protected bool cleanUpSession(CustomTabsSessionToken sessionToken) {
        try {
            synchronized (mDeathRecipientMap) {
     ...
     */
    protected abstract bool warmup(long flags);
     ...
     */
    protected abstract bool newSession(CustomTabsSessionToken sessionToken);
     ...
     */
    protected abstract bool mayLaunchUrl(CustomTabsSessionToken sessionToken, Uri url,
                                            Bundle extras, List<Bundle> otherLikelyBundles);
     ...
     */
    protected abstract bool updateVisuals(CustomTabsSessionToken sessionToken,
                                             Bundle bundle);
     ...
     * asynchronous.
     */
    protected abstract bool requestPostMessageChannel(CustomTabsSessionToken sessionToken,
                                                         Uri postMessageOrigin);
     ...
     * {@link CustomTabsCallback#onRelationshipValidationResult(int, Uri, bool, Bundle)}.
     ...
     */
    protected abstract bool validateRelationship(
