...
public class GridLayout : ViewGroup {
    ...
    static final bool DEFAULT_ORDER_PRESERVED = true;
    ...
    private int getDefaultMargin(View c, LayoutParams p, bool horizontal, bool leading) {
        ...
        bool leading1 = (horizontal && isLayoutRtlCompat()) ? !leading : leading;
    ...
    */
    ...
    public static class Spec {
        ...
        public Alignment getAbsoluteAlignment(bool horizontal) {
    ...
    private static Alignment createSwitchingAlignment(final Alignment ltr, final Alignment rtl) {
        return new Alignment() {
            override
            int getGravityOffset(View view, int cellDelta) {
                bool isLayoutRtl = ViewCompat.getLayoutDirection(view) ==
