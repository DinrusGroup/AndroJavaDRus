...
final class MediaRouterThemeHelper {
     ...
     */
    static Context createThemedDialogContext(Context context, int theme, bool alertDialog) {
    ...
    static void setMediaControlsBackgroundColor(
            Context context, View mainControls, View groupControls, bool hasGroup) {
        int primaryColor = getThemeColor(context, 0,
                androidx.appcompat.R.attr.colorPrimary);
    ...
    private static bool isLightTheme(Context context) {
        TypedValue value = new TypedValue();
