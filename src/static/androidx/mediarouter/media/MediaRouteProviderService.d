 ...
 * </pre>
 */
public abstract class MediaRouteProviderService : Service {
    ...
    bool onRegisterClient(Messenger messenger, int requestId, int version) {
    ...
    bool onUnregisterClient(Messenger messenger, int requestId) {
        int index = findClient(messenger);
        if (index >= 0) {
    ...
    bool onCreateRouteController(Messenger messenger, int requestId,
    ...
    bool onReleaseRouteController(Messenger messenger, int requestId,
            int controllerId) {
        ClientRecord client = getClient(messenger);
        if (client != null) {
    ...
    bool onSelectRoute(Messenger messenger, int requestId,
            int controllerId) {
        ClientRecord client = getClient(messenger);
        if (client != null) {
    ...
    bool onUnselectRoute(Messenger messenger, int requestId,
    ...
    bool onSetRouteVolume(Messenger messenger, int requestId,
    ...
    bool onUpdateRouteVolume(Messenger messenger, int requestId,
    ...
    bool onRouteControlRequest(final Messenger messenger, final int requestId,
    ...
    bool onSetDiscoveryRequest(Messenger messenger, int requestId,
            MediaRouteDiscoveryRequest request) {
        ClientRecord client = getClient(messenger);
        if (client != null) {
            bool actuallyChanged = client.setDiscoveryRequest(request);
            if (DEBUG) {
    ...
    bool updateCompositeDiscoveryRequest() {
    ...
    private final class PrivateHandler : Handler {
        PrivateHandler() {
        }
    ...
    private final class ClientRecord : DeathRecipient {
        ...
        public bool hasMessenger(Messenger other) {
            return mMessenger.getBinder() == other.getBinder();
        }

        public bool createRouteController(String routeId, String routeGroupId,
                int controllerId) {
        ...
        public bool releaseRouteController(int controllerId) {
        ...
        public bool setDiscoveryRequest(MediaRouteDiscoveryRequest request) {
     ...
     * </p>
     */
    private static final class ReceiveHandler : Handler {
        ...
        private bool processMessage(int what,
