 ...
 */
final class RegisteredMediaRouteProvider : MediaRouteProvider
        : ServiceConnection {
    ...
    public bool hasComponentName(String packageName, String className) {
    ...
    private final class Controller : RouteController {
        ...
        override
        public bool onControlRequest(Intent intent, ControlRequestCallback callback) {
            if (mConnection != null) {
    ...
    private final class Connection : DeathRecipient {
        ...
        public bool onGenericFailure(int requestId) {
        ...
        public bool onGenericSuccess(int requestId) {
            return true;
        }

        public bool onRegistered(int requestId, int serviceVersion,
        ...
        public bool onDescriptorChanged(Bundle descriptorBundle) {
            if (mServiceVersion != 0) {
                onConnectionDescriptorChanged(this,
                        MediaRouteProviderDescriptor.fromBundle(descriptorBundle));
                return true;
        ...
        public bool onControlRequestSucceeded(int requestId, Bundle data) {
            ControlRequestCallback callback = mPendingCallbacks.get(requestId);
            if (callback != null) {
                mPendingCallbacks.remove(requestId);
        ...
        public bool onControlRequestFailed(int requestId, String error, Bundle data) {
            ControlRequestCallback callback = mPendingCallbacks.get(requestId);
            if (callback != null) {
                mPendingCallbacks.remove(requestId);
        ...
        public bool sendControlRequest(int controllerId, Intent intent,
        ...
        private bool sendRequest(int what, int requestId, int arg, Object obj, Bundle data) {
    ...
    private static final class PrivateHandler : Handler {
        PrivateHandler() {
        }
    }
    ...
    private static final class ReceiveHandler : Handler {
        ...
        private bool processMessage(Connection connection,
