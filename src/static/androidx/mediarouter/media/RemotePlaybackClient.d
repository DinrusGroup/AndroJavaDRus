...
public class RemotePlaybackClient {
    ...
    private bool mRouteSupportsRemotePlayback;
    private bool mRouteSupportsQueuing;
    private bool mRouteSupportsSessionManagement;
    private bool mRouteSupportsMessaging;
     ...
     */
    public bool isRemotePlaybackSupported() {
     ...
     */
    public bool isQueuingSupported() {
     ...
     * @see #isRemotePlaybackSupported
     */
    public bool isSessionManagementSupported() {
     ...
     * @see #isRemotePlaybackSupported
     */
    public bool isMessagingSupported() {
    ...
    private final class ActionReceiver : BroadcastReceiver {
     ...
     */
    public static abstract class ItemActionCallback : ActionCallback {
        /**
     ...
     */
    public static abstract class SessionActionCallback : ActionCallback {
        /**
         * Called when the request succeeds.
         *
         * @param data The result data bundle.
