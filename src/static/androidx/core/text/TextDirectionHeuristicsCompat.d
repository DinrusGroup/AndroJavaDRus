...
public final class TextDirectionHeuristicsCompat {
     ...
     */
    private static abstract class TextDirectionHeuristicImpl : TextDirectionHeuristicCompat {
         ...
         */
        abstract protected bool defaultIsRtl();
        ...
        override
        public bool isRtl(CharSequence cs, int start, int count) {
        ...
        private bool doCheck(CharSequence cs, int start, int count) {
    ...
    private static class TextDirectionHeuristicInternal : TextDirectionHeuristicImpl {
        private final bool mDefaultIsRtl;
     ...
     */
    private static class FirstStrong : TextDirectionAlgorithm {
        override
     ...
     * direction of text.
     */
    private static class AnyStrong : TextDirectionAlgorithm {
        private final bool mLookForRtl;
     ...
     */
    private static class TextDirectionHeuristicLocale : TextDirectionHeuristicImpl {
