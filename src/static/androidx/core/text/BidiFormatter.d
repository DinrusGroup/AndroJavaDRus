...
public final class BidiFormatter {
    ...
    public static final class Builder {
         ...
         */
        private void initialize(bool isRtlContext) {
         ...
         */
        public Builder stereoReset(bool stereoReset) {
            if (stereoReset) {
        ...
        private static BidiFormatter getDefaultInstanceFromContext(bool isRtlContext) {
    ...
    private final bool mIsRtlContext;
     ...
     */
    BidiFormatter(bool isRtlContext, int flags, TextDirectionHeuristicCompat heuristic) {
        mIsRtlContext = isRtlContext;
        mFlags = flags;
    ...
    private String markAfter(CharSequence str, TextDirectionHeuristicCompat heuristic) {
        final bool isRtl = heuristic.isRtl(str, 0, str.length());
     ...
     *          false.
     */
    public bool isRtl(CharSequence str) {
     ...
     * {@link Builder#stereoReset(bool)} with a {@code false} argument, also prepends a Unicode
     ...
     *     {@code null}.
     */
    public String unicodeWrap(String str, TextDirectionHeuristicCompat heuristic, bool isolate) {
     ...
     * androidx.core.text.TextDirectionHeuristicCompat, bool)}, but takes a CharSequence
     * instead of a string
     *
    ...
    /**
     * Operates like {@link #unicodeWrap(String, androidx.core.text.TextDirectionHeuristicCompat, bool)}, but assumes
     ...
     * androidx.core.text.TextDirectionHeuristicCompat, bool)}, but assumes {@code isolate}
     * is true.
     *
     * @param str The input CharSequence.
     * @param heuristic The algorithm to be used to estimate the CharSequence's overall direction.
    ...
    /**
     * Operates like {@link #unicodeWrap(String, androidx.core.text.TextDirectionHeuristicCompat, bool)}, but uses the
    ...
    /**
     * Operates like {@link #unicodeWrap(CharSequence,
     * androidx.core.text.TextDirectionHeuristicCompat, bool)}, but uses the formatter's
     ...
     * @return Input CharSequence after applying the above processing.
     */
    public CharSequence unicodeWrap(CharSequence str, bool isolate) {
        return unicodeWrap(str, mDefaultTextDirectionHeuristicCompat, isolate);
    }
    ...
    private static class DirectionalityEstimator {
         ...
         *     tags and entities.
         */
        DirectionalityEstimator(CharSequence text, bool isHtml) {
            this.text = text;
            this.isHtml = isHtml;
            length = text.length();
        }
