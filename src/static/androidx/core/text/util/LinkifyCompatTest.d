...
public class LinkifyCompatTest {
    ...
    private MatchFilter mMatchFilterStartWithDot = new MatchFilter() {
        override
        public bool acceptMatch(final CharSequence s, final int start, final int end) {
            if (start == 0) {
                return true;
            }
    ...
    private bool containsUrl(URLSpan[] spans, String expectedValue) {
    ...
    public void testAddLinks_doesNotAddLinksForUrlWithoutProtocolAndWithoutKnownTld() {
        ...
        bool linksAdded = LinkifyCompat.addLinks(spannable, Linkify.ALL);
    ...
    private static void verifyAddLinksSucceeds(String msg, String string, int type) {
        ...
        bool linksAdded = LinkifyCompat.addLinks(spannable, type);
