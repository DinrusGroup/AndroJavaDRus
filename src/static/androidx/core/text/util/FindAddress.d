...
class FindAddress {
    ...
    private static bool checkHouseNumber(String houseNumber) {
     ...
     * of the string.
     */
    private static bool isValidZipCode(String zipCode, MatchResult stateMatch) {
     ...
     */
    @VisibleForTesting
    public static bool isValidZipCode(String zipCode, String state) {
     ...
     */
    @VisibleForTesting
    public static bool isValidLocationName(String location) {
    ...
    private static int attemptMatch(String content, MatchResult houseNumberMatch) {
        ...
        int numLines = 1;
        bool consecutiveHouseNumbers = true;
        bool foundLocationName = false;
        int wordCount = 1;
        String lastWord = "";
