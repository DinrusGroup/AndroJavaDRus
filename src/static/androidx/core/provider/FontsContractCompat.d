...
public class FontsContractCompat {
     ...
     * client application.
     */
    public static final class Columns : BaseColumns {
        /**
    ...
    public static Typeface getFontSync(final Context context, final FontRequest request,
            ...
            final @Nullable Handler handler, bool isBlockingFetch, int timeout,
            final int style) {
    ...
    public static class FontInfo {
         ...
         * @param italic A bool that indicates the font is italic style or not.
         * @param resultCode A bool that indicates the font contents is ready.
         *
         * @hide
         */
        @RestrictTo(LIBRARY_GROUP)
    ...
    private static bool equalsByteArrayList(List<byte[]> signatures,
        ...
        try {
            ...
            if (cursor != null && cursor.getCount() > 0) {
                ...
                while (cursor.moveToNext()) {
                    ...
                    bool italic = italicColumnIndex != -1 && cursor.getInt(italicColumnIndex)
                            == 1;
