...
public class FontResourcesParserCompat {
     ...
     */
    public static final class ProviderResourceEntry : FamilyResourceEntry {
    ...
    public static final class FontFileResourceEntry {
        ...
        public FontFileResourceEntry(@NonNull String fileName, int weight, bool italic,
     ...
     */
    public static final class FontFamilyFilesResourceEntry : FamilyResourceEntry {
    ...
    public static List<List<byte[]>> readCerts(Resources resources, @ArrayRes int certsId) {
        ...
        if (certsId != 0) {
            ...
            if (typedArray.length() > 0) {
                certs = new ArrayList<>();
                bool isArrayOfArrays = typedArray.getResourceId(0, 0) != 0;
                if (isArrayOfArrays) {
    ...
    private static FontFileResourceEntry readFont(XmlPullParser parser, Resources resources)
        ...
        bool isItalic = ITALIC == array.getInt(styleAttr, 0);
