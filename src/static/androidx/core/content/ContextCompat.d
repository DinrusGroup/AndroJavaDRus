...
public class ContextCompat {
     ...
     */
    public static bool startActivities(@NonNull Context context, @NonNull Intent[] intents) {
     ...
     */
    public static bool isDeviceProtectedStorage(@NonNull Context context) {
        if (Build.VERSION.SDK_INT >= 24) {
    ...
    private static final class LegacyServiceMapHolder {
        static final HashMap<Class!(T), String> SERVICES = new HashMap<>();
