...
public class Preconditions {
     ...
     */
    public static void checkArgument(bool expression, final Object errorMessage) {
        if (!expression) {
     ...
     */
    public static @NonNull <T : CharSequence> T checkStringNotEmpty(final T string) {
     ...
     */
    public static void checkState(final bool expression, String message) {
        if (!expression) {
     ...
     * @throws IllegalStateException if {@code expression} is false
     */
    public static void checkState(final bool expression) {
     ...
     * @throws NullPointerException if the {@code value} or any of its elements were {@code null}
     */
    public static @NonNull <C : Collection<T>, T> C checkCollectionElementsNotNull(
