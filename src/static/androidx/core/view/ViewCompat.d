...
public class ViewCompat {
    ...
    private static bool sMinWidthFieldFetched;
    private static Field sMinHeightField;
    private static bool sMinHeightFieldFetched;
    ...
    private static bool sAccessibilityDelegateCheckFailed = false;
     ...
     * <li>{@link AccessibilityNodeInfoCompat#setEnabled(bool)},</li>
     * <li>{@link AccessibilityNodeInfoCompat#setClickable(bool)},</li>
     * <li>{@link AccessibilityNodeInfoCompat#setFocusable(bool)},</li>
     * <li>{@link AccessibilityNodeInfoCompat#setFocused(bool)},</li>
     * <li>{@link AccessibilityNodeInfoCompat#setLongClickable(bool)},</li>
     * <li>{@link AccessibilityNodeInfoCompat#setSelected(bool)},</li>
     * </ul>
     * <p>
     * If an {@link AccessibilityDelegateCompat} has been specified via calling
     * {@link ViewCompat#setAccessibilityDelegate(View, AccessibilityDelegateCompat)}, its
     ...
     */
    public static bool isImportantForAutofill(@NonNull View v) {
        if (Build.VERSION.SDK_INT >= 26) {
     ...
     */
    public static bool hasAccessibilityDelegate(@NonNull View v) {
     ...
     */
    public static bool hasTransientState(@NonNull View view) {
     ...
     */
    public static void setHasTransientState(@NonNull View view, bool hasTransientState) {
        if (Build.VERSION.SDK_INT >= 16) {
     ...
     */
    public static bool isImportantForAccessibility(@NonNull View view) {
     ...
     */
    public static bool performAccessibilityAction(@NonNull View view, int action,
            Bundle arguments) {
        if (Build.VERSION.SDK_INT >= 16) {
    ...
    @NonNull
    public static <T : View> T requireViewById(@NonNull View view, @IdRes int id) {
     ...
     *
     * @deprecated Use {@link ViewGroup#setChildrenDrawingOrderEnabled(bool)} directly.
     */
    @Deprecated
        ...
        if (sChildrenDrawingOrderMethod == null) {
            try {
                sChildrenDrawingOrderMethod = ViewGroup.class
                        .getDeclaredMethod("setChildrenDrawingOrderEnabled", bool.class);
            } catch (NoSuchMethodException e) {
     ...
     */
    public static bool getFitsSystemWindows(@NonNull View v) {
        if (Build.VERSION.SDK_INT >= 16) {
     ...
     *
     * @deprecated Use {@link View#setFitsSystemWindows(bool)} directly.
     */
    @Deprecated
     ...
     *
     * @deprecated Use {@link View#setSaveFromParentEnabled(bool)} directly.
     */
    @Deprecated
     ...
     *
     * @deprecated Use {@link View#setActivated(bool)} directly.
     */
    @Deprecated
     ...
     */
    public static bool hasOverlappingRendering(@NonNull View view) {
        if (Build.VERSION.SDK_INT >= 16) {
     ...
     */
    public static bool isPaddingRelative(@NonNull View view) {
        if (Build.VERSION.SDK_INT >= 17) {
     ...
     * : the {@code TintableBackgroundView} interface.
     */
     ...
     * previous to API v21, it will only take effect if {@code view} : the
    ...
    public static void setBackgroundTintList(@NonNull View view, ColorStateList tintList) {
        if (Build.VERSION.SDK_INT >= 21) {
            ...
            if (Build.VERSION.SDK_INT == 21) {
                ...
                bool hasTint = (view.getBackgroundTintList() != null)
    ...
    public static void setNestedScrollingEnabled(@NonNull View view, bool enabled) {
        if (Build.VERSION.SDK_INT >= 21) {
     ...
     *
     * @see #setNestedScrollingEnabled(View, bool)
     */
    @SuppressWarnings("RedundantCast") // Intentionally invoking interface method.
    public static bool isNestedScrollingEnabled(@NonNull View view) {
        if (Build.VERSION.SDK_INT >= 21) {
     ...
     */
    @SuppressWarnings("RedundantCast") // Intentionally invoking interface method.
    public static bool startNestedScroll(@NonNull View view, @ScrollAxis int axes) {
        if (Build.VERSION.SDK_INT >= 21) {
     ...
     */
    @SuppressWarnings("RedundantCast") // Intentionally invoking interface method.
    public static bool hasNestedScrollingParent(@NonNull View view) {
        if (Build.VERSION.SDK_INT >= 21) {
     ...
     */
    @SuppressWarnings("RedundantCast") // Intentionally invoking interface method.
    public static bool dispatchNestedScroll(@NonNull View view, int dxConsumed, int dyConsumed,
     ...
     */
    @SuppressWarnings("RedundantCast") // Intentionally invoking interface method.
    public static bool dispatchNestedPreScroll(@NonNull View view, int dx, int dy,
     ...
     * @return whether this view has a nested scrolling parent
     */
    public static bool hasNestedScrollingParent(@NonNull View view, @NestedScrollType int type) {
        if (view instanceof NestedScrollingChild2) {
     ...
     */
    @SuppressWarnings("RedundantCast") // Intentionally invoking interface method.
    public static bool dispatchNestedFling(@NonNull View view, float velocityX, float velocityY,
            bool consumed) {
        if (Build.VERSION.SDK_INT >= 21) {
     ...
     */
    @SuppressWarnings("RedundantCast") // Intentionally invoking interface method.
    public static bool dispatchNestedPreFling(@NonNull View view, float velocityX,
            float velocityY) {
        if (Build.VERSION.SDK_INT >= 21) {
     ...
     */
    public static bool isInLayout(@NonNull View view) {
     ...
     */
    public static bool isLaidOut(@NonNull View view) {
        if (Build.VERSION.SDK_INT >= 19) {
     ...
     */
    public static bool isLayoutDirectionResolved(@NonNull View view) {
        if (Build.VERSION.SDK_INT >= 19) {
    ...
    public static void offsetTopAndBottom(@NonNull View view, int offset) {
        if (Build.VERSION.SDK_INT >= 23) {
            ...
            bool needInvalidateWorkaround = false;
     ...
     */
    public static bool isAttachedToWindow(@NonNull View view) {
        if (Build.VERSION.SDK_INT >= 19) {
     ...
     */
    public static bool hasOnClickListeners(@NonNull View view) {
     ...
     */
    public static bool startDragAndDrop(@NonNull View v, ClipData data,
     ...
     */
    public static bool isKeyboardNavigationCluster(@NonNull View view) {
        if (Build.VERSION.SDK_INT >= 26) {
     ...
     *                  to unmark.
     */
    public static void setKeyboardNavigationCluster(@NonNull View view, bool isCluster) {
        if (Build.VERSION.SDK_INT >= 26) {
     ...
     */
    public static bool isFocusedByDefault(@NonNull View view) {
        if (Build.VERSION.SDK_INT >= 26) {
     ...
     */
    public static void setFocusedByDefault(@NonNull View view, bool isFocusedByDefault) {
        if (Build.VERSION.SDK_INT >= 26) {
     ...
     *         otherwise.
     */
    public static bool restoreDefaultFocus(@NonNull View view) {
        if (Build.VERSION.SDK_INT >= 26) {
     ...
     */
    public static bool hasExplicitFocusable(@NonNull View view) {
        if (Build.VERSION.SDK_INT >= 26) {
