 ...
 * of Android.</p>
 */
public interface NestedScrollingChild2 : NestedScrollingChild {
     ...
     */
    bool startNestedScroll(@ScrollAxis int axes, @NestedScrollType int type);
     ...
     */
    bool hasNestedScrollingParent(@NestedScrollType int type);
     ...
     * @see #dispatchNestedScroll(int, int, int, int, int[], int)
     */
    bool dispatchNestedPreScroll(int dx, int dy, @Nullable int[] consumed,
