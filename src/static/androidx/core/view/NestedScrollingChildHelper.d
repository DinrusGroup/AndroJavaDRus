 ...
 * method implementation. This : the standard framework policy for nested scrolling.</p>
 *
...
public class NestedScrollingChildHelper {
     ...
     * @return true if this view has a nested scrolling parent, false otherwise
     */
    public bool hasNestedScrollingParent(@NestedScrollType int type) {
     ...
     */
    public bool startNestedScroll(@ScrollAxis int axes) {
     ...
     * @return true if a cooperating parent view was found and nested scrolling started successfully
     */
    public bool startNestedScroll(@ScrollAxis int axes, @NestedScrollType int type) {
