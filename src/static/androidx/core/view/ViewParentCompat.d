...
public final class ViewParentCompat {
     ...
     */
    @Deprecated
    public static bool requestSendAccessibilityEvent(
     ...
     */
    public static bool onStartNestedScroll(ViewParent parent, View child, View target,
     ...
     */
    @SuppressWarnings("RedundantCast") // Intentionally invoking interface method.
    public static bool onNestedFling(ViewParent parent, View target, float velocityX,
            float velocityY, bool consumed) {
        if (Build.VERSION.SDK_INT >= 21) {
            try {
     ...
     */
    @SuppressWarnings("RedundantCast") // Intentionally invoking interface method.
    public static bool onNestedPreFling(ViewParent parent, View target, float velocityX,
            float velocityY) {
        if (Build.VERSION.SDK_INT >= 21) {
            try {
