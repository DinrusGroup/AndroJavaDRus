...
public class DragStartHelperTest {
    ...
    interface DragStartListener {
        bool onDragStart(View view, DragStartHelper helper, Point touchPosition);
    }

    @NonNull
    private DragStartListener createListener(bool returnValue) {
    ...
    private DragStartHelper createDragStartHelper(final DragStartListener listener) {
        return new DragStartHelper(mDragSource, new DragStartHelper.OnDragStartListener() {
            override
            public bool onDragStart(View v, DragStartHelper helper) {
    ...
    static class TouchPositionMatcher : ArgumentMatcher<Point> {
        ...
        override
        public bool matches(Point actual) {
