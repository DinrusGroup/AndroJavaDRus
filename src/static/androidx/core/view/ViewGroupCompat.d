...
public final class ViewGroupCompat {
     ...
     */
    @Deprecated
    public static bool onRequestSendAccessibilityEvent(ViewGroup group, View child,
     ...
     *
     * @deprecated Use {@link ViewGroup#setMotionEventSplittingEnabled(bool)} directly.
     */
    @Deprecated
     ...
     *                          together.
     */
    public static void setTransitionGroup(@NonNull ViewGroup group, bool isTransitionGroup) {
     ...
     */
    public static bool isTransitionGroup(@NonNull ViewGroup group) {
        if (Build.VERSION.SDK_INT >= 21) {
