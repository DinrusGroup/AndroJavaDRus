...
public final class AccessibilityManagerCompat {
     ...
     */
    @Deprecated
    public static bool addAccessibilityStateChangeListener(AccessibilityManager manager,
     ...
     */
    @Deprecated
    public static bool removeAccessibilityStateChangeListener(AccessibilityManager manager,
            AccessibilityStateChangeListener listener) {
        if (listener == null) {
            return false;
        }
     ...
     * @return True if successfully registered.
     */
    public static bool addTouchExplorationStateChangeListener(AccessibilityManager manager,
     ...
     * @return True if successfully unregistered.
     */
    public static bool removeTouchExplorationStateChangeListener(AccessibilityManager manager,
            TouchExplorationStateChangeListener listener) {
        if (Build.VERSION.SDK_INT >= 19) {
            if (listener == null) {
                return false;
