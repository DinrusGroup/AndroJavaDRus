...
public class AccessibilityNodeInfoCompat {
    ...
    public static class CollectionItemInfoCompat {
         ...
         *                {@link AccessibilityNodeInfoCompat#setHeading(bool)} used to identify
         *                headings.
     ...
     * @throws IllegalStateException If called from an AccessibilityService.
     */
    public bool removeAction(AccessibilityActionCompat action) {
        if (Build.VERSION.SDK_INT >= 21) {
    ...
    public List<AccessibilityActionCompat> getActionList() {
        ...
        if (Build.VERSION.SDK_INT >= 21) {
            actions = (List<Object>) (List!(T)) mInfo.getActionList();
        }
        if (actions != null) {
    ...
    private void setBooleanProperty(int property, bool value) {
        ...
        if (extras != null) {
            int boolProperties = extras.getInt(BOOLEAN_PROPERTY_KEY, 0);
            boolProperties &= ~property;
            boolProperties |= (value) ? property : 0;
            extras.putInt(BOOLEAN_PROPERTY_KEY, boolProperties);
        }
    }
