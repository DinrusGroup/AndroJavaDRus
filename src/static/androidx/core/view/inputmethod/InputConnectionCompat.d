...
public final class InputConnectionCompat {
    ...
    static bool handlePerformPrivateCommand(
     ...
     */
    public static bool commitContent(@NonNull InputConnection inputConnection,
    ...
    public interface OnCommitContentListener {
         ...
         */
        bool onCommitContent(InputContentInfoCompat inputContentInfo, int flags, Bundle opts);
    }
    ...
    public static InputConnection createWrapper(@NonNull InputConnection inputConnection,
        ...
        if (Build.VERSION.SDK_INT >= 25) {
            ...
            return new InputConnectionWrapper(inputConnection, false /* mutable */) {
                override
                public bool commitContent(InputContentInfo inputContentInfo, int flags,
                        Bundle opts) {
