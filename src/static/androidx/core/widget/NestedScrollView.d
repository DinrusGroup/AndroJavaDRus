 ...
 */
public class NestedScrollView : FrameLayout : NestedScrollingParent2,
    ...
    override
    public bool onStartNestedScroll(@NonNull View child, @NonNull View target, int axes,
            int type) {
     ...
     */
    public bool executeKeyEvent(@NonNull KeyEvent event) {
        mTempRect.setEmpty();
    ...
    bool overScrollByCompat(int deltaX, int deltaY,
            int scrollX, int scrollY,
            int scrollRangeX, int scrollRangeY,
            int maxOverScrollX, int maxOverScrollY,
            bool isTouchEvent) {
        final int overScrollMode = getOverScrollMode();
        final bool canScrollHorizontal =
                computeHorizontalScrollRange() > computeHorizontalScrollExtent();
        final bool canScrollVertical =
                computeVerticalScrollRange() > computeVerticalScrollExtent();
        final bool overScrollHorizontal = overScrollMode == View.OVER_SCROLL_ALWAYS
                || (overScrollMode == View.OVER_SCROLL_IF_CONTENT_SCROLLS && canScrollHorizontal);
        final bool overScrollVertical = overScrollMode == View.OVER_SCROLL_ALWAYS
    ...
    private View findFocusableViewInBounds(bool topFocus, int top, int bottom) {
        ...
        for (int i = 0; i < count; i++) {
            ...
            if (top < viewBottom && viewTop < bottom) {
                ...
                final bool viewIsFullyContained = (top < viewTop) && (viewBottom < bottom);
                ...
                if (focusCandidate == null) {
                    ...
                    final bool viewIsCloserToBoundary =
        ...
        if (mScroller.computeScrollOffset()) {
            ...
            if (dy != 0) {
                ...
                if (!dispatchNestedScroll(0, scrolledDeltaY, 0, unconsumedY, null,
                    ...
                    final bool canOverscroll = mode == OVER_SCROLL_ALWAYS
     ...
     */
    private static bool isViewDescendantOf(View child, View parent) {
        if (child == parent) {
            return true;
        }
    ...
    private void flingWithNestedDispatch(int velocityY) {
        final int scrollY = getScrollY();
        final bool canFling = (scrollY > 0 || velocityY > 0)
    ...
    static class AccessibilityDelegate : AccessibilityDelegateCompat {
        override
        ...
        public void onInitializeAccessibilityEvent(View host, AccessibilityEvent event) {
            ...
            final bool scrollable = nsvHost.getScrollRange() > 0;
