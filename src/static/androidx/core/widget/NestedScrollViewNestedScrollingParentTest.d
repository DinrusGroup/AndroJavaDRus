...
public class NestedScrollViewNestedScrollingParentTest :
    ...
    private void onStartNestedScrollV1(int iScrollAxis, bool oRetValue) {
        bool retVal = mNestedScrollView.onStartNestedScroll(mChild, mChild, iScrollAxis);
        assertThat(retVal, is(oRetValue));
    }

    private void onStartNestedScrollV2(int iScrollAxis, bool oRetValue) {
        bool retVal = mNestedScrollView.onStartNestedScroll(mChild, mChild, iScrollAxis,
                ViewCompat.TYPE_TOUCH);
        assertThat(retVal, is(oRetValue));
    }
    ...
    public class NestedScrollingSpyView : FrameLayout : NestedScrollingChild2,
        ...
        override
        public bool dispatchNestedPreScroll(int dx, int dy, @Nullable int[] consumed,
        ...
        override
        public bool dispatchNestedPreScroll(int dx, int dy, int[] consumed,
                int[] offsetInWindow) {
            return false;
        }
        ...
        override
        public bool onStartNestedScroll(View child, View target, int axes) {
            return false;
        }
        ...
        override
        public bool onNestedFling(View target, float velocityX, float velocityY,
                bool consumed) {
            return false;
        }
