...
@SmallTest
public class TextViewCompatTest : BaseInstrumentationTestCase<TextViewTestActivity> {
    private static final String TAG = "TextViewCompatTest";

    private TextView mTextView;

    private class TestDrawable : ColorDrawable {
        private int mWidth;
        private int mHeight;
    ...
    public void testSetCustomSelectionActionModeCallback_doesNotIgnoreTheGivenCallback() {
        ...
        final bool[] callbackCalled = new bool[4];
        ...
        for (bool called : callbackCalled) {
            assertTrue(called);
        }
    }
