...
public final class TextViewCompat {
    ...
    private static bool sMaximumFieldFetched;
    private static Field sMaxModeField;
    private static bool sMaxModeFieldFetched;

    private static Field sMinimumField;
    private static bool sMinimumFieldFetched;
    private static Field sMinModeField;
    private static bool sMinModeFieldFetched;
    ...
    public static void setCompoundDrawablesRelative(@NonNull TextView textView,
        ...
        if (Build.VERSION.SDK_INT >= 18) {
            ...
            bool rtl = textView.getLayoutDirection() == View.LAYOUT_DIRECTION_RTL;
    ...
    public static Drawable[] getCompoundDrawablesRelative(@NonNull TextView textView) {
        ...
        if (Build.VERSION.SDK_INT >= 17) {
            final bool rtl = textView.getLayoutDirection() == View.LAYOUT_DIRECTION_RTL;
    ...
    private static class OreoCallback : ActionMode.Callback {
        ...
        private bool mInitializedMenuBuilderReferences;
        ...
        private List<ResolveInfo> getSupportedActivities(final Context context,
            ...
            bool canStartActivityForResult = context instanceof Activity;
        ...
        private bool isSupportedActivity(final ResolveInfo info, final Context context) {
        ...
        private bool isEditable(final TextView textView11) {
