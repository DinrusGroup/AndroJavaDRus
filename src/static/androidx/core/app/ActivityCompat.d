...
public class ActivityCompat : ContextCompat {
    ...
    public interface PermissionCompatDelegate {
         ...
         */
        bool requestPermissions(@NonNull Activity activity,
         ...
         * @see ActivityCompat#requestPermissions(Activity, String[], int)
         */
        bool onActivityResult(@NonNull Activity activity,
    ...
    @NonNull
    public static <T : View> T requireViewById(@NonNull Activity activity, @IdRes int id) {
     ...
     * @see #requestPermissions(android.app.Activity, String[], int)
     */
    public static bool shouldShowRequestPermissionRationale(@NonNull Activity activity,
    ...
    @RequiresApi(21)
    private static class SharedElementCallback21Impl : android.app.SharedElementCallback {
    ...
    @RequiresApi(23)
    private static class SharedElementCallback23Impl : SharedElementCallback21Impl {
