...
public class ComponentActivity : Activity : LifecycleOwner {
    /**
     * Storage for {@link ExtraData} instances.
     *
     * <p>Note that these objects are not retained across configuration changes</p>
     */
    private SimpleArrayMap<Class<? : ExtraData>, ExtraData> mExtraDataMap =
            new SimpleArrayMap<>();
     ...
     */
    @RestrictTo(LIBRARY_GROUP)
    public <T : ExtraData> T getExtraData(Class<T> extraDataClass) {
