    ...
    */
    ...
    public bool areNotificationsEnabled() {
        if (Build.VERSION.SDK_INT >= 24) {
            ...
            int uid = appInfo.uid;
            try {
                Class!(T) appOpsClass = Class.forName(AppOpsManager.class.getName());
     ...
     */
    private static bool useSideChannelForNotification(Notification notification) {
     ...
     * listeners.
     */
    private static class SideChannelManager : Handler.Callback, ServiceConnection {
         ...
         */
        private bool ensureServiceBound(ListenerRecord record) {
            if (record.bound) {
                return true;
            }
    ...
    private static class NotifyTask : Task {
    ...
    private static class CancelTask : Task {
        final String packageName;
        final int id;
        final String tag;
        final bool all;
