...
public class NotificationCompat {
     ...
     * of a timestamp, as supplied to {@link Builder#setUsesChronometer(bool)}.
     */
    public static final String EXTRA_SHOW_CHRONOMETER = "android.showChronometer";

    /**
     * Notification extras key: whether the when field set using {@link Builder#setWhen} should
     * be shown, as supplied to {@link Builder#setShowWhen(bool)}.
     */
    ...
    public static class Builder {
         ...
         * Don't use if you're also using {@link #setProgress(int, int, bool)};
        ...
        public Builder setLights(@ColorInt int argb, int onMs, int offMs) {
            ...
            bool showLights = mNotification.ledOnMS != 0 && mNotification.ledOffMS != 0;
         ...
         */
        public Builder setLocalOnly(bool b) {
            mLocalOnly = b;
            return this;
        }
    ...
    public static abstract class Style {
         ...
         */
        @RestrictTo(LIBRARY_GROUP)
        public RemoteViews applyStandardTemplate(bool showSmallIcon,
                int resId, bool fitIn1U) {
            ...
            bool minPriority = mBuilder.getPriority() < NotificationCompat.PRIORITY_LOW;
            ...
            bool hasRightSide = !(Build.VERSION.SDK_INT >= 21) && mBuilder.mLargeIcon != null;
    ...
    public static class MessagingStyle : Style {
         ...
         * can be overridden by calling {@link #setGroupConversation(bool)} regardless of SDK
         ...
         * less than {@link Build.VERSION_CODES#P} and {@link #setGroupConversation(bool)}
         ...
         * #setGroupConversation(bool)} has precedence over this legacy behavior. From {@code P}
        ...
        public void apply(NotificationBuilderWithBuilderAccessor builder) {
            ...
            if (Build.VERSION.SDK_INT >= 24) {
                ...
                if (Build.VERSION.SDK_INT >= 16) {
                    ...
                    bool showNames = mConversationTitle != null
        ...
        private CharSequence makeMessageLine(MessagingStyle.Message message) {
            ...
            final bool afterLollipop = Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP;
    ...
    public static class DecoratedCustomViewStyle : Style {
        ...
        private RemoteViews createRemoteViews(RemoteViews innerView, bool showActions) {
    ...
    public static class Action {
        ...
        Action(int icon, CharSequence title, PendingIntent intent, Bundle extras,
                ...
                bool allowGeneratedReplies, @SemanticAction int semanticAction,
        ...
        public static final class Builder {
            ...
            private bool mShowsUserInterface = true;
            ...
            private Builder(int icon, CharSequence title, PendingIntent intent, Bundle extras,
                    ...
                    @SemanticAction int semanticAction, bool showsUserInterface) {
                mIcon = icon;
             ...
             * The default value is {@code true}
             */
            public Builder setShowsUserInterface(bool showsUserInterface) {
                mShowsUserInterface = showsUserInterface;
                return this;
            }
