...
public class PaintCompatHasGlyphTest {
    ...
    private final bool mExpectedResult;

    public PaintCompatHasGlyphTest(String testString, bool expectedResult) {
    ...
    public void testHasGlyph() {
        final bool hasGlyph = PaintCompat.hasGlyph(new Paint(), mTestString);
