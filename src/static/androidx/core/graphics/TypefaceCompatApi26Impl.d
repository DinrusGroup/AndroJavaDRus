...
@RequiresApi(26)
public class TypefaceCompatApi26Impl : TypefaceCompatApi21Impl {
     ...
     *      bool isAsset, int ttcIndex, int weight, int isItalic, FontVariationAxis[] axes)
     */
    private bool addFontFromAssetManager(Context context, Object family, String fileName,
     ...
     */
    private bool addFontFromBuffer(Object family, ByteBuffer buffer,
     ...
     */
    private bool freeze(Object family) {
        try {
    ...
    public Typeface createFromFontInfo(Context context,
        ...
        bool atLeastOneFont = false;
        for (FontsContractCompat.FontInfo font : fonts) {
            final ByteBuffer fontBuffer = uriBuffer.get(font.getUri());
            if (fontBuffer == null) {
                continue;  // skip
            }
            final bool success = addFontFromBuffer(fontFamily, fontBuffer,
