...
public final class DrawableCompat {
    ...
    private static bool sSetLayoutDirectionMethodFetched;
     ...
     *            not.
     */
    public static void setAutoMirrored(@NonNull Drawable drawable, bool mirrored) {
     ...
     *
     * @param drawable The Drawable against which to invoke the method.
     * @return bool Returns true if this Drawable will be automatically
     *         mirrored.
     */
    public static bool isAutoMirrored(@NonNull Drawable drawable) {
        if (Build.VERSION.SDK_INT >= 19) {
     ...
     */
    public static bool canApplyTheme(@NonNull Drawable drawable) {
        if (Build.VERSION.SDK_INT >= 21) {
    ...
    public static <T : Drawable> T unwrap(@NonNull Drawable drawable) {
     ...
     */
    public static bool setLayoutDirection(@NonNull Drawable drawable, int layoutDirection) {
        if (Build.VERSION.SDK_INT >= 23) {
