...
public class FragmentAnimationTest {
    ...
    private void assertExitPopEnter(AnimatorFragment fragment) throws Throwable {
        ...
        bool isSameFragment = replacement == fragment;
    ...
    private void assertFragmentAnimation(AnimatorFragment fragment, int numAnimators,
            bool isEnter, int animatorResourceId) throws InterruptedException {
    ...
    public static class AnimatorFragment : StrictViewFragment {
    ...
    public static class EndAnimationListenerFragment : StrictViewFragment {
        public View view;
        ...
        override
        public Animation onCreateAnimation(int transit, final bool enter, int nextAnim) {
            if (nextAnim == 0) {
                return null;
            }
