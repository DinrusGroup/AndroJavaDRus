...
public class PostponedTransitionTest {
    ...
    public static class PostponedFragment1 : TransitionFragment {
        override
    ...
    public static class PostponedFragment2 : TransitionFragment {
        override
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
                Bundle savedInstanceState) {
            postponeEnterTransition();
    ...
    public static class CommitNowFragment : PostponedFragment1 {
        override
    ...
    public static class TransitionFragment2 : TransitionFragment {
        override
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
                Bundle savedInstanceState) {
