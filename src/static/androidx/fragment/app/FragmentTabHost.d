 ...
 *      complete}
 */
public class FragmentTabHost : TabHost
    ...
    static final class TabInfo {
        ...
        final @NonNull Class!(T) clss;
        final @Nullable Bundle args;
        Fragment fragment;

        TabInfo(@NonNull String _tag, @NonNull Class!(T) _class, @Nullable Bundle _args) {
            tag = _tag;
            clss = _class;
            args = _args;
        }
    ...
    static class DummyTabFactory : TabHost.TabContentFactory {
    ...
    public void addTab(@NonNull TabHost.TabSpec tabSpec, @NonNull Class!(T) clss,
