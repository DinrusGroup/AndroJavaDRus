 ...
 * </ul>
 */
public class FragmentActivity : ComponentActivity :
        ViewModelStoreOwner,
    ...
    bool mRequestedPermissionsFromFragment;
    ...
    bool mStartedIntentSenderFromFragment;
    ...
    // fragment, since we need to use the ActivityCompat version for backward compatibility.
    bool mStartedActivityFromFragment;
    ...
    public void onBackPressed() {
        ...
        final bool isStateSaved = fragmentManager.isStateSaved();
    ...
    public bool onCreatePanelMenu(int featureId, Menu menu) {
        if (featureId == Window.FEATURE_OPTIONS_PANEL) {
            bool show = super.onCreatePanelMenu(featureId, menu);
    ...
    public bool onPreparePanel(int featureId, View view, Menu menu) {
        if (featureId == Window.FEATURE_OPTIONS_PANEL && menu != null) {
            bool goforit = onPrepareOptionsPanel(view, menu);
    ...
    protected bool onPrepareOptionsPanel(View view, Menu menu) {
    ...
    class HostCallbacks : FragmentHostCallback<FragmentActivity> {
    ...
    private static bool markState(FragmentManager manager, Lifecycle.State state) {
