...
public class FragmentLifecycleTest {
    ...
    public static class StateSaveFragment : StrictFragment {
     ...
     */
    public static class ChildFragmentManagerFragment : StrictFragment {
    ...
    public static class ChildFragmentManagerChildFragment : StrictFragment {
    ...
    static class HostCallbacks : FragmentHostCallback<FragmentActivity> {
        ...
        override
        public bool onShouldShowRequestPermissionRationale(@NonNull String permission) {
    ...
    public static class SimpleFragment : Fragment {
    ...
    public static class TargetFragment : Fragment {
        public bool calledCreate;
    ...
    public static class ReferrerFragment : Fragment {
        override
        public void onCreate(@Nullable Bundle savedInstanceState) {
            super.onCreate(savedInstanceState);
    ...
    public static class SaveStateFragment : Fragment {
    ...
    public static class RemoveHelloInOnResume : Fragment {
        override
    ...
    public static class InvalidateOptionFragment : Fragment {
        public bool onPrepareOptionsMenuCalled;
    ...
    public static class OnCreateFragment : Fragment {
