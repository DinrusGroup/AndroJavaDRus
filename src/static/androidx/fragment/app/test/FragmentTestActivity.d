 ...
 */
public class FragmentTestActivity : FragmentActivity {
    ...
    public static class TestFragment : Fragment {
        ...
        public bool waitForEnd(int transitionKey)
                throws InterruptedException {
            TransitionCalledListener l = ((TransitionCalledListener)mListeners[transitionKey]);
        ...
        private class TransitionCalledListener : TransitionListener {
    ...
    public static class ParentFragment : Fragment {
        static final String CHILD_FRAGMENT_TAG = "childFragment";
        public bool wasAttachedInTime;

        private bool mRetainChild;
        ...
        public void setRetainChildInstance(bool retainChild) {
            mRetainChild = retainChild;
        }
    }

    public static class ChildFragment : Fragment {
        private OnAttachListener mOnAttachListener;

        public bool attached;
        public bool onActivityResultCalled;
    ...
    public static class AssertNotDestroyed : Fragment {
        override
