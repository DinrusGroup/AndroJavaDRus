...
public class FragmentTestUtil {
    ...
    public static void waitForExecution(final ActivityTestRule<? : FragmentActivity> rule) {
    ...
    private static void runOnUiThreadRethrow(ActivityTestRule<? : Activity> rule,
            Runnable r) {
    ...
    public static bool executePendingTransactions(
            final ActivityTestRule<? : FragmentActivity> rule) {
    ...
    public static bool executePendingTransactions(
            final ActivityTestRule<? : Activity> rule, final FragmentManager fm) {
        final bool[] ret = new bool[1];
    ...
    public static bool popBackStackImmediate(final ActivityTestRule<FragmentTestActivity> rule) {
    ...
    public static FragmentController createController(
            ActivityTestRule<? : FragmentActivity> rule) {
    ...
    public static void resume(ActivityTestRule<? : Activity> rule,
    ...
    public static bool waitForAnimationEnd(long timeout, final Animation animation) {
        long endTime = SystemClock.uptimeMillis() + timeout;
        final bool[] hasEnded = new bool[1];
