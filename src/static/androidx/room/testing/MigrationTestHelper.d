 ...
 * </pre>
 */
public class MigrationTestHelper : TestWatcher {
    ...
    public SupportSQLiteDatabase runMigrationsAndValidate(String name, int version,
            bool validateDroppedTables, Migration... migrations) throws IOException {
        File dbPath = mInstrumentation.getTargetContext().getDatabasePath(name);
        if (!dbPath.exists()) {
    ...
    static class MigratingDelegate : RoomOpenHelperDelegate {
        private final bool mVerifyDroppedTables;

        MigratingDelegate(DatabaseBundle databaseBundle, bool verifyDroppedTables) {
    ...
    static class CreatingDelegate : RoomOpenHelperDelegate {
    ...
    abstract static class RoomOpenHelperDelegate : RoomOpenHelper.Delegate {
