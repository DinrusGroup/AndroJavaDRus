...
public class TableInfo {
        ...
        try {
            if (cursor.getColumnCount() > 0) {
                ...
                while (cursor.moveToNext()) {
                    ...
                    final bool notNull = 0 != cursor.getInt(notNullIndex);
    ...
    private static Set<Index> readIndices(SupportSQLiteDatabase database, String tableName) {
        ...
        try {
            ...
            while (cursor.moveToNext()) {
                ...
                bool unique = cursor.getInt(uniqueIndex) == 1;
     ...
     */
    @Nullable
    private static Index readIndex(SupportSQLiteDatabase database, String name, bool unique) {
    ...
    public static class Column {
        ...
        public Column(String name, String type, bool notNull, int primaryKeyPosition) {
            this.name = name;
            this.type = type;
     ...
     */
    @RestrictTo(RestrictTo.Scope.LIBRARY_GROUP)
    static class ForeignKeyWithSequence : Comparable<ForeignKeyWithSequence> {
        final int mId;
        final int mSequence;
        final String mFrom;
        final String mTo;
    ...
    public static class Index {
        ...
        public final String name;
        public final bool unique;
        public final List<String> columns;

        public Index(String name, bool unique, List<String> columns) {
            this.name = name;
            this.unique = unique;
