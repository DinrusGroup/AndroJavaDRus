...
public class Room {
     ...
     * @param klass   The abstract class which is annotated with {@link Database} and :
     *                {@link RoomDatabase}.
    ...
    @NonNull
    public static <T : RoomDatabase> RoomDatabase.Builder<T> databaseBuilder(
     ...
     */
    @NonNull
    public static <T : RoomDatabase> RoomDatabase.Builder<T> inMemoryDatabaseBuilder(
