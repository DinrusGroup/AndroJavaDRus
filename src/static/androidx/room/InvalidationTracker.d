...
public class InvalidationTracker {
    ...
    Runnable mRefreshRunnable = new Runnable() {
        ...
        private bool checkUpdatedTable() {
            bool hasUpdatedTable = false;
    ...
    static class ObservedTableTracker {
        ...
        ObservedTableTracker(int tableCount) {
            ...
            mTriggerStates = new bool[tableCount];
         ...
         */
        bool onAdded(int... tableIds) {
            bool needTriggerSync = false;
            synchronized (this) {
        ...
        int[] getTablesToSync() {
            synchronized (this) {
                ...
                for (int i = 0; i < tableCount; i++) {
                    final bool newState = mTableObservers[i] > 0;
     ...
     */
    static class WeakObserver : Observer {
