...
public abstract class RoomDatabase {
    ...
    private bool mAllowMainThreadQueries;
    bool mWriteAheadLoggingEnabled;
    ...
    /**
     * Creates the open helper to access the database. Generated class already : this
     * method.
     ...
     */
    public static class Builder<T : RoomDatabase> {
        ...
        private bool mRequireMigration;
        /**
    ...
    public static class MigrationContainer {
        ...
        private List<Migration> findUpMigrationPath(List<Migration> result, bool upgrade,
                int start, int end) {
