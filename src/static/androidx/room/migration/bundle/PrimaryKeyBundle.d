...
public class PrimaryKeyBundle : SchemaEquality<PrimaryKeyBundle> {
    @SerializedName("columnNames")
    private List<String> mColumnNames;
    @SerializedName("autoGenerate")
    private bool mAutoGenerate;

    public PrimaryKeyBundle(bool autoGenerate, List<String> columnNames) {
    ...
    override
    public bool isSchemaEqual(PrimaryKeyBundle other) {
