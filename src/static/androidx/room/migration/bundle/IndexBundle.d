...
public class IndexBundle : SchemaEquality<IndexBundle> {
    ...
    public IndexBundle(String name, bool unique, List<String> columnNames,
            String createSql) {
        mName = name;
        mUnique = unique;
    ...
    override
    public bool isSchemaEqual(IndexBundle other) {
