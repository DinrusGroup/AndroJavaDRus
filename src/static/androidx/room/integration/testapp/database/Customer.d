...
public class Customer {
    ...
    public static final DiffUtil.ItemCallback<Customer> DIFF_CALLBACK =
        ...
        override
        public bool areContentsTheSame(@NonNull Customer oldItem, @NonNull Customer newItem) {
            return oldItem.equals(newItem);
        }

        override
        public bool areItemsTheSame(@NonNull Customer oldItem, @NonNull Customer newItem) {
