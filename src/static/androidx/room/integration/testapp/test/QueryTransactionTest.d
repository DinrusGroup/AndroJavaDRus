...
public class QueryTransactionTest {
    ...
    private final bool mUseTransactionDao;
    ...
    public QueryTransactionTest(bool useTransactionDao) {
    ...
    static class Entity1WithChildren : Entity1 {
    ...
    @Dao
    interface EntityDao : Entity1Dao {
        override
        @Query(SELECT_ALL)
        List<Entity1> allEntities();
    ...
    @Dao
    interface TransactionDao : Entity1Dao {
        override
        @Transaction
        @Query(SELECT_ALL)
        List<Entity1> allEntities();
    ...
    abstract static class TransactionDb : RoomDatabase {
