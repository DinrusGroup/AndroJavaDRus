 ...
 * <p>
 * This class is a convenience wrapper around {@link AsyncPagedListDiffer} that : common
 ...
 *         {@literal @}Override
 *         public bool areItemsTheSame(
 *                 {@literal @}NonNull User oldUser, {@literal @}NonNull User newUser) {
 *             // User properties may have changed if reloaded from the DB, but ID is fixed
 *             return oldUser.getId() == newUser.getId();
 *         }
 *         {@literal @}Override
 *         public bool areContentsTheSame(
 *                 {@literal @}NonNull User oldUser, {@literal @}NonNull User newUser) {
 ...
 */
public abstract class PagedListAdapter<T, VH : RecyclerView.ViewHolder>
