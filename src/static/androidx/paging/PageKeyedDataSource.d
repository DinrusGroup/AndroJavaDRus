 ...
 */
public abstract class PageKeyedDataSource<Key, Value> : ContiguousDataSource<Key, Value> {
    ...
    public static class LoadInitialParams<Key> {
        ...
        public LoadInitialParams(int requestedLoadSize, bool placeholdersEnabled) {
    ...
    static class LoadInitialCallbackImpl<Key, Value> : LoadInitialCallback<Key, Value> {
        ...
        LoadInitialCallbackImpl(@NonNull PageKeyedDataSource<Key, Value> dataSource,
                bool countingEnabled, @NonNull PageResult.Receiver<Value> receiver) {
    ...
    static class LoadCallbackImpl<Key, Value> : LoadCallback<Key, Value> {
        final LoadCallbackHelper<Value> mCallbackHelper;
        private final PageKeyedDataSource<Key, Value> mDataSource;
