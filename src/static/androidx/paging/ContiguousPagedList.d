...
class ContiguousPagedList<K, V> : PagedList<V> : PagedStorage.Callback {
    private final ContiguousDataSource<K, V> mDataSource;
    private bool mPrependWorkerRunning = false;
    private bool mAppendWorkerRunning = false;
    ...
    private PageResult.Receiver<V> mReceiver = new PageResult.Receiver<V>() {
        ...
        public void onPageResult(@PageResult.ResultType int resultType,
            ...
            if (mBoundaryCallback != null) {
                bool deferEmpty = mStorage.size() == 0;
