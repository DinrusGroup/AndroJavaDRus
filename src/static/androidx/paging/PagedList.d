 ...
 * {@link Config.Builder#setEnablePlaceholders(bool)} when building a {@link Config}.
 ...
 */
public abstract class PagedList<T> : AbstractList<T> {
    @NonNull
    ...
    private bool mBoundaryCallbackBeginDeferred = false;
    private bool mBoundaryCallbackEndDeferred = false;
    ...
    public static final class Builder<Key, Value> {
         ...
         * completes.
         * <p>
         * If the DataSource : its load synchronously, doing the load work immediately in
    ...
    @AnyThread
    void deferBoundaryCallbacks(final bool deferEmpty,
            final bool deferBegin, final bool deferEnd) {
     ...
     */
    private void tryDispatchBoundaryCallbacks(bool post) {
    ...
    private void dispatchBoundaryCallbacks(bool begin, bool end) {
    ...
    public static class Config {
         ...
         */
        @SuppressWarnings("WeakerAccess")
        public final bool enablePlaceholders;
        ...
        private Config(int pageSize, int prefetchDistance,
                bool enablePlaceholders, int initialLoadSizeHint) {
        ...
        public static final class Builder {
            ...
            private bool mEnablePlaceholders = true;
            ...
            public Builder setEnablePlaceholders(bool enablePlaceholders) {
