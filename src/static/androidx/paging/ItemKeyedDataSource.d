 ...
 */
public abstract class ItemKeyedDataSource<Key, Value> : ContiguousDataSource<Key, Value> {
     ...
     */
    public abstract static class LoadInitialCallback<Value> : LoadCallback<Value> {
        /**
    ...
    static class LoadInitialCallbackImpl<Value> : LoadInitialCallback<Value> {
        final LoadCallbackHelper<Value> mCallbackHelper;
        private final bool mCountingEnabled;
        LoadInitialCallbackImpl(@NonNull ItemKeyedDataSource dataSource, bool countingEnabled,
    ...
    static class LoadCallbackImpl<Value> : LoadCallback<Value> {
        final LoadCallbackHelper<Value> mCallbackHelper;
