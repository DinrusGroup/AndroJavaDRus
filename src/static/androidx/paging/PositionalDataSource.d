 ...
 */
public abstract class PositionalDataSource<T> : DataSource<Integer, T> {
    ...
    static class LoadInitialCallbackImpl<T> : LoadInitialCallback<T> {
        final LoadCallbackHelper<T> mCallbackHelper;
        private final bool mCountingEnabled;
        private final int mPageSize;

        LoadInitialCallbackImpl(@NonNull PositionalDataSource dataSource, bool countingEnabled,
    ...
    static class LoadRangeCallbackImpl<T> : LoadRangeCallback<T> {
    ...
    final void dispatchLoadInitial(bool acceptCount,
     ...
     * <pre>
     * class ItemDataSource : PositionalDataSource&lt;Item> {
    ...
    static class ContiguousWithoutPlaceholdersWrapper<Value>
            : ContiguousDataSource<Integer, Value> {
        @NonNull
        ...
        void dispatchLoadInitial(@Nullable Integer position, int initialLoadSize, int pageSize,
                bool enablePlaceholders, @NonNull Executor mainThreadExecutor,
