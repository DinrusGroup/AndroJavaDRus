...
public class CoordinatorLayoutTest {
    ...
    private static bool dependsOn(CoordinatorLayout.LayoutParams lpChild,
    ...
    public void testDodgeInsetBeforeLayout() throws Throwable {
        ...
        lpDodge.setBehavior(new CoordinatorLayout.Behavior() {
            override
            public bool getInsetDodgeRect(CoordinatorLayout parent, View child, Rect rect) {
    ...
    public static class NestedScrollingBehavior : CoordinatorLayout.Behavior<View> {
        override
        public bool onStartNestedScroll(CoordinatorLayout coordinatorLayout, View child,
    ...
    public static class DodgeBoundsBehavior : CoordinatorLayout.Behavior<View> {
        override
        public bool getInsetDodgeRect(CoordinatorLayout parent, View child, Rect rect) {
