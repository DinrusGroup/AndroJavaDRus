 ...
 */
public class CoordinatorLayout : ViewGroup : NestedScrollingParent2 {
    ...
    static final Class!(T)[] CONSTRUCTOR_PARAMS = new Class!(T)[] {
            Context.class,
            AttributeSet.class
    };
    ...
    override
    protected bool verifyDrawable(Drawable who) {
    ...
    public void setVisibility(int visibility) {
        ...
        final bool visible = visibility == VISIBLE;
     ...
     */
    private void resetTouchBehaviors(bool notifyOnInterceptTouchEvent) {
    ...
    private void getTopSortedChildren(List<View> out) {
        ...
        final bool useCustomOrder = isChildrenDrawingOrderEnabled();
        final int childCount = getChildCount();
    ...
    private bool performIntercept(MotionEvent ev, final int type) {
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            final bool wasBlocking = lp.didBlockInteraction();
            final bool isBlocking = lp.isBlockingInteractionBelow(this, child);
    ...
    public bool onInterceptTouchEvent(MotionEvent ev) {
        ...
        final bool intercepted = performIntercept(ev, TYPE_ON_INTERCEPT);
    ...
    LayoutParams getResolvedLayoutParams(View child) {
        ...
        if (!result.mBehaviorResolved) {
            if (child instanceof AttachedBehavior) {
                ...
                Class!(T) childClass = child.getClass();
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        final bool isRtl = layoutDirection == ViewCompat.LAYOUT_DIRECTION_RTL;
        ...
        final bool applyInsets = mLastInsets != null && ViewCompat.getFitsSystemWindows(this);
    ...
    override
    public void setFitsSystemWindows(bool fitSystemWindows) {
     ...
     * {@link #getChildRect(View, bool, Rect)}, with translation
     * disabled.
     *
     ...
     */
    private bool hasDependencies(View child) {
     ...
     */
    public bool isPointInChildBounds(@NonNull View child, int x, int y) {
     ...
     */
    public bool doViewsOverlap(@NonNull View first, @NonNull View second) {
    ...
    public bool onStartNestedScroll(View child, View target, int axes, int type) {
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            if (viewBehavior != null) {
                final bool accepted = viewBehavior.onStartNestedScroll(this, view, child,
                        target, axes, type);
                handled |= accepted;
    ...
    class OnPreDrawListener : ViewTreeObserver.OnPreDrawListener {
        override
     ...
     */
    static class ViewElevationComparator : Comparator<View> {
        override
     ...
     *
     * <p>A Behavior : one or more interactions that a user can take on a child view.
     ...
     */
    public static abstract class Behavior<V : View> {
         ...
         */
        public bool onInterceptTouchEvent(@NonNull CoordinatorLayout parent, @NonNull V child,
         ...
         */
        public bool onTouchEvent(@NonNull CoordinatorLayout parent, @NonNull V child,
                @NonNull MotionEvent ev) {
            return false;
        }
         ...
         *         return > 0.0f.
         */
        public bool blocksInteractionBelow(@NonNull CoordinatorLayout parent, @NonNull V child) {
         ...
         */
        public bool layoutDependsOn(@NonNull CoordinatorLayout parent, @NonNull V child,
         ...
         */
        public bool onDependentViewChanged(@NonNull CoordinatorLayout parent, @NonNull V child,
                @NonNull View dependency) {
            return false;
        }
         ...
         */
        public bool onMeasureChild(@NonNull CoordinatorLayout parent, @NonNull V child,
         ...
         */
        public bool onLayoutChild(@NonNull CoordinatorLayout parent, @NonNull V child,
                int layoutDirection) {
            return false;
        }
         ...
         */
        @Deprecated
        public bool onStartNestedScroll(@NonNull CoordinatorLayout coordinatorLayout,
         ...
         *
         * @see NestedScrollingParent#onNestedFling(View, float, float, bool)
         */
        public bool onNestedFling(@NonNull CoordinatorLayout coordinatorLayout,
         ...
         */
        public bool onNestedPreFling(@NonNull CoordinatorLayout coordinatorLayout,
                @NonNull V child, @NonNull View target, float velocityX, float velocityY) {
            return false;
        }
         ...
         * {@link ViewParent#requestChildRectangleOnScreen(View, Rect, bool)}.</p>
         *
         * @param coordinatorLayout the CoordinatorLayout parent of the view this Behavior is
         *                          associated with
         ...
         * @see ViewParent#requestChildRectangleOnScreen(View, Rect, bool)
         */
        public bool onRequestChildRectangleOnScreen(@NonNull CoordinatorLayout coordinatorLayout,
                @NonNull V child, @NonNull Rect rectangle, bool immediate) {
            return false;
        }
         ...
         */
        public bool getInsetDodgeRect(@NonNull CoordinatorLayout parent, @NonNull V child,
                @NonNull Rect rect) {
            return false;
        }
    }
     ...
     */
    public static class LayoutParams : MarginLayoutParams {
        /**
    ...
    private class HierarchyChangeListener : OnHierarchyChangeListener {
    ...
    protected static class SavedState : AbsSavedState {
