...
public class TestFloatingBehavior : CoordinatorLayout.Behavior<TextView> {
    ...
    override
    public bool layoutDependsOn(CoordinatorLayout parent, TextView child, View dependency) {
        return dependency instanceof CustomBar;
    }

    override
    public bool onDependentViewChanged(CoordinatorLayout parent, TextView child,
            View dependency) {
