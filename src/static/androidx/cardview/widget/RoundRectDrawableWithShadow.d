 ...
 */
class RoundRectDrawableWithShadow : Drawable {
    ...
    * */
    ...
    private bool mAddPaddingForCorners = true;

    /**
     * If shadow size is set to a value above max shadow, we print a warning
     */
    private bool mPrintedShadowClipWarning = false;
    ...
    private void drawShadow(Canvas canvas) {
        ...
        final bool drawHorizontalEdges = mCardBounds.width() - 2 * inset > 0;
        final bool drawVerticalEdges = mCardBounds.height() - 2 * inset > 0;
        // LT
