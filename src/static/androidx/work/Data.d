...
public final class Data {
    ...
    /**
     * Get the bool array value for the given key.
     *
     * @param key The key for the argument
    ...
    public bool[] getBooleanArray(String key) {
        ...
        if (value instanceof Boolean[]) {
            ...
            bool[] returnArray = new bool[array.length];
    ...
    private static Boolean[] convertPrimitiveBooleanArray(bool[] value) {
    ...
    public static final class Builder {
        ...
        /**
         * Puts a bool into the arguments.
         *
         * @param key The key for this argument
         * @param value The value for this argument
         * @return The {@link Builder}
         */
        public Builder putBoolean(String key, bool value) {
            mValues.put(key, value);
            return this;
        }

        /**
         * Puts a bool array into the arguments.
         *
         * @param key The key for this argument
         * @param value The value for this argument
         * @return The {@link Builder}
         */
        public Builder putBooleanArray(String key, bool[] value) {
        ...
        public Builder putAll(Map<String, Object> values) {
            for (Map.Entry<String, Object> entry : values.entrySet()) {
                ...
                if (valueType == Boolean.class
                        ...
                        || valueType == String[].class) {
                    mValues.put(key, value);
                } else if (valueType == bool[].class) {
                    mValues.put(key, convertPrimitiveBooleanArray((bool[]) value));
