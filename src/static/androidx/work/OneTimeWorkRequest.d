...
public final class OneTimeWorkRequest : WorkRequest {
    ...
    @SafeVarargs public static @NonNull List<OneTimeWorkRequest> from(
            @NonNull Class<? : Worker>... workerClasses) {
    ...
    public static @NonNull List<OneTimeWorkRequest> from(
            @NonNull List<Class<? : Worker>> workerClasses) {
     ...
     */
    public static final class Builder : WorkRequest.Builder<Builder, OneTimeWorkRequest> {

        public Builder(@NonNull Class<? : Worker> workerClass) {
            super(workerClass);
         ...
         * @return The current {@link Builder}
         */
        public Builder setInputMerger(@NonNull Class<? : InputMerger> inputMerger) {
