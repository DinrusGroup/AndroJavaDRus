...
public class CommandHandler : ExecutionListener {
    ...
    private void handleExecutionCompleted(
        ...
        Bundle extras = intent.getExtras();
        String workSpecId = extras.getString(KEY_WORKSPEC_ID);
        bool isSuccessful = extras.getBoolean(KEY_IS_SUCCESSFUL);
        bool needsReschedule = extras.getBoolean(KEY_NEEDS_RESCHEDULE);
    ...
    private static bool hasKeys(@Nullable Bundle bundle, @NonNull String... keys) {
