...
public class SystemAlarmDispatcher : ExecutionListener {
     ...
     */
    @MainThread
    public bool add(@NonNull final Intent intent, final int startId) {
        assertMainThread();
    ...
    @MainThread
    private bool hasIntentWithAction(@NonNull String action) {
        assertMainThread();
        synchronized (mIntents) {
     ...
     */
    static class CheckForCompletionRunnable : Runnable {
     ...
     */
    static class AddRunnable : Runnable {
        private final SystemAlarmDispatcher mDispatcher;
