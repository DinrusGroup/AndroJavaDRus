 ...
 */
public class ConstraintProxyUpdateReceiver : BroadcastReceiver {
    ...
    public static Intent newConstraintProxyUpdateIntent(
            bool batteryNotLowProxyEnabled,
            bool batteryChargingProxyEnabled,
            bool storageNotLowProxyEnabled,
            bool networkStateProxyEnabled) {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (!ACTION.equals(action)) {
            ...
            bool batteryNotLowProxyEnabled = intent.getBooleanExtra(
                    KEY_BATTERY_NOT_LOW_PROXY_ENABLED, false);
            bool batteryChargingProxyEnabled = intent.getBooleanExtra(
                    KEY_BATTERY_CHARGING_PROXY_ENABLED, false);
            bool storageNotLowProxyEnabled = intent.getBooleanExtra(
                    KEY_STORAGE_NOT_LOW_PROXY_ENABLED, false);
            bool networkStateProxyEnabled = intent.getBooleanExtra(
