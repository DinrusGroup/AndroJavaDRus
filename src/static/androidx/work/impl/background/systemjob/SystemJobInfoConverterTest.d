...
public class SystemJobInfoConverterTest : WorkManagerTest {
     ...
     * sets some dummy constraint to toggle some internal bool flags in {@link JobInfo.Builder}
    ...
    public void testConvert_requireCharging() {
        final bool expectedRequireCharging = true;
    ...
    public void testConvert_requireDeviceIdle() {
        final bool expectedRequireDeviceIdle = true;
        WorkSpec workSpec = getTestWorkSpecWithConstraints(new Constraints.Builder()
    ...
    public void testConvert_requireBatteryNotLow() {
        final bool expectedRequireBatteryNotLow = true;
        WorkSpec workSpec = getTestWorkSpecWithConstraints(new Constraints.Builder()
    ...
    public void testConvert_requireStorageNotLow() {
        final bool expectedRequireStorageNotLow = true;
        WorkSpec workSpec = getTestWorkSpecWithConstraints(new Constraints.Builder()
