...
public class Processor : ExecutionListener {
     ...
     */
    public synchronized bool startWork(String id) {
     ...
     * @return {@code true} if the work was successfully enqueued for processing
     */
    public synchronized bool startWork(String id, Extras.RuntimeExtras runtimeExtras) {
     ...
     */
    public synchronized bool stopWork(String id) {
     ...
     * @return {@code true} if the work was stopped successfully
     */
    public synchronized bool stopAndCancelWork(String id) {
     ...
     */
    public synchronized bool isCancelled(String id) {
     ...
     */
    public synchronized bool hasWork() {
     ...
     */
    public synchronized bool isEnqueued(@NonNull String workSpecId) {
