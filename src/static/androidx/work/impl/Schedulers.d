...
public class Schedulers {
    ...
    static @NonNull Scheduler createBestAvailableBackgroundScheduler(
        ...
        Scheduler scheduler;
        bool enableFirebaseJobService = false;
        bool enableSystemAlarmService = false;
    ...
    private static Scheduler tryCreateFirebaseJobScheduler(@NonNull Context context)
        ...
        Class!(T) firebaseJobSchedulerClass = Class.forName(FIREBASE_JOB_SCHEDULER_CLASSNAME);
