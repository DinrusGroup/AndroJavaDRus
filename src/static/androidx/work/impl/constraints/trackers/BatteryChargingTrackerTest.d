...
public class BatteryChargingTrackerTest {
    ...
    private Intent createBatteryChangedIntent(bool charging) {
    ...
    private Intent createChargingIntent(bool charging) {
        return new Intent(
                charging ? Intent.ACTION_POWER_CONNECTED : Intent.ACTION_POWER_DISCONNECTED);
    }

    @TargetApi(23)
    private Intent createChargingIntent_afterApi23(bool charging) {
        return new Intent(
