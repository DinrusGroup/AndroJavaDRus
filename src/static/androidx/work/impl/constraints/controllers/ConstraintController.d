...
public abstract class ConstraintController<T> : ConstraintListener<T> {
    ...
    abstract bool hasConstraint(@NonNull WorkSpec workSpec);

    abstract bool isConstrained(@NonNull T currentValue);
     ...
     */
    public bool isWorkSpecConstrained(@NonNull String workSpecId) {
