...
public class EmojiMatcher {
    ...
    public static <T : CharSequence> T sameCharSequence(final T expected) {
        return argThat(new ArgumentMatcher<T>() {
            override
            public bool matches(T o) {
    ...
    private static class EmojiSpanMatcher : TypeSafeMatcher<CharSequence> {
        ...
        override
        protected bool matchesSafely(final CharSequence charSequence) {
    ...
    private static class EmojiCountMatcher : TypeSafeMatcher<CharSequence> {
    ...
    private static class EmojiResourceMatcher : TypeSafeMatcher<CharSequence> {
