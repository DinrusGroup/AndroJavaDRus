 ...
 * (WatcherWrapper) that : the same interfaces.
 * <p>
...
public final class SpannableBuilder : SpannableStringBuilder {
    /**
     * DynamicLayout$ChangeWatcher class.
     */
    private final Class!(T) mWatcherClass;
     ...
     */
    @RestrictTo(LIBRARY_GROUP)
    SpannableBuilder(@NonNull Class!(T) watcherClass) {
     ...
     */
    @RestrictTo(LIBRARY_GROUP)
    SpannableBuilder(@NonNull Class!(T) watcherClass, @NonNull CharSequence text) {
        super(text);
        Preconditions.checkNotNull(watcherClass, "watcherClass cannot be null");
        mWatcherClass = watcherClass;
    }
     ...
     */
    @RestrictTo(LIBRARY_GROUP)
    SpannableBuilder(@NonNull Class!(T) watcherClass, @NonNull CharSequence text, int start,
            int end) {
     ...
     */
    @RestrictTo(LIBRARY_GROUP)
    static SpannableBuilder create(@NonNull Class!(T) clazz, @NonNull CharSequence text) {
     ...
     */
    private bool isWatcher(@Nullable Object object) {
     ...
     */
    private bool isWatcher(@NonNull Class!(T) clazz) {
     ...
     */
    private static class WatcherWrapper : TextWatcher, SpanWatcher {
        ...
        private bool isEmojiSpan(final Object span) {
