...
@RequiresApi(19)
final class EmojiInputConnection : InputConnectionWrapper {
    ...
    override
    public bool deleteSurroundingText(final int beforeLength, final int afterLength) {
        final bool result = EmojiCompat.handleDeleteSurroundingText(this, getEditable(),
                beforeLength, afterLength, false /*inCodePoints*/);
        return result || super.deleteSurroundingText(beforeLength, afterLength);
    }

    override
    public bool deleteSurroundingTextInCodePoints(final int beforeLength,
