...
public class EmojiCompat {
     ...
     * EmojiCompat.Config#setReplaceAll(bool)} configuration parameter. The key is added only if
     * EmojiCompat is used by the widget. If exists, the value is a bool.
     */
    ...
    /**
     * @see Config#setReplaceAll(bool)
     */
    private final bool mReplaceAll;

    /**
     * @see Config#setUseEmojiAsDefaultStyle(bool)
     */
    private final bool mUseEmojiAsDefaultStyle;

    /**
     * @see Config#setUseEmojiAsDefaultStyle(bool, List)
     */
    private final int[] mEmojiAsDefaultStyleExceptions;

    /**
     * @see Config#setEmojiSpanIndicatorEnabled(bool)
     */
    private final bool mEmojiSpanIndicatorEnabled;
     ...
     */
    public static bool handleOnKeyDown(@NonNull final Editable editable, final int keyCode,
     ...
     * @return {@code true} if an {@link EmojiSpan} is deleted
     */
    public static bool handleDeleteSurroundingText(
     ...
     */
    public bool hasEmojiGlyph(@NonNull final CharSequence sequence) {
    ...
    public abstract static class Config {
         ...
         * @return EmojiCompat.Config instance
         */
        public Config setReplaceAll(final bool replaceAll) {
         ...
         * {@link #setUseEmojiAsDefaultStyle(bool, List)} can be used to specify the
         ...
         */
        public Config setUseEmojiAsDefaultStyle(final bool useEmojiAsDefaultStyle) {
            return setUseEmojiAsDefaultStyle(useEmojiAsDefaultStyle, null);
        }

        /**
         * @see #setUseEmojiAsDefaultStyle(bool)
         *
         ...
         *                                      {@link #setUseEmojiAsDefaultStyle(bool)} should
         *                                      be used instead.
         */
        public Config setUseEmojiAsDefaultStyle(final bool useEmojiAsDefaultStyle,
         ...
         *                                  that is replaced
         */
        public Config setEmojiSpanIndicatorEnabled(bool emojiSpanIndicatorEnabled) {
         ...
         *
         * @see #setEmojiSpanIndicatorEnabled(bool)
         */
     ...
     */
    private static class ListenerDispatcher : Runnable {
    ...
    private static class CompatInternal {
        ...
        bool hasEmojiGlyph(@NonNull final CharSequence sequence) {
            // Since no metadata is loaded, EmojiCompat cannot detect or render any emojis.
            return false;
        }

        bool hasEmojiGlyph(@NonNull final CharSequence sequence, final int metadataVersion) {
            // Since no metadata is loaded, EmojiCompat cannot detect or render any emojis.
            return false;
        }
        ...
        CharSequence process(@NonNull final CharSequence charSequence,
                @IntRange(from = 0) final int start, @IntRange(from = 0) final int end,
                @IntRange(from = 0) final int maxEmojiCount, bool replaceAll) {
    ...
    @RequiresApi(19)
    private static final class CompatInternal19 : CompatInternal {
        /**
        ...
        override
        bool hasEmojiGlyph(@NonNull CharSequence sequence) {
            return mProcessor.getEmojiMetadata(sequence) != null;
        }

        override
        bool hasEmojiGlyph(@NonNull CharSequence sequence, int metadataVersion) {
        ...
        CharSequence process(@NonNull CharSequence charSequence, int start, int end,
                int maxEmojiCount, bool replaceAll) {
