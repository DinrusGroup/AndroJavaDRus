...
public class TestConfigBuilder {
    ...
    public static class TestConfig : EmojiCompat.Config {
        TestConfig() {
    ...
    public static class WaitingDataLoader : EmojiCompat.MetadataRepoLoader {
        private final CountDownLatch mLoaderLatch;
        private final CountDownLatch mTestLatch;
        private final bool mSuccess;

        public WaitingDataLoader(bool success) {
    ...
    public static class TestEmojiDataLoader : EmojiCompat.MetadataRepoLoader {
