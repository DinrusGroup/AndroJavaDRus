...
public final class MultiDex {
    ...
    private static final bool IS_VM_MULTIDEX_CAPABLE =
    ...
    private static void doInstallation(Context mainContext, File sourceApk, File dataDir,
            ...
            bool reinstallOnPatchRecoverableException) throws IOException,
    ...
    static bool isVMMultidexCapable(String versionString) {
        bool isMultidexCapable = false;
    ...
    private static Field findField(Object instance, String name) throws NoSuchFieldException {
        for (Class!(T) clazz = instance.getClass(); clazz != null; clazz = clazz.getSuperclass()) {
            try {
     ...
     */
    private static Method findMethod(Object instance, String name, Class!(T)... parameterTypes)
    ...
    private static final class V14 {
         ...
         */
        private static class ICSElementConstructor : ElementConstructor {
            private final Constructor!(T) elementConstructor;

            ICSElementConstructor(Class!(T) elementClass)
         ...
         */
        private static class JBMR11ElementConstructor : ElementConstructor {
            private final Constructor!(T) elementConstructor;

            JBMR11ElementConstructor(Class!(T) elementClass)
                    throws SecurityException, NoSuchMethodException {
         ...
         */
        private static class JBMR2ElementConstructor : ElementConstructor {
            private final Constructor!(T) elementConstructor;

            JBMR2ElementConstructor(Class!(T) elementClass)
                    throws SecurityException, NoSuchMethodException {
                elementConstructor = elementClass
        ...
        private  V14() throws ClassNotFoundException, SecurityException, NoSuchMethodException {
            ...
            Class!(T) elementClass = Class.forName("dalvik.system.DexPathList$Element");
            try {
         ...
         * them through.
         */
        private Object[] makeDexElements(List<? : File> files)
                throws IOException, SecurityException, IllegalArgumentException,
