...
public class NavOptions {
    ...
    private bool mPopUpToInclusive;
    @AnimRes @AnimatorRes
    ...
    NavOptions(int launchMode, @IdRes int popUpTo, bool popUpToInclusive,
     ...
     */
    @Deprecated
    public bool shouldLaunchDocument() {
     ...
     * @see #getPopUpTo
     */
    public bool isPopUpToInclusive() {
    ...
    public static class Builder {
         ...
         */
        @NonNull
        public Builder setLaunchSingleTop(bool singleTop) {
            if (singleTop) {
        ...
        @Deprecated
        @NonNull
        public Builder setLaunchDocument(bool launchDocument) {
            if (launchDocument) {
         ...
         * {@link #setLaunchDocument(bool) document}, this will clear the document task.
         * Otherwise it will clear the current task.
         *
         * @param clearTask
         * @return
         * @deprecated Use {@link #setPopUpTo(int, bool)} with the
        ...
        @Deprecated
        @NonNull
        public Builder setClearTask(bool clearTask) {
            if (clearTask) {
         ...
         */
        @NonNull
        public Builder setPopUpTo(@IdRes int destinationId, bool inclusive) {
