...
public class NavController {
    ...
    private final SimpleNavigatorProvider mNavigatorProvider = new SimpleNavigatorProvider() {
        ...
        public Navigator<? : NavDestination> addNavigator(@NonNull String name,
            ...
            Navigator<? : NavDestination> previousNavigator =
     ...
     */
    public bool popBackStack(@IdRes int destinationId, bool inclusive) {
        if (mBackStack.isEmpty()) {
            throw new IllegalArgumentException("NavController back stack is empty");
        }
     ...
     */
    public bool onHandleDeepLink(@Nullable Intent intent) {
        if (intent == null) {
            return false;
        }
    ...
    public Bundle saveState() {
        ...
        for (Map.Entry<String, Navigator<? : NavDestination>> entry :
