 ...
 */
@Navigator.Name("test")
public class TestNavigator : Navigator<TestNavigator.Destination> {
    ...
    public bool popBackStack() {
        bool popped = mBackStack.pollLast() != null;
        if (popped) {
    ...
    public static class Destination : NavDestination {
         ...
         */
        Destination(@NonNull Navigator<? : NavDestination> navigator) {
            super(navigator);
        }
    }
}
