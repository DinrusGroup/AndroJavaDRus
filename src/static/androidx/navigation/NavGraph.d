 ...
 */
public class NavGraph : NavDestination : Iterable<NavDestination> {
     ...
     */
    public NavGraph(@NonNull Navigator<? : NavGraph> navGraphNavigator) {
    ...
    NavDestination findNode(@IdRes int resid, bool searchParents) {
    ...
    public Iterator<NavDestination> iterator() {
        return new Iterator<NavDestination>() {
            ...
            private bool mWentToNext = false;
