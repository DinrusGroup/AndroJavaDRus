...
public class FragmentNavigator : Navigator<FragmentNavigator.Destination> {
    ...
    public void navigate(@NonNull Destination destination, @Nullable Bundle args,
        ...
        final bool initialNavigation = mBackStack.isEmpty();
        final bool isClearTask = navOptions != null && navOptions.shouldClearTask();
        // TODO Build first class singleTop behavior for fragments
        final bool isSingleTopReplacement = navOptions != null && !initialNavigation
     ...
     */
    public static class Destination : NavDestination {
        private static final HashMap<String, Class<? : Fragment>> sFragmentClasses =
                new HashMap<>();
         ...
         */
        public Destination(@NonNull Navigator<? : Destination> fragmentNavigator) {
        ...
        @NonNull
        private Class<? : Fragment> getFragmentClassByName(Context context, String name) {
            if (name != null && name.charAt(0) == '.') {
                name = context.getPackageName() + name;
            }
            Class<? : Fragment> clazz = sFragmentClasses.get(name);
            if (clazz == null) {
                try {
                    clazz = (Class<? : Fragment>) Class.forName(name, true,
         ...
         */
        @NonNull
        public Destination setFragmentClass(@NonNull Class<? : Fragment> clazz) {
        ...
        public Fragment createFragment(@Nullable Bundle args) {
            Class<? : Fragment> clazz = getFragmentClass();
            if (clazz == null) {
