...
public class NavigationUI {
     ...
     */
    public static bool onNavDestinationSelected(@NonNull MenuItem item,
            @NonNull NavController navController) {
        return onNavDestinationSelected(item, navController, false);
    }

    private static bool onNavDestinationSelected(@NonNull MenuItem item,
            @NonNull NavController navController, bool popUp) {
     ...
     */
    public static bool navigateUp(@Nullable DrawerLayout drawerLayout,
            @NonNull NavController navController) {
    ...
    public static void setupWithNavController(@NonNull final NavigationView navigationView,
        ...
        navigationView.setNavigationItemSelectedListener(
                new NavigationView.OnNavigationItemSelectedListener() {
                    override
                    public bool onNavigationItemSelected(@NonNull MenuItem item) {
                        bool handled = onNavDestinationSelected(item, navController, true);
                        if (handled) {
 ...
 *                      selected item in the BottomNavigationView.
     ...
     */
    private static bool matchDestination(@NonNull NavDestination destination,
            @IdRes int destId) {
     ...
     */
    private static class ActionBarOnNavigatedListener : NavController.OnNavigatedListener {
        ...
        public void onNavigated(@NonNull NavController controller,
            ...
            bool isStartDestination = findStartDestination(controller.getGraph()) == destination;
        ...
        void setActionBarUpIndicator(bool showAsDrawerIndicator) {
