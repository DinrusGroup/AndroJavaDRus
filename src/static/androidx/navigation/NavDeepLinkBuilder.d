...
public class NavDeepLinkBuilder {
     ...
     */
    @NonNull
    public NavDeepLinkBuilder setComponentName(@NonNull Class<? : Activity> activityClass) {
    ...
    private static class PermissiveNavigatorProvider : SimpleNavigatorProvider {
        /**
        ...
        @NonNull
        override
        public Navigator<? : NavDestination> getNavigator(@NonNull String name) {
            try {
