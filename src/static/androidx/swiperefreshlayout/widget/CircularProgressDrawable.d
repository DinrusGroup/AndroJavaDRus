 ...
 * at the end of the arc by {@link #setArrowEnabled(bool)} and {@link #setArrowDimensions(float,
 * float)} methods.
 *
 ...
 */
public class CircularProgressDrawable : Drawable : Animatable {
     ...
     */
    public void setArrowEnabled(bool show) {
     ...
     */
    private void applyTransformation(float interpolatedTime, Ring ring, bool lastFrame) {
        if (mFinishing) {
