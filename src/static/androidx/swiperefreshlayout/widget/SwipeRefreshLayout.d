 ...
 * </p>
 */
public class SwipeRefreshLayout : ViewGroup : NestedScrollingParent,
    ...
    private void setRefreshing(bool refreshing, final bool notify) {
    ...
    override
    public bool onNestedPreFling(View target, float velocityX,
            float velocityY) {
    ...
    public interface OnChildScrollUpCallback {
         ...
         */
        bool canChildScrollUp(@NonNull SwipeRefreshLayout parent, @Nullable View child);
    }
}
