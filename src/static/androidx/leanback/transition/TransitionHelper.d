...
public final class TransitionHelper {
     ...
     */
    public static bool systemSupportsEntranceTransitions() {
    ...
    public static Object createChangeBounds(bool reparent) {
        if (Build.VERSION.SDK_INT >= 19) {
    ...
    public static Object createTransitionSet(bool sequential) {
        if (Build.VERSION.SDK_INT >= 19) {
    ...
    public static void exclude(Object transition, int targetId, bool exclude) {
        if (Build.VERSION.SDK_INT >= 19) {
            ((Transition) transition).excludeTarget(targetId, exclude);
        }
    }

    public static void exclude(Object transition, View targetView, bool exclude) {
        if (Build.VERSION.SDK_INT >= 19) {
            ((Transition) transition).excludeTarget(targetView, exclude);
        }
    }

    public static void excludeChildren(Object transition, int targetId, bool exclude) {
        if (Build.VERSION.SDK_INT >= 19) {
            ((Transition) transition).excludeChildren(targetId, exclude);
        }
    }

    public static void excludeChildren(Object transition, View targetView, bool exclude) {
        if (Build.VERSION.SDK_INT >= 19) {
    ...
    public static void setTransitionGroup(ViewGroup viewGroup, bool transitionGroup) {
        if (Build.VERSION.SDK_INT >= 21) {
