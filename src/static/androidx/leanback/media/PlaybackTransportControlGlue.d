 ...
 * Sample Code:
 * <pre><code>
 * public class MyVideoFragment : VideoFragment {
 *     &#64;Override
 ...
 */
public class PlaybackTransportControlGlue<T : PlayerAdapter>
        : PlaybackBaseControlGlue<T> {
    ...
    class SeekUiClient : PlaybackSeekUi.Client {
        bool mPausedBeforeSeek;
     ...
     */
    public final void setSeekEnabled(bool seekEnabled) {
     ...
     */
    public final bool isSeekEnabled() {
        return mSeekEnabled;
    }
}
