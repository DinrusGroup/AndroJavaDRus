...
/**
 * This glue : the {@link androidx.leanback.media.PlaybackControlGlue} with a
...
@Deprecated
public class MediaPlayerGlue : PlaybackControlGlue :
    ...
    private bool mInitialized = false; // true when the MediaPlayer is prepared/initialized
    ...
    override
    public void enableProgressUpdating(final bool enabled) {
    ...
    public bool onKey(View v, int keyCode, KeyEvent event) {
        ...
        bool consume = mSelectedAction instanceof PlaybackControlsRow.RewindAction;
     ...
     */
    public bool setMediaSource(Uri uri) {
     ...
     * @see MediaPlayer#setDataSource(String)
     */
    public bool setMediaSource(String path) {
