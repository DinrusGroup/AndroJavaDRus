 ...
 */
public abstract class PlaybackBaseControlGlue<T : PlayerAdapter> : PlaybackGlue
    ...
    final PlayerAdapter.Callback mAdapterCallback = new PlayerAdapter
        ...
        override
        public void onBufferingStateChanged(PlayerAdapter wrapper, bool start) {
            mBuffering = start;
            if (mPlayerCallback != null) {
     ...
     * @see PlaybackGlueHost#setControlsOverlayAutoHideEnabled(bool)
     */
    public void setControlsOverlayAutoHideEnabled(bool enable) {
     ...
     */
    override
    public abstract bool onKey(View v, int keyCode, KeyEvent event);
