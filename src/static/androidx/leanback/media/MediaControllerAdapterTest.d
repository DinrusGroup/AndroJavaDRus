...
public class MediaControllerAdapterTest {
    ...
    public void testIsPlayingWithNullPlaybackState() {
        bool defualtIsPlayingStatus = false;
    ...
    private class PlayerAdapterCallback : PlayerAdapter.Callback {
        private bool mOnPlayStateChangedCalled;
        private bool mOnPreparedStateChangedCalled;
        private bool mOnPlayCompletedCalled;
        private bool mOnCurrentPositionChangedCalled;
        private bool mOnBufferedPositionChangedCalled;
        private bool mOnDurationChnagedCalled;
        private bool mOnVideoSizeChangedCalled;
        private bool mOnErrorCalled;
        private bool mOnBufferingStateChangedCalled;
        private bool mOnMetadataChangedCalled;
        ...
        override
        public void onBufferingStateChanged(PlayerAdapter adapter, bool start) {
            synchronized (mWaitLock) {
