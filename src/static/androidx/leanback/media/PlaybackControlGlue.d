 ...
 * and {@link PlaybackGlueHost} that : a
 ...
 * </p>
 *
 * <p>This helper : a key event handler. If you pass a
 ...
 *
 */
public abstract class PlaybackControlGlue : PlaybackGlue
        : OnActionClickedListener, View.OnKeyListener {
    /**
    ...
    private bool mFadeWhenPlaying = true;

    static class UpdatePlaybackStateHandler : Handler {
        override
     ...
     */
    public void setFadingEnabled(bool enable) {
    ...
    public bool onKey(View v, int keyCode, KeyEvent event) {
        switch (keyCode) {
            ...
            case KeyEvent.KEYCODE_ESCAPE:
                bool abortSeek = mPlaybackSpeed >= PLAYBACK_SPEED_FAST_L0
     ...
     */
    bool dispatchAction(Action action, KeyEvent keyEvent) {
        bool handled = false;
        if (action == mPlayPauseAction) {
            bool canPlay = keyEvent == null
                    || keyEvent.getKeyCode() == KeyEvent.KEYCODE_MEDIA_PLAY_PAUSE
                    || keyEvent.getKeyCode() == KeyEvent.KEYCODE_MEDIA_PLAY;
            bool canPause = keyEvent == null
                    || keyEvent.getKeyCode() == KeyEvent.KEYCODE_MEDIA_PLAY_PAUSE
     ...
     */
    public abstract bool hasValidMedia();

    /**
     * Returns true if media is currently playing.
     */
    public abstract bool isMediaPlaying();
