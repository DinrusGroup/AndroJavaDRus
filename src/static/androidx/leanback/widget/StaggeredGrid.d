 ...
 */
abstract class StaggeredGrid : Grid {

    /**
     * Cached representation of Staggered item.
     */
    public static class Location : Grid.Location {
        /**
    ...
    override
    protected final bool prependVisibleItems(int toLimit, bool oneColumnMode) {
     ...
     */
    protected final bool prependVisbleItemsWithCache(int toLimit, bool oneColumnMode) {
    ...
    private int calculateOffsetAfterLastItem(int row) {
        ...
        bool foundCachedItemInSameRow = false;
    ...
    /**
     * This : the algorithm of layout staggered grid, the method should only be called by
     * prependVisibleItems().
     */
    protected abstract bool prependVisibleItemsWithoutCache(int toLimit, bool oneColumnMode);
    ...
    override
    protected final bool appendVisibleItems(int toLimit, bool oneColumnMode) {
        if (mProvider.getCount() == 0) {
            return false;
        }
     ...
     */
    protected final bool appendVisbleItemsWithCache(int toLimit, bool oneColumnMode) {
        if (mLocations.size() == 0) {
            return false;
        }
     ...
     * appendVisibleItems().
     */
    protected abstract bool appendVisibleItemsWithoutCache(int toLimit, bool oneColumnMode);
