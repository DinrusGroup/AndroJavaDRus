 ...
 * toggled edit mode by {@link View#setActivated(bool)}.
 ...
 * @see GuidedAction
 */
public class GuidedActionsStylist : FragmentAnimationProvider {
     ...
     * @see GuidedAction
     */
    public static class ViewHolder : RecyclerView.ViewHolder : FacetProvider {
        ...
        private final bool mIsSubAction;
         ...
         */
        public ViewHolder(View v, bool isSubAction) {
            super(v);
         ...
         */
        public bool isInEditingDescription() {
         ...
         * otherwise.
         */
        public bool isInEditingActivatorView() {
        ...
        override
        public Object getFacet(Class!(T) facetClass) {
    ...
    private bool mBackToCollapseSubActions = true;
    private bool mBackToCollapseActivatorView = true;
     ...
     */
    @Deprecated
    public void setEditingMode(ViewHolder vh, GuidedAction action, bool editing) {
        if (editing != vh.isInEditing() && isInExpandTransition()) {
            onEditingModeChange(vh, action, editing);
        }
    }

    void setEditingMode(ViewHolder vh, bool editing) {
        setEditingMode(vh, editing, true /*withTransition*/);
    }

    void setEditingMode(ViewHolder vh, bool editing, bool withTransition) {
        if (editing != vh.isInEditing() && !isInExpandTransition()) {
    ...
    /**
     * @deprecated Use {@link #onEditingModeChange(ViewHolder, bool, bool)}.
     */
    @Deprecated
    protected void onEditingModeChange(ViewHolder vh, GuidedAction action, bool editing) {
    }
     ...
     */
    @CallSuper
    protected void onEditingModeChange(ViewHolder vh, bool editing, bool withTransition) {
     ...
     */
    public void onAnimateItemFocused(ViewHolder vh, bool focused) {
     ...
     */
    public void onAnimateItemPressed(ViewHolder vh, bool pressed) {
        vh.press(pressed);
    }
     ...
     */
    public void onAnimateItemChecked(ViewHolder vh, bool checked) {
     ...
     * @see #onAnimateItemChecked(ViewHolder, bool)
     */
     ...
     */
    public bool onUpdateActivatorView(ViewHolder vh, GuidedAction action) {
        if (action instanceof GuidedDatePickerAction) {
            GuidedDatePickerAction dateAction = (GuidedDatePickerAction) action;
            DatePicker dateView = (DatePicker) vh.mActivatorView;
    ...
    void onEditActivatorView(final ViewHolder vh, bool editing, final bool withTransition) {
        if (editing) {
    ...
    public void onBindChevronView(ViewHolder vh, GuidedAction action) {
        final bool hasNext = action.hasNext();
        final bool hasSubActions = action.hasSubActions();
     ...
     * @deprecated use {@link #expandAction(GuidedAction, bool)} and
     * {@link #collapseAction(bool)}
     */
    @Deprecated
     ...
     */
    public bool isInExpandTransition() {
     ...
     * @return True if it is running an expanding or collapsing transition, false otherwise.
     */
    public bool isExpandTransitionSupported() {
     ...
     */
    public final void setBackKeyToCollapseSubActions(bool backToCollapse) {
     ...
     * @see GuidedAction#getSubActions
     */
    public final bool isBackKeyToCollapseSubActions() {
     ...
     */
    public final void setBackKeyToCollapseActivatorView(bool backToCollapse) {
     ...
     * @see GuidedAction#hasEditableActivatorView
     */
    public final bool isBackKeyToCollapseActivatorView() {
     ...
     */
    public void expandAction(GuidedAction action, final bool withTransition) {
        ...
        bool runTransition = isExpandTransitionSupported() && withTransition;
        if (!runTransition) {
     ...
     * @param withTransition True to run transition animation, false otherwsie.
     */
    public void collapseAction(bool withTransition) {
        if (isInExpandTransition() || mExpandedAction == null) {
            return;
        }
        bool runTransition = isExpandTransitionSupported() && withTransition;
     ...
     * expanded.
     */
    void startExpanded(ViewHolder avh, final bool withTransition) {
        ...
        bool isExpand = avh != null;
        bool isSubActionTransition = focusAvh.getAction().hasSubActions();
        if (withTransition) {
     ...
     */
    public bool isSubActionsExpanded() {
    ...
    void onUpdateSubActionsGridView(GuidedAction action, bool expand) {
    ...
    private bool setIcon(final ImageView iconView, GuidedAction action) {
        Drawable icon = null;
        if (iconView != null) {
            icon = action.getIcon();
            if (icon != null) {
