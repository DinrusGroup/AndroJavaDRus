...
public abstract class ParallaxEffect {
     ...
     */
    public final <T, V : Number> ParallaxEffect target(T targetObject,
    ...
    final float getFractionWithWeightAdjusted(float fraction, int markerValueIndex) {
        ...
        if (mMarkerValues.size() >= 3) {
            final bool hasWeightsDefined = mWeights.size() == mMarkerValues.size() - 1;
     ...
     */
    static final class IntEffect : ParallaxEffect {
     ...
     */
    static final class FloatEffect : ParallaxEffect {
