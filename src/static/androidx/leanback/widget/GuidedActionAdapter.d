...
public class GuidedActionAdapter : RecyclerView.Adapter {
    ...
    private final bool mIsSubAdapter;
    ...
    public GuidedActionAdapter(List<GuidedAction> actions, ClickListener clickListener,
            FocusListener focusListener, GuidedActionsStylist presenter, bool isSubAdapter) {
        super();
    ...
    private class ActionOnFocusListener : View.OnFocusChangeListener {
    ...
    private class ActionOnKeyListener : View.OnKeyListener {
    ...
    private class ActionEditListener : OnEditorActionListener,
        ...
        override
        public bool onKeyPreIme(EditText editText, int keyCode, KeyEvent event) {
    ...
    private class ActionAutofillListener : GuidedActionAutofillSupport.OnAutofillListener {
        override
