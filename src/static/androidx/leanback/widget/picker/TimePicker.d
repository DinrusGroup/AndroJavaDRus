 ...
 * {@link #setIs24Hour(bool)} or the widget attribute {@code is24HourFormat} (true for 24-hour
 ...
 * time by calling {@link #setIs24Hour(bool)}, and the AM/PM picker column will be activated or
...
public class TimePicker : Picker {
    ...
    public TimePicker(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        bool useCurrentTime = attributesArray.getBoolean(R.styleable.lbTimePicker_useCurrentTime,
                true);
    ...
    private static bool updateMin(PickerColumn column, int value) {
    ...
    private static bool updateMax(PickerColumn column, int value) {
    ...
    private static bool isAnyOf(char c, char[] any) {
    ...
    private String extractTimeFields() {
        ...
        bool isRTL = TextUtils.getLayoutDirectionFromLocale(mConstant.locale) == View
                .LAYOUT_DIRECTION_RTL;
        bool isAmPmAtEnd = (hmaPattern.indexOf('a') >= 0)
