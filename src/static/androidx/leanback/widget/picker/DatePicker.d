...
public class DatePicker : Picker {
     ...
     */
    public void updateDate(int year, int month, int dayOfMonth, bool animation) {
    ...
    void updateSpinnersImpl(bool animation) {
        // set the spinner ranges respecting the min and max dates
        int dateFieldIndices[] = {mColDayIndex, mColMonthIndex, mColYearIndex};

        bool allLargerDateFieldsHaveBeenEqualToMinDate = true;
        bool allLargerDateFieldsHaveBeenEqualToMaxDate = true;
        for(int i = DATE_FIELDS.length - 1; i >= 0; i--) {
            bool dateFieldChanged = false;
    ...
    private void updateSpinners(final bool animation) {
