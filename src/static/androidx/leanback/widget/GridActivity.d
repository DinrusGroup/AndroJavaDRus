...
public class GridActivity : Activity {
    ...
    /**
     * Class that : GridWidgetTest.ViewTypeProvider for creating different
     * view types for each position.
     */
    public static final String EXTRA_VIEWTYPEPROVIDER_CLASS = "viewtype_class";
    /**
     * Class that : GridWidgetTest.ItemAlignmentFacetProvider for creating different
    ...
    static final bool DEFAULT_STAGGERED = true;
    static final bool DEFAULT_REQUEST_LAYOUT_ONFOCUS = false;
    static final bool DEFAULT_REQUEST_FOCUS_ONLAYOUT = false;
    ...
    int mChildLayout;
    bool mStaggered;
    bool mRequestLayoutOnFocus;
    bool mRequestFocusOnLayout;
    bool mSecondarySizeZero;
    ...
    bool mUpdateSize = true;
    bool mUpdateSizeSecondary = false;
    bool mHasStableIds;

    int[] mGridViewLayoutSize;
    BaseGridView mGridView;
    int[] mItemLengths;
    bool[] mItemFocusables;
    int[] mLayoutMargins;
    ...
    void moveItem(int index1, int index2, bool notify) {
        if (index1 == index2) {
            return;
        }
    ...
    int[] removeItems(int index, int length, bool notify) {
    ...
    void addItems(int index, int[] items, bool notify) {
    ...
    class MyAdapter : RecyclerView.Adapter : FacetProviderAdapter {
        ...
        public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            ...
            if (mChildLayout != -1) {
                ...
                TextView textView = new TextView(parent.getContext()) {
                    override
                    protected void onLayout(bool change, int left, int top, int right,
                            int bottom) {
    ...
    static class ViewHolder : RecyclerView.ViewHolder : FacetProvider {
