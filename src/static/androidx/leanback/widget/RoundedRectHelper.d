...
final class RoundedRectHelper {
    static bool supportsRoundedCorner() {
     ...
     */
    static void setClipToRoundedOutline(View view, bool clip, int radius) {
     ...
     * Sets or removes a rounded rectangle outline on the given view.
     */
    static void setClipToRoundedOutline(View view, bool clip) {
        if (Build.VERSION.SDK_INT >= 21) {
