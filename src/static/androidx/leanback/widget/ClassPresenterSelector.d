 ...
 * Java class.
 */
public final class ClassPresenterSelector : PresenterSelector {

    private final ArrayList<Presenter> mPresenters = new ArrayList<Presenter>();

    private final HashMap<Class!(T), Object> mClassMap = new HashMap<Class!(T), Object>();
     ...
     */
    public ClassPresenterSelector addClassPresenter(Class!(T) cls, Presenter presenter) {
     ...
     * @return This ClassPresenterSelector object.
     */
    public ClassPresenterSelector addClassPresenterSelector(Class!(T) cls,
