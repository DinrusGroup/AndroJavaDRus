 ...
 * </p>
 */
public class PlaybackControlsRow : Row {
     ...
     */
    public static abstract class MultiAction : Action {
        private int mIndex;
     ...
     */
    public static class PlayPauseAction : MultiAction {
        /**
     ...
     */
    public static class FastForwardAction : MultiAction {
        /**
         * Constructor
         * @param context Context used for loading resources.
         */
     ...
     */
    public static class RewindAction : MultiAction {
        /**
         * Constructor
         * @param context Context used for loading resources.
         */
     ...
     */
    public static class SkipNextAction : Action {
        /**
         * Constructor
         * @param context Context used for loading resources.
         */
     ...
     */
    public static class SkipPreviousAction : Action {
        /**
         * Constructor
         * @param context Context used for loading resources.
         */
     ...
     */
    public static class PictureInPictureAction : Action {
        /**
         * Constructor
         * @param context Context used for loading resources.
         */
     ...
     */
    public static class MoreActions : Action {
        /**
         * Constructor
         * @param context Context used for loading resources.
         */
     ...
     */
    public static abstract class ThumbsAction : MultiAction {
        /**
     ...
     */
    public static class ThumbsUpAction : ThumbsAction {
     ...
     */
    public static class ThumbsDownAction : ThumbsAction {
     ...
     */
    public static class RepeatAction : MultiAction {
        /**
     ...
     */
    public static class ShuffleAction : MultiAction {
        /**
     ...
     */
    public static class HighQualityAction : MultiAction {
        /**
     ...
     */
    public static class ClosedCaptioningAction : MultiAction {
        /**
