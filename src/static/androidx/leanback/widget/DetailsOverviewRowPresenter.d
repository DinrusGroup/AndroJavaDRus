 ...
 */
@Deprecated
public class DetailsOverviewRowPresenter : RowPresenter {
     ...
     */
    public final class ViewHolder : RowPresenter.ViewHolder {
        ...
        private void showMoreLeft(bool show) {
        ...
        private void showMoreRight(bool show) {
    ...
    private bool mIsStyleLarge = true;
     ...
     */
    public void setStyleLarge(bool large) {
        mIsStyleLarge = large;
    }
    ...
    override
    protected void onRowViewSelected(RowPresenter.ViewHolder vh, bool selected) {
    ...
    void bindImageDrawable(ViewHolder vh) {
        ...
        bool scaleImage = row.isImageScaleUpAllowed();
