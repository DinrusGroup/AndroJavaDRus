...
class ActionPresenterSelector : PresenterSelector {
    ...
    static class ActionViewHolder : Presenter.ViewHolder {
        Action mAction;
        Button mButton;
    ...
    abstract static class ActionPresenter : Presenter {
        override
    ...
    static class OneLineActionPresenter : ActionPresenter {
        override
    ...
    static class TwoLineActionPresenter : ActionPresenter {
        override
        public ViewHolder onCreateViewHolder(ViewGroup parent) {
            View v = LayoutInflater.from(parent.getContext())
