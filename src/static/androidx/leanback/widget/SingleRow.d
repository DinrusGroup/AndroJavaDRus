...
class SingleRow : Grid {
    ...
    override
    protected final int findRowMin(bool findLarge, int indexLimit, int[] indices) {
        if (indices != null) {
            indices[0] = 0;
    ...
    override
    protected final int findRowMax(bool findLarge, int indexLimit, int[] indices) {
        if (indices != null) {
            indices[0] = 0;
            indices[1] = indexLimit;
        }
