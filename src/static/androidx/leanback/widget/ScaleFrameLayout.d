...
public class ScaleFrameLayout : FrameLayout {
    ...
    override
    protected bool addViewInLayout (View child, int index, ViewGroup.LayoutParams params,
            bool preventRequestLayout) {
        bool ret = super.addViewInLayout(child, index, params, preventRequestLayout);
        if (ret) {
            child.setScaleX(mChildScale);
            child.setScaleY(mChildScale);
        }
