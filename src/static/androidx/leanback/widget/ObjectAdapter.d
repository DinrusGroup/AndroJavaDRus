...
public abstract class ObjectAdapter {
    ...
    private static final class DataObservable : Observable<DataObserver> {
    ...
    public final void setPresenterSelector(PresenterSelector presenterSelector) {
        ...
        final bool update = (mPresenterSelector != null);
        final bool selectorChanged = update && mPresenterSelector != presenterSelector;
     ...
     * data.
     */
    public final void setHasStableIds(bool hasStableIds) {
        bool changed = mHasStableIds != hasStableIds;
    ...
    /**
     * Called when {@link #setHasStableIds(bool)} is called and the status
     ...
     * false otherwise.
     */
    public bool isImmediateNotifySupported() {
        return false;
    }
}
