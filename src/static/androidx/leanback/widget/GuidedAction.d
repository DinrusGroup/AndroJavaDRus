 ...
 */
public class GuidedAction : Action {
     ...
     * can override this BuilderBase class, : your build() method which should call
     * {@link #applyValues(GuidedAction)}.  When using GuidedAction directly, use {@link Builder}.
     */
    public abstract static class BuilderBase<B : BuilderBase> {
         ...
         */
        public B editable(bool editable) {
            if (!editable) {
         ...
         */
        public B descriptionEditable(bool editable) {
            if (!editable) {
         ...
         */
        public B hasEditableActivatorView(bool editable) {
            if (!editable) {
         ...
         */
        public B multilineDescription(bool multilineDescription) {
         ...
         */
        public B infoOnly(bool infoOnly) {
         ...
         * @return The same BuilderBase object.
         */
        public B focusable(bool focusable) {
         ...
         */
        public B autoSaveRestoreEnabled(bool autoSaveRestoreEnabled) {
     ...
     */
    public static class Builder : BuilderBase<Builder> {
     ...
     */
    public bool hasEditableActivatorView() {
     ...
     * otherwise.
     */
    public bool hasMultilineDescription() {
     ...
     */
    public final bool isAutoSaveRestoreEnabled() {
    ...
    static bool isPasswordVariant(int inputType) {
    ...
    final bool needAutoSaveTitle() {
        return isEditable() && !isPasswordVariant(getEditInputType());
    }

    final bool needAutoSaveDescription() {
