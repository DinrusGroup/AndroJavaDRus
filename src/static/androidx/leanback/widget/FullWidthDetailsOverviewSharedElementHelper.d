 ...
 * The helper : {@link FullWidthDetailsOverviewRowPresenter.Listener} and starts delayed
...
public class FullWidthDetailsOverviewSharedElementHelper :
    ...
    static class TransitionTimeOutRunnable : Runnable {
    ...
    private bool mStartedPostpone;
    String mSharedElementName;
    private bool mAutoStartSharedElementTransition = true;
     ...
     */
    public void setAutoStartSharedElementTransition(bool enabled) {
     ...
     * windowEnterSharedElementTransition set on the activity.
     */
    public bool getAutoStartSharedElementTransition() {
