...
public class GridWidgetTest {
    ...
    private static final bool HUMAN_DELAY = false;
     ...
     */
    protected void waitForLayout(bool force) {
        if (mWaitLayoutListener == null) {
    ...
    static class DividerDecoration : RecyclerView.ItemDecoration {
    ...
    void testSetSelectedPosition(final bool inSmoothScroll, final bool layoutRequested,
            final bool viewVisible, final bool smooth,
            final bool resultLayoutRequested, final bool resultSmoothScroller,
    ...
    void testScrollInSmoothScrolling(final bool smooth, final bool scrollToInvisible,
            final bool useRecyclerViewMethod) throws Throwable {
    ...
    public void testScrollAfterRequestLayout() throws Throwable {
        ...
        final bool[] scrolled = new bool[1];
    ...
    public void testNonFocusableHorizontal() throws Throwable {
        ...
        mOrientation = BaseGridView.HORIZONTAL;
        mNumRows = numColumns;
        bool[] focusable = new bool[numItems];
    ...
    public void testFocusableViewAvailable() throws Throwable {
        ...
        final bool[] scrolled = new bool[]{false};
        mGridView.addOnScrollListener(new RecyclerView.OnScrollListener() {
            override
            public void onScrolled(RecyclerView recyclerView, int dx, int dy){
                if (dy > 0) {
    ...
    static class TwoViewTypesProvider : ViewTypeProvider {
    ...
    static class ChangeableViewTypesProvider : ViewTypeProvider {
    ...
    static class PositionItemAlignmentFacetProviderForRelativeLayout2 :
            ItemAlignmentFacetProvider {
        ItemAlignmentFacet mMultipleFacet;
    ...
    static class ViewTypePositionItemAlignmentFacetProviderForRelativeLayout2 :
            ItemAlignmentFacetProvider {
        ItemAlignmentFacet mMultipleFacet;
    ...
    private void testSelectViewTaskWithAdapterChange(final bool smooth) throws Throwable {
        Intent intent = new Intent();
        intent.putExtra(GridActivity.EXTRA_LAYOUT_RESOURCE_ID,
                R.layout.vertical_linear);
        intent.putExtra(GridActivity.EXTRA_NUM_ITEMS, 2);
    ...
    private bool hasAction(AccessibilityNodeInfoCompat info, Object action) {
        if (Build.VERSION.SDK_INT >= 21) {
    ...
    private void setUpActivityForScrollingTest(final bool isRTL, bool isHorizontal,
            int numChildViews, bool isSiblingViewVisible) throws Throwable {
        Intent intent = new Intent();
        int layout;
        if (isHorizontal) {
    ...
    private void testScrollingAction(bool isRTL, bool isHorizontal) throws Throwable {
        waitForItemAnimation();
    ...
    static class FiveViewTypesProvider : ViewTypeProvider {
    ...
    static class ItemAlignmentWithPaddingFacetProvider :
            ItemAlignmentFacetProvider {
    ...
    public void testPreferKeyLine(final int windowAlignment,
            final bool preferKeyLineOverLow,
            final bool preferKeyLineOverHigh,
    ...
    static class TestPreferKeyLineOptions {
        ...
        bool mPreferKeyLineOverLow;
        bool mPreferKeyLineOverHigh;
