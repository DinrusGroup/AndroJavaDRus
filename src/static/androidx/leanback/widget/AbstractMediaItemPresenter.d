 ...
 * {@link #setHasMediaRowSeparator(bool)} to true.
 * <p>
 ...
 * </p>
 */
public abstract class AbstractMediaItemPresenter : RowPresenter {
    ...
    private bool mMediaRowSeparator;
    ...
    public static class ViewHolder : RowPresenter.ViewHolder {
        ...
        public ViewHolder(View view) {
            ...
            bool found = view.getContext().getTheme().resolveAttribute(
     ...
     */
    public void setHasMediaRowSeparator(bool hasSeparator) {
        mMediaRowSeparator = hasSeparator;
    }

    public bool hasMediaRowSeparator() {
    ...
    static ValueAnimator updateSelector(final View selectorView,
            View focusChangedView, ValueAnimator layoutAnimator, bool isDetails) {
