...
class RoundedRectHelperApi21 {
    ...
    static final class RoundedRectOutlineProvider : ViewOutlineProvider {
    ...
    public static void setClipToRoundedOutline(View view, bool clip, int roundedCornerRadius) {
        if (clip) {
