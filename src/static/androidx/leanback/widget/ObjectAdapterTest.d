...
public class ObjectAdapterTest {
     ...
     */
    public static class DiffCallbackPayloadTesting : DiffCallback<AdapterItem> {
        // Using item's mId as the standard to judge if two items is the same
        override
        public bool areItemsTheSame(AdapterItem oldItem, AdapterItem newItem) {
            return oldItem.getId() == newItem.getId();
        }

        // Using equals method to judge if two items have the same content.
        override
        public bool areContentsTheSame(AdapterItem oldItem, AdapterItem newItem) {
     ...
     */
    public static class AdapterItemPresenter : Presenter {
        int mWidth;
        int mHeight;
    ...
    public void testSetItemsMethod0() {
        ...
        DiffCallback<String> callback = new DiffCallback<String>() {
            ...
            override
            public bool areItemsTheSame(String oldItem, String newItem) {
                return true;
            }

            // Always treat two items have the same content.
            override
            public bool areContentsTheSame(String oldItem, String newItem) {
                return true;
            }
        };
