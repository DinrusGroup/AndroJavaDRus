...
class WindowAlignment {
    ...
    public static class Axis {
        ...
        public final bool isMinUnknown() {
            return mMinEdge == Integer.MIN_VALUE;
        }

        public final bool isMaxUnknown() {
        ...
        public final void updateMinMax(int minEdge, int maxEdge,
            ...
            final bool isMinUnknown = isMinUnknown();
            final bool isMaxUnknown = isMaxUnknown();
            if (!isMinUnknown) {
