...
public class FocusHighlightHelper {
    ...
    static bool isValidZoomIndex(int zoomIndex) {
    ...
    static class FocusAnimator : TimeAnimator.TimeListener {
        ...
        void animateFocus(bool select, bool immediate) {
            endAnimation();
        ...
        FocusAnimator(View view, float scale, bool useDimmer, int duration) {
            mView = view;
            mDuration = duration;
            mScaleDiff = scale - 1f;
    ...
    static class BrowseItemFocusHighlight : FocusHighlightHandler {
        private static final int DURATION_MS = 150;

        private int mScaleIndex;
        private final bool mUseDimmer;

        BrowseItemFocusHighlight(int zoomIndex, bool useDimmer) {
        ...
        override
        public void onItemFocused(View view, bool hasFocus) {
     ...
     * not call this method, it uses {@link ListRowPresenter#ListRowPresenter(int, bool)}.
     *
     ...
     * @deprecated Use {@link #setupHeaderItemFocusHighlight(ItemBridgeAdapter, bool)}
     */
    @Deprecated
    public static void setupHeaderItemFocusHighlight(VerticalGridView gridView,
                                                     bool scaleEnabled) {
    ...
    static class HeaderItemFocusHighlight : FocusHighlightHandler {
        private bool mInitialized;
        private float mSelectScale;
        private int mDuration;
        bool mScaleEnabled;

        HeaderItemFocusHighlight(bool scaleEnabled) {
        ...
        static class HeaderFocusAnimator : FocusAnimator {
        ...
        private void viewFocused(View view, bool hasFocus) {
            lazyInit(view);
            view.setSelected(hasFocus);
            FocusAnimator animator = (FocusAnimator) view.getTag(R.id.lb_focus_animator);
            if (animator == null) {
