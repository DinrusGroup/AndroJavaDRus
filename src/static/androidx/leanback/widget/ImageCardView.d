...
public class ImageCardView : BaseCardView {
    ...
    private void buildImageCardView(AttributeSet attrs, int defStyleAttr, int defStyle) {
        ...
        bool hasImageOnly = cardType == CARD_TYPE_FLAG_IMAGE_ONLY;
        bool hasTitle = (cardType & CARD_TYPE_FLAG_TITLE) == CARD_TYPE_FLAG_TITLE;
        bool hasContent = (cardType & CARD_TYPE_FLAG_CONTENT) == CARD_TYPE_FLAG_CONTENT;
        bool hasIconRight = (cardType & CARD_TYPE_FLAG_ICON_RIGHT) == CARD_TYPE_FLAG_ICON_RIGHT;
        bool hasIconLeft =
     ...
     */
    public void setMainImageAdjustViewBounds(bool adjustViewBounds) {
        if (mImageView != null) {
     ...
     */
    public void setMainImage(Drawable drawable, bool fade) {
        if (mImageView == null) {
            return;
        }
