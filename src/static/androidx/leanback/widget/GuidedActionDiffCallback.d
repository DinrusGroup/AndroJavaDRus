 ...
 */
public class GuidedActionDiffCallback : DiffCallback<GuidedAction> {
    ...
    override
    public bool areItemsTheSame(@NonNull GuidedAction oldItem, @NonNull GuidedAction newItem) {
        if (oldItem == null) {
            return newItem == null;
    ...
    override
    public bool areContentsTheSame(@NonNull GuidedAction oldItem,
