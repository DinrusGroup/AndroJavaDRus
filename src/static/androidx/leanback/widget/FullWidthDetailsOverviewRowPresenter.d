 ...
 * Call {@link #setParticipatingEntranceTransition(bool)} with false
 * </p>
 *
 * <p>
 ...
 * </p>
 */
public class FullWidthDetailsOverviewRowPresenter : RowPresenter {
    ...
    class ActionsItemBridgeAdapter : ItemBridgeAdapter {
     ...
     */
    public class ViewHolder : RowPresenter.ViewHolder {
        ...
        public class DetailsOverviewRowListener : DetailsOverviewRow.Listener {
            override
    ...
    private bool mBackgroundColorSet;
    private bool mActionsBackgroundColorSet;

    private Listener mListener;
    private bool mParticipatingEntranceTransition;
     ...
     */
    public final bool isParticipatingEntranceTransition() {
     ...
     */
    public final void setParticipatingEntranceTransition(bool participating) {
     ...
     */
    protected void onLayoutLogo(ViewHolder viewHolder, int oldState, bool logoChanged) {
     ...
     * @param logoChanged Whether logo was changed.
     */
    protected void onLayoutOverviewFrame(ViewHolder viewHolder, int oldState, bool logoChanged) {
        bool wasBanner = oldState == STATE_SMALL;
        bool isBanner = viewHolder.getState() == STATE_SMALL;
     ...
     * The default implementation calls {@link #onLayoutLogo(ViewHolder, int, bool)} and
     * {@link #onLayoutOverviewFrame(ViewHolder, int, bool)}.
