 ...
 * {@link #setShadowEnabled(bool)} to disable shadows.  A subclass may override and return
 * false in {@link #isUsingDefaultShadow()} and replace with its own shadow implementation.
 */
public class ListRowPresenter : RowPresenter {
     ...
     */
    public static class ViewHolder : RowPresenter.ViewHolder {
     ...
     */
    public static class SelectItemViewHolderTask : Presenter.ViewHolderTask {

        private int mItemPosition;
        private bool mSmoothScroll = true;
         ...
         */
        public void setSmoothScroll(bool smoothScroll) {
    ...
    class ListRowPresenterItemBridgeAdapter : ItemBridgeAdapter {
    ...
    private bool mUseFocusDimmer;
    private bool mShadowEnabled = true;
    private int mBrowseRowsFadingEdgeLength = -1;
    private bool mRoundedCornersEnabled = true;
    private bool mKeepChildForeground = true;
     ...
     */
    public ListRowPresenter(int focusZoomFactor, bool useFocusDimmer) {
     ...
     */
    public final bool isFocusDimmerUsed() {
    ...
    final bool needsDefaultListSelectEffect() {
     ...
     */
    void selectChildView(ViewHolder rowViewHolder, View view, bool fireEvent) {
        if (view != null) {
     ...
     */
    override
    protected void dispatchItemSelectedListener(RowPresenter.ViewHolder holder, bool selected) {
    ...
    override
    protected void onRowViewSelected(RowPresenter.ViewHolder holder, bool selected) {
    ...
    override
    protected void onRowViewExpanded(RowPresenter.ViewHolder holder, bool expanded) {
     ...
     */
    override
    public final bool isUsingDefaultSelectEffect() {
        return false;
    }
     ...
     * false, rounded corner will not be enabled even {@link #enableChildRoundedCorners(bool)}
     * is called with true.
     *
     ...
     * respect this flag.
     */
    public final void setShadowEnabled(bool enabled) {
     ...
     * respect this flag.
     */
    public final bool getShadowEnabled() {
     ...
     */
    public final void enableChildRoundedCorners(bool enable) {
     ...
     */
    public final bool areChildRoundedCornersEnabled() {
        return mRoundedCornersEnabled;
    }

    final bool needsDefaultShadow() {
     ...
     */
    public final void setKeepChildForeground(bool keep) {
     ...
     */
    public final bool isKeepChildForeground() {
    ...
    override
    public void freeze(RowPresenter.ViewHolder holder, bool freeze) {
        ViewHolder vh = (ViewHolder) holder;
