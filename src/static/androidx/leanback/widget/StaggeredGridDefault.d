 ...
 */
final class StaggeredGridDefault : StaggeredGrid {
     ...
     */
    override
    public int findRowMax(bool findLarge, int indexLimit, int[] indices) {
        int value;
     ...
     */
    override
    public int findRowMin(bool findLarge, int indexLimit, int[] indices) {
        int value;
        int edge = mProvider.getEdge(indexLimit);
        Location loc = getLocation(indexLimit);
        int row = loc.row;
    ...
    private int findRowEdgeLimitSearchIndex(bool append) {
        bool wrapped = false;
        if (append) {
    ...
    override
    protected bool appendVisibleItemsWithoutCache(int toLimit, bool oneColumnMode) {
        final int count = mProvider.getCount();
        int itemIndex;
        int rowIndex;
        int edgeLimit;
        bool edgeLimitIsValid;
    ...
    override
    protected bool prependVisibleItemsWithoutCache(int toLimit, bool oneColumnMode) {
        int itemIndex;
        int rowIndex;
        int edgeLimit;
        bool edgeLimitIsValid;
