...
public class ImageCardViewTest {
    ...
    private bool mOnAnimationStartCalled;
    private bool mOnAnimationPauseCalled;
    private bool mOnAnimationResumeCalled;
    private bool mOnAnimationCancelCalled;
    private bool mOnAnimationEndCalled;
    private bool mOnAnimationRepeatCalled;
    ...
    public void testSetMainImageInTransitionTest0() throws Throwable {
        ...
        // Interrupt current animation using setMainImage(Drawable, bool) method
        mRule.runOnUiThread(new Runnable() {
            override
            public void run() {
