 ...
 * </p>
 */
public class PlaybackTransportRowPresenter : PlaybackRowPresenter {
     ...
     */
    public class ViewHolder : PlaybackRowPresenter.ViewHolder : PlaybackSeekUi {
        ...
        void updateProgressInSeek(bool forward) {
            long newPos;
        ...
        void updateThumbsInSeek(int thumbHeroIndex, bool forward) {
        ...
        public ViewHolder(View rootView, Presenter descriptionPresenter) {
            ...
            mProgressBar.setAccessibilitySeekListener(new SeekBar.AccessibilitySeekListener() {
                override
                public bool onAccessibilitySeekForward() {
                    return onForward();
                }

                override
                public bool onAccessibilitySeekBackward() {
                    return onBackward();
                }
            });
