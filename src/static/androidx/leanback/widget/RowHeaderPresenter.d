 ...
 */
public class RowHeaderPresenter : Presenter {

    private final int mLayoutResourceId;
    private final Paint mFontMeasurePaint = new Paint(Paint.ANTI_ALIAS_FLAG);
    private bool mNullItemVisibilityGone;
    private final bool mAnimateSelect;
     ...
     */
    @RestrictTo(LIBRARY_GROUP)
    public RowHeaderPresenter(int layoutResourceId, bool animateSelect) {
     ...
     */
    public void setNullItemVisibilityGone(bool nullItemVisibilityGone) {
     ...
     */
    public bool isNullItemVisibilityGone() {
