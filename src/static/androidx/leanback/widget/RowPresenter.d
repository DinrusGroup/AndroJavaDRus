 ...
 * <ul>
 * <li>
 * A row is selected via {@link #setRowViewSelected(Presenter.ViewHolder, bool)}.  The event
 ...
 * Subclasses of RowPresenter may override {@link #onRowViewSelected(ViewHolder, bool)}.
 * </li>
 * <li>
 * A row is expanded to full height via {@link #setRowViewExpanded(Presenter.ViewHolder, bool)}
 ...
 * Subclasses of RowPresenter may override {@link #onRowViewExpanded(ViewHolder, bool)}.
 * </li>
 * </ul>
 *
 * <h3>Activated status</h3>
 * The activated status of a row is applied to the row view and its children via
 * {@link View#setActivated(bool)}.
 ...
 *     Application should call {@link RowPresenter.ViewHolder#setActivated(bool)} to change
 ...
 * </p>
 * <p>
 * Call {@link #setSelectEffectEnabled(bool)} to enable/disable the select effect,
 * This will not only enable/disable the default dim effect but also subclasses must
 * respect this flag as well.
 * </p>
 */
public abstract class RowPresenter : Presenter {

    /**
     * Don't synchronize row view activated status with selected status or expanded status,
     * application will do its own through {@link RowPresenter.ViewHolder#setActivated(bool)}.
     */
    ...
    static class ContainerViewHolder : Presenter.ViewHolder {
        /**
     ...
     */
    public static class ViewHolder : Presenter.ViewHolder {
         ...
         */
        public final void setActivated(bool activated) {
            mActivated = activated ? ACTIVATED : NOT_ACTIVATED;
        }

        /**
         * Synchronizes the activated status of view to the last value passed through
         * {@link RowPresenter.ViewHolder#setActivated(bool)}. No operation if
         * {@link RowPresenter.ViewHolder#setActivated(bool)} is never called.  Normally
    ...
    bool mSelectEffectEnabled = true;
     ...
     */
    protected bool isClippingChildren() {
        return false;
    }
     ...
     */
    public final void setRowViewExpanded(Presenter.ViewHolder holder, bool expanded) {
     ...
     */
    public final void setRowViewSelected(Presenter.ViewHolder holder, bool selected) {
        ViewHolder rowViewHolder = getRowViewHolder(holder);
     ...
     * Row view.
     */
    protected void onRowViewExpanded(ViewHolder vh, bool expanded) {
     ...
     * {@link #onRowViewSelected(ViewHolder, bool)} onRowViewSelected.
     ...
     */
    protected void dispatchItemSelectedListener(ViewHolder vh, bool selected) {
        if (selected) {
     ...
     */
    protected void onRowViewSelected(ViewHolder vh, bool selected) {
     ...
     * respect this flag as well.
     */
    public final void setSelectEffectEnabled(bool applyDimOnSelect) {
     ...
     */
    public final bool getSelectEffectEnabled() {
     ...
     */
    public bool isUsingDefaultSelectEffect() {
        return true;
    }

    final bool needsDefaultSelectEffect() {
        return isUsingDefaultSelectEffect() && getSelectEffectEnabled();
    }

    final bool needsRowContainerView() {
     ...
     */
    public void freeze(ViewHolder holder, bool freeze) {
    }
     ...
     */
    public void setEntranceTransitionState(ViewHolder holder, bool afterEntrance) {
