 ...
 */
class PlaybackControlsPresenter : ControlBarPresenter {

    /**
     * The data type expected by this presenter.
     */
    static class BoundData : ControlBarPresenter.BoundData {
        /**
    ...
    class ViewHolder : ControlBarPresenter.ViewHolder {
    ...
    private bool mMoreActionsEnabled = true;
     ...
     */
    public void enableSecondaryActions(bool enable) {
     ...
     */
    public bool areMoreActionsEnabled() {
    ...
    public void enableTimeMargins(ViewHolder vh, bool enable) {
