 ...
 * </p>
 * <p>
 * {@link #initialize(bool, bool, bool)} must be first called on the container.
 ...
 * </p>
 */
public class ShadowOverlayContainer : FrameLayout {
    ...
    ShadowOverlayContainer(Context context,
            int shadowType, bool hasColorDimOverlay,
     ...
     */
    @Deprecated
    public void initialize(bool hasShadow, bool hasColorDimOverlay) {
     ...
     */
    @Deprecated
    public void initialize(bool hasShadow, bool hasColorDimOverlay, bool roundedCorners) {
        int shadowType;
        if (!hasShadow) {
     ...
     * Initialize shadows, color overlay, and rounded corners.  All are optional.
     */
    void initialize(int shadowType, bool hasColorDimOverlay, int roundedCornerRadius) {
        if (mInitialized) {
