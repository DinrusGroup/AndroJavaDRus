 ...
 * </ol>
 */
public class HorizontalGridView : BaseGridView {

    private bool mFadingLowEdge;
    private bool mFadingHighEdge;
     ...
     */
    public final void setFadingLeftEdge(bool fading) {
     ...
     */
    public final bool getFadingLeftEdge() {
     ...
     * that you should turn off when HorizontalGridView is scrolling.
     */
    public final void setFadingRightEdge(bool fading) {
     ...
     */
    public final bool getFadingRightEdge() {
    ...
    private bool needsFadingLowEdge() {
        if (!mFadingLowEdge) {
            return false;
        }
    ...
    private bool needsFadingHighEdge() {
        if (!mFadingHighEdge) {
            return false;
        }
        final int c = getChildCount();
    ...
    public void draw(Canvas canvas) {
        final bool needsFadingLow = needsFadingLowEdge();
        final bool needsFadingHigh = needsFadingHighEdge();
        if (!needsFadingLow) {
            mTempBitmapLow = null;
        }
        if (!needsFadingHigh) {
