 ...
 * not position-based.  The leanback framework : the adapter concept using
 ...
 * public class StringTextViewPresenter : Presenter {
 ...
 */
public abstract class Presenter : FacetProvider {
    /**
     ...
     */
    public static class ViewHolder : FacetProvider {
        ...
        override
        public final Object getFacet(Class!(T) facetClass) {
            if (mFacets == null) {
                return null;
            }
         ...
         */
        public final void setFacet(Class!(T) facetClass, Object facetImpl) {
            if (mFacets == null) {
