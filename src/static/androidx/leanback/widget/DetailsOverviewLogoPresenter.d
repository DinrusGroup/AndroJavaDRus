 ...
 */
public class DetailsOverviewLogoPresenter : Presenter {
    ...
    public static class ViewHolder : Presenter.ViewHolder {
        ...
        private bool mSizeFromDrawableIntrinsic;
         ...
         */
        public bool isSizeFromDrawableIntrinsic() {
         ...
         * @see DetailsOverviewLogoPresenter#onBindViewHolder(Presenter.ViewHolder, Object)
         */
        public void setSizeFromDrawableIntrinsic(bool sizeFromDrawableIntrinsic) {
     ...
     */
    public bool isBoundToImage(ViewHolder viewHolder, DetailsOverviewRow row) {
