 ...
 * </p>
 */
public class PlaybackControlsRowPresenter : PlaybackRowPresenter {

    static class BoundData : PlaybackControlsPresenter.BoundData {
     ...
     */
    public class ViewHolder : PlaybackRowPresenter.ViewHolder {
        ...
        Presenter getPresenter(bool primary) {
    ...
    private bool mProgressColorSet;
    private bool mSecondaryActionsHidden;
     ...
     */
    public void setSecondaryActionsHidden(bool hidden) {
     ...
     */
    public bool areSecondaryActionsHidden() {
     ...
     */
    public void showBottomSpace(ViewHolder vh, bool show) {
     ...
     * to display the secondary actions; see {@link #setSecondaryActionsHidden(bool)}.
     */
