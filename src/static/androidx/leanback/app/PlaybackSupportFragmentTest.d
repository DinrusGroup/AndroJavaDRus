...
public class PlaybackSupportFragmentTest : SingleSupportFragmentTestBase {
    ...
    public void testSelectedListener() throws Throwable {
        ...
        // selected.
        bool listRowItemPassed = (itemCaptor.getValue() == listRow0.getAdapter().get(0)
    ...
    public static class PurePlaybackSupportFragment : PlaybackSupportFragment {
        override
    ...
    public static class ControlGlueFragment : PlaybackSupportFragment {
        override
        public void onCreate(Bundle savedInstanceState) {
            super.onCreate(savedInstanceState);
