...
public class HeadersSupportFragmentTest : SingleSupportFragmentTestBase {
    ...
    public static class F_defaultScale : HeadersSupportFragment {
    ...
    public static class F_disableScale : HeadersSupportFragment {
        override
        public void onCreate(Bundle savedInstanceState) {
            super.onCreate(savedInstanceState);
    ...
    public static class F_disableScaleInConstructor : HeadersSupportFragment {
