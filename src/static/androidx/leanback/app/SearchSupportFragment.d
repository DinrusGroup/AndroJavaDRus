 ...
 * </p>
 */
public class SearchSupportFragment : Fragment {
    ...
    private final Runnable mSetSearchResultProvider = new Runnable() {
        ...
        public void run() {
            ...
            if (adapter != mResultAdapter) {
                bool firstTime = mResultAdapter == null;
                releaseAdapter();
    ...
    int mStatus;
    bool mAutoStartRecognition = true;

    private bool mIsPaused;
    private bool mPendingStartRecognitionWhenPaused;
     ...
     */
    public void setSearchQuery(String query, bool submit) {
     ...
     * @param submit Whether to submit the query.
     */
    public void setSearchQuery(Intent intent, bool submit) {
     ...
     * {@link #setSearchQuery(Intent, bool)}.
     */
    ...
    static class ExternalQuery {
        ...
        ExternalQuery(String query, bool submit) {
            mQuery = query;
            mSubmit = submit;
        }
    }
