...
public class HeadersFragmentTest : SingleFragmentTestBase {
    ...
    public static class F_defaultScale : HeadersFragment {
    ...
    public static class F_disableScale : HeadersFragment {
        override
        public void onCreate(Bundle savedInstanceState) {
            super.onCreate(savedInstanceState);
    ...
    public static class F_disableScaleInConstructor : HeadersFragment {
