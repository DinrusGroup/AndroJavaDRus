...
public final class BackgroundManager {
    ...
    private bool mAutoReleaseOnStop = true;
    ...
    static class BitmapDrawable : Drawable {

        static final class ConstantState : Drawable.ConstantState {
    ...
    static final class TranslucentLayerDrawable : LayerDrawable {
        DrawableWrapper[] mWrapper;
        int mAlpha = FULL_ALPHA;
        bool mSuspendInvalidation;
    ...
    private bool mChangeRunnablePending;
    ...
    private static class BackgroundContinuityService {
        ...
        private static final bool DEBUG = BackgroundManager.DEBUG;
     ...
     */
    public void setAutoReleaseOnStop(bool autoReleaseOnStop) {
     ...
     */
    public bool isAutoReleaseOnStop() {
    ...
    bool sameDrawable(Drawable first, Drawable second) {
     ...
     */
    final class ChangeBackgroundRunnable : Runnable {
        final Drawable mDrawable;
    ...
    static class EmptyDrawable : BitmapDrawable {
