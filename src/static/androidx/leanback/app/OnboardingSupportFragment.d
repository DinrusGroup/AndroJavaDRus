 ...
 */
abstract public class OnboardingSupportFragment : Fragment {
     ...
     */
    protected final void startEnterAnimation(bool force) {
        final Context context = getContext();
        if (context == null) {
            return;
        }
     ...
     */
    protected final bool isLogoAnimationFinished() {
    ...
    private Animator createAnimator(View view, bool fadeIn, int slideDirection,
            long startDelay) {
        bool isLtr = getView().getLayoutDirection() == View.LAYOUT_DIRECTION_LTR;
        bool slideRight = (isLtr && slideDirection == Gravity.END)
