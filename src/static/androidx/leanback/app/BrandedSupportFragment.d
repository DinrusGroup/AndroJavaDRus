...
public class BrandedSupportFragment : Fragment {
     ...
     * browse_title_group that : {@link TitleViewAdapter.Provider}. Subclass may return
     ...
     * @return Title view which must have a descendant with id browse_title_group that :
    ...
    public View onInflateTitleView(LayoutInflater inflater, ViewGroup parent,
        ...
        bool found = parent.getContext().getTheme().resolveAttribute(
    ...
    /**
     * Returns the view that : {@link TitleViewAdapter.Provider}.
     * @return The view that : {@link TitleViewAdapter.Provider}.
     */
     ...
     *
     * @return bool to indicate whether or not it's showing the title.
     */
    public final bool isShowingTitle() {
