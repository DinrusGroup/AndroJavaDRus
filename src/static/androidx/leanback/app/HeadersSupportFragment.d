 ...
 */
public class HeadersSupportFragment : BaseRowSupportFragment {
    ...
    private bool mHeadersEnabled = true;
    private bool mHeadersGone = false;
    ...
    void setHeadersEnabled(bool enabled) {
        mHeadersEnabled = enabled;
        updateListViewVisibility();
    }

    void setHeadersGone(bool gone) {
        mHeadersGone = gone;
        updateListViewVisibility();
    }

    static class NoOverlappingFrameLayout : FrameLayout {
