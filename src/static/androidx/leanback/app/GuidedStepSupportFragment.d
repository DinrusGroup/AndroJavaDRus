 ...
 */
public class GuidedStepSupportFragment : Fragment : GuidedActionAdapter.FocusListener {
    ...
    private static final bool IS_FRAMEWORK_FRAGMENT = false;
     ...
     */
    @RestrictTo(LIBRARY_GROUP)
    public static class DummyFragment : Fragment {
        override
     ...
     * @see #expandAction(GuidedAction, bool)
     */
     ...
     */
    public void expandAction(GuidedAction action, bool withTransition) {
    ...
    public static int add(FragmentManager fragmentManager, GuidedStepSupportFragment fragment, int id) {
        ...
        bool inGuidedStep = current != null;
     ...
     * false otherwise.
     */
    static bool isStackEntryUiStyleEntrance(String backStackEntryName) {
    ...
    static bool isSaveEnabled(GuidedAction action) {
    ...
    private static bool isGuidedStepTheme(Context context) {
        int resId = R.attr.guidedStepThemeFlag;
        TypedValue typedValue = new TypedValue();
        bool found = context.getTheme().resolveAttribute(resId, typedValue, true);
     ...
     */
    public bool isFocusOutStartAllowed() {
        return false;
    }
     ...
     */
    public bool isFocusOutEndAllowed() {
        return false;
    }
    ...
    void runImeAnimations(bool entering) {
