...
import static androidx.leanback.app.BrowseFragmentTestActivity.EXTRA_HEADERS_STATE;
...
public class BrowseTestFragment : BrowseFragment {
    ...
    final static bool DEFAULT_TEST_ENTRANCE_TRANSITION = true;
    final static bool DEFAULT_SET_ADAPTER_AFTER_DATA_LOAD = false;
    ...
    int NUM_ROWS;
    int REPEAT_PER_ROW;
    bool mEntranceTransitionStarted;
    bool mEntranceTransitionEnded;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        bool TEST_ENTRANCE_TRANSITION = arguments.getBoolean(
                EXTRA_TEST_ENTRANCE_TRANSITION,
                DEFAULT_TEST_ENTRANCE_TRANSITION);
        final bool SET_ADAPTER_AFTER_DATA_LOAD = arguments.getBoolean(
    ...
    private final class ItemViewClickedListener : OnItemViewClickedListener {
        override
