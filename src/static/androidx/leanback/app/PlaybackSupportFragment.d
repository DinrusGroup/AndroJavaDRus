 ...
 * {@link #setControlsOverlayAutoHideEnabled(bool)} upon play/pause. The auto hiding timer will
 * be cancelled upon {@link #tickle()} triggered by input event.
 * </p>
 */
public class PlaybackSupportFragment : Fragment {
    ...
    bool mFadingEnabled = true;
    bool mControlVisibleBeforeOnCreateView = true;
    bool mControlVisible = true;
    int mBgAlpha;
    ...
    private void enableVerticalGridAnimations(bool enable) {
    ...
    /**
     * @deprecated Uses {@link #setControlsOverlayAutoHideEnabled(bool)}
     */
    @Deprecated
     ...
     * also kill the timer created by {@link #setControlsOverlayAutoHideEnabled(bool)}. When
    ...
    private bool onInterceptInputEvent(InputEvent event) {
        final bool controlsHidden = !mControlVisible;
     ...
     * @deprecated Call {@link #hideControlsOverlay(bool)}
     */
    @Deprecated
    public void fadeOut() {
        showControlsOverlay(false, false);
     ...
     * @see #showControlsOverlay(bool)
     * @see #hideControlsOverlay(bool)
     */
     ...
     */
    void showControlsOverlay(bool show, bool animation) {
     ...
     */
    protected void onBufferingStateChanged(bool start) {
        ProgressBarManager progressBarManager = getProgressBarManager();
        if (progressBarManager != null) {
            if (start) {
     ...
     * {@link #onBufferingStateChanged(bool)}.
