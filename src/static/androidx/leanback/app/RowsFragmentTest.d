...
public class RowsFragmentTest : SingleFragmentTestBase {
    ...
    public static class F_defaultAlignment : RowsFragment {
        override
    ...
    public static class F_selectBeforeSetAdapter : RowsFragment {
        override
        public void onCreate(Bundle savedInstanceState) {
            super.onCreate(savedInstanceState);
    ...
    public static class F_selectBeforeAddData : RowsFragment {
        override
        public void onCreate(Bundle savedInstanceState) {
            super.onCreate(savedInstanceState);
            ListRowPresenter lrp = new ListRowPresenter();
    ...
    public static class F_selectAfterAddData : RowsFragment {
        override
        public void onCreate(Bundle savedInstanceState) {
            super.onCreate(savedInstanceState);
            ListRowPresenter lrp = new ListRowPresenter();
    ...
    public static class F_restoreSelection : RowsFragment {
    ...
    public static class F_ListRowWithOnClick : RowsFragment {
    ...
    public static class F_rowNotifyItemRangeChange : BrowseFragment {
    ...
    public static class F_rowNotifyItemRangeChangeWithTransition : BrowseFragment {
    ...
    public static class F_Base : BrowseFragment {
     ...
     */
    public static class SampleRowsFragment : RowsFragment {
    ...
    static class MyFragmentFactory : BrowseFragment.FragmentFactory {
        override
    ...
    void mixedBrowseFragmentRestoreToSampleRowsFragment(final bool hideFastLane)
            throws Throwable {
        final SingleFragmentTestActivity activity = launchAndWaitActivity(
                RowsFragmentTest.F_3ListRow2PageRow.class, 2000);
        final F_3ListRow2PageRow fragment = ((F_3ListRow2PageRow) activity.getTestFragment());
    ...
    void mixedBrowseFragmentRestoreToSampleFragment(final bool hideFastLane)
            throws Throwable {
        final SingleFragmentTestActivity activity = launchAndWaitActivity(
                RowsFragmentTest.F_3ListRow2PageRow.class, 2000);
        final F_3ListRow2PageRow fragment = ((F_3ListRow2PageRow) activity.getTestFragment());
