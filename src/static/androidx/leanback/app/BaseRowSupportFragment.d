 ...
 */
abstract class BaseRowSupportFragment : Fragment {
    ...
    private bool mPendingTransitionPrepare;
     ...
     * row.
     */
    private class LateSelectionObserver : RecyclerView.AdapterDataObserver {
        bool mIsLateSelection = false;
    ...
    void setAdapterAndSelection() {
        ...
        bool lateSelection = mBridgeAdapter.getItemCount() == 0 && mSelectedPosition >= 0;
        if (lateSelection) {
