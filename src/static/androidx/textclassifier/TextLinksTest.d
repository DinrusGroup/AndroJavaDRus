...
public final class TextLinksTest {
    ...
    private static class NoOpSpan : ClickableSpan {
        override
    ...
    private static class CustomTextLinkSpan : TextLinks.TextLinkSpan {
        CustomTextLinkSpan(@Nullable TextLinks.TextLink textLink) {
            super(textLink);
        }
    }

    private static class CustomSpanFactory : TextLinks.SpanFactory {
        override
