 ...
 */
public class VectorDrawableCompat : VectorDrawableCommon {
    ...
    public void draw(Canvas canvas) {
        ...
        final bool needMirroring = needMirroring();
        if (needMirroring) {
     ...
     */
    @RequiresApi(24)
    private static class VectorDrawableDelegateState : ConstantState {
    ...
    private static class VectorDrawableCompatState : ConstantState {
        ...
        public bool canReuseBitmap(int width, int height) {
    ...
    private static class VClipPath : VPath {
        ...
        public void inflate(Resources r, AttributeSet attrs, Theme theme, XmlPullParser parser) {
            ...
            final bool hasPathData = TypedArrayUtils.hasAttribute(parser, "pathData");
            if (!hasPathData) {
                return;
            }
     ...
     */
    private static class VFullPath : VPath {
        /////////////////////////////////////////////////////
        // Variables below need to be copied (deep copy if applicable) for mutation.
        private int[] mThemeAttrs;
