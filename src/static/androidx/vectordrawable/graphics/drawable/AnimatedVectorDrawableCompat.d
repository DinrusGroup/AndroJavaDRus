...
public class AnimatedVectorDrawableCompat : VectorDrawableCommon
        : Animatable2Compat {
     ...
     */
    @RequiresApi(24)
    private static class AnimatedVectorDrawableDelegateState : ConstantState {
    ...
    private static class AnimatedVectorDrawableCompatState : ConstantState {
     ...
     */
    @RequiresApi(23)
    private static bool unregisterPlatformCallback(AnimatedVectorDrawable dr,
    ...
    override
    public bool unregisterAnimationCallback(
     ...
     * Otherwise, it is treated as AnimatedVectorDrawableCompat.
     */
    public static bool unregisterAnimationCallback(Drawable dr,
            Animatable2Compat.AnimationCallback callback) {
        if (dr == null || callback == null) {
            return false;
        }
