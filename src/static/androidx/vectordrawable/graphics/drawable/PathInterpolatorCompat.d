...
public class PathInterpolatorCompat : Interpolator {
    ...
    private void parseInterpolatorFromTypeArray(TypedArray a, XmlPullParser parser) {
        ...
        if (TypedArrayUtils.hasAttribute(parser, "pathData")) {
            ...
            bool hasX2 = TypedArrayUtils.hasAttribute(parser, "controlX2");
            bool hasY2 = TypedArrayUtils.hasAttribute(parser, "controlY2");
