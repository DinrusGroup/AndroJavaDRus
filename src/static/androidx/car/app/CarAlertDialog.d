 ...
 * {@code AlertDialog}.
 */
public class CarAlertDialog : Dialog {
    ...
    private void setTitleInternal(CharSequence title) {
        ...
        bool hasBody = mBodyView.getVisibility() == View.VISIBLE;
        bool hasButton = mButtonPanel.getVisibility() == View.VISIBLE;
    ...
    private void setPositiveButton(CharSequence text) {
        bool showButton = !TextUtils.isEmpty(text);
    ...
    private void updateButtonPanelVisibility() {
        bool hasButtons = mPositiveButton.getVisibility() == View.VISIBLE
                || mNegativeButton.getVisibility() == View.VISIBLE;
     ...
     */
    private static final class ButtonPanelTouchDelegate : TouchDelegate {
