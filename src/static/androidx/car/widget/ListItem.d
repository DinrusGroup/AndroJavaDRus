 ...
 *
 * @param <VH> ViewHolder that : {@link ListItem.ViewHolder}.
 */
public abstract class ListItem<VH : ListItem.ViewHolder> {
    ...
    /**
     * Classes that : {@code ListItem} should register its view type in
     ...
     */
    public void setHideDivider(bool hideDivider) {
     ...
     */
    public bool removeViewBinder(ViewBinder<VH> binder) {
     ...
     *
     * @param <VH> class that : {@link RecyclerView.ViewHolder}.
     */
     ...
     */
    public abstract static class ViewHolder : RecyclerView.ViewHolder {
