 ...
 * its items.
 */
public class PagedListView : FrameLayout {
    /**
    ...
    private bool mScrollBarEnabled;
    @VisibleForTesting
    ...
    public interface DividerVisibilityManager {
         ...
         */
        bool shouldHideDivider(int position);
    }
    ...
    public void onLayout(bool changed, int left, int top, int right, int bottom) {
        ...
        bool isAtStart = isAtStart();
        bool isAtEnd = isAtEnd();
     ...
     */
    private void updatePaginationButtons(bool animate) {
        if (!mScrollBarEnabled) {
            // Don't change the visibility of the ScrollBar unless it's enabled.
            return;
        }
    ...
    private void updateMaxItems() {
        ...
        // Ensure mRowsPerPage regardless of if the adapter : ItemCap.
        updateRowsPerPage();
    ...
    private void updateAlphaJump() {
        bool supportsAlphaJump = (mAdapter instanceof IAlphaJumpAdapter);
    ...
    private final Runnable mPaginationRunnable =
            new Runnable() {
                override
                public void run() {
                    bool upPressed = mScrollBarView.isUpPressed();
                    bool downPressed = mScrollBarView.isDownPressed();
     ...
     */
    private static class ItemSpacingDecoration : RecyclerView.ItemDecoration {
     ...
     */
    private static class DividerDecoration : RecyclerView.ItemDecoration {
        ...
        public void onDrawOver(Canvas c, RecyclerView parent, RecyclerView.State state) {
            bool usesGridLayoutManager = parent.getLayoutManager() instanceof GridLayoutManager;
        ...
        private bool hideDividerForAdapterPosition(int position) {
     ...
     */
    private static class TopOffsetDecoration : RecyclerView.ItemDecoration {
