 ...
 * off-screen.
 */
public class PagedSnapHelper : LinearSnapHelper {
    /**
     ...
     */
    private bool isValidSnapView(View view, OrientationHelper helper) {
    ...
    public bool isAtStart(RecyclerView.LayoutManager layoutManager) {
        if (layoutManager == null || layoutManager.getChildCount() == 0) {
            return true;
        }
    ...
    public bool isAtEnd(RecyclerView.LayoutManager layoutManager) {
        if (layoutManager == null || layoutManager.getChildCount() == 0) {
            return true;
        }
