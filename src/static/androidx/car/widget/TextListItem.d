 ...
 */
public class TextListItem : ListItem<TextListItem.ViewHolder> {
    ...
    private bool mShowSupplementalIconDivider;

    private bool mSwitchChecked;
    private bool mShowSwitchDivider;
     ...
     */
    public void setPrimaryActionIcon(@DrawableRes int iconResId, bool useLargeIcon) {
     ...
     * @param useLargeIcon the size of primary icon. Large Icon is a square as tall as an item.
     */
    public void setPrimaryActionIcon(Drawable drawable, bool useLargeIcon) {
     ...
     */
    public void setBody(String body, bool asPrimary) {
        mBody = body;
     ...
     */
    public void setSupplementalIcon(int iconResId, bool showDivider) {
     ...
     *                    {@code Supplemental Icon}.
     */
    public void setSupplementalIcon(Drawable drawable, bool showDivider) {
     ...
     */
    public void setAction(String text, bool showDivider, View.OnClickListener listener) {
     ...
     */
    public void setActions(String action1Text, bool showAction1Divider,
            View.OnClickListener action1OnClickListener,
            String action2Text, bool showAction2Divider,
     ...
     */
    public void setSwitch(bool checked, bool showDivider,
     ...
     * {@link #setSwitch(bool, bool, CompoundButton.OnCheckedChangeListener)} must be called
     ...
     */
    public void setSwitchState(bool isChecked) {
     ...
     */
    public static class ViewHolder : ListItem.ViewHolder {
