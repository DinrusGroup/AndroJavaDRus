 ...
 */
public class SeekbarListItem : ListItem<SeekbarListItem.ViewHolder> {
    ...
    public void setSupplementalIcon(@DrawableRes int iconResId,
            bool showSupplementalIconDivider) {
     ...
     * Sets {@code Supplemental Action} to be represented by an {@code Supplemental Icon}.
     */
    public void setSupplementalIcon(Drawable drawable, bool showSupplementalIconDivider) {
    ...
    private void setSupplementalIconInfo(Drawable drawable, bool showSupplementalIconDivider) {
     ...
     * Sets {@code Supplemental Action} to be represented by an {@code Supplemental Icon}.
     *
     * @deprecated use either {@link #setSupplementalIcon(Drawable, bool)} or
     * {@link #setSupplementalIcon(int, bool)} and
     ...
     */
    public void setSupplementalEmptyIcon(bool seekbarOffsetDividerWidth) {
