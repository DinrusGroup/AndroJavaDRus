...
public class PagedScrollBarView : ViewGroup {
    ...
    private bool mUseCustomThumbBackground;
    ...
    void setShowAlphaJump(bool show) {
    ...
    public void setParameters(
            ...
            @IntRange(from = 0) int extent, bool animate) {
    ...
    /**
     * An optimized version of {@link #setParameters(int, int, int, bool)} that is meant to be
     ...
     * @param extent The extent of the scrollbar's thumb
     *
     * @see #setParameters(int, int, int, bool)
     */
    ...
    private void moveY(final View view, float newPosition, bool animate) {
    ...
    private static class PaginateButtonClickListener : View.OnClickListener {
    ...
    private static class AlphaJumpButtonClickListener : View.OnClickListener {
        private PaginationListener mPaginationListener;
