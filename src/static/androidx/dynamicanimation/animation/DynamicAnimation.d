 ...
 */
public abstract class DynamicAnimation<T : DynamicAnimation<T>>
     ...
     */
    public abstract static class ViewProperty : FloatPropertyCompat<View> {
     ...
     */
    abstract bool updateValueAndVelocity(long deltaT);

    /**
     * Internal method to reset the animation states when animation is finished/canceled.
     */
    private void endAnimationInternal(bool canceled) {
        mRunning = false;
     ...
     */
    abstract bool isAtEquilibrium(float value, float velocity);
    ...
    public interface OnAnimationEndListener {
         ...
         */
        void onAnimationEnd(DynamicAnimation animation, bool canceled, float value,
                              float velocity);
    }
