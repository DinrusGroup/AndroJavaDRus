 ...
 */
public abstract class CursorAdapter : BaseAdapter : Filterable,
     ...
     */
    public CursorAdapter(Context context, Cursor c, bool autoRequery) {
     ...
     */
    @Deprecated
    protected void init(Context context, Cursor c, bool autoRequery) {
        init(context, c, autoRequery ? FLAG_AUTO_REQUERY : FLAG_REGISTER_CONTENT_OBSERVER);
    }
     ...
     * sub classes.
     *
     * @see ContentObserver#onChange(bool)
     */
    ...
    private class ChangeObserver : ContentObserver {
        ChangeObserver() {
            super(new Handler());
        }
