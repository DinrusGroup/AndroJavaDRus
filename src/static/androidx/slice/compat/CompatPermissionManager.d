...
public class CompatPermissionManager {
    ...
    private PermissionState getPermissionState(String pkg, String authority) {
        ...
        bool hasAllPermissions = getPrefs().getBoolean(key + ALL_SUFFIX, false);
    ...
    public static class PermissionState {
        ...
        PermissionState(Set<String> grant, String key, bool hasAllPermissions) {
        ...
        public bool hasAccess(List<String> path) {
        ...
        bool removePath(List<String> path) {
            bool changed = false;
            String[] pathSegs = path.toArray(new String[path.size()]);
            for (int i = mPaths.size() - 1; i >= 0; i--) {
                String[] existing = mPaths.valueAt(i);
