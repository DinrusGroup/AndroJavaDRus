 ...
 */
@Deprecated
public class GridBuilder : TemplateSliceBuilder {
     ...
     */
    @Deprecated
    public static final class CellBuilder : TemplateSliceBuilder {
         ...
         */
        @NonNull
        public CellBuilder addText(@Nullable CharSequence text, bool isLoading) {
         ...
         */
        @NonNull
        public CellBuilder addTitleText(@Nullable CharSequence text, bool isLoading) {
        ...
        @Deprecated
        @RequiresApi(23)
        public CellBuilder addLargeImage(@Nullable Icon image, bool isLoading) {
        ...
        @Deprecated
        @RequiresApi(23)
        public CellBuilder addImage(@Nullable Icon image, bool isLoading) {
