...
public interface ListBuilder {
    ...
    /**
     * Create a builder that : {@link RowBuilder}.
     */
    ...
    /**
     * Create a builder that : {@link GridRowBuilder}.
     */
    TemplateBuilderImpl createGridBuilder();
    /**
     * Create a builder that : {@link HeaderBuilder}.
     */
    ...
    /**
     * Create a builder that : {@link InputRangeBuilder}.
     */
    TemplateBuilderImpl createInputRangeBuilder();
    /**
     * Create a builder that : {@link RangeBuilder}.
     */
     ...
     */
    interface InputRangeBuilder : RangeBuilder {
        /**
    ...
    interface RowBuilder {
         ...
         */
        void setTitleItem(IconCompat icon, int imageMode, bool isLoading);
         ...
         * until updated.
         */
        void setTitleItem(SliceAction action, bool isLoading);
         ...
         * until updated.
         */
        void setTitle(CharSequence title, bool isLoading);
         ...
         * until updated.
         */
        void setSubtitle(CharSequence subtitle, bool isLoading);
         ...
         * @param isLoading whether this content is being loaded in the background.
         */
        void addEndItem(IconCompat icon, int imageMode, bool isLoading);
         ...
         * until updated.
         */
        void addEndItem(SliceAction action, bool isLoading);
    ...
    public interface HeaderBuilder {
         ...
         * small format.
         */
        void setSummary(CharSequence summarySubtitle, bool isLoading);
