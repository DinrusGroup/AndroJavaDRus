...
public interface GridRowBuilder {
    /**
     * Create an TemplateBuilderImpl that : {@link CellBuilder}.
     */
    TemplateBuilderImpl createGridRowBuilder();

    /**
     * Create an TemplateBuilderImpl that : {@link CellBuilder} with the specified Uri.
     */
    ...
    interface CellBuilder {
         ...
         */
        @NonNull
        void addText(@Nullable CharSequence text, bool isLoading);
         ...
         */
        @NonNull
        void addTitleText(@Nullable CharSequence text, bool isLoading);
         ...
         */
        @NonNull
        void addImage(@NonNull IconCompat image, int imageMode, bool isLoading);
