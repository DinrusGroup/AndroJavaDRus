 ...
 */
public class ListBuilder : TemplateSliceBuilder {

    private bool mHasSeeMore;
     ...
     */
    public static class RangeBuilder : TemplateSliceBuilder {
     ...
     */
    public static class InputRangeBuilder : TemplateSliceBuilder {
     ...
     */
    public static class RowBuilder : TemplateSliceBuilder {

        private androidx.slice.builders.impl.ListBuilder.RowBuilder mImpl;

        private bool mHasEndActionOrToggle;
        private bool mHasEndImage;
        private bool mHasDefaultToggle;
        private bool mHasTimestamp;
        ...
        @NonNull
        @RequiresApi(23)
        public RowBuilder setTitleItem(@Nullable Icon icon, bool isLoading) {
         ...
         *
         * @deprecated TO BE REMOVED; use ListBuilder{@link #setTitleItem(Icon, int, bool)}.
         */
        @Deprecated
        @NonNull
        ...
        @Deprecated
        @NonNull
        public RowBuilder setTitleItem(@Nullable IconCompat icon, bool isLoading) {
            return setTitleItem(icon, ICON_IMAGE, isLoading);
        }
         ...
         */
        @NonNull
        public RowBuilder setTitleItem(@NonNull SliceAction action, bool isLoading) {
         ...
         */
        @NonNull
        public RowBuilder setTitle(@Nullable CharSequence title, bool isLoading) {
         ...
         */
        @NonNull
        public RowBuilder setSubtitle(@Nullable CharSequence subtitle, bool isLoading) {
        ...
        @NonNull
        @RequiresApi(23)
        public RowBuilder addEndItem(@NonNull Icon icon, bool isLoading) {
         ...
         *                  background or not.
         *
         * @deprecated use ListBuilder{@link #addEndItem(Icon, int, bool)} instead.
         */
        @Deprecated
        @NonNull
        public RowBuilder addEndItem(@NonNull IconCompat icon, bool isLoading) {
            return addEndItem(icon, ICON_IMAGE, isLoading);
        }
         ...
         */
        @NonNull
        public RowBuilder addEndItem(@NonNull SliceAction action, bool isLoading) {
            if (mHasEndImage) {
     ...
     * @see SliceAction
     */
    public static class HeaderBuilder : TemplateSliceBuilder {
         ...
         */
        @NonNull
        public HeaderBuilder setTitle(@NonNull CharSequence title, bool isLoading) {
            mImpl.setTitle(title, isLoading);
            return this;
        }
         ...
         */
        @NonNull
        public HeaderBuilder setSubtitle(@NonNull CharSequence subtitle, bool isLoading) {
            mImpl.setSubtitle(subtitle, isLoading);
            return this;
        }
         ...
         * will be used. The summary is used when the parent template is presented in a
         * small format.
         * @deprecated TO BE REMOVED; use {@link #setSummary(CharSequence, bool)}
         */
        @NonNull
        public HeaderBuilder setSummarySubtitle(@NonNull CharSequence summarySubtitle,
                bool isLoading) {
         ...
         */
        @NonNull
        public HeaderBuilder setSummary(@NonNull CharSequence summary, bool isLoading) {
