 ...
 */
public class SliceAction : androidx.slice.core.SliceAction {
    ...
    @RequiresApi(23)
    public SliceAction(@NonNull PendingIntent action, @NonNull Icon actionIcon,
            @NonNull CharSequence actionTitle, bool isChecked) {
    ...
    @NonNull
    override
    public SliceAction setChecked(bool isChecked) {
