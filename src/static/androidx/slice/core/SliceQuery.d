...
public class SliceQuery {
    ...
    /**
     */
    public static bool hasAnyHints(SliceItem item, String... hints) {
    ...
    /**
     */
    public static bool hasHints(SliceItem item, String... hints) {
    ...
    /**
     */
    public static bool hasHints(Slice item, String... hints) {
        if (hints == null) return true;
        List<String> itemHints = item.getHints();
        for (String hint : hints) {
            if (!TextUtils.isEmpty(hint) && !itemHints.contains(hint)) {
    ...
    public static List<SliceItem> findAll(Slice s, final String format, final String[] hints,
        ...
        return collect(filter(stream(s), new Filter<SliceItem>() {
            override
            public bool filter(SliceItem item) {
    ...
    private static bool checkFormat(SliceItem item, String format) {
        return format == null || format.equals(item.getFormat());
    }

    private static bool checkSubtype(SliceItem item, String subtype) {
