 ...
 */
@RestrictTo(LIBRARY)
public class SliceActionView : FrameLayout : View.OnClickListener,
    ...
    private void sendAction() {
        ...
        try {
            ...
            if (mSliceAction.isToggle()) {
                ...
                bool isChecked = ((Checkable) mActionView).isChecked();
     ...
     */
    private static class ImageToggle : ImageView : Checkable, View.OnClickListener {
