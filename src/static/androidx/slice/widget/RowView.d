...
public class RowView : SliceChildView : View.OnClickListener {
    ...
    private bool mIsHeader;
    private List<SliceItem> mHeaderActions;
    private bool mIsSingleItem;
     ...
     */
    public void setSingleItem(bool isSingleItem) {
    ...
    override
    public void setShowLastUpdated(bool showLastUpdated) {
     ...
     */
    override
    public void setSliceItem(SliceItem slice, bool isHeader, int index,
    ...
    private void populateViews() {
        ...
        bool showStart = startItem != null && mRowIndex > 0;
        if (showStart) {
        ...
        int itemCount = 0;
        bool firstItemIsADefaultToggle = false;
        bool hasEndItemAction = false;
        ...
        bool hasStartAction = startItem != null
    ...
    private void addSubtitle(final SliceItem subtitleItem) {
        ...
        bool subtitleExists = !TextUtils.isEmpty(subtitle)
    ...
    private void addRange(final SliceItem range) {
        final bool isSeekBar = FORMAT_ACTION.equals(range.getFormat());
    ...
    private void addAction(final SliceActionImpl actionContent, int color, ViewGroup container,
        ...
        bool isToggle = actionContent.isToggle();
     ...
     * timestamps.
     */
    private bool addItem(SliceItem sliceItem, int color, bool isStart) {
        ...
        View addedView = null;
        if (icon != null) {
            bool isIcon = imageMode == ICON_IMAGE;
    ...
    private void setViewClickable(View layout, bool isClickable) {
