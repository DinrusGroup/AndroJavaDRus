...
public class ListContent {
     ...
     */
    private bool populate(Slice slice) {
        ...
        for (int i = 0; i < children.size(); i++) {
            ...
            bool isNonRowContent = child.hasAnyHints(HINT_ACTIONS, HINT_SEE_MORE, HINT_KEYWORDS,
     ...
     */
    public int getHeight(Context context, SliceItem item, bool isHeader, int index,
            int count, int mode) {
     ...
     */
    public static int getRowType(Context context, SliceItem rowItem, bool isHeader,
     ...
     */
    public static bool isValidHeader(SliceItem sliceItem) {
