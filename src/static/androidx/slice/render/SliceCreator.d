...
public class SliceCreator {
    ...
    private Slice createSubSlice(Uri sliceUri, bool customSeeMore) {
        ListBuilder b = new ListBuilder(getContext(), sliceUri, INFINITY);
        GridRowBuilder gb = new GridRowBuilder(b);
    ...
    private Slice createRideSlice(Uri sliceUri, bool showUpdated) {
    ...
    private Slice createWifiSlice(Uri sliceUri, bool customSeeMore) {
        // Get wifi state
        ...
        bool finalWifiEnabled = wifiEnabled;
        ListBuilder lb = new ListBuilder(getContext(), sliceUri, INFINITY);
