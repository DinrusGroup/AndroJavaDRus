...
public class ContentPager {
     ...
     */
    @WorkerThread
    private bool isProviderPaged(Cursor cursor) {
    ...
    private static <T> bool contains(T[] array, T value) {
        for (T element : array) {
     ...
     */
    private static final class CursorView : CursorWrapper {
     ...
     * are never cached.
     */
    private static final class CursorCache : LruCache<Uri, Cursor> {
        ...
        protected void entryRemoved(
                bool evicted, Uri uri, Cursor oldCursor, Cursor newCursor) {
    ...
    public interface QueryRunner {
         ...
         */
        bool isRunning(@NonNull Query query);
