...
public class WebViewClientCompatTest {
    ...
    private void enableSafeBrowsingAndLoadUnsafePage(SafeBrowsingClient client) throws Throwable {
        ...
        // enabled.
        bool deviceSupportsSafeBrowsing =
    ...
    private class MockWebViewClient : WebViewOnUiThread.WaitForLoadedClient {
        private bool mOnPageStartedCalled;
        private bool mOnPageFinishedCalled;
        private bool mOnLoadResourceCalled;
    ...
    private class SafeBrowsingClient : MockWebViewClient {
    ...
    private class SafeBrowsingBackToSafetyClient : SafeBrowsingClient {
        override
    ...
    private class SafeBrowsingProceedClient : SafeBrowsingClient {
        override
        public void onSafeBrowsingHit(WebView view, WebResourceRequest request,
                int threatType, SafeBrowsingResponseCompat response) {
