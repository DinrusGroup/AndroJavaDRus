...
class WebViewOnUiThread {
    ...
    private abstract class ValueGetter<T> : Runnable {
        private T mValue;
     ...
     */
    private synchronized bool isLoaded() {
    ...
    private void pumpMessages() {
        class ExitLoopException : RuntimeException {
        }
     ...
     * directly.
     */
    public static class WaitForProgressClient : WebChromeClient {
     ...
     */
    public static class WaitForLoadedClient : WebViewClientCompat {
        private WebViewOnUiThread mOnUiThread;
