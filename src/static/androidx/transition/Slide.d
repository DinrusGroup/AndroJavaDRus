...
public class Slide : Visibility {
    ...
    private abstract static class CalculateSlideHorizontal : CalculateSlide {
    ...
    private abstract static class CalculateSlideVertical : CalculateSlide {
    ...
    private static final CalculateSlide sCalculateStart = new CalculateSlideHorizontal() {
        override
        public float getGoneX(ViewGroup sceneRoot, View view) {
            final bool isRtl = ViewCompat.getLayoutDirection(sceneRoot)
