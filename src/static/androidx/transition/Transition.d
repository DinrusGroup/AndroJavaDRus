 ...
 */
public abstract class Transition : Cloneable {
    ...
    private static bool isValidMatch(int match) {
        return (match >= MATCH_FIRST && match <= MATCH_LAST);
    }

    private static bool alreadyContains(int[] array, int searchIndex) {
    ...
    protected void createAnimators(ViewGroup sceneRoot, TransitionValuesMaps startValues,
        ...
        for (int i = 0; i < startValuesListCount; ++i) {
            ...
            bool isChanged = start == null || end == null || isTransitionRequired(start, end);
            if (isChanged) {
                if (DBG) {
     ...
     */
    bool isValidTarget(View target) {
     ...
     * @see #excludeTarget(Class, bool)
     * @see #excludeChildren(Class, bool)
     */
    @NonNull
     ...
     */
    private static <T> ArrayList<T> excludeObject(ArrayList<T> list, T target, bool exclude) {
        if (target != null) {
            if (exclude) {
     ...
     * @return This transition object.
     * @see #excludeChildren(View, bool)
     * @see #excludeTarget(int, bool)
     * @see #excludeTarget(Class, bool)
     */
    @NonNull
    public Transition excludeTarget(@NonNull View target, bool exclude) {
     ...
     *                 current list of excluded targets.
     * @return This transition object.
     * @see #excludeChildren(int, bool)
     * @see #excludeTarget(View, bool)
     * @see #excludeTarget(Class, bool)
     */
    @NonNull
    public Transition excludeTarget(@IdRes int targetId, bool exclude) {
     ...
     */
    @NonNull
    public Transition excludeTarget(@NonNull String targetName, bool exclude) {
     ...
     */
    @NonNull
    public Transition excludeChildren(@NonNull View target, bool exclude) {
     ...
     */
    @NonNull
    public Transition excludeChildren(@IdRes int targetId, bool exclude) {
     ...
     * are excluding targets or their children.
     */
    private ArrayList<Integer> excludeId(ArrayList<Integer> list, int targetId, bool exclude) {
        if (targetId > 0) {
            if (exclude) {
     ...
     * are excluding targets or their children.
     */
    private ArrayList<View> excludeView(ArrayList<View> list, View target, bool exclude) {
        if (target != null) {
            if (exclude) {
                list = ArrayListManager.add(list, target);
            } else {
     ...
     */
    @NonNull
    public Transition excludeTarget(@NonNull Class type, bool exclude) {
     ...
     */
    @NonNull
    public Transition excludeChildren(@NonNull Class type, bool exclude) {
     ...
     * are excluding targets or their children.
     */
    private ArrayList<Class> excludeType(ArrayList<Class> list, Class type, bool exclude) {
        if (type != null) {
            if (exclude) {
     ...
     *              otherwise.
     */
    private void captureHierarchy(View view, bool start) {
        if (view == null) {
            return;
        }
        int id = view.getId();
     ...
     */
    @Nullable
    public TransitionValues getTransitionValues(@NonNull View view, bool start) {
        if (mParent != null) {
        ...
        for (int i = numOldAnims - 1; i >= 0; i--) {
            ...
            if (anim != null) {
                ...
                if (oldInfo != null && oldInfo.mView != null
                    ...
                    bool cancel = (startValues != null || endValues != null)
     ...
     */
    public bool isTransitionRequired(@Nullable TransitionValues startValues,
    ...
    private static bool isValueChanged(TransitionValues oldValues, TransitionValues newValues,
            String key) {
    ...
    protected void animate(Animator animator) {
        // TODO: maybe pass auto-end as a bool parameter?
        if (animator == null) {
            end();
        } else {
            if (getDuration() >= 0) {
