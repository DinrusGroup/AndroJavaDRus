...
class TransitionUtils {
    ...
    private static final bool HAS_IS_ATTACHED_TO_WINDOW =
            Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT;
    private static final bool HAS_OVERLAY =
            Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN_MR2;
    private static final bool HAS_PICTURE_BITMAP =
    ...
    private static Bitmap createViewBitmap(View view, Matrix matrix, RectF bounds,
            ViewGroup sceneRoot) {
        final bool addToOverlay;
        final bool sceneRootIsAttached;
    ...
    static class MatrixEvaluator : TypeEvaluator<Matrix> {
