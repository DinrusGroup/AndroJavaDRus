...
public class SafeIterableMap<K, V> : Iterable<Map.Entry<K, V>> {
    ...
    private abstract static class ListIterator<K, V> : Iterator<Map.Entry<K, V>>,
            SupportRemove<K, V> {
    ...
    static class AscendingIterator<K, V> : ListIterator<K, V> {
    ...
    private static class DescendingIterator<K, V> : ListIterator<K, V> {
    ...
    private class IteratorWithAdditions : Iterator<Map.Entry<K, V>>, SupportRemove<K, V> {
    ...
    static class Entry<K, V> : Map.Entry<K, V> {
        @NonNull
        final K mKey;
        @NonNull
        final V mValue;
