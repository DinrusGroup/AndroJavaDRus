...
class AppCompatDelegateImpl : AppCompatDelegate
        : MenuBuilder.Callback, LayoutInflater.Factory2 {

    private static final bool DEBUG = false;
    private static final bool IS_PRE_LOLLIPOP = Build.VERSION.SDK_INT < 21;
    ...
    static {
        if (IS_PRE_LOLLIPOP && !sInstalledExceptionHandler) {
            ...
            Thread.setDefaultUncaughtExceptionHandler(new Thread.UncaughtExceptionHandler() {
                ...
                private bool shouldWrapException(Throwable throwable) {
    ...
    private bool mHandleNativeActionModes = true; // defaults to true
    ...
    private bool mFeatureProgress, mFeatureIndeterminateProgress;
    ...
    private bool mApplyDayNightCalled;
    ...
    override
    public bool hasWindowFeature(int featureId) {
        bool result = false;
    ...
    final bool shouldAnimateActionModeView() {
    ...
    override
    public void setHandleNativeActionModesEnabled(bool enabled) {
        mHandleNativeActionModes = enabled;
    }

    override
    public bool isHandleNativeActionModesEnabled() {
    ...
    bool onKeyShortcut(int keyCode, KeyEvent ev) {
    ...
    bool onKeyUp(int keyCode, KeyEvent event) {
        switch (keyCode) {
            ...
            case KeyEvent.KEYCODE_BACK:
                final bool wasLongPressBackDown = mLongPressBackDown;
    ...
    private bool shouldInheritContext(ViewParent parent) {
        if (parent == null) {
    ...
    private bool initializePanelDecor(PanelFeatureState st) {
    ...
    private void reopenMenu(MenuBuilder menu, bool toggleMenuMode) {
    ...
    private bool initializePanelMenu(final PanelFeatureState st) {
    ...
    private bool initializePanelContent(PanelFeatureState st) {
    ...
    private bool preparePanel(PanelFeatureState st, KeyEvent event) {
        if (mIsDestroyed) {
            return false;
        }
    ...
    void closePanel(PanelFeatureState st, bool doCallback) {
    ...
    private bool onKeyDownPanel(int featureId, KeyEvent event) {
    ...
    private bool onKeyUpPanel(int featureId, KeyEvent event) {
        if (mActionMode != null) {
            return false;
        }
    ...
    protected PanelFeatureState getPanelState(int featureId, bool required) {
    ...
    private bool performPanelShortcut(PanelFeatureState st, int keyCode, KeyEvent event,
            int flags) {
        if (event.isSystem()) {
            return false;
        }
     ...
     */
    private bool updateForNightMode(@ApplyableNightMode final int mode) {
    ...
    private bool shouldRecreateOnNightModeChange() {
     ...
     */
    class ActionModeCallbackWrapperV9 : ActionMode.Callback {
    ...
    private final class PanelMenuPresenterCallback : MenuPresenter.Callback {
    ...
    private class ListMenuDecorView : ContentFrameLayout {
    ...
    class AppCompatWindowCallback : WindowCallbackWrapper {
        ...
        public bool onPreparePanel(int featureId, View view, Menu menu) {
            ...
            final bool handled = super.onPreparePanel(featureId, view, menu);
    ...
    final class AutoNightModeManager {
        ...
        void dispatchTimeChanged() {
            final bool isNight = mTwilightManager.isNight();
            if (isNight != mIsNight) {
                mIsNight = isNight;
                applyDayNight();
            }
    ...
    private class ActionBarDrawableToggleImpl : ActionBarDrawerToggle.Delegate {
