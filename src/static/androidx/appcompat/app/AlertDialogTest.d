...
public class AlertDialogTest {
    ...
    private void verifyMultiChoiceItemsContent(String[] expectedContent,
        ...
        bool[] expectedAfterClick1 = checkedTracker.clone();
        ...
        bool[] expectedAfterClickLast = checkedTracker.clone();
    ...
    public void testMultiChoiceItemsFromRuntimeArray() {
        final String[] content = new String[] { "Alice", "Bob", "Charlie", "Delta" };
        final bool[] checkedTracker = new bool[] { false, true, false, false };
        AlertDialog.Builder builder = new AlertDialog.Builder(mActivityTestRule.getActivity())
                .setTitle(R.string.alert_dialog_title)
                .setMultiChoiceItems(
        ...
        // Pass the same bool[] array as used for initialization since our click listener
    ...
    public void testMultiChoiceItemsFromResourcesArray() {
        final bool[] checkedTracker = new bool[] { true, false, true, false };
        AlertDialog.Builder builder = new AlertDialog.Builder(mActivityTestRule.getActivity())
                .setTitle(R.string.alert_dialog_title)
    ...
    private static class TestDrawable : ColorDrawable {
        private int mWidth;
        private int mHeight;
