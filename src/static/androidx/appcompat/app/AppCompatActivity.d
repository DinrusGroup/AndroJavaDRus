 ...
 * </div>
 */
public class AppCompatActivity : FragmentActivity : AppCompatCallback,
    ...
    override
    public final bool onMenuItemSelected(int featureId, android.view.MenuItem item) {
     ...
     */
    @Deprecated
    public void setSupportProgressBarVisibility(bool visible) {
    }
     ...
     */
    @Deprecated
    public void setSupportProgressBarIndeterminateVisibility(bool visible) {
    }
     ...
     */
    @Deprecated
    public void setSupportProgressBarIndeterminate(bool indeterminate) {
    }
     ...
     */
    public bool supportShouldUpRecreateTask(@NonNull Intent targetIntent) {
     ...
     */
    private bool performMenuItemShortcut(int keycode, KeyEvent event) {
