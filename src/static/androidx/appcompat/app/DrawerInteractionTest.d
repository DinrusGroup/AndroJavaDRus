...
public class DrawerInteractionTest {
    ...
    private class TestDrawerLayout : DrawerLayout {
        ...
        public bool waitForLayouts(int seconds) throws InterruptedException {
            bool result = mLayoutCountDownLatch.await(seconds, TimeUnit.SECONDS);
    ...
    private class MockView : View {
        ...
        bool mDispatchGenericMotionEventCalled = false;
