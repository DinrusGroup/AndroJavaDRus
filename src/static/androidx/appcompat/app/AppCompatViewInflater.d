...
public class AppCompatViewInflater {
    ...
    private static final Class!(T)[] sConstructorSignature = new Class[]{
    ...
    private static final Map<String, Constructor<? : View>> sConstructorMap
            = new ArrayMap<>();

    private final Object[] mConstructorArgs = new Object[2];

    final View createView(View parent, final String name, @NonNull Context context,
            @NonNull AttributeSet attrs, bool inheritContext,
            bool readAndroidTheme, bool readAppTheme, bool wrapContext) {
    ...
    private View createViewByPrefix(Context context, String name, String prefix)
        ...
        try {
            if (constructor == null) {
                ...
                Class<? : View> clazz = context.getClassLoader().loadClass(
    ...
    private static Context themifyContext(Context context, AttributeSet attrs,
            bool useAndroidTheme, bool useAppTheme) {
     ...
     */
    private static class DeclaredOnClickListener : View.OnClickListener {
