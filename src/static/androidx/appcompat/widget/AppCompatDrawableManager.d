...
public final class AppCompatDrawableManager {
    ...
    private bool mHasCheckedVectorDrawableSetup;
    ...
    private Drawable tintDrawable(@NonNull Context context, @DrawableRes int resId,
            bool failIfNotKnown, @NonNull Drawable drawable) {
        ...
        if (tintList != null) {
            ...
            final bool tinted = tintDrawableUsingColorFilter(context, resId, drawable);
    ...
    private bool addDrawableToCache(@NonNull final Context context, final long key,
    ...
    static bool tintDrawableUsingColorFilter(@NonNull Context context,
            @DrawableRes final int resId, @NonNull Drawable drawable) {
        PorterDuff.Mode tintMode = DEFAULT_MODE;
        bool colorAttrSet = false;
        int colorAttr = 0;
        int alpha = -1;
    ...
    private static class ColorFilterLruCache : LruCache<Integer, PorterDuffColorFilter> {
    ...
    private static bool isVectorDrawable(@NonNull Drawable d) {
        return d instanceof VectorDrawableCompat
                || PLATFORM_VD_CLAZZ.equals(d.getClass().getName());
    }

    private static class VdcInflateDelegate : InflateDelegate {
        VdcInflateDelegate() {
        }
    ...
    private static class AvdcInflateDelegate : InflateDelegate {
        AvdcInflateDelegate() {
        }
