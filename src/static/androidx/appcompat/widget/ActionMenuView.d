 ...
 */
public class ActionMenuView : LinearLayoutCompat : MenuBuilder.ItemInvoker,
        MenuView {
     ...
     */
    @RestrictTo(LIBRARY_GROUP)
    protected bool hasSupportDividerBeforeChildAt(int childIndex) {
        if (childIndex == 0) {
            return false;
        }
    ...
    private class MenuBuilderCallback : MenuBuilder.Callback {
        MenuBuilderCallback() {
        }
    ...
    private static class ActionMenuPresenterCallback : ActionMenuPresenter.Callback {
    ...
    public static class LayoutParams : LinearLayoutCompat.LayoutParams {
