 ...
 * base view class.
 */
public abstract class AppCompatBaseAutoSizeTest<A : BaseTestActivity,
        T : TextView & AutoSizeableTextView> {
    ...
    public void testAutoSizeUniform_obtainStyledAttributesUsingPredefinedSizes() {
        ...
        bool containsValueFromExpectedSizes = false;
    ...
    private T prepareAndRetrieveAutoSizeTestData(final @IdRes int viewId,
            final bool shouldWrapLayoutContent) throws Throwable {
        mActivityTestRule.runOnUiThread(new Runnable() {
            override
            public void run() {
                LinearLayout ll = mActivity.findViewById(R.id.container);
    ...
    private final class DoubleTextTransformationMethod : TransformationMethod {
        ...
        override
        public void onFocusChanged(View view, CharSequence sourceText, bool focused,
