...
public class Toolbar : ViewGroup {
    ...
    private void addSystemView(View v, bool allowHide) {
    ...
    public bool onTouchEvent(MotionEvent ev) {
        ...
        if (!mEatingTouch) {
            final bool handled = super.onTouchEvent(ev);
    ...
    override
    public bool onHoverEvent(MotionEvent ev) {
        ...
        if (!mEatingHover) {
            final bool handled = super.onHoverEvent(ev);
    ...
    protected void onLayout(bool changed, int l, int t, int r, int b) {
        final bool isRtl =  ViewCompat.getLayoutDirection(this) ==  ViewCompat.LAYOUT_DIRECTION_RTL;
        ...
        final bool layoutTitle = shouldLayout(mTitleTextView);
        final bool layoutSubtitle = shouldLayout(mSubtitleTextView);
        int titleHeight = 0;
        if (layoutTitle) {
        ...
        if (layoutTitle || layoutSubtitle) {
            ...
            final bool titleHasWidth = (layoutTitle && (mTitleTextView.getMeasuredWidth() > 0))
    ...
    private bool shouldLayout(View view) {
    ...
    private static bool isCustomView(View child) {
    ...
    private bool isChildOrHidden(View child) {
     ...
     *
     * <p>Toolbar.LayoutParams : ActionBar.LayoutParams for compatibility with existing
     * ActionBar API. See
     ...
     */
    public static class LayoutParams : ActionBar.LayoutParams {
