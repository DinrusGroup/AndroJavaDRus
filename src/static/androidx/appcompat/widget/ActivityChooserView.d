...
public class ActivityChooserView : ViewGroup :
     ...
     */
    bool mIsSelectingDefaultActivity;
    ...
    void showPopupUnchecked(int maxActivityCount) {
        ...
        final bool defaultActivityButtonShown =
     ...
     */
    private class Callbacks : AdapterView.OnItemClickListener,
     ...
     */
    private class ActivityChooserViewAdapter : BaseAdapter {
        ...
        private bool mShowDefaultActivity;

        private bool mHighlightDefaultActivity;

        private bool mShowFooterView;
        ...
        public void setShowFooterView(bool showFooterView) {
        ...
        public void setShowDefaultActivity(bool showDefaultActivity,
                bool highlightDefaultActivity) {
        ...
        public bool getShowDefaultActivity() {
     ...
     */
    @RestrictTo(LIBRARY_GROUP)
    public static class InnerLayout : LinearLayout {
