...
public class ActionBarContextView : AbsActionBarView {
    ...
    private void initTitle() {
        ...
        final bool hasTitle = !TextUtils.isEmpty(mTitle);
        final bool hasSubtitle = !TextUtils.isEmpty(mSubtitle);
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (mTitleLayout != null && mCustomView == null) {
            if (mTitleOptional) {
                ...
                final bool titleFits = titleWidth <= availableWidth;
                if (titleFits) {
    ...
    public void setTitleOptional(bool titleOptional) {
