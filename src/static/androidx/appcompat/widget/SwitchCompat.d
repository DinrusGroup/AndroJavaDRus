 ...
 */
public class SwitchCompat : CompoundButton {
    ...
    private bool mHasThumbTint = false;
    private bool mHasThumbTintMode = false;

    private Drawable mTrackDrawable;
    private ColorStateList mTrackTintList = null;
    private PorterDuff.Mode mTrackTintMode = null;
    private bool mHasTrackTint = false;
    private bool mHasTrackTintMode = false;
    ...
    public void setSwitchTextAppearance(Context context, int resid) {
        ...
        bool allCaps = appearance.getBoolean(R.styleable.TextAppearance_textAllCaps, false);
        if (allCaps) {
     ...
     */
    public void setSplitTrack(bool splitTrack) {
    ...
    private void stopDrag(MotionEvent ev) {
        ...
        final bool commitChange = ev.getAction() == MotionEvent.ACTION_UP && isEnabled();
        final bool oldState = isChecked();
        final bool newState;
        if (commitChange) {
    ...
    private void animateThumbToCheckedState(final bool newCheckedState) {
