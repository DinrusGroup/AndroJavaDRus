...
public class AppCompatSpinnerTest
        : AppCompatBaseViewTest<AppCompatSpinnerActivity, AppCompatSpinner> {
    public AppCompatSpinnerTest() {
        super(AppCompatSpinnerActivity.class);
    }

    override
    protected bool hasBackgroundByDefault() {
    ...
    private void verifySpinnerPopupTheming(@IdRes int spinnerId,
            @ColorRes int expectedPopupColorResId, bool matchDropDownListView) {
