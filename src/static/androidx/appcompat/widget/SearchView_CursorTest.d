...
public class SearchView_CursorTest {
    ...
    protected class MyQueryTextListener : SearchView.OnQueryTextListener {
        override
        public bool onQueryTextSubmit(String s) {
            return false;
        }

        override
        public bool onQueryTextChange(String s) {
    ...
    // This should be protected to spy an object of this class.
    protected class MySuggestionListener : SearchView.OnSuggestionListener {
        override
