 ...
 * {@link #setIconifiedByDefault(bool) setIconifiedByDefault(false)}.
 * </p>
 *
 ...
 */
public class SearchView : LinearLayoutCompat : CollapsibleActionView {
    ...
    public bool requestFocus(int direction, Rect previouslyFocusedRect) {
        ...
        if (!isIconified()) {
            bool result = mSearchSrcTextView.requestFocus(direction, previouslyFocusedRect);
            if (result) {
     ...
     * text field.
     */
    public void setQuery(CharSequence query, bool submit) {
     ...
     */
    public void setIconifiedByDefault(bool iconified) {
     ...
     * {@link #setIconifiedByDefault(bool)}. If the default state is iconified, then
     ...
     * expand it.
     */
    public void setIconified(bool iconify) {
        if (iconify) {
            onCloseClicked();
        } else {
            onSearchClicked();
     ...
     */
    public void setQueryRefinementEnabled(bool enable) {
    ...
    private void updateViewsVisibility(final bool collapsed) {
        mIconified = collapsed;
        // Visibility of views that are visible when collapsed
        final int visCollapsed = collapsed ? VISIBLE : GONE;
        // Is there text in the query
        final bool hasText = !TextUtils.isEmpty(mSearchSrcTextView.getText());
    ...
    private void updateCloseButton() {
        ...
        final bool showClose = hasText || (mIconifiedByDefault && !mExpandedInActionView);
    ...
    void updateFocusedState() {
        final bool focused = mSearchSrcTextView.hasFocus();
     ...
     * EditText.
     */
    bool onSuggestionsKey(View v, int keyCode, KeyEvent event) {
    ...
    static class SavedState : AbsSavedState {
        bool isIconified;
    ...
    void adjustDropDownSizeAndPosition() {
        if (mDropDownAnchor.getWidth() > 1) {
            ...
            final bool isLayoutRtl = ViewUtils.isLayoutRtl(this);
    ...
    bool onItemClicked(int position, int actionKey, String actionMsg) {
    ...
    bool onItemSelected(int position) {
        if (mOnSuggestionListener == null
    ...
    private final OnItemSelectedListener mOnItemSelectedListener = new OnItemSelectedListener() {
         ...
         */
        override
        public void onItemSelected(AdapterView!(T) parent, View view, int position, long id) {
    ...
    static bool isLandscapeMode(Context context) {
    ...
    private static class UpdatableTouchDelegate : TouchDelegate {
        /**
     ...
     */
    @RestrictTo(LIBRARY_GROUP)
    public static class SearchAutoComplete : AppCompatAutoCompleteTextView {
        ...
        private void setImeVisibility(final bool visible) {
            final InputMethodManager imm = (InputMethodManager)
                        getContext().getSystemService(Context.INPUT_METHOD_SERVICE);
            if (!visible) {
                mHasPendingShowSoftInputRequest = false;
    ...
    private static class AutoCompleteTextViewReflector {
        ...
        AutoCompleteTextViewReflector() {
            ...
            try {
                ensureImeVisible = AutoCompleteTextView.class
                        .getMethod("ensureImeVisible", bool.class);
        ...
        void ensureImeVisible(AutoCompleteTextView view, bool visible) {
