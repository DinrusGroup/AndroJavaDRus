...
class DropDownListView : ListView {
    ...
    *
    * This bool is set to true whenever we explicitly hide the list's
    * selection and reset to false whenever we know the user moved the
    * selection back to the list.
    *
    * When this bool is true, isInTouchMode() returns true, otherwise it
    ...
    */
     ...
     */
    DropDownListView(Context context, bool hijackFocus) {
    ...
    protected void dispatchDraw(Canvas canvas) {
        final bool drawSelectorOnTop = false;
     ...
     */
    public int lookForSelectablePosition(int position, bool lookDown) {
    ...
    private static class GateKeeperDrawable : DrawableWrapper {
    ...
    override
    public bool onHoverEvent(@NonNull MotionEvent ev) {
     ...
     */
    public bool onForwardedEvent(MotionEvent event, int activePointerId) {
        bool handledEvent = true;
        bool clearPressedItem = false;
    ...
    private void positionSelectorLikeFocusCompat(int position, View sel) {
        ...
        final Drawable selector = getSelector();
        final bool manageState = selector != null && position != INVALID_POSITION;
        if (manageState) {
    ...
    private void positionSelectorCompat(int position, View sel) {
        ...
        try {
            ...
            // modify its value
            final bool isChildViewEnabled = mIsChildViewEnabled.getBoolean(this);
     ...
     */
    private class ResolveHoverRunnable : Runnable {
        override
        public void run() {
