 ...
 * side.
 */
final class CascadingMenuPopup : MenuPopup : MenuPresenter, OnKeyListener,
    ...
    public CascadingMenuPopup(@NonNull Context context, @NonNull View anchor,
            @AttrRes int popupStyleAttr, @StyleRes int popupStyleRes, bool overflowOnly) {
        mContext = context;
        mAnchorView = anchor;
    ...
    override
    public void setForceShowIcon(bool forceShow) {
    ...
    public void show() {
        ...
        if (mShownAnchorView != null) {
            final bool addGlobalListener = mTreeObserver == null;
    ...
    private void showMenu(@NonNull MenuBuilder menu) {
        ...
        if (parentView != null) {
            ...
            final bool showOnRight = nextMenuPosition == HORIZ_POSITION_RIGHT;
    ...
    override
    protected bool closeMenuOnSubMenuOpened() {
