...
public final class MenuItemImpl : SupportMenuItem {
    ...
    private bool mNeedToApplyIconTint = false;
     ...
     * change.  If unsure, use {@link #setVisible(bool)} instead.
     *
    ...
    override
    public MenuItem setVisible(bool shown) {
    ...
    public void setIsActionButton(bool isActionButton) {
        if (isActionButton) {
            mFlags |= IS_ACTION;
        } else {
            mFlags &= ~IS_ACTION;
