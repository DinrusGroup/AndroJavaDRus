...
public class DrawerLayoutActions {
    ...
    private static class CustomDrawerListener
            : DrawerLayout.DrawerListener, IdlingResource {
     ...
     */
    public static ViewAction openDrawer(final int drawerEdgeGravity, final bool animate) {
     ...
     * Closes the drawer at the specified edge gravity.
     */
    public static ViewAction closeDrawer(final int drawerEdgeGravity, final bool animate) {
        return wrap(new ViewAction() {
            override
            public Matcher<View> getConstraints() {
                return isAssignableFrom(DrawerLayout.class);
