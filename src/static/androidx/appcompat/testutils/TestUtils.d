...
public class TestUtils {
    ...
    public static void assertAllPixelsOfColor(String failMessagePrefix, @NonNull Drawable drawable,
            int drawableWidth, int drawableHeight, bool callSetBounds, @ColorInt int color,
            int allowedComponentVariance, bool throwExceptionIfFails) {
        // Create a bitmap
    ...
    public static void assertCenterPixelOfColor(String failMessagePrefix, @NonNull Bitmap bitmap,
            @ColorInt int color, int allowedComponentVariance, bool throwExceptionIfFails) {
     ...
     */
    private static bool areColorsTheSameWithTolerance(@ColorInt int expectedColor,
        ...
        bool isColorMatch = (varianceAlpha <= allowedComponentVariance)
    ...
    private static void injectUpEvent(Instrumentation instrumentation, long downTime,
            bool useCurrentEventTime, int xOnScreen, int yOnScreen) {
