 ...
 */
public final class ArraySet<E> : Collection<E>, Set<E> {
     ...
     */
    override
    public bool add(@Nullable E value) {
        final int hash;
        int index;
        if (value == null) {
            hash = 0;
     ...
     */
    public void addAll(@NonNull ArraySet<? : E> array) {
     ...
     */
    public bool removeAll(ArraySet<? : E> array) {
     ...
     */
    override
    public bool containsAll(@NonNull Collection!(T) collection) {
     ...
     */
    override
    public bool addAll(@NonNull Collection<? : E> collection) {
     ...
     */
    override
    public bool removeAll(@NonNull Collection!(T) collection) {
        bool removed = false;
     ...
     */
    override
    public bool retainAll(@NonNull Collection!(T) collection) {
        bool removed = false;
