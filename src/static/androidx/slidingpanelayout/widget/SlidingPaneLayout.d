 ...
 * pattern instead. ({@link androidx.drawerlayout.widget.DrawerLayout DrawerLayout} : this pattern.)</p>
 *
 ...
 */
public class SlidingPaneLayout : ViewGroup {
     ...
     */
    public static class SimplePanelSlideListener : PanelSlideListener {
        override
    ...
    void updateObscuredViewsVisibility(View panel) {
        final bool isLayoutRtl = isLayoutRtlSupport();
    ...
    private static bool viewIsOpaque(View v) {
        if (v.isOpaque()) {
            return true;
        }
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (canSlide || weightSum > 0) {
            ...
            for (int i = 0; i < childCount; i++) {
                ...
                final bool skippedFirstPass = lp.width == 0 && lp.weight > 0;
    ...
    public bool onInterceptTouchEvent(MotionEvent ev) {
        ...
        final bool interceptForDrag = mDragHelper.shouldInterceptTouchEvent(ev);
    ...
    private bool closePane(View pane, int initialVelocity) {
    ...
    private bool openPane(View pane, int initialVelocity) {
    ...
    private void parallaxOtherViews(float slideOffset) {
        ...
        final bool dimViews = slideLp.dimWhenOffset
    ...
    private class DisableLayerRunnable : Runnable {
