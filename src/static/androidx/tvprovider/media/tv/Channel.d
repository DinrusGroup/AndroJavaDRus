...
public final class Channel {
     ...
     */
    @RestrictTo(LIBRARY_GROUP)
    public ContentValues toContentValues(bool includeProtectedFields) {
    ...
    public static final class Builder {
         ...
         * @return This Builder object to allow for chaining of calls to builder methods.
         */
        public Builder setSearchable(bool searchable) {
         ...
         * @return This Builder object to allow for chaining of calls to builder methods.
         */
        public Builder setTransient(bool value) {
         ...
         */
        @RestrictTo(LIBRARY_GROUP)
        public Builder setBrowsable(bool value) {
         ...
         */
        @RestrictTo(LIBRARY_GROUP)
        public Builder setSystemApproved(bool value) {
         ...
         */
        @RestrictTo(LIBRARY_GROUP)
        public Builder setLocked(bool value) {
