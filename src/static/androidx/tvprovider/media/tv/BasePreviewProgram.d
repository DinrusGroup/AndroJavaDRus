 ...
 */
@RestrictTo(LIBRARY)
public abstract class BasePreviewProgram : BaseProgram {
    /**
     * @hide
     */
     ...
     */
    public abstract static class Builder<T : Builder> : BaseProgram.Builder<T> {
         ...
         * @see androidx.tvprovider.media.tv.TvContractCompat.PreviewPrograms#COLUMN_TRANSIENT
         */
        public T setTransient(bool transientValue) {
         ...
         */
        @RestrictTo(LIBRARY_GROUP)
        public T setBrowsable(bool browsable) {
