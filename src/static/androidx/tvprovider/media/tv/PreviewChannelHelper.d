...
public class PreviewChannelHelper {
    ...
    public long publishChannel(@NonNull PreviewChannel channel) throws IOException {
        try {
            ...
            bool logoAdded = addChannelLogo(channelId, channel);
    ...
    public void updatePreviewChannel(long channelId,
        ...
        if (update.isLogoChanged()) {
            bool logoAdded = addChannelLogo(channelId, update);
            if (!logoAdded) {
     ...
     */
    private bool addChannelLogo(long channelId, @NonNull PreviewChannel channel) {
        bool result = false;
