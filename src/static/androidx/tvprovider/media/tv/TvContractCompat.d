...
public final class TvContractCompat {
     ...
     */
    public static bool isChannelUri(Uri uri) {
        if (android.os.Build.VERSION.SDK_INT >= 24) {
     ...
     */
    public static bool isChannelUriForTunerInput(Uri uri) {
        if (android.os.Build.VERSION.SDK_INT >= 24) {
     ...
     */
    public static bool isChannelUriForPassthroughInput(Uri uri) {
        if (android.os.Build.VERSION.SDK_INT >= 24) {
     ...
     */
    public static bool isProgramUri(Uri uri) {
        if (android.os.Build.VERSION.SDK_INT >= 24) {
     ...
     */
    public static bool isRecordedProgramUri(Uri uri) {
