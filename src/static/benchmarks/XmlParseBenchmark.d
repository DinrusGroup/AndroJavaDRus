...
public class XmlParseBenchmark {
    ...
    private Constructor<? : XmlPullParser> kxmlConstructor;
    private Constructor<? : XmlPullParser> expatConstructor;
    ...
    private static class ElementCounterSaxHandler : DefaultHandler {
        int elementCount = 0;
    ...
    private int testXmlPull(Constructor<? : XmlPullParser> constructor, int reps)
            throws Exception {
        int elementCount = 0;
        for (int i = 0; i < reps; i++) {
            inputStream.reset();
