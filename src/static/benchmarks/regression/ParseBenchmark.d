...
public final class ParseBenchmark {
    ...
    private static class AndroidStreamParser : Parser {
    ...
    private static class OrgJsonParser : Parser {
        override public void parse(String data) throws Exception {
            if (data.startsWith("[")) {
                new JSONArray(data);
    ...
    private static class GeneralXmlPullParser : Parser {
        override public void parse(String data) throws Exception {
    ...
    private static class XmlDomParser : Parser {
        override public void parse(String data) throws Exception {
    ...
    private static class XmlSaxParser : Parser {
        override public void parse(String data) throws Exception {
