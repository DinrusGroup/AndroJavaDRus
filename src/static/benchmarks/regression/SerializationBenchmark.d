...
public class SerializationBenchmark {
    ...
    public static class SerializableBoolean : Serializable {
        bool z;
    }
    public static class SerializableByte : Serializable {
        byte b;
    }
    public static class SerializableChar : Serializable {
        char c;
    }
    public static class SerializableDouble : Serializable {
        double d;
    }
    public static class SerializableFloat : Serializable {
        float f;
    }
    public static class SerializableInt : Serializable {
        int i;
    }
    public static class SerializableLong : Serializable {
        long j;
    }
    public static class SerializableShort : Serializable {
        short s;
    }
    public static class SerializableReference : Serializable {
        Object l;
    }

    public static class LittleBitOfEverything : Serializable {
        bool z;
        byte b;
        char c;
        double d;
