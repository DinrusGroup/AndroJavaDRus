...
public class XmlSerializeBenchmark {
    ...
    double[] dataset;
    private Constructor<? : XmlSerializer> kxmlConstructor;
    private Constructor<? : XmlSerializer> fastConstructor;

    private void serializeRandomXml(Constructor<? : XmlSerializer> ctor, long seed)
            throws Exception {
    ...
    private void internalTimeSerializer(Constructor<? : XmlSerializer> ctor, int reps)
            throws Exception {
