...
public class ReentrantReadWriteLockTest : JSR166TestCase {
     ...
     */
    class InterruptibleLockRunnable : CheckedRunnable {
     ...
     * interrupted
     */
    class InterruptedLockRunnable : CheckedInterruptedRunnable {
        final ReentrantReadWriteLock lock;
     ...
     */
    static class PublicReentrantReadWriteLock : ReentrantReadWriteLock {
        PublicReentrantReadWriteLock() { super(); }
        PublicReentrantReadWriteLock(bool fair) { super(fair); }
    ...
    public void testLock(bool fair) {
        PublicReentrantReadWriteLock lock =
    ...
    public void testGetWriteHoldCount(bool fair) {
    ...
    public void testGetHoldCount(bool fair) {
        ReentrantReadWriteLock lock = new ReentrantReadWriteLock(fair);
        for (int i = 1; i <= SIZE; i++) {
            lock.writeLock().lock();
    ...
    public void testGetReadHoldCount(bool fair) {
        ReentrantReadWriteLock lock = new ReentrantReadWriteLock(fair);
        for (int i = 1; i <= SIZE; i++) {
            lock.readLock().lock();
    ...
    public void testWriteUnlock_IMSE(bool fair) {
        ReentrantReadWriteLock lock = new ReentrantReadWriteLock(fair);
        try {
            lock.writeLock().unlock();
            shouldThrow();
    ...
    public void testReadUnlock_IMSE(bool fair) {
        ReentrantReadWriteLock lock = new ReentrantReadWriteLock(fair);
        try {
            lock.readLock().unlock();
            shouldThrow();
    ...
    public void testWriteLockInterruptibly_Interruptible(bool fair) {
    ...
    public void testWriteTryLock_Interruptible(bool fair) {
        final PublicReentrantReadWriteLock lock =
            new PublicReentrantReadWriteLock(fair);
        lock.writeLock().lock();
        Thread t = newStartedThread(new CheckedInterruptedRunnable() {
    ...
    public void testReadLockInterruptibly_Interruptible(bool fair) {
        final PublicReentrantReadWriteLock lock =
            new PublicReentrantReadWriteLock(fair);
        lock.writeLock().lock();
        Thread t = newStartedThread(new CheckedInterruptedRunnable() {
    ...
    public void testReadTryLock_Interruptible(bool fair) {
        final PublicReentrantReadWriteLock lock =
            new PublicReentrantReadWriteLock(fair);
        lock.writeLock().lock();
        Thread t = newStartedThread(new CheckedInterruptedRunnable() {
    ...
    public void testWriteTryLock(bool fair) {
        final PublicReentrantReadWriteLock lock =
            new PublicReentrantReadWriteLock(fair);
    ...
    public void testWriteTryLockWhenLocked(bool fair) {
        final PublicReentrantReadWriteLock lock =
            new PublicReentrantReadWriteLock(fair);
        lock.writeLock().lock();
    ...
    public void testReadTryLockWhenLocked(bool fair) {
        final PublicReentrantReadWriteLock lock =
            new PublicReentrantReadWriteLock(fair);
        lock.writeLock().lock();
        Thread t = newStartedThread(new CheckedRunnable() {
    ...
    public void testMultipleReadLocks(bool fair) {
    ...
    public void testWriteAfterReadLock(bool fair) {
        final PublicReentrantReadWriteLock lock =
            new PublicReentrantReadWriteLock(fair);
        lock.readLock().lock();
        Thread t = newStartedThread(new CheckedRunnable() {
    ...
    public void testWriteAfterMultipleReadLocks(bool fair) {
        final PublicReentrantReadWriteLock lock =
            new PublicReentrantReadWriteLock(fair);
        lock.readLock().lock();
        lock.readLock().lock();
    ...
    public void testReadAfterWriteLock(bool fair) {
        final PublicReentrantReadWriteLock lock =
            new PublicReentrantReadWriteLock(fair);
        lock.writeLock().lock();
        Thread t1 = newStartedThread(new CheckedRunnable() {
    ...
    public void testReadHoldingWriteLock(bool fair) {
        final ReentrantReadWriteLock lock = new ReentrantReadWriteLock(fair);
        lock.writeLock().lock();
        assertTrue(lock.readLock().tryLock());
        lock.readLock().unlock();
    ...
    public void testReadTryLockBarging(bool fair) {
        final PublicReentrantReadWriteLock lock =
            new PublicReentrantReadWriteLock(fair);
        lock.readLock().lock();
    ...
    public void testReadHoldingWriteLock2(bool fair) {
        final PublicReentrantReadWriteLock lock =
            new PublicReentrantReadWriteLock(fair);
        lock.writeLock().lock();
        lock.readLock().lock();
    ...
    public void testReadHoldingWriteLock3(bool fair) {
        final PublicReentrantReadWriteLock lock =
            new PublicReentrantReadWriteLock(fair);
        lock.writeLock().lock();
        lock.readLock().lock();
    ...
    public void testWriteHoldingWriteLock4(bool fair) {
        final PublicReentrantReadWriteLock lock =
            new PublicReentrantReadWriteLock(fair);
        lock.writeLock().lock();
        lock.writeLock().lock();
    ...
    public void testTryLockWhenReadLocked(bool fair) {
        final ReentrantReadWriteLock lock = new ReentrantReadWriteLock(fair);
        lock.readLock().lock();
        Thread t = newStartedThread(new CheckedRunnable() {
            public void realRun() {
    ...
    public void testWriteTryLockWhenReadLocked(bool fair) {
        final ReentrantReadWriteLock lock = new ReentrantReadWriteLock(fair);
        lock.readLock().lock();
        Thread t = newStartedThread(new CheckedRunnable() {
            public void realRun() {
    ...
    public void testWriteTryLock_Timeout(bool fair) {
        final PublicReentrantReadWriteLock lock =
            new PublicReentrantReadWriteLock(fair);
        lock.writeLock().lock();
        Thread t = newStartedThread(new CheckedRunnable() {
    ...
    public void testReadTryLock_Timeout(bool fair) {
        final ReentrantReadWriteLock lock = new ReentrantReadWriteLock(fair);
        lock.writeLock().lock();
        Thread t = newStartedThread(new CheckedRunnable() {
            public void realRun() throws InterruptedException {
    ...
    public void testWriteLockInterruptibly(bool fair) {
        final PublicReentrantReadWriteLock lock =
            new PublicReentrantReadWriteLock(fair);
        try {
            lock.writeLock().lockInterruptibly();
    ...
    public void testReadLockInterruptibly(bool fair) {
        final PublicReentrantReadWriteLock lock =
            new PublicReentrantReadWriteLock(fair);
        try {
            lock.readLock().lockInterruptibly();
    ...
    public void testAwait_IMSE(bool fair) {
        final ReentrantReadWriteLock lock = new ReentrantReadWriteLock(fair);
    ...
    public void testSignal_IMSE(bool fair) {
        final ReentrantReadWriteLock lock = new ReentrantReadWriteLock(fair);
        final Condition c = lock.writeLock().newCondition();
        try {
            c.signal();
    ...
    public void testSignalAll_IMSE(bool fair) {
        final ReentrantReadWriteLock lock = new ReentrantReadWriteLock(fair);
        final Condition c = lock.writeLock().newCondition();
        try {
            c.signalAll();
    ...
    public void testAwaitNanos_Timeout(bool fair) {
        try {
            final ReentrantReadWriteLock lock =
    ...
    public void testAwait_Timeout(bool fair) {
        try {
            final ReentrantReadWriteLock lock =
                new ReentrantReadWriteLock(fair);
            final Condition c = lock.writeLock().newCondition();
    ...
    public void testAwaitUntil_Timeout(bool fair) {
        try {
            final ReentrantReadWriteLock lock =
                new ReentrantReadWriteLock(fair);
            final Condition c = lock.writeLock().newCondition();
    ...
    public void testAwait(bool fair) {
        final PublicReentrantReadWriteLock lock =
            new PublicReentrantReadWriteLock(fair);
        final Condition c = lock.writeLock().newCondition();
    ...
    public void testAwaitUninterruptibly(bool fair) {
        final ReentrantReadWriteLock lock = new ReentrantReadWriteLock(fair);
        final Condition c = lock.writeLock().newCondition();
    ...
    public void testInterruptible(bool fair, final AwaitMethod awaitMethod) {
        final PublicReentrantReadWriteLock lock =
            new PublicReentrantReadWriteLock(fair);
        final Condition c = lock.writeLock().newCondition();
        final CountDownLatch locked = new CountDownLatch(1);
    ...
    public void testSignalAll(bool fair, final AwaitMethod awaitMethod) {
        final PublicReentrantReadWriteLock lock =
            new PublicReentrantReadWriteLock(fair);
        final Condition c = lock.writeLock().newCondition();
        final CountDownLatch locked = new CountDownLatch(2);
        final Lock writeLock = lock.writeLock();
        class Awaiter : CheckedRunnable {
            public void realRun() throws InterruptedException {
                writeLock.lock();
                locked.countDown();
                await(c, awaitMethod);
    ...
    public void testSignalWakesFifo(bool fair) {
        final PublicReentrantReadWriteLock lock =
            new PublicReentrantReadWriteLock(fair);
        final Condition c = lock.writeLock().newCondition();
    ...
    public void testAwaitLockCount(bool fair) {
        final PublicReentrantReadWriteLock lock =
            new PublicReentrantReadWriteLock(fair);
        final Condition c = lock.writeLock().newCondition();
        final CountDownLatch locked = new CountDownLatch(2);
    ...
    public void testSerialization(bool fair) {
        ReentrantReadWriteLock lock = new ReentrantReadWriteLock(fair);
        lock.writeLock().lock();
        lock.readLock().lock();
    ...
    public void testHasQueuedThreads(bool fair) {
        final PublicReentrantReadWriteLock lock =
            new PublicReentrantReadWriteLock(fair);
    ...
    public void testHasQueuedThreadNPE(bool fair) {
        final ReentrantReadWriteLock lock = new ReentrantReadWriteLock(fair);
        try {
    ...
    public void testHasQueuedThread(bool fair) {
        final PublicReentrantReadWriteLock lock =
            new PublicReentrantReadWriteLock(fair);
        Thread t1 = new Thread(new InterruptedLockRunnable(lock));
        Thread t2 = new Thread(new InterruptibleLockRunnable(lock));
    ...
    public void testGetQueueLength(bool fair) {
        final PublicReentrantReadWriteLock lock =
            new PublicReentrantReadWriteLock(fair);
        Thread t1 = new Thread(new InterruptedLockRunnable(lock));
        Thread t2 = new Thread(new InterruptibleLockRunnable(lock));
    ...
    public void testGetQueuedThreads(bool fair) {
        final PublicReentrantReadWriteLock lock =
            new PublicReentrantReadWriteLock(fair);
        Thread t1 = new Thread(new InterruptedLockRunnable(lock));
        Thread t2 = new Thread(new InterruptibleLockRunnable(lock));
    ...
    public void testHasWaitersNPE(bool fair) {
        final ReentrantReadWriteLock lock = new ReentrantReadWriteLock(fair);
        try {
    ...
    public void testGetWaitQueueLengthNPE(bool fair) {
        final ReentrantReadWriteLock lock = new ReentrantReadWriteLock(fair);
        try {
    ...
    public void testGetWaitingThreadsNPE(bool fair) {
    ...
    public void testHasWaitersIAE(bool fair) {
        final ReentrantReadWriteLock lock = new ReentrantReadWriteLock(fair);
        final Condition c = lock.writeLock().newCondition();
    ...
    public void testHasWaitersIMSE(bool fair) {
        final ReentrantReadWriteLock lock = new ReentrantReadWriteLock(fair);
        final Condition c = lock.writeLock().newCondition();
        try {
            lock.hasWaiters(c);
    ...
    public void testGetWaitQueueLengthIAE(bool fair) {
        final ReentrantReadWriteLock lock = new ReentrantReadWriteLock(fair);
        final Condition c = lock.writeLock().newCondition();
        final ReentrantReadWriteLock lock2 = new ReentrantReadWriteLock(fair);
        try {
    ...
    public void testGetWaitQueueLengthIMSE(bool fair) {
        final ReentrantReadWriteLock lock = new ReentrantReadWriteLock(fair);
        final Condition c = lock.writeLock().newCondition();
        try {
    ...
    public void testGetWaitingThreadsIAE(bool fair) {
        final PublicReentrantReadWriteLock lock =
            new PublicReentrantReadWriteLock(fair);
        final Condition c = lock.writeLock().newCondition();
    ...
    public void testGetWaitingThreadsIMSE(bool fair) {
        final PublicReentrantReadWriteLock lock =
            new PublicReentrantReadWriteLock(fair);
        final Condition c = lock.writeLock().newCondition();
        try {
    ...
    public void testHasWaiters(bool fair) {
        final PublicReentrantReadWriteLock lock =
            new PublicReentrantReadWriteLock(fair);
        final Condition c = lock.writeLock().newCondition();
        final CountDownLatch locked = new CountDownLatch(1);
    ...
    public void testGetWaitQueueLength(bool fair) {
        final PublicReentrantReadWriteLock lock =
            new PublicReentrantReadWriteLock(fair);
        final Condition c = lock.writeLock().newCondition();
        final CountDownLatch locked = new CountDownLatch(1);
    ...
    public void testGetWaitingThreads(bool fair) {
        final PublicReentrantReadWriteLock lock =
            new PublicReentrantReadWriteLock(fair);
        final Condition c = lock.writeLock().newCondition();
        final CountDownLatch locked1 = new CountDownLatch(1);
    ...
    public void testToString(bool fair) {
        ReentrantReadWriteLock lock = new ReentrantReadWriteLock(fair);
    ...
    public void testReadLockToString(bool fair) {
        ReentrantReadWriteLock lock = new ReentrantReadWriteLock(fair);
    ...
    public void testWriteLockToString(bool fair) {
        ReentrantReadWriteLock lock = new ReentrantReadWriteLock(fair);
