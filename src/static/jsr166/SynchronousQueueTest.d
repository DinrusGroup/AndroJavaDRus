...
public class SynchronousQueueTest : JSR166TestCase {

    // android-note: These tests have been moved into their own separate
    // classes to work around CTS issues.
    //
    // public static class Fair : BlockingQueueTest {
    //     protected BlockingQueue emptyCollection() {
    //         return new SynchronousQueue(true);
    //     }
    // }

    // public static class NonFair : BlockingQueueTest {
    //     protected BlockingQueue emptyCollection() {
    ...
    public void testEmptyFull(bool fair) {
    ...
    public void testOffer(bool fair) {
    ...
    public void testAddAll_self(bool fair) {
        SynchronousQueue q = new SynchronousQueue(fair);
        try {
            q.addAll(q);
            shouldThrow();
    ...
    public void testAddAll_ISE(bool fair) {
        SynchronousQueue q = new SynchronousQueue(fair);
    ...
    public void testBlockingPut(bool fair) {
        final SynchronousQueue q = new SynchronousQueue(fair);
    ...
    public void testPutWithTake(bool fair) {
        final SynchronousQueue q = new SynchronousQueue(fair);
    ...
    public void testTimedOffer(bool fair) {
        final SynchronousQueue q = new SynchronousQueue(fair);
        final CountDownLatch pleaseInterrupt = new CountDownLatch(1);
        Thread t = newStartedThread(new CheckedRunnable() {
            public void realRun() throws InterruptedException {
    ...
    public void testPoll(bool fair) {
        final SynchronousQueue q = new SynchronousQueue(fair);
        assertNull(q.poll());
    }
    ...
    public void testTimedPoll0(bool fair) {
        final SynchronousQueue q = new SynchronousQueue(fair);
    ...
    public void testTimedPoll(bool fair) {
        final SynchronousQueue q = new SynchronousQueue(fair);
        long startTime = System.nanoTime();
    ...
    public void testTimedPollWithOffer(bool fair) {
        final SynchronousQueue q = new SynchronousQueue(fair);
    ...
    public void testPeek(bool fair) {
        final SynchronousQueue q = new SynchronousQueue(fair);
        assertNull(q.peek());
    }
    ...
    public void testElement(bool fair) {
        final SynchronousQueue q = new SynchronousQueue(fair);
        try {
            q.element();
            shouldThrow();
    ...
    public void testRemove(bool fair) {
        final SynchronousQueue q = new SynchronousQueue(fair);
        try {
            q.remove();
            shouldThrow();
    ...
    public void testContains(bool fair) {
        final SynchronousQueue q = new SynchronousQueue(fair);
    ...
    public void testClear(bool fair) {
        final SynchronousQueue q = new SynchronousQueue(fair);
        q.clear();
        assertTrue(q.isEmpty());
    }
    ...
    public void testContainsAll(bool fair) {
        final SynchronousQueue q = new SynchronousQueue(fair);
    ...
    public void testRetainAll(bool fair) {
        final SynchronousQueue q = new SynchronousQueue(fair);
        Integer[] empty = new Integer[0];
    ...
    public void testRemoveAll(bool fair) {
        final SynchronousQueue q = new SynchronousQueue(fair);
        Integer[] empty = new Integer[0];
    ...
    public void testToArray(bool fair) {
        final SynchronousQueue q = new SynchronousQueue(fair);
        Object[] o = q.toArray();
    ...
    public void testToArray2(bool fair) {
    ...
    public void testToArray_null(bool fair) {
        final SynchronousQueue q = new SynchronousQueue(fair);
        try {
    ...
    public void testIterator(bool fair) {
    ...
    public void testIteratorRemove(bool fair) {
        final SynchronousQueue q = new SynchronousQueue(fair);
    ...
    public void testOfferInExecutor(bool fair) {
        final SynchronousQueue q = new SynchronousQueue(fair);
    ...
    public void testPollInExecutor(bool fair) {
        final SynchronousQueue q = new SynchronousQueue(fair);
        final CheckedBarrier threadsStarted = new CheckedBarrier(2);
        final ExecutorService executor = Executors.newFixedThreadPool(2);
        try (PoolCleaner cleaner = cleaner(executor)) {
    ...
    public void testDrainTo(bool fair) {
        final SynchronousQueue q = new SynchronousQueue(fair);
    ...
    public void testDrainToWithActivePut(bool fair) {
        final SynchronousQueue q = new SynchronousQueue(fair);
        Thread t = newStartedThread(new CheckedRunnable() {
            public void realRun() throws InterruptedException {
                q.put(one);
    ...
    public void testNeverContainsNull() {
        Collection!(T) q = new SynchronousQueue();
