...
public class CountedCompleterTest : JSR166TestCase {
    ...
    void checkCompletedNormally(CountedCompleter!(T) a) {
        assertTrue(a.isDone());
        assertFalse(a.isCancelled());
        assertTrue(a.isCompletedNormally());
        assertFalse(a.isCompletedAbnormally());
    ...
    abstract class CheckedCC : CountedCompleter<Object> {
        ...
        public bool onExceptionalCompletion(Throwable ex,
    ...
    abstract class FailingCCF : CheckedCC {
        int number;
        int rnumber;
