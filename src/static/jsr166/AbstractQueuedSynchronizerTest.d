...
public class AbstractQueuedSynchronizerTest : JSR166TestCase {
    ...
    static class Mutex : AbstractQueuedSynchronizer {
        ...
        public bool tryAcquireNanos(long nanos) throws InterruptedException {
     ...
     */
    static class BooleanLatch : AbstractQueuedSynchronizer {
        public bool isSignalled() { return getState() != 0; }

        public int tryAcquireShared(int ignore) {
            return isSignalled() ? 1 : -1;
        }

        public bool tryReleaseShared(int ignore) {
            setState(1);
            return true;
        }
    }
     ...
     * be interrupted.
     */
    class InterruptibleSyncRunnable : CheckedRunnable {
        final Mutex sync;
     ...
     * interrupted.
     */
    class InterruptedSyncRunnable : CheckedInterruptedRunnable {
        final Mutex sync;
