...
public class ForkJoinPool8Test : JSR166TestCase {
    ...
    public static final class FJException : RuntimeException {
        public FJException() { super(); }
        public FJException(Throwable cause) { super(cause); }
    }

    // A simple recursive action for testing
    final class FibAction : CheckedRecursiveAction {
        final int number;
        int result;
    ...
    static final class FailingFibAction : RecursiveAction {
        final int number;
        int result;
    ...
    abstract static class CCF : CountedCompleter {
        int number;
        int rnumber;
    ...
    abstract static class FailingCCF : CountedCompleter {
        int number;
        int rnumber;
    ...
    static final class LFCCF : FailingCCF {
    ...
    static final class RFCCF : FailingCCF {
        ...
        try (PoolCleaner cleaner = cleaner(p)) {
            ...
            ForkJoinTask a = new CheckedRecursiveAction() {
                protected void realCompute() {
                    ...
                    bool quiescent = p.awaitQuiescence(LONG_DELAY_MS, MILLISECONDS);
