 ...
 * </ul>
 */
public class JSR166TestCase : TestCase {
    private static final bool useSecurityManager =
        Boolean.getBoolean("jsr166.useSecurityManager");

    protected static final bool expensiveTests =
     ...
     */
    protected static final bool testImplementationDetails =
     ...
     */
    private static final bool profileTests =
...
//     }
    ...
    // static class PithyResultPrinter : junit.textui.ResultPrinter {
    ...
    public static TestSuite newTestSuite(Object... suiteOrClasses) {
        ...
        for (Object suiteOrClass : suiteOrClasses) {
            if (suiteOrClass instanceof TestSuite)
                ...
                suite.addTest(new TestSuite((Class!(T)) suiteOrClass));
            else
    ...
    public static void addNamedTestClasses(TestSuite suite,
        ...
        for (String testClassName : testClassNames) {
            try {
                Class!(T) testClass = Class.forName(testClassName);
    ...
    public static bool atLeastJava6() { return JAVA_CLASS_VERSION >= 50.0; }
    public static bool atLeastJava7() { return JAVA_CLASS_VERSION >= 51.0; }
    public static bool atLeastJava8() { return JAVA_CLASS_VERSION >= 52.0; }
    public static bool atLeastJava9() {
        return JAVA_CLASS_VERSION >= 53.0
            // As of 2015-09, java9 still uses 52.0 class file version
            || JAVA_SPECIFICATION_VERSION.matches("^(1\\.)?(9|[0-9][0-9])$");
    }
    public static bool atLeastJava10() {
    ...
    public static ArrayList<String> testMethodNames(Class!(T) testClass) {
    ...
    public static <ExtraData> Test parameterizedTestSuite
        (Class<? : JSR166TestCase> testClass,
     ...
     */
    class PoolCleaner : AutoCloseable {
     ...
     */
    class PoolCleanerWithReleaser : PoolCleaner {
    ...
    void testInParallel(Action ... actions) {
        ...
        try (PoolCleaner cleaner = cleaner(pool)) {
            ArrayList<Future!(T)> futures = new ArrayList<>(actions.length);
     ...
     * or all cleared.
     */
    public static class AdjustablePolicy : java.security.Policy {
        ...
        public bool implies(ProtectionDomain pd, Permission p) {
...
//     }
    ...
    public abstract class CheckedRunnable : Runnable {
    ...
    public abstract class RunnableShouldThrow : Runnable {
        protected abstract void realRun() throws Throwable;

        final Class!(T) exceptionClass;

        <T : Throwable> RunnableShouldThrow(Class<T> exceptionClass) {
    ...
    public abstract class ThreadShouldThrow : Thread {
        protected abstract void realRun() throws Throwable;

        final Class!(T) exceptionClass;

        <T : Throwable> ThreadShouldThrow(Class<T> exceptionClass) {
            this.exceptionClass = exceptionClass;
        }
    ...
    public abstract class CheckedInterruptedRunnable : Runnable {
        protected abstract void realRun() throws Throwable;
    ...
    public abstract class CheckedCallable<T> : Callable<T> {
    ...
    public static class NoOpRunnable : Runnable {
        public void run() {}
    }

    public static class NoOpCallable : Callable {
        public Object call() { return Boolean.TRUE; }
    }

    public static final String TEST_STRING = "a test string";

    public static class StringTask : Callable<String> {
        final String value;
    ...
    class LatchAwaiter : CheckedRunnable {
...
//     }
    ...
    public static class NPETask : Callable<String> {
        public String call() { throw new NullPointerException(); }
    }

    public static class CallableOne : Callable<Integer> {
        public Integer call() { return one; }
    }

    public class ShortRunnable : CheckedRunnable {
        protected void realRun() throws Throwable {
            delay(SHORT_DELAY_MS);
        }
    }

    public class ShortInterruptedRunnable : CheckedInterruptedRunnable {
        protected void realRun() throws InterruptedException {
            delay(SHORT_DELAY_MS);
        }
    }

    public class SmallRunnable : CheckedRunnable {
        protected void realRun() throws Throwable {
            delay(SMALL_DELAY_MS);
        }
    }

    public class SmallPossiblyInterruptedRunnable : CheckedRunnable {
    ...
    public class SmallCallable : CheckedCallable {
    ...
    public class MediumRunnable : CheckedRunnable {
        protected void realRun() throws Throwable {
            delay(MEDIUM_DELAY_MS);
        }
    }

    public class MediumInterruptedRunnable : CheckedInterruptedRunnable {
        protected void realRun() throws InterruptedException {
            delay(MEDIUM_DELAY_MS);
        }
    }
    ...
    public class MediumPossiblyInterruptedRunnable : CheckedRunnable {
        protected void realRun() {
            try {
                delay(MEDIUM_DELAY_MS);
            } catch (InterruptedException ok) {}
    ...
    public class LongPossiblyInterruptedRunnable : CheckedRunnable {
        protected void realRun() {
            try {
                delay(LONG_DELAY_MS);
            } catch (InterruptedException ok) {}
     ...
     */
    public static class SimpleThreadFactory : ThreadFactory {
        public Thread newThread(Runnable r) {
            return new Thread(r);
        }
    }

    public interface TrackedRunnable : Runnable {
        bool isDone();
    }
    ...
    public static class TrackedShortRunnable : Runnable {
    ...
    public static class TrackedSmallRunnable : Runnable {
        public volatile bool done = false;
        public void run() {
            try {
                delay(SMALL_DELAY_MS);
    ...
    public static class TrackedMediumRunnable : Runnable {
        public volatile bool done = false;
        public void run() {
            try {
                delay(MEDIUM_DELAY_MS);
    ...
    public static class TrackedLongRunnable : Runnable {
        public volatile bool done = false;
        public void run() {
            try {
                delay(LONG_DELAY_MS);
    ...
    public static class TrackedNoOpRunnable : Runnable {
        public volatile bool done = false;
        public void run() {
            done = true;
        }
    ...
    public static class TrackedCallable : Callable {
        public volatile bool done = false;
        public Object call() {
            try {
                delay(SMALL_DELAY_MS);
     ...
     */
    public abstract class CheckedRecursiveAction : RecursiveAction {
     ...
     */
    public abstract class CheckedRecursiveTask<T> : RecursiveTask<T> {
     ...
     */
    public static class NoOpREHandler : RejectedExecutionHandler {
     ...
     */
    public class CheckedBarrier : CyclicBarrier {
    ...
    public void assertThrows(Class<? : Throwable> expectedExceptionClass,
    ...
    public void assertIteratorExhausted(Iterator!(T) it) {
        try {
            it.next();
            shouldThrow();
        } catch (NoSuchElementException success) {}
