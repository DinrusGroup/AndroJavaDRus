...
public class SemaphoreTest : JSR166TestCase {
     ...
     */
    static class PublicSemaphore : Semaphore {
        PublicSemaphore(int permits) { super(permits); }
        PublicSemaphore(int permits, bool fair) { super(permits, fair); }
        public Collection<Thread> getQueuedThreads() {
            return super.getQueuedThreads();
        }
        public bool hasQueuedThread(Thread t) {
    ...
    public void testConstructor(bool fair) {
    ...
    public void testTryAcquireInSameThread(bool fair) {
    ...
    public void testTryAcquire_timeout(bool fair) {
    ...
    public void testTryAcquireN_timeout(bool fair) {
        Semaphore s = new Semaphore(2, fair);
        long startTime = System.nanoTime();
    ...
    public void testInterruptible(bool fair, final AcquireMethod acquirer) {
    ...
    public void testUninterruptible(bool fair, final AcquireMethod acquirer) {
        final PublicSemaphore s = new PublicSemaphore(0, fair);
    ...
    public void testDrainPermits(bool fair) {
        Semaphore s = new Semaphore(0, fair);
        assertEquals(0, s.availablePermits());
    ...
    public void testReleaseIAE(bool fair) {
    ...
    public void testReducePermitsIAE(bool fair) {
    ...
    public void testReducePermits(bool fair) {
        PublicSemaphore s = new PublicSemaphore(10, fair);
        assertEquals(10, s.availablePermits());
        s.reducePermits(0);
        assertEquals(10, s.availablePermits());
    ...
    public void testTryAcquireNInSameThread(bool fair) {
        Semaphore s = new Semaphore(2, fair);
        assertEquals(2, s.availablePermits());
    ...
    public void testReleaseAcquireSameThread(bool fair,
    ...
    public void testReleaseAcquireDifferentThreads(bool fair,
                                                   final AcquireMethod acquirer) {
