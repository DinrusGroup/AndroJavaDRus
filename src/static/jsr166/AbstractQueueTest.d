...
public class AbstractQueueTest : JSR166TestCase {
    ...
    static class Succeed : AbstractQueue<Integer> {
        public bool offer(Integer x) {
    ...
    static class Fail : AbstractQueue<Integer> {
        public bool offer(Integer x) {
            if (x == null) throw new NullPointerException();
            return false;
        }
