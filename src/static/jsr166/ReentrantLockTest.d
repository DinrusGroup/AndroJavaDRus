...
public class ReentrantLockTest : JSR166TestCase {
     ...
     */
    static class PublicReentrantLock : ReentrantLock {
        PublicReentrantLock() { super(); }
        PublicReentrantLock(bool fair) { super(fair); }
    ...
    public void testUnlock_IMSE(bool fair) {
    ...
    public void testTryLock(bool fair) {
        PublicReentrantLock lock = new PublicReentrantLock(fair);
    ...
    public void testTryLock_Interruptible(bool fair) {
        final PublicReentrantLock lock = new PublicReentrantLock(fair);
        lock.lock();
    ...
    public void testTryLockWhenLocked(bool fair) {
        final PublicReentrantLock lock = new PublicReentrantLock(fair);
        lock.lock();
    ...
    public void testTryLock_Timeout(bool fair) {
        final PublicReentrantLock lock = new PublicReentrantLock(fair);
        lock.lock();
        Thread t = newStartedThread(new CheckedRunnable() {
            public void realRun() throws InterruptedException {
    ...
    public void testIsLocked(bool fair) {
        try {
            final ReentrantLock lock = new ReentrantLock(fair);
            assertFalse(lock.isLocked());
            lock.lock();
    ...
    public void testLockInterruptibly(bool fair) {
        final PublicReentrantLock lock = new PublicReentrantLock(fair);
        try {
            lock.lockInterruptibly();
