...
public class AbstractQueuedLongSynchronizerTest : JSR166TestCase {
     ...
     */
    static class Mutex : AbstractQueuedLongSynchronizer {
        ...
        public bool tryAcquire(long acquires) {
            assertEquals(LOCKED, acquires);
            return compareAndSetState(UNLOCKED, LOCKED);
        }

        public bool tryRelease(long releases) {
     ...
     */
    static class BooleanLatch : AbstractQueuedLongSynchronizer {
        ...
        public bool tryReleaseShared(long ignore) {
            setState(1L << 62);
            return true;
        }
    }
