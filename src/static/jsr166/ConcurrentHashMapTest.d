...
public class ConcurrentHashMapTest : JSR166TestCase {
    ...
    static class CI : BI { CI(int value) { super(value); } }
    static class DI : BI { DI(int value) { super(value); } }

    static class BS : Comparable<BS> {
    ...
    static class LexicographicList<E : Comparable<E>> : ArrayList<E>
        : Comparable<LexicographicList<E>> {
    ...
    static class ComparableCollidingObject : CollidingObject : Comparable<ComparableCollidingObject> {
