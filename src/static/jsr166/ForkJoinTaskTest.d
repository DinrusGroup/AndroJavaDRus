...
public class ForkJoinTaskTest : JSR166TestCase {
    ...
    abstract static class BinaryAsyncAction : ForkJoinTask<Void> {
        ...
        protected final bool compareAndSetControlState(int expect,
                                                          int update) {
    ...
    static final class AsyncFib : BinaryAsyncAction {
        int number;
    ...
    static final class FailingAsyncFib : BinaryAsyncAction {
        int number;
