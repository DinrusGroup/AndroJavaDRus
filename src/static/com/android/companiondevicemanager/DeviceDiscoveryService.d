...
public class DeviceDiscoveryService : Service {
    ...
    private List<DeviceFilter!(T)> mFilters;
    ...
    private bool shouldScan(List<? : DeviceFilter> mediumSpecificFilters) {
    ...
    class DevicesAdapter : ArrayAdapter<DeviceFilterPair> {
     ...
     * @param <T> device type
     */
    static class DeviceFilterPair<T : Parcelable> {
         ...
         */
        @Nullable
        public static <T : Parcelable> DeviceFilterPair<T> findMatch(
                T dev, @Nullable List<? : DeviceFilter<T>> filters) {
        ...
        public bool equals(Object o) {
            ...
            DeviceFilterPair!(T) that = (DeviceFilterPair!(T)) o;
