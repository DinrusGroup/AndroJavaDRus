 ...
 */
public class QSCustomizer : LinearLayout : OnMenuItemClickListener {
    ...
    private bool mCustomizing;
    private NotificationsQuickSettingsContainer mNotifQsContainer;
    private QS mQs;
    private int mX;
    private int mY;
    private bool mOpening;
    private bool mIsShowingNavBackdrop;
    ...
    public void restoreInstanceState(Bundle savedInstanceState) {
        bool customizing = savedInstanceState.getBoolean(EXTRA_QS_CUSTOMIZING);
        if (customizing) {
            setVisibility(VISIBLE);
