...
public class TileAdapter : RecyclerView.Adapter<Holder> : TileStateListener {
    ...
    override
    public bool onFailedToRecycleView(Holder holder) {
        holder.clearDrag();
        return true;
    }
    ...
    public void onBindViewHolder(final Holder holder, int position) {
        ...
        if (mAccessibilityManager.isTouchExplorationEnabled()) {
            final bool selectable = mAccessibilityAction == ACTION_NONE || position < mEditIndex;
    ...
    private bool move(int from, int to, View v) {
        if (to == from) {
            return true;
        }
    ...
    private class TileItemDecoration : ItemDecoration {
    ...
    private final ItemTouchHelper.Callback mCallbacks = new ItemTouchHelper.Callback() {
        ...
        override
        public bool onMove(RecyclerView recyclerView, ViewHolder viewHolder, ViewHolder target) {
