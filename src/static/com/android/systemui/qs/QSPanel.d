...
public class QSPanel : LinearLayout : Tunable, Callback, BrightnessMirrorListener {
    ...
    private bool mGridContentVisible = true;
    ...
    public bool isShowingCustomize() {
    ...
    private void updatePageIndicator() {
        if (mTileLayout instanceof PagedTileLayout) {
            ...
            bool shouldUseFooterPageIndicator =
    ...
    public void showDetailAdapter(bool show, DetailAdapter adapter, int[] locationInWindow) {
    ...
    protected void showDetail(bool show, Record r) {
    ...
    public void setTiles(Collection<QSTile> tiles, bool collapsedView) {
        if (!collapsedView) {
    ...
    protected QSTileView createTileView(QSTile tile, bool collapsedView) {
        return mHost.createTileView(tile, collapsedView);
    }

    protected bool shouldShowDetail() {
        return mExpanded;
    }

    protected TileRecord addTile(final QSTile tile, bool collapsedView) {
        ...
        final QSTile.Callback callback = new QSTile.Callback() {
            ...
            override
            public void onShowDetail(bool show) {
            ...
            override
            public void onScanStateChanged(bool state) {
                r.scanState = state;
                if (mDetailRecord == r) {
    ...
    protected void handleShowDetail(Record r, bool show) {
    ...
    private void handleShowDetailTile(TileRecord r, bool show) {
    ...
    private void handleShowDetailImpl(Record r, bool show, int x, int y) {
    ...
    protected void setDetailRecord(Record r) {
        ...
        mDetailRecord = r;
        final bool scanState = mDetailRecord instanceof TileRecord
                && ((TileRecord) mDetailRecord).scanState;
        fireScanStateChanged(scanState);
    }

    void setGridContentVisibility(bool visible) {
    ...
    private void fireToggleStateChanged(bool state) {
        if (mCallback != null) {
            mCallback.onToggleStateChanged(state);
        }
    }

    private void fireScanStateChanged(bool state) {
        if (mCallback != null) {
    ...
    public static final class TileRecord : Record {
        public QSTile tile;
