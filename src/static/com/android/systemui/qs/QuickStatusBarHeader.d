 ...
 * contents.
 */
public class QuickStatusBarHeader : RelativeLayout :
    ...
    private void updateStatusText() {
        bool changed = updateRingerStatus() || updateAlarmStatus();

        if (changed) {
            bool alarmVisible = mNextAlarmTextView.getVisibility() == View.VISIBLE;
            bool ringerVisible = mRingerModeTextView.getVisibility() == View.VISIBLE;
    ...
    private bool updateRingerStatus() {
        bool isOriginalVisible = mRingerModeTextView.getVisibility() == View.VISIBLE;
        CharSequence originalRingerText = mRingerModeTextView.getText();

        bool ringerVisible = false;
    ...
    private bool updateAlarmStatus() {
        bool isOriginalVisible = mNextAlarmTextView.getVisibility() == View.VISIBLE;
    ...
    protected void onConfigurationChanged(Configuration newConfig) {
        ...
        bool shouldUseWallpaperTextColor =
     ...
     */
    public void setExpansion(bool isKeyguardShowing, float expansionFraction,
     ...
     */
    private void hideLongPressTooltip(bool shouldShowStatusText) {
        mLongPressTooltipView.animate().cancel();
