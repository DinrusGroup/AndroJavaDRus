 ...
 */
public abstract class QSTileImpl<TState : State> : QSTile {
    protected final String TAG = "Tile." + getClass().getSimpleName();
    protected static final bool DEBUG = Log.isLoggable("Tile", Log.DEBUG);
    ...
    private bool mAnnounceNextStateChange;
     ...
     */
    public void setListening(Object listener, bool listening) {
    ...
    public void fireToggleStateChanged(bool state) {
        mHandler.obtainMessage(H.TOGGLE_STATE_CHANGED, state ? 1 : 0, 0).sendToTarget();
    }

    public void fireScanStateChanged(bool state) {
    ...
    protected void handleRefreshState(Object arg) {
        ...
        final bool changed = mTmpState.copyTo(mState);
        if (changed) {
            handleStateChanged();
        }
    ...
    private void handleStateChanged() {
        bool delayAnnouncement = shouldAnnouncementBeDelayed();
    ...
    private void handleShowDetail(bool show) {
        mShowingDetail = show;
        for (int i = 0; i < mCallbacks.size(); i++) {
    ...
    protected bool isShowingDetail() {
    ...
    private void handleScanStateChanged(bool state) {
        for (int i = 0; i < mCallbacks.size(); i++) {
    ...
    private void handleSetListeningInternal(Object listener, bool listening) {
        if (listening) {
    ...
    protected abstract void handleSetListening(bool listening);
    ...
    protected final class H : Handler {
    ...
    public static class DrawableIcon : Icon {
    ...
    public static class DrawableIconWithRes : DrawableIcon {
    ...
    public static class ResourceIcon : Icon {
    ...
    protected static class AnimationIcon : ResourceIcon {
