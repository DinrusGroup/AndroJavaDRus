...
public class QSTileView : QSTileBaseView {
    private static final int MAX_LABEL_LINES = 2;
    private static final bool DUAL_TARGET_ALLOWED = false;
    ...
    public QSTileView(Context context, QSIconView icon, bool collapsedView) {
    ...
    protected void handleStateChanged(QSTile.State state) {
        ...
        bool dualTarget = DUAL_TARGET_ALLOWED && state.dualTarget;
