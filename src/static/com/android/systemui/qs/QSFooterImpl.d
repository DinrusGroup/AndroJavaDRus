...
public class QSFooterImpl : FrameLayout : QSFooter,
    ...
    private bool mShowEmergencyCallsOnly;
    ...
    override
    public void setEmergencyCallsOnly(bool show) {
        bool changed = show != mShowEmergencyCallsOnly;
        if (changed) {
    ...
    public void setMobileDataIndicators(NetworkController.IconState statusIcon,
            ...
            int qsType, bool activityIn, bool activityOut,
    ...
    override
    public void setNoSims(bool hasNoSims, bool simDetected) {
        if (hasNoSims) {
            mInfo.visible = false;
        }
        handleUpdateState();
