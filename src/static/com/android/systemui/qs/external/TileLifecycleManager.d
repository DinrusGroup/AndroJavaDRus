 ...
 * ({@link #setBindService(bool)}) and when the service is available.
 */
public class TileLifecycleManager : BroadcastReceiver :
    ...
    private bool mBound;
    bool mReceiverRegistered;
    private bool mUnbindImmediate;
    ...
    public void setBindService(bool bind) {
    ...
    private bool checkComponentState() {
    ...
    private bool isComponentAvailable() {
    ...
    public static bool isTileAdded(Context context, ComponentName component) {
        return context.getSharedPreferences(TILES, 0).getBoolean(component.flattenToString(), false);
    }

    public static void setTileAdded(Context context, ComponentName component, bool added) {
