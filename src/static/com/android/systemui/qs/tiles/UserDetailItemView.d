 ...
 */
public class UserDetailItemView : LinearLayout {
    ...
    public void setAvatarEnabled(bool enabled) {
        mAvatar.setEnabled(enabled);
    }

    public void setDisabledByAdmin(bool disabled) {
    ...
    private void updateTypeface() {
        bool activated = ArrayUtils.contains(getDrawableState(), android.R.attr.state_activated);
