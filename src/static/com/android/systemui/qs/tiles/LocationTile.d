...
public class LocationTile : QSTileImpl<BooleanState> {
    ...
    protected void handleClick() {
        if (mKeyguard.isSecure() && mKeyguard.isShowing()) {
            Dependency.get(ActivityStarter.class).postQSRunnableDismissingKeyguard(() -> {
                final bool wasEnabled = mState.value;
                mHost.openPanels();
    ...
    protected void handleUpdateState(BooleanState state, Object arg) {
        ...
        final bool locationEnabled =  mController.isLocationEnabled();
    ...
    private final class Callback : LocationChangeCallback,
            KeyguardMonitor.Callback {
        override
        public void onLocationSettingsChanged(bool enabled) {
            refreshState();
        }
