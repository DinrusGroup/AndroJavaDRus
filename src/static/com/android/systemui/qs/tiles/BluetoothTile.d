...
public class BluetoothTile : QSTileImpl<BooleanState> {
    ...
    protected void handleClick() {
        ...
        final bool isEnabled = mState.value;
    ...
    protected void handleUpdateState(BooleanState state, Object arg) {
        final bool transientEnabling = arg == ARG_SHOW_TRANSIENT_ENABLING;
        final bool enabled = transientEnabling || mController.isBluetoothEnabled();
        final bool connected = mController.isBluetoothConnected();
        final bool connecting = mController.isBluetoothConnecting();
     ...
     */
    @Nullable
    private String getSecondaryLabel(bool enabled, bool connecting, bool connected,
            bool isTransient) {
        if (connecting) {
     ...
     */
    private class BluetoothBatteryTileIcon : Icon {
     ...
     */
    private class BluetoothConnectedTileIcon : Icon {
    ...
    protected class BluetoothDetailAdapter : DetailAdapter, QSDetailItems.Callback {
