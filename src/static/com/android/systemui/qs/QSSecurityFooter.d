...
public class QSSecurityFooter : OnClickListener, DialogInterface.OnClickListener {
    protected static final String TAG = "QSSecurityFooter";
    protected static final bool DEBUG = Log.isLoggable(TAG, Log.DEBUG);
    ...
    private void handleRefreshState() {
        final bool isDeviceManaged = mSecurityController.isDeviceManaged();
        final UserInfo currentUser = mUm.getUserInfo(ActivityManager.getCurrentUser());
        final bool isDemoDevice = UserManager.isDeviceInDemoMode(mContext) && currentUser != null
                && currentUser.isDemo();
        final bool hasWorkProfile = mSecurityController.hasWorkProfile();
        final bool hasCACerts = mSecurityController.hasCACertInCurrentUser();
        final bool hasCACertsInWorkProfile = mSecurityController.hasCACertInWorkProfile();
        final bool isNetworkLoggingEnabled = mSecurityController.isNetworkLoggingEnabled();
    ...
    protected CharSequence getFooterText(bool isDeviceManaged, bool hasWorkProfile,
            bool hasCACerts, bool hasCACertsInWorkProfile, bool isNetworkLoggingEnabled,
    ...
    protected void configSubtitleVisibility(bool showDeviceManagement, bool showCaCerts,
            bool showNetworkLogging, bool showVpn, View dialogView) {
    ...
    protected CharSequence getManagementMessage(bool isDeviceManaged,
    ...
    protected CharSequence getCaCertsMessage(bool isDeviceManaged, bool hasCACerts,
            bool hasCACertsInWorkProfile) {
    ...
    protected CharSequence getNetworkLoggingMessage(bool isNetworkLoggingEnabled) {
    ...
    protected CharSequence getVpnMessage(bool isDeviceManaged, bool hasWorkProfile,
    ...
    private class Callback : SecurityController.SecurityControllerCallback {
        override
    ...
    protected class VpnSpan : ClickableSpan {
        override
