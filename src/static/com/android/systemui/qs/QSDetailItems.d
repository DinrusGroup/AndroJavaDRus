 ...
 */
public class QSDetailItems : FrameLayout {
    ...
    private bool mItemsVisible = true;
    ...
    private void handleSetItemsVisible(bool visible) {
    ...
    private class Adapter : BaseAdapter {
        ...
        public View getView(int position, View view, ViewGroup parent) {
            ...
            final bool twoLines = !TextUtils.isEmpty(item.line2);
