...
public class SwipeDetector {
    ...
    public bool isDraggingOrSettling() {
    ...
    private bool mIgnoreSlopWhenSettling;

    public interface Listener {
        void onDragStart(bool start);

        bool onDrag(float displacement, float velocity);

        void onDragEnd(float velocity, bool fling);
    }
    ...
    public void setDetectableScrollConditions(int scrollDirectionFlags, bool ignoreSlop) {
        mScrollConditions = scrollDirectionFlags;
        mIgnoreSlopWhenSettling = ignoreSlop;
    }

    private bool shouldScrollStart(MotionEvent ev, int pointerIndex) {
    ...
    private bool reportDragStart(bool recatch) {
