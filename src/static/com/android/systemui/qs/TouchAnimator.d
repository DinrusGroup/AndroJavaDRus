...
public class TouchAnimator {
    ...
    public static class ListenerAdapter : Listener {
        override
    ...
    public static class Builder {
        ...
        private static Property getProperty(Object target, String property, Class!(T) cls) {
    ...
    private static class FloatKeyframeSet<T> : KeyframeSet {
    ...
    private static class IntKeyframeSet<T> : KeyframeSet {
