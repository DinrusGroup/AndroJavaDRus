...
public class QSDetail : LinearLayout {
    ...
    private bool mScanState;
    private bool mClosingDetail;
    private bool mFullyExpanded;
    private QuickStatusBarHeader mHeader;
    private bool mTriggeredExpand;
    private int mOpenX;
    private int mOpenY;
    private bool mAnimatingOpen;
    ...
    public void setFullyExpanded(bool fullyExpanded) {
    ...
    public void handleShowingDetail(final DetailAdapter adapter, int x, int y,
            bool toggleQs) {
        final bool showingDetail = adapter != null;
        ...
        bool visibleDiff = (mDetailAdapter != null) != (adapter != null);
    ...
    protected void animateDetailVisibleDiff(int x, int y, bool visibleDiff, AnimatorListener listener) {
        if (visibleDiff) {
    ...
    protected void setupDetailHeader(final DetailAdapter adapter) {
        ...
        if (toggleState == null) {
            ...
            mQsDetailHeader.setOnClickListener(new OnClickListener() {
                override
                public void onClick(View v) {
                    bool checked = !mQsDetailHeaderSwitch.isChecked();
    ...
    private void handleToggleStateChanged(bool state, bool toggleEnabled) {
        mSwitchState = state;
        if (mAnimatingOpen) {
            return;
        }
    ...
    protected Callback mQsPanelCallback = new Callback() {
        override
        public void onToggleStateChanged(final bool state) {
            post(new Runnable() {
                override
                public void run() {
        ...
        override
        public void onScanStateChanged(final bool state) {
            post(new Runnable() {
                override
                public void run() {
