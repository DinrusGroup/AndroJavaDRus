 ...
 */
public class QSScrollLayout : NestedScrollView {
    ...
    public bool shouldIntercept(MotionEvent ev) {
    ...
    private class OverScrollHelper : SwipeDetector.Listener {
        private bool mIsInOverScroll;

        // We use this value to calculate the actual amount the user has overscrolled.
        private float mFirstDisplacement = 0;

        override
        public void onDragStart(bool start) {}

        override
        public bool onDrag(float displacement, float velocity) {
            ...
            bool wasInOverScroll = mIsInOverScroll;
        ...
        override
        public void onDragEnd(float velocity, bool fling) {
            reset();
        }
