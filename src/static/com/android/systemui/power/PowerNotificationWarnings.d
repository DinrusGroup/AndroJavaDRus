...
public class PowerNotificationWarnings : PowerUI.WarningsUI {
    private static final String TAG = PowerUI.TAG + ".Notification";
    private static final bool DEBUG = PowerUI.DEBUG;
    ...
    private bool mShowAutoSaverSuggestion;
    private bool mPlaySound;
    private bool mInvalidCharger;
    private SystemUIDialog mSaverConfirmation;
    private SystemUIDialog mSaverEnabledConfirmation;
    private bool mHighTempWarning;
    ...
    override
    public bool isInvalidChargerWarningShowing() {
    ...
    private bool hasBatterySettings() {
        return mOpenBatterySettings.resolveActivity(mContext.getPackageManager()) != null;
    }

    override
    public void showLowBatteryWarning(bool playSound) {
        Slog.i(TAG,
    ...
    private void setSaverMode(bool mode, bool needFirstTimeWarning) {
