...
public class SegmentedButtons : LinearLayout {
    ...
    protected void setSelectedStyle(TextView textView, bool selected) {
    ...
    private void fireOnSelected(bool fromClick) {
        if (mCallback != null) {
    ...
    public interface Callback : Interaction.Callback {
        void onSelected(Object value, bool fromClick);
    }
}
