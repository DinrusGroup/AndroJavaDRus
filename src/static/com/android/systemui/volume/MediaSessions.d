...
public class MediaSessions {
    ...
    private static final bool USE_SERVICE_LABEL = false;
    ...
    private static bool isRemote(PlaybackInfo pi) {
    ...
    private final class MediaControllerRecord : MediaController.Callback {
        private final MediaController controller;

        private bool sentRemote;
        private String name;
        ...
        public void onAudioInfoChanged(PlaybackInfo info) {
            ...
            final bool remote = isRemote(info);
