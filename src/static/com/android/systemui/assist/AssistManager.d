 ...
 */
public class AssistManager : ConfigurationChangedReceiver {
    ...
    private final bool mShouldEnableOrb;
    ...
    public void startAssist(Bundle args) {
        ...
        final bool isService = assistComponent.equals(getVoiceInteractorComponentName());
    ...
    private void showOrb(@NonNull ComponentName assistComponent, bool isService) {
    ...
    private void startAssistActivity(Bundle args, @NonNull ComponentName assistComponent) {
        ...
        bool structureEnabled = Settings.Secure.getIntForUser(mContext.getContentResolver(),
    ...
    public bool canVoiceAssistBeLaunchedFromKeyguard() {
    ...
    private void maybeSwapSearchIcon(@NonNull ComponentName assistComponent, bool isService) {
