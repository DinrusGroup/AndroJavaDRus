 ...
 */
public class ScreenDecorations : SystemUI : Tunable {
    public static final String SIZE = "sysui_rounded_size";
    public static final String PADDING = "sysui_rounded_content_padding";
    private static final bool DEBUG_SCREENSHOT_ROUNDED_CORNERS =
    ...
    private void updateWindowVisibility(View overlay) {
        bool visibleForCutout = shouldDrawCutout()
                && overlay.findViewById(R.id.display_cutout).getVisibility() == View.VISIBLE;
        bool visibleForRoundedCorners = hasRoundedCorners();
    ...
    private bool shouldDrawCutout() {
        return shouldDrawCutout(mContext);
    }

    static bool shouldDrawCutout(Context context) {
    ...
    @VisibleForTesting
    static class TunablePaddingTagListener : FragmentListener {
    ...
    public static class DisplayCutoutView : View : DisplayManager.DisplayListener,
        ...
        private final bool mStart;
        private final Runnable mVisibilityChangedListener;
        private int mColor = Color.BLACK;

        public DisplayCutoutView(Context context, bool start,
        ...
        private void updateBoundingPath() {
            ...
            bool flipped = mInfo.rotation == ROTATION_90 || mInfo.rotation == ROTATION_270;
        ...
        override
        public bool shouldInterceptTouch() {
    ...
    private bool isLandscape(int rotation) {
