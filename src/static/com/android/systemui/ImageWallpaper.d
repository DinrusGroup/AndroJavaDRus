...
public class ImageWallpaper : WallpaperService {
    ...
    class DrawableEngine : Engine {
        ...
        private bool mNeedsDrawAfterLoadingWallpaper;
        private bool mSurfaceValid;
        private bool mSurfaceRedrawNeeded;
        ...
        bool updateSurfaceSize(SurfaceHolder surfaceHolder, DisplayInfo displayInfo,
                bool forDraw) {
            bool hasWallpaper = true;
        ...
        void drawFrame() {
            ...
            try {
                ...
                bool surfaceDimensionsChanged = dw != mLastSurfaceWidth
                        || dh != mLastSurfaceHeight;

                bool redrawNeeded = surfaceDimensionsChanged || newRotation != mLastRotation
         ...
         */
        private void loadWallpaper(bool needsDraw) {
        ...
        private void unloadWallpaper(bool forgetSize) {
            if (mLoader != null) {
