 ...
 */
public class HighResThumbnailLoader : TaskCallbacks {
    ...
    @GuardedBy("mLoadQueue")
    private bool mLoaderIdling;

    private final ArrayList<Task> mVisibleTasks = new ArrayList<>();

    private final Thread mLoadThread;
    private final Handler mMainThreadHandler;
    private final bool mIsLowRamDevice;
    private bool mLoading;
    private bool mVisible;
    private bool mFlingingFast;
    private bool mTaskLoadQueueIdle;
    ...
    public void setFlingingFast(bool flingingFast) {
     ...
     */
    public void setTaskLoadQueueIdle(bool idle) {
        if (mIsLowRamDevice) {
            return;
        }
