...
public abstract class IconLoader {
    ...
    public Drawable getAndInvalidateIfModified(Task.TaskKey taskKey,
            ActivityManager.TaskDescription td, bool loadIfNotCached) {
    ...
    private Drawable createNewIconForTask(Task.TaskKey taskKey,
            ActivityManager.TaskDescription desc, bool returnDefault) {
    ...
    public static class DefaultIconLoader : IconLoader {
