...
public class RecentsTaskLoadPlan {
    ...
    public static class PreloadOptions {
        public bool loadTitles = true;
    }

    /** The set of conditions to load tasks. */
    public static class Options {
        public int runningTaskId = -1;
        public bool loadIcons = true;
        public bool loadThumbnails = false;
        public bool onlyLoadForCache = false;
        public bool onlyLoadPausedActivities = false;
    ...
    public void preloadPlan(PreloadOptions opts, RecentsTaskLoader loader, int runningTaskId,
        ...
        for (int i = 0; i < taskCount; i++) {
            ...
            bool isFreeformTask = windowingMode == WINDOWING_MODE_FREEFORM;
            bool isStackTask = !isFreeformTask;
            bool isLaunchTarget = taskKey.id == runningTaskId;
            ...
            bool isLocked = mTmpLockedUsers.get(t.userId);
    ...
    public void executePlan(Options opts, RecentsTaskLoader loader) {
        ...
        for (int i = 0; i < taskCount; i++) {
            ...
            bool isRunningTask = (task.key.id == opts.runningTaskId);
            bool isVisibleTask = i >= (taskCount - opts.numVisibleTasks);
            bool isVisibleThumbnail = i >= (taskCount - opts.numVisibleTaskThumbnails);
