...
public class TaskStack {
    ...
    public interface TaskStackCallbacks {
        ...
        void onStackTaskRemoved(TaskStack stack, Task removedTask, Task newFrontMostTask,
                AnimationProps animation, bool fromDockGesture,
                bool dismissRecentsIfAllRemoved);
     ...
     */
    public void removeTask(Task t, AnimationProps animation, bool fromDockGesture) {
     ...
     */
    public void removeAllTasks(bool notifyStackChanges) {
    ...
    /**
     * @see #setTasks(List, bool)
     */
    public void setTasks(TaskStack stack, bool notifyStackChanges) {
     ...
     */
    public void setTasks(List<Task> tasks, bool notifyStackChanges) {
     ...
     */
    public bool isNextLaunchTargetPip(long lastPipTime) {
