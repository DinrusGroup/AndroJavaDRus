...
public class ActivityManagerWrapper {
     ...
     */
    public @NonNull ThumbnailData getTaskThumbnail(int taskId, bool reducedResolution) {
     ...
     */
    public void cancelRecentsAnimation(bool restoreHomeStackPosition) {
        try {
     ...
     */
    public bool startActivityFromRecents(int taskId, ActivityOptions options) {
        try {
     ...
     */
    public bool isScreenPinningEnabled() {
     ...
     */
    public bool showVoiceSession(IBinder token, Bundle args, int flags) {
