 ...
 */
public class GuestResumeSessionReceiver : BroadcastReceiver {
    ...
    private static void wipeGuestSession(Context context, int userId) {
        ...
        bool marked = userManager.markGuestForDeletion(currentUser.id);
        if (!marked) {
    ...
    private static class ResetSessionDialog : SystemUIDialog :
