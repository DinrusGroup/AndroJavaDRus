...
public class ForegroundServiceControllerImpl
    ...
    override
    public bool isDungeonNeededForUser(int userId) {
        synchronized (mMutex) {
    ...
    override
    public bool isSystemAlertWarningNeeded(int userId, String pkg) {
        synchronized (mMutex) {
            final UserServices services = mUserServices.get(userId);
            if (services == null) return false;
    ...
    override
    public void onAppOpChanged(int code, int uid, String packageName, bool active) {
    ...
    override
    public bool removeNotification(StatusBarNotification sbn) {
        synchronized (mMutex) {
    ...
    override
    public bool isDungeonNotification(StatusBarNotification sbn) {
    ...
    override
    public bool isSystemAlertNotification(StatusBarNotification sbn) {
    ...
    private static class UserServices {
        ...
        public bool removeOp(String pkg, int op) {
            final bool found;
        ...
        public bool removeImportantNotification(String pkg, String key) {
        ...
        public bool removeStandardLayoutNotification(String pkg, String key) {
            return removeNotification(mStandardLayoutNotifications, pkg, key);
        }

        public bool removeNotification(String pkg, String key) {
            bool removed = false;
        ...
        public bool removeNotification(ArrayMap<String, ArraySet<String>> map,
