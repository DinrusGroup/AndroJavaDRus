 ...
 */
public class ViewTransformationHelper : TransformableView,
    ...
    public static abstract class CustomTransformation {
         ...
         */
        public abstract bool transformTo(TransformState ownState,
         ...
         * @return whether a custom transformation is performed
         */
        public abstract bool transformFrom(TransformState ownState,
                TransformableView notification,
                float transformationAmount);
         ...
         */
        public bool initTransformation(TransformState ownState,
                TransformState otherState) {
            return false;
        }

        public bool customTransformTarget(TransformState ownState,
                TransformState otherState) {
            return false;
        }
         ...
         */
        public Interpolator getCustomInterpolator(int interpolationType, bool isFrom) {
            return null;
        }
    }
}
