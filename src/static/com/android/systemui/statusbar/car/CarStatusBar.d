 ...
 */
public class CarStatusBar : StatusBar :
        CarBatteryController.BatteryViewHandler {
    private static final String TAG = "CarStatusBar";
    public static final bool ENABLE_HVAC_CONNECTION
    ...
    private bool mShowLeft;
    private bool mShowRight;
    private bool mShowBottom;
    private CarFacetButtonController mCarFacetButtonController;
    private ActivityManagerWrapper mActivityManagerWrapper;
    private DeviceProvisionedController mDeviceProvisionedController;
    private bool mDeviceIsProvisioned = true;
    ...
    public bool hideKeyguard() {
        bool result = super.hideKeyguard();
     ...
     */
    private class TaskStackListenerImpl : SysUiTaskStackChangeListener {
        override
    ...
    override
    public void updateKeyguardState(bool goingToFullShade, bool fromShadeLocked) {
