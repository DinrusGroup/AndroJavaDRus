 ...
 */
public class UserGridRecyclerView : PagedListView :
     ...
     */
    public final class UserAdapter : RecyclerView.Adapter<UserAdapter.UserAdapterViewHolder>
        ...
        private class AddNewUserTask : AsyncTask<String, Void, UserInfo> {
    ...
    public static final class UserRecord {
        ...
        public final bool mIsStartGuestSession;
        public final bool mIsAddUser;
        public final bool mIsForeground;

        public UserRecord(UserInfo userInfo, bool isStartGuestSession, bool isAddUser,
                bool isForeground) {
            mInfo = userInfo;
