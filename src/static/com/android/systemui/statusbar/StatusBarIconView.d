...
public class StatusBarIconView : AnimatedImageView : StatusIconDisplayable {
    ...
    private void reloadDimens() {
        bool applyRadius = mDotRadius == mStaticDotRadius;
    ...
    public bool equalIcons(Icon a, Icon b) {
        if (a == b) return true;
     ...
     */
    public bool set(StatusBarIcon icon) {
        final bool iconEquals = mIcon != null && equalIcons(mIcon.icon, icon.icon);
        final bool levelEquals = iconEquals
                && mIcon.iconLevel == icon.iconLevel;
        final bool visibilityEquals = mIcon != null
                && mIcon.visible == icon.visible;
        final bool numberEquals = mIcon != null
    ...
    private bool updateDrawable(bool withClear) {
        if (mIcon == null) {
            return false;
        }
        Drawable drawable;
    ...
    public void setIconColor(int iconColor, bool animate) {
    ...
    public void setVisibleState(int state, bool animate) {
    ...
    public void setVisibleState(int visibleState, bool animate, Runnable endRunnable) {
            ...
            if (animate) {
                ...
                if (targetAmount != currentAmount) {
                    ...
                    mDotAnimator.setDuration(duration == 0 ? ANIMATION_DURATION_FAST
                            : duration);
                    final bool runRunnable = !runnableAdded;
    ...
    public void setIsInShelf(bool isInShelf) {
