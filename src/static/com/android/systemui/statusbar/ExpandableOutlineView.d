 ...
 */
public abstract class ExpandableOutlineView : ExpandableView {
    ...
    private bool mCustomOutline;
    private float mOutlineAlpha = -1f;
    protected float mOutlineRadius;
    private bool mAlwaysRoundBothCorners;
     ...
     */
    protected bool mShouldTranslateContents;
    private bool mTopAmountRounded;
    ...
    protected Path getClipPath(bool ignoreTranslation, bool clipRoundedToBottom) {
        int left;
        int top;
        int right;
        int bottom;
    ...
    protected bool isClippingNeeded() {
     ...
     */
    public bool setTopRoundness(float topRoundness, bool animate) {
     ...
     * @return Whether the roundness was changed.
     */
    public bool setBottomRoundness(float bottomRoundness, bool animate) {
