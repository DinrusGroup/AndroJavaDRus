 ...
 */
public class ScrimController : ViewTreeObserver.OnPreDrawListener, OnColorsChangedListener,
        Dumpable {
    ...
    private bool mNeedsDrawableColorUpdate;
    ...
    private bool mDarkenWhileDragging;
    private bool mExpansionAffectsAlpha = true;
    protected bool mAnimateChange;
    private bool mUpdatePending;
    private bool mTracking;
    protected long mAnimationDuration = -1;
    private long mAnimationDelay;
    private Runnable mOnAnimationFinished;
    private bool mDeferFinishedListener;
    ...
    private bool mWallpaperVisibilityTimedOut;
    private int mScrimsVisibility;
    private final TriConsumer<ScrimState, Float, GradientColors> mScrimStateListener;
    private final Consumer<Integer> mScrimVisibleListener;
    private bool mBlankScreen;
    private bool mScreenBlankingCallbackCalled;
    private Callback mCallback;
    private bool mWallpaperSupportsAmbientMode;
    ...
    public void setPanelExpansion(float fraction) {
        if (mExpansionFraction != fraction) {
            ...
            final bool keyguardOrUnlocked = mState == ScrimState.UNLOCKED
    ...
    protected void updateScrims() {
        ...
        if (mNeedsDrawableColorUpdate) {
            ...
            if (mState == ScrimState.KEYGUARD || mState == ScrimState.BOUNCER_SCRIMMED
                ...
                bool animateScrimInFront = mScrimInFront.getViewAlpha() != 0;
                bool animateScrimBehind = mScrimBehind.getViewAlpha() != 0;
        ...
        bool aodWallpaperTimeout = mState == ScrimState.AOD && mWallpaperVisibilityTimedOut;
        // We also want to hide FLAG_SHOW_WHEN_LOCKED activities under the scrim.
        bool occludedKeyguard = (mState == ScrimState.PULSING || mState == ScrimState.AOD)
                && mKeyguardOccluded;
    ...
    private bool isAnimating(View scrim) {
        return scrim.getTag(TAG_KEY_ANIM) != null;
    }

    public void setDrawBehindAsSrc(bool asSrc) {
    ...
    private void updateScrim(ScrimView scrim, float alpha) {
        ...
        final bool wantsAlphaUpdate = alpha != currentAlpha;
        final bool wantsTintUpdate = scrim.getTint() != getCurrentScrimTint(scrim);
    ...
    public void setExpansionAffectsAlpha(bool expansionAffectsAlpha) {
        mExpansionAffectsAlpha = expansionAffectsAlpha;
    }

    public void setKeyguardOccluded(bool keyguardOccluded) {
