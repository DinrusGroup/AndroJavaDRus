 ...
 */
public class HeadsUpAppearanceController : OnHeadsUpChangedListener,
    ...
    private void updateIsolatedIconLocation(bool requireStateUpdate) {
    ...
    public void setExpandedHeight(float expandedHeight, float appearFraction) {
        bool changedHeight = expandedHeight != mExpandedHeight;
        mExpandedHeight = expandedHeight;
        mExpandFraction = appearFraction;
        bool isExpanded = expandedHeight > 0;
        if (changedHeight) {
    ...
    public void setPublicMode(bool publicMode) {
