...
public class BarTransitions {
    ...
    private static final bool DEBUG_COLORS = false;
    ...
    private int mMode;
    private bool mAlwaysOpaque = false;
     ...
     */
    public void setAlwaysOpaque(bool alwaysOpaque) {
        mAlwaysOpaque = alwaysOpaque;
    }

    public bool isAlwaysOpaque() {
        // Low-end devices do not support translucent modes, fallback to opaque
        return mAlwaysOpaque;
    }

    public void transitionTo(int mode, bool animate) {
    ...
    protected void applyModeBackground(int oldMode, int newMode, bool animate) {
    ...
    private static class BarBackgroundDrawable : Drawable {
        ...
        public void applyModeBackground(int oldMode, int newMode, bool animate) {
