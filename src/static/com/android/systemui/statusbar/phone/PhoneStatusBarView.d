...
public class PhoneStatusBarView : PanelBar {
    private static final String TAG = "PhoneStatusBarView";
    private static final bool DEBUG = StatusBar.DEBUG;
    private static final bool DEBUG_GESTURES = false;
    private static final int NO_VALUE = Integer.MIN_VALUE;

    StatusBar mBar;

    bool mIsFullyOpenedPanel = false;
     ...
     * @return bool indicating if we need to update the cutout location / margins
     */
    private bool updateOrientationAndCutout(int newOrientation) {
        bool changed = false;
    ...
    public bool onTouchEvent(MotionEvent event) {
        bool barConsumedEvent = mBar.interceptTouchEvent(event);
    ...
    override
    public void panelExpansionChanged(float frac, bool expanded) {
