...
public class ReverseLinearLayout : LinearLayout {
    ...
    public void setAlternativeOrder(bool alternative) {
    ...
    private void updateOrder() {
        bool isLayoutRtl = getLayoutDirection() == LAYOUT_DIRECTION_RTL;
        bool isLayoutReverse = isLayoutRtl ^ mIsAlternativeOrder;
    ...
    public interface Reversable {
        void reverse(bool isLayoutReverse);
    }

    public static class ReverseRelativeLayout : RelativeLayout : Reversable {
        ...
        override
        public void reverse(bool isLayoutReverse) {
        ...
        public void updateGravity(bool isLayoutReverse) {
    ...
    private static void reverseGroup(ViewGroup group, bool isLayoutReverse) {
