 ...
 */
public class QuickStepController : GestureHelper {
    ...
    private bool mQuickScrubActive;
    private bool mAllowGestureDetection;
    private bool mQuickStepStarted;
    private int mTouchDownX;
    private int mTouchDownY;
    private bool mDragPositive;
    ...
    public bool onTouchEvent(MotionEvent event) {
        ...
        final bool ignoreProxyDownEvent = event.getAction() == MotionEvent.ACTION_DOWN
                && mOverviewEventSender.getProxy() != null;
        return ignoreProxyDownEvent || handleTouchEvent(event);
    }

    private bool handleTouchEvent(MotionEvent event) {
        ...
        switch (action) {
            ...
            case MotionEvent.ACTION_MOVE: {
                ...
                bool exceededScrubTouchSlop, exceededSwipeUpTouchSlop;
                ...
                final bool allowDrag = !mDragPositive
    ...
    public void setBarState(bool isVertical, bool isRTL) {
        final bool changed = (mIsVertical != isVertical) || (mIsRTL != isRTL);
        if (changed) {
    ...
    private void endQuickScrub(bool animate) {
        if (mQuickScrubActive) {
            animateEnd();
            try {
    ...
    private bool proxyMotionEvents(MotionEvent event) {
