...
public interface StatusBarIconController {
    ...
    public void setIconVisibility(String slot, bool b);
    /**
     ...
     */
    public static class DarkIconManager : IconManager {
        ...
        override
        protected void onIconAdded(int index, String slot, bool blocked,
    ...
    public static class TintedIconManager : IconManager {
        private int mColor;
     ...
     */
    public static class IconManager : DemoMode {
        protected final ViewGroup mGroup;
        protected final Context mContext;
        protected final int mIconSize;
        // Whether or not these icons show up in dumpsys
        protected bool mShouldLog = false;

        // Enables SystemUI demo mode to take effect in this group
        protected bool mDemoable = true;
        private bool mIsInDemoMode;
        ...
        public bool isDemoable() {
            return mDemoable;
        }

        public void setIsDemoable(bool demoable) {
            mDemoable = demoable;
        }

        public void setShouldLog(bool should) {
            mShouldLog = should;
        }
        ...
        protected StatusIconDisplayable addHolder(int index, String slot, bool blocked,
                StatusBarIconHolder holder) {
        ...
        @VisibleForTesting
        protected StatusBarIconView addIcon(int index, String slot, bool blocked,
                StatusBarIcon icon) {
        ...
        private StatusBarIconView onCreateStatusBarIconView(String slot, bool blocked) {
