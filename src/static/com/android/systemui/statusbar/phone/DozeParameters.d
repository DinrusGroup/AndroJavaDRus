...
public class DozeParameters : TunerService.Tunable {
    private static final int MAX_DURATION = 60 * 1000;
    public static final String DOZE_SENSORS_WAKE_UP_FULLY = "doze_sensors_wake_up_fully";
    public static final bool FORCE_NO_BLANKING =
    ...
    private bool mDozeAlwaysOn;
    private bool mControlScreenOffAnimation;
    ...
    public bool getDisplayStateSupported() {
        return getBoolean("doze.display.supported", R.bool.doze_display_state_supported);
    }

    public bool getDozeSuspendDisplayStateSupported() {
     ...
     */
    public bool getDisplayNeedsBlanking() {
        return !FORCE_NO_BLANKING && mContext.getResources().getBoolean(
                com.android.internal.R.bool.config_displayBlanksAfterDoze);
    }

    public bool shouldControlScreenOff() {
        return mControlScreenOffAnimation;
    }

    public void setControlScreenOffAnimation(bool controlScreenOffAnimation) {
    ...
    private bool getBoolean(String propName, int resId) {
    ...
    public bool getPickupSubtypePerformsProxCheck(int subType) {
    ...
    public bool doubleTapReportsTouchCoordinates() {
    ...
    public static class IntInOutMatcher {
        ...
        private final bool mDefaultIsIn;
        final String mSpec;
        ...
        public IntInOutMatcher(String spec) {
            ...
            for (String itemPrefixed : spec.split(",", -1)) {
                ...
                bool isIn = itemPrefixed.charAt(0) != OUT_PREFIX;
