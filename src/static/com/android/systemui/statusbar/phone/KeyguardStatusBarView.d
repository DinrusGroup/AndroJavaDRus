 ...
 */
public class KeyguardStatusBarView : RelativeLayout
        : BatteryStateChangeCallback, OnUserInfoChangedListener, ConfigurationListener {

    private static final int LAYOUT_NONE = 0;
    private static final int LAYOUT_CUTOUT = 1;
    private static final int LAYOUT_NO_CUTOUT = 2;

    private bool mBatteryCharging;
    private bool mKeyguardUserSwitcherShowing;
    private bool mBatteryListening;
    ...
    private bool updateLayoutConsideringCutout() {
    ...
    private bool updateLayoutParamsNoCutout() {
    ...
    private bool updateLayoutParamsForCutout(DisplayCutout dc) {
    ...
    private void updateUserSwitcher() {
        bool keyguardSwitcherAvailable = mKeyguardUserSwitcher != null;
    ...
    public void setKeyguardUserSwitcherShowing(bool showing, bool animate) {
    ...
    private void animateNextLayoutChange() {
        ...
        final bool userSwitcherVisible = mMultiUserSwitch.getParent() == mStatusIconArea;
        getViewTreeObserver().addOnPreDrawListener(new ViewTreeObserver.OnPreDrawListener() {
            override
            public bool onPreDraw() {
                getViewTreeObserver().removeOnPreDrawListener(this);
                bool userSwitcherHiding = userSwitcherVisible
