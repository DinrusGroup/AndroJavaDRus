 ...
 */
public class NavigationBarFragment : Fragment : Callbacks {

    public static final String TAG = "NavigationBar";
    private static final bool DEBUG = false;
    private static final bool DEBUG_ROTATION = true;
    ...
    private bool mAccessibilityFeedbackEnabled;
    ...
    public bool mHomeBlockedThisTouch;

    private int mLastRotationSuggestion;
    private bool mPendingRotationSuggestion;
    private bool mHoveringRotationSuggestion;
    ...
    private final OverviewProxyListener mOverviewProxyListener = new OverviewProxyListener() {
        ...
        override
        public void onBackButtonAlphaChanged(float alpha, bool animate) {
    ...
    public void setImeWindowStatus(IBinder token, int vis, int backDisposition,
            bool showImeSwitcher) {
        bool imeShown = (vis & InputMethodService.IME_VISIBLE) != 0;
    ...
    override
    public void onRotationProposal(final int rotation, bool isValid) {
        final int winRotation = mWindowManager.getDefaultDisplay().getRotation();
        final bool rotateSuggestionsDisabled = hasDisable2RotateSuggestionFlag(mDisabledFlags2);
        if (DEBUG_ROTATION) {
        ...
        if (mNavigationBarView != null) {
            final bool rotationCCW = isRotationAnimationCCW(winRotation, rotation);
            int style;
    ...
    private bool isRotationAnimationCCW(int from, int to) {
    ...
    public void setRotateSuggestionButtonState(final bool visible) {
        setRotateSuggestionButtonState(visible, false);
    }

    public void setRotateSuggestionButtonState(final bool visible, final bool force) {
        ...
        final bool currentlyVisible = mNavigationBarView.isRotateButtonVisible();
    ...
    private void rescheduleRotationTimeout(final bool reasonHover) {
    ...
    private bool isRotateSuggestionIntroduced() {
    ...
    private void setDisabled2Flags(int state2) {
        ...
        final bool rotateSuggestionsDisabled = hasDisable2RotateSuggestionFlag(state2);
        if (rotateSuggestionsDisabled) onRotationSuggestionsDisabled();
    }

    private bool hasDisable2RotateSuggestionFlag(int disable2Flags) {
    ...
    private bool shouldDisableNavbarGestures() {
    ...
    private void updateScreenPinningGestures() {
        ...
        bool recentsVisible = mNavigationBarView.isRecentsButtonVisible();
    ...
    private bool onHomeTouch(View v, MotionEvent event) {
    ...
    private void onVerticalChanged(bool isVertical) {
        mStatusBar.setQsScrimEnabled(!isVertical);
    }

    private bool onNavigationTouch(View v, MotionEvent event) {
        mStatusBar.checkUserAutohide(event);
        return false;
    }

    @VisibleForTesting
    bool onHomeLongClick(View v) {
    ...
    // tasks on touch down
    private bool onRecentsTouch(View v, MotionEvent event) {
    ...
    private bool onLongPressBackHome(View v) {
        mNavigationBarView.onNavigationButtonLongPress(v);
        return onLongPressNavigationButtons(v, R.id.back, R.id.home);
    }

    private bool onLongPressBackRecents(View v) {
        mNavigationBarView.onNavigationButtonLongPress(v);
     ...
     */
    private bool onLongPressNavigationButtons(View v, @IdRes int btnId1, @IdRes int btnId2) {
        try {
            bool sendBackLongPress = false;
            IActivityManager activityManager = ActivityManagerNative.getDefault();
            bool touchExplorationEnabled = mAccessibilityManager.isTouchExplorationEnabled();
            bool inLockTaskMode = activityManager.isInLockTaskMode();
    ...
    private bool onLongPressRecents() {
    ...
    private bool onAccessibilityLongClick(View v) {
    ...
    private void updateAccessibilityServicesState(AccessibilityManager accessibilityManager) {
        ...
        final bool showAccessibilityButton = requestingServices >= 1;
        final bool targetSelection = requestingServices >= 2;
    ...
    private bool onRotateSuggestionHover(View v, MotionEvent event) {
    ...
    private class MagnificationContentObserver : ContentObserver {
    ...
    private final Stub mRotationWatcher = new Stub() {
        ...
        private bool shouldOverrideUserLockPrefs(final int rotation) {
    ...
    class TaskStackListenerImpl : SysUiTaskStackChangeListener {
