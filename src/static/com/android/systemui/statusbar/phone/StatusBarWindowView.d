...
public class StatusBarWindowView : FrameLayout {
    public static final String TAG = "StatusBarWindowView";
    public static final bool DEBUG = StatusBar.DEBUG;
    ...
    private bool mTouchActive;
    private bool mExpandAnimationRunning;
    private bool mExpandAnimationPending;
    ...
    protected bool fitSystemWindows(Rect insets) {
        if (getFitsSystemWindows()) {
            bool paddingChanged = insets.top != getPaddingTop()
    ...
    public bool dispatchKeyEvent(KeyEvent event) {
        ...
        bool down = event.getAction() == KeyEvent.ACTION_DOWN;
    ...
    public bool dispatchTouchEvent(MotionEvent ev) {
        bool isDown = ev.getActionMasked() == MotionEvent.ACTION_DOWN;
        bool isCancel = ev.getActionMasked() == MotionEvent.ACTION_CANCEL;
    ...
    public void setExpandAnimationPending(bool pending) {
    ...
    public class LayoutParams : FrameLayout.LayoutParams {
