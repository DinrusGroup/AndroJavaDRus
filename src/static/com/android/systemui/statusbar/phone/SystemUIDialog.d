 ...
 */
public class SystemUIDialog : AlertDialog {
    ...
    public void setShowForAllUsers(bool show) {
    ...
    public static void setShowForAllUsers(Dialog dialog, bool show) {
        if (show) {
    ...
    private static class DismissReceiver : BroadcastReceiver : OnDismissListener {
