...
public class NavigationBarInflaterView : FrameLayout
        : Tunable, PluginListener<NavBarButtonProvider> {
    ...
    private bool mAlternativeOrder;
    private bool mUsingCustomLayout;
    ...
    public void updateButtonDispatchersCurrentView() {
        if (mButtonDispatchers != null) {
            ...
            final bool portrait = rotation == Surface.ROTATION_0
    ...
    public void setAlternativeOrder(bool alternativeOrder) {
    ...
    private void inflateButtons(String[] buttons, ViewGroup parent, bool landscape,
            bool start) {
    ...
    @Nullable
    protected View inflateButton(String buttonSpec, ViewGroup parent, bool landscape,
            bool start) {
    ...
    private View applySize(View v, String buttonSpec, bool landscape, bool start) {
