...
public class StatusBar : SystemUI : DemoMode,
        DragDownHelper.DragDownCallback, ActivityStarter, OnUnlockMethodChangedListener,
        OnHeadsUpChangedListener, CommandQueue.Callbacks, ZenModeController.Callback,
        ColorExtractor.OnColorsChangedListener, ConfigurationListener, NotificationPresenter {
    public static final bool MULTIUSER_DEBUG = false;

    public static final bool ENABLE_CHILD_NOTIFICATIONS
    ...
    public static final bool SPEW = false;
    public static final bool DUMPTRUCK = true; // extra dumpsys info
    public static final bool DEBUG_GESTURES = false;
    public static final bool DEBUG_MEDIA_FAKE_ARTWORK = false;
    public static final bool DEBUG_CAMERA_LIFT = false;

    public static final bool DEBUG_WINDOW_STATE = false;

    // additional instrumentation for testing purposes; intended to be left on during development
    public static final bool CHATTY = DEBUG;

    public static final bool SHOW_LOCKSCREEN_MEDIA_ARTWORK = true;
    ...
    protected static final bool CLOSE_PANEL_WHEN_EMPTIED = true;
    ...
    private static final bool ONLY_CORE_APPS;

    /** If true, the lockscreen will show a distinct wallpaper */
    private static final bool ENABLE_LOCKSCREEN_WALLPAPER = true;
    ...
    protected bool mBouncerShowing;
    ...
    private bool mBrightnessMirrorVisible;
    ...
    private bool mWakeUpComingFromTouch;
    ...
    private bool mLeaveOpenOnKeyguardHide;
    KeyguardIndicationController mKeyguardIndicationController;

    // Keyguard is actually fading away now.
    protected bool mKeyguardFadingAway;
    ...
    private bool mAutohideSuspended;
    ...
    protected bool mDozing;
    private bool mDozingRequested;
    protected bool mScrimSrcModeEnabled;
    ...
    private BroadcastReceiver mWallpaperChangedReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            final bool supportsAmbientMode = info != null &&
    ...
    protected bool mLaunchTransitionFadingAway;
    private ExpandableNotificationRow mDraggedDownRow;
    private bool mLaunchCameraOnScreenTurningOn;
    private bool mLaunchCameraOnFinishedGoingToSleep;
    ...
    private bool mTopHidesStatusBar;
    private bool mStatusBarWindowHidden;
    private bool mHideIconsForBouncer;
    private bool mIsOccluded;
    private bool mWereIconsJustHidden;
    private bool mBouncerWasShowingWhenHidden;
    ...
    protected bool mPanelExpanded;
    private IOverlayManager mOverlayManager;
    private bool mKeyguardRequested;
    private bool mIsKeyguard;
    private LogMaker mStatusBarStateLog;
    private final LockscreenGestureLogger mLockscreenGestureLogger = new LockscreenGestureLogger();
    protected NotificationIconAreaController mNotificationIconAreaController;
    private bool mReinflateNotificationsOnUserSwitched;
    protected bool mClearAllEnabled;
    ...
    private bool mNoAnimationOnNextBarModeChange;
    protected FalsingManager mFalsingManager;

    private final KeyguardUpdateMonitorCallback mUpdateCallback =
            new KeyguardUpdateMonitorCallback() {
                override
                public void onDreamingStateChanged(bool dreaming) {
                    if (dreaming) {
    ...
    private bool mVibrateOnOpening;
    ...
    protected void makeStatusBarView() {
        ...
        try {
            bool showNav = mWindowManagerService.hasNavigationBar();
        ...
        mBatteryController.addCallback(new BatteryStateChangeCallback() {
            override
            public void onPowerSaveChanged(bool isPowerSave) {
            ...
            override
            public void onBatteryLevelChanged(int level, bool pluggedIn, bool charging) {
                // noop
            }
        });
        ...
        if (mScrimSrcModeEnabled) {
            Runnable runnable = () -> {
                bool asSrc = mBackdrop.getVisibility() != View.VISIBLE;
    ...
    public void clearAllNotifications() {
        ...
        for (int i = 0; i < numChildren; i++) {
            ...
            if (child instanceof ExpandableNotificationRow) {
                ...
                bool hasClipBounds = child.getClipBounds(mTmpRect);
    ...
    protected bool toggleSplitScreenMode(int metricsDockAction, int metricsUndockAction) {
        if (mRecents == null) {
            return false;
        }
    ...
    protected void updateFooter() {
        bool showDismissView = mClearAllEnabled && hasActiveClearableNotifications();
        bool showFooterView = (showDismissView ||
     ...
     */
    private bool hasActiveClearableNotifications() {
    ...
    private void updateSpeedBumpIndex() {
        ...
        bool noAmbient = speedBumpIndex == N;
        mStackScroller.updateSpeedBumpIndex(speedBumpIndex, noAmbient);
    }

    public static bool isTopLevelChild(Entry entry) {
        return entry.row.getParent() instanceof NotificationStackScrollLayout;
    }

    public bool areNotificationsHidden() {
    ...
    protected void setAreThereNotifications() {
        ...
        if (SPEW) {
            final bool clearable = hasActiveNotifications() &&
        ...
        if (mStatusBarView != null) {
            ...
            final bool showDot = hasActiveNotifications() && !areLightsOn();
     ...
     */
    override
    public void updateMediaMetaData(bool metaDataChanged, bool allowEnterAnimation) {
        ...
        bool wakeAndUnlock = mFingerprintUnlockController != null
        ...
        bool hideBecauseOccluded = mStatusBarKeyguardViewManager != null
                && mStatusBarKeyguardViewManager.isOccluded();

        final bool hasArtwork = artworkDrawable != null;
        ...
        if ((hasArtwork || DEBUG_MEDIA_FAKE_ARTWORK) && !mDozing
            ...
            if (mBackdrop.getVisibility() != View.GONE) {
                ...
                bool cannotAnimateDoze = mDozing && !ScrimState.AOD.getAnimateChange();
     ...
     */
    public void recomputeDisableFlags(bool animate) {
    ...
    private void startActivity(Intent intent, bool onlyProvisioned, bool dismissShade,
            int flags) {
    ...
    public bool isGoingToNotificationShade() {
        return mLeaveOpenOnKeyguardHide;
    }

    public bool isWakeUpComingFromTouch() {
        return mWakeUpComingFromTouch;
    }

    public bool isFalsingThresholdNeeded() {
        return getBarState() == StatusBarState.KEYGUARD;
    }

    override
    public bool isDozing() {
        return mDozing && mStackScroller.isFullyDark();
    }

    override
    public bool shouldPeek(Entry entry, StatusBarNotification sbn) {
        if (mIsOccluded && !isDozing()) {
            bool devicePublic = mLockscreenUserManager.
                    isLockscreenPublicMode(mLockscreenUserManager.getCurrentUserId());
            bool userPublic = devicePublic
                    || mLockscreenUserManager.isLockscreenPublicMode(sbn.getUserId());
            bool needsRedaction = mLockscreenUserManager.needsRedaction(entry);
    ...
    public bool isScrimSrcModeEnabled() {
    ...
    override
    public void onHeadsUpPinnedModeChanged(bool inPinnedMode) {
        if (inPinnedMode) {
    ...
    override
    public void onHeadsUpStateChanged(Entry entry, bool isHeadsUp) {
    ...
    public bool isKeyguardCurrentlySecure() {
    ...
    public bool isLaunchTransitionFadingAway() {
        return mLaunchTransitionFadingAway;
    }

    public bool hideStatusBarIconsWhenExpanded() {
    ...
    public bool hideStatusBarIconsForBouncer() {
     ...
     */
    private void updateHideIconsForBouncer(bool animate) {
        bool hideBecauseApp = mTopHidesStatusBar && mIsOccluded
                && (mStatusBarWindowHidden || mBouncerShowing);
        bool hideBecauseKeyguard = !mPanelExpanded && !mIsOccluded && mBouncerShowing;
        bool shouldHideIconsForBouncer = hideBecauseApp || hideBecauseKeyguard;
    ...
    override
    public void showPinningEnterExitToast(bool entering) {
        if (entering) {
    ...
    void makeExpandedVisible(bool force) {
    ...
    public void animateCollapsePanels(int flags, bool force) {
        animateCollapsePanels(flags, force, false /* delayed */, 1.0f /* speedUpFactor */);
    }

    public void animateCollapsePanels(int flags, bool force, bool delayed) {
    ...
    public bool interceptTouchEvent(MotionEvent event) {
        if (DEBUG_GESTURES) {
    ...
    public void setWindowState(int window, int state) {
        bool showing = state == WINDOW_STATE_SHOWING;
    ...
    public void setInteracting(int barWindow, bool interacting) {
        final bool changing = ((mInteractingWindows & barWindow) != 0) != interacting;
    ...
    override
    public void topAppWindowChanged(bool showMenu) {
        if (SPEW) {
    ...
    public void dump(FileDescriptor fd, PrintWriter pw, String[] args) {
        ...
        final bool lightWpTheme = mContext.getThemeResId() == R.style.Theme_SystemUI_Light;
    ...
    public void startActivityDismissingKeyguard(final Intent intent, bool onlyProvisioned,
            bool dismissShade, int flags) {
        startActivityDismissingKeyguard(intent, onlyProvisioned, dismissShade,
    ...
    public void startActivityDismissingKeyguard(final Intent intent, bool onlyProvisioned,
            final bool dismissShade, final bool disallowEnterPictureInPictureWhileLaunching,
            final Callback callback, int flags) {
        if (onlyProvisioned && !isDeviceProvisioned()) return;

        final bool afterKeyguardGone = PreviewInflater.wouldLaunchResolverActivity(
    ...
    public void executeRunnableDismissingKeyguard(final Runnable runnable,
            ...
            final bool dismissShade,
            final bool afterKeyguardGone,
            final bool deferred) {
    ...
    protected void dismissKeyguardThenExecute(OnDismissAction action, bool afterKeyguardGone) {
        dismissKeyguardThenExecute(action, null /* cancelRunnable */, afterKeyguardGone);
    }

    private void dismissKeyguardThenExecute(OnDismissAction action, Runnable cancelAction,
            bool afterKeyguardGone) {
    ...
    protected void handleVisibleToUserChanged(bool visibleToUser) {
        if (visibleToUser) {
     ...
     */
    private void handleVisibleToUserChangedImpl(bool visibleToUser) {
        if (visibleToUser) {
            bool pinnedHeadsUp = mHeadsUpManager.hasPinnedHeadsUp();
            bool clearNotificationEffects =
    ...
    private void logStateToEventlog() {
        bool isShowing = mStatusBarKeyguardViewManager.isShowing();
        bool isOccluded = mStatusBarKeyguardViewManager.isOccluded();
        bool isBouncerShowing = mStatusBarKeyguardViewManager.isBouncerShowing();
        bool isSecure = mUnlockMethodCache.isMethodSecure();
        bool canSkipBouncer = mUnlockMethodCache.canSkipBouncer();
     ...
     */
    private static int getLoggingFingerprint(int statusBarState, bool keyguardShowing,
            bool keyguardOccluded, bool bouncerShowing, bool secure,
            bool currentlyInsecure) {
    ...
    private void handleStartActivityDismissingKeyguard(Intent intent, bool onlyProvisioned) {
    ...
    public void dispatchDemoCommand(String command, Bundle args) {
        ...
        bool modeChange = command.equals(COMMAND_ENTER) || command.equals(COMMAND_EXIT);
    ...
    override
    public bool isPresenterFullyCollapsed() {
     ...
     */
    public bool isFullScreenUserSwitcherState() {
        return mState == StatusBarState.FULLSCREEN_USER_SWITCHER;
    }

    private bool updateIsKeyguard() {
        bool wakeAndUnlocking = mFingerprintUnlockController.getMode()
        ...
        // turned off fully.
        bool keyguardForDozing = mDozingRequested &&
                (!mDeviceInteractive || isGoingToSleep() && (isScreenFullyOff() || mIsKeyguard));
        bool shouldBeKeyguard = (mKeyguardRequested || keyguardForDozing) && !wakeAndUnlocking;
    ...
    public bool isInLaunchTransition() {
     ...
     */
    public bool hideKeyguardImpl() {
        mIsKeyguard = false;
        Trace.beginSection("StatusBar#hideKeyguard");
        bool staying = mLeaveOpenOnKeyguardHide;
    ...
    private void updatePublicMode() {
        final bool showingKeyguard = mStatusBarKeyguardViewManager.isShowing();
        final bool devicePublic = showingKeyguard
        ...
        for (int i = currentProfiles.size() - 1; i >= 0; i--) {
            ...
            bool isProfilePublic = devicePublic;
    ...
    protected void updateKeyguardState(bool goingToFullShade, bool fromShadeLocked) {
    ...
    protected void updateTheme() {
        final bool inflated = mStackScroller != null;

        // The system wallpaper defines if QS should be light or dark.
        WallpaperColors systemColors = mColorExtractor
                .getWallpaperColors(WallpaperManager.FLAG_SYSTEM);
        final bool useDarkTheme = systemColors != null
        ...
        final bool lockDarkText = mColorExtractor.getColors(WallpaperManager.FLAG_LOCK, true
        ...
        if (inflated) {
            ...
            final bool useDarkText = mColorExtractor.getColors(which,
    ...
    private void updateDozingState() {
        ...
        bool sleepingFromKeyguard =
                mStatusBarKeyguardViewManager.isGoingToSleepVisibleNotOccluded();
        bool animate = (!mDozing && mDozeServiceHost.shouldAnimateWakeup())
    ...
    public void updateStackScrollerState(bool goingToFullShade, bool fromShadeLocked) {
        if (mStackScroller == null) return;
        bool onKeyguard = mState == StatusBarState.KEYGUARD;
        bool publicMode = mLockscreenUserManager.isAnyProfilePublicMode();
        if (mHeadsUpAppearanceController != null) {
    ...
    public bool interceptMediaKey(KeyEvent event) {
        return mState == StatusBarState.KEYGUARD
                && mStatusBarKeyguardViewManager.interceptMediaKey(event);
    }

    protected bool shouldUnlockOnMenuPressed() {
    ...
    public bool onBackPressed() {
        bool isScrimmedBouncer = mScrimController.getState() == ScrimState.BOUNCER_SCRIMMED;
    ...
    protected void showBouncer(bool scrimmed) {
    ...
    public void onTrackingStopped(bool expand) {
        if (mState == StatusBarState.KEYGUARD || mState == StatusBarState.SHADE_LOCKED) {
    ...
    override
    public int getMaxNotificationsWhileLocked(bool recompute) {
        if (recompute) {
    ...
    override
    public bool onDraggedDown(View startingChild, int dragLengthY) {
        if (mState == StatusBarState.KEYGUARD
    ...
    override
    public void onCrossedThreshold(bool above) {
    ...
    override
    public bool isFalsingCheckNeeded() {
        return mState == StatusBarState.KEYGUARD;
    }
    ...
    public void goToLockedShade(View expandView) {
        ...
        bool fullShadeNeedsBouncer = !mLockscreenUserManager.
    ...
    override
    public bool shouldHandleRemoteInput(View view, PendingIntent pendingIntent) {
        // Skip remote input as doing so will expand the notification shade.
        return (mDisabled2 & StatusBarManager.DISABLE2_NOTIFICATION_SHADE) != 0;
    }

    override
    public bool handleRemoteViewClick(View view, PendingIntent pendingIntent,
            Intent fillInIntent, NotificationRemoteInputManager.ClickHandler defaultHandler) {
        final bool isActivity = pendingIntent.isActivity();
        if (isActivity) {
            final bool afterKeyguardGone = PreviewInflater.wouldLaunchResolverActivity(
            ...
            dismissKeyguardThenExecute(() -> {
                ...
                bool handled = defaultHandler.handleClick();
    ...
    protected bool startWorkChallengeIfNecessary(int userId, IntentSender intendSender,
    ...
    override
    public void onExpandClicked(Entry clickedEntry, bool nowExpanded) {
    ...
    public void setBouncerShowing(bool bouncerShowing) {
    ...
    public void showScreenPinningRequest(int taskId, bool allowCancel) {
    ...
    override
    public bool isDeviceLocked(int userId) {
    ...
    private bool isScreenTurningOnOrOn() {
    ...
    private void updateDozing() {
        ...
        bool dozing = mDozingRequested && mState == StatusBarState.KEYGUARD
                || mFingerprintUnlockController.getMode()
                        == FingerprintUnlockController.MODE_WAKE_AND_UNLOCK_PULSING;
        final bool alwaysOn = DozeParameters.getInstance(mContext).getAlwaysOn();
    ...
    void updateScrimController() {
        ...
        bool wakeAndUnlocking = mFingerprintUnlockController.isWakeAndUnlock();
    ...
    private final class DozeServiceHost : DozeHost {
        private final ArrayList<Callback> mCallbacks = new ArrayList<>();
        private bool mAnimateWakeup;
        private bool mAnimateScreenOff;
        private bool mIgnoreTouchWhilePulsing;
        ...
        public void firePowerSaveChanged(bool active) {
        ...
        override
        public void onIgnoreTouchWhilePulsing(bool ignore) {
        ...
        override
        public bool isPowerSaveActive() {
            return mBatteryController.isAodPowerSave();
        }

        override
        public bool isPulsingBlocked() {
        ...
        override
        public void setAnimateWakeup(bool animateWakeup) {
        ...
        override
        public void setAnimateScreenOff(bool animateScreenOff) {
        ...
        private bool shouldAnimateWakeup() {
            return mAnimateWakeup;
        }

        public bool shouldAnimateScreenOff() {
            return mAnimateScreenOff;
        }
    }

    public bool shouldIgnoreTouch() {
    ...
    protected bool mDeviceInteractive;

    protected bool mVisible;

    // mScreenOnFromKeyguard && mVisible.
    private bool mVisibleToUser;
    ...
    private final IVrStateCallbacks mVrStateCallbacks = new IVrStateCallbacks.Stub() {
        override
        public void onVrStateChanged(bool enabled) {
            mVrMode = enabled;
        }
    };

    public bool isDeviceInVrMode() {
        return mVrMode;
    }
    ...
    public void onNotificationClicked(StatusBarNotification sbn, ExpandableNotificationRow row) {
        ...
        final bool afterKeyguardGone = intent.isActivity()
                && PreviewInflater.wouldLaunchResolverActivity(mContext, intent.getIntent(),
                mLockscreenUserManager.getCurrentUserId());
        final bool wasOccluded = mIsOccluded;
        dismissKeyguardThenExecute(() -> {
    ...
    override  // NotificationData.Environment
    public bool isNotificationForCurrentProfiles(StatusBarNotification n) {
    ...
    override
    public void setTopAppHidesStatusBar(bool topAppHidesStatusBar) {
     ...
     */
    override  // NotificationData.Environment
    public bool isSecurelyLocked(int userId) {
    ...
    private bool shouldAutoCancel(StatusBarNotification sbn) {
    ...
    protected void visibilityChanged(bool visible) {
        if (mVisible != visible) {
            mVisible = visible;
            if (!visible) {
                mGutsManager.closeAndSaveGuts(true /* removeLeavebehind */, true /* force */,
    ...
    protected void updateVisibleToUser() {
        bool oldVisibleToUser = mVisibleToUser;
