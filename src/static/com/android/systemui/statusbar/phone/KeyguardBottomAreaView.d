 ...
 * text.
 */
public class KeyguardBottomAreaView : FrameLayout : View.OnClickListener,
    ...
    private bool mLeftIsVoiceAssist;
    ...
    override
    public void onStateChanged(bool accessibilityEnabled, bool touchExplorationEnabled) {
    ...
    public void unbindCameraPrewarmService(bool launched) {
        if (mPrewarmBound) {
    ...
    public void launchCamera(String source) {
        ...
        bool wouldLaunchResolverActivity = PreviewInflater.wouldLaunchResolverActivity(
        ...
        if (intent == SECURE_CAMERA_INTENT && !wouldLaunchResolverActivity) {
            AsyncTask.execute(new Runnable() {
                ...
                public void run() {
                    ...
                    final bool launched = isSuccessfulLaunch(result);
                    post(new Runnable() {
                        override
                        public void run() {
    ...
    private static bool isSuccessfulLaunch(int result) {
    ...
    private void launchVoiceAssist() {
        ...
        if (mStatusBar.isKeyguardCurrentlySecure()) {
            ...
            bool dismissShade = !TextUtils.isEmpty(mRightButtonStr)
    ...
    private bool canLaunchVoiceAssist() {
    ...
    private void launchPhone() {
        ...
        if (tm.isInCall()) {
            ...
            bool dismissShade = !TextUtils.isEmpty(mLeftButtonStr)
    ...
    private final KeyguardUpdateMonitorCallback mUpdateMonitorCallback =
            new KeyguardUpdateMonitorCallback() {
                ...
                override
                public void onFingerprintRunningStateChanged(bool running) {
                    mLockIcon.update();
                }
    ...
    private class DefaultLeftButton : IntentButton {
    ...
    private class DefaultRightButton : IntentButton {
        ...
        public IconState getIcon() {
            ...
            bool isCameraDisabled = (mStatusBar != null) && !mStatusBar.isCameraAllowedByAdmin();
        ...
        public Intent getIntent() {
            KeyguardUpdateMonitor updateMonitor = KeyguardUpdateMonitor.getInstance(mContext);
            bool canSkipBouncer = updateMonitor.getUserCanSkipBouncer(
                    KeyguardUpdateMonitor.getCurrentUser());
            bool secure = mLockPatternUtils.isSecure(KeyguardUpdateMonitor.getCurrentUser());
