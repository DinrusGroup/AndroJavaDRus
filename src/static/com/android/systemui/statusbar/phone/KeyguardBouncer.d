...
public class KeyguardBouncer {
    ...
    private bool mShowingSoon;
    private int mBouncerPromptReason;
    private bool mIsAnimatingAway;
    private bool mIsScrimmed;
    ...
    public void show(bool resetSecuritySelection) {
     ...
     */
    public void show(bool resetSecuritySelection, bool isScrimmed) {
        ...
        final bool allowDismissKeyguard = !isSystemUser && activeUserId == keyguardUserId;
    ...
    public void hide(bool destroyView) {
        if (isShowing()) {
            StatsLog.write(StatsLog.KEYGUARD_BOUNCER_STATE_CHANGED,
     ...
     */
    public bool isAnimatingAway() {
        return mIsAnimatingAway;
    }

    public void prepare() {
        bool wasInitialized = mRoot != null;
        ensureView();
        if (wasInitialized) {
            mKeyguardView.showPrimarySecurityScreen();
        }
    ...
    protected void ensureView() {
        ...
        bool forceRemoval = mHandler.hasCallbacks(mRemoveViewRunnable);
     ...
     */
    public bool needsFullscreenBouncer() {
        ensureView();
        if (mKeyguardView != null) {
