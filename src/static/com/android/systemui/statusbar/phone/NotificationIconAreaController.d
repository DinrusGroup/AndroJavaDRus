 ...
 */
public class NotificationIconAreaController : DarkReceiver {
    ...
    protected bool shouldShowNotificationIcon(NotificationData.Entry entry,
            bool showAmbient, bool hideDismissed, bool hideRepliedMessages) {
    ...
    private void updateIconsForLayout(Function<NotificationData.Entry, StatusBarIconView> function,
            NotificationIconContainer hostLayout, bool showAmbient, bool hideDismissed,
            bool hideRepliedMessages) {
    ...
    private void updateTintForIcon(StatusBarIconView v) {
        bool isPreL = Boolean.TRUE.equals(v.getTag(R.id.icon_is_pre_L));
        int color = StatusBarIconView.NO_COLOR;
        bool colorize = !isPreL || NotificationUtils.isGrayscale(v, mNotificationColorUtil);
        if (colorize) {
    ...
    public void setIsolatedIconLocation(Rect iconDrawingRect, bool requireStateUpdate) {
