...
public abstract class PanelView : FrameLayout {
    public static final bool DEBUG = PanelBar.DEBUG;
    ...
    private bool mPanelUpdateWhenAnimatorEnds;
    private bool mVibrateOnOpening;
    protected bool mLaunchingNotification;
    ...
    private bool mCollapsedAndHeadsUpOnDown;
    private float mExpandedFraction = 0;
    protected float mExpandedHeight = 0;
    private bool mPanelClosedOnDown;
    private bool mHasLayoutedSinceDown;
    private float mUpdateFlingVelocity;
    private bool mUpdateFlingOnLayout;
    private bool mPeekTouching;
    private bool mJustPeeked;
    private bool mClosing;
    protected bool mTracking;
    private bool mTouchSlopExceeded;
    private int mTrackingPointer;
    protected int mTouchSlop;
    protected bool mHintAnimationRunning;
    private bool mOverExpandedBeforeFling;
    private bool mTouchAboveFalsingThreshold;
    private int mUnlockFalsingThreshold;
    private bool mTouchStartedInEmptyArea;
    private bool mMotionAborted;
    private bool mUpwardsWhenTresholdReached;
    private bool mAnimatingOnDown;
     ...
     */
    private bool mInstantExpanding;
    private bool mAnimateAfterExpanding;
    ...
    private bool mGestureWaitForTouchSlop;
    private bool mIgnoreXTouchSlop;
    private bool mExpandLatencyTracking;
    ...
    private void runPeekAnimation(long duration, float peekHeight, bool collapseWhenFinished) {
     ...
     */
    private bool isDirectionUpwards(float x, float y) {
    ...
    protected void startExpandMotion(float newX, float newY, bool startTracking,
    ...
    private void endMotionEvent(MotionEvent event, float x, float y, bool forceCancel) {
        mTrackingPointer = -1;
        if ((mTracking && mTouchSlopExceeded)
            ...
            bool expand = flingExpands(vel, vectorVel, x, y)
                    || event.getActionMasked() == MotionEvent.ACTION_CANCEL
                    || forceCancel;
            ...
            bool expands = onEmptySpaceClick(mInitialTouchX);
    ...
    protected abstract bool hasConflictingGestures();

    protected abstract bool shouldGestureIgnoreXTouchSlop(float x, float y);
     ...
     */
    protected abstract bool isInContentBounds(float x, float y);
     ...
     */
    private bool isFalseTouch(float x, float y) {
    ...
    protected void fling(float vel, bool expand) {
        fling(vel, expand, 1.0f /* collapseSpeedUpFactor */, false);
    }

    protected void fling(float vel, bool expand, bool expandBecauseOfFalsing) {
        fling(vel, expand, 1.0f /* collapseSpeedUpFactor */, expandBecauseOfFalsing);
    }

    protected void fling(float vel, bool expand, float collapseSpeedUpFactor,
            bool expandBecauseOfFalsing) {
        cancelPeek();
    ...
    protected void flingToHeight(float vel, bool expand, float target,
        ...
        final bool clearAllExpandHack = expand && fullyExpandedClearAllVisible()
    ...
    protected abstract bool shouldUseDismissingAnimation();
     ...
     */
    protected abstract bool isTrackingBlocked();

    protected abstract void setOverExpansion(float overExpansion, bool isPixels);
    ...
    public bool canPanelBeCollapsed() {
    ...
    public void expand(final bool animate) {
    ...
    protected abstract bool isPanelVisibleBecauseOfHeadsUp();
     ...
     */
    protected bool onEmptySpaceClick(float x) {
    ...
    protected abstract bool onMiddleClicked();

    protected abstract bool isDozing();
     ...
     */
    protected abstract bool fullyExpandedClearAllVisible();

    protected abstract bool isClearAllVisible();
    ...
    public void setLaunchingNotification(bool launchingNotification) {
