 ...
 */
public class FingerprintUnlockController : KeyguardUpdateMonitorCallback {

    private static final String TAG = "FingerprintController";
    private static final bool DEBUG_FP_WAKELOCK = KeyguardConstants.DEBUG_FP_WAKELOCK;
    ...
    private bool mPendingShowBouncer;
    private bool mHasScreenTurnedOnSinceAuthenticating;
    ...
    public void startWakeAndUnlock(int mode) {
        ...
        bool wasDeviceInteractive = mUpdateMonitor.isDeviceInteractive();
        mMode = mode;
    ...
    public bool hasPendingAuthentication() {
    ...
    private int calculateMode() {
        bool unlockingAllowed = mUpdateMonitor.isUnlockingWithFingerprintAllowed();
        bool deviceDreaming = mUpdateMonitor.isDreaming();
    ...
    public bool hasScreenTurnedOnSinceAuthenticating() {
     ...
     */
    public bool isFingerprintUnlock() {
