 ...
 */
public class LightBarController : BatteryController.BatteryStateChangeCallback, Dumpable {
    ...
    private bool mFullscreenLight;
    private bool mDockedLight;
    ...
    public void onSystemUiVisibilityChanged(int fullscreenStackVis, int dockedStackVis,
            int mask, Rect fullscreenStackBounds, Rect dockedStackBounds, bool sbModeChanged,
            int statusBarMode) {
    ...
    public void onNavigationVisibilityChanged(int vis, int mask, bool nbModeChanged,
    ...
    public void setQsCustomizing(bool customizing) {
    ...
    public void setScrimState(ScrimState scrimState, float scrimBehindAlpha,
        ...
        bool forceDarkForScrimLast = mForceDarkForScrim;
    ...
    private bool isLight(int vis, int barMode, int flag) {
        bool isTransparentBar = (barMode == MODE_TRANSPARENT
                || barMode == MODE_LIGHTS_OUT_TRANSPARENT);
        bool light = (vis & flag) != 0;
        return isTransparentBar && light;
    }

    private bool animateChange() {
    ...
    private void updateStatus(Rect fullscreenStackBounds, Rect dockedStackBounds) {
        bool hasDockedStack = !dockedStackBounds.isEmpty();
