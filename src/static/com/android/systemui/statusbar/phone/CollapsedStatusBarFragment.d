 ...
 */
public class CollapsedStatusBarFragment : Fragment : CommandQueue.Callbacks {
    ...
    private bool shouldHideNotificationIcons() {
    ...
    public void hideSystemIconArea(bool animate) {
        animateHide(mSystemIconArea, animate);
    }

    public void showSystemIconArea(bool animate) {
        animateShow(mSystemIconArea, animate);
    }

    public void hideClock(bool animate) {
        animateHiddenState(mClockView, clockHiddenMode(), animate);
    }

    public void showClock(bool animate) {
    ...
    public void hideNotificationIconArea(bool animate) {
        animateHide(mNotificationIconAreaInner, animate);
    }

    public void showNotificationIconArea(bool animate) {
        animateShow(mNotificationIconAreaInner, animate);
    }

    public void hideOperatorName(bool animate) {
        if (mOperatorNameFrame != null) {
            animateHide(mOperatorNameFrame, animate);
        }
    }

    public void showOperatorName(bool animate) {
        if (mOperatorNameFrame != null) {
     ...
     */
    private void animateHiddenState(final View v, int state, bool animate) {
        v.animate().cancel();
        if (!animate) {
            v.setAlpha(0f);
     ...
     * Hides a view.
     */
    private void animateHide(final View v, bool animate) {
     ...
     */
    private void animateShow(View v, bool animate) {
        v.animate().cancel();
