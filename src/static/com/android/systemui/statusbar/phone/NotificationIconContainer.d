 ...
 */
public class NotificationIconContainer : AlphaOptimizedFrameLayout {
    /**
    ...
    private static final bool DEBUG_OVERFLOW = false;
    ...
    private bool mIsStaticLayout = true;
    ...
    private bool mDark;
    private bool mChangingViewPositions;
    private int mAddAnimationStartIndex = -1;
    private int mCannedAnimationStartIndex = -1;
    private int mSpeedBumpIndex = -1;
    private int mIconSize;
    private float mOpenedAmount = 0.0f;
    private bool mDisallowNextAnimation;
    ...
    public void onViewAdded(View child) {
        ...
        bool isReplacingIcon = isReplacingIcon(child);
    ...
    private bool isReplacingIcon(View child) {
        ...
        if (child instanceof StatusBarIconView) {
            ...
            if (!mChangingViewPositions) {
                ...
                if (!isReplacingIcon) {
                    ...
                    bool isIsolatedIcon = child == mIsolatedIcon;
    ...
    public void calculateIconTranslations() {
        ...
        bool hasAmbient = mSpeedBumpIndex != -1 && mSpeedBumpIndex < getChildCount();
        for (int i = 0; i < childCount; i++) {
            ...
            bool forceOverflow = mSpeedBumpIndex != -1 && i >= mSpeedBumpIndex
                    && iconState.iconAppearAmount > 0.0f || i >= maxVisibleIcons;
            bool noOverflowAfter = i == childCount - 1;
     ...
     */
    public void setIsStaticLayout(bool isStaticLayout) {
    ...
    public void setChangingViewPositions(bool changingViewPositions) {
     ...
     */
    public bool hasPartialOverflow() {
    ...
    public void showIconIsolated(StatusBarIconView icon, bool animated) {
        if (animated) {
    ...
    public void setIsolatedIconLocation(Rect isolatedIconLocation, bool requireUpdate) {
    ...
    public class IconState : ViewState {
        ...
        private bool justReplaced;
        public bool needsCannedAnimation;
        public bool useFullTransitionAmount;
        public bool useLinearTransitionAmount;
        public bool translateContent;
        public int iconColor = StatusBarIconView.NO_COLOR;
        public bool noAnimations;
        public bool isLastExpandIcon;
        ...
        public void applyToView(View view) {
            if (view instanceof StatusBarIconView) {
                ...
                bool animationsAllowed = mAnimationsEnabled && !mDisallowNextAnimation
                        && !noAnimations;
                ...
                bool inShelf = iconAppearAmount == 1.0f;
        ...
        public bool hasCustomTransformHeight() {
