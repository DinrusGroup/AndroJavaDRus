 ...
 */
public class PhoneStatusBarPolicy : Callback, Callbacks,
    ...
    private bool mZenVisible;
    private bool mVolumeVisible;
    private bool mCurrentUserSetup;
    private bool mDockedStackExists;

    private bool mManagedProfileIconVisible = false;
    ...
    override
    public void onLocationActiveChanged(bool active) {
        updateLocation();
    }
    ...
    private void updateAlarm() {
        ...
        final bool hasAlarm = alarm != null && alarm.getTriggerTime() > 0;
    ...
    override
    public void onBluetoothStateChange(bool enabled) {
        updateBluetooth();
    }
    ...
    private final void updateTTY(int currentTtyMode) {
        bool enabled = currentTtyMode != TelecomManager.TTY_MODE_OFF;
    ...
    private void updateManagedProfile() {
        ...
        mUiOffloadThread.submit(() -> {
            ...
            try {
                ...
                bool isManagedProfile = mUserManager.isManagedProfile(userId);
                mHandler.post(() -> {
                    final bool showIcon;
                    if (isManagedProfile &&
    ...
    private bool hasNotif(ArraySet<Pair<String, Integer>> notifs, String pkg, int userId) {
    ...
    public void onUserSetupChanged() {
        bool userSetup = mProvisionedController.isUserSetup(
    ...
    public void onRotationLockStateChanged(bool rotationLocked, bool affordanceVisible) {
        bool portrait = RotationLockTile.isCurrentOrientationLockPortrait(
    ...
    private void updateHeadsetPlug(Intent intent) {
        bool connected = intent.getIntExtra("state", 0) != 0;
        bool hasMic = intent.getIntExtra("microphone", 0) != 0;
        if (connected) {
