...
public class ExpandableIndicator : ImageView {

    private bool mExpanded;
    private bool mIsDefaultDirection = true;
    ...
    public void setDefaultDirection(bool isDefaultDirection) {
        mIsDefaultDirection = isDefaultDirection;
        updateIndicatorDrawable();
    }

    private int getDrawableResourceId(bool expanded) {
    ...
    private String getContentDescription(bool expanded) {
