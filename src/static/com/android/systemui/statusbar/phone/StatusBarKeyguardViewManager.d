 ...
 */
public class StatusBarKeyguardViewManager : RemoteInputController.Callback {
    ...
    protected bool mOccluded;
    protected bool mRemoteInputActive;
    private bool mDozing;

    protected bool mFirstUpdate = true;
    protected bool mLastShowing;
    protected bool mLastOccluded;
    private bool mLastBouncerShowing;
    private bool mLastBouncerDismissible;
    protected bool mLastRemoteInputActive;
    private bool mLastDozing;
    private int mLastFpMode;
    private bool mGoingToSleepVisibleNotOccluded;
    ...
    @VisibleForTesting
    void onPanelExpansionChanged(float expansion, bool tracking) {
     ...
     */
    protected void showBouncerOrKeyguard(bool hideBouncerWhenShowing) {
    ...
    protected bool shouldDestroyViewOnReset() {
        return false;
    }

    private void hideBouncer(bool destroyView) {
        mBouncer.hide(destroyView);
        cancelPendingWakeupAction();
    }

    public void showBouncer(bool scrimmed) {
    ...
    public void dismissWithAction(OnDismissAction r, Runnable cancelAction,
            bool afterKeyguardGone, String message) {
        if (mShowing) {
            cancelPendingWakeupAction();
    ...
    private bool isWakeAndUnlocking() {
     ...
     */
    public void reset(bool hideBouncerWhenShowing) {
        if (mShowing) {
    ...
    public bool isGoingToSleepVisibleNotOccluded() {
    ...
    override
    public void onRemoteInputActive(bool active) {
    ...
    public bool isUnlockWithWallpaper() {
        return mStatusBarWindowManager.isShowingWallpaper();
    }

    public void setOccluded(bool occluded, bool animate) {
        ...
        bool isOccluding = !mOccluded && occluded;
        mOccluded = occluded;
        if (mShowing) {
    ...
    public void hide(long startTime, long fadeoutDuration) {
        ...
        if (mStatusBar.isInLaunchTransition() ) {
            ...
            if (wakeUnlockPulsing) {
                ...
                bool staying = mStatusBar.hideKeyguard();
                if (!staying) {
                    mStatusBarWindowManager.setKeyguardFadingAway(true);
                    wakeAndUnlockDejank();
                } else {
     ...
     */
    public bool onBackPressed(bool hideImmediately) {
        if (mBouncer.isShowing()) {
    ...
    public bool isFullscreenBouncer() {
    ...
    protected void updateStates() {
        ...
        bool occluded = mOccluded;
        bool bouncerShowing = mBouncer.isShowing();
        bool bouncerDismissible = !mBouncer.isFullscreenBouncer();
        bool remoteInputActive = mRemoteInputActive;
        ...
        bool navBarVisible = isNavBarVisible();
        bool lastNavBarVisible = getLastNavBarVisible();
    ...
    protected void updateNavigationBarVisibility(bool navBarVisible) {
     ...
     */
    protected bool isNavBarVisible() {
        int fpMode = mFingerprintUnlockController.getMode();
        bool keyguardShowing = mShowing && !mOccluded;
        bool hideWhileDozing = mDozing && fpMode != MODE_WAKE_AND_UNLOCK_PULSING;
     ...
     */
    protected bool getLastNavBarVisible() {
        bool keyguardShowing = mLastShowing && !mLastOccluded;
        bool hideWhileDozing = mLastDozing && mLastFpMode != MODE_WAKE_AND_UNLOCK_PULSING;
        return (!keyguardShowing && !hideWhileDozing || mLastBouncerShowing
                || mLastRemoteInputActive);
    }

    public bool shouldDismissOnMenuPressed() {
    ...
    public bool shouldDisableWindowAnimationsForUnlock() {
     ...
     * fingerprint.
     */
    public void notifyKeyguardAuthenticated(bool strongAuth) {
    ...
    public bool willDismissWithAction() {
        return mBouncer.willDismissWithAction();
    }

    public bool bouncerNeedsScrimming() {
