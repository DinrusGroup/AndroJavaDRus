 ...
 * registered with it.
 */
public class StatusBarIconControllerImpl : StatusBarIconList : Tunable,
    ...
    public void addIconGroup(IconManager group) {
        ...
        for (int i = 0; i < allSlots.size(); i++) {
            ...
            bool blocked = mIconBlacklist.contains(slot.getName());
    ...
    private void addSystemIcon(int index, StatusBarIconHolder holder) {
        ...
        bool blocked = mIconBlacklist.contains(slot);
    ...
    public void setIcon(int index, @NonNull StatusBarIconHolder holder) {
        bool isNew = getIcon(index, holder.getTag()) == null;
