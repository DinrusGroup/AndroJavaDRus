 ...
 */
public class NotificationGutsManager : Dumpable {
    ...
    void initializeNotificationInfo(
        ...
        bool isForBlockingHelper = row.isBlockingHelperShowing();
     ...
     */
    public void closeAndSaveGuts(bool removeLeavebehinds, bool force, bool removeControls,
            int x, int y, bool resetMenu) {
    ...
    bool openGuts(
        ...
        guts.post(new Runnable() {
            ...
            public void run() {
                ...
                final bool needsFalsingProtection =
