 ...
 */
public class DragDownHelper : Gefingerpoken {
    ...
    private bool mDraggingDown;
    private float mTouchSlop;
    private DragDownCallback mDragDownCallback;
    private View mHost;
    private final int[] mTemp2 = new int[2];
    private bool mDraggedFarEnough;
    ...
    private void handleExpansion(float heightDelta, ExpandableView child) {
        ...
        bool expandable = child.isContentExpandable();
    ...
    public interface DragDownCallback {
         ...
         */
        bool onDraggedDown(View startingChild, int dragLengthY);
         ...
         */
        void onCrossedThreshold(bool above);
        void onTouchSlopExceeded();
        void setEmptyDragAmount(float amount);
        bool isFalsingCheckNeeded();
    }
}
