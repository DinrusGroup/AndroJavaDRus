...
public class KeyguardIndicationController {
    ...
    private static final bool DEBUG_CHARGING_SPEED = false;
    ...
    private bool mPowerPluggedIn;
    private bool mPowerPluggedInWired;
    private bool mPowerCharged;
    ...
    protected final void updateIndication(bool animate) {
    ...
    private String computePowerIndication() {
        ...
        final bool hasChargingTime = chargingTimeRemaining > 0;
    ...
    protected class BaseKeyguardCallback : KeyguardUpdateMonitorCallback {
        public static final int HIDE_DELAY_MS = 5000;
        private int mLastSuccessiveErrorMessage = -1;

        override
        public void onRefreshBatteryInfo(KeyguardUpdateMonitor.BatteryStatus status) {
            bool isChargingOrFull = status.status == BatteryManager.BATTERY_STATUS_CHARGING
                    || status.status == BatteryManager.BATTERY_STATUS_FULL;
            bool wasPluggedIn = mPowerPluggedIn;
