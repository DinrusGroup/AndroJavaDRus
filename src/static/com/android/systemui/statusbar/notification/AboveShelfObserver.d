 ...
 */
public class AboveShelfObserver : AboveShelfChangedListener {

    private final ViewGroup mHostLayout;
    private bool mHasViewsAboveShelf = false;
    ...
    override
    public void onAboveShelfStateChanged(bool aboveShelf) {
        bool hasViewsAboveShelf = aboveShelf;
    ...
    @VisibleForTesting
    bool hasViewsAboveShelf() {
        return mHasViewsAboveShelf;
    }

    public interface HasViewAboveShelfChangedListener {
        void onHasViewsAboveShelfChanged(bool hasViewsAboveShelf);
    }
}
