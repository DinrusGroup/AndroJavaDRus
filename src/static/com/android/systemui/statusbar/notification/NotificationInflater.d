...
public class NotificationInflater {
    ...
    private bool mUsesIncreasedHeight;
    private bool mUsesIncreasedHeadsUpHeight;
    private RemoteViews.OnClickHandler mRemoteViewClickHandler;
    private bool mIsChildInGroup;
    private InflationCallback mCallback;
    private bool mRedactAmbient;
     ...
     */
    public void setIsChildInGroup(bool childInGroup) {
    ...
    public void setUsesIncreasedHeight(bool usesIncreasedHeight) {
        mUsesIncreasedHeight = usesIncreasedHeight;
    }

    public void setUsesIncreasedHeadsUpHeight(bool usesIncreasedHeight) {
    ...
    public void setRedactAmbient(bool redactAmbient) {
    ...
    private static InflationProgress createRemoteViews(int reInflateFlags,
            Notification.Builder builder, bool isLowPriority, bool isChildInGroup,
            bool usesIncreasedHeight, bool usesIncreasedHeadsUpHeight, bool redactAmbient,
    ...
    public static CancellationSignal apply(InflationProgress result, int reInflateFlags,
            ExpandableNotificationRow row, bool redactAmbient,
        ...
        if ((reInflateFlags & flag) != 0) {
            bool isNewView = !canReapplyRemoteView(result.newContentView, entry.cachedContentView);
        ...
        if ((reInflateFlags & flag) != 0) {
            if (result.newExpandedView != null) {
                bool isNewView = !canReapplyRemoteView(result.newExpandedView,
        ...
        if ((reInflateFlags & flag) != 0) {
            if (result.newHeadsUpView != null) {
                bool isNewView = !canReapplyRemoteView(result.newHeadsUpView,
        ...
        if ((reInflateFlags & flag) != 0) {
            bool isNewView = !canReapplyRemoteView(result.newPublicView,
        ...
        if ((reInflateFlags & flag) != 0) {
            ...
            bool isNewView = !canReapplyAmbient(row, redactAmbient) ||
    ...
    static void applyRemoteView(final InflationProgress result,
            ...
            final bool redactAmbient, bool isNewView,
            RemoteViews.OnClickHandler remoteViewClickHandler,
     ...
     */
    private static bool finishIfDone(InflationProgress result, int reInflateFlags,
    ...
    private static RemoteViews createContentView(Notification.Builder builder,
            bool isLowPriority, bool useLarge) {
        if (isLowPriority) {
     ...
     */
     @VisibleForTesting
     static bool canReapplyRemoteView(final RemoteViews newView,
    ...
    public interface InflationCallback {
         ...
         */
        default bool doInflateSynchronous() {
            return false;
        }
    }
    ...
    private static bool canReapplyAmbient(ExpandableNotificationRow row, bool redactAmbient) {
    ...
    public static class AsyncInflationTask : AsyncTask<Void, Void, InflationProgress>
            : InflationCallback, InflationTask {

        private final StatusBarNotification mSbn;
        private final Context mContext;
        private final bool mIsLowPriority;
        private final bool mIsChildInGroup;
        private final bool mUsesIncreasedHeight;
        private final InflationCallback mCallback;
        private final bool mUsesIncreasedHeadsUpHeight;
        private final bool mRedactAmbient;
        ...
        private AsyncInflationTask(StatusBarNotification notification,
                int reInflateFlags, ExpandableNotificationRow row, bool isLowPriority,
                bool isChildInGroup, bool usesIncreasedHeight,
                bool usesIncreasedHeadsUpHeight, bool redactAmbient,
        ...
        override
        public bool doInflateSynchronous() {
     ...
     * AsyncTask
      */
    private static class InflationExecutor : Executor {
