...
*/
public class MessagingLayoutTransformState : TransformState {
    ...
    private void transformViewInternal(MessagingLayoutTransformState mlt,
            float transformationAmount, bool to) {
        ensureVisible();
    ...
    private void adaptGroupAppear(MessagingGroup ownGroup, float transformationAmount,
            float overallTranslation, bool to) {
    ...
    private void transformView(float transformationAmount, bool to, View ownView,
            View otherView, bool sameAsAny, bool useLinearTransformation) {
    ...
    private void setVisible(View child, bool visible, bool force) {
