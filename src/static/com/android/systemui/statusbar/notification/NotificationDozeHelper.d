...
public class NotificationDozeHelper {
    ...
    public void fadeGrayscale(final ImageView target, final bool dark, long delay) {
    ...
    public void updateGrayscale(ImageView target, bool dark) {
    ...
    public void startIntensityAnimation(ValueAnimator.AnimatorUpdateListener updateListener,
            bool dark, long delay, Animator.AnimatorListener listener) {
    ...
    public void setIntensityDark(Consumer<Float> listener, bool dark,
            bool animate, long delay, View view) {
        if (animate) {
