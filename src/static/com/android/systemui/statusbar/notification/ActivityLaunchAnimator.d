...
public class ActivityLaunchAnimator {
    ...
    private bool mAnimationPending;
    ...
    public RemoteAnimationAdapter getLaunchAnimation(
            ExpandableNotificationRow sourceNotification, bool occluded) {
    ...
    private void setAnimationPending(bool pending) {
    ...
    class AnimationRunner : IRemoteAnimationRunner.Stub {

        private final ExpandableNotificationRow mSourceNotification;
        private final ExpandAnimationParameters mParams;
        private final Rect mWindowCrop = new Rect();
        private bool mInstantCollapsePanel = true;
        ...
        private void setExpandAnimationRunning(bool running) {
