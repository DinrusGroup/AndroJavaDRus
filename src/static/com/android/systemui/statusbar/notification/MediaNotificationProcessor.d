...
public class MediaNotificationProcessor {
    ...
    private Palette.Swatch selectMutedCandidate(Palette.Swatch first,
        ...
        bool firstValid = hasEnoughPopulation(first);
        bool secondValid = hasEnoughPopulation(second);
    ...
    private bool hasEnoughPopulation(Palette.Swatch swatch) {
    ...
    private bool isWhiteOrBlack(float[] hsl) {
