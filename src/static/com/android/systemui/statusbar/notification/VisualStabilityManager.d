 ...
 */
public class VisualStabilityManager : OnHeadsUpChangedListener {

    private final ArrayList<Callback> mCallbacks =  new ArrayList<>();

    private bool mPanelExpanded;
    private bool mScreenOn;
    private bool mReorderingAllowed;
    ...
    private void updateReorderingAllowed() {
        bool reorderingAllowed = (!mScreenOn || !mPanelExpanded) && !mPulsing;
        bool changed = reorderingAllowed && !mReorderingAllowed;
     ...
     */
    public bool isReorderingAllowed() {
     ...
     */
    public bool canReorderNotification(ExpandableNotificationRow row) {
