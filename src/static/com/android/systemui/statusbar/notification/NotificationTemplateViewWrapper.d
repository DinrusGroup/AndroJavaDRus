 ...
 */
public class NotificationTemplateViewWrapper : NotificationHeaderViewWrapper {
    ...
    protected NotificationTemplateViewWrapper(Context ctx, View view,
        ...
        mTransformationHelper.setCustomTransformation(
                new ViewTransformationHelper.CustomTransformation() {
                    override
                    public bool transformTo(TransformState ownState,
                    ...
                    override
                    public bool transformFrom(TransformState ownState,
    ...
    private bool isOnView(View view, float x, float y) {
