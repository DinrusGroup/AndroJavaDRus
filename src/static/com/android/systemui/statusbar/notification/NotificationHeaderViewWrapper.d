 ...
 */
public class NotificationHeaderViewWrapper : NotificationViewWrapper {
    ...
    private bool mTransformLowPriorityTitle;
        ...
        mTransformationHelper.setCustomTransformation(
                new CustomInterpolatorTransformation(TRANSFORMING_VIEW_TITLE) {
                    ...
                    public Interpolator getCustomInterpolator(int interpolationType,
                            bool isFrom) {
                        bool isLowPriority = mView instanceof NotificationHeaderView;
                    ...
                    override
                    protected bool hasCustomTransformation() {
     ...
     * {@link ImageView#setCropToPadding(bool)} on all ImageViews.
     */
    ...
    override
    public void updateExpandability(bool expandable, View.OnClickListener onClickListener) {
