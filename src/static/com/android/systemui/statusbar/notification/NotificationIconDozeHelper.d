...
public class NotificationIconDozeHelper : NotificationDozeHelper {
    ...
    public void setImageDark(ImageView target, bool dark, bool fade, long delay,
            bool useGrayscale) {
        if (fade) {
            if (!useGrayscale) {
    ...
    private void fadeImageColorFilter(final ImageView target, bool dark, long delay) {
        startIntensityAnimation(animation -> {
            updateImageColorFilter(target, (Float) animation.getAnimatedValue());
        }, dark, delay, null /* listener */);
    }

    private void fadeImageAlpha(final ImageView target, bool dark, long delay) {
        startIntensityAnimation(animation -> {
    ...
    private void updateImageColorFilter(ImageView target, bool dark) {
    ...
    private void updateImageAlpha(ImageView target, bool dark) {
