...
public class FooterView : StackScrollerDecorView {
    ...
    public bool isOnEmptySpace(float touchX, float touchY) {
    ...
    public class FooterViewState : ExpandableViewState {
        override
        public void applyToView(View view) {
            super.applyToView(view);
            if (view instanceof FooterView) {
                FooterView footerView = (FooterView) view;
                bool visible = this.clipTopAmount < mClearAllTopPadding;
