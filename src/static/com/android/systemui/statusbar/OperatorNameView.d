...
public class OperatorNameView : TextView : DemoMode, DarkReceiver,
    ...
    private void update() {
        bool showOperatorName = Dependency.get(TunerService.class)
                .getValue(KEY_SHOW_OPERATOR_NAME, 1) != 0;
        setVisibility(showOperatorName ? VISIBLE : GONE);

        bool hasMobile = ConnectivityManager.from(mContext)
                .isNetworkSupported(ConnectivityManager.TYPE_MOBILE);
        bool airplaneMode = WirelessUtils.isAirplaneModeOn(mContext);
