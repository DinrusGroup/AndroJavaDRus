...
public class CrossFadeHelper {
     ...
     *
     * @see #fadeIn(View, float, bool)
     */
    public static void fadeOut(View view, float fadeOutAmount, bool remap) {
        view.animate().cancel();
     ...
     * {@link StackStateAnimator#ANIMATION_DURATION_STANDARD} in order to have a faster fading.
     *
     * @see #fadeOut(View, float, bool)
     */
    public static void fadeIn(View view, float fadeInAmount, bool remap) {
        view.animate().cancel();
        if (view.getVisibility() == View.INVISIBLE) {
            view.setVisibility(View.VISIBLE);
        }
