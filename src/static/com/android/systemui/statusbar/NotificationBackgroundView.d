 ...
 */
public class NotificationBackgroundView : View {

    private final bool mDontModifyCorners;
    ...
    private bool mBottomIsRounded;
    private int mBackgroundTop;
    private bool mBottomAmountClips = true;
    private bool mExpandAnimationRunning;
    private float mActualWidth;
    private int mDrawableAlpha = 255;
    private bool mIsPressedAllowed;
    ...
    public void setBottomAmountClips(bool clips) {
    ...
    public void setExpandAnimationRunning(bool running) {
    ...
    public void setPressedAllowed(bool allowed) {
