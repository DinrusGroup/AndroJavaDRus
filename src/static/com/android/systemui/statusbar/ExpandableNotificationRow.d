 ...
 */
public class ExpandableNotificationRow : ActivatableNotificationView
        : PluginListener<NotificationMenuRowPlugin> {
    ...
    private bool mDark;
    private bool mLowPriorityStateUpdated;
    ...
    private bool mMustStayOnScreen;

    /** Does this row contain layouts that can adapt to row expansion */
    private bool mExpandable;
    /** Has the user actively changed the expansion state of this row */
    private bool mHasUserChangedExpansion;
    /** If {@link #mHasUserChangedExpansion}, has the user expanded this row */
    private bool mUserExpanded;
    /** Whether the blocking helper is showing on this notification (even if dismissed) */
    private bool mIsBlockingHelperShowing;

    /**
     * Has this notification been expanded while it was pinned
     */
    private bool mExpandedWhenPinned;
    /** Is the user touching this row */
    private bool mUserLocked;
    /** Are we showing the "public" version */
    private bool mShowingPublic;
    private bool mSensitive;
    private bool mSensitiveHiddenInGeneral;
    private bool mShowingPublicInitialized;
    private bool mHideSensitiveForIntrinsicHeight;
    ...
    private bool mLastChronometerRunning = true;
    private ViewStub mChildrenContainerStub;
    private NotificationGroupManager mGroupManager;
    private bool mChildrenExpanded;
    private bool mIsSummaryWithChildren;
    private NotificationChildrenContainer mChildrenContainer;
    private NotificationMenuRowPlugin mMenuRow;
    private ViewStub mGutsStub;
    private bool mIsSystemChildExpanded;
    private bool mIsPinned;
    private FalsingManager mFalsingManager;
    private bool mExpandAnimationRunning;
    private AboveShelfChangedListener mAboveShelfChangedListener;
    private HeadsUpManager mHeadsUpManager;
    private Consumer<Boolean> mHeadsUpAnimatingAwayListener;
    private bool mChildIsExpanding;

    private bool mJustClicked;
    private bool mIconAnimationRunning;
    private bool mShowNoBackground;
    ...
    private bool mGroupExpansionChanging;
     ...
     */
    private bool mEnableNonGroupedNotificationExpand;
     ...
     */
    private bool mShowGroupBackgroundWhenExpanded;
    ...
    private OnClickListener mExpandClickListener = new OnClickListener() {
        ...
        public void onClick(View v) {
            if (!shouldShowPublic() && (!mIsLowPriority || isExpanded())
                ...
                final bool wasExpanded = mGroupManager.isGroupExpanded(mStatusBarNotification);
                bool nowExpanded = mGroupManager.toggleGroupExpansion(mStatusBarNotification);
    ...
    private bool mForceUnlocked;
    private bool mDismissed;
    private bool mKeepInParent;
    ...
    private bool mHeadsupDisappearRunning;
    private View mChildAfterViewWhenDismissed;
    private View mGroupParentWhenDismissed;
    private bool mRefocusOnDismiss;
    private float mContentTransformationAmount;
    private bool mIconsVisible = true;
    private bool mAboveShelf;
    private bool mShowAmbient;
    private bool mIsLastChild;
    private Runnable mOnDismissRunnable;
    private bool mIsLowPriority;
    private bool mIsColorized;
    private bool mUseIncreasedCollapsedHeight;
    private bool mUseIncreasedHeadsUpHeight;
    private float mTranslationWhenRemoved;
    private bool mWasChildInGroupWhenRemoved;
    ...
    public void setGroupExpansionChanging(bool changing) {
    ...
    public void setIconAnimationRunning(bool running) {
    ...
    private void setIconAnimationRunning(bool running, NotificationContentView layout) {
        if (layout != null) {
    ...
    private void setIconAnimationRunningForChild(bool running, View child) {
        if (child != null) {
    ...
    private void setIconRunning(ImageView imageView, bool running) {
        if (imageView != null) {
     ...
     */
    public bool getIsNonblockable() {
        bool isNonblockable = Dependency.get(NotificationBlockingHelperManager.class)
    ...
    void updateShelfIconColor() {
        ...
        bool isPreL = Boolean.TRUE.equals(expandedIcon.getTag(R.id.icon_is_pre_L));
        bool colorize = !isPreL || NotificationUtils.isGrayscale(expandedIcon,
    ...
    private void updateLimitsForView(NotificationContentView layout) {
        bool customView = layout.getContractedChild().getId()
                != com.android.internal.R.id.status_bar_latest_event_content;
        bool beforeN = mEntry.targetSdk < Build.VERSION_CODES.N;
        bool beforeP = mEntry.targetSdk < Build.VERSION_CODES.P;
        int minHeight;
        ...
        bool headsUpCustom = layout.getHeadsUpChild() != null &&
    ...
    public void setHeadsUp(bool isHeadsUp) {
        bool wasAboveShelf = isAboveShelf();
     ...
     */
    public bool isOnlyChildInGroup() {
     ...
     */
    public void setIsChildInGroup(bool isChildInGroup, ExpandableNotificationRow parent) {
        bool childInGroup = StatusBar.ENABLE_CHILD_NOTIFICATIONS && isChildInGroup;
     ...
     */
    public bool applyChildOrder(List<ExpandableNotificationRow> childOrder,
     ...
     */
    private int getPinnedHeadsUpHeight(bool atLeastMinHeight) {
        if (mIsSummaryWithChildren) {
     ...
     */
    public void setJustClicked(bool justClicked) {
    ...
    public void setChronometerRunning(bool running) {
    ...
    private void setChronometerRunning(bool running, NotificationContentView layout) {
        if (layout != null) {
    ...
    private void setChronometerRunningForChild(bool running, View child) {
        if (child != null) {
    ...
    private void updateClickAndFocus() {
        bool normalChild = !isChildInGroup() || isGroupExpanded();
        bool clickable = mOnClickListener != null && normalChild;
    ...
    public void onPluginConnected(NotificationMenuRowPlugin plugin, Context pluginContext) {
        bool existed = mMenuRow.getMenuView() != null;
        if (existed) {
    ...
    public void setContentBackground(int customBackgroundColor, bool animate,
    ...
    public void setForceUnlocked(bool forceUnlocked) {
    ...
    public void setDismissed(bool fromAccessibility) {
    ...
    public void setKeepInParent(bool keepInParent) {
    ...
    public bool wasChildInGroupWhenRemoved() {
    ...
    public void setHeadsUpAnimatingAway(bool headsUpAnimatingAway) {
        bool wasAboveShelf = isAboveShelf();
        bool changed = headsUpAnimatingAway != mHeadsupDisappearRunning;
     ...
     */
    public bool performDismissWithBlockingHelper(bool fromAccessibility) {
        NotificationBlockingHelperManager manager =
                Dependency.get(NotificationBlockingHelperManager.class);
        bool isBlockingHelperShown = manager.perhapsShowBlockingHelper(this, mMenuRow);
    ...
    public void performDismiss(bool fromAccessibility) {
    ...
    public void setBlockingHelperShowing(bool isBlockingHelperShowing) {
        mIsBlockingHelperShowing = isBlockingHelperShowing;
    }

    public bool isBlockingHelperShowing() {
    ...
    public void setContentTransformationAmount(float contentTransformationAmount,
            bool isLastChild) {
        bool changeTransformation = isLastChild != mIsLastChild;
    ...
    public void setLowPriorityStateUpdated(bool lowPriorityStateUpdated) {
        mLowPriorityStateUpdated = lowPriorityStateUpdated;
    }

    public bool hasLowPriorityStateUpdated() {
    ...
    public void setUseIncreasedCollapsedHeight(bool use) {
        mUseIncreasedCollapsedHeight = use;
        mNotificationInflater.setUsesIncreasedHeight(use);
    }

    public void setUseIncreasedHeadsUpHeight(bool use) {
    ...
    public void setNeedsRedaction(bool needsRedaction) {
    ...
    public interface ExpansionLogger {
        void logNotificationExpansion(String key, bool userAction, bool expanded);
    }
    ...
    override
    public bool onKeyLongPress(int keyCode, KeyEvent event) {
        if (KeyEvent.isConfirmKey(keyCode)) {
            doLongClickCallback();
            return true;
        }
     ...
     */
    private void updateContentAccessibilityImportanceForGuts(bool isEnabled) {
        if (mChildrenContainer != null) {
     ...
     * {@code isEnabled}.
     */
    private void updateChildAccessibilityImportance(View childView, bool isEnabled) {
    ...
    private void updateChildrenVisibility() {
        bool hideContentWhileLaunching = mExpandAnimationRunning && mGuts != null
                && mGuts.isExposed();
    ...
    public void setExpandAnimationRunning(bool expandAnimationRunning) {
        View contentView;
        if (mIsSummaryWithChildren) {
    ...
    private void setChildIsExpanding(bool isExpanding) {
    ...
    public bool isSoundEffectsEnabled() {
        final bool mute = mDark && mSecureStateProvider != null &&
     ...
     */
    public bool hasUserChangedExpansion() {
     ...
     */
    public void setUserExpanded(bool userExpanded) {
     ...
     */
    public void setUserExpanded(bool userExpanded, bool allowChildExpansion) {
    ...
    public void setUserLocked(bool userLocked) {
     ...
     */
    public void setSystemExpanded(bool expand) {
     ...
     */
    public void setOnKeyguard(bool onKeyguard) {
     ...
     * #setSystemExpanded(bool)} and can be overridden by user expansion or
     * collapsing in {@link #setUserExpanded(bool)}. Note that the visual appearance of this
    ...
    public bool isExpanded(bool allowOnKeyguard) {
        return (!mOnKeyguard || allowOnKeyguard)
                && (!hasUserChangedExpansion() && (isSystemExpanded() || isSystemChildExpanded())
                || isUserExpanded());
    }

    private bool isSystemChildExpanded() {
        return mIsSystemChildExpanded;
    }

    public void setSystemChildExpanded(bool expanded) {
    ...
    public void setSensitive(bool sensitive, bool hideSensitive) {
    ...
    public void setHideSensitive(bool hideSensitive, bool animated, long delay,
        ...
        bool oldShowingPublic = mShowingPublic;
    ...
    private void animateShowingPublic(long delay, long duration, bool showingPublic) {
    ...
    public void setChildrenExpanded(bool expanded, bool animate) {
    ...
    override
    public void setActualHeight(int height, bool notifyListeners) {
        bool changed = height != getActualHeight();
    ...
    public void updateBackgroundForGroupState() {
        if (mIsSummaryWithChildren) {
            ...
            final bool showBackground = isGroupExpanded()
    ...
    public void onExpandedByGesture(bool userExpanded) {
    ...
    override
    protected bool disallowSingleClick(MotionEvent event) {
        if (areGutsExposed()) {
            return false;
        }
        float x = event.getX();
    ...
    private void onExpansionChanged(bool userAction, bool wasExpanded) {
        bool nowExpanded = isExpanded();
    ...
    public void onInitializeAccessibilityNodeInfoInternal(AccessibilityNodeInfo info) {
        ...
        bool expandable = shouldShowPublic();
    ...
    public bool shouldRefocusOnDismiss() {
        return mRefocusOnDismiss || isAccessibilityFocused();
    }

    public interface OnExpandClickListener {
        void onExpandClicked(NotificationData.Entry clickedEntry, bool nowExpanded);
    }
    ...
    public void setShowAmbient(bool showAmbient) {
    ...
    override
    public bool topAmountNeedsClipping() {
        if (isGroupExpanded()) {
            return true;
        }
    ...
    private bool hasNoRounding() {
        return getCurrentBottomRoundness() == 0.0f && getCurrentTopRoundness() == 0.0f;
    }

    public bool isShowingAmbient() {
        return mShowAmbient;
    }

    public void setAboveShelf(bool aboveShelf) {
        bool wasAboveShelf = isAboveShelf();
    ...
    public static class NotificationViewState : ExpandableViewState {
    ...
    public interface LongPressListener {
         ...
         */
        bool onLongPress(View v, int x, int y, MenuItem item);
    }
    ...
    public interface OnAppOpsClickListener {
         ...
         */
        bool onClick(View v, int x, int y, MenuItem item);
    }
     ...
     */
    private class SystemNotificationAsyncTask : AsyncTask<Void, Void, Boolean> {
