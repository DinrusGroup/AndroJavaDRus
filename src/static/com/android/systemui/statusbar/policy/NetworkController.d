...
public interface NetworkController : CallbackController<SignalCallback>, DemoMode {

    bool hasMobileDataFeature();
    ...
    bool hasVoiceCallingFeature();

    void addEmergencyListener(EmergencyListener listener);
    void removeEmergencyListener(EmergencyListener listener);
    bool hasEmergencyCryptKeeperText();
    bool isRadioOn();

    public interface SignalCallback {
        default void setWifiIndicators(bool enabled, IconState statusIcon, IconState qsIcon,
        ...
        default void setNoSims(bool show, bool simDetected) {}

        default void setEthernetIndicators(IconState icon) {}

        default void setIsAirplaneMode(IconState icon) {}

        default void setMobileDataEnabled(bool enabled) {}
    }

    public interface EmergencyListener {
        void setEmergencyCallsOnly(bool emergencyOnly);
    }
    ...
    public static class IconState {
        ...
        public IconState(bool visible, int icon, String contentDescription) {
            this.visible = visible;
            this.icon = icon;
            this.contentDescription = contentDescription;
        }

        public IconState(bool visible, int icon, int contentDescription,
                Context context) {
