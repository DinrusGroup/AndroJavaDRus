 ...
 */
public class Clock : TextView : DemoMode, Tunable, CommandQueue.Callbacks,
    ...
    private bool mClockVisibleByPolicy = true;
    private bool mClockVisibleByUser = true;
    ...
    private final bool mShowDark;
    private bool mShowSeconds;
     ...
     * for text.
     */
    private bool mUseWallpaperTextColor;
    ...
    public void setClockVisibleByUser(bool visible) {
        mClockVisibleByUser = visible;
        updateClockVisibility();
    }

    public void setClockVisibilityByPolicy(bool visible) {
        mClockVisibleByPolicy = visible;
        updateClockVisibility();
    }

    private void updateClockVisibility() {
        bool visible = mClockVisibleByPolicy && mClockVisibleByUser;
    ...
    public void disable(int state1, int state2, bool animate) {
        bool clockVisibleByPolicy = (state1 & StatusBarManager.DISABLE_CLOCK) == 0;
     ...
     */
    public void useWallpaperTextColor(bool shouldUseWallpaperTextColor) {
    ...
    private final CharSequence getSmallTime() {
        ...
        bool is24 = DateFormat.is24HourFormat(context, mCurrentUserId);
    ...
    public void dispatchDemoCommand(String command, Bundle args) {
        if (!mDemoMode && command.equals(COMMAND_ENTER)) {
            ...
            if (millis != null) {
                ...
                bool is24 = DateFormat.is24HourFormat(getContext(), mCurrentUserId);
                if (is24) {
