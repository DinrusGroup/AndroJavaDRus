...
public class KeyButtonRipple : Drawable {
    ...
    private bool mDrawingHardwareGlow;
    private int mMaxWidth;
    private bool mLastDark;
    private bool mDark;
    private bool mDelayTouchFeedback;
    ...
    public void setDelayTouchFeedback(bool delay) {
    ...
    private void setPressedSoftware(bool pressed) {
        if (pressed) {
    ...
    private void setPressedHardware(bool pressed) {
        if (pressed) {
            if (mDelayTouchFeedback) {
                if (mRunningAnimations.isEmpty()) {
                    mHandler.removeCallbacksAndMessages(null);
     ...
     */
    private static final class LogInterpolator : Interpolator {
        override
