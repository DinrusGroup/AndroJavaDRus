 ...
 */
public class RemoteInputView : LinearLayout : View.OnClickListener, TextWatcher {
    ...
    private void onDefocus(bool animate) {
        mController.removeRemoteInput(mEntry, mToken);
        mEntry.remoteInputText = mEditText.getText();
    ...
    public void onNotificationUpdateOrReset() {
        bool sending = mProgressBar.getVisibility() == VISIBLE;
     ...
     */
    public bool updatePendingIntentFromActions(Notification.Action[] actions) {
     ...
     */
    public static class RemoteEditText : EditText {

        private final Drawable mBackground;
        private RemoteInputView mRemoteInputView;
        bool mShowImeOnInputConnection;
        ...
        private void defocusIfNeeded(bool animate) {
        ...
        public bool onCheckIsTextEditor() {
            ...
            bool flyingOut = mRemoteInputView != null && mRemoteInputView.mRemoved;
        ...
        void setInnerFocusable(bool focusable) {
