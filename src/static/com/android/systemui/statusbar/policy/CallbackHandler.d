 ...
 */
public class CallbackHandler : Handler : EmergencyListener, SignalCallback {
    ...
    override
    public void setWifiIndicators(final bool enabled, final IconState statusIcon,
            final IconState qsIcon, final bool activityIn, final bool activityOut,
            final String description, bool isTransient, String secondaryLabel) {
        post(new Runnable() {
            override
            public void run() {
    ...
    public void setMobileDataIndicators(final IconState statusIcon, final IconState qsIcon,
            final int statusType, final int qsType,final bool activityIn,
            final bool activityOut, final String typeContentDescription,
            final String description, final bool isWide, final int subId, bool roaming) {
        post(new Runnable() {
            override
            public void run() {
                for (SignalCallback signalCluster : mSignalCallbacks) {
    ...
    override
    public void setEmergencyCallsOnly(bool emergencyOnly) {
    ...
    public void setListening(EmergencyListener listener, bool listening) {
        obtainMessage(MSG_ADD_REMOVE_EMERGENCY, listening ? 1 : 0, 0, listener).sendToTarget();
    }

    public void setListening(SignalCallback listener, bool listening) {
