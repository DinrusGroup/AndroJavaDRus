 ...
 */
public abstract class SignalController<T : SignalController.State,
        I : SignalController.IconGroup> {
    // Save the previous SignalController.States of all SignalControllers for dumps.
    static final bool RECORD_HISTORY = true;
    // If RECORD_HISTORY how many to save, must be a power of 2.
    static final int HISTORY_SIZE = 64;

    protected static final bool DEBUG = NetworkControllerImpl.DEBUG;
    protected static final bool CHATTY = NetworkControllerImpl.CHATTY;
