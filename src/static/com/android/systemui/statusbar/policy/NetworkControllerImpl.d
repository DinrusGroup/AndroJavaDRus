...
public class NetworkControllerImpl : BroadcastReceiver
        : NetworkController, DemoMode, DataUsageController.NetworkNameProvider,
        ConfigurationChangedReceiver, Dumpable {
    // debug
    static final String TAG = "NetworkController";
    static final bool DEBUG = Log.isLoggable(TAG, Log.DEBUG);
    // additional diagnostics, but not logspew
    static final bool CHATTY =  Log.isLoggable(TAG + "Chat", Log.DEBUG);
    ...
    private final bool mHasMobileDataFeature;
    ...
    private bool mInetCondition; // Used for Logging and demo.
    ...
    private bool mAirplaneMode = false;
    private bool mHasNoSubs;
    ...
    private bool mIsEmergency;

    @VisibleForTesting
    ServiceState mLastServiceState;
    private bool mUserSetup;
    private bool mSimDetected;
    ...
    NetworkControllerImpl(Context context, ConnectivityManager connectivityManager,
        ...
        mDataUsageController.setCallback(new DataUsageController.Callback() {
            override
            public void onMobileDataEnabled(bool enabled) {
        ...
        ConnectivityManager.NetworkCallback callback = new ConnectivityManager.NetworkCallback(){
            ...
            public void onCapabilitiesChanged(
                ...
                bool lastValidated = (mLastNetworkCapabilities != null) &&
    ...
    public bool hasMobileDataFeature() {
        return mHasMobileDataFeature;
    }

    public bool hasVoiceCallingFeature() {
    ...
    override
    public void setWifiEnabled(final bool enabled) {
    ...
    protected void updateNoSims() {
        bool hasNoSubs = mHasMobileDataFeature && mMobileSignalControllers.size() == 0;
        bool simDetected = hasAnySim();
    ...
    private void setUserSetupComplete(final bool userSetup) {
        mReceiverHandler.post(() -> handleSetUserSetupComplete(userSetup));
    }

    private void handleSetUserSetupComplete(bool userSetup) {
    ...
    @VisibleForTesting
    bool hasCorrectMobileControllers(List<SubscriptionInfo> allSubscriptions) {
    ...
    private void updateAirplaneMode(bool force) {
        bool airplaneMode = (Settings.Global.getInt(mContext.getContentResolver(),
    ...
    private bool mDemoInetCondition;
    ...
    public void dispatchDemoCommand(String command, Bundle args) {
        if (!mDemoMode && command.equals(COMMAND_ENTER)) {
            ...
            if (airplane != null) {
                bool show = airplane.equals("show");
            ...
            if (carrierNetworkChange != null) {
                bool show = carrierNetworkChange.equals("show");
                for (int i = 0; i < mMobileSignalControllers.size(); i++) {
                    MobileSignalController controller = mMobileSignalControllers.valueAt(i);
    ...
    public bool hasEmergencyCryptKeeperText() {
    ...
    private class SubListener : OnSubscriptionsChangedListener {
        override
    ...
    @VisibleForTesting
    static class Config {
        bool showAtLeast3G = false;
        bool alwaysShowCdmaRssi = false;
        bool show4gForLte = false;
        bool hideLtePlus = false;
        bool hspaDataDistinguishable;
        bool inflateSignalStrengths = false;
        bool alwaysShowDataRatIcon = false;
