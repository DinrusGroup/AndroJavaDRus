...
public class SmartReplyView : ViewGroup {
    ...
    private int estimateOptimalSqueezedButtonTextWidth(Button button) {
        ...
        if (initialLeftTextWidth != initialRightTextWidth) {
            ...
            final bool moveLeft = initialLeftTextWidth > initialRightTextWidth;
    ...
    protected void onLayout(bool changed, int left, int top, int right, int bottom) {
        final bool isRtl = getLayoutDirection() == View.LAYOUT_DIRECTION_RTL;
    ...
    public void setBackgroundTintColor(int backgroundColor) {
        ...
        final bool dark = !NotificationColorUtil.isColorLight(backgroundColor);
    ...
    @VisibleForTesting
    static class LayoutParams : ViewGroup.LayoutParams {
