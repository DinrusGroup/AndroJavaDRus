...
public class CastControllerImpl : CastController {
    ...
    private bool mDiscovering;
    private bool mCallbackRegistered;
    ...
    override
    public void setDiscovering(bool request) {
        synchronized (mDiscoveringLock) {
    ...
    public void stopCasting(CastDevice device) {
        final bool isProjection = device.tag instanceof MediaProjectionInfo;
    ...
    private void setProjection(MediaProjectionInfo projection, bool started) {
        bool changed = false;
        final MediaProjectionInfo oldProjection = mProjection;
        synchronized (mProjectionLock) {
            final bool isCurrent = Objects.equals(projection, mProjection);
