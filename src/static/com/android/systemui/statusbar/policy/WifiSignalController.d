...
public class WifiSignalController :
    ...
    private final bool mHasMobileData;
    private final WifiStatusTracker mWifiTracker;

    public WifiSignalController(Context context, bool hasMobileData,
    ...
    public void notifyListeners(SignalCallback callback) {
        ...
        bool wifiVisible = mCurrentState.enabled
                && (mCurrentState.connected || !mHasMobileData);
        String wifiDesc = wifiVisible ? mCurrentState.ssid : null;
        bool ssidPresent = wifiVisible && mCurrentState.ssid != null;
     ...
     */
    private class WifiHandler : Handler {
    ...
    static class WifiState : SignalController.State {
        String ssid;
        bool isTransient;
        String statusLabel;
