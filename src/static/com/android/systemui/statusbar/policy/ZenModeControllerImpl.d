...
public class ZenModeControllerImpl : CurrentUserTracker : ZenModeController {
    ...
    override
    public bool areNotificationsHiddenInShade() {
    ...
    override
    public bool isCountdownConditionSupported() {
    ...
    private void fireZenAvailableChanged(bool available) {
    ...
    private final class SetupObserver : ContentObserver {
