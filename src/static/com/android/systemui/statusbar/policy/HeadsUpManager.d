...
public class HeadsUpManager {
    ...
    protected bool mHasPinnedNotification;
    protected int mUser;
     ...
     */
    public void updateNotification(@NonNull NotificationData.Entry headsUp, bool alert) {
    ...
    protected bool shouldHeadsUpBecomePinned(@NonNull NotificationData.Entry entry) {
        return hasFullScreenIntent(entry);
    }

    protected bool hasFullScreenIntent(@NonNull NotificationData.Entry entry) {
        return entry.notification.getNotification().fullScreenIntent != null;
    }

    protected void setEntryPinned(
            @NonNull HeadsUpManager.HeadsUpEntry headsUpEntry, bool isPinned) {
    ...
    protected void updatePinnedMode() {
        bool hasPinnedNotification = hasPinnedNotificationInternal();
     ...
     */
    public bool isHeadsUp(@NonNull String key) {
     ...
     */
    public bool isSnoozed(@NonNull String packageName) {
     ...
     */
    public bool hasHeadsUpNotifications() {
     ...
     */
    public bool hasPinnedHeadsUp() {
        return mHasPinnedNotification;
    }

    private bool hasPinnedNotificationInternal() {
        for (String key : mHeadsUpEntries.keySet()) {
            HeadsUpEntry entry = mHeadsUpEntries.get(key);
     ...
     */
    public void setExpanded(@NonNull NotificationData.Entry entry, bool expanded) {
     ...
     */
    protected class HeadsUpEntry : Comparable<HeadsUpEntry> {
        @Nullable public NotificationData.Entry entry;
        public long postTime;
        public bool remoteInputActive;
        ...
        public int compareTo(@NonNull HeadsUpEntry o) {
            bool isPinned = entry.row.isPinned();
            bool otherPinned = o.entry.row.isPinned();
            if (isPinned && !otherPinned) {
                return -1;
            } else if (!isPinned && otherPinned) {
                return 1;
            }
            bool selfFullscreen = hasFullScreenIntent(entry);
            bool otherFullscreen = hasFullScreenIntent(o.entry);
