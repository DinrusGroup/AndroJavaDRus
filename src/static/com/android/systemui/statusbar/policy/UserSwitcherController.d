...
public class UserSwitcherController {
    ...
    private bool mResumeUserOnGuestLogout = true;
    private bool mSimpleUserSwitcher;
    private bool mAddUsersWhenLocked;
    private bool mPauseRefreshUsers;
    ...
    private void refreshUsers(int forcePictureLoadForId) {
        ...
        bool forceAllUsers = mForcePictureLoadForUserId.get(UserHandle.USER_ALL);
        ...
        final bool addUsersWhenLocked = mAddUsersWhenLocked;
        new AsyncTask<SparseArray<Bitmap>, Void, ArrayList<UserRecord>>() {
            ...
            protected ArrayList<UserRecord> doInBackground(SparseArray<Bitmap>... params) {
                ...
                bool canSwitchUsers = mUserManager.canSwitchUsers();
                UserInfo currentUserInfo = null;
                UserRecord guestRecord = null;

                for (UserInfo info : infos) {
                    bool isCurrent = currentId == info.id;
                    if (isCurrent) {
                        currentUserInfo = info;
                    }
                    bool switchToEnabled = canSwitchUsers || isCurrent;
                    if (info.isEnabled()) {
                        if (info.isGuest()) {
                ...
                bool systemCanCreateUsers = !mUserManager.hasBaseUserRestriction(
                                UserManager.DISALLOW_ADD_USER, UserHandle.SYSTEM);
                bool currentUserCanCreateUsers = currentUserInfo != null
                        && (currentUserInfo.isAdmin()
                                || currentUserInfo.id == UserHandle.USER_SYSTEM)
                        && systemCanCreateUsers;
                bool anyoneCanCreateUsers = systemCanCreateUsers && addUsersWhenLocked;
                bool canCreateGuest = (currentUserCanCreateUsers || anyoneCanCreateUsers)
                        && guestRecord == null;
                bool canCreateUser = (currentUserCanCreateUsers || anyoneCanCreateUsers)
                        && mUserManager.canAddMoreUsers();
                bool createIsRestricted = !addUsersWhenLocked;
    ...
    public bool isSimpleUserSwitcher() {
        return mSimpleUserSwitcher;
    }

    public bool useFullscreenUserSwitcher() {
        // Use adb to override:
    ...
    public void setResumeUserOnGuestLogout(bool resume) {
    ...
    private BroadcastReceiver mReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            bool unpauseRefreshUsers = false;
            ...
            if (Intent.ACTION_USER_SWITCHED.equals(intent.getAction())) {
                ...
                for (int i = 0; i < N; i++) {
                    ...
                    bool shouldBeCurrent = record.info.id == currentId;
    ...
    public static abstract class BaseUserAdapter : BaseAdapter {
        ...
        public int getUserCount() {
            bool secureKeyguardShowing = mKeyguardMonitor.isShowing()
    ...
    public static final class UserRecord {
        ...
        public final bool isGuest;
        public final bool isCurrent;
        public final bool isAddUser;
        /** If true, the record is only visible to the owner and only when unlocked. */
        public final bool isRestricted;
        public bool isDisabledByAdmin;
        public EnforcedAdmin enforcedAdmin;
        public bool isSwitchToEnabled;

        public UserRecord(UserInfo info, Bitmap picture, bool isGuest, bool isCurrent,
                bool isAddUser, bool isRestricted, bool isSwitchToEnabled) {
            this.info = info;
        ...
        public UserRecord copyWithIsCurrent(bool _isCurrent) {
    ...
    private final class ExitGuestDialog : SystemUIDialog :
    ...
    private final class AddUserDialog : SystemUIDialog :
            DialogInterface.OnClickListener {
