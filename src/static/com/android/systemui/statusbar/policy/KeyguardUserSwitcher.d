...
public class KeyguardUserSwitcher {
    ...
    private static final bool ALWAYS_ON = false;
    ...
    public KeyguardUserSwitcher(Context context, ViewStub userSwitcher,
        ...
        bool keyguardUserSwitcherEnabled =
    ...
    public void setKeyguard(bool keyguard, bool animate) {
        if (mUserSwitcher != null) {
    ...
    private bool hide(bool animate) {
        if (mUserSwitcher != null && mUserSwitcherContainer.getVisibility() == View.VISIBLE) {
            cancelAnimations();
            if (animate) {
    ...
    public bool hideIfNotSimple(bool animate) {
    ...
    public static class Adapter : UserSwitcherController.BaseUserAdapter :
    ...
    public static class Container : FrameLayout {
