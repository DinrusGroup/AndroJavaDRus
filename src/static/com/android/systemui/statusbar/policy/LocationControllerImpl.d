 ...
 */
public class LocationControllerImpl : BroadcastReceiver : LocationController {
    ...
    private bool mAreActiveLocationRequests;
     ...
     */
    public bool setLocationEnabled(bool enabled) {
     ...
     */
    private bool isUserLocationRestricted(int userId) {
     ...
     */
    @VisibleForTesting
    protected bool areActiveHighPowerLocationRequests() {
    ...
    private void updateActiveLocationRequests() {
        bool hadActiveLocationRequests = mAreActiveLocationRequests;
    ...
    private final class H : Handler {
        ...
        private void locationSettingsChanged() {
            bool isEnabled = isLocationEnabled();
            Utils.safeForeach(mSettingsChangeCallbacks,
