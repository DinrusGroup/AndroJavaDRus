...
public class HotspotControllerImpl : HotspotController, WifiManager.SoftApCallback {
    ...
    private bool mWaitingForCallback;
     ...
     */
    private void updateWifiStateListeners(bool shouldListen) {
    ...
    override
    public bool isHotspotTransient() {
     ...
     * {@link #fireHotspotChangedCallback(bool, int)} and assumes that the number of devices has
     * not changed.
     *
     * @param enabled whether the hotspot is enabled
     */
    private void fireHotspotChangedCallback(bool enabled) {
     ...
     */
    private void fireHotspotChangedCallback(bool enabled, int numConnectedDevices) {
        synchronized (mCallbacks) {
    ...
    private final class OnStartTetheringCallback :
     ...
     */
    private final class WifiStateReceiver : BroadcastReceiver {
