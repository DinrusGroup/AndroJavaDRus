 ...
 */
public class NotificationMediaManager : Dumpable {
    private static final String TAG = "NotificationMediaManager";
    public static final bool DEBUG_MEDIA = false;
    ...
    private bool isPlaybackActive(int state) {
        return state != PlaybackState.STATE_STOPPED && state != PlaybackState.STATE_ERROR
                && state != PlaybackState.STATE_NONE;
    }

    private bool sameSessions(MediaController a, MediaController b) {
        if (a == b) {
            return true;
        }
        if (a == null) {
    ...
    private bool isMediaNotification(NotificationData.Entry entry) {
