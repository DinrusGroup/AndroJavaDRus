...
public class ScrimView : View : ConfigurationController.ConfigurationListener {
    ...
    public void setDrawAsSrc(bool asSrc) {
        mDrawAsSrc = asSrc;
    ...
    public void setColors(@NonNull ColorExtractor.GradientColors colors, bool animated) {
        if (colors == null) {
    ...
    public void setTint(int color, bool animated) {
        if (mTintColor == color) {
            return;
        }
        mTintColor = color;
    ...
    private void updateColorWithTint(bool animated) {
