 ...
 */
public class CommandQueue : IStatusBar.Stub {
    ...
    public interface Callbacks {
        ...
        default void disable(int state1, int state2, bool animate) { }
        ...
        default void topAppWindowChanged(bool visible) { }
        default void setImeWindowStatus(IBinder token, int vis, int backDisposition,
                bool showImeSwitcher) { }
        default void showRecentApps(bool triggeredFromAltTab) { }
        default void hideRecentApps(bool triggeredFromAltTab, bool triggeredFromHomeKey) { }
        ...
        default void appTransitionPending(bool forced) { }
        default void appTransitionCancelled() { }
        default void appTransitionStarting(long startTime, long duration, bool forced) { }
        ...
        default void setTopAppHidesStatusBar(bool topAppHidesStatusBar) { }
        ...
        default void showPinningEnterExitToast(bool entering) { }
        default void showPinningEscapeToast() { }
        default void handleShowGlobalActionsMenu() { }
        default void handleShowShutdownUi(bool isReboot, String reason) { }

        default void showWirelessChargingAnimation(int batteryLevel) {  }

        default void onRotationProposal(int rotation, bool isValid) { }
    ...
    public void topAppWindowChanged(bool menuVisible) {
        synchronized (mLock) {
    ...
    public void showRecentApps(bool triggeredFromAltTab) {
        synchronized (mLock) {
    ...
    public void hideRecentApps(bool triggeredFromAltTab, bool triggeredFromHomeKey) {
        synchronized (mLock) {
    ...
    public void appTransitionPending(bool forced) {
        synchronized (mLock) {
    ...
    public void appTransitionStarting(long startTime, long duration, bool forced) {
        synchronized (mLock) {
    ...
    override
    public void setTopAppHidesStatusBar(bool hidesStatusBar) {
    ...
    override
    public void showShutdownUi(bool isReboot, String reason) {
        synchronized (mLock) {
    ...
    override
    public void onProposedRotationChanged(int rotation, bool isValid) {
        synchronized (mLock) {
    ...
    // Need this class since CommandQueue already : IStatusBar.Stub, so CommandQueueStart
    // is needed so it can extend SystemUI.
    public static class CommandQueueStart : SystemUI {
        override
        public void start() {
