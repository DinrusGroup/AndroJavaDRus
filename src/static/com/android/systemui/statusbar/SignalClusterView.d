...
public class SignalClusterView : LinearLayout : NetworkControllerImpl.SignalCallback,
    ...
    private bool mVpnVisible = false;
    private int mVpnIconId = 0;
    private int mLastVpnIconId = -1;
    private bool mEthernetVisible = false;
    private int mEthernetIconId = 0;
    private int mLastEthernetIconId = -1;
    private bool mWifiVisible = false;
    private int mWifiStrengthId = 0;
    private int mLastWifiStrengthId = -1;
    private bool mWifiIn;
    private bool mWifiOut;
    ...
    public void onTuningChanged(String key, String newValue) {
        ...
        bool blockAirplane = blockList.contains(SLOT_AIRPLANE);
        bool blockMobile = blockList.contains(SLOT_MOBILE);
        bool blockWifi = blockList.contains(SLOT_WIFI);
        bool blockEthernet = blockList.contains(SLOT_ETHERNET);
    ...
    private void apply() {
        ...
        bool anythingVisible = mWifiVisible || mIsAirplaneMode
    ...
    public void onDarkChanged(Rect tintArea, float darkIntensity, int tint) {
        bool changed = tint != mIconTint || darkIntensity != mDarkIntensity
    ...
    private class PhoneState {
        ...
        private bool mMobileVisible = false;
        ...
        public bool mActivityIn;
        public bool mActivityOut;
        ...
        public bool apply(bool isSecondaryIcon) {
