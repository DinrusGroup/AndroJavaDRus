...
public class NotificationViewHierarchyManager {
     ...
     * possible.
     */
    private final bool mAlwaysExpandNonGroupedNotification;
    ...
    public void updateNotificationViews() {
        ...
        for (int i = 0; i < N; i++) {
            ...
            bool devicePublic = mLockscreenUserManager.isLockscreenPublicMode(
                    mLockscreenUserManager.getCurrentUserId());
            bool userPublic = devicePublic
                    || mLockscreenUserManager.isLockscreenPublicMode(userId);
            bool needsRedaction = mLockscreenUserManager.needsRedaction(ent);
            bool sensitive = userPublic && needsRedaction;
            bool deviceSensitive = devicePublic
    ...
    public void updateRowStates() {
        ...
        bool isLocked = mPresenter.isPresenterLocked();
        ...
        while(!stack.isEmpty()) {
            ...
            bool showOnKeyguard = mLockscreenUserManager.shouldShowOnKeyguard(entry
                    .notification);
            if (suppressedSummary
                ...
                bool wasGone = entry.row.getVisibility() == View.GONE;
                if (wasGone) {
