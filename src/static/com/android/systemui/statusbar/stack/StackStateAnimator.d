...
public class StackStateAnimator {
    ...
    public StackStateAnimator(NotificationStackScrollLayout hostLayout) {
        ...
        mAnimationProperties = new AnimationProperties() {
            ...
            override
            public bool wasAdded(View view) {
    ...
    private void initAnimationProperties(StackScrollState finalState, ExpandableView child,
        ...
        bool wasAdded = mAnimationProperties.wasAdded(child);
    ...
    private void adaptDurationWhenGoingToFullShade(ExpandableView child,
            ExpandableViewState viewState, bool wasAdded) {
     ...
     */
    private bool applyWithoutAnimation(ExpandableView child, ExpandableViewState viewState,
        ...
        for (NotificationStackScrollLayout.AnimationEvent event : mNewEvents) {
            ...
            switch (event.animationType) {
                ...
                case NotificationStackScrollLayout.AnimationEvent.ANIMATION_TYPE_REMOVE: {
                    int ownIndex = viewState.notGoneIndex;
                    bool noNextView = event.viewAfterChangingView == null;
    ...
    public void animateOverScrollToAmount(float targetAmount, final bool onTop,
            final bool isRubberbanded) {
    ...
    public void cancelOverScrollAnimators(bool onTop) {
