 ...
 */
public class NotificationChildrenContainer : ViewGroup {
    ...
    private bool mShowDividersWhenExpanded;
    private bool mHideDividersDuringExpand;
    ...
    private int getIntrinsicHeight(float maxAllowedVisibleChildren) {
        ...
        bool childrenExpanded = mChildrenExpanded || mContainingNotification.isShowingAmbient();
        for (int i = 0; i < childCount; i++) {
    ...
    public void getState(StackScrollState resultState, ExpandableViewState parentState,
        ...
        float expandFactor = 0;
        bool expandingToExpandedGroup = mUserLocked && !showingAsLowPriority();
        if (mUserLocked) {
            expandFactor = getGroupExpandFraction();
            firstOverflowIndex = getMaxAllowedVisibleChildren(true /* likeCollapsed */);
        }

        bool childrenExpandedAndNotAnimating = mChildrenExpanded
     ...
     */
    private bool updateChildStateForExpandedGroup(ExpandableNotificationRow child,
    ...
    private int getMaxAllowedVisibleChildren(bool likeCollapsed) {
        if (mContainingNotification.isShowingAmbient()) {
    ...
    public void applyState(StackScrollState state) {
        ...
        final bool dividersVisible = mUserLocked && !showingAsLowPriority()
    ...
    private void updateChildrenClipping() {
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            bool isVisible = child.getVisibility() == VISIBLE;
    ...
    public void setChildrenExpanded(bool childrenExpanded) {
    ...
    private void updateHeaderVisibility(bool animate) {
    ...
    private void startChildAlphaAnimations(bool toVisible) {
     ...
     */
    public void updateHeaderForExpansion(bool expanded) {
        if (mNotificationHeader != null) {
            if (expanded) {
    ...
    public void setActualHeight(int actualHeight) {
        ...
        float fraction = getGroupExpandFraction();
        bool showingLowPriority = showingAsLowPriority();
     ...
     */
    private int getMinHeight(int maxAllowedVisibleChildren, bool likeHighPriority) {
    ...
    public bool showingAsLowPriority() {
