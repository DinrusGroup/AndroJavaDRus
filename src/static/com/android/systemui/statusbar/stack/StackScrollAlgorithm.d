...
public class StackScrollAlgorithm {
    ...
    private bool mClipNotificationScrollToTop;
    ...
    private void updateClipping(StackScrollState resultState,
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            bool isHeadsUp = (child instanceof ExpandableNotificationRow)
    ...
    public static bool canChildBeDismissed(View v) {
        if (!(v instanceof ExpandableNotificationRow)) {
            return false;
        }
        ExpandableNotificationRow row = (ExpandableNotificationRow) v;
    ...
    private void updateDimmedActivatedHideSensitive(AmbientState ambientState,
        ...
        bool dimmed = ambientState.isDimmed();
        bool dark = ambientState.isFullyDark();
        bool hideSensitive = ambientState.isHideSensitive();
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            bool isActivatedChild = activatedChild == child;
    ...
    protected float updateChild(int i, StackScrollState resultState,
        ...
        bool isFooterView = child instanceof FooterView;
        bool isEmptyShadeView = child instanceof EmptyShadeView;
    ...
    private void updateHeadsUpStates(StackScrollState resultState,
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            bool isTopEntry = topHeadsUpEntry == row;
