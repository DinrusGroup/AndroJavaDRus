...
public class NotificationData {
    ...
    public static final class Entry {
        ...
        public bool autoRedacted; // whether the redacted notification was generated by us
        ...
        public int getContrastedColor(Context context, bool isLowPriority,
                int backgroundColor) {
        ...
        public bool isLastMessageFromReply() {
            if (!hasSentReply) {
                return false;
            }
    ...
    private final Comparator<Entry> mRankingComparator = new Comparator<Entry>() {
        ...
        public int compare(Entry a, Entry b) {
            ...
            final bool aMedia = a.key.equals(mediaNotification)
                    && aImportance > NotificationManager.IMPORTANCE_MIN;
            final bool bMedia = b.key.equals(mediaNotification)
                    && bImportance > NotificationManager.IMPORTANCE_MIN;

            bool aSystemMax = aImportance >= NotificationManager.IMPORTANCE_HIGH &&
                    isSystemNotification(na);
            bool bSystemMax = bImportance >= NotificationManager.IMPORTANCE_HIGH &&
                    isSystemNotification(nb);

            bool isHeadsUp = a.row.isHeadsUp();
    ...
    public void updateAppOp(int appOp, int uid, String pkg, String key, bool showIcon) {
        synchronized (mEntries) {
            final int N = mEntries.size();
            for (int i = 0; i < N; i++) {
                Entry entry = mEntries.valueAt(i);
    ...
    public bool isAmbient(String key) {
        if (mRankingMap != null) {
    ...
    protected bool isExemptFromDndVisualSuppression(Entry entry) {
     ...
     */
    protected bool isNotificationBlockedByPolicy(Notification n) {
    ...
    private bool isCategory(String category, Notification n) {
    ...
    public bool shouldHide(String key) {
        if (mRankingMap != null) {
            getRanking(key, mTmpRanking);
     ...
     */
    @VisibleForTesting
    protected bool getRanking(String key, Ranking outRanking) {
     ...
     */
    public bool shouldFilterOut(Entry entry) {
        final StatusBarNotification sbn = entry.notification;
    ...
    public static bool showNotificationEvenIfUnprovisioned(StatusBarNotification sbn) {
        return showNotificationEvenIfUnprovisioned(AppGlobals.getPackageManager(), sbn);
    }

    @VisibleForTesting
    static bool showNotificationEvenIfUnprovisioned(IPackageManager packageManager,
    ...
    private static bool isSystemNotification(StatusBarNotification sbn) {
    ...
    public interface Environment {
        ...
        public bool isNotificationForCurrentProfiles(StatusBarNotification sbn);
