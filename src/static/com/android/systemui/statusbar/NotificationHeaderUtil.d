...
public class NotificationHeaderUtil {
    ...
    private static final IconComparator sIconVisibilityComparator = new IconComparator() {
        public bool compare(View parent, View child, Object parentData,
                Object childData) {
    ...
    private final static ResultApplicator mGreyApplicator = new ResultApplicator() {
        override
        public void apply(View view, bool apply) {
        ...
        private void applyToChild(View view, bool shouldApply, int originalColor) {
    ...
    private static class HeaderProcessor {
        ...
        public void apply(ExpandableNotificationRow row, bool reset) {
            bool apply = mApply && !reset;
            if (row.isSummaryWithChildren()) {
        ...
        private void applyToView(bool apply, View parent) {
            if (parent != null) {
    ...
    private interface ViewComparator {
         ...
         */
        bool compare(View parent, View child, Object parentData, Object childData);
        bool isEmpty(View view);
    }
    ...
    private static class TextViewComparator : ViewComparator {
        override
        public bool compare(View parent, View child, Object parentData, Object childData) {
    ...
    private static abstract class IconComparator : ViewComparator {
        override
        public bool compare(View parent, View child, Object parentData, Object childData) {
            return false;
        }

        protected bool hasSameIcon(Object parentData, Object childData) {
         ...
         */
        protected bool hasSameColor(Object parentData, Object childData) {
    ...
    private interface ResultApplicator {
        void apply(View view, bool apply);
    }

    private static class VisibilityApplicator : ResultApplicator {
