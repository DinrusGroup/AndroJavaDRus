 ...
 */
public class KeyguardAffordanceView : ImageView {
    ...
    private bool mCircleWillBeHidden;
    ...
    private bool mSupportHardware;
    private bool mFinishing;
    private bool mLaunchingAffordance;
    private bool mShouldTint = true;
    ...
    public void setImageDrawable(@Nullable Drawable drawable, bool tint) {
    ...
    public void setCircleRadius(float circleRadius, bool slowAnimation) {
    ...
    private void setCircleRadius(float circleRadius, bool slowAnimation, bool noAnimation) {

        // Check if we need a new animation
        bool radiusHidden = (mCircleAnimator != null && mCircleWillBeHidden)
                || (mCircleAnimator == null && mCircleRadius == 0.0f);
        bool nowHidden = circleRadius == 0.0f;
        bool radiusNeedsAnimation = (radiusHidden != nowHidden) && !noAnimation;
    ...
    public void setImageScale(float imageScale, bool animate) {
     ...
     *                     interpolator.
     */
    public void setImageScale(float imageScale, bool animate, long duration,
    ...
    public void setImageAlpha(float alpha, bool animate) {
     ...
     *                     interpolator.
     */
    public void setImageAlpha(float alpha, bool animate, long duration,
    ...
    public void setLaunchingAffordance(bool launchingAffordance) {
