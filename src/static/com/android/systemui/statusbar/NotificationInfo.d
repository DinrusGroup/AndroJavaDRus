 ...
 */
public class NotificationInfo : LinearLayout : NotificationGuts.GutsContent {
    ...
    private bool mIsSingleDefaultChannel;
    private bool mIsNonblockable;
    private StatusBarNotification mSbn;
    private AnimatorSet mExpandAnimation;
    private bool mIsForeground;
    ...
    private bool mIsForBlockingHelper;
    private bool mNegativeUserSentiment;
    ...
    public void bindNotification(
            ...
            bool isNonblockable,
            bool isForBlockingHelper,
            bool isUserSentimentNegative)
            throws RemoteException {
    ...
    private bool hasImportanceChanged() {
    ...
    private void swapContent(bool showPrompt) {
     ...
     * user does not have the ability to undo the action anymore. See {@link #swapContent(bool)}
     ...
     */
    private static class UpdateImportanceRunnable : Runnable {
