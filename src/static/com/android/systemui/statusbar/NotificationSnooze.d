...
public class NotificationSnooze : LinearLayout
        : NotificationGuts.GutsContent, View.OnClickListener {
    ...
    private void showSnoozeOptions(bool show) {
    ...
    private void animateSnoozeOptions(bool show) {
    ...
    private void setSelected(SnoozeOption option, bool userAction) {
    ...
    public class NotificationSnoozeOption : SnoozeOption {
