 ...
 */
public class NotificationRemoteInputManager : Dumpable {
    public static final bool ENABLE_REMOTE_INPUT =
            SystemProperties.getBoolean("debug.enable_remote_input", true);
    public static final bool FORCE_REMOTE_INPUT_HISTORY =
    ...
    private final RemoteViews.OnClickHandler mOnClickHandler = new RemoteViews.OnClickHandler() {
        ...
        private bool superOnClickHandler(View view, PendingIntent pendingIntent,
                Intent fillInIntent) {
            return super.onClickHandler(view, pendingIntent, fillInIntent,
                    WINDOWING_MODE_FULLSCREEN_OR_SPLIT_SCREEN_SECONDARY);
        }

        private bool handleRemoteInput(View view, PendingIntent pendingIntent) {
     ...
     */
    public bool onRemoveNotification(NotificationData.Entry entry) {
    ...
    public interface Callback {
         ...
         */
        bool shouldHandleRemoteInput(View view, PendingIntent pendingIntent);
         ...
         */
        bool handleRemoteViewClick(View view, PendingIntent pendingIntent, Intent fillInIntent,
