 ...
 */
class SaveImageInBackgroundTask : AsyncTask<Void, Void, Void> {
 ...
 */
class DeleteImageInBackgroundTask : AsyncTask<Uri, Void, Void> {
...
class GlobalScreenshot {
     ...
     */
    private void takeScreenshot(Runnable finisher, bool statusBarVisible, bool navBarVisible,
            Rect crop) {
    ...
    void takeScreenshot(Runnable finisher, bool statusBarVisible, bool navBarVisible) {
        mDisplay.getRealMetrics(mDisplayMetrics);
     ...
     */
    void takeScreenshotPartial(final Runnable finisher, final bool statusBarVisible,
     ...
     */
    private void startAnimation(final Runnable finisher, int w, int h, bool statusBarVisible,
            bool navBarVisible) {
    ...
    private ValueAnimator createScreenshotDropOutAnimation(int w, int h, bool statusBarVisible,
            bool navBarVisible) {
        ValueAnimator anim = ValueAnimator.ofFloat(0f, 1f);
     ...
     */
    public static class ScreenshotActionReceiver : BroadcastReceiver {
        override
     ...
     */
    public static class TargetChosenReceiver : BroadcastReceiver {
        override
        public void onReceive(Context context, Intent intent) {
     ...
     */
    public static class DeleteScreenshotReceiver : BroadcastReceiver {
        override
        public void onReceive(Context context, Intent intent) {
