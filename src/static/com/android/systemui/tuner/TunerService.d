...
public abstract class TunerService {
    ...
    public static final void setTunerEnabled(Context context, bool enabled) {
    ...
    public static final bool isTunerEnabled(Context context) {
        return userContext(context).getPackageManager().getComponentEnabledSetting(
                new ComponentName(context, TunerActivity.class))
                == PackageManager.COMPONENT_ENABLED_STATE_ENABLED;
    }

    public static class ClearReceiver : BroadcastReceiver {
        override
