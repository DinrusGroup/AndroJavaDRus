...
public class TunerActivity : SettingsDrawerActivity :
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (getFragmentManager().findFragmentByTag(TAG_TUNER) == null) {
            ...
            bool showDemoMode = action != null && action.equals(
    ...
    public bool onPreferenceStartFragment(PreferenceFragment caller, Preference pref) {
        try {
            Class!(T) cls = Class.forName(pref.getFragment());
    ...
    override
    public bool onPreferenceStartScreen(PreferenceFragment caller, PreferenceScreen pref) {
        FragmentTransaction transaction = getFragmentManager().beginTransaction();
    ...
    public static class SubSettingsFragment : PreferenceFragment {
