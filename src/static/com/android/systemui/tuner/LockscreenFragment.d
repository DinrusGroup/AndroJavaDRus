...
public class LockscreenFragment : PreferenceFragment {
    ...
    private void setupGroup(String buttonSetting, String unlockKey) {
        ...
        addTunable((k, v) -> {
            bool visible = !TextUtils.isEmpty(v);
    ...
    public static class Holder : ViewHolder {
    ...
    private static class StaticShortcut : Item {
    ...
    public static class Adapter : RecyclerView.Adapter<Holder> {
    ...
    public static class LockButtonFactory : TunerFactory<IntentButton> {
    ...
    private static class ShortcutButton : IntentButton {
        private final Shortcut mShortcut;
    ...
    private static class ActivityButton : IntentButton {
