 ...
 */
public class DividerView : FrameLayout : OnTouchListener,
    ...
    private bool mBackgroundLifted;
    private bool mIsInMinimizeInteraction;
    ...
    private bool mGrowRecents;
    private ValueAnimator mCurrentAnimator;
    private bool mEntranceAnimationRunning;
    private bool mExitAnimationRunning;
    private int mExitStartPosition;
    private bool mDockedStackMinimized;
    private bool mHomeStackResizable;
    ...
    protected void onFinishInflate() {
        ...
        updateDisplayInfo();
        bool landscape = getResources().getConfiguration().orientation
    ...
    public bool startDragging(bool animate, bool touching) {
    ...
    public void stopDragging(int position, float velocity, bool avoidDismissStart,
            bool logMetrics) {
    ...
    public bool onTouch(View v, MotionEvent event) {
        ...
        switch (action) {
            case MotionEvent.ACTION_DOWN:
                ...
                bool result = startDragging(true /* animate */, true /* touching */);
                if (!result) {
    ...
    private void fling(int position, float velocity, bool avoidDismissStart,
            bool logMetrics) {
    ...
    private ValueAnimator getFlingAnimator(int position, final SnapTarget snapTarget,
        ...
        final bool taskPositionSameAtEnd = snapTarget.flag == SnapTarget.FLAG_NONE;
    ...
    public void setMinimizedDockStack(bool minimized, bool isHomeStackResizable) {
    ...
    public void setMinimizedDockStack(bool minimized, long animDuration,
    ...
    public void setAdjustedForIme(bool adjustedForIme) {
        updateDockSide();
    ...
    public void setAdjustedForIme(bool adjustedForIme, long animDuration) {
        updateDockSide();
        mHandle.animate()
     ...
     */
    private bool hasInsetsAtDismissTarget(SnapTarget dismissTarget) {
        if (isHorizontalDivision()) {
    ...
    private static bool isDismissing(SnapTarget snapTarget, int position, int dockSide) {
     ...
     */
    private static bool dockSideTopLeft(int dockSide) {
     ...
     */
    private static bool dockSideBottomRight(int dockSide) {
