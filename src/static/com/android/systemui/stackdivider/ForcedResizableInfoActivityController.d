...
public class ForcedResizableInfoActivityController {
    ...
    public void notifyDockedStackExistsChanged(bool exists) {
        if (!exists) {
    ...
    private bool debounce(String packageName) {
        if (packageName == null) {
            return false;
        }
        ...
        bool debounce = mPackagesShownInSession.contains(packageName);
