 ...
 * that the keyguard be disabled via {@link #setKeyguardEnabled(bool)}.  When
 ...
 */
public class KeyguardViewMediator : SystemUI {
     ...
     * callback before unblocking a call to {@link #setKeyguardEnabled(bool)}
    ...
    private bool mBootSendUserPresent;
     ...
     */
    private bool mExternallyEnabled = true;
     ...
     */
    private bool mNeedToReshowWhenReenabled = false;
    ...
    private bool mInputRestricted;

    // true if the keyguard is hidden by another window
    private bool mOccluded = false;
     ...
     * the keyguard.
     */
    private bool mWaitingUntilKeyguardVisible = false;
    private LockPatternUtils mLockPatternUtils;
    private bool mKeyguardDonePending = false;
    private bool mHideAnimationRun = false;
    private bool mHideAnimationRunning = false;
    ...
    private bool mLockLater;

    private bool mWakeAndUnlocking;
    private IKeyguardDrawnCallback mDrawnCallback;
    private bool mLockWhenSimRemoved;
    ...
    KeyguardUpdateMonitorCallback mUpdateCallback = new KeyguardUpdateMonitorCallback() {
        ...
        public void onSimStateChanged(int subId, int slotId, IccCardConstants.State simState) {
            ...
            bool simPinSecure = mUpdateMonitor.isSimPinSecure();
    ...
    ViewMediatorCallback mViewMediatorCallback = new ViewMediatorCallback() {
        ...
        override
        public void keyguardDone(bool strongAuth, int targetUserId) {
        ...
        override
        public void keyguardDonePending(bool strongAuth, int targetUserId) {
        ...
        override
        public void onBouncerVisiblityChanged(bool shown) {
            synchronized (KeyguardViewMediator.this) {
        ...
        public int getBouncerPromptReason() {
            ...
            bool trust = mTrustManager.isTrustUsuallyManaged(currentUser);
            bool fingerprint = mUpdateMonitor.isUnlockWithFingerprintPossible(currentUser);
            bool any = trust || fingerprint;
    ...
    public void onFinishedGoingToSleep(int why, bool cameraGestureTriggered) {
     ...
     */
    public void setKeyguardEnabled(bool enabled) {
        synchronized (this) {
     ...
     */
    public bool isShowingAndNotOccluded() {
     ...
     */
    public void setOccluded(bool isOccluded, bool animate) {
     ...
     */
    private void handleSetOccluded(bool isOccluded, bool animate) {
    ...
    private void updateInputRestrictedLocked() {
        bool inputRestricted = isInputRestricted();
    ...
    private void doKeyguardLocked(Bundle options) {
        ...
        if (!mustNotUnlockCurrentUser()
            ...
            final bool requireSim = !SystemProperties.getBoolean("keyguard.no_require_sim", false);
            final bool absent = SubscriptionManager.isValidSubscriptionId(
                    mUpdateMonitor.getNextSubIdForState(ABSENT));
            final bool disabled = SubscriptionManager.isValidSubscriptionId(
                    mUpdateMonitor.getNextSubIdForState(IccCardConstants.State.PERM_DISABLED));
            final bool lockedOrMissing = mUpdateMonitor.isSimPinSecure()
            ...
            bool forceShow = options != null && options.getBoolean(OPTION_FORCE_SHOW, false);
    ...
    private bool shouldWaitForProvisioning() {
    ...
    private void playSounds(bool locked) {
    ...
    private void updateActivityLockScreenState(bool showing, bool aodShowing,
    ...
    private void adjustStatusBarLocked(bool forceHideHomeRecentsButtons) {
    ...
    private void setShowingLocked(bool showing, bool aodShowing) {
        setShowingLocked(showing, aodShowing, mSecondaryDisplayShowing,
                false /* forceCallbacks */);
    }

    private void setShowingLocked(bool showing, bool aodShowing, int secondaryDisplayShowing,
            bool forceCallbacks) {
        final bool notifyDefaultDisplayCallbacks = showing != mShowing
    ...
    private void notifyDefaultDisplayCallbacks(bool showing) {
        int size = mKeyguardStateCallbacks.size();
        for (int i = size - 1; i >= 0; i--) {
    ...
    private void notifyTrustedChangedLocked(bool trusted) {
        int size = mKeyguardStateCallbacks.size();
        for (int i = size - 1; i >= 0; i--) {
            try {
    ...
    private void notifyHasLockscreenWallpaperChanged(bool hasLockscreenWallpaper) {
        int size = mKeyguardStateCallbacks.size();
        for (int i = size - 1; i >= 0; i--) {
            try {
