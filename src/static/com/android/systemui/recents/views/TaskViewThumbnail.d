...
/**
 * The task thumbnail view.  It : an image view that allows for animating the dim and
 * alpha of the thumbnail image.
 */
public class TaskViewThumbnail : View {
    ...
    private bool mSizeToFit = false;
    private bool mOverlayHeaderOnThumbnailActionBar = true;
    ...
    protected bool mUserLocked = false;
    ...
    @ViewDebug.ExportedProperty(category="recents")
    private bool mDisabledInSafeMode;
    ...
    public void setSizeToFit(bool flag) {
        mSizeToFit = flag;
    }
     ...
     */
    public void setOverlayHeaderOnThumbnailActionBar(bool flag) {
    ...
    void updateThumbnailVisibility(int clipBottom) {
        bool invisible = mTaskBar != null && (getHeight() - clipBottom) <= mTaskBar.getHeight();
     ...
     */
    void bindToTask(Task t, bool disabledInSafeMode, int displayOrientation, Rect displayRect) {
        mTask = t;
