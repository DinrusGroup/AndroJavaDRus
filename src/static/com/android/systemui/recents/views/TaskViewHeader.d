...
/* The task bar view */
public class TaskViewHeader : FrameLayout
     ...
     */
    private class HighlightColorDrawable : Drawable {
    ...
    // Used in grid layout.
    private bool mShouldDarkenBackgroundColor = false;
    ...
    int getSecondaryColor(int primaryColor, bool useLightOverlayColor) {
     ...
     */
    public void setShouldDarkenBackgroundColor(bool flag) {
     ...
     */
    public void bindToTask(Task t, bool touchExplorationEnabled, bool disabledInSafeMode) {
        mTask = t;
    ...
    void unbindFromTask(bool touchExplorationEnabled) {
        mTask = null;
     ...
     */
    private void hideAppOverlay(bool immediate) {
