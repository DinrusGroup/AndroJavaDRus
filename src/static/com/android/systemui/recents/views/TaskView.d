 ...
 */
public class TaskView : FixedSizeFrameLayout : Task.TaskCallbacks,
    ...
    private Task mTask;
    private bool mTaskBound;
    @ViewDebug.ExportedProperty(category="recents")
    private bool mClipViewInStack = true;
    @ViewDebug.ExportedProperty(category="recents")
    private bool mTouchExplorationEnabled;
    @ViewDebug.ExportedProperty(category="recents")
    private bool mIsDisabledInSafeMode;
     ...
     */
    bool isAnimatingTo(TaskViewTransform transform) {
    ...
    void setClipViewInStack(bool clip) {
     ...
     */
    public void setFocusedState(bool isFocused, bool requestViewFocus) {
        if (isFocused) {
     ...
     */
    public void showActionButton(bool fadeIn, int fadeInDuration) {
     ...
     */
    public void hideActionButton(bool fadeOut, int fadeOutDuration, bool scaleDown,
    ...
    public void onStartLaunchTargetEnterAnimation(TaskViewTransform transform, int duration,
            bool screenPinningEnabled, ReferenceCountedTrigger postAnimationTrigger) {
        cancelDimAnimationIfExists();
    ...
    override
    public void onStartLaunchTargetLaunchAnimation(int duration, bool screenPinningRequested,
    ...
    override
    public void onStartFrontTaskEnterAnimation(bool screenPinningEnabled) {
        if (screenPinningEnabled) {
    ...
    public void onTaskBound(Task t, bool touchExplorationEnabled, int displayOrientation,
            Rect displayRect) {
    ...
    override
     public void onClick(final View v) {
        ...
        bool screenPinningRequested = false;
