 ...
 */
class TaskStackViewTouchHandler : SwipeHelper.Callback {
    ...
    bool mInterceptedBySwipeHelper;
    ...
    public void onBeginDrag(View v) {
        ...
        if (anchorTask != null) {
            ...
            bool pullStackForward = mCurrentTasks.size() > 0;
            if (pullStackForward) {
                if (Recents.getConfiguration().isLowRamDevice) {
    ...
    override
    public bool updateSwipeProgress(View v, bool dismissable, float swipeProgress) {
