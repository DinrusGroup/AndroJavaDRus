...
public class TaskViewTransform {
     ...
     */
    public bool isSame(TaskViewTransform other) {
    ...
    public bool hasAlphaChangedFrom(float v) {
        return (Float.compare(alpha, v) != 0);
    }

    public bool hasScaleChangedFrom(float v) {
        return (Float.compare(scale, v) != 0);
    }

    public bool hasTranslationZChangedFrom(float v) {
        return (Float.compare(translationZ, v) != 0);
    }

    public bool hasRectChangedFrom(View v) {
    ...
    public void applyToTaskView(TaskView v, ArrayList<Animator> animators,
            AnimationProps animation, bool allowShadows) {
