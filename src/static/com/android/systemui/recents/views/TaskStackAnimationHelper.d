...
public class TaskStackAnimationHelper {
    ...
    public interface Callbacks {
         ...
         */
        void onStartLaunchTargetLaunchAnimation(int duration, bool screenPinningRequested,
         ...
         * target.
         */
        void onStartFrontTaskEnterAnimation(bool screenPinningEnabled);
    }
    ...
    public void prepareForEnterAnimation() {
        ...
        bool isLandscape = appResources.getConfiguration().orientation
     ...
     */
    public void startExitToHomeAnimation(bool animated,
            ReferenceCountedTrigger postAnimationTrigger) {
        TaskStackLayoutAlgorithm stackLayout = mStackView.getStackAlgorithm();
        TaskStack stack = mStackView.getStack();
     ...
     */
    public void startLaunchTaskAnimation(TaskView launchingTaskView, bool screenPinningRequested,
     ...
     */
    public void startDeleteTaskAnimation(final TaskView deleteTaskView, bool gridLayout,
            final ReferenceCountedTrigger postAnimationTrigger) {
        if (gridLayout) {
     ...
     */
    public void startDeleteAllTasksAnimation(final List<TaskView> taskViews, bool gridLayout,
            final ReferenceCountedTrigger postAnimationTrigger) {
        if (gridLayout) {
     ...
     */
    public bool startScrollToFocusedTaskAnimation(Task newFocusedTask,
            bool requestViewFocus) {
        TaskStackLayoutAlgorithm stackLayout = mStackView.getStackAlgorithm();
        TaskStackViewScroller stackScroller = mStackView.getScroller();
        TaskStack stack = mStackView.getStack();
        ...
        bool willScrollToFront = newScroll > curScroll;
        bool willScroll = Float.compare(newScroll, curScroll) != 0;
