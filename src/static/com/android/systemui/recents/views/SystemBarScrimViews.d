...
public class SystemBarScrimViews {
    ...
    private bool mHasNavBarScrim;
    private bool mShouldAnimateNavBarScrim;
    private bool mHasTransposedNavBar;
    private bool mHasDockedTasks;
     ...
     */
    public void updateNavBarScrim(bool animateNavBarScrim, bool hasStackTasks,
     ...
     */
    private void prepareEnterRecentsAnimation(bool hasNavBarScrim, bool animateNavBarScrim) {
     ...
     */
    private void animateNavBarScrimVisibility(bool visible, AnimationProps animation) {
        int toY = 0;
        if (visible) {
     ...
     */
    private bool isNavBarScrimRequired(bool hasStackTasks) {
     ...
     */
    private void animateScrimToCurrentNavBarState(bool hasStackTasks) {
        bool hasNavBarScrim = isNavBarScrimRequired(hasStackTasks);
