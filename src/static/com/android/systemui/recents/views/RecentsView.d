 ...
 */
public class RecentsView : FrameLayout {
    ...
    private bool mAwaitingFirstLayout = true;
    ...
    public void reevaluateStyles() {
        ...
        bool usingDarkText = Color.luminance(textColor) < 0.5f;
     ...
     */
    public void onReload(TaskStack stack, bool isResumingFromVisible) {
        ...
        final bool isTaskStackEmpty = stack.getTaskCount() == 0;
     ...
     */
    public void updateStack(TaskStack stack, bool setStackViewTasks) {
     ...
     */
    public void updateBackgroundScrim(Window window, bool isInMultiWindow) {
        if (isInMultiWindow) {
    ...
    public bool launchFocusedTask(int logEvent) {
        if (mTaskStackView != null) {
    ...
    public bool launchPreviousTask() {
     ...
     */
    public void setScrimColors(ColorExtractor.GradientColors scrimColors, bool animated) {
     ...
     */
    private void showStackActionButton(final int duration, final bool translate) {
     ...
     */
    private void hideStackActionButton(int duration, bool translate) {
        final ReferenceCountedTrigger postAnimationTrigger = new ReferenceCountedTrigger();
     ...
     */
    private void animateEmptyView(bool show, ReferenceCountedTrigger postAnimationTrigger) {
    ...
    private void updateVisibleDockRegions(DockState[] newDockStates,
            bool isDefaultDockState, int overrideAreaAlpha, int overrideHintAlpha,
            bool animateAlpha, bool animateBounds) {
    ...
    public void launchTaskFromRecents(final TaskStack stack, @Nullable final Task task,
            ...
            final bool screenPinningRequested, final int windowingMode, final int activityType) {
