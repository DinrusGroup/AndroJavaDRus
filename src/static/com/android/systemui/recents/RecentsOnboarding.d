...
public class RecentsOnboarding {
    ...
    private static final bool RESET_PREFS_FOR_DEBUG = false;
    private static final bool ONBOARDING_ENABLED = true;
    ...
    private bool mOverviewProxyListenerRegistered;
    private bool mTaskListenerRegistered;
    private bool mLayoutAttachedToWindow;
    private bool mHasDismissedSwipeUpTip;
    private bool mHasDismissedQuickScrubTip;
    ...
    private final SysUiTaskStackChangeListener mTaskListener = new SysUiTaskStackChangeListener() {
        ...
        private void onAppLaunch() {
            ...
            if (activityType == ACTIVITY_TYPE_STANDARD) {
                bool alreadySeenSwipeUpOnboarding = hasSeenSwipeUpOnboarding();
                bool alreadySeenQuickScrubsOnboarding = hasSeenQuickScrubOnboarding();
    ...
    private OverviewProxyService.OverviewProxyListener mOverviewProxyListener =
            new OverviewProxyService.OverviewProxyListener() {
                override
                public void onOverviewShown(bool fromHome) {
    ...
    public bool show(@StringRes int stringRes) {
        if (!shouldShow()) {
            return false;
        }
    ...
    private bool hasSeenSwipeUpOnboarding() {
        return Prefs.getBoolean(mContext, HAS_SEEN_RECENTS_SWIPE_UP_ONBOARDING, false);
    }

    private void setHasSeenSwipeUpOnboarding(bool hasSeenSwipeUpOnboarding) {
    ...
    private bool hasSeenQuickScrubOnboarding() {
        return Prefs.getBoolean(mContext, HAS_SEEN_RECENTS_QUICK_SCRUB_ONBOARDING, false);
    }

    private void setHasSeenQuickScrubOnboarding(bool hasSeenQuickScrubOnboarding) {
    ...
    private bool hasDismissedQuickScrubOnboardingOnce() {
    ...
    private void setHasDismissedQuickScrubOnboardingOnce(
            bool hasDismissedQuickScrubOnboardingOnce) {
