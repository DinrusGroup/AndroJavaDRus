 ...
 * users.
 */
public class Recents : SystemUI
        : RecentsComponent, CommandQueue.Callbacks {
    ...
    override
    public bool splitPrimaryTask(int dragMode, int stackCreateMode, Rect initialBounds,
        ...
        bool screenPinningActive = ActivityManagerWrapper.getInstance().isScreenPinningActive();
        bool isRunningTaskInHomeOrRecentsStack =
    ...
    private void postToSystemUser(final Runnable onConnectRunnable) {
        ...
        if (mUserToSystemCallbacks == null) {
            ...
            bool bound = mContext.bindServiceAsUser(systemUserServiceIntent,
