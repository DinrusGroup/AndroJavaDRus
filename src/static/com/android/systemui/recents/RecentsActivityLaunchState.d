...
public class RecentsActivityLaunchState {
    ...
    public bool launchedWithAltTab;
    public bool launchedFromApp;
    // Set if the activity that we launched from entered PiP during the transition into Recents
    public bool launchedFromPipApp;
    // Set if the next activity that quick-switch will launch is the PiP activity
    public bool launchedWithNextPipApp;
    public bool launchedFromHome;
    public bool launchedViaDragGesture;
    public bool launchedViaDockGesture;
