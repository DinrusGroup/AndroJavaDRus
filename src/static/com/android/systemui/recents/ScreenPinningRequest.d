...
public class ScreenPinningRequest : View.OnClickListener {
    ...
    public void showPrompt(int taskId, bool allowCancel) {
        try {
            clearPrompt();
    ...
    private class RequestWindowView : FrameLayout {
        ...
        public RequestWindowView(Context context, bool showCancel) {
            super(context);
            setClickable(true);
        ...
        private void inflateView(int rotation) {
            ...
            final bool recentsVisible = navigationBarView != null
                    && navigationBarView.isRecentsButtonVisible();
            bool touchExplorationEnabled = mAccessibilityService.isTouchExplorationEnabled();
