...
public class BatteryMeterView : LinearLayout :
    ...
    private int mLevel;
    private bool mForceShowPercent;
     ...
     */
    private bool mUseWallpaperTextColors;
    ...
    public void setForceShowPercent(bool show) {
    ...
    public void onTuningChanged(String key, String newValue) {
        if (StatusBarIconController.ICON_BLACKLIST.equals(key)) {
            ...
            bool hidden = icons.contains(mSlotBattery);
    ...
    private void updateShowPercent() {
        final bool showing = mBatteryPercentView != null;
