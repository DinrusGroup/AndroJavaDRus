 ...
 */
public class SysuiColorExtractor : ColorExtractor : Dumpable {
    private static final String TAG = "SysuiColorExtractor";
    private bool mWallpaperVisible;
    private bool mMediaBackdropVisible;
    ...
    @VisibleForTesting
    public SysuiColorExtractor(Context context, ExtractionType type, bool registerVisibility) {
        super(context, type);
        ...
        if (registerVisibility) {
            try {
                ...
                bool visible = windowManagerService.registerWallpaperVisibilityListener(
     ...
     * @return
     */
    public GradientColors getColors(int which, bool ignoreWallpaperVisibility) {
     ...
     * @return colors
     */
    public GradientColors getColors(int which, int type, bool ignoreWallpaperVisibility) {
    ...
    public void setMediaBackdropVisible(bool visible) {
