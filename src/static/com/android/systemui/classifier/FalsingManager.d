 ...
 */
public class FalsingManager : SensorEventListener {
    ...
    private bool mEnforceBouncer = false;
    private bool mBouncerOn = false;
    private bool mBouncerOffOnDown = false;
    private bool mSessionActive = false;
    private bool mIsTouchScreen = true;
    private int mState = StatusBarState.SHADE;
    private bool mScreenOn;
    private bool mShowingAod;
    ...
    private bool shouldSessionBeActive() {
    ...
    private bool sessionEntrypoint() {
    ...
    private void sessionExitpoint(bool force) {
    ...
    public bool isClassiferEnabled() {
    ...
    public bool shouldEnforceBouncer() {
        return mEnforceBouncer;
    }

    public void setShowingAod(bool showingAod) {
    ...
    public void onTrackingStarted(bool secure) {
        if (FalsingLog.ENABLED) {
    ...
    public void onNotificationDoubleTap(bool accepted, float dx, float dy) {
        if (FalsingLog.ENABLED) {
    ...
    public void onAffordanceSwipingStarted(bool rightCorner) {
        if (FalsingLog.ENABLED) {
