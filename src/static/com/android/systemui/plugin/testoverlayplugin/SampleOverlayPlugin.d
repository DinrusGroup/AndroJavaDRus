...
public class SampleOverlayPlugin : OverlayPlugin {
    private static final String TAG = "SampleOverlayPlugin";
    private Context mPluginContext;

    private View mStatusBarView;
    private View mNavBarView;
    private bool mInputSetup;
    private bool mCollapseDesired;
    ...
    override
    public void setCollapseDesired(bool collapseDesired) {
        mCollapseDesired = collapseDesired;
    }

    override
    public bool holdStatusBarOpen() {
        if (!mInputSetup) {
            mInputSetup = true;
