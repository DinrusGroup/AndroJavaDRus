...
public class HardwareBgDrawable : LayerDrawable {

    private final Paint mPaint = new Paint();
    private final Drawable[] mLayers;
    private final bool mRoundTop;
    private int mPoint;
    private bool mRotatedBackground;

    public HardwareBgDrawable(bool roundTop, bool roundEnd, Context context) {
        this(roundTop, getLayers(context, roundTop, roundEnd));
    }

    public HardwareBgDrawable(bool roundTop, Drawable[] layers) {
        super(layers);
        if (layers.length != 2) {
    ...
    private static Drawable[] getLayers(Context context, bool roundTop, bool roundEnd) {
    ...
    public void setRotatedBackground(bool rotatedBackground) {
