 ...
 */
public class PipMotionHelper : Handler.Callback {
     ...
     * Resizes the pinned stack back to fullscreen.
     */
    void expandPip(bool skipAnimation) {
        if (DEBUG) {
    ...
    void animateToUnexpandedState(Rect normalBounds, float savedSnapFraction,
            Rect normalMovementBounds, Rect currentMovementBounds, bool minimized,
            bool immediate) {
     ...
     *         dismissing.
     */
    private Point getDismissEndPoint(Rect pipBounds, float velX, float velY, bool isFling) {
        Point displaySize = new Point();
        mContext.getDisplay().getRealSize(displaySize);
     ...
     *         dismissing.
     */
    public bool isGestureToDismissArea(Rect pipBounds, float velX, float velY,
            bool isFling) {
