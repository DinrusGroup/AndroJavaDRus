...
public class PipTouchState {
    ...
    private bool mIsUserInteracting = false;
    // Set to true only if the multiple taps occur within the double tap timeout
    private bool mIsDoubleTap = false;
    // Set to true only if a gesture
    private bool mIsWaitingForDoubleTap = false;
    private bool mIsDragging = false;
    // The previous gesture was a drag
    private bool mPreviouslyDragging = false;
    private bool mStartedDragging = false;
    private bool mAllowDraggingOffscreen = false;
    ...
    public void onTouchEvent(MotionEvent ev) {
        switch (ev.getAction()) {
            ...
            case MotionEvent.ACTION_MOVE: {
                ...
                bool hasMovedBeyondTap = mDownDelta.length() > mViewConfig.getScaledTouchSlop();
                if (!mIsDragging) {
     ...
     */
    public void setAllowTouches(bool allowTouches) {
     ...
     */
    public bool allowDraggingOffscreen() {
     ...
     */
    public bool isWaitingForDoubleTap() {
