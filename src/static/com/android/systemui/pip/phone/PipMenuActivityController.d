...
public class PipMenuActivityController {
    ...
    public interface Listener {
         ...
         */
        void onPipMenuStateChanged(int menuState, bool resize);
    ...
    private bool mStartActivityRequested;
    ...
    public bool isMenuActivityVisible() {
    ...
    public void showMenu(int menuState, Rect stackBounds, Rect movementBounds,
            bool allowMenuTimeout, bool willResizeMenu) {
        if (DEBUG) {
     ...
     */
    private bool isValidActions(ParceledListSlice actions) {
     ...
     */
    private bool isStartActivityRequestedElapsed() {
     ...
     */
    private void onMenuStateChanged(int menuState, bool resize) {
        if (DEBUG) {
    ...
    private void setStartActivityRequested(bool requested) {
