 ...
 */
public class PipMenuActivity : Activity {
    ...
    private bool mAllowMenuTimeout = true;
    private bool mAllowTouches = true;
    ...
    private void showMenu(int menuState, Rect stackBounds, Rect movementBounds,
            bool allowMenuTimeout, bool resizeMenuOnShow) {
        mAllowMenuTimeout = allowMenuTimeout;
        if (mMenuState != menuState) {
            // Disallow touches if the menu needs to resize while showing, and we are transitioning
            // to/from a full menu state.
            bool disallowTouchesUntilAnimationEnd = resizeMenuOnShow &&
    ...
    private void hideMenu(final Runnable animationFinishedRunnable, bool notifyMenuVisibility,
            bool isDismissing) {
        if (mMenuState != MENU_STATE_NONE) {
            cancelDelayedFinish();
    ...
    private void updateFromIntent(Intent intent) {
        ...
        if (menuState != MENU_STATE_NONE) {
            ...
            bool allowMenuTimeout = intent.getBooleanExtra(EXTRA_ALLOW_TIMEOUT, true);
            bool willResizeMenu = intent.getBooleanExtra(EXTRA_WILL_RESIZE_MENU, false);
    ...
    private void updateActionViews(Rect stackBounds) {
        ...
        if (mActions.isEmpty() || mMenuState == MENU_STATE_CLOSE) {
            ...
            if (mActionsGroup != null) {
                ...
                // Recreate the layout
                final bool isLandscapePip = stackBounds != null &&
