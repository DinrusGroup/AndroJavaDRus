 ...
 * @hide
 */
public class WirelessChargingLayout : FrameLayout {
    ...
    public WirelessChargingLayout(Context context, int batteryLevel, bool isDozing) {
        super(context);
    ...
    private void init(Context c, AttributeSet attrs, bool isDozing) {
        init(c, attrs, -1, false);
    }

    private void init(Context context, AttributeSet attrs, int batteryLevel, bool isDozing) {
