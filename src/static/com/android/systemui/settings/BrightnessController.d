...
public class BrightnessController : ToggleSlider.Listener {
    private static final String TAG = "StatusBar.BrightnessController";
    private static final bool SHOW_AUTOMATIC_ICON = false;
    ...
    private final bool mAutomaticAvailable;
    ...
    private volatile bool mAutomatic;  // Brightness adjusted automatically using ambient light.
    private volatile bool mIsVrModeEnabled;
    private bool mListening;
    private bool mExternalChange;
    private bool mControlValueInitialized;
    ...
    private class BrightnessObserver : ContentObserver {
    ...
    private final Runnable mUpdateSliderRunnable = new Runnable() {
        ...
        public void run() {
            final int val;
            final bool inVrMode = mIsVrModeEnabled;
            if (inVrMode) {
    ...
    public bool removeStateChangedCallback(BrightnessStateChangeCallback cb) {
    ...
    override
    public void onChanged(ToggleSlider toggleSlider, bool tracking, bool automatic,
            int value, bool stopTracking) {
    ...
    private void updateIcon(bool automatic) {
        if (mIcon != null) {
    ...
    private void updateVrMode(bool isEnabled) {
    ...
    private void updateSlider(int val, bool inVrMode) {
        final int min;
        final int max;
        if (inVrMode) {
            min = mMinimumBacklightForVr;
