 ...
 */
public class RingtonePlayer : SystemUI {
     ...
     */
    private class Client : IBinder.DeathRecipient {
    ...
    private IRingtonePlayer mCallback = new IRingtonePlayer.Stub() {
        override
        public void play(IBinder token, Uri uri, AudioAttributes aa, float volume, bool looping)
        ...
        override
        public bool isPlaying(IBinder token) {
        ...
        override
        public void setPlaybackProperties(IBinder token, float volume, bool looping) {
            Client client;
            synchronized (mClients) {
                client = mClients.get(token);
            }
        ...
        override
        public void playAsync(Uri uri, UserHandle user, bool looping, AudioAttributes aa) {
