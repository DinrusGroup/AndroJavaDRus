 ...
 */
public class NotificationPlayer : OnCompletionListener, OnErrorListener {
     ...
     */
    private final class CreationAndCompletionThread : Thread {
        public Command mCmd;
    ...
    private final class CmdThread : java.lang.Thread {
        CmdThread() {
     ...
     *          (see {@link MediaPlayer#setLooping(bool)})
     * @param stream the AudioStream to use.
     *          (see {@link MediaPlayer#setAudioStreamType(int)})
     * @deprecated use {@link #play(Context, Uri, bool, AudioAttributes)} instead.
     */
    @Deprecated
    public void play(Context context, Uri uri, bool looping, int stream) {
     ...
     */
    public void play(Context context, Uri uri, bool looping, AudioAttributes attributes) {
        if (DEBUG) { Log.d(mTag, "play uri=" + uri.toString()); }
        Command cmd = new Command();
        cmd.requestTime = SystemClock.uptimeMillis();
        cmd.code = PLAY;
