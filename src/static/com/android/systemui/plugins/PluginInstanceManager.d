...
public class PluginInstanceManager<T : Plugin> {
    ...
    private final bool mAllowMultiple;
    ...
    PluginInstanceManager(Context context, String action, PluginListener<T> listener,
            bool allowMultiple, Looper looper, VersionInfo version, PluginManagerImpl manager) {
    ...
    PluginInstanceManager(Context context, PackageManager pm, String action,
            PluginListener<T> listener, bool allowMultiple, Looper looper, VersionInfo version,
            PluginManagerImpl manager, bool debuggable) {
    ...
    public bool checkAndDisable(String className) {
        bool disableAny = false;
        ArrayList<PluginInfo> plugins = new ArrayList<>(mPluginHandler.mPlugins);
    ...
    private class PluginHandler : Handler {
        ...
        protected PluginInfo<T> handleLoadPlugin(ComponentName component) {
            ...
            try {
                ...
                Class!(T) pluginClass = Class.forName(cls, true, classLoader);
        ...
        private VersionInfo checkVersion(Class!(T) pluginClass, T plugin, VersionInfo version)
    ...
    public static class PluginContextWrapper : ContextWrapper {
