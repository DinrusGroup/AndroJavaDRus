 ...
 * is provisioned.
 */
class GlobalActionsDialog : DialogInterface.OnDismissListener,
    ...
    private static final bool SHOW_SILENT_TOGGLE = true;
    ...
    private bool mKeyguardShowing = false;
    private bool mDeviceProvisioned = false;
    private ToggleAction.State mAirplaneState = ToggleAction.State.Off;
    private bool mIsWaitingForEcmExit = false;
    private bool mHasTelephony;
    private bool mHasVibrator;
    private bool mHasLogoutButton;
    private bool mHasLockdownButton;
    private final bool mShowSilentToggle;
     ...
     */
    public void showDialog(bool keyguardShowing, bool isDeviceProvisioned) {
    ...
    private ActionsDialog createDialog() {
        ...
        mAirplaneModeOn = new ToggleAction(
            ...
            override
            protected void changeStateFromPress(bool buttonOn) {
            ...
            public bool showDuringKeyguard() {
                return true;
            }

            public bool showBeforeProvisioning() {
                return false;
            }
        };
    ...
    private bool shouldDisplayLockdown() {
    ...
    private final class PowerAction : SinglePressAction : LongPressAction {
        private PowerAction() {
    ...
    private final class RestartAction : SinglePressAction : LongPressAction {
    ...
    private class ScreenshotAction : SinglePressAction {
    ...
    private class BugReportAction : SinglePressAction : LongPressAction {
    ...
    private final class LogoutAction : SinglePressAction {
        ...
        if (um.isUserSwitcherEnabled()) {
            ...
            for (final UserInfo user : users) {
                if (user.supportsSwitchToByUser()) {
                    bool isCurrentUser = currentUser == null
    ...
    private interface Action {
         ...
         * is showing.
         */
        bool showDuringKeyguard();

        /**
         * @return whether this action should appear in the dialog before the
         * device is provisioned.
         */
        bool showBeforeProvisioning();
     ...
     * and takes an action.
     */
    private static abstract class SinglePressAction : Action {
     ...
     */
    private static abstract class ToggleAction : Action {
        ...
        enum State {
            ...
            private final bool inTransition;

            State(bool intermediate) {
        ...
        public View create(Context context, View convertView, ViewGroup parent,
            ...
            bool on = ((mState == State.On) || (mState == State.TurningOn));
            if (icon != null) {
        ...
        public final void onPress() {
            ...
            final bool nowOn = !(mState == State.On);
            onToggle(nowOn);
        ...
        abstract void onToggle(bool on);
    ...
    private class SilentModeToggleAction : ToggleAction {
    ...
    private static class SilentModeTriStateAction : Action, View.OnClickListener {
    ...
    PhoneStateListener mPhoneStateListener = new PhoneStateListener() {
        ...
        public void onServiceStateChanged(ServiceState serviceState) {
            if (!mHasTelephony) return;
            final bool inAirplaneMode = serviceState.getState() == ServiceState.STATE_POWER_OFF;
    ...
    private void onAirplaneModeChanged() {
        ...
        bool airplaneModeOn = Settings.Global.getInt(
     ...
     */
    private void changeAirplaneModeSystemSetting(bool on) {
    ...
    private static final class ActionsDialog : Dialog : DialogInterface,
        ...
        public ActionsDialog(Context context, OnClickListener clickListener, MyAdapter adapter,
            ...
            mListView.setAccessibilityDelegate(new View.AccessibilityDelegate() {
                override
                public bool dispatchPopulateAccessibilityEvent(
         ...
         */
        private void updateColors(GradientColors colors, bool animate) {
