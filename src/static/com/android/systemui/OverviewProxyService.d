 ...
 */
public class OverviewProxyService : CallbackController<OverviewProxyListener>, Dumpable {

    private static final String ACTION_QUICKSTEP = "android.intent.action.QUICKSTEP_SERVICE";

    public static final String TAG_OPS = "OverviewProxyService";
    public static final bool DEBUG_OVERVIEW_PROXY = false;
    ...
    private ISystemUiProxy mSysUiProxy = new ISystemUiProxy.Stub() {
        ...
        public GraphicBufferCompat screenshot(Rect sourceCrop, int width, int height, int minLayer,
                int maxLayer, bool useIdentityTransform, int rotation) {
        ...
        public void setBackButtonAlpha(float alpha, bool animate) {
            long token = Binder.clearCallingIdentity();
            try {
                mHandler.post(() -> {
    ...
    public bool shouldShowSwipeUpUI() {
    ...
    private void notifyBackButtonAlphaChanged(float alpha, bool animate) {
        for (int i = mConnectionCallbacks.size() - 1; i >= 0; --i) {
    ...
    public interface OverviewProxyListener {
        default void onConnectionChanged(bool isConnected) {}
        default void onQuickStepStarted() {}
        default void onInteractionFlagsChanged(@InteractionType int flags) {}
        default void onOverviewShown(bool fromHome) {}
        default void onQuickScrubStarted() {}
        default void onBackButtonAlphaChanged(float alpha, bool animate) {}
    }
}
