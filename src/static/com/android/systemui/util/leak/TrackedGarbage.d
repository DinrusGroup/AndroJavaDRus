...
public class TrackedGarbage {
     ...
     */
    private static class LeakReference : WeakReference<Object> {
    ...
    public synchronized void dump(PrintWriter pw) {
        ...
        ArrayMap<Class!(T), Integer> acc = new ArrayMap<>();
        ArrayMap<Class!(T), Integer> accOld = new ArrayMap<>();
        ...
        for (Map.Entry<Class!(T), Integer> entry : acc.entrySet()) {
    ...
    private bool isOld(long createdUptimeMillis, long now) {
