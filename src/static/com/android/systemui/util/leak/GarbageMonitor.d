...
public class GarbageMonitor {
    private static final bool LEAK_REPORTING_ENABLED =
            Build.IS_DEBUGGABLE
    ...
    private static final bool HEAP_TRACKING_ENABLED = Build.IS_DEBUGGABLE;
    private static final bool ENABLE_AM_HEAP_LIMIT = true; // use ActivityManager.setHeapLimit
    ...
    private bool gcAndCheckGarbage() {
    ...
    private static class MemoryIconDrawable : Drawable {
        long pss, limit;
    ...
    private static class MemoryGraphIcon : QSTile.Icon {
        long pss, limit;
    ...
    public static class MemoryTile : QSTileImpl<QSTile.State> {
    ...
    public static class Service : SystemUI {
    ...
    private class BackgroundHeapCheckHandler : Handler {
