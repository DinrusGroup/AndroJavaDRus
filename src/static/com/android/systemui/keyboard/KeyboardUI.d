...
public class KeyboardUI : SystemUI : InputManager.OnTabletModeChangedListener {
    ...
    private final class KeyboardUIHandler : Handler {
    ...
    private final class KeyboardHandler : Handler {
    ...
    private final class BluetoothDialogClickListener : DialogInterface.OnClickListener {
        override
    ...
    private final class KeyboardScanCallback : ScanCallback {

        private bool isDeviceDiscoverable(ScanResult result) {
    ...
    private final class BluetoothCallbackHandler : BluetoothCallback {
        override
    ...
    private final class BluetoothErrorListener : Utils.ErrorListener {
