 ...
 *
 * DozeMachine : a state machine that orchestrates how the UI and triggers work and
...
public class DozeMachine {
    ...
    static final bool DEBUG = DozeService.DEBUG;
    ...
    private bool mWakeLockHeldForCurrentState = false;
    ...
    private void requestState(State requestedState, int pulseReason) {
        ...
        bool runNow = !isExecutingTransition();
    ...
    private bool isExecutingTransition() {
    ...
    private void updateWakeLockState(State newState) {
        bool staysAwake = newState.staysAwake();
