 ...
 */
public class DozeScreenState : DozeMachine.Part {
    ...
    public void transitionTo(DozeMachine.State oldState, DozeMachine.State newState) {
        ...
        bool messagePending = mHandler.hasCallbacks(mApplyPendingScreenState);
        bool pulseEnding = oldState  == DozeMachine.State.DOZE_PULSE_DONE
        ...
        if (messagePending || oldState == DozeMachine.State.INITIALIZED || pulseEnding) {
            ...
            bool shouldDelayTransition = newState == DozeMachine.State.DOZE_AOD
