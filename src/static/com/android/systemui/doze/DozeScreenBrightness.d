 ...
 */
public class DozeScreenBrightness : DozeMachine.Part, SensorEventListener {
    ...
    private void updateBrightnessAndReady() {
        if (mRegistered) {
            ...
            bool brightnessReady = brightness > 0;
            if (brightnessReady) {
    ...
    private void setLightSensorEnabled(bool enabled) {
