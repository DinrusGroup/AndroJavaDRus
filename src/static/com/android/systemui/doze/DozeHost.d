...
public interface DozeHost {
    ...
    void stopDozing();
    void dozeTimeTick();
    bool isPowerSaveActive();
    bool isPulsingBlocked();
    bool isProvisioned();
    bool isBlockingDoze();
    ...
    void setAnimateWakeup(bool animateWakeup);
    void setAnimateScreenOff(bool animateScreenOff);
    ...
    void onIgnoreTouchWhilePulsing(bool ignore);

    interface Callback {
        default void onNotificationHeadsUp() {}
        default void onPowerSaveChanged(bool active) {}
    }
