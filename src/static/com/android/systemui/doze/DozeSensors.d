...
public class DozeSensors {
    ...
    public void setTouchscreenSensorsListening(bool listening) {
    ...
    public void setProxListening(bool listen) {
    ...
    public void setDisableSensorsInterferingWithProximity(bool disable) {
    ...
    private class ProxSensor : SensorEventListener {
        ...
        private void setRegistered(bool register) {
    ...
    private class TriggerSensor : TriggerEventListener {
        final Sensor mSensor;
        final bool mConfigured;
        final int mPulseReason;
        final String mSetting;
        final bool mReportsTouchCoordinates;
        final bool mSettingDefault;
        final bool mRequiresTouchscreen;

        private bool mRequested;
        private bool mRegistered;
        private bool mDisabled;

        public TriggerSensor(Sensor sensor, String setting, bool configured, int pulseReason,
                bool reportsTouchCoordinates, bool requiresTouchscreen) {
            this(sensor, setting, true /* settingDef */, configured, pulseReason,
                    reportsTouchCoordinates, requiresTouchscreen);
        }

        public TriggerSensor(Sensor sensor, String setting, bool settingDef,
                bool configured, int pulseReason, bool reportsTouchCoordinates,
        ...
        public void updateListener() {
            ...
            if (mRequested && !mDisabled && enabledBySetting() && !mRegistered) {
                ...
                final bool rt = mSensorManager.cancelTriggerSensor(this, mSensor);
                if (DEBUG) Log.d(TAG, "cancelTriggerSensor " + rt);
                mRegistered = false;
            }
        }

        private bool enabledBySetting() {
        ...
        public void onTrigger(TriggerEvent event) {
            ...
            mHandler.post(mWakeLock.wrap(() -> {
                ...
                bool sensorPerformsProxCheck = false;
    ...
    public interface Callback {
         ...
         *                if the sensor doesn't support reporting screen locations.
         */
        void onSensorPulse(int pulseReason, bool sensorPerformedProxCheck,
