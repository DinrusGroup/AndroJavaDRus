 ...
 */
public class WapPushManager : Service {
    ...
    private static final bool DEBUG_SQL = false;
    private static final bool LOCAL_LOGV = false;

    /**
     * Inner class that deals with application ID table
     */
    private class WapPushManDBHelper : SQLiteOpenHelper {
     ...
     */
    private class IWapPushManagerStub : IWapPushManager.Stub {
         ...
         */
        protected bool signatureCheck(String package_name) {
        ...
        protected bool appTypeCheck(int app_type) {
         ...
         */
        public bool addPackage(String x_app_id, String content_type,
                String package_name, String class_name,
                int app_type, bool need_signature, bool further_processing) {
            WapPushManDBHelper dbh = getDatabase(mContext);
         ...
         */
        public bool updatePackage(String x_app_id, String content_type,
                String package_name, String class_name,
                int app_type, bool need_signature, bool further_processing) {
         ...
         */
        public bool deletePackage(String x_app_id, String content_type,
                String package_name, String class_name) {
            WapPushManDBHelper dbh = getDatabase(mContext);
            SQLiteDatabase db = dbh.getWritableDatabase();
            String where = "x_wap_application=\'" + x_app_id + "\'"
     ...
     */
    public bool verifyData(String x_app_id, String content_type,
            String package_name, String class_name,
            int app_type, bool need_signature, bool further_processing) {
     ...
     * This method is used for testing
     */
    public bool isDataExist(String x_app_id, String content_type,
            String package_name, String class_name) {
        WapPushManDBHelper dbh = getDatabase(this);
        SQLiteDatabase db = dbh.getReadableDatabase();
        bool ret = dbh.queryLastApp(db, x_app_id, content_type) != null;
