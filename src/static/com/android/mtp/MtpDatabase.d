...
class MtpDatabase {
     ...
     */
    bool deleteDocumentsAndRootsRecursively(String selection, String[] args) {
        mDatabase.beginTransaction();
        try {
            bool changed = false;
            final Cursor cursor = mDatabase.query(
     ...
     */
    bool disconnectDocumentsRecursively(String selection, String[] args) {
        mDatabase.beginTransaction();
        try {
            bool changed = false;
            try (final Cursor cursor = mDatabase.query(
    ...
    bool deleteDocumentsAndRoots(String selection, String[] args) {
        mDatabase.beginTransaction();
        try {
            int deleted = 0;
    ...
    bool disconnectDocuments(String selection, String[] args) {
        mDatabase.beginTransaction();
        try {
            final ContentValues values = new ContentValues();
            ...
            final bool updated = mDatabase.update(TABLE_DOCUMENTS, values, selection, args) != 0;
            mDatabase.setTransactionSuccessful();
            return updated;
        } finally {
            mDatabase.endTransaction();
    ...
    private static class OpenHelper : SQLiteOpenHelper {
