...
class Mapper {
     ...
     */
    synchronized bool putDeviceDocument(MtpDeviceRecord device) throws FileNotFoundException {
        ...
        try {
            ...
            final bool changed = putDocuments(
                    null,
                    valuesList,
                    extraValuesList,
     ...
     * @throws FileNotFoundException
     */
    synchronized bool putStorageDocuments(
     ...
     * @throws FileNotFoundException
     */
    bool stopAddingDocuments(@Nullable String parentId) throws FileNotFoundException {
        final String selection;
        final String[] args;
        if (parentId != null) {
            selection = COLUMN_PARENT_DOCUMENT_ID + " = ?";
        ...
        try {
            ...
            final bool keepUnmatchedDocument =
