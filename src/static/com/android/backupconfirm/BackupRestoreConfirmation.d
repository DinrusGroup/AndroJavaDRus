 ...
 * @hide
 */
public class BackupRestoreConfirmation : Activity {
    ...
    public void onCreate(Bundle icicle) {
        ...
        bool tokenValid = setTokenOrFinish(intent, icicle);
    ...
    public void onNewIntent(Intent intent) {
        ...
        bool tokenValid = setTokenOrFinish(intent, null);
        if (!tokenValid) { // already called finish()
            return;
        }
    ...
    private bool setTokenOrFinish(Intent intent, Bundle icicle) {
    ...
    void sendAcknowledgement(int token, bool allow, IFullBackupRestoreObserver observer) {
        if (!mDidAcknowledge) {
     ...
     */
    class FullObserver : IFullBackupRestoreObserver.Stub {
