...
//      noman.notify(1, cat.buildNotification(NekoLand.this).build());
    ...
    private class CatAdapter : RecyclerView.Adapter<CatHolder> {
        ...
        private void setContextGroupVisible(final CatHolder holder, bool vis) {
    ...
    private static class CatHolder : RecyclerView.ViewHolder {
