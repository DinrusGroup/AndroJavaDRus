...
public class OctopusDrawable : Drawable {
    private static float BASE_SCALE = 100f;
    public static bool PATH_DEBUG = false;
    ...
    private void drawPupil(Canvas canvas, float x, float y, float size, bool open,
            Paint pt) {
