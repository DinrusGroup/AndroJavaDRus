...
public class Content {
    ...
    private static final String USAGE =
            "usage: adb shell content [subcommand] [options]\n"
                    ...
                    + "  b - bool, s - string, i - integer, l - long, f - float, d - double\n"
    ...
    private static class InsertCommand : Command {
    ...
    private static class DeleteCommand : Command {
        final String mWhere;
    ...
    private static class CallCommand : Command {
    ...
    private static class GetTypeCommand : Command {
    ...
    private static class ReadCommand : Command {
    ...
    private static class WriteCommand : Command {
    ...
    private static class QueryCommand : DeleteCommand {
    ...
    private static class UpdateCommand : InsertCommand {
        final String mWhere;
