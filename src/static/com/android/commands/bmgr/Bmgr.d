...
public final class Bmgr {
    ...
    private String enableToString(bool enabled) {
        return enabled ? "enabled" : "disabled";
    }

    private void doEnabled() {
        try {
            bool isEnabled = mBmgr.isBackupEnabled();
    ...
    private void doEnable() {
        ...
        try {
            bool enable = Boolean.parseBoolean(arg);
    ...
    abstract class Observer : IBackupObserver.Stub {
    ...
    private void backupNowAllPackages(bool nonIncrementalBackup) {
    ...
    private void backupNowPackages(List<String> packages, bool nonIncrementalBackup) {
        int flags = 0;
    ...
    private void doBackupNow() {
        ...
        bool nonIncrementalBackup = false;
    ...
    class RestoreObserver : IRestoreObserver.Stub {
        bool done;
