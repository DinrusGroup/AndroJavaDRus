...
public final class Telecom : BaseCommand {
    ...
    private void runSetPhoneAccountEnabled(bool enabled) throws RemoteException {
        final PhoneAccountHandle handle = getPhoneAccountHandleFromArgs();
        final bool success =  mTelecomService.enablePhoneAccount(handle, enabled);
        if (success) {
    ...
    private void runSetDefaultDialer() throws RemoteException {
        ...
        final bool success = mTelecomService.setDefaultDialer(packageName);
        if (success) {
