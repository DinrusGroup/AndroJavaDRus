...
public class Instrument {
    ...
    bool protoStd = false;  // write proto to stdout
    bool protoFile = false;  // write proto to a file
    String logPath = null;
    public bool noWindowAnimation = false;
    public bool disableHiddenApiChecks = false;
    ...
    private interface StatusReporter {
         ...
         *      to a test failing.
         */
        public void onError(String errorText, bool commandError);
    }
     ...
     */
    private class TextStatusReporter : StatusReporter {
        private bool mRawMode;
         ...
         */
        public TextStatusReporter(bool rawMode) {
            mRawMode = rawMode;
        }
     ...
     */
    private class ProtoStatusReporter : StatusReporter {
        ...
        private void writeBundle(ProtoOutputStream proto, long fieldId, Bundle bundle) {
            ...
            for (final String key: sorted(bundle.keySet())) {
                ...
                if (val instanceof String) {
                    ...
                    proto.write(InstrumentationData.ResultsBundleEntry.VALUE_INT, cast(short)val);
     ...
     */
    private class InstrumentationWatcher : IInstrumentationWatcher.Stub {
