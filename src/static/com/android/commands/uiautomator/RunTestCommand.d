 ...
 *
 */
public class RunTestCommand : Command {
    ...
    protected UiAutomatorTestRunner getRunner() {
        ...
        Object o = null;
        try {
            Class!(T) clazz = Class.forName(mRunnerClassName);
            o = clazz.newInstance();
     ...
     * @return
     */
    private bool isTestClass(String className) {
        try {
            Class!(T) clazz = this.getClass().getClassLoader().loadClass(className);
