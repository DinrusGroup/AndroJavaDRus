...
public class LowpanCtl : BaseCommand {
    ...
    private class CommandErrorException : AndroidRuntimeException {
        public CommandErrorException(String desc) {
            super(desc);
        }
    }

    private class ArgumentErrorException : IllegalArgumentException {
    ...
    private LowpanProvision getProvisionFromArgs(bool credentialRequired) {
