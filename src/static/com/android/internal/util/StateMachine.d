...
class HelloWorld : StateMachine {
    ...
    class State1 : State {
        &#64;Override public bool processMessage(Message message) {
            log("Hello World");
            return HANDLED;
        }
    }
...
public class StateMachine {
     ...
     */
    public static final bool HANDLED = true;
     ...
     * processed by parent states
     */
    public static final bool NOT_HANDLED = false;
    ...
    private static class LogRecords {
        ...
        private bool mLogOnlyTransitions = false;
        ...
        */
        ...
        synchronized void setLogOnlyTransitions(bool enable) {
            mLogOnlyTransitions = enable;
        }

        synchronized bool logOnlyTransitions() {
    ...
    private static class SmHandler : Handler {

        /** true if StateMachine has quit */
        private bool mHasQuit = false;
        ...
        private bool mIsConstructionCompleted;
         ...
         */
        private bool mTransitionInProgress = false;
        ...
        private void performTransitions(State msgProcessedState, Message msg) {
             ...
             */
            bool recordLogMsg = mSm.recordLogRec(mMsg) && (msg.obj != mSmHandlerObj);
        ...
        private void removeState(State state) {
            ...
            bool isParent = mStateInfo.values().stream()
        ...
        private final bool isQuit(Message msg) {
            return (msg.what == SM_QUIT_CMD) && (msg.obj == mSmHandlerObj);
        }

        /** @see StateMachine#isDbg() */
        private final bool isDbg() {
            return mDbg;
        }

        /** @see StateMachine#setDbg(bool) */
        private final void setDbg(bool dbg) {
            mDbg = dbg;
        }
     ...
     */
    public final void setLogOnlyTransitions(bool enable) {
     ...
     */
    protected final bool hasDeferredMessages(int what) {
        SmHandler smh = mSmHandler;
     ...
     */
    protected final bool hasMessages(int what) {
        SmHandler smh = mSmHandler;
        if (smh == null) return false;
     ...
     * */
    protected final bool isQuit(Message msg) {
        // mSmHandler can be null if the state machine has quit.
        SmHandler smh = mSmHandler;
