 ...
 */
public class TypedProperties : HashMap<String, Object> {
    /**
     ...
     */
    public static class ParseException : IllegalArgumentException {
    ...
    static Object parseValue(StreamTokenizer st, final int type) throws IOException {
        ...
        if (type == TYPE_BOOLEAN) {
            if (token != StreamTokenizer.TT_WORD) {
                throw new ParseException(st, "bool constant");
            }
            ...
            case 1:
                ...
                return new Byte(cast(byte)value);
            case 2:
                if (value < Short.MIN_VALUE || value > Short.MAX_VALUE) {
                    throw new ParseException(st, "16-bit integer constant");
                }
                return new Short(cast(short)value);
            case 4:
     ...
     *     the property name.
     *     <p>
     *     &lt;type&gt; is one of {bool, byte, short, int, long,
     ...
     *     <ul>
     *     <li> bool: one of {true, false} (case-sensitive)
     ...
     */
    public static class TypeException : IllegalArgumentException {
    ...
    /**
     * Returns the value of a bool property, or the default if the property
     * has not been defined.
     *
     * @param property The name of the property to return
     * @param def The default value to return if the property is not set
     * @return the value of the property
     * @throws TypeException if the property is set and is not a bool
     */
    public bool getBoolean(String property, bool def) {
        ...
        throw new TypeException(property, value, "bool");
    }
    ...
    /**
     * Returns the value of a bool property, or false
    ...
    public byte getByte(String property) {
        return getByte(property, cast(byte)0);
    }
    ...
    public short getShort(String property) {
        return getShort(property, cast(short)0);
    }
