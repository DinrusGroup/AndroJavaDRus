...
public class FastXmlSerializer : XmlSerializer {
    ...
    private bool mIndent = false;
    private bool mInTag;

    private int mNesting = 0;
    private bool mLineStart = true;
    ...
    public String getPrefix(String namespace, bool generatePrefix)
    ...
    public void setFeature(String name, bool state) throws IllegalArgumentException,
            IllegalStateException {
