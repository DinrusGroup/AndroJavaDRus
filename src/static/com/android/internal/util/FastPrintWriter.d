...
public class FastPrintWriter : PrintWriter {
    private static class DummyWriter : Writer {
        override
     ...
     *             if {@code out} is {@code null}.
     */
    public FastPrintWriter(OutputStream out, bool autoFlush) {
     ...
     *             if {@code out} is {@code null}.
     */
    public FastPrintWriter(OutputStream out, bool autoFlush, int bufferLen) {
     ...
     *             if {@code out} is {@code null}.
     */
    public FastPrintWriter(Writer wr, bool autoFlush) {
     ...
     *             if {@code wr} is {@code null}.
     */
    public FastPrintWriter(Writer wr, bool autoFlush, int bufferLen) {
        super(new DummyWriter(), autoFlush);
        if (wr == null) {
