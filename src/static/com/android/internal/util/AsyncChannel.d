...
public class AsyncChannel {
    ...
    public int connectSrcHandlerToPackageSync(
        ...
        bool result = srcContext.bindService(intent, mConnection, Context.BIND_AUTO_CREATE);
    ...
    public void connect(Context srcContext, Handler srcHandler, String dstPackageName,
        ...
        final class ConnectAsync : Runnable {
            Context mSrcCtx;
            Handler mSrcHdlr;
     ...
     */
    public void connect(Context srcContext, Handler srcHandler, Class!(T) klass) {
    ...
    private static class SyncMessenger {
        ...
        private class SyncHandler : Handler {
     ...
     */
    private bool linkToDeathMonitor() {
     ...
     */
    class AsyncChannelConnection : ServiceConnection {
