...
public class CollectionUtils {
     ...
     */
    public static int size(@Nullable Collection!(T) cur) {
     ...
     */
    public static bool isEmpty(@Nullable Collection!(T) cur) {
        return size(cur) == 0;
    }
     ...
     */
    public static @NonNull <T> List<T> filter(@Nullable List!(T) list, Class<T> c) {
     ...
     */
    public static <T> bool any(@Nullable List<T> items,
