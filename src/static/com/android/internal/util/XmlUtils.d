...
public class XmlUtils {
    ...
    convertValueToBoolean(CharSequence value, bool defaultValue)
    {
        bool result = false;
    ...
    /**
     * Flatten a bool[] into an XmlSerializer.  The list can later be read back
     * with readThisBooleanArrayXml().
     *
     * @param val The bool array to be flattened.
     * @param name Name attribute to include with this array's tag, or null for
     *             none.
     * @param out XmlSerializer to write the array into.
     *
     ...
     * @see #readThisIntArrayXml
     */
    public static final void writeBooleanArrayXml(bool[] val, String name, XmlSerializer out)
            throws XmlPullParserException, java.io.IOException {
    ...
    private static final void writeValueXml(Object v, String name, XmlSerializer out,
        ...
        if (v == null) {
            ...
            writeBooleanArrayXml((bool[])v, name, out);
            return;
    ...
    private static final ArrayList readThisListXml(XmlPullParser parser, String endTag,
            String[] name, ReadMapCallback callback, bool arrayMap)
            throws XmlPullParserException, java.io.IOException {
    ...
    private static final HashSet readThisSetXml(XmlPullParser parser, String endTag, String[] name,
            ReadMapCallback callback, bool arrayMap)
            throws XmlPullParserException, java.io.IOException {
                ...
                if (num > 0) {
                    ...
                    for (int i = 0; i < num; i ++) {
                        ...
                        int nibbleLow = nibbleLowChar > 'a' ? (nibbleLowChar - 'a' + 10)
                                : (nibbleLowChar - '0');
                        array[i] = cast(byte) ((nibbleHigh & 0x0F) << 4 | (nibbleLow & 0x0F));
                    }
                }
            } else if (eventType == parser.END_TAG) {
                if (parser.getName().equals(endTag)) {
    ...
    /**
     * Read a bool[] object from an XmlPullParser.  The XML data could
     ...
     *             of the list's tag.
     *
     * @return Returns a newly generated bool[].
     *
     * @see #readListXml
     */
    public static final bool[] readThisBooleanArrayXml(XmlPullParser parser, String endTag,
            String[] name) throws XmlPullParserException, java.io.IOException {
    ...
    private static final Object readThisValueXml(XmlPullParser parser, String[] name,
        ...
        if (tagName.equals("null")) {
            ...
            //System.out.println("Returning value for " + valueName + ": " + res);
            return res;
        } else if (tagName.equals("bool-array")) {
            res = readThisBooleanArrayXml(parser, "bool-array", name);
            name[0] = valueName;
            //System.out.println("Returning value for " + valueName + ": " + res);
            return res;
    ...
    public static bool nextElementWithin(XmlPullParser parser, int outerDepth)
    ...
    public static bool readBooleanAttribute(XmlPullParser in, String name) {
        final String value = in.getAttributeValue(null, name);
    ...
    public static void writeBooleanAttribute(XmlSerializer out, String name, bool value)
            throws IOException {
