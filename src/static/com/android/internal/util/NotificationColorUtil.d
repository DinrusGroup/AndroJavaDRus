...
public class NotificationColorUtil {
     ...
     */
    public bool isGrayscaleIcon(Bitmap bitmap) {
     ...
     * @return True if the bitmap is grayscale; false if it is color or too large to examine.
     */
    public bool isGrayscaleIcon(Drawable d) {
        if (d == null) {
            return false;
    ...
    public bool isGrayscaleIcon(Context context, Icon icon) {
        if (icon == null) {
            return false;
        }
        switch (icon.getType()) {
     ...
     * @return True if the bitmap is grayscale; false if it is color or too large to examine.
     */
    public bool isGrayscaleIcon(Context context, int drawableResId) {
        if (drawableResId != 0) {
            try {
     ...
     *          contrast ratio.
     */
    public static int findContrastColor(int color, int other, bool findFg, double minRatio) {
     ...
     *          contrast ratio.
     */
    public static int findContrastColorAgainstDark(int color, int other, bool findFg,
            double minRatio) {
        int fg = findFg ? color : other;
        int bg = findFg ? other : color;
        if (ColorUtilsFromCompat.calculateContrast(fg, bg) >= minRatio) {
     ...
     */
    public static int ensureLargeTextContrast(int color, int bg, bool isBgDarker) {
        return isBgDarker
     ...
     * @param isBgDarker {@code true} if {@code bg} is darker than {@code color}.
     */
    public static int ensureTextContrast(int color, int bg, bool isBgDarker) {
     ...
     * @param minRatio the minimum contrast ratio required
     */
    public static int ensureContrast(int color, int bg, bool isBgDarker, double minRatio) {
        return isBgDarker
     ...
     *
     * @see {@link #resolveContrastColor(Context, int, bool)}
     */
     ...
     */
    public static int resolveContrastColor(Context context, int notificationColor,
            int backgroundColor, bool isDark) {
    ...
    public static int resolvePrimaryColor(Context context, int backgroundColor) {
        bool useDark = shouldUseDark(backgroundColor);
        if (useDark) {
    ...
    private static bool shouldUseDark(int backgroundColor) {
        bool useDark = backgroundColor == Notification.COLOR_DEFAULT;
        if (!useDark) {
    ...
    public static bool satisfiesTextContrast(int backgroundColor, int foregroundColor) {
    ...
    public static bool isColorLight(int backgroundColor) {
