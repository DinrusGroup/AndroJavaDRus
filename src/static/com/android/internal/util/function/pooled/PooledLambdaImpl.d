 ...
 * @hide
 */
final class PooledLambdaImpl<R> : OmniFunction<Object,
    ...
    static class Pool : Pools.SynchronizedPool<PooledLambdaImpl> {
    ...
    R invoke(Object a1, Object a2, Object a3, Object a4, Object a5, Object a6) {
        ...
        final bool notUsed = fillInArg(a1) && fillInArg(a2) && fillInArg(a3)
    ...
    private bool fillInArg(Object invocationArg) {
        int argsSize = ArrayUtils.size(mArgs);
        for (int i = 0; i < argsSize; i++) {
            if (mArgs[i] == ArgumentPlaceholder.INSTANCE) {
     ...
     */
    static <E : PooledLambda> E acquire(Pool pool, Object func,
    ...
    private bool isRecycleOnUse() {
        return (mFlags & FLAG_RECYCLE_ON_USE) != 0;
    }

    private bool isInvocationArgAtIndex(int argIndex) {
