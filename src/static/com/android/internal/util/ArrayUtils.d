...
public class ArrayUtils {
    ...
    public static bool[] newUnpaddedBooleanArray(int minLen) {
        return (bool[])VMRuntime.getRuntime().newUnpaddedArray(bool.class, minLen);
    }
     ...
     */
    public static bool isEmpty(@Nullable Collection!(T) array) {
     ...
     */
    public static bool isEmpty(@Nullable Map<?, ?> map) {
     ...
     * Checks if given array is null or has zero elements.
     */
    public static <T> bool isEmpty(@Nullable T[] array) {
     ...
     * Checks if given array is null or has zero elements.
     */
    public static bool isEmpty(@Nullable int[] array) {
        return array == null || array.length == 0;
    }
     ...
     * Checks if given array is null or has zero elements.
     */
    public static bool isEmpty(@Nullable long[] array) {
        return array == null || array.length == 0;
    }
     ...
     * Checks if given array is null or has zero elements.
     */
    public static bool isEmpty(@Nullable byte[] array) {
        return array == null || array.length == 0;
    }
     ...
     * Checks if given array is null or has zero elements.
     */
    public static bool isEmpty(@Nullable bool[] array) {
        return array == null || array.length == 0;
    }
     ...
     */
    public static int size(@Nullable Collection!(T) collection) {
     ...
     */
    public static <T> bool contains(@Nullable T[] array, T value) {
     ...
     */
    public static <T> bool containsAll(@Nullable T[] array, T[] check) {
     ...
     */
    public static <T> bool containsAny(@Nullable T[] array, T[] check) {
    ...
    public static bool contains(@Nullable int[] array, int value) {
    ...
    public static bool contains(@Nullable long[] array, long value) {
        if (array == null) return false;
    ...
    public static bool contains(@Nullable char[] array, char value) {
        if (array == null) return false;
     ...
     * Test if all {@code check} items are contained in {@code array}.
     */
    public static <T> bool containsAll(@Nullable char[] array, char[] check) {
        if (check == null) return true;
    ...
    public static <T> bool contains(@Nullable Collection<T> cur, T val) {
     ...
     */
    public static <T> bool referenceEquals(ArrayList<T> a, ArrayList<T> b) {
        if (a == b) {
            return true;
        }
