...
public final class BitUtils {
    ...
    public static bool maskedEquals(long a, long b, long mask) {
        return (a & mask) == (b & mask);
    }

    public static bool maskedEquals(byte a, byte b, byte mask) {
        return (a & mask) == (b & mask);
    }

    public static bool maskedEquals(byte[] a, byte[] b, @Nullable byte[] mask) {
    ...
    public static bool maskedEquals(UUID a, UUID b, @Nullable UUID mask) {
        if (mask == null) {
    ...
    public static bool isBitSet(long flags, int bitIndex) {
