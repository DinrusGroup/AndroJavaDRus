...
public class NotificationMessagingUtil {
    ...
    public bool isImportantMessaging(StatusBarNotification sbn, int importance) {
    ...
    public bool isMessaging(StatusBarNotification sbn) {
        return hasMessagingStyle(sbn) || isDefaultMessagingApp(sbn) || isCategoryMessage(sbn);
    }

    @SuppressWarnings("deprecation")
    private bool isDefaultMessagingApp(StatusBarNotification sbn) {
    ...
    private bool hasMessagingStyle(StatusBarNotification sbn) {
        Class<? : Notification.Style> style = sbn.getNotification().getNotificationStyle();
        return Notification.MessagingStyle.class.equals(style);
    }

    private bool isCategoryMessage(StatusBarNotification sbn) {
