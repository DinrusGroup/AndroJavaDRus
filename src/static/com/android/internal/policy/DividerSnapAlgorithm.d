...
public class DividerSnapAlgorithm {
    ...
    private bool mIsHorizontalDivision;
    ...
    public DividerSnapAlgorithm(Resources res, int displayWidth, int displayHeight, int dividerSize,
            bool isHorizontalDivision, Rect insets) {
        this(res, displayWidth, displayHeight, dividerSize, isHorizontalDivision, insets,
                DOCKED_INVALID, false);
    }

    public DividerSnapAlgorithm(Resources res, int displayWidth, int displayHeight, int dividerSize,
        bool isHorizontalDivision, Rect insets, int dockSide) {
        this(res, displayWidth, displayHeight, dividerSize, isHorizontalDivision, insets,
            dockSide, false);
    }

    public DividerSnapAlgorithm(Resources res, int displayWidth, int displayHeight, int dividerSize,
            bool isHorizontalDivision, Rect insets, int dockSide, bool isMinimizedMode) {
     ...
     */
    public bool isSplitScreenFeasible() {
     ...
     */
    public SnapTarget calculateSnapTarget(int position, float velocity, bool hardDismiss) {
    ...
    private SnapTarget snap(int position, bool hardDismiss) {
        int minIndex = -1;
    ...
    private void calculateTargets(bool isHorizontalDivision, int dockedSide) {
        mTargets.clear();
    ...
    private void addNonDismissingTargets(bool isHorizontalDivision, int topPosition,
    ...
    private void addFixedDivisionTargets(bool isHorizontalDivision, int dividerMax) {
    ...
    private void addRatio16_9Targets(bool isHorizontalDivision, int dividerMax) {
        int start = isHorizontalDivision ? mInsets.top : mInsets.left;
        int end = isHorizontalDivision
                ? mDisplayHeight - mInsets.bottom
                : mDisplayWidth - mInsets.right;
    ...
    private void addMiddleTarget(bool isHorizontalDivision) {
        int position = DockedDividerUtils.calculateMiddlePosition(isHorizontalDivision,
                mInsets, mDisplayWidth, mDisplayHeight, mDividerSize);
        mTargets.add(new SnapTarget(position, position, SnapTarget.FLAG_NONE));
    }

    private void addMinimizedTarget(bool isHorizontalDivision, int dockedSide) {
     ...
     */
    public bool showMiddleSplitTargetForAccessibility() {
        return (mTargets.size() - 2) > 1;
    }

    public bool isFirstSplitTargetAvailable() {
        return mFirstSplitTarget != mMiddleTarget;
    }

    public bool isLastSplitTargetAvailable() {
