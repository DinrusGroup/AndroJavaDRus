 ...
 * @hide
 */
public class PhoneWindow : Window : MenuBuilder.Callback {
    ...
    private bool mForceDecorInstall = false;
    ...
    private bool mContentParentExplicitlySet = false;
    ...
    private bool mSupportsPictureInPicture;
    ...
    private bool mForcedStatusBarColor = false;
    private bool mForcedNavigationBarColor = false;

    private CharSequence mTitle = null;

    private int mTitleColor = 0;

    private bool mAlwaysReadCloseOnTouchAttr = false;
    ...
    private bool mInvalidatePanelMenuPosted;
    ...
    private bool mIsStartingWindow;
    private int mTheme = -1;

    private int mDecorCaptionShade = DECOR_CAPTION_SHADE_AUTO;

    private bool mUseDecorContext = false;
    ...
    public PhoneWindow(Context context, Window preservedWindow,
        ...
        bool forceResizable = Settings.Global.getInt(context.getContentResolver(),
    ...
    public void setTitle(CharSequence title, bool updateAccessibilityTitle) {
        if (mTitleView != null) {
     ...
     *         returns false.
     */
    public final bool preparePanel(PanelFeatureState st, KeyEvent event) {
        if (isDestroyed()) {
            return false;
        }
    ...
    private void openPanel(final PanelFeatureState st, KeyEvent event) {
        ...
        if (st.featureId == FEATURE_OPTIONS_PANEL) {
            ...
            bool isXLarge = (config.screenLayout & Configuration.SCREENLAYOUT_SIZE_MASK) ==
                    Configuration.SCREENLAYOUT_SIZE_XLARGE;
            bool isHoneycombApp = context.getApplicationInfo().targetSdkVersion >=
     ...
     */
    public final void closePanel(PanelFeatureState st, bool doCallback) {
     ...
     */
    public final bool onKeyDownPanel(int featureId, KeyEvent event) {
    ...
    override
    public bool performPanelShortcut(int featureId, int keyCode, KeyEvent event, int flags) {
        return performPanelShortcut(getPanelState(featureId, false), keyCode, event, flags);
    }

    bool performPanelShortcut(PanelFeatureState st, int keyCode, KeyEvent event,
            int flags) {
    ...
    override
    public bool performPanelIdentifierAction(int featureId, int id, int flags) {
        ...
        bool res = st.menu.performIdentifierAction(id, flags);
    ...
    private void reopenMenu(bool toggleMenuMode) {
        ...
        bool newExpandedMode = toggleMenuMode ? !st.isInExpandedMode : st.isInExpandedMode;
     ...
     */
    protected bool initializePanelMenu(final PanelFeatureState st) {
        Context context = getContext();
     ...
     */
    protected bool initializePanelDecor(PanelFeatureState st) {
     ...
     * @return Whether the initialization was successful.
     */
    protected bool initializePanelContent(PanelFeatureState st) {
        if (st.createdPanelView != null) {
    ...
    override
    public bool performContextMenuIdentifierAction(int id, int flags) {
    ...
    override
    public final void setClipToOutline(bool clipToOutline) {
     ...
     */
    protected final void updateDrawable(int featureId, bool fromActive) {
    ...
    override
    public void setLocalFocus(bool hasFocus, bool inTouchMode) {
    ...
    override
    public bool superDispatchKeyEvent(KeyEvent event) {
        return mDecor.superDispatchKeyEvent(event);
    }

    override
    public bool superDispatchKeyShortcutEvent(KeyEvent event) {
        return mDecor.superDispatchKeyShortcutEvent(event);
    }

    override
    public bool superDispatchTouchEvent(MotionEvent event) {
        return mDecor.superDispatchTouchEvent(event);
    }

    override
    public bool superDispatchTrackballEvent(MotionEvent event) {
        return mDecor.superDispatchTrackballEvent(event);
    }

    override
    public bool superDispatchGenericMotionEvent(MotionEvent event) {
     ...
     */
    protected bool onKeyDown(int featureId, int keyCode, KeyEvent event) {
        /* ****************************************************************************
     ...
     * @see android.view.KeyEvent
     */
    protected bool onKeyUp(int featureId, int keyCode, KeyEvent event) {
        final KeyEvent.DispatcherState dispatcher =
                mDecor != null ? mDecor.getKeyDispatcherState() : null;
        if (dispatcher != null) {
    ...
    private bool isNotInstantAppAndKeyguardRestricted() {
    ...
    protected ViewGroup generateLayout(DecorView decor) {
        ...
        final bool targetPreHoneycomb = targetSdk < android.os.Build.VERSION_CODES.HONEYCOMB;
        final bool targetPreIcs = targetSdk < android.os.Build.VERSION_CODES.ICE_CREAM_SANDWICH;
        final bool targetPreL = targetSdk < android.os.Build.VERSION_CODES.LOLLIPOP;
        final bool targetHcNeedsOptions = context.getResources().getBoolean(
                R.bool.target_honeycomb_needs_options_menu);
        final bool noActionBar = !hasFeature(FEATURE_ACTION_BAR) || hasFeature(FEATURE_NO_TITLE);
    ...
    private DrawableFeatureState getDrawableState(int featureId, bool required) {
     ...
     */
    PanelFeatureState getPanelState(int featureId, bool required) {
     ...
     * @return The panel state.
     */
    private PanelFeatureState getPanelState(int featureId, bool required,
    ...
    private void updateDrawable(int featureId, DrawableFeatureState st, bool fromResume) {
    ...
    private void updateInt(int featureId, int value, bool fromResume) {
    ...
    private ProgressBar getCircularProgressBar(bool shouldInstallDecor) {
    ...
    private ProgressBar getHorizontalProgressBar(bool shouldInstallDecor) {
    ...
    /** @hide */
    override
    public void setCloseOnSwipeEnabled(bool closeOnSwipeEnabled) {
    ...
    private bool isTvUserSetupComplete() {
        bool isTvSetupComplete = Settings.Secure.getInt(getContext().getContentResolver(),
     ...
     */
    private bool launchDefaultSearch(KeyEvent event) {
    ...
    override
    public void setAllowEnterTransitionOverlap(bool allow) {
    ...
    override
    public void setAllowReturnTransitionOverlap(bool allowExitTransitionOverlap) {
    ...
    override
    public void setSharedElementsUseOverlay(bool sharedElementsUseOverlay) {
    ...
    static final class PanelFeatureState {
         ...
         * mode
         */
        bool isInExpandedMode;

        public bool qwertyMode;

        bool refreshDecorView;

        bool refreshMenuContent;

        bool wasLastOpen;

        bool wasLastExpanded;
        ...
        private static class SavedState : Parcelable {
            int featureId;
            bool isOpen;
            bool isInExpandedMode;
            Bundle menuState;
    ...
    static class RotationWatcher : Stub {
    ...
    public static final class PhoneWindowMenuCallback
        ...
        private bool mShowDialogForSubmenu;
        ...
        public void setShowDialogForSubmenu(bool enabled) {
    ...
    public void setIsStartingWindow(bool isStartingWindow) {
