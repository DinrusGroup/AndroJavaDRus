 ...
 * @hide
 */
public class BackdropFrameRenderer : Thread : Choreographer.FrameCallback {
    ...
    public BackdropFrameRenderer(DecorView decorView, ThreadedRenderer renderer, Rect initialBounds,
            ...
            bool fullscreen, Rect systemInsets, Rect stableInsets, int resizeMode) {
        setName("ResizeFrame");
     ...
     */
    public void setTargetRect(Rect newTargetBounds, bool fullscreen, Rect systemInsets,
            Rect stableInsets) {
        synchronized (this) {
            mFullscreen = fullscreen;
     ...
     */
    public bool onContentDrawn(int xOffset, int yOffset, int xSize, int ySize) {
        synchronized (this) {
            final bool firstCall = mLastContentWidth == 0;
     ...
     * @param stableInsets The stable insets for the window.
     */
    private void redrawLocked(Rect newBounds, bool fullscreen, Rect systemInsets,
            Rect stableInsets) {
    ...
    private void drawColorViews(int left, int top, int width, int height,
            bool fullscreen, Rect systemInsets, Rect stableInsets) {
        if (mSystemBarBackgroundNode == null) {
            return;
        }
     ...
     */
    private void pingRenderLocked(bool drawImmediate) {
