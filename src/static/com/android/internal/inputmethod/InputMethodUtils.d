...
public class InputMethodUtils {
    ...
    public static bool isSystemIme(InputMethodInfo inputMethod) {
        return (inputMethod.getServiceInfo().applicationInfo.flags
                & ApplicationInfo.FLAG_SYSTEM) != 0;
    }

    public static bool isSystemImeThatHasSubtypeOf(final InputMethodInfo imi,
            final Context context, final bool checkDefaultAttribute,
            @Nullable final Locale requiredLocale, final bool checkCountry,
    ...
    private static bool isSystemAuxilialyImeThatHasAutomaticSubtype(final InputMethodInfo imi,
            final Context context, final bool checkDefaultAttribute) {
        if (!isSystemIme(imi)) {
            return false;
        }
    ...
    private static final class InputMethodListBuilder {
        ...
        public InputMethodListBuilder fillImes(final ArrayList<InputMethodInfo> imis,
                final Context context, final bool checkDefaultAttribute,
                @Nullable final Locale locale, final bool checkCountry,
                final String requiredSubtypeMode) {
            for (int i = 0; i < imis.size(); ++i) {
    ...
    public static ArrayList<InputMethodInfo> getDefaultEnabledImes(
            Context context, ArrayList<InputMethodInfo> imis, bool onlyMinimum) {
    ...
    public static bool containsSubtypeOf(final InputMethodInfo imi,
            @Nullable final Locale locale, final bool checkCountry, final String mode) {
        if (locale == null) {
            return false;
        }
    ...
    public static bool isValidSubtypeId(InputMethodInfo imi, int subtypeHashCode) {
    ...
    private static ArrayList<InputMethodSubtype> getImplicitlyApplicableSubtypesLockedImpl(
        ...
        if (!applicableSubtypes.isEmpty()) {
            bool hasAsciiCapableKeyboard = false;
    ...
    public static InputMethodSubtype findLastResortApplicableSubtypeLocked(
            ...
            bool canIgnoreLocaleAsLastResort) {
    ...
    public static bool canAddToLastInputMethod(InputMethodSubtype subtype) {
    ...
    public static void setNonSelectedSystemImesDisabledUntilUsed(
        ...
        for (final String packageName : systemImesDisabledUntilUsed) {
            ...
            final bool isSystemPackage = (ai.flags & ApplicationInfo.FLAG_SYSTEM) != 0;
            if (!isSystemPackage) {
                continue;
            }
     ...
     */
    public static bool checkIfPackageBelongsToUid(final AppOpsManager appOpsManager,
    ...
    public static class InputMethodSettings {
        ...
        private bool mCopyOnWrite = false;
        @NonNull
        ...
        public InputMethodSettings(
                ...
                @UserIdInt int userId, bool copyOnWrite) {
            mRes = res;
            mResolver = resolver;
         ...
         */
        public void switchCurrentUser(@UserIdInt int userId, bool copyOnWrite) {
            if (DEBUG) {
        ...
        private void putBoolean(final String key, final bool value) {
            putInt(key, value ? 1 : 0);
        }

        private bool getBoolean(final String key, final bool defaultValue) {
        ...
        public List<InputMethodSubtype> getEnabledInputMethodSubtypeListLocked(
                Context context, InputMethodInfo imi, bool allowsImplicitlySelectedSubtypes) {
        ...
        public void appendAndPutEnabledInputMethodLocked(String id, bool reloadInputMethodStr) {
         ...
         */
        public bool buildAndPutEnabledInputMethodsStrRemovingIdLocked(
                StringBuilder builder, List<Pair<String, ArrayList<String>>> imsList, String id) {
            bool isRemoved = false;
            bool needsAppendSeparator = false;
        ...
        public bool isShowImeWithHardKeyboardEnabled() {
            return getBoolean(Settings.Secure.SHOW_IME_WITH_HARD_KEYBOARD, false);
        }

        public void setShowImeWithHardKeyboard(bool show) {
    ...
    public static ArrayList<Locale> getSuitableLocalesForSpellChecker(
        ...
        if (systemLocale != null) {
            ...
            final bool hasLanguage = !TextUtils.isEmpty(language);
            final String country = systemLocale.getCountry();
            final bool hasCountry = !TextUtils.isEmpty(country);
            final String variant = systemLocale.getVariant();
            final bool hasVariant = !TextUtils.isEmpty(variant);
    ...
    public static bool isSoftInputModeStateVisibleAllowed(
