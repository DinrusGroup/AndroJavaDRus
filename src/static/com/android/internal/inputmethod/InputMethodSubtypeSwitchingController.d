...
public class InputMethodSubtypeSwitchingController {
    ...
    public static class ImeSubtypeListItem : Comparable<ImeSubtypeListItem> {
        public final CharSequence mImeName;
        public final CharSequence mSubtypeName;
        public final InputMethodInfo mImi;
        public final int mSubtypeId;
        public final bool mIsSystemLocale;
        public final bool mIsSystemLanguage;
        ...
        private static int compareNullableCharSequences(@Nullable CharSequence c1,
            ...
            final bool empty1 = TextUtils.isEmpty(c1);
            final bool empty2 = TextUtils.isEmpty(c2);
            if (empty1 || empty2) {
    ...
    private static class InputMethodAndSubtypeList {
        ...
        public List<ImeSubtypeListItem> getSortedInputMethodAndSubtypeList(
                bool includeAuxiliarySubtypes, bool isScreenLocked) {
    ...
    private static class StaticRotationList {
         ...
         */
        @Nullable
        public ImeSubtypeListItem getNextInputMethodLocked(bool onlyCurrentIme,
                InputMethodInfo imi, @Nullable InputMethodSubtype subtype, bool forward) {
            if (imi == null) {
                return null;
            }
    ...
    public static class ControllerImpl {
         ...
         */
        @Nullable
        public ImeSubtypeListItem getNextInputMethod(bool onlyCurrentIme, InputMethodInfo imi,
                @Nullable InputMethodSubtype subtype, bool forward) {
            if (imi == null) {
                return null;
            }
        ...
        private static List<ImeSubtypeListItem> filterImeSubtypeList(
                ...
                final bool supportsSwitchingToNextInputMethod) {
    ...
    public ImeSubtypeListItem getNextInputMethodLocked(bool onlyCurrentIme, InputMethodInfo imi,
            InputMethodSubtype subtype, bool forward) {
        if (mController == null) {
            if (DEBUG) {
                Log.e(TAG, "mController shouldn't be null.");
            }
    ...
    public List<ImeSubtypeListItem> getSortedInputMethodAndSubtypeListLocked(
            bool includingAuxiliarySubtypes, bool isScreenLocked) {
