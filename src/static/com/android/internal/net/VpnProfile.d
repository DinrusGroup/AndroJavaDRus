 ...
 * @hide
 */
public class VpnProfile : Cloneable, Parcelable {
     ...
     * connection.
     */
    public bool isValidLockdownProfile() {
    ...
    public bool isTypeValidForLockdown() {
    ...
    public bool isServerAddressNumeric() {
        try {
     ...
     * e.g. 8.8.8.8
     */
    public bool areDnsAddressesNumeric() {
        try {
