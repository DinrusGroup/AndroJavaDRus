...
public class NetworkStatsFactory {
    ...
    private static final bool USE_NATIVE_PARSING = true;
    private static final bool SANITY_CHECK_NATIVE = false;
    ...
    @VisibleForTesting
    public NetworkStatsFactory(File procRoot, bool useBpfStats) {
    ...
    public NetworkStats readNetworkStatsSummaryDev() throws IOException {
        ...
        try {
            ...
            while (reader.hasMoreData()) {
                ...
                final bool active = reader.nextInt() != 0;
    ...
    public static native int nativeReadNetworkStatsDetail(NetworkStats stats, String path,
        int limitUid, String[] limitIfaces, int limitTag, bool useBpfStats);
