...
public class NotificationVisibility : Parcelable {
    ...
    private NotificationVisibility(String key, int rank, int count, bool visibile) {
        this();
        this.key = key;
        this.rank = rank;
        this.count = count;
     ...
     */
    public static NotificationVisibility obtain(String key, int rank, int count, bool visible) {
