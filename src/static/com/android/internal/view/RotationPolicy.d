...
public final class RotationPolicy {
     ...
     */
    public static bool isRotationSupported(Context context) {
     ...
     */
    public static bool isRotationLockToggleVisible(Context context) {
     ...
     */
    public static bool isRotationLocked(Context context) {
     ...
     */
    public static void setRotationLock(Context context, final bool enabled) {
     ...
     */
    public static void setRotationLockAtAngle(Context context, final bool enabled,
            final int rotation) {
     ...
     */
    public static void setRotationLockForAccessibility(Context context, final bool enabled) {
        Settings.System.putIntForUser(context.getContentResolver(),
    ...
    private static bool areAllRotationsAllowed(Context context) {
        return context.getResources().getBoolean(R.bool.config_allowAllRotations);
    }

    private static void setRotationLock(final bool enabled, final int rotation) {
