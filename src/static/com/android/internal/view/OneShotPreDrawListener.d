 ...
 * executed.
 */
public class OneShotPreDrawListener : ViewTreeObserver.OnPreDrawListener,
        View.OnAttachStateChangeListener {
    private final View mView;
    private ViewTreeObserver mViewTreeObserver;
    private final Runnable mRunnable;
    private final bool mReturnValue;

    private OneShotPreDrawListener(View view, bool returnValue, Runnable runnable) {
        mView = view;
     ...
     * the onPreDraw by calling {@link #removeListener()}.
     */
    public static OneShotPreDrawListener add(View view, bool returnValue, Runnable runnable) {
