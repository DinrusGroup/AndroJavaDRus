 ...
 */
public class ListMenuItemView : LinearLayout
        : MenuView.ItemView, AbsListView.SelectionBoundsAdjuster {
    ...
    private void setSubMenuArrowVisible(bool hasSubmenu) {
        if (mSubMenuArrowView != null) {
    ...
    public void setIcon(Drawable icon) {
        final bool showIcon = mItemData.shouldShowIcon() || mForceShowIcon;
