...
public class ActionMenu : Menu {
    ...
    private ActionMenuItem findItemWithShortcut(int keyCode, KeyEvent event) {
        ...
        for (int i = 0; i < itemCount; i++) {
            ...
            final bool is_modifiers_exact_match = (modifierState & SUPPORTED_MODIFIERS_MASK)
    ...
    public void setGroupCheckable(int group, bool checkable,
            bool exclusive) {
        final ArrayList<ActionMenuItem> items = mItems;
        final int itemCount = items.size();
