 ...
 */
public class MenuPopupHelper : MenuHelper {
    ...
    private final bool mOverflowOnly;
    ...
    public MenuPopupHelper(@NonNull Context context, @NonNull MenuBuilder menu,
            @NonNull View anchorView,
            bool overflowOnly, @AttrRes int popupStyleAttr) {
        this(context, menu, anchorView, overflowOnly, popupStyleAttr, 0);
    }

    public MenuPopupHelper(@NonNull Context context, @NonNull MenuBuilder menu,
            @NonNull View anchorView, bool overflowOnly, @AttrRes int popupStyleAttr,
     ...
     */
    public void setForceShowIcon(bool forceShowIcon) {
     ...
     */
    public bool tryShow(int x, int y) {
        if (isShowing()) {
            return true;
        }
    ...
    private MenuPopup createPopup() {
        ...
        final bool enableCascadingSubmenus = smallestWidth >= minSmallestWidthCascading;
    ...
    private void showPopup(int xOffset, int yOffset, bool useOffsets, bool showTitle) {
