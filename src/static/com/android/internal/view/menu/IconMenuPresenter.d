 ...
 */
public class IconMenuPresenter : BaseMenuPresenter {
    ...
    public bool shouldIncludeItem(int childIndex, MenuItemImpl item) {
        ...
        bool fits = (itemsToShow.size() == mMaxItems && childIndex < mMaxItems) ||
    ...
    public void updateMenuView(bool cleared) {
        ...
        final ArrayList<MenuItemImpl> itemsToShow = mMenu.getNonActionItems();
        final bool needsMore = itemsToShow.size() > mMaxItems;
    ...
    override
    protected bool filterLeftoverView(ViewGroup parent, int childIndex) {
    ...
    class SubMenuPresenterCallback : MenuPresenter.Callback {
        override
