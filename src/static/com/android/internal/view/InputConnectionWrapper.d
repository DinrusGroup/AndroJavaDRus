...
public class InputConnectionWrapper : InputConnection {
    ...
    static class InputContextCallback : IInputContextCallback.Stub {
        ...
        public bool mRequestUpdateCursorAnchorInfoResult;
        public bool mCommitContentResult;
        ...
        @BinderThread
        public void setRequestUpdateCursorAnchorInfoResult(bool result, int seq) {
            synchronized (this) {
                if (seq == mSeq) {
        ...
        @BinderThread
        public void setCommitContentResult(bool result, int seq) {
            synchronized (this) {
                if (seq == mSeq) {
    ...
    @AnyThread
    private bool isMethodMissing(@MissingMethodFlags final int methodFlag) {
