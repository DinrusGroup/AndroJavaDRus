...
class LocalTransportParameters : KeyValueSettingObserver {
    ...
    private bool mFakeEncryptionFlag;
    private bool mIsNonIncrementalOnly;

    LocalTransportParameters(Handler handler, ContentResolver resolver) {
        super(handler, resolver, Settings.Secure.getUriFor(SETTING));
    }

    bool isFakeEncryptionFlag() {
        return mFakeEncryptionFlag;
    }

    bool isNonIncrementalOnly() {
