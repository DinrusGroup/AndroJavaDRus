...
public abstract class PackageMonitor : android.content.BroadcastReceiver {
    ...
    bool mSomePackagesChanged;
    String[] mModifiedComponents;

    String[] mTempArray = new String[1];

    public void register(Context context, Looper thread, bool externalStorage) {
    ...
    public void register(Context context, UserHandle user,
        bool externalStorage, Handler handler) {
    ...
    //not yet implemented
    bool isPackageUpdating(String packageName) {
    ...
    public bool didSomePackagesChange() {
    ...
    public bool anyPackagesAppearing() {
    ...
    public bool anyPackagesDisappearing() {
    ...
    public bool isPackageModified(String packageName) {
    ...
    public bool isComponentModified(String className) {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (Intent.ACTION_PACKAGE_ADDED.equals(action)) {
            ...
            bool canRestart = onHandleForceStop(intent,
