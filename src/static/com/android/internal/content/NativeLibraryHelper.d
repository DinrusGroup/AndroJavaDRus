...
public class NativeLibraryHelper {
    ...
    private static final bool DEBUG_NATIVE = false;
     ...
     * @hide
     */
    public static class Handle : Closeable {
        private final CloseGuard mGuard = CloseGuard.get();
        private volatile bool mClosed;

        final long[] apkHandles;
        final bool multiArch;
        ...
        private static Handle create(List<String> codePaths, bool multiArch,
                bool extractNativeLibs, bool debuggable) throws IOException {
        ...
        Handle(long[] apkHandles, bool multiArch, bool extractNativeLibs,
                bool debuggable) {
    ...
    private native static int nativeCopyNativeBinaries(long handle, String sharedLibraryPath,
            String abiToCopy, bool extractNativeLibs, bool hasNativeBridge,
            bool debuggable);
    ...
    public static int copyNativeBinariesForSupportedAbi(Handle handle, File libraryRoot,
            String[] abiList, bool useIsaSubdir) throws IOException {
    ...
    private static final bool HAS_NATIVE_BRIDGE =
            !"0".equals(SystemProperties.get("ro.dalvik.vm.native.bridge", "0"));

    private static native int hasRenderscriptBitcode(long apkHandle);

    public static bool hasRenderscriptBitcode(Handle handle) throws IOException {
        for (long apkHandle : handle.apkHandles) {
