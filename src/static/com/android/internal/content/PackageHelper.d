...
public class PackageHelper {
    ...
    public static abstract class TestableInterface {
        ...
        abstract public bool getForceAllowOnExternalSetting(Context context);
        abstract public bool getAllow3rdPartyOnInternalConfig(Context context);
    ...
    private synchronized static TestableInterface getDefaultTestableInterface() {
        if (sDefaultTestableInterface == null) {
            sDefaultTestableInterface = new TestableInterface() {
                ...
                override
                public bool getForceAllowOnExternalSetting(Context context) {
                    return Settings.Global.getInt(context.getContentResolver(),
                            Settings.Global.FORCE_ALLOW_ON_EXTERNAL, 0) != 0;
                }

                override
                public bool getAllow3rdPartyOnInternalConfig(Context context) {
    ...
    public static String resolveInstallVolume(Context context, SessionParams params,
        ...
        final bool forceAllowOnExternal = testInterface.getForceAllowOnExternalSetting(context);
        final bool allow3rdPartyOnInternal =
        ...
        bool fitsOnInternal = false;
        VolumeInfo bestCandidate = null;
        long bestCandidateAvailBytes = Long.MIN_VALUE;
        for (VolumeInfo vol : storageManager.getVolumes()) {
            if (vol.type == VolumeInfo.TYPE_PRIVATE && vol.isMountedWritable()) {
                final bool isInternalStorage = ID_PRIVATE_INTERNAL.equals(vol.id);
    ...
    public static bool fitsOnInternal(Context context, SessionParams params) throws IOException {
    ...
    public static bool fitsOnExternal(Context context, SessionParams params) {
        final StorageManager storage = context.getSystemService(StorageManager.class);
    ...
    @Deprecated
    public static long calculateInstalledSize(PackageLite pkg, bool isForwardLocked,
