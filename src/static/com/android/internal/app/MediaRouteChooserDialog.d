...
/**
 * This class : the route chooser dialog for {@link MediaRouter}.
 * <p>
 ...
 */
public class MediaRouteChooserDialog : Dialog {
     ...
     */
    public bool onFilterRoute(MediaRouter.RouteInfo route) {
    ...
    static bool isLightTheme(Context context) {
        TypedValue value = new TypedValue();
        return context.getTheme().resolveAttribute(R.attr.isLightTheme, value, true)
                && value.data != 0;
    }

    private final class RouteAdapter : ArrayAdapter<MediaRouter.RouteInfo>
    ...
    private final class MediaRouterCallback : MediaRouter.SimpleCallback {
        override
    ...
    private static final class RouteComparator : Comparator<MediaRouter.RouteInfo> {
