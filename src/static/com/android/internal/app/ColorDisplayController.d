...
public final class ColorDisplayController {
     ...
     * be activated manually via {@link #setActivated(bool)}.
     *
     * @see #setAutoMode(int)
     */
     ...
     */
    public bool setAutoMode(@AutoMode int autoMode) {
        if (autoMode != AUTO_MODE_DISABLED
                && autoMode != AUTO_MODE_CUSTOM
                && autoMode != AUTO_MODE_TWILIGHT) {
     ...
     */
    public bool setCustomStartTime(@NonNull LocalTime startTime) {
        if (startTime == null) {
     ...
     */
    public bool setCustomEndTime(@NonNull LocalTime endTime) {
        if (endTime == null) {
     ...
     */
    public bool setColorTemperature(int colorTemperature) {
        return Secure.putIntForUser(mContext.getContentResolver(),
    ...
    private bool isColorModeAvailable(@ColorMode int colorMode) {
     ...
     */
    public bool getAccessibilityTransformActivated() {
        final ContentResolver cr = mContext.getContentResolver();
        return
    ...
    public interface Callback {
         ...
         */
        default void onActivated(bool activated) {}
        /**
         ...
         */
        default void onAccessibilityTransformChanged(bool state) {}
    }
}
