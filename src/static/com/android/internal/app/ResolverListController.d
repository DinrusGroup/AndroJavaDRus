...
public class ResolverListController {
    ...
    public List<ResolverActivity.ResolvedComponentInfo> getResolversForIntent(
            bool shouldGetResolvedFilter,
            bool shouldGetActivityMetadata,
            List<Intent> intents) {
    ...
    public ArrayList<ResolverActivity.ResolvedComponentInfo> filterIneligibleActivities(
            ...
            bool returnCopyOfOriginalListIfModified) {
        ...
        for (int i = inputList.size()-1; i >= 0; i--) {
            ...
            bool suspended = (ai.applicationInfo.flags
    ...
    private class ComputeCallback : ResolverComparator.AfterCompute {
    ...
    private static bool isSameResolvedComponent(ResolveInfo a,
    ...
    bool isComponentFiltered(ComponentName componentName) {
        return false;
    }
