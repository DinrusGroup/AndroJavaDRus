 ...
 */
@UiThread
public class ResolverActivity : Activity {

    protected ResolveListAdapter mAdapter;
    private bool mSafeForwardingMode;
    ...
    private bool mResolvingHome = false;
    ...
    private bool mSupportsAlwaysUseOption;
    ...
    private final PackageMonitor mPackageMonitor = new PackageMonitor() {
        ...
        override
        public bool onPackageChanged(String packageName, int uid, String[] components) {
    ...
    protected void onCreate(Bundle savedInstanceState, Intent intent,
            ...
            List<ResolveInfo> rList, bool supportsAlwaysUseOption) {
    ...
    private void setProfileSwitchMessageId(int contentUserHint) {
        if (contentUserHint != UserHandle.USER_CURRENT &&
            ...
            bool originIsManaged = originUserInfo != null ? originUserInfo.isManagedProfile()
                    : false;
            bool targetIsManaged = userManager.isManagedProfile();
     ...
     */
    public void setSafeForwardingMode(bool safeForwarding) {
    ...
    protected CharSequence getTitleForAction(String action, int defaultTitleRes) {
        ...
        final bool named = mAdapter.getFilteredPosition() >= 0;
    ...
    private bool hasManagedProfile() {
        UserManager userManager = (UserManager) getSystemService(Context.USER_SERVICE);
        if (userManager == null) {
            return false;
        }
    ...
    private bool supportsManagedProfiles(ResolveInfo resolveInfo) {
        try {
    ...
    private void setAlwaysButtonEnabled(bool hasValidSelection, int checkedPos,
            bool filtered) {
        bool enabled = false;
    ...
    public void startSelected(int which, bool always, bool hasIndexBeenFiltered) {
        if (isFinishing()) {
            return;
        }
    ...
    protected bool onTargetSelected(TargetInfo target, bool alwaysCheck) {
        ...
        if (intent != null && (mSupportsAlwaysUseOption || mAdapter.hasFilteredItem())
            ...
            if (filter != null) {
                ...
                final bool needToAddBackProfileForwardingComponent
                ...
                if (alwaysCheck) {
                    ...
                    if (ri.handleAllWebDataURI) {
                        ...
                        bool isHttpOrHttps = (dataScheme != null) &&
                                (dataScheme.equals(IntentFilter.SCHEME_HTTP) ||
                                        dataScheme.equals(IntentFilter.SCHEME_HTTPS));

                        bool isViewAction = (action != null) && action.equals(Intent.ACTION_VIEW);
                        bool hasCategoryBrowsable = (categories != null) &&
    ...
    public bool shouldGetActivityMetadata() {
        return false;
    }

    public bool shouldAutoLaunchSingleChoice(TargetInfo target) {
        return true;
    }
     ...
     */
    public bool configureContentView(List<Intent> payloadIntents, Intent[] initialIntents,
        ...
        bool rebuildCompleted = mAdapter.rebuildList();
    ...
    public void onPrepareAdapterView(AbsListView adapterView, ResolveListAdapter adapter) {
        final bool useHeader = adapter.hasFilteredItem();
    ...
    private bool useLayoutWithDefault() {
     ...
     */
    protected void setRetainInOnStop(bool retainInOnStop) {
     ...
     */
    static bool resolveInfoMatch(ResolveInfo lhs, ResolveInfo rhs) {
    ...
    public final class DisplayResolveInfo : TargetInfo {
        ...
        override
        public bool start(Activity activity, Bundle options) {
            activity.startActivity(mResolvedIntent, options);
            return true;
        }

        override
        public bool startAsCaller(Activity activity, Bundle options, int userId) {
            activity.startActivityAsCaller(mResolvedIntent, options, false, userId);
            return true;
        }

        override
        public bool startAsUser(Activity activity, Bundle options, UserHandle user) {
    ...
    public interface TargetInfo {
         ...
         */
        bool start(Activity activity, Bundle options);
         ...
         * @return true if the start completed successfully
         */
        bool startAsCaller(Activity activity, Bundle options, int userId);
         ...
         * @return true if the start completed successfully
         */
        bool startAsUser(Activity activity, Bundle options, UserHandle user);
    ...
    public class ResolveListAdapter : BaseAdapter {
        private final List<Intent> mIntents;
        private final Intent[] mInitialIntents;
        private final List<ResolveInfo> mBaseResolveList;
        protected ResolveInfo mLastChosen;
        private DisplayResolveInfo mOtherProfile;
        private bool mHasExtendedInfo;
        ...
        public bool shouldGetResolvedFilter() {
        ...
        @Nullable
        public ResolveInfo resolveInfoForPosition(int position, bool filtered) {
        ...
        @Nullable
        public TargetInfo targetInfoForPosition(int position, bool filtered) {
            if (filtered) {
        ...
        public bool hasResolvedTarget(ResolveInfo info) {
        ...
        public bool showsExtendedInfo(TargetInfo info) {
            return !TextUtils.isEmpty(info.getExtendedInfo());
        }

        public bool isComponentPinned(ComponentName name) {
            return false;
        }
    ...
    class ItemClickListener : AdapterView.OnItemClickListener,
        ...
        public void onItemClick(AdapterView!(T) parent, View view, int position, long id) {
            ...
            final bool hasValidSelection = checkedPos != ListView.INVALID_POSITION;
            if (!useLayoutWithDefault()
        ...
        override
        public bool onItemLongClick(AdapterView!(T) parent, View view, int position, long id) {
            final ListView listView = parent instanceof ListView ? (ListView) parent : null;
            if (listView != null) {
                position -= listView.getHeaderViewsCount();
            }
    ...
    abstract class LoadIconTask : AsyncTask<Void, Void, Drawable> {
    ...
    class LoadAdapterIconTask : LoadIconTask {
    ...
    class LoadIconIntoViewTask : LoadIconTask {
    ...
    static final bool isSpecificUriMatch(int match) {
        match = match&IntentFilter.MATCH_CATEGORY_MASK;
        return match >= IntentFilter.MATCH_CATEGORY_HOST
                && match <= IntentFilter.MATCH_CATEGORY_PATH;
    }

    static class PickTargetOptionRequest : PickOptionRequest {
        ...
        override
        public void onPickOptionResult(bool finished, Option[] selections, Bundle result) {
