 ...
 */
class ResolverComparator : Comparator<ResolvedComponentInfo> {
    ...
    public int compare(ResolvedComponentInfo lhsp, ResolvedComponentInfo rhsp) {
        ...
        if (mHttp) {
            ...
            final bool lhsSpecific = ResolverActivity.isSpecificUriMatch(lhs.match);
            final bool rhsSpecific = ResolverActivity.isSpecificUriMatch(rhs.match);
            if (lhsSpecific != rhsSpecific) {
                return lhsSpecific ? -1 : 1;
            }
        }

        final bool lPinned = lhsp.isPinned();
        final bool rPinned = rhsp.isPinned();
    ...
    private class ResolverRankerServiceConnection : ServiceConnection {
    ...
    static bool isPersistentProcess(ResolvedComponentInfo rci) {
