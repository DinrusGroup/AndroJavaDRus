...
public class ChooserActivity : ResolverActivity {
    ...
    protected bool mIsSuccessfullySelected;
    ...
    public void showTargetDetails(ResolveInfo ri) {
        ...
        bool pinned = mPinnedSharedPrefs.getBoolean(name.flattenToString(), false);
    ...
    override
    public void startSelected(int which, bool always, bool filtered) {
    ...
    bool checkTargetSourceIntent(TargetInfo target, Intent matchingIntent) {
    ...
    public class ChooserListController : ResolverListController {
        ...
        override
        bool isComponentPinned(ComponentName name) {
            return mPinnedSharedPrefs.getBoolean(name.flattenToString(), false);
        }

        override
        bool isComponentFiltered(ComponentName name) {
    ...
    final class ChooserTargetInfo : TargetInfo {
        ...
        public bool startAsCaller(Activity activity, Bundle options, int userId) {
            ...
            final bool ignoreTargetSecurity = mSourceInfo != null
    ...
    public class ChooserListAdapter : ResolveListAdapter {
        ...
        private bool mShowServiceTargets;

        private float mLateFee = 1.f;

        private bool mTargetsNeedPruning = false;
        ...
        public ChooserListAdapter(Context context, List<Intent> payloadIntents,
                Intent[] initialIntents, List<ResolveInfo> rList, int launchedFromUid,
                bool filterLastUsed, ResolverListController resolverListController) {
         ...
         */
        public void setShowServiceTargets(bool show) {
    ...
    static class BaseChooserTargetComparator : Comparator<ChooserTarget> {
        override
    ...
    class ChooserRowAdapter : BaseAdapter {
        private ChooserListAdapter mChooserListAdapter;
    ...
    static class ChooserTargetServiceConnection : ServiceConnection {
    ...
    static class RefinementResultReceiver : ResultReceiver {
        private ChooserActivity mChooserActivity;
    ...
    class OffsetDataSetObserver : DataSetObserver {
