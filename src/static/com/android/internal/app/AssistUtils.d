...
public class AssistUtils {
    ...
    public bool activeServiceSupportsAssistGesture() {
        try {
    ...
    public bool activeServiceSupportsLaunchFromKeyguard() {
        try {
            return mVoiceInteractionManagerService != null
    ...
    public static bool isPreinstalledAssistant(Context context, ComponentName assistant) {
        if (assistant == null) {
            return false;
        }
    ...
    private static bool isDisclosureEnabled(Context context) {
     ...
     */
    public static bool shouldDisclose(Context context, ComponentName assistant) {
    ...
    public static bool allowDisablingAssistDisclosure(Context context) {
