...
/**
 * This class : some handy methods to process with locales.
 */
public class LocaleHelper {
    ...
    private static bool shouldUseDialectName(Locale locale) {
     ...
     */
    public static String getDisplayName(Locale locale, Locale displayLocale, bool sentenceCase) {
     ...
     * @return the localized name of the locale.
     */
    public static String getDisplayName(Locale locale, bool sentenceCase) {
    ...
    public static String getDisplayLocaleList(
        ...
        final bool ellipsisNeeded = locales.size() > maxLocales;
     ...
     */
    public static final class LocaleInfoComparator : Comparator<LocaleStore.LocaleInfo> {
        private final Collator mCollator;
        private final bool mCountryMode;
         ...
         */
        public LocaleInfoComparator(Locale sortLocale, bool countryMode) {
