...
public class LocalePicker : ListFragment {
    ...
    public static class LocaleInfo : Comparable<LocaleInfo> {
    ...
    public static List<LocaleInfo> getAllAssetLocales(Context context, bool isInDeveloperMode) {
    ...
    public static ArrayAdapter<LocaleInfo> constructAdapter(Context context,
        ...
        bool isInDeveloperMode = Settings.Global.getInt(context.getContentResolver(),
