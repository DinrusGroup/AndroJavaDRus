 ...
 * default locale.</p>
 */
public class LocalePickerWithRegion : ListFragment : SearchView.OnQueryTextListener {
    ...
    private bool mTranslatedOnly = false;
    private SearchView mSearchView = null;
    private CharSequence mPreviousSearch = null;
    private bool mPreviousSearchHadFocus = false;
    ...
    private static LocalePickerWithRegion createCountryPicker(Context context,
        ...
        bool shouldShowTheList = localePicker.setListener(context, listener, parent,
                translatedOnly);
        return shouldShowTheList ? localePicker : null;
    }

    public static LocalePickerWithRegion createLanguagePicker(Context context,
            LocaleSelectedListener listener, bool translatedOnly) {
        LocalePickerWithRegion localePicker = new LocalePickerWithRegion();
     ...
     */
    private bool setListener(Context context, LocaleSelectedListener listener,
            LocaleStore.LocaleInfo parent, bool translatedOnly) {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        final bool countryMode = mParentLocale != null;
    ...
    override
    public bool onOptionsItemSelected(MenuItem menuItem) {
