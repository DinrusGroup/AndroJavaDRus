 ...
 */
public class ConfirmUserCreationActivity : AlertActivity
    ...
    private String checkUserCreationRequirements() {
        ...
        bool cantCreateUser = mUserManager.hasUserRestriction(UserManager.DISALLOW_ADD_USER)
                || !mUserManager.isAdminUser();
        // Check the system state and user count
        bool cantCreateAnyMoreUsers = !mUserManager.canAddMoreUsers();
        // Check the account existence
        final Account account = new Account(mAccountName, mAccountType);
        bool accountExists = mAccountName != null && mAccountType != null
