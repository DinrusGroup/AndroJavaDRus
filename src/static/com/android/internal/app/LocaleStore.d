...
public class LocaleStore {
    ...
    private static bool sFullyInitialized = false;
    ...
    public static class LocaleInfo {
        ...
        private bool mIsTranslated;
        private bool mIsPseudo;
        private bool mIsChecked; // Used by the LocaleListEditor to mark entries for deletion
        ...
        public void setTranslated(bool isTranslated) {
            mIsTranslated = isTranslated;
        }

        /* package */ bool isSuggested() {
        ...
        private bool isSuggestionOfType(int suggestionMask) {
            if (!mIsTranslated) { // Never suggest an untranslated locale
                return false;
            }
        ...
        String getLabel(bool countryMode) {
            if (countryMode) {
        ...
        String getContentDescription(bool countryMode) {
            if (countryMode) {
    ...
    public static void fillCache(Context context) {
        ...
        final bool isInDeveloperMode = Settings.Global.getInt(context.getContentResolver(),
    ...
    private static int getLevel(Set<String> ignorables, LocaleInfo li, bool translatedOnly) {
    ...
    public static Set<LocaleInfo> getLevelLocales(Context context, Set<String> ignorables,
            LocaleInfo parent, bool translatedOnly) {
        fillCache(context);
