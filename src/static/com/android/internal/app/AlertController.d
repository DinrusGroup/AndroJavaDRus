...
public class AlertController {
    ...
    private static final class ButtonHandler : Handler {
    ...
    private static bool shouldCenterSingleButton(Context context) {
    ...
    public void setInverseBackgroundForced(bool forceInverseBackground) {
    ...
    private void setupView() {
        ...
        final bool hasCustomPanel = customPanel != null
                && customPanel.getVisibility() != View.GONE;
        final bool hasTopPanel = topPanel != null
                && topPanel.getVisibility() != View.GONE;
        final bool hasButtonPanel = buttonPanel != null
    ...
    private void setupCustomContent(ViewGroup customPanel) {
        ...
        final bool hasCustomView = customView != null;
    ...
    protected void setupTitle(ViewGroup topPanel) {
        if (mCustomTitleView != null && mShowTitle) {
            ...
            final bool hasTextTitle = !TextUtils.isEmpty(mTitle);
    ...
    protected void setupButtons(ViewGroup buttonPanel) {
        ...
        final bool hasButtons = whichButtons != 0;
        if (!hasButtons) {
    ...
    private void setBackground(TypedArray a, View topPanel, View contentPanel, View customPanel,
        ...
        final bool needsDefaultBackgrounds = a.getBoolean(
    ...
    public static class RecycleListView : ListView {
        ...
        public void setHasDecor(bool hasTitle, bool hasButtons) {
        ...
        private void createListView(final AlertController dialog) {
            ...
            if (mOnClickListener != null) {
                listView.setOnItemClickListener(new OnItemClickListener() {
                    override
                    public void onItemClick(AdapterView!(T) parent, View v, int position, long id) {
    ...
    private static class CheckedItemAdapter : ArrayAdapter<CharSequence> {
