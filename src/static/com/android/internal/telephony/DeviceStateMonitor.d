 ...
 * strength update.
 */
public class DeviceStateMonitor : Handler {
    protected static final bool DBG = false;      /* STOPSHIP if true */
     ...
     */
    private bool mIsLowDataExpected;
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            switch (intent.getAction()) {
                ...
                case ConnectivityManager.ACTION_TETHER_STATE_CHANGED:
                    ...
                    bool isTetheringOn = activeTetherIfaces != null
     ...
     */
    private bool isLowDataExpected() {
     ...
     */
    private bool shouldTurnOffSignalStrength() {
     ...
     */
    private bool shouldTurnOffFullNetworkUpdate() {
     ...
     */
    private bool shouldTurnOffDormancyUpdate() {
     ...
     */
    private bool shouldTurnOffLinkCapacityEstimate() {
     ...
     */
    private bool shouldTurnOffPhysicalChannelConfig() {
     ...
     */
    private void onUpdateDeviceState(int eventType, bool state) {
        switch (eventType) {
            case EVENT_SCREEN_STATE_CHANGED:
     ...
     * @param state True if enabled/on, otherwise disabled/off
     */
    private void sendDeviceState(int type, bool state) {
     ...
     */
    private void setUnsolResponseFilter(int newFilter, bool force) {
     ...
     */
    private bool isPowerSaveModeOn() {
     ...
     */
    private void log(String msg, bool logIntoLocalLog) {
