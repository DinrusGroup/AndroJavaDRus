...
public class SmsMessage : SmsMessageBase {
    ...
    // TP-Reply-Path
    // e.g. 23.040 9.2.2.1
    private bool mReplyPathPresent = false;
     ...
     */
    private bool mIsStatusReportMessage = false;
    ...
    public static class SubmitPdu : SubmitPduBase {
    }
    ...
    public static SubmitPdu getSubmitPdu(String scAddress,
            ...
            bool statusReportRequested, byte[] header) {
    ...
    public static SubmitPdu getSubmitPdu(String scAddress,
            String destinationAddress, String message,
            bool statusReportRequested, byte[] header, int encoding,
    ...
    public static SubmitPdu getSubmitPdu(String scAddress,
        ...
        byte mtiByte = cast(byte)(0x01 | (validityPeriodFormat << 0x03) |
    ...
    private static byte[] encodeUCS2(String message, byte[] header)
        ...
        if (header != null) {
            ...
            userData[0] = cast(byte)header.length;
        ...
        ret[0] = cast(byte) (userData.length & 0xff );
    ...
    public static SubmitPdu getSubmitPdu(String scAddress,
            String destinationAddress, String message,
            bool statusReportRequested, int validityPeriod) {
        return getSubmitPdu(scAddress, destinationAddress, message, statusReportRequested,
    ...
    public static SubmitPdu getSubmitPdu(String scAddress,
        ...
        SubmitPdu ret = new SubmitPdu();
        ByteArrayOutputStream bo = getSubmitPduHead(
                scAddress, destinationAddress, cast(byte) 0x41, // MTI = SMS-SUBMIT,
                                                            // TP-UDHI = true
                statusReportRequested, ret);
        // Skip encoding pdu if error occurs when create pdu head and the error will be handled
        // properly later on encodedMessage sanity check.
    ...
    private static ByteArrayOutputStream getSubmitPduHead(
            ...
            bool statusReportRequested, SubmitPdu ret) {
    ...
    private static class PduParser {
        ...
        long getSCTimestampMillis() {
            ...
            // Mask out sign bit.
            int timezoneOffset = IccUtils.gsmBcdByteToInt(cast(byte) (tzByte & (~0x08)));
     ...
     *                          User Data.
     */
    private void parseUserData(PduParser p, bool hasUserDataHeader) {
