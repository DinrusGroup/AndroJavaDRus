...
public class SmsCbHeader {
    ...
    public SmsCbHeader(byte[] pdu) throws IllegalArgumentException {
        ...
        if (pdu.length <= PDU_LENGTH_GSM) {
            ...
            if (isEtwsMessage() && pdu.length <= PDU_LENGTH_ETWS) {
                ...
                mPageIndex = -1;
                mNrOfPages = -1;
                bool emergencyUserAlert = (pdu[4] & 0x1) != 0;
                bool activatePopup = (pdu[5] & 0x80) != 0;
        ...
        if (isEtwsMessage()) {
            bool emergencyUserAlert = isEtwsEmergencyUserAlert();
            bool activatePopup = isEtwsPopupAlert();
     ...
     */
    bool isEtwsPrimaryNotification() {
     ...
     */
    private bool isEtwsEmergencyUserAlert() {
