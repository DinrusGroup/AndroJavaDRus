 ...
 *
 */
public final class GsmMmiCode : Handler : MmiCode {
    ...
    private bool mIsPendingUSSD;

    private bool mIsUssdRequest;

    private bool mIsCallFwdReg;
    State mState = State.PENDING;
    CharSequence mMessage;
    private bool mIsSsInfo = false;
...
*/
    ...
    newNetworkInitiatedUssd(String ussdMessage,
                            bool isUssdRequest, GsmCdmaPhone phone, UiccCardApplication app) {
        GsmMmiCode ret;
        ...
        switch (ssData.requestType) {
            ...
            case SS_ERASURE:
                if ((ssData.result == RILConstants.SUCCESS) &&
                     ...
                     */
                    bool cffEnabled = ((ssData.requestType == SsData.RequestType.SS_ACTIVATION ||
    ...
    private bool isServiceClassVoiceorNone(int serviceClass) {
...
*/
     ...
     * such.
     */
    static private bool isShortCode(String dialString, GsmCdmaPhone phone) {
     ...
     */
    static private bool isShortCodeUSSD(String dialString, GsmCdmaPhone phone) {
     ...
     */
    public bool isPendingUSSD() {
        return mIsPendingUSSD;
    }

    override
    public bool isUssdRequest() {
        return mIsUssdRequest;
    }

    public bool isSsInfo() {
        return mIsSsInfo;
    }

    public static bool isVoiceUnconditionalForwarding(int reason, int serviceClass) {
     ...
     */
    public void
    onUssdFinished(String ussdMessage, bool isUssdRequest) {
        ...
        if (ar.exception != null) {
            ...
            if (ints.length != 0) {
                if (ints[0] == 0) {
                    ...
                    // for all other services, treat it as a bool
