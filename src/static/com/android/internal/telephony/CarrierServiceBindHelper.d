...
public class CarrierServiceBindHelper {
    ...
    private class CarrierServiceConnection : ServiceConnection {
    ...
    private class CarrierServicePackageMonitor : PackageMonitor {
        override
        ...
        private void evaluateBinding(String carrierPackageName, bool forceUnbind) {
            for (AppBinding appBinding : mBindings) {
                String appBindingPackage = appBinding.getPackage();
                bool isBindingForPackage = carrierPackageName.equals(appBindingPackage);
