...
public class RetryManager {
    ...
    public static final bool DBG = true;
    public static final bool VDBG = false; // STOPSHIP if true
     ...
     */
    private bool mRetryForever = false;
     ...
     */
    private bool configure(String configStr) {
     ...
     * @return Pair.first
     */
    private bool validateNonNegativeInt(String name, int value) {
        bool retVal;
        if (value < 0) {
