...
public class WspTypeDecoder {
     ...
     */
    public bool decodeTextString(int startIndex) {
     ...
     */
    public bool decodeTokenText(int startIndex) {
        int index = startIndex;
        while (mWspData[index] != 0) {
            index++;
        }
     ...
     *         length of data in pdu can be retrieved by getDecodedDataLength() method
     */
    public bool decodeShortInteger(int startIndex) {
     ...
     *         length of data in pdu can be retrieved by getDecodedDataLength() method
     */
    public bool decodeLongInteger(int startIndex) {
     ...
     *         length of data in pdu can be retrieved by getDecodedDataLength() method
     */
    public bool decodeIntegerValue(int startIndex) {
     ...
     *         length of data in pdu can be retrieved by getDecodedDataLength() method
     */
    public bool decodeUintvarInteger(int startIndex) {
        int index = startIndex;
     ...
     *         length of data in pdu can be retrieved by getDecodedDataLength() method
     */
    public bool decodeValueLength(int startIndex) {
     ...
     */
    public bool decodeExtensionMedia(int startIndex) {
        int index = startIndex;
        mDataLength = 0;
        mStringValue = null;
     ...
     *         length of data in pdu can be retrieved by getDecodedDataLength() method
     */
    public bool decodeConstrainedEncoding(int startIndex) {
        if (decodeShortInteger(startIndex) == true) {
            mStringValue = null;
            return true;
        }
     ...
     */
    public bool decodeContentType(int startIndex) {
    ...
    private bool readContentParameters(int startIndex, int leftToRead, int accumulator) {
     ...
     */
    private bool decodeNoValue(int startIndex) {
     ...
     *         length of data in pdu can be retrieved by getDecodedDataLength() method
     */
    public bool decodeContentLength(int startIndex) {
     ...
     *         length of data in pdu can be retrieved by getDecodedDataLength() method
     */
    public bool decodeContentLocation(int startIndex) {
     ...
     *         length of data in pdu can be retrieved by getDecodedDataLength() method
     */
    public bool decodeXWapApplicationId(int startIndex) {
     ...
     */
    public bool seekXWapApplicationId(int startIndex, int endIndex) {
        int index = startIndex;
     ...
     *         length of data in pdu can be retrieved by getDecodedDataLength() method
     */
    public bool decodeXWapContentURI(int startIndex) {
        return decodeTextString(startIndex);
    }
     ...
     *         length of data in pdu can be retrieved by getDecodedDataLength() method
     */
    public bool decodeXWapInitiatorURI(int startIndex) {
        return decodeTextString(startIndex);
    }
