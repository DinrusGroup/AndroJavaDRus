...
public class TimeServiceHelper {
    ...
    public interface Listener {
         ...
         */
        void onTimeDetectionChange(bool enabled);

        /**
         * Automatic time zone detection has been enabled or disabled.
         */
        void onTimeZoneDetectionChange(bool enabled);
    }
     ...
     */
    public bool isTimeZoneSettingInitialized() {
     ...
     */
    public bool isTimeDetectionEnabled() {
        try {
     ...
     */
    public bool isTimeZoneDetectionEnabled() {
        try {
     ...
     */
    static bool isTimeZoneSettingInitializedStatic() {
