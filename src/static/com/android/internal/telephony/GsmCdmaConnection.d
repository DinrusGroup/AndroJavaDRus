 ...
 * {@hide}
 */
public class GsmCdmaConnection : Connection {
    ...
    private bool mIsEmergencyCall = false;
    ...
    public GsmCdmaConnection (GsmCdmaPhone phone, String dialString, GsmCdmaCallTracker ct,
                              GsmCdmaCall parent, bool isEmergencyCall) {
        super(phone.getPhoneType());
        createWakeLock(phone.getContext());
        acquireWakeLock();
    ...
    static bool equalsHandlesNulls(Object a, Object b) {
    ...
    update (DriverCall dc) {
        ...
        bool changed = false;
        bool wasConnectingInOrOut = isConnectingInOrOut();
        bool wasHolding = (getState() == GsmCdmaCall.State.HOLDING);
    ...
    private static bool isWait(char c) {
        return c == PhoneNumberUtils.WAIT;
    }

    private static bool isWild(char c) {
    ...
    private static int findNextPCharOrNonPOrNonWCharIndex(String phoneNumber, int currIndex) {
        bool wMatched = isWait(phoneNumber.charAt(currIndex));
