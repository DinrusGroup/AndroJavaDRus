...
public abstract class Phone : Handler : PhoneInternalInterface {
    ...
    private bool mDnsCheckDisabled;
    ...
    private bool mDoesRilSendMultipleCallRing;
    private int mCallRingContinueToken;
    private int mCallRingDelay;
    private bool mIsVoiceCapable = true;
    ...
    // subclasses
    protected bool mIsPhoneInEcmState = false;
    ...
    protected bool mIsVideoCapable = false;
    ...
    private bool mImsServiceReady = false;
    ...
    private static final bool LCE_PULL_MODE = true;
     ...
     */
    public bool supportsConversionOfCdmaCallerIdMmiCodesWhileRoaming() {
     ...
     */
    public void disableDnsCheck(bool b) {
        mDnsCheckDisabled = b;
     ...
     */
    public bool isDnsCheckDisabled() {
     ...
     * is complete.
     *
     * @see #selectNetworkManually(OperatorInfo, bool, android.os.Message)
     */
     ...
     */
    private void setUnitTestMode(bool f) {
        mUnitTestMode = f;
    }
     ...
     *  Message.obj will be an AsyncResult
     *  AsyncResult.userObj = obj
     *  AsyncResult.result = bool, true to start play ringback tone
     *                       and false to stop. <p>
     */
     ...
     *  Message.obj will be an AsyncResult
     *  AsyncResult.userObj = obj
     *  AsyncResult.result = bool, true to start play on-hold tone
     *                       and false to stop. <p>
     */
    ...
    */
    ...
    private void setCallForwardingIndicatorInSharedPref(bool enable) {
    ...
    public void setVoiceCallForwardingFlag(int line, bool enable, String number) {
    ...
    protected void setVoiceCallForwardingFlag(IccRecords r, int line, bool enable,
                                              String number) {
        setCallForwardingIndicatorInSharedPref(enable);
        r.setVoiceCallForwardingFlag(line, enable, number);
    }
     ...
     * @param onComplete a callback message when the action is completed.
     */
    public void enableEnhancedVoicePrivacy(bool enable, Message onComplete) {
    }
    ...
    public void notifyUserMobileDataStateChanged(bool state) {
    ...
    // phones
    protected static bool getInEcmMode() {
    ...
    public void setIsInEcm(bool isInEcm) {
     ...
     */
    private bool isVideoCallOrConference(Call call) {
        if (call.isMultiparty()) {
            return true;
        }

        bool isDowngradedVideoCall = false;
     ...
     */
    public bool isImsVideoCallOrConferencePresent() {
     ...
     */
    public  bool isOtaSpNumber(String dialStr) {
        return false;
    }
     ...
     * @return True if data is allowed to be established
     */
    public bool isDataAllowed(DataConnectionReasons reasons) {
     ...
     */
    public void carrierActionSetMeteredApnsEnabled(bool enabled) {
     ...
     */
    public void carrierActionSetRadioEnabled(bool enabled) {
     ...
     */
    public void carrierActionReportDefaultNetworkStatus(bool report) {
     ...
     */
    public void notifyForVideoCapabilityChanged(bool isVideoCallCapable) {
     ...
     */
    public bool setOperatorBrandOverride(String brand) {
        return false;
    }
     ...
     */
    public bool setRoamingOverride(List<String> gsmRoamingList,
     ...
     */
    public bool isWifiCallingEnabled() {
        Phone imsPhone = mImsPhone;
        bool isWifiCallingEnabled = false;
        if (imsPhone != null) {
    ...
    private bool getRoamingOverrideHelper(String prefix, String key) {
        String iccId = getIccSerialNumber();
    ...
    public void radioCapabilityUpdated(RadioCapability rc) {
        ...
        if (SubscriptionManager.isValidSubscriptionId(getSubId())) {
            bool restoreSelection = !mContext.getResources().getBoolean(
                    com.android.internal.R.bool.skip_restoring_network_selection);
            sendSubscriptionSettings(restoreSelection);
        }
    }

    public void sendSubscriptionSettings(bool restoreNetworkSelection) {
        // Send settings down
     ...
     */
    public bool isImsUseEnabled() {
        ImsManager imsManager = ImsManager.getInstance(mContext, mPhoneId);
        bool imsUseEnabled = ((imsManager.isVolteEnabledByPlatform()
    ...
    public void setInternalDataEnabled(bool enable, Message onCompleteMsg) {
        mDcTracker.setInternalDataEnabled(enable, onCompleteMsg);
    }

    public bool updateCurrentCarrierInProvider() {
        return false;
    }
    ...
    protected bool isMatchGid(String gid) {
    ...
    public static void checkWfcWifiOnlyModeBeforeDial(Phone imsPhone, int phoneId, Context context)
        ...
        if (imsPhone == null || !imsPhone.isWifiCallingEnabled()) {
            ...
            bool wfcWiFiOnly = (imsManager.isWfcEnabledByPlatform()
    ...
    /**
     * Set bool broadcastEmergencyCallStateChanges
     */
    public abstract void setBroadcastEmergencyCallStateChanges(bool broadcast);

    public abstract void sendEmergencyCallStateChange(bool callActive);
