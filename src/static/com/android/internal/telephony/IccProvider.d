 ...
 * {@hide}
 */
public class IccProvider : ContentProvider {
    ...
    public Uri insert(Uri url, ContentValues initialValues) {
        ...
        bool success = addIccRecordToEf(efType, tag, number, null, pin2, subId);
    ...
    public int delete(Uri url, String where, String[] whereArgs) {
        ...
        bool success = deleteIccRecordFromEf(efType, tag, number, emails, pin2, subId);
        if (!success) {
            return 0;
        }
    ...
    public int update(Uri url, ContentValues values, String where, String[] whereArgs) {
        ...
        bool success = updateIccRecordInEf(efType, tag, number,
    ...
    private bool deleteIccRecordFromEf(int efType, String name, String number, String[] emails,
            String pin2, int subId) {
