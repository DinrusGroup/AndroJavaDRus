...
public class Sms7BitEncodingTranslator {
    ...
    private static bool mIs7BitTranslationTableLoaded = false;
    ...
    public static String translate(CharSequence message) {
        ...
        if ((mTranslationTableCommon != null && mTranslationTableCommon.size() > 0) ||
            ...
            bool isCdmaFormat = useCdmaFormatForMoSms();
     ...
     *         character
     */
    private static char translateIfNeeded(char c, bool isCdmaFormat) {
    ...
    private static bool noTranslationNeeded(char c, bool isCdmaFormat) {
        if (isCdmaFormat) {
