 ...
 *
 */
public class SmsDispatchersController : Handler {
     ...
     */
    public bool isCdmaFormat(String format) {
     ...
     * @return a Pair in which the first bool is whether the report was handled successfully
     *          or not and the second bool is whether processing the sms is complete and the
    ...
    private Pair<Boolean, Boolean> handleCdmaStatusReport(SMSDispatcher.SmsTracker tracker,
        ...
        bool success = triggerDeliveryIntent(tracker, format, pdu);
    ...
    private bool triggerDeliveryIntent(SMSDispatcher.SmsTracker tracker, String format,
                                          byte[] pdu) {
