 ...
 *@hide
 */
public class SubscriptionInfoUpdater : Handler {
    ...
    private bool isAllIccIdQueryDone() {
    ...
    public bool updateEmbeddedSubscriptions() {
        ...
        final bool isRemovable = result.getIsRemovable();
    ...
    private bool isNewSim(String iccId, String decIccId, String[] oldIccId) {
        bool newSim = true;
        for(int i = 0; i < PROJECT_SIM_NUM; i++) {
