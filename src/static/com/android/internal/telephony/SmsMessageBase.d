...
public abstract class SmsMessageBase {
    ...
    // 23.038 Section 4
    /** {@hide} */
    protected bool mIsMwi;

    /** {@hide} */
    protected bool mMwiSense;

    /** {@hide} */
    protected bool mMwiDontStore;
     ...
     * SMS
     */
    public abstract bool isReplace();
     ...
     *         B.4.2
     */
    public abstract bool isCphsMwiMessage();

    /**
     * returns true if this message is a CPHS voicemail / message waiting
     * indicator (MWI) clear message
     */
    public abstract bool isMWIClearMessage();

    /**
     * returns true if this message is a CPHS voicemail / message waiting
     * indicator (MWI) set message
     */
    public abstract bool isMWISetMessage();

    /**
     * returns true if this message is a "Message Waiting Indication Group:
     * Discard Message" notification and should not be stored.
     */
    public abstract bool isMwiDontStore();
     ...
     */
    public abstract bool isStatusReportMessage();

    /**
     * Returns true iff the <code>TP-Reply-Path</code> bit is set in
     * this message.
     */
    public abstract bool isReplyPathPresent();
