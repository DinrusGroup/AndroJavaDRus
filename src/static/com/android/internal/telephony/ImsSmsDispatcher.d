 ...
 * @hide
 */
public class ImsSmsDispatcher : SMSDispatcher {
    ...
    private volatile bool mIsSmsCapable;
    private volatile bool mIsImsServiceUp;
    private volatile bool mIsRegistered;
    ...
    override
    protected bool shouldBlockSmsForEcbm() {
    ...
    override
    protected TextEncodingDetails calculateLength(CharSequence messageBody, bool use7bitOnly) {
    ...
    public void sendSms(SmsTracker tracker) {
        ...
        bool isRetry = tracker.mRetryCount > 0;
        ...
        if (SmsConstants.FORMAT_3GPP.equals(getFormat()) && tracker.mRetryCount > 0) {
            ...
            if (((0x01 & pdu[0]) == 0x01)) {
                pdu[0] |= 0x04; // TP-RD
                pdu[1] = cast(byte) tracker.mMessageRef; // TP-MR
            }
        }
