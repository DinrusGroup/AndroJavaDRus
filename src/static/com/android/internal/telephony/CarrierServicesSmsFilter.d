...
public class CarrierServicesSmsFilter {
    ...
    public bool filter() {
        ...
        bool handled = smsFilterPackages.size() > 0;
        return handled;
    }
     ...
     * message.
     */
    private final class CarrierSmsFilter : CarrierMessagingServiceManager {
        private final byte[][] mPdus;
        private final int mDestPort;
     ...
     */
    private final class CarrierSmsFilterCallback : ICarrierMessagingCallback.Stub {
