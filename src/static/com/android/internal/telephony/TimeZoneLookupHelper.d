...
public class TimeZoneLookupHelper {
    ...
    public static final class OffsetResult {
        ...
        public final bool isOnlyMatch;

        public OffsetResult(String zoneId, bool isOnlyMatch) {
            this.zoneId = zoneId;
    ...
    public static final class CountryResult {
         ...
         */
        public final bool allZonesHaveSameOffset;

        /** The time associated with {@link #allZonesHaveSameOffset}. */
        public final long whenMillis;

        public CountryResult(String zoneId, bool allZonesHaveSameOffset, long whenMillis) {
            this.zoneId = zoneId;
     ...
     */
    public bool countryUsesUtc(String isoCountryCode, long whenMillis) {
