...
public class SimulatedCommands : BaseCommands
        : CommandsInterface, SimulatedRadioControl {
    ...
    private bool mDcSuccess = true;
    private SetupDataCallResult mSetupDataCallResult;
    private bool mIsRadioPowerFailResponse = false;
    ...
    override
    public void
    setSuppServiceNotifications(bool enable, Message result) {
        resultSuccess(result, null);
    ...
    override
    public void setFacilityLock(String facility, bool lockEnabled, String pin, int serviceClass,
            Message result) {
        setFacilityLockForApp(facility, lockEnabled, pin, serviceClass, null, result);
    }

    override
    public void setFacilityLockForApp(String facility, bool lockEnabled,
    ...
    override
    public void setMute (bool enableMute, Message result) {unimplemented(result);}
    ...
    public void setDataCallResult(final bool success, final SetupDataCallResult dcResult) {
    ...
    override
    public void
    setAutoProgressConnectingCall(bool b) {
        simulatedCallState.setAutoProgressConnectingCall(b);
    }

    override
    public void
    setNextDialFailImmediately(bool b) {
    ...
    override
    public void startLceService(int report_interval_ms, bool pullMode, Message result) {
    ...
    public void setRadioPowerFailResponse(bool fail) {
