 ...
 * {@hide}
 */
public class SipPhone : SipPhoneBase {
    ...
    public bool equals(SipPhone phone) {
        ...
        synchronized (SipPhone.class) {
            ...
            try {
                ...
                if (localUri.equals(mProfile.getUriString())) {
                    bool makeCallWait = mForegroundCall.getState().isAlive();
    ...
    private synchronized bool isHoldTimeoutExpired() {
    ...
    private class SipCall : SipCallBase {
        private static final String SC_TAG = "SipCall";
        private static final bool SC_DBG = true;
        private static final bool SC_VDBG = false; // STOPSHIP if true
        ...
        SipConnection initIncomingCall(SipAudioCall sipAudioCall, bool makeCallWait) {
        ...
        void onConnectionEnded(SipConnection conn) {
            ...
            if (mState != State.DISCONNECTED) {
                bool allConnectionsDisconnected = true;
    ...
    private class SipConnection : SipConnectionBase {
        private static final String SCN_TAG = "SipConnection";
        private static final bool SCN_DBG = true;

        private SipCall mOwner;
        private SipAudioCall mSipAudioCall;
        private Call.State mState = Call.State.IDLE;
        private SipProfile mPeer;
        private bool mIncoming = false;
    ...
    private abstract class SipAudioCallAdapter : SipAudioCall.Listener {
        private static final String SACA_TAG = "SipAudioCallAdapter";
        private static final bool SACA_DBG = true;
