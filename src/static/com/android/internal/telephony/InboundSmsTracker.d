...
public class InboundSmsTracker {
    ...
    private final bool mIs3gpp2;
    private final bool mIs3gpp2WapPdu;
     ...
     */
    public InboundSmsTracker(byte[] pdu, long timestamp, int destPort, bool is3gpp2,
            bool is3gpp2WapPdu, String address, String displayAddress, String messageBody) {
        mPdu = pdu;
    ...
    public InboundSmsTracker(byte[] pdu, long timestamp, int destPort, bool is3gpp2,
            ...
            int messageCount, bool is3gpp2WapPdu, String messageBody) {
        mPdu = pdu;
        mTimestamp = timestamp;
        mDestPort = destPort;
        mIs3gpp2 = is3gpp2;
     ...
     */
    public InboundSmsTracker(Cursor cursor, bool isCurrentFormat3gpp2) {
