...
class CommandParamsFactory : Handler {
     ...
     */
    private bool processDisplayText(CommandDetails cmdDet,
            List<ComprehensionTlv> ctlvs)
            throws ResultException {
     ...
     * @throws ResultException
     */
    private bool processSetUpIdleModeText(CommandDetails cmdDet,
     ...
     * @throws ResultException
     */
    private bool processGetInkey(CommandDetails cmdDet,
            List<ComprehensionTlv> ctlvs) throws ResultException {
     ...
     * @throws ResultException
     */
    private bool processGetInput(CommandDetails cmdDet,
            List<ComprehensionTlv> ctlvs) throws ResultException {
     ...
     *        object and Device Identities object within the proactive command
     */
    private bool processRefresh(CommandDetails cmdDet,
            List<ComprehensionTlv> ctlvs) {
     ...
     * @throws ResultException
     */
    private bool processSelectItem(CommandDetails cmdDet,
            List<ComprehensionTlv> ctlvs) throws ResultException {
        ...
        bool presentTypeSpecified = (cmdDet.commandQualifier & 0x01) != 0;
     ...
     *         asynchronous processing is required.
     */
    private bool processEventNotify(CommandDetails cmdDet,
            List<ComprehensionTlv> ctlvs) throws ResultException {
     ...
     *         is not required.
     */
    private bool processSetUpEventList(CommandDetails cmdDet,
            List<ComprehensionTlv> ctlvs) {
     ...
     * @throws ResultException
     */
    private bool processLaunchBrowser(CommandDetails cmdDet,
            List<ComprehensionTlv> ctlvs) throws ResultException {
     ...
     * @throws ResultException
     */
    private bool processPlayTone(CommandDetails cmdDet,
            List<ComprehensionTlv> ctlvs) throws ResultException {
        ...
        bool vibrate = (cmdDet.commandQualifier & 0x01) != 0x00;
     ...
     *         asynchronous processing is required.
     */
    private bool processSetupCall(CommandDetails cmdDet,
            List<ComprehensionTlv> ctlvs) throws ResultException {
    ...
    private bool processProvideLocalInfo(CommandDetails cmdDet, List<ComprehensionTlv> ctlvs)
            throws ResultException {
     ...
     *         is not required.
     */
    private bool processLanguageNotification(CommandDetails cmdDet, List<ComprehensionTlv> ctlvs)
            throws ResultException {
    ...
    private bool processBIPClient(CommandDetails cmdDet,
                                     List<ComprehensionTlv> ctlvs) throws ResultException {
