 ...
 */
class RilMessageDecoder : StateMachine {
    ...
    private class StateStart : State {
        override
    ...
    private class StateCmdParamsReady : State {
        override
        public bool processMessage(Message msg) {
    ...
    private bool decodeMessageParams(RilMessage rilMsg) {
