...
/**
 * Class that : SIM Toolkit Telephony Service. Interacts with the RIL
 * and application.
 *
 * {@hide}
 */
public class CatService : Handler : AppInterface {
    ...
    private bool mStkAppInstalled = false;
     ...
     */
    private bool isSupportedSetupEventCommand(CatCmdMessage cmdMsg) {
        bool flag = true;
     ...
     */
    private void handleCommand(CommandParams cmdParams, bool isProactiveCmd) {
    ...
    private void sendTerminalResponse(CommandDetails cmdDet,
            ResultCode resultCode, bool includeAdditionalInfo,
    ...
    private void sendMenuSelection(int menuId, bool helpRequired) {
    ...
    private void eventDownload(int event, int sourceId, int destinationId,
            byte[] additionalInfo, bool oneShot) {
    ...
    private void  broadcastCardStateAndIccRefreshResp(CardState cardState,
        ...
        bool cardPresent = (cardState == CardState.CARDSTATE_PRESENT);
    ...
    private bool validateResponse(CatResponseMessage resMsg) {
    ...
    private bool isStkAppInstalled() {
        Intent intent = new Intent(AppInterface.CAT_CMD_ACTION);
