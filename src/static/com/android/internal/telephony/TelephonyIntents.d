...
public class TelephonyIntents {
     ...
     *   <li><em>roaming</em> - A bool value indicating whether the phone is roaming.</li>
     ...
     *   <li><em>manual</em> - A bool, where true indicates that the user has chosen to select
     ...
     * <ul>
     *   <li><em>phoneinECMState</em> - A bool value,true=phone in ECM, false=ECM off</li>
     * </ul>
     * <p class="note">
     * You can <em>not</em> receive this through components declared
     * in manifests, only by explicitly registering for it with
     ...
     * <ul>
     *   <li><em>phoneInEmergencyCall</em> - A bool value, true if phone in emergency call,
     *   false otherwise</li>
     * </ul>
     * <p class="note">
     * You can <em>not</em> receive this through components declared
     ...
     *   <dd>A bool indicates a rebroadcast on unlock. optional extra, defaults to {@code false}
     *   if not specified </dd>
     * </dl>
     *
     * <p class="note">
     ...
     * The intent will have the following extra values:</p>
     * <ul>
     *   <li>defaultNetworkAvailable</li><dd>A bool indicates default network available.</dd>
