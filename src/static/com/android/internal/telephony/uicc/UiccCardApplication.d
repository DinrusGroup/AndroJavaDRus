...
public class UiccCardApplication {
    ...
    private bool       mPin1Replaced;
    private PinState      mPin1State;
    private PinState      mPin2State;
    private bool       mIccFdnEnabled;
    private bool       mDesiredFdnEnabled;
    private bool       mIccLockEnabled;
    private bool       mDesiredPinLocked;

    // App state will be ignored while deciding whether the card is ready or not.
    private bool       mIgnoreApp;
    private bool       mIccFdnAvailable = true; // Default is enabled.
    ...
    private bool mDestroyed;//set to true once this App is commanded to be disposed of.
     ...
     */
    public bool getIccFdnAvailable() {
     ...
     *        ((AsyncResult)onComplete.obj).exception != null on fail
     */
    public void setIccLockEnabled (bool enabled,
     ...
     *        ((AsyncResult)onComplete.obj).exception != null on fail
     */
    public void setIccFdnEnabled (bool enabled,
            String password, Message onComplete) {
        synchronized (mLock) {
            int serviceClassX;
            serviceClassX = CommandsInterface.SERVICE_CLASS_VOICE +
    ...
    public bool isAppIgnored() {
        return mIgnoreApp;
    }

    public void setAppIgnoreState(bool ignore) {
        mIgnoreApp = ignore;
    }
