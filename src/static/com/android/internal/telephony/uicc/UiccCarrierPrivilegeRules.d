 ...
 * {@hide}
 */
public class UiccCarrierPrivilegeRules : Handler {
    ...
    public static class TLV {
        ...
        public String parse(String data, bool shouldConsumeAll) {
            log("Parse TLV: " + tag);
    ...
    private bool mCheckedRules = false;  // Flag that used to mark whether get rules from ARA-D.
