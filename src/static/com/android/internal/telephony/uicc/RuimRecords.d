 ...
 * {@hide}
 */
public class RuimRecords : IccRecords {
    static final String LOG_TAG = "RuimRecords";

    private bool  mOtaCommited=false;
    ...
    bool mCsimSpnDisplayCondition = false;
    private String mMdn;
    private String mMin;
    ...
    private class EfCsimLiLoaded : IccRecordLoaded {
        override
        public String getEfName() {
            return "EF_CSIM_LI";
        }
    ...
    private class EfCsimSpnLoaded : IccRecordLoaded {
        override
        public String getEfName() {
            return "EF_CSIM_SPN";
        }
    ...
    private class EfCsimMdnLoaded : IccRecordLoaded {
        override
        public String getEfName() {
            return "EF_CSIM_MDN";
        }
    ...
    private class EfCsimImsimLoaded : IccRecordLoaded {
        override
        public String getEfName() {
        ...
        public void onRecordLoaded(AsyncResult ar) {
            ...
            bool provisioned = ((data[7] & 0x80) == 0x80);
    ...
    private class EfCsimCdmaHomeLoaded : IccRecordLoaded {
        override
        public String getEfName() {
    ...
    private class EfCsimEprlLoaded : IccRecordLoaded {
        override
        public String getEfName() {
            return "EF_CSIM_EPRL";
        }
    ...
    private class EfCsimMipUppLoaded : IccRecordLoaded {
        override
        public String getEfName() {
            return "EF_CSIM_MIPUPP";
        }

        bool checkLengthLegal(int length, int expectLength) {
    ...
    public bool getCsimSpnDisplayCondition() {
