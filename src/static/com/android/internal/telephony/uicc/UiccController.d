 ...
 */
public class UiccController : Handler {
    ...
    private bool mIsSlotStatusSupported = true;
    ...
    private synchronized void onGetSlotStatusDone(AsyncResult ar) {
        ...
        for (int i = 0; i < status.size(); i++) {
            ...
            bool isActive = (iss.slotState == IccSlotStatus.SlotState.SLOTSTATE_ACTIVE);
            if (isActive) {
                numActiveSlots++;
    ...
    private bool slotStatusChanged(ArrayList<IccSlotStatus> slotStatusList) {
    ...
    private void onSimRefresh(AsyncResult ar, Integer index) {
        ...
        if (changed && resp.refreshResult == IccRefreshResponse.REFRESH_RESULT_RESET) {
            ...
            bool requirePowerOffOnSimRefreshReset = mContext.getResources().getBoolean(
    ...
    private bool isValidPhoneIndex(int index) {
