 ...
 */
public class EuiccCard : UiccCard {
     ...
     * @since 1.1.0 [GSMA SGP.22]
     */
    public void disableProfile(String iccid, bool refresh, AsyncResultCallback<Void> callback,
            Handler handler) {
     ...
     * @since 1.1.0 [GSMA SGP.22]
     */
    public void switchToProfile(String iccid, bool refresh, AsyncResultCallback<Void> callback,
            Handler handler) {
        sendApduWithSimResetErrorWorkaround(
                newRequestProvider((RequestBuilder requestBuilder) -> {
                    byte[] iccidBytes = IccUtils.bcdToBytes(padTrailingFs(iccid));
