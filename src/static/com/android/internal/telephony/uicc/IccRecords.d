 ...
 * {@hide}
 */
public abstract class IccRecords : Handler : IccConstants {
    protected static final bool DBG = true;
    protected static final bool VDBG = false; // STOPSHIP if true
    ...
    protected bool mRecordsRequested = false; // true if we've made requests for the sim records
    ...
    protected bool mIsVoiceMailFixed = false;
     ...
     */
    public abstract void onRefresh(bool fileChanged, int[] fileList);

    public bool getRecordsLoaded() {
        return mRecordsToLoad == 0 && mRecordsRequested;
    }

    protected bool getLockedRecordsLoaded() {
        return mRecordsToLoad == 0
                && mLockedRecordsReqReason == LOCKED_RECORDS_REQ_REASON_LOCKED;
    }

    protected bool getNetworkLockedRecordsLoaded() {
        return mRecordsToLoad == 0
