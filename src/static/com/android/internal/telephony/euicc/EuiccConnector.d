 ...
 */
public class EuiccConnector : StateMachine : ServiceConnection {
    ...
    private static bool isEuiccCommand(int what) {
    ...
    @VisibleForTesting(visibility = PACKAGE)
    public interface GetEidCommandCallback : BaseEuiccCommandCallback {
    ...
    @VisibleForTesting(visibility = PACKAGE)
    public interface GetOtaStatusCommandCallback : BaseEuiccCommandCallback {
    ...
    @VisibleForTesting(visibility = PACKAGE)
    public interface OtaStatusChangedCallback : BaseEuiccCommandCallback {
        /**
    ...
    @VisibleForTesting(visibility = PACKAGE)
    public interface DownloadCommandCallback : BaseEuiccCommandCallback {
        /** Called when the download has completed (though it may have failed). */
        void onDownloadComplete(int result);
    }

    interface GetEuiccProfileInfoListCommandCallback : BaseEuiccCommandCallback {
    ...
    @VisibleForTesting(visibility = PACKAGE)
    public interface GetDefaultListCommandCallback : BaseEuiccCommandCallback {
        /** Called when the list has completed (though it may have failed). */
    ...
    @VisibleForTesting(visibility = PACKAGE)
    public interface GetEuiccInfoCommandCallback : BaseEuiccCommandCallback {
    ...
    @VisibleForTesting(visibility = PACKAGE)
    public interface DeleteCommandCallback : BaseEuiccCommandCallback {
    ...
    @VisibleForTesting(visibility = PACKAGE)
    public interface SwitchCommandCallback : BaseEuiccCommandCallback {
    ...
    @VisibleForTesting(visibility = PACKAGE)
    public interface UpdateNicknameCommandCallback : BaseEuiccCommandCallback {
    ...
    @VisibleForTesting(visibility = PACKAGE)
    public interface EraseCommandCallback : BaseEuiccCommandCallback {
    ...
    @VisibleForTesting(visibility = PACKAGE)
    public interface RetainSubscriptionsCommandCallback : BaseEuiccCommandCallback {
    ...
    public void getDownloadableSubscriptionMetadata(DownloadableSubscription subscription,
            bool forceDeactivateSim, GetMetadataCommandCallback callback) {
    ...
    public void downloadSubscription(DownloadableSubscription subscription,
            bool switchAfterDownload, bool forceDeactivateSim,
    ...
    public void getDefaultDownloadableSubscriptionList(
            bool forceDeactivateSim, GetDefaultListCommandCallback callback) {
    ...
    @VisibleForTesting(visibility = PACKAGE)
    public void switchToSubscription(@Nullable String iccid, bool forceDeactivateSim,
     ...
     * available.
     */
    private class UnavailableState : State {
        override
     ...
     */
    private class AvailableState : State {
        override
        public bool processMessage(Message message) {
     ...
     */
    private class BindingState : State {
        override
        public void enter() {
            if (createBinding()) {
    ...
    private class DisconnectedState : State {
        ...
        public bool processMessage(Message message) {
            if (message.what == CMD_SERVICE_CONNECTED) {
                ...
                bool forceRebind = bestComponent != null
    ...
    private static bool isValidEuiccComponent(
    ...
    private class EuiccPackageMonitor : PackageMonitor {
        override
        ...
        private void sendPackageChange(String packageName, bool forceUnbindForThisPackage) {
