...
public class EuiccOperation : Parcelable {
    ...
    private void resolvedGetMetadataDeactivateSim(
            bool consent, PendingIntent callbackIntent) {
        if (consent) {
    ...
    private void resolvedDownloadNoPrivileges(bool consent, PendingIntent callbackIntent) {
        if (consent) {
    ...
    private void resolvedSwitchNoPrivileges(bool consent, PendingIntent callbackIntent) {
        if (consent) {
