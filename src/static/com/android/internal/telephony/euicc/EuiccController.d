...
public class EuiccController : IEuiccController.Stub {
    ...
    void getDownloadableSubscriptionMetadata(DownloadableSubscription subscription,
            bool forceDeactivateSim, String callingPackage, PendingIntent callbackIntent) {
        if (!callerCanWriteEmbeddedSubscriptions()) {
    ...
    class GetMetadataCommandCallback : EuiccConnector.GetMetadataCommandCallback {
    ...
    public void downloadSubscription(DownloadableSubscription subscription,
            bool switchAfterDownload, String callingPackage, PendingIntent callbackIntent) {
    ...
    void downloadSubscription(DownloadableSubscription subscription,
            bool switchAfterDownload, String callingPackage, bool forceDeactivateSim,
            PendingIntent callbackIntent) {
        bool callerCanWriteEmbeddedSubscriptions = callerCanWriteEmbeddedSubscriptions();
        mAppOpsManager.checkPackage(Binder.getCallingUid(), callingPackage);
    ...
    class DownloadSubscriptionGetMetadataCommandCallback : GetMetadataCommandCallback {
        private final bool mSwitchAfterDownload;
        private final bool mForceDeactivateSim;

        DownloadSubscriptionGetMetadataCommandCallback(long callingToken,
                DownloadableSubscription subscription, bool switchAfterDownload,
                String callingPackage, bool forceDeactivateSim,
                PendingIntent callbackIntent) {
    ...
    void downloadSubscriptionPrivileged(final long callingToken,
            DownloadableSubscription subscription, bool switchAfterDownload,
            bool forceDeactivateSim, final String callingPackage,
    ...
    class GetDefaultListCommandCallback : EuiccConnector.GetDefaultListCommandCallback {
    ...
    void switchToSubscription(int subscriptionId, bool forceDeactivateSim, String callingPackage,
            PendingIntent callbackIntent) {
        bool callerCanWriteEmbeddedSubscriptions = callerCanWriteEmbeddedSubscriptions();
        mAppOpsManager.checkPackage(Binder.getCallingUid(), callingPackage);
    ...
    void switchToSubscriptionPrivileged(final long callingToken, int subscriptionId,
            @Nullable String iccid, bool forceDeactivateSim, final String callingPackage,
            final PendingIntent callbackIntent) {
    ...
    public void addResolutionIntent(Intent extrasIntent, String resolutionAction,
            String callingPackage, bool confirmationCodeRetried, EuiccOperation op) {
    ...
    private bool canManageActiveSubscription(String callingPackage) {
    ...
    private bool callerCanReadPhoneStatePrivileged() {
        return mContext.checkCallingPermission(Manifest.permission.READ_PRIVILEGED_PHONE_STATE)
                == PackageManager.PERMISSION_GRANTED;
    }

    private bool callerCanWriteEmbeddedSubscriptions() {
     ...
     */
    private bool callerHasCarrierPrivilegesForActiveSubscription() {
        // TODO(b/36260308): We should plumb a slot ID through here for multi-SIM devices.
        TelephonyManager tm =
