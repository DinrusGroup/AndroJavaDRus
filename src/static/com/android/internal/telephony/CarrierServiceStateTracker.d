 ...
 * {@hide}
 */
public class CarrierServiceStateTracker : Handler {
    ...
    private bool isPhoneStillRegistered() {
        if (mSST.mSS == null) {
    ...
    private bool isPhoneVoiceRegistered() {
        if (mSST.mSS == null) {
            return true; //something has gone wrong, return true and not show the notification.
        }
        return (mSST.mSS.getVoiceRegState() == ServiceState.STATE_IN_SERVICE);
    ...
    private bool isPhoneRegisteredForWifiCalling() {
     ...
     */
    @VisibleForTesting
    public bool isRadioOffOrAirplaneMode() {
     ...
     **/
    @VisibleForTesting
    public bool evaluateSendingMessage(NotificationType notificationType) {
    ...
    public interface NotificationType {
        ...
        /**
         * decides if the message should be sent, Returns bool
         **/
        bool sendMessage();
     ...
     */
    public class PrefNetworkNotification : NotificationType {
     ...
     */
    public class EmergencyNetworkNotification : NotificationType {
