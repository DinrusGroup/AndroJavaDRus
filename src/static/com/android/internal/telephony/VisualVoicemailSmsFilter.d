...
public class VisualVoicemailSmsFilter {
     ...
     */
    public static bool filter(Context context, byte[][] pdus, String format, int destPort,
            int subId) {
    ...
    private static bool isSmsFromNumbers(SmsMessage message, List<String> numbers) {
        if (message == null) {
