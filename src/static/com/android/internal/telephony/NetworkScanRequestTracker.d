...
public final class NetworkScanRequestTracker {
    ...
    private bool isValidScan(NetworkScanRequestInfo nsri) {
    ...
    */
    class NetworkScanRequestInfo : IBinder.DeathRecipient {
        ...
        synchronized void setIsBinderDead(bool val) {
            mIsBinderDead = val;
        }

        synchronized bool getIsBinderDead() {
    ...
    private class NetworkScanRequestScheduler {
        ...
        private synchronized bool interruptLiveScan(NetworkScanRequestInfo nsri) {
        ...
        private bool cacheScan(NetworkScanRequestInfo nsri) {
            // TODO(30954762): Cache periodic scan for OC-MR1.
            return false;
        }

        // Starts a new scan with nsri if there is no live scan running.
        private synchronized bool startNewScan(NetworkScanRequestInfo nsri) {
