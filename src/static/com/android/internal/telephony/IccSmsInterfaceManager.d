...
public class IccSmsInterfaceManager {
     ...
     *
     */
    public bool copyMessageToIccEf(String callingPackage, int status, byte[] pdu, byte[] smsc) {
    ...
    private void sendTextInternal(String callingPackage, String destAddr, String scAddr,
            String text, PendingIntent sentIntent, PendingIntent deliveryIntent,
            bool persistMessageForNonDefaultSmsApp, int priority, bool expectMore,
            int validityPeriod) {
        if (Rlog.isLoggable("SMS", Log.VERBOSE)) {
    ...
    public void sendMultipartTextWithOptions(String callingPackage, String destAddr,
            ...
            List<PendingIntent> deliveryIntents, bool persistMessageForNonDefaultSmsApp,
            int priority, bool expectMore, int validityPeriod) {
        if (!checkCallingSendTextPermissions(
                persistMessageForNonDefaultSmsApp, callingPackage, "Sending SMS message")) {
            return;
        }
    ...
    public bool enableCellBroadcast(int messageIdentifier, int ranType) {
        return enableCellBroadcastRange(messageIdentifier, messageIdentifier, ranType);
    }

    public bool disableCellBroadcast(int messageIdentifier, int ranType) {
        return disableCellBroadcastRange(messageIdentifier, messageIdentifier, ranType);
    }

    public bool enableCellBroadcastRange(int startMessageId, int endMessageId, int ranType) {
    ...
    public bool disableCellBroadcastRange(int startMessageId, int endMessageId, int ranType) {
        if (ranType == SmsManager.CELL_BROADCAST_RAN_TYPE_GSM ) {
    ...
    synchronized public bool enableGsmBroadcastRange(int startMessageId, int endMessageId) {
    ...
    synchronized public bool disableGsmBroadcastRange(int startMessageId, int endMessageId) {
    ...
    synchronized public bool enableCdmaBroadcastRange(int startMessageId, int endMessageId) {
    ...
    synchronized public bool disableCdmaBroadcastRange(int startMessageId, int endMessageId) {
    ...
    class CellBroadcastRangeManager : IntRangeManager {
         ...
         */
        protected void addRange(int startId, int endId, bool selected) {
    ...
    class CdmaBroadcastRangeManager : IntRangeManager {
    ...
    private bool setCellBroadcastConfig(SmsBroadcastConfigInfo[] configs) {
        if (DBG)
    ...
    private bool setCellBroadcastActivation(bool activate) {
        if (DBG)
    ...
    private bool setCdmaBroadcastConfig(CdmaSmsBroadcastConfigInfo[] configs) {
        if (DBG)
    ...
    private bool setCdmaBroadcastActivation(bool activate) {
        if (DBG)
    ...
    private bool isFailedOrDraft(ContentResolver resolver, Uri messageUri) {
     ...
     */
    @VisibleForTesting
    public bool checkCallingSendTextPermissions(
            bool persistMessageForNonDefaultSmsApp, String callingPackage, String message) {
     ...
     */
    private bool checkCallingOrSelfSendSmsPermission(String callingPackage, String message) {
     ...
     * @return whether the caller has the OP_SEND_SMS AppOps bit.
     */
    private bool checkCallingSendSmsPermission(String callingPackage, String message) {
