...
public class ApnSetting {
    ...
    /**
      ...
      */
    public final bool carrierEnabled;
    /**
    ...
    public final bool modemCognitive;
     ...
     * */
    public bool permanentFailed = false;
    ...
    public ApnSetting(int id, String numeric, String carrier, String apn,
                      ...
                      String protocol, String roamingProtocol, bool carrierEnabled, int bearer,
                      int bearerBitmask, int profileId, bool modemCognitive, int maxConns,
    ...
    public ApnSetting(int id, String numeric, String carrier, String apn,
                      ...
                      String mmsc, String mmsProxy, String mmsPort,
                      String user, String password, int authType, String[] types,
                      String protocol, String roamingProtocol, bool carrierEnabled,
                      int networkTypeBitmask, int profileId, bool modemCognitive, int maxConns,
                      int waitTime, int maxConnsTime, int mtu, String mvnoType,
                      String mvnoMatchData) {
    ...
    private static bool iccidMatches(String mvnoData, String iccId) {
    ...
    private static bool imsiMatches(String imsiDB, String imsiSIM) {
    ...
    public static bool mvnoMatches(IccRecords r, String mvnoType, String mvnoMatchData) {
     ...
     */
    public static bool isMeteredApnType(String type, Phone phone) {
        if (phone == null) {
            return true;
        }

        bool isRoaming = phone.getServiceState().getDataRoaming();
        bool isIwlan = phone.getServiceState().getRilDataRadioTechnology()
     ...
     */
    public bool isMetered(Phone phone) {
        if (phone == null) {
            return true;
        }
    ...
    public bool equals(Object o, bool isDataRoaming) {
     ...
     */
    public bool similar(ApnSetting other) {
    ...
    private bool typeSameAny(ApnSetting first, ApnSetting second) {
        if (VDBG) {
    ...
    private bool xorEquals(String first, String second) {
