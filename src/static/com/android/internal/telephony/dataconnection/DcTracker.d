 ...
 * {@hide}
 */
public class DcTracker : Handler {
    ...
    private static final bool VDBG_STALL = false; // STOPSHIP if true
    private static final bool RADIO_TESTS = false;
    ...
    private static final bool DATA_STALL_SUSPECTED = true;
    private static final bool DATA_STALL_NOT_SUSPECTED = false;
    ...
    private bool mIsPsRestricted = false;
    ...
    private bool mIsProvisioning = false;
    ...
    private bool mNetStatPollEnabled = false;
    ...
    private volatile bool mDataStallDetectionEnabled = true;

    private volatile bool mFailFast = false;

    // True when in voice call
    private bool mInVoiceCall = false;

    /** Intent sent when the reconnect alarm fires. */
    private PendingIntent mReconnectIntent = null;

    // When false we will not auto attach and manually attaching is required.
    private bool mAutoAttachOnCreationConfig = false;
    private AtomicBoolean mAutoAttachOnCreation = new AtomicBoolean(false);

    // State of screen
    // (TODO: Reconsider tying directly to screen, maybe this is
    //        really a lower power mode")
    private bool mIsScreenOn = true;
    ...
    private bool mMvnoMatched = false;
    ...
    private bool mMeteredApnDisabled = false;
     ...
     */
    private class ApnChangeObserver : ContentObserver {
    ...
    private bool mReregisterOnReconnectFailure = false;
    ...
    private bool mCanSetPreferApn = false;
    ...
    private void onSetUserDataEnabled(bool enabled) {
    ...
    public bool isApnSupported(String name) {
        if (name == null) {
    ...
    // notification.
    private class ProvisionNotificationBroadcastReceiver : BroadcastReceiver {
    ...
    private bool isProvisioningApn(String apnType) {
        ApnContext apnContext = mApnContexts.get(apnType);
        if (apnContext != null) {
    ...
    public DctConstants.State getOverallState() {
        ...
        bool isFailed = true; // All enabled Apns should be FAILED.
     ...
     */
    public bool isDataAllowed(DataConnectionReasons dataConnectionReasons) {
     ...
     * @return True if data connection is allowed, otherwise false.
     */
    bool isDataAllowed(ApnContext apnContext, DataConnectionReasons dataConnectionReasons) {
        ...
        // Step 1: Get all environment conditions.
        final bool internalDataEnabled = mDataEnabledSettings.isInternalDataEnabled();
        bool attachedState = mAttached.get();
        bool desiredPowerState = mPhone.getServiceStateTracker().getDesiredPowerState();
        bool radioStateFromCarrier = mPhone.getServiceStateTracker().getPowerStateFromCarrier();
        ...
        bool recordsLoaded = mIccRecords.get() != null && mIccRecords.get().getRecordsLoaded();

        bool defaultDataSelected = SubscriptionManager.isValidSubscriptionId(
                SubscriptionManager.getDefaultDataSubscriptionId());

        bool isMeteredApnType = apnContext == null
    ...
    bool isEmergency() {
        final bool result = mPhone.isInEcm() || mPhone.isInEmergencyCall();
        log("isEmergency: result=" + result);
        return result;
    }

    private bool trySetupData(ApnContext apnContext) {
        ...
        bool isDataAllowed = isDataAllowed(apnContext, dataConnectionReasons);
        ...
        if (isDataAllowed) {
            ...
            bool retValue = setupData(apnContext, radioTech, dataConnectionReasons.contains(
     ...
     * @return bool - true if we did cleanup any connections, false if they
     *                   were already all disconnected.
     */
    private bool cleanUpAllConnections(bool tearDown, String reason) {
        if (DBG) log("cleanUpAllConnections: tearDown=" + tearDown + " reason=" + reason);
        bool didDisconnect = false;
        bool disableMeteredOnly = false;
    ...
    void sendCleanUpConnection(bool tearDown, ApnContext apnContext) {
    ...
    private void cleanUpConnection(bool tearDown, ApnContext apnContext) {
        if (apnContext == null) {
    ...
    public bool hasMatchedTetherApnSetting() {
    ...
    bool isPermanentFailure(DcFailCause dcFailCause) {
    ...
    private bool dataConnectionNotInUse(DcAsyncChannel dcac) {
     ...
     */
    private bool setupData(ApnContext apnContext, int radioTech, bool unmeteredUseOnly) {
    ...
    private void onApnChanged() {
        ...
        bool isDisconnected = (overallState == DctConstants.State.IDLE ||
     ...
     */
    private bool isHigherPriorityApnContextActive(ApnContext apnContext) {
        if (apnContext.getApnType().equals(PhoneConstants.APN_TYPE_IMS)) {
            return false;
        }
     ...
     */
    private bool isOnlySingleDcAllowed(int rilRadioTech) {
        ...
        bool onlySingleDcAllowed = false;
     ...
     */
    private bool retryAfterDisconnected(ApnContext apnContext) {
        bool retry = true;
    ...
    public bool getAutoAttachOnCreation() {
    ...
    private void onSetDependencyMet(String apnType, bool met) {
    ...
    public void setPolicyDataEnabled(bool enabled) {
    ...
    private void onSetPolicyDataEnabled(bool enabled) {
        final bool prevEnabled = isDataEnabled();
    ...
    private void applyNewState(ApnContext apnContext, bool enabled, bool met) {
        bool cleanup = false;
        bool trySetup = false;
    ...
    private bool onTrySetupData(String reason) {
        if (DBG) log("onTrySetupData: reason=" + reason);
        setupDataOnConnectableApns(reason);
        return true;
    }

    private bool onTrySetupData(ApnContext apnContext) {
     ...
     */
    public void setDataRoamingEnabledByUser(bool enabled) {
     ...
     */
    private bool getDefaultDataRoamingEnabled() {
        final CarrierConfigManager configMgr = (CarrierConfigManager)
                mPhone.getContext().getSystemService(Context.CARRIER_CONFIG_SERVICE);
        bool isDataRoamingEnabled = "true".equalsIgnoreCase(SystemProperties.get(
    ...
    private void setDefaultDataRoamingEnabled() {
        ...
        bool useCarrierSpecificDefault = false;
        if (TelephonyManager.getDefault().getSimCount() != 1) {
        ...
        if (useCarrierSpecificDefault) {
            bool defaultVal = getDefaultDataRoamingEnabled();
    ...
    private bool isDataRoamingFromUserAction() {
    ...
    private void setDataRoamingFromUserAction(bool isUserAction) {
    ...
    private void onDataRoamingOnOrSettingsChanged(int messageType) {
        ...
        bool settingChanged = (messageType == DctConstants.EVENT_ROAMING_SETTING_CHANGE);
    ...
    private void checkDataRoamingStatus(bool settingChanged) {
    ...
    private void onDataSetupComplete(AsyncResult ar) {
        ...
        if (ar.exception == null) {
            ...
            if (dcac == null) {
                ...
                bool isProvApn = apnContext.isProvisioningApn();
    ...
    private void onDisconnectDone(AsyncResult ar) {
        ...
        if (mAttached.get() && apnContext.isReady() && retryAfterDisconnected(apnContext)) {
            ...
            bool restartRadioAfterProvisioning = mPhone.getContext().getResources().getBoolean(
    ...
    private void onCleanUpConnection(bool tearDown, int apnId, String reason) {
    ...
    public void handleMessage (Message msg) {
        ...
        switch (msg.what) {
            ...
            case DctConstants.EVENT_CLEAN_UP_CONNECTION:
                bool tearDown = (msg.arg1 == 0) ? false : true;
            ...
            case DctConstants.EVENT_SET_INTERNAL_DATA_ENABLE: {
                final bool enabled = (msg.arg1 == DctConstants.ENABLED) ? true : false;
            ...
            case DctConstants.CMD_SET_DEPENDENCY_MET: {
                bool met = (msg.arg1 == DctConstants.ENABLED) ? true : false;
            ...
            case DctConstants.CMD_SET_ENABLE_FAIL_FAST_MOBILE_DATA: {
                ...
                final bool enabled = sEnableFailFastRefCounter > 0;
                if (DBG) {
    ...
    private void onSetInternalDataEnabled(bool enabled, Message onCompleteMsg) {
        if (DBG) log("onSetInternalDataEnabled: enabled=" + enabled);
        bool sendOnComplete = true;
    ...
    public bool setInternalDataEnabled(bool enable) {
        return setInternalDataEnabled(enable, null);
    }

    public bool setInternalDataEnabled(bool enable, Message onCompleteMsg) {
    ...
    private bool containsAllApns(ArrayList<ApnSetting> oldApnList,
    ...
    private void cleanUpConnectionsOnUpdatedApns(bool tearDown, String reason) {
    ...
    private static class RecoveryAction {
        ...
        private static bool isAggressiveRecovery(int value) {
    ...
    private void onDataStallAlarm(int tag) {
        ...
        bool suspectedStall = DATA_STALL_NOT_SUSPECTED;
    ...
    private void startDataStallAlarm(bool suspectedStall) {
    ...
    private void onDataServiceBindingChanged(bool bound) {
        if (bound) {
            mDcc.start();
        } else {
            mDcc.dispose();
