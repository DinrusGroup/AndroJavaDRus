...
public class ApnContext {
    ...
    protected static final bool DBG = false;
     ...
     */
    private bool mConcurrentVoiceAndDataAllowed;
     ...
     */
    public long getDelayForNextApn(bool failFastEnabled) {
     ...
     */
    public synchronized void setConcurrentVoiceAndDataAllowed(bool allowed) {
     ...
     */
    public synchronized bool isConcurrentVoiceAndDataAllowed() {
     ...
     */
    private bool isFastRetryReason() {
    ...
    public void setDependencyMet(bool met) {
        if (DBG) {
    ...
    public bool getDependencyMet() {
       return mDependencyMet.get();
    }

    public bool isProvisioningApn() {
    ...
    public bool hasNoRestrictedRequests(bool excludeDun) {
        synchronized (mRefCountLock) {
    ...
    public bool restartOnError(int errorCode) {
        bool result = false;
        int retriesLeft = 0;
        synchronized(mRetriesLeftPerErrorCode) {
