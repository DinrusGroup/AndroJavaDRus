...
public class DataConnectionReasons {
    ...
    bool contains(DataDisallowedReasonType reason) {
     ...
     */
    public bool containsOnly(DataDisallowedReasonType reason) {
        return mDataDisallowedReasonSet.size() == 1 && contains(reason);
    }

    bool contains(DataAllowedReasonType reason) {
        return reason == mDataAllowedReason;
    }

    bool containsHardDisallowedReasons() {
        for (DataDisallowedReasonType reason : mDataDisallowedReasonSet) {
    ...
    public enum DataDisallowedReasonType {
        ...
        private bool mIsHardReason;

        bool isHardReason() {
            return mIsHardReason;
        }

        DataDisallowedReasonType(bool isHardReason) {
