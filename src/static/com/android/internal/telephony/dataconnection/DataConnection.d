 ...
 */
public class DataConnection : StateMachine {
    private static final bool DBG = true;
    private static final bool VDBG = true;
    ...
    private void onConnect(ConnectionParams cp) {
        ...
        bool isModemRoaming = mPhone.getServiceState().getDataRoamingFromRegistration();

        // Set this flag to true if the user turns on data roaming. Or if we override the roaming
        // state in framework, we should set this flag to true as well so the modem will not reject
        // the data call setup (because the modem actually thinks the device is roaming).
        bool allowRoaming = mPhone.getDataRoamingEnabled()
     ...
     */
    private void notifyConnectCompleted(ConnectionParams cp, DcFailCause cause, bool sendAll) {
     ...
     */
    private void notifyDisconnectCompleted(DisconnectParams dp, bool sendAll) {
    ...
    private bool isDnsOk(String[] domainNameServers) {
     ...
     */
    private bool mRestrictedNetworkOverride = false;
    ...
    private void setNetworkRestriction() {
        ...
        bool noRestrictedRequests = true;
    ...
    private SetupResult setLinkProperties(DataCallResponse response,
        ...
        bool okToUseSystemPropertyDns = isDnsOk(dnsServers);
     ...
     */
    private bool initConnection(ConnectionParams cp) {
        ApnContext apnContext = cp.mApnContext;
        if (mApnSetting == null) {
     ...
     */
    private class DcDefaultState : State {
        override
        public void enter() {
     ...
     */
    private class DcInactiveState : State {
     ...
     */
    private class DcActivatingState : State {
        override
        public void enter() {
            StatsLog.write(StatsLog.MOBILE_CONNECTION_STATE_CHANGED,
     ...
     */
    private class DcActiveState : State {
     ...
     */
    private class DcDisconnectingState : State {
        override
        public void enter() {
            StatsLog.write(StatsLog.MOBILE_CONNECTION_STATE_CHANGED,
     ...
     */
    private class DcDisconnectionErrorCreatingConnection : State {
        override
        public void enter() {
            StatsLog.write(StatsLog.MOBILE_CONNECTION_STATE_CHANGED,
    ...
    private class DcNetworkAgent : NetworkAgent {
