...
public class DataEnabledSettings {
     ...
     */
    private bool mInternalDataEnabled = true;

    /**
     * Flag indicating data allowed by network policy manager or not.
     */
    private bool mPolicyDataEnabled = true;
     ...
     */
    private bool mCarrierDataEnabled = true;
    ...
    public synchronized void setInternalDataEnabled(bool enabled) {
        localLog("InternalDataEnabled", enabled);
        bool prevDataEnabled = isDataEnabled();
        mInternalDataEnabled = enabled;
        if (prevDataEnabled != isDataEnabled()) {
            notifyDataEnabledChanged(!prevDataEnabled, REASON_INTERNAL_DATA_ENABLED);
        }
    }
    public synchronized bool isInternalDataEnabled() {
        return mInternalDataEnabled;
    }

    public synchronized void setUserDataEnabled(bool enabled) {
    ...
    public synchronized bool isUserDataEnabled() {
        bool defaultVal = "true".equalsIgnoreCase(SystemProperties.get(
    ...
    public synchronized void setPolicyDataEnabled(bool enabled) {
    ...
    public synchronized bool isPolicyDataEnabled() {
        return mPolicyDataEnabled;
    }

    public synchronized void setCarrierDataEnabled(bool enabled) {
    ...
    public synchronized bool isCarrierDataEnabled() {
        return mCarrierDataEnabled;
    }

    public synchronized bool isDataEnabled() {
        if (isProvisioning()) {
     ...
     */
    public bool isProvisioningDataEnabled() {
        final String prov_property = SystemProperties.get("ro.com.android.prov_mobiledata",
                "false");
        bool retVal = "true".equalsIgnoreCase(prov_property);
    ...
    private void notifyDataEnabledChanged(bool enabled, int reason) {
    ...
    private void localLog(String name, bool value) {
