...
public class TelephonyNetworkFactory : NetworkFactory {
    ...
    private static final bool REQUEST = true;
    private static final bool RELEASE = false;

    private void applyRequests(HashMap<NetworkRequest, LocalLog> requestMap, bool action,
            String logStr) {
    ...
    private void onActivePhoneSwitch() {
        final bool newIsActive = mPhoneSwitcher.isPhoneActive(mPhoneId);
    ...
    private void onDefaultChange() {
        ...
        final bool newIsDefault = (newDefaultSubscriptionId == mSubscriptionId);
