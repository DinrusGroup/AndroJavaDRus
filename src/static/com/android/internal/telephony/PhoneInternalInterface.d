...
public interface PhoneInternalInterface {
    ...
    static final bool DEBUG_PHONE = true;
    ...
    public static class DialArgs {
        public static class Builder<T : Builder<T>> {
     ...
     */
    bool handleUssdRequest(String ussdRequest, ResultReceiver wrappedCallback)
     ...
     * @throws CallStateException
     */
    bool handleInCallMmiCommands(String command) throws CallStateException;
     ...
     */
    bool setLine1Number(String alphaTag, String number, Message onComplete);
     ...
     * sets a call forwarding option.
     *
     * @param enable is a bool representing the state that you are
     *        requesting, true for enabled, false for disabled.
     * @param onComplete a callback message when the action is completed.
     */
    void setCallWaiting(bool enable, Message onComplete);
     ...
     */
    void setDataRoamingEnabled(bool enable);

    /**
     * @return true if user has enabled data
     */
    bool isUserDataEnabled();
     ...
     */
    void setUserDataEnabled(bool enable);
