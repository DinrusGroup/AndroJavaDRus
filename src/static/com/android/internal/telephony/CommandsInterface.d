...
public interface CommandsInterface {
    enum RadioState {
        ...
        public bool isOn() /* and available...*/ {
...
//  static final int CF_ACTION_UNUSED           = 2;
     ...
     */
    void setSuppServiceNotifications(bool enable, Message result);
     ...
     */
    void setPreferredVoicePrivacy(bool enable, Message result);
    ...
    void setMute (bool enableMute, Message response);
    ...
    void setRadioPower(bool on, Message response);

    void acknowledgeLastIncomingGsmSms(bool success, int cause, Message response);

    void acknowledgeLastIncomingCdmaSms(bool success, int cause, Message response);
     ...
     * @param response sent when operation completes.
     */
    void acknowledgeIncomingGsmSmsWithPdu(bool success, String ackPdu, Message response);
    ...
    void setCallWaiting(bool enable, int serviceClass, Message response);
     ...
     * @param response is callback message
     */
    void setFacilityLock (String facility, bool lockState, String password,
     ...
     * @param response is callback message
     */
    void setFacilityLockForApp(String facility, bool lockState, String password,
     ...
     * @param response callback message
     */
    void setLocationUpdates(bool enable, Message response);
     ...
     */
    void reportSmsMemoryStatus(bool available, Message result);
     ...
     *            Callback message
     */
    void setupDataCall(int accessNetworkType, DataProfile dataProfile, bool isRoaming,
     ...
     */
    void setInitialAttachApn(DataProfile dataProfile, bool isRoaming, Message result);
     ...
     *            callback message contains the information of SUCCESS/FAILURE
     */
    void setDataProfile(DataProfile[] dps, bool isRoaming, Message result);
   ...
   /**
     ...
     * @param result callback message contains the information of SUCCESS/FAILURE
     */
    void sendDeviceState(int stateType, bool state, Message result);
