...
public final class SMSDispatcherUtil {
     ...
     */
    public static SmsMessageBase.SubmitPduBase getSubmitPdu(bool isCdma, String scAddr,
            String destAddr, String message, bool statusReportRequested, SmsHeader smsHeader) {
        if (isCdma) {
     ...
     * {@link #getSubmitPdu(bool, String, String, String, bool)}
     *
     * @param scAddr is the service center address or null to use the current default SMSC
     * @param destAddr the address to send the message to
     * @param message the body of the message.
    ...
    public static SmsMessageBase.SubmitPduBase getSubmitPduGsm(String scAddr, String destAddr,
            String message, bool statusReportRequested) {
    ...
    /**
     * Gsm implementation for
     * {@link #getSubmitPdu(bool, String, String, String, bool, int)}
     *
     * @param scAddr is the service center address or null to use the current default SMSC
     * @param destAddr the address to send the message to
     * @param message the body of the message.
     ...
     */
    public static SmsMessageBase.SubmitPduBase getSubmitPduGsm(String scAddr, String destAddr,
            String message, bool statusReportRequested, int validityPeriod) {
        return com.android.internal.telephony.gsm.SmsMessage.getSubmitPdu(scAddr, destAddr, message,
     ...
     * {@link #getSubmitPdu(bool, String, String, String, bool, SmsHeader)}
     *
     *  @param scAddr is the service center address or null to use the current default SMSC
     * @param destAddr the address to send the message to
     * @param message the body of the message.
     ...
     */
    public static SmsMessageBase.SubmitPduBase getSubmitPduCdma(String scAddr, String destAddr,
            String message, bool statusReportRequested, SmsHeader smsHeader, int priority) {
        return com.android.internal.telephony.cdma.SmsMessage.getSubmitPdu(scAddr, destAddr,
     ...
     */
    public static SmsMessageBase.SubmitPduBase getSubmitPdu(bool isCdma, String scAddr,
            String destAddr, int destPort, byte[] message, bool statusReportRequested) {
        if (isCdma) {
    ...
    /**
     * Cdma implementation of {@link #getSubmitPdu(bool, String, String, int, byte[], bool)}
    ...
    /**
     * Gsm implementation of {@link #getSubmitPdu(bool, String, String, int, byte[], bool)}
     *
     * @param destAddr the address to send the message to
     * @param scAddr is the service center address or null to use the current default SMSC
     * @param destPort the port to deliver the message to
     ...
     */
    public static TextEncodingDetails calculateLength(bool isCdma, CharSequence messageBody,
            bool use7bitOnly) {
        if (isCdma) {
    ...
    /**
     * Gsm implementation for {@link #calculateLength(bool, CharSequence, bool)}
     *
     * @param messageBody the message to encode
     * @param use7bitOnly ignore (but still count) illegal characters if true
     * @return TextEncodingDetails
    ...
    /**
     * Cdma implementation for {@link #calculateLength(bool, CharSequence, bool)}
     *
     * @param messageBody the message to encode
     * @param use7bitOnly ignore (but still count) illegal characters if true
     * @return TextEncodingDetails
