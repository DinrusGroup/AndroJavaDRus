...
import java.util.HashMap;
 ...
 /**
 * This class : handle the MO SMS target address before sending.
...
public class SmsNumberUtils {
    ...
    private static final bool DBG = Build.IS_DEBUGGABLE;
    ...
    private static bool isNANP(String number) {
    ...
    private static bool inExceptionListForNpCcAreaLocal(NumberEntry numberEntry) {
        int countryCode = numberEntry.countryCode;
        bool result = (numberEntry.number.length() == 12
    ...
    private static bool isInternationalRoaming(Phone phone) {
        ...
        String simIsoCountry = TelephonyManager.from(phone.getContext()).getSimCountryIsoForPhone(
                phone.getPhoneId());
        bool internationalRoaming = !TextUtils.isEmpty(operatorIsoCountry)
    ...
    private static bool needToConvert(Phone phone) {
    ...
    private static bool compareGid1(Phone phone, String serviceGid1) {
