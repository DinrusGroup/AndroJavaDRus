...
public class RadioIndication : IRadioIndication.Stub {
    RIL mRil;
    ...
    public void nitzTimeReceived(int indicationType, String nitzTime, long receivedTime) {
        ...
        bool ignoreNitz = SystemProperties.getBoolean(
    ...
    public void callRing(int indicationType, bool isGsm, CdmaSignalInfoRecord record) {
        mRil.processIndication(indicationType);
    ...
    public void indicateRingbackTone(int indicationType, bool start) {
        mRil.processIndication(indicationType);
    ...
    public void subscriptionStatusChanged(int indicationType, bool activate) {
        mRil.processIndication(indicationType);
