...
public class TelephonyMetrics {
    ...
    private bool mTelephonyEventsDropped = false;
     ...
     */
    public void writeCarrierKeyEvent(int phoneId, int keyType,  bool isDownloadSuccessful) {
    ...
    private bool disconnectReasonsKnown(RilCall[] calls) {
     ...
     */
    public synchronized void writeNewCBSms(int phoneId, int format, int priority, bool isCMAS,
                                           bool isETWS, int serviceCategory) {
        InProgressSmsSession smsSession = startNewSmsSessionIfNeeded(phoneId);
