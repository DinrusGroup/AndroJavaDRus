...
public class TelephonyCapabilities {
     ...
     * otherwise.
     */
    public static bool supportsEcm(Phone phone) {
     ...
     */
    public static bool supportsOtasp(Phone phone) {
        return (phone.getPhoneType() == PhoneConstants.PHONE_TYPE_CDMA);
    }
     ...
     */
    public static bool supportsVoiceMessageCount(Phone phone) {
     ...
     */
    public static bool supportsNetworkSelection(Phone phone) {
     ...
     */
    public static bool supportsConferenceCallManagement(Phone phone) {
        return ((phone.getPhoneType() == PhoneConstants.PHONE_TYPE_GSM)
     ...
     * on hold.")
     */
    public static bool supportsHoldAndUnhold(Phone phone) {
        return ((phone.getPhoneType() == PhoneConstants.PHONE_TYPE_GSM)
                || (phone.getPhoneType() == PhoneConstants.PHONE_TYPE_SIP)
     ...
     */
    public static bool supportsAnswerAndHold(Phone phone) {
        return ((phone.getPhoneType() == PhoneConstants.PHONE_TYPE_GSM)
                || (phone.getPhoneType() == PhoneConstants.PHONE_TYPE_SIP));
    }
     ...
     */
    public static bool supportsAdn(int phoneType) {
     ...
     */
    public static bool canDistinguishDialingAndConnected(int phoneType) {
        return phoneType == PhoneConstants.PHONE_TYPE_GSM;
    }
}
