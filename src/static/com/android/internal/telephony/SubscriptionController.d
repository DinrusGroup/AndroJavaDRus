 ...
 *
 */
public class SubscriptionController : ISub.Stub {
    static final String LOG_TAG = "SubscriptionController";
    static final bool DBG = true;
    static final bool VDBG = false;
    static final bool DBG_CACHE = false;
    ...
    private SubscriptionInfo getSubInfoRecord(Cursor cursor) {
        ...
        bool isEmbedded = cursor.getInt(cursor.getColumnIndexOrThrow(
    ...
    public List<SubscriptionInfo> getSubscriptionInfoListForEmbeddedSubscriptionUpdate(
            String[] embeddedIccids, bool isEuiccRemovable) {
     ...
     */
    public bool setPlmnSpn(int slotIndex, bool showPlmn, String plmn, bool showSpn,
                              String spn) {
        synchronized (mLock) {
            int subId = getSubIdUsingPhoneId(slotIndex);
    ...
    public int getDefaultSubId() {
        int subId;
        bool isVoiceCapable = mContext.getResources().getBoolean(
    ...
    private bool shouldDefaultBeCleared(List<SubscriptionInfo> records, int subId) {
    ...
    public bool isActiveSubId(int subId) {
        bool retVal = SubscriptionManager.isValidSubscriptionId(subId)
