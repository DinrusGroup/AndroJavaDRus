 ...
 * {@hide}
 */
public class GsmCdmaCallTracker : CallTracker {
    private static final String LOG_TAG = "GsmCdmaCallTracker";
    private static final bool REPEAT_POLLING = false;

    private static final bool DBG_POLL = false;
    ...
    private bool mPendingCallInEcm;
    private bool mIsInEmergencyCall;
    private int mPendingCallClirMode;
    private bool mIsEcmTimerCanceled;
    ...
    private BroadcastReceiver mEcmExitReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            if (intent.getAction().equals(
                ...
                bool isInEcm = intent.getBooleanExtra(PhoneConstants.PHONE_IN_ECM_STATE, false);
    ...
    private void updatePhoneType(bool duringInit) {
        if (!duringInit) {
            reset();
            pollCallsWhenSafe();
        }
    ...
    public synchronized Connection dial(String dialString, int clirMode, UUSInfo uusInfo,
        ...
        bool isEmergencyCall = PhoneNumberUtils.isLocalEmergencyNumber(mPhone.getContext(),
                dialString);
    ...
    private Connection dial(String dialString, int clirMode) throws CallStateException {
        ...
        bool internationalRoaming = !TextUtils.isEmpty(operatorIsoContry)
        ...
        bool isPhoneInEcmMode = mPhone.isInEcm();
    ...
    protected synchronized void handlePollCalls(AsyncResult ar) {
        ...
        bool hasNonHangupStateChanged = false;   // Any change besides
                                                    // a dropped connection
        bool hasAnyCallDisconnected = false;
        bool needsPollDelay = false;
        bool unknownConnectionAppeared = false;
        int handoverConnectionsSize = mHandoverConnections.size();

        //CDMA
        bool noConnectionExists = true;
