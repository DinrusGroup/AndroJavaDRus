...
public final class TelephonyPermissions {
     ...
     */
    public static bool checkCallingOrSelfReadPhoneState(
     ...
     * devices.
     */
    public static bool checkReadPhoneState(
     ...
     */
    public static bool checkReadCallLog(
     ...
     */
    public static bool checkCallingOrSelfReadPhoneNumber(
            Context context, int subId, String callingPackage, String message) {
    ...
    @VisibleForTesting
    public static bool checkReadPhoneNumber(
            Context context, Supplier<ITelephony> telephonySupplier, int subId, int pid, int uid,
            String callingPackage, String message) {
