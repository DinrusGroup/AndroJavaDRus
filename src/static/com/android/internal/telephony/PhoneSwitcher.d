 ...
 */
public class PhoneSwitcher : Handler {
    ...
    private static class PhoneSwitcherNetworkRequestListener : NetworkFactory {
    ...
    private static final bool REQUESTS_CHANGED   = true;
    private static final bool REQUESTS_UNCHANGED = false;
    /**
     * Re-evaluate things.
     ...
     */
    private void onEvaluate(bool requestsChanged, String reason) {
        ...
        bool diffDetected = requestsChanged;
    ...
    public bool isPhoneActive(int phoneId) {
        validatePhoneId(phoneId);
