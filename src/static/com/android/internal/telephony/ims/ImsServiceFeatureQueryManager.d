...
public class ImsServiceFeatureQueryManager {
    ...
    private final class ImsServiceFeatureQuery : ServiceConnection {
        ...
        public bool start() {
            ...
            bool bindStarted = mContext.bindService(imsServiceIntent, this, serviceFlags);
            if (!bindStarted) {
     ...
     */
    public bool startQuery(ComponentName name, String intentFilter) {
        synchronized (mLock) {
