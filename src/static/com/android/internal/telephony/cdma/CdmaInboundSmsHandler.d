 ...
 */
public class CdmaInboundSmsHandler : InboundSmsHandler {
    ...
    private final bool mCheckForDuplicatePortsInOmadmWapPush = Resources.getSystem().getBoolean(
    ...
    protected int dispatchMessageRadioSpecific(SmsMessageBase smsb) {
        ...
        bool isBroadcastType = (SmsEnvelope.MESSAGE_TYPE_BROADCAST == sms.getMessageType());
     ...
     */
    override
    protected void acknowledgeLastIncomingSms(bool success, int result, Message response) {
     ...
     */
    private static bool checkDuplicatePortOmadmWapPush(byte[] origPdu, int index) {
        index += 4;
