...
public final class BearerData {
    ...
    public bool priorityIndicatorSet = false;
    ...
    public bool privacyIndicatorSet = false;
    ...
    public bool alertIndicatorSet = false;
    ...
    public bool displayModeSet = false;
    ...
    public bool languageIndicatorSet = false;
    ...
    public bool messageStatusSet = false;
     ...
     * 4.5.3)
     */
    public bool userResponseCodeSet = false;
    public int userResponseCode;

    /**
     * 6-byte-field, see 3GPP2 C.S0015-B, v2, 4.5.4
     */
    public static class TimeStamp : Time {
    ...
    public bool validityPeriodRelativeSet;
    public int validityPeriodRelative;
    public bool deferredDeliveryTimeRelativeSet;
     ...
     */
    public bool userAckReq;
    public bool deliveryAckReq;
    public bool readAckReq;
    public bool reportReq;
    ...
    private static class CodingException : Exception {
    ...
    private static int countAsciiSeptets(CharSequence msg, bool force) {
    ...
    public static TextEncodingDetails calcTextEncodingDetails(CharSequence msg,
            bool force7BitEncoding, bool isEntireMsg) {
    ...
    private static byte[] encode7bitAscii(String msg, bool force)
    ...
    private static Gsm7bitCodingResult encode7bitGsm(String msg, int septetOffset, bool force)
        throws CodingException
    {
        try {
            /*
    ...
    private static void encode7bitEms(UserData uData, byte[] udhData, bool force)
        throws CodingException
    {
        ...
        uData.payload[0] = cast(byte)udhData.length;
    ...
    private static bool decodeMessageId(BearerData bData, BitwiseInputStream inStream)
    ...
    private static bool decodeUserData(BearerData bData, BitwiseInputStream inStream)
        throws BitwiseInputStream.AccessException
    {
        int paramBits = inStream.read(8) * 8;
    ...
    private static void decodeUserDataPayload(UserData userData, bool hasUserDataHeader)
        throws CodingException
    {
        int offset = 0;
        ...
        case UserData.ENCODING_OCTET:
            ...
            */
            bool decodingtypeUTF8 = Resources.getSystem()
    ...
    private static void decodeIs91Cli(BearerData bData) throws CodingException {
        ...
        addr.numberOfDigits = cast(byte)numFields;
    ...
    private static bool decodeReplyOption(BearerData bData, BitwiseInputStream inStream)
        throws BitwiseInputStream.AccessException {
    ...
    private static bool decodeMsgCount(BearerData bData, BitwiseInputStream inStream)
        throws BitwiseInputStream.AccessException {
        final int EXPECTED_PARAM_SIZE = 1 * 8;
        bool decodeSuccess = false;
        int paramBits = inStream.read(8) * 8;
        if (paramBits >= EXPECTED_PARAM_SIZE) {
            paramBits -= EXPECTED_PARAM_SIZE;
            decodeSuccess = true;
            bData.numberOfMessages = IccUtils.cdmaBcdByteToInt(cast(byte)inStream.read(8));
        }
        if ((! decodeSuccess) || (paramBits > 0)) {
    ...
    private static bool decodeDepositIndex(BearerData bData, BitwiseInputStream inStream)
        throws BitwiseInputStream.AccessException {
    ...
    private static bool decodeCallbackNumber(BearerData bData, BitwiseInputStream inStream)
        throws BitwiseInputStream.AccessException, CodingException
    {
    ...
    private static bool decodeMsgStatus(BearerData bData, BitwiseInputStream inStream)
        throws BitwiseInputStream.AccessException {
        final int EXPECTED_PARAM_SIZE = 1 * 8;
        bool decodeSuccess = false;
        int paramBits = inStream.read(8) * 8;
    ...
    private static bool decodeMsgCenterTimeStamp(BearerData bData, BitwiseInputStream inStream)
        throws BitwiseInputStream.AccessException {
    ...
    private static bool decodeValidityAbs(BearerData bData, BitwiseInputStream inStream)
        throws BitwiseInputStream.AccessException {
        final int EXPECTED_PARAM_SIZE = 6 * 8;
        bool decodeSuccess = false;
        int paramBits = inStream.read(8) * 8;
    ...
    private static bool decodeDeferredDeliveryAbs(BearerData bData, BitwiseInputStream inStream)
        throws BitwiseInputStream.AccessException {
        final int EXPECTED_PARAM_SIZE = 6 * 8;
        bool decodeSuccess = false;
        int paramBits = inStream.read(8) * 8;
    ...
    private static bool decodeValidityRel(BearerData bData, BitwiseInputStream inStream)
        throws BitwiseInputStream.AccessException {
        final int EXPECTED_PARAM_SIZE = 1 * 8;
        bool decodeSuccess = false;
        int paramBits = inStream.read(8) * 8;
    ...
    private static bool decodeDeferredDeliveryRel(BearerData bData, BitwiseInputStream inStream)
        throws BitwiseInputStream.AccessException {
        final int EXPECTED_PARAM_SIZE = 1 * 8;
        bool decodeSuccess = false;
        int paramBits = inStream.read(8) * 8;
    ...
    private static bool decodePrivacyIndicator(BearerData bData, BitwiseInputStream inStream)
        throws BitwiseInputStream.AccessException {
        final int EXPECTED_PARAM_SIZE = 1 * 8;
        bool decodeSuccess = false;
        int paramBits = inStream.read(8) * 8;
    ...
    private static bool decodeLanguageIndicator(BearerData bData, BitwiseInputStream inStream)
        throws BitwiseInputStream.AccessException {
        final int EXPECTED_PARAM_SIZE = 1 * 8;
        bool decodeSuccess = false;
        int paramBits = inStream.read(8) * 8;
    ...
    private static bool decodeDisplayMode(BearerData bData, BitwiseInputStream inStream)
        throws BitwiseInputStream.AccessException {
        final int EXPECTED_PARAM_SIZE = 1 * 8;
        bool decodeSuccess = false;
        int paramBits = inStream.read(8) * 8;
    ...
    private static bool decodePriorityIndicator(BearerData bData, BitwiseInputStream inStream)
        throws BitwiseInputStream.AccessException {
        final int EXPECTED_PARAM_SIZE = 1 * 8;
        bool decodeSuccess = false;
        int paramBits = inStream.read(8) * 8;
    ...
    private static bool decodeMsgDeliveryAlert(BearerData bData, BitwiseInputStream inStream)
        throws BitwiseInputStream.AccessException {
        final int EXPECTED_PARAM_SIZE = 1 * 8;
        bool decodeSuccess = false;
        int paramBits = inStream.read(8) * 8;
    ...
    private static bool decodeUserResponseCode(BearerData bData, BitwiseInputStream inStream)
        throws BitwiseInputStream.AccessException {
        final int EXPECTED_PARAM_SIZE = 1 * 8;
        bool decodeSuccess = false;
        int paramBits = inStream.read(8) * 8;
    ...
    private static bool decodeServiceCategoryProgramData(BearerData bData,
    ...
    private static bool isCmasAlertCategory(int category) {
