...
public class SmsMessage : SmsMessageBase {
    ...
    public static SubmitPdu getSubmitPdu(String scAddr, String destAddr, String message,
            bool statusReportRequested, SmsHeader smsHeader) {
     ...
     */
    public static SubmitPdu getSubmitPdu(String scAddr, String destAddr, String message,
            bool statusReportRequested, SmsHeader smsHeader, int priority) {
    ...
    public static SubmitPdu getSubmitPdu(String scAddr, String destAddr, int destPort,
            byte[] data, bool statusReportRequested) {
     ...
     */
    public static SubmitPdu getSubmitPdu(String destAddr, UserData userData,
            bool statusReportRequested, int priority) {
    ...
    public static TextEncodingDetails calculateLength(CharSequence messageBody,
            bool use7bitOnly, bool isEntireMsg) {
    ...
    */
                ...
                switch (parameterId) {
                    ...
                    case DESTINATION_ADDRESS:
                        ...
                        if (addr.digitMode == CdmaSmsAddress.DIGIT_MODE_4BIT_DTMF) {
                            ...
                            for (int index = 0; index < addr.numberOfDigits; index++) {
                                b = cast(byte) (0xF & addrBis.read(4));
                            ...
                            if (addr.numberMode == CdmaSmsAddress.NUMBER_MODE_NOT_DATA_NETWORK) {
                                for (int index = 0; index < addr.numberOfDigits; index++) {
                                    b = cast(byte) (0xFF & addrBis.read(8));
                                    data[index] = b;
                                }
                    ...
                    case DESTINATION_SUB_ADDRESS:
                        ...
                        for (int index = 0; index < subAddrLen; index++) {
                            b = cast(byte) (0xFF & subAddrBis.read(4));
     ...
     */
    private static SubmitPdu privateGetSubmitPdu(String destAddrStr, bool statusReportRequested,
            UserData userData) {
