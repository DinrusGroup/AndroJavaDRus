...
public final class CdmaInformationRecords {
    ...
    public static class CdmaSignalInfoRec {
        public bool isPresent;   /* non-zero if signal information record is present */
    ...
    public static class CdmaNumberInfoRec {
        ...
        public CdmaNumberInfoRec(int id, String number, int numberType, int numberPlan, int pi,
                int si) {
            this.number = number;
            this.numberType = cast(byte)numberType;
            this.numberPlan = cast(byte)numberPlan;
            this.pi = cast(byte)pi;
            this.si = cast(byte)si;
        }
    ...
    public static class CdmaLineControlInfoRec {
        ...
        public CdmaLineControlInfoRec(int lineCtrlPolarityIncluded, int lineCtrlToggle,
            ...
            this.lineCtrlPolarityIncluded = cast(byte)lineCtrlPolarityIncluded;
            this.lineCtrlToggle = cast(byte)lineCtrlToggle;
            this.lineCtrlReverse = cast(byte)lineCtrlReverse;
            this.lineCtrlPowerDenial = cast(byte)lineCtrlPowerDenial;
        }
    ...
    public static class CdmaT53AudioControlInfoRec {
        ...
        public CdmaT53AudioControlInfoRec(int uplink, int downlink) {
            this.uplink = cast(byte) uplink;
            this.downlink = cast(byte) downlink;
        }
