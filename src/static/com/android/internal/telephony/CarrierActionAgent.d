 ...
 * {@link android.telephony.TelephonyManager#carrierActionSetRadioEnabled(int, bool)
 ...
 */
public class CarrierActionAgent : Handler {
    private static final String LOG_TAG = "CarrierActionAgent";
    private static final bool DBG = true;
    private static final bool VDBG = Rlog.isLoggable(LOG_TAG, Log.VERBOSE);
    ...
    public void handleMessage(Message msg) {
        ...
        if (enabled != null && enabled == (bool) msg.obj) return;
        switch (msg.what) {
            case CARRIER_ACTION_SET_METERED_APNS_ENABLED:
                mCarrierActionOnMeteredApnEnabled = (bool) msg.obj;
            ...
            case CARRIER_ACTION_SET_RADIO_ENABLED:
                mCarrierActionOnRadioEnabled = (bool) msg.obj;
            ...
            case CARRIER_ACTION_REPORT_DEFAULT_NETWORK_STATUS:
                mCarrierActionReportDefaultNetworkStatus = (bool) msg.obj;
