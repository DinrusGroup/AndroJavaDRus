...
public final class SmsApplication {
    ...
    private static final bool DEBUG_MULTIUSER = false;
     ...
     * (4) Null
     */
    private static SmsApplicationData getApplication(Context context, bool updateIfNeeded,
            int userId) {
     ...
     */
    private static final class SmsPackageMonitor : PackageMonitor {
     ...
     */
    public static ComponentName getDefaultSmsApplication(Context context, bool updateIfNeeded) {
        int userId = getIncomingUserId(context);
        final long token = Binder.clearCallingIdentity();
        try {
     ...
     */
    public static ComponentName getDefaultMmsApplication(Context context, bool updateIfNeeded) {
        int userId = getIncomingUserId(context);
        final long token = Binder.clearCallingIdentity();
        try {
            ComponentName component = null;
    ...
    public static ComponentName getDefaultExternalTelephonyProviderChangedApplication(
            Context context, bool updateIfNeeded) {
        int userId = getIncomingUserId(context);
        final long token = Binder.clearCallingIdentity();
        try {
            ComponentName component = null;
     ...
     * Caller must pass in the correct user context if calling from a singleton service.
     */
    public static bool shouldWriteMessageForPackage(String packageName, Context context) {
     ...
     */
    public static bool isDefaultSmsApplication(Context context, String packageName) {
        if (packageName == null) {
            return false;
        }
