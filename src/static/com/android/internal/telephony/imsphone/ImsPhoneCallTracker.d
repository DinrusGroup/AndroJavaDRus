 ...
 * {@hide}
 */
public class ImsPhoneCallTracker : CallTracker : ImsPullCall {
    ...
    public interface PhoneNumberUtilsProxy {
        bool isEmergencyNumber(String number);
    }
    ...
    private static final bool FORCE_VERBOSE_STATE_LOGGING = false; /* stopship if true */
    private static final bool VERBOSE_STATE_LOGGING = FORCE_VERBOSE_STATE_LOGGING ||
    ...
    private bool mCarrierConfigLoaded = false;

    private final MmTelFeatureListener mMmTelFeatureListener = new MmTelFeatureListener();
    private class MmTelFeatureListener : MmTelFeature.Listener {
        override
        public void onIncomingCall(IImsCallSession c, Bundle extras) {
            ...
            try {
                ...
                bool isUssd = extras.getBoolean(ImsManager.EXTRA_USSD, false);
                if (isUssd) {
                ...
                bool isUnknown = extras.getBoolean(ImsManager.EXTRA_IS_UNKNOWN_CALL, false);
                if (DBG) {
     ...
     */
    private bool mIsMonitoringConnectivity = false;
    ...
    private bool mDesiredMute = false;    // false = mute off
    private bool mOnHoldToneStarted = false;
    ...
    private bool mIsInEmergencyCall = false;
    private bool mIsDataEnabled = false;

    private int pendingCallClirMode;
    private int mPendingCallVideoState;
    private Bundle mPendingIntentExtras;
    private bool pendingCallInEcm = false;
    private bool mSwitchingFgAndBgCalls = false;
    private ImsCall mCallExpectedToResume = null;
    private bool mAllowEmergencyVideoCalls = false;
    private bool mIgnoreDataEnabledChangedForVideoCalls = false;
    private bool mIsViLteDataMetered = false;
    private bool mAlwaysPlayRemoteHoldTone = false;
     ...
     */
    private bool mTreatDowngradedVideoCallsAsVideoCalls = false;
     ...
     */
    private bool mSupportDowngradeVtToAudio = false;
     ...
     * information.
     */
    private bool mNotifyHandoverVideoFromWifiToLTE = false;
     ...
     * information.
     */
    private bool mNotifyHandoverVideoFromLTEToWifi = false;
     ...
     */
    private bool mHasPerformedStartOfCallHandover = false;
     ...
     */
    private bool mSupportPauseVideo = false;
     ...
     * When {@code true}, forces {@link ImsManager#updateImsServiceConfig(bool)} to
     * be called when an ongoing video call is disconnected.  In some cases, where video pause is
     * supported by the carrier, when {@link #onDataEnabledChanged(bool, int)} reports that data
     ...
     */
    private bool mShouldUpdateImsConfigOnDisconnect = false;
    ...
    public synchronized Connection dial(String dialString, ImsPhone.ImsDialArgs dialArgs)
        ...
        bool isPhoneInEcmMode = isPhoneInEcbMode();
        bool isEmergencyNumber = mPhoneNumberUtilsProxy.isEmergencyNumber(dialString);
    ...
    private bool shouldNumberBePlacedOnIms(bool isEmergency, String number) {
    ...
    public void acceptCall (int videoState) throws CallStateException {
        ...
        if ((mRingingCall.getState() == ImsPhoneCall.State.WAITING)
            ...
            bool answeringWillDisconnect = false;
    ...
    public void switchWaitingOrHoldingAndActive() throws CallStateException {
        ...
        if (mForegroundCall.getState() == ImsPhoneCall.State.ACTIVE) {
            ...
            bool switchingWithWaitingCall = !mBackgroundCall.getState().isAlive() &&
                    mRingingCall != null &&
    ...
    updatePhoneState() {
        ...
        bool isPendingMOIdle = mPendingMO == null || !mPendingMO.getState().isAlive();
    ...
    private synchronized void removeConnection(ImsPhoneConnection conn) {
        ...
        if (mIsInEmergencyCall) {
            bool isEmergencyCallInList = false;
    ...
    private void dialPendingMO() {
        bool isPhoneInEcmMode = isPhoneInEcbMode();
        bool isEmergencyNumber = mPendingMO.isEmergency();
        if ((!isPhoneInEcmMode) || (isPhoneInEcmMode && isEmergencyNumber)) {
    ...
    private ImsCall.Listener mImsCallListener = new ImsCall.Listener() {
        ...
        public void onCallResumeReceived(ImsCall imsCall) {
            ...
            bool useVideoPauseWorkaround = mPhone.getContext().getResources().getBoolean(
        ...
        override
        public void onCallMerged(final ImsCall call, final ImsCall peerCall, bool swapCalls) {
        ...
        public void onCallHandover(ImsCall imsCall, int srcAccessTech, int targetAccessTech,
            ...
            bool isHandoverToWifi = srcAccessTech != ServiceState.RIL_RADIO_TECHNOLOGY_UNKNOWN
        ...
        public void onCallHandoverFailed(ImsCall imsCall, int srcAccessTech, int targetAccessTech,
            ...
            bool isHandoverToWifi = srcAccessTech != ServiceState.RIL_RADIO_TECHNOLOGY_IWLAN &&
                    targetAccessTech == ServiceState.RIL_RADIO_TECHNOLOGY_IWLAN;
            ImsPhoneConnection conn = findConnection(imsCall);
         ...
         */
        override
        public void onMultipartyStateChanged(ImsCall imsCall, bool isMultiParty) {
    ...
    public void dump(FileDescriptor fd, PrintWriter pw, String[] args) {
        pw.println("ImsPhoneCallTracker ::");
    ...
    public bool isInEmergencyCall() {
        return mIsInEmergencyCall;
    }

    public bool isVolteEnabled() {
        bool isRadioTechLte = getImsRegistrationTech()
                == ImsRegistrationImplBase.REGISTRATION_TECH_LTE;
        return isRadioTechLte && mMmTelCapabilities.isCapable(
                MmTelFeature.MmTelCapabilities.CAPABILITY_TYPE_VOICE);
    }

    public bool isVowifiEnabled() {
        bool isRadioTechIwlan = getImsRegistrationTech()
                == ImsRegistrationImplBase.REGISTRATION_TECH_IWLAN;
        return isRadioTechIwlan && mMmTelCapabilities.isCapable(
                MmTelFeature.MmTelCapabilities.CAPABILITY_TYPE_VOICE);
    }

    public bool isVideoCallEnabled() {
     ...
     */
    private bool shouldDisconnectActiveCallOnAnswer(ImsCall activeCall,
        ...
        bool isActiveCallVideo = activeCall.isVideoCall() ||
                (mTreatDowngradedVideoCallsAsVideoCalls && activeCall.wasVideoCall());
        bool isActiveCallOnWifi = activeCall.isWifiCall();
        bool isVoWifiEnabled = mImsManager.isWfcEnabledByPlatform()
                && mImsManager.isWfcEnabledByUser();
        bool isIncomingCallAudio = !incomingCall.isVideoCall();
     ...
     */
    public NetworkStats getVtDataUsage(bool perUidStats) {
     ...
     */
    private void onDataEnabledChanged(bool enabled, int reason) {
    ...
    private void maybeNotifyDataDisabled(bool enabled, int reasonCode) {
        if (!enabled) {
     ...
     */
    private void handleDataEnabledChange(bool enabled, int reasonCode) {
        if (!enabled) {
            // If data is disabled while there are ongoing VT calls which are not taking place over
            // wifi, then they should be disconnected to prevent the user from incurring further
            // data charges.
    ...
    private void handleFeatureCapabilityChanged(ImsFeature.Capabilities capabilities) {
        ...
        bool isVideoEnabled = isVideoCallEnabled();
        bool isVideoEnabledStatechanged = tmpIsVideoCallEnabled != isVideoEnabled;
        if (DBG) {
    ...
    @VisibleForTesting
    public void setAlwaysPlayRemoteHoldTone(bool shouldPlayRemoteHoldTone) {
