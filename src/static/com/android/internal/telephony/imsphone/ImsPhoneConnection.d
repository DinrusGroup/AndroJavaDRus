 ...
 * {@hide}
 */
public class ImsPhoneConnection : Connection :
    ...
    */
    ...
    private bool mIsEmergency = false;
     ...
     */
    private bool mShouldIgnoreVideoStateChanges = false;
     ...
     * calls.
     */
    private bool mIsVideoEnabled = true;
    ...
    public ImsPhoneConnection(Phone phone, ImsCall imsCall, ImsPhoneCallTracker ct,
           ImsPhoneCall parent, bool isUnknown) {
    ...
    public ImsPhoneConnection(Phone phone, String dialString, ImsPhoneCallTracker ct,
            ImsPhoneCall parent, bool isEmergency) {
        super(PhoneConstants.PHONE_TYPE_IMS);
        createWakeLock(phone.getContext());
        acquireWakeLock();
    ...
    override
    public bool onDisconnect(int cause) {
    ...
    override
    public synchronized bool isMultiparty() {
     ...
     */
    override
    public synchronized bool isConferenceHost() {
        return mImsCall != null && mImsCall.isConferenceHost();
    }

    override
    public bool isMemberOfPeerConference() {
     ...
     */
    public bool update(ImsCall imsCall, ImsPhoneCall.State state) {
        ...
        bool updateParent = mParent.update(this, imsCall, state);
        bool updateAddressDisplay = updateAddressDisplay(imsCall);
        bool updateMediaCapabilities = updateMediaCapabilities(imsCall);
        bool updateExtras = updateExtras(imsCall);
     ...
     */
    public bool updateAddressDisplay(ImsCall imsCall) {
        if (imsCall == null) {
            return false;
        }
     ...
     */
    public bool updateMediaCapabilities(ImsCall imsCall) {
        if (imsCall == null) {
            return false;
        }
    ...
    public bool hasRttTextStream() {
        return mRttTextStream != null;
    }

    public bool isRttEnabledForCall() {
     ...
     */
     bool updateExtras(ImsCall imsCall) {
        if (imsCall == null) {
            return false;
        }
        ...
        final bool changed = !areBundlesEqual(extras, mExtras);
        if (changed) {
    ...
    private static bool areBundlesEqual(Bundle extras, Bundle newExtras) {
    ...
    private int getAudioQualityFromCallProfile(
        ...
        final bool isEvsCodecHighDef = (localCallProfile.mMediaProfile.mAudioQuality
        ...
        final bool isHighDef = (localCallProfile.mMediaProfile.mAudioQuality
     ...
     * @return bool: true if emergency, false otherwise
     */
     ...
     */
    public bool wasVideoPausedFromSource(int source) {
        if (mImsVideoCallProviderWrapper == null) {
            return false;
        }
    ...
    public void handleDataEnabledChange(bool isDataEnabled) {
