 ...
 *
 */
public final class ImsPhoneMmiCode : Handler : MmiCode {
...
*/
    ...
    newNetworkInitiatedUssd(String ussdMessage, bool isUssdRequest, ImsPhone phone) {
        ImsPhoneMmiCode ret;
    ...
    static bool isScMatchesSuppServType(String dialString) {
        bool isMatch = false;
     ...
     * such.
     */
    static private bool isShortCode(String dialString, ImsPhone phone) {
     ...
     */
    static private bool isShortCodeUSSD(String dialString, ImsPhone phone) {
        ...
        switch (ssData.requestType) {
            ...
            case ImsSsData.SS_ERASURE:
                if ((ssData.result == ImsSsData.RESULT_SUCCESS)
                     ...
                     */
                    bool cffEnabled = ((ssData.requestType == ImsSsData.SS_ACTIVATION
    ...
    private bool isServiceClassVoiceVideoOrNone(int serviceClass) {
    ...
    public void setIsSsInfo(bool isSsInfo) {
        mIsSsInfo = isSsInfo;
    }
