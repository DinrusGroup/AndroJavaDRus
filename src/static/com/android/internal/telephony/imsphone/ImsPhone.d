 ...
 * {@hide}
 */
public class ImsPhone : ImsPhoneBase {
    ...
    public static class ImsDialArgs : DialArgs {
        public static class Builder : DialArgs.Builder<ImsDialArgs.Builder> {
    ...
    private static class Cf {
        ...
        Cf(String cfNumber, bool isCfu, Message onComplete) {
    ...
    public void setServiceState(int state) {
        bool isVoiceRegStateChanged = false;
    ...
    private bool handleCallWaitingIncallSupplementaryService(
            String dialString) {
    ...
    private bool handleMultipartyIncallSupplementaryService(
            String dialString) {
        if (dialString.length() > 1) {
            return false;
        }
    ...
    override
    public void notifyForVideoCapabilityChanged(bool isVideoCapable) {
    ...
    public void setCallWaiting(bool enable, int serviceClass, Message onComplete) {
    ...
    public void handleMessage(Message msg) {
        ...
        switch (msg.what) {
            ...
            case EVENT_VOICE_CALL_ENDED:
                ...
                mCT.unregisterForVoiceCallEnded(this);
                // only update if roaming status changed
                bool newRoaming = getCurrentRoaming();
    ...
    public void setImsRegistered(bool value) {
    ...
    private void updateRoamingState(bool newRoaming) {
    ...
    private bool getCurrentRoaming() {
