 ...
 */
public class ImsExternalCallTracker : ImsPhoneCallTracker.PhoneStateListener {
     ...
     */
    public class ExternalCallStateListener : ImsExternalCallStateListener {
        override
     ...
     */
    public class ExternalConnectionListener : ImsExternalConnection.Listener {
        override
    ...
    private bool mIsVideoCapable;
    private bool mHasActiveCalls;
    ...
    private void createExternalConnection(ImsExternalCallState state) {
        ...
        bool isCallPullPermitted = isCallPullPermitted(state.isCallPullable(), videoState);
    ...
    private void updateExistingConnection(ImsExternalConnection connection,
        ...
        bool isCallPullPermitted = isCallPullPermitted(state.isCallPullable(), newVideoState);
        Log.d(TAG,
     ...
     */
    private bool containsCallId(List<ImsExternalCallState> externalCallStates, int callId) {
     ...
     * {@link Phone#notifyForVideoCapabilityChanged(bool)}.
     *
     ...
     */
    private bool isCallPullPermitted(bool isNetworkPullable, int videoState) {
