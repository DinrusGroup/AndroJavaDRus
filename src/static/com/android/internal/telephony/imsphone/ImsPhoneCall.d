 ...
 * {@hide}
 */
public class ImsPhoneCall : Call {
    ...
    private static final bool DBG = FORCE_DEBUG || Rlog.isLoggable(LOG_TAG, Log.DEBUG);
    private static final bool VDBG = FORCE_DEBUG || Rlog.isLoggable(LOG_TAG, Log.VERBOSE);
    ...
    private bool mRingbackTonePlayed = false;
     ...
     */
    public bool connectionDisconnected(ImsPhoneConnection conn) {
        if (mState != State.DISCONNECTED) {
            /* If only disconnected connections remain, we are disconnected*/

            bool hasOnlyDisconnectedConnections = true;
    ...
    /*package*/ static bool isLocalTone(ImsCall imsCall) {
    ...
    public bool update (ImsPhoneConnection conn, ImsCall imsCall, State state) {
        bool changed = false;
