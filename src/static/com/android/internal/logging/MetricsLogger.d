...
public class MetricsLogger {
    ...
    public void visibility(int category, bool visibile)
    ...
    public void action(int category, bool value) {
    ...
    /** @deprecated use {@link #visibility(int, bool)} */
    @Deprecated
    public static void visibility(Context context, int category, bool visibile)
            throws IllegalArgumentException {
    ...
    /** @deprecated use {@link #action(int, bool)} */
    @Deprecated
    public static void action(Context context, int category, bool value) {
        getLogger().action(category, value);
    }
