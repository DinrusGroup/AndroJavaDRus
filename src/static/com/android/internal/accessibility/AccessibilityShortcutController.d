...
public class AccessibilityShortcutController {
    ...
    private bool mIsShortcutEnabled;
    private bool mEnabledOnLockScreen;
    private int mUserId;
    ...
    private String getShortcutFeatureDescription(bool includeSummary) {
        final String currentShortcutServiceString = getTargetServiceComponentNameString(
                mContext, UserHandle.USER_CURRENT);
        if (currentShortcutServiceString == null) {
            return null;
    ...
    private bool isServiceEnabled(AccessibilityServiceInfo serviceInfo) {
        AccessibilityManager accessibilityManager =
                mFrameworkObjectProvider.getAccessibilityManagerInstance(mContext);
    ...
    private bool hasFeatureLeanback() {
