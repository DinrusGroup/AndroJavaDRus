...
public class PointerLocationView : View : InputDeviceListener,
    ...
    public static class PointerState {
        ...
        private bool[] mTraceCurrent = new bool[32];
        ...
        public void addTrace(float x, float y, bool current) {
            ...
            if (mTraceCount == traceCapacity) {
                ...
                bool[] newTraceCurrent = new bool[traceCapacity];
    ...
    public void setPrintCoords(bool state) {
        mPrintCoords = state;
    }
