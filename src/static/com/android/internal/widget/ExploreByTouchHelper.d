 ...
 * logical items. It : {@link android.view.accessibility.AccessibilityNodeProvider} and
 ...
 * </pre>
 */
public abstract class ExploreByTouchHelper : View.AccessibilityDelegate {
    ...
    private bool performAction(int virtualViewId, int action, Bundle arguments) {
        switch (virtualViewId) {
            case HOST_ID:
    ...
    private bool manageFocusForChild(int virtualViewId, int action) {
        switch (action) {
            case AccessibilityNodeInfo.ACTION_ACCESSIBILITY_FOCUS:
     ...
     */
    private bool isAccessibilityFocused(int virtualViewId) {
     ...
     * used in API 16+.
     */
    private class ExploreByTouchNodeProvider : AccessibilityNodeProvider {
        override
