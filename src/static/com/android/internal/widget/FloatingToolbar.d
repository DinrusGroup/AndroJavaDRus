...
public final class FloatingToolbar {
    ...
    public void setOutsideTouchable(
            bool outsideTouchable, @Nullable PopupWindow.OnDismissListener onDismiss) {
     ...
     */
    private bool isCurrentlyShowing(List<MenuItem> menuItems) {
    ...
    private static final class FloatingToolbarPopup {
        ...
        private bool mDismissed = true; // tracks whether this popup is dismissed or dismissing.
        private bool mHidden; // tracks whether this popup is hidden or hiding.
        ...
        private bool mOpenOverflowUpwards;  // Whether the overflow opens upwards or downwards.
        private bool mIsOverflowOpen;
         ...
         *
         * @see PopupWindow#setOutsideTouchable(bool)
         * @see PopupWindow#setFocusable(bool)
         * @see PopupWindow.OnDismissListener
         */
        public bool setOutsideTouchable(
                bool outsideTouchable, @Nullable PopupWindow.OnDismissListener onDismiss) {
            bool ret = false;
        ...
        public List<MenuItem> layoutMainPanelItems(
            ...
            while (!remainingMenuItems.isEmpty()) {
                ...
                final bool showIcon = isFirstItem && menuItem.getItemId() == R.id.textAssist;
                ...
                final bool canFitWithOverflow =
                        menuItemButtonWidth <=
                                availableWidth - mOverflowButtonSize.getWidth();
                final bool canFitNoOverflow =
        ...
        private bool isOverflowAnimating() {
            final bool overflowOpening = mOpenOverflowAnimation.hasStarted()
                    && !mOpenOverflowAnimation.hasEnded();
            final bool overflowClosing = mCloseOverflowAnimation.hasStarted()
         ...
         */
        private static final class OverflowPanel : ListView {
         ...
         */
        private static final class LogAccelerateInterpolator : Interpolator {
        ...
        private static final class OverflowPanelViewHelper {
            ...
            private bool shouldShowIcon(MenuItem menuItem) {
                if (menuItem != null) {
