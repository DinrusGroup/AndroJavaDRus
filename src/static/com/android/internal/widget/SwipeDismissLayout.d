 ...
 */
public class SwipeDismissLayout : FrameLayout {
    ...
    private bool mIsWindowNativelyTranslucent;
    ...
    private bool mDiscardIntercept;
    private VelocityTracker mVelocityTracker;
    private bool mBlockGesture = false;
    private bool mActivityTranslucencyConverted = false;
    ...
    private bool mDismissable = true;
     ...
     */
    protected bool canScroll(View v, bool checkV, float dx, float x, float y) {
    ...
    private class DismissAnimator : AnimatorUpdateListener, Animator.AnimatorListener {
        ...
        private bool mDismissOnComplete = false;
