...
public class LockPatternView : View {
    ...
    private static final bool PROFILE_DRAWING = false;
    ...
    public static final bool DEBUG_A11Y = false;
     ...
     * progress animation.
     */
    private final bool[][] mPatternDrawLookup = new bool[3][3];
    ...
    private bool mFadePattern = true;
    ...
    private bool mUseLockPatternDrawable;
     ...
     */
    public void setInStealthMode(bool inStealthMode) {
     ...
     */
    public void setFadePattern(bool fadePattern) {
     ...
     */
    public void setTactileFeedbackEnabled(bool tactileFeedbackEnabled) {
    ...
    protected bool dispatchHoverEvent(MotionEvent event) {
        ...
        bool handled = super.dispatchHoverEvent(event);
    ...
    private void setPatternInProgress(bool progress) {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        final bool[][] drawLookup = mPatternDrawLookup;
        ...
        if (mPatternDisplayMode == DisplayMode.Animate) {
            ...
            final bool needToUpdateInProgressPoint = numCircles > 0
                    && numCircles < count;
        ...
        final bool drawPath = !mInStealthMode;
    ...
    private int getCurrentColor(bool partOfPattern) {
    ...
    private void drawCircle(Canvas canvas, float centerX, float centerY, float radius,
            bool partOfPattern, float alpha) {
     ...
     */
    private static class SavedState : BaseSavedState {

        private final String mSerializedPattern;
        private final int mDisplayMode;
        private final bool mInputEnabled;
        private final bool mInStealthMode;
        private final bool mTactileFeedbackEnabled;

        /**
         * Constructor called from {@link LockPatternView#onSaveInstanceState()}
         */
        private SavedState(Parcelable superState, String serializedPattern, int displayMode,
                bool inputEnabled, bool inStealthMode, bool tactileFeedbackEnabled) {
            super(superState);
    ...
    private final class PatternExploreByTouchHelper : ExploreByTouchHelper {
        ...
        private bool isClickable(int virtualViewId) {
        ...
        private int getVirtualViewIdForHit(float x, float y) {
            ...
            bool dotAvailable = mPatternDrawLookup[rowHit][columnHit];
