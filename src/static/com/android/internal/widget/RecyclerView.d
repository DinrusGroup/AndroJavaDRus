 ...
 */
public class RecyclerView : ViewGroup : ScrollingView, NestedScrollingChild {
     ...
     */
    private void setAdapterInternal(Adapter adapter, bool compatibleWithPrevious,
    ...
    void resumeRequestLayout(bool performLayoutChildren) {
    ...
    private bool isPreferredNextFocus(View focused, View next, int direction) {
        ...
        if (direction == View.FOCUS_FORWARD || direction == View.FOCUS_BACKWARD) {
            final bool rtl = mLayout.getLayoutDirection() == View.LAYOUT_DIRECTION_RTL;
     ...
     */
    private bool isPreferredNextFocusAbsolute(View focused, View next, int direction) {
    ...
    protected void onMeasure(int widthSpec, int heightSpec) {
        ...
        if (mLayout.mAutoMeasure) {
            ...
            final bool skipMeasure = widthMode == MeasureSpec.EXACTLY
    ...
    public final class Recycler {
         ...
         * @return
         */
        private bool tryBindViewHolderByDeadline(ViewHolder holder, int offsetPosition,
    ...
    public abstract static class Adapter<VH : ViewHolder> {
         ...
         */
        public bool onFailedToRecycleView(VH holder) {
            return false;
        }
    ...
    public abstract static class LayoutManager {
         ...
         *
         * @see #setAutoMeasureEnabled(bool)
         */
         ...
         */
        public void getTransformedBoundingBox(View child, bool includeDecorInsets, Rect out) {
         ...
         */
        public bool requestChildRectangleOnScreen(RecyclerView parent, View child, Rect rect,
                bool immediate) {
         ...
         */
        @Deprecated
        public bool onRequestChildFocus(RecyclerView parent, View child, View focused) {
         ...
         */
        public bool onRequestChildFocus(RecyclerView parent, State state, View child,
                View focused) {
         ...
         */
        public bool onAddFocusables(RecyclerView recyclerView, ArrayList<View> views,
         ...
         */
        public bool isLayoutHierarchical(Recycler recycler, State state) {
            return false;
        }
         ...
         */
        public bool performAccessibilityAction(Recycler recycler, State state, int action,
                Bundle args) {
            if (mRecyclerView == null) {
                return false;
            }
         ...
         * @see View#performAccessibilityAction(int, android.os.Bundle)
         */
        public bool performAccessibilityActionForItem(Recycler recycler, State state, View view,
    ...
    public interface OnItemTouchListener {
         ...
         *         the gesture.
         */
        bool onInterceptTouchEvent(RecyclerView rv, MotionEvent e);
    ...
    public abstract static class ItemAnimator {
         ...
         * @return true if there are any item animations currently running, false otherwise.
         */
        public final bool isRunning(ItemAnimatorFinishedListener listener) {
