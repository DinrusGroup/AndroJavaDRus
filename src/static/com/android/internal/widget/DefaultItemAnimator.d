 ...
 */
public class DefaultItemAnimator : SimpleItemAnimator {
    ...
    public void runPendingAnimations() {
        ...
        bool changesPending = !mPendingChanges.isEmpty();
    ...
    override
    public bool animateRemove(final ViewHolder holder) {
    ...
    override
    public bool animateAdd(final ViewHolder holder) {
        resetAnimation(holder);
    ...
    override
    public bool animateMove(final ViewHolder holder, int fromX, int fromY,
            int toX, int toY) {
        final View view = holder.itemView;
    ...
    override
    public bool animateChange(ViewHolder oldHolder, ViewHolder newHolder,
            int fromX, int fromY, int toX, int toY) {
    ...
    private bool endChangeAnimationIfNecessary(ChangeInfo changeInfo, ViewHolder item) {
        bool oldItem = false;
