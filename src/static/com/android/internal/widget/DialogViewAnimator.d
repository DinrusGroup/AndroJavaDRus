 ...
 */
public class DialogViewAnimator : ViewAnimator {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        final bool measureMatchParentChildren =
        ...
        for (int i = 0; i < count; i++) {
            ...
            if (getMeasureAllChildren() || child.getVisibility() != GONE) {
                ...
                final bool matchWidth = lp.width == LayoutParams.MATCH_PARENT;
                final bool matchHeight = lp.height == LayoutParams.MATCH_PARENT;
