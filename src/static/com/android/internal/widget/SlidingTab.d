 ...
 *
 */
public class SlidingTab : ViewGroup {
    ...
    private static class Slider {
        ...
        void hide() {
            bool horiz = alignment == ALIGN_LEFT || alignment == ALIGN_RIGHT;
        ...
        void reset(bool animate) {
            ...
            tab.setVisibility(View.VISIBLE);
            target.setVisibility(View.INVISIBLE);
            final bool horiz = alignment == ALIGN_LEFT || alignment == ALIGN_RIGHT;
    ...
    public bool onInterceptTouchEvent(MotionEvent event) {
        ...
        bool leftHit = mTmpRect.contains((int) x, (int) y);

        View rightHandle = mRightSlider.tab;
        rightHandle.getHitRect(mTmpRect);
        bool rightHit = mTmpRect.contains((int)x, (int) y);
                ...
                case MotionEvent.ACTION_MOVE:
                    if (withinView(x, y, this) ) {
                        ...
                        if (!mTriggered && thresholdReached) {
                            ...
                            bool isLeft = mCurrentSlider == mLeftSlider;
    ...
    void startAnimating(final bool holdAfter) {
        mAnimating = true;
    ...
    private bool withinView(final float x, final float y, final View view) {
    ...
    public void setHoldAfterTrigger(bool holdLeft, bool holdRight) {
    ...
    private synchronized void vibrate(long duration) {
        final bool hapticEnabled = Settings.System.getIntForUser(
