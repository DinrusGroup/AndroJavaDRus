 ...
 * </ul>
 */
public abstract class AutoScrollHelper : View.OnTouchListener {
    /**
     ...
     */
    public AutoScrollHelper setEnabled(bool enabled) {
        if (mEnabled && !enabled) {
            requestStop();
        }
     ...
     * @return The scroll helper, which may used to chain setter calls.
     */
    public AutoScrollHelper setExclusive(bool exclusive) {
     ...
     *         specified direction.
     */
    public abstract bool canTargetScrollHorizontally(int direction);
     ...
     *         specified direction.
     */
    public abstract bool canTargetScrollVertically(int direction);
    ...
    private class ScrollAnimationRunnable : Runnable {
        override
        public void run() {
            if (!mAnimating) {
                return;
     ...
     */
    public static class AbsListViewAutoScroller : AutoScrollHelper {
        ...
        override
        public bool canTargetScrollHorizontally(int direction) {
            // List do not scroll horizontally.
            return false;
        }

        override
        public bool canTargetScrollVertically(int direction) {
