...
public class MessagingImageMessage : ImageView : MessagingMessage {
    ...
    override
    public bool setMessage(Notification.MessagingStyle.Message message) {
    ...
    static MessagingMessage createMessage(MessagingLayout layout,
        ...
        bool created = createdMessage.setMessage(m);
        if (!created) {
    ...
    public int getMeasuredType() {
        ...
        bool measuredTooSmall = measuredHeight < minImageHeight
