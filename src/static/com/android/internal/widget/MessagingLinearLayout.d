...
public class MessagingLinearLayout : ViewGroup {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        for (int i = count - 1; i >= 0 && totalHeight < targetHeight; i--) {
            ...
            bool isShortened = measureType == MessagingChild.MEASURED_SHORTENED;
            bool isTooSmall = measureType == MessagingChild.MEASURED_TOO_SMALL;
    ...
    public static bool isGone(View view) {
    ...
    public static class LayoutParams : MarginLayoutParams {
        ...
        public bool visibleBefore = false;
