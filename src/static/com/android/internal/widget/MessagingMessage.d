 ...
 */
public interface MessagingMessage : MessagingLinearLayout.MessagingChild {
    ...
    static bool hasImage(Notification.MessagingStyle.Message m) {
     ...
     */
    default bool setMessage(Notification.MessagingStyle.Message message) {
    ...
    default bool sameAs(Notification.MessagingStyle.Message message) {
        ...
        bool hasRemoteInputHistoryChanged = message.isRemoteInputHistory()
    ...
    default bool sameAs(MessagingMessage message) {
    ...
    default void setIsHistoric(bool isHistoric) {
    ...
    default void setIsHidingAnimated(bool isHiding) {
        getState().setIsHidingAnimated(isHiding);
    }

    override
    default bool isHidingAnimated() {
    ...
    default bool hasOverlappingRendering() {
        return false;
    }
