 ...
 * @hide
 */
public class ActionBarView : AbsActionBarView : DecorToolbar {
    ...
    private bool mIsCollapsible;
    private bool mWasHomeEnabled; // Was it enabled before action view expansion?

    private MenuBuilder mOptionsMenu;
    private bool mMenuPrepared;
    ...
    override
    public void setSplitToolbar(bool splitActionBar) {
    ...
    public void setCustomView(View view) {
        final bool showCustom = (mDisplayOptions & ActionBar.DISPLAY_SHOW_CUSTOM) != 0;
    ...
    private void setTitleImpl(CharSequence title) {
        ...
        if (mTitleView != null) {
            ...
            final bool visible = mExpandedActionView == null &&
    ...
    private void setHomeButtonEnabled(bool enable, bool recordState) {
        if (recordState) {
    ...
    private void updateHomeAccessibility(bool homeEnabled) {
        if (!homeEnabled) {
    ...
    public void setDisplayOptions(int options) {
        ...
        if ((flagsChanged & DISPLAY_RELAYOUT_MASK) != 0) {
            ...
            if ((flagsChanged & ActionBar.DISPLAY_HOME_AS_UP) != 0) {
                final bool setUp = (options & ActionBar.DISPLAY_HOME_AS_UP) != 0;
            ...
            if ((flagsChanged & ActionBar.DISPLAY_USE_LOGO) != 0) {
                final bool logoVis = mLogo != null && (options & ActionBar.DISPLAY_USE_LOGO) != 0;
            ...
            final bool showHome = (options & ActionBar.DISPLAY_SHOW_HOME) != 0;
            final bool homeAsUp = (mDisplayOptions & ActionBar.DISPLAY_HOME_AS_UP) != 0;
            final bool titleUp = !showHome && homeAsUp;
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        final bool showTitle = mTitleLayout != null && mTitleLayout.getVisibility() != GONE &&
                (mDisplayOptions & ActionBar.DISPLAY_SHOW_TITLE) != 0;
    ...
    private static class HomeView : FrameLayout {
        ...
        public void setShowUp(bool isUp) {
            mUpView.setVisibility(isUp ? VISIBLE : GONE);
        }

        public void setShowIcon(bool showIcon) {
    ...
    private class ExpandedActionViewMenuPresenter : MenuPresenter {
        MenuBuilder mMenu;
