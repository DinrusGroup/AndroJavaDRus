 ...
 * @hide
 */
public class ActionBarContainer : FrameLayout {
    ...
    private static bool isCollapsed(View view) {
    ...
    override
    public void onLayout(bool changed, int l, int t, int r, int b) {
        super.onLayout(changed, l, t, r, b);

        final View tabContainer = mTabContainer;
        final bool hasTabs = tabContainer != null && tabContainer.getVisibility() != GONE;
     ...
     * projection surfaces.
     */
    private class ActionBarBackgroundDrawable : Drawable {
        override
