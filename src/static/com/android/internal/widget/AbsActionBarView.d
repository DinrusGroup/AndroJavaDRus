...
public abstract class AbsActionBarView : ViewGroup {
    ...
    protected bool mSplitActionBar;
    protected bool mSplitWhenNarrow;
     ...
     */
    public void setSplitToolbar(bool split) {
     ...
     */
    public void setSplitWhenNarrow(bool splitWhenNarrow) {
    ...
    static protected int next(int x, int val, bool isRtl) {
        return isRtl ? x - val : x + val;
    }

    protected int positionChild(View child, int x, int y, int contentHeight, bool reverse) {
    ...
    protected class VisibilityAnimListener : Animator.AnimatorListener {
