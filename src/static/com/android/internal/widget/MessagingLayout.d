...
public class MessagingLayout : FrameLayout {
    ...
    private bool mShowHistoricMessages;
    ...
    private bool mIsOneToOne;
    private ArrayList<MessagingGroup> mAddedGroups = new ArrayList<>();
    private Person mUser;
    private CharSequence mNameReplacement;
    private bool mDisplayImagesAtEnd;
    ...
    private void updateTitleAndNamesDisplay() {
        ...
        for (int i = 0; i < mGroups.size(); i++) {
            ...
            MessagingGroup group = mGroups.get(i);
            bool isOwnMessage = group.getSender() == mUser;
            CharSequence senderName = group.getSenderName();
            if (!group.needsGeneratedAvatar() || TextUtils.isEmpty(senderName)
    ...
    public Icon createAvatarSymbol(CharSequence senderName, String symbol, int layoutColor) {
        if (symbol.isEmpty() || TextUtils.isDigitsOnly(symbol) ||
            ...
            bool needDarkText = ColorUtils.calculateLuminance(color) > 0.5f;
    ...
    @RemotableViewMethod
    public void setIsOneToOne(bool oneToOne) {
    ...
    private void addMessagesToGroups(List<MessagingMessage> historicMessages,
            List<MessagingMessage> messages, bool showSpinner) {
    ...
    private void createGroupViews(List<List<MessagingMessage>> groups,
            List<Person> senders, bool showSpinner) {
        mGroups.clear();
    ...
    private void findGroups(List<MessagingMessage> historicMessages,
        ...
        for (int i = 0; i < histSize + messages.size(); i++) {
            ...
            bool isNewGroup = currentGroup == null;
    ...
    private List<MessagingMessage> createMessages(
            List<Notification.MessagingStyle.Message> newMessages, bool historic) {
    ...
    public void showHistoricMessages(bool show) {
