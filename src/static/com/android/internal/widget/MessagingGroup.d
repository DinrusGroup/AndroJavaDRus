...
public class MessagingGroup : LinearLayout : MessagingLinearLayout.MessagingChild {
    ...
    private bool mIsHidingAnimated;
    private bool mNeedsGeneratedAvatar;
    private Person mSender;
    private bool mImagesAtEnd;
    private ViewGroup mImageContainer;
    private MessagingImageMessage mIsolatedMessage;
    private bool mTransformingImages;
    ...
    public int getMeasuredType() {
        ...
        for (int i = mMessageContainer.getChildCount() - 1; i >= 0; i--) {
            ...
            if (child instanceof MessagingLinearLayout.MessagingChild) {
                ...
                bool tooSmall = type == MEASURED_TOO_SMALL;
    ...
    override
    public bool isHidingAnimated() {
        return mIsHidingAnimated;
    }

    private void setIsHidingAnimated(bool isHiding) {
    ...
    public void setMessages(List<MessagingMessage> group) {
        ...
        for (int messageIndex = 0; messageIndex < group.size(); messageIndex++) {
            ...
            bool isImage = message instanceof MessagingImageMessage;
     ...
     */
    private bool removeFromParentIfDifferent(MessagingMessage message, ViewGroup newParent) {
    ...
    protected void onLayout(bool changed, int left, int top, int right, int bottom) {
        ...
        if (!mAddedMessages.isEmpty()) {
            final bool firstLayout = mFirstLayout;
    ...
    public bool needsGeneratedAvatar() {
    ...
    public void setTransformingImages(bool transformingImages) {
        mTransformingImages = transformingImages;
    }

    public void setDisplayImagesAtEnd(bool atEnd) {
