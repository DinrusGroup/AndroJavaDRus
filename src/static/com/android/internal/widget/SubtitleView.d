...
public class SubtitleView : View {
    ...
    private bool computeMeasurements(int maxWidth) {
    ...
    protected void onDraw(Canvas c) {
        ...
        if (edgeType == CaptionStyle.EDGE_TYPE_OUTLINE) {
            ...
            final bool raised = edgeType == CaptionStyle.EDGE_TYPE_RAISED;
