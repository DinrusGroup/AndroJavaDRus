 ...
 * class that : {@link ItemHolderInfo}.
 */
public abstract class SimpleItemAnimator : RecyclerView.ItemAnimator {
    ...
    override
    public bool animateDisappearance(@NonNull ViewHolder viewHolder,
    ...
    override
    public bool animateAppearance(@NonNull ViewHolder viewHolder,
    ...
    override
    public bool animatePersistence(@NonNull ViewHolder viewHolder,
    ...
    override
    public bool animateChange(@NonNull ViewHolder oldHolder, @NonNull ViewHolder newHolder,
            @NonNull ItemHolderInfo preInfo, @NonNull ItemHolderInfo postInfo) {
        if (DEBUG) {
     ...
     * false otherwise.
     */
    public abstract bool animateRemove(ViewHolder holder);
     ...
     * false otherwise.
     */
    public abstract bool animateAdd(ViewHolder holder);
     ...
     * false otherwise.
     */
    public abstract bool animateMove(ViewHolder holder, int fromX, int fromY,
            int toX, int toY);
     ...
     * {@link #dispatchChangeFinished(ViewHolder, bool)} for each non-null distinct ViewHolder,
     ...
     * {@link #dispatchChangeFinished(ViewHolder, bool)} once and only once. In that case, the
     ...
     * false otherwise.
     */
    public abstract bool animateChange(ViewHolder oldHolder,
     ...
     */
    public final void dispatchChangeFinished(ViewHolder item, bool oldItem) {
     ...
     *                it is the new item that replaced the old item.
     */
    public final void dispatchChangeStarting(ViewHolder item, bool oldItem) {
     ...
     */
    @SuppressWarnings("UnusedParameters")
    public void onChangeStarting(ViewHolder item, bool oldItem) {
    }
     ...
     *                it is the new item that replaced the old item.
     */
    public void onChangeFinished(ViewHolder item, bool oldItem) {
    }
}
