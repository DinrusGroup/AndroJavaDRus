...
public class ItemTouchHelper : RecyclerView.ItemDecoration
     ...
     */
    int endRecoverAnimation(ViewHolder viewHolder, bool override) {
        final int recoverAnimSize = mRecoverAnimations.size();
        for (int i = recoverAnimSize - 1; i >= 0; i--) {
     ...
     */
    bool checkSelectForSwipe(int action, MotionEvent motionEvent, int pointerIndex) {
    ...
    public abstract static class Callback {
         ...
         * otherwise.
         */
        public bool canDropOver(RecyclerView recyclerView, ViewHolder current,
                ViewHolder target) {
            return true;
        }
    ...
    private class RecoverAnimation : Animator.AnimatorListener {
