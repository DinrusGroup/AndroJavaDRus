 ...
 */
public class MessagingPropertyAnimator : View.OnLayoutChangeListener {
    ...
    private static bool isFirstLayout(View view) {
    ...
    private static void setFirstLayout(View view, bool first) {
    ...
    private static bool isHidingAnimated(View v) {
    ...
    private static void updateLayerType(View view, bool animating) {
    ...
    public static void setClippingDeactivated(final View transformedView, bool deactivated) {
        ViewClippingUtil.setClippingDeactivated(transformedView, deactivated,
                CLIPPING_PARAMETERS);
    }

    public static bool isAnimatingTranslation(View v) {
        return v.getTag(TAG_TOP_ANIMATOR) != null;
    }

    public static bool isAnimatingAlpha(View v) {
