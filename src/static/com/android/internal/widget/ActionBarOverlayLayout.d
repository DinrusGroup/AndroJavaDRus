 ...
 */
public class ActionBarOverlayLayout : ViewGroup : DecorContentParent {
    ...
    private bool mAnimatingForFling;
    ...
    public void setHasNonEmbeddedTabs(bool hasNonEmbeddedTabs) {
        mHasNonEmbeddedTabs = hasNonEmbeddedTabs;
    }

    public void setShowingForActionMode(bool showing) {
        if (showing) {
    ...
    public void onWindowSystemUiVisibilityChanged(int visible) {
        ...
        final bool barVisible = (visible & SYSTEM_UI_FLAG_FULLSCREEN) == 0;
        final bool stable = (visible & SYSTEM_UI_FLAG_LAYOUT_STABLE) != 0;
    ...
    private bool applyInsets(View view, Rect insets, bool left, bool top,
    ...
    public WindowInsets onApplyWindowInsets(WindowInsets insets) {
        ...
        final bool stable = (vis & SYSTEM_UI_FLAG_LAYOUT_STABLE) != 0;
        final Rect systemInsets = insets.getSystemWindowInsets();

        // The top and bottom action bars are always within the content area.
        bool changed = applyInsets(mActionBarTop, systemInsets, true, true, false, true);
    ...
    private bool shouldHideActionBarOnFling(float velocityX, float velocityY) {
    ...
    public void setUiOptions(int uiOptions) {
        bool splitActionBar = false;
        final bool splitWhenNarrow =
    ...
    public interface ActionBarVisibilityCallback {
        ...
        void showForSystem();
        void hideForSystem();
        void enableContentAnimations(bool enable);
