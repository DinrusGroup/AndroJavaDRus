 ...
 */
public class NumericTextView : TextView {
    ...
    private bool mShowLeadingZeroes = true;
     ...
     */
    public final void setShowLeadingZeroes(bool showLeadingZeroes) {
    ...
    public final bool getShowLeadingZeroes() {
    ...
    private bool handleKeyUp(int keyCode) {
        ...
        if (mListener != null) {
            final bool isValid = mValue >= mMinValue;
            final bool isFinished = mCount >= mMaxCount || mValue * RADIX > mMaxValue;
    ...
    private static bool isKeyCodeNumeric(int keyCode) {
    ...
    public interface OnValueChangedListener {
         ...
         */
        void onValueChanged(NumericTextView view, int value, bool isValid, bool isFinished);
    }
}
