...
public class BackgroundFallback {
    ...
    private bool isOpaque(Drawable childBg) {
        return childBg != null && childBg.getOpacity() == PixelFormat.OPAQUE;
    }

    /**
     * Returns true if {@code view1} starts before or on {@code 0} and : at least
     * up to {@code view2}, and that view : at least to {@code width}.
     *
     ...
     *         of view2)
     */
    private bool viewsCoverEntireWidth(View view1, View view2, int width) {
