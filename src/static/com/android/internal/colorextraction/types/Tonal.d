 ...
 */
public class Tonal : ExtractionType {
    ...
    public void extractInto(@Nullable WallpaperColors inWallpaperColors,
        ...
        bool success = runTonalExtraction(inWallpaperColors, outColorsNormal, outColorsDark,
                outColorsExtraDark);
        if (!success) {
     ...
     */
    private bool runTonalExtraction(@Nullable WallpaperColors inWallpaperColors,
            @NonNull GradientColors outColorsNormal, @NonNull GradientColors outColorsDark,
            @NonNull GradientColors outColorsExtraDark) {
        ...
        final bool supportsDarkText = (hints & WallpaperColors.HINT_SUPPORTS_DARK_TEXT) != 0;
        final bool generatedFromBitmap = (hints & WallpaperColors.HINT_FROM_BITMAP) != 0;
    ...
    public static void applyFallback(@Nullable WallpaperColors inWallpaperColors,
        ...
        bool light = inWallpaperColors != null
     ...
     */
    private bool isBlacklisted(float[] hsl) {
    ...
    public static class ColorRange {
        ...
        public bool containsColor(float h, float s, float l) {
            if (!mHue.contains(h)) {
                return false;
