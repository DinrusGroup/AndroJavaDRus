...
class WebViewZygoteInit {
    ...
    private static class WebViewZygoteServer : ZygoteServer {
        override
    ...
    private static class WebViewZygoteConnection : ZygoteConnection {
        ...
        protected void handlePreloadPackage(String packagePath, String libsPath, String libFileName,
            ...
            try {
                ...
                if (preloadInZygote.getReturnType() != Boolean.TYPE) {
                    Log.e(TAG, "Unexpected return type: preloadInZygote must return bool");
                } else {
                    preloadSucceeded = (bool) providerClass.getMethod("preloadInZygote")
                            .invoke(null);
                    if (!preloadSucceeded) {
