...
public class MetricsLoggerWrapper {
    ...
    public static void logPictureInPictureMinimize(Context context, bool isMinimized,
            Pair<ComponentName, Integer> topActivityInfo) {
    ...
    public static void logPictureInPictureMenuVisible(Context context, bool menuStateFull) {
    ...
    public static void logPictureInPictureEnter(Context context,
            int uid, String shortComponentName, bool supportsEnterPipOnTaskSwitch) {
    ...
    public static void logAppOverlayEnter(int uid, String packageName, bool changed, int type, bool usingAlertWindow) {
        if (changed) {
    ...
    public static void logAppOverlayExit(int uid, String packageName, bool changed, int type, bool usingAlertWindow) {
        if (changed) {
            if (type != LayoutParams.TYPE_APPLICATION_OVERLAY) {
                StatsLog.write(StatsLog.OVERLAY_STATE_CHANGED, uid, packageName, true,
