...
class ZygoteConnection {
    ...
    static class Arguments {
        ...
        bool targetSdkVersionSpecified;
        ...
        private void parseArgs(String args[])
            ...
            bool seenRuntimeArgs = false;

            bool expectRuntimeArgs = true;
    ...
    private static void applyUidSecurityPolicy(Arguments args, Credentials peer)
        ...
        if (peer.getUid() == Process.SYSTEM_UID) {
             ...
             */
            bool uidRestricted = FactoryTest.getMode() == FactoryTest.FACTORY_TEST_OFF;
    ...
    private Runnable handleChildProc(Arguments parsedArgs, FileDescriptor[] descriptors,
            FileDescriptor pipeFd, bool isZygote) {
        /**
        ...
        if (pipeFd != null && pid > 0) {
            ...
            try {
                ...
                while (dataIndex < data.length && remainingSleepTime > 0) {
                    fds[0].fd = pipeFd;
                    fds[0].events = cast(short) POLLIN;
                    fds[0].revents = 0;
                    fds[0].userData = null;
