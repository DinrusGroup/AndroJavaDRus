...
public abstract class LoggingPrintStream : PrintStream {
     ...
     */
    private void flush(bool completely) {
    ...
    public void write(int oneByte) {
        write(new byte[] { cast(byte) oneByte }, 0, 1);
    }
    ...
    override
    public synchronized void print(bool bool) {
        builder.append(bool);
    }
    ...
    override
    public synchronized void println(bool bool) {
        builder.append(bool);
        flush(true);
    }
