...
public class KernelUidCpuFreqTimeReader :
    ...
    public interface Callback : KernelUidCpuTimeReaderBase.Callback {
    ...
    private bool mPerClusterTimesAvailable;
    private bool mAllUidTimesAvailable = true;
    ...
    public bool perClusterTimesAvailable() {
        return mPerClusterTimesAvailable;
    }

    public bool allUidTimesAvailable() {
    ...
    private bool getFreqTimeForUid(IntBuffer buffer, long[] freqTime) {
        bool valid = true;
        for (int i = 0; i < mCpuFreqsCount; i++) {
