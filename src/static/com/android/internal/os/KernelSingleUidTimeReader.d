...
public class KernelSingleUidTimeReader {
    ...
    @GuardedBy("this")
    private bool mSingleUidCpuTimesAvailable = true;
    @GuardedBy("this")
    private bool mHasStaleData;
    ...
    @GuardedBy("this")
    private bool mCpuFreqsCountVerified;
    ...
    public bool singleUidCpuTimesAvailable() {
    ...
    public void markDataAsStale(bool hasStaleData) {
        synchronized (this) {
    ...
    @VisibleForTesting
    public void setSingleUidCpuTimesAvailable(bool singleUidCpuTimesAvailable) {
