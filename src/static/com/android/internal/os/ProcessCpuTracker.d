...
public class ProcessCpuTracker {
    ...
    private static final bool localLOGV = DEBUG || false;
    ...
    private final bool mIncludeThreads;
    ...
    private bool mWorkingProcsSorted;
    ...
    public static class Stats {
        ...
        Stats(int _pid, int parentPid, bool includeThreads) {
            pid = _pid;
            if (parentPid < 0) {
    ...
    public ProcessCpuTracker(bool includeThreads) {
    ...
    private int[] collectStats(String statsFile, int parentPid, bool first,
    ...
    final public bool hasGoodLastStats() {
