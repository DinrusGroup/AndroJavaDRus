...
public class ClassLoaderFactory {
     ...
     */
    public static bool isValidClassLoaderName(String name) {
     ...
     */
    public static bool isPathClassLoaderName(String name) {
     ...
     */
    public static bool isDelegateLastClassLoaderName(String name) {
    ...
    public static ClassLoader createClassLoader(String dexPath,
            ...
            int targetSdkVersion, bool isNamespaceShared, String classloaderName) {
