...
public class RuntimeInit {
    ...
    private static volatile bool mCrashing = false;

    private static final native void nativeFinishInit();
    private static final native void nativeSetExitWithoutCleanup(bool exitWithoutCleanup);
     ...
     */
    private static class LoggingHandler : Thread.UncaughtExceptionHandler {
        public volatile bool mTriggered = false;
     ...
     */
    private static class KillApplicationHandler : Thread.UncaughtExceptionHandler {
     ...
     */
    public static void wtf(String tag, Throwable t, bool system) {
        try {
     ...
     */
    static class MethodAndArgsCaller : Runnable {
        /** method to call */
