...
public class BatteryStatsHelper {
    ...
    final private bool mCollectBatteryBroadcast;
    final private bool mWifiOnly;
    ...
    bool mHasWifiPowerReporting = false;
    bool mHasBluetoothPowerReporting = false;

    public static bool checkWifiOnly(Context context) {
    ...
    public static bool checkHasWifiPowerReporting(BatteryStats stats, PowerProfile profile) {
    ...
    public static bool checkHasBluetoothPowerReporting(BatteryStats stats,
    ...
    public BatteryStatsHelper(Context context, bool collectBatteryBroadcast) {
        this(context, collectBatteryBroadcast, checkWifiOnly(context));
    }

    public BatteryStatsHelper(Context context, bool collectBatteryBroadcast, bool wifiOnly) {
        mContext = context;
    ...
    public void refreshStats(int statsType, SparseArray<UserHandle> asUsers, long rawRealtimeUs,
        ...
        final bool hasWifiPowerReporting = checkHasWifiPowerReporting(mStats, mPowerProfile);
        ...
        final bool hasBluetoothPowerReporting = checkHasBluetoothPowerReporting(mStats,
                mPowerProfile);
    ...
    private void processAppUsage(SparseArray<UserHandle> asUsers) {
        final bool forAllUsers = (asUsers.get(UserHandle.USER_ALL) != null);
        mStatsPeriod = mTypeBatteryRealtimeUs;

        BatterySipper osSipper = null;
        final SparseArray<? : Uid> uidStats = mStats.getUidStats();
     ...
     */
    public bool shouldHideSipper(BatterySipper sipper) {
     ...
     */
    public bool isTypeService(BatterySipper sipper) {
     ...
     */
    public bool isTypeSystem(BatterySipper sipper) {
