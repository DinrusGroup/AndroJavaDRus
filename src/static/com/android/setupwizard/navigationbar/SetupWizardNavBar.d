 ...
 */
public class SetupWizardNavBar : Fragment : OnPreDrawListener, OnClickListener {
     ...
     */
    public void setUseImmersiveMode(bool useImmersiveMode) {
        // By default, enable layoutHideNavigation if immersive mode is used
        setUseImmersiveMode(useImmersiveMode, useImmersiveMode);
    }

    public void setUseImmersiveMode(bool useImmersiveMode, bool layoutHideNavigation) {
        if (useImmersiveMode) {
    ...
    private int getNavbarTheme() {
        ...
        if (theme == 0) {
            ...
            bool isDarkBg = foregroundHsv[2] > backgroundHsv[2];
    ...
    public static class NavButton : Button {
