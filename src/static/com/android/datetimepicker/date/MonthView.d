...
abstract class MonthView : View {
    ...
    protected bool mHasToday = false;
    ...
    private bool mLockAccessibilityDelegate;
    ...
    private bool sameDay(int day, Time today) {
     ...
     * Integer.MAX_VALUE.
     */
    protected bool isOutOfRange(int year, int month, int day) {
    ...
    private bool isBeforeMin(int year, int month, int day) {
        if (mController == null) {
            return false;
        }
    ...
    private bool isAfterMax(int year, int month, int day) {
        if (mController == null) {
            return false;
        }
     ...
     */
    public bool restoreAccessibilityFocus(CalendarDay day) {
     ...
     * service.
     */
    protected class MonthViewTouchHelper : ExploreByTouchHelper {
