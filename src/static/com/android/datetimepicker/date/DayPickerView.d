 ...
 */
abstract class DayPickerView : ListView : OnScrollListener,
    ...
    protected bool mShowWeekNumber = false;
    ...
    private bool mPerformingScroll;
     ...
     */
    public bool goTo(CalendarDay day, bool animate, bool setSelected, bool forceScroll) {
    ...
    protected class ScrollStateRunnable : Runnable {
        ...
        public void run() {
            ...
            if (mNewState == OnScrollListener.SCROLL_STATE_IDLE
                ...
                bool scroll = firstPosition != 0 && lastPosition != getCount() - 1;
     ...
     */
    private bool restoreAccessibilityFocus(CalendarDay day) {
        if (day == null) {
            return false;
        }
