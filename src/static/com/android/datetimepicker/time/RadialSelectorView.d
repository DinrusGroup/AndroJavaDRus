...
class RadialSelectorView : View {
     ...
     */
    public void initialize(Context context, bool is24HourMode, bool hasInnerCircle,
            bool disappearsOut, int selectionDegrees, bool isInnerCircle) {
        if (mIsInitialized) {
     ...
     */
    public void setSelection(int selectionDegrees, bool isInnerCircle, bool forceDrawDot) {
    ...
    public int getDegreesFromCoords(float pointX, float pointY, bool forceLegal,
        ...
        if (mHasInnerCircle) {
            if (forceLegal) {
                ...
                // bool based based off whichever number the coordinates are closer to.
                ...
                // two allotted equally), set the isInnerCircle bool as the closer one.
        ...
        bool rightSide = (pointX > mXCenter);
        bool topSide = (pointY < mYCenter);
     ...
     */
    private class InvalidateUpdateListener : AnimatorUpdateListener {
        override
