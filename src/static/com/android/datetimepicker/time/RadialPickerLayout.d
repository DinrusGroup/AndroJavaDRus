 ...
 */
public class RadialPickerLayout : FrameLayout : OnTouchListener {
    ...
    private bool mTimeInitialized;
    private int mCurrentHoursOfDay;
    private int mCurrentMinutes;
    private bool mIs24HourMode;
    private bool mHideAmPm;
    ...
    private bool mDoingMove;
    private bool mDoingTouch;
    ...
    public interface OnValueSelectedListener {
        void onValueSelected(int pickerIndex, int newValue, bool autoAdvance);
    }
    ...
    public void initialize(Context context, HapticFeedbackController hapticFeedbackController,
            int initialHoursOfDay, int initialMinutes, bool is24HourMode) {
        if (mTimeInitialized) {
    ...
    /* package */ void setTheme(Context context, bool themeDark) {
     ...
     */
    private bool isHourInnerCircle(int hourOfDay) {
     ...
     */
    private int reselectSelector(int degrees, bool isInnerCircle,
            bool forceToVisibleValue, bool forceDrawDot) {
        if (degrees == -1) {
            return -1;
        }
        ...
        int stepSize;
        bool allowFineGrained = !forceToVisibleValue && (currentShowing == MINUTE_INDEX);
        if (allowFineGrained) {
     ...
     * @param isInnerCircle If the selection may be in the inner circle, pass in a size-1 bool
     ...
     */
    private int getDegreesFromCoords(float pointX, float pointY, bool forceLegal,
     ...
     */
    public void setCurrentItemShowing(int index, bool animate) {
        ...
        switch(event.getAction()) {
            case MotionEvent.ACTION_DOWN:
                ...
                if (mIsTouchingAmOrPm == AM || mIsTouchingAmOrPm == PM) {
                    ...
                    bool forceLegal = mAccessibilityManager.isTouchExplorationEnabled();
     ...
     */
    public bool trySettingInputEnabled(bool inputEnabled) {
