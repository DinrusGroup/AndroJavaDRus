 ...
 */
@Deprecated
public class TimePickerDialog : DialogFragment : OnValueSelectedListener{
    ...
    private bool mThemeDark;

    // For hardware IME input.
    private char mPlaceholderText;
    private String mDoublePlaceholderText;
    private String mDeletedKeyFormat;
    private bool mInKbMode;
    ...
    public TimePickerDialog(Context context, int theme, OnTimeSetListener callback,
            int hourOfDay, int minute, bool is24HourMode) {
        // Empty constructor required for dialog fragment.
    }
     ...
     */
    public void setThemeDark(bool dark) {
        mThemeDark = dark;
    }
     ...
     */
    override
    public void onValueSelected(int pickerIndex, int newValue, bool autoAdvance) {
    ...
    private void setHour(int value, bool announce) {
        String format;
        if (mIs24HourMode) {
            format = "%02d";
        } else {
    ...
    private void setCurrentItemShowing(int index, bool animateCircle, bool delayLabelAnimate,
            bool announce) {
     ...
     */
    private bool processKeyUp(int keyCode) {
    ...
    private bool addKeyIfLegal(int keyCode) {
     ...
     */
    private bool isTypedTimeLegalSoFar() {
     ...
     */
    private void finishKbMode(bool updateDisplays) {
        mInKbMode = false;
        if (!mTypedTimes.isEmpty()) {
            int values[] = getEnteredTime(null);
     ...
     */
    private void updateDisplay(bool allowEmptyDisplay) {
     ...
     * @param enteredZeros A size-2 bool array, which the caller should initialize, and which
    ...
    private class KeyboardListener : OnKeyListener {
        override
