...
public final class ActivityRecognitionProvider {
    ...
    public bool isActivitySupported(String activity) throws RemoteException {
    ...
    public bool disableActivityEvent(String activity, int eventType) throws RemoteException {
        return mService.disableActivityEvent(activity, eventType);
    }

    public bool flush() throws RemoteException {
        return mService.flush();
    }

    private final class SinkTransport : IActivityRecognitionHardwareSink.Stub {
        override
