 ...
 * </p>
 * <pre>
 *   public class SampleRemoteDisplayProviderService : Service {
 ...
 *       }
 *
 *       class SampleProvider : RemoteDisplayProvider {
...
public abstract class RemoteDisplayProvider {
     ...
     * <p>
     * This is intended to be used for the onBind() method of a service that :
    ...
    final class ProviderStub : IRemoteDisplayProvider.Stub {
        override
    ...
    final class ProviderHandler : Handler {
