...
public class MediaSessionService2Impl : MediaSessionService2Provider {

    private static final String TAG = "MPSessionService"; // to meet 23 char limit in Log tag
    private static final bool DEBUG = true; // TODO(jaewan): Change this. (b/74094611)
    ...
    private bool mIsRunningForeground;
    ...
    private class SessionServiceEventCallback : PlayerEventCallback {
        override
    ...
    public static class MediaNotificationImpl : MediaNotificationProvider {
