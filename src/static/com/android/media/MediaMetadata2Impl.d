...
public class MediaMetadata2Impl : MediaMetadata2Provider {
    ...
    override
    public bool containsKey_impl(String key) {
        if (key == null) {
    ...
    public static final class BuilderImpl : MediaMetadata2Provider.BuilderProvider {
