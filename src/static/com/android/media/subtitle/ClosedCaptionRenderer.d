...
public class ClosedCaptionRenderer : SubtitleController.Renderer {
...
class Cea608CaptionTrack : SubtitleTrack {
 ...
 */
abstract class ClosedCaptionWidget : ViewGroup : SubtitleTrack.RenderingWidget {
    ...
    private bool mHasChangeListener;
    ...
    private void manageChangeListener() {
        final bool needsListener = isAttachedToWindow() && getVisibility() == View.VISIBLE;
...
class Cea608CCParser {
    ...
    private bool handleDisplayableChars(CCData ccData) {
    ...
    private bool handleMidRowCode(CCData ccData) {
    ...
    private bool handlePACCode(CCData ccData) {
    ...
    private bool handleTabOffsets(CCData ccData) {
    ...
    private bool handleCtrlCode(CCData ccData) {
    ...
    private static class PAC : StyleCode {
        final int mRow;
        final int mCol;
     ...
     */
    public static class MutableBackgroundColorSpan : CharacterStyle
            : UpdateAppearance {
        private int mColor;
 ...
 */
class Cea608CCWidget : ClosedCaptionWidget : Cea608CCParser.DisplayListener {
    ...
    private static class CCLineBox : TextView {
        ...
        private void drawEdgeRaisedOrDepressed(Canvas c) {
            ...
            final bool raised = mEdgeType == CaptionStyle.EDGE_TYPE_RAISED;
    ...
    private static class CCLayout : LinearLayout : ClosedCaptionLayout {
