 ...
 */
public abstract class SubtitleTrack : MediaTimeProvider.OnMediaTimeListener {
     ...
     */
    protected abstract void onData(byte[] data, bool eos, long runID);
    ...
    protected synchronized void updateActiveCues(bool rebuild, long timeMs) {
    ...
    protected synchronized bool addCue(Cue cue) {
        mCues.add(cue);
    ...
    static class CueList {
        ...
        private bool addEvent(Cue cue, long timeMs) {
        ...
        class EntryIterator : Iterator<Pair<Long, Cue> > {
            override
            public bool hasNext() {
                return !mDone;
            }
