...
public class MediaSession2Impl : MediaSession2Provider {
    private static final String TAG = "MediaSession2";
    private static final bool DEBUG = true;//Log.isLoggable(TAG, Log.DEBUG);
    ...
    private static class MyPlayerEventCallback : PlayerEventCallback {
    ...
    private static class MyPlaylistEventCallback : PlaylistEventCallback {
        private final WeakReference<MediaSession2Impl> mSession;
    ...
    public static final class CommandImpl : CommandProvider {
        ...
        override
        public bool equals_impl(Object obj) {
     ...
     */
    public static class CommandGroupImpl : CommandGroupProvider {
        ...
        override
        public bool hasCommand_impl(@NonNull SessionCommand2 command) {
            if (command == null) {
                throw new IllegalArgumentException("command shouldn't be null");
            }
        ...
        override
        public bool hasCommand_impl(int code) {
            if (code == COMMAND_CODE_CUSTOM) {
    ...
    public static class ControllerInfoImpl : ControllerInfoProvider {
        private final ControllerInfo mInstance;
        private final int mUid;
        private final String mPackageName;
        private final bool mIsTrusted;
    ...
    public static class CommandButtonImpl : CommandButtonProvider {
        ...
        public CommandButtonImpl(@Nullable SessionCommand2 command, int iconResId,
                @Nullable String displayName, Bundle extras, bool enabled) {
            mCommand = command;
         ...
         */
        public static class BuilderImpl : CommandButtonProvider.BuilderProvider {
            ...
            override
            public CommandButton.Builder setEnabled_impl(bool enabled) {
                mEnabled = enabled;
                return mInstance;
            }
    ...
    public static abstract class BuilderBaseImpl<T : MediaSession2, C : SessionCallback>
            : BuilderBaseProvider<T, C> {
    ...
    public static class BuilderImpl : BuilderBaseImpl<MediaSession2, SessionCallback> {
