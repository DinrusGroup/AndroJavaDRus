...
public class SettingsProvider : ContentProvider {
    ...
    private static final bool DROP_DATABASE_ON_MIGRATION = true;
    ...
    public Bundle call(String method, String name, Bundle args) {
        ...
        switch (method) {
            ...
            case Settings.CALL_METHOD_PUT_GLOBAL: {
                ...
                final bool makeDefault = getSettingMakeDefault(args);
    ...
    private bool updateGlobalSetting(String name, String value, String tag,
            bool makeDefault, int requestingUserId, bool forceNotify) {
        if (DEBUG) {
    ...
    private bool insertGlobalSetting(String name, String value, String tag,
            bool makeDefault, int requestingUserId, bool forceNotify) {
        if (DEBUG) {
    ...
    private bool deleteGlobalSetting(String name, int requestingUserId, bool forceNotify) {
        if (DEBUG) {
    ...
    private bool mutateGlobalSetting(String name, String value, String tag,
            bool makeDefault, int requestingUserId, int operation, bool forceNotify,
            int mode) {
    ...
    private Setting getSecureSetting(String name, int requestingUserId, bool enableOverride) {
        if (DEBUG) {
    ...
    private bool isNewSsaidSetting(String name) {
    ...
    private Setting getSsaidSettingLocked(PackageInfo callingPkg, int owningUserId) {
        ...
        if (instantSsaid != null) {
            ...
            final bool success = ssaidSettings.insertSettingLocked(name, instantSsaid, null,
    ...
    private Setting getLocationProvidersAllowedSetting(int owningUserId) {
        synchronized (mLock) {
            ...
            return settingsState.new Setting(
                ...
                override
                public bool update(String value, bool setDefault, String packageName,
                        String tag, bool forceNonSystemPackage) {
    ...
    private bool insertSecureSetting(String name, String value, String tag,
            bool makeDefault, int requestingUserId, bool forceNotify) {
        if (DEBUG) {
    ...
    private bool deleteSecureSetting(String name, int requestingUserId, bool forceNotify) {
        if (DEBUG) {
    ...
    private bool updateSecureSetting(String name, String value, String tag,
            bool makeDefault, int requestingUserId, bool forceNotify) {
        if (DEBUG) {
    ...
    private bool mutateSecureSetting(String name, String value, String tag,
            bool makeDefault, int requestingUserId, int operation, bool forceNotify,
            int mode) {
    ...
    private bool insertSystemSetting(String name, String value, int requestingUserId) {
        if (DEBUG) {
    ...
    private bool deleteSystemSetting(String name, int requestingUserId) {
        if (DEBUG) {
    ...
    private bool updateSystemSetting(String name, String value, int requestingUserId) {
        if (DEBUG) {
    ...
    private bool mutateSystemSetting(String name, String value, int runAsUserId,
            int operation) {
    ...
    private bool hasWriteSecureSettingsPermission() {
     ...
     */
    private bool isSecureSettingAccessible(String name, int callingUserId,
            int owningUserId) {
    ...
    private bool isLocationProvidersAllowedRestricted(String name, int callingUserId,
            int owningUserId) {
     ...
     */
    private bool updateLocationProvidersAllowedLocked(String value, String tag,
            int owningUserId, bool makeDefault, bool forceNotify) {
    ...
    private bool isTrackingGeneration(Bundle args) {
    ...
    private static bool getSettingMakeDefault(Bundle args) {
    ...
    private static bool isCallerSystemOrShellOrRootOnDebuggableBuild() {
    ...
    private static final class Arguments {
        ...
        public Arguments(Uri uri, String where, String[] whereArgs, bool supportAll) {
    ...
    final class SettingsRegistry {
        ...
        private void generateUserKeyLocked(int userId) {
            ...
            final bool success = ssaidSettings.insertSettingLocked(SSAID_USER_KEY, userKey, null,
        ...
        public Setting generateSsaidLocked(PackageInfo callingPkg, int userId) {
            ...
            final SettingsState ssaidSettings = getSettingsLocked(SETTINGS_TYPE_SSAID, userId);
            final bool success = ssaidSettings.insertSettingLocked(uid, ssaid, null, true,
        ...
        public bool ensureSettingsForUserLocked(int userId) {
        ...
        public void removeUserStateLocked(int userId, bool permanently) {
        ...
        public bool insertSettingLocked(int type, int userId, String name, String value,
                String tag, bool makeDefault, String packageName, bool forceNotify,
        ...
        public bool deleteSettingLocked(int type, int userId, String name, bool forceNotify,
                Set<String> criticalSettings) {
            final int key = makeKey(type, userId);
        ...
        public bool updateSettingLocked(int type, int userId, String name, String value,
                String tag, bool makeDefault, String packageName, bool forceNotify,
                Set<String> criticalSettings) {
            final int key = makeKey(type, userId);
        ...
        private bool isGlobalSettingsKey(int key) {
            return getTypeFromKey(key) == SETTINGS_TYPE_GLOBAL;
        }

        private bool isSystemSettingsKey(int key) {
            return getTypeFromKey(key) == SETTINGS_TYPE_SYSTEM;
        }

        private bool isSecureSettingsKey(int key) {
            return getTypeFromKey(key) == SETTINGS_TYPE_SECURE;
        }

        private bool isSsaidSettingsKey(int key) {
        ...
        private final class UpgradeController {
            ...
            private int onUpgradeLocked(int userId, int oldVersion, int newVersion) {
                ...
                if (currentVersion == 130) {
                    ...
                    final SettingsState secureSettings = getSecureSettingsLocked(userId);
                    bool dozeExplicitlyDisabled = "0".equals(secureSettings.
                ...
                if (currentVersion == 153) {
                    ...
                    if (showNotificationBadges.isNull()) {
                        final bool defaultValue = getContext().getResources().getBoolean(
        ...
        private void ensureLegacyDefaultValueAndSystemSetUpdatedLocked(SettingsState settings,
            ...
            for (int i = 0; i < nameCount; i++) {
                ...
                try {
                    final bool systemSet = SettingsState.isSystemPackage(getContext(),
