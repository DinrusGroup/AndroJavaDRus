...
abstract class BaseSettingsProviderTest {
    ...
    protected String queryStringViaProviderApi(int type, String name, bool queryStringInQuotes,
            bool appendNameToUri) {
        final Uri uri;
    ...
    protected static void setSettingViaShell(int type, String name, String value,
            bool makeDefault) throws IOException {
        setSettingViaShell(type, name, value, null, makeDefault);
    }

    protected static void setSettingViaShell(int type, String name, String value,
            String token, bool makeDefault) throws IOException {
        switch (type) {
            case SETTING_TYPE_GLOBAL: {
