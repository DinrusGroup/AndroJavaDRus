...
public class SettingsHelper {
    ...
    private bool isAlreadyConfiguredCriticalAccessibilitySetting(String name) {
    ...
    private void setAutoRestore(bool enabled) {
        try {
    ...
    private void setSoundEffects(bool enable) {
        if (enable) {
