...
class DatabaseHelper : SQLiteOpenHelper {
    ...
    public static bool isValidTable(String name) {
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int currentVersion) {
       ...
       if (upgradeVersion == 51) {
        ...
        if (upgradeVersion == 79) {
            ...
            final bool accessibilityEnabled = getIntValueFromTable(db, TABLE_SECURE,
                    Settings.Secure.ACCESSIBILITY_ENABLED, 0) == 1;
            final bool touchExplorationEnabled = getIntValueFromTable(db, TABLE_SECURE,
    ...
    private void moveSettingsToNewTable(SQLiteDatabase db,
            ...
            String[] settingsToMove, bool doIgnore) {
    ...
    private void loadVibrateSetting(SQLiteDatabase db, bool deleteOld) {
        if (deleteOld) {
    ...
    private void loadVibrateWhenRingingSetting(SQLiteDatabase db) {
        ...
        bool vibrateWhenRinging = ((vibrateSetting & 3) == AudioManager.VIBRATE_SETTING_ON);
