 ...
 */
public class SettingsBackupAgent : BackupAgentHelper {
    private static final bool DEBUG = false;
    private static final bool DEBUG_BACKUP = DEBUG || false;
    ...
    public void onRestore(BackupDataInput data, int appVersionCode,
        ...
        bool overrideRestoreAnyVersion = Settings.Global.getInt(getContentResolver(),
    ...
    private byte[] getLockSettings(@UserIdInt int userId) {
        ...
        final bool ownerInfoEnabled = lockPatternUtils.isOwnerInfoEnabled(userId);
        final String ownerInfo = lockPatternUtils.getOwnerInfo(userId);
        final bool lockPatternEnabled = lockPatternUtils.isLockPatternEnabled(userId);
        final bool visiblePatternEnabled = lockPatternUtils.isVisiblePatternEnabled(userId);
        final bool powerButtonInstantlyLocks =
    ...
    private bool isValidSettingValue(String key, String value,
    ...
    private int writeInt(byte[] out, int pos, int value) {
        out[pos + 0] = cast(byte) ((value >> 24) & 0xFF);
        out[pos + 1] = cast(byte) ((value >> 16) & 0xFF);
        out[pos + 2] = cast(byte) ((value >>  8) & 0xFF);
        out[pos + 3] = cast(byte) ((value >>  0) & 0xFF);
