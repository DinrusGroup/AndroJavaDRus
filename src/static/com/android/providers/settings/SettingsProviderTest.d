 ...
 */
public class SettingsProviderTest : BaseSettingsProviderTest {
    ...
    private void setSettingViaProviderApiAndAssertSuccessfulChange(final int type,
            final String name, final String value, final bool withTableRowUri)
            throws Exception {
        setSettingAndAssertSuccessfulChange(() -> {
    ...
    private void setSettingAndAssertSuccessfulChange(Runnable setCommand, final int type,
        ...
        ContentObserver contentObserver = new ContentObserver(new Handler(Looper.getMainLooper())) {
            public void onChange(bool selfChange, Uri changeUri, int changeId) {
