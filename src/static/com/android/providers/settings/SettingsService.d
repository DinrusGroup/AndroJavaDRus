...
final public class SettingsService : Binder {
    ...
    final static class MyShellCommand : ShellCommand {
        final SettingsProvider mProvider;
        final bool mDumping;
        ...
        MyShellCommand(SettingsProvider provider, bool dumping) {
            mProvider = provider;
            mDumping = dumping;
        }
        ...
        void putForUser(IContentProvider provider, int userHandle, final String table,
                final String key, final String value, String tag, bool makeDefault) {
