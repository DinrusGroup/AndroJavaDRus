 ...
 */
public class TiledImageView : FrameLayout {

    private static final bool USE_TEXTURE_VIEW = false;
    private static final bool IS_SUPPORTED =
            Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN;
    private static final bool USE_CHOREOGRAPHER =
            Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN;

    private BlockingGLTextureView mTextureView;
    private GLSurfaceView mGLSurfaceView;
    private bool mInvalPending = false;
    ...
    public static bool isTilingSupported() {
        return IS_SUPPORTED;
    }
    ...
    public void positionFromMatrix(Matrix matrix) {
        ...
        if (mRenderer.source != null) {
            ...
            final bool swap = !(rotation % 180 == 0);
    ...
    private class TileRenderer : Renderer {
        ...
        public void onDrawFrame(GL10 gl) {
            ...
            bool complete = mRenderer.image.draw(mCanvas);
    ...
    private static class ColoredTiles : TileSource {
