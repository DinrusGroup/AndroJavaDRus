...
public class TiledImageRenderer {
    ...
    private bool mBackgroundTileUploaded;
    ...
    private static bool isHighResolution(Context context) {
    ...
    public bool draw(GLCanvas canvas) {
        layoutTiles();
        uploadTiles(canvas);
   ...
   private void queueForDecode(Tile tile) {
    ...
    private void decodeTile(Tile tile) {
        ...
        bool decodeComplete = tile.decode();
        synchronized (mQueueLock) {
    ...
    private class Tile : UploadedTexture {
        public int mX;
        public int mY;
    ...
    private class TileDecoder : Thread {
