...
class SimpleBitmapRegionDecoderWrapper : SimpleBitmapRegionDecoder {
    ...
    public static SimpleBitmapRegionDecoderWrapper newInstance(
            String pathName, bool isShareable) {
        try {
    ...
    public static SimpleBitmapRegionDecoderWrapper newInstance(
            InputStream is, bool isShareable) {
        try {
...
class DumbBitmapRegionDecoder : SimpleBitmapRegionDecoder {
    Bitmap mBuffer;
    Canvas mTempCanvas;
    Paint mTempPaint;
...
public class BitmapRegionTileSource : TiledImageRenderer.TileSource {

    private static final String TAG = "BitmapRegionTileSource";

    private static final bool REUSE_BITMAP =
    ...
    public static abstract class BitmapSource {
        ...
        public abstract bool readExif(ExifInterface ei);
        public abstract SimpleBitmapRegionDecoder loadBitmapRegionDecoder();
        public abstract Bitmap loadPreviewBitmap(BitmapFactory.Options options);
    }

    public static class FilePathBitmapSource : BitmapSource {
        ...
        override
        public bool readExif(ExifInterface ei) {
            try {
                ei.readExif(mPath);
                return true;
    ...
    public static class UriBitmapSource : BitmapSource {
    ...
    public static class ResourceBitmapSource : BitmapSource {
