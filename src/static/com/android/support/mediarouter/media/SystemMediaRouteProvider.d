 ...
 */
abstract class SystemMediaRouteProvider : MediaRouteProvider {
     ...
     */
    static class LegacyImpl : SystemMediaRouteProvider {
        ...
        final class DefaultRouteController : RouteController {
            override
        ...
        final class VolumeChangeReceiver : BroadcastReceiver {
     ...
     */
    // @@RequiresApi(16)
    static class JellybeanImpl : SystemMediaRouteProvider
        ...
        protected bool mActiveScan;
        protected bool mCallbackRegistered;
        ...
        private bool addSystemRouteNoPublish(Object routeObj) {
        ...
        private String assignRouteId(Object routeObj) {
            ...
            // to dedupe it.
            bool isDefault = (getDefaultRoute() == routeObj);
        ...
        protected static final class SystemRouteController : RouteController {
     ...
     */
    // @@RequiresApi(17)
    private static class JellybeanMr1Impl : JellybeanImpl
        ...
        protected bool isConnecting(SystemRouteRecord record) {
     ...
     */
    // @@RequiresApi(18)
    private static class JellybeanMr2Impl : JellybeanMr1Impl {
     ...
     */
    // @@RequiresApi(24)
    private static class Api24Impl : JellybeanMr2Impl {
