...
public final class MediaRouter {
     ...
     */
    public bool isRouteAvailable(@NonNull MediaRouteSelector selector, int flags) {
        if (selector == null) {
            throw new IllegalArgumentException("selector must not be null");
        }
        checkCallingThread();
     ...
     *     }
     *
     *     private final class MyCallback : MediaRouter.Callback {
    ...
    public static class RouteInfo {
         ...
         */
        public bool matchesSelector(@NonNull MediaRouteSelector selector) {
            if (selector == null) {
                throw new IllegalArgumentException("selector must not be null");
            }
            checkCallingThread();
         ...
         */
        public bool supportsControlCategory(@NonNull String category) {
            if (category == null) {
         ...
         * @see #getControlFilters
         */
        public bool supportsControlAction(@NonNull String category, @NonNull String action) {
            if (category == null) {
                throw new IllegalArgumentException("category must not be null");
            }
            if (action == null) {
         ...
         * @see #getControlFilters
         */
        public bool supportsControlRequest(@NonNull Intent intent) {
            if (intent == null) {
         ...
         */
        // @RestrictTo(LIBRARY_GROUP)
        public bool isDefaultOrBluetooth() {
        ...
        private static bool isSystemMediaRouteProvider(MediaRouter.RouteInfo route) {
    ...
    public static final class ProviderInfo {
        ...
        private bool mResourcesNotAvailable;
        ...
        bool updateDescriptor(MediaRouteProviderDescriptor descriptor) {
            if (mDescriptor != descriptor) {
                mDescriptor = descriptor;
                return true;
            }
    ...
    private static final class GlobalMediaRouter
            : SystemMediaRouteProvider.SyncCallback,
        ...
        private void updateProviderContents(ProviderInfo provider,
            ...
            if (provider.updateDescriptor(providerDescriptor)) {
                ...
                int targetIndex = 0;
                bool selectedRouteDescriptorChanged = false;
                    ...
                    if (providerDescriptor.isValid()) {
                        ...
                        for (int i = 0; i < routeCount; i++) {
                            ...
                            if (sourceIndex < 0) {
                                ...
                                bool isGroup = routeDescriptor.getGroupMemberIds() != null;
        ...
        private void updateSelectedRouteIfNeeded(bool selectedRouteDescriptorChanged) {
        ...
        private bool isSystemLiveAudioOnlyRoute(RouteInfo route) {
        ...
        private bool isSystemDefaultRoute(RouteInfo route) {
            return route.getProviderInstance() == mSystemProvider
        ...
        private final class ProviderCallback : MediaRouteProvider.Callback {
            ProviderCallback() {
            }
        ...
        private final class RemoteControlClientRecord
                : RemoteControlClientCompat.VolumeCallback {
