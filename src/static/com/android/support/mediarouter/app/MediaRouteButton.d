...
public class MediaRouteButton : View {
     ...
     */
    void setCheatSheetEnabled(bool enable) {
    ...
    void refreshRoute() {
        ...
        final bool isRemote = !route.isDefaultOrBluetooth() && route.matchesSelector(mSelector);
        final bool isConnecting = isRemote && route.isConnecting();
    ...
    private final class RemoteIndicatorLoader : AsyncTask<Void, Void, Drawable> {
