 ...
 */
public class BasicBitmapDrawable : Drawable : DecodeCallback,
    ...
    private final bool mLimitDensity;
    ...
    private static final bool DEBUG = DecodeTask.DEBUG;

    public BasicBitmapDrawable(final Resources res, final BitmapCache cache,
            final bool limitDensity) {
     ...
     * All UI operations should be called from the UI thread.
     */
    public void unbind(bool temporary) {
