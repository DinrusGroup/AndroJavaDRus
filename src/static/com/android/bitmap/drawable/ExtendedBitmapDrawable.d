 ...
 */
public class ExtendedBitmapDrawable : BasicBitmapDrawable :
    ...
    public ExtendedBitmapDrawable(final Resources res, final BitmapCache cache,
            final bool limitDensity, ExtendedOptions opts) {
    ...
    protected void loadFileDescriptorFactory() {
        bool executeStateChange = shouldExecuteStateChange();
    ...
    protected bool shouldExecuteStateChange() {
    ...
    private void setLoadState(int loadState) {
        ...
        bool placeholderVisible = mPlaceholder != null && mPlaceholder.isVisible();
        bool progressVisible = mProgress != null && mProgress.isVisible();
    ...
    private static class Placeholder : TileDrawable {

        private final ValueAnimator mPulseAnimator;
        private bool mPulseEnabled = true;
        ...
        public bool setVisible(bool visible) {
            final bool changed = super.setVisible(visible);
            if (changed) {
                if (isVisible()) {
                    // start
    ...
    private static class Progress : TileDrawable {
