 ...
 * be returned.
 */
public class UnrefedBitmapCache : UnrefedPooledCache<RequestKey, ReusableBitmap>
        : BitmapCache {
    ...
    private final static bool DEBUG = DecodeTask.DEBUG;
     ...
     */
    override
    public void setBlocking(final bool blocking) {
        synchronized (mLock) {
            if (DEBUG) {
    ...
    /**
     * If {@link #setBlocking(bool)} has been called with true, this method will block until a
    ...
    override
    public ReusableBitmap get(final RequestKey key, final bool incrementRefCount) {
