...
public class Exif {
    ...
    public static int getOrientation(final InputStream inputStream, final long byteSize) {
        ...
        if (has(jpeg, byteSize, 1)) {
            ...
            final bool possibleJpegFormat = jpeg.get(0) == cast(byte) 0xFF
                    && jpeg.get(1) == cast(byte) 0xD8;
        ...
        if (length > 8) {
            ...
            final bool littleEndian = (tag == 0x49492A00);
    ...
    private static bool has(final InputStreamBuffer jpeg, final long byteSize, final int index) {
        if (byteSize >= 0) {
