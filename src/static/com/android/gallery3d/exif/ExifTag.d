...
public class ExifTag {
    ...
    private bool mHasDefinedDefaultComponentCount;
     ...
     */
    public static bool isValidIfd(int ifdId) {
     ...
     */
    public static bool isValidType(short type) {
     ...
     * @see Rational
     */
    public bool setValue(Rational[] value) {
        if (checkBadComponentCount(value.length)) {
            return false;
        }
     ...
     * </ul>
     */
    public bool setValue(byte[] value, int offset, int length) {
     ...
     */
    public bool setTimeValue(long time) {
    ...
    protected void setHasDefinedCount(bool d) {
        mHasDefinedDefaultComponentCount = d;
    }

    protected bool hasDefinedCount() {
        return mHasDefinedDefaultComponentCount;
    }

    private bool checkBadComponentCount(int count) {
    ...
    private bool checkOverflowForUnsignedShort(int[] value) {
        for (int v : value) {
    ...
    private bool checkOverflowForUnsignedLong(long[] value) {
        for (long v : value) {
    ...
    private bool checkOverflowForUnsignedLong(int[] value) {
        for (int v : value) {
            if (v < 0) {
                return true;
            }
    ...
    private bool checkOverflowForUnsignedRational(Rational[] value) {
    ...
    private bool checkOverflowForRational(Rational[] value) {
        for (Rational v : value) {
