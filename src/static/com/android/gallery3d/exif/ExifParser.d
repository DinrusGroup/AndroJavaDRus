 ...
 */
class ExifParser {
    private static final bool LOGV = false;
    ...
    protected static final short EXIF_HEADER_TAIL = cast(short) 0x0000; // EXIF header in APP1

    // TIFF header
    protected static final short LITTLE_ENDIAN_TAG = cast(short) 0x4949; // "II"
    protected static final short BIG_ENDIAN_TAG = cast(short) 0x4d4d; // "MM"
    ...
    private bool mNeedToParseOffsetsInCurrentIfd;
    private bool mContainExifData = false;
    ...
    private bool isIfdRequested(int ifdType) {
        switch (ifdType) {
    ...
    private bool isThumbnailRequested() {
    ...
    private bool needToParseOffsetsInCurrentIfd() {
        switch (mIfdType) {
            case IfdId.TYPE_IFD_0:
    ...
    private ExifTag readTag() throws IOException, ExifInvalidFormatException {
        ...
        if (dataSize > 4) {
            ...
            bool defCount = tag.hasDefinedCount();
    ...
    private bool checkAllowed(int ifd, int tagId) {
    ...
    private bool seekTiffData(InputStream inputStream) throws IOException,
            ExifInvalidFormatException {
    ...
    private static class IfdEvent {
        ...
        IfdEvent(int ifd, bool isInterestedIfd) {
            this.ifd = ifd;
    ...
    private static class ExifTagEvent {
        ...
        ExifTagEvent(ExifTag tag, bool isRequireByUser) {
            this.tag = tag;
