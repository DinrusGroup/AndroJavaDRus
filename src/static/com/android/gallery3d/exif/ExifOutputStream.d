 ...
 * </pre>
 */
class ExifOutputStream : FilterOutputStream {
    ...
    public void write(int oneByte) throws IOException {
        mSingleByteArray[0] = cast(byte) (0xff & oneByte);
    ...
    private void writeExifData() throws IOException {
        ...
        dataOutputStream.writeShort(cast(short) (exifSize + 8));
        dataOutputStream.writeInt(EXIF_HEADER);
        dataOutputStream.writeShort(cast(short) 0x0000);
    ...
    private void writeIfd(IfdData ifd, OrderedDataOutputStream dataOutputStream)
        ...
        dataOutputStream.writeShort(cast(short) tags.length);
    ...
    static void writeTagValue(ExifTag tag, OrderedDataOutputStream dataOutputStream)
        ...
        switch (tag.getDataType()) {
            ...
            case ExifTag.TYPE_UNSIGNED_SHORT:
                for (int i = 0, n = tag.getComponentCount(); i < n; i++) {
                    dataOutputStream.writeShort(cast(short) tag.getValueAt(i));
                }
                break;
        }
    }
