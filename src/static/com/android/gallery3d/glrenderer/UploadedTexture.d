...
public abstract class UploadedTexture : BasicTexture {
    ...
    protected UploadedTexture(bool hasBorder) {
    ...
    protected void setIsUploading(bool uploading) {
    ...
    private static class BorderKey : Cloneable {
    ...
    protected void setThrottled(bool throttled) {
        mThrottled = throttled;
    }

    private static Bitmap getBorderLine(
            bool vertical, Config config, int length) {
    ...
    public static bool uploadLimitReached() {
    ...
    override
    protected bool onBind(GLCanvas canvas) {
