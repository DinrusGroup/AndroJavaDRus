...
public class Utils {
    ...
    private static final bool IS_DEBUG_BUILD =
    ...
    //   assertTrue(bool cond, String message, Object ... args);
    ...
    public static bool isOpaque(int color) {
    ...
    public static byte[] getBytes(String in) {
        ...
        for (char ch : in.toCharArray()) {
            result[output++] = cast(byte) (ch & 0xFF);
            result[output++] = cast(byte) (ch >> 8);
        }
        return result;
    }
    ...
    public static bool isNullOrEmpty(String exifMake) {
    ...
    public static bool handleInterrruptedException(Throwable e) {
