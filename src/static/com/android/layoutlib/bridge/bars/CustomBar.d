 ...
 */
abstract class CustomBar : LinearLayout {
    ...
    protected void loadIcon(int index, String iconName, Density density, bool isRtl) {
    ...
    protected TextView setText(int index, String string, bool reference) {
        View child = getChildAt(index);
    ...
    private void setText(TextView textView, String string, bool reference) {
        if (reference) {
    ...
    protected int getBarColor(@NonNull String colorAttrName, @NonNull String translucentAttrName) {
        ...
        bool translucent = ResourceHelper.getBooleanThemeValue(renderResources,
        ...
        bool transparent = ResourceHelper.getBooleanThemeValue(renderResources,
