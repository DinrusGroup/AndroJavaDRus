...
public class ReflectionUtils {
    ...
    @NonNull
    public static Method getMethod(@NonNull Class!(T) clazz, @NonNull String name,
            @Nullable Class!(T)... params) throws ReflectionException {
        try {
    ...
    @NonNull
    public static Method getAccessibleMethod(@NonNull Class!(T) clazz, @NonNull String name,
      @Nullable Class!(T)... params) throws ReflectionException {
     ...
     * for interfaces.
     */
    public static bool isInstanceOf(Object object, String className) {
     ...
     */
    public static bool isInstanceOf(Object object, String[] classNames) {
        Class superClass = object.getClass();
        while (superClass != null) {
            String name = superClass.getName();
     ...
     */
    @NonNull
    public static Class!(T) getClassInstance(@NonNull Object object, @NonNull String className) {
        Class!(T) superClass = object.getClass();
        while (superClass != null) {
    ...
    public static <T> T createProxy(Class<T> interfaze) {
        ...
        return (T) Proxy.newProxyInstance(loader, new Class[]{interfaze}, new InvocationHandler() {
            public Object invoke(Object proxy, Method m, Object[] args) {
                final Class!(T) returnType = m.getReturnType();
     ...
     */
    public static class ReflectionException : Exception {
