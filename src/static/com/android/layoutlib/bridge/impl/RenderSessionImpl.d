 ...
 */
public class RenderSessionImpl : RenderAction<SessionParams> {
    ...
    private bool mIsAlphaChannelImage;
    ...
    private bool mFirstFrameExecuted = false;
    ...
    private bool mNewRenderSize;

    private static final class PostInflateException : Exception {
    ...
    public Result inflate() {
        ...
        try {
            ...
            bool isPreference = "PreferenceScreen".equals(rootTag);
            View view;
            if (isPreference) {
     ...
     */
    public Result render(bool freshRender) {
     ...
     * @see RenderSession#render(long)
     */
    private Result renderAndBuildResult(bool freshRender, bool onlyMeasure) {
        checkLock();
        ...
        try {
            ...
            if (onlyMeasure) {
                ...
                bool disableBitmapCaching = Boolean.TRUE.equals(params.getFlag(
    ...
    private void postInflateProcess(View view, LayoutlibCallback layoutlibCallback, View skip)
        ...
        } else if (view instanceof AdapterView!(T)) {
            // get the view ID.
            int id = view.getId();
    ...
    private bool hasToolbar(View collapsingToolbar) {
     ...
     */
    private ViewInfo visit(View view, int hOffset, int vOffset, bool setExtendedInfo,
            bool isContentFrame) {
    ...
    private List<ViewInfo> visitAllChildren(ViewGroup viewGroup, int hOffset, int vOffset,
            bool setExtendedInfo, bool isContentFrame) {
        if (viewGroup == null) {
            return null;
        }
     ...
     * content frame.
     */
    private ViewInfo createViewInfo(View view, int hOffset, int vOffset, bool setExtendedInfo,
            bool isContentFrame) {
        if (view == null) {
            return null;
        }
    ...
    public bool isAlphaChannelImage() {
