 ...
 */
public class LayoutParserWrapper : XmlPullParser {
    ...
    override
    public void setFeature(String s, bool b) throws XmlPullParserException {
    ...
    override
    public bool getFeature(String s) {
        throw new UnsupportedOperationException("Only few parser methods are supported.");
    }
    ...
    override
    public bool isAttributeDefault(int i) {
        throw new UnsupportedOperationException("Only few parser methods are supported.");
    }
