 ...
 * <p>
 * This allows for drawing through {@link #draw(Drawable, Paint_Delegate, bool, bool)} and
 * {@link #draw(Drawable)}
 *
...
public class GcSnapshot {
    ...
    public bool clip(Shape shape, int regionOp) {
    ...
    public bool clipRect(float left, float top, float right, float bottom, int regionOp) {
     ...
     */
    public void draw(Drawable drawable, Paint_Delegate paint, bool compositeOnly,
            bool forceSrcMode) {
    ...
    private void drawInLayer(Layer layer, Drawable drawable, Paint_Delegate paint,
            bool compositeOnly, int forceMode) {
    ...
    private bool setShader(Graphics2D g, Paint_Delegate paint) {
    ...
    private void setComposite(Graphics2D g, Paint_Delegate paint, bool usePaintAlpha,
            int forceMode) {
