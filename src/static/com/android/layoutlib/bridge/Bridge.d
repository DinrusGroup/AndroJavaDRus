 ...
 */
public final class Bridge : com.android.ide.common.rendering.api.Bridge {

    private static final String ICU_LOCALE_DIRECTION_RTL = "right-to-left";

    public static class StaticMethodNotImplementedException : RuntimeException {
    ...
    override
    public bool supports(int feature) {
        return feature <= LAST_SUPPORTED_FEATURE;
    }

    override
    public bool init(Map<String,String> platformProperties,
            File fontLocation,
        ...
        if (debug != null && !debug.equals("0") && !debug.equals("false")) {
            ...
            OverrideMethod.setDefaultListener(new MethodAdapter() {
                override
                public void onInvokeV(String signature, bool isNative, Object caller) {
        ...
        try {
            Class!(T) r = com.android.internal.R.class;
            // Parse the styleable class first, since it may contribute to attr values.
            parseStyleable();

            for (Class!(T) inner : r.getDeclaredClasses()) {
     ...
     */
    private static bool isValidRField(Field field) {
        int modifiers = field.getModifiers();
        bool isAcceptable = Modifier.isPublic(modifiers) && Modifier.isStatic(modifiers);
    ...
    private static void parseStyleable() throws Exception {
        ...
        Class!(T) c = com.android.internal.R.styleable.class;
        ...
        Arrays.sort(fields, (o1, o2) -> {
            ...
            Class!(T) t1 = o1.getType();
            Class!(T) t2 = o2.getType();
        ...
        try {
            ...
            try {
                ...
                if (lastResult.isSuccess()) {
                    ...
                    bool doNotRenderOnCreate = Boolean.TRUE.equals(
    ...
    override
    public bool isRtl(String locale) {
