...
public class RecyclerViewUtil {
    ...
    private static final Class!(T)[] LLM_CONSTRUCTOR_SIGNATURE = new Class!(T)[]{Context.class};
    ...
    private static void setProperty(@NonNull Object object, @NonNull String propertyClassName,
            ...
            throws ReflectionException {
        Class!(T) propertyClass = ReflectionUtils.getClassInstance(propertyValue, propertyClassName);
        setProperty(object, propertyClass, propertyValue, propertySetter);
    }

    private static void setProperty(@NonNull Object object, @NonNull Class!(T) propertyClass,
