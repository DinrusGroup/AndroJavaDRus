...
public class LightsService : SystemService {
    static final String TAG = "LightsService";
    static final bool DEBUG = false;

    final LightImpl mLights[] = new LightImpl[LightsManager.LIGHT_ID_COUNT];

    private final class LightImpl : Light {
        ...
        private bool shouldBeInLowPersistenceMode() {
        ...
        private bool mUseLowPersistenceForVR;
