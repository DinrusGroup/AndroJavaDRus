...
class BluetoothManagerService : IBluetoothManager.Stub {
    ...
    private bool mBinding;
    private bool mUnbinding;

    // used inside handler thread
    private bool mQuietEnable = false;
    ...
    private class ActiveLog {
        ...
        ActiveLog(int reason, String packageName, bool enable, long timestamp) {
            mReason = reason;
    ...
    private bool mQuietEnableExternal;
    private bool mEnableExternal;
    ...
    private final ContentObserver mAirplaneModeObserver = new ContentObserver(null) {
        override
        public void onChange(bool unused) {
            synchronized (this) {
    ...
    BluetoothManagerService(Context context) {
        ...
        try {
            ...
            bool noHome = mContext.getResources().getBoolean(R.bool.config_noHomeScreen);
            if (!noHome) {
    ...
    private bool supportBluetoothPersistedState() {
     ...
     */
    private bool isBluetoothPersistedStateOn() {
     ...
     */
    private bool isBluetoothPersistedStateOnBluetooth() {
        if (!supportBluetoothPersistedState()) {
            return false;
        }
     ...
     * @return
     */
    private bool isNameAndAddressSet() {
    ...
    class ClientDeathRecipient : IBinder.DeathRecipient {
        private String mPackageName;
    ...
    override
    public bool isBleScanAlwaysAvailable() {
    ...
    public int updateBleAppCount(IBinder token, bool enable, String packageName) {
    ...
    public bool enableNoAutoConnect(String packageName) {
    ...
    public bool enable(String packageName) throws RemoteException {
        final int callingUid = Binder.getCallingUid();
        final bool callerSystem = UserHandle.getAppId(callingUid) == Process.SYSTEM_UID;
    ...
    public bool disable(String packageName, bool persist) throws RemoteException {
        final int callingUid = Binder.getCallingUid();
        final bool callerSystem = UserHandle.getAppId(callingUid) == Process.SYSTEM_UID;
    ...
    private bool startConsentUiIfNeeded(String packageName,
     ...
     * @hide
     */
    private bool checkBluetoothPermissionWhenPermissionReviewRequired() {
    ...
    override
    public bool bindBluetoothProfileService(int bluetoothProfile,
    ...
    public void handleOnBootPhase() {
        ...
        final bool isBluetoothDisallowed = isBluetoothDisallowed();
        if (isBluetoothDisallowed) {
            return;
        }
    ...
    private final class ProfileServiceConnections
        ...
        Intent mIntent;
        bool mInvokingProxyCallbacks = false;
    ...
    private void sendBluetoothStateCallback(bool isUp) {
        try {
    ...
    private class BluetoothServiceConnection : ServiceConnection {
    ...
    private class BluetoothHandler : Handler {
        bool mGetNameAddressOnly = false;
            ...
            switch (msg.what) {
                ...
                case MESSAGE_USER_SWITCHED: {
                    ...
                    if (mBluetooth != null && isEnabled()) {
                        ...
                        bool didDisableTimeout = !waitForOnOff(false, true);
    ...
    private void handleEnable(bool quietMode) {
    ...
    bool doBind(Intent intent, ServiceConnection conn, int flags, UserHandle user) {
    ...
    private bool checkIfCallerIsForegroundUser() {
        int foregroundUser;
    ...
    private void bluetoothStateChangeHandler(int prevState, int newState) {
        ...
        if (newState == BluetoothAdapter.STATE_BLE_ON || newState == BluetoothAdapter.STATE_OFF) {
            ...
            bool isUp = (newState == BluetoothAdapter.STATE_ON);
     ...
     */
    private bool waitForOnOff(bool on, bool off) {
        int i = 0;
        while (i < 10) {
            try {
                mBluetoothLock.readLock().lock();
    ...
    private void sendEnableMsg(bool quietMode, int reason, String packageName) {
        mHandler.sendMessage(mHandler.obtainMessage(MESSAGE_ENABLE, quietMode ? 1 : 0, 0));
        addActiveLog(reason, packageName, true);
        mLastEnabledTime = SystemClock.elapsedRealtime();
    }

    private void addActiveLog(int reason, String packageName, bool enable) {
    ...
    private void recoverBluetoothServiceFromError(bool clearBle) {
    ...
    private bool isBluetoothDisallowed() {
        long callingIdentity = Binder.clearCallingIdentity();
        try {
     ...
     */
    private void updateOppLauncherComponentState(int userId, bool bluetoothSharingDisallowed) {
    ...
    public void dump(FileDescriptor fd, PrintWriter writer, String[] args) {
        ...
        bool protoOut = (args.length > 0) && args[0].startsWith("--proto");
