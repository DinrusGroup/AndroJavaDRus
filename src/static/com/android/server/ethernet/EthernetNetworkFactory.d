 ...
 */
public class EthernetNetworkFactory : NetworkFactory {
    private final static String TAG = EthernetNetworkFactory.class.getSimpleName();
    final static bool DBG = true;
    ...
    override
    public bool acceptRequest(NetworkRequest request, int score) {
        if (DBG) {
     ...
     */
    String[] getAvailableInterfaces(bool includeRestricted) {
    ...
    bool updateInterfaceLinkState(String ifaceName, bool up) {
        if (!mTrackingInterfaces.containsKey(ifaceName)) {
            return false;
        }
    ...
    bool hasInterface(String interfacName) {
    ...
    private static class NetworkInterfaceState {
        ...
        bool statisified(NetworkCapabilities requestedCapabilities) {
