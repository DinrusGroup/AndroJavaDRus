...
final class EthernetTracker {
    ...
    private final static bool DBG = EthernetNetworkFactory.DBG;
    ...
    bool isTrackingInterface(String iface) {
        return mFactory.hasInterface(iface);
    }

    String[] getInterfaces(bool includeRestricted) {
     ...
     */
    bool isRestrictedInterface(String iface) {
    ...
    void addListener(IEthernetServiceListener listener, bool canUseRestrictedNetworks) {
    ...
    private void updateInterfaceState(String iface, bool up) {
        bool modified = mFactory.updateInterfaceLinkState(iface, up);
        if (modified) {
            bool restricted = isRestrictedInterface(iface);
    ...
    private class InterfaceObserver : BaseNetworkObserver {
    ...
    private static class ListenerInfo {
        ...
        bool canUseRestrictedNetworks = false;

        ListenerInfo(bool canUseRestrictedNetworks) {
    ...
    private static NetworkCapabilities createNetworkCapabilities(bool clearDefaultCapabilities) {
    ...
    private static NetworkCapabilities createNetworkCapabilities(
            bool clearDefaultCapabilities, @Nullable String commaSeparatedCapabilities) {
