 ...
 * @hide
 */
public final class DreamManagerService : SystemService {
    ...
    private bool mCurrentDreamIsTest;
    private bool mCurrentDreamCanDoze;
    private bool mCurrentDreamIsDozing;
    private bool mCurrentDreamIsWaking;
    ...
    private bool isDreamingInternal() {
        synchronized (mLock) {
    ...
    private void finishSelfInternal(IBinder token, bool immediate) {
        if (DEBUG) {
    ...
    private void startDreamInternal(bool doze) {
    ...
    private void stopDreamInternal(bool immediate) {
        synchronized (mLock) {
            stopDreamLocked(immediate);
        }
    }
    ...
    private ComponentName chooseDreamForUser(bool doze, int userId) {
        if (doze) {
    ...
    private bool validateDream(ComponentName component) {
    ...
    private void startDreamLocked(final ComponentName name,
            final bool isTest, final bool canDoze, final int userId) {
    ...
    private void stopDreamLocked(final bool immediate) {
    ...
    private void writePulseGestureEnabled() {
        ...
        bool dozeEnabled = validateDream(name);
     ...
     */
    private final class DreamHandler : Handler {
        public DreamHandler(Looper looper) {
            super(looper, null, true /*async*/);
        }
    }

    private final class BinderService : IDreamManager.Stub {
        ...
        override // Binder call
        public void finishSelf(IBinder token, bool immediate) {
    ...
    private final class LocalService : DreamManagerInternal {
        override
        public void startDream(bool doze) {
            startDreamInternal(doze);
        }

        override
        public void stopDream(bool immediate) {
