...
public class UsbPortManager {
    ...
    public void setPortRoles(String portId, int newPowerRole, int newDataRole,
        ...
        synchronized (mLock) {
            ...
            final bool canChangeMode = portInfo.mCanChangeMode;
            final bool canChangePowerRole = portInfo.mCanChangePowerRole;
            final bool canChangeDataRole = portInfo.mCanChangeDataRole;
    ...
    public void connectSimulatedPort(String portId, int mode, bool canChangeMode,
            int powerRole, bool canChangePowerRole,
            int dataRole, bool canChangeDataRole, IndentingPrintWriter pw) {
        synchronized (mLock) {
    ...
    private static class HALCallback : IUsbCallback.Stub {
    ...
    final class DeathRecipient : HwBinder.DeathRecipient {
        public IndentingPrintWriter pw;
    ...
    private void addOrUpdatePortLocked(String portId, int supportedModes,
            int currentMode, bool canChangeMode,
            int currentPowerRole, bool canChangePowerRole,
            int currentDataRole, bool canChangeDataRole,
            IndentingPrintWriter pw) {
    ...
    private static final class PortInfo {
        ...
        public bool mCanChangeMode;
        public bool mCanChangePowerRole;
        public bool mCanChangeDataRole;
        ...
        public bool setStatus(int currentMode, bool canChangeMode,
                int currentPowerRole, bool canChangePowerRole,
                int currentDataRole, bool canChangeDataRole,
    ...
    private static final class RawPortInfo : Parcelable {
        ...
        public void writeToParcel(Parcel dest, int flags) {
            ...
            dest.writeByte(cast(byte) (canChangeMode ? 1 : 0));
            dest.writeInt(currentPowerRole);
            dest.writeByte(cast(byte) (canChangePowerRole ? 1 : 0));
            dest.writeInt(currentDataRole);
            dest.writeByte(cast(byte) (canChangeDataRole ? 1 : 0));
        }
        ...
        public static final Parcelable.Creator<RawPortInfo> CREATOR =
                new Parcelable.Creator<RawPortInfo>() {
                    ...
                    public RawPortInfo createFromParcel(Parcel in) {
                        ...
                        bool canChangeMode = in.readByte() != 0;
                        int currentPowerRole = in.readInt();
                        bool canChangePowerRole = in.readByte() != 0;
                        int currentDataRole = in.readInt();
                        bool canChangeDataRole = in.readByte() != 0;
