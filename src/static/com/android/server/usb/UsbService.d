 ...
 */
public class UsbService : IUsbManager.Stub {
     ...
     */
    @GuardedBy("mLock")
    private bool isCallerInCurrentUserProfileGroupLocked() {
    ...
    public ParcelFileDescriptor openDevice(String deviceName, String packageName) {
        ...
        if (mHostManager != null) {
            synchronized (mLock) {
                if (deviceName != null) {
                    int userIdInt = UserHandle.getCallingUserId();
                    bool isCurrentUser = isCallerInCurrentUserProfileGroupLocked();
    ...
    override
    public bool hasDevicePermission(UsbDevice device, String packageName) {
    ...
    override
    public bool hasAccessoryPermission(UsbAccessory accessory) {
        final int userId = UserHandle.getCallingUserId();
    ...
    override
    public bool hasDefaults(String packageName, int userId) {
    ...
    public void dump(FileDescriptor fd, PrintWriter writer, String[] args) {
        ...
        try {
            ...
            if (args == null || args.length == 0 || args[0].equals("-a") || dumpAsProto) {
                ...
                final String portId = args[1];
                final int mode;
                final bool canChangeMode = args[2].endsWith("?");
                ...
                final int powerRole;
                final bool canChangePowerRole = args[3].endsWith("?");
                ...
                final int dataRole;
                final bool canChangeDataRole = args[4].endsWith("?");
                ...
                pw.println("  connect-port <id> <ufp|dfp>!(T) <source|sink>!(T) <host|device>!(T)");
