...
public class UsbDebuggingManager {
    ...
    private bool mAdbEnabled = false;
    ...
    class UsbDebuggingThread : Thread {
    ...
    class UsbDebuggingHandler : Handler {
     ...
     */
    private bool startConfirmationActivity(ComponentName componentName, UserHandle userHandle,
     ...
     */
    private bool startConfirmationService(ComponentName componentName, UserHandle userHandle,
            String key, String fingerprints) {
        Intent intent = createConfirmationIntent(componentName, key, fingerprints);
        try {
    ...
    public void setAdbEnabled(bool enabled) {
