...
public class UsbHostManager {
    ...
    private bool isBlackListed(String deviceAddress) {
    ...
    private bool isBlackListed(int clazz, int subClass) {
        // blacklist hubs
    ...
    private void logUsbDevice(UsbDescriptorParser descriptorParser) {
        ...
        bool hasAudio = descriptorParser.hasAudioInterface();
        bool hasHid = descriptorParser.hasHIDInterface();
        bool hasStorage = descriptorParser.hasStorageInterface();
    ...
    private bool usbDeviceAdded(String deviceAddress, int deviceClass, int deviceSubclass,
            byte[] descriptors) {
        if (DEBUG) {
