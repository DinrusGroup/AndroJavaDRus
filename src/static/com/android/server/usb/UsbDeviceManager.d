 ...
 */
public class UsbDeviceManager : ActivityManagerInternal.ScreenObserver {
    ...
    private final bool mHasUsbAccessory;
    @GuardedBy("mLock")
    ...
    private class AdbSettingsObserver : ContentObserver {
        ...
        public void onChange(bool selfChange) {
            bool enable = (Settings.Global.getInt(mContentResolver,
     ...
     */
    private final class UsbUEventObserver : UEventObserver {
        override
    ...
    override
    public void onKeyguardStateChanged(bool isShowing) {
        int userHandle = ActivityManager.getCurrentUser();
        bool secure = mContext.getSystemService(KeyguardManager.class)
    ...
    override
    public void onAwakeStateChanged(bool isAwake) {
        // ignore
    }
    ...
    public UsbDeviceManager(Context context, UsbAlsaManager alsaManager,
        ...
        bool secureAdbEnabled = SystemProperties.getBoolean("ro.adb.secure", false);
        bool dataEncrypted = "1".equals(SystemProperties.get("vold.decrypt"));
        ...
        BroadcastReceiver chargingReceiver = new BroadcastReceiver() {
            ...
            public void onReceive(Context context, Intent intent) {
                ...
                bool usbCharging = chargePlug == BatteryManager.BATTERY_PLUGGED_USB;
    ...
    private void startAccessoryMode() {
        ...
        bool enableAudio = (nativeGetAudioMode() == AUDIO_MODE_SOURCE);
        // don't start accessory mode if our mandatory strings have not been set
        bool enableAccessory = (mAccessoryStrings != null &&
    ...
    abstract static class UsbHandler : Handler {

        // current USB state
        private bool mConnected;
        private bool mHostConnected;
        private bool mSourcePower;
        private bool mSinkPower;
        private bool mConfigured;
        private bool mAudioAccessoryConnected;
        private bool mAudioAccessorySupported;

        private UsbAccessory mCurrentAccessory;
        private int mUsbNotificationId;
        private bool mAdbNotificationShown;
        private bool mUsbCharging;
        private bool mHideUsbNotification;
        private bool mSupportsAllCombinations;
        private bool mScreenLocked;
        private bool mSystemReady;
        private Intent mBroadcastedIntent;
        private bool mPendingBootBroadcast;
        private bool mAudioSourceEnabled;
        private bool mMidiEnabled;
        ...
        protected bool mAdbEnabled;
        protected bool mBootCompleted;
        protected bool mCurrentFunctionsApplied;
        protected bool mUseUsbNotification;
        protected long mCurrentFunctions;
        protected final UsbDeviceManager mUsbDeviceManager;
        protected final ContentResolver mContentResolver;
        protected SharedPreferences mSettings;
        protected int mCurrentUser;
        protected bool mCurrentUsbFunctionsReceived;
        ...
        UsbHandler(Looper looper, Context context, UsbDeviceManager deviceManager,
            ...
            bool massStorageSupported = primary != null && primary.allowMassStorage();
            mUseUsbNotification = !massStorageSupported && mContext.getResources().getBoolean(
                    com.android.internal.R.bool.config_usbChargingMessage);
        }

        public void sendMessage(int what, bool arg) {
            removeMessages(what);
        ...
        public void sendMessage(int what, Object arg, bool arg1) {
            removeMessages(what);
            Message m = Message.obtain(this, what);
            m.obj = arg;
            m.arg1 = (arg1 ? 1 : 0);
        ...
        public void sendMessage(int what, bool arg1, bool arg2) {
            removeMessages(what);
            Message m = Message.obtain(this, what);
            m.arg1 = (arg1 ? 1 : 0);
            m.arg2 = (arg2 ? 1 : 0);
        ...
        public void sendMessageDelayed(int what, bool arg, long delayMillis) {
            removeMessages(what);
            Message m = Message.obtain(this, what);
            m.arg1 = (arg ? 1 : 0);
        ...
        private void setAdbEnabled(bool enable) {
        ...
        protected bool isUsbTransferAllowed() {
        ...
        private void updateCurrentAccessory() {
            ...
            bool enteringAccessoryMode = hasMessages(MSG_ACCESSORY_MODE_ENTER_TIMEOUT);
        ...
        private bool isUsbStateChanged(Intent intent) {
        ...
        private void updateMidiFunction() {
            bool enabled = (mCurrentFunctions & UsbManager.FUNCTION_MIDI) != 0;
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                ...
                case MSG_UPDATE_PORT_STATE:
                    ...
                    bool prevHostConnected = mHostConnected;
        ...
        protected bool isUsbDataTransferActive(long functions) {
        ...
        protected void updateUsbNotification(bool force) {
        ...
        protected void updateAdbNotification(bool force) {
         ...
         */
        protected abstract void setEnabledFunctions(long functions, bool forceRestart);
    }

    private static final class UsbHandlerLegacy : UsbHandler {
        /**
        ...
        private bool waitForState(String state) {
        ...
        override
        protected void setEnabledFunctions(long usbFunctions, bool forceRestart) {
            bool usbDataUnlocked = isUsbDataTransferActive(usbFunctions);
            if (DEBUG) {
            ...
            final bool oldFunctionsApplied = mCurrentFunctionsApplied;
        ...
        private bool trySetEnabledFunctions(long usbFunctions, bool forceRestart) {
        ...
        private String getPersistProp(bool functions) {
            String bootMode = getSystemProperty(BOOT_MODE_PROPERTY, "unknown");
        ...
        static bool containsFunction(String functions, String function) {
    ...
    private static final class UsbHandlerHal : UsbHandler {
        ...
        protected bool mCurrentUsbFunctionsRequested;
        ...
        UsbHandlerHal(Looper looper, Context context, UsbDeviceManager deviceManager,
            ...
            try {
                ...
                bool ret = IServiceManager.getService()
        ...
        final class UsbGadgetDeathRecipient : HwBinder.DeathRecipient {
            override
        ...
        final class ServiceNotification : IServiceNotification.Stub {
            override
        ...
        private class UsbGadgetCallback : IUsbGadgetCallback.Stub {
            int mRequest;
            long mFunctions;
            bool mChargingFunctions;

            UsbGadgetCallback() {
            }

            UsbGadgetCallback(int request, long functions,
                    bool chargingFunctions) {
                mRequest = request;
        ...
        private void setUsbConfig(long config, bool chargingFunctions) {
        ...
        override
        protected void setEnabledFunctions(long functions, bool forceRestart) {
            if (DEBUG) {
            ...
            if (mCurrentFunctions != functions
                ...
                bool chargingFunctions = functions == UsbManager.FUNCTION_NONE;
    ...
    public void allowUsbDebugging(bool alwaysAllow, String publicKey) {
        if (mDebuggingManager != null) {
    ...
    private native bool nativeIsStartRequested();
