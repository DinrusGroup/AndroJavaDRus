...
class UsbUserSettingsManager {
     ...
     *         False otherwise.
     */
    private bool isCameraDevicePresent(UsbDevice device) {
     ...
     */
    private bool isCameraPermissionGranted(String packageName, int uid) {
    ...
    public bool hasPermission(UsbDevice device, String packageName, int uid) {
        synchronized (mLock) {
