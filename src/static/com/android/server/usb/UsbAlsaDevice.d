...
public final class UsbAlsaDevice {
    ...
    private final bool mHasOutput;
    private final bool mHasInput;

    private final bool mIsInputHeadset;
    private final bool mIsOutputHeadset;
    ...
    public UsbAlsaDevice(IAudioService audioService, int card, int device, String deviceAddress,
            ...
            bool isInputHeadset, bool isOutputHeadset) {
     ...
     */
    private synchronized bool isInputJackConnected() {
     ...
     * @returns true if input jack is detected or jack detection is not supported.
     */
    private synchronized bool isOutputJackConnected() {
        if (mJackDetector == null) {
            return true;  // if jack detect isn't supported, say it's connected.
        }
     ...
     */
    public synchronized void updateWiredDeviceConnectionState(bool enable) {
        if (!mSelected) {
        ...
        try {
            ...
            if (mHasOutput) {
                ...
                bool connected = isOutputJackConnected();
            ...
            if (mHasInput) {
                ...
                bool connected = isInputJackConnected();
