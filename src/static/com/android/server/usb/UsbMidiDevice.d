...
public final class UsbMidiDevice : Closeable {
    ...
    private final class InputReceiverProxy : MidiReceiver {
    ...
    private bool openLocked() {
        ...
        for (int i = 0; i < inputStreamCount; i++) {
            ...
            pollfd.fd = fd;
            pollfd.events = cast(short)OsConstants.POLLIN;
            mPollFDs[i] = pollfd;
    ...
    private bool register(Context context, Bundle properties) {
