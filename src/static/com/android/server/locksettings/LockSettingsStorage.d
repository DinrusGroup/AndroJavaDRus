...
class LockSettingsStorage {
    ...
    public static class CredentialHash {
        ...
        private CredentialHash(byte[] hash, int type, int version, bool isBaseZeroPattern) {
    ...
    public bool hasChildProfileLock(int userId) {
    ...
    static class DatabaseHelper : SQLiteOpenHelper {
    ...
    private static class Cache {
        ...
        bool hasKeyValue(String key, int userId) {
        ...
        private synchronized bool contains(int type, String key, int userId) {
