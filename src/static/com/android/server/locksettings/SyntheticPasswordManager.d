...
public class SyntheticPasswordManager {
    ...
    private synchronized bool isWeaverAvailable() {
        if (mWeaver == null) {
    ...
    public bool hasSidForUser(int userId) {
    ...
    private bool loadEscrowData(AuthenticationToken authToken, int userId) {
    ...
    public bool hasEscrowData(int userId) {
    ...
    public bool removePendingToken(long handle, int userId) {
        if (!tokenMap.containsKey(userId)) {
            return false;
        }
    ...
    public bool activateTokenBasedSyntheticPassword(long handle, AuthenticationToken authToken,
            int userId) {
        if (!tokenMap.containsKey(userId)) {
            return false;
        }
    ...
    public bool existsHandle(long handle, int userId) {
    ...
    private bool hasState(String stateName, long handle, int userId) {
