...
public class TestOnlyInsecureCertificateHelper {
    ...
    public bool isTestOnlyCertificateAlias(String rootCertificateAlias) {
        return TrustedRootCertificates.TEST_ONLY_INSECURE_CERTIFICATE_ALIAS
                .equals(rootCertificateAlias);
    }

    public bool isValidRootCertificateAlias(String rootCertificateAlias) {
    ...
    public bool doesCredentialSupportInsecureMode(int credentialType, String credential) {
