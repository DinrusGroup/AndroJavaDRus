 ...
 * @hide
 */
public class KeySyncTask : Runnable {
    ...
    private final bool mCredentialUpdated;
    ...
    private bool isCustomLockScreen() {
    ...
    private void syncKeysForAgent(int recoveryAgentUid) throws IOException {
        bool shouldRecreateCurrentVersion = false;
        ...
        bool useScryptToHashCredential = shouldUseScryptToHashCredential();
    ...
    @VisibleForTesting
    int getSnapshotVersion(int recoveryAgentUid, bool shouldRecreateCurrentVersion)
            throws IOException {
     ...
     */
    private bool shouldCreateSnapshot(int recoveryAgentUid) {
     ...
     */
    @VisibleForTesting
    static bool isPin(@Nullable String credential) {
        if (credential == null) {
            return false;
        }
    ...
    private bool shouldUseScryptToHashCredential() {
