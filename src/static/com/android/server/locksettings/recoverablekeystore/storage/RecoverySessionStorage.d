 ...
 * @hide
 */
public class RecoverySessionStorage : Destroyable {
     ...
     * @hide
     */
    public static class Entry : Destroyable {
        ...
        override
        public void destroy() {
            Arrays.fill(mLskfHash, cast(byte) 0);
            Arrays.fill(mKeyClaimant, cast(byte) 0);
        }
    }
}
