...
public class RecoverableKeyStoreDb {
     ...
     */
    public bool removeKey(int uid, String alias) {
        SQLiteDatabase db = mKeyStoreDbHelper.getWritableDatabase();
     ...
     * @hide
     */
    public long setShouldCreateSnapshot(int userId, int uid, bool pending) {
        return setLong(userId, uid,
     ...
     * @hide
     */
    public bool getShouldCreateSnapshot(int userId, int uid) {
