 ...
 */
public final class DropBoxManagerService : SystemService {
    ...
    private static final bool PROFILE_DUMP = false;
    ...
    private volatile bool mBooted = false;
    ...
    public synchronized void dump(FileDescriptor fd, PrintWriter pw, String[] args) {
        ...
        bool doPrint = false, doFile = false;
    ...
    private static final class FileList : Comparable<FileList> {
        public int blocks = 0;
     ...
     */
    @VisibleForTesting
    static final class EntryFile : Comparable<EntryFile> {
