 ...
 * {@hide}
 */
public abstract class IntentResolver<F : IntentFilter, R : Object> {
    final private static String TAG = "IntentResolver";
    final private static bool DEBUG = false;
    final private static bool localLOGV = DEBUG || false;
    final private static bool localVerificationLOGV = DEBUG || false;
    ...
    public static bool filterEquals(IntentFilter f1, IntentFilter f2) {
    ...
    bool dumpMap(PrintWriter out, String titlePrefix, String title,
            String prefix, ArrayMap<String, F[]> map, String packageName,
            bool printFilter, bool collapseDuplicates) {
    ...
    public bool dump(PrintWriter out, String title, String prefix, String packageName,
            bool printFilter, bool collapseDuplicates) {
    ...
    private class IteratorWrapper : Iterator<F> {
    ...
    public List<R> queryIntentFromList(Intent intent, String resolvedType, bool defaultOnly,
            ArrayList<F[]> listCut, int userId) {
        ArrayList<R> resultList = new ArrayList<R>();

        final bool debug = localLOGV ||
    ...
    public List<R> queryIntent(Intent intent, String resolvedType, bool defaultOnly,
            int userId) {
     ...
     * same target object.
     */
    protected bool allowFilterResult(F filter, List<R> dest) {
        return true;
    }
     ...
     */
    protected bool isFilterStopped(F filter, int userId) {
        return false;
    }
     ...
     * is "http" or "https".
     *
     * @see android.content.IntentFilter#setAutoVerify(bool)
     * @see android.content.IntentFilter#getAutoVerify()
     */
    protected bool isFilterVerified(F filter) {
     ...
     */
    protected abstract bool isPackageForFilter(String packageName, F filter);
    ...
    private void buildResolveList(Intent intent, FastImmutableArraySet<String> categories,
            bool debug, bool defaultOnly, String resolvedType, String scheme,
            F[] src, List<R> dest, int userId) {
        final String action = intent.getAction();
        final Uri data = intent.getData();
        final String packageName = intent.getPackage();

        final bool excludingStopped = intent.isExcludingStopped();
