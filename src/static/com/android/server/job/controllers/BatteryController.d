 ...
 * ACTION_BATTERY_OK.
 */
public final class BatteryController : StateController {
    ...
    override
    public void maybeStopTrackingJobLocked(JobStatus taskStatus, JobStatus incomingJob, bool forUpdate) {
    ...
    private void maybeReportNewChargingStateLocked() {
        final bool stablePower = mChargeTracker.isOnStablePower();
        final bool batteryNotLow = mChargeTracker.isBatteryNotLow();
        if (DEBUG) {
        ...
        for (int i = mTrackedTasks.size() - 1; i >= 0; i--) {
            ...
            bool previous = ts.setChargingConstraintSatisfied(stablePower);
    ...
    public final class ChargingTracker : BroadcastReceiver {
        /**
        ...
        public void setMonitorBatteryLocked(bool enabled) {
            if (enabled) {
                if (mMonitor == null) {
        ...
        public bool isOnStablePower() {
            return mCharging && mBatteryHealthy;
        }

        public bool isBatteryNotLow() {
