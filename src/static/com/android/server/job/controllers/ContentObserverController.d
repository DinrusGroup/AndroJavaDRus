 ...
 */
public final class ContentObserverController : StateController {
    ...
    final class ObserverInstance : ContentObserver {
    ...
    static final class TriggerRunnable : Runnable {
            ...
            if (uris != null) {
                for (JobInfo.TriggerContentUri uri : uris) {
                    ...
                    if (obs == null) {
                        ...
                        final bool andDescendants = (uri.getFlags() &
