 ...
 */
public final class TimeController : StateController {
    ...
    private final bool mChainedAttributionEnabled;
     ...
     * back and forth.
     */
    private bool canStopTrackingJobLocked(JobStatus job) {
    ...
    private bool evaluateDeadlineConstraint(JobStatus job, long nowElapsedMillis) {
    ...
    private bool evaluateTimingDelayConstraint(JobStatus job, long nowElapsedMillis) {
        final long jobDelayTime = job.getEarliestRunTime();
