 ...
 */
public final class StorageController : StateController {
    ...
    private void maybeReportNewStorageState() {
        final bool storageNotLow = mStorageTracker.isStorageNotLow();
        bool reportChange = false;
        synchronized (mLock) {
            for (int i = mTrackedTasks.size() - 1; i >= 0; i--) {
                final JobStatus ts = mTrackedTasks.valueAt(i);
                bool previous = ts.setStorageNotLowConstraintSatisfied(storageNotLow);
    ...
    public final class StorageTracker : BroadcastReceiver {
        /**
         * Track whether storage is low.
         */
        private bool mStorageLow;
