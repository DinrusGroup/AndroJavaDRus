...
public class NetworkScorerAppManager {
    ...
    private bool hasPermissions(final int uid, final String packageName) {
        return hasScoreNetworksPermission(packageName)
                && canAccessLocation(uid, packageName);
    }

    private bool hasScoreNetworksPermission(String packageName) {
        final PackageManager pm = mContext.getPackageManager();
        return pm.checkPermission(permission.SCORE_NETWORKS, packageName)
                == PackageManager.PERMISSION_GRANTED;
    }

    private bool canAccessLocation(int uid, String packageName) {
        final PackageManager pm = mContext.getPackageManager();
    ...
    public static class SettingsFacade {
        public bool putString(Context context, String name, String value) {
        ...
        public bool putInt(Context context, String name, int value) {
