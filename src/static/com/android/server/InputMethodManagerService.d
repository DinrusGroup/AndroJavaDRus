 ...
 */
public class InputMethodManagerService : IInputMethodManager.Stub
    ...
    private static final class DebugFlag {
        ...
        private final bool mDefaultValue;
        @GuardedBy("LOCK")
        private bool mValue;

        public DebugFlag(String key, bool defaultValue) {
            mKey = key;
    ...
    private bool mShowOngoingImeSwitcherForPhones;
    private bool mNotificationShown;
    ...
    private bool mCurClientInKeyguard;
    ...
    private bool mShowImeWithHardKeyboard;
    private bool mAccessibilityRequestingNoSoftKeyboard;
     ...
     */
    private bool mBindInstantServiceAllowed = false;
     ...
     * {@link InputMethodService#doStartInput(InputConnection, EditorInfo, bool)} will be called
    ...
    private static class StartInputInfo {
        ...
        StartInputInfo(@NonNull IBinder imeToken, @NonNull String imeId,
                /* @InputMethodClient.StartInputReason */ int startInputReason, bool restarting,
            ...
            synchronized (mMethodMap) {
                if (showImeUri.equals(uri)) {
                    ...
                    if (mAccessibilityRequestingNoSoftKeyboard) {
                        final bool showRequested = mShowRequested;
    ...
    class ImmsBroadcastReceiver : BroadcastReceiver {
        override
    ...
    final class MyPackageMonitor : PackageMonitor {
        /**
         ...
         * which should be bound to {@link #getRegisteredHandler()}.</p>
         */
        private bool mImePackageAppeared = false;
        ...
        @GuardedBy("mMethodMap")
        private bool isChangingPackagesOfCurrentUserLocked() {
            final int userId = getChangingUserId();
            final bool retval = userId == mSettings.getCurrentUserId();
            if (DEBUG) {
                if (!retval) {
        ...
        override
        public bool onHandleForceStop(Intent intent, String[] packages, int uid, bool doit) {
            synchronized (mMethodMap) {
        ...
        @GuardedBy("mMethodMap")
        private bool shouldRebuildInputMethodListLocked() {
    ...
    private static final class MethodCallback : IInputSessionCallback.Stub {
    ...
    private class HardKeyboardListener
        ...
        override
        public void onHardKeyboardStatusChange(bool available) {
            mHandler.sendMessage(mHandler.obtainMessage(MSG_HARD_KEYBOARD_SWITCH_CHANGED,
                        available ? 1 : 0));
        }

        public void handleHardKeyboardStatusChange(bool available) {
            if (DEBUG) {
    ...
    private void switchUserLocked(int newUserId) {
        ...
        final bool useCopyOnWriteSettings =
        ...
        // IME for that user.
        final bool initialUserSwitch = TextUtils.isEmpty(defaultImiId);
    ...
    public void systemRunning(StatusBarManagerService statusBar) {
        synchronized (mMethodMap) {
            ...
            if (!mSystemReady) {
                ...
                final String defaultImiId = mSettings.getSelectedInputMethod();
                final bool imeSelectedOnBoot = !TextUtils.isEmpty(defaultImiId);
    ...
    private bool calledFromValidUser() {
     ...
     */
    private bool calledWithValidToken(@Nullable IBinder token) {
    ...
    @GuardedBy("mMethodMap")
    private bool bindCurrentInputMethodServiceLocked(
    ...
    private List<InputMethodInfo> getInputMethodList(final bool isVrOnly) {
    ...
    InputBindResult attachNewInputLocked(
            /* @InputMethodClient.StartInputReason */ final int startInputReason, bool initial) {
        if (!mBoundToMethod) {
    ...
    void unbindCurrentMethodLocked(bool savePosition) {
        if (mVisibleBound) {
    ...
    public void onServiceDisconnected(ComponentName name) {
        ...
        //    adb install -r <APK that : the current IME>
    ...
    private bool shouldShowImeSwitcherLocked(int visibility) {
    ...
    public void setImeWindowStatus(IBinder token, IBinder startInputToken, int vis,
        ...
        final bool dismissImeOnBackKeyPressed;
    ...
    private void updateSystemUiLocked(IBinder token, int vis, int backDisposition) {
        ...
        try {
            ...
            final bool needsToShowImeSwitcher = shouldShowImeSwitcherLocked(vis);
            if (mStatusBar != null) {
    ...
    override
    public bool notifySuggestionPicked(SuggestionSpan span, String originalString, int index) {
        if (!calledFromValidUser()) {
            return false;
        }
        synchronized (mMethodMap) {
    ...
    void updateFromSettingsLocked(bool enabledMayChange) {
        updateInputMethodsFromSettingsLocked(enabledMayChange);
        updateKeyboardFromSettingsLocked();
    }

    void updateInputMethodsFromSettingsLocked(bool enabledMayChange) {
        if (enabledMayChange) {
    ...
    override
    public bool showSoftInput(IInputMethodClient client, int flags,
    ...
    bool showCurrentInputLocked(int flags, ResultReceiver resultReceiver) {
        mShowRequested = true;
        if (mAccessibilityRequestingNoSoftKeyboard) {
            return false;
        }
    ...
    override
    public bool hideSoftInput(IInputMethodClient client, int flags,
            ResultReceiver resultReceiver) {
        if (!calledFromValidUser()) {
            return false;
        }
    ...
    bool hideCurrentInputLocked(int flags, ResultReceiver resultReceiver) {
        ...
        final bool shouldHideSoftInput = (mCurMethod != null) && (mInputShown ||
    ...
    private InputBindResult windowGainedFocus(
        ...
        final bool calledFromValidUser = calledFromValidUser();
    ...
    private bool canShowInputMethodPickerLocked(IInputMethodClient client) {
        final int uid = Binder.getCallingUid();
    ...
    public bool isInputMethodPickerShownForTest() {
        synchronized(mMethodMap) {
            if (mSwitchingDialog == null) {
                return false;
            }
    ...
    override
    public bool switchToPreviousInputMethod(IBinder token) {
        if (!calledFromValidUser()) {
            return false;
        }
        synchronized (mMethodMap) {
            ...
            if (lastIme != null && lastImi != null) {
                final bool imiIdIsSame = lastImi.getId().equals(mCurMethodId);
    ...
    override
    public bool switchToNextInputMethod(IBinder token, bool onlyCurrentIme) {
        if (!calledFromValidUser()) {
            return false;
        }
        synchronized (mMethodMap) {
    ...
    override
    public bool shouldOfferSwitchingToNextInputMethod(IBinder token) {
        if (!calledFromValidUser()) {
            return false;
        }
        synchronized (mMethodMap) {
    ...
    public bool handleMessage(Message msg) {
        ...
        switch (msg.what) {
            ...
            case MSG_START_INPUT: {
                ...
                final bool restarting = msg.arg2 != 0;
                args = (SomeArgs) msg.obj;
            ...
            case MSG_REPORT_FULLSCREEN_MODE: {
                final bool fullscreen = msg.arg1 != 0;
                final ClientState clientState = (ClientState)msg.obj;
                try {
    ...
    private void handleSetInteractive(final bool interactive) {
        synchronized (mMethodMap) {
    ...
    private void handleSwitchInputMethod(final bool forwardDirection) {
        synchronized (mMethodMap) {
            final ImeSubtypeListItem nextSubtype = mSwitchingController.getNextInputMethodLocked(
    ...
    private bool chooseNewDefaultIMELocked() {
    ...
    @GuardedBy("mMethodMap")
    void buildInputMethodListLocked(bool resetDefaultEnabledIme) {
        if (DEBUG) {
        ...
        bool reenableMinimumNonAuxSystemImes = false;
        // TODO: The following code should find better place to live.
        if (!resetDefaultEnabledIme) {
            bool enabledImeFound = false;
            bool enabledNonAuxImeFound = false;
    ...
    private void showInputMethodMenu(bool showAuxSubtypes) {
        if (DEBUG) Slog.v(TAG, "Show switching menu. showAuxSubtypes=" + showAuxSubtypes);

        final bool isScreenLocked = isScreenLocked();
    ...
    private static class ImeSubtypeListAdapter : ArrayAdapter<ImeSubtypeListItem> {
    ...
    bool setInputMethodEnabledLocked(String id, bool enabled) {
    ...
    private void setSelectedInputMethodAndSubtypeLocked(InputMethodInfo imi, int subtypeId,
        ...
        final bool isVrInput = imi != null && imi.isVrOnly();
        if (!isVrInput) {
    ...
    private InputMethodSubtype getCurrentInputMethodSubtypeLocked() {
        ...
        final bool subtypeIsSelected = mSettings.isSubtypeSelected();
        final InputMethodInfo imi = mMethodMap.get(mCurMethodId);
    ...
    private static class InputMethodFileManager {
        ...
        private static void writeAdditionalInputMethodSubtypes(
            ...
            final bool isSetMethodMap = methodMap != null && methodMap.size() > 0;
            ...
            try (final FileInputStream fis = subtypesFile.openRead()) {
                ...
                while (((type = parser.next()) != XmlPullParser.END_TAG
                    ...
                    if (NODE_IMI.equals(nodeName)) {
                        ...
                        final bool isAuxiliary = "1".equals(String.valueOf(
                                parser.getAttributeValue(null, ATTR_IS_AUXILIARY)));
                        final bool isAsciiCapable = "1".equals(String.valueOf(
    ...
    private static final class LocalServiceImpl : InputMethodManagerInternal {
        @NonNull
    ...
    override
    public void reportFullscreenMode(IBinder token, bool fullscreen) {
        if (!calledFromValidUser()) {
            return;
        }
        synchronized (mMethodMap) {
    ...
    private static final class ShellCommandImpl : ShellCommand {
        @NonNull
    ...
    private int handleSetBindInstantServiceAllowed(@NonNull ShellCommand shellCommand) {
        ...
        final bool allowed = Boolean.parseBoolean(allowedString);
        synchronized (mMethodMap) {
            if (mContext.checkCallingOrSelfPermission(
    ...
    private int handleShellCommandEnableDisableInputMethod(
            @NonNull ShellCommand shellCommand, bool enabled) {
        if (!calledFromValidUser()) {
            shellCommand.getErrPrintWriter().print(
