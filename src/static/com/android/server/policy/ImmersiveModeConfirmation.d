...
public class ImmersiveModeConfirmation {
    ...
    private static final bool DEBUG_SHOW_EVERY_TIME = false; // super annoying, use with caution
    ...
    public void immersiveModeChangedLw(String pkg, bool isImmersiveMode,
            bool userSetupComplete, bool navBarEmpty) {
        mHandler.removeMessages(H.SHOW);
        if (isImmersiveMode) {
            final bool disabled = PolicyControl.disableImmersiveConfirmation(pkg);
    ...
    public bool onPowerKeyDown(bool isScreenOn, long time, bool inImmersiveMode,
            bool navBarEmpty) {
    ...
    private class ClingWindowView : FrameLayout {
        ...
        override
        public bool onTouchEvent(MotionEvent motion) {
            return true;
        }
    }
    ...
    private final IVrStateCallbacks mVrStateCallbacks = new IVrStateCallbacks.Stub() {
        override
        public void onVrStateChanged(bool enabled) throws RemoteException {
