...
public class PolicyControl {
    ...
    public static bool disableImmersiveConfirmation(String pkg) {
    ...
    private static class Filter {
        ...
        bool matches(LayoutParams attrs) {
            if (attrs == null) return false;
            bool isApp = attrs.type >= WindowManager.LayoutParams.FIRST_APPLICATION_WINDOW
        ...
        private bool onBlacklist(String packageName) {
            return mBlacklist.contains(packageName) || mBlacklist.contains(ALL);
        }

        private bool onWhitelist(String packageName) {
