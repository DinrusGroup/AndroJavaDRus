 ...
 */
public class PhoneWindowManager : WindowManagerPolicy {
    static final String TAG = "WindowManager";
    static final bool DEBUG = false;
    static final bool localLOGV = false;
    static final bool DEBUG_INPUT = false;
    static final bool DEBUG_KEYGUARD = false;
    static final bool DEBUG_LAYOUT = false;
    static final bool DEBUG_SPLASH_SCREEN = false;
    static final bool DEBUG_WAKEUP = false;
    static final bool SHOW_SPLASH_SCREENS = true;

    // Whether to allow dock apps with METADATA_DOCK_HOME to temporarily take over the Home key.
    // No longer recommended for desk docks;
    static final bool ENABLE_DESK_DOCK_HOME_CAPTURE = false;

    // Whether to allow devices placed in vr headset viewers to have an alternative Home intent.
    static final bool ENABLE_VR_HEADSET_HOME_CAPTURE = true;

    static final bool ALTERNATE_CAR_MODE_NAV_SIZE = false;
     ...
     * Keyguard stuff
     */
    private bool mKeyguardDrawnOnce;
    ...
    private bool mHasFeatureWatch;
    private bool mHasFeatureLeanback;
    ...
    bool mEnableShiftMenuBugReports = false;
    ...
    bool mHasNavigationBar = false;
    bool mNavigationBarCanMove = false; // can the navigation bar ever move to the side?
    ...
    private bool mEnableCarDockHomeCapture = true;

    bool mBootMessageNeedsHiding;
    KeyguardServiceDelegate mKeyguardDelegate;
    private bool mKeyguardBound;
    ...
    volatile bool mPowerKeyHandled;
    volatile bool mBackKeyHandled;
    volatile bool mBeganFromNonInteractive;
    volatile int mPowerKeyPressCounter;
    volatile bool mEndCallKeyHandled;
    volatile bool mCameraGestureTriggeredDuringGoingToSleep;
    volatile bool mGoingToSleep;
    volatile bool mRequestedOrGoingToSleep;
    volatile bool mRecentsVisible;
    volatile bool mNavBarVirtualKeyHapticFeedbackEnabled = true;
    volatile bool mPictureInPictureVisible;
    // Written by vr manager thread, only read in this class.
    volatile private bool mPersistentVrModeEnabled;
    volatile private bool mDismissImeOnBackKeyPressed;
    ...
    bool mLanguageSwitchKeyPressed;

    int mLidState = LID_ABSENT;
    int mCameraLensCoverState = CAMERA_LENS_COVER_ABSENT;
    bool mHaveBuiltInKeyboard;
    ...
    bool mDemoHdmiRotationLock;
    int mDemoRotation;
    bool mDemoRotationLock;

    bool mWakeGestureEnabledSetting;
    MyWakeGestureListener mWakeGestureListener;

    // Default display does not rotate, apps that require non-default orientation will have to
    // have the orientation emulated.
    private bool mForceDefaultOrientation = false;

    int mUserRotationMode = WindowManagerPolicy.USER_ROTATION_FREE;
    int mUserRotation = Surface.ROTATION_0;

    bool mSupportAutoRotation;
    int mAllowAllRotations = -1;
    bool mCarDockEnablesAccelerometer;
    bool mDeskDockEnablesAccelerometer;
    int mLidKeyboardAccessibility;
    int mLidNavigationAccessibility;
    bool mLidControlsScreenLock;
    bool mLidControlsSleep;
    ...
    volatile bool mAwake;
    bool mScreenOnEarly;
    bool mScreenOnFully;
    ScreenOnListener mScreenOnListener;
    bool mKeyguardDrawComplete;
    bool mWindowManagerDrawComplete;
    bool mOrientationSensorEnabled = false;
    int mCurrentAppOrientation = ActivityInfo.SCREEN_ORIENTATION_UNSPECIFIED;
    bool mHasSoftInput = false;
    bool mTranslucentDecorEnabled = true;
    bool mUseTvRouting;
    int mVeryLongPressTimeout;
    bool mAllowStartActivityForLongPressOnPowerDuringSetup;
    MetricsLogger mLogger;

    private bool mHandleVolumeKeysInWM;
    ...
    bool mLastFocusNeedsMenu = false;
    ...
    bool mTopIsFullscreen;
    bool mForceStatusBar;
    bool mForceStatusBarFromKeyguard;
    private bool mForceStatusBarTransparent;
    int mNavBarOpacityMode = NAV_BAR_OPAQUE_WHEN_FREEFORM_OR_DOCKED;
    bool mForcingShowNavBar;
    int mForcingShowNavBarLayer;

    private bool mPendingKeyguardOccluded;
    private bool mKeyguardOccludedChanged;
    private bool mNotifyUserActivity;

    bool mShowingDream;
    private bool mLastShowingDream;
    bool mDreamingLockscreen;
    bool mDreamingSleepTokenNeeded;
    private bool mWindowSleepTokenNeeded;
    private bool mLastWindowSleepTokenNeeded;
    ...
    volatile bool mKeyguardOccluded;
    bool mHomePressed;
    bool mHomeConsumed;
    bool mHomeDoubleTapPending;
    Intent mHomeIntent;
    Intent mCarDockIntent;
    Intent mDeskDockIntent;
    Intent mVrHeadsetHomeIntent;
    bool mSearchKeyShortcutPending;
    bool mConsumeSearchKeyUp;
    bool mPendingMetaAction;
    bool mPendingCapsLockToggle;
    int mMetaState;
    int mInitialMetaState;
    bool mForceShowSystemBars;

    // support for activating the lock screen while the screen is on
    bool mAllowLockscreenWhenOn;
    int mLockScreenTimeout;
    bool mLockScreenTimerActive;
    ...
    bool mSystemNavigationKeysEnabled;
    ...
    private bool mAllowTheaterModeWakeFromKey;
    private bool mAllowTheaterModeWakeFromPowerKey;
    private bool mAllowTheaterModeWakeFromMotion;
    private bool mAllowTheaterModeWakeFromMotionWhenNotDreaming;
    private bool mAllowTheaterModeWakeFromCameraLens;
    private bool mAllowTheaterModeWakeFromLidSwitch;
    private bool mAllowTheaterModeWakeFromWakeGesture;

    // Whether to support long press from power button in non-interactive mode
    private bool mSupportLongPressPowerWhenNonInteractive;

    // Whether to go to sleep entering theater mode from power button
    private bool mGoToSleepOnButtonPressTheaterMode;
    ...
    private bool mScreenshotChordEnabled;
    private bool mScreenshotChordVolumeDownKeyTriggered;
    private long mScreenshotChordVolumeDownKeyTime;
    private bool mScreenshotChordVolumeDownKeyConsumed;
    private bool mA11yShortcutChordVolumeUpKeyTriggered;
    private long mA11yShortcutChordVolumeUpKeyTime;
    private bool mA11yShortcutChordVolumeUpKeyConsumed;

    private bool mScreenshotChordPowerKeyTriggered;
    ...
    private bool mBugreportTvKey1Pressed;
    private bool mBugreportTvKey2Pressed;
    private bool mBugreportTvScheduled;

    private bool mAccessibilityTvKey1Pressed;
    private bool mAccessibilityTvKey2Pressed;
    private bool mAccessibilityTvScheduled;
    ...
    bool mHavePendingMediaKeyRepeatWithWakeLock;
    ...
    private class PolicyHandler : Handler {
        override
    ...
    class SettingsObserver : ContentObserver {
        ...
        override public void onChange(bool selfChange) {
            updateSettings();
            updateRotation(false);
        }
    }

    class MyWakeGestureListener : WakeGestureListener {
    ...
    class MyOrientationListener : WindowOrientationListener {
        ...
        private class UpdateRunnable : Runnable {
            ...
            public void run() {
                ...
                if (isRotationChoicePossible(mCurrentAppOrientation)) {
                    final bool isValid = isValidRotationChoice(mCurrentAppOrientation,
                            mRotation);
    ...
    final IPersistentVrStateCallbacks mPersistentVrModeListener =
        ...
        override
        public void onPersistentVrStateChanged(bool enabled) {
    ...
    private final BarController.OnBarVisibilityChangedListener mNavBarVisibilityListener =
        ...
        override
        public void onBarVisibilityChanged(bool visible) {
    ...
    private bool interceptBackKeyUp(KeyEvent event) {
        // Cache handled state
        bool handled = mBackKeyHandled;
    ...
    private void interceptPowerKeyDown(KeyEvent event, bool interactive) {
        ...
        bool panic = mImmersiveModeConfirmation.onPowerKeyDown(interactive,
        ...
        bool gesturedServiceIntercepted = false;
    ...
    private void interceptPowerKeyUp(KeyEvent event, bool interactive, bool canceled) {
        final bool handled = canceled || mPowerKeyHandled;
    ...
    private void powerPress(long eventTime, bool interactive, int count) {
    ...
    private void powerMultiPressAction(long eventTime, bool interactive, int behavior) {
        switch (behavior) {
    ...
    private void powerLongPress() {
        ...
        case LONG_PRESS_POWER_GO_TO_VOICE_ASSIST:
            mPowerKeyHandled = true;
            performHapticFeedbackLw(null, HapticFeedbackConstants.LONG_PRESS, false);
            final bool keyguardActive = mKeyguardDelegate == null
                    ? false
    ...
    private bool hasLongPressOnPowerBehavior() {
        return getResolvedLongPressOnPowerBehavior() != LONG_PRESS_POWER_NOTHING;
    }

    private bool hasVeryLongPressOnPowerBehavior() {
        return mVeryLongPressOnPowerBehavior != VERY_LONG_PRESS_POWER_NOTHING;
    }

    private bool hasLongPressOnBackBehavior() {
    ...
    private class ScreenshotRunnable : Runnable {
    ...
    void showGlobalActionsInternal() {
        ...
        final bool keyguardShowing = isKeyguardShowingAndNotOccluded();
    ...
    bool isUserSetupComplete() {
        bool isSetupComplete = Settings.Secure.getIntForUser(mContext.getContentResolver(),
    ...
    private bool isTvUserSetupComplete() {
        return Settings.Secure.getIntForUser(mContext.getContentResolver(),
    ...
    public void init(Context context, IWindowManager windowManager,
        ...
        bool burnInProtectionEnabled = context.getResources().getBoolean(
                com.android.internal.R.bool.config_enableBurnInProtection);
        // Allow a system property to override this. Used by developer settings.
        bool burnInProtectionDevMode =
    ...
    public void setInitialDisplaySize(Display display, int width, int height, int density) {
        ...
        final bool isCar = mContext.getPackageManager().hasSystemFeature(
                PackageManager.FEATURE_AUTOMOTIVE);
        // For TV, it's usually 960dp x 540dp, ignore the size limitation.
        // so if the orientation is forced, we need to respect that no matter what.
        final bool isTv = mContext.getPackageManager().hasSystemFeature(
     ...
     */
    private bool canHideNavigationBar() {
        return mHasNavigationBar;
    }

    override
    public bool isDefaultOrientationForced() {
    ...
    public void updateSettings() {
        ...
        synchronized (mLock) {
            ...
            bool wakeGestureEnabledSetting = Settings.Secure.getIntForUser(resolver,
            ...
            bool hasSoftInput = imId != null && imId.length() > 0;
    ...
    private bool shouldEnableWakeGestureLp() {
    ...
    public int checkAddPermission(WindowManager.LayoutParams attrs, int[] outAppOp) {
        ...
        final bool isRoundedCornerOverlay =
    ...
    override
    public bool checkShowToOwnerOnly(WindowManager.LayoutParams attrs) {
    ...
    public void adjustWindowParamsLw(WindowState win, WindowManager.LayoutParams attrs,
            bool hasStatusBarServicePermission) {

        final bool isScreenDecor = (attrs.privateFlags & PRIVATE_FLAG_IS_SCREEN_DECOR) != 0;
    ...
    private int getImpliedSysUiFlagsForLayout(LayoutParams attrs) {
        ...
        final bool forceWindowDrawsStatusBarBackground =
    ...
    private bool isHidden(int accessibilityMode) {
    ...
    override
    public bool isKeyguardHostWindow(WindowManager.LayoutParams attrs) {
        return attrs.type == TYPE_STATUS_BAR;
    }

    override
    public bool canBeHiddenByKeyguardLw(WindowState win) {
    ...
    private bool shouldBeHiddenByKeyguard(WindowState win, WindowState imeTarget) {
        ...
        final bool showImeOverKeyguard = imeTarget != null && imeTarget.isVisibleLw() &&
                ((imeTarget.getAttrs().flags & FLAG_SHOW_WHEN_LOCKED) != 0
                        || !canBeHiddenByKeyguardLw(imeTarget));

        // Show IME over the keyguard if the target allows it
        bool allowWhenLocked = (win.isInputMethodWindow() || imeTarget == this)
                && showImeOverKeyguard;
        ...
        bool keyguardLocked = isKeyguardLocked();
        bool hideDockDivider = attrs.type == TYPE_DOCK_DIVIDER
    ...
    static final bool PRINT_ANIM = false;
    ...
    public int selectAnimationLw(WindowState win, int transit) {
        if (PRINT_ANIM) Log.i(TAG, "selectAnimation in " + win
              + ": transit=" + transit);
        if (win == mStatusBar) {
            final bool isKeyguard = (win.getAttrs().privateFlags & PRIVATE_FLAG_KEYGUARD) != 0;
            final bool expanded = win.getAttrs().height == MATCH_PARENT
    ...
    private int selectDockedDividerAnimationLw(WindowState win, int transit) {
        ...
        final bool behindNavBar = mNavigationBar != null
        ...
        final bool landscape = frame.height() > frame.width();
        final bool offscreenLandscape = landscape && (frame.right - insets <= 0
                || frame.left + insets >= win.getDisplayFrameLw().right);
        final bool offscreenPortrait = !landscape && (frame.top - insets <= 0
                || frame.bottom + insets >= win.getDisplayFrameLw().bottom);
        final bool offscreen = offscreenLandscape || offscreenPortrait;
    ...
    public void selectRotationAnimationLw(int anim[]) {
        ...
        final bool forceJumpcut = !mScreenOnFully || !okToAnimate();
    ...
    override
    public bool validateRotationAnimationLw(int exitAnimId, int enterAnimId,
            bool forceDefault) {
        switch (exitAnimId) {
    ...
    override
    public Animation createHiddenByKeyguardExit(bool onWallpaper,
            bool goingToNotificationShade) {
    ...
    override
    public Animation createKeyguardWallpaperExit(bool goingToNotificationShade) {
        if (goingToNotificationShade) {
            return null;
        } else {
    ...
    public long interceptKeyBeforeDispatching(WindowState win, KeyEvent event, int policyFlags) {
        final bool keyguardOn = keyguardOn();
        final int keyCode = event.getKeyCode();
        final int repeatCount = event.getRepeatCount();
        final int metaState = event.getMetaState();
        final int flags = event.getFlags();
        final bool down = event.getAction() == KeyEvent.ACTION_DOWN;
        final bool canceled = event.isCanceled();
        ...
        if (down && repeatCount == 0
            ...
            final bool forwardDirection = (metaState & KeyEvent.META_SHIFT_MASK) == 0;
     ...
     */
    private bool interceptBugreportGestureTv(int keyCode, bool down) {
     ...
     */
    private bool interceptAccessibilityGestureTv(int keyCode, bool down) {
    ...
    public KeyEvent dispatchUnhandledKey(WindowState win, KeyEvent event, int policyFlags) {
        ...
        if ((event.getFlags() & KeyEvent.FLAG_FALLBACK) == 0) {
            ...
            final int keyCode = event.getKeyCode();
            final int metaState = event.getMetaState();
            final bool initialDown = event.getAction() == KeyEvent.ACTION_DOWN
    ...
    private bool interceptFallback(WindowState win, KeyEvent fallbackEvent, int policyFlags) {
    ...
    override
    public void onKeyguardOccludedChangedLw(bool occluded) {
    ...
    private void showRecentApps(bool triggeredFromAltTab) {
        mPreloadedRecentApps = false; // preloading no longer needs to be canceled
        StatusBarManagerInternal statusbar = getStatusBarManagerInternal();
        if (statusbar != null) {
    ...
    private void hideRecentApps(bool triggeredFromAltTab, bool triggeredFromHome) {
        mPreloadedRecentApps = false; // preloading no longer needs to be canceled
        StatusBarManagerInternal statusbar = getStatusBarManagerInternal();
        if (statusbar != null) {
     ...
     */
    void launchHomeFromHotKey(final bool awakenFromDreams, final bool respectKeyguard) {
        // Abort possibly stuck animations.
        mHandler.post(mWindowManagerFuncs::triggerAnimationFailsafe);
     ...
     */
    final class HideNavInputEventReceiver : InputEventReceiver {
    ...
    override
    public void setRecentsVisibilityLw(bool visible) {
        mRecentsVisible = visible;
    }

    override
    public void setPipVisibilityLw(bool visible) {
        mPictureInPictureVisible = visible;
    }

    override
    public void setNavBarVirtualKeyHapticFeedbackEnabledLw(bool enabled) {
    ...
    public bool getLayoutHintLw(WindowManager.LayoutParams attrs, Rect taskBounds,
        ...
        final bool useOutsets = outOutsets != null && shouldUseOutsets(attrs, fl);
        if (useOutsets) {
        ...
        final bool layoutInScreen = (fl & FLAG_LAYOUT_IN_SCREEN) != 0;
        final bool layoutInScreenAndInsetDecor = layoutInScreen &&
                (fl & FLAG_LAYOUT_INSET_DECOR) != 0;
        final bool screenDecor = (pfl & PRIVATE_FLAG_IS_SCREEN_DECOR) != 0;
    ...
    private bool shouldUseOutsets(WindowManager.LayoutParams attrs, int fl) {
    ...
    public void beginLayoutLw(DisplayFrames displayFrames, int uiMode) {
        ...
        if (displayFrames.mDisplayId == DEFAULT_DISPLAY) {
            ...
            bool navVisible = (sysui & View.SYSTEM_UI_FLAG_HIDE_NAVIGATION) == 0;
            bool navTranslucent = (sysui
                    & (View.NAVIGATION_BAR_TRANSLUCENT | View.NAVIGATION_BAR_TRANSPARENT)) != 0;
            bool immersive = (sysui & View.SYSTEM_UI_FLAG_IMMERSIVE) != 0;
            bool immersiveSticky = (sysui & View.SYSTEM_UI_FLAG_IMMERSIVE_STICKY) != 0;
            bool navAllowedHidden = immersive || immersiveSticky;
            navTranslucent &= !immersiveSticky;  // transient trumps translucent
            bool isKeyguardShowing = isStatusBarKeyguard() && !mKeyguardOccluded;
            if (!isKeyguardShowing) {
                navTranslucent &= areTranslucentBarsAllowed();
            }
            bool statusBarExpandedNotKeyguard = !isKeyguardShowing && mStatusBar != null
            ...
            bool updateSysUiVisibility = layoutNavigationBar(displayFrames, uiMode, dcf,
    ...
    private bool layoutStatusBar(DisplayFrames displayFrames, Rect pf, Rect df, Rect of, Rect vf,
            Rect dcf, int sysui, bool isKeyguardShowing) {
        ...
        bool statusBarTransient = (sysui & View.STATUS_BAR_TRANSIENT) != 0;
        bool statusBarTranslucent = (sysui
    ...
    private bool layoutNavigationBar(DisplayFrames displayFrames, int uiMode, Rect dcf,
            bool navVisible, bool navTranslucent, bool navAllowedHidden,
            bool statusBarExpandedNotKeyguard) {
        if (mNavigationBar == null) {
            return false;
        }
        bool transientNavBarShowing = mNavigationBarController.isTransientShowing();
    ...
    private void setAttachedWindowFrames(WindowState win, int fl, int adjust, WindowState attached,
            bool insetDecors, Rect pf, Rect df, Rect of, Rect cf, Rect vf,
    ...
    private bool canReceiveInput(WindowState win) {
        bool notFocusable =
        ...
        bool notFocusableForIm = notFocusable ^ altFocusableIm;
    ...
    public void layoutWindowLw(WindowState win, WindowState attached, DisplayFrames displayFrames) {
        ...
        final bool isDefaultDisplay = win.isDefaultDisplay();
        final bool needsToOffsetInputMethodTarget = isDefaultDisplay &&
        ...
        final bool hasNavBar = (isDefaultDisplay && mHasNavigationBar
                && mNavigationBar != null && mNavigationBar.isVisibleLw());

        final int adjust = sim & SOFT_INPUT_MASK_ADJUST;

        final bool requestedFullscreen = (fl & FLAG_FULLSCREEN) != 0
                || (requestedSysUiFl & View.SYSTEM_UI_FLAG_FULLSCREEN) != 0;

        final bool layoutInScreen = (fl & FLAG_LAYOUT_IN_SCREEN) == FLAG_LAYOUT_IN_SCREEN;
        final bool layoutInsetDecor = (fl & FLAG_LAYOUT_INSET_DECOR) == FLAG_LAYOUT_INSET_DECOR;
        ...
        bool parentFrameWasClippedByDisplayCutout = false;
        final int cutoutMode = attrs.layoutInDisplayCutoutMode;
        final bool attachedInParent = attached != null && !layoutInScreen;
        final bool requestedHideNavigation =
        ...
        final bool floatingInScreenWindow = !attrs.isFullscreen() && layoutInScreen
        ...
        final bool useOutsets = shouldUseOutsets(attrs, fl);
    ...
    public void applyPostLayoutPolicyLw(WindowState win, WindowManager.LayoutParams attrs,
        ...
        final bool affectsSystemUi = win.canAffectSystemUiFlags();
        ...
        bool appWindow = attrs.type >= FIRST_APPLICATION_WINDOW
                && attrs.type < FIRST_SYSTEM_WINDOW;
        final int windowingMode = win.getWindowingMode();
        final bool inFullScreenOrSplitScreenSecondaryWindowingMode =
    ...
    public int finishPostLayoutPolicyLw() {
        ...
        if (mStatusBar != null) {
            ...
            bool shouldBeTransparent = mForceStatusBarTransparent
                    && !mForceStatusBar
            ...
            bool statusBarExpanded = statusBarAttrs.height == MATCH_PARENT
                    && statusBarAttrs.width == MATCH_PARENT;
            bool topAppHidesStatusBar = topAppHidesStatusBar();
     ...
     *         window.
     */
    private bool topAppHidesStatusBar() {
        if (mTopFullscreenOpaqueWindowState == null) {
            return false;
        }
     ...
     */
    private bool setKeyguardOccludedLw(bool isOccluded, bool force) {
        if (DEBUG_KEYGUARD) Slog.d(TAG, "setKeyguardOccluded occluded=" + isOccluded);
        final bool wasOccluded = mKeyguardOccluded;
        final bool showing = mKeyguardDelegate.isShowing();
        final bool changed = wasOccluded != isOccluded || force;
    ...
    private bool isStatusBarKeyguard() {
        return mStatusBar != null
                && (mStatusBar.getAttrs().privateFlags & PRIVATE_FLAG_KEYGUARD) != 0;
    }

    override
    public bool allowAppAnimationsLw() {
    ...
    /** {@inheritDoc} */
    override
    public void notifyLidSwitchChanged(long whenNanos, bool lidOpen) {
        // lid changed state
    ...
    override
    public void notifyCameraLensCoverSwitchChanged(long whenNanos, bool lensCovered) {
        ...
        if (mCameraLensCoverState == CAMERA_LENS_COVERED &&
            ...
            Intent intent;
            final bool keyguardActive = mKeyguardDelegate == null ? false :
                    mKeyguardDelegate.isShowing();
            if (keyguardActive) {
    ...
    void setHdmiPlugged(bool plugged) {
    ...
    public int interceptKeyBeforeQueueing(KeyEvent event, int policyFlags) {
        ...
        final bool interactive = (policyFlags & FLAG_INTERACTIVE) != 0;
        final bool down = event.getAction() == KeyEvent.ACTION_DOWN;
        final bool canceled = event.isCanceled();
        final int keyCode = event.getKeyCode();

        final bool isInjected = (policyFlags & WindowManagerPolicy.FLAG_INJECTED) != 0;
        ...
        int result;
        bool isWakeKey = (policyFlags & WindowManagerPolicy.FLAG_WAKE) != 0
                || event.isWakeKey();
        ...
        final bool isNavBarVirtKey = ((event.getFlags() & KeyEvent.FLAG_VIRTUAL_HARD_KEY) != 0);
        bool useHapticFeedback = down
        ...
        switch (keyCode) {
            case KeyEvent.KEYCODE_BACK: {
                if (down) {
                    ...
                    bool handled = interceptBackKeyUp(event);
            ...
            case KeyEvent.KEYCODE_VOLUME_MUTE: {
                ...
                if (down) {
                    ...
                    bool isInCall = (telecomManager != null && telecomManager.isInCall()) ||
            ...
            case KeyEvent.KEYCODE_ASSIST: {
                final bool longPressed = event.getRepeatCount() > 0;
                if (down && longPressed) {
     ...
     */
    private void sendProposedRotationChangeToStatusBarInternal(int rotation, bool isValid) {
        StatusBarManagerInternal statusBar = getStatusBarManagerInternal();
        if (statusBar != null) {
     ...
     */
    private static bool isValidGlobalKey(int keyCode) {
        switch (keyCode) {
            case KeyEvent.KEYCODE_POWER:
            case KeyEvent.KEYCODE_WAKEUP:
            case KeyEvent.KEYCODE_SLEEP:
     ...
     */
    private bool isWakeKeyWhenScreenOff(int keyCode) {
        switch (keyCode) {
    ...
    private bool shouldDispatchInputWhenNonInteractive(KeyEvent event) {
        final bool displayOff = (mDisplay == null || mDisplay.getState() == STATE_OFF);
    ...
    private void requestTransientBars(WindowState swipeTarget) {
        synchronized (mWindowManagerFuncs.getWindowManagerLock()) {
            ...
            bool sb = mStatusBarController.checkShowTransientBarLw();
            bool nb = mNavigationBarController.checkShowTransientBarLw()
                    && !isNavBarEmpty(mLastSystemUiFlags);
            if (sb || nb) {
    ...
    private bool wakeUp(long wakeTime, bool wakeInTheaterMode, String reason) {
        final bool theaterModeEnabled = isTheaterModeEnabled();
    ...
    private void reportScreenStateToVrManager(bool isScreenOn) {
    ...
    override
    public bool okToAnimate() {
        return mAwake && !mGoingToSleep;
    }

    /** {@inheritDoc} */
    override
    public void enableKeyguard(bool enabled) {
        if (mKeyguardDelegate != null) {
    ...
    override
    public bool isKeyguardShowingAndNotOccluded() {
        if (mKeyguardDelegate == null) return false;
        return mKeyguardDelegate.isShowing() && !mKeyguardOccluded;
    }

    override
    public bool isKeyguardTrustedLw() {
        if (mKeyguardDelegate == null) return false;
    ...
    /** {@inheritDoc} */
    override
    public bool isKeyguardSecure(int userId) {
        if (mKeyguardDelegate == null) return false;
    ...
    /** {@inheritDoc} */
    override
    public bool isKeyguardOccluded() {
        if (mKeyguardDelegate == null) return false;
    ...
    /** {@inheritDoc} */
    override
    public bool inKeyguardRestrictedKeyInputMode() {
        if (mKeyguardDelegate == null) return false;
    ...
    override
    public bool isNavBarForcedShownLw(WindowState windowState) {
        return mForceShowSystemBars;
    }
    ...
    override
    public bool isDockSideAllowed(int dockSide, int originalDockSide, int displayWidth,
    ...
    @VisibleForTesting
    static bool isDockSideAllowed(int dockSide, int originalDockSide,
            int navBarPosition, bool navigationBarCanMove) {
    ...
    override
    public int rotationForOrientationLw(int orientation, int lastRotation, bool defaultDisplay) {
        if (false) {
    ...
    override
    public bool rotationHasCompatibleMetricsLw(int orientation, int rotation) {
        switch (orientation) {
            case ActivityInfo.SCREEN_ORIENTATION_PORTRAIT:
            case ActivityInfo.SCREEN_ORIENTATION_REVERSE_PORTRAIT:
            case ActivityInfo.SCREEN_ORIENTATION_SENSOR_PORTRAIT:
    ...
    public bool isRotationChoicePossible(int orientation) {
    ...
    public bool isValidRotationChoice(int orientation, final int preferredRotation) {
    ...
    private bool isLandscapeOrSeascape(int rotation) {
        return rotation == mLandscapeRotation || rotation == mSeascapeRotation;
    }

    private bool isAnyPortrait(int rotation) {
    ...
    override
    public void setSafeMode(bool safeMode) {
        mSafeMode = safeMode;
        if (safeMode) {
    ...
    override
    public bool canDismissBootAnimation() {
        synchronized (mLock) {
    ...
    /** {@inheritDoc} */
    override
    public void showBootMessage(final CharSequence msg, final bool always) {
        mHandler.post(new Runnable() {
            override public void run() {
                if (mBootMsgDialog == null) {
                    ...
                    mBootMsgDialog = new ProgressDialog(mContext, theme) {
                        ...
                        override public bool dispatchKeyEvent(KeyEvent event) {
                            return true;
                        }
                        override public bool dispatchKeyShortcutEvent(KeyEvent event) {
                            return true;
                        }
                        override public bool dispatchTouchEvent(MotionEvent ev) {
                            return true;
                        }
                        override public bool dispatchTrackballEvent(MotionEvent ev) {
                            return true;
                        }
                        override public bool dispatchGenericMotionEvent(MotionEvent ev) {
                            return true;
                        }
                        override public bool dispatchPopulateAccessibilityEvent(
    ...
    class ScreenLockTimeout : Runnable {
        Bundle options;
    ...
    private void updateLockScreenTimeout() {
        synchronized (mScreenLockTimeout) {
            bool enable = (mAllowLockscreenWhenOn && mAwake &&
    ...
    private void updateDreamingSleepToken(bool acquire) {
        if (acquire) {
    ...
    // TODO (multidisplay): Support multiple displays in WindowManagerPolicy.
    private void updateScreenOffSleepToken(bool acquire) {
        if (acquire) {
    ...
    void updateRotation(bool alwaysSendConfiguration, bool forceRelayout) {
        try {
            //set orientation on WindowManager
    ...
    void startDockOrHome(bool fromHomeKey, bool awakenFromDreams) {
        try {
            ActivityManager.getService().stopAppSwitches();
        } catch (RemoteException e) {}
    ...
    private bool isTheaterModeEnabled() {
        return Settings.Global.getInt(mContext.getContentResolver(),
                Settings.Global.THEATER_MODE_ON, 0) == 1;
    }

    override
    public bool performHapticFeedbackLw(WindowState win, int effectId, bool always) {
        if (!mVibrator.hasVibrator()) {
            return false;
        }
        final bool hapticsDisabled = Settings.System.getIntForUser(mContext.getContentResolver(),
    ...
    private int updateSystemUiVisibilityLw() {
        ...
        final bool needsMenu = win.getNeedsMenuLw(mTopFullscreenOpaqueWindowState);
    ...
    private int updateLightStatusBarLw(int vis, WindowState opaque, WindowState opaqueOrDimming) {
        final bool onKeyguard = isStatusBarKeyguard() && !mKeyguardOccluded;
    ...
    static WindowState chooseNavigationColorWindowLw(WindowState opaque,
        ...
        final bool imeWindowCanNavColorWindow = imeWindow != null
    ...
    private int updateSystemBarsLw(WindowState win, int oldVis, int vis) {
        final bool dockedStackVisible =
                mWindowManagerInternal.isStackVisible(WINDOWING_MODE_SPLIT_SCREEN_PRIMARY);
        final bool freeformStackVisible =
                mWindowManagerInternal.isStackVisible(WINDOWING_MODE_FREEFORM);
        final bool resizing = mWindowManagerInternal.isDockedDividerResizing();

        // We need to force system bars when the docked stack is visible, when the freeform stack
        // is visible but also when we are resizing for the transitions when docked stack
        // visibility changes.
        mForceShowSystemBars = dockedStackVisible || freeformStackVisible || resizing;
        final bool forceOpaqueStatusBar = mForceShowSystemBars && !mForceStatusBarFromKeyguard;
        ...
        // update status bar
        bool immersiveSticky =
                (vis & View.SYSTEM_UI_FLAG_IMMERSIVE_STICKY) != 0;
        final bool hideStatusBarWM =
                mTopFullscreenOpaqueWindowState != null
                && (PolicyControl.getWindowFlags(mTopFullscreenOpaqueWindowState, null)
                        & WindowManager.LayoutParams.FLAG_FULLSCREEN) != 0;
        final bool hideStatusBarSysui =
                (vis & View.SYSTEM_UI_FLAG_FULLSCREEN) != 0;
        final bool hideNavBarSysui =
                (vis & View.SYSTEM_UI_FLAG_HIDE_NAVIGATION) != 0;

        final bool transientStatusBarAllowed = mStatusBar != null
                && (statusBarHasFocus || (!mForceShowSystemBars
                        && (hideStatusBarWM || (hideStatusBarSysui && immersiveSticky))));

        final bool transientNavBarAllowed = mNavigationBar != null
                && !mForceShowSystemBars && hideNavBarSysui && immersiveSticky;

        final long now = SystemClock.uptimeMillis();
        final bool pendingPanic = mPendingPanicGestureUptime != 0
        ...
        final bool denyTransientStatus = mStatusBarController.isTransientShowRequested()
                && !transientStatusBarAllowed && hideStatusBarSysui;
        final bool denyTransientNav = mNavigationBarController.isTransientShowRequested()
        ...
        final bool immersive = (vis & View.SYSTEM_UI_FLAG_IMMERSIVE) != 0;
        immersiveSticky = (vis & View.SYSTEM_UI_FLAG_IMMERSIVE_STICKY) != 0;
        final bool navAllowedHidden = immersive || immersiveSticky;
        ...
        bool oldImmersiveMode = isImmersiveMode(oldVis);
        bool newImmersiveMode = isImmersiveMode(vis);
    ...
    private bool drawsStatusBarBackground(int vis, WindowState win) {
        ...
        final bool drawsSystemBars =
                (win.getAttrs().flags & FLAG_DRAWS_SYSTEM_BAR_BACKGROUNDS) != 0;
        final bool forceDrawsSystemBars =
     ...
     */
    private int configureNavBarOpacity(int visibility, bool dockedStackVisible,
            bool freeformStackVisible, bool isDockedDividerResizing) {
    ...
    private bool isImmersiveMode(int vis) {
    ...
    private static bool isNavBarEmpty(int systemUiFlags) {
     ...
     * R.bool.config_enableTranslucentDecor is false.
     */
    private bool areTranslucentBarsAllowed() {
    ...
    override
    public void setDismissImeOnBackKeyPressed(bool newValue) {
    ...
    override
    public bool isTopLevelWindow(int windowType) {
    ...
    override
    public bool shouldRotateSeamlessly(int oldRotation, int newRotation) {
    ...
    override
    public bool setAodShowing(bool aodShowing) {
