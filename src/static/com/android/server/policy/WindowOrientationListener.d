...
public abstract class WindowOrientationListener {
    ...
    private static final bool LOG = SystemProperties.getBoolean(
            "debug.orientation.log", false);

    private static final bool USE_GRAVITY_SENSOR = false;
     ...
     *                             part of the reset.
     */
    public void enable(bool clearCurrentRotation) {
        synchronized (mLock) {
            if (mSensor == null) {
    ...
    abstract class OrientationJudge : SensorEventListener {
         ...
         */
        public abstract void resetLocked(bool clearCurrentRotation);
     ...
     */
    final class AccelSensorJudge : OrientationJudge {
        ...
        override
        public void resetLocked(bool clearCurrentRotation) {
         ...
         */
        private bool isTiltAngleAcceptableLocked(int rotation, int tiltAngle) {
         ...
         * for hysteresis.
         */
        private bool isOrientationAngleAcceptableLocked(int rotation, int orientationAngle) {
         ...
         * proposed rotation.
         */
        private bool isPredictedRotationAcceptableLocked(long now) {
        ...
        private bool isAcceleratingLocked(float magnitude) {
        ...
        private bool isFlatLocked(long now) {
        ...
        private bool isSwingingLocked(long now, float tilt) {
            for (int i = mTiltHistoryIndex; (i = nextTiltHistoryIndexLocked(i)) >= 0; ) {
    ...
    final class OrientationSensorJudge : OrientationJudge {
        private bool mTouching;
        private long mTouchEndedTimestampNanos = Long.MIN_VALUE;
        private int mProposedRotation = -1;
        private int mDesiredRotation = -1;
        private bool mRotationEvaluationScheduled;
        ...
        private bool isDesiredRotationAcceptableLocked(long now) {
            if (mTouching) {
                return false;
            }
