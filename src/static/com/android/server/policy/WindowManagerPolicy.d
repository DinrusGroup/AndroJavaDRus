 ...
 * </dl>
 */
public interface WindowManagerPolicy : WindowManagerPolicyConstants {
    @Retention(SOURCE)
     ...
     */
    void onKeyguardOccludedChangedLw(bool occluded);
    ...
    public interface WindowState {
         ...
         */
        public bool getNeedsMenuLw(WindowState bottom);
         ...
         */
        bool canAffectSystemUiFlags();

        /**
         * Is this window considered to be gone for purposes of layout?
         */
        bool isGoneForLayoutLw();
         ...
         */
        default bool isLetterboxedForDisplayCutoutLw() {
            return false;
        }
         ...
         * the given {@code rect}.
         */
        default bool isLetterboxedOverlappingWith(Rect rect) {
            return false;
        }
         ...
         */
        default bool canAddInternalSystemWindow() {
            return false;
        }
     ...
     * @return int An arbitrary integer used to order windows, with lower numbers below higher ones.
     */
    default int getWindowLayerFromTypeLw(int type, bool canAddInternalSystemWindow) {
     ...
     */
    default bool getLayoutHintLw(WindowManager.LayoutParams attrs, Rect taskBounds,
    ...
    public int rotationForOrientationLw(@ActivityInfo.ScreenOrientation int orientation,
            int lastRotation, bool defaultDisplay);
     ...
     */
    public bool rotationHasCompatibleMetricsLw(@ActivityInfo.ScreenOrientation int orientation,
            int rotation);
     ...
     */
    void setPipVisibilityLw(bool visible);

    /**
     * Called by System UI to enable or disable haptic feedback on the navigation bar buttons.
     */
    void setNavBarVirtualKeyHapticFeedbackEnabledLw(bool enabled);
     ...
     * @hide
     */
    default void setDismissImeOnBackKeyPressed(bool newValue) {
     ...
     */
    void setSwitchingUser(bool switching);
     ...
     */
    public bool isNavBarForcedShownLw(WindowState win);
     ...
     */
    bool setAodShowing(bool aodShowing);
}
