 ...
 */
class SipSessionGroup : SipListener {
    private static final String TAG = "SipSession";
    private static final bool DBG = false;
    private static final bool DBG_PING = false;
    ...
    public synchronized bool isClosed() {
    ...
    synchronized bool containsSession(String callId) {
    ...
    private synchronized void process(EventObject event) {
        ...
        try {
            bool isLoggable = isLoggable(session, event);
            bool processed = (session != null) && session.process(event);
    ...
    private class SipSessionCallReceiverImpl : SipSessionImpl {
        private static final String SSCRI_TAG = "SipSessionCallReceiverImpl";
        private static final bool SSCRI_DBG = true;
        ...
        override
        public bool process(EventObject evt) throws SipException {
    ...
    static interface KeepAliveProcessCallback {
        ...
        void onResponse(bool portChanged);
        void onError(int errorCode, String description);
    }

    class SipSessionImpl : ISipSession.Stub {
        private static final String SSI_TAG = "SipSessionImpl";
        private static final bool SSI_DBG = true;
        ...
        private bool processExceptions(EventObject evt) throws SipException {
        ...
        private bool isCurrentTransaction(TransactionTerminatedEvent event) {
        ...
        private bool registeringToReady(EventObject evt)
                throws SipException {
        ...
        private bool handleAuthentication(ResponseEvent event)
                throws SipException {
            Response response = event.getResponse();
        ...
        private bool crossDomainAuthenticationRequired(Response response) {
        ...
        private bool readyForCall(EventObject evt) throws SipException {
        ...
        private bool incomingCall(EventObject evt) throws SipException {
        ...
        private bool incomingCallToInCall(EventObject evt) {
        ...
        private bool outgoingCall(EventObject evt) throws SipException {
        ...
        private bool outgoingCallToReady(EventObject evt)
                throws SipException {
        ...
        private bool processReferRequest(RequestEvent event)
                throws SipException {
            try {
        ...
        private bool inCall(EventObject evt) throws SipException {
        ...
        private bool endingCall(EventObject evt) throws SipException {
        ...
        private void establishCall(bool enableKeepAlive) {
        ...
        class SipKeepAlive : SipSessionAdapter : Runnable {
            private static final String SKA_TAG = "SipKeepAlive";
            private static final bool SKA_DBG = true;

            private bool mRunning = false;
            private KeepAliveProcessCallback mCallback;

            private bool mPortChanged = false;
            ...
            private bool parseOptionsResult(EventObject evt) {
     ...
     */
    private static bool isRequestEvent(String method, EventObject event) {
        try {
    ...
    private static bool isLoggable(SipSessionImpl s) {
        if (s != null) {
            switch (s.mState) {
    ...
    private static bool isLoggable(EventObject evt) {
        return isLoggable(null, evt);
    }

    private static bool isLoggable(SipSessionImpl s, EventObject evt) {
    ...
    private class RegisterCommand : EventObject {
    ...
    private class MakeCallCommand : EventObject {
    ...
    static class KeepAliveProcessCallbackProxy : KeepAliveProcessCallback {
        ...
        override
        public void onResponse(final bool portChanged) {
