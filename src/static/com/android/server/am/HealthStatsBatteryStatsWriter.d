...
public class HealthStatsBatteryStatsWriter {
    ...
    public void writeUid(HealthStatsWriter uidWriter, BatteryStats bs, BatteryStats.Uid uid) {
        ...
        SparseArray<? : BatteryStats.Uid.Sensor> sensors;
        SparseArray<? : BatteryStats.Uid.Pid> pids;
        ...
        for (final Map.Entry<String,? : BatteryStats.Uid.Wakelock> entry:
        ...
        // TIMERS_SYNCS
        for (final Map.Entry<String,? : BatteryStats.Timer> entry:
        ...
        // STATS_PROCESSES
        for (final Map.Entry<String,? : BatteryStats.Uid.Proc> entry:
        ...
        // STATS_PACKAGES
        for (final Map.Entry<String,? : BatteryStats.Uid.Pkg> entry:
    ...
    public void writePkg(HealthStatsWriter pkgWriter, BatteryStats.Uid.Pkg pkg) {
        // STATS_SERVICES
        for (final Map.Entry<String,? : BatteryStats.Uid.Pkg.Serv> entry:
        ...
        for (final Map.Entry<String,? : BatteryStats.Counter> entry:
