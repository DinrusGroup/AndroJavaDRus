...
final class ContentProviderRecord : ComponentName.WithComponentName {
    ...
    public ContentProviderRecord(ActivityManagerService _service, ProviderInfo _info,
            ApplicationInfo ai, ComponentName _name, bool _singleton) {
        service = _service;
        info = _info;
        uid = ai.uid;
        appInfo = ai;
    ...
    public bool canRunHere(ProcessRecord app) {
    ...
    public bool removeExternalProcessHandleLocked(IBinder token) {
    ...
    private class ExternalProcessHandle : DeathRecipient {
