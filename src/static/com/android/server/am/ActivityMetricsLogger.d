...
class ActivityMetricsLogger {
    ...
    private bool mLoggedTransitionStarting;
    ...
    private final class WindowingModeTransitionInfo {
        ...
        private bool currentTransitionProcessRunning;
        ...
        private bool loggedWindowsDrawn;
        private bool loggedStartingWindowDrawn;
    }
    ...
    void notifyActivityLaunched(int resultCode, ActivityRecord launchedActivity) {
        ...
        final bool processRunning = processRecord != null;

        // We consider this a "process switch" if the process of the activity that gets launched
        // didn't have an activity that was in started state. In this case, we assume that lot
        // of caches might be purged so the time until it produces the first frame is very
        // interesting.
        final bool processSwitch = processRecord == null
    ...
    private bool hasStartedActivity(ProcessRecord record, ActivityRecord launchedActivity) {
    ...
    private void notifyActivityLaunched(int resultCode, ActivityRecord launchedActivity,
            bool processRunning, bool processSwitch) {
        ...
        final bool otherWindowModesLaunching =
     ...
     */
    private bool isLoggableResultCode(int resultCode) {
    ...
    private void logAppTransition(int currentTransitionDeviceUptime, int currentTransitionDelayMs,
        ...
        final bool isInstantApp = info.applicationInfo.isInstantApp();
    ...
    void logAppTransitionReportedDrawn(ActivityRecord r, bool restoredFromBundle) {
