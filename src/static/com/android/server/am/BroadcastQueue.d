...
public final class BroadcastQueue {
     ...
     * receiver's process.
     */
    final bool mDelayBehindServices;
     ...
     */
    bool mBroadcastsScheduled = false;

    /**
     * True if we have a pending unexpired BROADCAST_TIMEOUT_MSG posted to our handler.
     */
    bool mPendingBroadcastTimeoutMessage;
    ...
    private final class BroadcastHandler : Handler {
    ...
    private final class AppNotResponding : Runnable {
    ...
    BroadcastQueue(ActivityManagerService service, Handler handler,
            String name, long timeoutPeriod, bool allowDelayBehindServices) {
        mService = service;
    ...
    public bool isPendingBroadcastProcessLocked(int pid) {
    ...
    private final void processCurBroadcastLocked(BroadcastRecord r,
            ProcessRecord app, bool skipOomAdj) throws RemoteException {
    ...
    public bool sendPendingBroadcastsLocked(ProcessRecord app) {
    ...
    public bool finishReceiverLocked(BroadcastRecord r, int resultCode,
            String resultData, Bundle resultExtras, bool resultAbort, bool waitForServices) {
    ...
    void performReceiveLocked(ProcessRecord app, IIntentReceiver receiver,
            ...
            bool ordered, bool sticky, int sendingUser) throws RemoteException {
    ...
    private void deliverToRegisteredReceiverLocked(BroadcastRecord r,
            BroadcastFilter filter, bool ordered, int index) {
        bool skip = false;
        ...
        final bool visibleToInstantApps =
    ...
    private bool requestStartTargetPermissionsReviewIfNeededLocked(
        ...
        final bool callerForeground = receiverRecord.callerApp != null
     ...
     */
    final bool isSignaturePerm(String[] perms) {
        if (perms == null) {
            return false;
        }
    ...
    final void processNextBroadcast(bool fromMsg) {
        synchronized (mService) {
            processNextBroadcastLocked(fromMsg, false);
        }
    }

    final void processNextBroadcastLocked(bool fromMsg, bool skipOomAdj) {
        BroadcastRecord r;
    ...
    final void broadcastTimeoutLocked(bool fromMsg) {
        if (fromMsg) {
            mPendingBroadcastTimeoutMessage = false;
        }
        ...
        final bool debugging = (r.curApp != null && r.curApp.debugging);
    ...
    bool cleanupDisabledPackageReceiversLocked(
            String packageName, Set<String> filterByClasses, int userId, bool doit) {
        bool didSomething = false;
    ...
    final bool dumpLocked(FileDescriptor fd, PrintWriter pw, String[] args,
            int opti, bool dumpAll, String dumpPackage, bool needSep) {
