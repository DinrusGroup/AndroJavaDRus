...
public final class ProcessList {
    ...
    private void updateOomLevels(int displayWidth, int displayHeight, bool write) {
        ...
        final bool is64bit = Build.SUPPORTED_64_BIT_ABIS.length > 0;
    ...
    public static bool procStatesDifferForMem(int procState1, int procState2) {
        return sProcStateToProcMem[procState1] != sProcStateToProcMem[procState2];
    }

    public static long minTimeFromStateChange(bool test) {
    ...
    public static long computeNextPssTime(int procState, ProcStateMemTracker tracker, bool test,
            bool sleeping, long now) {
        bool first;
        float scalingFactor;
    ...
    private static bool openLmkdSocket() {
        try {
