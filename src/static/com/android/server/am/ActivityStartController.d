...
public class ActivityStartController {
    ...
    private final class StartHandler : Handler {
     ...
     */
    int checkTargetUser(int targetUserId, bool validateIncomingUser,
    ...
    final int startActivityInPackage(int uid, int realCallingPid, int realCallingUid,
            ...
            int userId, TaskRecord inTask, String reason, bool validateIncomingUser) {
        ...
        try {
            synchronized (mService) {
                ...
                for (int i=0; i < intents.length; i++) {
                    ...
                    final bool top = i == intents.length - 1;
    ...
    void doPendingActivityLaunches(bool doResume) {
        while (!mPendingActivityLaunches.isEmpty()) {
            final PendingActivityLaunch pal = mPendingActivityLaunches.remove(0);
            final bool resume = doResume && mPendingActivityLaunches.isEmpty();
    ...
    bool clearPendingActivityLaunches(String packageName) {
    ...
    void dump(PrintWriter pw, String prefix, String dumpPackage) {
        ...
        final bool dumpPackagePresent = dumpPackage != null;

        if (mLastStarter != null) {
            final bool dump = !dumpPackagePresent
