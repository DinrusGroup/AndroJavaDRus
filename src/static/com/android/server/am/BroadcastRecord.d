 ...
 */
final class BroadcastRecord : Binder {
    ...
    final bool callerInstantApp; // caller is an Instant App?
    final bool ordered;  // serialize the send to receivers?
    final bool sticky;   // originated from existing sticky data?
    final bool initialSticky; // initial broadcast from register to sticky?
    ...
    bool resultAbort;    // current result abortBroadcast value.
    ...
    BroadcastRecord(BroadcastQueue _queue,
            ...
            int _callingPid, int _callingUid, bool _callerInstantApp, String _resolvedType,
            ...
            bool _serialized, bool _sticky, bool _initialSticky, int _userId) {
        if (_intent == null) {
