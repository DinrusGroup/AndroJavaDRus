...
class ActivityManagerDebugConfig {
    ...
    static final bool APPEND_CATEGORY_NAME = false;

    // Default log tag for the activity manager package.
    static final String TAG_AM = "ActivityManager";

    // Enable all debug log categories.
    static final bool DEBUG_ALL = false;

    // Enable all debug log categories for activities.
    static final bool DEBUG_ALL_ACTIVITIES = DEBUG_ALL || false;

    // Available log categories in the activity manager package.
    static final bool DEBUG_ADD_REMOVE = DEBUG_ALL_ACTIVITIES || false;
    static final bool DEBUG_ANR = false;
    static final bool DEBUG_APP = DEBUG_ALL_ACTIVITIES || false;
    static final bool DEBUG_BACKGROUND_CHECK = DEBUG_ALL || false;
    static final bool DEBUG_BACKUP = DEBUG_ALL || false;
    static final bool DEBUG_BROADCAST = DEBUG_ALL || false;
    static final bool DEBUG_BROADCAST_BACKGROUND = DEBUG_BROADCAST || false;
    static final bool DEBUG_BROADCAST_LIGHT = DEBUG_BROADCAST || false;
    static final bool DEBUG_CLEANUP = DEBUG_ALL || false;
    static final bool DEBUG_CONFIGURATION = DEBUG_ALL || false;
    static final bool DEBUG_CONTAINERS = DEBUG_ALL_ACTIVITIES || false;
    static final bool DEBUG_FOCUS = false;
    static final bool DEBUG_IDLE = DEBUG_ALL_ACTIVITIES || false;
    static final bool DEBUG_IMMERSIVE = DEBUG_ALL || false;
    static final bool DEBUG_LOCKTASK = DEBUG_ALL || false;
    static final bool DEBUG_LRU = DEBUG_ALL || false;
    static final bool DEBUG_MU = DEBUG_ALL || false;
    static final bool DEBUG_NETWORK = DEBUG_ALL || false;
    static final bool DEBUG_OOM_ADJ = DEBUG_ALL || false;
    static final bool DEBUG_OOM_ADJ_REASON = DEBUG_ALL || false;
    static final bool DEBUG_PAUSE = DEBUG_ALL || false;
    static final bool DEBUG_POWER = DEBUG_ALL || false;
    static final bool DEBUG_POWER_QUICK = DEBUG_POWER || false;
    static final bool DEBUG_PROCESS_OBSERVERS = DEBUG_ALL || false;
    static final bool DEBUG_PROCESSES = DEBUG_ALL || false;
    static final bool DEBUG_PROVIDER = DEBUG_ALL || false;
    static final bool DEBUG_PSS = DEBUG_ALL || false;
    static final bool DEBUG_RECENTS = DEBUG_ALL || false;
    static final bool DEBUG_RECENTS_TRIM_TASKS = DEBUG_RECENTS || false;
    static final bool DEBUG_RELEASE = DEBUG_ALL_ACTIVITIES || false;
    static final bool DEBUG_RESULTS = DEBUG_ALL || false;
    static final bool DEBUG_SAVED_STATE = DEBUG_ALL_ACTIVITIES || false;
    static final bool DEBUG_SERVICE = DEBUG_ALL || false;
    static final bool DEBUG_FOREGROUND_SERVICE = DEBUG_ALL || false;
    static final bool DEBUG_SERVICE_EXECUTING = DEBUG_ALL || false;
    static final bool DEBUG_STACK = DEBUG_ALL || false;
    static final bool DEBUG_STATES = DEBUG_ALL_ACTIVITIES || false;
    static final bool DEBUG_SWITCH = DEBUG_ALL || false;
    static final bool DEBUG_TASKS = DEBUG_ALL || false;
    static final bool DEBUG_TRANSITION = DEBUG_ALL || false;
    static final bool DEBUG_UID_OBSERVERS = DEBUG_ALL || false;
    static final bool DEBUG_URI_PERMISSION = DEBUG_ALL || false;
    static final bool DEBUG_USER_LEAVING = DEBUG_ALL || false;
    static final bool DEBUG_VISIBILITY = DEBUG_ALL || false;
    static final bool DEBUG_USAGE_STATS = DEBUG_ALL || false;
    static final bool DEBUG_PERMISSIONS_REVIEW = DEBUG_ALL || false;
    static final bool DEBUG_WHITELISTS = DEBUG_ALL || false;
    static final bool DEBUG_METRICS = DEBUG_ALL || false;
