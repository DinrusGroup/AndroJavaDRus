...
public final class ActiveServices {
    ...
    private static final bool DEBUG_DELAYED_SERVICE = DEBUG_SERVICE;
    private static final bool DEBUG_DELAYED_STARTS = DEBUG_DELAYED_SERVICE;

    private static final bool LOG_SERVICE_START_STOP = false;

    private static final bool SHOW_DUNGEON_NOTIFICATION = false;
     ...
     * services down.
     */
    class ForcedStandbyListener : AppStateTracker.Listener {
        override
     ...
     */
    final class ServiceMap : Handler {
        final int mUserId;
        ...
        */
        ...
        bool mActiveForegroundAppsChanged;
    ...
    bool hasBackgroundServicesLocked(int callingUser) {
    ...
    private bool appRestrictedAnyInBackground(final int uid, final String packageName) {
    ...
    ComponentName startServiceLocked(IApplicationThread caller, Intent service, String resolvedType,
            int callingPid, int callingUid, bool fgRequired, String callingPackage, final int userId)
        ...
        final bool bgLaunch = !mAm.isUidActiveLocked(r.appInfo.uid);
    ...
    private bool requestStartTargetPermissionsReviewIfNeededLocked(ServiceRecord r,
            String callingPackage, int callingUid, Intent service, bool callerFg,
            final int userId) {
    ...
    ComponentName startServiceInnerLocked(ServiceMap smap, Intent service, ServiceRecord r,
            bool callerFg, bool addToStarting) throws TransactionTooLargeException {
        ...
        if (r.startRequested && addToStarting) {
            bool first = smap.mStartingBackground.size() == 0;
    ...
    bool stopServiceTokenLocked(ComponentName className, IBinder token,
            int startId) {
    ...
    bool foregroundAppShownEnoughLocked(ActiveForegroundApp aa, long nowElapsed) {
        ...
        synchronized (mAm) {
            ...
            if (smap != null) {
                ...
                for (int i = smap.mActiveForegroundApps.size()-1; i >= 0; i--) {
                    ...
                    if (aa.mEndTime != 0) {
                        bool canRemove = foregroundAppShownEnoughLocked(aa, now);
                        if (canRemove) {
    ...
    void updateScreenStateLocked(bool screenOn) {
    ...
    private void updateServiceForegroundLocked(ProcessRecord proc, bool oomAdj) {
    ...
    private bool updateServiceClientActivitiesLocked(ProcessRecord proc,
            ConnectionRecord modCr, bool updateLru) {
        ...
        bool anyClientActivities = false;
    ...
    int bindServiceLocked(IApplicationThread caller, IBinder token, Intent service,
        ...
        final bool isCallerSystem = callerApp.info.uid == Process.SYSTEM_UID;
        ...
        final bool callerFg = callerApp.setSchedGroup != ProcessList.SCHED_GROUP_BACKGROUND;
        final bool isBindExternal = (flags & Context.BIND_EXTERNAL_SERVICE) != 0;
        final bool allowInstant = (flags & Context.BIND_ALLOW_INSTANT) != 0;
        ...
        bool permissionsReviewRequired = false;
    ...
    bool unbindServiceLocked(IServiceConnection connection) {
        IBinder binder = connection.asBinder();
    ...
    void unbindFinishedLocked(ServiceRecord r, Intent intent, bool doRebind) {
        final long origId = Binder.clearCallingIdentity();
        try {
            if (r != null) {
                Intent.FilterComparison filter
                ...
                bool inDestroying = mDestroyingServices.contains(r);
                if (b != null) {
    ...
    private class ServiceRestarter : Runnable {
    ...
    private ServiceLookupResult retrieveServiceLocked(Intent service,
            ...
            bool createIfNeeded, bool callingFromFg, bool isBindExternal,
            bool allowInstant) {
    ...
    private final void bumpServiceExecutingLocked(ServiceRecord r, bool fg, String why) {
    ...
    private final bool requestServiceBindingLocked(ServiceRecord r, IntentBindRecord i,
            bool execInFg, bool rebind) throws TransactionTooLargeException {
        ...
        if ((!i.requested || rebind) && i.apps.size() > 0) {
            try {
                ...
                final bool inDestroying = mDestroyingServices.contains(r);
    ...
    private final bool scheduleServiceRestartLocked(ServiceRecord r, bool allowCancel) {
        bool canceled = false;
    ...
    private final bool unscheduleServiceRestartLocked(ServiceRecord r, int callingUid,
            bool force) {
        ...
        bool removed = mRestartingServices.remove(r);
    ...
    private String bringUpServiceLocked(ServiceRecord r, int intentFlags, bool execInFg,
            bool whileRestarting, bool permissionsReviewRequired)
            throws TransactionTooLargeException {
        ...
        final bool isolated = (r.serviceInfo.flags&ServiceInfo.FLAG_ISOLATED_PROCESS) != 0;
    ...
    private final void requestServiceBindingsLocked(ServiceRecord r, bool execInFg)
            throws TransactionTooLargeException {
    ...
    private final void realStartServiceLocked(ServiceRecord r,
            ProcessRecord app, bool execInFg) throws RemoteException {
        if (app.thread == null) {
        ...
        final bool newService = app.services.add(r);
    ...
    private final void sendServiceArgsLocked(ServiceRecord r, bool execInFg,
            bool oomAdjusted) throws TransactionTooLargeException {
    ...
    private final bool isServiceNeededLocked(ServiceRecord r, bool knowConn,
            bool hasConn) {
    ...
    private final void bringDownServiceIfNeededLocked(ServiceRecord r, bool knowConn,
            bool hasConn) {
    ...
    void removeConnectionLocked(
        ...
        if (!c.serviceDead) {
            ...
            if ((c.flags&Context.BIND_AUTO_CREATE) != 0) {
                bool hasAutoCreate = s.hasAutoCreateConnections();
                if (!hasAutoCreate) {
                    if (s.tracker != null) {
    ...
    private void serviceDoneExecutingLocked(ServiceRecord r, bool inDestroying,
            bool finishing) {
    ...
    bool attachApplicationLocked(ProcessRecord proc, String processName)
    ...
    private bool collectPackageServicesLocked(String packageName, Set<String> filterByClasses,
            bool evenPersistent, bool doit, bool killProcess,
            ArrayMap<ComponentName, ServiceRecord> services) {
        bool didSomething = false;
        for (int i = services.size() - 1; i >= 0; i--) {
            ServiceRecord service = services.valueAt(i);
            final bool sameComponent = packageName == null
    ...
    bool bringDownDisabledPackageServicesLocked(String packageName, Set<String> filterByClasses,
            int userId, bool evenPersistent, bool killProcess, bool doit) {
        bool didSomething = false;
    ...
    final void killServicesLocked(ProcessRecord app, bool allowRestart) {
        ...
        for (int i=app.services.size()-1; i>=0; i--) {
            ...
            if (allowRestart && sr.crashCount >= mAm.mConstants.BOUND_SERVICE_MAX_CRASH_RETRY
                ...
                bool canceled = scheduleServiceRestartLocked(sr, true);
    ...
    List<ActivityManager.RunningServiceInfo> getRunningServiceInfoLocked(int maxNum, int flags,
        int callingUid, bool allowed, bool canInteractAcrossUsers) {
    ...
    final class ServiceDumper {
        ...
        ServiceDumper(FileDescriptor fd, PrintWriter pw, String[] args,
                int opti, bool dumpAll, String dumpPackage) {
            this.fd = fd;
            this.pw = pw;
            this.args = args;
     ...
     */
    protected bool dumpService(FileDescriptor fd, PrintWriter pw, final String name,
            String[] args, int opti, bool dumpAll) {
    ...
    private void dumpService(String prefix, FileDescriptor fd, PrintWriter pw,
            final ServiceRecord r, String[] args, bool dumpAll) {
