...
class KeyguardController {
    ...
    private bool mDismissalRequested;
     ...
     */
    bool isKeyguardOrAodShowing(int displayId) {
     ...
     */
    bool isKeyguardShowing(int displayId) {
     ...
     */
    void setKeyguardShown(bool keyguardShowing, bool aodShowing,
            int secondaryDisplayShowing) {
        bool showingChanged = keyguardShowing != mKeyguardShowing || aodShowing != mAodShowing;
    ...
    private void setKeyguardGoingAway(bool keyguardGoingAway) {
     ...
     */
    bool canShowActivityWhileKeyguardShowing(ActivityRecord r, bool dismissKeyguard) {
     ...
     */
    bool canShowWhileOccluded(bool dismissKeyguard, bool showWhenLocked) {
        return showWhenLocked || dismissKeyguard && !mWindowManager.isKeyguardSecure();
    }

    private void visibilitiesUpdated() {
        final bool lastOccluded = mOccluded;
