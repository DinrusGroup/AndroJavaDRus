 ...
 */
class PinnedActivityStack : ActivityStack<PinnedStackWindowController>
        : PinnedStackWindowListener {
    ...
    override
    PinnedStackWindowController createStackWindowController(int displayId, bool onTop,
            Rect outBounds) {
    ...
    private bool skipResizeAnimation(bool toFullscreen) {
        if (!toFullscreen) {
            return false;
        }
    ...
    bool isAnimatingBoundsToFullscreen() {
