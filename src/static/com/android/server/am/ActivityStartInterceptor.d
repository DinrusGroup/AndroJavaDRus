...
class ActivityStartInterceptor {
     ...
     */
    bool intercept(Intent intent, ResolveInfo rInfo, ActivityInfo aInfo, String resolvedType,
    ...
    private bool interceptQuietProfileIfNeeded() {
    ...
    private bool interceptSuspendedByAdminPackage() {
    ...
    private bool interceptSuspendedPackageIfNeeded() {
    ...
    private bool interceptWorkProfileChallengeIfNeeded() {
    ...
    private bool interceptHarmfulAppIfNeeded() {
