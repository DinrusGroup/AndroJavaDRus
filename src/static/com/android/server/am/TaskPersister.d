...
public class TaskPersister {
    ...
    private static class TaskWriteQueueItem : WriteQueueItem {
    ...
    private static class ImageWriteQueueItem : WriteQueueItem {
    ...
    void wakeup(TaskRecord task, bool flush) {
        synchronized (this) {
            if (task != null) {
                int queueNdx;
    ...
    private static bool createParentDirectory(String filePath) {
        File parentDir = new File(filePath).getParentFile();
        return parentDir.exists() || parentDir.mkdirs();
    }

    private class LazyTaskWriterThread : Thread {
