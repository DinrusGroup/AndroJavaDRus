...
class AppWarnings {
    ...
    public void showUnsupportedCompileSdkDialogIfNeeded(ActivityRecord r) {
        ...
        final bool isCompileSdkPreview = !"REL".equals(r.appInfo.compileSdkVersionCodename);
        final bool isPlatformSdkPreview = !"REL".equals(Build.VERSION.CODENAME);
     ...
     */
    bool hasPackageFlag(String name, int flag) {
     ...
     */
    void setPackageFlag(String name, int flag, bool enabled) {
        synchronized (mPackageFlags) {
     ...
     */
    private final class UiHandler : Handler {
     ...
     */
    private final class ConfigHandler : Handler {
