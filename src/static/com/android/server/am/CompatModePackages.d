...
public final class CompatModePackages {
    ...
    private final class CompatHandler : Handler {
    ...
    public void handlePackageAddedLocked(String packageName, bool updated) {
        ...
        final bool mayCompat = !ci.alwaysSupportsScreen()
    ...
    public int computeCompatModeLocked(ApplicationInfo ai) {
        final bool enabled = (getPackageFlags(ai.packageName)&COMPAT_FLAG_ENABLED) != 0;
        final Configuration globalConfig = mService.getGlobalConfiguration();
    ...
    public bool getFrontActivityAskCompatModeLocked() {
    ...
    public bool getPackageAskCompatModeLocked(String packageName) {
        return (getPackageFlags(packageName)&COMPAT_FLAG_DONT_ASK) == 0;
    }

    public void setFrontActivityAskCompatModeLocked(bool ask) {
        ActivityRecord r = mService.getFocusedStack().topRunningActivityLocked();
        if (r != null) {
    ...
    public void setPackageAskCompatModeLocked(String packageName, bool ask) {
        setPackageFlagLocked(packageName, COMPAT_FLAG_DONT_ASK, ask);
    }

    private void setPackageFlagLocked(String packageName, int flag, bool set) {
