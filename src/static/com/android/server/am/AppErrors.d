...
class AppErrors {
    ...
    bool dumpLocked(FileDescriptor fd, PrintWriter pw, bool needSep, String dumpPackage) {
        if (!mProcessCrashTimes.getMap().isEmpty()) {
            bool printed = false;
            final long now = SystemClock.uptimeMillis();
            final ArrayMap<String, SparseArray<Long>> pmap = mProcessCrashTimes.getMap();
    ...
    bool isBadProcessLocked(ApplicationInfo info) {
    ...
    void resetProcessCrashTimeLocked(bool resetEntireUser, int appId, int userId) {
        final ArrayMap<String, SparseArray<Long>> pmap = mProcessCrashTimes.getMap();
    ...
    private bool handleAppCrashInActivityController(ProcessRecord r,
    ...
    private bool makeAppCrashingLocked(ProcessRecord app,
    ...
    bool handleAppCrashLocked(ProcessRecord app, String reason,
            String shortMsg, String longMsg, String stackTrace, AppErrorDialog.Data data) {
        final long now = SystemClock.uptimeMillis();
        final bool showBackground = Settings.Secure.getInt(mContext.getContentResolver(),
                Settings.Secure.ANR_SHOW_BACKGROUND, 0) != 0;

        final bool procIsBoundForeground =
    ...
    void handleShowAppErrorUi(Message msg) {
        ...
        bool showBackground = Settings.Secure.getInt(mContext.getContentResolver(),
                Settings.Secure.ANR_SHOW_BACKGROUND, 0) != 0;
        ...
        synchronized (mService) {
            ...
            bool isBackground = (UserHandle.getAppId(proc.uid)
            ...
            final bool showFirstCrash = Settings.Global.getInt(
                    mContext.getContentResolver(),
                    Settings.Global.SHOW_FIRST_CRASH_DIALOG, 0) != 0;
            final bool showFirstCrashDevOption = Settings.Secure.getIntForUser(
                    mContext.getContentResolver(),
                    Settings.Secure.SHOW_FIRST_CRASH_DIALOG_DEV_OPTION,
                    0,
                    mService.mUserController.getCurrentUserId()) != 0;
            final bool crashSilenced = mAppsNotReportingCrashes != null &&
    ...
    static bool isInterestingForBackgroundTraces(ProcessRecord app) {
    ...
    final void appNotResponding(ProcessRecord app, ActivityRecord activity,
            ActivityRecord parent, bool aboveSystem, final String annotation) {
