...
class ActivityStarter {
     ...
     */
    static class DefaultFactory : Factory {
        /**
    ...
    private static class Request {
        ...
        bool ignoreTargetSecurity;
        bool componentSpecified;
        bool avoidMoveToFront;
         ...
         */
        bool allowPendingRemoteAnimationRegistryLookup;
    ...
    bool relatedToPackage(String packageName) {
    ...
    int startResolvedActivity(final ActivityRecord r, ActivityRecord sourceRecord,
            ...
            int startFlags, bool doResume, ActivityOptions options, TaskRecord inTask,
            ActivityRecord[] outActivity) {
        try {
    ...
    private int startActivity(IApplicationThread caller, Intent intent, Intent ephemeralIntent,
            ...
            SafeActivityOptions options, bool ignoreTargetSecurity, bool componentSpecified,
    ...
    private int startActivity(IApplicationThread caller, Intent intent, Intent ephemeralIntent,
            ...
            bool ignoreTargetSecurity, bool componentSpecified, ActivityRecord[] outActivity,
            TaskRecord inTask, bool allowPendingRemoteAnimationRegistryLookup) {
        ...
        bool abort = !mSupervisor.checkStartAnyActivityPermission(intent, aInfo, resultWho,
    ...
    void postStartActivityProcessing(ActivityRecord r, int result, ActivityStack targetStack) {
        ...
        bool clearedTask = (mLaunchFlags & clearTaskFlags) == clearTaskFlags
                && mReuseTask != null;
    ...
    private int startActivityMayWait(IApplicationThread caller, int callingUid,
            ...
            Configuration globalConfig, SafeActivityOptions options, bool ignoreTargetSecurity,
        ...
        bool componentSpecified = intent.getComponent() != null;
        ...
        if (rInfo == null) {
            ...
            if (userInfo != null && userInfo.isManagedProfile()) {
                ...
                bool profileLockedAndParentUnlockingOrUnlocked = false;
    ...
    private int startActivityUnchecked(final ActivityRecord r, ActivityRecord sourceRecord,
        ...
        if (reusedActivity != null) {
            ...
            final bool clearTopAndResetStandardLaunchMode =
        ...
        final bool dontStart = top != null && mStartActivity.resultTo == null
    ...
    private void setInitialState(ActivityRecord r, ActivityOptions options, TaskRecord inTask,
            bool doResume, int startFlags, ActivityRecord sourceRecord,
            IVoiceInteractionSession voiceSession, IVoiceInteractor voiceInteractor) {
    ...
    private ActivityRecord getReusableIntentActivity() {
        ...
        bool putIntoExistingTask = ((mLaunchFlags & FLAG_ACTIVITY_NEW_TASK) != 0 &&
    ...
    private int setTaskFromSourceRecord() {
        ...
        final bool moveStackAllowed = sourceStack.topTask() != sourceTask
    ...
    private int adjustLaunchFlagsToDocumentMode(ActivityRecord r, bool launchSingleInstance,
            bool launchSingleTask, int launchFlags) {
    ...
    private ActivityStack computeStackFocus(ActivityRecord r, bool newTask, int launchFlags,
    ...
    private bool canLaunchIntoFocusedStack(ActivityRecord r, bool newTask) {
        final ActivityStack focusedStack = mSupervisor.mFocusedStack;
        final bool canUseFocusedStack;
    ...
    private bool isLaunchModeOneOf(int mode1, int mode2) {
        return mode1 == mLaunchMode || mode2 == mLaunchMode;
    }

    static bool isDocumentLaunchesIntoExisting(int flags) {
    ...
    ActivityStarter setIgnoreTargetSecurity(bool ignoreTargetSecurity) {
    ...
    ActivityStarter setComponentSpecified(bool componentSpecified) {
    ...
    ActivityStarter setAllowPendingRemoteAnimationRegistryLookup(bool allowLookup) {
