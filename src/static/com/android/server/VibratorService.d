...
public class VibratorService : IVibratorService.Stub
    ...
    private final bool mAllowPriorityVibrationsInLowPowerMode;
    private final bool mSupportsAmplitudeControl;
    ...
    private bool mVibrateInputDevicesSetting; // guarded by mInputDeviceVibrators
    private bool mInputDeviceListenerRegistered; // guarded by mInputDeviceVibrators

    @GuardedBy("mLock")
    private Vibration mCurrentVibration;
    private int mCurVibUid = -1;
    private bool mLowPowerMode;
    private int mHapticFeedbackIntensity;
    private int mNotificationIntensity;

    native static bool vibratorExists();
    native static void vibratorInit();
    native static void vibratorOn(long milliseconds);
    native static void vibratorOff();
    native static bool vibratorSupportsAmplitudeControl();
    native static void vibratorSetAmplitude(int amplitude);
    native static long vibratorPerformEffect(long effect, long strength);

    private class Vibration : IBinder.DeathRecipient {
        ...
        public bool hasTimeoutLongerThan(long millis) {
     ...
     */
    private static bool verifyVibrationEffect(VibrationEffect effect) {
        if (effect == null) {
    ...
    private static bool isRepeatingVibration(VibrationEffect effect) {
    ...
    private bool isAllowedToVibrateLocked(Vibration vib) {
        if (!mLowPowerMode) {
            return true;
        }
    ...
    private bool shouldVibrateForRingtone() {
    ...
    private void updateVibrators() {
        synchronized (mLock) {
            bool devicesUpdated = updateInputDeviceVibratorsLocked();
            bool lowPowerModeUpdated = updateLowPowerModeLocked();
    ...
    private bool updateInputDeviceVibratorsLocked() {
        bool changed = false;
        bool vibrateInputDevices = false;
        try {
    ...
    private bool updateLowPowerModeLocked() {
        bool lowPowerMode = mPowerManagerInternal
    ...
    private long doVibratorPrebakedEffectLocked(Vibration vib) {
        ...
        try {
            ...
            final bool usingInputDeviceVibrators;
            synchronized (mInputDeviceVibrators) {
    ...
    private class VibrateThread : Thread {
        private final VibrationEffect.Waveform mWaveform;
        private final int mUid;
        private final int mUsageHint;

        private bool mForceStop;
    ...
    private final class VibratorShellCommand : ShellCommand {
