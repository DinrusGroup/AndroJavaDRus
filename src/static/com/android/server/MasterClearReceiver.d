...
public class MasterClearReceiver : BroadcastReceiver {
    private static final String TAG = "MasterClear";
    private bool mWipeExternalStorage;
    private bool mWipeEsims;
    ...
    public void onReceive(final Context context, final Intent intent) {
        ...
        final bool shutdown = intent.getBooleanExtra("shutdown", false);
        ...
        final bool forceWipe = intent.getBooleanExtra(Intent.EXTRA_FORCE_MASTER_CLEAR, false)
    ...
    private class WipeDataTask : AsyncTask<Void, Void, Void> {
