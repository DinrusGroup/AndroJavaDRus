 ...
 * </p>
 */
public class NetworkTimeUpdateService : Binder {
    ...
    private void updateSystemClock(int event) {
        final bool forceUpdate = (event == EVENT_AUTO_TIME_CHANGED);
        if (!forceUpdate) {
     ...
     */
    private bool isAutomaticTimeRequested() {
    ...
    private class NetworkTimeUpdateCallback : NetworkCallback {
        override
