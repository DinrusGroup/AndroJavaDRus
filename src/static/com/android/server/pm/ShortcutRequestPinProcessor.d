...
class ShortcutRequestPinProcessor {
    ...
    private static final bool DEBUG = ShortcutService.DEBUG;
     ...
     */
    private abstract static class PinItemRequestInner : IPinItemRequest.Stub {
         ...
         */
        override
        public bool accept(Bundle options) {
     ...
     * Internal for {@link android.content.pm.LauncherApps.PinItemRequest} which receives callbacks.
     */
    private static class PinAppWidgetRequestInner : PinItemRequestInner {
     ...
     * Internal for {@link android.content.pm.LauncherApps.PinItemRequest} which receives callbacks.
     */
    private static class PinShortcutRequestInner : PinItemRequestInner {
        ...
        private PinShortcutRequestInner(ShortcutRequestPinProcessor processor,
                ...
                String launcherPackage, int launcherUserId, int launcherUid, bool preExisting) {
            super(processor, resultIntent, launcherUid);
     ...
     * always null.
     */
    public bool requestPinItemLocked(ShortcutInfo inShortcut, AppWidgetProviderInfo inAppWidget,
    ...
    private PinItemRequest requestPinShortcutLocked(ShortcutInfo inShortcut,
        ...
        final bool existsAlready = existing != null;
        final bool existingIsVisible = existsAlready && existing.isVisibleToPublisher();
        ...
        if (existsAlready) {
            ...
            final bool isAlreadyPinned = mService.getLauncherShortcutsLocked(
    ...
    private bool startRequestConfirmActivity(ComponentName activity, int launcherUserId,
    ...
    public bool isCallerUid(int uid) {
     ...
     * request.
     */
    public bool directPinShortcut(PinShortcutRequestInner request) {
