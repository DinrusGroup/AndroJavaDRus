...
public class UserRestrictionsUtils {
     ...
     */
    public static bool isValidRestriction(@NonNull String restriction) {
    ...
    public static bool isEmpty(@Nullable Bundle in) {
     ...
     * restriction.
     */
    public static bool contains(@Nullable Bundle in, String restriction) {
     ...
     */
    public static bool canDeviceOwnerChange(String restriction) {
     ...
     */
    public static bool canProfileOwnerChange(String restriction, int userId) {
        return !IMMUTABLE_BY_OWNERS.contains(restriction)
     ...
     */
    public static void sortToGlobalAndLocal(@Nullable Bundle in, bool isDeviceOwner,
     ...
     */
    private static bool isGlobal(bool isDeviceOwner, String key) {
     ...
     */
    public static bool areEqual(@Nullable Bundle a, @Nullable Bundle b) {
        if (a == b) {
            return true;
        }
        if (isEmpty(a)) {
    ...
    public static void applyUserRestrictions(Context context, int userId,
        ...
        for (String key : USER_RESTRICTIONS) {
            final bool newValue = newRestrictions.getBoolean(key);
            final bool prevValue = prevRestrictions.getBoolean(key);
        ...
        try {
            switch (key) {
                ...
                case UserManager.DISALLOW_AIRPLANE_MODE:
                    if (newValue) {
                        final bool airplaneMode = Settings.Global.getInt(
                                context.getContentResolver(),
     ...
     */
    public static bool restrictionsChanged(Bundle oldRestrictions, Bundle newRestrictions,
            String... restrictions) {
