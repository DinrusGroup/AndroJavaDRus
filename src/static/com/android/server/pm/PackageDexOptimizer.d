...
public class PackageDexOptimizer {
    ...
    static bool canOptimizePackage(PackageParser.Package pkg) {
    ...
    private int performDexOptLI(PackageParser.Package pkg, String[] sharedLibraries,
        ...
        bool[] pathsWithCode = new bool[paths.size()];
        ...
        for (int i = 0; i < paths.size(); i++) {
            ...
            final bool isUsedByOtherApps = options.isDexoptAsSharedLibrary()
                    || packageUseInfo.isUsedByOtherApps(path);
            final String compilerFilter = getRealCompilerFilter(pkg.applicationInfo,
                options.getCompilerFilter(), isUsedByOtherApps);
            final bool profileUpdated = options.isCheckForProfileUpdates() &&
    ...
    private int dexOptPath(PackageParser.Package pkg, String path, String isa,
            String compilerFilter, bool profileUpdated, String classLoaderContext,
            int dexoptFlags, int uid, CompilerStats.PackageStats packageStats, bool downgrade,
    ...
    private String getRealCompilerFilter(ApplicationInfo info, String targetCompilerFilter,
            bool isUsedByOtherApps) {
        int flags = info.flags;
        bool vmSafeMode = (flags & ApplicationInfo.FLAG_VM_SAFE_MODE) != 0;
    ...
    private bool isAppImageEnabled() {
        return SystemProperties.get("dalvik.vm.appimageformat", "").length() > 0;
    }

    private int getDexFlags(ApplicationInfo info, String compilerFilter, DexoptOptions options) {
        int flags = info.flags;
        bool debuggable = (flags & ApplicationInfo.FLAG_DEBUGGABLE) != 0;
        ...
        bool isProfileGuidedFilter = isProfileGuidedCompilerFilter(compilerFilter);
        bool isPublic = !info.isForwardLocked() &&
        ...
        bool generateAppImage = isProfileGuidedFilter && (info.splitDependencies == null ||
    ...
    private int getDexoptNeeded(String path, String isa, String compilerFilter,
            String classLoaderContext, bool newProfile, bool downgrade) {
        int dexoptNeeded;
        try {
     ...
     */
    private bool isProfileUpdated(PackageParser.Package pkg, int uid, String profileName,
     ...
     * dexopt path.
     */
    public static class ForcedUpdatePackageDexOptimizer : PackageDexOptimizer {
