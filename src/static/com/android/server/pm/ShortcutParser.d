...
public class ShortcutParser {
    ...
    private static final bool DEBUG = ShortcutService.DEBUG || false; // DO NOT SUBMIT WITH TRUE
    ...
    private static ShortcutInfo parseShortcutAttributes(ShortcutService service,
        ...
        try {
            ...
            final bool enabled = sa.getBoolean(R.styleable.Shortcut_enabled, true);
    ...
    private static ShortcutInfo createShortcutFromManifest(ShortcutService service,
            ...
            int rank, int iconResId, bool enabled) {
