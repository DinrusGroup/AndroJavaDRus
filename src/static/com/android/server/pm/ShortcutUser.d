...
class ShortcutUser {
    ...
    public bool hasPackage(@NonNull String packageName) {
    ...
    public void rescanPackageIfNeeded(@NonNull String packageName, bool forceRescan) {
        final bool isNewApp = !mPackages.containsKey(packageName);
    ...
    private void saveShortcutPackageItem(XmlSerializer out,
            ShortcutPackageItem spi, bool forBackup) throws IOException, XmlPullParserException {
        if (forBackup) {
    ...
    public static ShortcutUser loadFromXml(ShortcutService s, XmlPullParser parser, int userId,
            bool fromBackup) throws IOException, XmlPullParserException, InvalidFileFormatException {
    ...
    private void setLauncher(ComponentName launcherComponent, bool allowPurgeLastKnown) {
