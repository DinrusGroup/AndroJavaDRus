 ...
 * {@hide}
 */
public class OtaDexoptService : IOtaDexopt.Stub {
    private final static String TAG = "OTADexopt";
    private final static bool DEBUG_DEXOPT = true;
    ...
    override
    public synchronized bool isDone() throws RemoteException {
        if (mDexoptCommands == null) {
    ...
    private synchronized List<String> generatePackageDexopts(PackageParser.Package pkg,
        ...
        final Installer collectingInstaller = new Installer(mContext, true) {
            ...
            public void dexopt(String apkPath, int uid, @Nullable String pkgName,
                    ...
                    @Nullable String sharedLibraries, @Nullable String seInfo, bool downgrade,
