 ...
 * managed profiles.
 */
public class LauncherAppsService : SystemService {
    ...
    @VisibleForTesting
    static class LauncherAppsImpl : ILauncherApps.Stub {
         ...
         * group.
         */
        private bool canAccessProfile(int targetUserId, String message) {
        ...
        override
        public bool isPackageEnabled(String callingPackage, String packageName, UserHandle user)
                throws RemoteException {
            if (!canAccessProfile(user.getIdentifier(), "Cannot check package")) {
                return false;
            }
        ...
        override
        public bool hasShortcutHostPermission(String callingPackage) {
            verifyCallingPackage(callingPackage);
        ...
        override
        public bool startShortcut(String callingPackage, String packageName, String shortcutId,
        ...
        private bool startShortcutIntentsAsPublisher(@NonNull Intent[] intents,
        ...
        private bool isEnabledProfileOf(UserHandle listeningUser, UserHandle user,
                String debugMsg) {
        ...
        private class MyPackageMonitor : PackageMonitor : ShortcutChangeListener {
        ...
        class PackageCallbackList<T : IInterface> : RemoteCallbackList<T> {
            override
