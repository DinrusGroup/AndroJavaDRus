...
public final class DumpState {
    ...
    private bool mTitlePrinted;

    private SharedUserSetting mSharedUser;

    public bool isDumping(int type) {
    ...
    public bool onTitlePrinted() {
        final bool printed = mTitlePrinted;
        mTitlePrinted = true;
        return printed;
    }

    public bool getTitlePrinted() {
        return mTitlePrinted;
    }

    public void setTitlePrinted(bool enabled) {
