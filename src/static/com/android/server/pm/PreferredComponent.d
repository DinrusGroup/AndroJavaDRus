...
public class PreferredComponent {
    ...
    private static final String ATTR_ALWAYS = "always"; // bool
    ...
    public interface Callbacks {
        public bool onReadTag(String tagName, XmlPullParser parser)
                throws XmlPullParserException, IOException;
    }

    public PreferredComponent(Callbacks callbacks, int match, ComponentName[] set,
            ComponentName component, bool always) {
    ...
    public bool sameSet(List<ResolveInfo> query) {
    ...
    public bool sameSet(ComponentName[] comps) {
    ...
    public bool isSuperset(List<ResolveInfo> query) {
        if (mSetPackages == null) {
            return query == null;
        }
        if (query == null) {
