...
public class PackageManagerServiceUtils {
     ...
     */
    public static bool isUnusedSinceTimeInMillis(long firstInstallTime, long currentTimeInMillis,
        ...
        bool isActiveInForeground = (currentTimeInMillis
        ...
        // by other packages.
        bool isActiveInBackgroundAndUsedByOtherPackages = ((currentTimeInMillis
     ...
     * the running device.
     */
    public static bool checkISA(String isa) {
     ...
     */
    private static bool matchSignaturesCompat(String packageName,
    ...
    private static bool matchSignaturesRecover(
            String packageName,
     ...
     */
    private static bool matchSignatureInSystem(PackageSetting pkgSetting,
    ...
    static bool isApkVerityEnabled() {
    ...
    static bool isApkVerificationForced(@Nullable PackageSetting disabledPs) {
     ...
     */
    public static bool verifySignatures(PackageSetting pkgSetting,
            PackageSetting disabledPkgSetting, PackageParser.SigningDetails parsedSignatures,
            bool compareCompat, bool compareRecover)
        ...
        if (pkgSetting.signatures.mSigningDetails.signatures != null) {
            ...
            bool match = parsedSignatures.checkCapability(
                    pkgSetting.signatures.mSigningDetails,
                    PackageParser.SigningDetails.CertCapabilities.INSTALLED_DATA)
    ...
    public static bool compressedFileExists(String codePath) {
