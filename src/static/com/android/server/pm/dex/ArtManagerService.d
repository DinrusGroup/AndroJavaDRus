 ...
 */
public class ArtManagerService : android.content.pm.dex.IArtManager.Stub {
    ...
    private bool checkAndroidPermissions(int callingUid, String callingPackage) {
     ...
     */
    private bool checkShellPermissions(@ProfileType int profileType, String packageName,
            int callingUid) {
    ...
    public void snapshotRuntimeProfile(@ProfileType int profileType, @Nullable String packageName,
        ...
        bool bootImageProfile = profileType == ArtManager.PROFILE_BOOT_IMAGE;
        if (!bootImageProfile) {
    ...
    private void snapshotAppProfile(String packageName, String codePath,
        ...
        bool pathFound = info.applicationInfo.getBaseCodePath().equals(codePath);
    ...
    override
    public bool isRuntimeProfilingEnabled(@ProfileType int profileType, String callingPackage) {
        int callingUid = Binder.getCallingUid();
        ...
        try {
            ...
            for (int i = codePathsProfileNames.size() - 1; i >= 0; i--) {
                ...
                synchronized (mInstaller) {
                    bool result = mInstaller.prepareAppProfile(pkg.packageName, user, appId,
    ...
    private class ArtManagerInternalImpl : ArtManagerInternal {
        override
