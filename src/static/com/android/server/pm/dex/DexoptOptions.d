...
public final class DexoptOptions {
    ...
    public bool isCheckForProfileUpdates() {
    ...
    public bool isDexoptOnlySecondaryDex() {
        return (mFlags & DEXOPT_ONLY_SECONDARY_DEX) != 0;
    }

    public bool isDexoptOnlySharedDex() {
    ...
    public bool isDexoptAsSharedLibrary() {
        return (mFlags & DEXOPT_AS_SHARED_LIBRARY) != 0;
    }

    public bool isDexoptIdleBackgroundJob() {
        return (mFlags & DEXOPT_IDLE_BACKGROUND_JOB) != 0;
    }

    public bool isDexoptInstallWithDexMetadata() {
