 ...
 */
class ShortcutPackage : ShortcutPackageItem {
    ...
    override
    protected bool canRestoreAnyVersion() {
        return false;
    }
    ...
    public bool isShortcutExistsAndInvisibleToPublisher(String id) {
        ShortcutInfo si = findShortcutById(id);
        return si != null && !si.isVisibleToPublisher();
    }

    public bool isShortcutExistsAndVisibleToPublisher(String id) {
        ShortcutInfo si = findShortcutById(id);
        return si != null && si.isVisibleToPublisher();
    }

    private void ensureNotImmutable(@Nullable ShortcutInfo shortcut, bool ignoreInvisible) {
    ...
    public void ensureNotImmutable(@NonNull String id, bool ignoreInvisible) {
     ...
     */
    public void deleteAllDynamicShortcuts(bool ignoreInvisible) {
     ...
     * pinned.
     */
    public bool deleteDynamicWithId(@NonNull String shortcutId, bool ignoreInvisible) {
     ...
     * pinned.
     */
    private bool disableDynamicWithId(@NonNull String shortcutId, bool ignoreInvisible,
            int disabledReason) {
    ...
    public void disableWithId(@NonNull String shortcutId, String disabledMessage,
            int disabledMessageResId, bool overrideImmutable, bool ignoreInvisible,
            int disabledReason) {
    ...
    @Nullable
    private ShortcutInfo deleteOrDisableWithId(@NonNull String shortcutId, bool disable,
            bool overrideImmutable, bool ignoreInvisible, int disabledReason) {
     ...
     * locale changes.
     */
    public int getApiCallCount(bool unlimited) {
        final ShortcutService s = mShortcutUser.mService;
     ...
     */
    public bool tryApiCall(bool unlimited) {
        final ShortcutService s = mShortcutUser.mService;
    ...
    public void findAll(@NonNull List<ShortcutInfo> result,
            @Nullable Predicate<ShortcutInfo> query, int cloneFlag,
            @Nullable String callingLauncher, int launcherUserId, bool getPinnedByAnyLauncher) {
        ...
        for (int i = 0; i < mShortcuts.size(); i++) {
            ...
            final bool isPinnedByCaller = (callingLauncher == null)
     ...
     */
    private bool areAllActivitiesStillEnabled() {
     ...
     */
    public bool rescanPackageIfNeeded(bool isNewApp, bool forceRescan) {
        final ShortcutService s = mShortcutUser.mService;
    ...
    private bool publishManifestShortcuts(List<ShortcutInfo> newManifestShortcutList) {
        if (ShortcutService.DEBUG) {
        ...
        if (newManifestShortcutList != null) {
            ...
            for (int i = 0; i < newListSize; i++) {
                ...
                final bool newDisabled = !newShortcut.isEnabled();
     ...
     */
    private bool pushOutExcessShortcuts() {
    ...
    public bool hasNonManifestShortcuts() {
        for (int i = mShortcuts.size() - 1; i >= 0; i--) {
            final ShortcutInfo si = mShortcuts.valueAt(i);
    ...
    override
    public JSONObject dumpCheckin(bool clear) throws JSONException {
    ...
    override
    public void saveToXml(@NonNull XmlSerializer out, bool forBackup)
    ...
    private void saveShortcut(XmlSerializer out, ShortcutInfo si, bool forBackup,
            bool appSupportsBackup)
            throws IOException, XmlPullParserException {
        ...
        final bool shouldBackupDetails =
    ...
    public static ShortcutPackage loadFromXml(ShortcutService s, ShortcutUser shortcutUser,
            XmlPullParser parser, bool fromBackup)
            throws IOException, XmlPullParserException {
    ...
    private static ShortcutInfo parseShortcut(XmlPullParser parser, String packageName,
            @UserIdInt int userId, bool fromBackup)
            throws IOException, XmlPullParserException {
        String id;
    ...
    private bool verifyRanksSequential(List<ShortcutInfo> list) {
        bool failed = false;
