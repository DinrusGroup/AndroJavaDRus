...
public class CrossProfileAppsServiceImpl : ICrossProfileApps.Stub {
    ...
    private bool isPackageEnabled(String packageName, @UserIdInt int userId) {
        final int callingUid = mInjector.getCallingUid();
        final long ident = mInjector.clearCallingIdentity();
        try {
    ...
    private static class InjectorImpl : Injector {
        private Context mContext;
