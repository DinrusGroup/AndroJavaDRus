...
public class KeySetManagerService {
     ...
     */
    public bool packageIsSignedByLPr(String packageName, KeySetHandle ks) {
     ...
     */
    public bool packageIsSignedByExactlyLPr(String packageName, KeySetHandle ks) {
        PackageSetting pkg = mPackages.get(packageName);
        if (pkg == null) {
            throw new NullPointerException("Invalid package name");
        }
    ...
    public bool isIdValidKeySetId(long id) {
        return mKeySets.get(id) != null;
    }

    public bool shouldCheckUpgradeKeySetLocked(PackageSettingBase oldPs, int scanFlags) {
    ...
    public bool checkUpgradeKeySetLocked(PackageSettingBase oldPS,
