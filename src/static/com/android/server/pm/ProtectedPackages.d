...
public class ProtectedPackages {
    ...
    private synchronized bool hasDeviceOwnerOrProfileOwner(int userId, String packageName) {
        if (packageName == null) {
            return false;
        }
     ...
     */
    private synchronized bool isProtectedPackage(String packageName) {
     ...
     */
    public bool isPackageStateProtected(@UserIdInt int userId, String packageName) {
     ...
     * {@code false}.
     */
    public bool isPackageDataProtected(@UserIdInt int userId, String packageName) {
        return hasDeviceOwnerOrProfileOwner(userId, packageName)
                || isProtectedPackage(packageName);
    }
}
