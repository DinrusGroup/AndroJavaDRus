...
class ShortcutPackageInfo {
    ...
    // we use this bool to control dumpsys.
    private bool mBackupAllowedInitialized;
    private bool mBackupAllowed;
    private bool mBackupSourceBackupAllowed;

    private ShortcutPackageInfo(long versionCode, long lastUpdateTime,
            ArrayList<byte[]> sigHashes, bool isShadow) {
    ...
    @VisibleForTesting
    public bool isBackupSourceBackupAllowed() {
    ...
    //@DisabledReason
    public int canRestoreTo(ShortcutService s, PackageInfo currentPackage, bool anyVersionOkay) {
    ...
    public void saveToXml(ShortcutService s, XmlSerializer out, bool forBackup)
            throws IOException {
    ...
    public void loadFromXml(XmlPullParser parser, bool fromBackup)
        ...
        // default.
        final bool backupAllowed = ShortcutService.parseBooleanAttribute(
                parser, ATTR_BACKUP_ALLOWED, true);
        final bool backupSourceBackupAllowed = ShortcutService.parseBooleanAttribute(
