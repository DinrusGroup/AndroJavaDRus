...
public class Installer : SystemService {
     ...
     */
    public Installer(Context context, bool isolated) {
        super(context);
        mIsolated = isolated;
    }
     ...
     */
    private bool checkBeforeRemote() {
    ...
    public void dexopt(String apkPath, int uid, @Nullable String pkgName, String instructionSet,
            ...
            @Nullable String seInfo, bool downgrade, int targetSdkVersion,
    ...
    public bool mergeProfiles(int uid, String packageName, String profileName)
            throws InstallerException {
    ...
    public bool dumpProfiles(int uid, String packageName, String profileName, String codePath)
            throws InstallerException {
        if (!checkBeforeRemote()) return false;
        try {
    ...
    public bool copySystemProfile(String systemProfile, int uid, String packageName,
    ...
    public bool reconcileSecondaryDexFile(String apkPath, String packageName, int uid,
    ...
    public bool createProfileSnapshot(int appId, String packageName, String profileName,
    ...
    public bool isQuotaSupported(String volumeUuid) throws InstallerException {
        if (!checkBeforeRemote()) return false;
        try {
    ...
    public bool prepareAppProfile(String pkg, @UserIdInt int userId, @AppIdInt int appId,
    ...
    public static class InstallerException : Exception {
