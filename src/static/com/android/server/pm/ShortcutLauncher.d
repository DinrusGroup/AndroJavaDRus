 ...
 */
class ShortcutLauncher : ShortcutPackageItem {
    ...
    public void pinShortcuts(@UserIdInt int packageUserId,
            @NonNull String packageName, @NonNull List<String> ids, bool forPinRequest) {
     ...
     */
    public bool hasPinned(ShortcutInfo shortcut) {
    ...
    /**
     * Additionally pin a shortcut. c.f. {@link #pinShortcuts(int, String, List, bool)}
     */
    public void addPinnedShortcut(@NonNull String packageName, @UserIdInt int packageUserId,
            String id, bool forPinRequest) {
    ...
    bool cleanUpPackage(String packageName, @UserIdInt int packageUserId) {
     ...
     */
    override
    public void saveToXml(XmlSerializer out, bool forBackup)
            throws IOException {
    ...
    public static ShortcutLauncher loadFromXml(XmlPullParser parser, ShortcutUser shortcutUser,
            int ownerUserId, bool fromBackup) throws IOException, XmlPullParserException {
