...
public abstract class PermissionManagerInternal {
    ...
    public static class PermissionCallback {
        ...
        public void onPermissionUpdated(int[] updatedUserIds, bool sync) {
        }
    ...
    public abstract bool isPermissionsReviewRequired(PackageParser.Package pkg, int userId);

    public abstract void grantRuntimePermission(
            @NonNull String permName, @NonNull String packageName, bool overridePolicy,
    ...
    public abstract void revokeRuntimePermission(@NonNull String permName,
            @NonNull String packageName, bool overridePolicy, int callingUid, int userId,
            @Nullable PermissionCallback callback);

    public abstract void updatePermissions(@Nullable String packageName,
            @Nullable PackageParser.Package pkg, bool replaceGrant,
            @NonNull Collection<PackageParser.Package> allPacakges, PermissionCallback callback);
    public abstract void updateAllPermissions(@Nullable String volumeUuid, bool sdkUpdated,
            @NonNull Collection<PackageParser.Package> allPacakges, PermissionCallback callback);
     ...
     */
    public abstract void addAllPermissions(@NonNull PackageParser.Package pkg, bool chatty);
    public abstract void addAllPermissionGroups(@NonNull PackageParser.Package pkg, bool chatty);
    public abstract void removeAllPermissions(@NonNull PackageParser.Package pkg, bool chatty);
    public abstract bool addDynamicPermission(@NonNull PermissionInfo info, bool async,
     ...
     */
    public abstract bool updatePermissionFlagsForAllApps(int flagMask, int flagValues,
    ...
    public abstract void enforceCrossUserPermission(int callingUid, int userId,
            bool requireFullPermission, bool checkShell, @NonNull String message);
    /**
     * @see #enforceCrossUserPermission(int, int, bool, bool, String)
    ...
    public abstract void enforceCrossUserPermission(int callingUid, int userId,
            ...
            bool requirePermissionWhenSameUser, @NonNull String message);
