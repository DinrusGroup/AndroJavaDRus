...
public final class BasePermission {
    ...
    public void setGids(int[] gids, bool perUser) {
        this.gids = gids;
    ...
    public bool isPermission(Permission perm) {
    ...
    public bool addToTree(@ProtectionLevel int protectionLevel,
    ...
    static BasePermission createOrUpdate(@Nullable BasePermission bp, @NonNull Permission p,
        ...
        if (bp != null && !Objects.equals(bp.sourcePackageName, p.info.packageName)) {
            final bool currentOwnerIsSystem = (bp.perm != null
    ...
    public @NonNull PermissionInfo generatePermissionInfo(int adjustedProtectionLevel, int flags) {
        ...
        if (perm != null) {
            final bool protectionLevelChanged = protectionLevel != adjustedProtectionLevel;
    ...
    public static bool readLPw(@NonNull Map<String, BasePermission> out,
        ...
        final bool dynamic = "dynamic".equals(ptype);
    ...
    private static bool compareStrings(CharSequence s1, CharSequence s2) {
        if (s1 == null) {
            return s2 == null;
        }
        if (s2 == null) {
    ...
    private static bool comparePermissionInfos(PermissionInfo pi1, PermissionInfo pi2) {
    ...
    public bool dumpPermissionsLPr(@NonNull PrintWriter pw, @NonNull String packageName,
            @NonNull Set<String> permissionNames, bool readEnforced,
            bool printedSomething, @NonNull DumpState dumpState) {
