...
public class PermissionSettings {
    ...
    public final bool mPermissionReviewRequired;
    ...
    public void dumpPermissions(PrintWriter pw, String packageName,
            ArraySet<String> permissionNames, bool externalStorageEnforced,
            DumpState dumpState) {
        synchronized (mLock) {
    ...
    public bool isPermissionInstant(String permName) {
        synchronized (mLock) {
            final BasePermission bp = mPermissions.get(permName);
    ...
    bool isPermissionAppOp(String permName) {
        synchronized (mLock) {
            final BasePermission bp = mPermissions.get(permName);
