 ...
 */
class TelephonyRegistry : ITelephonyRegistry.Stub {
    private static final String TAG = "TelephonyRegistry";
    private static final bool DBG = false; // STOPSHIP if true
    private static final bool DBG_LOC = false; // STOPSHIP if true
    ...
    private static class Record {
        ...
        bool matchPhoneStateListenerEvent(int events) {
            return (callback != null) && ((events & this.events) != 0);
        }

        bool matchOnSubscriptionsChangedListener() {
    ...
    private bool hasNotifySubscriptionInfoChangedOccurred = false;
    ...
    private bool[] mUserMobileDataState;

    private SignalStrength[] mSignalStrength;

    private bool[] mMessageWaiting;

    private bool[] mCallForwarding;
    ...
    private bool mCarrierNetworkChangeState = false;
    ...
    private class TelephonyRegistryDeathRecipient : IBinder.DeathRecipient {
    ...
    TelephonyRegistry(Context context) {
        ...
        mUserMobileDataState = new bool[numPhones];
        mSignalStrength = new SignalStrength[numPhones];
        mMessageWaiting = new bool[numPhones];
        mCallForwarding = new bool[numPhones];
    ...
    override
    public void notifyMessageWaitingChangedForPhoneId(int phoneId, int subId, bool mwi) {
    ...
    public void notifyUserMobileDataStateChangedForPhoneId(int phoneId, int subId, bool state) {
    ...
    public void notifyCallForwardingChanged(bool cfi) {
        notifyCallForwardingChangedForSubscriber(SubscriptionManager.DEFAULT_SUBSCRIPTION_ID, cfi);
    }

    public void notifyCallForwardingChangedForSubscriber(int subId, bool cfi) {
    ...
    public void notifyDataConnection(int state, bool isDataAllowed,
            String reason, String apn, String apnType, LinkProperties linkProperties,
            NetworkCapabilities networkCapabilities, int networkType, bool roaming) {
    ...
    public void notifyDataConnectionForSubscriber(int subId, int state,
            bool isDataAllowed, String reason, String apn, String apnType,
            LinkProperties linkProperties, NetworkCapabilities networkCapabilities,
            int networkType, bool roaming) {
    ...
    private void broadcastDataConnectionStateChanged(int state,
            bool isDataAllowed,
            String reason, String apn, String apnType, LinkProperties linkProperties,
            NetworkCapabilities networkCapabilities, bool roaming, int subId) {
    ...
    private bool checkNotifyPermission(String method) {
        if (checkNotifyPermission()) {
            return true;
        }
    ...
    private bool validateEventsAndUserLocked(Record r, int events) {
        int foregroundUser;
    ...
    private bool validatePhoneId(int phoneId) {
        bool valid = (phoneId >= 0) && (phoneId < mNumPhones);
    ...
    bool idMatch(int rSubId, int subId, int phoneId) {
    ...
    private bool checkLocationAccess(Record r) {
