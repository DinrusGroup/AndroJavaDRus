...
public class StorageStatsService : IStorageStatsManager.Stub {
    ...
    override
    public bool isQuotaSupported(String volumeUuid, String callingPackage) {
    ...
    override
    public bool isReservedSupported(String volumeUuid, String callingPackage) {
        enforcePermission(Binder.getCallingUid(), callingPackage);
    ...
    @VisibleForTesting
    static bool isCacheQuotaCalculationsEnabled(ContentResolver resolver) {
