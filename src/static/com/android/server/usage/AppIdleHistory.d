...
public class AppIdleHistory {
    ...
    private static final bool DEBUG = AppStandbyController.DEBUG;
    ...
    public void updateDisplay(bool screenOn, long elapsedRealtime) {
    ...
    private AppUsageHistory getPackageHistory(ArrayMap<String, AppUsageHistory> userHistory,
            String packageName, long elapsedRealtime, bool create) {
    ...
    public bool isIdle(String packageName, int userId, long elapsedRealtime) {
        ArrayMap<String, AppUsageHistory> userHistory = getUserHistory(userId);
    ...
    public void setAppStandbyBucket(String packageName, int userId, long elapsedRealtime,
            int bucket, int reason, bool resetTimeout) {
        ArrayMap<String, AppUsageHistory> userHistory = getUserHistory(userId);
        AppUsageHistory appUsageHistory =
                getPackageHistory(userHistory, packageName, elapsedRealtime, true);
    ...
    public ArrayList<AppStandbyInfo> getAppStandbyBuckets(int userId, bool appIdleEnabled) {
        ArrayMap<String, AppUsageHistory> userHistory = getUserHistory(userId);
    ...
    public int setIdle(String packageName, int userId, bool idle, long elapsedRealtime) {
        ArrayMap<String, AppUsageHistory> userHistory = getUserHistory(userId);
    ...
    bool shouldInformListeners(String packageName, int userId,
