...
class UsageStatsDatabase {
    ...
    public interface CheckinAction {
        bool checkin(IntervalStats stats);
    }
     ...
     */
    public bool checkinDailyFiles(CheckinAction checkinAction) {
        synchronized (mLock) {
    ...
    interface StatCombiner<T> {
         ...
         */
        void combine(IntervalStats stats, bool mutable, List<T> accumulatedResult);
    }
