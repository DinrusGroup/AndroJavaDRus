 ...
 */
public class UsageStatsService : SystemService :
        UserUsageStatsService.StatsUpdatedListener {

    static final String TAG = "UsageStatsService";
    public static final bool ENABLE_TIME_CHANGE_CORRECTION
            = SystemProperties.getBoolean("persist.debug.time_correction", true);

    static final bool DEBUG = false; // Never submit with true
    ...
    private static final bool ENABLE_KERNEL_UPDATES = true;
    ...
    private class UserActionsReceiver : BroadcastReceiver {
        override
    ...
    private bool shouldObfuscateInstantAppsForCaller(int callingUid, int userId) {
    ...
    private static bool validRange(long currentTime, long beginTime, long endTime) {
    ...
    private final class BinderService : IUsageStatsManager.Stub {

        private bool hasPermission(String callingPackage) {
        ...
        private bool hasObserverPermission(String callingPackage) {
            final int callingUid = Binder.getCallingUid();
        ...
        private bool isCallingUidSystem() {
        ...
        public ParceledListSlice<UsageStats> queryUsageStats(int bucketType, long beginTime,
            ...
            final bool obfuscateInstantApps = shouldObfuscateInstantAppsForCaller(
        ...
        override
        public bool isAppInactive(String packageName, int userId) {
            try {
        ...
        override
        public void setAppInactive(String packageName, bool idle, int userId) {
            final int callingUid = Binder.getCallingUid();
            try {
        ...
        public int getAppStandbyBucket(String packageName, String callingPackage, int userId) {
            ...
            final bool obfuscateInstantApps = shouldObfuscateInstantAppsForCaller(callingUid,
                    userId);
            final long token = Binder.clearCallingIdentity();
            try {
        ...
        public void setAppStandbyBucket(String packageName,
            ...
            final bool shellCaller = callingUid == 0 || callingUid == Process.SHELL_UID;
            final bool systemCaller = UserHandle.isCore(callingUid);
     ...
     */
    private final class LocalService : UsageStatsManagerInternal {
        ...
        override
        public bool isAppIdle(String packageName, int uidForAppId, int userId) {
