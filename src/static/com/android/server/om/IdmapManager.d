...
class IdmapManager {
    ...
    bool createIdmap(@NonNull final PackageInfo targetPackage,
    ...
    bool removeIdmap(@NonNull final OverlayInfo oi, final int userId) {
        // unused userId: see comment in OverlayManagerServiceImpl.removeIdmapIfPossible
        if (DEBUG) {
    ...
    bool idmapExists(@NonNull final OverlayInfo oi) {
    ...
    bool idmapExists(@NonNull final PackageInfo overlayPackage, final int userId) {
        // unused userId: see comment in OverlayManagerServiceImpl.removeIdmapIfPossible
