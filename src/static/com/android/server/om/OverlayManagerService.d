 ...
 * </ul>
 */
public final class OverlayManagerService : SystemService {
    ...
    private Future!(T) mInitCompleteSignal;
    ...
    private final class PackageReceiver : BroadcastReceiver {
        override
    ...
    private final class UserReceiver : BroadcastReceiver {
        override
        public void onReceive(@NonNull final Context context, @NonNull final Intent intent) {
    ...
    private final IBinder mService = new IOverlayManager.Stub() {
        ...
        override
        public bool setEnabled(@Nullable final String packageName, final bool enable,
                int userId) throws RemoteException {
        ...
        override
        public bool setEnabledExclusive(@Nullable final String packageName, final bool enable,
                int userId) throws RemoteException {
            enforceChangeOverlayPackagesPermission("setEnabled");
            userId = handleIncomingUser(userId, "setEnabled");
        ...
        override
        public bool setEnabledExclusiveInCategory(@Nullable String packageName, int userId)
        ...
        override
        public bool setPriority(@Nullable final String packageName,
        ...
        override
        public bool setHighestPriority(@Nullable final String packageName, int userId)
                throws RemoteException {
        ...
        override
        public bool setLowestPriority(@Nullable final String packageName, int userId)
                throws RemoteException {
        ...
        protected void dump(@NonNull final FileDescriptor fd, @NonNull final PrintWriter pw,
            ...
            final bool verbose = argv.length > 0 && "--verbose".equals(argv[0]);
    ...
    private final class OverlayChangeListener
            : OverlayManagerServiceImpl.OverlayChangeListener {
        override
    ...
    private void updateOverlayPaths(int userId, List<String> targetPackageNames) {
        ...
        final bool updateFrameworkRes = targetPackageNames.contains("android");
    ...
    private static final class PackageManagerHelper :
        ...
        override
        public bool signaturesMatching(@NonNull final String packageName1,
        ...
        public void dump(@NonNull final PrintWriter pw, final bool verbose) {
