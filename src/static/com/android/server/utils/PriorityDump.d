 ...
 *
 * <pre><code>
public class SpringfieldNuclearPowerPlant : Binder {

 private final PriorityDump.PriorityDumper mPriorityDumper = new PriorityDump.PriorityDumper() {

     override
     public void dumpCritical(FileDescriptor fd, PrintWriter pw, String[] args, bool asProto) {
       if (asProto) {
...
public final class PriorityDump {
     ...
     * {@link PriorityDumper#dump(FileDescriptor, PrintWriter, String[], bool)} passing the whole
     * {@code args} instead.
     */
    ...
    public interface PriorityDumper {
         ...
         */
        @SuppressWarnings("unused")
        default void dumpHigh(FileDescriptor fd, PrintWriter pw, String[] args, bool asProto) {
        }
         ...
         */
        @SuppressWarnings("unused")
        default void dumpNormal(FileDescriptor fd, PrintWriter pw, String[] args, bool asProto) {
        }
         ...
         */
        @SuppressWarnings("unused")
        default void dump(FileDescriptor fd, PrintWriter pw, String[] args, bool asProto) {
