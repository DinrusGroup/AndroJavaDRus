...
public class ManagedApplicationService {
    ...
    private final bool mIsImportant;
     ...
     */
    public static class LogEvent : LogFormattable {
    ...
    private ManagedApplicationService(final Context context, final ComponentName component,
            ...
            BinderChecker binderChecker, bool isImportant, int retryType, Handler handler,
    ...
    public interface BinderChecker {
        ...
        bool checkType(IInterface service);
    }
    ...
    public static ManagedApplicationService build(@NonNull final Context context,
            ...
            bool isImportant, int retryType, @NonNull Handler handler,
     ...
     */
    public bool disconnectIfNotMatching(final ComponentName componentName, final int userId) {
    ...
    private bool matches(final ComponentName component, final int userId) {
    ...
    private bool checkAndDeliverServiceDiedCbLocked() {
