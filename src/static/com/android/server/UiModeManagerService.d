...
final class UiModeManagerService : SystemService {
    private static final String TAG = UiModeManager.class.getSimpleName();
    private static final bool LOG = false;

    // Enable launching of applications when entering the dock.
    private static final bool ENABLE_LAUNCH_DESK_DOCK_APP = true;
    ...
    private bool mCarModeEnabled = false;
    private bool mCharging = false;
    private int mDefaultUiModeType;
    private bool mCarModeKeepsScreenOn;
    private bool mDeskModeKeepsScreenOn;
    private bool mTelevision;
    private bool mWatch;
    private bool mVrHeadset;
    private bool mComputedNightMode;
    private int mCarModeEnableFlags;

    // flag set by resource, whether to enable Car dock launch when starting car mode.
    private bool mEnableCarDockLaunch = true;
    // flag set by resource, whether to lock UI mode to the default one or not.
    private bool mUiModeLocked = false;
    // flag set by resource, whether to night mode change for normal all or not.
    private bool mNightModeLocked = false;

    int mCurUiMode = 0;
    private int mSetUiMode = 0;
    private bool mHoldingConfiguration = false;
    ...
    void setCarModeLocked(bool enabled, int flags) {
    ...
    private static bool isDeskDockState(int state) {
        switch (state) {
     ...
     */
    private static class Shell : ShellCommand {
