...
class WallpaperController {
    ...
    private final ToBooleanFunction<WindowState> mFindWallpaperTargetFunction = w -> {
        ...
        final bool keyguardGoingAwayWithWallpaper = (w.mAppToken != null
        ...
        bool needsShowWhenLockedWallpaper = false;
        ...
        final bool animationWallpaper = w.mAppToken != null && w.mAppToken.getAnimation() != null
                && w.mAppToken.getAnimation().getShowWallpaper();
        final bool hasWallpaper = (w.mAttrs.flags & FLAG_SHOW_WALLPAPER) != 0
                || animationWallpaper;
        final bool isRecentsTransitionTarget = (recentsAnimationController != null
    ...
    bool isWallpaperTarget(WindowState win) {
        return win == mWallpaperTarget;
    }

    bool isBelowWallpaperTarget(WindowState win) {
    ...
    private final bool isWallpaperVisible(WindowState wallpaperTarget) {
        final RecentsAnimationController recentsAnimationController =
                mService.getRecentsAnimationController();
        bool isAnimatingWithRecentsComponent = recentsAnimationController != null
    ...
    bool isWallpaperTargetAnimating() {
    ...
    void updateWallpaperVisibility() {
        final bool visible = isWallpaperVisible(mWallpaperTarget);
    ...
    void hideWallpapers(final WindowState winGoingAway) {
        ...
        final bool wasDeferred = (mDeferredHideWallpaper == winGoingAway);
    ...
    bool updateWallpaperOffset(WindowState wallpaperWin, int dw, int dh, bool sync) {
        int xOffset = 0;
        int yOffset = 0;
        ...
        bool changed = wallpaperWin.mWinAnimator.setWallpaperOffset(xOffset, yOffset);
    ...
    Bundle sendWindowWallpaperCommand(
            WindowState window, String action, int x, int y, int z, Bundle extras, bool sync) {
    ...
    private void updateWallpaperOffsetLocked(WindowState changingTarget, bool sync) {
    ...
    private bool isFullscreen(WindowManager.LayoutParams attrs) {
    ...
    private void updateWallpaperWindowsTarget(DisplayContent dc,
        ...
        bool oldAnim = prevWallpaperTarget.isAnimatingLw();
        bool foundAnim = wallpaperTarget.isAnimatingLw();
        if (DEBUG_WALLPAPER_LIGHT) Slog.v(TAG,
        ...
        final bool newTargetHidden = wallpaperTarget.mAppToken != null
                && wallpaperTarget.mAppToken.hiddenRequested;
        final bool oldTargetHidden = prevWallpaperTarget.mAppToken != null
    ...
    private void updateWallpaperTokens(bool visible) {
        for (int curTokenNdx = mWallpaperTokens.size() - 1; curTokenNdx >= 0; curTokenNdx--) {
            final WallpaperWindowToken token = mWallpaperTokens.get(curTokenNdx);
    ...
    void adjustWallpaperWindows(DisplayContent dc) {
        ...
        final bool visible = mWallpaperTarget != null && isWallpaperVisible(mWallpaperTarget);
    ...
    bool processWallpaperDrawPendingTimeout() {
    ...
    bool wallpaperTransitionReady() {
        bool transitionReady = true;
        bool wallpaperReady = true;
    ...
    final private static class FindWallpaperTargetResult {
        ...
        bool useTopWallpaperAsTarget = false;
        WindowState wallpaperTarget = null;
        bool resetTopWallpaper = false;
        ...
        void setUseTopWallpaperAsTarget(bool topWallpaperAsTarget) {
