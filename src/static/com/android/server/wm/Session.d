 ...
 */
class Session : IWindowSession.Stub : IBinder.DeathRecipient {
    ...
    final bool mCanAddInternalSystemWindow;
    final bool mCanHideNonSystemOverlayWindows;
    final bool mCanAcquireSleepToken;
    private AlertWindowNotification mAlertWindowNotification;
    private bool mShowingAlertWindowNotificationAllowed;
    private bool mClientDead = false;
    ...
    override
    public void prepareToReplaceWindows(IBinder appToken, bool childrenOnly) {
    ...
    override
    public bool outOfMemory(IWindow window) {
    ...
    override
    public bool performHapticFeedback(IWindow window, int effectId,
            bool always) {
        synchronized(mService.mWindowMap) {
            long ident = Binder.clearCallingIdentity();
            try {
    ...
    override
    public void reportDropResult(IWindow window, bool consumed) {
        final long ident = Binder.clearCallingIdentity();
        try {
    ...
    override
    public bool startMovingTask(IWindow window, float startX, float startY) {
    ...
    void setShowingAlertWindowNotificationAllowed(bool allowed) {
    ...
    private void setHasOverlayUi(bool hasOverlayUi) {
