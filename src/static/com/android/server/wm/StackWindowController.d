...
public class StackWindowController
        : WindowContainerController<TaskStack, StackWindowListener> {
    ...
    public StackWindowController(int stackId, StackWindowListener listener, int displayId,
            bool onTop, Rect outBounds) {
        this(stackId, listener, displayId, onTop, outBounds, WindowManagerService.getInstance());
    }

    @VisibleForTesting
    public StackWindowController(int stackId, StackWindowListener listener,
            int displayId, bool onTop, Rect outBounds, WindowManagerService service) {
    ...
    public void reparent(int displayId, Rect outStackBounds, bool onTop) {
        synchronized (mWindowMap) {
            if (mContainer == null) {
    ...
    public void positionChildAtTop(TaskWindowContainerController child, bool includingParents) {
        if (child == null) {
    ...
    /**
     * @see TaskStack.getStackDockedModeBoundsLocked(Rect, Rect, Rect, bool)
     */
   public void getStackDockedModeBounds(Rect currentTempTaskBounds, Rect outStackBounds,
    ...
    public void adjustConfigurationForBounds(Rect bounds, Rect insetBounds,
            Rect nonDecorBounds, Rect stableBounds, bool overrideWidth,
            bool overrideHeight, float density, Configuration config,
        ...
        synchronized (mWindowMap) {
            ...
            bool intersectParentBounds = false;
    ...
    private void intersectDisplayBoundsExcludeInsets(Rect inOutBounds, Rect inInsetBounds,
            Rect stableInsets, Rect displayBounds, bool overrideWidth, bool overrideHeight) {
    ...
    private static final class H : Handler {
