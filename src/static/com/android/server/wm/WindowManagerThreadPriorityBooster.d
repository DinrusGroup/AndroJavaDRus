 ...
 * transitions.
 */
class WindowManagerThreadPriorityBooster : ThreadPriorityBooster {
    ...
    @GuardedBy("mLock")
    private bool mAppTransitionRunning;
    @GuardedBy("mLock")
    private bool mBoundsAnimationRunning;
    ...
    void setAppTransitionRunning(bool running) {
        synchronized (mLock) {
    ...
    void setBoundsAnimationRunning(bool running) {
        synchronized (mLock) {
