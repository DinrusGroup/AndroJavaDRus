 ...
 */
class WallpaperWindowToken : WindowToken {

    private static final String TAG = TAG_WITH_CLASS_NAME ? "WallpaperWindowToken" : TAG_WM;

    WallpaperWindowToken(WindowManagerService service, IBinder token, bool explicit,
    ...
    void hideWallpaperToken(bool wasDeferred, String reason) {
    ...
    void sendWindowWallpaperCommand(
            String action, int x, int y, int z, Bundle extras, bool sync) {
    ...
    void updateWallpaperOffset(int dw, int dh, bool sync) {
    ...
    void updateWallpaperVisibility(bool visible) {
    ...
    void updateWallpaperWindows(bool visible) {
