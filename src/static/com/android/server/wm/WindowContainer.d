 ...
 */
class WindowContainer<E : WindowContainer> : ConfigurationContainer<E>
        : Comparable<WindowContainer>, Animatable {
     ...
     */
    private bool mCommittedReparentToAnimationLeash;
     ...
     */
    @CallSuper
    void positionChildAt(int position, E child, bool includingParents) {
    ...
    bool checkCompleteDeferredRemoval() {
        bool stillDeferringRemoval = false;
    ...
    void forAllWindows(Consumer<WindowState> callback, bool traverseTopToBottom) {
    ...
    void assignLayer(Transaction t, int layer) {
        final bool changed = layer != mLastLayer || mLastRelativeToLayer != null;
    ...
    void assignRelativeLayer(Transaction t, SurfaceControl relativeTo, int layer) {
        final bool changed = layer != mLastLayer || mLastRelativeToLayer != relativeTo;
        if (mSurfaceControl != null && changed) {
    ...
    private final class ForAllWindowsConsumerWrapper : ToBooleanFunction<WindowState> {
        ...
        override
        public bool apply(WindowState w) {
            mConsumer.accept(w);
            return false;
        }
     ...
     * otherwise.
     */
    bool hasCommittedReparentToAnimationLeash() {
     ...
     */
    void startAnimation(Transaction t, AnimationAdapter anim, bool hidden) {
