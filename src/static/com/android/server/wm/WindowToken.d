 ...
 */
class WindowToken : WindowContainer<WindowState> {
    ...
    final bool mRoundedCornerOverlay;
    ...
    bool sendingToBottom;

    // The display this token is on.
    protected DisplayContent mDisplayContent;

    /** The owner has {@link android.Manifest.permission#MANAGE_APP_TOKENS} */
    final bool mOwnerCanManageAppTokens;
    ...
    WindowToken(WindowManagerService service, IBinder _token, int type, bool persistOnEmpty,
            DisplayContent dc, bool ownerCanManageAppTokens) {
        this(service, _token, type, persistOnEmpty, dc, ownerCanManageAppTokens,
                false /* roundedCornersOverlay */);
    }

    WindowToken(WindowManagerService service, IBinder _token, int type, bool persistOnEmpty,
            DisplayContent dc, bool ownerCanManageAppTokens, bool roundedCornerOverlay) {
        super(service);
        token = _token;
        windowType = type;
    ...
    bool windowsCanBeWallpaperTarget() {
