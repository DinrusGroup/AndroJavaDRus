 ...
 */
class TaskSnapshotSurface : StartingSurface {
    ...
    Rect calculateSnapshotCrop() {
        ...
        final bool isTop = mTaskBounds.top == 0 && mFrame.top == 0;
    ...
    void drawBackgroundAndBars(Canvas c, Rect frame) {
        ...
        final bool fillHorizontally = c.getWidth() > frame.right;
        final bool fillVertically = c.getHeight() > frame.bottom;
        if (fillHorizontally) {
    ...
    @VisibleForTesting
    static class Window : BaseIWindow {
    ...
    static class SystemBarBackgroundPainter {
        ...
        int getStatusBarColorViewHeight() {
            final bool forceStatusBarBackground =
        ...
        private bool isNavigationBarColorViewVisible() {
        ...
        void drawNavigationBarBackground(Canvas c) {
            ...
            getNavigationBarRect(c.getWidth(), c.getHeight(), mStableInsets, mContentInsets,
                    navigationBarRect);
            final bool visible = isNavigationBarColorViewVisible();
