 ...
 */
class DisplayContent : WindowContainer<DisplayContent.DisplayChildWindowContainer> {
    ...
    private bool mTmpRecoveringMemory;
    private bool mUpdateImeTarget;
    private bool mTmpInitial;
    ...
    /** @see #computeCompatSmallestWidth(bool, int, int, int, int) */
     ...
     *
     * @see WindowManagerService#updateOrientationFromAppTokensLocked(bool, int)
     */
     ...
     * @see #updateRotationUnchecked()
     */
    private bool mAltOrientation = false;
     ...
     */
    private bool mLastWallpaperVisible = false;

    private Rect mBaseDisplayRect = new Rect();

    // Accessed directly by all users.
    private bool mLayoutNeeded;
     ...
     * DisplayManager.
     */
    bool mShouldOverrideDisplayConfiguration = true;
    ...
    private bool mHaveBootMsg = false;
    private bool mHaveApp = false;
    private bool mHaveWallpaper = false;
    private bool mHaveKeyguard = true;
    ...
    private bool mRemovingDisplay = false;

    // {@code false} if this display is in the processing of being created.
    private bool mDisplayReady = false;
    ...
    private final Consumer<WindowState> mPerformLayout = w -> {
        ...
        final bool gone = (mTmpWindow != null && mService.mPolicy.canBeHiddenByKeyguardLw(w))
                || w.isGoneForLayoutLw();
        ...
        if (!gone || !w.mHaveFrame || w.mLayoutNeeded
            ...
            if (!w.mLayoutAttached) {
                ...
                w.prelayout();
                final bool firstLayout = !w.isLaidOut();
    ...
    private final Consumer<WindowState> mApplySurfaceChangesTransaction = w -> {
        ...
        final bool obscuredChanged = w.mObscured !=
                mTmpApplySurfaceChangesTransactionState.obscured;
        final RootWindowContainer root = mService.mRoot;
        // Only used if default window
        final bool someoneLosingFocus = !mService.mLosingFocus.isEmpty();

        // Update effect.
        w.mObscured = mTmpApplySurfaceChangesTransactionState.obscured;
        if (!mTmpApplySurfaceChangesTransactionState.obscured) {
            final bool isDisplayed = w.isDisplayedLw();
        ...
        if (w.mHasSurface) {
            ...
            final bool committed = winAnimator.commitFinishDrawingLocked();
        ...
        if (atoken != null) {
            ...
            final bool updateAllDrawn = atoken.updateDrawnWindowStates(w);
    ...
    bool getAltOrientation() {
        return mAltOrientation;
    }

    void setAltOrientation(bool altOrientation) {
     ...
     *         {@link WindowManagerService#sendNewConfiguration(int)} TO UNFREEZE THE SCREEN.
     */
    bool updateRotationUnchecked(bool forceUpdate) {
        ...
        final bool oldAltOrientation = mAltOrientation;
        ...
        bool mayRotateSeamlessly = mService.mPolicy.shouldRotateSeamlessly(oldRotation,
                rotation);
        ...
        final bool rotateSeamlessly = mayRotateSeamlessly;
        ...
        final bool altOrientation = !mService.mPolicy.rotationHasCompatibleMetricsLw(
    ...
    private DisplayInfo updateDisplayAndOrientation(int uiMode) {
        ...
        final bool rotated = (mRotation == ROTATION_90 || mRotation == ROTATION_270);
    ...
    private WmDisplayCutout calculateDisplayCutoutForRotationUncached(
        ...
        final bool rotated = (rotation == ROTATION_90 || rotation == ROTATION_270);
    ...
    void computeScreenConfiguration(Configuration config) {
        ...
        final bool rotated = (displayInfo.rotation == Surface.ROTATION_90
        ...
        bool hardKeyboardAvailable = config.keyboard != Configuration.KEYBOARD_NOKEYS;
    ...
    private int computeCompatSmallestWidth(bool rotated, int uiMode, int dw, int dh,
            int displayId) {
    ...
    private void computeSizeRangesAndScreenLayout(DisplayInfo displayInfo, int displayId,
            bool rotated, int uiMode, int dw, int dh, float density, Configuration outConfig) {
    ...
    bool hasSplitScreenPrimaryStack() {
     ...
     */
    private bool skipTraverseChild(WindowContainer child) {
    ...
    bool forAllImeWindows(ToBooleanFunction<WindowState> callback, bool traverseTopToBottom) {
    ...
    private void updateBaseDisplayMetricsIfNeeded() {
        ...
        final bool rotated = (orientation == ROTATION_90 || orientation == ROTATION_270);
        final int newWidth = rotated ? mDisplayInfo.logicalHeight : mDisplayInfo.logicalWidth;
        final int newHeight = rotated ? mDisplayInfo.logicalWidth : mDisplayInfo.logicalHeight;
        final int newDensity = mDisplayInfo.logicalDensityDpi;
        final DisplayCutout newCutout = mDisplayInfo.displayCutout;

        final bool displayMetricsChanged = mInitialDisplayWidth != newWidth
        ...
        if (displayMetricsChanged) {
            ...
            final bool isDisplaySizeForced = mBaseDisplayWidth != mInitialDisplayWidth
                    || mBaseDisplayHeight != mInitialDisplayHeight;
            final bool isDisplayDensityForced = mBaseDisplayDensity != mInitialDisplayDensity;
    ...
    TaskStack createStack(int stackId, bool onTop, StackWindowController controller) {
    ...
    void moveStackToDisplay(TaskStack stack, bool onTop) {
    ...
    override
    void positionChildAt(int position, DisplayChildWindowContainer child, bool includingParents) {
    ...
    override
    bool checkCompleteDeferredRemoval() {
        final bool stillDeferringRemoval = super.checkCompleteDeferredRemoval();
    ...
    bool isRemovalDeferred() {
        return mDeferredRemoval;
    }

    bool animateForIme(float interpolatedValue, float animationTarget,
    ...
    void adjustForImeIfNeeded() {
        ...
        final bool imeVisible = imeWin != null && imeWin.isVisibleLw() && imeWin.isDisplayedLw()
                && !mDividerControllerLocked.isImeHideRequested();
        final bool dockVisible = isStackVisible(WINDOWING_MODE_SPLIT_SCREEN_PRIMARY);
        final TaskStack imeTargetStack = mService.getImeFocusStackLocked();
        final int imeDockSide = (dockVisible && imeTargetStack != null) ?
                imeTargetStack.getDockSide() : DOCKED_INVALID;
        final bool imeOnTop = (imeDockSide == DOCKED_TOP);
        final bool imeOnBottom = (imeDockSide == DOCKED_BOTTOM);
        final bool dockMinimized = mDividerControllerLocked.isMinimizedDock();
        final int imeHeight = mDisplayFrames.getInputMethodWindowVisibleHeight();
        final bool imeHeightChanged = imeVisible &&
        ...
        if (imeVisible && dockVisible && (imeOnTop || imeOnBottom) && !dockMinimized) {
            for (int i = mTaskStackContainers.getChildCount() - 1; i >= 0; --i) {
                final TaskStack stack = mTaskStackContainers.getChildAt(i);
                final bool isDockedOnBottom = stack.getDockSide() == DOCKED_BOTTOM;
    ...
    override
    public void dump(PrintWriter pw, String prefix, bool dumpAll) {
    ...
    bool isStackVisible(int windowingMode) {
    ...
    bool canAddToastWindowForUid(int uid) {
    ...
    void assignWindowLayers(bool setLayoutNeeded) {
     ...
     */
    WindowState computeImeTarget(bool updateImeTarget) {
    ...
    private void setInputMethodTarget(WindowState target, bool targetWaitingAnim) {
    ...
    bool getNeedsMenu(WindowState top, WindowManagerPolicy.WindowState bottom) {
    ...
    void dumpTokens(PrintWriter pw, bool dumpAll) {
     ...
     */
    void startKeyguardExitOnNonAppWindows(bool onWallpaper, bool goingToShade) {
        final WindowManagerPolicy policy = mService.mPolicy;
        forAllWindows(w -> {
    ...
    bool checkWaitingForWindows() {
        ...
        bool wallpaperEnabled = mService.mContext.getResources().getBoolean(
    ...
    bool inputMethodClientHasFocus(IInputMethodClient client) {
    ...
    void waitForAllWindowsDrawn() {
        final WindowManagerPolicy policy = mService.mPolicy;
        forAllWindows(w -> {
            final bool keyguard = policy.isKeyguardHostWindow(w.mAttrs);
    ...
    bool applySurfaceChangesTransaction(bool recoveringMemory) {
        ...
        final bool wallpaperVisible = mWallpaperController.isWallpaperVisible();
    ...
    private void calculateBounds(Rect out) {
        ...
        final int orientation = mDisplayInfo.rotation;
        bool rotated = (orientation == ROTATION_90 || orientation == ROTATION_270);
    ...
    void performLayout(bool initial, bool updateInputWindows) {
        if (!isLayoutNeeded()) {
            return;
        }
        clearLayoutNeeded();
    ...
    Bitmap screenshotDisplayLocked(Bitmap.Config config) {
        ...
        final bool inRotation = screenRotationAnimation != null &&
    ...
    void setExitingTokensHasVisible(bool hasVisible) {
        for (int i = mExitingTokens.size() - 1; i >= 0; i--) {
    ...
    private static final class ScreenshotApplicationState {
        ...
        void reset(bool screenshotReady) {
            appWin = null;
            maxLayer = 0;
            minLayer = 0;
     ...
     */
    static class DisplayChildWindowContainer<E : WindowContainer> : WindowContainer<E> {
     ...
     * I.e Activities.
     */
    private final class TaskStackContainers : DisplayChildWindowContainer<TaskStack> {
        /**
         ...
         * @see DisplayContent#createStack(int, bool, StackWindowController)
         */
        void addStackToDisplay(TaskStack stack, bool onTop) {
        ...
        private void addChild(TaskStack stack, bool toTop) {
        ...
        override
        void positionChildAt(int position, TaskStack child, bool includingParents) {
         ...
         */
        private int findPositionForStack(int requestedPosition, TaskStack stack, bool adding) {
            final int topChildPosition = mChildren.size() - 1;
            bool toTop = requestedPosition == POSITION_TOP;
        ...
        override
        bool forAllWindows(ToBooleanFunction<WindowState> callback,
        ...
        private bool forAllExitingAppTokenWindows(ToBooleanFunction<WindowState> callback,
                bool traverseTopToBottom) {
        ...
        int getOrientation() {
            ...
            bool isCar = mService.mContext.getPackageManager().hasSystemFeature(
    ...
    private final class AboveAppWindowContainers : NonAppWindowContainers {
        ...
        void assignChildLayers(SurfaceControl.Transaction t, WindowContainer imeContainer) {
            bool needAssignIme = imeContainer != null
     ...
     * Apps. E.g. status bar.
     */
    private class NonAppWindowContainers : DisplayChildWindowContainer<WindowToken> {
        /**
    ...
    private class NonMagnifiableWindowContainers : NonAppWindowContainers {
     ...
     */
    private bool canUpdateImeTarget() {
