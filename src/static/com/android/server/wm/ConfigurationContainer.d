 ...
 * hierarchy.
 */
public abstract class ConfigurationContainer<E : ConfigurationContainer> {
    /**
    ...
    private bool mHasOverrideConfiguration;
     ...
     */
    public bool equivalentOverrideBounds(Rect bounds) {
     ...
     */
    public static bool equivalentBounds(Rect bounds, Rect other) {
        return bounds == other
    ...
    public bool inSplitScreenWindowingMode() {
        /*@WindowConfiguration.WindowingMode*/ int windowingMode =
                mFullConfiguration.windowConfiguration.getWindowingMode();
    ...
    public bool inSplitScreenSecondaryWindowingMode() {
        /*@WindowConfiguration.WindowingMode*/ int windowingMode =
                mFullConfiguration.windowConfiguration.getWindowingMode();
    ...
    public bool inSplitScreenPrimaryWindowingMode() {
        return mFullConfiguration.windowConfiguration.getWindowingMode()
    ...
    public bool isActivityTypeHome() {
        return getActivityType() == ACTIVITY_TYPE_HOME;
    }

    public bool isActivityTypeRecents() {
        return getActivityType() == ACTIVITY_TYPE_RECENTS;
    }

    public bool isActivityTypeAssistant() {
        return getActivityType() == ACTIVITY_TYPE_ASSISTANT;
    }

    public bool isActivityTypeStandard() {
        return getActivityType() == ACTIVITY_TYPE_STANDARD;
    }

    public bool isActivityTypeStandardOrUndefined() {
    ...
    public bool hasCompatibleActivityType(ConfigurationContainer other) {
    ...
    public bool isCompatible(int windowingMode, int activityType) {
        ...
        final bool sameActivityType = thisActivityType == activityType;
        final bool sameWindowingMode = thisWindowingMode == windowingMode;
