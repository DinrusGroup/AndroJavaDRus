...
class ScreenRotationAnimation {
    ...
    static final bool DEBUG_STATE = false;
    static final bool DEBUG_TRANSFORMS = false;
    static final bool TWO_PHASE_ANIMATION = false;
    static final bool USE_CUSTOM_BLACK_FRAME = false;
    ...
    bool mStarted;
    bool mAnimRunning;
    bool mFinishAnimReady;
    long mFinishAnimStartTime;
    bool mForceDefaultOrientation;
    ...
    private bool mMoreRotateEnter;
    private bool mMoreRotateExit;
    private bool mMoreRotateFrame;
    private bool mMoreFinishEnter;
    private bool mMoreFinishExit;
    private bool mMoreFinishFrame;
    private bool mMoreStartEnter;
    private bool mMoreStartExit;
    private bool mMoreStartFrame;
    long mHalfwayPoint;
    ...
    public ScreenRotationAnimation(Context context, DisplayContent displayContent,
            bool forceDefaultOrientation, bool isSecure, WindowManagerService service) {
        mService = service;
        mContext = context;
    ...
    public bool setRotation(SurfaceControl.Transaction t, int rotation,
     ...
     */
    private bool startAnimation(SurfaceControl.Transaction t, long maxAnimationDuration,
            float animationScale, int finalWidth, int finalHeight, bool dismissing,
     ...
     * Returns true if animating.
     */
    public bool dismiss(SurfaceControl.Transaction t, long maxAnimationDuration,
    ...
    private bool stepAnimation(long now) {
        ...
        final bool more = (TWO_PHASE_ANIMATION
    ...
    public bool stepAnimationLocked(long now) {
        if (!hasAnimations()) {
