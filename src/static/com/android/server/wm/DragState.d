...
class DragState {
     ...
     */
    volatile bool mAnimationCompleted = false;
    ...
    private bool isValidDropTarget(WindowState targetWin) {
        if (targetWin == null) {
            return false;
        }
    ...
    private bool targetWindowSupportsGlobalDrag(WindowState targetWin) {
    ...
    private bool isWindowNotified(WindowState newWin) {
        for (WindowState ws : mNotifiedWindows) {
            if (ws == newWin) {
                return true;
            }
    ...
    private bool isFromSource(int source) {
