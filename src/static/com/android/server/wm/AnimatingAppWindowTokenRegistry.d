...
class AnimatingAppWindowTokenRegistry {
    ...
    private bool mEndingDeferredFinish;
     ...
     */
    bool notifyAboutToFinish(AppWindowToken token, Runnable endDeferFinishCallback) {
        final bool removed = mAnimatingTokens.remove(token);
        if (!removed) {
            return false;
        }
