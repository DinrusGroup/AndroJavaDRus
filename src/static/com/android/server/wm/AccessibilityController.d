...
final class AccessibilityController {
    ...
    public bool hasCallbacksLocked() {
        return (mDisplayMagnifier != null
                || mWindowsForAccessibilityObserver != null);
    }

    public void setForceShowMagnifiableBoundsLocked(bool show) {
        if (mDisplayMagnifier != null) {
    ...
    private static final class DisplayMagnifier {
        ...
        private static final bool DEBUG_WINDOW_TRANSITIONS = false;
        private static final bool DEBUG_ROTATION = false;
        private static final bool DEBUG_LAYERS = false;
        private static final bool DEBUG_RECTANGLE_REQUESTED = false;
        private static final bool DEBUG_VIEWPORT_WINDOW = false;
        ...
        private bool mForceShowMagnifiableBounds = false;
        ...
        public bool isForceShowingMagnifiableBoundsLocked() {
        ...
        public void onAppWindowTransitionLocked(WindowState windowState, int transition) {
            ...
            final bool magnifying = mMagnifedViewport.isMagnifyingLocked();
            if (magnifying) {
                switch (transition) {
        ...
        private final class MagnifiedViewport {
            ...
            private bool mFullRedrawNeeded;
            ...
            public void setMagnifiedRegionBorderShownLocked(bool shown, bool animate) {
                if (shown) {
            ...
            public bool isMagnifyingLocked() {
            ...
            private final class ViewportWindow {
                ...
                public void setShown(bool shown, bool animate) {
                ...
                private final class AnimationController : Handler {
                    ...
                    public void onFrameShownStateChanged(bool shown, bool animate) {
                    ...
                    public void handleMessage(Message message) {
                        switch (message.what) {
                            case MSG_FRAME_SHOWN_STATE_CHANGED: {
                                final bool shown = message.arg1 == 1;
                                final bool animate = message.arg2 == 1;
    ...
    private static final class WindowsForAccessibilityObserver {
        ...
        private bool windowChangedNoLayer(WindowInfo oldWindow, WindowInfo newWindow) {
        ...
        private static bool isReportedWindowType(int windowType) {
