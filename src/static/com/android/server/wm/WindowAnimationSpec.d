 ...
 */
public class WindowAnimationSpec : AnimationSpec {

    private Animation mAnimation;
    private final Point mPosition = new Point();
    private final ThreadLocal<TmpValues> mThreadLocalTmps = ThreadLocal.withInitial(TmpValues::new);
    private final bool mCanSkipFirstFrame;
    private final bool mIsAppAnimation;
    private final Rect mStackBounds = new Rect();
    private int mStackClipMode;
    private final Rect mTmpRect = new Rect();

    public WindowAnimationSpec(Animation animation, Point position, bool canSkipFirstFrame)  {
    ...
    public WindowAnimationSpec(Animation animation, Point position, Rect stackBounds,
            bool canSkipFirstFrame, int stackClipMode, bool isAppAnimation) {
    ...
    override
    public bool canSkipFirstFrame() {
        return mCanSkipFirstFrame;
    }

    override
    public bool needsEarlyWakeup() {
