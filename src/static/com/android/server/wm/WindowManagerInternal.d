...
public abstract class WindowManagerInternal {
    ...
    public interface IDragDropCallback {
        default bool registerInputChannel(
         ...
         */
        default bool prePerformDrag(IWindow window, IBinder dragToken,
         ...
         */
        default void preReportDropResult(IWindow window, bool consumed) {}
     ...
     */
    public abstract void setForceShowMagnifiableBounds(bool show);
    ...
    */
    public abstract bool isKeyguardShowingAndNotOccluded();
     ...
     */
    public abstract void removeWindowToken(android.os.IBinder token, bool removeWindows,
            int displayId);
    ...
    /**
      ...
      */
    public abstract bool isHardKeyboardAvailable();
    ...
    public abstract bool isStackVisible(int windowingMode);

    /**
     * @return True if and only if the docked divider is currently in resize mode.
     */
    public abstract bool isDockedDividerResizing();
