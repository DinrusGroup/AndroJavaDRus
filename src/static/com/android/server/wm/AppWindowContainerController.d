...
public class AppWindowContainerController
        : WindowContainerController<AppWindowToken, AppWindowContainerListener> {
    ...
    public AppWindowContainerController(TaskWindowContainerController taskController,
            ...
            int requestedOrientation, bool fullscreen, bool showForAllUsers, int configChanges,
            bool voiceInteraction, bool launchTaskBehind, bool alwaysFocusable,
    ...
    AppWindowToken createAppWindow(WindowManagerService service, IApplicationToken token,
            bool voiceInteraction, DisplayContent dc, long inputDispatchingTimeoutNanos,
            bool fullscreen, bool showForAllUsers, int targetSdk, int orientation,
            int rotationAnimationHint, int configChanges, bool launchTaskBehind,
            bool alwaysFocusable, AppWindowContainerController controller) {
    ...
    public Configuration setOrientation(int requestedOrientation, int displayId,
            Configuration displayConfig, bool freezeScreenIfNeeded) {
        synchronized(mWindowMap) {
            if (mContainer == null) {
                Slog.w(TAG_WM,
    ...
    public void setVisibility(bool visible, bool deferHidingClient) {
        synchronized(mWindowMap) {
            if (mContainer == null) {
    ...
    public bool addStartingWindow(String pkg, int theme, CompatibilityInfo compatInfo,
            CharSequence nonLocalizedLabel, int labelRes, int icon, int logo, int windowFlags,
            IBinder transferFrom, bool newTask, bool taskSwitch, bool processRunning,
            bool allowTaskSnapshot, bool activityCreated, bool fromRecents) {
        synchronized(mWindowMap) {
            ...
            if (theme != 0) {
                ...
                final bool windowIsTranslucent = ent.array.getBoolean(
                        com.android.internal.R.styleable.Window_windowIsTranslucent, false);
                final bool windowIsFloating = ent.array.getBoolean(
                        com.android.internal.R.styleable.Window_windowIsFloating, false);
                final bool windowShowWallpaper = ent.array.getBoolean(
                        com.android.internal.R.styleable.Window_windowShowWallpaper, false);
                final bool windowDisableStarting = ent.array.getBoolean(
    ...
    private int getStartingWindowType(bool newTask, bool taskSwitch, bool processRunning,
            bool allowTaskSnapshot, bool activityCreated, bool fromRecents,
    ...
    private bool createSnapshot(TaskSnapshot snapshot) {
        if (snapshot == null) {
            return false;
        }
    ...
    private bool snapshotOrientationSameAsTask(TaskSnapshot snapshot) {
        if (snapshot == null) {
            return false;
        }
    ...
    public void notifyAppResumed(bool wasStopped) {
        synchronized(mWindowMap) {
            if (mContainer == null) {
    ...
    public void stopFreezingScreen(bool force) {
        synchronized(mWindowMap) {
            if (mContainer == null) {
                return;
            }
    ...
    bool keyDispatchingTimedOut(String reason, int windowPid) {
     ...
     */
    public void setWillCloseOrEnterPip(bool willCloseOrEnterPip) {
        synchronized (mWindowMap) {
            if (mContainer == null) {
                return;
            }
