...
final class InputMonitor : InputManagerService.WindowManagerCallbacks {
    ...
    private bool mInputDispatchFrozen;
    ...
    private bool mInputDispatchEnabled;

    // When true, need to call updateInputWindowsLw().
    private bool mUpdateInputWindowsNeeded = true;
    ...
    private bool mAddInputConsumerHandle;
    private bool mAddPipInputConsumerHandle;
    private bool mAddWallpaperInputConsumerHandle;
    private bool mAddRecentsAnimationInputConsumerHandle;
    private bool mDisableWallpaperTouchEvents;
    ...
    private bool mInputDevicesReady;
    ...
    private static final class EventReceiverInputConsumer : InputConsumerImpl
    ...
    bool destroyInputConsumer(String name) {
    ...
    private bool disposeInputConsumer(InputConsumerImpl consumer) {
        if (consumer != null) {
    ...
    public long notifyANR(InputApplicationHandle inputApplicationHandle,
        ...
        if (appWindowToken != null && appWindowToken.appToken != null) {
            ...
            final bool abort = controller != null
    ...
    void addInputWindowHandle(final InputWindowHandle inputWindowHandle,
            final WindowState child, int flags, final int type, final bool isVisible,
            final bool hasFocus, final bool hasWallpaper) {
    ...
    void updateInputWindowsLw(bool force) {
        ...
        final bool inDrag = mService.mDragDropController.dragDropActiveLocked();
        if (inDrag) {
            if (DEBUG_DRAG) {
        ...
        final bool inPositioning = mService.mTaskPositioningController.isPositioningLocked();
        if (inPositioning) {
    ...
    public bool waitForInputDevicesReady(long timeoutMillis) {
        synchronized (mInputDevicesReadyMonitor) {
            if (!mInputDevicesReady) {
                try {
     ...
     */
    public void setInputFocusLw(WindowState newWindow, bool updateInputWindows) {
    ...
    public void setEventDispatchingLw(bool enabled) {
    ...
    private final class UpdateInputForAllWindowsConsumer : Consumer<WindowState> {
        ...
        private void updateInputWindows(bool inDrag) {
        ...
        public void accept(WindowState w) {
            ...
            final bool hasFocus = w == mInputFocus;
            final bool isVisible = w.isVisibleLw();
            ...
            final bool hasWallpaper = wallpaperController.isWallpaperTarget(w)
