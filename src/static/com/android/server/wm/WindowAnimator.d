...
public class WindowAnimator {
    ...
    private bool mLastRootAnimating;
    ...
    private bool mRemoveReplacedWindows = false;
     ...
     */
    private bool mAnimationFrameCallbackScheduled;
    ...
    private bool mInExecuteAfterPrepareSurfacesRunnables;
    ...
    private void animate(long frameTimeNs) {
        ...
        synchronized (mService.mWindowMap) {
            ...
            bool hasPendingLayoutChanges = mService.mRoot.hasPendingLayoutChanges(this);
            ...
            final bool rootAnimating = mService.mRoot.isSelfOrChildAnimating();
    ...
    public void dumpLocked(PrintWriter pw, String prefix, bool dumpAll) {
    ...
    void orAnimating(bool animating) {
        mAnimating |= animating;
    }
