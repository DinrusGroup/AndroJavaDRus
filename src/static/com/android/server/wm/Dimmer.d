...
class Dimmer {
    ...
    private class DimAnimatable : SurfaceAnimator.Animatable {
    ...
    interface SurfaceAnimatorStarter {
        void startAnimation(SurfaceAnimator surfaceAnimator, SurfaceControl.Transaction t,
                AnimationAdapter anim, bool hidden);
    }
     ...
     */
    bool updateDims(SurfaceControl.Transaction t, Rect bounds) {
        if (mDimState == null) {
            return false;
        }
    ...
    private static class AlphaAnimationSpec : LocalAnimationAdapter.AnimationSpec {
