...
class Task : WindowContainer<AppWindowToken> {
    ...
    final int mTaskId;
    final int mUserId;
    private bool mDeferRemoval = false;
    ...
    private bool mPreserveNonFloatingState = false;

    private Dimmer mDimmer = new Dimmer(this);
    private final Rect mTmpDimBoundsRect = new Rect();

    /** @see #setCanAffectSystemUiFlags */
    private bool mCanAffectSystemUiFlags = true;

    Task(int taskId, TaskStack stack, int userId, WindowManagerService service, int resizeMode,
            bool supportsPictureInPicture, TaskDescription taskDescription,
    ...
    override
    void positionChildAt(int position, AppWindowToken child, bool includingParents) {
        position = getAdjustedAddPosition(position);
        super.positionChildAt(position, child, includingParents);
        mDeferRemoval = false;
    }

    private bool hasWindowsAlive() {
    ...
    void reparent(TaskStack stack, int position, bool moveParents) {
        if (stack == mStack) {
     ...
     */
    bool preserveOrientationOnResize() {
     ...
     */
    void alignToAdjustedBounds(Rect adjustedBounds, Rect tempInsetBounds, bool alignBottom) {
     ...
     */
    bool getMaxVisibleBounds(Rect out) {
        bool foundTop = false;
        for (int i = mChildren.size() - 1; i >= 0; i--) {
    ...
    public void getDimBounds(Rect out) {
        ...
        final bool dockedResizing = displayContent != null
    ...
    void setDragResizing(bool dragResizing, int dragResizeMode) {
    ...
    void forceWindowsScaleable(bool force) {
     ...
     */
    void setCanAffectSystemUiFlags(bool canAffectSystemUiFlags) {
