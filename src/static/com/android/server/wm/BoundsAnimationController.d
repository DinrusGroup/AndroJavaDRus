...
public class BoundsAnimationController {
    private static final bool DEBUG_LOCAL = false;
    private static final bool DEBUG = DEBUG_LOCAL || DEBUG_ANIM;
    ...
    private final class AppTransitionNotifier
            : WindowManagerInternal.AppTransitionListener : Runnable {
    ...
    private bool mFinishAnimationAfterTransition = false;
    ...
    @VisibleForTesting
    final class BoundsAnimator : ValueAnimator
        ...
        // animation.
        private bool mMoveFromFullscreen;
        ...
        private bool mMoveToFullscreen;
        ...
        BoundsAnimator(BoundsAnimationTarget target, Rect from, Rect to,
                ...
                bool moveFromFullscreen, bool moveToFullscreen) {
            super();
            mTarget = target;
            mFrom.set(from);
            mTo.set(to);
         ...
         */
        bool isAnimatingTo(Rect bounds) {
    ...
    BoundsAnimator animateBoundsImpl(final BoundsAnimationTarget target, Rect from, Rect to,
        ...
        final bool replacing = existing != null;
