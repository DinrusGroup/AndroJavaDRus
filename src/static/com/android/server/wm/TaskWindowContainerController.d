...
public class TaskWindowContainerController
        : WindowContainerController<Task, TaskWindowContainerListener> {
    ...
    public TaskWindowContainerController(int taskId, TaskWindowContainerListener listener,
            ...
            bool supportsPictureInPicture, bool toTop, bool showForAllUsers,
    ...
    public void reparent(StackWindowController stackController, int position, bool moveParents) {
        synchronized (mWindowMap) {
    ...
    public void resize(bool relayout, bool forced) {
        synchronized (mWindowMap) {
            if (mContainer == null) {
     ...
     */
    public void setTaskDockedResizing(bool resizing) {
        synchronized (mWindowMap) {
            if (mContainer == null) {
