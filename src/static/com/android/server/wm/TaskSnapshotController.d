...
class TaskSnapshotController {
     ...
     */
    void notifyAppVisibilityChanged(AppWindowToken appWindowToken, bool visible) {
        if (!visible) {
     ...
     */
    @Nullable TaskSnapshot getSnapshot(int taskId, int userId, bool restoreFromDisk,
            bool reducedResolution) {
    ...
    private TaskSnapshot snapshotTask(Task task) {
        ...
        final bool hasVisibleChild = top.forAllWindows(
        ...
        final bool isLowRamDevice = ActivityManager.isLowRamDeviceStatic();
        ...
        final bool isWindowTranslucent = mainWindow.getAttrs().format != PixelFormat.OPAQUE;
    ...
    private bool shouldDisableSnapshots() {
     ...
     */
    void setPersisterPaused(bool paused) {
