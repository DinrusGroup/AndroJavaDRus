 ...
 * @hide
 */
public class ComprehensiveCountryDetector : CountryDetectorBase {

    private final static String TAG = "CountryDetector";
    /* package */ static final bool DEBUG = false;
    ...
    private bool isNetworkCountryCodeAvailable() {
     ...
     */
    private Country detectCountry(bool notifyChange, bool startLocationBasedDetection) {
    ...
    protected void runAfterDetectionAsync(final Country country, final Country detectedCountry,
            final bool notifyChange, final bool startLocationBasedDetection) {
    ...
    protected bool isAirplaneModeOff() {
    ...
    protected bool isGeoCoderImplemented() {
