 ...
 */
public class MediaSessionService : SystemService : Monitor {
    private static final String TAG = "MediaSessionService";
    static final bool USE_MEDIA2_APIS = false; // TODO: Change this to true when we're ready.
    static final bool DEBUG = Log.isLoggable(TAG, Log.DEBUG);
    // Leave log for key event always.
    private static final bool DEBUG_KEY_EVENT = true;
    ...
    private bool isGlobalPriorityActiveLocked() {
    ...
    private void registerPackageBroadcastReceivers() {
        ...
        getContext().registerReceiverAsUser(new BroadcastReceiver() {
            ...
            public void onReceive(Context context, Intent intent) {
                ...
                final bool isReplacing = intent.getBooleanExtra(Intent.EXTRA_REPLACING, false);
    ...
    private void buildMediaSessionService2List() {
        ...
        synchronized (mLock) {
            ...
            bool notifySessionTokensUpdated = false;
    ...
    private bool isCurrentVolumeController(int pid, int uid) {
     ...
     */
    private bool isEnabledNotificationListener(ComponentName compName, int userId,
            int forUserId) {
        if (userId != forUserId) {
     ...
     */
    final class FullUserRecord : MediaSessionStack.OnMediaButtonSessionChangedListener {
        ...
        private bool mInitialDownMusicOnly;
    ...
    final class SessionsListenerRecord : IBinder.DeathRecipient {
    ...
    class SessionManagerImpl : ISessionManager.Stub {
        private static final String EXTRA_WAKELOCK_ACQUIRED =
                "android.media.AudioService.WAKELOCK_ACQUIRED";
        private static final int WAKELOCK_RELEASE_ON_FINISHED = 1980; // magic number

        private bool mVoiceButtonDown = false;
        private bool mVoiceButtonHandled = false;
         ...
         */
        override
        public void dispatchMediaKeyEvent(String packageName, bool asSystemService,
                KeyEvent keyEvent, bool needWakeLock) {
            ...
            try {
                ...
                synchronized (mLock) {
                    bool isGlobalPriorityActive = isGlobalPriorityActiveLocked();
         ...
         */
        override
        public void dispatchVolumeKeyEvent(String packageName, bool asSystemService,
                KeyEvent keyEvent, int stream, bool musicOnly) {
            if (keyEvent == null ||
        ...
        private void dispatchVolumeKeyEventLocked(String packageName, int pid, int uid,
                bool asSystemService, KeyEvent keyEvent, int stream, bool musicOnly) {
            bool down = keyEvent.getAction() == KeyEvent.ACTION_DOWN;
            bool up = keyEvent.getAction() == KeyEvent.ACTION_UP;
            int direction = 0;
            bool isMute = false;
        ...
        override
        public bool isGlobalPriorityActive() {
            synchronized (mLock) {
                return isGlobalPriorityActiveLocked();
            }
        }
         ...
         */
        override
        public bool isTrusted(String controllerPackageName, int controllerPid, int controllerUid)
                throws RemoteException {
            final int uid = Binder.getCallingUid();
            final long token = Binder.clearCallingIdentity();
            try {
         ...
         */
        override
        public bool createSession2(Bundle sessionToken) {
            if (!USE_MEDIA2_APIS) {
                return false;
            }
            final int uid = Binder.getCallingUid();
        ...
        override
        public List<Bundle> getSessionTokens(bool activeSessionOnly,
                bool sessionServiceOnly, String packageName) throws RemoteException {
            if (!USE_MEDIA2_APIS) {
                return null;
            }
            final int pid = Binder.getCallingPid();
            ...
            try {
                ...
                synchronized (mLock) {
                    for (Map.Entry<SessionToken2, MediaController2> record
                        ...
                        bool isSessionService = (record.getKey().getType() != TYPE_SESSION);
                        bool isActive = record.getValue() != null;
        ...
        // For MediaSession2
        private bool hasMediaControlPermission(int resolvedUserId, String packageName,
        ...
        private void dispatchAdjustVolumeLocked(String packageName, int pid, int uid,
                bool asSystemService, int suggestedStream, int direction, int flags) {
            MediaSessionRecord session = isGlobalPriorityActiveLocked() ? mGlobalPrioritySession
                    : mCurrentFullUserRecord.mPriorityStack.getDefaultVolumeSession();

            bool preferSuggestedStream = false;
        ...
        private void handleVoiceKeyEventLocked(String packageName, int pid, int uid,
                bool asSystemService, KeyEvent keyEvent, bool needWakeLock) {
            int action = keyEvent.getAction();
            bool isLongPress = (keyEvent.getFlags() & KeyEvent.FLAG_LONG_PRESS) != 0;
        ...
        private void startVoiceInput(bool needWakeLock) {
            ...
            bool isLocked = mKeyguardManager != null && mKeyguardManager.isKeyguardLocked();
        ...
        private bool isVoiceKey(int keyCode) {
            return keyCode == KeyEvent.KEYCODE_HEADSETHOOK
                    || (!mHasFeatureLeanback && keyCode == KeyEvent.KEYCODE_MEDIA_PLAY_PAUSE);
        }

        private bool isUserSetupComplete() {
            return Settings.Secure.getIntForUser(getContext().getContentResolver(),
                    Settings.Secure.USER_SETUP_COMPLETE, 0, UserHandle.USER_CURRENT) != 0;
        }

        // we only handle public stream types, which are 0-5
        private bool isValidLocalStreamType(int streamType) {
            return streamType >= AudioManager.STREAM_VOICE_CALL
                    && streamType <= AudioManager.STREAM_NOTIFICATION;
        }

        private class MediaKeyListenerResultReceiver : ResultReceiver : Runnable {
            private final String mPackageName;
            private final int mPid;
            private final int mUid;
            private final bool mAsSystemService;
            private final KeyEvent mKeyEvent;
            private final bool mNeedWakeLock;
        ...
        class KeyEventWakeLockReceiver : ResultReceiver : Runnable,
    ...
    final class MessageHandler : Handler {
    ...
    private class ControllerCallback : MediaController2.ControllerCallback {
    ...
    private final class SessionTokensListenerRecord : IBinder.DeathRecipient {
    ...
    private bool addSessionRecordLocked(SessionToken2 token) {
        return addSessionRecordLocked(token, null);
    }

    private bool addSessionRecordLocked(SessionToken2 token, MediaController2 controller) {
    ...
    private bool removeSessionRecordLocked(SessionToken2 token) {
