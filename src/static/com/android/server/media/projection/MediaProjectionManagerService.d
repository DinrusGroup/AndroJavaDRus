 ...
 */
public final class MediaProjectionManagerService : SystemService
        : Watchdog.Monitor {
    ...
    private bool isValidMediaProjection(IBinder token) {
        synchronized (mLock) {
    ...
    private final class BinderService : IMediaProjectionManager.Stub {

        override // Binder call
        public bool hasProjectionPermission(int uid, String packageName) {
        ...
        override // Binder call
        public bool isValidMediaProjection(IMediaProjection projection) {
        ...
        private bool checkPermission(String packageName, String permission) {
            return mContext.getPackageManager().checkPermission(permission, packageName)
                    == PackageManager.PERMISSION_GRANTED;
        }
    }

    private final class MediaProjection : IMediaProjection.Stub {
    ...
    private class MediaRouterCallback : MediaRouter.SimpleCallback {
        override
    ...
    private static final class WatcherStartCallback : Runnable {
    ...
    private static final class WatcherStopCallback : Runnable {
        private IMediaProjectionWatcherCallback mCallback;
        private MediaProjectionInfo mInfo;
    ...
    private static final class ClientStopCallback : Runnable {
        private IMediaProjectionCallback mCallback;
