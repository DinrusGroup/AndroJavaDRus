...
class MediaSessionStack {
    private static final bool DEBUG = MediaSessionService.DEBUG;
     ...
     */
    public bool contains(MediaSessionRecord record) {
     ...
     */
    public ArrayList<MediaSessionRecord> getPriorityList(bool activeOnly, int userId) {
    ...
    private bool shouldUpdatePriority(int oldState, int newState) {
    ...
    private bool containsState(int state, int[] states) {
