 ...
 * </p>
 */
public final class MediaRouterService : IMediaRouterService.Stub
        : Watchdog.Monitor {
    ...
    bool mGlobalBluetoothA2dpOn = false;
    ...
    public MediaRouterService(Context context) {
        ...
        mAudioPlayerStateMonitor.registerListener(
            ...
            public void onAudioPlayerActiveStateChanged(
                    @NonNull AudioPlaybackConfiguration config, bool isRemoved) {
                final bool active = !isRemoved && config.isActive();
    ...
    public void registerClientAsUser(IMediaRouterClient client, String packageName, int userId) {
        ...
        final bool trusted = mContext.checkCallingOrSelfPermission(
    ...
    // Binder call
    override
    public bool isPlaybackActive(IMediaRouterClient client) {
        if (client == null) {
            throw new IllegalArgumentException("client must not be null");
        }
    ...
    public void setDiscoveryRequest(IMediaRouterClient client,
            int routeTypes, bool activeScan) {
        if (client == null) {
            throw new IllegalArgumentException("client must not be null");
        }
    ...
    override
    public void setSelectedRoute(IMediaRouterClient client, String routeId, bool explicit) {
        if (client == null) {
            throw new IllegalArgumentException("client must not be null");
        }
    ...
    private void registerClientLocked(IMediaRouterClient client,
            int uid, int pid, String packageName, int userId, bool trusted) {
    ...
    private void unregisterClientLocked(IMediaRouterClient client, bool died) {
    ...
    private void disposeClientLocked(ClientRecord clientRecord, bool died) {
        if (DEBUG) {
            if (died) {
    ...
    final class MediaRouterServiceBroadcastReceiver : BroadcastReceiver {
        override
        public void onReceive(Context context, Intent intent) {
     ...
     */
    final class ClientRecord : DeathRecipient {
        public final UserRecord mUserRecord;
        public final IMediaRouterClient mClient;
        public final int mUid;
        public final int mPid;
        public final String mPackageName;
        public final bool mTrusted;

        public int mRouteTypes;
        public bool mActiveScan;
        public String mSelectedRouteId;

        public ClientRecord(UserRecord userRecord, IMediaRouterClient client,
                int uid, int pid, String packageName, bool trusted) {
     ...
     * </p>
     */
    static final class UserHandler : Handler
        ...
        private bool mClientStateUpdateScheduled;
        ...
        static final class ProviderRecord {
            ...
            public bool updateDescriptor(RemoteDisplayState descriptor) {
                bool changed = false;
        ...
        static final class RouteRecord {
            ...
            public bool updateDescriptor(RemoteDisplayInfo descriptor) {
                bool changed = false;
                if (mDescriptor != descriptor) {
                    mDescriptor = descriptor;
                    if (descriptor != null) {
                        ...
                        final bool enabled = computeEnabled(descriptor);
            ...
            private static bool computeEnabled(RemoteDisplayInfo descriptor) {
