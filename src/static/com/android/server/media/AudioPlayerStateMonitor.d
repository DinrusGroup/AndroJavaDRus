 ...
 */
class AudioPlayerStateMonitor : IPlaybackConfigDispatcher.Stub {
    private static bool DEBUG = MediaSessionService.DEBUG;
    ...
    private final static class MessageHandler : Handler {
        ...
        void sendAudioPlayerActiveStateChangedMessage(
                final AudioPlaybackConfiguration config, final bool isRemoved) {
    ...
    @GuardedBy("mLock")
    private bool mRegisteredToAudioService;
        ...
        try {
            synchronized (mLock) {
                ...
                for (AudioPlaybackConfiguration config : configs) {
                    ...
                    bool wasActive = mPrevActiveAudioPlaybackConfigs.remove(pii) != null;
     ...
     */
    public bool isPlaybackActive(int uid) {
        synchronized (mLock) {
