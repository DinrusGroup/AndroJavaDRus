 ...
 */
public class MediaSessionRecord : IBinder.DeathRecipient {
    ...
    public void adjustVolume(String packageName, int pid, int uid,
            ISessionControllerCallback caller, bool asSystemService, int direction, int flags,
            bool useSuggested) {
    ...
    public void sendMediaButton(String packageName, int pid, int uid, bool asSystemService,
    ...
    private void postAdjustLocalVolume(final int stream, final int direction, final int flags,
            final String packageName, final int uid, final bool useSuggested,
    ...
    private final Runnable mClearOptimisticVolumeRunnable = new Runnable() {
        override
        public void run() {
            bool needUpdate = (mOptimisticVolume != mCurrentVolume);
            mOptimisticVolume = -1;
            if (needUpdate) {
                pushVolumeUpdate();
            }
    ...
    private final class SessionStub : ISession.Stub {
        override
        public void destroy() {
    ...
    class SessionCb {
        ...
        public bool sendMediaButton(String packageName, int pid, int uid,
                bool asSystemService, KeyEvent keyEvent, int sequenceId, ResultReceiver cb) {
            try {
                if (asSystemService) {
        ...
        public bool sendMediaButton(String packageName, int pid, int uid,
                ISessionControllerCallback caller, bool asSystemService,
                KeyEvent keyEvent) {
            try {
                if (asSystemService) {
                    mCb.onMediaButton(mContext.getPackageName(), Process.myPid(),
        ...
        public void adjustVolume(String packageName, int pid, int uid,
                ISessionControllerCallback caller, bool asSystemService, int direction) {
            try {
                if (asSystemService) {
    ...
    class ControllerStub : ISessionController.Stub {
        override
        ...
        override
        public bool sendMediaButton(String packageName, ISessionControllerCallback cb,
                bool asSystemService, KeyEvent keyEvent) {
        ...
        public void adjustVolume(String packageName, ISessionControllerCallback caller,
                bool asSystemService, int direction, int flags) {
