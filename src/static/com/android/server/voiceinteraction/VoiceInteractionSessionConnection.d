...
final class VoiceInteractionSessionConnection : ServiceConnection,
    ...
    public bool showLocked(Bundle args, int flags, int disabledContext,
        ...
        if (mBound) {
            ...
            bool needDisclosure = mAssistDataRequester.getPendingDataCount() > 0
    ...
    override
    public bool canHandleReceivedAssistDataLocked() {
    ...
    public void cancelLocked(bool finishTask) {
        hideLocked();
        mCanceled = true;
        if (mBound) {
            if (mSession != null) {
    ...
    public bool deliverNewSessionLocked(IVoiceInteractionSession session,
