 ...
 */
public class VoiceInteractionManagerService : SystemService {
    ...
    class LocalService : VoiceInteractionManagerInternal {
        override
        ...
        override
        public bool supportsLocalVoiceInteraction() {
    ...
    class VoiceInteractionManagerServiceStub : IVoiceInteractionManagerService.Stub {

        VoiceInteractionManagerServiceImpl mImpl;

        private bool mSafeMode;
        private int mCurUser;
        private bool mCurUserUnlocked;
        private final bool mEnableService;
        ...
        private bool shouldEnableService(Context context) {
        ...
        public void systemRunning(bool safeMode) {
            mSafeMode = safeMode;
        ...
        void switchImplementationIfNeeded(bool force) {
            synchronized (this) {
                switchImplementationIfNeededLocked(force);
            }
        }

        void switchImplementationIfNeededLocked(bool force) {
            if (!mSafeMode) {
                ...
                final bool hasComponent = serviceComponent != null && serviceInfo != null;
        ...
        override
        public bool deliverNewSession(IBinder token, IVoiceInteractionSession session,
        ...
        override
        public bool showSessionFromSession(IBinder token, Bundle sessionArgs, int flags) {
            synchronized (this) {
                if (mImpl == null) {
        ...
        override
        public bool hideSessionFromSession(IBinder token) {
            synchronized (this) {
                if (mImpl == null) {
        ...
        override
        public void setKeepAwake(IBinder token, bool keepAwake) {
            synchronized (this) {
                if (mImpl == null) {
        ...
        //----------------- SoundTrigger APIs --------------------------------//
        override
        public bool isEnrolledForKeyphrase(IVoiceInteractionService service, int keyphraseId,
                String bcp47Locale) {
            synchronized (this) {
                if (mImpl == null || mImpl.mService == null
                        || service.asBinder() != mImpl.mService.asBinder()) {
        ...
        override
        public bool showSessionForActiveService(Bundle args, int sourceFlags,
        ...
        override
        public bool activeServiceSupportsAssist() {
            enforceCallingPermission(Manifest.permission.ACCESS_VOICE_INTERACTION_SERVICE);
            synchronized (this) {
        ...
        override
        public bool activeServiceSupportsLaunchFromKeyguard() throws RemoteException {
            enforceCallingPermission(Manifest.permission.ACCESS_VOICE_INTERACTION_SERVICE);
            synchronized (this) {
