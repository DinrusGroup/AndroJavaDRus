...
public class DatabaseHelper : SQLiteOpenHelper {
     ...
     */
    public bool updateKeyphraseSoundModel(KeyphraseSoundModel soundModel) {
        synchronized(this) {
     ...
     */
    public bool deleteKeyphraseSoundModel(int keyphraseId, int userHandle, String bcp47Locale) {
            ...
            try {
                if (c.moveToFirst()) {
                    do {
                        ...
                        bool isAvailableForCurrentUser = false;
                        for (int user : users) {
                            if (userHandle == user) {
    ...
    private static class SoundModelRecord {
        ...
        private bool V6PrimaryKeyMatches(SoundModelRecord record) {
        ...
        public bool ifViolatesV6PrimaryKeyIsFirstOfAnyDuplicates(
        ...
        static private bool stringComparisonHelper(String a, String b) {
          if (a != null) {
            return a.equals(b);
          }
          return a == b;
