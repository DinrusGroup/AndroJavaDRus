...
class VoiceInteractionManagerServiceImpl : VoiceInteractionSessionConnection.Callback {
    ...
    public bool showSessionLocked(Bundle args, int flags,
    ...
    public bool deliverNewSessionLocked(IBinder token,
    ...
    public void setKeepAwakeLocked(IBinder token, bool keepAwake) {
        try {
            if (mActiveSession == null || token != mActiveSession.mToken) {
    ...
    public void finishLocked(IBinder token, bool finishTask) {
