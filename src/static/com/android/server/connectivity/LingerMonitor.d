...
public class LingerMonitor {
    ...
    private static bool hasTransport(NetworkAgentInfo nai, int transport) {
    ...
    private bool everNotified(NetworkAgentInfo nai) {
        return mEverNotified.get(nai.network.netId, false);
    }

    @VisibleForTesting
    public bool isNotificationEnabled(NetworkAgentInfo fromNai, NetworkAgentInfo toNai) {
    ...
    private void notify(NetworkAgentInfo fromNai, NetworkAgentInfo toNai, bool forceToast) {
        int notifyType =
    ...
    public void noteLingerDefaultNetwork(NetworkAgentInfo fromNai, NetworkAgentInfo toNai) {
        ...
        bool forceToast = fromNai.networkCapabilities.hasCapability(
    ...
    private bool isRateLimited(long now) {
    ...
    private bool isAboveDailyLimit(long now) {
