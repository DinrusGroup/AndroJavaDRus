 ...
 * {@hide}
 */
public class NetworkMonitor : StateMachine {
    ...
    static enum EvaluationResult {
        ...
        EvaluationResult(bool isValidated) {
    ...
    static enum ValidationStage {
        ...
        ValidationStage(bool isFirstValidation) {
    ...
    @VisibleForTesting
    protected bool mIsCaptivePortalCheckEnabled;
    ...
    private bool mUserDoesNotWant = false;
    // Avoids surfacing "Sign in to network" notification.
    private bool mDontDisplaySigninNotification = false;
    ...
    private class MaybeNotifyState : State {
        override
        public bool processMessage(Message message) {
            switch (message.what) {
    ...
    private class EvaluatingState : State {
    ...
    private class CustomIntentReceiver : BroadcastReceiver {
    ...
    private class CaptivePortalState : State {
    ...
    private class EvaluatingPrivateDnsState : State {
        ...
        private bool isStrictModeHostnameResolved() {
        ...
        private bool sendPrivateDnsProbe() {
    ...
    private static class OneAddressPerFamilyNetwork : Network {
    ...
    public bool getIsCaptivePortalCheckEnabled() {
    ...
    private CaptivePortalProbeResult sendParallelHttpProbes(
        ...
        final class ProbeThread : Thread {
            private final bool mIsHttps;
            private volatile CaptivePortalProbeResult mResult = CaptivePortalProbeResult.FAILED;

            public ProbeThread(bool isHttps) {
                mIsHttps = isHttps;
            }
     ...
     */
    private void sendNetworkConditionsBroadcast(bool responseReceived, bool isCaptivePortal,
    ...
    private void logValidationProbe(long durationMs, int probeType, int probeResult) {
        int[] transports = mNetworkAgentInfo.networkCapabilities.getTransportTypes();
        bool isFirstValidation = validationStage().isFirstValidation;
    ...
    @VisibleForTesting
    public static class DefaultNetworkMonitorSettings : NetworkMonitorSettings {
