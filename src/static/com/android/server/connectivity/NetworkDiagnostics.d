...
public class NetworkDiagnostics {
    ...
    public class Measurement {
        ...
        public bool checkSucceeded() { return succeeded; }
    ...
    private class SimpleSocketCheck : Closeable {
    ...
    private class IcmpCheck : SimpleSocketCheck : Runnable {
        ...
        public void run() {
            ...
            final byte[] icmpPacket = {
                    cast(byte) mIcmpType, 0, 0, 0, 0, 0, 0, 0  // ICMP header
            };
            ...
            while (now() < mDeadlineTime - (TIMEOUT_SEND + TIMEOUT_RECV)) {
                count++;
                icmpPacket[icmpPacket.length - 1] = cast(byte) count;
                try {
    ...
    private class DnsUdpCheck : SimpleSocketCheck : Runnable {
        private static final int TIMEOUT_SEND = 100;
        ...
        private byte[] getDnsQueryPacket(String sixRandomDigits) {
            ...
            return new byte[] {
                cast(byte) mRandom.nextInt(), cast(byte) mRandom.nextInt(),  // [0-1]   query ID
