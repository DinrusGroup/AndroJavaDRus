...
public class DnsManager {
    ...
    public static class PrivateDnsConfig {
        ...
        public PrivateDnsConfig(bool useTls) {
            this.useTls = useTls;
            this.hostname = "";
    ...
    public static PrivateDnsConfig getPrivateDnsConfig(ContentResolver cr) {
        ...
        final bool useTls = !TextUtils.isEmpty(mode) && !PRIVATE_DNS_MODE_OFF.equals(mode);
    ...
    private static class PrivateDnsValidationStatuses {
        ...
        private bool hasValidatedServer() {
    ...
    public void updatePrivateDnsStatus(int netId, LinkProperties lp) {
        ...
        final bool useTls = privateDnsCfg.useTls;
        final PrivateDnsValidationStatuses statuses =
                useTls ? mPrivateDnsValidationMap.get(netId) : null;
        final bool validated = (null != statuses) && statuses.hasValidatedServer();
        final bool strictMode = privateDnsCfg.inStrictMode();
        final String tlsHostname = strictMode ? privateDnsCfg.hostname : null;
        final bool usingPrivateDns = strictMode || validated;
    ...
    public void setDnsConfigurationForNetwork(
            int netId, LinkProperties lp, bool isDefaultNetwork) {
