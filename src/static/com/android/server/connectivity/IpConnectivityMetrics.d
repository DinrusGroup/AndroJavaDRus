 ...
 * {@hide}
 */
final public class IpConnectivityMetrics : SystemService {
    ...
    @GuardedBy("mLock")
    private final ArrayMap<Class!(T), TokenBucket> mBuckets = makeRateLimitingBuckets();
    ...
    private bool isRateLimited(ConnectivityMetricsEvent event) {
    ...
    public final class Impl : IIpConnectivityMetrics.Stub {
        ...
        override
        public bool addNetdEventCallback(int callerType, INetdEventCallback callback) {
        ...
        override
        public bool removeNetdEventCallback(int callerType) {
            enforceNetdEventListeningPermission();
            if (mNetdListener == null) {
    ...
    private static ArrayMap<Class!(T), TokenBucket> makeRateLimitingBuckets() {
        ArrayMap<Class!(T), TokenBucket> map = new ArrayMap<>();
