...
public class PacManager {
    ...
    private volatile bool mHasSentBroadcast;
    private volatile bool mHasDownloaded;
    ...
    class PacRefreshIntentReceiver : BroadcastReceiver {
     ...
     */
    public synchronized bool setCurrentProxyScriptUrl(ProxyInfo proxy) {
    ...
    private bool setCurrentProxyScript(String script) {
        if (mProxyService == null) {
