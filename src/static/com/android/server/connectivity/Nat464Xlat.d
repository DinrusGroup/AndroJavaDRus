 ...
 * @hide
 */
public class Nat464Xlat : BaseNetworkObserver {
     ...
     */
    public static bool requiresClat(NetworkAgentInfo nai) {
        // TODO: migrate to NetworkCapabilities.TRANSPORT_*.
        final bool supported = ArrayUtils.contains(NETWORK_TYPES, nai.networkInfo.getType());
        final bool connected = ArrayUtils.contains(NETWORK_STATES, nai.networkInfo.getState());
        // We only run clat on networks that don't have a native IPv4 address.
        final bool hasIPv4Address =
     ...
     */
    private void handleInterfaceLinkStateChanged(String iface, bool up) {
