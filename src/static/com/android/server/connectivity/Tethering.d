 ...
 */
public class Tethering : BaseNetworkObserver {

    private final static String TAG = Tethering.class.getSimpleName();
    private final static bool DBG = false;
    private final static bool VDBG = false;
    ...
    private bool mRndisEnabled;       // track the RNDIS function enabled state
    // True iff. WiFi tethering should be started when soft AP is ready.
    private bool mWifiTetherRequested;
     ...
     *
     * @return a bool - {@code true} indicating tether provisioning is required by the carrier.
     */
    @VisibleForTesting
    protected bool isTetherProvisioningRequired() {
        final TetheringConfiguration cfg = mConfig;
    ...
    private bool carrierConfigAffirmsEntitlementCheckNotRequired() {
        ...
        final bool isEntitlementCheckRequired = carrierConfig.getBoolean(
     ...
     */
    private void enableTetheringInternal(int type, bool enable, ResultReceiver receiver) {
        bool isProvisioningRequired = enable && isTetherProvisioningRequired();
        int result;
        switch (type) {
            case TETHERING_WIFI:
    ...
    private int setWifiTethering(final bool enable) {
    ...
    private void setBluetoothTethering(final bool enable, final ResultReceiver receiver) {
    ...
    private void sendTetherStateChangedBroadcast() {
        ...
        bool wifiTethered = false;
        bool usbTethered = false;
        bool bluetoothTethered = false;
    ...
    @VisibleForTesting
    protected void showTetheredNotification(int id, bool tetheringOn) {
    ...
    private class StateReceiver : BroadcastReceiver {
        ...
        private void handleUsbAction(Intent intent) {
            final bool usbConnected = intent.getBooleanExtra(USB_CONNECTED, false);
            final bool usbConfigured = intent.getBooleanExtra(USB_CONFIGURED, false);
            final bool rndisEnabled = intent.getBooleanExtra(USB_FUNCTION_RNDIS, false);
    ...
    @VisibleForTesting
    protected static class TetheringUserRestrictionListener : UserRestrictionsListener {
        ...
        public void onUserRestrictionsChanged(int userId,
            ...
            final bool tetheringDisallowedChanged = (newlyDisallowed != previouslyDisallowed);
            ...
            final bool isTetheringActiveOnDevice = (mWrapper.getTetheredIfaces().length != 0);
    ...
    public bool hasTetherableConfiguration() {
        final TetheringConfiguration cfg = mConfig;
        final bool hasDownstreamConfiguration =
                (cfg.tetherableUsbRegexs.length != 0) ||
                (cfg.tetherableWifiRegexs.length != 0) ||
                (cfg.tetherableBluetoothRegexs.length != 0);
        final bool hasUpstreamConfiguration = !cfg.preferredUpstreamIfaceTypes.isEmpty();
    ...
    private bool pertainsToCurrentUpstream(NetworkState ns) {
    ...
    class TetherMasterSM : StateMachine {
        ...
        protected bool turnOnMasterTetherSettings() {
            final TetheringConfiguration cfg = mConfig;
            try {
        ...
        protected bool turnOffMasterTetherSettings() {
            try {
                mNMService.stopTethering();
            } catch (Exception e) {
                mLog.e(e);
        ...
        protected void chooseUpstreamType(bool tryCell) {
        ...
        class TetherModeAliveState : State {
            bool mUpstreamWanted = false;
            bool mTryCell = true;
            ...
            private bool updateUpstreamWanted() {
                final bool previousUpstreamWanted = mUpstreamWanted;
            ...
            public bool processMessage(Message message) {
                ...
                switch (message.what) {
                    case EVENT_IFACE_SERVING_STATE_ACTIVE: {
                        ...
                        final bool previousUpstreamWanted = updateUpstreamWanted();
        ...
        class SetIpForwardingEnabledErrorState : ErrorState {
            override
            public void enter() {
        ...
        class SetIpForwardingDisabledErrorState : ErrorState {
            override
            public void enter() {
        ...
        class StartTetheringErrorState : ErrorState {
            override
            public void enter() {
        ...
        class StopTetheringErrorState : ErrorState {
            override
            public void enter() {
        ...
        class SetDnsForwardersErrorState : ErrorState {
            override
            public void enter() {
    ...
    private static bool argsContain(String[] args, String target) {
        for (String arg : args) {
