...
public class TetheringConfiguration {
    ...
    public final bool isDunRequired;
    ...
    public bool isUsb(String iface) {
        return matchesDownstreamRegexs(iface, tetherableUsbRegexs);
    }

    public bool isWifi(String iface) {
        return matchesDownstreamRegexs(iface, tetherableWifiRegexs);
    }

    public bool isBluetooth(String iface) {
        return matchesDownstreamRegexs(iface, tetherableBluetoothRegexs);
    }

    public bool hasMobileHotspotProvisionApp() {
    ...
    private static bool matchesDownstreamRegexs(String iface, String[] regexs) {
    ...
    private static bool containsOneOf(ArrayList<Integer> list, Integer... values) {
