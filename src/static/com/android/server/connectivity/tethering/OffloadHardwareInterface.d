...
public class OffloadHardwareInterface {
    ...
    private static native bool configOffload();
    ...
    public bool initOffloadConfig() {
        return configOffload();
    }

    public bool initOffloadControl(ControlCallback controlCb) {
    ...
    public bool setLocalPrefixes(ArrayList<String> localPrefixes) {
    ...
    public bool setDataLimit(String iface, long limit) {
    ...
    public bool setUpstreamParameters(
    ...
    public bool addDownstreamPrefix(String ifname, String prefix) {
    ...
    public bool removeDownstreamPrefix(String ifname, String prefix) {
    ...
    private static class TetheringOffloadCallback : ITetheringOffloadCallback.Stub {
