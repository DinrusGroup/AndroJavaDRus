...
public class OffloadController {
    ...
    private bool mConfigInitialized;
    private bool mControlInitialized;
    ...
    private class OffloadTetheringStatsProvider : ITetheringStatsProvider.Stub {
        override
    ...
    private bool maybeUpdateDataLimit(String iface) {
    ...
    private bool isOffloadDisabled() {
    ...
    private bool pushUpstreamParameters(String prevUpstream) {
        final String iface = currentUpstreamInterface();

        if (TextUtils.isEmpty(iface)) {
            final bool rval = mHwInterface.setUpstreamParameters("", ANYIP, ANYIP, null);
        ...
        bool success = mHwInterface.setUpstreamParameters(
    ...
    private bool computeAndPushLocalPrefixes(UpdateType how) {
        final bool force = (how == UpdateType.FORCE);
    ...
    private static bool shouldIgnoreDownstreamRoute(RouteInfo route) {
