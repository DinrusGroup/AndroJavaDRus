 ...
 */
public class DeviceStorageMonitorService : SystemService {
    ...
    private static class State {
         ...
         * and {@link #LEVEL_FULL}.
         */
        private static bool isEntering(int level, int oldLevel, int newLevel) {
         ...
         */
        private static bool isLeaving(int level, int oldLevel, int newLevel) {
            return newLevel < level && (oldLevel >= level || oldLevel == LEVEL_UNKNOWN);
        }
    ...
    private static bool isBootImageOnDisk() {
    ...
    public void onStart() {
        ...
        bool isTv = packageManager.hasSystemFeature(PackageManager.FEATURE_LEANBACK);
    ...
    private static class CacheFileDeletedObserver : FileObserver {
