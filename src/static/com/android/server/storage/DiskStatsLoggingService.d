 ...
 */
public class DiskStatsLoggingService : JobService {
    ...
    @VisibleForTesting
    static bool isDumpsysTaskEnabled(ContentResolver resolver) {
    ...
    @VisibleForTesting
    static class LogRunnable : Runnable {
        ...
        private void finishJob(bool needsReschedule) {
            if (mJobService != null) {
