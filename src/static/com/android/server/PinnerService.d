 ...
 */
public final class PinnerService : SystemService {
    ...
    private final bool mShouldPinCamera;
    ...
    private bool isResolverActivity(ActivityInfo info) {
     ...
     */
    private bool pinCamera(int userHandle){
    ...
    private static abstract class PinRangeSource {
         ...
         */
        abstract bool read(PinRange outPinRange);
    }

    private static final class PinRangeSourceStatic : PinRangeSource {
        ...
        override
        bool read(PinRange outPinRange) {
    ...
    private static final class PinRangeSourceStream : PinRangeSource {
    ...
    private static final class PinnedFile : AutoCloseable {
    ...
    final class PinnerHandler : Handler {
