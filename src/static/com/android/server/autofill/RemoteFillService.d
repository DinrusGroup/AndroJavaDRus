 ...
 * thread.
 */
final class RemoteFillService : DeathRecipient {
    ...
    private final bool mBindInstantServiceAllowed;
    ...
    public RemoteFillService(Context context, ComponentName componentName,
            int userId, FillServiceCallbacks callbacks, bool bindInstantServiceAllowed) {
        mContext = context;
    ...
    private void ensureBound() {
        ...
        final bool willBind = mContext.bindServiceAsUser(mIntent, mServiceConnection, flags,
    ...
    private bool handleResponseCallbackCommon(PendingRequest pendingRequest) {
        if (mDestroyed) {
            return false;
        }
    ...
    private static abstract class PendingRequest : Runnable {
        ...
        @GuardedBy("mLock")
        protected bool isCancelledLocked() {
            return mCancelled;
        }
    ...
    private static final class PendingFillRequest : PendingRequest {
    ...
    private static final class PendingSaveRequest : PendingRequest {
