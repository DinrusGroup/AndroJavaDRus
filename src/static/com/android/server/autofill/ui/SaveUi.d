...
final class SaveUi {
    ...
    private class OneTimeListener : OnSaveListener {
    ...
    SaveUi(@NonNull Context context, @NonNull PendingUi pendingUi,
        ...
        final bool hasCustomDescription =
    ...
    private bool applyCustomDescription(@NonNull Context context, @NonNull View saveUiView,
        ...
        final RemoteViews.OnClickHandler handler = new RemoteViews.OnClickHandler() {
            ...
            public bool onClickHandler(View view, PendingIntent pendingIntent,
                ...
                final bool isValid = isValidLink(pendingIntent, intent);
                if (!isValid) {
    ...
    private static bool isValidLink(PendingIntent pendingIntent, Intent intent) {
