...
public final class AutoFillUI {
    ...
    public void destroyAll(@Nullable PendingUi pendingSaveUi,
            @Nullable AutoFillUiCallback callback, bool notifyClient) {
    ...
    private void hideFillUiUiThread(@Nullable AutoFillUiCallback callback, bool notifyClient) {
    ...
    @android.annotation.UiThread
    private void destroySaveUiUiThread(@Nullable PendingUi pendingSaveUi, bool notifyClient) {
        if (mSaveUi == null) {
