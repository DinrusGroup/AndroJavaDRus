...
final class FillUi {
    ...
    public static bool isFullScreen(Context context) {
    ...
    public void destroy(bool notifyClient) {
        throwIfDestroyed();
        if (mWindow != null) {
            mWindow.hide(false);
        }
    ...
    private bool updateContentSize() {
        if (mAdapter == null) {
            return false;
        }
        if (mFullScreen) {
    ...
    private bool updateWidth(View view, Point maxSize) {
        bool changed = false;
    ...
    private bool updateHeight(View view, Point maxSize) {
        bool changed = false;
    ...
    private static class ViewItem {
         ...
         */
        ViewItem(@Nullable Dataset dataset, @Nullable Pattern filter, bool filterable,
         ...
         */
        public bool matches(CharSequence filterText) {
            if (TextUtils.isEmpty(filterText)) {
    ...
    private final class AutofillWindowPresenter : IAutofillWindowPresenter.Stub {
        override
        public void show(WindowManager.LayoutParams p, Rect transitionEpicenter,
                bool fitsSystemWindows, int layoutDirection) {
            if (sVerbose) {
    ...
    final class AnchoredWindow {
        ...
        void hide(bool destroyCallbackOnError) {
            try {
                if (mShowing) {
    ...
    private final class ItemsAdapter : BaseAdapter : Filterable {
    ...
    private final class AnnounceFilterResult : Runnable {
