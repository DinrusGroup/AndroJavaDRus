 ...
 * @hide
 */
public class WebViewUpdateService : SystemService {
     ...
     * @hide
     */
    public static bool entirePackageChanged(Intent intent) {
    ...
    private class BinderService : IWebViewUpdateService.Stub {
        ...
        override // Binder call
        public bool isFallbackPackage(String packageName) {
        ...
        override // Binder call
        public bool isMultiProcessEnabled() {
            return WebViewUpdateService.this.mImpl.isMultiProcessEnabled();
        }

        override // Binder call
        public void enableMultiProcess(bool enable) {
            if (getContext().checkCallingPermission(
                        android.Manifest.permission.WRITE_SECURE_SETTINGS)
                    != PackageManager.PERMISSION_GRANTED) {
