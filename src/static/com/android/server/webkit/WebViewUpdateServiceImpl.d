 ...
 *
 * This class : two main features - handling WebView fallback packages and keeping track
...
public class WebViewUpdateServiceImpl {
    ...
    private bool existsValidNonFallbackProvider(WebViewProviderInfo[] providers) {
    ...
    void enableFallbackLogic(bool enable) {
    ...
    private void updateFallbackStateOnPackageChange(String changedPackage, int changedState) {
        ...
        bool changedPackageAvailableByDefault = false;
    ...
    private void updateFallbackState(WebViewProviderInfo[] webviewProviders) {
        ...
        bool existsValidNonFallbackProvider = existsValidNonFallbackProvider(webviewProviders);
    ...
    bool isFallbackPackage(String packageName) {
    ...
    void enableMultiProcess(bool enable) {
    ...
    private static bool isDisabledForAllUsers(List<UserPackage> userPackages) {
