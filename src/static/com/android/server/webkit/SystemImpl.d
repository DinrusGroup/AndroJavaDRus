 ...
 * @hide
 */
public class SystemImpl : SystemInterface {
        ...
        try {
            ...
            while(true) {
                ...
                if (element.equals(TAG_WEBVIEW_PROVIDER)) {
                    ...
                    bool availableByDefault = "true".equals(
                            parser.getAttributeValue(null, TAG_AVAILABILITY));
                    bool isFallback = "true".equals(
    ...
    override
    public bool isFallbackLogicEnabled() {
    ...
    override
    public void enableFallbackLogic(bool enable) {
    ...
    override
    public void enablePackageForAllUsers(Context context, String packageName, bool enable) {
    ...
    override
    public void enablePackageForUser(String packageName, bool enable, int userId) {
        try {
    ...
    override
    public bool systemIsDebuggable() {
    ...
    override
    public void notifyZygote(bool enableMultiProcess) {
        WebViewZygote.setMultiprocessEnabled(enableMultiProcess);
    }

    override
    public bool isMultiProcessDefaultEnabled() {
