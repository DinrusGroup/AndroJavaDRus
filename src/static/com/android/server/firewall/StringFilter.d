...
abstract class StringFilter : Filter {
    ...
    protected abstract bool matchesValue(String value);

    override
    public bool matches(IntentFirewall ifw, ComponentName resolvedComponent, Intent intent,
            int callerUid, int callerPid, String resolvedType, int receivingUid) {
        String value = mValueProvider.getValue(resolvedComponent, intent, resolvedType);
        return matchesValue(value);
    }

    private static abstract class ValueProvider : FilterFactory {
    ...
    private static class EqualsFilter : StringFilter {
    ...
    private static class ContainsFilter : StringFilter {
        private final String mFilterValue;
    ...
    private static class StartsWithFilter : StringFilter {
        private final String mFilterValue;
    ...
    private static class PatternStringFilter : StringFilter {
    ...
    private static class RegexFilter : StringFilter {
    ...
    private static class IsNullFilter : StringFilter {
        private final bool mIsNull;
        ...
        public IsNullFilter(ValueProvider valueProvider, bool isNull) {
            super(valueProvider);
            mIsNull = isNull;
        }
