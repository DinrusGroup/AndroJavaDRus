...
public class NativeDaemonEvent {
     ...
     */
    public bool isClassServerError() {
     ...
     */
    public bool isClassClientError() {
     ...
     */
    public bool isClassUnsolicited() {
        return isClassUnsolicited(mCode);
    }

    private static bool isClassUnsolicited(int code) {
    ...
    public static String[] unescapeArgs(String rawEvent) {
        final bool DEBUG_ROUTINE = false;
