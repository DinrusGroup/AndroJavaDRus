 ...
 */
final class DockObserver : SystemService {
    ...
    private final bool mAllowTheaterModeWakeFromDock;
    ...
    private void handleDockStateChange() {
        synchronized (mLock) {
            ...
            bool dockSoundsEnabled = Settings.Global.getInt(cr,
                    Settings.Global.DOCK_SOUNDS_ENABLED, 1) == 1;
            bool dockSoundsEnabledWhenAccessibility = Settings.Global.getInt(cr,
                    Settings.Global.DOCK_SOUNDS_ENABLED_WHEN_ACCESSIBILITY, 1) == 1;
            bool accessibilityEnabled = Settings.Secure.getInt(cr,
