...
public class SyncOperation {
    ...
    public final bool allowParallelSyncs;
    public final Bundle extras;
    public final bool isPeriodic;
    ...
    public SyncOperation(Account account, int userId, int owningUid, String owningPackage,
                         ...
                         bool allowParallelSyncs, @SyncExemption int syncExemptionFlag) {
    ...
    private SyncOperation(SyncStorageEngine.EndPoint info, int owningUid, String owningPackage,
            int reason, int source, Bundle extras, bool allowParallelSyncs,
    ...
    public SyncOperation(SyncStorageEngine.EndPoint info, int owningUid, String owningPackage,
                         int reason, int source, Bundle extras, bool allowParallelSyncs,
                         bool isPeriodic, int sourcePeriodicId, long periodMillis,
    ...
    static SyncOperation maybeCreateFromJobExtras(PersistableBundle jobExtras) {
        ...
        int initiatedBy;
        Bundle extras;
        bool allowParallelSyncs, isPeriodic;
     ...
     */
    bool isConflict(SyncOperation toRun) {
    ...
    bool isReasonPeriodic() {
        return reason == REASON_PERIODIC;
    }

    bool matchesPeriodicOperation(SyncOperation other) {
    ...
    bool isDerivedFromFailedPeriodicSync() {
    ...
    String dump(PackageManager pm, bool shorter, SyncAdapterStateFetcher appStates) {
        StringBuilder sb = new StringBuilder();
