 ...
 * {@hide}
 */
public final class ContentService : IContentService.Stub {
    ...
    public static class Lifecycle : SystemService {
        ...
        override
        public void onStart() {
            final bool factoryTest = (FactoryTest
    ...
    protected synchronized void dump(FileDescriptor fd, PrintWriter pw_, String[] args) {
        ...
        final bool dumpAll = ArrayUtils.contains(args, "-a");
    ...
    /*package*/ ContentService(Context context, bool factoryTest) {
        mContext = context;
     ...
     */
    override
    public void registerContentObserver(Uri uri, bool notifyForDescendants,
    ...
    public void notifyChange(Uri uri, IContentObserver observer,
            bool observerWantsSelfNotifications, int flags, int userHandle,
    ...
    public void notifyChange(Uri uri, IContentObserver observer,
                             bool observerWantsSelfNotifications, bool syncToNetwork) {
    ...
    public static final class ObserverCall {
        ...
        final bool mSelfChange;
        final int mObserverUserId;

        ObserverCall(ObserverNode node, IContentObserver observer, bool selfChange, int observerUserId) {
            mNode = node;
            mObserver = observer;
    ...
    override
    public bool getSyncAutomatically(Account account, String providerName) {
     ...
     */
    override
    public bool getSyncAutomaticallyAsUser(Account account, String providerName, int userId) {
        enforceCrossUserPermission(userId,
    ...
    override
    public void setSyncAutomatically(Account account, String providerName, bool sync) {
        setSyncAutomaticallyAsUser(account, providerName, sync, UserHandle.getCallingUserId());
    }

    override
    public void setSyncAutomaticallyAsUser(Account account, String providerName, bool sync,
                                           int userId) {
    ...
    override
    public bool getMasterSyncAutomatically() {
     ...
     */
    override
    public bool getMasterSyncAutomaticallyAsUser(int userId) {
        enforceCrossUserPermission(userId,
                "no permission to read the sync settings for user " + userId);
        mContext.enforceCallingOrSelfPermission(Manifest.permission.READ_SYNC_SETTINGS,
                "no permission to read the sync settings");
    ...
    override
    public void setMasterSyncAutomatically(bool flag) {
        setMasterSyncAutomaticallyAsUser(flag, UserHandle.getCallingUserId());
    }

    override
    public void setMasterSyncAutomaticallyAsUser(bool flag, int userId) {
        enforceCrossUserPermission(userId,
    ...
    override
    public bool isSyncActive(Account account, String authority, ComponentName cname) {
    ...
    override
    public bool isSyncPending(Account account, String authority, ComponentName cname) {
        return isSyncPendingAsUser(account, authority, cname, UserHandle.getCallingUserId());
    }

    override
    public bool isSyncPendingAsUser(Account account, String authority, ComponentName cname,
                                       int userId) {
        mContext.enforceCallingOrSelfPermission(Manifest.permission.READ_SYNC_STATS,
                "no permission to read the sync stats");
        enforceCrossUserPermission(userId,
    ...
    private int handleIncomingUser(Uri uri, int pid, int uid, int modeFlags, bool allowNonFull,
            int userId) {
    ...
    public static final class ObserverNode {
        private class ObserverEntry : IBinder.DeathRecipient {
            public final IContentObserver observer;
            public final int uid;
            public final int pid;
            public final bool notifyForDescendants;
            private final int userHandle;
            private final Object observersLock;

            public ObserverEntry(IContentObserver o, bool n, Object observersLock,
        ...
        public void addObserverLocked(Uri uri, IContentObserver observer,
                                      bool notifyForDescendants, Object observersLock,
        ...
        public bool removeObserverLocked(IContentObserver observer) {
            int size = mChildren.size();
            for (int i = 0; i < size; i++) {
                bool empty = mChildren.get(i).removeObserverLocked(observer);
                if (empty) {
                    mChildren.remove(i);
                    i--;
                    size--;
        ...
        private void collectMyObserversLocked(bool leaf, IContentObserver observer,
                                              bool observerWantsSelfNotifications, int flags,
            ...
            for (int i = 0; i < N; i++) {
                ...
                bool selfChange = (entry.observer.asBinder() == observerBinder);
