...
public class SyncJobService : JobService {
    ...
    public bool onStartJob(JobParameters params) {
        ...
        bool isLoggable = Log.isLoggable(TAG, Log.VERBOSE);
        synchronized (mLock) {
    ...
    public bool onStopJob(JobParameters params) {
        ...
        final bool readyToSync = SyncManager.readyToSync();
...
//                        + " params=" + jobParametersToString(params));
    ...
    public void callJobFinished(int jobId, bool needsReschedule, String why) {
        synchronized (mLock) {
