 ...
 */
final class NativeDaemonConnector : Runnable, Handler.Callback, Watchdog.Monitor {
    ...
    private volatile bool mDebug = false;
    ...
    static void appendEscaped(StringBuilder builder, String arg) {
        final bool hasSpaces = arg.indexOf(' ') >= 0;
        if (hasSpaces) {
            builder.append('"');
        }
    ...
    private static class NativeDaemonArgumentException : NativeDaemonConnectorException {
    ...
    private static class NativeDaemonFailureException : NativeDaemonConnectorException {
