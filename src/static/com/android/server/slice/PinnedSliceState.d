...
public class PinnedSliceState {
    ...
    private void setSlicePinned(bool pinned) {
        synchronized (mLock) {
    ...
    public bool unpin(String pkg, IBinder token) {
        synchronized (mLock) {
    ...
    private class ListenerInfo {
        ...
        public ListenerInfo(IBinder token, String pkg, bool hasPermission,
