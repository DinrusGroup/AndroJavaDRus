...
public class PackageTracker {
    ...
    @VisibleForTesting(visibility = VisibleForTesting.Visibility.PACKAGE)
    protected synchronized bool start() {
     ...
     */
    public synchronized void triggerUpdateIfNeeded(bool packageChanged) {
        if (!mTrackingEnabled) {
        ...
        // an application.
        bool updaterAppManifestValid = validateUpdaterAppManifest();
        bool dataAppManifestValid = validateDataAppManifest();
     ...
     */
    @VisibleForTesting(visibility = VisibleForTesting.Visibility.PACKAGE)
    protected synchronized void recordCheckResult(CheckToken checkToken, bool success) {
        ...
        if (checkToken == null) {
            ...
            // completed.
            bool recordedCheckCompleteSuccessfully =
    ...
    private bool isCheckResponseOverdue() {
    ...
    private bool validateDataAppManifest() {
    ...
    private bool validateUpdaterAppManifest() {
        try {
