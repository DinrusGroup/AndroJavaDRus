...
public final class RulesManagerService : IRulesManager.Stub {
    ...
    private RulesState getRulesStateInternal() {
        synchronized(this) {
            ...
            bool operationInProgress = this.mOperationInProgress.get();
    ...
    public int requestInstall(ParcelFileDescriptor distroParcelFileDescriptor,
        ...
        bool closeParcelFileDescriptorOnExit = true;
        try {
    ...
    private class InstallRunnable : Runnable {
    ...
    private class UninstallRunnable : Runnable {
        ...
        public void run() {
            ...
            bool packageTrackerStatus = false;
            try {
    ...
    override
    public void requestNothing(byte[] checkTokenBytes, bool success) {
        mPermissionHelper.enforceCallerHasPermission(REQUIRED_UPDATER_PERMISSION);
        CheckToken checkToken = null;
        if (checkTokenBytes != null) {
            checkToken = createCheckTokenOrThrow(checkTokenBytes);
    ...
    void notifyIdle() {
        ...
        // *might* be work to do.
        final bool packageChanged = false;
