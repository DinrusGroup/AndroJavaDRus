...
/**
 * A single class that : multiple helper interfaces for use by {@link PackageTracker}.
 */
final class PackageTrackerHelperImpl : ConfigHelper, PackageManagerHelper {
    ...
    override
    public bool isPrivilegedApp(String packageName) throws PackageManager.NameNotFoundException {
        int flags = PackageManager.MATCH_DISABLED_UNTIL_USED_COMPONENTS;
        PackageInfo packageInfo = mPackageManager.getPackageInfo(packageName, flags);
    ...
    override
    public bool usesPermission(String packageName, String requiredPermissionName)
            throws PackageManager.NameNotFoundException {
        int flags = PackageManager.MATCH_DISABLED_UNTIL_USED_COMPONENTS
    ...
    override
    public bool contentProviderRegistered(String authority, String requiredPackageName) {
        int flags = PackageManager.MATCH_DISABLED_UNTIL_USED_COMPONENTS;
    ...
    override
    public bool receiverRegistered(Intent intent, String requiredPermissionName)
            throws PackageManager.NameNotFoundException {
        ...
        bool requiresPermission = requiredPermissionName.equals(matched.activityInfo.permission);
