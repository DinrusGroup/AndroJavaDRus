...
final class PackageStatusStorage {
    ...
    CheckToken generateCheckToken(PackageVersions currentInstalledVersions) {
        ...
        synchronized (this) {
            ...
            try {
                bool statusUpdated = writePackageStatusWithOptimisticLockCheck(
     ...
     */
    bool markChecked(CheckToken checkToken, bool succeeded) {
        synchronized (this) {
    ...
    @GuardedBy("this")
    private bool writePackageStatusWithOptimisticLockCheck(int optimisticLockId,
