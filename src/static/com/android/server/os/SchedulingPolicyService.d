 ...
 * @hide
 */
public class SchedulingPolicyService : ISchedulingPolicyService.Stub {
    ...
    public int requestPriority(int pid, int tid, int prio, bool isForApp) {
    ...
    public int requestCpusetBoost(bool enable, IBinder client) {
