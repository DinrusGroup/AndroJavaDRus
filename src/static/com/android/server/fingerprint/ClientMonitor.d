 ...
 */
public abstract class ClientMonitor : IBinder.DeathRecipient {
    ...
    protected static final bool DEBUG = FingerprintService.DEBUG;
    ...
    public ClientMonitor(Context context, long halDeviceId, IBinder token,
            IFingerprintServiceReceiver receiver, int userId, int groupId,bool restricted,
            String owner) {
        mContext = context;
     ...
     */
    public abstract int stop(bool initiatedByClient);
    ...
    public abstract bool onEnrollResult(int fingerId, int groupId, int rem);
    public abstract bool onAuthenticated(int fingerId, int groupId);
    public abstract bool onRemoved(int fingerId, int groupId, int remaining);
    public abstract bool onEnumerationResult(int fingerId, int groupId, int remaining);
     ...
     */
    public bool onAcquired(int acquiredInfo, int vendorCode) {
        if (mReceiver == null)
     ...
     * @return true if client should be removed
     */
    public bool onError(int error, int vendorCode) {
        if (mReceiver != null) {
            try {
    ...
    public final bool getIsRestricted() {
