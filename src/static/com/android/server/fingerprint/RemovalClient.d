 ...
 */
public abstract class RemovalClient : ClientMonitor {
     ...
     */
    private bool sendRemoved(int fingerId, int groupId, int remaining) {
    ...
    override
    public bool onEnrollResult(int fingerId, int groupId, int rem) {
