 ...
 * @hide
 */
public class FingerprintService : SystemService : IHwBinder.DeathRecipient {
    static final String TAG = "FingerprintService";
    static final bool DEBUG = true;
    private static final bool CLEANUP_UNUSED_FP = true;
    ...
    private void enumerateUser(int userId) {
        ...
        bool restricted = !hasPermission(MANAGE_FINGERPRINT);
     ...
     */
    private void startClient(ClientMonitor newClient, bool initiatedByClient) {
    ...
    void startRemove(IBinder token, int fingerId, int groupId, int userId,
            IFingerprintServiceReceiver receiver, bool restricted, bool internal) {
        if (token == null) {
    ...
    public bool hasEnrolledFingerprints(int userId) {
    ...
    bool isCurrentUserOrProfile(int userId) {
        UserManager um = UserManager.get(mContext);
        if (um == null) {
            Slog.e(TAG, "Unable to acquire UserManager");
            return false;
    ...
    private bool isForegroundActivity(int uid, int pid) {
        try {
     ...
     */
    private bool canUseFingerprint(String opPackageName, bool requireForeground, int uid,
            int pid, int userId) {
     ...
     */
    private bool currentClient(String opPackageName) {
     ...
     */
    private bool isKeyguard(String clientPackage) {
    ...
    private void notifyClientActiveCallbacks(bool isActive) {
    ...
    private void startAuthentication(IBinder token, long opId, int callingUserId, int groupId,
                IFingerprintServiceReceiver receiver, int flags, bool restricted,
    ...
    protected void resetFailedAttemptsForUser(bool clearAttemptCounter, int userId) {
    ...
    private class FingerprintServiceLockoutResetMonitor : IBinder.DeathRecipient {
    ...
    private final class FingerprintServiceWrapper : IFingerprintService.Stub {
        ...
        public void enroll(final IBinder token, final byte[] cryptoToken, final int userId,
            ...
            final bool restricted = isRestricted();
            mHandler.post(new Runnable() {
                override
                public void run() {
        ...
        private bool isRestricted() {
            ...
            final bool restricted = !hasPermission(MANAGE_FINGERPRINT);
            return restricted;
        }
        ...
        override // Binder call
        public bool isHardwareDetected(long deviceId, String opPackageName) {
        ...
        override // Binder call
        public bool hasEnrolledFingerprints(int userId, String opPackageName) {
            if (!canUseFingerprint(opPackageName, false /* foregroundOnly */,
                    Binder.getCallingUid(), Binder.getCallingPid(),
                    UserHandle.getCallingUserId())) {
                return false;
     ...
     */
    private bool isWorkProfile(int userId) {
