 ...
 */
public abstract class AuthenticationClient : ClientMonitor {
    private long mOpId;
    ...
    private bool mInLockout;
    private final FingerprintManager mFingerprintManager;
    protected bool mDialogDismissed;
    ...
    public AuthenticationClient(Context context, long halDeviceId, IBinder token,
            ...
            bool restricted, String owner, Bundle bundle,
    ...
    override
    public bool onAuthenticated(int fingerId, int groupId) {
        bool result = false;
        bool authenticated = fingerId != 0;
    ...
    override
    public int stop(bool initiatedByClient) {
    ...
    override
    public bool onEnrollResult(int fingerId, int groupId, int remaining) {
        if (DEBUG) Slog.w(TAG, "onEnrollResult() called for authenticate!");
        return true; // Invalid for Authenticate
    }

    override
    public bool onRemoved(int fingerId, int groupId, int remaining) {
        if (DEBUG) Slog.w(TAG, "onRemoved() called for authenticate!");
        return true; // Invalid for Authenticate
    }

    override
    public bool onEnumerationResult(int fingerId, int groupId, int remaining) {
