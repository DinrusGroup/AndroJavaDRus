 ...
 * @hide
 */
public class CameraServiceProxy : SystemService
    ...
    public void binderDied() {
        ...
        synchronized(mLock) {
            ...
            bool wasEmpty = mActiveCameraUsage.isEmpty();
    ...
    private bool notifyMediaserverLocked(int eventType, Set<Integer> updatedUserHandles) {
    ...
    private void updateActivityCount(String cameraId, int newCameraState, int facing,
        ...
        synchronized(mLock) {
            ...
            bool isEmpty = mActiveCameraUsage.isEmpty();
    ...
    private void notifyNfcService(bool enablePolling) {
