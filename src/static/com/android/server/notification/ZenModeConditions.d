...
public class ZenModeConditions : ConditionProviders.Callback {
    ...
    private bool mFirstEvaluation = true;
    ...
    public void evaluateConfig(ZenModeConfig config, bool processSubscriptions) {
    ...
    public void onConditionChanged(Uri id, Condition condition) {
        ...
        if (config == null) return;
        bool updated = updateCondition(id, condition, config.manualRule);
        for (ZenRule automaticRule : config.automaticRules.values()) {
    ...
    private void evaluateRule(ZenRule rule, ArraySet<Uri> current, bool processSubscriptions) {
        if (rule == null || rule.conditionId == null) return;
        final Uri id = rule.conditionId;
        bool isSystemCondition = false;
    ...
    private bool isAutomaticActive(ComponentName component) {
    ...
    private bool updateSnoozing(ZenRule rule) {
    ...
    private bool updateCondition(Uri id, Condition condition, ZenRule rule) {
