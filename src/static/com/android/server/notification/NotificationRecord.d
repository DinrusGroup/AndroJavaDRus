...
public final class NotificationRecord {
    ...
    private bool mRecentlyIntrusive;
    private long mLastIntrusive;

    // is this notification currently being intercepted by Zen Mode?
    private bool mIntercept;
    ...
    private bool mPreChannelsNotification = true;
    private Uri mSound;
    ...
    private bool mIsInterruptive;
    private bool mTextChanged;
    private bool mRecordedInterruption;
    private int mNumberOfSmartRepliesAdded;
    private bool mHasSeenSmartReplies;
    /**
     ...
     */
    private bool mIsAppImportanceLocked;
    ...
    private bool isPreChannelsNotification() {
    ...
    private Uri calculateSound() {
        ...
        if (mPreChannelsNotification && (getChannel().getUserLockedFields()
            ...
            final bool useDefaultSound = (n.defaults & Notification.DEFAULT_SOUND) != 0;
            if (useDefaultSound) {
    ...
    void dump(ProtoOutputStream proto, long fieldId, bool redact, int state) {
    ...
    void dump(PrintWriter pw, String prefix, Context baseContext, bool redact) {
        final Notification notification = sbn.getNotification();
    ...
    public void setIsAppImportanceLocked(bool isAppImportanceLocked) {
    ...
    public void setRecentlyIntrusive(bool recentlyIntrusive) {
    ...
    public bool isRecentlyIntrusive() {
    ...
    public bool setIntercepted(bool intercept) {
    ...
    public bool isAudioAttributesUsage(int usage) {
     ...
     */
    public void setVisibility(bool visible, int rank, int count) {
     ...
     */
    public bool getIsAppImportanceLocked() {
    ...
    public void setInterruptive(bool interruptive) {
        mIsInterruptive = interruptive;
    }

    public void setTextChanged(bool textChanged) {
        mTextChanged = textChanged;
    }

    public void setRecordedInterruption(bool recorded) {
        mRecordedInterruption = recorded;
    }

    public bool hasRecordedInterruption() {
    ...
    public bool hasSeenSmartReplies() {
        return mHasSeenSmartReplies;
    }

    public void setSeenSmartReplies(bool hasSeenSmartReplies) {
     ...
     */
    private void visitGrantableUri(Uri uri, bool userOverriddenUri) {
