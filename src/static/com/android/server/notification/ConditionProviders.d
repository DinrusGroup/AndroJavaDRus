...
public class ConditionProviders : ManagedServices {
    ...
    public bool isSystemProviderEnabled(String path) {
    ...
    override
    public void onPackagesChanged(bool removingPackage, String[] pkgList, int[] uid) {
        if (removingPackage) {
    ...
    private ConditionRecord getRecordLocked(Uri id, ComponentName component, bool create) {
    ...
    public bool subscribeIfNecessary(ComponentName component, Uri conditionId) {
        synchronized (mMutex) {
            final ConditionRecord r = getRecordLocked(conditionId, component, false /*create*/);
            if (r == null) {
