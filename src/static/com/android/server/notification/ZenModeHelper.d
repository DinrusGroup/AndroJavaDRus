...
public class ZenModeHelper {
    ...
    @VisibleForTesting protected bool mIsBootComplete;
    ...
    public bool matchesCallFilter(UserHandle userHandle, Bundle extras,
    ...
    public bool isCall(NotificationRecord record) {
    ...
    public bool shouldIntercept(NotificationRecord record) {
        synchronized (mConfig) {
    ...
    public bool updateAutomaticZenRule(String ruleId, AutomaticZenRule automaticZenRule,
            String reason) {
        ZenModeConfig newConfig;
        synchronized (mConfig) {
    ...
    public bool removeAutomaticZenRule(String id, String reason) {
        ZenModeConfig newConfig;
        synchronized (mConfig) {
            if (mConfig == null) return false;
            newConfig = mConfig.copy();
    ...
    public bool removeAutomaticZenRules(String packageName, String reason) {
        ZenModeConfig newConfig;
        synchronized (mConfig) {
            if (mConfig == null) return false;
            newConfig = mConfig.copy();
    ...
    public bool canManageAutomaticZenRule(ZenRule rule) {
    ...
    private bool ruleValuesEqual(AutomaticZenRule rule, ZenRule defaultRule) {
    ...
    private bool isSystemRule(AutomaticZenRule rule) {
    ...
    private void populateZenRule(AutomaticZenRule automaticZenRule, ZenRule rule, bool isNew) {
        if (isNew) {
    ...
    public void readXml(XmlPullParser parser, bool forRestore)
    ...
    public void writeXml(XmlSerializer out, bool forBackup, Integer version) throws IOException {
        final int N = mConfigs.size();
        for (int i = 0; i < N; i++) {
            //TODO: http://b/22388012
    ...
    public bool setConfigLocked(ZenModeConfig config, String reason) {
    ...
    private bool setConfigLocked(ZenModeConfig config, String reason, bool setRingerMode) {
        ...
        try {
            ...
            final bool policyChanged = !Objects.equals(getNotificationPolicy(mConfig),
    ...
    private void applyConfig(ZenModeConfig config, String reason, bool setRingerMode) {
    ...
    @VisibleForTesting
    protected bool evaluateZenMode(String reason, bool setRingerMode) {
    ...
    protected void applyRestrictions() {
        final bool zenPriorityOnly = mZenMode == Global.ZEN_MODE_IMPORTANT_INTERRUPTIONS;
        final bool zenSilence = mZenMode == Global.ZEN_MODE_NO_INTERRUPTIONS;
        final bool zenAlarmsOnly = mZenMode == Global.ZEN_MODE_ALARMS;

        // notification restrictions
        final bool muteNotifications =
                (mSuppressedEffects & SUPPRESSED_EFFECT_NOTIFICATIONS) != 0;
        // call restrictions
        final bool muteCalls = zenAlarmsOnly
                || (zenPriorityOnly && !mConfig.allowCalls && !mConfig.allowRepeatCallers)
                || (mSuppressedEffects & SUPPRESSED_EFFECT_CALLS) != 0;
        // alarm restrictions
        final bool muteAlarms = zenPriorityOnly && !mConfig.allowAlarms;
        // media restrictions
        final bool muteMedia = zenPriorityOnly && !mConfig.allowMedia;
        // system restrictions
        final bool muteSystem = zenAlarmsOnly || (zenPriorityOnly && !mConfig.allowSystem);
        // total silence restrictions
        final bool muteEverything = zenSilence
    ...
    @VisibleForTesting
    protected void applyRestrictions(bool mute, int usage, int code) {
    ...
    @VisibleForTesting
    protected void applyRestrictions(bool mute, int usage) {
    ...
    @VisibleForTesting
    protected final class RingerModeDelegate : AudioManagerInternal.RingerModeDelegate {
        override
        public String toString() {
            return TAG;
        }
        ...
        public int onSetRingerModeInternal(int ringerModeOld, int ringerModeNew, String caller,
            ...
            final bool isChange = ringerModeOld != ringerModeNew;
        ...
        public int onSetRingerModeExternal(int ringerModeOld, int ringerModeNew, String caller,
            ...
            final bool isChange = ringerModeOld != ringerModeNew;
            final bool isVibrate = ringerModeInternal == AudioManager.RINGER_MODE_VIBRATE;
        ...
        override
        public bool canVolumeDownEnterSilent() {
    ...
    private void showZenUpgradeNotification(int zen) {
        final bool showNotification = mIsBootComplete
    ...
    private final class Metrics : Callback {
    ...
    private final class H : Handler {
        ...
        private final class ConfigMessageData {
            ...
            public final bool setRingerMode;

            ConfigMessageData(ZenModeConfig config, String reason, bool setRingerMode) {
                this.config = config;
                this.reason = reason;
        ...
        private void postApplyConfig(ZenModeConfig config, String reason, bool setRingerMode) {
