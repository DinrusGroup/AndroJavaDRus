...
public class CountdownConditionProvider : SystemConditionProviderService {
    ...
    override
    public bool isValidConditionId(Uri id) {
    ...
    private final class Receiver : BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            if (ACTION.equals(intent.getAction())) {
                ...
                final bool alarm = ZenModeConfig.isValidCountdownToAlarmConditionId(conditionId);
    ...
    private static final Condition newCondition(long time, bool alarm, int state) {
