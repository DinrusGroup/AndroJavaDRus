...
public class NotificationComparator
    ...
    public int compare(NotificationRecord left, NotificationRecord right) {
        ...
        bool leftImportantColorized = isImportantColorized(left);
        bool rightImportantColorized = isImportantColorized(right);
        ...
        bool leftImportantOngoing = isImportantOngoing(left);
        bool rightImportantOngoing = isImportantOngoing(right);
        ...
        bool leftMessaging = isImportantMessaging(left);
        bool rightMessaging = isImportantMessaging(right);
        ...
        bool leftPeople = isImportantPeople(left);
        bool rightPeople = isImportantPeople(right);
    ...
    private bool isImportantColorized(NotificationRecord record) {
    ...
    private bool isImportantOngoing(NotificationRecord record) {
        if (!isOngoing(record)) {
            return false;
        }
    ...
    protected bool isImportantPeople(NotificationRecord record) {
        if (record.getImportance() < NotificationManager.IMPORTANCE_LOW) {
            return false;
        }
