...
public class SnoozeHelper {
    ...
    protected bool isSnoozed(int userId, String pkg, String key) {
    ...
    protected bool cancel(int userId, String pkg, String tag, int id) {
        if (mSnoozedNotifications.containsKey(userId)) {
    ...
    protected bool cancel(int userId, bool includeCurrentProfiles) {
        int[] userIds = {userId};
    ...
    protected bool cancel(int userId, String pkg) {
        if (mSnoozedNotifications.containsKey(userId)) {
    ...
    protected void writeXml(XmlSerializer out, bool forBackup) throws IOException {
