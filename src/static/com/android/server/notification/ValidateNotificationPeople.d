 ...
 * {@hide}
 */
public class ValidateNotificationPeople : NotificationSignalExtractor {
    ...
    private static final bool ENABLE_PEOPLE_VALIDATOR = true;
    ...
    private static class LookupResult {
        ...
        public void mergeContact(Cursor cursor) {
            ...
            if (starIdx >= 0) {
                bool isStarred = cursor.getInt(starIdx) != 0;
                if (isStarred) {
    ...
    private class PeopleRankingReconsideration : RankingReconsideration {
