...
public class GroupHelper {
    ...
    public void onNotificationPosted(StatusBarNotification sbn, bool autogroupSummaryExists) {
     ...
     */
    private void maybeUngroup(StatusBarNotification sbn, bool notificationGone, int userId) {
    ...
    private void adjustNotificationBundling(List<String> keys, bool group) {
        for (String key : keys) {
