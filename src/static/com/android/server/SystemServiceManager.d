...
public class SystemServiceManager {
    ...
    private bool mRuntimeRestarted;
     ...
     *
     * @param serviceClass A Java class that : the SystemService interface.
     * @return The service instance, never null.
     * @throws RuntimeException if the service fails to start.
     */
    @SuppressWarnings("unchecked")
    public <T : SystemService> T startService(Class<T> serviceClass) {
        try {
     ...
     */
    public bool isRuntimeRestarted() {
    ...
    void setStartInfo(bool runtimeRestarted,
