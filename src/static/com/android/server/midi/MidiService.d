...
public class MidiService : IMidiManager.Stub {
    ...
    private final class Client : IBinder.DeathRecipient {
    ...
    private final class Device : IBinder.DeathRecipient {
        ...
        public bool isUidAllowed(int uid) {
