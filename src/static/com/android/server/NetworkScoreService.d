 ...
 * @hide
 */
public class NetworkScoreService : INetworkScoreService.Stub {
    private static final String TAG = "NetworkScoreService";
    private static final bool DBG = Build.IS_DEBUGGABLE && Log.isLoggable(TAG, Log.DEBUG);
    private static final bool VERBOSE = Build.IS_DEBUGGABLE && Log.isLoggable(TAG, Log.VERBOSE);
     ...
     */
    private class NetworkScorerPackageMonitor : PackageMonitor {
        ...
        private void evaluateBinding(String changedPackageName, bool forceUnbind) {
     ...
     */
    @VisibleForTesting
    public static class DispatchingContentObserver : ContentObserver {
    ...
    override
    public bool updateScores(ScoredNetwork[] networks) {
    ...
    static class FilteringCacheUpdatingConsumer
            : BiConsumer<INetworkScoreCache, Object> {
        private final Context mContext;
     ...
     */
    private static class WifiInfoSupplier : Supplier<WifiInfo> {
        private final Context mContext;
     ...
     * Helper class that improves the testability of the cache filter Functions.
     */
    private static class ScanResultsSupplier : Supplier<List<ScanResult>> {
        private final Context mContext;
     ...
     */
    @VisibleForTesting
    static class CurrentNetworkScoreCacheFilter : UnaryOperator<List<ScoredNetwork>> {
     ...
     */
    @VisibleForTesting
    static class ScanResultsScoreCacheFilter : UnaryOperator<List<ScoredNetwork>> {
    ...
    override
    public bool setActiveScorer(String packageName) {
     ...
     */
    override
    public bool isCallerActiveScorer(int callingUid) {
        synchronized (mServiceConnectionLock) {
    ...
    override
    public bool requestScores(NetworkKey[] networks) {
        enforceSystemOnly();
        final long token = Binder.clearCallingIdentity();
        try {
    ...
    @VisibleForTesting
    public static class ScoringServiceConnection : ServiceConnection {
        private final NetworkScorerAppData mAppData;
        private volatile bool mBound = false;
    ...
    @VisibleForTesting
    public final class ServiceHandler : Handler {
