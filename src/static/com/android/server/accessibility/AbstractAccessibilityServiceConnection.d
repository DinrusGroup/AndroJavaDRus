 ...
 */
abstract class AbstractAccessibilityServiceConnection : IAccessibilityServiceConnection.Stub
        : ServiceConnection, IBinder.DeathRecipient, KeyEventDispatcher.KeyEventFilter,
    ...
    bool mRequestTouchExplorationMode;

    bool mRequestFilterKeyEvents;

    bool mRetrieveInteractiveWindows;

    bool mCaptureFingerprintGestures;

    bool mRequestAccessibilityButton;

    bool mReceivedAccessibilityButtonCallbackSinceBind;

    bool mLastAccessibilityButtonCallbackState;
    ...
    bool mUsesAccessibilityCache = false;
    ...
    public interface SystemSupport {
         ...
         */
        bool performAccessibilityAction(int resolvedWindowId,
         ...
         */
        void onClientChange(bool serviceInfoChanged);

        int getCurrentUserIdLocked();

        bool isAccessibilityButtonShown();
    ...
    public AbstractAccessibilityServiceConnection(Context context, ComponentName componentName,
        ...
        mEventDispatchHandler = new Handler(mainHandler.getLooper()) {
            ...
            public void handleMessage(Message message) {
                ...
                bool serviceWantsEvent = message.arg1 != 0;
    ...
    override
    public bool onKeyEvent(KeyEvent keyEvent, int sequenceNumber) {
    ...
    protected bool supportsFlagForNotImportantViews(AccessibilityServiceInfo info) {
        return info.getResolveInfo().serviceInfo.applicationInfo.targetSdkVersion
                >= Build.VERSION_CODES.JELLY_BEAN;
    }

    public bool canReceiveEventsLocked() {
        return (mEventTypes != 0 && mFeedbackType != 0 && mService != null);
    }

    override
    public void setOnKeyEventResult(bool handled, int sequence) {
    ...
    protected abstract bool isCalledForCurrentUserLocked();
    ...
    override
    public bool performAccessibilityAction(int accessibilityWindowId,
            long accessibilityNodeId, int action, Bundle arguments, int interactionId,
            IAccessibilityInteractionConnectionCallback callback, long interrogatingTid)
            throws RemoteException {
        final int resolvedWindowId;
    ...
    override
    public bool performGlobalAction(int action) {
        synchronized (mLock) {
            if (!isCalledForCurrentUserLocked()) {
                return false;
            }
    ...
    public Region getMagnificationRegion() {
        synchronized (mLock) {
            ...
            bool registeredJustForThisCall =
    ...
    private bool registerMagnificationIfNeeded(
            MagnificationController magnificationController) {
    ...
    override
    public bool resetMagnification(bool animate) {
        synchronized (mLock) {
            if (!isCalledForCurrentUserLocked()) {
                return false;
            }
    ...
    override
    public bool setMagnificationScaleAndCenter(float scale, float centerX, float centerY,
            bool animate) {
        synchronized (mLock) {
            if (!isCalledForCurrentUserLocked()) {
                return false;
    ...
    override
    public void setMagnificationCallbackEnabled(bool enabled) {
        mInvocationHandler.setMagnificationCallbackEnabled(enabled);
    }

    public bool isMagnificationCallbackEnabled() {
        return mInvocationHandler.mIsMagnificationCallbackEnabled;
    }

    override
    public void setSoftKeyboardCallbackEnabled(bool enabled) {
    ...
    public void notifyAccessibilityEvent(AccessibilityEvent event) {
        synchronized (mLock) {
            ...
            final bool serviceWantsEvent = wantsEventLocked(event);
            final bool requiredForCacheConsistency = mUsesAccessibilityCache
     ...
     */
    private bool wantsEventLocked(AccessibilityEvent event) {
    ...
    public void notifyAccessibilityButtonAvailabilityChangedLocked(bool available) {
    ...
    private void notifyAccessibilityButtonAvailabilityChangedInternal(bool available) {
    ...
    private final class InvocationHandler : Handler {
        ...
        private bool mIsMagnificationCallbackEnabled = false;
        private bool mIsSoftKeyboardCallbackEnabled = false;
        ...
        public void handleMessage(Message message) {
            ...
            switch (type) {
                ...
                case MSG_ON_ACCESSIBILITY_BUTTON_AVAILABILITY_CHANGED: {
                    final bool available = (message.arg1 != 0);
