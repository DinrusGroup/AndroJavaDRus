 ...
 */
public class ActionReplacingCallback : IAccessibilityInteractionConnectionCallback.Stub {
    ...
    public void setFindAccessibilityNodeInfosResult(List<AccessibilityNodeInfo> infos,
            int interactionId) {
        bool callbackForSingleNode;
        bool callbackForMultipleNodes;
        synchronized(mLock) {
            if (interactionId == mInteractionId) {
