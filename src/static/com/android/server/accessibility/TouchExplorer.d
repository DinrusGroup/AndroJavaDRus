 ...
 * @hide
 */
class TouchExplorer : BaseEventStreamTransformation
    ...
    private bool mTouchExplorationInProgress;
    ...
    override
    public bool onDoubleTap(MotionEvent event, int policyFlags) {
        // Ignore the event if we aren't touch exploring.
        if (mCurrentState != STATE_TOUCH_EXPLORING) {
            return false;
        }
        ...
        final bool targetAccessibilityFocus = (result == CLICK_LOCATION_ACCESSIBILITY_FOCUS);
    ...
    override
    public bool onGestureCompleted(int gestureId) {
     ...
     */
    private bool isDraggingGesture(MotionEvent event) {
        ReceivedPointerTracker receivedTracker = mReceivedPointerTracker;
     ...
     */
    private final class ExitGestureDetectionModeDelayed : Runnable {
     ...
     */
    class SendHoverEnterAndMoveDelayed : Runnable {
        ...
        public void post(MotionEvent event, bool touchExplorationInProgress,
     ...
     */
    class SendHoverExitDelayed : Runnable {
    ...
    private class SendAccessibilityEventDelayed : Runnable {
    ...
    class InjectedPointerTracker {
         ...
         */
        public bool isInjectedPointerDown(int pointerId) {
            final int pointerFlag = (1 << pointerId);
    ...
    class ReceivedPointerTracker {
         ...
         * @return True if the pointer is down.
         */
        public bool isReceivedPointerDown(int pointerId) {
            final int pointerFlag = (1 << pointerId);
