...
class UiAutomationManager {
    ...
    private class UiAutomationService : AbstractAccessibilityServiceConnection {
        ...
        override
        protected bool isCalledForCurrentUserLocked() {
        ...
        override
        public bool setSoftKeyboardShowMode(int mode) {
            return false;
        }
        ...
        override
        public bool isCapturingFingerprintGestures() {
            return false;
        }

        override
        public void onFingerprintGestureDetectionActiveChanged(bool active) {}
