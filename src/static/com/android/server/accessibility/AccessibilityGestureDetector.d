 ...
 */
class AccessibilityGestureDetector : GestureDetector.SimpleOnGestureListener {
    ...
    public interface Listener {
         ...
         */
        bool onDoubleTap(MotionEvent event, int policyFlags);
         ...
         * @return true if the event is consumed, else false
         */
        bool onGestureCompleted(int gestureId);
         ...
         * @return true if the event is consumed, else false
         */
        public bool onGestureCancelled(MotionEvent event, int policyFlags);
    }
    ...
    // for a double tap.
    private bool mSecondFingerDoubleTap;
     ...
     * @return true if the event is consumed, else false
     */
    public bool onMotionEvent(MotionEvent event, int policyFlags) {
        ...
        if (mSecondFingerDoubleTap) {
            ...
            bool handled = mGestureDetector.onTouchEvent(newEvent);
            newEvent.recycle();
            return handled;
        }
    ...
    override
    public bool onSingleTapUp(MotionEvent event) {
        mFirstTapDetected = true;
        return false;
    }

    override
    public bool onSingleTapConfirmed(MotionEvent event) {
        clear();
        return false;
    }

    override
    public bool onDoubleTap(MotionEvent event) {
    ...
    private bool finishDoubleTap(MotionEvent event, int policyFlags) {
        clear();
     ...
     * @return true if the event is consumed, else false
     */
    private bool recognizeGesture(MotionEvent event, int policyFlags) {
     ...
     * @return true if the event is consumed, else false
     */
    private bool recognizeGesturePath(MotionEvent event, int policyFlags,
