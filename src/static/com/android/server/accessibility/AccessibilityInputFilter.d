 ...
 */
class AccessibilityInputFilter : InputFilter : EventStreamTransformation {
    ...
    private void enableFeatures() {
        ...
        if ((mEnabledFeatures & FLAG_FEATURE_CONTROL_SCREEN_MAGNIFIER) != 0
            ...
            final bool detectControlGestures = (mEnabledFeatures
                    & FLAG_FEATURE_SCREEN_MAGNIFIER) != 0;
            final bool triggerable = (mEnabledFeatures
    ...
    private static class EventStreamState {
         ...
         */
        public bool updateDeviceId(int deviceId) {
         ...
         */
        public bool shouldProcessScroll() {
            return false;
        }
         ...
         */
        public bool shouldProcessMotionEvent(MotionEvent event) {
            return false;
        }
         ...
         * @return Whether the event should be handled by event transformations.
         */
        public bool shouldProcessKeyEvent(KeyEvent event) {
            return false;
        }
    }
     ...
     */
    private static class MouseEventStreamState : EventStreamState {
        private bool mMotionSequenceStarted;
        ...
        override
        final public bool shouldProcessScroll() {
            return true;
        }

        override
        final public bool shouldProcessMotionEvent(MotionEvent event) {
     ...
     */
    private static class TouchScreenEventStreamState : EventStreamState {
        private bool mTouchSequenceStarted;
        private bool mHoverSequenceStarted;
     ...
     */
    private static class KeyboardEventStreamState : EventStreamState {
        ...
        override
        final public bool shouldProcessKeyEvent(KeyEvent event) {
            ...
            bool shouldProcess = event.getAction() == KeyEvent.ACTION_DOWN;
