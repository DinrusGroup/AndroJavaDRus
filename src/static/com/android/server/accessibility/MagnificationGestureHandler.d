...
class MagnificationGestureHandler : BaseEventStreamTransformation {
    private static final String LOG_TAG = "MagnificationGestureHandler";

    private static final bool DEBUG_ALL = false;
    private static final bool DEBUG_STATE_TRANSITIONS = false || DEBUG_ALL;
    private static final bool DEBUG_DETECTING = false || DEBUG_ALL;
    private static final bool DEBUG_PANNING_SCALING = false || DEBUG_ALL;
    private static final bool DEBUG_EVENT_STREAM = false || DEBUG_ALL;
    ...
    void notifyShortcutTriggered() {
        if (mDetectShortcutTrigger) {
            bool wasMagnifying = mMagnificationController.resetIfNeeded(/* animate */ true);
            if (wasMagnifying) {
                clearAndTransitionToStateDetecting();
            } else {
     ...
     * triggering.
     */
    final class PanningScalingState : SimpleOnGestureListener
            : OnScaleGestureListener, State {
        ...
        override
        public bool onScroll(MotionEvent first, MotionEvent second,
     ...
     */
    final class ViewportDraggingState : State {

        /** Whether to disable zoom after dragging ends */
        bool mZoomedInBeforeDrag;
        private bool mLastMoveOutsideMagnifiedRegion;
    ...
    final class DelegatingState : State {
        /**
     ...
     */
    final class DetectingState : State, Handler.Callback {
        ...
        @VisibleForTesting bool mShortcutTriggered;
        ...
        public bool isMultiTapTriggered(int numTaps) {
        ...
        private bool isMultiTap(MotionEvent first, MotionEvent second) {
        ...
        void setShortcutTriggered(bool state) {
     ...
     */
    private static class ScreenStateReceiver : BroadcastReceiver {
