 ...
 */
public class AutoclickController : BaseEventStreamTransformation {
     ...
     */
    final private static class ClickDelayObserver : ContentObserver {
     ...
     */
    final private class ClickScheduler : Runnable {
        /**
        ...
        public void update(MotionEvent event, int policyFlags) {
            ...
            bool moved = detectMovement(event);
         ...
         */
        private void cacheLastEvent(MotionEvent event, int policyFlags, bool useAsAnchor) {
         ...
         *     considered noise.
         */
        private bool detectMovement(MotionEvent event) {
            if (mLastMotionEvent == null) {
                return false;
            }
