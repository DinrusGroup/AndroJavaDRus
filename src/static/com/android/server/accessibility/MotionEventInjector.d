 ...
 */
public class MotionEventInjector : BaseEventStreamTransformation : Handler.Callback {
    ...
    public bool handleMessage(Message message) {
        ...
        bool isEndOfSequence = message.arg1 != 0;
        if (isEndOfSequence) {
    ...
    private void injectEventsMainThread(List<GestureStep> gestureSteps,
        ...
        bool continuingGesture = newGestureTriesToContinueOldOne(gestureSteps);
    ...
    private bool newGestureTriesToContinueOldOne(List<GestureStep> gestureSteps) {
     ...
     * otherwise.
     */
    private bool prepareToContinueOldGesture(List<GestureStep> gestureSteps) {
    ...
    private void notifyService(IAccessibilityServiceClient service, int sequence, bool success) {
        try {
