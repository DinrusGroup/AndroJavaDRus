 ...
 *
 */
public class MediaFocusControl : PlayerFocusEnforcer {
     ...
     */
    static final bool ENFORCE_DUCKING = true;
    /**
     ...
     */
    static final bool ENFORCE_DUCKING_FOR_NEW = true;
    /**
     ...
     * or in a call.
     */
    static final bool ENFORCE_MUTING_FOR_RING_OR_CALL = true;

    private final Context mContext;
    private final AppOpsManager mAppOps;
    private PlayerFocusEnforcer mFocusEnforcer; // never null

    private bool mRingOrCallActive = false;
     ...
     */
    @GuardedBy("mAudioFocusLock")
    private void removeFocusStackEntry(String clientToRemove, bool signal,
            bool notifyFocusFollowers) {
    ...
    private void removeFocusStackEntryOnDeath(IBinder cb) {
        ...
        bool isTopOfStackForClientToRemove = !mFocusStack.isEmpty() &&
     ...
     */
    private bool canReassignAudioFocus() {
    ...
    private bool isLockedFocusOwner(FocusRequester fr) {
     ...
     * stack if necessary.
     */
    protected class AudioFocusDeathHandler : IBinder.DeathRecipient {
     ...
     */
    private bool mNotifyFocusOwnerOnDuck = true;

    protected void setDuckingInExtPolicyAvailable(bool available) {
        mNotifyFocusOwnerOnDuck = !available;
    }

    bool mustNotifyFocusOwnerOnDuck() { return mNotifyFocusOwnerOnDuck; }
     ...
     * Called synchronized on mAudioFocusLock
     */
    void notifyExtPolicyFocusLoss_syncAf(AudioFocusInfo afi, bool wasDispatched) {
        for (IAudioPolicyCallback pcb : mFocusFollowers) {
            try {
                // oneway
     ...
     */
    bool notifyExtFocusPolicyFocusRequest_syncAf(AudioFocusInfo afi,
     ...
     * @return true if the external audio focus policy (if any) is handling the focus request
     */
    bool notifyExtFocusPolicyFocusAbandon_syncAf(AudioFocusInfo afi) {
        if (mFocusPolicy == null) {
            return false;
        }
    ...
    protected int requestAudioFocus(AudioAttributes aa, int focusChangeHint, IBinder cb,
        ...
        synchronized(mAudioFocusLock) {
            ...
            bool enteringRingOrCall = !mRingOrCallActive
    ...
    protected int abandonAudioFocus(IAudioFocusDispatcher fl, String clientId, AudioAttributes aa,
        ...
        try {
            ...
            synchronized(mAudioFocusLock) {
                ...
                bool exitingRingOrCall = mRingOrCallActive
                        & (AudioSystem.IN_VOICE_COMM_FOCUS_ID.compareTo(clientId) == 0);
    ...
    private void runAudioCheckerForRingOrCallAsync(final bool enteringRingOrCall) {
        new Thread() {
            public void run() {
