...
public class AudioServiceEvents {
    ...
    final static class PhoneStateEvent : AudioEventLogger.Event {
    ...
    final static class WiredDevConnectEvent : AudioEventLogger.Event {
    ...
    final static class ForceUseEvent : AudioEventLogger.Event {
        final int mUsage;
        final int mConfig;
    ...
    final static class VolumeEvent : AudioEventLogger.Event {
