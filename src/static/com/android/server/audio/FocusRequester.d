...
public class FocusRequester {
     ...
     */
    private bool mFocusLossWasNotified;
    /**
    ...
    bool hasSameClient(String otherClient) {
        try {
    ...
    bool handleFocusLossFromGain(int focusGain, final FocusRequester frWinner, bool forceDuck)
    {
    ...
    @GuardedBy("MediaFocusControl.mAudioFocusLock")
    void handleFocusLoss(int focusLoss, @Nullable final FocusRequester frWinner, bool forceDuck)
    {
        try {
            if (focusLoss != mFocusLossReceived) {
                ...
                //    (i.e. it has a focus controller that : a ducking policy)
                // 2/ it is a DUCK loss
