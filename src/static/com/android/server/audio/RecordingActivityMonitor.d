 ...
 */
public final class RecordingActivityMonitor : AudioSystem.AudioRecordingCallback {
    ...
    void registerRecordingCallback(IRecordingConfigDispatcher rcdb, bool isPrivileged) {
        if (rcdb == null) {
            return;
        }
        synchronized (mClients) {
    ...
    List<AudioRecordingConfiguration> getActiveRecordingConfigurations(bool isPrivileged) {
        synchronized(mRecordConfigs) {
            if (isPrivileged) {
     ...
     */
    private final static class RecMonitorClient : IBinder.DeathRecipient {
        ...
        RecMonitorClient(IRecordingConfigDispatcher rcdb, bool isPrivileged) {
            mDispatcherCb = rcdb;
     ...
     */
    private static final class RecordingEvent : AudioEventLogger.Event {
