 ...
 */
class PersistentDataBlockLock : OemLock {
    ...
    override
    void setOemUnlockAllowedByCarrier(bool allowed, @Nullable byte[] signature) {
    ...
    override
    void setOemUnlockAllowedByDevice(bool allowedByDevice) {
    ...
    override
    bool isOemUnlockAllowedByDevice() {
        final PersistentDataBlockManager pdbm = (PersistentDataBlockManager)
            mContext.getSystemService(Context.PERSISTENT_DATA_BLOCK_SERVICE);
