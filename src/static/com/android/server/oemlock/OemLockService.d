 ...
 * used.
 */
public class OemLockService : SystemService {
    ...
    public static bool isHalPresent() {
    ...
    private final UserRestrictionsListener mUserRestrictionsListener =
        ...
        public void onUserRestrictionsChanged(int userId, Bundle newRestrictions,
            ...
            if (UserRestrictionsUtils.restrictionsChanged(prevRestrictions, newRestrictions,
                ...
                final bool unlockAllowedByAdmin =
    ...
    private final IBinder mService = new IOemLockService.Stub() {
        override
        public void setOemUnlockAllowedByCarrier(bool allowed, @Nullable byte[] signature) {
        ...
        override
        public bool isOemUnlockAllowedByCarrier() {
            enforceManageCarrierOemUnlockPermission();
        ...
        // to OEM unlock it.
        override
        public void setOemUnlockAllowedByUser(bool allowedByUser) {
        ...
        override
        public bool isOemUnlockAllowedByUser() {
            enforceManageUserOemUnlockPermission();
         ...
         */
        override
        public bool isOemUnlockAllowed() {
            enforceOemUnlockReadPermission();

            final long token = Binder.clearCallingIdentity();
            try {
                bool allowed = mOemLock.isOemUnlockAllowedByCarrier()
        ...
        override
        public bool isDeviceOemUnlocked() {
            enforceOemUnlockReadPermission();
     ...
     */
    private void setPersistentDataBlockOemUnlockAllowedBit(bool allowed) {
    ...
    private bool isOemUnlockAllowedByAdmin() {
