 ...
 * </ul>
 */
final class RoutingControlAction : HdmiCecFeatureAction {
    ...
    private final bool mQueryDevicePowerStatus;
    ...
    private final bool mNotifyInputChange;
    ...
    RoutingControlAction(HdmiCecLocalDevice localDevice, int path, bool queryDevicePowerStatus,
    ...
    override
    public bool processCommand(HdmiCecMessage cmd) {
    ...
    private static bool isPowerOnOrTransient(int status) {
    ...
    private void handlDevicePowerStatusAckResult(bool acked) {
        if (acked) {
