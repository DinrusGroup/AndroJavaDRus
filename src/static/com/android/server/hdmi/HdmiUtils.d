...
final class HdmiUtils {
     ...
     */
    static bool isValidAddress(int address) {
     ...
     */
    static bool checkCommandSource(HdmiCecMessage cmd, int expectedAddress, String tag) {
     ...
     */
    static bool parseCommandParamSystemAudioStatus(HdmiCecMessage cmd) {
     ...
     */
    static bool isAudioStatusMute(HdmiCecMessage cmd) {
     ...
     */
    static bool isAffectingActiveRoutingPath(int activePath, int newPath) {
     ...
     */
    static bool isInActiveRoutingPath(int activePath, int newPath) {
