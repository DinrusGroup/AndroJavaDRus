...
public final class HdmiCecMessageValidator {
    ...
    private static class FixedLengthValidator : ParameterValidator {
    ...
    private static class VariableLengthValidator : ParameterValidator {
    ...
    private bool isValidPhysicalAddress(byte[] params, int offset) {
    ...
    private static int toErrorCode(bool success) {
        return success ? OK : ERROR_PARAMETER;
    }

    private class PhysicalAddressValidator : ParameterValidator {
        override
        public int isValid(byte[] params) {
            if (params.length < 2) {
    ...
    private class SystemAudioModeRequestValidator : PhysicalAddressValidator {
        override
        public int isValid(byte[] params) {
    ...
    private class ReportPhysicalAddressValidator : ParameterValidator {
        override
        public int isValid(byte[] params) {
            if (params.length < 3) {
                return ERROR_PARAMETER_SHORT;
    ...
    private class RoutingChangeValidator : ParameterValidator {
        override
        public int isValid(byte[] params) {
            if (params.length < 4) {
                return ERROR_PARAMETER_SHORT;
