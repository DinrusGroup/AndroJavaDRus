 ...
 */
final class VolumeControlAction : HdmiCecFeatureAction {
    ...
    private bool mIsVolumeUp;
    private long mLastKeyUpdateTime;
    private int mLastAvrVolume;
    private bool mLastAvrMute;
    private bool mSentKeyPressed;
    ...
    VolumeControlAction(HdmiCecLocalDevice source, int avrAddress, bool isVolumeUp) {
        super(source);
    ...
    void handleVolumeChange(bool isVolumeUp) {
    ...
    private bool handleReportAudioStatus(HdmiCecMessage cmd) {
        byte params[] = cmd.getParams();
        bool mute = HdmiUtils.isAudioStatusMute(cmd);
    ...
    private bool shouldUpdateAudioVolume(bool mute) {
    ...
    private bool handleFeatureAbort(HdmiCecMessage cmd) {
