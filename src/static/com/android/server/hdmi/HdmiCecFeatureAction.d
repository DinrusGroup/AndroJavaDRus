...
abstract class HdmiCecFeatureAction {
     ...
     */
    abstract bool processCommand(HdmiCecMessage cmd);
    ...
    private class ActionTimerHandler : Handler : ActionTimer {
    ...
    protected final <T : HdmiCecFeatureAction> List<T> getActions(final Class<T> clazz) {
    ...
    protected final <T : HdmiCecFeatureAction> void removeAction(final Class<T> clazz) {
        mSource.removeActionExcept(clazz, null);
    }

    protected final <T : HdmiCecFeatureAction> void removeActionExcept(final Class<T> clazz,
