 ...
 */
abstract class SystemAudioAction : HdmiCecFeatureAction {
    ...
    protected bool mTargetAudioStatus;
     ...
     */
    SystemAudioAction(HdmiCecLocalDevice source, int avrAddress, bool targetStatus,
    ...
    protected void setSystemAudioMode(bool mode) {
        tv().setSystemAudioMode(mode);
    }

    override
    final bool processCommand(HdmiCecMessage cmd) {
        ...
        switch (mState) {
            case STATE_WAIT_FOR_SET_SYSTEM_AUDIO_MODE:
                ...
                bool receivedStatus = HdmiUtils.parseCommandParamSystemAudioStatus(cmd);
