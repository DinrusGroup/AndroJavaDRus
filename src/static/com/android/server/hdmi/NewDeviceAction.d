 ...
 */
final class NewDeviceAction : HdmiCecFeatureAction {
    ...
    private void requestOsdName(bool firstTry) {
        if (firstTry) {
            mTimeoutRetry = 0;
        }
    ...
    private bool mayProcessCommandIfCached(int destAddress, int opcode) {
    ...
    private void requestVendorId(bool firstTry) {
        if (firstTry) {
            mTimeoutRetry = 0;
        }
    ...
    bool isActionOf(ActiveSource activeSource) {
