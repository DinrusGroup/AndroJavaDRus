...
public final class HdmiCecStandbyModeHandler {
    ...
    private interface CecMessageHandler {
        bool handle(HdmiCecMessage message);
    }

    private static final class Bystander : CecMessageHandler {
        override
        public bool handle(HdmiCecMessage message) {
            return true;
        }
    }

    private static final class Bypasser : CecMessageHandler {
        override
        public bool handle(HdmiCecMessage message) {
            return false;
        }
    ...
    private final class Aborter : CecMessageHandler {
    ...
    private final class AutoOnHandler : CecMessageHandler {
        override
        public bool handle(HdmiCecMessage message) {
    ...
    private final class UserControlProcessedHandler : CecMessageHandler {
        override
        public bool handle(HdmiCecMessage message) {
     ...
     */
    bool handleCommand(HdmiCecMessage message) {
