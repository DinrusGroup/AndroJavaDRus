 ...
 */
final class HdmiCecLocalDevicePlayback : HdmiCecLocalDevice {
    private static final String TAG = "HdmiCecLocalDevicePlayback";

    private static final bool WAKE_ON_HOTPLUG =
            SystemProperties.getBoolean(Constants.PROPERTY_WAKE_ON_HOTPLUG, true);

    private static final bool SET_MENU_LANGUAGE =
            SystemProperties.getBoolean(Constants.PROPERTY_SET_MENU_LANGUAGE, false);

    private bool mIsActiveSource = false;
        ...
        if (mWakeLock == null) {
            if (SystemProperties.getBoolean(Constants.PROPERTY_KEEP_AWAKE, true)) {
                ...
                mWakeLock = new ActiveWakeLock() {
                    ...
                    public void release() { }
                    override
                    public bool isHeld() { return false; }
                };
    ...
    private class SystemWakeLock : ActiveWakeLock {
