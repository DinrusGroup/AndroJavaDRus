 ...
 */
public final class HdmiControlService : SystemService {
    ...
    private class HdmiControlBroadcastReceiver : BroadcastReceiver {
        @ServiceThreadOnly
        override
    ...
    @GuardedBy("mLock")
    private bool mHdmiControlEnabled;
    ...
    @ServiceThreadOnly
    private bool mStandbyMessageReceived = false;

    @ServiceThreadOnly
    private bool mWakeUpMessageReceived = false;
    ...
    @GuardedBy("mLock")
    private bool mMhlInputChangeEnabled;
    ...
    private bool mAddressAllocated = false;
    ...
    private final class CecMessageBuffer {
        ...
        private bool replaceMessageIfBuffered(HdmiCecMessage message, int opcode) {
    ...
    private class SettingsObserver : ContentObserver {
        ...
        public void onChange(bool selfChange, Uri uri) {
            ...
            bool enabled = readBooleanSetting(option, true);
            switch (option) {
    ...
    private static int toInt(bool enabled) {
        return enabled ? ENABLED : DISABLED;
    }

    bool readBooleanSetting(String key, bool defVal) {
        ContentResolver cr = getContext().getContentResolver();
        return Global.getInt(cr, key, toInt(defVal)) == ENABLED;
    }

    void writeBooleanSetting(String key, bool value) {
        ContentResolver cr = getContext().getContentResolver();
     ...
     */
    bool isConnectedToArcPort(int physicalAddress) {
    ...
    @ServiceThreadOnly
    bool handleCecCommand(HdmiCecMessage message) {
        assertRunOnServiceThread();
    ...
    void enableAudioReturnChannel(int portId, bool enabled) {
        mCecController.enableAudioReturnChannel(portId, enabled);
    }

    @ServiceThreadOnly
    private bool dispatchMessageToLocalDevice(HdmiCecMessage message) {
        assertRunOnServiceThread();
    ...
    void setAudioStatus(bool mute, int volume) {
        ...
        bool muted = audioManager.isStreamMute(AudioManager.STREAM_MUSIC);
        if (mute) {
            if (!muted) {
    ...
    void announceSystemAudioModeChange(bool enabled) {
        synchronized (mLock) {
    ...
    @ServiceThreadOnly
    void handleMhlHotplugEvent(int portId, bool connected) {
        assertRunOnServiceThread();
    ...
    @ServiceThreadOnly
    void handleMhlBusOvercurrent(int portId, bool on) {
        assertRunOnServiceThread();
        HdmiMhlLocalDeviceStub device = mMhlController.getLocalDevice(portId);
        if (device != null) {
    ...
    private class HdmiMhlVendorCommandListenerRecord : IBinder.DeathRecipient {
    ...
    private final class HotplugEventListenerRecord : IBinder.DeathRecipient {
    ...
    private final class DeviceEventListenerRecord : IBinder.DeathRecipient {
    ...
    private final class SystemAudioModeChangeListenerRecord : IBinder.DeathRecipient {
    ...
    class VendorCommandListenerRecord : IBinder.DeathRecipient {
    ...
    private class HdmiRecordListenerRecord : IBinder.DeathRecipient {
    ...
    private final class BinderService : IHdmiControlService.Stub {
        override
        ...
        override
        public void sendKeyEvent(final int deviceType, final int keyCode, final bool isPressed) {
            enforceAccessPermission();
            runOnServiceThread(new Runnable() {
                override
                public void run() {
        ...
        override
        public bool canChangeSystemAudioMode() {
            enforceAccessPermission();
            HdmiCecLocalDeviceTv tv = tv();
            if (tv == null) {
                return false;
        ...
        override
        public bool getSystemAudioMode() {
            enforceAccessPermission();
            HdmiCecLocalDeviceTv tv = tv();
            if (tv == null) {
                return false;
        ...
        override
        public void setSystemAudioMode(final bool enabled, final IHdmiControlCallback callback) {
            enforceAccessPermission();
            runOnServiceThread(new Runnable() {
                override
                public void run() {
        ...
        override
        public void setSystemAudioMute(final bool mute) {
            enforceAccessPermission();
            runOnServiceThread(new Runnable() {
                override
                public void run() {
        ...
        override
        public void setArcMode(final bool enabled) {
            enforceAccessPermission();
            runOnServiceThread(new Runnable() {
                override
                public void run() {
        ...
        override
        public void setProhibitMode(final bool enabled) {
            enforceAccessPermission();
            if (!isTvDevice()) {
                return;
            }
        ...
        public void sendVendorCommand(final int deviceType, final int targetAddress,
                final byte[] params, final bool hasVendorId) {
            enforceAccessPermission();
            runOnServiceThread(new Runnable() {
                override
                public void run() {
        ...
        override
        public void setStandbyMode(final bool isStandbyModeOn) {
            enforceAccessPermission();
            runOnServiceThread(new Runnable() {
                override
                public void run() {
    ...
    private final class InputChangeListenerRecord : IBinder.DeathRecipient {
    ...
    private void announceHotplugEvent(int portId, bool connected) {
    ...
    bool invokeVendorCommandListenersOnReceived(int deviceType, int srcAddress, int destAddress,
            byte[] params, bool hasVendorId) {
        synchronized (mLock) {
    ...
    bool invokeVendorCommandListenersOnControlStateChanged(bool enabled, int reason) {
        synchronized (mLock) {
            if (mVendorCommandListenerRecords.isEmpty()) {
                return false;
            }
    ...
    void setStandbyMode(bool isStandbyModeOn) {
        assertRunOnServiceThread();
    ...
    void setProhibitMode(bool enabled) {
        synchronized (mLock) {
    ...
    @ServiceThreadOnly
    void setCecOption(int key, bool value) {
        assertRunOnServiceThread();
     ...
     */
    @ServiceThreadOnly
    void changeInputForMhl(int portId, bool contentOn) {
        assertRunOnServiceThread();
        if (tv() == null) return;
   ...
   void setMhlInputChangeEnabled(bool enabled) {
