 ...
 * @hide
 */
public class SoundTriggerDbHelper : SQLiteOpenHelper {
     ...
     *
     */
    public bool updateGenericSoundModel(GenericSoundModel soundModel) {
        synchronized(this) {
    ...
    public bool deleteGenericSoundModel(UUID model_uuid) {
        synchronized(this) {
