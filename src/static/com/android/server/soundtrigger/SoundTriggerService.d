 ...
 * @hide
 */
public class SoundTriggerService : SystemService {
    ...
    private synchronized bool isInitialized() {
        if (mSoundTriggerHelper == null ) {
    ...
    class SoundTriggerServiceStub : ISoundTriggerService.Stub {
        override
        ...
        override
        public bool isRecognitionActive(ParcelUuid parcelUuid) {
            enforceCallingPermission(Manifest.permission.MANAGE_SOUND_TRIGGER);
    ...
    private final class LocalSoundTriggerRecognitionStatusIntentCallback
        ...
        private void removeCallback(bool releaseWakeLock) {
    ...
    private class RemoteSoundTriggerDetectionService
        : IRecognitionStatusCallback.Stub : ServiceConnection {
         ...
         */
        @GuardedBy("mRemoteServiceLock")
        private bool mDestroyOnceRunningOpsDone;
    ...
    public final class LocalSoundTriggerService : SoundTriggerInternal {
