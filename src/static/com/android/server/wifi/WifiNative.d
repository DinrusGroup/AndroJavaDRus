...
public class WifiNative {
    ...
    private static class IfaceManager {
        ...
        private bool hasAnyIface() {
            return !mIfaces.isEmpty();
        }

        /** Checks if there are any iface of the given type active. */
        private bool hasAnyIfaceOfType(@Iface.IfaceType int type) {
            for (Iface iface : mIfaces.values()) {
                if (iface.type == type) {
                    return true;
                }
     ...
     */
    private bool waitForSupplicantConnection() {
    ...
    private bool registerNetworkObserver(NetworkObserverInternal observer) {
    ...
    private bool unregisterNetworkObserver(NetworkObserverInternal observer) {
        if (observer == null) return false;
        try {
     ...
     */
    private class VendorHalDeathHandlerInternal : VendorHalDeathEventHandler {
        override
        public void onDeath() {
            synchronized (mLock) {
     ...
     */
    private class WificondDeathHandlerInternal : WificondDeathEventHandler {
        override
        public void onDeath() {
            synchronized (mLock) {
     ...
     */
    private class SupplicantDeathHandlerInternal : SupplicantDeathEventHandler {
        override
        public void onDeath() {
            synchronized (mLock) {
     ...
     */
    private class HostapdDeathHandlerInternal : HostapdDeathEventHandler {
        override
        public void onDeath() {
            synchronized (mLock) {
    ...
    private void onInterfaceStateChanged(Iface iface, bool isUp) {
        synchronized (mLock) {
     ...
     */
    private class NetworkObserverInternal : BaseNetworkObserver {
        /** Identifier allocated for the interface */
        private final int mInterfaceId;
         ...
         * {@link BaseNetworkObserver#interfaceStatusChanged(String, bool)} here. But, that
         ...
         */
        override
        public void interfaceLinkStateChanged(String ifaceName, bool unusedIsLinkUp) {
            synchronized (mLock) {
    ...
    private class VendorHalRadioModeChangeHandlerInternal
            : VendorHalRadioModeChangeEventHandler {
        override
     ...
     */
    private String createStaIface(@NonNull Iface iface, bool lowPrioritySta) {
        synchronized (mLock) {
            if (mWifiVendorHal.isVendorHalSupported()) {
    ...
    // So simulate the HalDeviceManager behavior by triggering the destroy listener for
    // the interface.
    private bool handleIfaceRemovalWhenVendorHalNotSupported(@NonNull Iface iface) {
        synchronized (mLock) {
     ...
     * teardown any existing iface.
     */
    private bool removeStaIface(@NonNull Iface iface) {
        synchronized (mLock) {
            if (mWifiVendorHal.isVendorHalSupported()) {
     ...
     * Helper function to handle removal of STA iface.
     */
    private bool removeApIface(@NonNull Iface iface) {
        synchronized (mLock) {
            if (mWifiVendorHal.isVendorHalSupported()) {
    ...
    public interface StatusListener {
         ...
         */
        void onStatusChanged(bool allReady);
    }
     ...
     */
    public String setupInterfaceForClientMode(bool lowPrioritySta,
     ...
     */
    public bool isInterfaceUp(@NonNull String ifaceName) {
        synchronized (mLock) {
     ...
     */
    public bool startPnoScan(@NonNull String ifaceName, PnoSettings pnoSettings) {
     ...
     * @return true on success.
     */
    public bool stopPnoScan(@NonNull String ifaceName) {
     ...
     * @return true if connection is established, false otherwise.
     */
    private bool waitForHostapdConnection() {
        // Start initialization if not already started.
     ...
     * @return true on success, false otherwise.
     */
    public bool stopSoftAp(@NonNull String ifaceName) {
     ...
     * @return true on success
     */
    public bool setMacAddress(String interfaceName, MacAddress mac) {
     ...
     */
    public void setSupplicantLogLevel(bool turnOnVerbose) {
     ...
     */
    public bool reconnect(@NonNull String ifaceName) {
     ...
     * @return true if request is sent successfully, false otherwise.
     */
    public bool reassociate(@NonNull String ifaceName) {
     ...
     * @return true if request is sent successfully, false otherwise.
     */
    public bool disconnect(@NonNull String ifaceName) {
     ...
     */
    public bool startFilteringMulticastV4Packets(@NonNull String ifaceName) {
     ...
     * @return {@code true} if the operation succeeded, {@code false} otherwise
     */
    public bool stopFilteringMulticastV4Packets(@NonNull String ifaceName) {
        return mSupplicantStaIfaceHal.stopRxFilter(ifaceName)
     ...
     * @return {@code true} if the operation succeeded, {@code false} otherwise
     */
    public bool startFilteringMulticastV6Packets(@NonNull String ifaceName) {
        return mSupplicantStaIfaceHal.stopRxFilter(ifaceName)
                && mSupplicantStaIfaceHal.removeRxFilter(
     ...
     * @return {@code true} if the operation succeeded, {@code false} otherwise
     */
    public bool stopFilteringMulticastV6Packets(@NonNull String ifaceName) {
        return mSupplicantStaIfaceHal.stopRxFilter(ifaceName)
                && mSupplicantStaIfaceHal.addRxFilter(
                        ifaceName, RX_FILTER_TYPE_V6_MULTICAST)
                && mSupplicantStaIfaceHal.startRxFilter(ifaceName);
     ...
     */
    public bool setBluetoothCoexistenceMode(@NonNull String ifaceName, int mode) {
     ...
     */
    public bool setBluetoothCoexistenceScanMode(
            @NonNull String ifaceName, bool setCoexScanMode) {
     ...
     * @return true if request is sent successfully, false otherwise.
     */
    public bool setSuspendOptimizations(@NonNull String ifaceName, bool enabled) {
     ...
     * @return true if request is sent successfully, false otherwise.
     */
    public bool setCountryCode(@NonNull String ifaceName, String countryCode) {
     ...
     */
    public void startTdls(@NonNull String ifaceName, String macAddr, bool enable) {
        if (enable) {
     ...
     * @return true if request is sent successfully, false otherwise.
     */
    public bool startWpsPbc(@NonNull String ifaceName, String bssid) {
     ...
     * @return true if request is sent successfully, false otherwise.
     */
    public bool startWpsPinKeypad(@NonNull String ifaceName, String pin) {
     ...
     * @return true if request is sent successfully, false otherwise.
     */
    public bool setExternalSim(@NonNull String ifaceName, bool external) {
     ...
     * @return true if succeeds, false otherwise.
     */
    public bool simAuthFailedResponse(@NonNull String ifaceName, int id) {
     ...
     * @return true if succeeds, false otherwise.
     */
    public bool umtsAuthFailedResponse(@NonNull String ifaceName, int id) {
     ...
     * @return true if succeeds, false otherwise.
     */
    public bool simIdentityResponse(@NonNull String ifaceName, int id,
     ...
     * @return true if request is sent successfully, false otherwise.
     */
    public bool startWpsRegistrar(@NonNull String ifaceName, String bssid, String pin) {
     ...
     * @return true if request is sent successfully, false otherwise.
     */
    public bool cancelWps(@NonNull String ifaceName) {
     ...
     * @return true if request is sent successfully, false otherwise.
     */
    public bool setDeviceName(@NonNull String ifaceName, String name) {
     ...
     * @return true if request is sent successfully, false otherwise.
     */
    public bool setDeviceType(@NonNull String ifaceName, String type) {
     ...
     * @return true if request is sent successfully, false otherwise.
     */
    public bool setConfigMethods(@NonNull String ifaceName, String cfg) {
     ...
     * @return true if request is sent successfully, false otherwise.
     */
    public bool setManufacturer(@NonNull String ifaceName, String value) {
     ...
     * @return true if request is sent successfully, false otherwise.
     */
    public bool setModelName(@NonNull String ifaceName, String value) {
     ...
     * @return true if request is sent successfully, false otherwise.
     */
    public bool setModelNumber(@NonNull String ifaceName, String value) {
     ...
     * @return true if request is sent successfully, false otherwise.
     */
    public bool setSerialNumber(@NonNull String ifaceName, String value) {
     ...
     */
    public void setPowerSave(@NonNull String ifaceName, bool enabled) {
     ...
     * @return true if request is sent successfully, false otherwise.
     */
    public bool setConcurrencyPriority(bool isStaHigherPriority) {
     ...
     * @return true if request is sent successfully, false otherwise.
     */
    public bool enableStaAutoReconnect(@NonNull String ifaceName, bool enable) {
     ...
     */
    public bool migrateNetworksFromSupplicant(
     ...
     */
    public bool connectToNetwork(@NonNull String ifaceName, WifiConfiguration configuration) {
     ...
     * @return {@code true} if it succeeds, {@code false} otherwise
     */
    public bool roamToNetwork(@NonNull String ifaceName, WifiConfiguration configuration) {
     ...
     * @return {@code true} if it succeeds, {@code false} otherwise
     */
    public bool removeAllNetworks(@NonNull String ifaceName) {
     ...
     */
    public bool setConfiguredNetworkBSSID(@NonNull String ifaceName, String bssid) {
     ...
     * @return true if request is sent successfully, false otherwise
     */
    public bool requestIcon(@NonNull String ifaceName, String  bssid, String fileName) {
     ...
     */
    public bool getBgScanCapabilities(
     ...
     */
    public bool cancelRtt(RttManager.RttParams[] params) {
     ...
     */
    public bool disableRttResponder() {
     ...
     * @return true for success
     */
    public bool setScanningMacOui(@NonNull String ifaceName, byte[] oui) {
     ...
     * @return true for success
     */
    public bool installPacketFilter(@NonNull String ifaceName, byte[] filter) {
     ...
     * @return true for success
     */
    public bool setCountryCodeHal(@NonNull String ifaceName, String countryCode) {
     ...
     * @return true on success, false otherwise.
     */
    public bool setLoggingEventHandler(WifiLoggerEventHandler handler) {
     ...
     */
    public bool startLoggingRingBuffer(int verboseLevel, int flags, int maxInterval,
     ...
     * @return true on success, false otherwise.
     */
    public bool getRingBufferData(String ringName) {
     ...
     */
    @Immutable
    public static final class TxFateReport : FateReport {
     ...
     */
    @Immutable
    public static final class RxFateReport : FateReport {
     ...
     * @return true for success, false otherwise.
     */
    public bool startPktFateMonitoring(@NonNull String ifaceName) {
     ...
     * @return true for success, false otherwise.
     */
    public bool getTxPktFates(@NonNull String ifaceName, TxFateReport[] reportBufs) {
     ...
     * @param ifaceName Name of the interface.
     */
    public bool getRxPktFates(@NonNull String ifaceName, RxFateReport[] reportBufs) {
     ...
     * @return true for success, false otherwise.
     */
    public bool configureNeighborDiscoveryOffload(@NonNull String ifaceName, bool enabled) {
     ...
     * @return true for success, false otherwise.
     */
    public bool getRoamingCapabilities(
     ...
     * @param ifaceName Name of the interface.
     */
    public bool configureRoaming(@NonNull String ifaceName, RoamingConfig config) {
     ...
     * @param ifaceName Name of the interface.
     */
    public bool resetRoamingConfiguration(@NonNull String ifaceName) {
     ...
     */
    public bool selectTxPowerScenario(int scenario) {
