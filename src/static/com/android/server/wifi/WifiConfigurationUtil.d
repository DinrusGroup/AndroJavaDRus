...
public class WifiConfigurationUtil {
     ...
     * profiles
     */
    public static bool isVisibleToAnyProfile(WifiConfiguration config, List<UserInfo> profiles) {
     ...
     */
    public static bool doesUidBelongToAnyProfile(int uid, List<UserInfo> profiles) {
     ...
     */
    public static bool hasAnyValidWepKey(String[] wepKeys) {
     ...
     */
    public static bool isConfigForPskNetwork(WifiConfiguration config) {
     ...
     */
    public static bool isConfigForEapNetwork(WifiConfiguration config) {
     ...
     */
    public static bool isConfigForWepNetwork(WifiConfiguration config) {
     ...
     */
    public static bool isConfigForOpenNetwork(WifiConfiguration config) {
     ...
     */
    public static bool hasIpChanged(WifiConfiguration existingConfig,
     ...
     */
    public static bool hasProxyChanged(WifiConfiguration existingConfig,
            WifiConfiguration newConfig) {
     ...
     */
    @VisibleForTesting
    public static bool hasEnterpriseConfigChanged(WifiEnterpriseConfig existingEnterpriseConfig,
     ...
     * @return true if credentials have changed, false otherwise.
     */
    public static bool hasCredentialChanged(WifiConfiguration existingConfig,
            WifiConfiguration newConfig) {
    ...
    private static bool validateSsid(String ssid, bool isAdd) {
        if (isAdd) {
            if (ssid == null) {
    ...
    private static bool validatePsk(String psk, bool isAdd) {
        if (isAdd) {
            if (psk == null) {
    ...
    private static bool validateBitSet(BitSet bitSet, int validValuesLength) {
    ...
    private static bool validateBitSets(WifiConfiguration config) {
    ...
    private static bool validateKeyMgmt(BitSet keyMgmnt) {
    ...
    private static bool validateIpConfiguration(IpConfiguration ipConfig) {
        if (ipConfig == null) {
     ...
     */
    public static final bool VALIDATE_FOR_ADD = true;
    public static final bool VALIDATE_FOR_UPDATE = false;
     ...
     */
    public static bool validate(WifiConfiguration config, bool isAdd) {
     ...
     *         false otherwise.
     */
    public static bool isSameNetwork(WifiConfiguration config, WifiConfiguration config1) {
     ...
     * implementation.
     */
    public abstract static class WifiConfigurationComparator :
