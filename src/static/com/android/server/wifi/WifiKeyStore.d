...
public class WifiKeyStore {
     ...
     */
    void enableVerboseLogging(bool verbose) {
        mVerboseLoggingEnabled = verbose;
    }

    // Certificate and private key management for EnterpriseConfig
    private static bool needsKeyStore(WifiEnterpriseConfig config) {
        return (config.getClientCertificate() != null || config.getCaCertificate() != null);
    }

    private static bool isHardwareBackedKey(Key key) {
        return KeyChain.isBoundKeyAlgorithm(key.getAlgorithm());
    }

    private static bool hasHardwareBackedKey(Certificate certificate) {
     ...
     */
    private bool installKeys(WifiEnterpriseConfig existingConfig, WifiEnterpriseConfig config,
            String name) {
        bool ret = true;
     ...
     */
    public bool putCertInKeyStore(String name, Certificate cert) {
     ...
     * @return true on success
     */
    public bool putCertsInKeyStore(String name, Certificate[] certs) {
        try {
     ...
     * @return true on success
     */
    public bool putKeyInKeyStore(String name, Key key) {
     ...
     * @return true on success
     */
    public bool removeEntryFromKeyStore(String name) {
     ...
     * @return true if successful, false otherwise.
     */
    public bool updateNetworkKeys(WifiConfiguration config, WifiConfiguration existingConfig) {
     ...
     *               network.
     */
    public static bool needsSoftwareBackedKeyStore(WifiEnterpriseConfig config) {
        String client = config.getClientCertificateAlias();
        if (!TextUtils.isEmpty(client)) {
            // a valid client certificate is configured
