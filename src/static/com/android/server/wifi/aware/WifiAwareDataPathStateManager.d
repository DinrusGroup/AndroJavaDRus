...
public class WifiAwareDataPathStateManager {
    ...
    /* package */ bool mAllowNdpResponderFromAnyOverride = false;
     ...
     */
    public void onRespondToDataPathRequest(int ndpId, bool success, int reasonOnFailure) {
        if (VDBG) {
     ...
     */
    public WifiAwareNetworkSpecifier onDataPathConfirm(int ndpId, byte[] mac, bool accept,
        ...
        if (accept) {
            ...
            bool interfaceUsedByAnotherNdp = isInterfaceUpAndUsedByAnotherNdp(nnri);
    ...
    private class WifiAwareNetworkFactory : NetworkFactory {
        ...
        private bool mWaitingForTermination = false;
    ...
    private class WifiAwareNetworkAgent : NetworkAgent {
    ...
    private bool isInterfaceUpAndUsedByAnotherNdp(AwareNetworkRequestInformation nri) {
    ...
    public static class AwareNetworkRequestInformation {
        ...
        static AwareNetworkRequestInformation processNetworkSpecifier(WifiAwareNetworkSpecifier ns,
                ...
                bool allowNdpResponderFromAnyOverride) {
            int uid, pubSubId = 0;
    ...
    static class CanonicalConnectionInfo {
        ...
        public bool matches(CanonicalConnectionInfo other) {
    ...
    public class NetworkInterfaceWrapper {
         ...
         */
        public bool configureAgentProperties(AwareNetworkRequestInformation nnri,
