...
public class WifiAwareClientState {
    ...
    private final bool mNotifyIdentityChange;
    ...
    public WifiAwareClientState(Context context, int clientId, int uid, int pid,
            ...
            bool notifyIdentityChange, long creationTime) {
        mContext = context;
        mClientId = clientId;
        mUid = uid;
        mPid = pid;
    ...
    public bool getNotifyIdentityChange() {
    ...
    public void onInterfaceAddressChange(byte[] mac) {
        ...
        if (mNotifyIdentityChange && !Arrays.equals(mac, mLastDiscoveryInterfaceMac)) {
            try {
                bool hasPermission = hasLocationingPermission();
    ...
    private bool hasLocationingPermission() {
