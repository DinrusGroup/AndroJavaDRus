 ...
 */
public class WifiController : StateMachine {
    private static final String TAG = "WifiController";
    private static final bool DBG = false;
    private Context mContext;
    private bool mFirstUserSignOnSeen = false;
    ...
    WifiController(Context context, WifiStateMachine wsm, Looper wifiStateMachineLooper,
        ...
        bool isAirplaneModeOn = mSettingsStore.isAirplaneModeOn();
        bool isWifiEnabled = mSettingsStore.isWifiToggleEnabled();
        bool isScanningAlwaysAvailable = mSettingsStore.isScanAlwaysAvailable();
        bool isLocationModeActive =
    ...
    private bool checkScanOnlyModeAvailable() {
     ...
     * mode changes.
     */
    private class ScanOnlyCallback : ScanOnlyModeManager.Listener {
        override
     ...
     */
    private class ClientModeCallback : ClientModeManager.Listener {
        override
        public void onStateChanged(int state) {
            if (state == WifiManager.WIFI_STATE_UNKNOWN) {
    ...
    class StaDisabledState : State {
        private int mDeferredEnableSerialNumber = 0;
        private bool mHaveDeferredEnable = false;
        ...
        private bool doDeferEnable(Message msg) {
    ...
    class StaDisabledWithScanState : State {
        private int mDeferredEnableSerialNumber = 0;
        private bool mHaveDeferredEnable = false;
        private long mDisabledTimestamp;
