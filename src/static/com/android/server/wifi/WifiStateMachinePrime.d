...
public class WifiStateMachinePrime {
    ...
    private class ModeStateMachine : StateMachine {
        ...
        private bool checkForAndHandleModeChange(Message message) {
            switch(message.what) {
        ...
        class WifiDisabledState : ModeActiveState {
            override
            public void enter() {
        ...
        class ClientModeActiveState : ModeActiveState {
            ClientListener mListener;
            private class ClientListener : ClientModeManager.Listener {
                override
        ...
        class ScanOnlyModeActiveState : ModeActiveState {
            ScanOnlyListener mListener;
            private class ScanOnlyListener : ScanOnlyModeManager.Listener {
                override
                public void onStateChanged(int state) {
                    if (this != mListener) {
    ...
    private class SoftApCallbackImpl : ModeCallback : WifiManager.SoftApCallback {
        override
     ...
     *
     *  @param enabled bool indicating that some mode has been turned on or off
     */
    private void updateBatteryStatsWifiState(bool enabled) {
        try {
            if (enabled) {
    ...
    private final class WifiNativeStatusListener : StatusListener {
