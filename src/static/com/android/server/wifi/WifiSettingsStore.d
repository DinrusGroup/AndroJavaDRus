...
public class WifiSettingsStore {
    ...
    public synchronized bool isWifiToggleEnabled() {
     ...
     */
    public synchronized bool isAirplaneModeOn() {
       return mAirplaneModeOn;
    }

    public synchronized bool isScanAlwaysAvailable() {
        return !mAirplaneModeOn && mScanAlwaysAvailable;
    }

    public synchronized bool handleWifiToggled(bool wifiEnabled) {
    ...
    synchronized bool handleAirplaneModeToggled() {
    ...
    private bool isAirplaneSensitive() {
    ...
    private bool isAirplaneToggleable() {
     ...
     */
    private bool testAndClearWifiSavedState() {
    ...
    private bool getPersistedAirplaneModeOn() {
        return Settings.Global.getInt(mContext.getContentResolver(),
                Settings.Global.AIRPLANE_MODE_ON, 0) == 1;
    }

    private bool getPersistedScanAlwaysAvailable() {
        return Settings.Global.getInt(mContext.getContentResolver(),
