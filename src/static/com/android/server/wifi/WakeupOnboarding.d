...
public class WakeupOnboarding {
    ...
    private bool shouldShowNotification(long timestamp) {
    ...
    private void dismissNotification(bool shouldOnboard) {
    ...
    private class IsOnboardedDataSource : WakeupConfigStoreData.DataSource<Boolean> {
    ...
    private class NotificationsDataSource : WakeupConfigStoreData.DataSource<Integer> {
