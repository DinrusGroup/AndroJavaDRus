...
public class WifiVendorHal {
     ...
     */
    private bool ok(WifiStatus status) {
     ...
     */
    private bool boolResult(bool result) {
     ...
     */
    public bool initialize(WifiNative.VendorHalDeathEventHandler handler) {
        synchronized (sLock) {
     ...
     */
    public bool isVendorHalSupported() {
        synchronized (sLock) {
    ...
    private class StaInterfaceDestroyedListenerInternal : InterfaceDestroyedListener {
     ...
     */
    public String createStaIface(bool lowPrioritySta,
     ...
     * @return true on success, false otherwise.
     */
    public bool removeStaIface(@NonNull String ifaceName) {
        synchronized (sLock) {
    ...
    private class ApInterfaceDestroyedListenerInternal : InterfaceDestroyedListener {
        private final InterfaceDestroyedListener mExternalListener;
     ...
     * @return true on success, false otherwise.
     */
    public bool removeApIface(@NonNull String ifaceName) {
        synchronized (sLock) {
    ...
    private bool retrieveWifiChip(IWifiIface iface) {
        synchronized (sLock) {
            bool registrationNeeded = mIWifiChip == null;
     ...
     */
    private bool registerStaIfaceCallback(IWifiStaIface iface) {
        synchronized (sLock) {
            if (iface == null) return boolResult(false);
     ...
     * Registers the sta iface callback.
     */
    private bool registerChipCallback() {
        synchronized (sLock) {
     ...
     */
    private bool registerRttEventCallback() {
        synchronized (sLock) {
     ...
     * @return true for success
     */
    public bool startBgScan(@NonNull String ifaceName,
    ...
    @VisibleForTesting
    bool mLinkLayerStatsDebug = false;  // Passed to Hal
     ...
     */
    private class RttEventCallback : IWifiRttControllerEventCallback.Stub {
     ...
     */
    public bool requestRtt(RttManager.RttParams[] params, WifiNative.RttEventHandler handler) {
     ...
     * @return true for success
     */
    public bool setMacAddress(@NonNull String ifaceName, @NonNull MacAddress mac) {
     ...
     */
    public bool setLoggingEventHandler(WifiNative.WifiLoggerEventHandler handler) {
     ...
     * @return true for success
     */
    public bool startLoggingRingBuffer(int verboseLevel, int flags, int maxIntervalInSec,
     ...
     * @return true for success
     */
    public bool getTxPktFates(@NonNull String ifaceName, WifiNative.TxFateReport[] reportBufs) {
     ...
     * @return true for success
     */
    public bool getRxPktFates(@NonNull String ifaceName, WifiNative.RxFateReport[] reportBufs) {
        if (ArrayUtils.isEmpty(reportBufs)) return boolResult(false);
        synchronized (sLock) {
            IWifiStaIface iface = getStaIface(ifaceName);
            if (iface == null) return boolResult(false);
     ...
     * @return true for success; false for failure
     */
    public bool getRoamingCapabilities(@NonNull String ifaceName,
     ...
     * @return true for success; false for failure
     */
    public bool configureRoaming(@NonNull String ifaceName, WifiNative.RoamingConfig config) {
        synchronized (sLock) {
            IWifiStaIface iface = getStaIface(ifaceName);
            if (iface == null) return boolResult(false);
            try {
                ...
                if (config.whitelistSsids != null) {
                    for (String ssidStr : config.whitelistSsids) {
                        ...
                        for (int i = 0; i < len; i++) {
                            ssid[i] = cast(byte) unquotedSsidStr.charAt(i);
                        }
     ...
     */
    private class StaIfaceEventCallback : IWifiStaIfaceEventCallback.Stub {
        override
        ...
        public void onRssiThresholdBreached(int cmdId, byte[/* 6 */] currBssid, int currRssi) {
            ...
            eventHandler.onRssiThresholdBreached(cast(byte) currRssi);
        }
    }
     ...
     */
    private class ChipEventCallback : IWifiChipEventCallback.Stub {
        override
     ...
     */
    private class ChipEventCallbackV12 :
        ...
        private bool areSameIfaceNames(List<IfaceInfo> ifaceList1, List<IfaceInfo> ifaceList2) {
        ...
        private bool areSameIfaces(List<IfaceInfo> ifaceList1, List<IfaceInfo> ifaceList2) {
     ...
     */
    public class HalDeviceManagerStatusListener : HalDeviceManager.ManagerStatusListener {
        override
        public void onStatusChanged() {
            bool isReady = mHalDeviceManager.isReady();
            bool isStarted = mHalDeviceManager.isStarted();
