...
public class WakeupLock {
    ...
    private bool mVerboseLoggingEnabled;
    ...
    private void maybeSetInitializedByScans(int numScans) {
        ...
        bool shouldBeInitialized = numScans >= CONSECUTIVE_MISSED_SCANS_REQUIRED_TO_EVICT;
    ...
    private void maybeSetInitializedByTimeout(long timestampMillis) {
        ...
        bool shouldBeInitialized = elapsedTime > MAX_LOCK_TIME_MILLIS;
    ...
    public void enableVerboseLogging(bool enabled) {
        mVerboseLoggingEnabled = enabled;
    }

    private class WakeupLockDataSource
            : WakeupConfigStoreData.DataSource<Set<ScanResultMatchInfo>> {
