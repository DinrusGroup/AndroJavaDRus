...
public class WifiLockManager {
     ...
     */
    public bool acquireWifiLock(int lockMode, String tag, IBinder binder, WorkSource ws) {
    ...
    private static bool isValidLockMode(int lockMode) {
    ...
    private synchronized bool addLock(WifiLock lock) {
        if (mVerboseLoggingEnabled) {
    ...
    private synchronized bool releaseLock(IBinder binder) {
    ...
    private class WifiLock : IBinder.DeathRecipient {
        String mTag;
        int mUid;
        IBinder mBinder;
        int mMode;
