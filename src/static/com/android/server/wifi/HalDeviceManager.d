...
public class HalDeviceManager {
     ...
     */
    public IWifiStaIface createStaIface(bool lowPrioritySta,
     ...
     */
    public bool removeIface(IWifiIface iface) {
        bool success = removeIfaceInternal(iface);
     ...
     *                iface destruction.
     */
    public bool registerDestroyedListener(IWifiIface iface,
    ...
    public interface InterfaceAvailableForRequestListener {
         ...
         * unregisterInterfaceAvailableForRequestListener().
         */
        void onAvailabilityChanged(bool isAvailable);
    }
    ...
    private class WifiChipInfo {
        ...
        public bool currentModeIdValid;
    ...
    */
     ...
     */
    private bool validateInterfaceCache(WifiChipInfo[] chipInfos) {
    ...
    private class WifiEventCallback : IWifiEventCallback.Stub {
        override
    ...
    private class ManagerStatusListenerProxy  :
    ...
    private IWifiIface createIface(int ifaceType, bool lowPriority,
    ...
    private IWifiIface createIfaceIfPossible(WifiChipInfo[] chipInfos, int ifaceType,
            bool lowPriority, InterfaceDestroyedListener destroyedListener, Handler handler) {
        if (VDBG) {
    ...
    private bool isItPossibleToCreateIface(WifiChipInfo[] chipInfos, int ifaceType) {
        if (VDBG) {
    ...
    private IfaceCreationData canIfaceComboSupportRequest(WifiChipInfo chipInfo,
            IWifiChip.ChipMode chipMode, int[] chipIfaceCombo, int ifaceType, bool lowPriority) {
        if (VDBG) {
     ...
     */
    private bool compareIfaceCreationData(IfaceCreationData val1, IfaceCreationData val2) {
     ...
     */
    private bool allowedToDeleteIfaceTypeForRequestedType(int existingIfaceType,
    ...
    private bool removeIfaceInternal(IWifiIface iface) {
        String name = getName(iface);
        int type = getType(iface);
    ...
    private bool dispatchAvailableForRequestListeners() {
    ...
    private void dispatchAvailableForRequestListenersForType(int ifaceType,
        ...
        synchronized (mLock) {
            ...
            bool isAvailable = isItPossibleToCreateIface(chipInfos, ifaceType);
    ...
    private abstract class ListenerProxy<LISTENER>  {
        ...
        protected void action() {}
        protected void actionWithArg(bool arg) {}
    ...
    private class InterfaceDestroyedListenerProxy :
    ...
    private class InterfaceAvailableForRequestListenerProxy :
        ...
        override
        protected void actionWithArg(bool isAvailable) {
