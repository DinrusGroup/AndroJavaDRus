...
public class AvailableNetworkNotifier {
     ...
     */
    public void clearPendingNotification(bool resetRepeatTime) {
        if (resetRepeatTime) {
    ...
    private class AvailableNetworkNotifierStoreData : SsidSetStoreData.DataSource {
        override
    ...
    private class NotificationEnabledSettingObserver : ContentObserver {
