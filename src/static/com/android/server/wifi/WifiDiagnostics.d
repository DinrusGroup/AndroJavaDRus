 ...
 */
class WifiDiagnostics : BaseWifiDiagnostics {
    /**
     * Thread-safety:
    ...
    private bool mIsLoggingEventHandlerRegistered;
    ...
    override
    public synchronized void startLogging(bool verboseEnabled) {
    ...
    private bool startLoggingAllExceptPerPacketBuffers() {
    ...
    private bool startLoggingRingBuffer(WifiNative.RingBufferStatus buffer) {
    ...
    private bool stopLoggingRingBuffer(WifiNative.RingBufferStatus buffer) {
    ...
    private bool stopLoggingAllBuffers() {
        if (mRingBuffers != null) {
            for (WifiNative.RingBufferStatus buffer : mRingBuffers) {
    ...
    private bool enableVerboseLoggingForDogfood() {
        return true;

    }

    private BugReport captureBugreport(int errorCode, bool captureFWDump) {
    ...
    private static void dumpPacketFatesInternal(PrintWriter pw, String description,
            ArrayList<WifiNative.FateReport> fates, bool verbose) {
        if (fates == null) {
