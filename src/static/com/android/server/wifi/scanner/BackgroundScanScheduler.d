...
public class BackgroundScanScheduler {
    ...
    private class Bucket {
        ...
        public bool addSettings(ScanSettings scanSettings) {
            mChannelCollection.addChannels(scanSettings);
            return mScanSettingsList.add(scanSettings);
        }

        public bool removeSettings(ScanSettings scanSettings) {
     ...
     * settings.
     */
    public bool shouldReportFullScanResultForSettings(@NonNull ScanResult result,
     ...
     *         wasMerged -  bool indicating whether the original setting was merged to lower time
     *                      period buckets.
    ...
    private List<Bucket> optimizeBuckets() {
        ...
        while (iterBuckets.hasNext()) {
            ...
            while (iterSettings.hasNext()) {
                ...
                bool wasMerged = mergeResult.first.boolValue();
                if (wasMerged) {
