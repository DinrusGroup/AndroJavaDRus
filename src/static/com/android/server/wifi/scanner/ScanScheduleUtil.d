...
public class ScanScheduleUtil {
     ...
     */
    public static bool channelEquals(@Nullable WifiNative.ChannelSettings channel1,
     ...
     */
    public static bool bucketEquals(@Nullable WifiNative.BucketSettings bucket1,
     ...
     */
    public static bool scheduleEquals(@Nullable WifiNative.ScanSettings schedule1,
     ...
     */
    private static bool isBucketMaybeScanned(int scheduledBucket, int bucketsScannedBitSet) {
     ...
     * @param bucketsScannedBitSet The bitset of all buckets scanned, 0 if unavailable
     */
    private static bool isBucketDefinitlyScanned(int scheduledBucket, int bucketsScannedBitSet) {
     ...
     * settings.
     */
    public static bool shouldReportFullScanResultForSettings(ChannelHelper channelHelper,
