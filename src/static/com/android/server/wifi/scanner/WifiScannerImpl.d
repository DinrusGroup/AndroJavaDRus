...
public abstract class WifiScannerImpl {
    ...
    /**
     * A comparator that : the sort order that is expected for scan results
     */
     ...
     */
    public abstract bool getScanCapabilities(WifiNative.ScanCapabilities capabilities);
     ...
     */
    public abstract bool startSingleScan(WifiNative.ScanSettings settings,
     ...
     * scan may be scheduled async.
     */
    public abstract bool startBatchedScan(WifiNative.ScanSettings settings,
            WifiNative.ScanEventHandler eventHandler);
    /**
     ...
     */
    public abstract WifiScanner.ScanData[] getLatestBatchedScanResults(bool flush);
     ...
     */
    public abstract bool setHwPnoList(WifiNative.PnoSettings settings,
     ...
     * @return true if success, false otherwise
     */
    public abstract bool resetHwPnoList();
     ...
     */
    public abstract bool isHwPnoSupported(bool isConnectedPno);
