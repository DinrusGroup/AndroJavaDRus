 ...
 */
public class WificondScannerImpl : WifiScannerImpl : Handler.Callback {
    ...
    private final bool mHwPnoScanSupported;
     ...
     */
    private static bool isAllChannelsScanned(ChannelCollection channelCollection) {
    ...
    private bool startHwPnoScan(WifiNative.PnoSettings pnoSettings) {
     ...
     */
    private bool isHwPnoScanRequired(bool isConnectedPno) {
    ...
    private static class LastScanSettings {
        LastScanSettings(long startTime,
                bool reportSingleScanFullResults,
        ...
        public bool reportSingleScanFullResults;
