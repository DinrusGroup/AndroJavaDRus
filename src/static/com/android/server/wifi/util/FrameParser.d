...
public class FrameParser {
    ...
    private static short getUnsignedByte(ByteBuffer data) {
        return cast(short) (data.get() & 0x00ff);
    }
    /**
    ...
    private static final short ETHERTYPE_IP_V4 = cast(short) 0x0800;
    private static final short ETHERTYPE_ARP = cast(short) 0x0806;
    private static final short ETHERTYPE_IP_V6 = cast(short) 0x86dd;
    private static final short ETHERTYPE_EAPOL = cast(short) 0x888e;
    ...
    private static final byte IP_V4_VERSION_BYTE_MASK = cast(byte) 0b11110000;
    private static final byte IP_V4_IHL_BYTE_MASK = cast(byte) 0b00001111;
    ...
    private static final short WPA_KEY_INFO_FLAG_PAIRWISE = cast(short) 1 << 3;  // bit 4
    private static final short WPA_KEY_INFO_FLAG_INSTALL = cast(short) 1 << 6;  // bit 7
    private static final short WPA_KEY_INFO_FLAG_MIC = cast(short) 1 << 8;  // bit 9
    ...
    private static final byte IEEE_80211_FRAME_CTRL_FLAG_ORDER = cast(byte) (1 << 7); // bit 8
