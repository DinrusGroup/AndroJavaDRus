...
public class XmlUtil {
     ...
     * @throws XmlPullParserException if parsing errors occur.
     */
    public static bool gotoNextSectionOrEnd(
     ...
     */
    public static bool gotoNextSectionWithNameOrEnd(
     ...
     * @throws XmlPullParserException if parsing errors occur.
     */
    public static bool isNextSectionEnd(XmlPullParser in, int sectionDepth)
            throws XmlPullParserException, IOException {
            ...
            while (!XmlUtil.isNextSectionEnd(in, outerTagDepth)) {
                ...
                switch (valueName[0]) {
                    ...
                    case XML_TAG_HIDDEN_SSID:
                        configuration.hiddenSSID = (bool) value;
                        break;
                    case XML_TAG_REQUIRE_PMF:
                        configuration.requirePMF = (bool) value;
                        break;
                    ...
                    case XML_TAG_ALLOWED_PAIRWISE_CIPHERS:
                        ...
                        break;
                    case XML_TAG_SHARED:
                        configuration.shared = (bool) value;
                        break;
                    case XML_TAG_STATUS:
                    ...
                    case XML_TAG_IS_LEGACY_PASSPOINT_CONFIG:
                        configuration.isLegacyPasspointConfig = (bool) value;
                        break;
            ...
            while (!XmlUtil.isNextSectionEnd(in, outerTagDepth)) {
                ...
                switch (valueName[0]) {
                    ...
                    case XML_TAG_HAS_EVER_CONNECTED:
                        selectionStatus.setHasEverConnected((bool) value);
                        break;
                    default:
                        throw new XmlPullParserException(
                                "Unknown value name found: " + valueName[0]);
