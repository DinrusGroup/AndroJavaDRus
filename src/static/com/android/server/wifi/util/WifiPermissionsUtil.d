...
public class WifiPermissionsUtil {
     ...
     */
    public bool checkConfigOverridePermission(int uid) {
        try {
     ...
     * @return true if the app does have the permission, false otherwise.
     */
    public bool checkChangePermission(int uid) {
        try {
     ...
     * @return true if the app does have the permission, false otherwise.
     */
    public bool checkWifiAccessPermission(int uid) {
        try {
     ...
     * @param uid The uid of the package
     */
    public bool checkCallersLocationPermission(String pkgName, int uid) {
     ...
     * @param uid The uid of the package
     */
    public bool checkCallersFineLocationPermission(String pkgName, int uid) {
        // Having FINE permission implies having COARSE permission (but not the reverse)
        if ((mWifiPermissionsWrapper.getUidPermission(
    ...
    public void enforceCanAccessScanResults(String pkgName, int uid) throws SecurityException {
        ...
        bool canCallingUidAccessLocation = checkCallerHasPeersMacAddressPermission(uid);
        // LocationAccess by App: caller must have
        // Coarse Location permission to have access to location information.
        bool canAppPackageUseLocation = checkCallersLocationPermission(pkgName, uid);
     ...
     */
    private bool checkCallerHasPeersMacAddressPermission(int uid) {
     ...
     * and package.
     */
    private bool isScanAllowedbyApps(String pkgName, int uid) {
     ...
     */
    private bool checkInteractAcrossUsersFull(int uid) {
        return mWifiPermissionsWrapper.getUidPermission(
     ...
     * current user.
     */
    private bool isCurrentProfile(int uid) {
     ...
     */
    public bool isLegacyVersion(String pkgName, int minVersion) {
        try {
    ...
    private bool checkAppOpAllowed(int op, String pkgName, int uid) {
        return mAppOps.noteOp(op, uid, pkgName) == AppOpsManager.MODE_ALLOWED;
    }

    private bool isLocationModeEnabled() {
     ...
     */
    public bool checkNetworkSettingsPermission(int uid) {
        return mWifiPermissionsWrapper.getUidPermission(
     ...
     */
    public bool checkNetworkSetupWizardPermission(int uid) {
        return mWifiPermissionsWrapper.getUidPermission(
