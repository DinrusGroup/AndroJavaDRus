 ...
 */
public class SoftApManager : ActiveModeManager {
    ...
    private bool mTimeoutEnabled = false;
    ...
    private class SoftApStateMachine : StateMachine {
        ...
        private class StartedState : State {
            ...
            */
            private class SoftApTimeoutEnabledSettingObserver : ContentObserver {
                ...
                private bool getValue() {
                    bool enabled = mFrameworkFacade.getIntegerSetting(mContext,
            ...
            private void onUpChanged(bool isUp) {
                if (isUp == mIfaceIsUp) {
                    return;  // no change
                }
                mIfaceIsUp = isUp;
