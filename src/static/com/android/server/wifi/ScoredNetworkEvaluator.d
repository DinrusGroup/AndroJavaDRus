 ...
 */
public class ScoredNetworkEvaluator : WifiNetworkSelector.NetworkEvaluator {
    ...
    private bool mNetworkRecommendationsEnabled;
    ...
    private bool activeScorerAllowedtoSeeScanResults() {
    ...
    public WifiConfiguration evaluateNetworks(List<ScanDetail> scanDetails,
            WifiConfiguration currentNetwork, String currentBssid, bool connected,
            bool untrustedNetworkAllowed,
        ...
        for (int i = 0; i < scanDetails.size(); i++) {
            ...
            bool untrustedScanResult = configuredNetwork == null || configuredNetwork.ephemeral;
            ...
            bool isCurrentNetwork = currentNetwork != null
    ...
    class ScoreTracker {
         ...
         */
        @Nullable
        private Integer getNetworkScore(ScanResult scanResult, bool isCurrentNetwork) {
        ...
        void trackUntrustedCandidate(
                ScanResult scanResult, WifiConfiguration config, bool isCurrentNetwork) {
