...
public class WifiLastResortWatchdog {
    ...
    private bool mWifiIsConnected = false;
    ...
    private bool mWatchdogAllowedToTrigger = true;
    ...
    private bool mWatchdogFixedWifi = true;
     ...
     */
    public bool noteConnectionFailureAndTriggerIfNeeded(String ssid, String bssid, int reason) {
        if (mVerboseLoggingEnabled) {
        ...
        bool isRestartNeeded = checkTriggerCondition();
        if (mVerboseLoggingEnabled) {
     ...
     */
    public void connectedStateTransition(bool isEntering) {
        if (mVerboseLoggingEnabled) {
    ...
    private bool checkTriggerCondition() {
        ...
        bool atleastOneNetworkHasEverConnected = checkIfAtleastOneNetworkHasEverConnected();
        if (mVerboseLoggingEnabled) {
    ...
    private bool checkIfAtleastOneNetworkHasEverConnected() {
        for (Map.Entry<String, AvailableNetworkFailureCount> entry
                : mRecentAvailableNetworks.entrySet()) {
     ...
     */
    private void setWatchdogTriggerEnabled(bool enable) {
     ...
     */
    public bool isOverFailureThreshold(String bssid) {
