...
public class PasspointManager {
    ...
    private class CallbackHandler : PasspointEventHandler.Callbacks {
     ...
     */
    private class DataSourceHandler : PasspointConfigStoreData.DataSource {
        override
     ...
     */
    public bool addOrUpdateProvider(PasspointConfiguration config, int uid) {
     ...
     */
    public bool removeProvider(String fqdn) {
     ...
     */
    public static bool addLegacyPasspointConfig(WifiConfiguration config) {
     ...
     */
    public bool queryPasspointIcon(long bssid, String fileName) {
     ...
     * @return true on success
     */
    private bool addWifiConfig(WifiConfiguration wifiConfig) {
        if (wifiConfig == null) {
            return false;
        }
     ...
     * @return bool return value from the provisioning method
     */
    public bool startSubscriptionProvisioning(int callingUid, OsuProvider provider,
