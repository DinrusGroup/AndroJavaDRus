...
public class ANQPMatcher {
     ...
     */
    public static bool matchDomainName(DomainNameElement element, String fqdn,
     ...
     * @return true if a match is found
     */
    public static bool matchRoamingConsortium(RoamingConsortiumElement element,
            long[] providerOIs) {
        if (element == null) {
            return false;
        }
     ...
     */
    public static  bool matchThreeGPPNetwork(ThreeGPPNetworkElement element,
            IMSIParameter imsiParam, List<String> simImsiList) {
        if (element == null) {
            return false;
        }
     ...
     * @return true if a match is found
     */
    private static bool matchCellularNetwork(CellularNetwork network, IMSIParameter imsiParam,
     ...
     * @return true if a match is found
     */
    private static bool matchMccMnc(String mccMnc, IMSIParameter imsiParam,
            List<String> simImsiList) {
