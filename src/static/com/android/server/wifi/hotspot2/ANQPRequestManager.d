...
public class ANQPRequestManager {
     ...
     */
    public bool requestANQPElements(long bssid, ANQPNetworkKey anqpNetworkKey, bool rcOIs,
            bool hsReleaseR2) {
     ...
     */
    public ANQPNetworkKey onRequestCompleted(long bssid, bool success) {
        if (success) {
     ...
     */
    private bool canSendRequestNow(long bssid) {
     ...
     */
    private static List<Constants.ANQPElementType> getRequestElementIDs(bool rcOIs,
            bool hsReleaseR2) {
