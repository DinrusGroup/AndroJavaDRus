...
public class PasspointProvisioner {
     ...
     * @return bool value, true if provisioning was started, false otherwise.
     *
     ...
     */
    class OsuNetworkCallbacks : OsuNetworkConnection.Callbacks {
    ...
    public class OsuServerCallbacks {
         ...
         * @param succeeded bool indicating success/failure of server validation
         */
        public void onServerValidationStatus(int sessionId, bool succeeded) {
            if (mVerboseLoggingEnabled) {
