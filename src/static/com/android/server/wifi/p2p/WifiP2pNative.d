...
public class WifiP2pNative {
    ...
    private class InterfaceAvailableListenerInternal :
    ...
    // Internal callback registered to HalDeviceManager.
    private class InterfaceDestroyedListenerInternal :
     ...
     */
    public bool p2pListNetworks(WifiP2pGroupList groups) {
     ...
     */
    public bool startWpsPbc(String iface, String bssid) {
     ...
     * @return true, if operation was successful.
     */
    public bool startWpsPinKeypad(String iface, String pin) {
     ...
     * @return true, if operation was successful.
     */
    public bool removeP2pNetwork(int netId) {
     ...
     * @return true if request is sent successfully, false otherwise.
     */
    public bool setP2pDeviceName(String name) {
        return mSupplicantP2pIfaceHal.setWpsDeviceName(name);
    }
     ...
     * @return true if request is sent successfully, false otherwise.
     */
    public bool setP2pDeviceType(String type) {
     ...
     * @return true if request is sent successfully, false otherwise.
     */
    public bool setConfigMethods(String cfg) {
     ...
     */
    public bool setP2pSsidPostfix(String postfix) {
     ...
     * @return bool value indicating whether operation was successful.
     */
    public bool setP2pGroupIdle(String iface, int time) {
     ...
     * @return bool value indicating whether operation was successful.
     */
    public bool setP2pPowerSave(String iface, bool enabled) {
     ...
     * @return true, if operation was successful.
     */
    public bool setWfdEnable(bool enable) {
     ...
     * @return true, if operation was successful.
     */
    public bool setWfdDeviceInfo(String hex) {
     ...
     * @return bool value indicating whether operation was successful.
     */
    public bool p2pFind(int timeout) {
     ...
     * @return true, if operation was successful.
     */
    public bool p2pExtListen(bool enable, int period, int interval) {
     ...
     * @return true, if operation was successful.
     */
    public bool p2pSetChannel(int lc, int oc) {
     ...
     *        uses PIN.
     */
    public String p2pConnect(WifiP2pConfig config, bool joinExistingGroup) {
     ...
     * @return bool value indicating whether operation was successful.
     */
    public bool p2pProvisionDiscovery(WifiP2pConfig config) {
     ...
     * @return true, if operation was successful.
     */
    public bool p2pGroupAdd(bool persistent) {
     ...
     * @return true, if operation was successful.
     */
    public bool p2pGroupAdd(int netId) {
     ...
     * @return true, if operation was successful.
     */
    public bool p2pGroupRemove(String iface) {
     ...
     * @return bool value indicating whether operation was successful.
     */
    public bool p2pReject(String deviceAddress) {
     ...
     * @return bool value indicating whether operation was successful.
     */
    public bool p2pInvite(WifiP2pGroup group, String deviceAddress) {
     ...
     * @return true, if operation was successful.
     */
    public bool p2pReinvoke(int netId, String deviceAddress) {
     ...
     * @return true, if operation was successful.
     */
    public bool p2pServiceAdd(WifiP2pServiceInfo servInfo) {
     ...
     * @return true, if operation was successful.
     */
    public bool p2pServiceDel(WifiP2pServiceInfo servInfo) {
     ...
     * @return true, if operation was successful.
     */
    public bool p2pServDiscCancelReq(String id) {
     ...
     * @return true, if operation was successful.
     */
    public bool setP2pClientList(int netId, String list) {
