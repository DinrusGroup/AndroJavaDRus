...
public class SupplicantP2pIfaceHal {
    ...
    private bool linkToSupplicantP2pIfaceDeath() {
     ...
     */
    private bool checkSupplicantP2pIfaceAndLogFailure(String method) {
     ...
     *        interface object.
     * @return bool value indicating whether operation was successful.
     */
    public bool registerCallback(ISupplicantP2pIfaceCallback receiver) {
        synchronized (mLock) {
     ...
     * @return bool value indicating whether operation was successful.
     */
    public bool setPowerSave(String groupIfName, bool enable) {
        synchronized (mLock) {
     ...
     * @return bool value indicating whether operation was successful.
     */
    public bool setGroupIdle(String groupIfName, int timeoutInSec) {
        synchronized (mLock) {
     ...
     * @return bool value indicating whether operation was successful.
     */
    public bool setSsidPostfix(String postfix) {
        synchronized (mLock) {
     ...
     *        uses PIN.
     */
    public String connect(WifiP2pConfig config, bool joinExistingGroup) {
        ...
        synchronized (mLock) {
            ...
            bool persistent = (config.netId == WifiP2pGroup.PERSISTENT_NET_ID);
     ...
     * @return bool value indicating whether operation was successful.
     */
    public bool provisionDiscovery(WifiP2pConfig config) {
     ...
     * @return bool value indicating whether operation was successful.
     */
    public bool invite(WifiP2pGroup group, String peerAddress) {
     ...
     * @return bool value indicating whether operation was successful.
     */
    public bool reject(String peerAddress) {
        synchronized (mLock) {
     ...
     */
    public bool reinvoke(int networkId, String peerAddress) {
     ...
     * @return true, if operation was successful.
     */
    public bool groupAdd(int networkId, bool isPersistent) {
        synchronized (mLock) {
     ...
     * @return true, if operation was successful.
     */
    public bool groupAdd(bool isPersistent) {
     ...
     * @return true, if operation was successful.
     */
    public bool groupRemove(String groupName) {
     ...
     * @return true, if operation was successful.
     */
    public bool configureExtListen(bool enable, int periodInMillis, int intervalInMillis) {
     ...
     * @return true, if operation was successful.
     */
    public bool setListenChannel(int listenChannel, int operatingChannel) {
        synchronized (mLock) {
     ...
     * @return true, if operation was successful.
     */
    public bool serviceAdd(WifiP2pServiceInfo servInfo) {
        synchronized (mLock) {
     ...
     * @return true, if operation was successful.
     */
    public bool serviceRemove(WifiP2pServiceInfo servInfo) {
        synchronized (mLock) {
     ...
     * @return true, if operation was successful.
     */
    public bool cancelServiceDiscovery(String identifier) {
        synchronized (mLock) {
     ...
     * @return true, if operation was successful.
     */
    public bool setMiracastMode(int mode) {
        synchronized (mLock) {
     ...
     * @return true, if operation was successful.
     */
    public bool startWpsPbc(String groupIfName, String bssid) {
     ...
     * @return true, if operation was successful.
     */
    public bool startWpsPinKeypad(String groupIfName, String pin) {
     ...
     * @return true, if operation was successful.
     */
    public bool cancelWps(String groupIfName) {
        synchronized (mLock) {
     ...
     * @return true, if operation was successful.
     */
    public bool enableWfd(bool enable) {
        synchronized (mLock) {
     ...
     * @return true, if operation was successful.
     */
    public bool setWfdDeviceInfo(String info) {
        synchronized (mLock) {
     ...
     */
    public bool loadGroups(WifiP2pGroupList groups) {
        synchronized (mLock) {
            ...
            for (Integer networkId : networkIds) {
                ...
                try {
                    network.isCurrent(
                            (SupplicantStatus status, bool isCurrent) -> {
                ...
                try {
                    network.isGo(
                            (SupplicantStatus status, bool isGo) -> {
     ...
     */
    public bool setWpsDeviceName(String name) {
        if (name == null) {
            return false;
        }
        synchronized (mLock) {
     ...
     * @return true if request is sent successfully, false otherwise.
     */
    public bool setWpsDeviceType(String typeStr) {
        try {
     ...
     * @return true if request is sent successfully, false otherwise.
     */
    public bool setWpsConfigMethods(String configMethodsStr) {
        synchronized (mLock) {
     ...
     */
    public bool initiatorReportNfcHandover(String selectMessage) {
     ...
     * @return true if reported successfully, false otherwise.
     */
    public bool responderReportNfcHandover(String requestMessage) {
     ...
     * @return true, if operation was successful.
     */
    public bool setClientList(int networkId, String clientListStr) {
        synchronized (mLock) {
