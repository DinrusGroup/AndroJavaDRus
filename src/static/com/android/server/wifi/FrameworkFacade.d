...
public class FrameworkFacade {
    ...
    public bool setIntegerSetting(Context context, String name, int def) {
    ...
    public bool setStringSetting(Context context, String name, String def) {
     ...
     * {@see ContentResolver#registerContentObserver(Uri,bool,ContentObserver)}.
     *
     * @param context
     * @param uri
    ...
    public void registerContentObserver(Context context, Uri uri,
            bool notifyForDescendants, ContentObserver contentObserver) {
    ...
    public bool getConfigWiFiDisableInECBM(Context context) {
     ...
     */
    public bool inStorageManagerCryptKeeperBounce() {
     ...
     */
    public bool isAppForeground(int uid) throws RemoteException {
