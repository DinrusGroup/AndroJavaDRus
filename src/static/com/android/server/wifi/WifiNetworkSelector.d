...
public class WifiNetworkSelector {
    ...
    private final bool mEnableAutoJoinWhenAssociated;
    ...
    public interface NetworkEvaluator {
        ...
        WifiConfiguration evaluateNetworks(List<ScanDetail> scanDetails,
                        ...
                        bool connected, bool untrustedNetworkAllowed,
    ...
    private bool isCurrentNetworkSufficient(WifiInfo wifiInfo, List<ScanDetail> scanDetails) {
        ...
        bool hasQualifiedRssi = currentRssi
                > mScoringParams.getSufficientRssi(wifiInfo.getFrequency());
        bool hasActiveStream = (wifiInfo.txSuccessRate > mStayOnNetworkMinimumTxRate)
    ...
    private bool is5GHzNetworkAvailable(List<ScanDetail> scanDetails) {
    ...
    private bool isNetworkSelectionNeeded(List<ScanDetail> scanDetails, WifiInfo wifiInfo,
     ...
     */
    public bool isSignalTooWeak(ScanResult scanResult) {
    ...
    private List<ScanDetail> filterScanResults(List<ScanDetail> scanDetails,
                HashSet<String> bssidBlacklist, bool isConnected, String currentBssid) {
     ...
     */
    public bool setUserConnectChoice(int netId) {
    ...
    public WifiConfiguration selectNetwork(List<ScanDetail> scanDetails,
            ...
            bool connected, bool disconnected, bool untrustedNetworkAllowed) {
     ...
     */
    public bool registerNetworkEvaluator(NetworkEvaluator evaluator, int priority) {
