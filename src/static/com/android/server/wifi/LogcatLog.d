...
@ThreadSafe
@Immutable
class LogcatLog : WifiLog {
    private final String mTag;
    private static volatile bool sVerboseLogging = false;
    ...
    /* Internal details */
    private static class RealLogMessage : WifiLog.LogMessage {
        ...
        override
        public WifiLog.LogMessage c(bool value) {
            copyUntilPlaceholder();
            if (mNextFormatCharPos < mFormat.length()) {
                mStringBuilder.append(value);
                ++mNextFormatCharPos;
