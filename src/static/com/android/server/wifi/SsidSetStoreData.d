 ...
 */
public class SsidSetStoreData : WifiConfigStore.StoreData {
     ...
     * @param dataSource The DataSource that : the update and retrieval of the SSID set.
     */
    ...
    override
    public void serializeData(XmlSerializer out, bool shared)
    ...
    override
    public void deserializeData(XmlPullParser in, int outerTagDepth, bool shared)
            throws XmlPullParserException, IOException {
        // Ignore empty reads.
        if (in == null) {
            return;
    ...
    override
    public void resetData(bool shared) {
        if (!shared) {
