 ...
 * TBD
 */
public class RttNative : IWifiRttControllerEventCallback.Stub {
     ...
     */
    public bool rangeRequest(int cmdId, RangingRequest request,
     ...
     * @return Success status: true for success, false for failure.
     */
    public bool rangeCancel(int cmdId, ArrayList<byte[]> macAddresses) {
     ...
     * {@link #rangeRequest(int, RangingRequest, bool)}.
    ...
    private static ArrayList<RttConfig> convertRangingRequestToRttConfigs(RangingRequest request,
            bool isCalledFromPrivilegedContext, RttCapabilities cap) {
