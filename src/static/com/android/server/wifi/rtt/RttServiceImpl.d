 ...
 */
public class RttServiceImpl : IWifiRttManager.Stub {
    ...
    private class RttShellCommand : ShellCommand {
    ...
    public void startRanging(IBinder binder, String callingPackage, WorkSource workSource,
        ...
        bool isCalledFromPrivilegedContext =
    ...
    private class RttServiceSynchronized {
        ...
        private void cleanUpClientRequests(int uid, WorkSource workSource) {
            ...
            bool dispatchedRequestAborted = false;
            ListIterator<RttRequestInfo> it = mRttRequestQueue.listIterator();
            while (it.hasNext()) {
                RttRequestInfo rri = it.next();

                bool match = rri.uid == uid; // original UID will never be 0
        ...
        private void queueRangingRequest(int uid, WorkSource workSource, IBinder binder,
                ...
                IRttCallback callback, bool isCalledFromPrivilegedContext) {
        ...
        private bool isRequestorSpamming(WorkSource ws) {
        ...
        private void executeNextRangingRequestIfPossible(bool popFirst) {
         ...
         */
        private bool processAwarePeerHandles(RttRequestInfo request) {
        ...
        private void onRangingResults(int cmdId, List<RttResult> results) {
            ...
            bool permissionGranted = mWifiPermissionsUtil.checkCallersLocationPermission(
        ...
        private List<RangingResult> postProcessResults(RangingRequest request,
                List<RttResult> results, bool isCalledFromPrivilegedContext) {
    ...
    private static class RttRequestInfo {
        ...
        public bool isCalledFromPrivilegedContext;

        public int cmdId = 0; // uninitialized cmdId value
        public bool dispatchedToNative = false;
        public bool peerHandlesTranslated = false;
