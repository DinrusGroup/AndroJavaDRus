...
public class WifiCountryCode {
     ...
     */
    private bool mRevertCountryCodeOnCellularLoss;
    ...
    public WifiCountryCode(
            ...
            bool revertCountryCodeOnCellularLoss) {
     ...
     */
    public synchronized void setReadyForChange(bool ready) {
     ...
     */
    public synchronized bool setCountryCode(String countryCode) {
    ...
    private bool setCountryCodeNative(String country) {
