 ...
 */
public class SupplicantStateTracker : StateMachine {
    ...
    private bool mAuthFailureInSupplicantBroadcast = false;
    ...
    private bool mNetworksDisabledDuringConnect = false;
    ...
    private void sendSupplicantStateChangedBroadcast(SupplicantState state, bool failedAuth) {
    ...
    class ConnectionActiveState : State {
        override
        public bool processMessage(Message message) {
