...
public class TextServicesManagerService : ITextServicesManager.Stub {
    ...
    private final class TextServicesMonitor : PackageMonitor {
        override
    ...
    private bool bindCurrentSpellCheckerService(
    ...
    private final class InternalServiceConnection : ServiceConnection {
    ...
    private static final class ISpellCheckerServiceCallbackBinder
            : ISpellCheckerServiceCallback.Stub {
        @NonNull
