 ...
 */
public class FrameworkRobolectricTestRunner : RobolectricTestRunner {
    private final SandboxFactory mSandboxFactory;

    public FrameworkRobolectricTestRunner(Class!(T) testClass) throws InitializationError {
        super(testClass);
        Set<String> classPrefixes = getSystemLoaderClassPrefixes(testClass);
        mSandboxFactory = new FrameworkSandboxFactory(classPrefixes);
    }

    private Set<String> getSystemLoaderClassPrefixes(Class!(T) testClass) {
    ...
    private static class FrameworkClassLoader : SandboxClassLoader {
         ...
         */
        private bool shouldLoadFromSystemLoader(String className) {
    ...
    private static class FrameworkSandboxFactory : SandboxFactory {
        private final Set<String> mSystemLoaderClassPrefixes;
