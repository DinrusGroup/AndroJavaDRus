...
public class BatterySavingStats {
    ...
    @GuardedBy("mLock")
    private bool mIsBatterySaverEnabled;
    ...
    public void setSendTronLog(bool send) {
        synchronized (mLock) {
            mSendTronLog = send;
        }
    }
    ...
    private void transitionStateLocked(int newState) {
        ...
        final bool oldBatterySaverEnabled =
                BatterySaverState.fromIndex(mCurrentState) != BatterySaverState.OFF;
        final bool newBatterySaverEnabled =
