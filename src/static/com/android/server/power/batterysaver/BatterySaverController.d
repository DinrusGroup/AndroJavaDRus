 ...
 */
public class BatterySaverController : BatterySaverPolicyListener {
    static final String TAG = "BatterySaverController";

    static final bool DEBUG = BatterySaverPolicy.DEBUG;
    ...
    private class MyHandler : Handler {
        ...
        public void postStateChanged(bool sendBroadcast, int reason) {
     ...
     */
    public void enableBatterySaver(bool enable, int reason) {
        synchronized (mLock) {
            if (mEnabled == enable) {
                return;
            }
     ...
     */
    void handleBatterySaverStateChanged(bool sendBroadcast, int reason) {
        final LowPowerModeListener[] listeners;

        final bool enabled;
        final bool isInteractive = getPowerManager().isInteractive();
    ...
    private void updateBatterySavingStats() {
        ...
        final bool isInteractive = pm.isInteractive();
        final int dozeMode =
