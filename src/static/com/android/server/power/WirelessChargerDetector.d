...
final class WirelessChargerDetector {
    ...
    private bool mDetectionInProgress;
    ...
    private bool mMustUpdateRestPosition;
     ...
     */
    public bool update(bool isPowered, int plugType) {
        synchronized (mLock) {
            final bool wasPoweredWirelessly = mPoweredWirelessly;
    ...
    private static bool hasMoved(float x1, float y1, float z1,
        ...
        final bool moved = (dotProduct < mag1 * mag2 * MOVEMENT_ANGLE_COS_THRESHOLD);
        if (DEBUG) {
