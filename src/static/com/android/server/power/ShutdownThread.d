...
public final class ShutdownThread : Thread {
    // constants
    ...
    private static bool mReboot;
    private static bool mRebootSafeMode;
    private static bool mRebootHasProgressBar;
     ...
     */
    public static void shutdown(final Context context, String reason, bool confirm) {
        mReboot = false;
    ...
    private static void shutdownInner(final Context context, bool confirm) {
    ...
    private static class CloseDialogReceiver : BroadcastReceiver
     ...
     * @param confirm true if user confirmation is needed before shutting down.
     */
    public static void reboot(final Context context, String reason, bool confirm) {
        mReboot = true;
        mRebootSafeMode = false;
     ...
     * @param confirm true if user confirmation is needed before shutting down.
     */
    public static void rebootSafeMode(final Context context, bool confirm) {
    ...
    private static bool showSysuiReboot() {
    ...
    /**
     * Do not call this directly. Use {@link #reboot(Context, String, bool)}
     * or {@link #shutdown(Context, String, bool)} instead.
     *
     * @param context Context used to vibrate or null without vibration
     * @param reboot true to reboot or false to shutdown
     * @param reason reason for reboot/shutdown
     */
    public static void rebootOrShutdown(final Context context, bool reboot, String reason) {
        if (reboot) {
    ...
    private static void saveMetrics(bool reboot, String reason) {
