...
final class Notifier {
    ...
    private final bool mSuspendWhenScreenOffDueToProximityConfig;
    ...
    private bool mInteractiveChanging;
    ...
    private bool mPendingWakeUpBroadcast;
    private bool mPendingGoToSleepBroadcast;
    ...
    private bool mBroadcastInProgress;
    private long mBroadcastStartTime;

    // True if a user activity message should be sent.
    private bool mUserActivityPending;
    ...
    public void onWakeLockAcquired(int flags, String tag, String packageName,
        ...
        if (monitorType >= 0) {
            try {
                final bool unimportantForLogging = ownerUid == Process.SYSTEM_UID
    ...
    public void onWakeLockChanging(int flags, String tag, String packageName,
        ...
        if (workSource != null && newWorkSource != null
            ...
            final bool unimportantForLogging = newOwnerUid == Process.SYSTEM_UID
    ...
    public void onWakefulnessChangeStarted(final int wakefulness, int reason) {
        final bool interactive = PowerManagerInternal.isInteractive(wakefulness);
        if (DEBUG) {
    ...
    private void playWirelessChargingVibration() {
        final bool vibrateEnabled = Settings.Global.getInt(mContext.getContentResolver(),
    ...
    private bool isChargingFeedbackEnabled() {
        final bool enabled = Settings.Global.getInt(mContext.getContentResolver(),
                Settings.Global.CHARGING_SOUNDS_ENABLED, 1) != 0;
        final bool dndOff = Settings.Global.getInt(mContext.getContentResolver(),
                Settings.Global.ZEN_MODE, Settings.Global.ZEN_MODE_IMPORTANT_INTERRUPTIONS)
                == Settings.Global.ZEN_MODE_OFF;
        return enabled && dndOff;
    }

    private final class NotifierHandler : Handler {
