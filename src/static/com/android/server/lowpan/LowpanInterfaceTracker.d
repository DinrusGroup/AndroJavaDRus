...
class LowpanInterfaceTracker : StateMachine {
    ...
    private class LocalLowpanCallback : LowpanInterface.Callback {
        override
        public void onEnabledChanged(bool value) {}

        override
        public void onUpChanged(bool value) {}

        override
        public void onConnectedChanged(bool value) {}
    ...
    class IpManagerCallback : IpManager.Callback {
        override
    ...
    class CommissioningState : State {
        override
        public void enter() {}
