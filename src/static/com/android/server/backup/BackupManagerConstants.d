 ...
 * a Settings.Secure.
 */
class BackupManagerConstants : KeyValueSettingObserver {
    ...
    @VisibleForTesting public static final bool DEFAULT_KEY_VALUE_BACKUP_REQUIRE_CHARGING = true;
    ...
    @VisibleForTesting public static final bool DEFAULT_FULL_BACKUP_REQUIRE_CHARGING = true;
    ...
    public synchronized bool getKeyValueBackupRequireCharging() {
        if (BackupManagerService.DEBUG_SCHEDULING) {
            Slog.v(
                    TAG,
    ...
    public synchronized bool getFullBackupRequireCharging() {
        if (BackupManagerService.DEBUG_SCHEDULING) {
