...
public final class BackupPasswordManager {
     ...
     *   permission.
     */
    bool backupPasswordMatches(String password) {
     ...
     */
    bool setBackupPassword(String currentPassword, String newPassword) {
        mContext.enforceCallingOrSelfPermission(android.Manifest.permission.BACKUP,
                "setBackupPassword");
     ...
     */
    private bool usePbkdf2Fallback() {
     ...
     */
    private bool passwordMatchesSaved(String candidatePassword) {
     ...
     */
    private bool passwordMatchesSaved(String algorithm, String candidatePassword) {
