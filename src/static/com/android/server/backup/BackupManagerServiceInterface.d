...
public interface BackupManagerServiceInterface {
  ...
  bool setBackupPassword(String currentPw, String newPw);
  ...
  bool waitUntilOperationComplete(int token);

  void tearDownAgentAndKill(ApplicationInfo app);

  bool beginFullBackup(FullBackupJob scheduledJob);
  ...
  void adbBackup(ParcelFileDescriptor fd, bool includeApks, bool includeObbs,
  ...
  void acknowledgeAdbBackupOrRestore(int token, bool allow,
  ...
  void setAutoRestore(bool doAutoRestore);

  // Mark the backup service as having been provisioned
  void setBackupProvisioned(bool available);
  ...
  bool isAppEligibleForBackup(String packageName);
