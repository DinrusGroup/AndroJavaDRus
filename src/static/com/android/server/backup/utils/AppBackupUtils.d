...
public class AppBackupUtils {
     ...
     * </ol>
     */
    public static bool appIsEligibleForBackup(ApplicationInfo app, PackageManager pm) {
     ...
     *         {@link BackupTransport#isAppEligibleForBackup(PackageInfo, bool)}
     * </ol>
     */
    public static bool appIsRunningAndEligibleForBackupWithTransport(
    ...
    public static bool appIsDisabled(ApplicationInfo app, PackageManager pm) {
     ...
     */
    public static bool appIsStopped(ApplicationInfo app) {
     ...
     * policy!
     */
    public static bool appGetsFullBackup(PackageInfo pkg) {
     ...
     */
    public static bool appIsKeyValueOnly(PackageInfo pkg) {
     ...
     */
    public static bool signaturesMatch(Signature[] storedSigs, PackageInfo target,
