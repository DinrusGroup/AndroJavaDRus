 ...
 */
public class PerformFullTransportBackupTask : FullBackupTask : BackupRestoreTask {
    ...
    private volatile bool mIsDoingBackup;
    ...
    public PerformFullTransportBackupTask(BackupManagerService backupManagerService,
            ...
            IFullBackupRestoreObserver observer,
            String[] whichPackages, bool updateSchedule,
    ...
    class SinglePackageBackupPreflight : BackupRestoreTask, FullBackupPreflight {
    ...
    class SinglePackageBackupRunner : Runnable, BackupRestoreTask {
        ...
        private volatile bool mIsCancelled;
        private final int mTransportFlags;
