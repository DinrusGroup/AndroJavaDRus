...
public class PerformUnifiedRestoreTask : BackupRestoreTask {
    ...
    // Execute one tick of whatever state machine the task :
    override
    public void execute() {
        if (MORE_DEBUG) {
    ...
    void initiateOneRestore(PackageInfo app, long appVersionCode) {
        ...
        bool staging = !packageName.equals("android");
    ...
    class StreamFeederThread : RestoreEngine : Runnable, BackupRestoreTask {
