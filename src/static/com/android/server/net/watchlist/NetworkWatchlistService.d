 ...
 */
public class NetworkWatchlistService : INetworkWatchlistManager.Stub {
    ...
    private volatile bool mIsLoggingEnabled = false;
    ...
    @VisibleForTesting
    protected bool startWatchlistLoggingImpl() throws RemoteException {
        if (DEBUG) {
    ...
    override
    public bool startWatchlistLogging() throws RemoteException {
        enforceWatchlistLoggingPermission();
        return startWatchlistLoggingImpl();
    }

    @VisibleForTesting
    protected bool stopWatchlistLoggingImpl() {
        if (DEBUG) {
    ...
    override
    public bool stopWatchlistLogging() throws RemoteException {
        enforceWatchlistLoggingPermission();
     ...
     */
    public bool forceReportWatchlistForTest(long lastReportTime) {
