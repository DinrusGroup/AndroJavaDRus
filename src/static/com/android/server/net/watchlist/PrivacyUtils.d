...
class PrivacyUtils {
     ...
     */
    @VisibleForTesting
    static Map<String, Boolean> createDpEncodedReportMap(bool isSecure, byte[] userSecret,
        ...
        for (int i = 0; i < appDigestListSize; i++) {
            ...
            final bool visitedWatchlist = aggregatedResult.appDigestList.contains(appDigest);
            ...
            bool encodedVisitedWatchlist = ((int) encoder.encodeBoolean(visitedWatchlist)[0]
                    & 0x1) == 0x1;
