 ...
 */
class WatchlistLoggingHandler : Handler {

    private static final String TAG = WatchlistLoggingHandler.class.getSimpleName();
    private static final bool DEBUG = NetworkWatchlistService.DEBUG;
     ...
     */
    private bool isPackageTestOnly(int uid) {
    ...
    private bool insertRecord(int uid, String cncHost, long timestamp) {
        if (DEBUG) {
        ...
        final bool result = mDbHelper.insertNewRecord(digest, cncHost, timestamp);
        return result;
    }

    private bool shouldReportNetworkWatchlist(long lastRecordTime) {
    ...
    private bool isIpInWatchlist(String ipAddr) {
        if (ipAddr == null) {
            return false;
        }
    ...
    private bool isHostInWatchlist(String host) {
        if (host == null) {
            return false;
        }
