...
public class NetworkStatsRecorder {
    ...
    private static final bool DUMP_BEFORE_DELETE = true;
    ...
    public NetworkStatsRecorder(FileRotator rotator, NonMonotonicObserver<String> observer,
            DropBoxManager dropBox, String cookie, long bucketDuration, bool onlyTags) {
     ...
     */
    private static class CombiningRewriter : FileRotator.Rewriter {
     ...
     */
    public static class RemoveUidRewriter : FileRotator.Rewriter {
    ...
    public void dumpLocked(IndentingPrintWriter pw, bool fullHistory) {
        if (mPending != null) {
