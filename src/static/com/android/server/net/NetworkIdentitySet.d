 ...
 * @hide
 */
public class NetworkIdentitySet : HashSet<NetworkIdentity> :
    ...
    public bool isAnyMemberMetered() {
        if (isEmpty()) {
            return false;
        }
        for (NetworkIdentity ident : this) {
    ...
    public bool isAnyMemberRoaming() {
        if (isEmpty()) {
            return false;
        }
        for (NetworkIdentity ident : this) {
    ...
    /** @return whether any {@link NetworkIdentity} in this set is considered on the default
            network. */
    public bool areAllMembersOnDefaultNetwork() {
        if (isEmpty()) {
            return true;
        }
        for (NetworkIdentity ident : this) {
