 ...
 */
public class NetworkStatsCollection : FileRotator.Reader {
    ...
    @Deprecated
    public void readLegacyUid(File file, bool onlyTags) throws IOException {
        final AtomicFile inputFile = new AtomicFile(file);
     ...
     */
    private static bool templateMatches(NetworkTemplate template, NetworkIdentitySet identSet) {
    ...
    private static class Key : Comparable<Key> {
