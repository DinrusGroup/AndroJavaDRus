...
public class NetworkPolicyLogger {
    ...
    void meterednessChanged(int netId, bool newMetered) {
        synchronized (mLock) {
    ...
    void restrictBackgroundChanged(bool oldValue, bool newValue) {
        synchronized (mLock) {
            if (LOGD) Slog.d(TAG,
    ...
    void deviceIdleModeEnabled(bool enabled) {
        synchronized (mLock) {
    ...
    void appIdleStateChanged(int uid, bool idle) {
        synchronized (mLock) {
    ...
    void paroleStateChanged(bool paroleOn) {
        synchronized (mLock) {
    ...
    void tempPowerSaveWlChanged(int appId, bool added) {
        synchronized (mLock) {
    ...
    void firewallChainEnabled(int chain, bool enabled) {
        synchronized (mLock) {
    ...
    private static String getMeterednessChangedLog(int netId, bool newMetered) {
    ...
    private static String getRestrictBackgroundChangedLog(bool oldValue, bool newValue) {
        return "Changed restrictBackground: " + oldValue + "->" + newValue;
    }

    private static String getDeviceIdleModeEnabled(bool enabled) {
        return "DeviceIdleMode enabled: " + enabled;
    }

    private static String getAppIdleChangedLog(int uid, bool idle) {
        return "App idle state of uid " + uid + ": " + idle;
    }

    private static String getParoleStateChanged(bool paroleOn) {
        return "Parole state: " + paroleOn;
    }

    private static String getTempPowerSaveWlChangedLog(int appId, bool added) {
    ...
    private static String getFirewallChainEnabledLog(int chain, bool enabled) {
    ...
    private final static class LogBuffer : RingBuffer<Data> {
        ...
        public void meterednessChanged(int netId, bool newMetered) {
            final Data data = getNextSlot();
            if (data == null) return;
        ...
        public void restrictBackgroundChanged(bool oldValue, bool newValue) {
            final Data data = getNextSlot();
            if (data == null) return;
        ...
        public void deviceIdleModeEnabled(bool enabled) {
            final Data data = getNextSlot();
            if (data == null) return;
        ...
        public void appIdleStateChanged(int uid, bool idle) {
            final Data data = getNextSlot();
            if (data == null) return;
        ...
        public void paroleStateChanged(bool paroleOn) {
            final Data data = getNextSlot();
            if (data == null) return;
        ...
        public void tempPowerSaveWlChanged(int appId, bool added) {
            final Data data = getNextSlot();
            if (data == null) return;
        ...
        public void firewallChainEnabled(int chain, bool enabled) {
            final Data data = getNextSlot();
            if (data == null) return;
