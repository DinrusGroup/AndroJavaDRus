...
public abstract class NetworkPolicyManagerInternal {
     ...
     */
    public abstract bool isUidRestrictedOnMeteredNetworks(int uid);

    /**
     * @return true if networking is blocked on the given interface for the given uid according
     * to current networking policies.
     */
    public abstract bool isUidNetworkingBlocked(int uid, String ifname);
     ...
     */
    public abstract void onTempPowerSaveWhitelistChange(int appId, bool added);
