...
public final class NetworkStatsAccess {
    ...
    public static @NetworkStatsAccess.Level int checkAccessLevel(
        ...
        bool hasCarrierPrivileges = tm != null &&
                tm.checkCarrierPrivilegesForPackage(callingPackage) ==
                        TelephonyManager.CARRIER_PRIVILEGE_STATUS_HAS_ACCESS;
        bool isDeviceOwner = dpmi != null && dpmi.isActiveAdminWithPolicy(callingUid,
        ...
        bool hasAppOpsPermission = hasAppOpsPermission(context, callingUid, callingPackage);
        ...
        bool isProfileOwner = dpmi != null && dpmi.isActiveAdminWithPolicy(callingUid,
     ...
     */
    public static bool isAccessibleToUser(int uid, int callerUid,
    ...
    private static bool hasAppOpsPermission(
            Context context, int callingUid, String callingPackage) {
