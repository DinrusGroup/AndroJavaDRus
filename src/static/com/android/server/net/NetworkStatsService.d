 ...
 */
public class NetworkStatsService : INetworkStatsService.Stub {
    static final String TAG = "NetworkStats";
    static final bool LOGD = Log.isLoggable(TAG, Log.DEBUG);
    static final bool LOGV = Log.isLoggable(TAG, Log.VERBOSE);
    ...
    private final bool mUseBpfTrafficStats;
    ...
    public interface NetworkStatsSettings {
        ...
        public bool getSampleEnabled();
        public bool getAugmentEnabled();
    ...
    private volatile bool mSystemReady;
    ...
    private NetworkStatsRecorder buildRecorder(
            String prefix, NetworkStatsSettings.Config config, bool includeTags) {
    ...
    private bool isRateLimitedForPoll(int callingUid) {
    ...
    private INetworkStatsSession openSessionInternal(final int flags, final String callingPackage) {
        ...
        return new INetworkStatsSession.Stub() {
            ...
            public NetworkStats getSummaryForAllUid(
                    NetworkTemplate template, long start, long end, bool includeTags) {
                try {
    ...
    @VisibleForTesting
    void setUidForeground(int uid, bool uidForeground) {
        synchronized (mStatsLock) {
    ...
    private bool checkBpfStatsEnable() {
    ...
    private void updateIfacesLocked(Network[] defaultNetworks) {
        ...
        for (NetworkState state : states) {
            if (state.networkInfo.isConnected()) {
                final bool isMobile = isNetworkTypeMobile(state.networkInfo.getType());
                final bool isDefault = ArrayUtils.contains(mDefaultNetworks, state.network);
    ...
    private void performPollLocked(int flags) {
        ...
        final bool persistNetwork = (flags & FLAG_PERSIST_NETWORK) != 0;
        final bool persistUid = (flags & FLAG_PERSIST_UID) != 0;
        final bool persistForce = (flags & FLAG_PERSIST_FORCE) != 0;
    ...
    private class NetworkStatsManagerInternalImpl : NetworkStatsManagerInternal {
        override
        ...
        override
        public void setUidForeground(int uid, bool uidForeground) {
    ...
    protected void dump(FileDescriptor fd, PrintWriter rawWriter, String[] args) {
        ...
        final bool poll = argSet.contains("--poll") || argSet.contains("poll");
        final bool checkin = argSet.contains("--checkin");
        final bool fullHistory = argSet.contains("--full") || argSet.contains("full");
        final bool includeUid = argSet.contains("--uid") || argSet.contains("detail");
        final bool includeTag = argSet.contains("--tag") || argSet.contains("detail");
    ...
    @VisibleForTesting
    static class HandlerCallback : Handler.Callback {
    ...
    private class DropBoxNonMonotonicObserver : NonMonotonicObserver<String> {
        override
     ...
     */
    private static class DefaultNetworkStatsSettings : NetworkStatsSettings {
        ...
        private bool getGlobalBoolean(String name, bool def) {
    ...
    private static native long nativeGetTotalStat(int type, bool useBpfStats);
    private static native long nativeGetIfaceStat(String iface, int type, bool useBpfStats);
    private static native long nativeGetUidStat(int uid, int type, bool useBpfStats);
}
