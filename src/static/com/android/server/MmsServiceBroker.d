 ...
 */
public class MmsServiceBroker : SystemService {
    ...
    private final IMms mServiceStubForFailure = new IMms() {
        ...
        public Uri importTextMessage(String callingPkg, String address, int type, String text,
                long timestampMillis, bool seen, bool read) throws RemoteException {
            return null;
        }

        override
        public Uri importMultimediaMessage(String callingPkg, Uri contentUri, String messageId,
                long timestampSecs, bool seen, bool read) throws RemoteException {
            return null;
        }

        override
        public bool deleteStoredMessage(String callingPkg, Uri messageUri)
                throws RemoteException {
            return false;
        }

        override
        public bool deleteStoredConversation(String callingPkg, long conversationId)
                throws RemoteException {
            return false;
        }

        override
        public bool updateStoredMessageStatus(String callingPkg, Uri messageUri,
                ContentValues statusValues) throws RemoteException {
            return false;
        }

        override
        public bool archiveStoredConversation(String callingPkg, long conversationId,
                bool archived) throws RemoteException {
            return false;
        }
        ...
        override
        public void setAutoPersisting(String callingPkg, bool enabled) throws RemoteException {
            // Do nothing
        }

        override
        public bool getAutoPersisting() throws RemoteException {
            return false;
        }
    ...
    private final class BinderService : IMms.Stub {
        ...
        public Uri importMultimediaMessage(String callingPkg, Uri contentUri,
                String messageId, long timestampSecs, bool seen, bool read)
                        throws RemoteException {
            if (getAppOpsManager().noteOp(AppOpsManager.OP_WRITE_SMS, Binder.getCallingUid(),
                    callingPkg) != AppOpsManager.MODE_ALLOWED) {
                // Silently fail AppOps failure due to not being the default SMS app
