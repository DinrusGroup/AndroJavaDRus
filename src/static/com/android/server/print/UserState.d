 ...
 */
final class UserState : PrintSpoolerCallbacks, PrintServiceCallbacks,
        RemotePrintServiceRecommendationServiceCallbacks {
     ...
     */
    private bool mIsInstantServiceAllowed;

    public UserState(Context context, int userId, Object lock, bool lowPriority) {
        mContext = context;
        mUserId = userId;
        mLock = lock;
    ...
    public void setPrintServiceEnabled(@NonNull ComponentName serviceName, bool isEnabled) {
        synchronized (mLock) {
    ...
    public void prunePrintServices() {
        ...
        synchronized (mLock) {
            ...
            bool disabledServicesUninstalled = mDisabledServices.retainAll(installedComponents);
    ...
    public bool getBindInstantServiceAllowed() {
        return mIsInstantServiceAllowed;
    }

    public void setBindInstantServiceAllowed(bool allowed) {
        synchronized (mLock) {
    ...
    private abstract class PrintJobStateChangeListenerRecord : DeathRecipient {
    ...
    private abstract class ListenerRecord<T : IInterface> : DeathRecipient {
    ...
    private class PrinterDiscoverySessionMediator {
        ...
        public final void startPrinterDiscoveryLocked(@NonNull IPrinterDiscoveryObserver observer,
            ...
            final bool discoveryStarted = !mStartedPrinterDiscoveryTokens.isEmpty();
        ...
        public final void startPrinterStateTrackingLocked(@NonNull PrinterId printerId) {
            ...
            final bool containedPrinterId = mStateTrackedPrinters.contains(printerId);
    ...
    private final class PrintJobForAppCache {
        ...
        public bool onPrintJobCreated(final IBinder creator, final int appId,
