 ...
 */
public final class PrintManagerService : SystemService {
    ...
    class PrintManagerImpl : IPrintManager.Stub {
        ...
        override
        public void setPrintServiceEnabled(ComponentName service, bool isEnabled, int userId) {
            final int resolvedUserId = resolveCallingUserEnforcingPermissions(userId);
        ...
        override
        public bool getBindInstantServiceAllowed(@UserIdInt int userId) {
        ...
        override
        public void setBindInstantServiceAllowed(@UserIdInt int userId, bool allowed) {
            int callingUid = Binder.getCallingUid();
            if (callingUid != SHELL_UID && callingUid != ROOT_UID) {
                throw new SecurityException("Can only be called by uid " + SHELL_UID
                        + " or " + ROOT_UID);
        ...
        private bool isPrintingEnabled() {
        ...
        private void registerBroadcastReceivers() {
            PackageMonitor monitor = new PackageMonitor() {
                 ...
                 */
                private bool hasPrintService(String packageName) {
                 ...
                 */
                private bool hadPrintService(@NonNull UserState userState, String packageName) {
                ...
                override
                public bool onHandleForceStop(Intent intent, String[] stoppedPackages,
                        int uid, bool doit) {
                    ...
                    synchronized (mLock) {
                        ...
                        UserState userState = getOrCreateUserStateLocked(getChangingUserId(), false,
                                false /* enforceUserUnlockingOrUnlocked */);
                        bool stoppedSomePackages = false;
        ...
        private UserState getOrCreateUserStateLocked(int userId, bool lowPriority) {
            return getOrCreateUserStateLocked(userId, lowPriority,
                    true /* enforceUserUnlockingOrUnlocked */);
        }

        private UserState getOrCreateUserStateLocked(int userId, bool lowPriority,
                bool enforceUserUnlockingOrUnlocked) {
