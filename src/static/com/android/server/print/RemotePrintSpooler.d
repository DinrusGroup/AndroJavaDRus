...
final class RemotePrintSpooler {
    ...
    public RemotePrintSpooler(Context context, int userId, bool lowPriority,
    ...
    public final bool setPrintJobState(PrintJobId printJobId, int state, String error) {
        throwIfCalledOnMainThread();
        synchronized (mLock) {
            throwIfDestroyedLocked();
            mCanUnbind = false;
    ...
    public final bool setPrintJobTag(PrintJobId printJobId, String tag) {
        throwIfCalledOnMainThread();
        synchronized (mLock) {
            throwIfDestroyedLocked();
            mCanUnbind = false;
    ...
    public final void setPrintJobCancelling(PrintJobId printJobId, bool cancelling) {
        throwIfCalledOnMainThread();
        synchronized (mLock) {
            throwIfDestroyedLocked();
            mCanUnbind = false;
    ...
    private final class MyServiceConnection : ServiceConnection {
        override
    ...
    private static final class GetPrintJobInfosCaller
            : TimedRemoteCaller<List<PrintJobInfo>> {
    ...
    private static final class GetPrintJobInfoCaller : TimedRemoteCaller<PrintJobInfo> {
        private final IPrintSpoolerCallbacks mCallback;
    ...
    private static final class SetPrintJobStateCaller : TimedRemoteCaller<Boolean> {
        private final IPrintSpoolerCallbacks mCallback;
        ...
        public SetPrintJobStateCaller() {
            ...
            mCallback = new BasePrintSpoolerServiceCallbacks() {
                override
                public void onSetPrintJobStateResult(bool success, int sequence) {
                    onRemoteMethodResult(success, sequence);
                }
            };
        }

        public bool setPrintJobState(IPrintSpooler target, PrintJobId printJobId,
    ...
    private static final class SetPrintJobTagCaller : TimedRemoteCaller<Boolean> {
        private final IPrintSpoolerCallbacks mCallback;
        ...
        public SetPrintJobTagCaller() {
            ...
            mCallback = new BasePrintSpoolerServiceCallbacks() {
                override
                public void onSetPrintJobTagResult(bool success, int sequence) {
                    onRemoteMethodResult(success, sequence);
                }
            };
        }

        public bool setPrintJobTag(IPrintSpooler target, PrintJobId printJobId,
    ...
    private static final class OnCustomPrinterIconLoadedCaller : TimedRemoteCaller<Void> {
        private final IPrintSpoolerCallbacks mCallback;
    ...
    private static final class ClearCustomPrinterIconCacheCaller : TimedRemoteCaller<Void> {
        private final IPrintSpoolerCallbacks mCallback;
    ...
    private static final class GetCustomPrinterIconCaller : TimedRemoteCaller<Icon> {
        private final IPrintSpoolerCallbacks mCallback;
    ...
    private static abstract class BasePrintSpoolerServiceCallbacks
        ...
        override
        public void onCancelPrintJobResult(bool canceled, int sequence) {
            /* do nothing */
        }

        override
        public void onSetPrintJobStateResult(bool success, int sequece) {
            /* do nothing */
        }
    ...
    private static final class PrintSpoolerClient : IPrintSpoolerClient.Stub {
