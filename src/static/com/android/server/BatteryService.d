 ...
 * <p>&quot;present&quot; - bool, true if the battery is present<br />
 ...
 * </p>
 */
public final class BatteryService : SystemService {
    ...
    private bool mBatteryLevelCritical;
    private int mLastBatteryStatus;
    private int mLastBatteryHealth;
    private bool mLastBatteryPresent;
    private int mLastBatteryLevel;
    private int mLastBatteryVoltage;
    private int mLastBatteryTemperature;
    private bool mLastBatteryLevelCritical;
    ...
    private bool mUpdatesStopped;

    private Led mLed;

    private bool mSentLowBatteryBroadcast = false;
    ...
    private bool isPoweredLocked(int plugTypeSet) {
    ...
    private bool shouldSendBatteryLowLocked() {
        final bool plugged = mPlugType != BATTERY_PLUGGED_NONE;
        final bool oldPlugged = mLastPlugType != BATTERY_PLUGGED_NONE;
    ...
    private void processValuesLocked(bool force) {
        bool logOutlier = false;
    ...
    private void sendBatteryLevelChangedIntentLocked() {
        ...
        bool queueWasEmpty = mBatteryLevelsEventQueue.isEmpty();
    ...
    private final class HealthHalCallback : IHealthInfoCallback.Stub
            : HealthServiceWrapper.Callback {
    ...
    private final class BinderService : Binder {
    ...
    // Reduced IBatteryPropertiesRegistrar that only : getProperty for usage
    // in BatteryManager.
    private final class BatteryPropertiesRegistrar : IBatteryPropertiesRegistrar.Stub {
    ...
    private final class LocalService : BatteryManagerInternal {
        override
        public bool isPowered(int plugTypeSet) {
            synchronized (mLock) {
        ...
        override
        public bool getBatteryLevelLow() {
            synchronized (mLock) {
    ...
    static final class HealthServiceWrapper {
        ...
        private class Notification : IServiceNotification.Stub {
            override
