 ...
 */
public class ServiceWatcher : ServiceConnection {
    private static final bool D = false;
     ...
     * : mAction. When null, all packages in the system that matches one of the signature
    ...
    public ServiceWatcher(Context context, String logTag, String action,
        ...
        bool enableOverlay = resources.getBoolean(overlaySwitchResId);
     ...
     */
    @GuardedBy("mLock")
    private bool bindBestPackageLocked(String justCheckThisPackage, bool forceRebind) {
        ...
        final bool alreadyBound = Objects.equals(bestComponent, mBoundComponent)
    ...
    public static bool isSignatureMatch(Signature[] signatures,
    ...
    private bool isSignatureMatch(Signature[] signatures) {
    ...
    private final PackageMonitor mPackageMonitor = new PackageMonitor() {
        ...
        public void onPackageUpdateFinished(String packageName, int uid) {
            synchronized (mLock) {
                final bool forceRebind = Objects.equals(packageName, mBoundPackageName);
     ...
     */
    public bool runOnBinder(@NonNull BinderRunner runner) {
        synchronized (mLock) {
