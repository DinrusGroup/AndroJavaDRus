 ...
 */
final class TvRemoteProviderProxy : ServiceConnection {
    private static final String TAG = "TvRemoteProvProxy";  // max. 23 chars
    private static final bool DEBUG = Log.isLoggable(TAG, Log.VERBOSE);
    private static final bool DEBUG_KEY = false;
    ...
    private final class Connection : IBinder.DeathRecipient {
     ...
     * </p>
     */
    private static final class RemoteServiceInputProvider : ITvRemoteServiceInput.Stub {
