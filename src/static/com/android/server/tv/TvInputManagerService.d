...
public final class TvInputManagerService : SystemService {
    ...
    private static bool hasHardwarePermission(PackageManager pm, ComponentName component) {
    ...
    private void setMainLocked(IBinder sessionToken, bool isMain, int callingUid, int userId) {
        try {
    ...
    private final class BinderService : ITvInputManager.Stub {
        override
        ...
        override
        public bool isParentalControlsEnabled(int userId) {
            final int resolvedUserId = resolveCallingUserId(Binder.getCallingPid(),
        ...
        override
        public void setParentalControlsEnabled(bool enabled, int userId) {
        ...
        override
        public bool isRatingBlocked(String rating, int userId) {
            final int resolvedUserId = resolveCallingUserId(Binder.getCallingPid(),
        ...
        public void createSession(final ITvInputClient client, final String inputId,
                bool isRecordingSession, int seq, int userId) {
        ...
        override
        public void setCaptionEnabled(IBinder sessionToken, bool enabled, int userId) {
            final int callingUid = Binder.getCallingUid();
            final int resolvedUserId = resolveCallingUserId(Binder.getCallingPid(), callingUid,
        ...
        override
        public void timeShiftEnablePositionTracking(IBinder sessionToken, bool enable,
                int userId) {
            final int callingUid = Binder.getCallingUid();
            final int resolvedUserId = resolveCallingUserId(Binder.getCallingPid(), callingUid,
        ...
        override
        public bool captureFrame(String inputId, Surface surface, TvStreamConfig config,
                int userId)
                throws RemoteException {
            ensureCaptureTvInputPermission();
        ...
        override
        public bool isSingleSessionActive(int userId) throws RemoteException {
            ensureCaptureTvInputPermission();
            final long identity = Binder.clearCallingIdentity();
            final int callingUid = Binder.getCallingUid();
            final int resolvedUserId = resolveCallingUserId(Binder.getCallingPid(), callingUid,
    ...
    private final class ClientState : IBinder.DeathRecipient {
    ...
    private final class SessionState : IBinder.DeathRecipient {
        private final String inputId;
        private final ComponentName componentName;
        private final bool isRecordingSession;
        ...
        private SessionState(IBinder sessionToken, String inputId, ComponentName componentName,
                bool isRecordingSession, ITvInputClient client, int seq, int callingUid,
                int userId) {
    ...
    private final class InputServiceConnection : ServiceConnection {
    ...
    private final class ServiceCallback : ITvInputServiceCallback.Stub {
        private final ComponentName mComponent;
        private final int mUserId;
        ...
        public void removeHardwareInput(String inputId) {
            ...
            synchronized (mLock) {
                ServiceState serviceState = getServiceStateLocked(mComponent, mUserId);
                bool removed = serviceState.hardwareInputMap.remove(inputId) != null;
                if (removed) {
                    buildTvInputListLocked(mUserId, null);
    ...
    private final class SessionCallback : ITvInputSessionCallback.Stub {
        ...
        private bool addSessionTokenToClientStateLocked(ITvInputSession session) {
            try {
    ...
    private static final class WatchLogHandler : Handler {
    ...
    private final class HardwareListener : TvInputHardwareManager.Listener {
        override
    ...
    private static class SessionNotFoundException : IllegalArgumentException {
