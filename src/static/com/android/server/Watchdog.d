...
public class Watchdog : Thread {
    static final String TAG = "Watchdog";

    // Set this to true to use debug default values.
    static final bool DB = false;
     ...
     */
    public final class HandlerChecker : Runnable {
    ...
    final class RebootRequestReceiver : BroadcastReceiver {
        override
     ...
     */
    private static final class BinderThreadMonitor : Watchdog.Monitor {
        override
        public void monitor() {
    ...
    public void setAllowRestart(bool allowRestart) {
        synchronized (this) {
