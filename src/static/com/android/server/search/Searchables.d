...
public class Searchables {
     ...
     * the manifest entry:
     * <ol>
     * <li>The activity itself : search.  This is indicated by the
     ...
     * <li>A related activity : search.  This is indicated by the
     ...
     */
    private bool isInstalled(ComponentName globalSearch) {
        Intent intent = new Intent(SearchManager.INTENT_ACTION_GLOBAL_SEARCH);
    ...
    private static final Comparator<ResolveInfo> GLOBAL_SEARCH_RANKER =
        ...
        public int compare(ResolveInfo lhs, ResolveInfo rhs) {
            ...
            bool lhsSystem = isSystemApp(lhs);
            bool rhsSystem = isSystemApp(rhs);
     ...
     */
    private static final bool isSystemApp(ResolveInfo res) {
