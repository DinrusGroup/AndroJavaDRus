 ...
 * @hide
 */
public class StatsCompanionService : IStatsCompanionService.Stub {
    /**
    ...
    private final static class AppUpdateReceiver : BroadcastReceiver {
        override
        public void onReceive(Context context, Intent intent) {
            /**
            ...
            synchronized (sStatsdLock) {
                ...
                try {
                    if (intent.getAction().equals(Intent.ACTION_PACKAGE_REMOVED)) {
                        ...
                        bool replacing = intent.getBooleanExtra(Intent.EXTRA_REPLACING, false);
                        if (!replacing) {
    ...
    public final static class AnomalyAlarmReceiver : BroadcastReceiver {
        override
        public void onReceive(Context context, Intent intent) {
    ...
    public final static class PullingAlarmReceiver : BroadcastReceiver {
        override
        public void onReceive(Context context, Intent intent) {
            if (DEBUG)
    ...
    public final static class PeriodicAlarmReceiver : BroadcastReceiver {
        override
        public void onReceive(Context context, Intent intent) {
            if (DEBUG)
    ...
    public final static class ShutdownEventReceiver : BroadcastReceiver {
        override
        public void onReceive(Context context, Intent intent) {
            /**
    ...
    private void addNetworkStats(
            int tag, List<StatsLogEventWrapper> ret, NetworkStats stats, bool withFGBG) {
        int size = stats.size();
    ...
    private class StatsdDeathRecipient : IBinder.DeathRecipient {
        override
