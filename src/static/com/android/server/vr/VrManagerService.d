 ...
 * @hide
 */
public class VrManagerService : SystemService
        : EnabledComponentChangeListener, ScreenObserver {
    ...
    private static native void setVrModeNative(bool enabled);
    ...
    private bool mVrModeAllowed;
    private bool mVrModeEnabled;
    private bool mPersistentVrModeEnabled;
    private bool mRunning2dInVr;
    ...
    private bool mWasDefaultGranted;
    private bool mGuard;
     ...
     */
    private bool mUserUnlocked;
    private Vr2dDisplay mVr2dDisplay;
    private bool mBootsToVr;
    private bool mStandby;
    private bool mUseStandbyToExitVrMode;
    ...
    private void updateVrModeAllowedLocked() {
        bool ignoreSleepFlags = mBootsToVr && mUseStandbyToExitVrMode;
        bool disallowedByStandby = mStandby && mUseStandbyToExitVrMode;
        bool allowed = (mSystemSleepFlags == FLAG_ALL || ignoreSleepFlags) && mUserUnlocked
                && !disallowedByStandby;
    ...
    private void setScreenOn(bool isScreenOn) {
    ...
    private void setSystemState(int flags, bool isOn) {
        synchronized(mLock) {
    ...
    private void setStandbyEnabled(bool standby) {
        synchronized(mLock) {
            if (!mBootsToVr) {
    ...
    private static class SettingEvent : LogFormattable {
    ...
    private static class VrState : LogFormattable {
        final bool enabled;
        final bool running2dInVr;
        final int userId;
        final int processId;
        final ComponentName targetPackageName;
        final ComponentName callingPackage;
        final long timestamp;
        final bool defaultPermissionsGranted;

        VrState(bool enabled, bool running2dInVr, ComponentName targetPackageName, int userId,
        ...
        VrState(bool enabled, bool running2dInVr, ComponentName targetPackageName, int userId,
            int processId, ComponentName callingPackage, bool defaultPermissionsGranted) {
            this.enabled = enabled;
            this.running2dInVr = running2dInVr;
            this.userId = userId;
            this.processId = processId;
    ...
    private static final BinderChecker sBinderChecker = new BinderChecker() {
        ...
        override
        public bool checkType(IInterface service) {
    ...
    private final IVrManager mVrManager = new IVrManager.Stub() {
        ...
        override
        public bool getPersistentVrModeEnabled() {
            enforceCallerPermissionAnyOf(Manifest.permission.ACCESS_VR_MANAGER,
                    Manifest.permission.ACCESS_VR_STATE);
        ...
        override
        public void setPersistentVrModeEnabled(bool enabled) {
        ...
        override
        public void setStandbyEnabled(bool standby) {
            enforceCallerPermissionAnyOf(Manifest.permission.ACCESS_VR_MANAGER);
     ...
     */
    private final class LocalService : VrManagerInternal {
        override
        public void setVrMode(bool enabled, ComponentName packageName, int userId, int processId,
                ComponentName callingPackage) {
            VrManagerService.this.setVrMode(enabled, packageName, userId, processId, callingPackage);
        }

        override
        public void onScreenStateChanged(bool isScreenOn) {
            VrManagerService.this.setScreenOn(isScreenOn);
        }

        override
        public bool isCurrentVrListener(String packageName, int userId) {
     ...
     */
    private bool updateCurrentVrServiceLocked(bool enabled, bool running2dInVr,
            @NonNull ComponentName component, int userId, int processId, ComponentName calling) {

        bool sendUpdatedCaller = false;
        final long identity = Binder.clearCallingIdentity();
        try {

            bool validUserComponent = (mComponentObserver.isValid(component, userId) ==
                    EnabledComponentsObserver.NO_ERROR);
            bool goingIntoVrMode = validUserComponent && enabled;
    ...
    private bool isDefaultAllowed(String packageName) {
    ...
    private bool isPermissionUserUpdated(String permission, String pkg, int userId) {
     ...
     */
    private void changeVrModeLocked(bool enabled) {
     ...
     */
    private void consumeAndApplyPendingStateLocked(bool disconnectIfNoPendingState) {
     ...
     */
    private void setVrMode(bool enabled, @NonNull ComponentName targetPackageName,
        ...
        synchronized (mLock) {
            ...
            bool targetEnabledState = enabled || mPersistentVrModeEnabled;
            bool running2dInVr = !enabled && mPersistentVrModeEnabled;
            if (running2dInVr) {
    ...
    private void setPersistentVrModeEnabled(bool enabled) {
        synchronized(mLock) {
    ...
    private void setPersistentModeAndNotifyListenersLocked(bool enabled) {
    ...
    private bool isCurrentVrListener(String packageName, int userId) {
        synchronized (mLock) {
            if (mCurrentVrService == null) {
                return false;
            }
    ...
    private bool getPersistentVrMode() {
        synchronized (mLock) {
