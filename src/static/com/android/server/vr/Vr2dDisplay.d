...
class Vr2dDisplay {
    ...
    private bool mIsVrModeOverrideEnabled;  // debug override to set vr mode.
    private bool mIsVirtualDisplayAllowed = true;  // Virtual-display feature toggle
    private bool mIsPersistentVrModeEnabled;  // indicates we are in vr persistent mode.
    private bool mBootsToVr = false;  // The device boots into VR (standalone VR device)
     ...
     */
    public void init(Context context, bool bootsToVr) {
        startVrModeListener();
    ...
    private bool shouldRunVirtualDisplay() {
