 ...
 * </p>
 */
final class OverlayDisplayWindow : DumpUtils.Dump {
    ...
    private final bool DISABLE_MOVE_AND_RESIZE = false;
    ...
    public OverlayDisplayWindow(Context context, String name,
            int width, int height, int densityDpi, int gravity, bool secure,
            Listener listener) {
    ...
    private void resize(int width, int height, int densityDpi, bool doLayout) {
        mWidth = width;
        mHeight = height;
    ...
    private bool updateDefaultDisplayInfo() {
