...
final class ColorFade {
    ...
    private bool mCreatedResources;
    private int mMode;
    ...
    private bool mSurfaceVisible;
    private float mSurfaceAlpha;

    // Texture names.  We only use one texture, which contains the screenshot.
    private final int[] mTexNames = new int[1];
    private bool mTexNamesGenerated;
     ...
     */
    public bool prepare(Context context, int mode) {
        if (DEBUG) {
    ...
    private bool initGLShaders(Context context) {
    ...
    private bool captureScreenshotTextureAndSetViewport() {
        if (!attachEglContext()) {
            return false;
        }
        try {
    ...
    private bool showSurface(float alpha) {
    ...
    private static bool checkGlErrors(String func) {
        return checkGlErrors(func, true);
    }

    private static bool checkGlErrors(String func, bool log) {
        bool hadError = false;
        int error;
     ...
     * owns the color fade.
     */
    private static final class NaturalSurfaceLayout : DisplayTransactionListener {
        private final DisplayManagerInternal mDisplayManagerInternal;
        private final int mDisplayId;
        private SurfaceControl mSurfaceControl;
