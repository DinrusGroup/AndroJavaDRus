 ...
 * </p>
 */
final class LocalDisplayAdapter : DisplayAdapter {
    ...
    private final class LocalDisplayDevice : DisplayDevice {
        ...
        private bool mHavePendingChanges;
        private int mState = Display.STATE_UNKNOWN;
        private int mBrightness = PowerManager.BRIGHTNESS_DEFAULT;
        private int mActivePhysIndex;
        private int mDefaultModeId;
        private int mActiveModeId;
        private bool mActiveModeInvalid;
        private int mActiveColorMode;
        private bool mActiveColorModeInvalid;
        private Display.HdrCapabilities mHdrCapabilities;
        private bool mSidekickActive;
        ...
        override
        public bool hasStableUniqueId() {
            return true;
        }

        public bool updatePhysicalDisplayInfoLocked(
                SurfaceControl.PhysicalDisplayInfo[] physicalDisplayInfos, int activeDisplayInfo,
                int[] colorModes, int activeColorMode) {
            ...
            bool recordsChanged = records.size() != mSupportedModes.size() || modesAdded;
        ...
        public Runnable requestDisplayStateLocked(final int state, final int brightness) {
            ...
            final bool stateChanged = (mState != state);
            final bool brightnessChanged = (mBrightness != brightness) && mBacklight != null;
            if (stateChanged || brightnessChanged) {
                ...
                return new Runnable() {
                    ...
                    private void setVrMode(bool isVrEnabled) {
                        if (DEBUG) {
        ...
        public bool requestModeLocked(int modeId) {
            if (modeId == 0) {
        ...
        public bool requestColorModeLocked(int colorMode) {
    ...
    private static final class DisplayModeRecord {
         ...
         */
        public bool hasMatchingMode(SurfaceControl.PhysicalDisplayInfo info) {
    ...
    private final class HotplugDisplayEventReceiver : DisplayEventReceiver {
        public HotplugDisplayEventReceiver(Looper looper) {
            super(looper, VSYNC_SOURCE_APP);
        }

        override
        public void onHotplug(long timestampNanos, int builtInDisplayId, bool connected) {
