 ...
 * </p>
 */
final class WifiDisplayController : DumpUtils.Dump {
    ...
    private bool mWifiP2pEnabled;
    private bool mWfdEnabled;
    private bool mWfdEnabling;
    ...
    private bool mRemoteDisplayConnected;
    ...
    // Certification
    private bool mWifiDisplayCertMode;
    ...
    private void handleStateChanged(bool enabled) {
            ...
            if (mDesiredDevice != null || mWifiDisplayCertMode) {
                mWifiP2pManager.requestGroupInfo(mWifiP2pChannel, new GroupInfoListener() {
                    ...
                    public void onGroupInfoAvailable(WifiP2pGroup info) {
                        ...
                        if (mWifiDisplayCertMode) {
                            bool owner = info.getOwner().deviceAddress
    ...
    private void handleConnectionFailure(bool timeoutOccurred) {
    ...
    private static bool isWifiDisplay(WifiP2pDevice device) {
        return device.wfdInfo != null
                && device.wfdInfo.isWfdEnabled()
                && isPrimarySinkDeviceType(device.wfdInfo.getDeviceType());
    }

    private static bool isPrimarySinkDeviceType(int deviceType) {
    ...
    private final BroadcastReceiver mWifiP2pReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (action.equals(WifiP2pManager.WIFI_P2P_STATE_CHANGED_ACTION)) {
                ...
                // on startup.
                bool enabled = (intent.getIntExtra(WifiP2pManager.EXTRA_WIFI_STATE,
