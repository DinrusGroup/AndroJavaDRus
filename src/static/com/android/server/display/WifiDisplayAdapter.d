 ...
 * </p>
 */
final class WifiDisplayAdapter : DisplayAdapter {
    ...
    private final bool mSupportsProtectedBuffers;
    ...
    private bool mPendingStatusChangeBroadcast;
    ...
    private void updateDisplaysLocked() {
        ...
        bool[] remembered = new bool[mAvailableDisplays.length];
    ...
    private void addDisplayDeviceLocked(WifiDisplay display,
        ...
        bool secure = (flags & RemoteDisplay.DISPLAY_FLAG_SECURE) != 0;
    ...
    private final WifiDisplayController.Listener mWifiDisplayListener =
        ...
        public void onScanResults(WifiDisplay[] availableDisplays) {
            synchronized (getSyncRoot()) {
                ...
                bool changed = !Arrays.equals(mAvailableDisplays, availableDisplays);
    ...
    private final class WifiDisplayDevice : DisplayDevice {
    ...
    private final class WifiDisplayHandler : Handler {
