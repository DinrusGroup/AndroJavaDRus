 ...
 * </p>
 */
final class OverlayDisplayAdapter : DisplayAdapter {
        ...
        for (String part : value.split(";")) {
            ...
            if (displayMatcher.matches()) {
                ...
                if (!modes.isEmpty()) {
                    ...
                    bool secure = flagString != null && flagString.contains(",secure");
    ...
    private abstract class OverlayDisplayDevice : DisplayDevice {
     ...
     */
    private final class OverlayDisplayHandle : OverlayDisplayWindow.Listener {
