...
class AutomaticBrightnessController {
    ...
    private static final bool DEBUG_PRETEND_LIGHT_SENSOR_ABSENT = false;

    // If true, enables the use of the screen auto-brightness adjustment setting.
    private static final bool USE_SCREEN_AUTO_BRIGHTNESS_ADJUSTMENT = true;
    ...
    private final bool mResetAmbientLuxAfterWarmUpConfig;
    ...
    private bool mLightSensorEnabled;
    ...
    private bool mBrightnessAdjustmentSamplePending;
    ...
    private bool mShortTermModelValid;
    ...
    public AutomaticBrightnessController(Callbacks callbacks, Looper looper,
            ...
            long darkeningLightDebounceConfig, bool resetAmbientLuxAfterWarmUpConfig,
    ...
    public void configure(bool enable, @Nullable BrightnessConfiguration configuration,
            float brightness, bool userChangedBrightness, float adjustment,
            bool userChangedAutoBrightnessAdjustment, int displayPolicy) {
        // While dozing, the application processor may be suspended which will prevent us from
        // receiving new information from the light sensor. On some devices, we may be able to
        // switch to a wake-up light sensor instead but for now we will simply disable the sensor
        // and hold onto the last computed screen auto brightness.  We save the dozing flag for
        // debugging purposes.
        bool dozing = (displayPolicy == DisplayPowerRequest.POLICY_DOZE);
        bool changed = setBrightnessConfiguration(configuration);
        ...
        final bool userInitiatedChange =
    ...
    private bool setDisplayPolicy(int policy) {
    ...
    public bool setBrightnessConfiguration(BrightnessConfiguration configuration) {
    ...
    private bool setLightSensorEnabled(bool enable) {
        if (enable) {
    ...
    private bool setAutoBrightnessAdjustment(float adjustment) {
    ...
    private void updateAutoBrightness(bool sendUpdate) {
        if (!mAmbientLuxValid) {
            return;
        }
    ...
    private final class AutomaticBrightnessHandler : Handler {
