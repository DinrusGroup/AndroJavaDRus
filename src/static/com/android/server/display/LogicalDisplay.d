...
final class LogicalDisplay {
     ...
     */
    public bool setDisplayInfoOverrideFromWindowManagerLocked(DisplayInfo info) {
        if (info != null) {
            if (mOverrideDisplayInfo == null) {
    ...
    public void configureDisplayLocked(SurfaceControl.Transaction t,
        ...
        bool rotated = (orientation == Surface.ROTATION_90
     ...
     */
    public void setHasContentLocked(bool hasContent) {
