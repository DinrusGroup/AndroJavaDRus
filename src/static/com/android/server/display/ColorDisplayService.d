 ...
 */
public final class ColorDisplayService : SystemService
    ...
    private static bool isUserSetupCompleted(ContentResolver cr, int userHandle) {
    ...
    override
    public void onAccessibilityTransformChanged(bool state) {
        onDisplayColorModeChanged(mController.getColorMode());
    }
     ...
     */
    private void setCoefficientMatrix(Context context, bool needsLinear) {
     ...
     */
    private void applyTint(bool immediate) {
    ...
    private abstract class AutoMode : ColorDisplayController.Callback {
        public abstract void onStart();

        public abstract void onStop();
    }

    private class CustomAutoMode : AutoMode : AlarmManager.OnAlarmListener {
        ...
        private void updateActivated() {
            ...
            bool activate = now.isBefore(end);
    ...
    private class TwilightAutoMode : AutoMode : TwilightListener {
     ...
     */
    private static class ColorMatrixEvaluator : TypeEvaluator<float[]> {
