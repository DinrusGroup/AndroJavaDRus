...
final class DisplayPowerState {
    ...
    private bool mScreenReady;
    private bool mScreenUpdatePending;

    private bool mColorFadePrepared;
    private float mColorFadeLevel;
    private bool mColorFadeReady;
    private bool mColorFadeDrawPending;
     ...
     */
    public bool prepareColorFade(Context context, int mode) {
   ...
   /**
     ...
     */
    public bool waitUntilClean(Runnable listener) {
     ...
     */
    private final class PhotonicModulator : Thread {
        ...
        private bool mStateChangeInProgress;
        private bool mBacklightChangeInProgress;

        public PhotonicModulator() {
            super("PhotonicModulator");
        }

        public bool setState(int state, int backlight) {
            synchronized (mLock) {
                bool stateChanged = state != mPendingState;
                bool backlightChanged = backlight != mPendingBacklight;
                if (stateChanged || backlightChanged) {
                    ...
                    bool changeInProgress = mStateChangeInProgress || mBacklightChangeInProgress;
