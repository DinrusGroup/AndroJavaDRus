 ...
 * </p>
 */
public final class DisplayManagerService : SystemService {
    ...
    private final bool mSingleDisplayDemoMode;
    ...
    private bool mPendingTraversal;
     ...
     */
    public void systemReady(bool safeMode, bool onlyCore) {
        synchronized (mSyncRoot) {
            mSafeMode = safeMode;
            mOnlyCore = onlyCore;
        }
    ...
    private bool shouldRegisterNonEssentialDisplayAdaptersLocked() {
    ...
    private LogicalDisplay addLogicalDisplayLocked(DisplayDevice device) {
        ...
        bool isDefault = (deviceInfo.flags
    ...
    private int assignDisplayIdLocked(bool isDefault) {
    ...
    private bool isBrightnessConfigurationTooDark(BrightnessConfiguration config) {
    ...
    // Sends notifications if needed.
    private bool updateLogicalDisplaysLocked() {
        bool changed = false;
    ...
    private void setDisplayPropertiesInternal(int displayId, bool hasContent,
            float requestedRefreshRate, int requestedModeId, bool inTraversal) {
        synchronized (mSyncRoot) {
            LogicalDisplay display = mLogicalDisplays.get(displayId);
            if (display == null) {
                return;
    ...
    private bool isUidPresentOnDisplayInternal(int uid, int displayId) {
        synchronized (mSyncRoot) {
    ...
    private void configureDisplayLocked(SurfaceControl.Transaction t, DisplayDevice device) {
        ...
        final bool ownContent = (info.flags & DisplayDeviceInfo.FLAG_OWN_CONTENT_ONLY) != 0;
    ...
    private void scheduleTraversalLocked(bool inTraversal) {
    ...
    private final class DisplayManagerHandler : Handler {
    ...
    private final class DisplayAdapterListener : DisplayAdapter.Listener {
        override
    ...
    private final class CallbackRecord : DeathRecipient {
        public final int mPid;
        private final IDisplayManagerCallback mCallback;

        public bool mWifiDisplayScanRequested;
    ...
    @VisibleForTesting
    final class BinderService : IDisplayManager.Stub {
        /**
        ...
        private bool validatePackageName(int uid, String packageName) {
            if (packageName != null) {
        ...
        private bool canProjectVideo(IMediaProjection projection) {
            if (projection != null) {
                try {
        ...
        private bool canProjectSecureVideo(IMediaProjection projection) {
            if (projection != null) {
                try {
    ...
    private final class LocalService : DisplayManagerInternal {
        override
        ...
        override
        public void setDisplayProperties(int displayId, bool hasContent,
                float requestedRefreshRate, int requestedMode, bool inTraversal) {
        ...
        override
        public bool isUidPresentOnDisplay(int uid, int displayId) {
