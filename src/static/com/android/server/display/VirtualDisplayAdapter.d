 ...
 */
@VisibleForTesting
public class VirtualDisplayAdapter : DisplayAdapter {
    ...
    public VirtualDisplayAdapter(DisplayManagerService.SyncRoot syncRoot,
        ...
        this(syncRoot, context, handler, listener,
                (String name, bool secure) -> SurfaceControl.createDisplay(name, secure));
    }
    ...
    private final class VirtualDisplayDevice : DisplayDevice : DeathRecipient {
        ...
        public void destroyLocked(bool binderAlive) {
            if (mSurface != null) {
                mSurface.release();
                mSurface = null;
            }
    ...
    private static class Callback : Handler {
    ...
    private final class MediaProjectionCallback : IMediaProjectionCallback.Stub {
    ...
    public interface SurfaceControlDisplayFactory {
        public IBinder createDisplay(String name, bool secure);
    }
}
