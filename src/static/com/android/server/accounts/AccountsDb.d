 ...
 */
class AccountsDb : AutoCloseable {
    ...
    private static class CeDatabaseHelper : SQLiteOpenHelper {
        ...
        static CeDatabaseHelper create(
                ...
                File ceDatabaseFile) {
            bool newDbExists = ceDatabaseFile.exists();
            if (Log.isLoggable(TAG, Log.VERBOSE)) {
        ...
        private static bool migratePreNDbToCe(File oldDbFile, File ceDbFile) {
    ...
    bool deleteAuthtokensByAccountIdAndType(long accountId, String authtokenType) {
    ...
    bool deleteAuthToken(String authTokenId) {
        SQLiteDatabase db = mDeDatabase.getWritableDatabaseUserIsUnlocked();
        return db.delete(
    ...
    bool renameCeAccount(long accountId, String newName) {
        SQLiteDatabase db = mDeDatabase.getWritableDatabaseUserIsUnlocked();
        final ContentValues values = new ContentValues();
    ...
    bool deleteAuthTokensByAccountId(long accountId) {
        SQLiteDatabase db = mDeDatabase.getWritableDatabaseUserIsUnlocked();
    ...
    bool updateExtra(long extrasId, String value) {
        SQLiteDatabase db = mDeDatabase.getWritableDatabaseUserIsUnlocked();
        ContentValues values = new ContentValues();
    ...
    static class DeDatabaseHelper : SQLiteOpenHelper {

        private final int mUserId;
        private volatile bool mCeAttached;
    ...
    bool deleteDeAccount(long accountId) {
    ...
    bool deleteSharedAccount(Account account) {
        SQLiteDatabase db = mDeDatabase.getWritableDatabase();
    ...
    bool updateAccountLastAuthenticatedTime(Account account) {
        SQLiteDatabase db = mDeDatabase.getWritableDatabase();
        final ContentValues values = new ContentValues();
    ...
    bool renameDeAccount(long accountId, String newName, String previousName) {
        SQLiteDatabase db = mDeDatabase.getWritableDatabase();
        final ContentValues values = new ContentValues();
        values.put(ACCOUNTS_NAME, newName);
    ...
    bool deleteGrantsByAccountIdAuthTokenTypeAndUid(long accountId,
    ...
    bool deleteGrantsByUid(int uid) {
        SQLiteDatabase db = mDeDatabase.getWritableDatabase();
        return db.delete(TABLE_GRANTS, GRANTS_GRANTEE_UID + "=?",
                new String[] {Integer.toString(uid)}) > 0;
    }

    bool setAccountVisibility(long accountId, String packageName, int visibility) {
        SQLiteDatabase db = mDeDatabase.getWritableDatabase();
        ContentValues values = new ContentValues();
    ...
    bool deleteAccountVisibilityForPackage(String packageName) {
        SQLiteDatabase db = mDeDatabase.getWritableDatabase();
    ...
    bool deleteMetaByAuthTypeAndUid(String type, int uid) {
        SQLiteDatabase db = mDeDatabase.getWritableDatabase();
        return db.delete(
                TABLE_META,
    ...
    private static class PreNDatabaseHelper : SQLiteOpenHelper {
        private final Context mContext;
        private final int mUserId;
    ...
    bool deleteCeAccount(long accountId) {
        SQLiteDatabase db = mDeDatabase.getWritableDatabaseUserIsUnlocked();
        return db.delete(
                CE_TABLE_ACCOUNTS, ACCOUNTS_ID + "=" + accountId, null) > 0;
    }

    bool isCeDatabaseAttached() {
    ...
    public static AccountsDb create(Context context, int userId, File preNDatabaseFile,
            File deDatabaseFile) {
        bool newDbExists = deDatabaseFile.exists();
