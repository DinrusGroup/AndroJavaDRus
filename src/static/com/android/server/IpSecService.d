 ...
 * @hide
 */
public class IpSecService : IIpSecService.Stub {
     ...
     *
     * <p>RefcountedResource : both explicit and implicit resource management. Creating a
     ...
     */
    @VisibleForTesting
    public class RefcountedResource<T : IResource> : IBinder.DeathRecipient {
        ...
        public void releaseReference() throws RemoteException {
            ...
            for (RefcountedResource<? : IResource> child : mChildren) {
     ...
     */
    private abstract class OwnedResourceRecord : IResource {
        final int pid;
        final int uid;
     ...
     */
    static class RefcountedResourceArray<T : IResource> {
     ...
     */
    private final class TransformRecord : OwnedResourceRecord {
     ...
     * object
     */
    private final class SpiRecord : OwnedResourceRecord {
        private final String mSourceAddress;
        private final String mDestinationAddress;
        private int mSpi;

        private bool mOwnedByTransform = false;
        ...
        public bool getOwnedByTransform() {
    ...
    private final class TunnelInterfaceRecord : OwnedResourceRecord {
     ...
     */
    private final class EncapSocketRecord : OwnedResourceRecord {
