 ...
 */
public class StatusBarManagerService : IStatusBarService.Stub {
    private static final String TAG = "StatusBarManagerService";
    private static final bool SPEW = false;
    ...
    private bool mShowImeSwitcher;
    private IBinder mImeToken = null;
    private int mCurrentUserId;

    private class DisableRecord : IBinder.DeathRecipient {
        int userId;
        String pkg;
        int what1;
        int what2;
    ...
    private final StatusBarManagerInternal mInternalService = new StatusBarManagerInternal() {
        private bool mNotificationLightOn;
        ...
        override
        public bool showShutdownUi(bool isReboot, String reason) {
    ...
    private final GlobalActionsProvider mGlobalActionsProvider = new GlobalActionsProvider() {
        override
        public bool isGlobalActionsDisabled() {
    ...
    override
    public void showPinningEnterExitToast(bool entering) throws RemoteException {
        if (mBar != null) {
            try {
    ...
    override
    public void setIconVisibility(String slot, bool visibility) {
        enforceStatusBar();
     ...
     */
    private void topAppWindowChanged(final bool menuVisible) {
        enforceStatusBar();
     ...
     */
    override
    public void onPanelRevealed(bool clearNotificationEffects, int numItems) {
        enforceStatusBarService();
     ...
     */
    override
    public void reboot(bool safeMode) {
        enforceStatusBarService();
        long identity = Binder.clearCallingIdentity();
        try {
            mHandler.post(() -> {
    ...
    override
    public void onNotificationExpansionChanged(String key, bool userAction,
            bool expanded) throws RemoteException {
        enforceStatusBarService();
        long identity = Binder.clearCallingIdentity();
        try {
