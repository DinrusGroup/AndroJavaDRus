 ...
 */
public class InputManagerService : IInputManager.Stub
        : Watchdog.Monitor {
    ...
    private bool mInputDevicesChangedPending; // guarded by mInputDevicesLock
    ...
    private bool mKeyboardLayoutNotificationShown;
    ...
    private bool mFocusedWindowHasCapture;
    ...
    private static native bool nativeHasKeys(long ptr,
            int deviceId, int sourceMask, int[] keyCodes, bool[] keyExists);
    private static native void nativeRegisterInputChannel(long ptr, InputChannel inputChannel,
            InputWindowHandle inputWindowHandle, bool monitor);
    private static native void nativeUnregisterInputChannel(long ptr, InputChannel inputChannel);
    private static native void nativeSetInputFilterEnabled(long ptr, bool enable);
    ...
    private static native void nativeSetInputDispatchMode(long ptr, bool enabled, bool frozen);
    private static native void nativeSetSystemUiVisibility(long ptr, int visibility);
    private static native void nativeSetFocusedApplication(long ptr,
            InputApplicationHandle application);
    private static native bool nativeTransferTouchFocus(long ptr,
            InputChannel fromChannel, InputChannel toChannel);
    private static native void nativeSetPointerSpeed(long ptr, int speed);
    private static native void nativeSetShowTouches(long ptr, bool enabled);
    private static native void nativeSetInteractive(long ptr, bool interactive);
    ...
    private static native bool nativeIsInputDeviceEnabled(long ptr, int deviceId);
    ...
    private static native void nativeSetPointerCapture(long ptr, bool detached);
    ...
    final bool mUseDevInputEventForAudioJack;
    ...
    public bool hasKeys(int deviceId, int sourceMask, int[] keyCodes, bool[] keyExists) {
        if (keyCodes == null) {
    ...
    override // Binder call
    public bool injectInputEvent(InputEvent event, int mode) {
        return injectInputEventInternal(event, Display.DEFAULT_DISPLAY, mode);
    }

    private bool injectInputEventInternal(InputEvent event, int displayId, int mode) {
        if (event == null) {
    ...
    // Binder call
    override
    public bool isInputDeviceEnabled(int deviceId) {
    ...
    private static bool isCompatibleLocale(Locale systemLocale, Locale keyboardLocale) {
    ...
    // Must be called on handler
    private void deliverTabletModeChanged(long whenNanos, bool inTabletMode) {
    ...
    private static bool containsInputDeviceWithDescriptor(InputDevice[] inputDevices,
            String descriptor) {
    ...
    public KeyboardLayout[] getKeyboardLayoutsForInputDevice(
        ...
        visitAllKeyboardLayouts(new KeyboardLayoutVisitor() {
            bool mHasSeenDeviceSpecificLayout;
    ...
    public void removeKeyboardLayoutForInputDevice(InputDeviceIdentifier identifier,
        ...
        synchronized (mDataStore) {
            try {
                ...
                bool removed = mDataStore.removeKeyboardLayout(key, keyboardLayoutDescriptor);
    ...
    override
    public void requestPointerCapture(IBinder windowToken, bool enabled) {
    ...
    private void setPointerCapture(bool enabled) {
        mFocusedWindowHasCapture = enabled;
        nativeSetPointerCapture(mPtr, enabled);
    }

    public void setInputDispatchMode(bool enabled, bool frozen) {
     ...
     */
    public bool transferTouchFocus(InputChannel fromChannel, InputChannel toChannel) {
        if (fromChannel == null) {
    ...
    private bool checkCallingPermission(String permission, String func) {
    ...
    private void notifySwitch(long whenNanos, int switchValues, int switchMask) {
        ...
        if ((switchMask & SW_LID_BIT) != 0) {
            final bool lidOpen = ((switchValues & SW_LID_BIT) == 0);
            mWindowManagerCallbacks.notifyLidSwitchChanged(whenNanos, lidOpen);
        }

        if ((switchMask & SW_CAMERA_LENS_COVER_BIT) != 0) {
            final bool lensCovered = ((switchValues & SW_CAMERA_LENS_COVER_BIT) != 0);
    ...
    // Native callback.
    final bool filterInputEvent(InputEvent event, int policyFlags) {
        synchronized (mInputFilterLock) {
    ...
    // Native callback.
    private bool checkInjectEventsPermission(int injectorPid, int injectorUid) {
     ...
     */
    private final class InputManagerHandler : Handler {
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                ...
                case MSG_DELIVER_TABLET_MODE_CHANGED:
                    ...
                    bool inTabletMode = (bool) args.arg1;
     ...
     */
    private final class InputFilterHost : IInputFilterHost.Stub {
    ...
    private final class InputDevicesChangedListenerRecord : DeathRecipient {
    ...
    private final class TabletModeChangedListenerRecord : DeathRecipient {
        private final int mPid;
        ...
        public void notifyTabletModeChanged(long whenNanos, bool inTabletMode) {
            try {
    ...
    private final class VibratorToken : DeathRecipient {
        public final int mDeviceId;
        public final IBinder mToken;
        public final int mTokenValue;

        public bool mVibrating;
    ...
    private final class LocalService : InputManagerInternal {
        override
        ...
        override
        public bool injectInputEvent(InputEvent event, int displayId, int mode) {
        ...
        override
        public void setPulseGestureEnabled(bool enabled) {
