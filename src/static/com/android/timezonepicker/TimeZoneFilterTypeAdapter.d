...
public class TimeZoneFilterTypeAdapter : BaseAdapter : Filterable, OnClickListener {
    ...
    private class ArrayFilter : Filter {
        ...
        protected FilterResults performFiltering(CharSequence prefix) {
            ...
            if (num != Integer.MIN_VALUE) {
                bool positiveOnly = prefixString.length() > startParsePosition
         ...
         * @return
         */
        private bool isStartingInitialsFor(String prefixString, String string) {
            final int initialLen = prefixString.length();
            final int strLen = string.length();

            int initialIdx = 0;
            bool wasWordBreak = true;
