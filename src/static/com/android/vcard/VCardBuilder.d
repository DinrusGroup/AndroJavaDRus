...
public class VCardBuilder {
    ...
    private final bool mIsV30OrV40;
    private final bool mIsJapaneseMobilePhone;
    private final bool mOnlyOneNoteFieldIsAvailable;
    private final bool mIsDoCoMo;
    private final bool mShouldUseQuotedPrintable;
    private final bool mUsesAndroidProperty;
    private final bool mUsesDefactProperty;
    private final bool mAppendTypeParamName;
    private final bool mRefrainsQPToNameProperties;
    private final bool mNeedsToConvertPhoneticString;

    private final bool mShouldAppendCharsetParam;

    private final String mCharset;
    private final String mVCardCharsetParameter;

    private StringBuilder mBuilder;
    private bool mEndAppended;
    ...
    private bool containsNonEmptyName(final ContentValues contentValues) {
    ...
    public VCardBuilder appendNameProperties(final List<ContentValues> contentValuesList) {
        ...
        if (!TextUtils.isEmpty(familyName) || !TextUtils.isEmpty(givenName)) {
            final bool reallyAppendCharsetParameterToName =
                    shouldAppendCharsetParam(familyName, givenName, middleName, prefix, suffix);
            final bool reallyUseQuotedPrintableToName =
            ...
            final bool reallyAppendCharsetParameterToFN =
                    shouldAppendCharsetParam(formattedName);
            final bool reallyUseQuotedPrintableToFN =
                    !mRefrainsQPToNameProperties &&
    ...
    private void buildSinglePartNameField(String property, String part) {
        final bool reallyUseQuotedPrintable =
                (!mRefrainsQPToNameProperties &&
    ...
    public VCardBuilder appendPhones(final List<ContentValues> contentValuesList,
        ...
        if (contentValuesList != null) {
            ...
            for (ContentValues contentValues : contentValuesList) {
                ...
                final bool isPrimary = (isPrimaryAsInteger != null ?
    ...
    private static class PostalStruct {
        final bool reallyUseQuotedPrintable;
        final bool appendCharset;
        final String addressData;
        public PostalStruct(final bool reallyUseQuotedPrintable,
                final bool appendCharset, final String addressData) {
    ...
    public VCardBuilder appendNotes(final List<ContentValues> contentValuesList) {
        if (contentValuesList != null) {
            if (mOnlyOneNoteFieldIsAvailable) {
                ...
                final bool shouldAppendCharsetInfo =
        ...
        if (contentValuesList != null) {
            ...
            for (final ContentValues contentValues : contentValuesList) {
                ...
                if (eventType == Event.TYPE_BIRTHDAY) {
                    ...
                    final bool isSuperPrimary = (isSuperPrimaryAsInteger != null ?
    ...
    public void appendPostalLine(final int type, final String label,
            final ContentValues contentValues,
            final bool isPrimary, final bool emitEveryTime) {
        final bool reallyUseQuotedPrintable;
        final bool appendCharset;
    ...
    public void appendEmailLine(final int type, final String label,
            final String rawValue, final bool isPrimary) {
        final String typeAsString;
        switch (type) {
    ...
    public void appendTelLine(final Integer typeAsInteger, final String label,
            final String encodedValue, bool isPrimary) {
    ...
    public void appendLine(final String propertyName,
            final String rawValue, final bool needCharset,
            bool reallyUseQuotedPrintable) {
    ...
    public void appendLine(final String propertyName, final List<String> rawValueList,
            final bool needCharset, bool needQuotedPrintable) {
        appendLine(propertyName, null, rawValueList, needCharset, needQuotedPrintable);
    }

    public void appendLine(final String propertyName, final List<String> parameterList,
            final List<String> rawValueList, final bool needCharset,
            final bool needQuotedPrintable) {
        mBuilder.append(propertyName);
        if (parameterList != null && parameterList.size() > 0) {
            mBuilder.append(VCARD_PARAM_SEPARATOR);
            appendTypeParameters(parameterList);
     ...
     */
    private bool shouldAppendCharsetParam(String...propertyValueList) {
