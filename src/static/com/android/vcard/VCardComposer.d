...
public class VCardComposer {
     ...
     * vCard is emitted.
     */
    private bool mFirstVCardEmittedInDoCoMoCase;

    private Cursor mCursor;
    private bool mCursorSuppliedFromOutside;
     ...
     */
    private bool mTerminateCalled = true;
    ...
    public VCardComposer(final Context context, ContentResolver resolver,
            final int vcardType, String charset, final bool careHandlerErrors) {
        // Not used right now
        // mContext = context;
        ...
        final bool shouldAppendCharsetParam = !(
     ...
     */
    @Deprecated
    public bool initWithRawContactsEntityUri(Uri contentUriForRawContactsEntity) {
     ...
     * arguments.
     */
    public bool init(final String selection, final String[] selectionArgs) {
     ...
     */
    public bool init(final Uri contentUri, final String selection,
     ...
     * @hide
     */
    public bool init(final Uri contentUri, final String[] projection,
     ...
     * @hide
     */
    public bool init(Cursor cursor) {
    ...
    * @return true when successful
    */
    public bool initWithCallback(Cursor cursor,
    ...
    private bool initInterFirstPart(Uri contentUriForRawContactsEntity) {
    ...
    private bool initInterCursorCreationPart(
    ...
    private bool initInterMainPart() {
    ...
    private bool initInterLastPart() {
        mInitDone = true;
