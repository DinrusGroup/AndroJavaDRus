...
public class VCardUtils {
     ...
     */
    private static class DecoderException : Exception {
    ...
    public static class TextUtilsPort {
        public static bool isPrintableAscii(final char c) {
            final int asciiFirst = 0x20;
            final int asciiLast = 0x7E;  // included
            return (asciiFirst <= c && c <= asciiLast) || c == '\r' || c == '\n';
        }

        public static bool isPrintableAsciiOnly(final CharSequence str) {
    ...
    public static bool isMobilePhoneLabel(final String label) {
    ...
    public static bool isValidInV21ButUnknownToContactsPhoteType(final String label) {
    ...
    public static bool containsOnlyPrintableAscii(final String...values) {
        if (values == null) {
            return true;
        }
    ...
    public static bool containsOnlyPrintableAscii(final Collection<String> values) {
        if (values == null) {
            return true;
        }
     ...
     * </p>
     */
    public static bool containsOnlyNonCrLfPrintableAscii(final String...values) {
        if (values == null) {
            return true;
        }
    ...
    public static bool containsOnlyNonCrLfPrintableAscii(final Collection<String> values) {
        if (values == null) {
            return true;
        }
        final int asciiFirst = 0x20;
     ...
     * </p>
     */
    public static bool containsOnlyAlphaDigitHyphen(final String...values) {
        if (values == null) {
            return true;
        }
    ...
    public static bool containsOnlyAlphaDigitHyphen(final Collection<String> values) {
        if (values == null) {
            return true;
        }
    ...
    public static bool containsOnlyWhiteSpaces(final String...values) {
        if (values == null) {
            return true;
        }
    ...
    public static bool containsOnlyWhiteSpaces(final Collection<String> values) {
        if (values == null) {
            return true;
        }
        for (final String str : values) {
     ...
     * </p>
     */
    public static bool isV21Word(final String value) {
        if (TextUtils.isEmpty(value)) {
            return true;
        }
        final int asciiFirst = 0x20;
    ...
    public static String guessImageType(final byte[] input) {
        ...
        if (input.length >= 3 && input[0] == 'G' && input[1] == 'I' && input[2] == 'F') {
            return "GIF";
        } else if (input.length >= 4 && input[0] == cast(byte) 0x89
            ...
            return "PNG";
        } else if (input.length >= 2 && input[0] == cast(byte) 0xff
                && input[1] == cast(byte) 0xd8) {
            return "JPEG";
        } else {
            return null;
        }
     ...
     */
    public static bool areAllEmpty(final String...values) {
        if (values == null) {
            return true;
        }
     ...
     */
    public static bool appearsLikeAndroidVCardQuotedPrintable(String value) {
    ...
    public static String parseQuotedPrintable(
            final String value, bool strictLineBreaking,
    ...
    // TODO: utilities for vCard 4.0: datetime, timestamp, integer, float, and bool
