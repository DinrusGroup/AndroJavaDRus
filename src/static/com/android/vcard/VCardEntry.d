...
public class VCardEntry {
    ...
    // FN;PREF=2:John Doe
    // FN;PREF=3;John
    public static class NameData : EntryElement {
        ...
        public bool emptyStructuredName() {
        ...
        public bool emptyPhoneticStructuredName() {
        ...
        public void constructInsertOperation(List<ContentProviderOperation> operationList,
            ...
            bool phoneticNameSpecified = false;
    ...
    public static class PhoneData : EntryElement {
        ...
        public PhoneData(String data, int type, String label, bool isPrimary) {
            mNumber = data;
            mType = type;
            mLabel = label;
    ...
    public static class EmailData : EntryElement {
        private final String mAddress;
        private final int mType;
        // Used only when TYPE is TYPE_CUSTOM.
        private final String mLabel;
        private final bool mIsPrimary;

        public EmailData(String data, int type, String label, bool isPrimary) {
            mType = type;
            mAddress = data;
            mLabel = label;
            mIsPrimary = isPrimary;
    ...
    public static class PostalData : EntryElement {
        ...
        public static PostalData constructPostalData(final List<String> propValueList,
                final int type, final String label, bool isPrimary, int vcardType) {
    ...
    public static class OrganizationData : EntryElement {
    ...
    public static class ImData : EntryElement {
        private final String mAddress;
        ...
        public ImData(final int protocol, final String customProtocol, final String address,
                final int type, final bool isPrimary) {
            mProtocol = protocol;
    ...
    public static class PhotoData : EntryElement {
        ...
        public PhotoData(String format, byte[] photoBytes, bool isPrimary) {
            mFormat = format;
            mBytes = photoBytes;
            mIsPrimary = isPrimary;
        }
    ...
    public static class NicknameData : EntryElement {
    ...
    public static class NoteData : EntryElement {
    ...
    public static class WebsiteData : EntryElement {
    ...
    public static class BirthdayData : EntryElement {
    ...
    public static class AnniversaryData : EntryElement {
    ...
    public static class SipData : EntryElement {
        /**
        ...
        public SipData(String rawSip, int type, String label, bool isPrimary) {
     ...
     */
    public static class AndroidCustomData : EntryElement {
    ...
    public interface EntryElementIterator {
         ...
         *         False otherwise.
         */
        public bool onElement(EntryElement elem);
    }
    ...
    private void iterateOneList(List<? : EntryElement> elemList,
    ...
    private class IsIgnorableIterator : EntryElementIterator {
        private bool mEmpty = true;
    ...
    private class ToStringIterator : EntryElementIterator {
        private StringBuilder mBuilder;

        private bool mFirstElement;
    ...
    private class InsertOperationConstrutor : EntryElementIterator {
    ...
    private void addPhone(int type, String data, String label, bool isPrimary) {
        if (mPhoneList == null) {
    ...
    private void addSip(String sipData, int type, String label, bool isPrimary) {
        if (mSipList == null) {
    ...
    private void addEmail(int type, String data, String label, bool isPrimary) {
        if (mEmailList == null) {
    ...
    private void addPostal(int type, List<String> propValueList, String label, bool isPrimary) {
        if (mPostalList == null) {
    ...
    /**
     * Should be called via {@link #handleOrgValue(int, List, Map, bool)} or
     * {@link #handleTitleValue(String)}.
     */
    private void addNewOrganization(final String organizationName, final String departmentName,
            final String titleName, final String phoneticName, int type, final bool isPrimary) {
    ...
    private void handleOrgValue(final int type, List<String> orgList,
            Map<String, Collection<String>> paramMap, bool isPrimary) {
    ...
    private void addPhotoBytes(String formatName, byte[] photoBytes, bool isPrimary) {
        if (mPhotoList == null) {
