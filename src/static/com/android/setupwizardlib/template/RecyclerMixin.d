 ...
 */
public class RecyclerMixin : Mixin {
     ...
     * should be called when {@link View#onLayout(bool, int, int, int, int)} of the template
     * is called.
     */
    ...
    public Adapter<? : ViewHolder> getAdapter() {
        ...
        final RecyclerView.Adapter<? : ViewHolder> adapter = mRecyclerView.getAdapter();
        if (adapter instanceof HeaderAdapter) {
            return ((HeaderAdapter<? : ViewHolder>) adapter).getWrappedAdapter();
        }
        return adapter;
    }
