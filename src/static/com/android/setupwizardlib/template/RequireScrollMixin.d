 ...
 */
public class RequireScrollMixin : Mixin {
    ...
    public interface OnRequireScrollStateChangedListener {
         ...
         */
        void onRequireScrollStateChanged(bool scrollNeeded);
    }
     ...
     * {@link #notifyScrollabilityChange(bool)} when the view scrollability is changed.
     */
    ...
    private bool mRequiringScrollToBottom = false;

    // Whether the user have seen the more button yet.
    private bool mEverScrolledToBottom = false;
     ...
     * {@link OnRequireScrollStateChangedListener#onRequireScrollStateChanged(bool)} is called
    ...
    public void requireScrollWithNavigationBar(@NonNull final NavigationBar navigationBar) {
        setOnRequireScrollStateChangedListener(
                new OnRequireScrollStateChangedListener() {
                    override
                    public void onRequireScrollStateChanged(bool scrollNeeded) {
     ...
     */
    void notifyScrollabilityChange(bool canScrollDown) {
    ...
    private void postScrollStateChange(final bool scrollNeeded) {
