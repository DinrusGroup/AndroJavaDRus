...
public class LinkSpan : ClickableSpan {
     ...
     * : this interface, this will be invoked when the link is clicked.
     */
    public interface OnLinkClickListener {
         ...
         */
        bool onLinkClick(LinkSpan span);
    }
    ...
    private bool dispatchClick(View view) {
        bool handled = false;
    ...
    private OnClickListener getLegacyListenerFromContext(@Nullable Context context) {
        while (true) {
            if (context instanceof OnClickListener) {
                ...
                // Unwrap any context wrapper, in base the base context : onClickListener.
