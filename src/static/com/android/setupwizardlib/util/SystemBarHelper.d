...
public class SystemBarHelper {
    ...
    public static void hideSystemBars(final Dialog dialog) {
        if (VERSION.SDK_INT >= VERSION_CODES.LOLLIPOP) {
            ...
            // doesn't work if android.R.bool.config_enableTranslucentDecor is false.
    ...
    public static void setBackButtonVisible(final Window window, final bool visible) {
        if (VERSION.SDK_INT >= VERSION_CODES.HONEYCOMB) {
            if (visible) {
    ...
    private static class WindowInsetsListener : View.OnApplyWindowInsetsListener {
        private int mBottomOffset;
        private bool mHasCalculatedBottomOffset = false;
