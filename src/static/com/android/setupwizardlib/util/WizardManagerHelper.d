...
public class WizardManagerHelper {
     ...
     */
    public static bool isSetupWizardIntent(Intent intent) {
     ...
     */
    public static bool isUserSetupComplete(Context context) {
     ...
     */
    public static bool isDeviceProvisioned(Context context) {
        if (VERSION.SDK_INT >= VERSION_CODES.JELLY_BEAN_MR1) {
     ...
     */
    public static bool isDeferredSetupWizard(Intent originalIntent) {
     ...
     */
    public static bool isPreDeferredSetupWizard(Intent originalIntent) {
        return originalIntent != null
     ...
     */
    public static bool isLightTheme(Intent intent, bool def) {
     ...
     */
    public static bool isLightTheme(String theme, bool def) {
     ...
     * your activity and call {@link Theme#applyStyle(int, bool)} using your theme overlay.
     *
     * <pre>{@code
     * protected void onApplyThemeResource(Theme theme, int resid, bool first) {
