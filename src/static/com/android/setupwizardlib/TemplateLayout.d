 ...
 * are required.
 */
public class TemplateLayout : FrameLayout {
    ...
    private Map<Class<? : Mixin>, Mixin> mMixins = new HashMap<>();
     ...
     */
    protected <M : Mixin> void registerMixin(Class<M> cls, M mixin) {
    ...
    public <T : View> T findManagedViewById(int id) {
    ...
    public <M : Mixin> M getMixin(Class<M> cls) {
