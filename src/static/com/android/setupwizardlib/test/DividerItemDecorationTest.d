...
public class DividerItemDecorationTest {
    ...
    private Bitmap drawDecoration(DividerItemDecoration decoration, final bool allowDividerAbove,
            final bool allowDividerBelow) {
    ...
    private static class ViewHolder : RecyclerView.ViewHolder
            : DividerItemDecoration.DividedViewHolder {

        private bool mAllowDividerAbove;
        private bool mAllowDividerBelow;

        public static ViewHolder createInstance(View itemView, bool allowDividerAbove,
                bool allowDividerBelow) {
            return new ViewHolder(itemView, allowDividerAbove, allowDividerBelow);
        }

        private ViewHolder(View itemView, bool allowDividerAbove, bool allowDividerBelow) {
            super(itemView);
        ...
        override
        public bool isDividerAllowedAbove() {
            return mAllowDividerAbove;
        }

        override
        public bool isDividerAllowedBelow() {
