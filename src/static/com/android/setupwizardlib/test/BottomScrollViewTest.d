...
public class BottomScrollViewTest {
    ...
    private static class TestChildView : View {
    ...
    private static class TestBottomScrollView : BottomScrollView {
    ...
    private static class TestBottomScrollListener : BottomScrollView.BottomScrollListener {

        bool mScrolledToBottom = true;
