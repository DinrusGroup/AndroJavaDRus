...
public interface TouchableMovementMethod {
    ...
    class TouchableLinkMovementMethod : LinkMovementMethod
        ...
        bool mLastEventResult = false;
        MotionEvent mLastEvent;

        override
        public bool onTouchEvent(TextView widget, Spannable buffer, MotionEvent event) {
            mLastEvent = event;
            bool result = super.onTouchEvent(widget, buffer, event);
            if (event.getAction() == MotionEvent.ACTION_DOWN) {
                // Unfortunately, LinkMovementMethod : ScrollMovementMethod, and it always
        ...
        override
        public bool isLastTouchEventHandled() {
