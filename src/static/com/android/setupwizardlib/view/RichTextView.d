 ...
 */
public class RichTextView : TextView : OnLinkClickListener {
    ...
    private bool hasLinks(CharSequence text) {
        if (text instanceof Spanned) {
    ...
    public bool onTouchEvent(MotionEvent event) {
        ...
        // method, if it : TouchableMovementMethod, to say that the touch is not handled,
    ...
    override
    public bool onLinkClick(LinkSpan span) {
