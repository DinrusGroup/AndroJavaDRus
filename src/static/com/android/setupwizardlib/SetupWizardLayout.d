...
public class SetupWizardLayout : TemplateLayout {
    ...
    protected void onRestoreInstanceState(Parcelable state) {
        ...
        final bool isProgressBarShown = ss.mIsProgressBarShown;
     ...
     */
    public void setProgressBarShown(bool shown) {
        getMixin(ProgressBarMixin.class).setShown(shown);
    }

    /**
     * @deprecated Use {@link #setProgressBarShown(bool)}
     */
    @Deprecated
    ...
    protected static class SavedState : BaseSavedState {

        bool mIsProgressBarShown = false;
