 ...
 */
class AndroidCameraAgentImpl : CameraAgent {
    ...
    private static class AndroidCameraDeviceInfo : CameraDeviceInfo {
        ...
        private static class AndroidCharacteristics : Characteristics {
     ...
     */
    private class CameraHandler : HistoryHandler : Camera.ErrorCallback {
        ...
        private void enableShutterSound(bool enable) {
    ...
    /**
     * A class which : {@link CameraAgent.CameraProxy} and
     * camera handler thread.
     */
    private class AndroidCameraProxyImpl : CameraAgent.CameraProxy {
        ...
        public void autoFocus(final Handler handler, final CameraAFCallback cb) {
            final AutoFocusCallback afCallback = new AutoFocusCallback() {
                override
                public void onAutoFocus(final bool b, Camera camera) {
    ...
    private static class AndroidCameraStateHolder : CameraStateHolder {
        /* Camera states */
     ...
     */
    private static class AFCallbackForward : AutoFocusCallback {
    ...
    @TargetApi(Build.VERSION_CODES.JELLY_BEAN)
    private static class AFMoveCallbackForward : AutoFocusMoveCallback {
        private final Handler mHandler;
        ...
        public void onAutoFocusMoving(
                final bool moving, android.hardware.Camera camera) {
            mHandler.post(new Runnable() {
                override
                public void run() {
     ...
     */
    private static class ShutterCallbackForward : ShutterCallback {
        private final Handler mHandler;
     ...
     */
    private static class PictureCallbackForward : PictureCallback {
        private final Handler mHandler;
     ...
     */
    private static class PreviewCallbackForward : PreviewCallback {
        private final Handler mHandler;
    ...
    private static class FaceDetectionCallbackForward : FaceDetectionListener {
        private final Handler mHandler;
