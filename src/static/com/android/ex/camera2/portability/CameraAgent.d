...
public abstract class CameraAgent {
     ...
     */
    public static class CameraOpenCallbackForward : CameraOpenCallback {
        private final Handler mHandler;
    ...
    public static interface CameraAFCallback {
        public void onAutoFocus(bool focused, CameraProxy camera);
    }
    ...
    public static interface CameraAFMoveCallback {
        public void onAutoFocusMoving(bool moving, CameraProxy camera);
    }
     ...
     */
    public void closeCamera(CameraProxy camera, bool synced) {
        try {
            if (synced) {
    ...
    public abstract static class CameraProxy {
         ...
         */
        public void setDisplayOrientation(final int degrees, final bool capture) {
            try {
                getDispatchThread().runJob(new Runnable() {
                    override
                    public void run() {
         ...
         */
        protected bool applySettingsHelper(CameraSettings settings,
         ...
         * @return Whether the settings can be applied.
         */
        public abstract bool applySettings(CameraSettings settings);
         ...
         */
        public void enableShutterSound(final bool enable) {
            try {
                getDispatchThread().runJob(new Runnable() {
                    override
                    public void run() {
