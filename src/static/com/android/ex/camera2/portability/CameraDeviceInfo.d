...
public interface CameraDeviceInfo {
    ...
    public abstract class Characteristics {
         ...
         */
        public abstract bool isFacingBack();

        /**
         * @return Whether the camera faces the device's screen.
         */
        public abstract bool isFacingFront();
         ...
         */
        public abstract bool canDisableShutterSound();

        protected static bool orientationIsValid(int angle) {
            if (angle % 90 != 0) {
