...
public abstract class CameraStateHolder {
     ...
     */
    public synchronized bool isInvalid() {
        return mInvalid;
    }
     ...
     *         reached.
     */
    private bool waitForCondition(ConditionChecker stateChecker,
            long timeoutMs) {
     ...
     *         reached.
     */
    public bool waitForStates(final int states) {
     ...
     *         reached.
     */
    public bool waitToAvoidStates(final int states) {
