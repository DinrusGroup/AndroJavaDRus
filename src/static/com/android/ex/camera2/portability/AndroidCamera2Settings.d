 ...
 */
public class AndroidCamera2Settings : CameraSettings {
    ...
    public AndroidCamera2Settings(CameraDevice camera, int template, Rect activeArray,
        ...
        setPhotoSize(photo);
        mJpegCompressQuality = queryTemplateDefaultOrMakeOneUp(JPEG_QUALITY, cast(byte) 0);
    ...
    private <T> T queryTemplateDefaultOrMakeOneUp(Key<T> key, T defaultDefault) {
        ...
        if (val != null) {
            ...
            // This approach beats a simple sentinel because it provides basic bool support.
    ...
    private bool matchesTemplateDefault(Key!(T) setting) {
