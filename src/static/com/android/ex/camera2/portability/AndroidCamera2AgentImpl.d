 ...
 */
class AndroidCamera2AgentImpl : CameraAgent {
     ...
     */
    private bool updateCameraDevices() {
        try {
    ...
    private class Camera2Handler : HistoryHandler {
                ...
                switch (cameraAction) {
                    ...
                    case CameraActions.AUTO_FOCUS: {
                        ...
                        CameraCaptureSession.CaptureCallback deferredCallbackSetter =
                            ...
                            private bool mAlreadyDispatched = false;
            ...
            public void monitorControlStates(CaptureResult result) {
                ...
                if (afStateMaybe != null) {
                    ...
                    if (result.getFrameNumber() > mLastAfFrameNumber) {
                        bool afStateChanged = afState != mLastAfState;
    ...
    private class AndroidCamera2ProxyImpl : CameraAgent.CameraProxy {
        ...
        private bool mShutterSoundEnabled;
                    ...
                    public void run() {
                        ...
                        if (cb != null) {
                            cbForward = new CameraAFCallback() {
                                override
                                public void onAutoFocus(final bool focused,
                    ...
                    public void run() {
                        ...
                        if (cb != null) {
                            cbForward = new CameraAFMoveCallback() {
                                override
                                public void onAutoFocusMoving(final bool moving,
                                                              final CameraProxy camera) {
                                    handler.post(new Runnable() {
                                        override
                                        public void run() {
        ...
        override
        public void enableShutterSound(bool enable) {
    ...
    private static class AndroidCamera2StateHolder : CameraStateHolder {
    ...
    private static class AndroidCamera2DeviceInfo : CameraDeviceInfo {
        private final CameraManager mCameraManager;
        ...
        private static class AndroidCharacteristics2 : Characteristics {
