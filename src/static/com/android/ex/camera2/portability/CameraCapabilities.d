...
public class CameraCapabilities {
     ...
     */
    public final bool supports(SceneMode scene) {
        return (scene != null && mSupportedSceneModes.contains(scene));
    }

    public bool supports(final CameraSettings settings) {
     ...
     */
    public final bool supports(FlashMode flash) {
     ...
     */
    public final bool supports(FocusMode focus) {
     ...
     */
    public bool supports(WhiteBalance wb) {
    ...
    public bool supports(Feature ft) {
    ...
    private bool zoomCheck(final CameraSettings settings) {
    ...
    private bool exposureCheck(final CameraSettings settings) {
    ...
    private bool focusCheck(final CameraSettings settings) {
    ...
    private bool flashCheck(final CameraSettings settings) {
    ...
    private bool photoSizeCheck(final CameraSettings settings) {
    ...
    private bool previewSizeCheck(final CameraSettings settings) {
    ...
    private bool videoStabilizationCheck(final CameraSettings settings) {
