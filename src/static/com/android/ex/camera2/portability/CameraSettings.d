...
public abstract class CameraSettings {
    ...
    protected bool mVideoStabilizationEnabled;
    protected bool mAutoExposureLocked;
    protected bool mAutoWhiteBalanceLocked;
    protected bool mRecordingHintEnabled;
     ...
     * @see #setPreviewSize
     */
    /*package*/ void setSizesLocked(bool locked) {
        mSizesLocked = locked;
    }
     ...
     */
    public bool setPreviewSize(Size previewSize) {
        if (mSizesLocked) {
     ...
     * @return Whether the operation was allowed (i.e. the sizes are unlocked).
     */
    public bool setPhotoSize(Size photoSize) {
        if (mSizesLocked) {
    ...
    public void setPhotoJpegCompressionQuality(int quality) {
        ...
        mJpegCompressQuality = cast(byte) quality;
    }
    ...
    public void setAutoExposureLock(bool locked) {
        mAutoExposureLocked = locked;
    }

    public bool isAutoExposureLocked() {
    ...
    public void setAutoWhiteBalanceLock(bool locked) {
        mAutoWhiteBalanceLocked = locked;
    }

    public bool isAutoWhiteBalanceLocked() {
    ...
    public bool isVideoStabilizationEnabled() {
        return mVideoStabilizationEnabled;
    }

    public void setRecordingHintEnabled(bool hintEnabled) {
        mRecordingHintEnabled = hintEnabled;
    }

    public bool isRecordingHintEnabled() {
