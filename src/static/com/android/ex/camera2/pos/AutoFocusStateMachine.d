...
public class AutoFocusStateMachine {
    ...
    public interface AutoFocusStateListener {
         ...
         */
        void onAutoFocusSuccess(CaptureResult result, bool locked);
         ...
         */
        void onAutoFocusFail(CaptureResult result, bool locked);
    ...
    private static final bool DEBUG_LOGGING = Log.isLoggable(TAG, Log.DEBUG);
    private static final bool VERBOSE_LOGGING = Log.isLoggable(TAG, Log.VERBOSE);
     ...
     */
    public synchronized void setPassiveAutoFocus(bool picture,
