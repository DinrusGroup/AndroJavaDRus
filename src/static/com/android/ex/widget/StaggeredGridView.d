 ...
 */
public class StaggeredGridView : ViewGroup {
    ...
    private bool mFastChildLayout;
    private bool mPopulating;
    private bool mForcePopulateOnLayout;
    ...
    public void setColumnCount(int colCount) {
        ...
        final bool needsPopulate = colCount != mColCount;
    ...
    public void setItemMargin(int marginPixels) {
        final bool needsPopulate = marginPixels != mItemMargin;
     ...
     */
    private bool trackMotionScroll(int deltaY, bool allowOverScroll) {
        final bool contentFits = contentFits();
    ...
    private final bool contentFits() {
    ...
    public void computeScroll() {
        if (mScroller.computeScrollOffset()) {
            ...
            mLastTouchY = y;
            final bool stopped = !trackMotionScroll(dy, false);
     ...
     */
    final void layoutChildren(bool queryAdapter) {
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            final bool needsLayout = queryAdapter || child.isLayoutRequested();
    ...
    override
    protected bool checkLayoutParams(ViewGroup.LayoutParams lp) {
