...
public class Intents {
    ...
    public static PhotoViewIntentBuilder newPhotoViewIntentBuilder(
            Context context, Class<? : Activity> cls) {
    ...
    public static class PhotoViewIntentBuilder {
        ...
        private bool mActionBarHiddenInitially;
        private bool mDisplayFullScreenThumbs;

        private PhotoViewIntentBuilder(Context context, Class!(T) cls) {
        ...
        public PhotoViewIntentBuilder setEnableTimerLightsOut(bool enable) {
