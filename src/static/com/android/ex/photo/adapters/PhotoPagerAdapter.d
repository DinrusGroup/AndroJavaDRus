 ...
 */
public class PhotoPagerAdapter : BaseCursorPagerAdapter {
    ...
    public PhotoPagerAdapter(
            ...
            float maxScale, bool thumbsFullScreen) {
        super(context, fm, c);
        mMaxScale = maxScale;
    ...
    public Fragment getItem(Context context, Cursor cursor, int position) {
        ...
        bool loading = shouldShowLoadingIndicator(cursor);
        bool onlyShowSpinner = false;
    ...
    protected Class<? : PhotoViewFragment> getPhotoViewFragmentClass() {
    ...
    public bool shouldShowLoadingIndicator(Cursor cursor) {
