 ...
 * Displays a photo.
 */
public class PhotoViewFragment : Fragment :
    ...
    public static PhotoViewFragment newInstance(
            Intent intent, int position, bool onlyShowSpinner) {
    ...
    public static void initializeArguments(
            Intent intent, int position, bool onlyShowSpinner, PhotoViewFragment f) {
    ...
    override
    public bool onInterceptMoveLeft(float origX, float origY) {
        if (!mCallback.isFragmentActive(this)) {
    ...
    override
    public bool onInterceptMoveRight(float origX, float origY) {
        if (!mCallback.isFragmentActive(this)) {
            // we're not in the foreground; don't intercept any touches
            return false;
        }
    ...
    private void setViewVisibility() {
        final bool fullScreen = mCallback == null ? false : mCallback.isFragmentFullScreen(this);
    ...
    public bool isProgressBarNeeded() {
        return mProgressBarNeeded;
    }

    private class InternetStateBroadcastReceiver : BroadcastReceiver {
