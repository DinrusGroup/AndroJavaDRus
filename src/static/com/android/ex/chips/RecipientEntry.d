...
public class RecipientEntry {
    ...
    private final bool mShouldDisplayIcon;
    ...
    protected RecipientEntry(int entryType, String displayName, String destination,
        ...
        long dataId, Uri photoThumbnailUri, bool isFirstLevel, bool isValid,
    ...
    protected RecipientEntry(int entryType, String displayName, String destination,
            int destinationType, String destinationLabel, long contactId, Long directoryId,
            long dataId, Uri photoThumbnailUri, bool shouldDisplayIcon,
            bool isFirstLevel, bool isValid, String lookupKey, String[] permissions) {
     ...
     */
    public static bool isCreatedRecipient(long id) {
     ...
     */
    public static RecipientEntry constructFakeEntry(final String address, final bool isValid) {
    ...
    public static RecipientEntry constructTopLevelEntry(String displayName, int displayNameSource,
            ...
            Long directoryId, long dataId, Uri photoThumbnailUri, bool isValid,
            String lookupKey) {
    ...
    public static RecipientEntry constructTopLevelEntry(String displayName, int displayNameSource,
            String destination, int destinationType, String destinationLabel, long contactId,
            Long directoryId, long dataId, String thumbnailUriAsString, bool isValid,
            String lookupKey) {
        return new RecipientEntry(ENTRY_TYPE_PERSON, pickDisplayName(displayNameSource,
                displayName, destination), destination, destinationType, destinationLabel,
    ...
    public static RecipientEntry constructSecondLevelEntry(String displayName,
            ...
            String thumbnailUriAsString, bool isValid, String lookupKey) {
        return new RecipientEntry(ENTRY_TYPE_PERSON, pickDisplayName(displayNameSource,
                displayName, destination), destination, destinationType, destinationLabel,
                contactId, directoryId, dataId, (thumbnailUriAsString != null
     ...
     */
    public bool isSamePerson(final RecipientEntry entry) {
     ...
     */
    public void setInReplacedChip(bool inReplacedChip) {
