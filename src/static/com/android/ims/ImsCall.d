...
public class ImsCall : ICall {
    ...
    private static final bool FORCE_DEBUG = false; /* STOPSHIP if true */
    ...
    private static final bool DBG = FORCE_DEBUG || Log.isLoggable(TAG, Log.DEBUG);
    private static final bool VDBG = FORCE_DEBUG || Log.isLoggable(TAG, Log.VERBOSE);
    ...
    private static final bool CONF_DBG = true;
    ...
    public static class Listener {
         ...
         */
        public void onCallMerged(ImsCall call, ImsCall peerCall, bool swapCalls) {
            onCallStateChanged(call);
        }
    ...
    private bool mMergeRequestedByConference = false;
    ...
    private bool mSessionEndDuringMerge = false;
    ...
    // successfully added.
    private bool mCallSessionMergePending = false;
     ...
     */
    private bool mTerminationRequestPending = false;
     ...
     * device.
     */
    private bool mIsConferenceHost = false;
     ...
     */
    private bool mWasVideoCall = false;
     ...
     */
    private bool mAnswerWithRtt = false;
     ...
     */
    override
    public bool checkIfRemoteUserIsSame(String userId) {
        if (userId == null) {
            return false;
        }
     ...
     */
    override
    public bool equalsTo(ICall call) {
        if (call == null) {
            return false;
        }
    ...
    public static bool isSessionAlive(ImsCallSession session) {
     ...
     */
    public void setListener(ImsCall.Listener listener, bool callbackImmediately) {
        bool inCall;
        bool onHold;
        int state;
     ...
     */
    public void setMute(bool muted) throws ImsException {
        synchronized(mLockObj) {
            if (mMute != muted) {
     ...
     */
    public void sendRttModifyResponse(bool status) {
     ...
     */
    private bool isTransientConferenceSession(ImsCallSession session) {
    ...
    private void markCallAsMerged(bool playDisconnectTone) {
     ...
     */
    public bool isMergeRequestedByConf() {
        synchronized(mLockObj) {
     ...
     */
    public void resetIsMergeRequestedByConf(bool value) {
        synchronized(mLockObj) {
   ...
   /**
    ...
    @VisibleForTesting
    public class ImsCallSessionListenerProxy : ImsCallSession.Listener {
        override
         ...
         */
        private bool doesCallSessionExistsInMerge(ImsCallSession cs) {
     ...
     */
    public bool isCallSessionMergePending() {
     ...
     *      {@code false} otherwise.
     */
    private void setCallSessionMergePending(bool callSessionMergePending) {
     ...
     */
    private bool shouldProcessConferenceResult() {
