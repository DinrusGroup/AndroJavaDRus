...
/**
 * A container of the IImsServiceController binder, which : all of the ImsFeatures that
...
public class MmTelFeatureConnection {
    ...
    private volatile bool mIsAvailable = false;
    ...
    private bool mSupportsEmergencyCalling = false;
    ...
    private abstract class CallbackAdapterManager<T> {
        ...
        private bool mHasConnected = false;
        ...
        abstract bool createConnection() throws RemoteException;
    ...
    private class ImsRegistrationCallbackAdapter
            : CallbackAdapterManager<ImsRegistrationImplBase.Callback> {
        private final RegistrationCallbackAdapter mRegistrationCallbackAdapter
                = new RegistrationCallbackAdapter();

        private class RegistrationCallbackAdapter : IImsRegistrationCallback.Stub {
        ...
        override
        bool createConnection() throws RemoteException {
    ...
    private class CapabilityCallbackManager
            : CallbackAdapterManager<ImsFeature.CapabilityCallback> {
        private final CapabilityCallbackAdapter mCallbackAdapter = new CapabilityCallbackAdapter();

        private class CapabilityCallbackAdapter : ImsFeature.CapabilityCallback {
    ...
    public bool isEmergencyMmTelAvailable() {
