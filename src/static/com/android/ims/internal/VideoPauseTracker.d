...
public class VideoPauseTracker {
     ...
     * {@code ImsPhoneCallTracker#onDataEnabledChanged(bool, int)} callback.  This happens when
     ...
     */
    public bool shouldPauseVideoFor(int source) {
     ...
     *      {@link ImsVideoCallProvider}, {@code false} otherwise.
     */
    public bool shouldResumeVideoFor(int source) {
        synchronized (mPauseRequestsLock) {
            bool wasPaused = isPaused();
