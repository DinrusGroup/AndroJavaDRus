 ...
 * @hide
 */
public class ImsVideoCallProviderWrapper : Connection.VideoProvider {
    ...
    private bool mUseVideoPauseWorkaround = false;
     ...
     */
    private final class ImsVideoCallCallback : IImsVideoCallCallback.Stub {
        override
     ...
     */
    @VisibleForTesting
    public static bool isPauseRequest(int from, int to) {
        bool fromPaused = VideoProfile.isPaused(from);
        bool toPaused = VideoProfile.isPaused(to);
     ...
     */
    @VisibleForTesting
    public static bool isResumeRequest(int from, int to) {
        bool fromPaused = VideoProfile.isPaused(from);
        bool toPaused = VideoProfile.isPaused(to);
     ...
     */
    @VisibleForTesting
    public static bool isTurnOffCameraRequest(int from, int to) {
     ...
     */
    @VisibleForTesting
    public static bool isTurnOnCameraRequest(int from, int to) {
        return !VideoProfile.isTransmissionEnabled(from)
                && VideoProfile.isTransmissionEnabled(to);
    }
    ...
    public VideoProfile maybeFilterPauseResume(VideoProfile fromProfile, VideoProfile toProfile,
        ...
        // pause.
        bool isPauseSpecialCase = (source == VideoPauseTracker.SOURCE_INCALL &&
                VideoProfile.isPaused(fromVideoState) &&
                VideoProfile.isPaused(toVideoState));

        bool isPauseRequest = isPauseRequest(fromVideoState, toVideoState) || isPauseSpecialCase;
        bool isResumeRequest = isResumeRequest(fromVideoState, toVideoState);
        if (isPauseRequest) {
            ...
            bool isTurnOffCameraRequest = isTurnOffCameraRequest(fromVideoState, toVideoState);
            bool isTurnOnCameraRequest = isTurnOnCameraRequest(fromVideoState, toVideoState);
    ...
    public void setUseVideoPauseWorkaround(bool useVideoPauseWorkaround) {
     ...
     */
    public void setIsVideoEnabled(bool isVideoEnabled) {
