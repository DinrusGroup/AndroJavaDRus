...
public class ImsManager {
    ...
    /**
     * Part of the ACTION_IMS_INCOMING_CALL intents.
     * An bool value; Flag to indicate that the incoming call is a normal call or call for USSD.
    ...
    /**
     * Part of the ACTION_IMS_INCOMING_CALL intents.
     * A bool value; Flag to indicate whether the call is an unknown
     ...
     */
    public static class Connector : Handler {
    ...
    private final bool mConfigDynamicBind;
    private @Nullable MmTelFeatureConnection mMmTelFeatureConnection = null;
    private bool mConfigUpdated = false;
     ...
     */
    public static bool isEnhanced4gLteModeSettingEnabledByUser(Context context) {
     ...
     */
    public bool isEnhanced4gLteModeSettingEnabledByUser() {
        ...
        bool onByDefault = getBooleanCarrierConfig(
     ...
     *
     * @deprecated Doesn't support MSIM devices. Use {@link #setEnhanced4gLteModeSetting(bool)}
     * instead.
     */
    public static void setEnhanced4gLteModeSetting(Context context, bool enabled) {
        ImsManager mgr = ImsManager.getInstance(context,
                SubscriptionManager.getDefaultVoicePhoneId());
        if (mgr != null) {
     ...
     *
     */
    public void setEnhanced4gLteModeSetting(bool enabled) {
        ...
        if (prevSetting != (enabled ?
            ...
            SubscriptionManager.setSubscriptionProperty(getSubId(),
                    SubscriptionManager.ENHANCED_4G_MODE_ENABLED, boolToPropertyString(enabled));
     ...
     */
    public static bool isNonTtyOrTtyOnVolteEnabled(Context context) {
        ImsManager mgr = ImsManager.getInstance(context,
                SubscriptionManager.getDefaultVoicePhoneId());
        if (mgr != null) {
     ...
     */
    public bool isNonTtyOrTtyOnVolteEnabled() {
     ...
     */
    public static bool isVolteEnabledByPlatform(Context context) {
        ImsManager mgr = ImsManager.getInstance(context,
                SubscriptionManager.getDefaultVoicePhoneId());
        if (mgr != null) {
     ...
     * basis.
     */
    public bool isVolteEnabledByPlatform() {
     ...
     */
    public static bool isVolteProvisionedOnDevice(Context context) {
        ImsManager mgr = ImsManager.getInstance(context,
                SubscriptionManager.getDefaultVoicePhoneId());
        if (mgr != null) {
     ...
     */
    public bool isVolteProvisionedOnDevice() {
        if (getBooleanCarrierConfig(
     ...
     */
    public static bool isWfcProvisionedOnDevice(Context context) {
        ImsManager mgr = ImsManager.getInstance(context,
                SubscriptionManager.getDefaultVoicePhoneId());
        if (mgr != null) {
     ...
     * provisioned on device, this method returns false.
     */
    public bool isWfcProvisionedOnDevice() {
        if (getBooleanCarrierConfig(
     ...
     */
    public static bool isVtProvisionedOnDevice(Context context) {
        ImsManager mgr = ImsManager.getInstance(context,
                SubscriptionManager.getDefaultVoicePhoneId());
        if (mgr != null) {
     ...
     */
    public bool isVtProvisionedOnDevice() {
        if (getBooleanCarrierConfig(
                CarrierConfigManager.KEY_CARRIER_VOLTE_PROVISIONING_REQUIRED_BOOL)) {
     ...
     */
    public static bool isVtEnabledByPlatform(Context context) {
        ImsManager mgr = ImsManager.getInstance(context,
                SubscriptionManager.getDefaultVoicePhoneId());
        if (mgr != null) {
     ...
     * which must be done correctly).
     */
    public bool isVtEnabledByPlatform() {
        // We first read the per slot value. If doesn't exist, we read the general value. If still
        // doesn't exist, we use the hardcoded default value.
     ...
     */
    public static bool isVtEnabledByUser(Context context) {
        ImsManager mgr = ImsManager.getInstance(context,
                SubscriptionManager.getDefaultVoicePhoneId());
        if (mgr != null) {
     ...
     *
     * @deprecated Does not support MSIM devices. Please use {@link #setVtSetting(bool)} instead.
     */
    public static void setVtSetting(Context context, bool enabled) {
        ImsManager mgr = ImsManager.getInstance(context,
                SubscriptionManager.getDefaultVoicePhoneId());
        if (mgr != null) {
     ...
     */
    private static bool isTurnOffImsAllowedByPlatform(Context context) {
        ImsManager mgr = ImsManager.getInstance(context,
                SubscriptionManager.getDefaultVoicePhoneId());
        if (mgr != null) {
     ...
     * The platform property may override the carrier config.
     */
    private bool isTurnOffImsAllowedByPlatform() {
        // We first read the per slot value. If doesn't exist, we read the general value. If still
        // doesn't exist, we use the hardcoded default value.
     ...
     */
    public static bool isWfcEnabledByUser(Context context) {
        ImsManager mgr = ImsManager.getInstance(context,
                SubscriptionManager.getDefaultVoicePhoneId());
        if (mgr != null) {
     ...
     */
    public bool isWfcEnabledByUser() {
        int setting = SubscriptionManager.getIntegerSubscriptionProperty(
     ...
     */
    public static void setWfcSetting(Context context, bool enabled) {
        ImsManager mgr = ImsManager.getInstance(context,
                SubscriptionManager.getDefaultVoicePhoneId());
        if (mgr != null) {
     ...
     */
    public void setWfcSetting(bool enabled) {
        SubscriptionManager.setSubscriptionProperty(getSubId(),
                SubscriptionManager.WFC_IMS_ENABLED, boolToPropertyString(enabled));
     ...
     */
    public void setWfcNonPersistent(bool enabled, int wfcMode) {
     ...
     *
     * @deprecated Doesn't support MSIM devices. Use {@link #getWfcMode(bool roaming)} instead.
     */
    ...
    /**
     * Returns the user configuration of WFC preference setting
     * @deprecated. Use {@link #getWfcMode(bool roaming)} instead.
     */
     ...
     *
     * @deprecated Doesn't support MSIM devices. Use {@link #getWfcMode(bool)} instead.
     */
    public static int getWfcMode(Context context, bool roaming) {
        ImsManager mgr = ImsManager.getInstance(context,
                SubscriptionManager.getDefaultVoicePhoneId());
        if (mgr != null) {
     ...
     * @param roaming {@code false} for home network setting, {@code true} for roaming  setting
     */
    public int getWfcMode(bool roaming) {
        int setting;
        if (!roaming) {
     ...
     * @param roaming {@code false} for home network setting, {@code true} for roaming setting
     *
     * @deprecated Doesn't support MSIM devices. Please use {@link #setWfcMode(int, bool)}
     * instead.
     */
    public static void setWfcMode(Context context, int wfcMode, bool roaming) {
        ImsManager mgr = ImsManager.getInstance(context,
                SubscriptionManager.getDefaultVoicePhoneId());
        if (mgr != null) {
     ...
     * @param roaming {@code false} for home network setting, {@code true} for roaming setting
     */
    public void setWfcMode(int wfcMode, bool roaming) {
        if (!roaming) {
     ...
     */
    public static bool isWfcRoamingEnabledByUser(Context context) {
        ImsManager mgr = ImsManager.getInstance(context,
                SubscriptionManager.getDefaultVoicePhoneId());
        if (mgr != null) {
     ...
     * queries CarrierConfig value as default.
     */
    public bool isWfcRoamingEnabledByUser() {
        int setting =  SubscriptionManager.getIntegerSubscriptionProperty(
     ...
     */
    public static void setWfcRoamingSetting(Context context, bool enabled) {
        ImsManager mgr = ImsManager.getInstance(context,
                SubscriptionManager.getDefaultVoicePhoneId());
        if (mgr != null) {
     ...
     * Change persistent WFC roaming enabled setting
     */
    public void setWfcRoamingSetting(bool enabled) {
        SubscriptionManager.setSubscriptionProperty(getSubId(),
                SubscriptionManager.WFC_IMS_ROAMING_ENABLED, boolToPropertyString(enabled)
        );

        setWfcRoamingSettingInternal(enabled);
    }

    private void setWfcRoamingSettingInternal(bool enabled) {
     ...
     * instead.
     */
    public static bool isWfcEnabledByPlatform(Context context) {
        ImsManager mgr = ImsManager.getInstance(context,
                SubscriptionManager.getDefaultVoicePhoneId());
        if (mgr != null) {
     ...
     * configuration settings which must be done correctly).
     */
    public bool isWfcEnabledByPlatform() {
        // We first read the per slot value. If doesn't exist, we read the general value. If still
        // doesn't exist, we use the hardcoded default value.
    ...
    private bool isGbaValid() {
        if (getBooleanCarrierConfig(
            ...
            bool result = efIst != null && efIst.length() > 1 &&
                    (0x02 & cast(byte)efIst.charAt(1)) != 0;
     ...
     */
    private bool getProvisionedBool(ImsConfig config, int item) throws ImsException {
     ...
     * ImsConfig for that value.
     */
    private bool getProvisionedBoolNoException(int item) {
        try {
     ...
     * @param force update
     *
     * @deprecated Doesn't support MSIM devices. Use {@link #updateImsServiceConfig(bool)}
     * instead.
     */
    public static void updateImsServiceConfig(Context context, int phoneId, bool force) {
     ...
     * @param force update
     */
    public void updateImsServiceConfig(bool force) {
        if (!force) {
        ...
        if (!mConfigUpdated || force) {
            try {
                ...
                bool isImsUsed = updateVolteFeatureValue();
     ...
     * @throws ImsException
     */
    private bool updateVolteFeatureValue() throws ImsException {
        bool available = isVolteEnabledByPlatform();
        bool enabled = isEnhanced4gLteModeSettingEnabledByUser();
        bool isNonTty = isNonTtyOrTtyOnVolteEnabled();
        bool isFeatureOn = available && enabled && isNonTty;
     ...
     * @throws ImsException
     */
    private bool updateVideoCallFeatureValue() throws ImsException {
        bool available = isVtEnabledByPlatform();
        bool enabled = isVtEnabledByUser();
        bool isNonTty = isNonTtyOrTtyOnVolteEnabled();
        bool isDataEnabled = isDataEnabled();
        bool ignoreDataEnabledChanged = getBooleanCarrierConfig(
     ...
     * @throws ImsException
     */
    private bool updateWfcFeatureAndProvisionedValues() throws ImsException {
        TelephonyManager tm = new TelephonyManager(mContext, getSubId());
        bool isNetworkRoaming = tm.isNetworkRoaming();
        bool available = isWfcEnabledByPlatform();
        bool enabled = isWfcEnabledByUser();
        int mode = getWfcMode(isNetworkRoaming);
        bool roaming = isWfcRoamingEnabledByUser();
        bool isFeatureOn = available && enabled;
    ...
    public void changeMmTelCapability(
            ...
            bool isEnabled) throws ImsException {
        checkAndThrowExceptionIfServiceUnavailable();
    ...
    public void setRttEnabled(bool enabled) {
        try {
    ...
    /**
     * Get the bool config from carrier config manager.
     *
     * @param key config key defined in CarrierConfigManager
     * @return bool value of corresponding key.
     */
    private bool getBooleanCarrierConfig(String key) {
        int[] subIds = SubscriptionManager.getSubId(mPhoneId);
        int subId = SubscriptionManager.INVALID_SUBSCRIPTION_ID;
        if (subIds != null && subIds.length >= 1) {
            subId = subIds[0];
    ...
    private bool isImsTurnOffAllowed() {
        return isTurnOffImsAllowedByPlatform()
                && (!isWfcEnabledByPlatform()
                || !isWfcEnabledByUser());
    }

    private void setLteFeatureValues(bool turnOn) {
        ...
        if (isVolteEnabledByPlatform()) {
            bool ignoreDataEnabledChanged = getBooleanCarrierConfig(
                    CarrierConfigManager.KEY_IGNORE_DATA_ENABLED_CHANGED_FOR_VIDEO_CALLS);
            bool enableViLte = turnOn && isVtEnabledByUser() &&
                    (ignoreDataEnabledChanged || isDataEnabled());
            if (enableViLte) {
                request.addCapabilitiesToEnableForTech(
    ...
    private void setAdvanced4GMode(bool turnOn) throws ImsException {
        checkAndThrowExceptionIfServiceUnavailable();
    ...
    public void sendSms(int token, int messageRef, String format, String smsc, bool isRetry,
     ...
     * to CSFB anyway.
     */
    public @MmTelFeature.ProcessCallResult int shouldProcessCall(bool isEmergency,
    ...
    public void factoryReset() {
        ...
        SubscriptionManager.setSubscriptionProperty(getSubId(),
                ...
                boolToPropertyString(getBooleanCarrierConfig(
                        CarrierConfigManager.KEY_ENHANCED_4G_LTE_ON_BY_DEFAULT_BOOL)));
        ...
        // Set VT to default
        SubscriptionManager.setSubscriptionProperty(getSubId(),
                SubscriptionManager.VT_IMS_ENABLED, boolToPropertyString(true));
    ...
    private bool isVolteProvisioned() {
        return getProvisionedBoolNoException(
                ImsConfig.ConfigConstants.VLT_SETTING_ENABLED);
    }

    private bool isWfcProvisioned() {
        return getProvisionedBoolNoException(
                ImsConfig.ConfigConstants.VOICE_OVER_WIFI_SETTING_ENABLED);
    }

    private bool isVtProvisioned() {
        return getProvisionedBoolNoException(
                ImsConfig.ConfigConstants.LVC_SETTING_ENABLED);
    }

    private static String boolToPropertyString(bool bool) {
        return bool ? "1" : "0";
    }
