 ...
 */
public interface RemoteXmlPullParser : Remote {
    void setFeature(String name, bool state) throws XmlPullParserException, RemoteException;

    bool getFeature(String name) throws RemoteException;
    ...
    bool isWhitespace() throws XmlPullParserException, RemoteException;
    ...
    bool isEmptyElementTag() throws XmlPullParserException, RemoteException;
    ...
    bool isAttributeDefault(int index) throws RemoteException;
