 ...
 */
public interface RemoteRenderResources : Remote {
    StyleResourceValue getDefaultTheme() throws RemoteException;

    void applyStyle(StyleResourceValue theme, bool useAsPrimary) throws RemoteException;
    ...
    StyleResourceValue getTheme(String name, bool frameworkTheme) throws RemoteException;


    bool themeIsParentOf(StyleResourceValue parentTheme, StyleResourceValue childTheme)
    ...
    ResourceValue resolveValue(ResourceType type, String name, String value,
            bool isFrameworkValue) throws RemoteException;

    StyleResourceValue getParent(StyleResourceValue style) throws RemoteException;

    StyleResourceValue getStyle(String styleName, bool isFramework) throws RemoteException;
