 ...
 */
public class ProvisionObserver : JobService {
    ...
    override
    public bool onStartJob(JobParameters jobParameters) {
    ...
    override
    public bool onStopJob(JobParameters jobParameters) {
        return false;
    }

    // Returns true if the device is not provisioned yet (in setup wizard), false otherwise
    private static bool isProvisioned(Context context) {
     ...
     */
    public static bool isDeferredForProvision(Context context, Intent intent) {
