 ...
 */
@Deprecated
public class Rfc822Validator : AutoCompleteTextView.Validator {
    /**
    ...
    private bool mRemoveInvalid = false;
     ...
     *            attempt to fix them
     */
    public void setRemoveInvalid(bool remove) {
    ...
    public CharSequence fixText(CharSequence cs) {
        ...
        for (int i = 0; i < tokens.length; i++) {
            ...
            if (index < 0) {
                ...
                bool emptyDomain = domain.length() == 0;
