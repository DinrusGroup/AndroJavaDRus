...
public class OperationScheduler {
    ...
    public long getNextTimeMillis(Options options) {
        bool enabledState = mStorage.getBoolean(PREFIX + "enabledState", true);
        if (!enabledState) return Long.MAX_VALUE;

        bool permanentError = mStorage.getBoolean(PREFIX + "permanentError", false);
     ...
     */
    public bool setMoratoriumTimeHttp(String retryAfter) {
        try {
