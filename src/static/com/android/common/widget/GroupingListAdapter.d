 ...
 */
public abstract class GroupingListAdapter : BaseAdapter {
     ...
     */
    protected void addGroup(int cursorPosition, int size, bool expanded) {
    ...
    public int getCount() {
        ...
        for (int i = 0; i < mGroupCount; i++) {
            ...
            bool expanded = (metadata & EXPANDED_GROUP_MASK) != 0;
    ...
    public void obtainPositionMetadata(PositionMetadata metadata, int position) {
        ...
        for (int i = firstGroupToCheck; i < mGroupCount; i++) {
            ...
            bool expanded = (group & EXPANDED_GROUP_MASK) != 0;
