 ...
 */
public abstract class BaseEmailAddressAdapter : CompositeCursorAdapter : Filterable {
     ...
     */
    public final static class DirectoryPartition : CompositeCursorAdapter.Partition {
     ...
     */
    private final class DefaultPartitionFilter : Filter {
     ...
     */
    private final class DirectoryPartitionFilter : Filter {
    ...
    private bool mDirectoriesLoaded;
    ...
    override
    protected bool isEnabled(int partitionIndex, int position) {
        // The "Searching..." item should not be selectable
        return !isLoading(partitionIndex);
    }

    private bool isLoading(int partitionIndex) {
    ...
    private bool hasDuplicates(Cursor cursor, int partition) {
        cursor.moveToPosition(-1);
     ...
     */
    private bool isDuplicate(String emailAddress, int excludePartition) {
