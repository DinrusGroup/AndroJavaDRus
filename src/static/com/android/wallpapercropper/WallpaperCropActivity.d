...
public class WallpaperCropActivity : Activity {
        ...
        actionBar.getCustomView().setOnClickListener(
                new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        bool finishActivityWhenDone = true;
    ...
    public void setCropViewTileSource(
            final BitmapRegionTileSource.BitmapSource bitmapSource, final bool touchEnabled,
            final bool moveToLeft, final Runnable postExecute) {
    ...
    protected void setWallpaper(String filePath, final bool finishActivityWhenDone) {
    ...
    protected void cropImageAndSetWallpaper(
            Resources res, int resId, final bool finishActivityWhenDone) {
    ...
    private static bool isScreenLarge(Resources res) {
        Configuration config = res.getConfiguration();
        return config.smallestScreenWidthDp >= 720;
    }

    protected void cropImageAndSetWallpaper(Uri uri,
            OnBitmapCroppedHandler onBitmapCroppedHandler, final bool finishActivityWhenDone) {
        bool centerCrop = getResources().getBoolean(R.bool.center_crop);
        // Get the crop
        bool ltr = mCropView.getLayoutDirection() == View.LAYOUT_DIRECTION_LTR;

        Display d = getWindowManager().getDefaultDisplay();

        Point displaySize = new Point();
        d.getSize(displaySize);
        bool isPortrait = displaySize.x < displaySize.y;
    ...
    protected static class BitmapCropTask : AsyncTask<Void, Void, Boolean> {
        Uri mInUri = null;
        Context mContext;
        String mInFilePath;
        byte[] mInImageBytes;
        ...
        public BitmapCropTask(Context c, String filePath,
                ...
                bool setWallpaper, bool saveCroppedBitmap, Runnable onEndRunnable) {
            mContext = c;
        ...
        public void setNoCrop(bool value) {
            mNoCrop = value;
        }
    ...
    protected static RectF getMaxCropRect(
            int inWidth, int inHeight, int outWidth, int outHeight, bool leftAligned) {
