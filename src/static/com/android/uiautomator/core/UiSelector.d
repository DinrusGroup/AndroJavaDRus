...
public class UiSelector {
     ...
     * widget class, and {@link #enabled(bool)} is true.
     ...
     * @since API Level 16
     */
    public UiSelector enabled(bool val) {
     ...
     * @since API Level 16
     */
    public UiSelector focused(bool val) {
     ...
     * @since API Level 16
     */
    public UiSelector focusable(bool val) {
     ...
     * @since API Level 16
     */
    public UiSelector scrollable(bool val) {
     ...
     * @since API Level 16
     */
    public UiSelector selected(bool val) {
     ...
     * @since API Level 16
     */
    public UiSelector checked(bool val) {
     ...
     * @since API Level 16
     */
    public UiSelector clickable(bool val) {
     ...
     * @since API Level 18
     */
    public UiSelector checkable(bool val) {
     ...
     * @since API Level 17
     */
    public UiSelector longClickable(bool val) {
    ...
    bool isMatchFor(AccessibilityNodeInfo node, int index) {
    ...
    private bool matchOrUpdateInstance() {
