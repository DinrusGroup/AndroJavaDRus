...
public class UiDevice {
    ...
    private bool mInWatcherContext = false;
     ...
     * @since API Level 18
     */
    public void setCompressedLayoutHeirarchy(bool compressed) {
     ...
     * @since API Level 16
     */
    public bool pressKeyCode(int keyCode) {
     ...
     * @since API Level 16
     */
    public bool pressKeyCode(int keyCode, int metaState) {
     ...
     * @since API Level 16
     */
    public bool pressRecentApps() throws RemoteException {
        Tracer.trace();
        waitForIdle();
     ...
     * @since API Level 16
     */
    public bool swipe(int startX, int startY, int endX, int endY, int steps) {
     ...
     * @since API Level 18
     */
    public bool drag(int startX, int startY, int endX, int endY, int steps) {
        Tracer.trace(startX, startY, endX, endY, steps);
        return getAutomatorBridge().getInteractionController()
     ...
     * @since API Level 16
     */
    public bool hasWatcherTriggered(String watcherName) {
     ...
     * @since API Level 16
     */
    public bool hasAnyWatcherTriggered() {
        Tracer.trace();
     ...
     * @since API Level 17
     */
    public bool isNaturalOrientation() {
        Tracer.trace();
        waitForIdle();
     ...
     * @since API Level 16
     */
    public bool waitForWindowUpdate(final String packageName, long timeout) {
     ...
     * @since API Level 17
     */
    public bool takeScreenshot(File storePath) {
     ...
     * @since API Level 17
     */
    public bool takeScreenshot(File storePath, float scale, int quality) {
