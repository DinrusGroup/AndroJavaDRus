 ...
 */
@Deprecated
public class UiScrollable : UiCollection {
    ...
    private bool mIsVerticalList = true;
     ...
     * @since API Level 16
     */
    protected bool exists(UiSelector selector) {
     ...
     * scroll search.
     * See {@link #getChildByDescription(UiSelector, String, bool)}
     *
     ...
     */
    public UiObject getChildByDescription(UiSelector childPattern, String text,
            bool allowScrollSearch) throws UiObjectNotFoundException {
     ...
     * scroll search.
     * See {@link #getChildByText(UiSelector, String, bool)}
     *
     ...
     * @since API Level 16
     */
    public UiObject getChildByText(UiSelector childPattern, String text, bool allowScrollSearch)
            throws UiObjectNotFoundException {
        Tracer.trace(childPattern, text, allowScrollSearch);
        if (text != null) {
            if (allowScrollSearch) {
     ...
     * @since API Level 16
     */
    public bool scrollDescriptionIntoView(String text) throws UiObjectNotFoundException {
        Tracer.trace(text);
     ...
     * @since API Level 16
     */
    public bool scrollIntoView(UiObject obj) throws UiObjectNotFoundException {
     ...
     * @since API Level 16
     */
    public bool scrollIntoView(UiSelector selector) throws UiObjectNotFoundException {
     ...
     * @hide
     */
    public bool ensureFullyVisible(UiObject childObject) throws UiObjectNotFoundException {
     ...
     * @since API Level 16
     */
    public bool scrollTextIntoView(String text) throws UiObjectNotFoundException {
        Tracer.trace(text);
     ...
     * @since API Level 16
     */
    public bool flingForward() throws UiObjectNotFoundException {
        Tracer.trace();
     ...
     * @since API Level 16
     */
    public bool scrollForward() throws UiObjectNotFoundException {
        Tracer.trace();
     ...
     * @since API Level 16
     */
    public bool scrollForward(int steps) throws UiObjectNotFoundException {
        Tracer.trace(steps);
     ...
     * @since API Level 16
     */
    public bool flingBackward() throws UiObjectNotFoundException {
        Tracer.trace();
     ...
     * @since API Level 16
     */
    public bool scrollBackward() throws UiObjectNotFoundException {
        Tracer.trace();
     ...
     * @since API Level 16
     */
    public bool scrollBackward(int steps) throws UiObjectNotFoundException {
        Tracer.trace(steps);
     ...
     * @since API Level 16
     */
    public bool scrollToBeginning(int maxSwipes, int steps) throws UiObjectNotFoundException {
     ...
     * @since API Level 16
     */
    public bool scrollToBeginning(int maxSwipes) throws UiObjectNotFoundException {
     ...
     * @since API Level 16
     */
    public bool flingToBeginning(int maxSwipes) throws UiObjectNotFoundException {
        Tracer.trace(maxSwipes);
     ...
     * @since API Level 16
     */
    public bool scrollToEnd(int maxSwipes, int steps) throws UiObjectNotFoundException {
        Tracer.trace(maxSwipes, steps);
        // protect against potential hanging and return after preset attempts
        for(int x = 0; x < maxSwipes; x++) {
     ...
     * @since API Level 16
     */
    public bool scrollToEnd(int maxSwipes) throws UiObjectNotFoundException {
        Tracer.trace(maxSwipes);
     ...
     * @since API Level 16
     */
    public bool flingToEnd(int maxSwipes) throws UiObjectNotFoundException {
        Tracer.trace(maxSwipes);
