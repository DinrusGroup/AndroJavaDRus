...
class InteractionController {
    ...
    private static final bool DEBUG = Log.isLoggable(LOG_TAG, Log.DEBUG);
     ...
     */
    class WaitForAnyEventPredicate : AccessibilityEventFilter {
        int mMask;
        WaitForAnyEventPredicate(int mask) {
            mMask = mask;
        }
        override
        public bool accept(AccessibilityEvent t) {
     ...
     */
    class EventCollectingPredicate : AccessibilityEventFilter {
        int mMask;
     ...
     */
    class WaitForAllEventPredicate : AccessibilityEventFilter {
        int mMask;
     ...
     */
    public bool sendKeyAndWaitForEvent(final int keyCode, final int metaState,
     ...
     */
    public bool clickNoSync(int x, int y) {
     ...
     */
    public bool clickAndSync(final int x, final int y, long timeout) {
     ...
     */
    public bool clickAndWaitForNewWindow(final int x, final int y, long timeout) {
     ...
     */
    public bool longTapNoSync(int x, int y) {
        if (DEBUG) {
    ...
    private bool touchDown(int x, int y) {
        if (DEBUG) {
    ...
    private bool touchUp(int x, int y) {
        if (DEBUG) {
    ...
    private bool touchMove(int x, int y) {
        if (DEBUG) {
     ...
     */
    public bool scrollSwipe(final int downX, final int downY, final int upX, final int upY,
            final int steps) {
     ...
     */
    public bool swipe(int downX, int downY, int upX, int upY, int steps) {
     ...
     * @return true if the swipe executed successfully
     */
    public bool swipe(int downX, int downY, int upX, int upY, int steps, bool drag) {
        bool ret = false;
     ...
     */
    public bool swipe(Point[] segments, int segmentSteps) {
        bool ret = false;
    ...
    public bool sendKey(int keyCode, int metaState) {
        if (DEBUG) {
     ...
     * @throws RemoteException
     */
    public bool wakeDevice() throws RemoteException {
        if(!isScreenOn()) {
     ...
     * @throws RemoteException
     */
    public bool sleepDevice() throws RemoteException {
        if(isScreenOn()) {
     ...
     * @throws RemoteException
     */
    public bool isScreenOn() throws RemoteException {
        return mUiAutomatorBridge.isScreenOn();
    }

    private bool injectEventSync(InputEvent event) {
