...
public class UiAutomationShellWrapper {
     ...
     */
    public void setRunAsMonkey(bool isSet) {
    ...
    public void setCompressedLayoutHierarchy(bool compressed) {
     ...
     */
    private class DummyActivityController : IActivityController.Stub {
        override
        public bool activityStarting(Intent intent, String pkg) throws RemoteException {
            /* do nothing and let activity proceed normally */
            return true;
        }

        override
        public bool activityResuming(String pkg) throws RemoteException {
            /* do nothing and let activity proceed normally */
            return true;
        }
