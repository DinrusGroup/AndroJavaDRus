...
public class TestCaseCollector {
    ...
    public void addTestClass(String className, String methodName) throws ClassNotFoundException {
        Class!(T) clazz = mClassLoader.loadClass(className);
        if (methodName != null) {
    ...
    protected void addSingleTestMethod(Class!(T) clazz, String method) {
    ...
    private UiAutomatorTestCase error(Class!(T) clazz, final String message) {
    ...
    public interface TestCaseFilter {
         ...
         * @param method
         */
        public bool accept(Method method);
         ...
         * @return
         */
        public bool accept(Class!(T) clazz);
    }
}
