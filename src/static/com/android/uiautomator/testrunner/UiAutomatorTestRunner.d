...
public class UiAutomatorTestRunner {
    ...
    public void run(List<String> testClasses, Bundle params, bool debug, bool monkey) {
    ...
    private class FakeInstrumentationWatcher : IInstrumentationWatcher {

        private final bool mRawMode = true;
    ...
    private interface ResultReporter : TestListener {
    ...
    private class WatcherResultPrinter : ResultReporter {
     ...
     */
    private class SimpleResultPrinter : ResultPrinter : ResultReporter {
        private final bool mFullOutput;
        public SimpleResultPrinter(PrintStream writer, bool fullOutput) {
            super(writer);
