 ...
 */
public class PageContentView : View
        : PageContentRepository.OnPageContentAvailableCallback {
    ...
    private bool mContentRequested;
    ...
    public void init(PageContentProvider provider, Drawable emptyState, Drawable errorState,
        ...
        final bool providerChanged = (mProvider == null)
                ? provider != null : !mProvider.equals(provider);
        final bool loadingDrawableChanged = (mEmptyState == null)
                ? emptyState != null : !mEmptyState.equals(emptyState);
        final bool mediaSizeChanged = (mMediaSize == null)
                ? mediaSize != null : !mMediaSize.equals(mediaSize);
        final bool marginsChanged = (mMinMargins == null)
