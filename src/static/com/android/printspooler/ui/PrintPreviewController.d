...
class PrintPreviewController : MutexFileProvider.OnReleaseRequestCallback,
    ...
    public void setUiShown(bool shown) {
        if (shown) {
    ...
    public void onContentUpdated(bool documentChanged, int documentPageCount,
    ...
    private final class MyHandler : Handler {
        ...
        private bool mAsyncOperationInProgress;
    ...
    private final class PreloadController : RecyclerView.OnScrollListener {
