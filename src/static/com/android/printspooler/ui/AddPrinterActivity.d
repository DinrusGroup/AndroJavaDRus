 ...
 * </ul>
 */
public class AddPrinterActivity : ListActivity : AdapterView.OnItemClickListener {
     ...
     */
    private class PrintServiceInfoLoaderCallbacks :
     ...
     * recommendations}.
     */
    private class PrintServicePrintServiceRecommendationLoaderCallbacks :
     ...
     */
    private abstract class ActionAdapter : BaseAdapter {
        /**
     ...
     */
    private class CombinedAdapter : ActionAdapter {
     ...
     */
    private abstract class PrintServiceInfoAdapter : ActionAdapter {
        /**
     ...
     */
    private class EnabledServicesAdapter : PrintServiceInfoAdapter {
        override
        public void performAction(@IntRange(from = 0) int position) {
     ...
     */
    private class DisabledServicesAdapter : PrintServiceInfoAdapter {
        override
        public void performAction(@IntRange(from = 0) int position) {
     ...
     */
    private class RecommendedServicesAdapter : ActionAdapter {
    ...
    private class NoPrintServiceMessageAdapter : ActionAdapter {
        private bool mHasPrintService;
