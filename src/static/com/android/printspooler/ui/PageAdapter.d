 ...
 */
public final class PageAdapter : Adapter<ViewHolder> {
    ...
    public void update(PageRange[] writtenPages, PageRange[] selectedPages,
        ...
        bool updatePreviewAreaAndPageSize = false;
    ...
    private PageRange[] computeRequestedPages(int pageInDocument) {
        ...
        final bool requestFromStart = mRequestedPages == null
    ...
    private final class MyViewHolder : ViewHolder {
        int mPageInAdapter;
    ...
    private final class PageClickListener : OnClickListener {
        override
