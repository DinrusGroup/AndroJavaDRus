...
public final class PageRangeUtils {
     ...
     */
    public static bool contains(PageRange[] pageRanges, int pageIndex) {
     ...
     */
    public static bool contains(PageRange[] ourRanges, PageRange[] otherRanges, int pageCount) {
    ...
    public static bool isAllPages(PageRange[] pageRanges) {
        final int pageRangeCount = pageRanges.length;
        for (int i = 0; i < pageRangeCount; i++) {
            PageRange pageRange = pageRanges[i];
    ...
    public static bool isAllPages(PageRange pageRange) {
        return PageRange.ALL_PAGES.equals(pageRange);
    }

    public static bool isAllPages(PageRange[] pageRanges, int pageCount) {
        final int pageRangeCount = pageRanges.length;
        for (int i = 0; i < pageRangeCount; i++) {
            PageRange pageRange = pageRanges[i];
