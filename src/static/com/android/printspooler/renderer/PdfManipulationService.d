 ...
 */
public final class PdfManipulationService : Service {
    ...
    private final class PdfRendererImpl : IPdfRenderer.Stub {
            ...
            synchronized (mLock) {
                try {
                    ...
                    try (PdfRenderer.Page page = mRenderer.openPage(pageIndex)) {
                        ...
                        final bool scaleContent = mRenderer.shouldScaleForPrinting();
                        final bool contentLandscape = !attributes.getMediaSize().isPortrait();
    ...
    private final class PdfEditorImpl : IPdfEditor.Stub {
        private final Object mLock = new Object();
        ...
        public void applyPrintAttributes(PrintAttributes attributes) {
            synchronized (mLock) {
                ...
                final bool layoutDirectionRtl = getResources().getConfiguration()
                ...
                final bool scaleForPrinting = mEditor.shouldScaleForPrinting();
