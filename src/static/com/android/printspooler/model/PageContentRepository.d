...
public final class PageContentRepository {
    ...
    public static final class RenderSpec {
        ...
        public bool hasSameSize(RenderedPage page) {
    ...
    private static final class AsyncRenderer : ServiceConnection {
        ...
        private final class OpenTask : AsyncTask<Void, Void, Integer> {
        ...
        private final class RenderPageTask : AsyncTask<Void, Void, RenderedPage> {
