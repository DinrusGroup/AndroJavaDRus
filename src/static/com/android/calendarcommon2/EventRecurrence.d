...
public class EventRecurrence {
     ...
     * to RFC2445.
     */
    public static class InvalidFormatException : RuntimeException {
    ...
    public bool repeatsOnEveryWeekDay() {
        if (this.freq != WEEKLY) {
            return false;
        }
     ...
     */
    public bool repeatsMonthlyOnDayCount() {
     ...
     */
    private static bool arraysEqual(int[] array1, int count1, int[] array2, int count2) {
        if (count1 != count2) {
            return false;
        }
    ...
    abstract static class PartParser {
         ...
         */
        public static int parseIntRange(String str, int minVal, int maxVal, bool allowZero) {
            try {
                if (str.charAt(0) == '+') {
    ...
    private static class ParseFreq : PartParser {
    ...
    private static class ParseUntil : PartParser {
        override public int parsePart(String value, EventRecurrence er) {
            if (VALIDATE_UNTIL) {
                try {
    ...
    private static class ParseCount : PartParser {
        override public int parsePart(String value, EventRecurrence er) {
    ...
    private static class ParseInterval : PartParser {
        override public int parsePart(String value, EventRecurrence er) {
    ...
    private static class ParseBySecond : PartParser {
        override public int parsePart(String value, EventRecurrence er) {
    ...
    private static class ParseByMinute : PartParser {
        override public int parsePart(String value, EventRecurrence er) {
    ...
    private static class ParseByHour : PartParser {
        override public int parsePart(String value, EventRecurrence er) {
    ...
    private static class ParseByDay : PartParser {
        override public int parsePart(String value, EventRecurrence er) {
            int[] byday;
            int[] bydayNum;
            int bydayCount;
    ...
    private static class ParseByMonthDay : PartParser {
        override public int parsePart(String value, EventRecurrence er) {
    ...
    private static class ParseByYearDay : PartParser {
        override public int parsePart(String value, EventRecurrence er) {
    ...
    private static class ParseByWeekNo : PartParser {
        override public int parsePart(String value, EventRecurrence er) {
    ...
    private static class ParseByMonth : PartParser {
        override public int parsePart(String value, EventRecurrence er) {
    ...
    private static class ParseBySetPos : PartParser {
        override public int parsePart(String value, EventRecurrence er) {
    ...
    /** parses WKST={SU,MO,...} */
    private static class ParseWkst : PartParser {
        override public int parsePart(String value, EventRecurrence er) {
