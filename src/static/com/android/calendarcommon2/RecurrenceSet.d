...
public class RecurrenceSet {
     ...
     */
    public static bool populateContentValues(ICalendar.Component component,
        ...
        try {
            ...
            bool inUtc = start.parse(dtstart);
            bool allDay = start.allDay;
    ...
    public static bool populateComponent(Cursor cursor,
        ...
        String exruleStr = cursor.getString(exruleColumn);
        String exdateStr = cursor.getString(exdateColumn);
        bool allDay = cursor.getInt(allDayColumn) == 1;
...
public static bool populateComponent(ContentValues values,
                                            ICalendar.Component component) {
        long dtstart = -1;
        ...
        final bool allDay = (null != allDayInteger) ? (allDayInteger == 1) : false;
