 ...
 * <p>Provides setters {@link #setBackButtonVisible(bool)} for setting CarSetupWizardLayout
...
public class BaseActivity : FragmentActivity {
     ...
     */
    private bool mAllowFragmentCommits = true;
     ...
     */
    @CallSuper
    protected bool popBackStackImmediate() {
     ...
     */
    protected bool handleBackButton() {
     ...
     */
    protected void setBackButtonVisible(bool visible) {
     ...
     */
    protected void setToolbarTitleVisible(bool visible) {
     ...
     */
    protected void setPrimaryToolbarButtonVisible(bool visible) {
     ...
     */
    protected void setPrimaryToolbarButtonEnabled(bool enabled) {
     ...
     */
    protected void setPrimaryToolbarButtonFlat(bool flat) {
     ...
     */
    protected void setSecondaryToolbarButtonVisible(bool visible) {
     ...
     * clicking the button will take the user to the next screen in the setup flow.
     */
    protected void setSecondaryToolbarButtonEnabled(bool enabled) {
     ...
     */
    protected void addElevationToTitleBar(bool animate) {
     ...
     */
    protected void removeElevationFromTitleBar(bool animate) {
     ...
     */
    protected void setProgressBarVisible(bool visible) {
        mCarSetupWizardLayout.setProgressBarVisible(visible);
    }

    @VisibleForTesting(otherwise = VisibleForTesting.PRIVATE)
    bool getAllowFragmentCommits() {
