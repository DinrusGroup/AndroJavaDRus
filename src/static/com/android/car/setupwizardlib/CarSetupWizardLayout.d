 ...
 */
public class CarSetupWizardLayout : LinearLayout {
     ...
     */
    private bool mPrimaryToolbarButtonFlat;
    ...
    private void init(TypedArray attrArray) {
        ...
        bool showPrimaryToolbarButton;
        String primaryToolbarButtonText;
        bool primaryToolbarButtonEnabled;

        bool showSecondaryToolbarButton;
        String secondaryToolbarButtonText;
        bool secondaryToolbarButtonEnabled;

        bool showProgressBar;
        bool indeterminateProgressBar;
    ...
    @VisibleForTesting(otherwise = VisibleForTesting.PRIVATE)
    void updateBackButtonTouchDelegate(bool visible) {
        if (visible) {
     ...
     */
    public void setToolbarTitleVisible(bool visible) {
     ...
     */
    public void setPrimaryToolbarButtonVisible(bool visible) {
     ...
     */
    public void setPrimaryToolbarButtonEnabled(bool enabled) {
     ...
     */
    public bool getPrimaryToolbarButtonFlat() {
     ...
     */
    public void setPrimaryToolbarButtonFlat(bool isFlat) {
    ...
    @VisibleForTesting(otherwise = VisibleForTesting.PRIVATE)
    Button createPrimaryToolbarButton(bool isFlat) {
     ...
     */
    public void setSecondaryToolbarButtonVisible(bool visible) {
     ...
     */
    public void setSecondaryToolbarButtonEnabled(bool enabled) {
        maybeInflateSecondaryToolbarButton();
     ...
     */
    public void addElevationToTitleBar(bool animate) {
        if (animate) {
     ...
     */
    public void removeElevationFromTitleBar(bool animate) {
        if (animate) {
            ValueAnimator elevationAnimator =
