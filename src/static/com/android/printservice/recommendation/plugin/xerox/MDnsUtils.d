...
class MDnsUtils {
    ...
    public static bool isVendorPrinter(NsdServiceInfo networkDevice, String[] vendorValues) {
    ...
    public static bool checkPDLSupport(NsdServiceInfo networkDevice, String[] pdlFormats) {
    ...
    private static bool containsVendor(String container, String[] vendorValues) {
    ...
    private static bool containsString(String container, String contained) {
