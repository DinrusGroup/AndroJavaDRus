...
public class HPRecommendationPlugin : ServiceRecommendationPlugin {
    ...
    private bool isPrintSupported(String printerModel) {
        bool isSupported;
    ...
    private static bool isSupportedDesignjet(String printerModel) {
    ...
    public bool matchesCriteria(String vendor, NsdServiceInfo nsdServiceInfo) {
        ...
        bool hasMobileSupport = TextUtils.equals(ATTRIBUTE_VALUE__TRUE, MDnsUtils.getString(nsdServiceInfo.getAttributes().get(MDNS_ATTRIBUTE__HPLFMOBILEPRINTER)));
