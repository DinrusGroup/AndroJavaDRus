 ...
 */
public class MDNSFilteredDiscovery : NsdManager.DiscoveryListener  {
    ...
    public interface PrinterFilter {
         ...
         */
        bool matchesCriteria(NsdServiceInfo nsdServiceInfo);
    }
                ...
                new NsdManager.ResolveListener() {
                    ...
                    public void onServiceResolved(NsdServiceInfo serviceInfo) {
                        if (mPrinterFilter.matchesCriteria(serviceInfo)) {
                            if (mCallback != null) {
                                bool added = mPrinters.add(serviceInfo.getHost());
                                if (added) {
                                    mCallback.onChanged(new ArrayList<>(mPrinters));
                                }
                            }
        ...
        mResolveQueue.resolve(getNDSManager(), serviceInfo,
                new NsdManager.ResolveListener() {
                    ...
                    public void onServiceResolved(NsdServiceInfo serviceInfo) {
                        if (mPrinterFilter.matchesCriteria(serviceInfo)) {
                            if (mCallback != null) {
                                bool removed = mPrinters.remove(serviceInfo.getHost());
