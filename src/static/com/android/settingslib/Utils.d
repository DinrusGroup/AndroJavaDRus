...
public class Utils {
    ...
    public static void updateLocationEnabled(Context context, bool enabled, int userId,
            int source) {
    ...
    public static bool updateLocationMode(Context context, int oldMode, int newMode, int userId,
            int source) {
        Settings.Secure.putIntForUser(
                context.getContentResolver(), Settings.Secure.LOCATION_CHANGER, source,
                userId);
    ...
    public static int getTetheringLabel(ConnectivityManager cm) {
        ...
        bool usbAvailable = usbRegexs.length != 0;
        bool wifiAvailable = wifiRegexs.length != 0;
        bool bluetoothAvailable = bluetoothRegexs.length != 0;
    ...
    public static String formatPercentage(double percentage, bool round) {
     ...
     */
    public static bool isSystemPackage(Resources resources, PackageManager pm, PackageInfo pkg) {
     ...
     * returns {@code false}.
     */
    public static bool isDeviceProvisioningPackage(Resources resources, String packageName) {
    ...
    public static bool isWifiOnly(Context context) {
        return !context.getSystemService(ConnectivityManager.class)
                .isNetworkSupported(ConnectivityManager.TYPE_MOBILE);
    }

    /** Returns if the automatic storage management feature is turned on or not. **/
    public static bool isStorageManagerEnabled(Context context) {
        bool isDefaultOn;
        try {
     ...
     */
    public static bool isAudioModeOngoingCall(Context context) {
