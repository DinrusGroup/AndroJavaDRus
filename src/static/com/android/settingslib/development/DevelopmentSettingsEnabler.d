...
public class DevelopmentSettingsEnabler {
    ...
    public static void setDevelopmentSettingsEnabled(Context context, bool enable) {
    ...
    public static bool isDevelopmentSettingsEnabled(Context context) {
        final UserManager um = (UserManager) context.getSystemService(Context.USER_SERVICE);
        final bool settingEnabled = Settings.Global.getInt(context.getContentResolver(),
                Settings.Global.DEVELOPMENT_SETTINGS_ENABLED,
                Build.TYPE.equals("eng") ? 1 : 0) != 0;
        final bool hasRestriction = um.hasUserRestriction(
                UserManager.DISALLOW_DEBUGGING_FEATURES);
        final bool isAdminOrDemo = um.isAdminUser() || um.isDemoUser();
