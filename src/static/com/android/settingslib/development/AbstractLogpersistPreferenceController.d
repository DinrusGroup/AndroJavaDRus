...
public abstract class AbstractLogpersistPreferenceController :
        DeveloperOptionsPreferenceController : Preference.OnPreferenceChangeListener,
    ...
    private bool mLogpersistCleared;
    ...
    protected void setLogpersistOff(bool update) {
    ...
    public void writeLogpersistOption(Object newValue, bool skipWarning) {
        if (mLogpersist == null) {
            return;
        }
