...
public class PowerWhitelistBackend {
    ...
    public bool isSysWhitelisted(String pkg) {
        return mSysWhitelistedApps.contains(pkg);
    }

    public bool isWhitelisted(String pkg) {
    ...
    public bool isWhitelisted(String[] pkgs) {
    ...
    public bool isSysWhitelistedExceptIdle(String pkg) {
        return mSysWhitelistedAppsExceptIdle.contains(pkg);
    }

    public bool isSysWhitelistedExceptIdle(String[] pkgs) {
        if (ArrayUtils.isEmpty(pkgs)) {
            return false;
        }
        for (String pkg : pkgs) {
