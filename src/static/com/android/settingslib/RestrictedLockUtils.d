...
public class RestrictedLockUtils {
    ...
    public static bool hasBaseUserRestriction(Context context,
            String userRestriction, int userId) {
    ...
    public static EnforcedAdmin checkIfInputMethodDisallowed(Context context,
        ...
        bool permittedByProfileAdmin = true;
    ...
    public static EnforcedAdmin checkIfAccountManagementDisabled(Context context,
        ...
        bool isAccountTypeDisabled = false;
    ...
    private interface LockSettingCheck {
        bool isEnforcing(DevicePolicyManager dpm, ComponentName admin, @UserIdInt int userId);
    }
    ...
    private static EnforcedAdmin checkForLockSetting(
        ...
        for (UserInfo userInfo : UserManager.get(context).getProfiles(userId)) {
            ...
            final bool isSeparateProfileChallengeEnabled =
    ...
    public static bool isCurrentUserOrProfile(Context context, int userId) {
    ...
    public static bool isAdminInCurrentUserOrProfile(Context context, ComponentName admin) {
        DevicePolicyManager dpm = (DevicePolicyManager) context.getSystemService(
                Context.DEVICE_POLICY_SERVICE);
        UserManager um = UserManager.get(context);
        for (UserInfo userInfo : um.getProfiles(UserHandle.myUserId())) {
    ...
    public static void setTextViewPadlock(Context context,
            TextView textView, bool showPadlock) {
    ...
    public static void setTextViewAsDisabledByAdmin(Context context,
            TextView textView, bool disabled) {
        final SpannableStringBuilder sb = new SpannableStringBuilder(textView.getText());
        removeExistingRestrictedSpans(sb);
        if (disabled) {
            final int disabledColor = context.getColor(R.color.disabled_text_color);
    ...
    @VisibleForTesting
    static class Proxy {
        public bool isSeparateProfileChallengeEnabled(LockPatternUtils utils, int userHandle) {
