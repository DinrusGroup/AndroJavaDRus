...
public class AccessibilityButtonHelper {
    public static bool isRequestedByMagnification(Context ctx) {
        return Settings.Secure.getInt(ctx.getContentResolver(),
                Settings.Secure.ACCESSIBILITY_DISPLAY_MAGNIFICATION_NAVBAR_ENABLED, 0) == 1;
    }

    public static bool isRequestedByAccessibilityService(Context ctx) {
    ...
    public static bool isRequested(Context ctx) {
