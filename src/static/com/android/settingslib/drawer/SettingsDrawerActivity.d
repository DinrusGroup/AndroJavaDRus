...
public class SettingsDrawerActivity : Activity {

    protected static final bool DEBUG_TIMING = false;
     ...
     */
    public bool setTileEnabled(ComponentName component, bool enabled) {
        PackageManager pm = getPackageManager();
        int state = pm.getComponentEnabledSetting(component);
        bool isEnabled = state == PackageManager.COMPONENT_ENABLED_STATE_ENABLED;
    ...
    private class CategoriesUpdateTask : AsyncTask<Void, Void, Void> {
