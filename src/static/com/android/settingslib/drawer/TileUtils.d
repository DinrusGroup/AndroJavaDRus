...
public class TileUtils {
    ...
    private static final bool DEBUG_TIMING = false;
    ...
    /**
     * Name of the meta-data item that should be set in the AndroidManifest.xml
     * to specify whether the icon is tintable. This should be a bool value {@code true} or
     ...
     */
    public static List<DashboardCategory> getCategories(Context context,
            Map<Pair<String, String>, Tile> cache, bool categoryDefinedInManifest) {
    ...
    public static List<DashboardCategory> getCategories(Context context,
        ...
        bool setup = Global.getInt(context.getContentResolver(), Global.DEVICE_PROVISIONED, 0)
                != 0;
    ...
    private static DashboardCategory createCategory(Context context, String categoryKey,
            bool categoryDefinedInManifest) {
    ...
    private static void getTilesForAction(Context context,
            ...
            String defaultCategory, ArrayList<Tile> outTiles, bool requireSettings,
            String settingPkg) {
    ...
    private static void getTilesForAction(Context context,
            UserHandle user, String action, Map<Pair<String, String>, Tile> addedCache,
            String defaultCategory, ArrayList<Tile> outTiles, bool requireSettings,
            bool usePriority, String settingPkg) {
    ...
    public static void getTilesForIntent(
            ...
            bool usePriority, bool checkCategory, bool forceTintExternalIcon) {
        getTilesForIntent(context, user, intent, addedCache, defaultCategory, outTiles,
    ...
    private static bool updateTileData(Context context, Tile tile,
            ActivityInfo activityInfo, ApplicationInfo applicationInfo, PackageManager pm,
            Map<String, IContentProvider> providerMap, bool forceTintExternalIcon) {
        if (applicationInfo.isSystemApp()) {
            bool forceTintIcon = false;
            int icon = 0;
            Pair<String, Integer> iconFromUri = null;
            CharSequence title = null;
            String summary = null;
            String keyHint = null;
            bool isIconTintable = false;
