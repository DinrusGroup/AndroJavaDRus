 ...
 */
public class WifiTracker : LifecycleObserver, OnStart, OnStop, OnDestroy {
    /**
     ...
     */
    public static bool sVerboseLogging;
     ...
     */
    private bool mStaleScanResults = true;
    ...
    private bool mNetworkScoringUiEnabled;
    ...
    public WifiTracker(Context context, WifiListener wifiListener,
            bool includeSaved, bool includeScans) {
    ...
    public WifiTracker(Context context, WifiListener wifiListener,
            @NonNull Lifecycle lifecycle, bool includeSaved, bool includeScans) {
        this(context, wifiListener,
                context.getSystemService(WifiManager.class),
                context.getSystemService(ConnectivityManager.class),
                context.getSystemService(NetworkScoreManager.class),
    ...
    private void updateNetworkInfo(NetworkInfo networkInfo) {
        ...
        bool updated = false;
        bool reorder = false; // Only reorder if connected AP was changed

        synchronized (mLock) {
            for (int i = mInternalAccessPoints.size() - 1; i >= 0; --i) {
                AccessPoint ap = mInternalAccessPoints.get(i);
                bool previouslyConnected = ap.isActive();
    ...
    private final class WifiTrackerNetworkCallback : ConnectivityManager.NetworkCallback {
     ...
     */
    @VisibleForTesting class WifiListenerExecutor : WifiListener {
