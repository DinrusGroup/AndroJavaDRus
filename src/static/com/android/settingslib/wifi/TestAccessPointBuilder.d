...
public class TestAccessPointBuilder {
    ...
    @Keep
    public TestAccessPointBuilder setActive(bool active) {
        if (active) {
    ...
    */
    @Keep
    public TestAccessPointBuilder setReachable(bool reachable) {
        if (reachable) {
    ...
    @Keep
    public TestAccessPointBuilder setSaved(bool saved){
        if (saved) {
             mNetworkId = 1;
        } else {
    ...
    public TestAccessPointBuilder setIsCarrierAp(bool isCarrierAp) {
