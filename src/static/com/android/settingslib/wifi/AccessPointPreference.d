...
public class AccessPointPreference : Preference {
    ...
    private bool mShowDivider;

    private bool mForSavedNetworks = false;
    ...
    AccessPointPreference(AccessPoint accessPoint, Context context, UserBadgeCache cache,
                          int iconResId, bool forSavedNetworks, StateListDrawable frictionSld,
    ...
    public bool shouldShowDivider() {
        return mShowDivider;
    }

    public void setShowDivider(bool showDivider) {
    ...
    @VisibleForTesting
    static void setTitle(AccessPointPreference preference, AccessPoint ap, bool savedNetworks) {
        if (savedNetworks) {
