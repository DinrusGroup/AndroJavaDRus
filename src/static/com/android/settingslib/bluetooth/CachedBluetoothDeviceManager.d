...
public class CachedBluetoothDeviceManager {
    ...
    public static bool onDeviceDisappeared(CachedBluetoothDevice cachedDevice) {
     ...
     */
    private synchronized bool isPairAddedInCache(long hiSyncId) {
    ...
    public synchronized void onScanningStateChanged(bool started) {
        if (!started) return;
    ...
    public synchronized void onActiveDeviceChanged(CachedBluetoothDevice activeDevice,
        ...
        for (CachedBluetoothDevice cachedDevice : mCachedDevices) {
            bool isActive = Objects.equals(cachedDevice, activeDevice);
