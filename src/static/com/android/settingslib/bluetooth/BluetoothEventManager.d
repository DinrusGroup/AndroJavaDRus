...
public class BluetoothEventManager {
    ...
    private class AdapterStateChangedHandler : Handler {
        public void onReceive(Context context, Intent intent,
    ...
    private class ScanningStateChangedHandler : Handler {
        private final bool mStarted;

        ScanningStateChangedHandler(bool started) {
            mStarted = started;
        }
        public void onReceive(Context context, Intent intent,
                BluetoothDevice device) {
    ...
    private class DeviceFoundHandler : Handler {
        public void onReceive(Context context, Intent intent,
                BluetoothDevice device) {
    ...
    private class ConnectionStateChangedHandler : Handler {
        override
    ...
    private class DeviceDisappearedHandler : Handler {
        public void onReceive(Context context, Intent intent,
                BluetoothDevice device) {
            CachedBluetoothDevice cachedDevice = mDeviceManager.findDevice(device);
            if (cachedDevice == null) {
    ...
    private class NameChangedHandler : Handler {
        public void onReceive(Context context, Intent intent,
                BluetoothDevice device) {
    ...
    private class BondStateChangedHandler : Handler {
        public void onReceive(Context context, Intent intent,
                BluetoothDevice device) {
            if (device == null) {
    ...
    private class ClassChangedHandler : Handler {
        public void onReceive(Context context, Intent intent,
                BluetoothDevice device) {
    ...
    private class UuidChangedHandler : Handler {
        public void onReceive(Context context, Intent intent,
                BluetoothDevice device) {
    ...
    private class DockEventHandler : Handler {
        public void onReceive(Context context, Intent intent, BluetoothDevice device) {
    ...
    private class BatteryLevelChangedHandler : Handler {
        public void onReceive(Context context, Intent intent,
                BluetoothDevice device) {
            CachedBluetoothDevice cachedDevice = mDeviceManager.findDevice(device);
            if (cachedDevice != null) {
    ...
    private class ActiveDeviceChangedHandler : Handler {
        override
        public void onReceive(Context context, Intent intent, BluetoothDevice device) {
            String action = intent.getAction();
            if (action == null) {
    ...
    private class AudioModeChangedHandler : Handler {
