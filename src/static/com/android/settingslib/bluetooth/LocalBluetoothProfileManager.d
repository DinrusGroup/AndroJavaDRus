...
public class LocalBluetoothProfileManager {
    ...
    private static final bool DEBUG = Utils.D;
    /** Singleton instance. */
    ...
    private final bool mUsePbapPce;
    private final bool mUseMapClient;
     ...
     */
    private class StateChangedHandler : BluetoothEventManager.Handler {
    ...
    private class HeadsetStateChangeHandler : StateChangedHandler {
    ...
    private class PanStateChangedHandler : StateChangedHandler {
    ...
    public synchronized bool isManagerReady() {
    ...
    synchronized void updateProfiles(ParcelUuid[] uuids, ParcelUuid[] localUuids,
            ...
            bool isPanNapConnected, BluetoothDevice device) {
