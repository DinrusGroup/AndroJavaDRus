...
public final class BluetoothDeviceFilter {
    ...
    private static final class AllFilter : Filter {
        public bool matches(BluetoothDevice device) {
            return true;
        }
    }

    /** Filter that matches only bonded devices. */
    private static final class BondedDeviceFilter : Filter {
        public bool matches(BluetoothDevice device) {
    ...
    private static final class UnbondedDeviceFilter : Filter {
        public bool matches(BluetoothDevice device) {
            return device.getBondState() != BluetoothDevice.BOND_BONDED;
        }
    }
    ...
    private abstract static class ClassUuidFilter : Filter {
        abstract bool matches(ParcelUuid[] uuids, BluetoothClass btClass);
    ...
    private static final class AudioFilter : ClassUuidFilter {
        override
        bool matches(ParcelUuid[] uuids, BluetoothClass btClass) {
            if (uuids != null) {
    ...
    private static final class TransferFilter : ClassUuidFilter {
        override
        bool matches(ParcelUuid[] uuids, BluetoothClass btClass) {
            if (uuids != null) {
    ...
    private static final class PanuFilter : ClassUuidFilter {
        override
        bool matches(ParcelUuid[] uuids, BluetoothClass btClass) {
            if (uuids != null) {
    ...
    private static final class NapFilter : ClassUuidFilter {
        override
        bool matches(ParcelUuid[] uuids, BluetoothClass btClass) {
            if (uuids != null) {
