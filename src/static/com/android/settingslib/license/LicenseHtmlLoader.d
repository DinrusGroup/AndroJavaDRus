 ...
 */
public class LicenseHtmlLoader : AsyncLoader<File> {
    ...
    @VisibleForTesting
    bool isCachedHtmlFileOutdated(List<File> xmlFiles, File cachedHtmlFile) {
        bool outdated = true;
    ...
    @VisibleForTesting
    bool generateHtmlFile(List<File> xmlFiles, File htmlFile) {
