...
public class HelpUtils {
    ...
    public static bool prepareHelpMenuItem(Activity activity, Menu menu, String helpUri,
    ...
    public static bool prepareHelpMenuItem(Activity activity, Menu menu, int helpUriResource,
            String backupContext) {
        MenuItem helpItem = menu.add(0, MENU_HELP, 0, R.string.help_feedback_label);
        helpItem.setIcon(R.drawable.ic_help_actionbar);
     ...
     */
    public static bool prepareHelpMenuItem(final Activity activity, MenuItem helpMenuItem,
