...
public class InputMethodAndSubtypeEnablerManager : Preference.OnPreferenceChangeListener {

    private final PreferenceFragment mFragment;

    private bool mHaveHardKeyboard;
    ...
    override
    public bool onPreferenceChange(final Preference pref, final Object newValue) {
        if (!(newValue instanceof Boolean)) {
            return true; // Invoke default behavior.
        }
        final bool isChecking = (Boolean) newValue;
    ...
    private bool isNoSubtypesExplicitlySelected(final String imiId) {
