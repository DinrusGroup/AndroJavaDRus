...
public class InputMethodAndSubtypeUtil {
    ...
    private static bool isInputMethodSubtypeSelected(ContentResolver resolver) {
    ...
    public static void saveInputMethodSubtypeList(PreferenceFragment context,
        ...
        bool needsToResetSelectedSubtype = false;
        for (final InputMethodInfo imi : inputMethodInfos) {
            ...
            final bool isImeChecked = (pref instanceof TwoStatePreference) ?
                    ((TwoStatePreference) pref).isChecked()
                    : enabledIMEsAndSubtypesMap.containsKey(imiId);
            final bool isCurrentInputMethod = imiId.equals(currentInputMethodId);
            final bool systemIme = InputMethodUtils.isSystemIme(imi);
    ...
    public static void loadInputMethodSubtypeList(final PreferenceFragment context,
        ...
        for (final InputMethodInfo imi : inputMethodInfos) {
            ...
            if (pref instanceof TwoStatePreference) {
                ...
                final bool isEnabled = enabledSubtypes.containsKey(imiId);
