 ...
 */
public class InputMethodPreference : RestrictedSwitchPreference : OnPreferenceClickListener,
    ...
    private final bool mHasPriorityInSorting;
    private final OnSavePreferenceListener mOnSaveListener;
    private final InputMethodSettingValuesWrapper mInputMethodSettingValues;
    private final bool mIsAllowedByOrganization;
    ...
    public InputMethodPreference(final Context context, final InputMethodInfo imi,
            final bool isImeEnabler, final bool isAllowedByOrganization,
    ...
    InputMethodPreference(final Context context, final InputMethodInfo imi,
            final CharSequence title, final bool isAllowedByOrganization,
            final OnSavePreferenceListener onSaveListener) {
        super(context);
        setPersistent(false);
        mImi = imi;
    ...
    override
    public bool onPreferenceChange(final Preference preference, final Object newValue) {
    ...
    override
    public bool onPreferenceClick(final Preference preference) {
    ...
    public void updatePreferenceViews() {
        final bool isAlwaysChecked = mInputMethodSettingValues.isAlwaysCheckedIme(
                mImi, getContext());
    ...
    private void setCheckedInternal(bool checked) {
    ...
    public int compareTo(final InputMethodPreference rhs, final Collator collator) {
        ...
        final bool emptyTitle = TextUtils.isEmpty(title);
        final bool rhsEmptyTitle = TextUtils.isEmpty(rhsTitle);
