...
public class ZoneGetter {
    ...
    public static List<Map<String, Object>> getZonesList(Context context) {
        ...
        final bool useExemplarLocationForLocalNames =
    ...
    private static bool shouldUseExemplarLocationForLocalNames(ZoneGetterData data,
        ...
        for (int i = 0; i < data.zoneCount; i++) {
            ...
            if (data.localZoneIds.contains(olsonId)) {
                ...
                final bool nameIsUnique = localZoneNames.add(displayName);
                if (!nameIsUnique) {
                    return true;
                }
            }
    ...
    private static CharSequence getTimeZoneDisplayName(ZoneGetterData data,
            TimeZoneNames timeZoneNames, bool useExemplarLocationForLocalNames, TimeZone tz,
            String olsonId) {
        final Date now = new Date();
        final bool isLocalZoneId = data.localZoneIds.contains(olsonId);
        final bool preferLongName = isLocalZoneId && !useExemplarLocationForLocalNames;
        String displayName;
    ...
    public static CharSequence getGmtOffsetText(TimeZoneFormat tzFormatter, Locale locale,
        ...
        int offsetMillis = tz.getOffset(now.getTime());
        final bool negative = offsetMillis < 0;
        ...
        bool isRtl = TextUtils.getLayoutDirectionFromLocale(locale) == View.LAYOUT_DIRECTION_RTL;
