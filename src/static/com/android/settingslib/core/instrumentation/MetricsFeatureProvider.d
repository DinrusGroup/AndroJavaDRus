...
public class MetricsFeatureProvider {
     ...
     * fragment has been visible.
     */
    public void action(VisibilityLoggerMixin visibilityLogger, int category, bool value) {
        for (LogWriter writer : mLoggerWriters) {
            writer.action(category, value,
                    sinceVisibleTaggedData(visibilityLogger.elapsedTimeSinceVisible()));
        }
    ...
    /** @deprecated use {@link #action(VisibilityLoggerMixin, int, bool)} */
    @Deprecated
    public void action(Context context, int category, bool value) {
        for (LogWriter writer : mLoggerWriters) {
            writer.action(context, category, value);
        }
    }
