...
public final class UserManagerHelper {
     ...
     *
     * @return {@bool true} if headless system user.
     */
    public bool isHeadlessSystemUser() {
     ...
     */
    public bool userIsSystemUser(UserInfo userInfo) {
     ...
     */
    public bool userCanBeRemoved(UserInfo userInfo) {
     ...
     */
    public bool userIsForegroundUser(UserInfo userInfo) {
     ...
     */
    public bool userIsRunningCurrentProcess(UserInfo userInfo) {
     ...
     */
    public bool foregroundUserIsGuestUser() {
     ...
     */
    public bool foregroundUserHasUserRestriction(String restriction) {
     ...
     */
    public bool foregroundUserCanAddUsers() {
     ...
     */
    public bool currentProcessRunningAsDemoUser() {
     ...
     */
    public bool currentProcessRunningAsGuestUser() {
     ...
     */
    public bool currentProcessRunningAsSystemUser() {
     ...
     */
    public bool currentProcessHasUserRestriction(String restriction) {
     ...
     */
    public bool currentProcessCanAddUsers() {
     ...
     */
    public bool currentProcessCanRemoveUsers() {
     ...
     */
    public bool currentProcessCanSwitchUsers() {
     ...
     */
    public bool currentProcessCanModifyAccounts() {
