...
public class AppRestrictionsHelper {
    ...
    private final bool mRestrictedProfile;
    private bool mLeanback;
    ...
    public bool isPackageSelected(String packageName) {
        return mSelectedPackages.get(packageName);
    }

    public void setLeanback(bool isLeanback) {
    ...
    public void applyUserAppsStates(OnDisableUiForPackageListener listener) {
        ...
        for (Map.Entry<String,Boolean> entry : mSelectedPackages.entrySet()) {
            ...
            bool enabled = entry.getValue();
            applyUserAppState(packageName, enabled, listener);
        }
    }

    public void applyUserAppState(String packageName, bool enabled,
    ...
    private static class AppLabelComparator : Comparator<SelectableAppInfo> {
