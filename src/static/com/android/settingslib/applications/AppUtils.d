...
public class AppUtils {
    ...
    public static CharSequence getLaunchByDefaultSummary(ApplicationsState.AppEntry appEntry,
        ...
        bool hasPreferred = hasPreferredActivities(pm, packageName)
    ...
    public static bool hasUsbDefaults(IUsbManager usbManager, String packageName) {
        try {
            if (usbManager != null) {
    ...
    public static bool hasPreferredActivities(PackageManager pm, String packageName) {
    ...
    /**
     * Returns a bool indicating whether the given package should be considered an instant app
     */
    public static bool isInstant(ApplicationInfo info) {
