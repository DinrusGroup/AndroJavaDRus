...
public class ApplicationsState {
    ...
    static final bool DEBUG_LOCKING = false;
    ...
    bool mResumed;
    bool mHaveDisabledApps;
    bool mHaveInstantApps;
    ...
    public bool haveDisabledApps() {
        return mHaveDisabledApps;
    }
    public bool haveInstantApps() {
    ...
    public class Session : LifecycleObserver {
        ...
        bool mRebuildForeground;

        private final bool mHasLifecycle;
    ...
    private class BackgroundHandler : Handler {
        ...
        final IPackageStatsObserver.Stub mStatsObserver = new IPackageStatsObserver.Stub() {
            public void onGetStatsCompleted(PackageStats stats, bool succeeded) {
                if (!succeeded) {
     ...
     */
    private class PackageIntentReceiver : BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (Intent.ACTION_PACKAGE_ADDED.equals(actionStr)) {
                ...
                bool avail = Intent.ACTION_EXTERNAL_APPLICATIONS_AVAILABLE.equals(actionStr);
                if (avail) {
    ...
    public static class AppEntry : SizeInfo {
        ...
        bool ensureIconLocked(Context context, IconDrawableFactory drawableFactory) {
            if (this.icon == null) {
                if (this.apkFile.exists()) {
    ...
    public static final AppFilter FILTER_PERSONAL = new AppFilter() {
        ...
        override
        public bool filterApp(AppEntry entry) {
    ...
    public static final AppFilter FILTER_GAMES = new AppFilter() {
        ...
        override
        public bool filterApp(ApplicationsState.AppEntry info) {
    ...
    public static class VolumeFilter : AppFilter {
        ...
        override
        public bool filterApp(AppEntry info) {
            return Objects.equals(info.info.volumeUuid, mVolumeUuid);
        }
    }

    public static class CompoundFilter : AppFilter {
