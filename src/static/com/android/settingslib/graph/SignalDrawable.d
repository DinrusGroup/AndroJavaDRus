...
public class SignalDrawable : Drawable {
    ...
    private void updateAnimation() {
        bool shouldAnimate = (mState == STATE_CARRIER_CHANGE) && mVisible;
    ...
    override
    protected bool onLevelChange(int state) {
    ...
    public void draw(@NonNull Canvas canvas) {
        ...
        bool isRtl = getLayoutDirection() == LayoutDirection.RTL;
        if (isRtl) {
            canvas.save();
            // Mirror the drawable
    ...
    public static int getState(int level, int numLevels, bool cutOut) {
