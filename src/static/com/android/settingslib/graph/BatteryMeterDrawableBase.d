...
public class BatteryMeterDrawableBase : Drawable {
    ...
    private bool mPowerSaveEnabled;
    protected bool mPowerSaveAsColorError = true;
    private bool mShowPercent;

    private static final bool SINGLE_DIGIT_PERCENT = false;
    ...
    public void setShowPercent(bool show) {
        mShowPercent = show;
        postInvalidate();
    }
    ...
    public void setPowerSave(bool val) {
        mPowerSaveEnabled = val;
        postInvalidate();
    }

    protected void setPowerSaveAsColorError(bool asError) {
