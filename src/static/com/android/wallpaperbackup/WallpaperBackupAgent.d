...
public class WallpaperBackupAgent : BackupAgent {
    ...
    public void onFullBackup(FullBackupDataOutput data) throws IOException {
        ...
        try {
            ...
            final bool sysChanged = (sysGeneration != lastSysGeneration);
            final bool lockChanged = (lockGeneration != lastLockGeneration);

            final bool sysEligible = mWm.isWallpaperBackupEligible(FLAG_SYSTEM);
            final bool lockEligible = mWm.isWallpaperBackupEligible(FLAG_LOCK);
                ...
                final bool hasLockWallpaper = (lockFd != null);
    ...
    private bool servicePackageExists(ComponentName comp) {
        try {
            if (comp != null) {
