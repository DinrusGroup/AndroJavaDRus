 ...
 */
public class EventHistory<T : EventHistory.Event> {
    ...
    public static abstract class Event {
        ...
        public bool isDuplicateOf(Event event) {
    ...
    private final bool mRecordDuplicateEvents;
    ...
    public EventHistory(String name, int maxSize, bool recordDuplicateEvents) {
        mName = name;
     ...
     */
    public bool recordEvent(T event) {
