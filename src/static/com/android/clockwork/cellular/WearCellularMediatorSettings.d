...
public class WearCellularMediatorSettings : SignalDetectorSettings {
    ...
    private final bool mCellAutoEnabled;
    ...
    override
    public bool getMobileSignalDetectorAllowed() {
        ...
        bool signalDetectorAllowedKeyValue =
     ...
     */
    public bool shouldTurnCellularOffDuringPowerSave() {
    ...
    private bool shouldDisableForCurrentOperator() {
    ...
    public int getRadioOnState() {
        ...
        try {
            ...
            if (telephony != null) {
                bool isRadioOn = telephony.isRadioOnForSubscriber(subId,
