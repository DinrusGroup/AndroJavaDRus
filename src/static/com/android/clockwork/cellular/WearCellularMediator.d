 ...
 */
public class WearCellularMediator :
    ...
    private bool mIsInTelephonyCall;
    ...
    public class CellDecision : EventHistory.Event {
    ...
    private bool isServiceStatePowerToggle(int serviceState) {
    ...
    public void updateProxyConnected(bool isProxyConnected) {
    ...
    public void updateDetectorState(bool signalDetectorAllowed) {
    ...
    private class RadioPowerHandler : Handler {
        ...
        public void handleMessage(Message msg) {
            ...
            bool enable = (msg.what == MSG_ENABLE_CELL);
