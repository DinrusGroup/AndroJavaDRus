 ...
 */
public class CompanionProxyShard : Closeable {
    ...
    private static final bool IS_CONNECTED = true;
    private static final bool IS_DISCONNECTED = !IS_CONNECTED;
    private static final bool PHONE_WITH_INTERNET = true;
    private static final bool PHONE_NO_INTERNET = !PHONE_WITH_INTERNET;

    private static int sInstance;
    /** An async disconnect request is outstanding and waiting for a JNI response */
    private static bool sWaitingForAsyncDisconnectResponse;

    static native void classInitNative();
    @VisibleForTesting native bool connectNative(int fd);
    @VisibleForTesting native bool disconnectNative();
    ...
    private bool mIsSysproxyConnected;
    private bool mIsMetered;
    private bool mIsConnected;
    private bool mPhoneNoInternet;
    ...
    @VisibleForTesting bool mIsClosed;
    ...
    public interface Listener {
        void onProxyConnectionChange(bool isConnected, int proxyScore, bool phoneNoInternet);
    }
    ...
    private void connectNativeInBackground(Integer fd) {
        ...
        new PassSocketAsyncTask() {
            ...
            protected Boolean doInBackgroundDefaultPriority(Integer fileDescriptor) {
                ...
                final bool rc = connectNative(fd);
     ...
     */
    @MainThread
    private void notifyConnectionChange(final bool isConnected) {
        DebugAssert.isMainThread();
        notifyConnectionChange(isConnected, false);
    }

    @MainThread
    private void notifyConnectionChange(final bool isConnected, final bool phoneNoInternet) {
        DebugAssert.isMainThread();
    ...
    private abstract static class PassSocketAsyncTask : AsyncTask<Integer, Void, Boolean> {
        override
