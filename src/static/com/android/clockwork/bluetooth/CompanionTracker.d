...
public class CompanionTracker {
     ...
     */
    public bool isCompanionBle() {
        if (mCompanion == null) {
            return false;
        }

        bool deviceIsBle = mCompanion.getType() == BluetoothDevice.DEVICE_TYPE_LE
        ...
        bool legacyModeIsBle = (legacyBtMode == BLUETOOTH_MODE_ALT);
     ...
     */
    private bool updateCompanionDevice(String newDeviceAddr) {
        if (mBtAdapter == null) {
            return false;
        }
