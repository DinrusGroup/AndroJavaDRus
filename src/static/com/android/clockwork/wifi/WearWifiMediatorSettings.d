...
public class WearWifiMediatorSettings {
    ...
    interface Listener {
        ...
        void onInWifiSettingsMenuChanged(bool inWifiSettingsMenu);
        void onEnableWifiWhileChargingChanged(bool enableWifiWhileCharging);
        void onDisableWifiMediatorChanged(bool disableWifiMediator);
        void onHardwareLowPowerModeChanged(bool inHardwareLowPowerMode);
        void onWifiOnWhenProxyDisconnectedChanged(bool wifiOnWhenProxyDisconnected);
    }
    ...
    final class SettingsObserver : ContentObserver {
        ...
        public void onChange(bool selfChange, Uri uri) {
            ...
            if (uri.equals(Settings.System.getUriFor(WIFI_SETTING_KEY))) {
                ...
                bool inWifiSettings = getInWifiSettings();
                ...
                bool enableWhileCharging = getEnableWifiWhileCharging();
                ...
                bool disableWifiMediator = getDisableWifiMediator();
                ...
                bool hardwareLowPowerMode = getHardwareLowPowerMode();
                ...
                bool isAirplaneModeOn = getIsInAirplaneMode();
                ...
                bool wifiOnWhenProxyDisconnected = getWifiOnWhenProxyDisconnected();
    ...
    public bool getWifiOnWhenProxyDisconnected() {
        return Settings.Global.getInt(mContentResolver,
                Settings.Global.WIFI_ON_WHEN_PROXY_DISCONNECTED, 1) == 1;
    }

    public bool getIsInAirplaneMode() {
