...
public class WearWifiMediator :
    ...
    private bool mInWifiSettings = false;
    private bool mEnableWifiWhenCharging;

    private bool mWifiDesired;
    private bool mWifiConnected = false;
    private bool mWifiLingering = false;

    private bool mInHardwareLowPowerMode;
    private bool mIsProxyConnected;

    private int mNumUnmeteredRequests = 0;
    private int mNumHighBandwidthRequests = 0;
    private int mNumWifiRequests = 0;

    private bool mActivityMode = false;

    private int mNumConfiguredNetworks = 0;
    private bool mDisableWifiMediator = false;

    private bool mWifiOnWhenProxyDisconnected = true;
    ...
    public class WifiDecision : EventHistory.Event {
    ...
    public void onBootCompleted(bool proxyConnected) {
    ...
    public void updateProxyConnected(bool proxyConnected) {
        mIsProxyConnected = proxyConnected;
    ...
    public void updateActivityMode(bool activityMode) {
    ...
    private void setWifiDecision(bool wifiDesired, WifiDecisionReason reason) {
     ...
     */
    private bool shouldSkipWifiLingering(WifiDecisionReason reason) {
     ...
     */
    private bool connectivityServiceWantsWifi() {
        ...
        public void onReceive(Context context, Intent intent) {
            switch (intent.getAction()) {
                case WifiManager.CONFIGURED_NETWORKS_CHANGED_ACTION:
                    bool multipleNetworksChanged = intent.getBooleanExtra(
                ...
                case WifiManager.NETWORK_STATE_CHANGED_ACTION:
                    ...
                    bool prevConnectedState = mWifiConnected;
