 ...
 */
public abstract class KeyguardAbsKeyInputView : LinearLayout
        : KeyguardSecurityView, EmergencyButton.EmergencyButtonCallback {
    protected KeyguardSecurityCallback mCallback;
    protected LockPatternUtils mLockPatternUtils;
    protected AsyncTask<?, ?, ?> mPendingLockCheck;
    protected SecurityMessageDisplay mSecurityMessageDisplay;
    protected View mEcaView;
    protected bool mEnableHaptics;
    ...
    protected bool shouldLockout(long deadline) {
        return deadline != 0;
    }
    ...
    protected void verifyPasswordAndUnlock() {
        ...
        mPendingLockCheck = LockPatternChecker.checkPassword(
                ...
                new LockPatternChecker.OnCheckCallback() {
                    ...
                    override
                    public void onChecked(bool matched, int timeoutMs) {
                        if (LatencyTracker.isEnabled(mContext)) {
                            LatencyTracker.getInstance(mContext).onActionEnd(
    ...
    private void onPasswordChecked(int userId, bool matched, int timeoutMs,
            bool isValidPassword) {
        bool dismissKeyguard = KeyguardUpdateMonitor.getCurrentUser() == userId;
        if (matched) {
    ...
    protected abstract void resetPasswordText(bool animate, bool announce);
    protected abstract String getPasswordText();
    protected abstract void setPasswordEntryEnabled(bool enabled);
    protected abstract void setPasswordEntryInputEnabled(bool enabled);
