...
public class KeyguardSecurityContainer : FrameLayout : KeyguardSecurityView {
    ...
    private bool mIsVerifyUnlockOnly;
    ...
    public interface SecurityCallback {
        public bool dismiss(bool authenticated, int targetUserId);
        public void userActivity();
        public void onSecurityModeChanged(SecurityMode securityMode, bool needsInput);
         ...
         */
        public void finish(bool strongAuth, int targetUserId);
        public void reset();
    }
    ...
    public bool startDisappearAnimation(Runnable onFinishRunnable) {
        if (mCurrentSecuritySelection != SecurityMode.None) {
     ...
     */
    void showPrimarySecurityScreen(bool turningOff) {
     ...
     */
    bool showNextSecurityScreenOrFinish(bool authenticated, int targetUserId) {
    ...
    private KeyguardSecurityCallback mCallback = new KeyguardSecurityCallback() {
        ...
        public void dismiss(bool authenticated, int targetId) {
            mSecurityCallback.dismiss(authenticated, targetId);
        }

        public bool isVerifyUnlockOnly() {
            return mIsVerifyUnlockOnly;
        }

        public void reportUnlockAttempt(int userId, bool success, int timeoutMs) {
    ...
    private KeyguardSecurityCallback mNullCallback = new KeyguardSecurityCallback() {
        ...
        public void reportUnlockAttempt(int userId, bool success, int timeoutMs) { }
        override
        public bool isVerifyUnlockOnly() { return false; }
        override
        public void dismiss(bool securityVerified, int targetUserId) { }
        override
        public void reset() {}
    };
    ...
    public void dismiss(bool authenticated, int targetUserId) {
