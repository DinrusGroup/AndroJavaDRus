 ...
 */
public class KeyguardSliceView : LinearLayout : View.OnClickListener,
    ...
    public static class Row : LinearLayout {
        ...
        public void setDarkAmount(float darkAmount) {
            bool isAwake = darkAmount != 0;
            bool wasAwake = mDarkAmount != 0;
            if (isAwake == wasAwake) {
                return;
            }
            mDarkAmount = darkAmount;
     ...
     */
    @VisibleForTesting
    static class KeyguardSliceButton : Button :
        ...
        private void updatePadding() {
            bool hasText = !TextUtils.isEmpty(getText());
     ...
     */
    static class TitleView : AlphaOptimizedTextView {
        ...
        protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
            ...
            bool ellipsizing = layout.getEllipsisCount(lineCount - 1) != 0;
    ...
    private class SliceViewTransitionListener : LayoutTransition.TransitionListener {
        override
