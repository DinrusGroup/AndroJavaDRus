 ...
 * changed
 */
public class PasswordTextView : View {
    ...
    public void reset(bool animated, bool announce) {
        CharSequence textbefore = getTransformedText();
        mText = "";
        int length = mTextChars.size();
    ...
    private class CharState {
        ...
        bool textAnimationIsGrowing;
        Animator dotAnimator;
        bool dotAnimationIsGrowing;
        ValueAnimator widthAnimator;
        bool widthAnimationIsGrowing;
        float currentTextSizeFactor;
        float currentDotSizeFactor;
        float currentWidthFactor;
        bool isDotSwapPending;
        ...
        private ValueAnimator.AnimatorUpdateListener textSizeUpdater
            ...
            override
            public void onAnimationUpdate(ValueAnimator animation) {
                bool textVisibleBefore = isCharVisibleForA11y();
        ...
        void startRemoveAnimation(long startDelay, long widthDelay) {
            bool dotNeedsAnimation = (currentDotSizeFactor > 0.0f && dotAnimator == null)
                    || (dotAnimator != null && dotAnimationIsGrowing);
            bool textNeedsAnimation = (currentTextSizeFactor > 0.0f && textAnimator == null)
                    || (textAnimator != null && textAnimationIsGrowing);
            bool widthNeedsAnimation = (currentWidthFactor > 0.0f && widthAnimator == null)
        ...
        void startAppearAnimation() {
            bool dotNeedsAnimation = !mShowPassword
                    && (dotAnimator == null || !dotAnimationIsGrowing);
            bool textNeedsAnimation = mShowPassword
                    && (textAnimator == null || !textAnimationIsGrowing);
            bool widthNeedsAnimation = (widthAnimator == null || !widthAnimationIsGrowing);
            if (dotNeedsAnimation) {
        ...
        public float draw(Canvas canvas, float currentDrawPosition, int charHeight, float yPosition,
                float charLength) {
            bool textVisible = currentTextSizeFactor > 0;
            bool dotVisible = currentDotSizeFactor > 0;
        ...
        public bool isCharVisibleForA11y() {
            ...
            bool textIsGrowing = textAnimator != null && textAnimationIsGrowing;
