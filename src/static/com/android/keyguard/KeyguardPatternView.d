...
public class KeyguardPatternView : LinearLayout : KeyguardSecurityView,
    ...
    private class UnlockPatternListener : LockPatternView.OnPatternListener {
        ...
        private void onPatternChecked(int userId, bool matched, int timeoutMs,
                bool isValidPattern) {
    ...
    override
    public bool startDisappearAnimation(final Runnable finishRunnable) {
    ...
    private void enableClipping(bool enable) {
    ...
    public void createAnimation(final LockPatternView.CellState animatedCell, long delay,
            long duration, float translationY, final bool appearing,
