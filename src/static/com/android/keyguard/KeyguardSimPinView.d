 ...
 */
public class KeyguardSimPinView : KeyguardPinBasedInputView {
    private static final String LOG_TAG = "KeyguardSimPinView";
    private static final bool DEBUG = KeyguardConstants.DEBUG_SIM_STATES;
    ...
    private bool mShowDefaultMessage = true;
    ...
    public void resetState() {
        ...
        bool isEsimLocked = KeyguardEsimArea.isEsimLocked(mContext, mSubId);
    ...
    private String getPinPasswordErrorMessage(int attemptsRemaining, bool isDefault) {
     ...
     * with a callback.
     */
    private abstract class CheckSimPin : Thread {
