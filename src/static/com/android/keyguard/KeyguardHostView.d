 ...
 * showing.
 */
public class KeyguardHostView : FrameLayout : SecurityCallback {
    ...
    private final KeyguardUpdateMonitorCallback mUpdateCallback =
        ...
        public void onTrustGrantedWithFlags(int flags, int userId) {
            ...
            bool bouncerVisible = isVisibleToUser();
    ...
    private static final bool KEYGUARD_MANAGES_VOLUME = false;
    public static final bool DEBUG = KeyguardConstants.DEBUG;
     ...
     */
    public bool dismiss(int targetUserId) {
    ...
    public bool shouldEnableMenuKey() {
        final Resources res = getResources();
        final bool configDisabled = res.getBoolean(R.bool.config_disableMenuKeyInLockScreen);
        final bool isTestHarness = ActivityManager.isRunningInTestHarness();
        final bool fileOverride = (new File(ENABLE_MENU_KEY_FILE)).exists();
