...
public class KeyguardStatusView : GridLayout :
    ...
    private void setEnableMarquee(bool enabled) {
    ...
    private void setEnableMarqueeImpl(bool enabled) {
    ...
    protected void onFinishInflate() {
        ...
        bool shouldMarquee = KeyguardUpdateMonitor.getInstance(mContext).isDeviceInteractive();
    ...
    private void onSliceContentChanged() {
        bool smallClock = mKeyguardSlice.hasHeader() || mPulsing;
    ...
    public void onLayoutChange(View view, int left, int top, int right, int bottom,
        ...
        bool hasHeader = mKeyguardSlice.hasHeader();
        bool smallClock = hasHeader || mPulsing;
        long duration = KeyguardSliceView.DEFAULT_ANIM_DURATION;
        long delay = smallClock ? 0 : duration / 4;

        bool shouldAnimate = mKeyguardSlice.getLayoutTransition() != null
        ...
        if (view == mClockView) {
            ...
            bool hasSeparator = hasHeader && !mPulsing;
            float alpha = hasSeparator ? 1 : 0;
            mClockSeparator.animate().cancel();
            if (shouldAnimate) {
                bool isAwake = mDarkAmount != 0;
    ...
    private void updateOwnerInfo() {
        ...
        if (info == null) {
            ...
            final bool ownerInfoEnabled = mLockPatternUtils.isOwnerInfoEnabled(
    ...
    private void updateDark() {
        bool dark = mDarkAmount == 1;
        if (mLogoutView != null) {
            mLogoutView.setAlpha(dark ? 0 : 1);
        }

        if (mOwnerInfo != null) {
            bool hasText = !TextUtils.isEmpty(mOwnerInfo.getText());
    ...
    public void setPulsing(bool pulsing, bool animate) {
        mPulsing = pulsing;
    ...
    private class ClipChildrenAnimationListener : AnimatorListenerAdapter :
