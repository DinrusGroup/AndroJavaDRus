...
/**
 * This class : a smart emergency button that updates itself based
...
public class EmergencyButton : Button {
    ...
    private bool mLongPressWasDragged;
    ...
    private final bool mIsVoiceCapable;
    private final bool mEnableEmergencyCallWhileSimLocked;
    ...
    private void updateEmergencyCallButton() {
        ...
        if (mIsVoiceCapable) {
            ...
            if (isInCall()) {
                ...
                final bool simLocked = KeyguardUpdateMonitor.getInstance(mContext)
                        .isSimPinVoiceSecure();
                if (simLocked) {
