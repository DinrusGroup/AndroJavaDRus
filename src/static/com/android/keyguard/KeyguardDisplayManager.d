...
public class KeyguardDisplayManager {
    ...
    private static bool DEBUG = KeyguardConstants.DEBUG;
    ...
    protected void updateDisplays(bool showing) {
        Presentation originalPresentation = mPresentation;
        if (showing) {
            MediaRouter.RouteInfo route = mMediaRouter.getSelectedRoute(
                    MediaRouter.ROUTE_TYPE_REMOTE_DISPLAY);
            bool useDisplay = route != null
    ...
    private final static class KeyguardPresentation : Presentation {
