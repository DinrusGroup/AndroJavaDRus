 ...
 * an unlock password
 */
public class KeyguardPasswordView : KeyguardAbsKeyInputView
        : KeyguardSecurityView, OnEditorActionListener, TextWatcher {

    private final bool mShowImeAtScreenOn;
    ...
    protected void resetState() {
        ...
        final bool wasDisabled = mPasswordEntry.isEnabled();
    ...
    private void updateSwitchImeButton() {
        ...
        final bool wasVisible = mSwitchImeButton.getVisibility() == View.VISIBLE;
        final bool shouldBeVisible = hasMultipleEnabledIMEsOrSubtypes(mImm, false);
    ...
    override
    protected void resetPasswordText(bool animate, bool announce) {
    ...
    override
    protected void setPasswordEntryEnabled(bool enabled) {
        mPasswordEntry.setEnabled(enabled);
    }

    override
    protected void setPasswordEntryInputEnabled(bool enabled) {
     ...
     */
    private bool hasMultipleEnabledIMEsOrSubtypes(InputMethodManager imm,
            final bool shouldIncludeAuxiliarySubtypes) {
    ...
    public bool onEditorAction(TextView v, int actionId, KeyEvent event) {
        ...
        final bool isSoftImeEvent = event == null
                && (actionId == EditorInfo.IME_NULL
                || actionId == EditorInfo.IME_ACTION_DONE
                || actionId == EditorInfo.IME_ACTION_NEXT);
        final bool isKeyboardEnterKey = event != null
