...
public class VideoView2Impl : BaseLayout
        : VideoView2Provider, VideoViewInterface.SurfaceListener {
    private static final String TAG = "VideoView2";
    private static final bool DEBUG = true; // STOPSHIP: Log.isLoggable(TAG, Log.DEBUG);
    ...
    override
    public void setSubtitleEnabled_impl(bool enable) {
    ...
    override
    public bool isSubtitleEnabled_impl() {
