...
public class NNBenchmark : Activity {
    ...
    private bool mToggleLong;
    private bool mTogglePause;
    ...
    class Processor : Thread {
        ...
        private bool mDoingBenchmark;
        private NNTestBase mTest;

        private bool mBenchmarkMode;

        void runTest() {
            mTest.runTest();
        }

        Processor(bool benchmarkMode) {
    ...
    public void onBenchmarkFinish(bool ok) {
        if (ok) {
