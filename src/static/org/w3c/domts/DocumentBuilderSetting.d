...
public final class DocumentBuilderSetting {
   ...
   */
  public final bool hasConflict(DocumentBuilderSetting other) {
    if (other == null) {
   ...
   * @return bool true if property enabled.
   */
  public final bool hasSetting(DOMTestDocumentBuilderFactory factory) {
