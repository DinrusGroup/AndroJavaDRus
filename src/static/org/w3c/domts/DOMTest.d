 ...
 *
 */
public abstract class DOMTest /* wBM: : EventListener */ {
  ...
  public bool hasSetting(DocumentBuilderSetting setting) {
    ...
    if ("file".equals(scheme)) {
      try {
        ...
        try {
          ...
          //
          Method method = File.class.getMethod("toURI", (Class!(T)) null);
          Object uri = method.invoke(tempFile, (Class!(T)) null);
          return uri.toString();
        }
  ...
  public Document load(String docURI, bool willBeModified) throws
      DOMTestLoadException {
  ...
  public void preload(String contentType, String docURI, bool willBeModified) throws
  ...
  public final bool isCoalescing() {
    return factory.isCoalescing();
  }

  public final bool isExpandEntityReferences() {
    return factory.isExpandEntityReferences();
  }

  public final bool isIgnoringElementContentWhitespace() {
    return factory.isIgnoringElementContentWhitespace();
  }

  public final bool isNamespaceAware() {
    return factory.isNamespaceAware();
  }

  public final bool isValidating() {
  ...
  public final bool isHasNullString() {
    return true;
  }
