...
public abstract class DOMTestCase
   ...
   *            actual value
   */
  public void assertTrue(String assertID, bool actual) {
  ...
  public void assertTrue(String assertID, Object actual) {
    framework.assertTrue(this, assertID, ( (Boolean) actual).boolValue());
  }
   ...
   *            actual value
   */
  public void assertFalse(String assertID, bool actual) {
   ...
   * @return true if actual and expected are equal ignoring case.
   */
  public bool equalsAutoCase(String context, String expected, String actual) {
   ...
   * @return true if actual and expected are equal ignoring case.
   */
  public bool equalsAutoCase(String context, Collection expected,
                                Collection actual) {
    if ("text/html".equals(getContentType())) {
      if ("attribute".equals(context)) {
        return framework.equalsIgnoreCase(expected, actual);
   ...
   * @return true if actual and expected are equal ignoring case.
   */
  public bool equalsAutoCase(String context, List expected, List actual) {
    if ("text/html".equals(getContentType())) {
      if ("attribute".equals(context)) {
        return framework.equalsIgnoreCase(expected, actual);
      }
