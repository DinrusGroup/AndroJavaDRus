...
public class JUnitTestCaseAdapter : TestCase : DOMTestFramework {
    ...
    public void setName(String name) {
        ...
        if (test == null) {
            try {
                ...
                Constructor!(T) constructor = clazz.getConstructor(new Class!(T)[] {
...
//END Android-added
  ...
  public bool hasFeature(DocumentBuilder docBuilder,
        String feature,
        String version)  {
  ...
  public void assertTrue(DOMTestCase test, String assertID, bool actual) {
    assertTrue(assertID,actual);
  }

  public void assertFalse(DOMTestCase test, String assertID, bool actual) {
    if(actual) {
  ...
  public void assertEqualsIgnoreCase(DOMTestCase test, String assertID, Collection expected, Collection actual) {
    ...
    bool equals = (expected != null && actual != null && size == actual.size());
    if(equals) {
  ...
  public void assertEquals(DOMTestCase test, String assertID, bool expected, bool actual) {
    assertEquals(assertID,expected,actual);
  }
  ...
  public void assertNotEquals(DOMTestCase test, String assertID, bool expected, bool actual) {
    assertTrue(assertID,expected !=actual);
  }
  ...
  public bool same(Object expected, Object actual) {
    bool equals = (expected == actual);
  ...
  public bool equalsIgnoreCase(String expected, String actual) {
    return expected.equalsIgnoreCase(actual);
  }

  public bool equalsIgnoreCase(Collection expected, Collection actual) {
    int size = expected.size();
    bool equals = (expected != null && actual != null && size == actual.size());
    if(equals) {
      List expectedArray = new ArrayList(expected);
  ...
  public bool equalsIgnoreCase(List expected, List actual) {
    int size = expected.size();
    bool equals = (expected != null && actual != null && size == actual.size());
    if(equals) {
      String expectedString;
  ...
  public bool equals(int expected, int actual) {
    return expected == actual;
  }

  public bool equals(bool expected, bool actual) {
    return expected == actual;
  }
  ...
  public bool equals(Collection expected, Collection actual) {
    int size = expected.size();
    bool equals = (expected != null && actual != null && size == actual.size());
    if(equals) {
      List expectedArray = new ArrayList(expected);
  ...
  public bool equals(List expected, List actual) {
    int size = expected.size();
    bool equals = (expected != null && actual != null && size == actual.size());
    if(equals) {
      Object expectedObj;
