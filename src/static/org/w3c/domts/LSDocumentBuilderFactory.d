...
/**
 *   This class : the generic parser and configuation
...
public class LSDocumentBuilderFactory
  ...
  private static abstract class LSStrategy {
     ...
     */
    public abstract bool hasSetting(Object parser);
  ...
  private static class LSFixedStrategy
     ...
     */
    public LSFixedStrategy(bool fixedValue) {
     ...
     */
    public bool hasSetting(Object parser) {
      return fixedValue;
    }
  }
  ...
  private static class LSParameterStrategy
     ...
     */
    public LSParameterStrategy(String lsParameter, bool inverse) {
    ...
    public bool hasSetting(Object parser) {
      try {
        if (inverse) {
          return! ( (Boolean) getParameter(parser, lsParameter)).boolValue();
        }
        else {
          return ( (Boolean) getParameter(parser, lsParameter)).boolValue();
        }
  ...
  public LSDocumentBuilderFactory(DocumentBuilderSetting[] settings) throws
    ...
    try {
      ...
      Method newInstanceMethod = domImplRegistryClass.getMethod("newInstance", (Class!(T)) null);
      Object domRegistry = newInstanceMethod.invoke(null, (Class!(T)) null);
      ...
      parser = createLSParserMethod.invoke(impl,
                                           new Object[] {new Short( cast(short) 1), null});
  ...
  private bool hasProperty(String parameter) {
    try {
