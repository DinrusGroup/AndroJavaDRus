...
public class LambdaTestHelpers {
    ...
    public static<V, T, R> Function<V, R> compose(Function<? super T, ? : R> after, Function<? super V, ? : T> before) {
    ...
    public static<T : Comparable<? super T>> void assertSorted(Iterator<T> i) {
    ...
    public static<T : Comparable<? super T>> void assertSorted(Iterable<T> iter) {
    ...
    public static <T, S : BaseStream<T, S>>
