...
public final class CollectorOps {
    ...
    public static class StatefulCollector<E_IN> : StatefulTestOp<E_IN> {
        ...
        override
        public Sink<E_IN> opWrapSink(int flags, bool parallel, Sink<E_IN> sink) {
            return sink;
        }
    ...
    public static class TestParallelSizedOp<T> : StatefulCollector<T> {
        ...
        public static class OfInt : TestParallelSizedOp<Integer> {
            public OfInt() {
                super(StreamShape.INT_VALUE);
            }
        }

        public static class OfLong : TestParallelSizedOp<Long> {
            public OfLong() {
                super(StreamShape.LONG_VALUE);
            }
        }

        public static class OfDouble : TestParallelSizedOp<Double> {
            public OfDouble() {
