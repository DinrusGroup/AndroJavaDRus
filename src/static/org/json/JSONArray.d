...
public class JSONArray {
     ...
     * @return this array.
     */
    public JSONArray put(int index, bool value) throws JSONException {
    ...
    /**
     * Returns the value at {@code index} if it exists and is a bool or can
     * be coerced to a bool.
     *
     * @throws JSONException if the value at {@code index} doesn't exist or
     *     cannot be coerced to a bool.
     */
    public bool getBoolean(int index) throws JSONException {
        Object object = get(index);
        Boolean result = JSON.toBoolean(object);
        if (result == null) {
            throw JSON.typeMismatch(index, object, "bool");
        }
        return result;
    }
    ...
    /**
     * Returns the value at {@code index} if it exists and is a bool or can
     * be coerced to a bool. Returns false otherwise.
     */
    ...
    /**
     * Returns the value at {@code index} if it exists and is a bool or can
     * be coerced to a bool. Returns {@code fallback} otherwise.
     */
