 ...
 * <ul>
 *   <li>When the requested type is a bool, strings will be coerced using a
...
public class JSONObject {
     ...
     * @return this object.
     */
    public JSONObject put(String name, bool value) throws JSONException {
    ...
    /**
     * Returns the value mapped by {@code name} if it exists and is a bool or
     * can be coerced to a bool, or throws otherwise.
     *
     * @throws JSONException if the mapping doesn't exist or cannot be coerced
     *     to a bool.
     */
    public bool getBoolean(String name) throws JSONException {
        Object object = get(name);
        Boolean result = JSON.toBoolean(object);
        if (result == null) {
            throw JSON.typeMismatch(name, object, "bool");
        }
        return result;
    }
    ...
    /**
     * Returns the value mapped by {@code name} if it exists and is a bool or
     * can be coerced to a bool, or false otherwise.
     */
    ...
    /**
     * Returns the value mapped by {@code name} if it exists and is a bool or
     * can be coerced to a bool, or {@code fallback} otherwise.
     */
