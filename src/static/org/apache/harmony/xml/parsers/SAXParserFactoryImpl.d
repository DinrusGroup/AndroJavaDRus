...
public class SAXParserFactoryImpl : SAXParserFactory {
    ...
    override
    public bool getFeature(String name) throws SAXNotRecognizedException {
        if (name == null) {
    ...
    override
    public void setFeature(String name, bool value) throws SAXNotRecognizedException {
        if (name == null) {
            throw new NullPointerException("name == null");
        }
    ...
    override
    public void setNamespaceAware(bool value) {
        try {
    ...
    override
    public void setValidating(bool value) {
        try {
