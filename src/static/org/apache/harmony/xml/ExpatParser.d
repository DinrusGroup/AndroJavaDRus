...
class ExpatParser {
    ...
    private bool inStartElement = false;
    ...
    /*package*/ ExpatParser(String encoding, ExpatReader xmlReader,
            bool processNamespaces, String publicId, String systemId) {
     ...
     */
    private native long initialize(String encoding, bool namespacesEnabled);
    ...
    private native void appendString(long pointer, String xml, bool isFinal)
     ...
     */
    private static class ClonedAttributes : ExpatAttributes {
    ...
    private class ExpatLocator : Locator {
     ...
     */
    private class CurrentAttributes : ExpatAttributes {
     ...
     */
    private static class ParseException : SAXParseException {
     ...
     */
    private static class EntityParser : ExpatParser {
