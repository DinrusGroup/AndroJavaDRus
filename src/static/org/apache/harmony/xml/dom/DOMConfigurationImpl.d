 ...
 */
public final class DOMConfigurationImpl : DOMConfiguration {
    ...
    static {
        ...
        PARAMETERS.put("error-handler", new Parameter() {
            ...
            public bool canSet(DOMConfigurationImpl config, Object value) {
    ...
    private bool cdataSections = true;
    private bool comments = true;
    private bool datatypeNormalization = false;
    private bool entities = true;
    private DOMErrorHandler errorHandler;
    private bool namespaces = true;
    private String schemaLocation;
    private String schemaType;
    private bool splitCdataSections = true;
    ...
    interface Parameter {
        ...
        bool canSet(DOMConfigurationImpl config, Object value);
    }

    static class FixedParameter : Parameter {
    ...
    static abstract class BooleanParameter : Parameter {
        public bool canSet(DOMConfigurationImpl config, Object value) {
     ...
     * in XML documents.
     */
    private bool isValid(CharSequence text) {
        for (int i = 0; i < text.length(); i++) {
            char c = text.charAt(i);
            // as defined by http://www.w3.org/TR/REC-xml/#charsets.
            bool valid = c == 0x9 || c == 0xA || c == 0xD
                    || (c >= 0x20 && c <= 0xd7ff)
                    || (c >= 0xe000 && c <= 0xfffd);
            if (!valid) {
                return false;
