...
public abstract class NodeImpl : Node {
    ...
    public final Node cloneNode(bool deep) {
     ...
     */
    static String validatePrefix(String prefix, bool namespaceAware, String namespaceURI) {
        if (!namespaceAware) {
     ...
     */
    bool isPrefixMappedToUri(String prefix, String uri) {
        if (prefix == null) {
            return false;
        }
    ...
    public final bool isDefaultNamespace(String namespaceURI) {
    ...
    public final bool isEqualNode(Node arg) {
        if (arg == this) {
            return true;
        }
    ...
    private bool namedNodeMapsEqual(NamedNodeMap a, NamedNodeMap b) {
