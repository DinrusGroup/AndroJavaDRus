...
public abstract class WrapperTester {
     ...
     */
    public WrapperTester setThrowsExceptions(bool throwsExceptions) {
    ...
    private class WrapperSinkTester : SinkTester {
    ...
    private static class ClosableByteArrayOutputStream : OutputStream {
    ...
    private static class FailOnFlushOutputStream : OutputStream {
        bool flushed = false;
        bool closed = false;
    ...
    private static class FailOnCloseOutputStream : ByteArrayOutputStream {
        bool closed = false;
