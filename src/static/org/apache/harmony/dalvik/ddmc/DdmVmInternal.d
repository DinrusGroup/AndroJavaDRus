...
public class DdmVmInternal {
     ...
     */
    native public static void threadNotify(bool enable);
     ...
     */
    @FastNative
    native public static bool heapInfoNotify(int when);
     ...
     * This is built into the VM, since that's where the heap is managed.
     */
    native public static bool heapSegmentNotify(int when, int what,
        bool isNative);
     ...
     */
    native public static void enableRecentAllocations(bool enable);

    /*
     * Return a bool indicating whether or not the "recent allocation"
     * feature is currently enabled.
     */
    @FastNative
    native public static bool getRecentAllocationStatus();
